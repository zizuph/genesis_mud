...
// Prototypes
public void icestorm_desc_cast(object caster, object target);
public void resolve_harm_spell(object caster, object *targets, int *resist,
  int result);
public void storm_desc_damage(object caster, object target, mixed * result);
public void icestorm_desc_damage(object caster, object target, int phurt,
  string hitloc_desc);
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    caster_message = "You are preparing ice storm!\n";
...
desc_harm_cast(object caster, object *targets)
{
    ...
    icestorm_desc_cast(caster, target);
}

/*
 * Function name: icestorm_desc_cast
 * Description:   Describe casting of the spell, not including damage messages.
 *                This can be redefined for custom messages.
 * Arguments:     object caster - the caster
 *                object target - the target
 */
public void
icestorm_desc_cast(object caster, object target)
{
    string caster_message, target_message, watcher_message;
    caster_message = "You extend both of your arms to the sky and a dark " +
      "cloud begins to gather above your enemies. Before they can react, " +
	  "frozen shards of ice begin to rain down upon them!\n";
    target_message = QCTNAME(caster) + " extends both of its arms to " +
      "the sky and a dark cloud begins to gather above you. Before " +
      "you can react, frozen shards of ice begin to rain down " +
      "upon you!\n";
    caster->catch_msg(caster_message);
    target->catch_msg(target_message);
    //caster->tell_watcher(target_message, target, ({ caster }));
}
...
{
    storm_desc_damage(caster, target, result);
}

/*
 * Function name: storm_desc_damage
 ...
 */
public void
storm_desc_damage(object caster, object target, mixed * result)
{
    string caster_message, target_message, watcher_message;
    int phurt = result[0];
    string hitloc_desc = result[1];
    icestorm_desc_damage(caster, target, phurt, hitloc_desc);
}

/*
 * Function name: icestorm_desc_damage
 * Description:   Write out some text describing the damage done.  This can
 *                be redefined for custom messages.
 * Arguments:     object caster - the caster
 *                object target - the target
 ...
 */
public void
icestorm_desc_damage(object caster, object target, int phurt,
    string hitloc_desc)
{
    ...
    if (caster->query_is_illusion())
    {
        ...
        watcher_message = "The frozen debris crashes through you.\n";
    }
    else
    {
        if (phurt < 0)
        {
            target_message = "The barrage of ice crashes around you " +
              "harmlessly.\n";
            watcher_message = "The barrage of ice crashes around " + 
              QCTNAME(target) + " harmlessly.\n";
        }
        else
        {   
            switch (phurt)
            ...
            case 0:
                ...
                watcher_message = "Ice shards collide with " +
            ...
            case 1..10:
                ...
                watcher_message = "The falling shards rain onto " +
            ...
            case 11..20:
                target_message = "You are scratched and bruised by the " +
				  "storm.\n";
                watcher_message = "Your enemies are scratched and bruised " +
                  "by the storm.\n";
                break;
                
            case 21..30:
                target_message = "You are battered and cut by the barrage!\n";
                watcher_message = "Your enemies are battered and cut by the " +
                  "barrage.\n";
                break;
            ...
            case 31..40:
                target_message = "You can feel the ice slicing through the " +
                  ...
                  "within!\n";
                watcher_message = "You see the ice slicing through the skin " +
            ...
            case 41..50:
                ...
                watcher_message = "You can see icicles forming on your " +
            ...
            default:
                ...
                watcher_message = "You can see your enemies turning into " +

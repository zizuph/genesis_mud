...
create_room()
{
    ...
    "lower level of the keep. The way branches to the west into the "+
    "second level of the keep.\n");
    add_item("torches","They light up this dim place.\n");
    add_item("stairwells","It leads up or down.\n");
    add_exit(KEEP_DIR + "keep26","up",0);
    add_exit(KEEP_DIR + "keep10","down",0);
    add_exit(KEEP_DIR + "keep14","west",0);

...
create_room()
{
    ...
    "west along the north city wall. A wooden house is off to your "+
    "south.\n");
    ...
    add_exit(DRAKMERE_DIR + "road28","west",0,0,0);
    add_exit(DRAKMERE_DIR + "road30","east",0,0,0);
    add_exit(DRAKMERE_DIR + "house02","south","@@house",0,0);
    
    //add_exit(DRAKMERE_DIR + "house19","north","@@house",0,0);
}

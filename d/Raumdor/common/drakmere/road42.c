...
create_room()
{
    ...
    "south along the east city wall. The corner where the south and "+
    "east walls intersect stand just to your south.\n");
    ...
    add_exit(DRAKMERE_DIR + "road41","north",0,0,0);
    add_exit(DRAKMERE_DIR + "road43","south",0,0,0);
}

...
create_room()
{
    ...
    "grassy field. The air here smells fresh and clean, as flowers "+
    ...
    clone_object(DRAKMERE_DIR + "obj/statue")->move(TO);
    add_exit(DRAKMERE_DIR + "road26","north",0,0,0);
    add_exit(DRAKMERE_DIR + "road24","south",0,0,0);

...
create_room() 
{
    ...
    ::create_room();
set_short("The store room of the Drakemere Equipment Shop");
set_long("This is the store room of the Drakmere Equipment Shop\n");
    add_exit(DRAKMERE_SHOP_DIR + "eshop","west",0,-1);
...
#define BAG     DRAKMERE_OBJ_DIR + "lbag"
#define TORCH   DRAKMERE_OBJ_DIR + "torch"
#define PACK    DRAKMERE_OBJ_DIR + "backpack"
#define LAMP    DRAKMERE_OBJ_DIR + "oil_lamp"
#define OIL     DRAKMERE_OBJ_DIR + "oilflask"

...
create_room()
{
    ...
    add_exit(DRAKMERE_DIR + "road27","west",0,0,0);
    add_exit(DRAKMERE_DIR + "road29","east",0,0,0);
    add_exit(DRAKMERE_DIR + "house01","south","@@house",0,0);
    
    add_npc(DRAKMERE_NPC_DIR + "dguard", 2);
    
    //add_exit(DRAKMERE_DIR + "house18","north","@@house",0,0);
}

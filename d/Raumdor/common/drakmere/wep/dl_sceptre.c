 ...
 *
 *     Modified:       Arman, Dec 2021, added as a spell enhancer.    
 */
...
create_weapon()
{
    ...
    add_prop(OBJ_S_WIZINFO,"This is a magical sceptre, able to heal, and "+
      "burn undead to dust (although these abilities have been disabled). " +
      "It can heal half of ones alignment. " +
      "It has a hit/pen of 40 and spellpower of 45.\n");
	...
	"hurt easily by it. It can also enhance the prayer and spell " +
        "powers of those who can wield it.\n",10}));

    add_prop(OBJ_I_VALUE, F_VALUE_WEAPON(40, 40) + random(20) -10);
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(40, W_CLUB) +
        random(50) - 25);

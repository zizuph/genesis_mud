...
create_room()
{
    ...
    "west along the north city wall. Right off to your west is a T "+
    ...
    add_exit(DRAKMERE_DIR + "road01","west",0,0,0);
    add_exit(DRAKMERE_DIR + "road32","east",0,0,0);
    add_exit(DRAKMERE_DIR + "house06","south","@@house",0,0);
}

...
create_room()
{
    ...
    set_long("You've reached the eastern part of the camp "
    +"centre. Rows of tents completely "
    +"block any passage south. You struggle not to get stuck in "
    +"the deep grooves that make "
    +"out something resembling a road coming from the east and "
    +"turning north. You reckon the grooves "
    +"are a direct result of heavy war machines being moved "
    +"through the camp and to more "
    +"strategic locations closer to the barely visible castle. "
    +"You're free to follow "
    +"the grooves north, or east towards the entrance. A path "
    +"leads westward into the "
    +"camp between further rows of tents and crusaders in various "
    ...
    add_item(({"ground", "grooves", "large grooves", "road"}),"The ground here looks "
    ...
    add_exit(MTRAIL_DIR + "siegecamp_10", "east");
    add_exit(MTRAIL_DIR + "siegecamp_5", "south");
    add_exit(MTRAIL_DIR + "siegecamp_12", "west");

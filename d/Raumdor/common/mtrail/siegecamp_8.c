...
create_room()
{
    ...
    set_long("You find yourself close to the souththwesternmost "
    +"part of the camp. Being the "
    +"edge of the camp, the tents are fewer. You're fairly sure "
    +"the stench emanating from "
    +"the west in large part contributes to the scarcity of "
    +"people. The ground here seems "
    +"well trod, but otherwise there's not much to see. You're "
    +"free to move in the "
    +"east-west direction, although judging by the smell you're "
    +"fairly certain you'll "
    +"find a garbage heap to the west. \n");
    ...
    add_exit(MTRAIL_DIR + "siegecamp_9", "west");
    add_exit(MTRAIL_DIR + "siegecamp_7", "east");

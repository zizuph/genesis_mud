...
create_room()
{
    ...
    +"block any passage south. You struggle not to get stuck in the "
    +"deep grooves that make "
    +"out something resembling a road coming from the east and turning "
    +"north. You reckon the grooves "
    +"are a direct result of heavy war machines being moved through the "
    +"camp and to more "
    +"strategic locations closer to the barely visible castle. "
    +"You're free to follow "
    +"the grooves north, or east towards the entrance. A path leads "
    +"westward into the "
    ...
    add_exit(MTRAIL_DIR + "siegecamp_16", "north");
    add_exit(MTRAIL_DIR + "siegecamp_2", "east");
    add_exit(MTRAIL_DIR + "siegecamp_11", "west");

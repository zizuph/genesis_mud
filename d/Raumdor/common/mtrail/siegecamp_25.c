...
create_room()
{
    ...
    set_long("Dead end, and boy does it stink! The "
    +"nauseating stench of fresh human waste "
    +"assaults your senses like a wet blanket, and you struggle "
    +"to stay poised as your "
    +"stomach does summersaults. As you look towards the cliff's "
    +"edge you see a small "
    +"outhouse and a line of crusaders crossing their legs "
    +"while pinching their "
    +"noses. You look to the west, which is your only traversable "
    +"option, and see "
    +"absolutely no reason to linger here.\n");
    
    
    add_item(({"cliffs", "cliff", "edge"}),"The cliffsides are present "
    +"all around the plateau, and "
    ...
    add_item(({"outhouse", "small outhouse"}),"This is a small "
    +"wooden structure "
    +"with an improvised roof and a door. The door consist of a "
    +"few rotten wooden "
    +"boards. The stench emanating from this structure however, could "
    +"probably kill anything. Holy or not, both men and beast must give "
    +"back to the nature, and this outhouse obviously serves as the lavatory "
    +"of the camp.\n");
    ...
    add_exit(MTRAIL_DIR + "siegecamp_24", "west");

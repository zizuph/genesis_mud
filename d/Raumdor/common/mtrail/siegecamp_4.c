...
create_room()
{
    ...
    set_long("You find yourself close to the southeastern "
    +"corner of the camp. The tents "
    +"erected here look ragged and torn, and you reckon they "
    +"are the ones who have "
    +"been around the longest as you're fairly close to the "
    +"entrance further northeast. "
    +"A couple of old timers look like they've had just about "
    +"enough to drink, and a "
    +"sinister mood has washed over the whole situation. Your "
    +"movements options are "
    +"either east towards the entrance or west along the "
    +"edge of the camp.\n");
    ...
    add_exit(MTRAIL_DIR + "siegecamp_5", "west");
    add_exit(MTRAIL_DIR + "siegecamp_3", "east");

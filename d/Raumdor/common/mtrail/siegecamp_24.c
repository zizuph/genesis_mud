...
create_room()
{
    ...
    set_long("You find yourself in a T-section farthest north "
    +"in the camp. The stench of "
    +"human waste assaults your nostrils as the wind hits "
    +"you from the east. There's "
    +"not much to see, and given the strong odour you too would "
    +"think twice about setting "
    +"up camp here. The castle is fairly visible from this "
    +"point, and you marvel at the "
    +"clouds hugging and dancing around the walls and mountain "
    +"peaks. You can travel deeper "
    +"into the camp by traversing south. Otherwise there are "
    +"options on the east-west axis.\n");
    ...
    add_exit(MTRAIL_DIR + "siegecamp_23", "west");
    add_exit(MTRAIL_DIR + "siegecamp_25", "east");
    add_exit(MTRAIL_DIR + "siegecamp_19", "south");

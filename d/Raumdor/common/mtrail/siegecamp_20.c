...
create_room()
{
    ...
    set_long("You find yourself within the northwestern of the "
    +"camp. The tents are "
    +"stacked fairly close to one another, and a result "
    +"you can't but gag a little "
    +"as various bodily odours seep out of the tents as the "
    +"crusaders come and go, "
    +"and tent-flaps open and close. You vaguely make out the "
    +"castle to the east, "
    +"and there are paths going both east and west through the "
    +"rubble and debris "
    ...
    add_exit(MTRAIL_DIR + "siegecamp_21", "west");
    add_exit(MTRAIL_DIR + "siegecamp_19", "east");

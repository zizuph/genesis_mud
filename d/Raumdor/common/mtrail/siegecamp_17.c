...
create_room()
{
    ...
    set_long("You find yourself in the the northeastern "
    +"part of camp centre, and "
    +"as you walk on the outer edges, the tents are "
    +"stacked close together. "
    +"As a result the ground is covered in, empty bottles, dirty rags, food "
    +"scraps and other random debris. Around each "
    +"tent there are crusaders in various states of inebriation, "
    +"and even though "
    +"the mood appears light, something sinister seem to "
    +"keep everyone in check. "
    +"The tents form rows preventing any movement north of south, "
    +"but you're free "
    ...
    add_exit(MTRAIL_DIR + "siegecamp_18", "west");
    add_exit(MTRAIL_DIR + "siegecamp_16", "east");

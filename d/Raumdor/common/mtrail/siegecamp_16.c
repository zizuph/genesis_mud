...
create_room()
{
    ...
    set_long("Walking at the northeastern part of the camp "
    +"centre, you struggle not "
    +"to get stuck in the deep grooves stretching from the south "
    +"to the east, and "
    +"as you study the topography in relation to the castle "
    +"in the east, you're "
    +"fairly sure there's a tactical spot to place a trebuchet "
    +"just east of here. "
    +"The wide berth needed to move big war machines displaces "
    +"any eligible tenting "
    +"locations and such it's fairly quiet and you feel a slight "
    +"freshness to the air. "
    +"You can follow the tracks to the east or south of here, or "
    +"head towards a more "
    +"crowded area to the west.\n");
    ...
    add_exit(MTRAIL_DIR + "siegecamp_17", "west");
    add_exit(MTRAIL_DIR + "siegecamp_15", "east");
    add_exit(MTRAIL_DIR + "siegecamp_10", "south");

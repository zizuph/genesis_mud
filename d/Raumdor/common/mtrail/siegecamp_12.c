...
create_room()
{
    ...
    set_long("As you walk through the center of the camp, the "
    +"tents are so closely "
    +"stacked they appear as one. The ground is pure mud, "
    +"and is littered with "
    +"empty bottles, dirty rags, food scraps and other random "
    +"debris. Outside each "
    +"tent there are crusaders in various stats of inebriation, "
    +"and even though "
    +"the mood appears light, something sinister seem to "
    +"keep everyone in check. "
    +"The tents form rows preventing any movement north of "
    +"south, but you're free "
    ...
    add_exit(MTRAIL_DIR + "siegecamp_13", "west");
    add_exit(MTRAIL_DIR + "siegecamp_11", "east");

...
create_room()
{
    ...
    +"are dead center in the camp. There is some debris on "
    +"the ground, but compared "
    +"to other parts of the camp, you reckon it's almost tidy. "
    +"Gazing westwards you "
    +"clearly make out a guarded tent which is significantly "
    +"larger than the rest. "
    +"You can also travel deeper into the camp eastwards, or "
    +"visit the edges to "
    +"the north or south.\n");
    ...
    add_exit(MTRAIL_DIR + "siegecamp_12", "east");
    add_exit(MTRAIL_DIR + "siegecamp_7", "south");
    add_exit(MTRAIL_DIR + "siegecamp_14", "west");
    add_exit(MTRAIL_DIR + "siegecamp_19", "north");

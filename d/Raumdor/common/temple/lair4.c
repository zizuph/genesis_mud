/* /d/Raumdor/common/temple/lair4.c 
*
*Lair of the Khiraa 
*
*
...
create_room()
{
    ...
    add_exit(TEMPLE_DIR + "lair3", "southwest", 0);
	add_exit(TEMPLE_DIR + "lair5", "north", 0);
	add_exit(TEMPLE_DIR + "lair1", "southeast", 0);
	add_exit(TEMPLE_DIR + "lair2", "south", 0);

...
create_room()
{
    ...
    set_long(
      "You stand at the foot of a grand chamber. It is square in shape, with " +
      "pillars lining the sides of the room. At the very front, there is an " +
      "exit to another chamber, while to the east and west, there are exits " +
    ...
    add_exit(TEMPLE_DIR + "temple15", "north", 0);
    add_exit(TEMPLE_DIR + "temple09", "west", 0);
    add_exit(TEMPLE_DIR + "temple11", "east", 0);
    add_exit(TEMPLE_DIR + "temple06", "south", 0);
    add_exit(TEMPLE_DIR + "temple05", "southwest", 0);
    add_exit(TEMPLE_DIR + "temple07", "southeast", 0);

...
create_room()
{
    ...
    set_long(
      "You now stand in the southeastern part of this grand chamber. It is " +
      "square in shape, with pillars lining the sides of the room. At the " +
      "very front, there is an exit to another chamber, while to the west, " +
    ...
    add_exit(TEMPLE_DIR + "temple16", "north", 0);
    add_exit(TEMPLE_DIR + "temple10", "west", 0);

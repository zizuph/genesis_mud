...
create_room()
{
    ...
    set_long(
      "You stand in the east part of this grand chamber. It is square in " +
      ...
      "to the east of you, you see it bends south.\n");
    add_item(({"pillars"}),
    ...
    add_exit(TEMPLE_DIR + "temple20", "north", 0);
    add_exit(TEMPLE_DIR + "temple15", "west", 0);
    add_exit(TEMPLE_DIR + "temple17", "east", 0);
    add_exit(TEMPLE_DIR + "temple11", "south", 0);

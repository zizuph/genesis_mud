/* /d/Raumdor/common/temple/lair3.c 
*
*Lair of the Khiraa 
*
*
...
query_k_rune()
{
    //if(IS_DK(TP) || IS_LP(TP))
      //  return "They are praises to the Nameless One. He who's "+
        //"name is unspeakable, whos power unmatched.\n";
...
create_room()
{
    ...
    "Intricatly carved walls encase you on your west and south sides. "+
    "An open archway leads to the northeast into what looks like a "+
    "large foyer. To the east, the semi-hallway you are in leads "+
    "to another set of stairs.\n"+ 
    "   Strange looking runes and symbols "+
    "adorn the top of the archway going northeast. The air has an "+
    ...
    "statue in the foyer to the northeast.\n\n");
    ...
    "now, but vaults up high to the northeast.\n");
    ...
    add_exit(TEMPLE_DIR + "lair2", "east", 0);
	add_exit(TEMPLE_DIR + "lair4", "northeast", 0);
	add_exit(TEMPLE_DIR + "temple02", "up", 0);

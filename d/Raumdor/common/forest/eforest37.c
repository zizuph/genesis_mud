...
create_room()
{
    ...
    add_exit(FOREST_DIR + "eforest46","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest28","south",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest27","southwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest36","west",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest45","northwest",0,FOREST_FATIGUE);
}

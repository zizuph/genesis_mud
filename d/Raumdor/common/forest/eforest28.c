...
create_room()
{
    ...
    set_no_exit_msg(({"south","southeast","east","northeast"}), climb);
    add_exit(FOREST_DIR + "eforest37","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest19","southwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest27","west",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest36","northwest",0,FOREST_FATIGUE);
}

...
create_room()
{
    ...
    add_exit(FOREST_DIR + "nforest58","east",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest51","southeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest50","south",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest49","southwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest56","west",0,FOREST_FATIGUE);
}

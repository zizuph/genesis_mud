...
create_room()
{
    ...
    add_exit(FOREST_DIR + "eforest13","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest14","northeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest06","east",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest04","west",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest12","northwest",0,FOREST_FATIGUE);
}

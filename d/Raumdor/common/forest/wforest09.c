...
create_room()
{
    ...
    add_exit(FOREST_DIR + "wforest19","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest08","west",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest18","northwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest20","northeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest10","east",0,FOREST_FATIGUE);
}

...
create_room()
{
    ...
    add_exit(FOREST_DIR + "eforest08","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest09","northeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest03","east",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest01","west",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest07","northwest",0,FOREST_FATIGUE);
}

...
create_room()
{
    ...
    add_exit(FOREST_DIR + "wforest55","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest56","northeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest54","northwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest40","west",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest30","southwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest42","east",0,FOREST_FATIGUE);
}

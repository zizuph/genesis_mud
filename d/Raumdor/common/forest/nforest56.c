...
create_room()
{
    ...
    add_exit(FOREST_DIR + "nforest57","east",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest50","southeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest49","south",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest48","southwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "nforest55","west",0,FOREST_FATIGUE);
}

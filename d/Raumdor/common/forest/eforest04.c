...
create_room()
{
    ...
    add_exit(FOREST_DIR + "eforest12","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest13","northeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest05","east",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "wforest44","northwest",0,FOREST_FATIGUE);
}

...
create_room()
{
    ...
    add_exit(FOREST_DIR + "eforest27","north",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest28","northeast",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest11","south",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest10","southwest",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest18","west",0,FOREST_FATIGUE);
    add_exit(FOREST_DIR + "eforest26","northwest",0,FOREST_FATIGUE);
}

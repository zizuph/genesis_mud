...
create_monster()
{
	...
	add_name("menacing death knight");
    set_adj("death");
    add_adj("menacing");
    set_short("menacing death knight");
    set_race_name("human");
    set_long(
    ...
    equip(({
      ...
      clone_unique(COMMON_ARM_DIR + "kbbracers", 20, COMMON_ARM_DIR + "rcbracers"), 

 ...
 * 2018-06-01 Malus: Address bug in drain object
 */
#include "defs.h"
inherit STD_UNDEAD;
...
create_monster(void)
{
    ...
    add_cact("say I shall take you to hell!");
    add_cact("say Feel the power of the grave, mortal!");
...
{
    command("say I hope you like thy grave, mortal!");
}

public void
do_die(object killer)
{
    command("say You will visit Death sooner or later, mortal!");

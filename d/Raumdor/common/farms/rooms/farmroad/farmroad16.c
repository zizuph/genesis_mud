/* 
 * /d/Raumdor/common/farms/farmroad16.c
 *
 * Ardent 2020
 */
...
void create_farms_room()
{
    ...
    set_long("You are on the main road in the middle of the farms. "+
        ...
        " East of the road you can see a pasture with a few horses."+
        " Further away you can see grain fields and plains on all "+
        "sides. Low stunted trees dot the landscape. In the "+
        "distance to the west you can see the Mill. The air is "+
        "calm here.\n");
 
    add_exit(FARMROAD_DIR + "farmroad10","north");
    add_exit(FARMROAD_DIR + "farmroad17","south");

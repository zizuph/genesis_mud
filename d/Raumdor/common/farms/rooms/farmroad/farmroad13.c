/* 
 * /d/Raumdor/common/farms/farmroad13.c
 *
 * Ardent 2020
 */
...
void create_farms_room()
{
    ...
    set_long("Gravel crunches under your feet as you walk along the "+ 
        ...
        "the landscape. A fenced pasture with some sheep can be seen "+
    ...
    "The ones to the south look bigger than the rest. Looking closely "+
    "you can see that someone has picked all the berries this bush "+
    "seems to have had. \n");

    add_exit(FARMS_DIR + "farmroad12","east");
    add_exit(FARMS_DIR + "farmroad14","west");

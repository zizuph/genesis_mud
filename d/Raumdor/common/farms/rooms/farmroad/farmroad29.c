/* 
 * /d/Raumdor/common/farms/farmroad29.c
 *
 * Ardent 2020
 */
...
void create_farms_room()
{
    ...
    set_long("You are on the main road south of the farms. "+
        ...
        "Drakmere. Further south the farmroad is intersected by "+
        "another road. The plains spread out on all "+
        "sides. Low stunted trees dot the landscape.\n");
 
    add_exit(FARMROAD_DIR + "farmroad28","north");

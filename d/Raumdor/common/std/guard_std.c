...
/* Sarr */
/* 2017-09-13 Malus: Removing holy_room effect, as Gilbert is now supposed
 * to be stationary per Nerull */   
...
*list_friends()
{
   ...
   /*RAUMDOR GUARDS LIST, they help eachother out*/
    ({"/d/Raumdor/common/drakmere/npc/dguard",
      "/d/Raumdor/common/drakmere/npc/dguard_s",
      "/d/Raumdor/common/drakmere/npc/eg_guard",
      "/d/Raumdor/common/drakmere/npc/eg_guard_s",
      "/d/Raumdor/common/drakmere/npc/drakmere",
      "/d/Raumdor/common/drakmere/npc/dguard_cap", 
      "/d/Raumdor/common/drakmere/npc/dguard_chief"});

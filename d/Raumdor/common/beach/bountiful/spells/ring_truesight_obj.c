...
create_spell_object()
{
    set_name("_ring_truesight_object_");
    set_short("ring truesight spell object");    
    ...
    set_spell_effect_desc("truesight");  
}
...
hook_spell_effect_started()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You feel your vision is enhanced to even detect invisible "
        +"creatures.\n");
    }    
}
...
hook_spell_effect_ended()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("Your enhanced vision ends, returning to normal.\n");
    }
}
...
hook_spell_effect_not_maintained()
{
    ...
    if (objectp(caster))
    {
        caster->catch_tell("Your enhanced vision ends, returning to normal.\n");
    }    
}
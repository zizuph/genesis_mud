/*
 * /d/Raumdor/beach/bountiful/npc/bount_ghast3.c
 *
 * Nerull 2021
 *
...
nomask void create_monster()
{
    ...
    set_long("Wearing various ropes around his body, "
    +"you feel this man is more obsessed with his work "
    +"than one should be. Ropes around his neck, arms and "
    +"legs, tightly bound. How he breaths you know "
    +"not, but he whistles a constant high note, over and "
    +"over and over.\n");

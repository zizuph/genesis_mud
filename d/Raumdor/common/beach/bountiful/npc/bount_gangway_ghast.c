/*
 * /d/Raumdor/beach/bountiful/npc/bount_gangway_ghast.c
 *
 * Nerull 2021
 *
 * This npc sports 15k hitpoints for increased difficulty.
 *
...
nomask void create_monster()
{
    ...
    add_name("_gangway_ghast");

    add_adj("straggly");
    add_adj("partially-bald");
    ...
    set_long("Wearing a yellow-stained bandana "
    +"to cover his face, this man stares blankly at "
    +"you as he constantly flicks his head to reset "
    +"his comb over. Wearing a dress blue uniform of "
    +"his station is not the only thing out of place "
    +"but also the talon-like fingers on his hands. "
    +"He is muttering something "
    +"constantly but so softly you are not sure what "
    +"he says.\n");

/*
 * /d/Raumdor/beach/bountiful/npc/bount_ghast2.c
 *
 * Nerull 2021
 *
...
nomask void create_monster()
{
    ...
    set_long("Large rounded shoulders and arms that look "
    +"the size of a regular mans thighs, point to the strength "
    +"of this man. His rotund belly made perfect from years "
    +"of consuming gallons of ale each night and hardened "
    +"equally through as many nights pounding metal. He sings "
    +"a well-known solemn tune as he moves about though his "
    +"voice is inhuman and emotionless.\n");

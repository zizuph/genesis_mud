/*
 * /d/Raumdor/beach/bountiful/npc/bount_ghast5.c
 *
 * Nerull 2021
 *
...
nomask void create_monster()
{
    ...
    set_long("This man is as clean as the cuts and "
    +"stitching of his sails. So clean is his shave that "
    +"his skin actually seems polished but how one can "
    +"achieve such perfection on the high seas, is a "
    +"mystery. Perhaps his motto is cut once and measure "
    +"twice, but you do notice his white collar is full "
    +"with a thick oozy substance and he keeps clearing "
    +"his throat.\n");

...
thanger(string str)
{
    ...
    if (!stringp(str))
    {
	write("You express your anger with righteous insults "+
	  "at demihumans.\n");
	allbb(" expresses your anger with appalling insults "+
	  "at demihumans.");
	return 1;
    }
    ...
    if (!sizeof(oblist))
    {
        notify_fail("Express your anger at whom?\n");
        return 0;
    }


    actor("You hurl the most horrible and vile insults known "+
      "at", oblist," because its well deserved.",);
    all2actbb(" hurls the most horrible and vile insults known "+
      "at", oblist, ".","");
    target(" hurls the most horrible and vile insults known "+
      "at you.", oblist,"");
...
thcruelty(string str)
{
...

	{
	    write("You develop a malicious and devious look on your "+
	      "face in anticipation of commiting acts of cruelty.\n");
...
thgrin(string str)
{
    ...
    if (!stringp(str))
    {
	write("You grin with utter supremacy sparkling in your eyes.\n");
	allbb(" grins with utter supremacy sparkling "+
	  "in " + HIS(TP) + " eyes.", "",);
	return 1;
    }
    oblist = parse_this(str, "[at] [the] %i");
    ...
    actor("You grin at",oblist," with utter supremacy sparkling in your eyes.");
    targetbb(" grins at you with utter supremacy sparkling in "+
      ""+ HIS(TP) +" eyes.", oblist, "");
    all2actbb(" grins at", oblist, " with utter supremacy sparkling in "+
      ""+ HIS(TP) +" eyes.");
    return 1;
}
...
thhorror(string str)
{
	...
	{
	    write("Your face contorts into a mask of horror and "+
	      "loathing at the thought of a world populated by demihumans.\n");
	    allbb(" face contorts into a mask of horror and "+
	      "loathing at the thought of a world populated by demihumans.",1);
	    return 1;
	}
    ...
    if (!sizeof(oblist))
    {
        notify_fail("In horror at whom/what?\n");
        return 0;
    }
    {
	actor("Your face contorts at",oblist," with utter horror "+
	  "and loathing.");
	targetbb("'s face contorts at you with utter horror and "+
	  "loathing.", oblist,);
	all2actbb("'s face contorts as "+ HE(TP) +" looks at",oblist," "+
...
thjoke(string str)
{
	...
	{
	    write("You make a very crude joke involving a "+
	      "hobbit, a horse and a wooden stick.\n");
	    allbb(" makes a very crude joke involving a hobbit, "+
	      "a horse and a wooden stick.",1);
	    return 1;
	}
    ...
    if (!sizeof(oblist))
    {
        notify_fail("Joke at whom/what?\n");
        return 0;
    }
    {
	actor("You make a very crude joke involving",oblist,", a "+
	  "horse and a wooden stick.");
	targetbb(" make a very crude joke involving you, a horse and "+
	  "a wooden stick.", oblist);
	all2actbb(" makes a very crude joke involving"+
	  "",oblist,", a horse and a wooden stick.");
	return 1;
    }
...
thpreach(string str)
{
    ...
    write("You begin to preach the praises of Thanar's world "+
      "vision, a vision where only the chosen race, humanity, "+
      "shall live while all other races are pushed into "+
      "servitude or extinction.\n");
    ...
    actor("You begin to preach to", oblist, " about the great Thanar's "+
      "world vision of human supremacy.");
    targetbb(" begins to preach to you about Thanar's world "+
      "vision of human supremacy.", oblist);
...
thshout(string str)
{
    ...
    write("You shout out in pure ecstacy at all the "+
      "glory that shall belong to Thanar.\n");
    allbb(" shouts out in pure ecstacy at all the glory "+
      "that shall belong to Thanar.");
    SOULDESC("shouting outloud in pure ecstacy");
    return 1;
    }
    ...
    SOULDESC("shouting out loud in pure ecstacy");
    actor("You shout at", oblist, " in pure ecstacy, "+
      "for all glory is Thanar's.");
    targetbb(" shouts at you in pure ecstacy, for all glory "+
      "is Thanar's.", oblist);
    all2actbb(" shouts at", oblist, " in pure ecstacy, for all "+
      "glory is Thanar's.");
    return 1;
}
...
thsuspicion(string str)
{
    ...
    write("You peer around the room suspiciously, searching for demihumans.\n");
    allbb(" peers around the room suspiciously, searching for demihumans.");
...
thswear(string str)
{
    ...
    write("You swear profusely and curse all demihumans.\n");
    allbb(" swears profusely and curses all demihumans.");
    return 1;
    }
...
ththink()
{
    ...
    ""+ HIS(TP) + " chin in a superior manner.", "");
    return 1;
}

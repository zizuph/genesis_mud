 ...
 * - Description:   Give messages indicating that spell             - *
 * -                concentration has begun                         - *
 * - Arguments:     1. (object)   The caster                        - *
 * -                2. (object *) The targets                       - *
 * -                3. (string)   The arguments passed to the       - *
 * -                              "cast" command                    - *
 **********************************************************************/
 ...
 * - Arguments:     1. (object) The caster                          - *
 * -                2. (object) The object responsible for breaking - * 
 * -                the spell                                       - *
 **********************************************************************/
public void
break_spell(object caster, object breaker)
{
    caster->catch_tell("Your concentration is broken.\n");
    FILTER_IS_SEEN(caster, FILTER_PLAYERS(all_inventory(environment(caster)))
...
{
    set_spell_fail("You feel the power of Thanar slip away.\n");
    set_spell_time(3);
...
hook_room_no_magic_fail(mixed reason, object room)
{
    ...
    else
    {
        write("For some reason you are unable to concentrate, "+
          "as if resisted by some strange property within this area.\n");
    }
}

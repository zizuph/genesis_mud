/*********************************************************************
 * - club.c                                                        - *
 * - This is the base room of the Ladies Club located in Drakmere  - *
 * - Created by Damaris 5/3003                                     - *
 *********************************************************************/
...
create_room()
{
    ...
    add_item(({"pattern", "patterns", "intricate pattern", "intricate patterns"}),
      "There is various patterns stained in the tiles. Red is "+
    ...
    add_room_tell(({
      ...
      "The sweet aroma of freesia infiltrates the air.\n",
    }));

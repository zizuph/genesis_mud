...
#define  LCIN    "/d/Raumdor/guilds/lc/room/join"
...
create_object()
{
    ...
    set_adj("huge");
    add_adj("blue");
    set_short("huge blue portal");
    set_long("This is a huge blue portal which has a peculiar " +
    "two-dimensional surface rising from the " +
    "ground resembling the shape of a whirling maelstrom. It is " +
    "simply blue, no variation in colour and no dirt " +
    "clinging to it.\n");

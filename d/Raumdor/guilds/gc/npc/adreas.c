...
create_monster()
{
  ...
  set_long("She is a seamstress and shopkeeper.\n"+
    "She has soft blue eyes.\n"+
    "She has smooth pale skin.\n"+
    "Her hair is shoulder length, soft blond and crimped along the sides.\n"+
    "She has small beads of persperation along her soft brow.\n");
  ...
  MONEY_MAKE_SC(random(40))->move(this_object());
    ...
    add_ask(({"goblin", "goblins"}),
      "say Goblins! Hide everything! Quickly!", 1);
    add_ask(({"drakmere"}),
    ...
    add_ask(({"minotaur", "minotaurs"}),
      "say You mean the cow... err uhh... No I haven't fitted one myself.", 1);
    ...
    add_ask(({"gnome", "gnomes"}),
      "emote giggless sweetly as she says: I have fitted a few in my lifetime.", 1);
}
/*********************************************************************
   ...
   if (SECURITY->query_wiz_rank(TIQRN) >= WIZ_ARCH)
    {
        ...
        present(str, environment(TO))->add_introduced("adreas");
        command("kneel " + str);

/*********************************************************************
 * - cloakstore.                                                   - *
 * - Storeroom for Cloak room in the Gentlemen's club              - *
 * - For members only                                              - *
 ...
 *********************************************************************/
#define WSHIRT       (ARM + "wshirt")
#define GPANTS       (ARM + "gpants")
#define GLOVES       (ARM + "gloves")
#define BOOTS        (ARM +  "boots")
#define SCARF        (ARM +  "scarf")
 ...
 * - objects that should be in stock. (30 items is the limit)      - *
 *********************************************************************/
mixed to_check = ({ ({"create_armour", WSHIRT, 5}),
                    ({"create_armour", GPANTS, 5}),
                    ({"create_armour", GLOVES, 10}),
                    ({"create_armour", BOOTS,  3}),             
                    ({"create_armour", SCARF,  7}),
                 });

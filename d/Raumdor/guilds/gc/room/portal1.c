/*
 * Temporary portal, connecting the clubs to Sparkle - Nerull.
 */
...
create_object()
{
    ...
    set_adj("huge");
    add_adj("black");
    set_short("huge black portal");
    set_long("This is a huge black portal which has a peculiar " +
    "two-dimensional surface rising from the " +
    "ground resembling the shape of a whirling maelstrom. It is " +
    "simply black, no variation in colour and no dirt " +
    "clinging to it.\n");

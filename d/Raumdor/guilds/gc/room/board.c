/*********************************************************************
 * - board.c                                                       - *
 * - Board room in the Gentleman's club                            - *
...
create_guild_room()
{
    ...
    add_item(({"east"}), "There is a doorway in that direction that leads " +
        "to the postal area.\n");
    add_item(({"south"}), "There is a doorway in that direction that leads " +
        "back to the lobby area.\n");
    add_item(({"north", "northwest", "northeast", "southeast", "southwest",
        "west"}), "There is a wall in that direction.\n");
    ...
    add_exit("post", "east");
    add_exit("lobby", "south");
    add_exit("cboard","up");
    set_no_exit_msg(({"north", "west", "northeast", "northwest", "southeast",
        "southwest"}),

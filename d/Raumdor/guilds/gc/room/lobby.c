...
create_guild_room()
{
    ...
    set_long("This is a spacious lobby in the Gentleman's "+
      "Club. The room is slightly rounded and it is from here "+
      "gentlemen may find access to many different areas. There "+
      "is a large round rug that has been placed on the tiled floor in the "+
      "center of the room. There is also a large round table "+
      "placed in the center as well. There are large and small "+
      "paintings along the walls with golden lanterns firmly "+
      "attached next to them.\n");
    add_item(({"room", "lobby", "area"}), query_long);
    add_item(({"floor", "flooring", "ground"}),
      "The flooring is made from a dark tile with small intricately "+
      "stained red patterns. A large round rug has been place upon it.\n");
    add_item(({"rug"}),
      "The rug has been died a soft ruby red colour and a round table "+
      "is sitting on it.\n");
    ...
    add_item(({"south"}),
      "There is a doorway in that direction that leads to the cloak room.\n");
    add_item(({"east"}),
      "There is a doorway in that direction that leads to the private "+
      "dining room.\n");
    add_item(({"west"}),
    ...
    add_item(({"painting", "paintings"}),
      ...
      "elegant in nature, depicting various gentleman in different "+
      "settings.\n");
    add_prop(ROOM_I_LIGHT, 2);
    add_prop(ROOM_I_NO_ATTACK, 1);
    add_prop(ROOM_I_NO_MAGIC_ATTACK, 1);
    add_exit("board", "north");
    add_exit("cloak", "south");
    add_exit("pdining", "east");
    add_exit("sit","west");

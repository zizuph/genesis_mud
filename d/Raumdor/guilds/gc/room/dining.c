...
create_guild_room()
{
    set_short("A quiet dining room");
    set_long("This is a quiet dining hall. Elegant tables set "+
    ...
    add_item(({"north", "west", "east", "southwest", "southeast", "northeast",
      "northwest"}),
    ...
    add_food(({
        ...
        add_food(({
            ...
            0);
    add_exit("join", "south");
    set_no_exit_msg(({"north", "east", "west", "northeast", "northwest",
        "southeast", "southwest"}),
    ...
    add_room_tell(({
        ...
        "A young dining room attendent cleans a table nearby.\n",

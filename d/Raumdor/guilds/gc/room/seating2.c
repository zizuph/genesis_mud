...
#define SDESC \
"There are a chairs placed near the fireplace and a few others near "+ \
"end tables.\n"

mixed sdef = ({
({
({"fire","in front of fire", "near fire"}),
"You sit down in one of the comfortable chairs near the fireplace.\n",
" sits down in one of the comfortable chairs near the fireplace.\n",
"You arise from your comfortable chair.\n",
" arises from a comfortable chair.\n",
"You are sitting comfortably in a chair near the fireplace.\n",
"You arises from a comfortable chair and leave the room.\n",
" sitting comfortably in one of the comfortable chairs near the fireplace",
" sitting comfortably in one of the comfortable chairs near the fireplace.\n",
}),

({
({"chair","in chair", "on chair"}),
"You sit down in one of the comfortable chairs near an end table.\n",
" sits down in one of the comfortable chairs near an end table.\n",
"You arise from your comfortable chair.\n",
" arises from a comfortable chair.\n",
"You are sitting comfortably in a chair near an end table.\n",
"You arises from a comfortable chair and leave the room.\n",
" sitting comfortably in one of the comfortable chairs near an end table",
" sitting comfortably in one of the comfortable chairs near an end table.\n",
})

/*********************************************************************
 * - cloak.c                                                       - *
 * - This is the cloak room of the Gentlemans Club located in      - *
 * - Drakmere                                                      - *
...
#define STORE  "/d/Raumdor/guilds/gc/room/cloakstore"
...
query_shop_sign()
{
    return("          *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*\n"+
      ...
      "          |    it's members with the much needed   |\n"+
      "          |     stylish and practical clothing     |\n"+
      "          |             for gentlemen              |\n"+
      "          |                                        |\n"+
      "          |  This cloak room operates like a shop. |\n"+
...
create_guild_room()
{
    set_short("A cloak room");
    set_long("This is a cloak room that has been elaborately "+
    ...
    add_item(({"shop", "room", "cloak room", "cloakroom"}), query_long);
    add_item(({"wall", "walls"}),
 ...
 *********************************************************************/
    ...
    set_shopkeep(GUILD_DIR + "npc/deldin", this_object());

    add_exit("lobby", "north");
    add_exit("cloakstore", "storeroom", wiz_check, 0, 1);
}

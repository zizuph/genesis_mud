...
create_weapon()
{
    ...
    set_long("This two-handed cleaver has a long wooden handle clad in "
        ...
        +"head is very broad with a single long jagged edge, and it's "
    ...
    set_hit(TWOH_BEAST_CLEAVER_HITPEN_DEFAULT);
    set_pen(TWOH_BEAST_CLEAVER_HITPEN_DEFAULT);
    ...
    "This cleaver contains a trapped soul.\n", 5,
    "The trapped soul within will sporadically empower " +
    "the cleaver and help dealing additional damage to the " +
    "enemy.\n", 50}));
    ...
    add_prop(OBJ_S_WIZINFO, "This two-handed weapon has a hit/pen of " 
        ...
        +"(TWOH_BEAST_CLEAVER_PROC) and "
        +"(TWOH_BEAST_CLEAVER_SPECIAL_MULTIPLIER).\n");
...
int dam)
{
    ...
    if(random(100) < TWOH_BEAST_CLEAVER_PROC)
    {
        ...
        // The damage formula.
        mindam = TWOH_BEAST_CLEAVER_SPECIAL_MULTIPLIER * 

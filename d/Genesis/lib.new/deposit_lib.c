...
deposit(string str)
{
    ...
    {
	notify_fail("The gnome says: You have to specify amount and cointype!\n");
	return 0;
    }
    ...
    {
	write("The gnome says: There is no such official money type.\n");
	return 1;
    }
...
withdraw(string str)
{
	...
	write("After deduction of the fee and the withdrawel of the coins, " +

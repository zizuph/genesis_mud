...
write("The Gnomes of Genesis are currently closed to be redecorated.\n");
write("The fabric of space will be intentionally distorted.\n");
throw("Gnomes of Genesis are being redecorated.\n");

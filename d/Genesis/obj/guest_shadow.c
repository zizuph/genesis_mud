...
{
    tell_object(QSW, "\nAs guest of Genesis you should not get involved in " +
	"hostilities. If you like this game, you can create your own " +
	"character to explore the world with.\n\n");
    tell_object(victim, "\nThe guest of Genesis is not allowed to get " +

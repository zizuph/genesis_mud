...
/*
 * /d/Genesis/cmd/soul.c
 *
 * This module contains the Genesis specific emotions. Currently two sets
 ...
 * the Genesis character creation procedure. October 6 1996.
 */

...
create_room()
{
    ...
    set_long("You find yourself in a large hall, quite mundane compared " +
      ...
      "then <improve> them. Defence, knife and sword skills are " +
...
set_up_skills()
{
    ...
    me = "use an axe"; ot = me;
    sk_add_train(SS_WEP_AXE,    ({ me, ot }), 0, 0, 10 );
    me = "defend yourself"; ot = me;
    sk_add_train(SS_DEFENCE, ({ me, ot }), 0, 0, 10);
    me = "use a knife"; ot = me;
    sk_add_train(SS_WEP_KNIFE,  ({ me, ot }), 0, 0, 10 );
    me = "use a club"; ot = me;
    sk_add_train(SS_WEP_CLUB, ({ me, ot }), 0, 0, 10);
    me = "use a sword"; ot = me;
    sk_add_train(SS_WEP_SWORD, ({ me, ot }), 0, 0, 10);
    me = "use a polearm"; ot = me;
    sk_add_train(SS_WEP_POLEARM, ({ me, ot }), 0, 0, 10);
    me = "become more aware of the surroundings"; ot = me;
    sk_add_train(SS_AWARENESS, ({ me, ot }), 0, 0, 10);
    me = "perform magic and spells"; ot = me;
    sk_add_train(SS_SPELLCRAFT, ({ me, ot }), 0, 0, 10);
    me = "make better trades and deals"; ot = me;
    sk_add_train(SS_TRADING, ({ me, ot }), 0, 0, 10);
    me = "handle animals"; ot = me;
    sk_add_train(SS_ANI_HANDL, ({ me, ot }), 0, 0, 10);
    me = "understand various languages"; ot = me;
    sk_add_train(SS_LANGUAGE, ({ me, ot }), 0, 0, 10);
    me = "climbing"; ot = me;
    sk_add_train(SS_CLIMB, ({ me, ot }), 0, 0, 10);
    me = "appraising different objects"; ot = me;
    sk_add_train(SS_APPR_OBJ, ({ me, ot }), 0, 0, 10);
    me = "appraising monsters"; ot = me;
    sk_add_train(SS_APPR_MON, ({ me, ot }), 0, 0, 10);
    me = "appraising values"; ot = me;
    sk_add_train(SS_APPR_VAL, ({ me, ot }), 0, 0, 10);
    me = "finding tracks"; ot = me;
    sk_add_train(SS_TRACKING, ({ me, ot }), 0, 0, 10);
    me = "hunt wild game"; ot = me;
    sk_add_train(SS_HUNTING,    ({ me, ot }), 0, 0, 10 );
    me = "swim"; ot = me;
    sk_add_train(SS_SWIM, ({me, ot}), 0, 0, 10); 
    me = "ride a horse"; ot = me;
    sk_add_train(SS_RIDING, ({me, ot}), 0, 0, 10); 
    me = "fight without weapons"; ot = me;
    sk_add_train(SS_UNARM_COMBAT, ({me, ot}), 0, 0, 10); 
    me = "fight in the dark"; ot = me;
    sk_add_train(SS_BLIND_COMBAT, ({me, ot}), 0, 0, 10); 
    me = "search for herbs"; ot = me;
    sk_add_train(SS_HERBALISM, ({me, ot}), 0, 0, 10); 
    me = "mix magic potions"; ot = me;
    sk_add_train(SS_ALCHEMY, ({me, ot}), 0, 0, 10); 
    me = "open locks"; ot = me;
    sk_add_train(SS_OPEN_LOCK, ({me, ot}), 0, 0, 10); 
    me = "pick a pocket"; ot = me;
    sk_add_train(SS_PICK_POCKET, ({me, ot}), 0, 0, 10); 
    me = "be acrobatic"; ot = me;
    sk_add_train(SS_ACROBAT, ({me, ot}), 0, 0, 10); 
    me = "find and remove traps"; ot = me;
    sk_add_train(SS_FR_TRAP, ({me, ot}), 0, 0, 10); 
    me = "be stealthy"; ot = me;
    sk_add_train(SS_SNEAK, ({me, ot}), 0, 0, 10); 
    me = "hide inside rooms"; ot = me;
    sk_add_train(SS_HIDE, ({me, ot}), 0, 0, 10); 
    me = "sense of location"; ot = me;
    sk_add_train(SS_LOC_SENSE, ({me, ot}), 0, 0, 10); 
}

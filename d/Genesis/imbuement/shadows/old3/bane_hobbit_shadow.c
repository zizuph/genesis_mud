/*
 *  /d/Genesis/imbuement/shadows/bane_hobbit_shadow.c
 *
 ...
 *
 *  This particular effect gives a special attack when used against halflings.
 *
...
stat_object()
{
    ...
    str += "This weapon has been given a random magic mod that does"
         ...
         + " amount) roughly 10% of the time to hobbits.\n";
    return str;
} /* stat_object */
...
{   
    ...
    set_add_item_array(   ({ "glow",
                             ...
                             "formations",
                             "unusual formation",
                             "unusual quartz formation",
                             "unusual quartz formations",
                             "unusual formations" }) );
    set_add_item_desc(
        "The " + shadow_who->short() + " is covered with unusual quartz"
...
long(string str, object for_obj)
{
    ...
    return shadow_who->long(str, for_obj)
      + "Quartz formations along its surface emit "
...
dispel_msg_hook()
{
    return "The quartz formations along the surface of the "

/*
 *  /d/Genesis/imbuement/shadows/bane_goblin_shadow.c
 *
 ...
 *
 *  This particular effect gives a special attack when used against goblins.
 *
...
stat_object()
{
    ...
    str += "This weapon has been given a random magic mod that does"
         ...
         + " amount) roughly 10% of the time to goblins.\n";
    return str;
} /* stat_object */
...
query_races()
{
    return ({ "goblin", "hobgoblin", "orc", "uruk", "uruk-hai" });
} /* query_races */
...
{   
    ...
    set_add_item_array(   ({ "glow",
                             ...
                             "formations",
                             "unusual formation",
                             "unusual onyx formation",
                             "unusual onyx formations",
                             "unusual formations" }) );
    set_add_item_desc(
        "The " + shadow_who->short() + " is covered with unusual onyx"
...
long(string str, object for_obj)
{
    ...
    return shadow_who->long(str, for_obj)
      + "Onyx formations along its surface emit "
...
dispel_msg_hook()
{
    return "The onyx formations along the surface of the "

/*
 *  /d/Genesis/imbuement/shadows/bane_dwarf_shadow.c
 *
 ...
 *
 *  This particular effect gives a special attack when used against dwarves.
 *
...
stat_object()
{
    ...
    str += "This weapon has been given a random magic mod that does"
         ...
         + " amount) roughly 10% of the time to dwarves.\n";
    return str;
} /* stat_object */
...
query_races()
{
    return ({ "dwarf", "gully-dwarf", "gully dwarf" });
} /* query_races */
...
{   
    ...
    set_add_item_array(   ({ "glow",
                             ...
                             "formations",
                             "unusual formation",
                             "unusual mithril formation",
                             "unusual mithril formations",
                             "unusual formations" }) );
    set_add_item_desc(
        "The " + shadow_who->short() + " is covered with unusual mithril"
...
long(string str, object for_obj)
{
    ...
    return shadow_who->long(str, for_obj)
      + "Mithril formations along its surface emit "
...
dispel_msg_hook()
{
    return "The mithril formations along the surface of the "

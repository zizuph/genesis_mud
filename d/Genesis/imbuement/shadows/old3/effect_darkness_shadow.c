...
//        ", " + POWER_DESC[Power_Level] + " black mist is produced from it!\n");
...
dispel_msg_hook()
{
    return "The aura of darkness surrounding " + POWER_DESC[Power_Level]
...
long(string str, object for_obj)
{
    ...
    return shadow_who->long(str, for_obj)
      + CA_POWER_DESC[Power_Level] + " aura of darkness surrounds this"
      + " object.\n";
} /* long */

/*
 *  /d/Genesis/imbuement/shadows/bane_minotaur_shadow.c
 *
 ...
 *
 *  This particular effect gives a special attack when used against minotaurs.
 *
...
stat_object()
{
    ...
    str += "This weapon has been given a random magic mod that does"
         ...
         + " amount) roughly 10% of the time to minotaurs.\n";
    return str;
} /* stat_object */
...
{   
    ...
    set_add_item_array(   ({ "glow",
                             ...
                             "formations",
                             "unusual formation",
                             "unusual ivory formation",
                             "unusual ivory formations",
                             "unusual formations" }) );
    set_add_item_desc(
        "The " + shadow_who->short() + " is covered with unusual ivory"
...
long(string str, object for_obj)
{
    ...
    return shadow_who->long(str, for_obj)
      + "Ivory formations along its surface emit "
...
dispel_msg_hook()
{
    return "The ivory formations along the surface of the "

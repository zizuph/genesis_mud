/*
 *  /d/Genesis/imbuement/shadows/bane_troll_shadow.c
 *
 ...
 *
 *  This particular effect gives a special attack when used against trolls.
 *
...
stat_object()
{
    ...
    str += "This weapon has been given a random magic mod that does"
         ...
         + " amount) roughly 10% of the time to trolls.\n";
    return str;
} /* stat_object */
...
{   
    ...
    set_damage_msgs( ({ "A flash of power erupts from the topaz formations"
                      + " on",
    ...
    set_add_item_array(   ({ "glow",
                             ...
                             "formations",
                             "unusual formation",
                             "unusual topaz formation",
                             "unusual topaz formations",
                             "unusual formations" }) );
    set_add_item_desc(
        "The " + shadow_who->short() + " is covered with unusual topaz"
...
long(string str, object for_obj)
{
    ...
    return shadow_who->long(str, for_obj)
      + "Topaz formations along its surface emit "
...
dispel_msg_hook()
{
    return "The topaz formations along the surface of the "

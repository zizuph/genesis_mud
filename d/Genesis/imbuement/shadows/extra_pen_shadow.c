...
{   
    ...
    set_add_item_desc("There is feeling coming from this item. It is"
 ...
 * Description  :        Mask the query_pen of the base item
 * Returns      :        int - Pen of base item plus our extra
 */
public int
query_pen()
{
...
stat_object()
{
    ...
    str += "This item has been given a random magic mod that gives a "
         ...
         + ") extra \"pen\" to the item. Modified pen="
         + this_object()->query_pen() + ".\n";
    return str;
} /* stat_object */
...
{
    return "It exudes " + A_POWER_DESC[Power_Level] + " aura of malevolence.";
}

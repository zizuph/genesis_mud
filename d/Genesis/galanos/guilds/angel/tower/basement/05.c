// file name: /d/Genesis/hannah/galanos/guilds/angel/tower/basement/05.c
...
create_room()
{
    ...
    add_exit(BA_DIR + "12", "north", 0);
    add_exit(BA_DIR + "04", "southeast", 0);
    add_exit(BA_DIR + "06", "southwest", 0);

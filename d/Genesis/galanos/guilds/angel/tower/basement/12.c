// file name:  /d/Genesis/hannah/galanos/guilds/angel/tower/basement/12.c // creator(s):       Hannah, 10/99
// revisions:
// purpose:
// note:           
// bug(s):
...
create_room()
{
    ...
    add_exit(BA_DIR + "05", "south", 0);
    add_exit(BA_DIR + "13", "southeast", 0);
    add_exit(BA_DIR + "76", "southwest", 0);

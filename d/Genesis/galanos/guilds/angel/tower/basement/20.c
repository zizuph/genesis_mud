// file name:  /d/Genesis/hannah/galanos/guilds/angel/tower/basement/20.c // creator(s):       Hannah, 10/99
// revisions:
// purpose:
// note:           
// bug(s):
...
create_room()
{
    ...
    add_exit(BA_DIR + "27", "west", 0);
    add_exit(BA_DIR + "19", "northwest", 0);
    add_exit(BA_DIR + "21", "southwest", 0);

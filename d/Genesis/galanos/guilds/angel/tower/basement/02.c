// file name:  /d/Genesis/hannah/galanos/guilds/angel/tower/basement/02.c
...
create_room()
{
    ...
    add_exit(BA_DIR + "03", "north", 0);
    add_exit(BA_DIR + "09", "west", 0);
    add_exit(BA_DIR + "10", "northwest", 0);
    add_exit(BA_DIR + "01", "southeast", 0);

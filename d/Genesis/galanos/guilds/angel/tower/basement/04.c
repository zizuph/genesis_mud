// file name:  /d/Genesis/hannah/galanos/guilds/angel/tower/basement/04.c
...
create_room()
{
    ...
    add_exit(BA_DIR + "03", "south", 0);
    add_exit(BA_DIR + "11", "west", 0);
    add_exit(BA_DIR + "05", "northwest", 0);
    add_exit(BA_DIR + "10", "southwest", 0);

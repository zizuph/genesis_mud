// file name:  /d/Genesis/hannah/galanos/guilds/angel/tower/basement/17.c // creator(s):       Hannah, 10/99
// revisions:
// purpose:
// note:           
// bug(s):
...
create_room()
{
    ...
    add_exit(BA_DIR + "31", "south", 0);
    add_exit(BA_DIR + "18", "east", 0);
    add_exit(BA_DIR + "16", "west", 0);

// file name: /d/Genesis/hannah/galanos/guilds/angel/tower/basement/06.c
...
create_room()
{
    ...
    add_exit(BA_DIR + "11", "east", 0);
    add_exit(BA_DIR + "07", "south", 0);
    add_exit(BA_DIR + "05", "northeast", 0);
    add_exit(BA_DIR + "10", "southeast", 0);

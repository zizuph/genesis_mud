// file name:  /d/Genesis/hannah/galanos/guilds/angel/tower/basement/01.c
...
create_room()
{
    ...
    add_exit(BA_DIR + "00", "south", 0);
    add_exit(BA_DIR + "02", "northeast", 0);
    add_exit(BA_DIR + "08", "northwest", 0);

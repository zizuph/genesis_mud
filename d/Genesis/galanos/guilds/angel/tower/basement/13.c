// file name:  /d/Genesis/hannah/galanos/guilds/angel/tower/basement/13.c // creator(s):       Hannah, 10/99
// revisions:
// purpose:
// note:           
// bug(s):
...
create_room()
{
    ...
    add_exit(BA_DIR + "12", "northwest", 0);
    add_exit(BA_DIR + "14", "southeast", 0);

...
public void
hook_actor_revealed(object actor)
{
    actor->catch_msg("You are no longer hidden.\n");
}
...
public void
hook_no_resource_fail(object ability)
{
    write("You don't have enough mana.\n");
}
...
public void
hook_no_attack_self(object actor)
{
    actor->catch_msg("You decide against harming yourself.\n");
}
 ...
 * regeneration spells under the Genesis Magic system created in 2009.
 * 
 * Regeneration spells are more powerful when out of combat and relaxed. When in
 * combat or not relaxed, their effectiveness will go down. For the exact calculation
 * and adjustments made, please look at the regeneration_obj.c.
 *
...
config_regeneration_spell()
{
    ...
    // Spell effect object
    set_spell_object(SPELL_OBJ_DIR + "regeneration_obj");
}

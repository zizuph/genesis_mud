...
{
    // Spell effect object
    set_spell_object(SPELL_OBJ_DIR + "featherweight_obj");
...
config_spell()
{
    ...
    // 140 weight conservatively equates to 5 caid.
    // Any set_weight_factor above 140 needs to be calculated by
    // the AoB team and factored in for sustained mana maintenance.
    set_spell_maintained_combat_aid(5.0);

...
setup_spell_effect()
{
    ...
    reflect = clone_object(REFLECT_OBJ_BASE);
    ...
    reflect->set_reflect_stats(query_spell_stats()); // wis and int
    ...
    reflect->set_effect_caster(query_effect_caster());
    reflect->set_effect_target(query_effect_target());

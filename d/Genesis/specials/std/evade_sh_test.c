...
query_not_attack_me(object attacker, int att_id)
{
    ...
    send_debug_message("evade_sh_stack", capitalize(shadow_who->query_real_name())
    + " percentage: " + percentage + ", combat_aid: " + query_effect_combat_aid()
    + " effects: " + variable2string(m_values(valid_evades)));

...
setup_spell_effect()
{
    ...
    evade_object = clone_object("/d/Genesis/specials/std/evade_obj_base");
    ...
    evade_object->set_evade_stats( ({ SKILL_AVG, TS_INT, TS_WIS, TS_DIS, SKILL_END }) ); // wisdom and intelligence 

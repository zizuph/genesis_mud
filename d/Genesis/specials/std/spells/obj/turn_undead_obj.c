...
#define FEAR_SHADOW "/d/Genesis/specials/std/spells/obj/turn_undead_shadow"
#define FEARED_SHADOW "/d/Genesis/specials/std/spells/obj/turn_undead_caster_shadow"
#define I_HAVE_BEEN_UNDEAD_TURNED "_i_have_been_undead_turned"

void 
create_spell_object()
{
    set_name("_turn_undead_ob_");
...
hook_spell_effect_started()
{
    ...
    shadow->set_turn_undead_ob(this_object());
    shadow->set_guild_type(TS_OCC);
    ...
    target->add_prop(I_HAVE_BEEN_UNDEAD_TURNED, time());    
}

...
// Global Variables
public string   m_sTriggeredSpell = "/d/Genesis/specials/std/spells/stoneskin"; // set stoneskin as a sample.
...
config_delayedtrigger_spell()
{
    ...
    set_shadow_filename(STD_SPELL_OBJ_DIR + "delayedtrigger_sh");    
}

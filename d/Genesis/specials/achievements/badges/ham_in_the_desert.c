/* 
 * Christmas Event 2013 Badge - Ham In The Desert
 *
...
create_badge()
{
    set_badge_name("Ham In The Desert");
    set_badge_description("Who knew that Hams and Chips can survive in the desert of Cirath? You "
                          + "did, of course! Keep it up and "
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect something in the Cirath domain! For that, you \n"
...
does_event_apply(object player, string event_name, mixed data)
{
    ...
    if (wildmatch("/d/Cirath/*", room_file))
    {
        return 1;
    }

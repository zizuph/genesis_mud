/* 
 * Christmas Event 2013 Badge - Celtic Ham Is Yummy
 *
...
create_badge()
{
    set_badge_name("Celtic Ham Is Yummy");
    set_badge_description("Khalakhor is the land of the Celtics. And boy, do they know "
                          + "how to eat their ham. You've found something useful there "
                          + "to take back the ham and chips from the theives. Keep it up and "
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect something in the Khalakhor domain! For that, you \n"
...
does_event_apply(object player, string event_name, mixed data)
{
    ...
    if (wildmatch("/d/Khalakhor/*", room_file))
    {
        return 1;
    }

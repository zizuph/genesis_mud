/* 
 * Christmas Event 2013 Badge - Are Those Maple Chips?
 *
 * This is a badge for the Christmas Event 2013. You get this for
 * collecting at least one Maple Chips
 *
...
create_badge()
{
    set_badge_name("Are Those Maple Chips?");
    set_badge_description("Score one for Maple Chips! You've managed to find your "
                          + "very own Maple Chips to smoke a Berkshire Ham with.\n");
...
{
    if (data["object_id"] != "_event_data_maple_chips")
    {
        return 0;
    }
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect some Maple Chips! For that, you have earned the "

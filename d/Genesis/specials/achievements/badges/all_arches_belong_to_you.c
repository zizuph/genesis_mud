/* 
 * Christmas Event 2013 Badge - All Arches Belong To You
 *
 * This is a badge for the Christmas Event 2013. You get this for
 * collecting all five of the Arch Pigs.
 *
...
create_badge()
{
    set_badge_name("All Arches Belong To You");
    set_badge_description("Now you've gone and done it. You have a full collection "
                          + "of Arch Pigs for your very own enjoyment. You may "
                          + "live to regret this day... or not.\n");
...
{
    if (data["object_id"] != "_event_data_arch_ham")
    {
        return 0;
    }
...
{
    string * arch_collection = CONTROLROOM->get_arch_collection(this_player()->query_real_name());
    if (sizeof(arch_collection) >= 5)
    {
        return 1;
    }
    return 0;
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect all the Arch Pigs! For that, you have earned the \n"

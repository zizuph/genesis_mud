/* 
 * Christmas Event 2013 Badge - You Got An Arch Pig
 *
 * This is a badge for the Christmas Event 2013. You get this for
 * collecting at least one arch pig.
 *
...
create_badge()
{
    set_badge_name("You Got An Arch Pig");
    set_badge_description("For collecting one of the Arch Pigs, you earn this "
...
{
    int num_arches = m_sizeof(badge_row["badge_history"]);
    if (num_arches > 0)
    {
        return 1;
    }
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect an Arch Pig! For that, you have earned the "

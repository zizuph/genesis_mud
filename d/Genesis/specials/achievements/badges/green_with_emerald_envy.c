/* 
 * Christmas Event 2013 Badge - Green With Emerald Envy
 *
...
create_badge()
{
    set_badge_name("Green With Emerald Envy!");
    set_badge_description("You know others are envious of your success in Emerald! You've "
                          + "managed find some Christmas ham and chips here. Keep it up and "
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect something in the Emerald domain! For that, you \n"
...
does_event_apply(object player, string event_name, mixed data)
{
    ...
    if (wildmatch("/d/Emerald/*", room_file))
    {
        return 1;
    }

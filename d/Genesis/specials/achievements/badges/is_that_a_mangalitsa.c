/* 
 * Christmas Event 2013 Badge - Is That a Mangalitsa
 *
 * This is a badge for the Christmas Event 2013. You get this for
 * collecting at least one Mangalitsa Pig
 *
...
create_badge()
{
    set_badge_name("Is That A Mangalitsa?");
    set_badge_description("Score one for the Mangalitsa! You've managed to find your "
                          + "very own Mangalitsa Ham.\n");
...
{
    if (data["object_id"] != "_event_data_mangalitsa_ham")
    {
        return 0;
    }
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect a Mangalitsa Ham! For that, you have earned the "

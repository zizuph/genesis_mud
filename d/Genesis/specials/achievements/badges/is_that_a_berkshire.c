/* 
 * Christmas Event 2013 Badge - Is That a Berkshire
 *
...
create_badge()
{
    set_badge_name("Is That A Berkshire?");
    set_badge_description("Score one for the Berkshire! You've managed to find your "
                          + "very own Berkshire Ham.\n");
...
{
    if (data["object_id"] != "_event_data_berkshire_ham")
    {
        return 0;
    }
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect a Berkshire Ham! For that, you have earned the "

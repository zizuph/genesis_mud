/* 
 * Christmas Event 2013 Badge - I Know How To Collect
 *
 * This is a badge for the Christmas Event 2013. You get this for
 * collecting and reaching 50 points
 *
...
create_badge()
{
    set_badge_name("I Know How To Collect");
    set_badge_description("You're starting to figure out how to collect for the Christmas "
                          + "2013 event! You've been able to collect 50 points so far. Keep "
                          + "it up and you may even be able to brag to others about your "
                          + "mad skills!\n");
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect enough to show that you know what you're doing! For that,\n"
                       + "you have earned the " + query_badge_name() + " Badge!\n");
    player->catch_tell("-----------------------------------------------------------------------------------\n");
}

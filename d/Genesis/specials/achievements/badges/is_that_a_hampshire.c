/* 
 * Christmas Event 2013 Badge - Is That a Hampshire
 *
...
create_badge()
{
    set_badge_name("Is That A Hampshire?");
    set_badge_description("Score one for the Hampshire! You've managed to find your "
                          + "very own Hampshire Ham.\n");
...
{
    if (data["object_id"] != "_event_data_hampshire_ham")
    {
        return 0;
    }
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect a Hampshire Ham! For that, you have earned the "

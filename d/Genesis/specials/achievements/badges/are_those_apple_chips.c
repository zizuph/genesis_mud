/* 
 * Christmas Event 2013 Badge - Are Those Apple Chips?
 *
...
create_badge()
{
    set_badge_name("Are Those Apple Chips?");
    set_badge_description("Score one for Apple Chips! You've managed to find your "
                          + "very own Apple Chips to smoke a Hampshire Ham with.\n");
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect some Apple Chips! For that, you have earned the "

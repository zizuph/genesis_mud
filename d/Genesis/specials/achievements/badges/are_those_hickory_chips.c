/* 
 * Christmas Event 2013 Badge - Are Those Hickory Chips?
 *
 * This is a badge for the Christmas Event 2013. You get this for
 * collecting at least one Hickory Chips
 *
...
create_badge()
{
    set_badge_name("Are Those Hickory Chips?");
    set_badge_description("Score one for Hickory Chips! You've managed to find your "
                          + "very own Hickory Chips to smoke a Mangalitsa Ham with.\n");
...
{
    if (data["object_id"] != "_event_data_hickory_chips")
    {
        return 0;
    }
...
hook_notify_player_earned_badge(object player)
{
    ...
    player->catch_tell("You've managed to collect some Hickory Chips! For that, you have earned the "

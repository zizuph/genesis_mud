  ...
  /* Generate a string based on the 'count' var. */
    switch(count)
    {
      ...
      /* Here's the man! Lars to the rescue! */
        ...
        case 13:
            /*
             * So this is the old sequence. While we're testing the way
             * things feel without a death penalty, we'll have a
             * different sequence here. (Gorboth)
            str = "Death says: REINCARNATION? FOR THIS ONE? HE IS NOT " +
                "WORTHY OF IT AND YOU KNOW IT! BE SENSIBLE, LARS!\n\n";
             */
            str = "Death says: YES I KNOW I LOST THAT CARD GAME, WHAT OF"
                + " IT?! YOU DON'T EXPECT ME TO HONOR THAT RIDICULOUS"
                + " AGREEMENT ABOUT REINCARNATION WITHOUT TAKING MY DUE,"
                + " SURELY? LARS, BE SENSIBLE!\n\n";
            break;
        case 14:
        ...
        case 15:
            str = "Death says: OH ALL RIGHT THEN! I CAN WAIT. ONE DAY " +
                ...
                "other walls and a couple fairly surprised horses " +

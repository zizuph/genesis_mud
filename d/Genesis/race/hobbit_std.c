 ...
 * Description  : Returns the "true" race for this player. 
 * Returns      : string "hobbit" - always.
 */
nomask string
query_race()          
{ 
	   ...
	   int phit, int dam)
{
    ...
    if (dam <= 0)
        return 1;
    this_object()->catch_msg(QCTNAME(enemy) + " recoils in pain as fortune " +
       "smiles upon you, causing your attack to be more powerful than " +
       "expected. How lucky!\n");

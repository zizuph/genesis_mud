/*
 * Written by Nuf.
 * /d/Genesis/nuf/startloc/dm/L0_tunnel17x12.c
 */
...
create_mountain_room()
{
    ...
    set_long("The walls here are still smooth. The light shed "+
             ...
             "to the west and to the east it opens up in a "+
             "shaft.\n" );
    ...
    /* Exits */
    add_exit( MOUNTAIN + "L0_shaft18x12.c", "east" );
    add_exit( MOUNTAIN + "L0_tunnel16x12.c", "west" );

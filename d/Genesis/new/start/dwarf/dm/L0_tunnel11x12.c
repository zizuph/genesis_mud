/*
 * Written by Nuf.
 * /d/Genesis/nuf/startloc/dm/L0_tunnel11x12.c
 */
...
{
    set_short("Tunnel in the depths of the mountain");
    set_long("The walls here are still smooth. The light shed "+
             ...
             "the it from the ceiling. The tunnel continues to "+
             "the east and narrows to the northwest and "+
             "southwest.\n" );
    ...
    /* Exits */
    add_exit( MOUNTAIN + "L0_west10x11.c", "northwest" );
    add_exit( MOUNTAIN + "L0_tunnel12x12.c", "east" );
    add_exit( MOUNTAIN + "L0_west10x13.c", "southwest" );

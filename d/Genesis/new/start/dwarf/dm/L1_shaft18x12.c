/*
 * Written by Nuf.
 * /d/Genesis/nuf/startloc/dm/L1_shaft18x12.c
 */
...
create_mountain_room()
{
    ...
    set_long("The walls here are a little bit worn down. "+
             ...
             "rugged. The shaft narrows into a tunnel to the north "+
	     "and continues down.\n" );
    ...
    /* Exits */
    add_exit( MOUNTAIN + "L1_tunnel18x11.c", "north");
    add_exit( MOUNTAIN + "L0_shaft18x12.c", "down", 0, 1, -1);

/*
 * Written by Nuf.
 * /d/Genesis/nuf/startloc/dm/L1_tunnel18x11.c
 */
...
create_mountain_room()
{
    ...
    /* Exits */
    add_exit( MOUNTAIN + "L1_west19x10.c", "northeast");
    add_exit( MOUNTAIN + "L1_tunnel20x11.c", "east");
    add_exit( MOUNTAIN + "L1_shaft18x12.c", "south");

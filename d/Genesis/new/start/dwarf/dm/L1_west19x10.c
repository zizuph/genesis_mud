/*
 * Written by Nuf.
 * /d/Genesis/nuf/startloc/dm/L1_tunnel19x10.c
 */
...
create_mountain_room()
{
    ...
    /* Exits */
    add_exit( MOUNTAIN + "L1_north19x09.c", "north");
    add_exit( MOUNTAIN + "L1_east20x10.c", "east");
    add_exit( MOUNTAIN + "L1_tunnel18x11.c", "southwest");

/*
 * Written by Nuf.
 * /d/Genesis/nuf/startloc/dm/L1_north19x09.c
 */
...
{
    set_short("Room in the depth of the mountain");
    ...
    /* Exits */
    add_exit( MOUNTAIN + "L1_north20x08.c", "northeast");
    add_exit( MOUNTAIN + "L1_east20x09.c", "east");
    add_exit( MOUNTAIN + "L1_west19x10.c", "south");
    add_exit( MOUNTAIN + "L1_north15x10.c", "west", 

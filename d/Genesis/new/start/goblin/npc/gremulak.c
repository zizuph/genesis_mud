/*
 * File         : /d/Genesis/new/start/goblin/npc/gremulak.c
 * Creator      : Nite@Genesis
 * Copyright    : John Griffin
 * Date         : October 6, 1999
 * Modifications: 
 * Purpose      : Gremulak - The Trainer
 * Related Files: 
 * Comments     : 
 * TODO         : 
 */
...
create_monster()
{
    ...
    set_adj("broad muscular");
    set_title("Chief Trainer and Esteemed Servant of Xi Tpa");
    set_gender(G_MALE);

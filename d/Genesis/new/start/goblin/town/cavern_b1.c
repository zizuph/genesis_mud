/*
 * File         : /d/Genesis/new/start/goblin/town/cavern_b1.c
...
create_room()
{
    ...
    "the Training Hall, which lies to the north, down to the " +
    "museum, which is southeast of here. A small footbridge " +
    "traverses the channel, approaching the Central Plaza to the " +
    "northeast.\n");
    ...
    "bridge offers you access to a small courtyard just off the " +
    ...
    add_exit("cavern_a1", "south");
    add_exit("cavern_a2", "southeast");
    add_exit("cavern_c2", "northeast");
}
...
cross_bridge()
{
   ...
   tell_room("/d/Genesis/new/start/goblin/town/cavern_c2",
   QCNAME(this_player()) + " arrives crossing over the footbridge.\n",
   this_player());

   this_player()->move_living("M", "/d/Genesis/new/start/goblin/town/cavern_c2", 0, 0);

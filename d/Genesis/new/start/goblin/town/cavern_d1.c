/*
 * File         : /d/Genesis/new/start/goblin/town/cavern_d1.c
...
create_room()
{
    ...
    "from beneath the west side of the Temple is a rather large water " +
    ...
    "guiding the water down beneath the Training Hall where it " +
    "disappears again.\n");
    ...
    add_exit("cavern_e2", "north");
    add_exit("cavern_d2", "east");
    add_exit("cavern_c2", "southeast");
}

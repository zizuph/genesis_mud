/*
 * File         : /d/Genesis/new/start/goblin/town/cavern_d2.c
...
create_room()
{
    ...
    "falls is quite loud here. The Bathing Pool is to the east, " +
    "the Central Plaza to the southeast.\n");
    ...
    add_exit("temple1", "north");
    add_exit("cavern_d3", "east");
    add_exit("cavern_c3", "southeast");
    add_exit("cavern_c2", "south");
    add_exit("cavern_d1", "west");
}

/*
 * File         : /d/Genesis/new/start/goblin/town/sleeping_tunnel5.c
...
create_room()
{
    ...
    "here lead up to the south and down to the north.\n");
    ...
    add_exit("sleeping_tunnel6", "north");
    add_exit("sleeping_tunnel4", "south");
}

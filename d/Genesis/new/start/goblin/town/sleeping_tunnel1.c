/*
 * File         : /d/Genesis/new/start/goblin/town/sleeping_tunnel1.c
...
create_room()
{
    ...
    "The walls here are dimly lit by a soft, green glow. You can see " +
    "flickering light to the north. The stairs lead down to the southwest.\n");
    ...
    "The flickering light appears to be coming from a chamber at " +
    "the top of the stairs.\n");

    add_item(({"chamber"}),
    "You cannot see much of the chamber from here.\n");
    ...
    add_exit("sleeping_cell", "north");
    add_exit("sleeping_tunnel2", "southwest");
}

/*
 * File         : /d/Genesis/new/start/goblin/town/cavern_e2.c
...
create_room()
{
    set_short("You are on a small footbridge");

    set_long("You are on a small footbridge.\n" +
    ...
    "from beneath the west side of the Temple, the water channel " +
    "runs directly beneath you and curves south where it disappears " +
    "under the Training Hall. To the north, this bridge merges onto a " +
    "path that curves around behind the Temple.\n");
    ...
    add_exit("cavern_e3", "northeast");
    add_exit("cavern_d1", "south");
}

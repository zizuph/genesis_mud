/*
 * File         : /d/Genesis/new/start/goblin/town/river_tunnel1.c
...
create_room()
{
   ...
   "The walls here are dimly lit by a soft, green glow. Below you, " +
   "a river rushes past, heading south.\n");
   ...
   add_exit("cavern_a5", "north");

   add_exit("river_tunnel2", "south");
}

/*
 * File         : /d/Genesis/new/start/goblin/town/sleeping_tunnel2.c
...
create_room()
{
    ...
    "here lead up to the northeast and down to the southwest.\n");
    ...
    add_exit("sleeping_tunnel1", "northeast");
    add_exit("sleeping_tunnel3", "southwest");
}

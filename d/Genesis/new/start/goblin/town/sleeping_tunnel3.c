/*
 * File         : /d/Genesis/new/start/goblin/town/sleeping_tunnel3.c
...
create_room()
{
    ...
    "here lead up to the northeast and down to the west.\n");
    ...
    add_exit("sleeping_tunnel2", "northeast");
    add_exit("sleeping_tunnel4", "west");
}

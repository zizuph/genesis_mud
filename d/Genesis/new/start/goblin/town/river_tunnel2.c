/*
 * File         : /d/Genesis/new/start/goblin/town/river_tunnel2.c
...
create_room()
{
   ...
   "you, a river rushes past, bending away to the southeast.\n");
   ...
   add_exit("river_tunnel1", "north");

   add_exit("river_tunnel3", "southeast");
}

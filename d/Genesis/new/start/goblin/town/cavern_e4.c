/*
 * File         : /d/Genesis/new/start/goblin/town/cavern_e4.c
...
create_room()
{
    ...
    "from beneath the east side of the Temple, the water channel " +
    "runs directly beneath you and curves south where it disappears " +
    "under the Shop. To the north, this bridge merges onto a path that " +
    "curves around behind the Temple.\n");
    ...
    add_exit("cavern_e3", "northwest");
    add_exit("cavern_d5", "south");
}

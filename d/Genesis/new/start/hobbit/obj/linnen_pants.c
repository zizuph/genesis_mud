/*
 * File         : /d/Genesis/start/hobbit/obj/linnen_pants.c
 * Creator      : Seaweed
 ...
 * Related Files: 
 * Comments     :
 *        This is a common pair of linnen pants from the hobbit startloc.
 * 
 * TODO         :
...
create_object()
{
    ...
    set_long(
      "This is a pair of linnen pants.\n");
    ...
    set_looseness(0);
    set_pname("pants");
    set_short("pair of linnen pants");
    set_adj("linnen");
    set_slots(A_LEGS);

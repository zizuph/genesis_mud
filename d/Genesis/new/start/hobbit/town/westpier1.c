/*
 * File         : /d/Genesis/start/hobbit/town/westpier1.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    add_exit("woodenbridge4.c", "east");
    add_exit("portroad5.c", "north");
    add_exit("westpier2.c", "west");
...
reset_room()
{
    ...
    if (!objectp(Seagull) && (random(3) == 0))
    {
        ...
        Seagull->grid_set_pos(3, 4);   // Where are we in it?

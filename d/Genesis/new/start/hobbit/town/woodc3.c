/*
 * File         : /d/Genesis/start/hobbit/town/woodc3.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    add_exit("woodc4.c", "east");
    add_exit("woodb3.c", "north");
    add_exit("woodb4.c", "northeast");
    add_exit("woodpath4.c", "northwest");
    add_exit("woodpath5.c", "west");

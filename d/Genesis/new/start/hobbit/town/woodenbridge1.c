/*
 * File         : /d/Genesis/start/hobbit/town/woodenbridge1.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    set_long(
      ...
      "creek. The old oak planks show signs of skillful use of axes and " +
      "this bridge differs from the other by beeing a little wider and " +
      "reinforced with bands of iron. There are rings on the water " +
      "indicating the extistance of life below.\n");
    add_item(({ "bridge", "wooden bridge" }), 
      "The ironreinforced bridge is made wider to enable cargo " +
      "transports. \n");
    add_item("bridges", 
    ...
    add_item(({ "plank", "planks" }), 
      "The iron reinforced planks are marked by heavy traffic. \n");
    add_item("water", 
    ...
    add_exit("villageroad1.c", "east");
    add_exit("portroad1.c", "west");

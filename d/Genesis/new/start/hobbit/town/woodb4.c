/*
 * File         : /d/Genesis/start/hobbit/town/woodb4.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    add_exit("wooda4.c", "north");
    add_exit("wooda3.c", "northwest");
    add_exit("woodc4.c", "south");
    add_exit("woodc3.c", "southwest");
    add_exit("woodb3.c", "west");

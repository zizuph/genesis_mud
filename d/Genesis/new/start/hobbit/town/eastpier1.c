/*
 * File         : /d/Genesis/start/hobbit/town/eastpier1.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    add_exit("eastpier2.c", "east");
    add_exit("woodenbridge4.c", "west");
...
reset_room()
{
    ...
    if (!objectp(Seagull) && (random(3) == 0))
    {
        ...
        // Set up flying
        Seagull->grid_set_size(7, 4);  // How big is the grided area?
        Seagull->grid_set_pos(5, 4);   // Where are we in it?

/*
 * File         : /d/Genesis/start/hobbit/town/villageroad3.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    set_long(
      "A village dirt road runs around the village hall which connects " +
      "to here with a stone paved entrance west of here. East there " +
      "seems to be a meeting place of some sort and further south along " +
      "the street a local pub can be seen.\n");
    add_item("bell", 
    ...
    add_exit("advguild.c", "east");
    add_exit("villageroad2.c", "north");
    add_exit("villageroad4.c", "south");
    add_exit("villagehall.c", "west");

/*
 * File         : /d/Genesis/start/hobbit/town/eastpier4.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    add_exit("warehouse3.c", "east");
    add_exit("eastpier3.c", "north");
    add_exit("eastpier5.c", "south");
...
reset_room()
{
    ...
    if (!objectp(Seagull) && (random(3) == 0))
    {
        ...
        Seagull->grid_set_pos(7, 2);   // Where are we in it?

/*
 * File         : /d/Genesis/start/hobbit/town/woodb3.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    add_exit("woodb4.c", "east");
    add_exit("wooda3.c", "north");
    add_exit("wooda4.c", "northeast");
    add_exit("woodpath3.c", "northwest");
    add_exit("woodc3.c", "south");
    add_exit("woodc4.c", "southeast");
    add_exit("woodpath5.c", "southwest");
    add_exit("woodpath4.c", "west");

/*
 * File         : /d/Genesis/start/hobbit/town/livinghouse2.c
 * Creator      : Seaweed
 ...
 * Related Files: 
 * Comments     :
 *        A poor but clean home of a hobbit
 * 
 * TODO         :
 *        Add items of this house Make some eatable objects 
 *
 * Modifications:
...
create_room()
{
    ...
    add_exit("villageroad4.c", "northwest");

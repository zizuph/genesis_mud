/*
 * File         : /d/Genesis/start/hobbit/town/woodpath2.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    set_long(
      "The narrow path connects the dark wood to the south with the " +
      "mountains further north. The wood is full of scattered rocks " +
      "along both sides. The view south shows the open blue sea behind " +
      "a small pond and a small village. Uphill to the north the path " +
    ...
    add_item("sea", 
      "To the south you can see the mighty sea all the way to the " +
      "horizon. \n");
    add_item("small", 
    ...
    add_exit("woodpath1.c", "north");
    add_exit("woodpath3.c", "south");

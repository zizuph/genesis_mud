/*
 * File         : /d/Genesis/start/hobbit/town/eastpier5.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    set_long(
      ...
      "cargo and passangers to and from foreign lands. This is the end " +
      "of the pier but just east of here is a small warehouse.\n");
    add_item(({ "smell", "fish", "saltwater", "tar" }), 
      "The smell here is a mix of fish, saltwater and tar. \n");
    add_item("warehouse", 
      "It is quite small and seems abandomed. \n");
    
    add_prop(OBJ_S_WIZINFO, "Made by Seaweed 1/28/99.\n");
    
    add_exit("warehouse4.c", "east");
    add_exit("eastpier4.c", "north");
...
reset_room()
{
    ...
    if (!objectp(Seagull) && (random(3) == 0))
    {
        ...
        Seagull->grid_set_pos(7, 1);   // Where are we in it?

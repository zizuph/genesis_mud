/*
 * File         : /d/Genesis/start/hobbit/town/westpier3.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    set_long(
      ...
      "cargo and passangers to and from foreign lands. A warehouse can " +
      "be entered to the west.\n");
    
    add_prop(OBJ_S_WIZINFO, "Made by Seaweed 1/28/99.\n");
    
    add_exit("westpier2.c", "northeast");
    add_exit("westpier4.c", "south");
    add_exit("warehouse2.c", "west");
...
reset_room()
{
    ...
    if (!objectp(Seagull) && (random(3) == 0))
    {
        ...
        Seagull->grid_set_pos(1, 3);   // Where are we in it?

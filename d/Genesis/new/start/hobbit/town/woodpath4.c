/*
 * File         : /d/Genesis/start/hobbit/town/woodpath4.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    add_exit("woodb3.c", "east");
    add_exit("woodpath3.c", "north");
    add_exit("wooda3.c", "northeast");
    add_exit("wooda1.c", "northwest");
    add_exit("woodpath5.c", "south");
    add_exit("woodc3.c", "southeast");
    add_exit("woodc1.c", "southwest");
    add_exit("woodb1.c", "west");

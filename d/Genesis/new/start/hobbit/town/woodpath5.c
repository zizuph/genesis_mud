/*
 * File         : /d/Genesis/start/hobbit/town/woodpath5.c
 * Creator      : Seaweed
...
create_room()
{
    ...
    set_long(
      ...
      "without any vegetation. To the south there is a wooden portal " +
      "with an open gate. A large defence wall of sand continues on " +
      "both sides of the gate further south. A creek flows through a " +
      "sturdy iron grid just beside the gate.\n");
    
    add_prop(OBJ_S_WIZINFO, "Made by Seaweed 1/18/99.\n");
    
    add_exit("woodc3.c", "east");
    add_exit("woodpath4.c", "north");
    add_exit("woodb3.c", "northeast");
    add_exit("woodb1.c", "northwest");
    add_exit("gate.c", "south");
    add_exit("woodc1.c", "west");

/*
 * File         : /d/Genesis/start/hobbit/town/woodenbridge4.c
 * Creator      : Seaweed
 ...
 *        crossed by 3-4 wooden bridges. These were made by dwarf
 *        craftsmen just after the great victory against trolls and wolfs.
 *        Players can stand on the bridges and fish if they got the right
 *        equipment. (i.e. rod, line, hook, worm or bread etc)
 * 
 * TODO         :
...
create_room()
{
    ...
    add_exit("eastpier1.c", "east");
    add_exit("westpier1.c", "west");
    
    
    add_prop(HOBBIT_SL_S_SEAGULL_LP,({"on a stone in the middle of the creek", 
                                      "on the bridge"}));

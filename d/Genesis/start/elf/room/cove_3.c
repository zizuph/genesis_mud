...
#define SOUTH  ROOMDIR + "cove_2"
#define NORTH  ROOMDIR + "cove_4"
...
#define LONG \
  ...
  "An unpaved road goes south to another pier, and then to the dark forest " +\
  "further south. " +\
  "At the north end, it continues to yet another pier.\n" + \
...
#define SIGN_DESC \
  "The wooden sign has a painting of a flute and some letters on it.\n"
#define SIGN_READDESC \
  "The letters read 'Terel'.\n"
  
#define SHIP_ENTER_MSG \
  " enters the cove below you, mooring at the next closest pier.\n"

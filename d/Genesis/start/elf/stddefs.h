...
#define IS_NATIVE(P)    (member_array(P->query_race(), NATIVE_RACES) >= 0)
...
#define SHOREDIR    "/d/Genesis/start/elf/shore/"
#define CASTLEDIR   "/d/Genesis/start/elf/castle/"
...
#define MAINTAINER (lower_case(WIZARD_IN_CHARGE))
...
#define CENTER_SQUARE      "/d/Genesis/start/elf/map/center"
#define CENTER_X 186
#define CENTER_Y 554
...
#define CARAVAN_KEY_VALUE 34621

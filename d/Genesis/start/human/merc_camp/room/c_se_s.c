...
create_room()
{
    ...
    add_exit(MERC_CAMP_ROOM + "c_se.c", "north", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_se_e.c", "northeast", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_s.c", "west", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_s_s.c", "southwest", 0, 1, 0);

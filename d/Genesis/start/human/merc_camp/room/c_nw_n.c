...
create_room()
{
    ...
    add_exit(MERC_CAMP_ROOM + "c_nw.c", "south", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_nw_w.c", "southwest", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_n.c", "east", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_n_n.c", "northeast", 0, 1, 0);

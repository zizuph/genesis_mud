...
create_room()
{
    ...
    add_exit(MERC_CAMP_ROOM + "c_ne.c", "west", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_e_e.c", "southeast", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_e.c", "south", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_ne_n.c", "northwest", 0, 1, 0);
    reset_room();
}

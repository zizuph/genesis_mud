...
create_room()
{
    ...
    add_exit(MERC_CAMP_ROOM + "c_sw.c", "east", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_w_w.c", "northwest", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_w.c", "north", 0, 1, 0);
    add_exit(MERC_CAMP_ROOM + "c_sw_s.c", "southeast", 0, 1, 0);
    reset_room();
}

/* 	fish_rd_3.c			Styles.   29 Apr 2009
 *  This room is part of preparing the players for the
 *  new version of Sparkle area and its surroundings.
 */
...
create_room()
{
    ...
    add_exit(THIS_DIR + "fish_mon_1","northeast");
    add_exit(THIS_DIR + "fish_rd_2", "south");

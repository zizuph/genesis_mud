...
arm_me()
{
    ...
    sword = clone_unique(MIRKWOOD_OBJ_DIR + "wep/avoris.c", 7, ({WEP_DIR + "bansword", WEP_DIR + "bansword1", WEP_DIR + "bansword2", WEP_DIR + "bansword3", WEP_DIR + "bansword4", WEP_DIR + "bansword5", WEP_DIR + "bansword6"}));

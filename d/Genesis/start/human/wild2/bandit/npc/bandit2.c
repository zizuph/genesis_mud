...
{
    string *banname;
    banname = ({"adion", "arcian", "blude", "brost", "caltion", "cedrus",
        "clabo", "cole", "danus", "detrian", "dilgus", "druvas",
        "erlo", "fralus", "gert", "gluff", "griss", "hiram",
        "holtan", "jerge", "jogu", "kap", "kortus", "langer", 
        "lappus", "mardial", "maudin", "merat", "molke", "neddi",
        "novian", "pagra", "pedor", "purfan", "quett", "randfas", "rogga",
        "stolly", "tarman", "teliar", "urte", "walir", "wodrun"});

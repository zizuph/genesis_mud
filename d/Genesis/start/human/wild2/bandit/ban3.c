...

{
    ...
    set_long("You are in a dark, underground tunnel. Wooden posts and " +
        "beams line the tunnel, supporting the hard-packed dirt which " +
        "forms the ground, walls and ceiling. At the north end of the " +
        "tunnel, a simple wooden ladder climbs up to a square trapdoor " +
    ...
    add_item(({"chamber", "room", "large chamber"}),
        ...
        "corridor.\n");
    add_item(({"tunnel", "corridor", "here"}),
        "You are in a dark, underground tunnel. Wooden posts and " +
        "beams line the tunnel, supporting the hard-packed dirt which " +
        "forms the ground, walls and ceiling. At the north end of the " +
        "tunnel, a simple wooden ladder climbs up to a square trapdoor " +
        "in the ceiling, leading back to the surface. To the south, the " +

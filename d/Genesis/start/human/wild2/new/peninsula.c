...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "peninsula","southeast","@@hill@@",1,1);
    add_exit(THIS_DIR + "peninsula","east","@@hill@@",1,1);
    add_exit(THIS_DIR + "peninsula","northwest","@@sea@@",1,1);
    add_exit(THIS_DIR + "peninsula","northeast","@@hill@@",1,1);
    add_exit(THIS_DIR + "peninsula","north","@@sea@@",1,1);
    add_exit(THIS_DIR + "peninsula","southwest","@@sea@@",1,1);
    add_exit(THIS_DIR + "peninsula","south","@@sea@@",1,1);
...
init() {
	...
	//Alert Styles about the visitor.
...
hill()
{
    write("It is far too steep and dangerous to reach the shore in that " +

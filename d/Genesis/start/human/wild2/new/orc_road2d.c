...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "orc_road2d", "southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "orc_road2d", "northeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "orc_road2d", "south","@@forest@@",1,1);
    add_exit(THIS_DIR + "orc_road2d", "north","@@forest@@",1,1);
    add_exit(THIS_DIR + "orc_road2d", "southwest","@@forest@@",1,1);
    add_exit(THIS_DIR + "orc_road2d", "northwest","@@forest@@",1,1);

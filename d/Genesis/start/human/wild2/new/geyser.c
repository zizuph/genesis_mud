 ...
 *  Styles.   3 Mar 1993
 *
 *  Minor cleanup, Finwe April 2015
 *
...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "geyser","west","@@block@@",1,1);
    add_exit(THIS_DIR + "geyser", "northeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "geyser", "north","@@mount@@",1,1);
    add_exit(THIS_DIR + "geyser", "northwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "geyser", "southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "geyser", "south","@@mount@@",1,1);
    add_exit(THIS_DIR + "geyser", "southwest","@@mount@@",1,1);
...
block()
{
    if (this_player()->query_wiz_level()) return 1;
        ...
        write("A large avalanche has blocked any passage west into the " +

...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "lane","south", "@@mount@@", 1,1);
    add_exit(THIS_DIR + "lane", "southwest", "@@mount@@", 1,1);
    add_exit(THIS_DIR + "lane", "southeast", "@@hill@@", 1,1);
    add_exit(THIS_DIR + "lane", "east", "@@hill@@", 1,1);
    add_exit(THIS_DIR + "lane", "northwest", "@@hill@@", 1,1);
    add_exit(THIS_DIR + "lane", "northeast", "@@hill@@", 1,1);

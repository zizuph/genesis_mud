...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "orc_road4", "southeast","@@forest@@",1,1);
    add_exit(THIS_DIR + "forest1", "northeast",0,1,1);
    add_exit(THIS_DIR + "orc_road4", "south","@@forest@@",1,1);
    add_exit(THIS_DIR + "orc_road4", "southwest","@@forest@@",1,1);
    add_exit(THIS_DIR + "orc_road4", "northwest","@@forest@@",1,1);

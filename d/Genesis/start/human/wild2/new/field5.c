...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "field5", "east","@@riv@@",1,1);
    add_exit(THIS_DIR + "field1", "southeast",0,1,1);
    add_exit(THIS_DIR + "field5", "northwest","@@riv@@",1,1);
    add_exit(THIS_DIR + "field5", "north","@@riv@@",1,1);
    add_exit(THIS_DIR + "field5", "northeast","@@riv@@",1,1);

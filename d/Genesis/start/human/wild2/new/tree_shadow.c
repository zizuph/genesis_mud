...
/*
 * Function name: remove_tree_shadow
 * Description:   Removes the shadow for when someone is no longer in the tree
 */
public void
remove_tree_shadow()
{
...
/*
 * Function name: add_present_objects
 * Description:   Makes sure people in trees don't act like they are on
 *                the ground. 
 */
public void
add_present_objects()
...
/*
 * Function name: climb_down_tree
 * Description:   Describing climbing out of the tree
 */
public void
climb_down_tree()
{
...
/*
 * Function name: query_tree_shadow
 * Description:   Checking for tree shadow
 */
public int
query_tree_shadow()
{
 ...
 * Description:   This calculates the ability to hide in the tree 
 */
public int
...
/*
 * Function name: short
 * Description:   Description added to short for someone who is seen in a tree
 */

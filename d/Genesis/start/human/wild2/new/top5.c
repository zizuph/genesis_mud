...
create_wild_room()
{
    ...
    add_exit("/d/Sparkle/area/goblin_caves/rooms/level1/roome", "north",
        check_exit, 1);
    add_exit(THIS_DIR + "top5","southwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "top5","west","@@mount@@",1,1);
    add_exit(THIS_DIR + "top5","northwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "top5","southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "top5","south","@@mount@@",1,1);
    add_exit(THIS_DIR + "top5","northeast","@@mount@@",1,1);

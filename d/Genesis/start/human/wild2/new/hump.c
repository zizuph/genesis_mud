...
create_wild_room()
{
    ...
    add_exit("/d/Genesis/start/human/wild2/new/crossroad","west");
    add_exit(TOWN_DIR + "vill_gate","east");
    add_exit(THIS_DIR + "hump", "northwest", "@@bridge@@", 1,1);
    add_exit(THIS_DIR + "hump", "north", "@@bridge@@", 1,1);
    add_exit(THIS_DIR + "hump", "northeast", "@@bridge@@", 1,1);
    add_exit(THIS_DIR + "hump", "southwest", "@@bridge@@", 1,1);
    add_exit(THIS_DIR + "hump", "south", "@@bridge@@", 1,1);
    add_exit(THIS_DIR + "hump", "southeast", "@@bridge@@", 1,1);
...
do_climb(string str)
{
    ...
    TP->move_living("M",THIS_DIR + "ban1",1,0);
...
bridge()
{
    write("This bridge looks like it is pretty high above the river here! " +

...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "giant_path", "northeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "giant_path", "north","@@mount@@",1,1);
    add_exit(THIS_DIR + "giant_path", "northwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "giant_path", "southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "giant_path", "south","@@mount@@",1,1);
    add_exit(THIS_DIR + "giant_path", "southwest","@@mount@@",1,1);

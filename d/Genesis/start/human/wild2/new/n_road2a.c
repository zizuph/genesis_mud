...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "n_road2a", "northeast", "@@riv@@", 1,1);
    add_exit(THIS_DIR + "n_road2a", "southeast", "@@riv@@", 1,1);
    add_exit(THIS_DIR + "n_road2a", "east", "@@riv@@", 1,1);
    add_exit(THIS_DIR + "n_road2a", "west", "@@spur@@", 1,1);
    add_exit(THIS_DIR + "n_road2a", "northwest", "@@spur@@", 1,1);
    add_exit(THIS_DIR + "n_road2a", "southwest", "@@spur@@",1,1);

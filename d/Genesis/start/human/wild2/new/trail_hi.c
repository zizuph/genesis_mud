...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "trail_hi", "northeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_hi", "southwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_hi", "northwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_hi", "southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_hi", "north","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_hi", "south","@@mount@@",1,1);

...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "field1", "southwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "field1", "south","@@mount@@",1,1);
    add_exit(THIS_DIR + "field1", "southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "field5", "northwest",0,1,1);
    add_exit(THIS_DIR + "field1", "north","@@riv@@",1,1);
    add_exit(THIS_DIR + "field1", "northeast","@@riv@@",1,1);
...
riv()
{
    write("The river is too wide to cross here, you will have to use the " +
        "bridge that is on the Dark Road to the east.\n");
    return 1;
}
/* riv */

...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "orc_road2c", "southwest", "@@forest@@", 1,1);
    add_exit(THIS_DIR + "orc_road2c", "northwest", "@@forest@@", 1,1);
    add_exit(THIS_DIR + "orc_road2c", "north", "@@mount@@", 1,1);
    add_exit(THIS_DIR + "orc_road2c", "northeast", "@@mount@@", 1,1);
    add_exit(THIS_DIR + "orc_road2c", "south", "@@mount@@", 1,1);
    add_exit(THIS_DIR + "orc_road2c", "southeast", "@@mount@@", 1,1);

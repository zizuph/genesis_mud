...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "s_road3a", "southeast","@@jade@@",1,1);
    add_exit(THIS_DIR + "s_road3a", "east","@@jade@@",1,1);
    add_exit(THIS_DIR + "s_road3a", "northeast","@@jade@@",1,1);
    add_exit(THIS_DIR + "s_road3a", "southwest","@@jade@@",1,1);
    add_exit(THIS_DIR + "s_road3a", "west","@@jade@@",1,1);
    add_exit(THIS_DIR + "s_road3a", "northwest","@@jade@@",1,1);

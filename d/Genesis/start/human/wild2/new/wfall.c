...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "wfall","south","@@riv@@",1,1);
    add_exit(THIS_DIR + "wfall","southwest","@@riv@@",1,1);
    add_exit(THIS_DIR + "wfall","northeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "wfall","north","@@mount@@",1,1);
    add_exit(THIS_DIR + "wfall","northwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "wfall","west","@@mount@@",1,1);
...
riv()
{
    write("It is impossible to cross the stream here, you will have to find " +
        "another way across.\n");
return 1;
}
/* riv *.
...
mount()
{
    write("The mountainside is far too difficult for you to climb! Perhaps " +

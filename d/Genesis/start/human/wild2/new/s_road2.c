...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "s_road2", "southeast","@@jade@@",1,1);
    add_exit(THIS_DIR + "s_road2", "northeast","@@banks@@",1,1);
    add_exit(THIS_DIR + "s_road2", "southwest","@@rough@@",1,1);
    add_exit(THIS_DIR + "s_road2", "northwest","@@banks@@",1,1);
...
rough()
{
    write("The foothills are far too treacherous and difficult to climb here, " +
        "it looks like you will have to follow the Bright Road or the " +
        "small path instead.\n");
    return 1;
}
/* rough */

...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "trail_lo", "northeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_lo", "southwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_lo", "northwest","@@hill@@",1,1);
    add_exit(THIS_DIR + "trail_lo", "southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_lo", "east","@@mount@@",1,1);
    add_exit(THIS_DIR + "trail_lo", "south","@@mount@@",1,1);

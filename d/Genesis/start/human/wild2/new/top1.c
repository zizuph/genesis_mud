...
create_wild_room()
{
    ...
    add_exit(THIS_DIR + "top1","southwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "top1","west","@@mount@@",1,1);
    add_exit(THIS_DIR + "top1","northwest","@@mount@@",1,1);
    add_exit(THIS_DIR + "top1","southeast","@@mount@@",1,1);
    add_exit(THIS_DIR + "top1","north","@@mount@@",1,1);
    add_exit(THIS_DIR + "top1","northeast","@@mount@@",1,1);

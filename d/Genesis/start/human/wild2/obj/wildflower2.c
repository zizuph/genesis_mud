/*
 * /d/Genesis/start/human/wild2/obj/wildflower.c
 *
 * Varian - March 2016
 *
...
"snapdragon", "rose", "cornflower", "poppy", "tulip", "daffodil", \
"daisy", "hydrangea", "lily", "iris", "geranium", "magnolia", "hibiscus",\
...
create_object() 
{
    ...
    "with a fresh fragrance, and the vivid "+shade+" "+colour+" of the " +
    "petals, you would expect that this particular "+flower+" has been " +
    "picked quite recently. The flower probably does not have any value, " +
    "save perhaps as a gift to a friend.\n");
...
smell_flower(string str)
{
    ...
    " smells the "+LANG_ASHORT(this_object())+".\n");
    write("You raise the "+LANG_ASHORT(this_object())+" to your nose and "
    +"inhale deeply. Your senses are flooded with beautiful scents that "
    +"bring calmness and ease into your heart.\n");
    return 1;
}

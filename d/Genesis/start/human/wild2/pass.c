...
create_wild_room()
{
    ...
    set_no_exit_msg(({"north"}),
        "You are postive there are some bandits in the pass ahead, " +
        "waiting to ambush unwary travellers. You feel that this is " +
        "not the right time to try and follow the Dark Road north " +
        "from here.\n");
    set_no_exit_msg(({"northeast","east","southeast","southwest","west",
            "northwest"}),
        "These cliffs are too difficult to climb! You will have to " +

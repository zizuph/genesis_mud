...
create_room()
{
    ...
    add_exit("/d/Genesis/start/human/sparkle/docks/" + "ware1_1a.c", "north");
    add_exit("/d/Genesis/start/human/sparkle/docks/" + "ware1_1d.c", "east");
    add_exit("/d/Genesis/start/human/sparkle/docks/" + "ware1_2c.c", "stairs");

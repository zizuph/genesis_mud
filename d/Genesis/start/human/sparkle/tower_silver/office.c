...
create_room()
{
    ...
    set_long("This is one of the hot spots in the world of Genesis." +
      ...
      " She can help you if you have problems while wandering" +
...
reset_room(){
    object board;
    if(!present("board")){
	board = clone_object("/d/Genesis/postmaster/private/arch_boards/restorations");

 ...
 * File   : train_main.c
 * Desc   : Main hall of the Sparkle Training Center.
 * Purpose: A player can meditate or list guilds here.
 * Comment: 
 * Updated: 
 * By Whom: 
 */
...
set_long("This is the main hall of the Sparkle Training Center." +

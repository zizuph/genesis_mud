...
create_room() 
{
   ...
   set_long("You are standing before the river "
    + "Bywater. The sunlight is reflected by the "
    + "clear, cold water with which the river is filled. "
    + "The river is too deep here to cross it. You can "
    + "follow the river to the east, or you can go back to the "
    + "beautiful garden to the south.\n");
   ...
   add_exit(STAND_DIR + "garden","south",0);
   add_exit(STAND_DIR + "river2","east",0);

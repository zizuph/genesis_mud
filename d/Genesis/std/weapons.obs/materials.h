...
#define MATERIAL_DATA ([\
    ...
    "steel":   ({ 8,  8,  8, 783,      16, ({0,0,0}), 0}), \
    "iron":    ({10, 10, 10, 765,      10, ({0,0,0}), 0}), \
    "bronze":  ({10, 15, 10, 815,      20, ({0,0,0}), 0}), \
    "brass":   ({10, 18, 10, 855,      25, ({0,0,0}), 0}), \
    "tin":     ({18, 25, 15, 735,       8, ({0,0,0}), 0}), \
    "oak":     ({ 8, 10, 13,  77,       2, ({0,-2,2}), 1}), \
    "pine":    ({ 8, 10, 15,  43,       1, ({0,-2,2}), 1}), \
    "granite": ({ 3, 10, 12, 157,      10, ({-2,-1,3}), -1}), \
])
#endif

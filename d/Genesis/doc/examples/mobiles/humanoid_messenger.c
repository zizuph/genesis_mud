/*
 * Example Humanoid Messenger
 *
 * This is a humanoid messenger based on the standard messenger library.
 * It shows how easy it is to create and customize messengers. Follow
 * this example if you wish to create a messenger based on an existing
 * npc class, such as /std/monster or a domain based base class. For
 * messengers based on /std/creature, see creature_messenger.c.
 *
...
inherit "/std/monster"; // replace this with any other base class
...
{
    set_name("messenger");
    set_short("example humanoid messenger");
    set_long("This is an example of a humanoid messenger.\n");    

...
create_area()
{
    set_map("/d/Genesis/doc/examples/area_handler/ah_map");
    ...
    add_bound("A", "/d/Genesis/doc/examples/area_handler/ah_entry");
    add_bound("B", "/d/Genesis/doc/examples/area_handler/ah_cottage_1");
    add_bound("C", "/d/Genesis/doc/examples/area_handler/ah_cottage_2");
}

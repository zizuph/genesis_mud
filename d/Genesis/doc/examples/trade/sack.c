/*
 * /d/Genesis/doc/examples/trade/sack.c
 *
...
create_container()
{
    ...
    set_long("It is a large and old sack. The merchant whom " +
        "this sack once belonged to, must have travelled a lot with it " +
        "and it must have been in a lot of places.\n");
    ...
    add_prop(OBJ_S_WIZINFO, "This sack is the store-room of " +
        ...
        "special properties are removed.\n");
}

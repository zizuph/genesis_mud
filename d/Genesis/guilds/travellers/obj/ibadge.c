 ...
 *
 * Modification log:
 * -29 Dec 1999     Shadowlynx - altered for the '99 hunt winners.
 */
...
{    
    ...
    add_adj("red");
    set_short("red ribbon with bold black lettering");
    set_long("This is a red satin ribbon. It is long, narrow, and "+
      "forked at the bottom. The words: \'Winner of the Second Annual "+
    ...
    add_item(({"letters", "words", "lettering", "bold black lettering"}),
      "The words: \'Winner of the Second Annual All Hallows Eve "+
      "Scavenger Hunt\' have been printed on the red ribbon with "+
      "bold black letters.\n");
...
show_subloc(string subloc, object me, object for_obj)
{
	...
	return "";
    if (for_obj == me)
	str = "You are a proud winner of the Second Annual All "+
	"Hallows Eve Scavenger Hunt.\n";    
    else
	str = capitalize(me->query_pronoun()) + " is a proud winner "+
	"of the Second Annual All Hallows Eve Scavenger Hunt.\n";
    return str;
}

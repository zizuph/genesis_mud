/* === /d/Genesis/lib/commerce.c =========================================
 * ============================================ Raven 2001 (c) Genesis ===
 *
...
/*
 * Update Log:
 * Fixed contractions and punctuations
 * -- Finwe, November 4, 2007
 */
...
#define COMMODITY_LIB           ("/d/Genesis/lib/commodity")
    ...
    float costfc = 1.0)
{
    ...
    {
        throw("Commodity " + commod + " wasn't defined.\n");
        return;
    }
...
{
    command("say I can't see you, light a torch first, please.");
    return 1;
}
...
hook_commerce_buy_faulty_syntax(string cmdarg)
{
    ...
    command("say What " + cmdarg + "? I don't have any of it, " +
        appeal() + ".");
    command("ponder");
    return 1;
}
...
hook_commerce_buy_faulty_amount(object commod, int amount, int in_stock)
{
    ...
    if (!in_stock)
    {
        command("say I am sorry, " + appeal() + ", but I don't have " +
...
hook_commerce_sell_faulty_syntax(string cmdarg)
{
    ...
    command("say What " + cmdarg + "? You don't seem to have it, " +
        appeal() + ".");
    command("ponder");
    return 1;
}

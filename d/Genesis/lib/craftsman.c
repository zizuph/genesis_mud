 ...
 *
 *     // display attributes in sorted order
...
static int sorted_attrs;

public mapping m_orders = ([]);

public void craftsman_config_attributes(int id, int attr_number);
public int craftsman_completed_config(int id);
public void craftsman_completed_order(int id);
public void craftsman_reset_completion_time();
public void craftsman_clean_completed_orders();
public int craftsman_calc_item_cost(object ob, int id);
...
craftsman_config_attributes(int id, int attr_number)
{
	...
	{
	    craftsman_set_attribute("", id, attr_number);
	    return;
	}

...
create_dwarf_room()
{
    ...
    add_item(({"cobbled path","path"}),
      ...
      "off to the northeast and southwest.\n");
    ...
    add_exit(IRON +  "r9","northeast",0);
    add_exit(IRON + "bridge","northwest",0);
    add_exit(IRON + "r10","southwest",0);
    add_exit(IRON + "r11","southeast",0);
...
short_descr()
{
    return "A cobbled path in Iron Delving";
}

/*
 * Louie April 2006 - Fixed bug preventing goblin enemies from
 * being attacked.
 */
...
/*
*  Created version to be at ease in the Dwarvenfug Tavern 
*  and thereby guard the trapdoor exit from the brewery
*  from goblin incursion into Iron Delving proper 
*
*  Vitwitch 2021
*/
...
create_krynn_monster()
{
    ...
    set_long("This is dwarven warrior of Iron Delving -- " +
      "drinking and smoking at ease in Iron Delving. He " +
      "looks like he is prepared for smoking and drinking, but does not " +
    ...
    set_default_answer("The dwarf looks at you funnily, "+
      "through a haze of smoke and ale, perhaps as if " +
      "you should already know the answer to that.\n");

    set_act_time(5);
    add_act("emote stretches his gnarled hands around his mug of brew.");
    add_act("emote curses the Mountain dwarves to eternal something or other...amidst indistinct muttering...");
    ...
    add_act("emote chuffs contentedly on his pipe.");
...
attacked_by(object ob)
{
    ...
    command("say Iron Delving! To arms!");
    command("blow horn");
    ::attacked_by(ob);
}

...
create_krynn_monster()
{
    ...
    set_long("Short and malicious, this goblin hunts and " +
      "pillages the lands of and surrounding Estwilde. While " +
      "cowardly on their own, in a group they often work " +
      "up the courage to raid even small towns.\n" +
      "This goblin is a member of the Grey Crag tribe of " +
      "Blood Mountain.\n");
    ...
    add_act("emote mumbles: Hoo much dwarrfy gold ull we find?");

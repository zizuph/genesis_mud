...
create_kalaman_room()
{
    ...
    add_item(({"palace walls","walls","wall"}),
      ...
      "this wall stands more to separate the palace from the " +
    ...
    add_item(({"palace","spires"}),
      ...
      "his council sits.\n");
    add_item_city();
    add_exit(CITY + "r10","north",0);
    add_exit(CITY + "r12","southwest",0);
...
long_descr()
{
    ...
    "The road continues to the north and the southwest.\n";
}

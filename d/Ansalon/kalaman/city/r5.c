...
create_kalaman_room()
{
    ...
    add_exit(CITY + "r2","northeast",0);
    add_exit(CITY + "r10","south",0);
    add_exit(CITY + "r22","northwest",0);
    reset_kalaman_room();
}
...
long_descr()
{
    ...
    "The road heads northeast, as well as south and northwest along the wall.\n";
}

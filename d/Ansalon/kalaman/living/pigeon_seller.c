...
create_krynn_monster()
{
    ...
    add_adj("friendly");
    set_gender(G_FEMALE);
    set_long("This friendly plump woman stands here " +
      "with a large wicker cage in her hands, selling " +
      "pigeons to people.\n");
...
buy(str)
{
    ...
    write("You pay the woman, and she opens her cage and gets " +
      "you a pigeon.\n");
    say(QCTNAME(TP) + " gets a pigeon from the friendly plump woman.\n");
    ...
    if (pig->move(who) != 0)
    {
    	write("Noticing that you are too burdened to carry the pigeon, the woman " +
    	  "places it on the ground before you.\n");
    	say("The woman places the pigeon on the ground before " + QCTNAME(TP) + ".\n");
    	/* pig?? */

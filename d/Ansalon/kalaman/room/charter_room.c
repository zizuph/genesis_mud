/* Join room for mariners has been moved to Palanthas */
...
read_sign()
{
    write("The sign contains a number of personal messages, and reads:\n\n" +
          ...
          "      Current personal charters out of Kalaman harbour will\n" +
          "      no longer continue, with the Guild of Mariners moving\n" +
          "      their vessels to be based out of the city of Palanthas.\n");
...
chartership(string str)
{
    ...
    write("With the Dragonarmies encroaching on Kalaman, the Guild of Mariners " +
        "have moved all their fishing vessels to Palanthas!\n");
...
craftjoin(string str)
{
	...
	case 1:
	    ...
	    write("The harbourmaster gives you a complementary spyglass " +
                  "as you sign up... You are now enlisted as a mariner of " +
                  "Genesis!\n");

	    say(QCTNAME(TP)+ " is handed a spyglass by the harbourmaster, and " +
             "then looks eagerly around after enlisting as " +

...
create_kalaman_room()
{
    set_short("The end of a pier within the harbour of Kalaman on the Vingaard River");
    set_long("@@long_descr");
    ...
    add_exit(KROOM + "dock2","southwest",0);
    reset_kalaman_room;
	add_pier_entry(MASTER_OB(TO), "Kalaman", "Gelan - Pelargir Circle");
	initialize_pier();
}

...
add_stuff()
{
    ...
    if(!ship)
    {
	ship = clone_object("/d/Ansalon/kalaman/ship/vin/ship");
	ship->start_ship();
    }
}
...
create_kalaman_room()
{
    set_short("A pier within the harbour of Kalaman on the Vingaard River");
    set_long("@@long_descr");
    ...
    add_exit(KROOM + "dock4","northeast",0);
    add_exit(KROOM + "road1","southwest",0);
...
read_sign()
{
    ...
    write("\n" +
      ...
      "   |                                       |\n" +
      "   |                                       |\n" +
      "   |     The boat that docks here travels  |\n" +
      "   |     down the Vingaard River to docks  |\n" +
      "   |     near Vingaard Keep.               |\n" +
      "   |                                       |\n" +
      "   |                                       |\n" +
      "   ----------------------------------------\n\n\n");

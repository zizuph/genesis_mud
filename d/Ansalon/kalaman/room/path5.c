...
create_kalaman_room()
{
    ...
    add_item(({"beacon","beacon tower","beacon towers","tower","towers"}),
      BSN("To your north stands one of the harbour's beacons. You believe this is " +
	"what the path leads to."));

    add_exit(KROOM + "path4","south",0);
    add_exit(KROOM + "path6","north",0);
...
long_descr()
{
    ...
    tod_descr1() +
    "The path continues to your north towards one of the " +
    "harbour's beacon towers, and south back towards the city.";

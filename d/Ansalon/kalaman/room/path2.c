...
create_kalaman_room()
{
    ...
    add_item(({"paved road","road"}),
      BSN("A paved road that runs along the harbour begins to your south."));

    add_exit(KROOM + "road3","south",0);
    add_exit(KROOM + "path7","northeast",0);
...
long_descr()
{
    ...
    tod_descr1() +
    "The path leads down to a paved road to your south, while it " +

...
create_kalaman_room()
{
    ...
    add_exit(KROOM + "road2","southwest",0);
    add_exit(KROOM + "dock1","northeast",0);

    reset_kalaman_room();
	add_pier_entry(MASTER_OB(TO), "Kalaman", "Line to Sparkle");
	initialize_pier();
}
...
read_sign()
{
    ...
    write("\n" +
      ...
      "   |                                       |\n" +
      "   |                                       |\n" +
      "   |     The ship that docks here will     |\n" +
      "   |     take passengers to the far lands  |\n" +
      "   |     of Gondor.                        |\n" +
      "   |                                       |\n" +
      "   |                                       |\n" +
      "   ----------------------------------------\n\n\n");

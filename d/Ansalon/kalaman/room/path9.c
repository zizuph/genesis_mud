...
create_kalaman_room()
{
    ...
    add_item(({"beacon","beacon tower","beacon towers"}),
      BSN("To your east stands one of the harbour's beacons. You believe this is " +
	"what the path leads to."));

    add_exit(KROOM + "path10","east",0);
    add_exit(KROOM + "path8","west",0);
...
long_descr()
{
    ...
    tod_descr1() +
    "The path continues to your east towards one of the " +
    "harbour's beacon towers, and west back towards the city.";

...
{
    ::create_sewer_room();
    add_exit(SECOND + "s12", "west");
    add_exit(SECOND + "s19", "east");
    add_exit(SECOND + "s17", "south");
    add_exit(SECOND + "s13", "southwest");
    add_exit(SECOND + "s21", "northeast");
...
enter_cmd(string str)
{
    ...
    else
    {
        ...
        TP->move_living("M", SECOND + "c2", 0, 0);

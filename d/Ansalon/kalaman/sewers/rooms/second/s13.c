...
{
    ::create_sewer_room();
    add_exit(SECOND + "s12", "north");
    add_exit(SECOND + "s18", "northeast");
    add_exit(SECOND + "s14", "southwest");
    add_exit(SECOND + "s17", "east");
    add_exit(SECOND + "s16", "southeast");
    add_exit(SECOND + "s15", "south");
...
cottage_desc()
{
    ...
    temp += "There is a small dwarven cottage here.\n";
    return temp;
}
...
enter_cmd(string str)
{
    ...
    else
    {
        ...
        TP->move_living("M", SECOND + "c4", 0, 0);

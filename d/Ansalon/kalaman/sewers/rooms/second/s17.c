...
{
    ::create_sewer_room();
    add_exit(SECOND + "s12", "northwest");
    add_exit(SECOND + "s18", "north");
    add_exit(SECOND + "s13", "west");
    add_exit(SECOND + "s16", "south");
    add_exit(SECOND + "s19", "northeast");
...
enter_cmd(string str)
{
    ...
    else
    {
        ...
        TP->move_living("M", SECOND + "c5", 0, 0);

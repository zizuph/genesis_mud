...
create_cave_room()
{
    ...
    "A large tent stands directly south of here.\n");
    ...
    "look of a more permanent construction. The opening of " +
    "the tent faces in this direction.\n");
    add_item(({"opening","opening of the tent"}),
    "The opening of the tent faces in this direction.\n");
    ...
    add_exit(CAVE_DIR + "camp2", "west");
    add_exit(CAVE_DIR + "camp4", "east");
    add_exit(CAVE_DIR + "camp1", "north");
    add_exit(CAVE_DIR + "tent1", "south");
}

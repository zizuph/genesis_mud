/* Ashlar, 2 Aug 97 - Dragonarmy Lieutenant */
...
/*
    switch(random(4))
    {
        case 0:
            ...
            tmp->enchant(P("weapon",TO), random(20) + 20);
            break;
    }
*/
    command("wield all");
...
create_krynn_monster()
{
    ...
    set_race_name("human");
    set_adj("dragonarmy");
    set_short("dragonarmy lieutenant");
    add_prop(OBJ_I_COLORABLE, 1);
    add_prop(LIVE_I_NEVERKNOWN, 1);

    set_long("This is a lieutenant of the dragonarmy. He is clean-shaven " +
...
query_player_al()
{
    if(TP->query_guild_name_occ() == "Solamnian Knights")
        return "The lieutenant eyes you angrily, seeming on the verge to attack you.";
    if(TP->query_alignment() > 200)
        return "The lieutenant studies you carefully.";
    return "The lieutenant glances quickly at you, then ignores you.";
}

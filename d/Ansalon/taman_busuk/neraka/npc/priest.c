...
/**
 * Navarre Feb 4th 2007
 * - Eventhough the priest had spells added to the list below of commands
 *   to do, they werent set up, and the priest didn't carry the ingredients
 *   for the spells.
 *   I added the spells to the priest, and I added the ingredients for him.
 */
...
create_pot_monster()
{
    ...
    set_pick_up_team(({"_priest_","_templeguard_","draconian"}));
    ...
    set_skill(PS_GUILD_LEVEL, 200 + random(60));

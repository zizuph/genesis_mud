...
arm_me(int l)
{
    ...
    case 10: switch(random(3))
             {
	     case 0:
	     case 1: wep += ({ UNIQUE(OBJ + "bbattleaxe",12,OBJ + "bmace") });
	             break;
    ...
    case 12: switch(random(3))
             { 
	     case 0:
	     case 1: wep += ({ UNIQUE(OBJ + "bclaymore",8,OBJ + "bsword") });
	             break;
...
/* This was the weapon, now to the armour...*/    
    ...
    case 10: arm += ({"barmour1"});
		 ...
		 case 3: arm += ({"bshinguard", "bheavyboots"});
             ...
             break;
    case 11: arm += ({ UNIQUE(OBJ + "bdragonarm",19,OBJ + "barmour1"),
			 "bshinguard", "bdragonhelm"});
             break;
    case 12: arm += ({ UNIQUE(OBJ + "bdragonarm",19,OBJ + "barmour1"),
			 "bshinguard","bheavyboots","bdragonhelm"});
             break;
    }

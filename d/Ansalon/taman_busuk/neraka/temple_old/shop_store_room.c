...
#define T_S_INV ({                                                      \
    ({ NWEP + "mace1h", "_temple_shop_mace", 4 }),                      \
    ({ NARM + "crescent_shield", "_temple_shop_shield", 4 }),           \
    ({ NARM + "black_chain_shirt", "_temple_shop_chainshirt", 4 }),     \
    ({ NWEP + "knife", "_temple_shop_knife", 2 }),                      \
    ({ "/d/Ansalon/guild/pot/obj/sandals", "_temple_shop_sandals", 3 }),\

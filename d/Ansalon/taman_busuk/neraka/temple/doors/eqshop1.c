...
create_door()
{
    ...
    set_other_room( DUNGONE + "eqshop.c");
    set_open(0);
    ...
    set_open_mess(({"slowly pulls the door open.\n", 
        "The large iridescent black mahogany door opens slowly.\n"}));
    set_fail_open(({"But the door is already open.\n", ""}));
    set_close_command(({"close", "push"}));
    set_close_mess(({"pushes the black mahogany door and closes it.\n", "The " +
        "large iridescent black mahogany door closes slowly.\n"}));

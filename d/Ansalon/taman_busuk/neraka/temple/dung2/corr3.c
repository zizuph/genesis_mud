...
create_temple_room()
{
    ...
    set_long("This is a dark narrow corridor deep below the temple. " +
        "It continues to the north and on both sides of the " +
        "corridor are small doors leading to prisoner cells. To the " +
        "south is a large guard room.\n");
    ...
    add_exit( DUNGTWO  + "corr2.c", "north" );
    add_exit( DUNGTWO  + "guard.c", "south" );
    add_exit( DUNGTWO + "cell3.c", "east", "@@enter_cell", 0, 1);
    add_exit( DUNGTWO + "cell4.c", "west", "@@enter_cell", 0, 1);
}

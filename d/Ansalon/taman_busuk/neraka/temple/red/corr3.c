...
create_temple_room()
{
    ...
    set_long("You are standing in a narrow stone corridor. It leads to " +
        "a winding stairway to the south and an archway to the west " +
    ...
    add_exit( RED + "stair2.c", "south" );
    add_exit( RED + "chamber.c", "west" );
    add_exit( RED + "landing.c", "east","@@stair_notice", 0, 1 );
}

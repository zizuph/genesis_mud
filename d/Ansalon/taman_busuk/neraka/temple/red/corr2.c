...
create_temple_room()
{
    ...
    set_long("You are standing in a corridor in the temple which opens " +
        "up into a larger chamber to the southeast. To the west is a " +
        "winding stairway and the corridor itself continues to the " +
        "southwest. The black walls are lined with torches which shed " +
    ...
    add_exit( RED + "stair1.c", "west" );
    add_exit( RED + "corr1.c", "southwest" );
    add_exit( RED + "achamber.c", "northeast" );
}

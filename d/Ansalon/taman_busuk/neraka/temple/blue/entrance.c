...
create_temple_room()
{
    ...
    ::create_temple_room();
     ...
     set_short("Inside the Blue Dragonarmy entrance of the temple");
    set_long("You are standing in a section of a corridor leading north" +
        "west further into the Temple of Darkness. To the southeast " +
        "stands a heavy oak door serving as entrance for the Blue " +
        "Dragonarmy to the temple and beyond that the grand city of " +
    ...
    door = clone_object( DOOR + "baent1");
    door->move(this_object());

    add_exit( BLUE + "corr1.c", "northwest" );
}

...
create_temple_room()
{
    ...
    ::create_temple_room();
     ...
     set_short("Inside the Green Dragonarmy entrance of the temple");
    set_long("You are standing in a section of a corridor leading " +
        "east, further into the Temple of Darkness. To the west " +
        "stands a heavy oak door serving as entrance for the Green " +
    ...
    door = clone_object( DOOR + "gaent1");
    door->move(this_object());

    add_exit( GREEN + "corr1.c", "east" );
}

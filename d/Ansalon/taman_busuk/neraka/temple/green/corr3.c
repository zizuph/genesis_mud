...
create_temple_room()
{
    ...
    set_long("You are standing in a narrow stone corridor. It leads to " +
        "a winding stairway to the west and an archway to the north " +
    ...
    add_exit( GREEN + "stair2.c", "west" );
    add_exit( GREEN + "chamber.c", "north" );
    add_exit( GREEN + "landing.c", "east","@@stair_notice", 0, 1 );
}

...
create_temple_room()
{
    ...
    add_item(({"experiments","experiment"}), "The experiments are "+
        "being carried out by initiates.\n");
    add_item(({"workbenches","workbench"}), "Upon the workbenches are "+
        "devices associated with experiments.\n");

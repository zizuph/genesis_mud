...
create_temple_room()
{
    ...
    ::create_temple_room();
     ...
     set_short("Inside the Black Dragonarmy entrance of the temple");
    set_long("You are standing in a section of a corridor leading " +
        "west further into the Temple of Darkness. To the east " +
        "stands a heavy oak door serving as entrance for the Black " +
    ...
    door = clone_object( DOOR + "bkaent1");
    door->move(this_object());

    add_exit( BLACK + "corr1.c", "west" );
    //add_exit( NINNER + "s22", "out");
}

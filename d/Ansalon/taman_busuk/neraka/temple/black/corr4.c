...
create_temple_room()
{
    ...
    set_long("You are standing in a narrow stone corridor. It leads to " +
        "a winding stairway to the northeast and an archway to the " +
        "south opens up into a small chamber. There is also another " +
    ...
    add_exit( BLACK + "stair2.c", "northeast" );
    add_exit( BLACK + "chamber.c", "south" );
    add_exit( BLACK + "landing.c", "northwest","@@stair_notice", 0, 1 );
}

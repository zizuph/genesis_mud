...
create_temple_room()
{
    ...
    set_long("This is a standard room for many Temple rooms.\n");
    ...
    add_item(({"wall", "walls", "black wall", "black walls"}),
        ...
        "along the surface in a chaotic saraband as flickering torches " +
        "create eerie shadows along the walls.\n");
    ...
    add_item(({"torch", "torches"}),
        "The large torches are lit and burn with a flickering flame " +
        "which make shadows dance along the walls, ceiling, and floor. " +
        "They are evenly spaced along the walls and held by massive " +
        "iron torch-holders.\n");


    add_item(({"torch-holders", "holders", "iron torch-holders", 
        "iron holders", "massive torch-holders", "massive holders"}),
        "The large massive torch-holders are made out of cast iron and " +
        "sculpted in the shape of a scaly arm ending in a clawed hand " +
        "which holds the lit torch.\n");

    add_cmd_item(({"torch-holders", "holders", "iron torch-holders", 
        "iron holders", "massive torch-holders", "massive holders"}),
        ({"touch", "feel"}), "You reach out and carefully touch one of " +
        "the scaly torch-holders. It is strangely warm beneath your " +
        "touch and perhaps it is your imagination but it feels just as " +
        "if it were alive and moved.\nYou quickly withdraw your hand.\n");

    add_cmd_item(({"torch-holders", "holders", "iron torch-holders", 
        "iron holders", "massive torch-holders", "massive holders"}),
        ({"pull", "tug", "turn", "push", "move"}), "You take hold of one " +
        "of the torch-holders and try to move it. It is securely attached " +
        "to the wall and will not budge at all.\n");


    add_item(({"shadows", "shadow"}),
        "Dark shadows move and flitter along the walls and ceiling, " +
        "created by the flames of the large torches along the walls.\n");
    ...
    add_item(({"ceiling"}), 
        "The ceiling is high and vaulted. It is made of the same stone " +
        "as the walls and the deep crevices in the texture seems to be " +

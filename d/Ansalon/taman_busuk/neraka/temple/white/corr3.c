...
create_temple_room()
{
    ...
    set_long("You are standing in a narrow stone corridor. It leads to " +
        "a winding stairway to the west and an archway to the south " +
        "opens up into a small chamber. There is also another " +
        "archway to the east leading down some twisted stairs.\n");
    ...
    add_exit( WHITE + "stair2.c", "west" );
    add_exit( WHITE + "chamber.c", "south" );
    add_exit( WHITE + "landing.c", "east","@@stair_notice", 0, 1 );
}

/* Ashlar, 20 Jul 97 */
/*
 * Louie April 2006 - All shops should be 100 greed.
 */
...
#define STORE_ROOM    NINNER + "ashop_store"

void
create_neraka_room()
{
	set_short("inside Ogdil's Armours");
...
{
    /* armour_filter() is defined in /lib/shop */
    return armour_filter(ob);
}

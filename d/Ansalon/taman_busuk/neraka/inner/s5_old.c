...
reset_neraka_room()
{
    ...
    if (!objectp(g1))
        g1 = clone_npc(NNPC + "sivak","shiny black");
    if (!objectp(g2))
        g2 = clone_npc(NNPC + "aurak","shiny black");
...
create_neraka_room()
{
    ...
    set_extra_long("You are in the center part of the Temple Square. " +
        "The square stretches west, east and north of here. " +
        "The Temple of Takhisis is south of here, the entrance gaping " +

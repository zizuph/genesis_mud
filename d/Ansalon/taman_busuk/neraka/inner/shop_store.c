...
#define WARFARE_AMULET "/d/Krynn/common/warfare/obj/warfare_scry_amulet"
...
reset_room()
{
    ...
    */
    ...
    if(!objectp(ob))
    {
        ob = clone_object(WARFARE_AMULET);
        ob->add_name(ARMID);
        ob->move(TO);
    }
}

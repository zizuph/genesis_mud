...
create_neraka_room()
{
    ...
    "Takhisis.\n");
    add_exit(NINNER+"i14.c","west",0,0);
    add_exit(NINNER+"i16.c","east",0,0);
    clone_object(NOUTER+"red/in_gate.c")->move(TO);
}

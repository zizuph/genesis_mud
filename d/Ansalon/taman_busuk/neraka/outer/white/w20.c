...
create_neraka_room()
{
    ...
    add_exit(NOUTER+"white/w24","west");
    add_exit(NOUTER+"white/w23","northwest");
    add_exit(NOUTER+"white/w21","north");
    add_exit(NOUTER+"white/t7","northeast","@@msg");
    add_exit(NOUTER+"white/w19","east");
    add_exit(NOUTER+"white/w27","south");

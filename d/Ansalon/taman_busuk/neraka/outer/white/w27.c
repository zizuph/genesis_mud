...
create_neraka_room()
{
    ...
    set_extra_long("You are in the White Army camp. Tents are placed at " +
        ...
        "around them. There are entrances to tents to the west and " +
        "south.");
    set_quarter(WHITE);
    add_item_camp();
    ...
    add_exit(NOUTER+"white/t5","west","@@msg");
    add_exit(NOUTER+"white/t6","south","@@msg");
    add_exit(NOUTER+"white/w19","northeast");
    add_exit(NOUTER+"white/w20","north");

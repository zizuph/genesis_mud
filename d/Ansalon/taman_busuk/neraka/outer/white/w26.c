...
create_neraka_room()
{
    ...
    set_extra_long("You are in the White Army camp. Tents are placed at " +
        ...
        "around them. There is an entrance to a tent to the southeast.");
    set_quarter(WHITE);
    add_item_camp();
    ...
    add_exit(NOUTER+"white/t4","southeast","@@msg");
    add_exit(NOUTER+"white/w24","northeast");
    add_exit(NOUTER+"white/w28","southwest");
}

...
create_neraka_room()
{
	set_short("Inside a guard tower in the Black Quarter");
    set_long("You are standing inside the guard tower at the entrance " +
        "of the Black Quarter. There are a few bunks " +
        "against the walls and a table in the middle of the room. " +
        "There is a fireplace set in the east wall. " +
    ...
    add_exit(NOUTER+"black/b12","southwest");

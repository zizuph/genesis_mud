...
create_neraka_room()
{
    ...
    set_extra_long("You are walking on a dirt road in the Blue Army camp. " +
        "There is a tent east of here, and the road continues west and " +
        "southeast.");
    set_quarter(BLUE);
    ...
    add_exit(NOUTER+"blue/b16","west");
    add_exit(NOUTER+"blue/t5","east","@@msg");
    add_exit(NOUTER+"blue/b19","southeast");
}

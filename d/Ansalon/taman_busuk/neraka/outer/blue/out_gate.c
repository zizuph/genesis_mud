...
create_door()
{
    ...
    set_door_id("neraka_blue_outer");
    set_other_room(NOUTER + "blue/tunnel");
    set_open(1);
...
pass_door(string arg)
{
    ...
    if(query_open() && TP->query_dragonarmy_division() == "blue")
    {
	write("As a member of the Blue Dragonarmy, you pass through the " +
	  "portcullis uncontested.\n");

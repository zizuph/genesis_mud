...
mixed es_query_can_wear(object what) { return 0; }
mixed es_query_can_remove(object what) { return 0; }
void es_hook_can_wear_msg(object what) { }
void es_hook_can_not_wear_msg(object what) { }
void es_hook_can_remove_msg(object what) { }
void es_hook_can_not_remove_msg(object what) { }

mixed es_query_can_wield(object what) { return 0; }
mixed es_query_can_unwield(object what) { return 0; }
void es_hook_can_wield_msg(object what) { }
void es_hook_can_not_wield_msg(object what) { }
void es_hook_can_unwield_msg(object what) { }
void es_hook_can_not_unwield_msg(object what) { }
...
{
	mixed s;
	if (s = es_query_can_wear(what))
	{
		es_hook_can_not_wear_msg(what);
		return s;
	}
    if (objectp(gAfObj))
...
{
	mixed s;
	if (s = es_query_can_remove(what))
	{
	    es_hook_can_not_remove_msg(what);
    	return s;
	}
    if (objectp(gAfObj))
...
{
	mixed s;
	if (s = es_query_can_wield(what))
	{
    	es_hook_can_not_wield_msg(what);
	    return s;
	}
    if (objectp(gAfObj))
...
{
	mixed s;
	if (s = es_query_can_unwield(what))
	{
    	es_hook_can_not_unwield_msg(what);
	    return s;
	}
    if (objectp(gAfObj))

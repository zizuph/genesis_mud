...
arm_me()
{
    ...
    clone_object("/d/Ansalon/taman_busuk/sanction/obj/weapon/long_pike")->move(TO, 1);

    arm1 = clone_object("/d/Krynn/solamn/splains/obj/bdragonarm");
    arm1->set_color("red");
    arm1->move(TO,1);
    arm3 = clone_object("/d/Krynn/solamn/splains/obj/bdragonhelm");
    arm3->set_color("red");
    arm3->move(TO,1);
    arm2 = clone_object("/d/Krynn/solamn/splains/obj/bshinguard");
    arm2->set_color("red");
    arm2->move(TO,1);
    arm4 = clone_object("/d/Ansalon/guild/dragonarmy/obj/uniform");
    arm4->set_colour("red");
    arm4->set_dalevel(2);
    arm4->move(TO,1);
    command("wear all");
...
public void attacked_by(object ob)
{
   ...
   ::attacked_by(ob);
   ob->add_prop("_i_attacked_rda_guild_home", 1);

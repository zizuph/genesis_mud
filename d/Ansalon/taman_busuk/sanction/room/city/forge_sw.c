...
create_forge_room()
{
    set_short("The southwest smith forge");
    set_long("This is the southwest forge in Sanction. " +
    ...
    add_exit("/d/Ansalon/taman_busuk/sanction/room/city/yard","northeast","@@check_forging@@");

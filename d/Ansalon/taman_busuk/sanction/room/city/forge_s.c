...
create_forge_room()
{
    set_short("The south smith forge");
    set_long("This is the south forge in Sanction. " +
    ...
    add_exit("/d/Ansalon/taman_busuk/sanction/room/city/yard","north","@@check_forging@@");

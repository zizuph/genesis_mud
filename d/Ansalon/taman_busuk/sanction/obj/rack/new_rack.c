/*
 * Filename:    new_rack
 * Description: Equipment rack for DAs.
 *
 * Creator:     Carnak, 2017-10-04
 */
...
prevent_leave(object ob)
{
    ...
    if (MANAGER->query_punishment(this_player(), PUN_NOARMOURY))
    {
        ...
        {
            this_player()->catch_msg("You have been punished by restricted "
            + "armoury access.\n");

...
create_kurinost_room()
{
    ...
    set_short("near a shadowy pass high up on the cliffs overlooking " +
        "the Bay of Balifor");
    set_long(show_me_long_desc);

    remove_item("pass");
    add_item(({"pass", "shadowy pass"}), 
        "To your south the cliffs form a pass through the top " +
...
ascend_path()
{
    write("Climbing the final short incline, you walk south " +
        "and quickly enter the pass at the top of the cliffside.\n");

...
show_me_berries()
{
    ...
    if (gBush)
    {
        desc = "The small green capers appear to grow on a small " +
    ...
    desc += " a quick look, you figure it holds ";
...
add_vegetation(int vegetation_type)
{
    ...
    if (vegetation_type == 1)
    {
        add_item(({ "bush", "bushes", "small bush", "small bushes",
            ...
            "away in a sheltered corner behind a few rocks, this " +
            "small shrubby caper bush has many branches and " +
            "thick, shiny and ovate shaped leaves. Growing out of " +
            "a patch of soil, this plant is known to be able to " +
            "survive almost anywhere. Growing on the branches of " +
            "this kind of bush, are the green flowerbuds known as " +
            "capers.\n");
        ...
        gVegetation_desc = "Sitting quietly in a sheltered corner " +
            "behind a few rocks is a small bush.";
...
public void
add_extra_long_desc(string str)
{
    if(!gCliff_desc)
        gCliff_desc = str;

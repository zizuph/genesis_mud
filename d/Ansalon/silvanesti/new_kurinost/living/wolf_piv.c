...
{
    set_name("wolf");
    set_long("A pair of gleaming yellow eyes glare dangerously at " +
      ...
      "Muscles ripple beneath it’s black and brown fur as it seems to " +
      "position itself between you and something in the pile of " +
      "garbage. Rising about 120 cm from the ground, the wolf is " +

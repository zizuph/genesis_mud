...
create_shadow_room()
{
    ...
    add_exit(SROOM + "cave03","east",0);   
    add_exit(SROOM + "cave02","northeast",0);
    add_exit(SROOM + "cave04","southeast",0);
    add_exit(SROOM + "tunnel14","southwest","@@shadow_block");
...
shadow_block()
{
  if (TP->query_race_name() == "shadowpeople")
    return 1;
  else
    return 0;
}

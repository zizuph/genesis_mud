...
create_shadow_room()
{
    ...
    add_exit(SROOM + "cave11","south",0);
    add_exit(SROOM + "cave15","east",0);
    add_exit(SROOM + "cave06","west",0);
    add_exit(SROOM + "cave14","northeast",0);
    add_exit(SROOM + "cave05","northwest",0);

...
{
    set_short("Northeast corner of Park Square");
    set_long("@@long_descr");
...
add_item(({"tree","trees"}),"The trees of the park haven't had leaves since "+
    ...
    add_item("fountain","The fountain lies southwest of here.  You feel you "+
    ...
    add_exit(BROOM + "park5","south",0);
    add_exit(BROOM + "park2","west",0);
    add_exit(BROOM + "street05","northeast",0);
...
long_descr()
{
    return "This is the northeast corner of Balinost's Park Square.  "+

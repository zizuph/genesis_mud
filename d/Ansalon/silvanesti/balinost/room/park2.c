...
{
    set_short("North side of Park Square");
    set_long("@@long_descr");
...
add_item(({"tree","trees"}),"The trees of the park haven't had leaves since "+
    ...
    add_item("fountain","The fountain lies south of here.  You feel you "+
    ...
    add_exit(BROOM + "street03","north",0);
    add_exit(BROOM + "fountain","south",0);
    add_exit(BROOM + "park1","west",0);
    add_exit(BROOM + "park3","east",0);
    add_exit(BROOM + "park4","southwest",0);
    add_exit(BROOM + "park5","southeast",0);
    reset_balinost_room();
}
...
long_descr()
{
    return "This is the north side of Balinost's Park Square.  "+

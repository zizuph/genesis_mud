...
{
    set_short("East side of Park Square");
...
add_item(({"tree","trees"}),"The trees of the park haven't had leaves since "+
    ...
    add_item("fountain","The fountain lies west of here.  You feel you "+
    ...
    add_exit(BROOM + "park3","north",0);
    add_exit(BROOM + "park8","south",0);
    add_exit(BROOM + "fountain","west",0);
    add_exit(BROOM + "street07","east",0);
    add_exit(BROOM + "park2","northwest",0);
    add_exit(BROOM + "park7","southwest",0);
...
long_descr()
{
    return "This is the east side of Balinost's Park Square.  "+

...
create_balinost_room()
{
    ...
    add_exit(BROOM + "street39","north",0);
    add_exit(BROOM + "street37","south",0);
    add_exit(BROOM + "street26","west","@@check_wiz");
    add_exit(BROOM + "street15","east",0);
    add_exit(BROOM + "guardpost3","northwest",0);
    add_exit(BROOM + "guardpost4","southwest",0);

...
{
    set_short("South side of Park Square");
    set_long("@@long_descr");
...
add_item(({"tree","trees"}),"The trees of the park haven't had leaves since "+
    ...
    add_exit(BROOM + "fountain","north",0);
    add_exit(BROOM + "street11","south",0);
    add_exit(BROOM + "park6","west",0);
    add_exit(BROOM + "park8","east",0);
    add_exit(BROOM + "park4","northwest",0);
    add_exit(BROOM + "park5","northeast",0);
...
long_descr()
{
    return "This is the south side of Balinost's Park Square.  "+

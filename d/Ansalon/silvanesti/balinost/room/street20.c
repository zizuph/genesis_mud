...
create_balinost_room()
{
    ...
    add_exit(BROOM + "street32","north","@@check_wiz()");
    add_exit(BROOM + "street03","south",0);
    add_exit(BROOM + "street19","west",0);
    add_exit(BROOM + "street21","east",0);
    add_exit(BROOM + "guardpost1","northwest",0);
    add_exit(BROOM + "guardpost2","northeast",0);

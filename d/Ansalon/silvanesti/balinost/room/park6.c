...
{
    set_short("Southwest corner of Park Square");
    set_long("@@long_descr");
...
add_item(({"tree","trees"}),"The trees of the park haven't had leaves since "+
    ...
    add_item("fountain","The fountain lies northeast of here.  You feel you "+
    ...
    add_exit(BROOM + "park4","north",0);
    add_exit(BROOM + "park7","east",0);
    add_exit(BROOM + "street13","southwest",0);
...
long_descr()
{
    return "This is the southwest corner of Balinost's Park Square.  "+

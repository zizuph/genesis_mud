...
{
    set_short("Streets of the inner circle of Balinost");
    set_long("@@long_descr");
    ...
    add_exit(BROOM + "street04","west",0);
    add_exit(BROOM + "street06","south",0);
    add_exit(BROOM + "street23","northeast",0);
    add_exit(BROOM + "park3","southwest",0);
...
long_descr()
{
    return tod_descr2()+"You are on the streets of the inner circle "+

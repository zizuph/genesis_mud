...
create_kurinost_room()
{
    ...
    add_exit(KROOM + "road8","southwest",0);
    add_exit(KROOM + "road2","southeast",0);
    add_exit(KROOM + "tent2","tent",0);
...
long_descr()
{
   return "This is the Green Dragonarmy's camp outside "+
     "of Kurinost.  The camp is just outside the perimeter of the "+
      "nightmarish forest.  Trees here have yet to be affected by "+
     "torturous disease that infects the woods to the southwest.  "+
     "A military tent stands to the north.  "+

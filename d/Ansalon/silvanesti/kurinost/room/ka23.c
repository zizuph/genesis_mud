...
create_kurinost_room()
{
    ...
    add_item(({"Alinost","alinost"}),"Across the thicket of "+
        "brambles you can see the town of Alinost.  It look like it "+
        "was once a decent sized town.  Now, however, it appears "+
        "deserted as the elves have been evacuating their homeland.\n");


    add_exit(KROOM + "ka24","west",0);
    add_exit(KROOM + "ka22","east",0);
...
long_descr()
{
    return "You are travelling on the Kurinost-Alinost road.  It "+
        ...
        "Alinost lies to the north of here, but the brambles have "+
        "grown thick across the path northwards to the town.  From "+
        "where you stand Alinost looks deserted and not worth your "+
        "time anyway.\n";
}

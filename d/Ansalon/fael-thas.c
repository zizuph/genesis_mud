...
arm_me()
{
	...
	ob = clone_unique("/d/Krynn/icewall/castle2/obj/weapons/fael_sword", 5,
	  "/d/Krynn/icewall/castle2/obj/weapons/fael_crap_sword");
	ob->move(TO, 1);
    }
    else
    {
	ob = clone_unique("/d/Krynn/icewall/castle2/obj/weapons/wclaymore", 5,
    ...
    ob = clone_unique("/d/Krynn/icewall/castle2/obj/armours/fael_ring", 3);
    ob->move(TO, 1);

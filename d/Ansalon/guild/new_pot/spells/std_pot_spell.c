    ...
    switch (query_spell_name())
    {
        ...
        case "ppain":
            ...
            if (random(100) < SLIME_KEEP_PERCENTAGE)
            {
                ...
                write("As you stick " + LANG_THESHORT(ingrs[i]) + " into " +
                    "the elven heart, you let the blood drip onto " +
                    LANG_THESHORT(ingrs[j]) +
                    ", consuming the heart and shard.\n");
            }
            else
            {
                write("As you stick " + LANG_THESHORT(ingrs[i]) + " into " +
                    ...
                    "flames, consuming the heart and shard.\n");
            }
            break;
        case "prestore":
            if (IS_LEFTOVER_OBJECT(ingrs[0]))
            ...
            write("You rub " + LANG_THESHORT(ingrs[i]) + " with " +
                LANG_THESHORT(ingrs[!i]) + " and  a " +

...
/* commented out for ease of testing shadow and soul
...
*/
    ...
    sh = clone_object(POT_SHADOW);
    int shadow_result = sh->shadow_me(pl, GUILD_TYPE, 
...
// Added for ease of testing... skipping the ceremony crap
    set_mentor(TP);

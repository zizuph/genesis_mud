...
"glow.\n");
Toby (05:45 PM) : 
j�tte bra skada av special extra desc f�r enemy:
...
when it connetcs to your " + hdesc() +, hantering f�r br�nna eller kyla
Enemy: "The " + TO->short() + " wielded by " + QTNAME(TP) + suddenly release
a burst of its swirling glow towards your " + hdesc() + ", " + hantering f�r
br�nna eller kyla

Toby (06:10 PM) : 
Ingen special 40% chans f�r meddelande:

...
public int query_cosmetic() { return 0; }
...
remove_all_extra(object obj)
{
    ...
    if (query_cosmetic())
    {
        obj->add_prop(MAGIC_AM_ID_INFO, "This item has previously been " +
        "shrouded in darkness, its residual effect prevents any magical " +
        "identification.\n");
        obj->add_prop(MAGIC_AM_MAGIC, ({ "enchantment", 5 }));
...
*/
    obj->add_prop(MAGIC_AM_ID_INFO, this_object()->query_identify_info());
...
query_recover()
{
    ...
    return "/d/Ansalon/guild/new_pot/rituals/obj/recover:" +

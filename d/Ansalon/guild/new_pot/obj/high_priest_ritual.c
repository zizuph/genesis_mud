...
create_object()
{
    set_name("high_priest_ritual");

    add_prop(OBJ_S_WIZINFO,
        "This is an object that plays out a ritual for the " +
        "High Priests of Takhisis. It should selfdestruct after " +
        "finishing.\n");
...
ritual()
{
    ...
    switch(round++)
    {
        ...
        case 20:
            ...
            "knowing you are now a High Priest of Takhisis!\n");

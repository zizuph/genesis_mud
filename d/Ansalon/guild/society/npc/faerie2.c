...
faerie_eat(string str)
{
        ...
        if (member_array(this_object(), faeries) != -1)
        {
            write("A moment of panic shows on the " + LANG_POSS(short()) +
                " face as you swallow " + this_object()->query_objective() +
                " whole.\n");
            say("A moment of panic shows on the " + LANG_POSS(short()) +
                " face as " + QTNAME(this_player()) + " swallows " +
                this_object()->query_objective() + " whole.\n");

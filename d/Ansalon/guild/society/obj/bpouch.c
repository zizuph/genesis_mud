/* 
 * /d/Ansalon/guild/society/obj/bpouch.c
 *
 ...
 * Decay removed on 21 May 2004 by Mercade
 */
...
create_wearable_pack()
{
    ...
    set_short("blue belt of pouches");
    set_pshort("blue pouch-belts");
    add_name(({"belt", "pouches", "belts", "pouch-belt", "pouch"}));
    add_adj("blue");
    set_long("A set of large voluminous pouches of blue leather hanging " +

/* 
 * /d/Ansalon/guild/society/obj/gpouch.c
 *
 ...
 *
 * Colours added on 24 Sept 1999 by Gwyneth
 * Decay removed by Mercade on 21 May 2004
 */
...
create_wearable_pack()
{
    ...
    set_short("green belt of pouches");
    set_pshort("green pouch-belts");
    add_name(({"belt", "pouches", "belts", "pouch-belt", "pouch"}));
    add_adj("green");
    set_long("A set of large voluminous pouches of green leather hanging " +
      "from a thick leather belt makes up the kender pouch-belt. " +

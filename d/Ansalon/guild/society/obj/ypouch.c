/* 
 * /d/Ansalon/guild/society/obj/ypouch.c
 *
 ...
 *
 * Colours added 24 Sept 1999 by Gwyneth
 * Decay removed by Mercade, 21 May 2004
 */
...
create_wearable_pack()
{
    ...
    set_short("yellow belt of pouches");
    set_pshort("yellow pouch-belts");
    add_name(({"belt", "pouches", "belts", "pouch-belt", "pouch"}));
    add_adj("yellow");
    set_long("A set of large voluminous pouches of yellow leather hanging " +

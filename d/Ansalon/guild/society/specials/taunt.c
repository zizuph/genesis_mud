                ...
                mixed *results)
{
    ...
    if (task > 0)
    {
        ...
        actor->catch_msg("\n" + QCTPNAME(enemy) + " " + message + " as you " +
        "taunt " + enemy->query_objective() + ", yelling: " + taunt + "\n\n");
        ...
        if (!enemy->query_kender_rage())
        {
            ...
            taunt_obj = clone_object(TAUNT_OBJ);
            taunt_obj->move(enemy);
            taunt_obj->start();
        }

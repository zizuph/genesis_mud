/******************************************************
 *  Solamnic boots for The Death Knights of Krynn     *
...
create_armour()
{
    ...
    set_adj("blackened");
    add_adj("solamnic");
    set_short("pair of blackened solamnic boots");
    set_long("This is a pair of solamnic boots, made from hardened "+
    ...
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_ARMOUR(35, A_FEET));

/* Navarre July 3rd 2006, fixed typo, had bracers instead
 * of greaves in the long description
 */

/******************************************************
 *  Solamnic greaves for The Death Knights of Krynn   *
...
create_armour()
{
    ...
    set_adj("blackened");
    add_adj("solamnic");
    set_short("pair of blackened solamnic greaves");
    set_long("This is a pair of solamnic greaves, made from hardened "+

...
{
    // add check for hoopak and pebble
}
...
validate_requirements(object player)
{
    ...
    {
        notify_fail("You're too busy thinking about running away to sling!\n");
        return 0;
    }
    */

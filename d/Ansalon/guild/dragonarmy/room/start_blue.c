...
create_sanction_room()
{
    ...
    add_exit(DGUILD + "train_blue","south",0);
...
start(string str)
{
    ...
    if(TP->set_default_start_location(DRAGONARMY_BLUE_STARTLOC))
    {

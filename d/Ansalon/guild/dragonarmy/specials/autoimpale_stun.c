...
{    
    ...
    // With a cycle time of 120 seconds at 5% combat aid, that means
    // 6 seconds of stun, with the maximum of 18 seconds for cooldown
    // on the stun. Times will be slightly higher with the 90% chance
    // on the autoimpale tohit.

    set_stun_combat_aid(0);  // stun removed August 2017

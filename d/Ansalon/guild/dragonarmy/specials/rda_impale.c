...
#define     WOUNDING_CAID   0
#define     WOUNDING_OBJ    "/d/Genesis/specials/std/wounding_obj_base"

// Wound attack disabled
#define     WOUND_ATTACK_ENABLED 0
                ...
                int dam, mixed * items, int result)
{
    ...
    //      Wound special removed July 2017  
      
        if ((dam > 0) && WOUND_ATTACK_ENABLED)
        {
            ...
            wound_obj->set_wounding_time(120); // 2 minutes

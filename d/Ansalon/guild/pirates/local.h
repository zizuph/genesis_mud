...
#define PBASH_OBJ              GUILD_OBJ + "pirate_pbash"
#define PSTAGGER_OBJ           GUILD_OBJ + "pirate_stagger"
...
#define PIRATE_RANK(x)      (x)->query_guild_level_lay()
#define IS_PIRATE_LORD      21

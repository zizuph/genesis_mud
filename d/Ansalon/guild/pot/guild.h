...
#define GUILDDIR	"/d/Ansalon/guild/pot/"
...
#define GUILDMASTERS	({ "arman", "carnak" })
 ...
 */
#define SKILL_LEVELS ([ \
 SS_SPELLCRAFT :        ({ 50, 50, 50, 50, 50, 60, 60, 70, 74, 84, 90 }),\
 SS_ELEMENT_LIFE :      ({  0, 10, 20, 45, 45, 60, 60, 70, 74, 84, 90 }),\
 SS_ELEMENT_AIR :       ({ 10, 10, 20, 20, 35, 45, 45, 60, 64, 64, 70 }),\
 SS_ELEMENT_WATER :     ({  0,  0,  4,  4, 10, 10, 10, 15, 15, 15, 20 }),\
 SS_ELEMENT_EARTH :     ({  0,  0,  4, 14, 14, 14, 14, 14, 20, 20, 20 }),\
 SS_FORM_TRANSMUTATION: ({  0,  0,  0, 25, 25, 44, 44, 60, 64, 74, 84 }),\
 SS_FORM_ENCHANTMENT :  ({  0,  0, 15, 30, 40, 40, 40, 55, 60, 64, 70 }),\
 SS_FORM_DIVINATION :   ({ 10, 15, 15, 20, 20, 20, 24, 34, 34, 34, 34 }),\
 SS_FORM_CONJURATION :  ({  0,  0, 10, 10, 10, 15, 15, 20, 20, 20, 24 }),\
 SS_WEP_CLUB :          ({ 30, 30, 30, 40, 50, 60, 60, 60, 64, 64, 64 }),\
 SS_DEFENCE :           ({ 40, 40, 40, 50, 50, 50, 50, 60, 60, 60, 60 }),\
 ...
 SS_PARRY :             ({ 10, 10, 10, 14, 14, 14, 14, 20, 30, 30, 34 }),\
 SS_WEP_KNIFE :         ({ 30, 30, 30, 40, 40, 40, 50, 50, 50, 50, 50 }),\
])

...
armour_bonus(string str)
{
    setuid();
    seteuid(getuid());
    object evade_object = clone_object("/d/Ansalon/guild/neidar/specials/special_armour_bonus");
...
shield_master(string str)
{
    ...
    setuid();
    seteuid(getuid());
    object evade_object = clone_object("/d/Ansalon/guild/neidars/specials/special_shieldblock");
    evade_object->set_effect_caster(this_player());
...
{
    return ([
    "chop" : "/d/Ansalon/guild/neidar/specials/special_attack_chop",
     ]);
}

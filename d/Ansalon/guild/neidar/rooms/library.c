...
create_dwarf_room()
{
    ...
    add_item(({"books","tomes","stone books"}),
        ...
        "explains how to access and add to all the wisdom of the Neidar and Shieldbearers "+
        "held in this place.\n");
    ...
    set_library_book_object(GUILD_OBJS + "stone_book");
             ...
             string book_id = "")
{
    ...
    CREATE_MAIL("New book " + author, "Neidar_libr",
                implode(names, ","), "",
                "========================================================="
              + "======================\n"
              + "Title: " + title + "\n"

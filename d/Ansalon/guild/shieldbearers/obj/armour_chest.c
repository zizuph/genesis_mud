...
create_rack()
{
    ...
    set_adj("iron");
    set_adj("studded");
    set_short("iron studded chest");
    set_long("This is a very large chest studded with iron, " 
        + "used to hold all the armours used by "
        + "shieldbearers. See <chesthelp> for instructions "
        + "on how to use it.\n");

...
shieldslam_special(string str)
{
    ...
    /*  This check was remove by Navarre
	I don't see a reason why Neidars should be punished
	more than other guilds.
	With the check in place Neidars cant do their occ attack
	and their layman attack at the same time.
	Mercenaries or knights or any other guild that is a
	shieldbearer can do both.

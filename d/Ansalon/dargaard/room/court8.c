...
{
    set_short("Southeastern part of the Courtyard of Dargaard Keep");
    set_long(tod_descr()+ "" +season_descr()+ "You are in the courtyard"+
		             ...
		             " wind."+
		             " The courtyard extends to the northwest, northeast and west."+
		             " To the southwest is the castle's main gate to the"+
		             " wilderness.\n"); 

    add_exit(DROOM + "court5","northwest",0);
    add_exit(DROOM + "court6","northeast",0);
    add_exit(DROOM + "court7","west",0);	
    add_exit(DROOM + "court0","southwest",0);

...
create_dargaard_room()
{
    ...
    set_long("This is a dark alcove. Slime and fungus covers the"+
             " walls. On some places of the walls you still can see"+
	           " the once beautiful ornaments. A few torches lite up "+
             "the hallway, which continues to the north, south and "+
             "southwest.\n"); 
    ...
    add_item(({"stone floor", "floor"}), 
     ...
     " practicalitey normal stone was used in this corridor. Probably"+ 
    ...
    add_exit(DROOM + "room7","north",0);
    add_exit(DROOM + "room9","south",0);
    add_exit(DROOM + "nowhere","east","@@nowhere",0);
    add_exit(DROOM + "room3","southwest",0);

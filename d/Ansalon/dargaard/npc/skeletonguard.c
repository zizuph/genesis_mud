...
create_krynn_monster()
{
    ...
    switch(random(3))
    {
        case 0:
            ...
            set_long("The skeleton is covered with shards of "+
                     ...
                     "bones. The skeleton might have been "+
                     "one of the guards that Lord Soth hired "+
                     "to protect his keep from raiders and "+
                     "draconians. However the skeleton looks "+
                     "rather weak. One of his arms has broken "+
                     "off and he can barely drag himself through "+
                     "the hallway.\n");
        ...
        case 1:
            ...
            set_long("The skeleton is covered with shards of "+
                     ...
                     "one of the guards that Lord Soth hired "+
                     "to protect his keep from raiders and "+
                     "draconians. The skeleton looks like a "+
                     "capable fighter.\n");
        ...
        case 2:
            ...
            set_long("The skeleton is covered with shards of "+
                     ...
                     "one of the guards that Lord Soth hired "+
                     "to protect his keep from raiders and "+
                     "draconians. The skeleton must be one "+
                     "of the veteran fighter that once commanded "+
                     "a group of guards here.\n");
    ...
    add_act("emote turns his empty eye sockets at you.");
    add_act("emote howls: Death to all mortals!");
    add_act("emote howls: I shall protect this Keep forever!");

...
create_steppe_room()
{
    set_short("On a road before the gates of Port Balifor");
    set_long("@@long_descr");
    ...
    add_item(({"bush","stumpy tree","tree","bird","bird of prey"}),
      ...
      "dinner.\n");
    add_item(({"gates","gate","port city","city","Balifor",
	"Port Balifor","balifor","port balifor"}),
      "To your southwest stand the gates to the port city " +
      "of Balifor.\n");
    ...
    add_exit(SROOM + "road10","northeast",0);
    add_exit("/d/Ansalon/balifor/port_balifor/room/gate",
      "southwest","@@pass_gate");
...
long_descr()
{
    ...
    "sparsely around the plains. To your southwest stands " +
    "the open gates to a large port city.\n";
}

int
pass_gate()
{
    write("You pass through the gates of the Port City of " +
      "Balifor.\n");
    return 0;
}

...
create_flotsam_room()
{
    ...
    add_exit(FOREST_PATH + "/dark_forest/path1","northeast","@@str_check");
    add_exit(FOREST_PATH + "/dark_forest/path3","northwest","@@str_check");
...
animal_trail()
{
	...
	"tracks. The trail heads northeast and northwest.\n";
    }
    ...
    "stealthfully. The trail heads northeast and northwest.\n";
}

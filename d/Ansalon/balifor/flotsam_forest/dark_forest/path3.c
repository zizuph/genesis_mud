...
create_flotsam_room()
{
    ...
    add_exit(FOREST_PATH + "/dark_forest/path2","southeast","@@str_check");
    add_exit(FOREST_PATH + "/dark_forest/path4","southwest","@@str_check");
...
animal_trail()
{
	...
	"tracks. The trail heads southeast and southwest.\n";
    }
    ...
    "stealthfully. The trail heads southeast and southwest.\n";
}

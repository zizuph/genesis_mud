...
tod_descr1()
{
   ...
   {
      case TOD_NIGHT:
      str = "It is night in the fields outside of Flotsam. ";
      break;
      case TOD_DAWN:
      str = "It is morning in the fields outside of Flotsam. ";
      break;
      case TOD_DAY:
      str = "It is day in the fields outside of Flotsam. ";
      break;
      case TOD_TWILIGHT:
      str = "It is evening in the fields outside of Flotsam. ";
      break;
   }
   return str;
}

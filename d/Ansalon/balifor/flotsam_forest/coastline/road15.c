...
create_flotsam_room()
{
   ...
   add_item(({"forest","shadows","shadows of the forest",
            "forboding forest"}),
      "To your west stands a forboding forest as ancient as the " +
      "sea it overlooks.\n");
   add_item(({"green grass","grass"}),"Between the forest and " +
      "the cliff's edge is a lush carpet of green grass.\n");
   
   
   add_exit(CROOM + "road16","north",0);
   add_exit(CROOM + "road14","northwest",0);
   add_exit(CROOM + "road17","southeast",0);
...
long_descr()
{
   ...
   "the Bloodbay. The forest to the west seems hesitant " +

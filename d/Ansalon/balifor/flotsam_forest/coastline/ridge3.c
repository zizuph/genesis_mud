...
create_flotsam_room()
{
    ...
    add_invis_exit(CROOM + "ridge2","south",0);

    add_cmd_item("down","climb","@@climb_cliff");
...
long_descr()
{
    ...
    "the cliff to the " +
    "south, " +
    "and you could probably climb down from here if you " +
    "wished to get closer to the bottom of the cliff.\n";
}

string
climb_cliff()
{
    write("You climb further down the cliffside.\n");
    TP->move_living("down the cliffside",
      CROOM + "cliff_bottom.c",1,0);
    return "";
}

...
create_flotsam_room()
{
    ...
    add_exit(FROOM + "roade","north","@@leave_forest");
    add_exit(FROOM + "road2","south",0);
    add_exit(FROOM + "road3","southeast",0);
...
temp_no_go()
{
    write("A wagon has been overturned by some great " +
      "beast to the southeast, blocking any passage in that " +

...
create_flotsam_room()
{
   ...
   add_item(({"rough path","path","rocks","cobblestone"}),
      ...
      "southeast " +
      "towards a farmhouse.\n");
   add_item(({"well maintained farmhouse","farmhouse","house"}),
      "To the southest you can see a well maintained farmhouse.\n");
   
   
   add_exit(FROOM + "roadb","west",0);
   add_exit(FROOM + "pathb","east",0);
   add_exit(FROOM + "pathf","southeast",0);
...
long_descr()
{
   ...
   "southeast " +
   "towards a well maintained looking farmhouse, " +

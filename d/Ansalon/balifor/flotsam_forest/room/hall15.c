...
create_flotsam_room()
{
    ...
    add_exit(FROOM + "hall2","northwest",0);
    add_exit(FROOM + "hall3","north",0);
    add_exit(FROOM + "hall4","northeast",0);
    add_exit(FROOM + "hall5","east",0);
    add_exit(FROOM + "hall","south",0);
    add_exit(FROOM + "hall1","west",0);

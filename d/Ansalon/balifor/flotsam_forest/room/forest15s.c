...
create_flotsam_room()
{
   ...
   add_item("branches","The branches of great oaks sway " +
      "with the wind.\n");
   add_item(({"small clearing","clearing","natural grove","grove"}),
      "Through the trees to your southeast a natural grove " +
      "opens up before you. You could probably enter it " +
   ...
   add_invis_exit(FROOM + "forest16s","north",0,4);
   add_invis_exit(FROOM + "nowhere","south","@@no_go");
   add_invis_exit(FROOM + "nowhere","east","@@no_go");
   add_invis_exit(FROOM + "forest14s","west",0,4);
   add_invis_exit(FROOM + "g31","southeast",0);
...
long_descr()
{
   ...
   "Through the trees and underbrush to your southeast you can " +
   "make out a small clearing." +
   tod_descr2() + 
   "\n";
}

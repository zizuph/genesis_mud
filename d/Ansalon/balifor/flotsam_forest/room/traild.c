...
create_flotsam_room()
{
    ...
    add_item(({"small trail","trail"}),
      "A small trail runs up the side of the river bank and into the forest " +
      "to your northeast.\n");

    add_exit(FROOM + "trailc","northwest",0);
    add_exit("/d/Ansalon/guild/kender/room/r1","northeast",0);
    add_exit(FROOM + "nowhere","southeast","@@no_go");
...
no_go()
{
    write("The river bank becomes too steep to the southeast " +
      "to follow it without getting your feet wet.\n");
    return 1;
}
...
long_descr()
{
    ...
    " What looks like a small trail leads off to the " +
    "northeast up the river bank and into the forest." +
    tod_descr2()+
    "\n";
}

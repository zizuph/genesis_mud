/*
 * Added Habbakuk revelation for the OotS lay guild
 * when you drink from the pool
 */
...
create_flotsam_room()
{
    ...
    add_exit(FROOM + "g16","northwest",0);
...
drink_water()
{
	...
	write("You are quite full of water at the moment, and don't feel like drinking " +
	  "anymore.\n");
    return "";
}

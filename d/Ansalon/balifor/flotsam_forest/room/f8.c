...
create_flotsam_room()
{
   ...
   add_item("branches","The branches of great oaks sway " +
      "with the wind.\n");
   add_item(({"clearing","grove"}),"Through the trees to your " +
      "northeast a natural grove opens up before you. You could " +
      "probably enter it by going in that direction.\n");
   ...
   add_invis_exit(FROOM + "f9","south",0,4);
   add_invis_exit(FROOM + "nowhere","east","@@no_go");
   add_invis_exit(FROOM + "f7","west",0,4);
   add_invis_exit(FROOM + "g11","northeast","@@enter_glade");
...
long_descr()
{
   ...
   " Through the trees and underbrush to your northeast you " +
   "can make out a small clearing." +
   tod_descr2() + 
   "\n";
}
...
enter_glade()
{
   write("You step through the trees and into a " +
      "lush glade.\n");
   return 0;
}

...
create_flotsam_room()
{
    ...
    add_exit(FROOM + "road1","north",0);
    add_exit(FROOM + "road14","south",0);
...
closed()
{
    write("An overturned cart blocks the road to " +
      "Port Balifor. Perhaps you should come back later when the road " +
      "is reopened?\n");
    return 1;
}

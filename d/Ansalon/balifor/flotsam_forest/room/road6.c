...
create_flotsam_room()
{
   ...
   add_exit(FROOM + "road5","northwest",0);
   add_exit(FROOM + "road7","southeast",0);
   add_invis_exit(FROOM + "nowhere","north","@@no_go");
   add_invis_exit(FROOM + "nowhere","south","@@no_go");
   add_invis_exit(FROOM + "f1","east","@@enter_forest");
   add_invis_exit(FROOM + "forest7s","west","@@enter_forest");

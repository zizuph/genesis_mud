...
create_flotsam_room()
{
   ...
   add_item("branches","The branches of great oaks sway " +
      "with the wind.\n");
   add_item(({"clearing","small clearing","grove","natural grove"}),
      "Through the trees to your northeast a natural grove opens up " +
      "before you. You could probably enter it by going in that " +
      "direction.\n");
   ...
   add_invis_exit(FROOM + "f14","south",0,4);
   add_invis_exit(FROOM + "nowhere","east","@@no_go");
   add_invis_exit(FROOM + "f12","west",0,4);
   add_invis_exit(FROOM + "g41","northeast",0);

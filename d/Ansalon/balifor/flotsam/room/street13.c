...
create_flotsam_room()
{
   ...
   add_item(({"soldiers","mercenaries"}),"Drunken soldiers of " +
      ...
      "stumble through the street. It would be best to keep out " +
      "of their way if you don't want trouble. \n");
   add_item("patrols","Heavily armed patrols wander the streets, stopping " +
      "newcomers to Flotsam, interrogating them and occasionally " +
      "arresting them. You wonder what they are looking for?\n");
   
   add_exit(FROOM + "street12","north",0);
   add_exit(FROOM + "street14","east",0);
   add_exit(FROOM + "street39","south",0);

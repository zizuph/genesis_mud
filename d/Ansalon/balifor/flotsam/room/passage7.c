...
create_flotsam_room()
{
   ...
   add_item("passageway","The passageway leads east and west " +
      "into shadows.\n");
   
   add_exit(FROOM + "passage8","east",0);
   add_exit(FROOM + "passage6","west",0);
...
long_descr()
{
   ...
   "evil place. " +
   "The cold stone walls of the passage continue to the " +
   "east and west. " +
   "\n";
}

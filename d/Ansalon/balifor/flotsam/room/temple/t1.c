...
create_flotsam_room()
{
   ...
   add_item(({"wall","walls","black marble walls","marble walls",
      ...
      "red colour.\n");
   add_item("illusionary wall","To the west is an illusion " +
   ...
   add_exit(FROOM + "passage4","west","@@enter_wall");
   add_exit(TEMP + "t3","south",0);
   DARK;
...
long_descr()
{
   ...
   "the illusionary wall to the west to take you back to the cellar. " +
   "\n";
}

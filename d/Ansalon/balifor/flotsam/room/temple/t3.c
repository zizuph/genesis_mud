...
create_flotsam_room()
{
   ...
   add_item(({"temple","ancient temple","evil temple"}),
      ...
      "the cataclysm. It is most likely a relic of Edon, " +
      "a part of Istar that controlled much of what is now " +
      "Goodlund, but is now ruins.\n");
   
   add_exit(TEMP + "t1","north",0);
   add_exit(TEMP + "t4","southwest",0);

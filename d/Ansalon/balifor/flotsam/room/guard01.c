...
create_flotsam_room()
{
   ...
   add_item(({"gate","gates"}),"To the south is one of the " +
      "gates out of Flotsam.\n");
   add_item(({"card","cards"}),"On the table is a pack of " +
      "36 cards, each one bearing the symbol of one of the old gods.\n");
   
   add_exit(FROOM + "street21","south","@@guard_exit",0);

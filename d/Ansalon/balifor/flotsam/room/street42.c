...
create_flotsam_room()
{
   set_short("Street corner in the western part of Flotsam");
   set_long("@@long_descr");
   ...
   add_item(({"soldiers","mercenaries"}),"Drunken soldiers " +
      ...
      "stumble through the street. It would be best to keep out of their way if you " +
      "don't want trouble.\n");
   add_item("patrols","Heavily armed patrols wander the streets, stopping newcomers to Flotsam, interrogating them, and occasionally arresting them. You wonder what they are looking for?\n");
   add_item("sidewalk","You find nothing of interest with the sidewalk.\n");
   
   add_exit(FROOM + "street41","north",0);
   add_exit(FROOM + "street38","east",0);
   add_exit(FROOM + "alley","southwest",0,1,1);
...
long_descr()
{
   ...
   "clouds overhead. A dark alley is just to the southwest of you. " +
   season_descr() + "\n";

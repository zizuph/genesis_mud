...
create_solamn_room()
{
   ...
   add_exit(SROOM + "road19","south",0);
   add_exit(SROOM + "road17","northeast",0);
...
long_descr()
{
   ...
   "lining the path. To your northeast the road continues " +
   "towards Kalaman, and to the south it curves towards Dargaard " +
   "Pass into Solamnia.\n";
}

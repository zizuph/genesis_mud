...
create_solamn_room()
{
   ...
   add_item(({"cloud","dust","dust cloud"}),
      "Probably kicked up off the road by something moving, but " +
      "its too far away to make anything out.\n");
   ...
   add_exit(SROOM + "road27","south",0);
   add_exit(SROOM + "road25","north",0);
...
long_descr()
{
   ...
   "towards Kalaman, and to the south it curves towards " +
   "Dargaard Pass into Solamnia. You see a faint cloud of dust " +

...
create_weapon()
{
    ...
    add_adj("kender");
    add_name("staff");
    set_short("oak hoopak");
    set_long("@@long_desc@@");
    set_default_weapon(15,15,W_POLEARM, W_BLUDGEON | W_IMPALE, W_ANYH);
    add_prop(OBJ_I_VOLUME, 250);
    add_prop(OBJ_I_VALUE, F_VALUE_WEAPON(25,20)); 
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(20, W_POLEARM));
    set_wf(TO);
    tstaff = this_object();
}
...
long_desc()
{
	...
	"one. It is made from a single piece of tough oak wood that, " + 

...
create_kendermore_room()
{
    ...
    add_invis_exit(KROOM + "forest5", "northwest", 0);
    add_invis_exit(KROOM + "forest8", "southeast", 0);
    add_invis_exit(KROOM + "forest10", "southwest", 0);
    add_invis_exit(KROOM + "forest4", "north", 0);
    add_invis_exit(KROOM + "forest9", "south", 0);
    add_invis_exit(KROOM + "forest7", "east", 0);
    add_exit(KROOM + "trail4", "west", 0);
    add_exit(KROOM + "trail2", "northeast", 0);

...
create_kendermore_room()
{
    ...
    add_exit(KROOM + "street54", "south", 0);
    add_exit(KROOM + "street52", "northeast", 0);
    add_exit(KROOM + "pc_office", "northwest", "@@in_message@@");
...
in_message()
{
    write("You hear a lot of noise coming from the waiting " +
...
long_descr()
{
    return (tod_descr() + season_descr() + "Houses stand on both sides " + 
        ...
        "winding way to the northeast and south. Numerous signs point " + 

...
{
    set_short("A busy street in Kendermore");
    set_long("@@long_descr");
    ...
    add_exit(KROOM + "street22", "southeast", 0);
    add_exit(KROOM + "street20", "southwest", 0);
...
enter_house()
{
    ...
    tell_room(KROOM + "house4", "The door opens, and " + QTNAME(TP) +  
        "enters the house.\n");
    TP->move_living("M", KROOM + "house4", 1, 0);
    return "";
}

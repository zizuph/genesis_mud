...
leave_house()
{
    ...
    tell_room(KROOM + "street29", "The door opens, and " + QTNAME(TP) +  
        " steps onto the street.\n");
    TP->move_living("M", KROOM + "street29", 1, 0);
    return "";
}
...
squeeze_out()
{
    ...
    tell_room(KROOM + "street29", QCTNAME(TP) + " comes tumbling out " + 
...
search_beds()
{
    ...
    return("You find something interesting in the beds!\n");
    say(QCTNAME(TP) + " finds something in the beds.\n");
}

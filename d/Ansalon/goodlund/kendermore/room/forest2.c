...
create_kendermore_room()
{
    ...
    add_item(({"trail","dirt trail"}), "A dirt trail runs through the " + 
        "forest to your south, southwest and southeast.\n");
    ...
    add_invis_exit(KROOM + "forest3", "west", 0);
    add_invis_exit(KROOM + "forest1", "east", 0);
    ...
    add_exit(KROOM + "forest4", "southwest", 0);
    add_exit(KROOM + "trail2", "south", 0);
    add_exit(KROOM + "trail1", "southeast", 0);
...
long_descr()
{
    return(tod_descr() + season_descr() + "You stand in the midst of a " + 
        ...
        "small dirt trail winds through the forest to the south, " + 

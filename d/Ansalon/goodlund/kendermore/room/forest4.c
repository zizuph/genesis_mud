...
reset_kendermore_room()
{
    ...
    if(!squirrel)
    {
        if(!P(squirrel, TO))
        {
            squirrel = clone_object(KNPC + "squirrel");
            squirrel->move(TO);
            squirrel = clone_object(KNPC + "squirrel");
            squirrel->move(TO);
            squirrel = clone_object(KNPC + "squirrel");
...
create_kendermore_room()
{
    ...
    add_item(({"trail","dirt trail"}), "A dirt trail runs through the " + 
        "forest to your south, east and southwest.\n");
    ...
    add_item(({"hut", "small hut"}), "A small, windowless hut blocks your " + 
    ...
    add_invis_exit(KROOM + "forest5", "west", 0);
    add_invis_exit(KROOM + "forest3", "north", 0);
    add_invis_exit(KROOM + "forest2", "northeast", 0);
    add_invis_exit(KROOM + "forest7", "southeast", 0);
    add_exit(KROOM + "trail2", "east", 0);
    add_exit(KROOM + "trail3", "south", 0);
    add_exit(KROOM + "trail4", "southwest", 0);
...
long_descr()
{
    return(tod_descr() + season_descr() + "You stand in the midst of a " + 
        ...
        "hut stands to your northwest, and a " + 
        "dirt trail winds through the forest to the south, east and " + 
        "southwest.\n");
}

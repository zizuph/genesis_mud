...
create_kendermore_room()
{
    ...
    add_exit(KROOM + "street19", "north", 0);
    add_exit(KROOM + "street17", "south", "@@loose_stone");
...
loose_stone()
{
    write("You trip over a loose stone as you walk to the south.\n");
    return 0;
}

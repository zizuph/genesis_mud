...
create_kendermore_room()
{
    ...
    add_invis_exit(KROOM + "forest7", "west", 0);
    add_exit(KROOM + "trail2", "northwest", 0);
    add_exit(KROOM + "trail1", "north", 0);
    add_invis_exit(KROOM + "spring", "south", 0);
    add_invis_exit(KROOM + "forest8", "southwest", 0);
...
long_descr()
{
    return(tod_descr() + season_descr() + "You stand in the midst of a " + 
        ...
        "small dirt trail winds through the forest to the north and " + 
        "northwest.\n");
}

...
create_kendermore_room()
{
    ...
    add_invis_exit(KROOM + "forest9", "west", 0);
    add_invis_exit(KROOM + "spring", "east", 0);
    add_invis_exit(KROOM + "forest7", "north", 0);
    add_invis_exit(KROOM + "forest6", "northeast", 0);
    add_exit(KROOM + "trail3", "northwest", 0);
...
long_descr()
{
    return(tod_descr() + season_descr() + "You stand in the midst of a " + 
        ...
        "small dirt trail winds through the forest to the " + 
        "northwest.\n");
}

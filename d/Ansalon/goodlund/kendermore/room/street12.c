...
{
    set_short("A twisty side street");
    set_long("@@long_descr");
    ...
    add_exit(KROOM + "street13", "west", 0);
    add_exit(KROOM + "street11", "northeast", 0);
...
enter_house()
{
    ...
    tell_room(KROOM + "house2", "The door opens, and " + QTNAME(TP) +  
        " enters the house.\n");
    TP->move_living("M", KROOM + "house2", 1, 0);
    return "";
}

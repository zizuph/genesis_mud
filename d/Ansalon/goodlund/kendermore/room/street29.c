...
create_kendermore_room()
{
    ...
    add_exit(KROOM + "street30", "northeast", 0);
    add_exit(KROOM + "street28", "northwest", 0);
...
enter_house()
{
    ...
    tell_room(KROOM + "house5", "The door opens, and " + QTNAME(TP) +  
        " enters the house.\n");
    TP->move_living("M", KROOM + "house5", 1, 0);
    return "";
}

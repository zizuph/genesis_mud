...
create_kendermore_room()
{
    ...
    add_item(({"trail","dirt trail"}), "A dirt trail runs through the " + 
        "forest to your north, northeast and west.\n");
    ...
    add_invis_exit(KROOM + "forest4", "northwest", 0);
    add_invis_exit(KROOM + "forest6", "east", 0);
    add_invis_exit(KROOM + "forest9", "southwest", 0);
    add_invis_exit(KROOM + "forest8", "south", 0);
    add_invis_exit(KROOM + "spring", "southeast", 0);
    add_exit(KROOM + "trail2", "north", 0);
    add_exit(KROOM + "trail1", "northeast", 0);
    add_exit(KROOM + "trail3", "west", 0);
...
long_descr()
{
    return(tod_descr() + season_descr() + "You stand in the midst of a " + 
        ...
        "small dirt trail winds through the forest to the north, northeast " + 
        "and west.\n");
}

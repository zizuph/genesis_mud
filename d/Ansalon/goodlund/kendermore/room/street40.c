...
switch_street()
{
    if (GET_MONTH > 6)
    {
        add_invis_exit("null", "west", "@@blocked_street");
        add_invis_exit("null", "east", "@@blocked_street");
        add_exit(KROOM + "street41", "southwest", 0);
        add_exit(KROOM + "street39", "southeast", 0);
    }
    else
    {
        add_invis_exit("null", "southwest", "@@blocked_street");
        add_invis_exit("null", "southeast", "@@blocked_street");
        add_exit(KROOM + "street41", "west", 0);
        add_exit(KROOM + "street39", "east", 0);
    }
}

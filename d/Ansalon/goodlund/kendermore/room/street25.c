...
{
    set_short("A wide twisty street");
    set_long("@@long_descr");
...
switch_street()
{
    if (GET_MONTH > 6)
    {
        ...
        add_exit(KROOM + "street27", "south", 0);
        add_exit(KROOM + "street26", "northeast", 0);
        add_exit(KROOM + "street24", "southwest", 0);
    }
    else
    {
        ...
        add_exit(KROOM + "street27", "south", 0);
        add_exit(KROOM + "street26", "northeast", 0);
        add_exit(KROOM + "street24", "northwest", 0);
    }
}  

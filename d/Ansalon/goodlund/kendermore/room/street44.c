...
create_kendermore_room()
{
    ...
    add_exit(KROOM + "kip_store1", "northeast", 0);
    add_exit(KROOM + "street43", "southeast", 0);
    add_exit(KROOM + "street45", "southwest", 0);
...
long_descr()
{
    return (tod_descr() + season_descr() + "Houses stand on both sides " + 
        ...
        "winding way to the southeast and southwest. Numerous signs point " + 

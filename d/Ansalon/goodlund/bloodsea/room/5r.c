...
create_bloodsea_room()
{
    ...
    add_item(({"karthay","coastline", "isle of karthay","isle","island"}),
               ...
               "can make out the coastline of the isle of Karthay to your north and east.\n");
    ...
    add_row_exit(BROOM + "6r", "west", 0, 1);
    add_row_exit(BROOM + "5s", "north", 0, 1);
    add_row_exit(BROOM + "4r", "east", 0, 1);
    add_row_exit(BROOM + "5q", "south", 0, 1);
...
short_descr()
{
    return bloodsea_short() + ", near the isle of Karthay";
}

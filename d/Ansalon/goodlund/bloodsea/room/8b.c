...
create_bloodsea_room()
{
    ...
    add_row_exit(BROOM + "9b", "west", 0, 1);
    add_row_exit(BROOM + "8c", "north", 0, 1);
    add_row_exit(BROOM + "7b", "east", 0, 1);
    add_row_exit("/d/Krynn/south_courrain/room/s_courrain-17-0-B", "south", 0, 1);

...
create_bloodsea_room()
{
    ...
    add_row_exit(BROOM + "1d", "north", 0, 1);
    add_row_exit(BROOM + "2c", "west", 0, 1);
    add_row_exit(BROOM + "1b", "south", 0, 1);
    add_wade_exit(BROOM + "1d", "north", "@@swim_off", 1);
    add_wade_exit(BROOM + "1b", "south", "@@swim_off", 1);

...
create_sea_room()
{
    ...
    add_item(({"coastline","wild coastline","ogrelands","the ogrelands",
        "kern"}),
        "To your west you can make out the wild coastline of the " +
    ...
    add_row_exit(FROOM + "4c", "northwest", 0, 1);
    add_row_exit(FROOM + "4d", "north", 0, 1);
    add_row_exit(FROOM + "3e", "east", 0, 1);
    add_row_exit(FROOM + "2d", "south", 0, 1);
    add_row_exit(FROOM + "2c", "southwest", 0, 1);
    ...
    set_sailing_fail_message("The waters along the coastline of the" +
        "Ogrelands are particularly treacherous. You don't have the " +
...
long_descr()
{
    return bloodsea_desc()+ "To west is the wild coastline of the Ogrelands, while " +
        "to your south and southwest the calmer waters of Blood Bay open, providing " +
        "sailors some relief. "

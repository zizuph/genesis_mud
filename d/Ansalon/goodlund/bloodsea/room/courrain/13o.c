...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","cape of nordmaar","coastline"}),
       "To your southwest you can just make out the Cape of " +
       "Nordmaar, the home of the horse barbarians.\n");


    add_row_exit(CROOM + "13n", "west", 0, 1);
    add_row_exit(CROOM + "14o", "north", 0, 1);
    add_row_exit(CROOM + "13p", "east", 0, 1);
    add_row_exit(CROOM + "12o", "south", 0, 1);

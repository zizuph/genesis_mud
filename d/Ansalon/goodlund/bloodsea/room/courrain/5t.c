...
create_courrain_room()
{
    ...
    add_item(({"port","small port","jennison","smoke","fire","blaze"}),
       "Along the coastline to your west you can just make out the small " +
    ...
    add_row_exit(CROOM + "5s", "west", 0, 1);
    add_row_exit(CROOM + "6t", "north", 0, 1);
    add_row_exit(CROOM + "5u", "east", 0, 1);
    add_row_exit(CROOM + "4t", "south", 0, 1);

...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","kingdom of nordmaar","coastline",
       ...
       "To your south you can make out the verdant coastline of " +
       "the Cape of Nordmaar, the most northern point of the continent " +
       "of Ansalon. Its tropical climate and incredible humidity " +
       "has resulted in all types of strange plants growing here.\n");

    add_row_exit(CROOM + "14m", "north", 0, 1);
    add_row_exit(CROOM + "13l", "west", 0, 1);
    add_row_exit(CROOM + "13n", "east", 0, 1);
...
short_descr()
{
    return "along the northern side of the Cape of Nordmaar";
}
 
string
long_descr()
{
    return "You are close to the northern coastline of the Cape of Nordmaar. " +
       ...
       "on the ground. To your north stretches the vast Courrain Ocean.\n";
}
...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","cape of nordmaar","coastline"}),
       "To your west you can just make out the Cape of " +
       "Nordmaar, the home of the horse barbarians.\n");


    add_row_exit(CROOM + "12p", "west", 0, 1);
    add_row_exit(CROOM + "13q", "north", 0, 1);
    add_row_exit(CROOM + "12r", "east", 0, 1);
    add_row_exit(CROOM + "11q", "south", 0, 1);

...
create_courrain_room()
{
    ...
    add_row_exit(CROOM + "5e", "west", 0, 1);
    add_row_exit(CROOM + "6f", "north", 0, 1);
    add_row_exit(CROOM + "5g", "east", 0, 1);
    add_row_exit(CROOM + "4f", "south", 0, 1);
...
long_descr()
{
    return courrain_desc()+ "To your southeast you can just make out " +
      "the coastline of Estwilde, while to your south opens up the " +

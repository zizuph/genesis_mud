...
create_courrain_room()
{
    ...
    add_row_exit(CROOM + "7h", "northwest", 0, 1);
    add_row_exit(CROOM + "7i", "north", 0, 1);
    add_row_exit(CROOM + "7j", "northeast", 0, 1);
...
short_descr()
{
    return courrain_short()+ ", in an unsheltered bay off the coastline of Estwilde";
}

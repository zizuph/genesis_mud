...
create_courrain_room()
{
    ...
    add_row_exit(CROOM + "4t", "north", 0, 1);
    add_row_exit(CROOM + "3s", "west", 0, 1);
    add_row_exit(CROOM + "3u", "east", 0, 1);
...
long_descr()
{
    return "You are in the deep green tidal marshes " +
       ...
       "Kern, where hardy pines and exotic ferns grow in abundance. Far to your " +

...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","kingdom of nordmaar","coastline"}),
       "To your west you can just make out the rugged coastline of " +
       "Nordmaar, the home of the horse barbarians.\n");


    add_row_exit(CROOM + "11q", "west", 0, 1);
    add_row_exit(CROOM + "12r", "north", 0, 1);
    add_row_exit(CROOM + "11s", "east", 0, 1);
    add_row_exit(CROOM + "10r", "south", 0, 1);

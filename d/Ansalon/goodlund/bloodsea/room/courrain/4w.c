...
create_courrain_room()
{
    ...
    add_item(({"peninsula","kern","pines","kern peninsula", "trees",
       ...
       "To the southwest is a peninsula covered with hardy pines and " +
    ...
    add_row_exit(CROOM + "5w", "north", 0, 1);
    add_row_exit(CROOM + "4v", "west", 0, 1);
    add_row_exit(CROOM + "3x", "southeast", 0, 1);
    add_row_exit(CROOM + "4x", "east", 0, 1);
...
long_descr()
{
    return courrain_desc()+ "To the southwest rises the peninsula of " +

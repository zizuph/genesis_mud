...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","kingdom of nordmaar","coastline",
       ...
       "To your east you can make out the verdant coastline of " +
    ...
    add_row_exit(CROOM + "11k", "north", 0, 1);
    add_row_exit(CROOM + "10j", "west", 0, 1);
    add_row_exit(CROOM + "9j", "southwest", 0, 1);
...
short_descr()
{
    return "along the western side of the Cape of Nordmaar";
}
 
string
long_descr()
{
    return "You are close to the western coastline of the Cape of Nordmaar. " +

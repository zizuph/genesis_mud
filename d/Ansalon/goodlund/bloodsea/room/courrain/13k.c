...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","cape of nordmaar","coastline"}),
       "To your southeast you can just make out the Cape of " +
       "Nordmaar, the home of the horse barbarians.\n");


    add_row_exit(CROOM + "13j", "west", 0, 1);
    add_row_exit(CROOM + "14k", "north", 0, 1);
    add_row_exit(CROOM + "13l", "east", 0, 1);
    add_row_exit(CROOM + "12k", "south", 0, 1);

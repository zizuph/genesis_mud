...
create_courrain_room()
{
    ...
    add_item(({"city","ruins","ruins of city","valkinord"}),
       "Far to the northwest you can just make out the smoking ruins " +
       "of the city of Valkinord. Once a thriving trade centre for the " +
       "Nordmaarians, it has recently been overrun by the Red Dragonarmy, " +
       "and little is now left of it.\n");

    add_row_exit(CROOM + "4s", "northeast", 0, 1);
    add_row_exit(CROOM + "3s", "east", 0, 1);
...
long_descr()
{
    return "You are in the deep green tidal marshes " +
       ...
       "While largely a barren wasteland, you do notice far to the northwest " +
       "what looks like the smoking ruins of a city. Far to your " +

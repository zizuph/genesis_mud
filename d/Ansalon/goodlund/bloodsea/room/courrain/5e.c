...
create_courrain_room()
{
    ...
    add_item(({"coastline","solamnia"}),
       "To your southwest you can just make out the green coastline of " +
       "Solamnia.\n");
    add_item(({"estuary","river","vingaard river","great estuary"}),
       "To your south opens up the estuary of the longest river in Krynn, " +
       "the Vingaard River.\n");


    add_row_exit(TURBIDUS + "4zk", "west", "@@no_go", 1);
    add_row_exit(CROOM + "6e", "north", 0, 1);
    add_row_exit(CROOM + "5f", "east", 0, 1);
    add_row_exit(CROOM + "4e", "south", 0, 1);
...
short_descr()
{
    return courrain_short()+ ", in sight of the coastline of Solamnia";
}
 
string
long_descr()
{
    return courrain_desc()+ "To your southwest you can just make out " +
      "the coastline of Solamnia, while to your south opens up the " +
      "great estuary of the Vingaard River.\n";

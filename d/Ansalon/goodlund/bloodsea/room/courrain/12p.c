...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","kingdom of nordmaar","coastline",
       ...
       "To your southwest you can make out the verdant coastline of " +
    ...
    add_row_exit(CROOM + "13p", "north", 0, 1);
    add_row_exit(CROOM + "12o", "west", 0, 1);
    add_row_exit(CROOM + "11q", "southeast", 0, 1);
    add_row_exit(CROOM + "12q", "east", 0, 1);
...
long_descr()
{
    return "You are close to the northern coastline of the Cape of Nordmaar. " +
       ...
       "on the ground. To your north and east stretches the vast Courrain Ocean.\n";
}
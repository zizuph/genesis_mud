...
create_courrain_room()
{
    ...
    add_item(({"coastline","estwilde","foothills","rugged foothills",
       "barren coastline","hills"}),
       "You are near the barren coastline of Nordmaar. You notice little " +
       "of interest, with there being only lonely rugged foothills as " +
       "far as the eye can see.\n");
    add_item(({"estuary","river","vingaard river"}),
       "To your southwest opens up the great estuary of the longest " +
       "river in Krynn, the Vingaard River.\n");



    add_row_exit(CROOM + "5f", "west", 0, 1);
    add_row_exit(CROOM + "6g", "north", 0, 1);
    add_row_exit(CROOM + "4f", "southwest", 0, 1);
...
long_descr()
{
    return courrain_desc()+ " You are near the barren coastline of Estwilde, " +
        "dominated by little more than rugged foothills as far as the eye " +
        "can see. To your southwest opens up the great estuary of the " +
        "Vingaard River.\n";

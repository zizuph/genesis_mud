...
create_courrain_room()
{
    ...
    add_row_exit(CROOM + "7g", "west", 0, 1);
    add_row_exit(CROOM + "8h", "north", 0, 1);
    add_row_exit(CROOM + "7i", "east", 0, 1);
    add_row_exit(CROOM + "6g", "southwest", 0, 1);
    add_row_exit(CROOM + "6i", "southeast", 0, 1);

...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","kingdom of nordmaar","coastline"}),
       "To your east you can just make out the rugged coastline of " +
       "Nordmaar, the home of the horse barbarians.\n");


    add_row_exit(CROOM + "9h", "west", 0, 1);
    add_row_exit(CROOM + "10i", "north", 0, 1);
    add_row_exit(CROOM + "9j", "east", 0, 1);
    add_row_exit(CROOM + "8i", "south", 0, 1);
...
short_descr()
{
    return courrain_short()+ ", in sight of the coastline of Nordmaar";
}
 
string
long_descr()
{
    return courrain_desc()+ "To your east you can just make out " +

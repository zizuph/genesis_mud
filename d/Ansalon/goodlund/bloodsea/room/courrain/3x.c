...
#define FLOT_ROOM "/d/Ansalon/goodlund/bloodsea/room/flotsam/"
...
create_courrain_room()
{
    ...
    add_row_exit(CROOM + "4w", "northwest", 0, 1);
    add_row_exit(FLOT_ROOM + "7b", "southwest", 0, 1);
    add_row_exit(CROOM + "4x", "north", 0, 1);
    add_row_exit(CROOM + "xx", "east", "@@no_go");
    add_row_exit(FLOT_ROOM + "7c", "south", 0, 1);
...
short_descr()
{
    return courrain_short()+ ", near the peninsula of Kern";
}
 
string
long_descr()
{
    return courrain_desc()+ "To the west rises the peninsula of " +

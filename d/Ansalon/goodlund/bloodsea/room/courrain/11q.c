...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","kingdom of nordmaar","coastline",
       ...
       "To your west you can make out the verdant coastline of " +
    ...
    add_row_exit(CROOM + "12q", "north", 0, 1);
    add_row_exit(CROOM + "12p", "northwest", 0, 1);
    add_row_exit(CROOM + "10q", "south", 0, 1);
    add_row_exit(CROOM + "11r", "east", 0, 1);
...
short_descr()
{
    return "along the eastern side of the Cape of Nordmaar";
}
 
string
long_descr()
{
    return "You are close to the eastern coastline of the Cape of Nordmaar. " +

...
create_courrain_room()
{
    ...
    add_item(({"nordmaar","kingdom","cape of nordmaar","coastline"}),
       "To your east you can just make out the Cape of " +
       "Nordmaar, the home of the horse barbarians.\n");


    add_row_exit(CROOM + "12i", "west", 0, 1);
    add_row_exit(CROOM + "13j", "north", 0, 1);
    add_row_exit(CROOM + "12k", "east", 0, 1);
    add_row_exit(CROOM + "11j", "south", 0, 1);

...
create_bloodsea_room()
{
    ...
    add_item(({"karthay","coastline", "isle of karthay","isle","island"}), 
               ...
               "can make out the coastline of the isle of Karthay to your north.\n");
    ...
    add_row_exit(CROOM + "5zg", "west", 0, 1);
    add_row_exit(BROOM + "9s", "north", 0, 1);
    add_row_exit(BROOM + "8r", "east", 0, 1);
    add_row_exit(BROOM + "9q", "south", 0, 1);

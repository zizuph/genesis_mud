...
create_bloodsea_room()
{
    ...
    add_row_exit(BROOM + "1e", "north", 0, 1);
    add_row_exit(BROOM + "2d", "west", 0, 1);
    add_row_exit(BROOM + "1c", "south", 0, 1);
    add_wade_exit(BROOM + "1e", "north", "@@swim_off", 1);
    add_wade_exit(BROOM + "1c", "south", "@@swim_off", 1);

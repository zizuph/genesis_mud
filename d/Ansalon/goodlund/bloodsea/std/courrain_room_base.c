...
#define CREATE "create_courrain_room"
#define RESET "reset_courrain_room"
...
courrain_short()
{
	...
	{
	case MIDNIGHT:
	    str = "Midnight on the Northern Courrainn Ocean";
	    break;
	case NIGHT:
	    str = "Spring night on the Northern Courrain Ocean";
	    break;
	case EARLY_MORNING:
	    str = "Early morning on the Northern Courrain Ocean";
	    break;
	case MORNING:
	    str = "Spring morning on the Northern Courrain Ocean";
	    break;
	case NOON:
	    str = "Noon on the Northern Courrain Ocean";
	    break;
	case AFTERNOON:
	    str = "Afternoon on the Northern Courrain Ocean";
	    break;
	case EVENING:
	    str = "Spring evening on the Northern Courrain Ocean";
	    break;
	}
	break;
    case SUMMER:
	...
	case MIDNIGHT:
	case NIGHT:
	    str = "Summer night on the Northern Courrain Ocean";
	    break;
	case EARLY_MORNING:
	    str = "Early morning on the Northern Courrain Ocean";
	    break;
	case MORNING:
	    str = "Summer morning on the Northern Courrain Ocean";
	    break;
	case NOON:
	case AFTERNOON:
	    str = "Afternoon on the Northern Courrain Ocean";
	    break;
	case EVENING:
	    str = "Summer evening on the Northern Courrain Ocean";
	    break;
	}
	break;
    case AUTUMN:
	...
	case MIDNIGHT:
	case NIGHT:
	    str = "Cloudy autumn night on the Northern Courrain Ocean";
	    break;
	case EARLY_MORNING:
	    str = "Early morning on the Northern Courrain Ocean";
	    break;
	case MORNING:
	    str = "Cloudy autumn morning on the Northern Courrain Ocean";
	    break;
	case NOON:
	case AFTERNOON:
	    str = "Cloudy afternoon on the Northern Courrain Ocean";
	    break;
	case EVENING:
	    str = "Cloudy autumn evening on the Northern Courrain Ocean";
	    break;
	}
	break;
	...
	case MIDNIGHT:
	case NIGHT:
	    str = "A stormy winter night on the Northern Courrain Ocean";
	    break;
	case EARLY_MORNING:
	    str = "Early winter morning on the Northern Courrain Ocean";
	    break;
	case MORNING:
	    str = "Windy winter morning on the Northern Courrain Ocean";
	    break;
	case NOON:
	    str = "A stormy winter day on the Northern Courrain Ocean";
	    break;
	case AFTERNOON:
	    str = "A stormy afternoon in winter on the Northern Courrain Ocean";
	    break;
	case EVENING:
	    str = "A stormy winter evening on the Northern Courrain Ocean";
	    break;
	}
	break;
    }
...
courrain_desc()
{
	...
	{
	case MIDNIGHT:
	    str = "It is midnight out on the Northern Courrain Ocean. Above, the " +
	    "night sky shines brightly stars. The silver moon Solinari " +
	    "and the smaller moon Lunitari illuminate the ever shifting ocean " +
            "that surrounds you. ";
	    break;
	case NIGHT:
	    str = "You are surrounded by waters of the Northern Courrain Ocean " +
	...
	case AFTERNOON:
	    ...
	    "sea rises and falls as a soft breeze blows across the Northern Courrain Ocean. ";
	    break;
	case EVENING:
	...
	case MIDNIGHT:
	case NIGHT:
	    str = "The warm night air here on the Northern Courrain Ocean " +
	...
	case EARLY_MORNING:
	    ...
	    "Northern Courrain Ocean. The shrill cry of " +
	...
	case MORNING:
	    ...
	    "Northern Courrain Ocean, the air begins to heat up. This seems " +
	...
	case AFTERNOON:
	    ...
	    "your head out on the shadeless high seas of the Northern Courrain " +
            "Ocean. High humidity makes it very uncomfortable, and even a " +
	...
	case MIDNIGHT:
	case NIGHT:
	    str = "You are surrounded by the Northern Courrain Ocean " +
	...
	case EARLY_MORNING:
	    ...
	    "horizon of the Northern Courrain Ocean. An autumn wind " +
	...
	case MORNING:
	    ...
	    "the heavens over the Northern Courrain Ocean. " +
	...
	case AFTERNOON:
	    str = "You are surrounded by the turbulent waters of the " +
            "Northern Courrain Ocean on a cool autumn " +
	...
	case EVENING:
	    ...
	    "angry waters of the Northern Courrain Ocean. You get the impression " +
	...
	case NIGHT:
	    ...
	    "echoes across the Northern Courrain Ocean, and a " +
	...
	case EARLY_MORNING:
	    ...
	    "over the waters of the Northern Courrain Ocean. ";
	    break;
	case MORNING:
	    str = "The morning air is chill on the Northern Courrain Ocean " +
	...
	case NOON:
	    ...
	    "clouds shadow the waters of theNorthern Courrain Ocean, " +
	...
	case AFTERNOON:
	    ...
	    "of the Northern Courrain Ocean rolling. ";
	    break;
	case EVENING:

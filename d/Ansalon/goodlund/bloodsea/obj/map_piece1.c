...
#define MAP_ID     "_ansalon_map_piece_2"
#define FIXED_MAP1  "_ansalon_bloodsea_map1"

void
create_object()
{
    set_name(({"map","piece","map piece","_ansalon_map_piece_1"}));
    set_adj("bloodstained");
    set_short("bloodstained map piece");
    set_long("This faded and bloodied piece of parchment looks like one " +
      "quarter of a piece of a treasure map! Unfortunately, " +
      "you will need all four quarters to be able to decipher " +

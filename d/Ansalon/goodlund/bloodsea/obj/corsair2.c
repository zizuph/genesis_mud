...
#define ROWER_DESC ({  "swift", "sleek", "trim", \
                         "well-made", "white-sailed", "aggressive" })

#define ROWER_DESIGN ({ "'The Seadog'",  \
                        "'Dolphin'", \
                        "'The Mako'", \
                        "'Habbakuk's Pride'", \
                        "'White Whale'", \
...
create_boat()
{
    ...
    set_adj(({d2,"ship-rigged"})); 
    set_short(d2+ " ship-rigged sloop"); 
...
boat_long_desc()
{
    ...
    string boat_long = "This is a swift-looking sloop-of-war, commonly used by the " +
        ...
        "Along the bow of this vessel has been engraved in silver " + d3 +". ";

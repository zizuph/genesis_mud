...
create_mithas_room()
{
   ...
   add_item(({"staircase","stone staircase"}),
     ...
     "ominous darkness. It also leads down beneath the tower.\n");
   add_item(({"down","basement"}),
     "Hmm... it could be the basement of the Tower? Hard to tell what lies beneath you.\n"); 

   add_prop(ROOM_S_DARK_LONG,                   
     "The ruins of a dark tower. It is impossible "+
     "to see anything in the ominous darkness.\n");

   DARK;

   add_exit(BISLAND + "tower02", "up", 0, 1);
   add_exit(BISLAND + "basement01", "down", 0, 1);
   add_exit(BISLAND + "cliff03","out",0,1);
...
{ 
   return "You are standing within the abandoned ruins of " +
      ...
      "stone staircase circles up the walls of the tower, swallowed by the " +
      "darkness above you. The staircase also leads down beneath the tower.\n";
}
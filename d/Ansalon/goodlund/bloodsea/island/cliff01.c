...
create_mithas_room()
{
   ...
   add_item(({"sandy beach","beach","coastline"}),
         "Down below you is a small stretch of white sand. To your south a trail " +
         "down the side of the cliff leads towards the beach.\n");
   ...
   add_item(({"trail","small trail"}),
         ...
         "to the northwest towards the ruins of a great tower. The trail also " +
         "drops down to a sandy beach to your south.\n");

   add_item(({"ruins","tower","great tower","winston's tower","winstons tower","lighthouse"}),
         "Not far to your northwest rises a prominent 130-foot-tall monolith, the ruins of " +
         "a great lighthouse that onced served as a beacon for travellers across the ancient "+
         "lands of Istar. Now it is abandoned, and rumours claim the tower to be cursed!\n"); 
   ...
   add_exit(BISLAND + "cliff02","northwest",0);
   add_exit(BISLAND + "beach","south",0);
...
{ 
   return "You stand on the edge of a cliff on the isle of Karthay. Far below you " +
     ...
     "can see. A small trail leads along the edge of the cliff to your northwest, while " +
     "also dropping down the side of the cliff here to a thin stretch of beach. Not far to " +
     "your west rises the ruins of a great tower.\n";
}

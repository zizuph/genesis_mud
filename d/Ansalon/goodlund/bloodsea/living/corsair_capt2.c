/*
 * 2021-01-16 - Cotillion
 * - Switched cloning from random to clone_unique
 */
...
string *gAdj1 = ({"strong","rugged-skin","dark-eyed","grey-bearded",
  "muscular","powerful","jovial","stern",
  "ugly","scarred","barrel-chested","tall","confident","young"});
...
create_krynn_monster()
{
    ...
    set_short(query_adj() + " ebony-skinned captain");
    set_gender("G_MALE");
    ...
    equip(({
            clone_unique(WEP, 7, WEP2),
            clone_object(FARM + "shirt"),
            clone_unique(SHIELD, 20, WEP2),
            clone_unique(FARM + "elven_cloth", 20, FARM + "bandana4")
            }));
}
...
special_attack(object enemy)
{
    ...
    *attack,
    ...
    if (attacktype == 1)
    {
	hitres = enemy->hit_me(500, W_IMPALE, TO, -1);

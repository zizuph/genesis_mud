 ...
 * specials easier.
 */
#include "../shadow/stab_special_attack.c"
...
static string *titles = ({
    "Novice Decksweeper of the Bloodsea",
    "Trained Decksweeper of the Bloodsea",
    "Experienced Decksweeper of the Bloodsea",
    "Master Decksweeper of the Bloodsea",
    "Young Sailor of the Bloodsea",
    "Learned Sailor of the Bloodsea",
    "Weather-beaten Sailor of the Bloodsea",
    "Experienced Sailor of the Bloodsea",
    "Young Pirate of the Bloodsea",
    "Dreaded Pirate of the Bloodsea",
    "Feared Pirate of the Bloodsea",
    "Deadly Pirate of the Bloodsea",
    "Wanted Pirate of the Bloodsea",
    "Notorious Pirate Lord of the Bloodsea",
    "Legendary Pirate Lord of the Bloodsea",
});
...
{
    /* throw out ghosts*/
    if (who->query_race() == "ghost")
    {
	return "We don't like ghosts.\n";
    }

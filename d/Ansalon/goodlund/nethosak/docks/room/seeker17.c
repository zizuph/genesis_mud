/* /d/Ansalon/goodlund/nethosak/docks/room/seeker17.c
   Glain
*/
...
void create_nethosak_room()
{
    ...
    set_long(
      ...
      "north.  To your port side a ballista is mounted at the very aft of the " +
      "deck.  Directly to the fore and port " +
    ...
    add_item(({"mast","mizzen mast"}),
      "Sitting to the fore and port, the mizzen mast rises up into " +
    ...
    add_exit(DROOM + "seeker14","fore",0);
    add_exit(DROOM + "seeker18","port",0);
}

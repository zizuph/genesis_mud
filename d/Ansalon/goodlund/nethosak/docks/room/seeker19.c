/* /d/Ansalon/goodlund/nethosak/docks/room/seeker19.c
   Glain
   11/7/98
*/
...
void create_nethosak_room()
{
    ...
    set_long(
      ...
      "keeping the stench of the city to itself.  The coastline " +
      "stretches to the south of here where the docks end.  Massive " + 
      "buildings made of stone rise " +
      "up throughout the sprawling city that stretches to the east and " +
      "north.  To your starboard side a ballista is mounted at the " +
      "very aft of the deck.  Directly to the fore and starboard " +
    ...
    add_exit(DROOM + "seeker18","fore",0);
    add_exit(DROOM + "seeker16","starboard",0);
}

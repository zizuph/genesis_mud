/* /d/Ansalon/goodlund/nethosak/docks/room/seeker16.c
   Glain
*/
...
void create_nethosak_room()
{
    ...
    set_long(
      ...
      "stretches to the south of here where the dock ends.  Massive " + 
      ...
      "deck.  Directly to the starboard " +
    ...
    add_exit(DROOM + "seeker13","fore","@@steps");
    add_exit(DROOM + "seeker15","starboard",0);
    add_exit(DROOM + "seeker19","aft",0);
}

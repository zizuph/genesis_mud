/* /d/Ansalon/goodlund/nethosak/docks/room/seeker11.c
   Glain
*/
...
void create_nethosak_room()
{
    ...
    set_long(
      ...
      "loaded off and on other docked ships.  To the fore " +
    ...
    add_item(({"mast","main mast"}),
      "Sitting to the fore and port, the main sail rises up into " +
    ...
    add_item("aft deck",
      ...
      "From the aft deck most of the city can be viewed.\n");
    add_item("city",
    ...
    add_exit(DROOM + "seeker08.c","fore",0);
    add_exit(DROOM + "seeker12.c","port",0);
    add_exit(DROOM + "seeker14.c","aft","@@steps");
} 

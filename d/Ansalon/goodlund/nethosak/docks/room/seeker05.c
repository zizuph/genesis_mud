/* /d/Ansalon/goodlund/nethosak/docks/room/seeker05.c
   Glain
*/
...
void create_nethosak_room()
{
    ...
    set_long(
      ...
      "loaded off and on other docked ships.  To the aft " +
      "and port the main mast rises up, its sails folded up and " +
      "tied down.  Steps head up to the fore deck, from which the " +
      "the entire bay can be seen.\n");
    ...
    add_item(({"mast","main mast"}),
      "Sitting to the aft and port, the main sail rises up into " +
    ...
    add_item("fore deck",
      ...
      "From the foredeck the entire bay can be viewed.\n");
    add_item("city",
    ...
    add_exit(DROOM + "seeker02.c","fore","@@steps");
    add_exit(DROOM + "seeker06.c","port",0);
    add_exit(DROOM + "seeker08.c","aft",0);
} 

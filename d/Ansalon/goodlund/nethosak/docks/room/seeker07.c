/* /d/Ansalon/goodlund/nethosak/docks/room/seeker07.c
   Glain
*/
...
void create_nethosak_room()
{
    ...
    add_item(({"mast","main mast"}),
      "Sitting to the aft and starboard, the main sail rises up into " +
    ...
    add_item("fore deck",
      ...
      "From the fore deck the entire bay can be viewed.\n");
    add_item("city",
    ...
    add_exit(DROOM + "seeker04.c","fore","@@steps");
    add_exit(DROOM + "seeker06.c","starboard",0);
    add_exit(DROOM + "seeker10.c","aft",0);
} 

/*
 * /d/Ansalon/goodlund/nethosak/docks/obj/weapon/side_dagger.c
 *
 * glain
 *
 * These daggers are a common side weapon among the minotaurs in
 * case their weapon of choice breaks, disarmed, etc.  Most
 * minotaurs carry one tucked into their belt.  This file will
 * prolly be moved up to a higher dir in the nethosak dir.
 *
 */
#pragma strict_types

...
create_mithas_room()
{
   ...
   add_exit(MROOM + "guardhouse3","northwest",0);
   add_exit(MROOM + "guardhouse4","southwest",0);
   add_exit(MROOM + "road16","west",0);
   gate = clone_object(MOBJ + "city_gate3");
...
{ 
   ...
   return tod_descr()+ "You are standing on a worn down "+
          ...
          "east where a small trail continues into a small "+
          "forest. " +season_descr()+ "\n";

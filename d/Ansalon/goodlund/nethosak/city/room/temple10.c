...
create_mithas_room()
{
   ...
   add_item(({"coated statue",
       ...
       "looks like a crowned, hooded head, "+
       "with two red eyes. You recognice this "+
       "statue as being Morgion, god of disease "+
       "and decay. He despises all healthy "+
       "things, and strives to destroy and "+
       "corrupt them with disease and decay.\n");

   add_exit(MROOM + "temple11","south",0); 
   add_exit(MROOM + "temple9","northwest",0);
}
...
{ 
   return  "You are in a small hallway in the Temple of "+
           ...
           "making the hallway seem even bigger. "+
           "The halway continues to the northwest and "+
           "south.\n";
}

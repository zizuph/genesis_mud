...
create_mithas_room()
{
   ...
   add_exit(MROOM + "temple2","north","@@temple_entry", 0); 
   add_exit(MROOM + "road21","northeast",0);
   add_exit(MROOM + "temple_entrance","west",0);
...
{ 
   return tod_descr()+ " You are standing at the entrance to "+
         ...
         "has been placed here. Two the entrances and one. "+
         ...
         "continues. " +season_descr()+ "A silvery plaque "+
         "has been fastened to the wall here.\n";
}

...
create_mithas_room()
{
   set_short("Northern guardroom");
   set_long("@@long_descr");

   add_exit(MROOM + "road16","southwest","@@guard_exit",0); 
   add_exit(MROOM + "road17","southeast","@@guard_exit",0);
...
long_descr()
{ 
   return "This is a crude guardroom in the northeastern part of "+
   ...
   "the middle of the room. The road to the southwest and "+
   "southeast leads back to the main road.\n";
}

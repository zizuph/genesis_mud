...
create_krynn_monster()
{
    ...
    set_long("This is one of the dirtiest creatures you've ever seen! "+
        "Her clothes are rags, and her hair looks as if the only time "+
        "it gets washed is when it rains. This gully dwarf is not very "+
        "bright, but she's rather friendly, and helps the minotaurs here "+
        "the keep the city clean.\n"+
        "She is holding a large dirty sack in her right hand.\n");
    set_alignment(50); 
    set_gender(1);
    ...
    add_act("emote lashes out after the flies buzzing over her."); 
    add_act("emote looks admiringly at one of the minotaurs.");
    add_act("emote peers curiously at you."); 
    add_act("emote closes her large dirty bag.");
    add_act("emote opens her large dirty bag."); 
    add_act("get all");

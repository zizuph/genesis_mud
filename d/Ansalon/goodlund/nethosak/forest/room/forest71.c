...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest78","east",0);
    add_exit(MROOM + "forest70","south",0);
    add_exit(MROOM + "forest72","north",0,2,1);
...
{ 
    ...
    "the southern part of Mithas. The narrow forest "+
    "trail stretches itself into several directions "+
    "here. The trail continues to the east and south.\n";
}

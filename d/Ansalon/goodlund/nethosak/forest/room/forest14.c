...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest13","northwest",0);
    add_exit(MROOM + "forest15","east",0);
...
{ 
    ...
    "You stand on an overgrown forest trail in "+
    "the southern part of Mithas. "+
    "Through the canopy above you, thick white "+
    "clouds begin to gather, covering the trees "+
    "in a grey light. "+
    "The trail stretches itself further into the "+
    "forest towards the east and northwest.\n";}

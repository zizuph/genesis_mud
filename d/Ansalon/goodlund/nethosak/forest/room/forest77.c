...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest76","northeast",0);
    add_exit(MROOM + "forest78","west",0);
...
{ 
    ...
    "southern part of Mithas. Dry leaves and "+
    "old branches lies scattered all over the "+
    "forest trail. The trail continues to the "+
    "northeast and west.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest76","southeast",0,2,1);
    add_exit(MROOM + "forest73","southwest",0,2,1);
    add_exit(MROOM + "forest75","south",0,2,1);
...
{ 
    ...
    "dense emerald-green forest. Through the canopy "+
    "above you, thick white clouds begin to gather, "+

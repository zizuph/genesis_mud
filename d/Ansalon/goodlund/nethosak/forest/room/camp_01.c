...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest34","north", 0, 1); 
    add_exit(MROOM + "camp_02","south", 0, 1); 
    ...
    add_item(({"camp","clearing"}),
               "It is hard to spot any details as the camp looks to be "+
...
{ 
    ...
    "decomposing wood and leaves. It looks like someone has " +
    "set up a camp in a clearing south of here. \n";
}

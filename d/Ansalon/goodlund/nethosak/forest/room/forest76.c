...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest86","northeast",0);
    add_exit(MROOM + "forest77","southwest",0);
    add_exit(MROOM + "forest85","southeast",0);
    add_exit(MROOM + "forest74","northwest",0,2,1);
...
{ 
    ...
    "forest in the southern part of Mithas. The "+
    "undergrowth here consists of a wide variety of "+
    "plant and herbs. The trail continues to "+

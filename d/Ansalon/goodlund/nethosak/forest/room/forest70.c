...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest71","north",0);
    add_exit(MROOM + "forest69","southwest",0);
    add_item(({"forest"}),
...
{ 
    ...
    "emerald-green forest. The green treetops blocks "+
    "the sun almost completely, covering the clearing "+
    "in a gloomy light. The trail continues to the "+
    "north and southwest.\n";
}

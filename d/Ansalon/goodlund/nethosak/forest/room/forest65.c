...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest66","northeast",0);
    add_exit(MROOM + "forest64","southwest",0);
...
{ 
    ...
    "You stand on an old forest trail in the southern part "+
    "of Mithas. The air here is filled with the smell of "+
    "decomposing wood and leaves. All around you a thin "+
    "mist of rain, falls down from above. The trail "+

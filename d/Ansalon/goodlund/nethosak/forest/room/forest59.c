...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest58","west",0);
...
{ 
    ...
    "vast emerald-green forest. The trail widens a "+
    "bit here, though it is still lined with heavy, "+
    "uncut foliage. The trail continues to the west.\n";
}

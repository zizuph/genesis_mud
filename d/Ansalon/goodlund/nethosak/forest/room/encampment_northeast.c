...
create_mithas_room()
{
    set_short("Northeast corner of encampment");
    set_long("@@long_descr"); 
    enable_reset(33);

    add_exit(MROOM + "encampment_center","southwest",0);
...
{ 
    ...
    "You stand in the northeast corner of the troll encampment. The ground "+

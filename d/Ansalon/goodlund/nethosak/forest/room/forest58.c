...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest59","east",0);
    add_exit(MROOM + "forest60","west",0);
    add_exit(MROOM + "forest64","southeast",0);
    add_exit(MROOM + "forest57","north",0);
...
{ 
    ...
    "emerald-green forest. Far to the south, you "+
    "notice four mountain peaks reaching towards "+
    "the sky. The trail continues to the north, "+

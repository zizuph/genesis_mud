...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest16","northeast",0);
...
{ 
    ...
    "You stand within a vast overgrown forest in "+
    "the southern part of Mithas. "+ 
    "The path widens a bit here, though it is "+
    "still lined with heavy, uncut foliage. "+
    "The trees here are huge, some of them might "+
    "even be centuries old. "+
    "The path continues to the northeast.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest56","northeast",0);
    add_exit(MROOM + "forest58","south",0);
...
{ 
    ...
    "emerald-green forest. Tall oak trees stretches "+
    "themselves toward the sky, these trees must be "+
    "more then a century old. The trail continues to "+

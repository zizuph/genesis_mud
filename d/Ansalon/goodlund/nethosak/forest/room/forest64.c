...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest65","northeast",0);
    add_exit(MROOM + "forest58","northwest",0);
...
{ 
    ...
    "You stand in a small green clearing within a vast "+
    "forest. The trail here is covered in moss and "+
    "branches, it looks like there hasn't been anyone "+
    "here for years. The trail continues to the "+

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest36","southwest",0,2,1); 
    add_exit(MROOM + "forest38","north",0,2,1);
...
{ 
    ...
    "mist of rain, falls down from above. A bit to the "+
    "southwest, the gloom seems to disappear.\n";
}

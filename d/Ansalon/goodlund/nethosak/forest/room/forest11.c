...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest10","north",0);
    add_exit(MROOM + "forest13","south",0); 
    add_exit(MROOM + "forest12","east",0,2,1);
...
{ 
    ...
    "You stand on an overgrown forest path in the southern "+
    "part of Mithas. "+ 
    "Thin sun rays reach through the canopy, covering "+
    "everything in a golden haze. "+
    "A overgrown trail continues to the north and south.\n";

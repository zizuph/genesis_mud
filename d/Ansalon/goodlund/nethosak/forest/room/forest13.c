...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest11","north",0);
    add_exit(MROOM + "forest14","southeast",0);
...
{ 
    ...
    "The path widens a bit here, though it is still lined "+
    "with heavy, uncut foliage. The trees here are huge, "+
    "some of them might even be centuries old. The trail "+
    "here continues to the north and southeast.\n";
}

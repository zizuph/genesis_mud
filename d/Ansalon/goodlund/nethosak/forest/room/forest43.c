...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest44","south",0);
    add_exit(MROOM + "forest42","west",0); 
...
{ 
    ...
    "You are standing within an old forest on the "+
    "Isle of Mithas. "+
    "Through the canopy above you, thick white "+
    "clouds begin to gather, covering the trees "+
    "in a grey light. The narrow trail curls itself "+

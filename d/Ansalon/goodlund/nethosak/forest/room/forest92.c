...
create_mithas_room()
{
    ...
    gate = clone_object("/d/Ansalon/goodlund/nethosak/city/obj/city_gate3b");
    gate->move(this_object());   
    add_exit(MROOM + "forest91","south",0);
...
{ 
    ...
    "You stand on an old forest trail in the "+
    "southern part of Mithas. Tall oak trees "+
    "stretch themselves toward the sky, these "+
    "trees must be more then a century old. The "+
    "trail continues to the south further into the "+
    "forest and to the west towards the city of Nethosak.\n";
}

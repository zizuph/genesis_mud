...
#define H1 KRHERB + "hop"
#define H2 KRHERB + "wild_plum"
#define H3 KRHERB + "wild_plum"
#define H4 KRHERB + "fireweed"
...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest53","south",0,2,1);
...
{ 
    ...
    "stretch themselves towards the sky.\n";
}

/* Navarre June 24th 2006, changed long description to not say the
 * leads to several directions, since it only has one exit.
 */
...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest5","north",0,2,1);
...
{ 
    ...
    "The narrow forest path leads back to the north.\n";
}

...
create_mithas_room()
{
    set_short("Northwest corner of encampment");
    set_long("@@long_descr"); 
    enable_reset(33);

    add_exit(MROOM + "encampment_center","southeast",0);
...
{ 
    ...
    "You stand in the northwest corner of the troll encampment. The ground "+

...
create_mithas_room()
{
    ...
    reset_mithas_room();
    set_short("At a crossing in the forest");
    set_long("@@long_descr"); 

    add_exit(MROOM + "forest60","east",0);
    add_exit(MROOM + "forest47","north",0); 
    add_exit(MROOM + "forest49","southwest",0);
...
{ 
    ...
    "You stand within a vast overgrown forest in the southern "+
    "part of Mithas. "+
    "The trail twists itself between the trees here, until "+
    "it finally splits in three parts, one leading to the east, "+
    "another towards the north and the last one going southwest.\n";
}

/*
 * 2004-12-19 - Cotillion
 * - Fixed wolf cloning bug.
 *
 */
...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest70","northeast",0);
    add_exit(MROOM + "forest55","west",0);
    add_exit(MROOM + "forest68","southeast",0);
...
{ 
    return tod_descr()+ "" +season_descr()+ 
        "You stand within a vast overgrown forest in the "+
        "southern part of Mithas. Thin sun rays reach "+
        "through the canopy, covering everything in a "+
        "golden haze. The trail continues to the "+

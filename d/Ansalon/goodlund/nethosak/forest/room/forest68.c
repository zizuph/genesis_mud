...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest79","northeast",0);
    add_exit(MROOM + "forest69","northwest",0);
    add_exit(MROOM + "forest66","south",0);
...
{ 
    ...
    "You are standing on a small trail within a dense "+
    "emerald-green forest. Through the canopy above "+
    "you, thick white clouds begin to gather, "+
    "covering the trees in a grey light. The trail "+
    "continues to the south, northeast and northwest.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest76","southwest",0);
    add_exit(MROOM + "forest87","northeast",0);
    add_exit(MROOM + "forest90","west",0,2,1);
...
{ 
    ...
    "vast forest. The green treetops blocks the sun "+
    "almost completely, covering the clearing in a "+
    "gloomy light. The trail continues to the "+

...
reset_mithas_room()
{
   ...
   if(!objectp(deer3))
      {
      deer3 = clone_object(MNPC + "deer");
      deer3->move(this_object());
   }
}
void
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest41","east",0);
    add_exit(MROOM + "forest93","south",0);
    add_exit(MROOM + "forest18","northwest",0);  
...
{ 
    ...
    "You stand on an old forest trail in the southern part of "+
    "Mithas. "+
    "Through the canopy above you, thick white clouds begin to gather, "+
    "covering the trees in a grey light. "+
    "The trail continues to the south, east and northwest.\n";
}

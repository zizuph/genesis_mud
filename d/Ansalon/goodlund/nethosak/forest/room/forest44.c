...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest43","north",0);
    add_exit(MROOM + "forest45","east",0); 
...
{ 
    ...
    "You are standing on a small hill within "+
    "a vast forest in the southern part of Mithas. "+
    "Far to the northwest you notice the glittering "+
    "of the sea, and to the south beyond the forest, "+
    "four small mountain peaks stretch themselves "+
    "towards the sky. The forest trail curls itself "+

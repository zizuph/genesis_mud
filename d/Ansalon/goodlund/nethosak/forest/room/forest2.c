...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest1","north",0);
    add_exit(MROOM + "forest3","southeast",0);
...
{ 
    ...
    "You stand on an old forest trail in the southern part of Mithas. "+
    "Through the tree trunks you notice the glittering "+
    "of the sea off in the northwest. The trail here continues to "+

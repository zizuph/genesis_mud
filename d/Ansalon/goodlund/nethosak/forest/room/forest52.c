...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest50","west",0,2,1);
...
{ 
    ...
    "dense emerald-green forest. Through the "+
    "canopy above you, thick white clouds begin "+
    "to gather, covering the trees in a grey " +
    "light.\n";
}

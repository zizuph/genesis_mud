...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest55","north",0);
    add_exit(MROOM + "forest57","southwest",0);
...
{ 
    ...
    "southern part of Mithas. Far to the south, "+
    "you notice four mountain peaks reaching towards "+
    "the sky. The trail continues to the north and "+
    "southwest.\n";
}

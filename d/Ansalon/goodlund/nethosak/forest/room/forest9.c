...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest7","west",0);
    add_exit(MROOM + "forest20","southeast",0); 
...
{ 
    ...
    "You stand within a vast overgrown forest "+
    "in the southern part of Mithas. "+
    "Through the canopy above you, thick "+
    "white clouds begin to gather, covering "+
    "the trees in a grey light. "+

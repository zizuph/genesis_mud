/* Navarre July 3rd 2006, fixed typo, thiner to thinner */
...
#define I_FOUND_BEHOLDER_LAIR   "_i_found_beholder_lair"

void
create_mithas_room()
{
    object door;
    set_short("Small circle of stones");
    set_long("@@long_descr"); 

    add_exit(MROOM + "forest63","northeast",0,2,1);

    add_item(({"circle", "rocks"}), "These huge rocks "+
     "have been placed in a perfectly round circle. Some thinner "+
     "stones act like a floor. This might have been the ground floor of "+
     "an ancient house.\n");

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest83","east",0);
    add_exit(MROOM + "forest79","south",0);
    add_item(({"forest"}),
...
{ 
    ...
    "vast forest. The trail here is covered in moss "+
    "and branches, it looks like there hasn't been "+
    "anyone here for years. The trail continues to the "+
    "east and south.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest68","southwest",0);
    add_exit(MROOM + "forest84","north",0);
    add_exit(MROOM + "forest80","east",0,2,1);
...
{ 
    ...
    "southern part of Mithas. The air here is filled "+
    "with the smell of decomposing wood and leaves. "+
    "All around you a thin mist of rain, falls down "+
    "from above. The trail continues to the north and "+
    "southwest.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest66","northwest",0,2,1);
    add_exit(MROOM + "trail1","east",0,2,1);
...
{ 
    ...
    "forest in the southern part of Mithas. Tall oak "+
    "trees stretch themselves toward the sky, these "+
    "trees must be more then a century old.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "encamp_north3","north",0);
    add_exit(MROOM + "encamp_south3","south",0);
    add_exit(MROOM + "encamp_east3","east",0);
    add_exit(MROOM + "encamp_west3","west",0);
    add_exit(MROOM + "encamp_southwest3","southwest",0);
    add_exit(MROOM + "encamp_southeast3","southeast",0);
    add_exit(MROOM + "trail2","northwest",0);
    add_exit(MROOM + "encamp_northeast3","northeast",0);
...
{ 
    ...
    "The encampment continues in almost every direction, however going northwest "+

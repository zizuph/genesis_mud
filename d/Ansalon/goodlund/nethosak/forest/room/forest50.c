...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest53","northeast",0);
    add_exit(MROOM + "forest46","west",0);
    add_exit(MROOM + "forest52","east",0,2,1);
    add_exit(MROOM + "forest51","south",0,2,1);
...
{ 
    ...
    "southern part of Mithas. Thin sun rays "+
    "reach through the canopy, covering every "+
    "thing in a golden haze. The trail continues "+

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest9","northwest",0);
    add_exit(MROOM + "forest22","east",0,2,1);
    add_exit(MROOM + "forest19","south",0);
    add_exit(MROOM + "forest21","northeast",0,2,1);
...
{ 
    ...
    "The forest trail continues to the south "+
    "and northwest.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest73","east",0,2,1);
    add_exit(MROOM + "forest71","south",0,2,1);
...
{ 
    ...
    "the southern part of Mithas. The trees here "+
    "are huge, some of them might even be centuries "+
    "old.\n";
}

...
create_mithas_room()
{
    set_short("Southwest corner of encampment");
    set_long("@@long_descr"); 
    enable_reset(33);

    add_exit(MROOM + "encampment_center","northeast",0);
...
{ 
    ...
    "You stand in the southwest corner of the troll encampment. The ground "+

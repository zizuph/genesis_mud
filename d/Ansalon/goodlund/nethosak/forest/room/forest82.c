...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest85","northeast",0);
    add_exit(MROOM + "forest83","west",0);
    add_exit(MROOM + "forest81","south",0,2,1);
...
{ 
    ...
    "emerald-green forest. The trail widens a bit "+
    "here, though it is still lined with heavy, "+
    "uncut foliage. The trail continues to the "+
    "northeast and west.\n";
}

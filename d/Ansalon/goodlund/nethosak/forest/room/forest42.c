...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest41","south",0);
    add_exit(MROOM + "forest43","east",0); 
...
{ 
    ...
    "You are standing within a old forest on the "+
    "Isle of Mithas. "+
    "The air here is filled with the smell of "+
    "decomposing wood and leaves. "+
    "All around you a thin mist of rain, falls "+
    "down from above. The narrow trail curls itself "+

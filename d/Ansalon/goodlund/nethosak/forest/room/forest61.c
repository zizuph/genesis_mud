...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest60","north",0,2,1);
    add_exit(MROOM + "forest62","southwest",0,2,1);
...
{ 
    ...
    "in the southern part of Mithas. Far to the "+
    "south, you notice four mountain peaks "+

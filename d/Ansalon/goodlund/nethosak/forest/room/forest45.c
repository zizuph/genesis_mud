...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest44","west",0);
    add_exit(MROOM + "forest46","east",0); 
...
{ 
    ...
    "Tall oak trees stretch themselves "+
    "toward the sky, these trees must be more "+
    "than a century old. "+
    "The forest trail curls itself towards the east "+
    "and west.\n";
}

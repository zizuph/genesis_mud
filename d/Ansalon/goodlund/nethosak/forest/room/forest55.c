...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest69","east",0);
    add_exit(MROOM + "forest53","west",0);
    add_exit(MROOM + "forest56","south",0);
...
{ 
    ...
    "vast forest. The narrow forest trail stretches "+
    "itself into several directions here. The trail "+

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest74","northeast",0,2,1);
    add_exit(MROOM + "forest72","west",0,2,1);
...
{ 
    ...
    "the southern part of Mithas. Far to the "+
    "northwest you notice the glittering of the "+
    "sea, and to the south beyond the forest, four "+
    "small mountain peaks stretch themselves "+
    "towards the sky.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest46","north",0);
    add_exit(MROOM + "forest48","south",0);  
...
{ 
    ...
    "All around you a thin mist of rain, falls down from above. "+
    "The trail here continues to the north and south.\n";
}

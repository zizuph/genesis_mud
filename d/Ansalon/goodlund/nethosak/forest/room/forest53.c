...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest50","southwest",0);
    add_exit(MROOM + "forest55","east",0);
    add_exit(MROOM + "forest54","north",0,2,1);
...
{ 
    ...
    "You are standing on a small trail within a "+
    "dense emerald-green forest. Tall oak trees "+
    "stretch themselves toward the sky, these "+
    "trees must be more then a century old. The "+
    "trail continues to the east and southwest.\n";
}

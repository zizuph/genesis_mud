...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest91","north",0);
    add_exit(MROOM + "forest86","southwest",0);
    add_exit(MROOM + "forest88","west",0,2,1);
...
{ 
    ...
    "You stand in a small green clearing within a "+
    "vast forest. Through the canopy above you, thick "+
    "white clouds begin to gather, covering the "+
    "trees in a grey light. The trail continues to "+

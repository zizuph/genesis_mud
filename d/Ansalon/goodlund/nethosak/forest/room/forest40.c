/* Navarre 24th June 2006, Changed long description to now say
 * the path stretches into several directions, when there is
 * only one exit.
 */
...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest38","west",0,2,1);

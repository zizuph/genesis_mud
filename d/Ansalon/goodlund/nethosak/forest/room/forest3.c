...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest2","northwest",0);
    add_exit(MROOM + "forest7","southeast",0);
    add_exit(MROOM + "forest4","northeast",0,2,1);
...
{ 
    ...
    "light. "+
    "The trail continues to the northwest and southeast.\n";
}

...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest19","northwest",0);
    add_exit(MROOM + "forest15","southwest",0);
    add_exit(MROOM + "forest26","southeast",0);
...
{ 
    ...
    "You stand in a small green clearing within "+
    "a vast forest. "+
    "The green treetops blocks the sun almost "+
    "completely, covering the clearing in a gloomy "+
    "light. "+

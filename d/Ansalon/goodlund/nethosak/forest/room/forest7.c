...
create_mithas_room()
{
    set_short("A clearing in the forest");
    set_long("@@long_descr"); 

    add_exit(MROOM + "forest3","northwest",0);
    add_exit(MROOM + "forest9","east",0);
    add_exit(MROOM + "forest10","south",0);
    add_exit(MROOM + "forest8","west",0);
    add_item(({"forest"}),
...
{ 
    ...
    "You stand in a small evergreen clearing "+
    "in the southern part of Mithas. "+
    "Far to the south, you notice four mountain "+
    "peaks reaching towards the sky. "+
    "The green treetops blocks the sun almost "+
    "completely, covering the clearing in a "+
    "gloomy light. The forest trail continues "+
    "towards the northwest, east and south.\n";
}

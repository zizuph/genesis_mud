...
create_mithas_room()
{
    ...
    add_exit(MROOM + "forest42","north",0);
    add_exit(MROOM + "forest26","west",0); 
    add_exit(MROOM + "forest38","southeast",0,2,1);
    ...
    add_item(({"sea"}),
     "The sea to the northwest glitter brightly in the "+
     "sun. Just outside the forest, the pier of Nethosak "+
     "can be seen.\n");
...
{ 
    ...
    "Far to the northwest you notice the "+
    "glittering of the sea, and to the south "+
    "beyond the forest, four small mountain peaks "+
    "stretch themselves towards the sky. The "+
    "narrow trail continues towards the west, "+
    "north and southeast.\n";
}

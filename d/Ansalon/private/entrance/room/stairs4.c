...
{
    set_short("The middle of a dimly lit stone stairway");
    set_long("You are standing on a dimly lit stone stairway. " + 
        ...
        "the darkness.\n");
    add_item("stair", "It winds up and down beyond your view into the " + 
    ...
    add_exit(RDIR + "stairs5", "up", "@@stair_message");
    add_exit(RDIR + "stairs3", "down", "@@down_message");
    reset_kendermore_room();
}
...
stair_message()
{
    write("The steps crumble a bit under your feet as you climb.\n");
    return 0;
}

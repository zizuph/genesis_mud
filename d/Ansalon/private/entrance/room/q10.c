...
create_kendermore_room()
{
    ...
    set_long("You are standing in a dimly lit stone hall. Rows of " + 
        "black metal doors stand along the west wall to the north and " + 
        "south. Torches " + 
        "are mounted on the walls at regular intervals. They flicker, " + 
        "throwing eerie shadows. " + 
        "The hallway continues into the darkness to your south and north.\n");
   ...
   set_tell_time(300);
    add_tell("The sound of something large moving to the west can " +
        "be heard.\n");
    ...
    add_exit(RDIR + "q8", "north", "@@hall_message");
    add_exit(RDIR + "q12", "south", "@@hall_message");
    door = clone_object(ODIR + "qdoor5b");
    door->move(TO);
    reset_kendermore_room();
}

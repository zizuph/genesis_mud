...
create_kendermore_room()
{
    ...
    add_exit(RDIR + "stairs4", "up", "@@stair_message");
    add_exit(RDIR + "q13", "north", "@@hall_message");
    reset_kendermore_room();
}
...
hall_message()
{
    write("You look back at the stairs, reluctant to go back into the " + 
        "dark gloomy castle.\n");
    return 0;
}
...
stair_message()
{
    write("Your steps echo into the darkness as you climb.\n");
    return 0;
}

...
{
    if(str == "eyes" || str == "ones eyes" || str == "pair of eyes")
    {
    ...
    if(str == "hourglass" || str == "e" || str == "nothing")
    {
...
test_of_wisdom()
{
    ...
    command("emote magically says: But be warned! You must answer one of many riddles correctly. Incorrect answers " +
      "I usually dismiss, but if an answer is incorrect as well as the " +
      "answer to another riddle, I will destroy you.");
    command("emote magically says: \n" +

...
enter_temple(string str)
{
    ...
    if(str == "hourglass" || str == "e" || str == "eyes" || str == "pair of eyes" || str == "ones eyes")
    {
...
test_of_wisdom()
{
    ...
    command("emote magically says: But be warned! I ask many a riddle. " +
      "incorrect answers I may dismiss, or I may call upon the wrath of the gods. " +
      "Choose wisely.");
    command("emote magically says: \n" +
      ...
      "     If a live man eats it, he will soon die.\nState " +

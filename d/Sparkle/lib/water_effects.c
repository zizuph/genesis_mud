/*
 *  /d/Sparkle/lib/water_effects.c
 *
 *  This allows flames to be doused if a player should dive beneath the
 *  surface of the water with torhces lit, etc.
 *
 *  Created back in Emerald sometime in late 1999 or so
 *  by Cooper Sherry (Gorboth)
 *
 */
#include <macros.h>

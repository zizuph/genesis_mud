...
#define M_SKILL_MAX_OCC_ACROBAT         100
#define M_SKILL_MAX_OCC_BLINDFIGHT      90
#define M_SKILL_MAX_OCC_AWARENESS       70
#define M_SKILL_MAX_OCC_HERBALISM       40
#define M_SKILL_MAX_OCC_ELEMENTAIR      5
#define M_SKILL_MAX_OCC_DIVINATION      5
#define M_SKILL_MAX_OCC_APPROBJ         50
#define M_SKILL_MAX_OCC_APPRMON         50
...
#define M_SKILL_MAX_LAY_ACROBAT         60
#define M_SKILL_MAX_LAY_BLINDFIGHT      50
#define M_SKILL_MAX_LAY_AWARENESS       50
#define M_SKILL_MAX_LAY_HERBALISM       40
    ...
    SS_DEFENCE : \
      ({ ({ M_SKILL_MAX_OCC_DEFENCE, "defend against attacks", \
         ...
         ({ M_SKILL_MAX_LAY_DEFENCE, "defend against attacks", \
            0, 5, SS_LAYMAN, 100 }) }), \
    SS_ACROBAT : \
      ({ ({ M_SKILL_MAX_OCC_ACROBAT, "move acrobatically", \
            0, 5, SS_OCCUP, 100 }), \
         ({ M_SKILL_MAX_LAY_ACROBAT, "move acrobatically", \
            0, 5, SS_LAYMAN, 100 }) }), \
    SS_BLIND_COMBAT : \
      ({ ({ M_SKILL_MAX_OCC_BLINDFIGHT, "fight without benefit of sight", \
            0, 5, SS_OCCUP, 100 }), \
         ({ M_SKILL_MAX_LAY_BLINDFIGHT, "fight without benefit of sight", \
            0, 5, SS_LAYMAN, 100 }) }), \
    SS_AWARENESS : \

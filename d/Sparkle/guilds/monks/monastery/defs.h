...
#define M_PATH_SPECIALS (M_PATH + "/specials")
...
#define M_MASTERS_ACTIVE        ({ "ckrik" })
#define M_MASTERS_RETIRED       ({ "amelia", "cirion", "lilith", "manat", "arandir" })
...
#define M_WEAPON_SUSPECT_HIT            50
#define M_WEAPON_SUSPECT_PEN            50

// How many minutes before acquired hit and pen decay
#define M_ACQUIRE_DECAY(int,wis)        \
  (((int) + (wis)) / 5)

#define M_PLEXUS_HIT                   100
#define M_PLEXUS_AID                    65
#define M_PLEXUS_TIME                   30
#define M_STRIKE_OCC_HIT                85
#define M_STRIKE_OCC_AID                65
#define M_STRIKE_LAY_HIT                85
#define M_STRIKE_LAY_AID                50

...
public int iHunger = 300;

#define M_STATS_MIN     10
...
int query_base_stat (int iStat)
{
  ...
  // Stats are exponentially proportional to the amount
  // of food it has been given ...

  iResult = (iHunger * iHunger) / 2000;
...
string m_hunger_desc_short ()
{
  switch (iHunger)
  {
    case 0..100:       return ("starving");
    case 101..200:     return ("very hungry");
    case 201..300:     return ("hungry");
    case 301..400:     return ("thin");
    case 401..500:     return ("lean");
    case 501..600:     return ("strong");
    case 601..700:     return ("fierce");
    case 701..800:     return ("terrifying");
    case 801..900:     return ("majestic");
    case 901..10000:   return ("invincible");
...
string m_hunger_desc_long ()
{
  switch (iHunger)
  {
    case 0..10:       return ("He is looking on the verge of death from hunger.");
    case 11..100:     return ("He is looking extemely hungry.");
    case 101..200:    return ("He is looking like he could eat a lot more.");
    case 201..300:    return ("He is looking a bit hungry.");
    case 301..400:    return ("He is looking a bit thin.");
    case 401..500:    return ("He is looking rather lean.");
    case 501..600:    return ("He is looking strong, although a bit hungry as usual.");
    case 601..700:    return ("He is looking strong and fierce, although he looks as though he could eat a bit more.");
    case 701..800:    return ("He is looking fierce and terrible, like he could tear your limbs off just by looking at them. He seems as though he might want to eat a bit more ...");
    case 801..900:    return ("He is looking majestic and fierce.");
    case 901..10000:  return ("He is looking as if nothing could stop him. He also seems very well fed.");
...
int m_devour (object oFood)
{
  ...
  iAmountAvailable = oFood->query_amount ();
  iAmountPossible = (M_HUNGER_MAX - iHunger) * M_SUSTENANCE;
  ...
  if (iAmountEaten > 0)
  {
    ...
    iHunger += iAmountEaten / M_SUSTENANCE;
...
void reset_npc ()
{
  ...
  iHunger = MAX (M_HUNGER_MIN, iHunger - (10 + random (20)));
...
void create_creature ()
{
  ...
  default_config_npc (SD_STATLEVEL_EPIC);

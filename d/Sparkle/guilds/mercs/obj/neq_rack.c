/* 
 * Mercenary Guild Armour rack by Morrigan 11/2001
 *
 * Adapted from code by Auberon and Gwyneth, April 2001
 *
...
{
    set_name("rack");
    add_name("_merc_guild_armour_rack_");
    add_adj("armour");
	...
	"The word 'armour' has been painted into the side.\n");

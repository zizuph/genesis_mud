/*
 *  /d/Sparkle/guilds/new_merc/obj/merc_book.c
 *
 *  This is the standard book object used by the Mercenary Library.
 *
...
create_library_book()
{
    ...
    add_name( ({ "_linor_library_book", "_merc_library_book" }) );
    add_adj( ({ "library" }) );

    set_long("This is one of the books from the Mercenary library. You"

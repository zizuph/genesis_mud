...
create_armour()
{
    ...
    add_name("_ch_helmet_");
    set_short("ancient steel helmet");
    set_adj(({"ancient","steel"}));
    set_long("This is a " + short() + ". It fits over the head and protects " +
        "it during battle. The helmet has some rust on it, but still " +
        "looks durable.\n");

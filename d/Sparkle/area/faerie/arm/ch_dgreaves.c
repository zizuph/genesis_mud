...
create_armour()
{
    ...
    add_name("_ch_dgreaves_");
    set_short("pair of dark greaves");
    set_adj(({"dark","steel"}));
    set_long("This is a " + short() + ". They protect the legs and are " +
        "forged from dark steel. The greaves are polished but have some " +
        "scratches.\n");

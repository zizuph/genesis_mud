...
create_armour()
{
    set_name(({"armour", "bracers"}));
    set_pname("pairs of steel bracers");
    add_name("_ch_bracers_");
    set_short("pair of steel bracers");
    set_adj(({"dark","steel"}));
    set_long("This is a " + short() + ". They are polished to a dark glow. " +
        "The bracers have a brushed finish which hide scratches.\n");

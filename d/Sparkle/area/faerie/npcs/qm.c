/*
 * Minister/QM of Green Oaks
 * /d/Sparkle/area/faerie/npcs/qm.c
 * By Finwe, April 2005
 *
 * Revision History:
 *   June 2011 - Added support for Sparkle Tour (Gorboth)
 */
...
#define TMP_ASKED_FOR_TOUR"_faerie_asked_for_tour"

#define TOURS   ({  "Go and find the bank in Green Oaks. It is run by gnomes " +\
                        "but still a good place to keep money.\n",\
                    "Find the Pub, it's one of the most popular places " +\
                        "in Green Oaks.\n",\
                    "The Shop of Green Oaks is visited by travellers. Discover " +\
                        "where this is at.\n",\
                    "Elves love their drink and have a vintner who makes " +\
                        "their wine. Find his shop and see what he offers.\n",\
                    "Find the Post Office. You can send or receive mail, " +\
                        "and rent messengers there.\n",\
                    "You can visit many faraway lands from here. Go and " +\
                        "find the landing area of the piers of Faerie.\n",\
                    "The Academy of Green Oaks is where you can improve " +\
                        "yourself and learn what travellers have said. "+\
                        "Go and find this important area and return " +\
...
reward_tour(object tp, int qno)
{
    ...
    switch(qno)
    {
        case BANK_TOUR_NUM:     reward = BANK_TOUR_EXP; break;
        case PUB_TOUR_NUM:      reward = PUB_TOUR_EXP; break;
        case SHOP_TOUR_NUM:     reward = SHOP_TOUR_EXP; break;
        case VINT_TOUR_NUM:     reward = VINT_TOUR_EXP; break;
...
//write("DEBUG: Tour number " + qno + " " + TOUR_MAX + "\n");
    ...
    tp->add_prop(TOUR_NOTE_PROP, qno);
    ...
    note = clone_object(OBJ_DIR + "tournote");

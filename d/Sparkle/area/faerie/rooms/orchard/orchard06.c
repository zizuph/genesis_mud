/*
 * /d/Sparkle/area/faerie/rooms/orchard/orchard06.c
 *
...
{
    //add_my_desc("\n");
    add_exit(ORCHARD_DIR + "orchard13", "south");
    add_exit(ORCHARD_DIR + "orchard07", "east");
    add_exit(ORCHARD_DIR + "orchard05", "west");

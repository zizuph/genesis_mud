...
string extra_line = "", 
       up_room = FOREST_DIR + "mtroad24u1";

void
create_forest_room()
{
    set_short("A track in the forest");
    set_long(mt_desc2(extra_line + "Some bees buzz around the upper " +
    ...
    add_exit(FOREST_DIR + "mtroad23", "west");
    add_exit(FOREST_DIR + "mtroad25", "southeast");
}

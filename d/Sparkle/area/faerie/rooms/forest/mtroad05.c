...
string extra_line = "", 
       up_room = FOREST_DIR + "mtroad05u1";

void
create_forest_room()
{
    set_short("A track deep in the mountains");
    set_long(mt_desc6(extra_line + "Some bees buzz around the upper " +
        "branches of a tree."));
    ...
    add_exit(FOREST_DIR + "mtroad04", "north");
    add_exit(FOREST_DIR + "path04", "south");
    add_exit(FOREST_DIR + "mtroad06", "southwest");

...
string extra_line = "The track is covered with animal prints.";
...
{   
    ...
    add_exit(FOREST_DIR + "path03", "northwest");
    add_exit(FOREST_DIR + "path01", "south");
}

...
string extra_line = "", 
       up_room = FOREST_DIR + "mtroad11u1";

void
create_forest_room()
{
    set_short("A track deep in the mountains");
    set_long(mt_desc8(extra_line + "Some bees buzz around the upper " +
    ...
    add_exit(FOREST_DIR + "mtroad10", "north");
    add_exit(FOREST_DIR + "mtroad12", "southeast");
}

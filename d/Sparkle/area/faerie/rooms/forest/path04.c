...
string extra_line = "The track leads north and southeast through the forest and is covered with countless animal prints.";
...
create_forest_room()
{
    ...
    add_exit(FOREST_DIR + "mtroad05", "north");
    add_exit(OC_DIR + "camp01", "southeast");
}

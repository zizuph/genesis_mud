...
string extra_line = "", 
       up_room = FOREST_DIR + "mtroad22u1";

void
create_forest_room()
{
    set_short("A track in the forest");
    set_long(mt_desc5(extra_line  + "Some bees buzz around the upper " +
    ...
    add_exit(FOREST_DIR + "mtroad21", "northwest");
    add_exit(FOREST_DIR + "mtroad23", "southeast");
}

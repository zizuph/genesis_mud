...
string extra_line = "", 
       up_room = FOREST_DIR + "mtroad08u1";

void
create_forest_room()
{
    set_short("A track deep in the mountains");
    set_long(mt_desc9(extra_line + "Some bees buzz around the upper " +
    ...
    add_exit(FOREST_DIR + "mtroad07", "northeast");
    add_exit(FOREST_DIR + "mtroad09", "southwest");
}

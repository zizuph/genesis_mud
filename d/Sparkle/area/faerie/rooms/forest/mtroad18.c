...
string extra_line = "", 
       up_room = FOREST_DIR + "mtroad18u1";

void
create_forest_room()
{
    set_short("A track in the forest");
    set_long(mt_desc1(extra_line + "Some bees buzz around the upper " +
    ...
    add_exit(FOREST_DIR + "mtroad17", "northwest");
    add_exit(FOREST_DIR + "mtroad19", "southeast");
}

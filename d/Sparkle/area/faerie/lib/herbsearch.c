...
#ifndef FAERIE_HERB_MASTER
#define FAERIE_HERB_MASTER "/d/Sparkle/area/faerie/herbs/herb_master.c"
#endif
...
add_std_herbs(mixed type, int seed)
{
    ...
    herb_list = FAERIE_HERB_MASTER->query_herbs(type);
...
/*
 * Function name: reset_faerie_herbs()

 ...
 * 
 * Updated by Petros,
 * March 24, 2009 - Fix the inventory masks so that light status gets updated
 *                  correctly.
 *
 * Updated by Lavellan,
 * September 12, 2010 - Copied fixes from Sparkle box.
 *                      
 */
...
{    
    ...
    if (!IS_CLONE)
    {
        // The master object should not be reset.
        return;
    }

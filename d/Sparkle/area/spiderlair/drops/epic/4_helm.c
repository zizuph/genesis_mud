/*
 * /d/Sparkle/area/spiderlair/drops/epic/4_helm.c
 *
 * magical resistance helm vs earth and air.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_short("dimly orange-glowing helm");
    set_long("This is a dimly orange-glowing helm made of steel. It covers"+
    ...
    " magical resistance to earth and air magic.\n");

/*
 * /d/Sparkle/area/spiderlair/drops/epic/6_bp.c
 *
 * magical resistance breastplate vs poison and illusions.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_short("dimly green-glowing breastplate");
    set_long("This dimly green-glowing breastplate appears to give " +
    "very good protection for the torso.\n");
    set_ac(50);
    set_at(A_CHEST);
        
    add_prop(OBJ_S_WIZINFO, "This breastplate adds 30 magical "+
    "resistance to poison and illusion magic.\n");

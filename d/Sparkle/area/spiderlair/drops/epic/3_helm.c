/*
 * /d/Sparkle/area/spiderlair/drops/epic/3_helm.c
 *
 * magical resistance helm vs death and cold.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    set_name("helm");
    set_adj("dimly");
    set_adj("white-glowing");
    set_short("dimly white-glowing helm");
    set_long("This is a dimly white-glowing helm made of steel. It covers"+
    ...
    " magical resistance to death and cold magic.\n");
...
mixed query_magic_protection(string prop, object what)
{
    ...
    if (prop == MAGIC_I_RES_DEATH || prop == MAGIC_I_RES_COLD)
    {    		 

/*
 * /d/Sparkle/area/spiderlair/drops/epic/3_bp.c
 *
 * magical resistance breastplate vs death and cold.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_short("dimly white-glowing breastplate");
    set_long("This dimly white-glowing breastplate appears to give " +
    "very good protection for the torso.\n");
    set_ac(50);
    set_at(A_CHEST);
        
    add_prop(OBJ_S_WIZINFO, "This breastplate adds 30 magical "+
    "resistance to death and cold magic.\n");

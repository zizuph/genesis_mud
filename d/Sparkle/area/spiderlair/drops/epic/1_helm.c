/*
 * /d/Sparkle/area/spiderlair/drops/epic/1_helm.c
 *
 * magical resistance helm vs light and life.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_short("dimly violet-glowing helm");
    set_long("This is a dimly violet-glowing helm made of steel. It covers"+
    ...
    " magical resistance to light and life magic.\n");

/*
 * /d/Sparkle/area/spiderlair/drops/epic/mr_helm.c
 *
 * magical resistance helm.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_short("dimly purple-glowing helm");
    set_long("This is a dimly purple-glowing helm made of steel. It covers"+
    ...
    " magical resistance vs all spells.\n");
    ...
    "spell.\n", 10,
    "This helm helps to protect the wearer from " +
    "all spells.\n", 50}));
}

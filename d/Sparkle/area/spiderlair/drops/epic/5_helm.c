/*
 * /d/Sparkle/area/spiderlair/drops/epic/5_helm.c
 *
 * magical resistance helm vs fire and water.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_adj("dimly");
    set_adj("red-glowing");
    set_short("dimly red-glowing helm");
    set_long("This is a dimly red-glowing helm made of steel. It covers"+
    ...
    " magical resistance to fire and water magic.\n");
...
mixed query_magic_protection(string prop, object what)
{
    ...
    if (prop == MAGIC_I_RES_FIRE || prop == MAGIC_I_RES_WATER)
    {    		 

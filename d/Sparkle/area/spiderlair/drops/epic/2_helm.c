/*
 * /d/Sparkle/area/spiderlair/drops/epic/2_helm.c
 *
 * magical resistance helm vs acid and electrical.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_short("dimly blue-glowing helm");
    set_long("This is a dimly blue-glowing helm made of steel. It covers"+
    ...
    " magical resistance to acid and electrical magic.\n");

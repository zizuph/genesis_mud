/*
 * /d/Sparkle/area/spiderlair/drops/epic/5_bp.c
 *
 * magical resistance breastplate vs fire and water.
 * Nerull, 21/2/09.
 */
...
void create_armour()
{
    ...
    set_adj("dimly");
    set_adj("red-glowing");
    set_short("dimly red-glowing breastplate");
    set_long("This dimly red-glowing breastplate appears to give " +

/*
 * /d/Sparkle/area/city/bank/room/line1.c
 *
 * This room is in the main hall of the Sparkle bank.
 * It connects to the garage and the main banking room.
 *
 *
...
create_bank_room()
{
    set_short("Bank of Sparkle central hall, northwest");
    set_long("The northwest section of the central hall of the Bank of "
    ...
    add_item( ({ "doors", "door" }),
        ...
        + "like to inspect? Bronze doors or the service door ?\n");
    add_item( ({ "bronze door", "doors", "bronze doors",
                 "main exit", "exit", "entrance", "main entrace",
                 "heavy bronze doors" }),
          "Far to the southeast, you see that thick bronze doors grant "
    ...
    add_item( ({ "lever", "large lever" }),
        ...
        + "Perhaps you should travel to the southeast and look again?\n");
    add_item( ({ "archway", "arch", "white marble arch" }),
          "You are too far away from the archway to properly inspect it. "
        + "Perhaps you should travel southeast to investigate further?\n");
    add_item( ({ "citizenry" }),
    ...
    add_item( ({ "door mechanism", "mechanism", "unsightly mechanism" }),
        ...
        + "unidentifiable parts. It appears that this is how the southeast "
        + "door is moved.\n");
    ...
    add_item( ({ "gnarled vine", "vine" }),
          "The vine in the rooster's beak appears to be gnarled. Do roosters "
        + "eat vines?\n");
...
/* Add_tells */
    ...
    set_room_tell_time(10);
    add_room_tell( size[z] + " " + coin[x] + " coins slowly begin ascending "
        + "the screw in the right tube.\n");
    add_room_tell( size[z] + " " + gem[y] + " slowly begin ascending the screw "
        + "in the right tube.\n");
    add_room_tell( size[z] + " " + gem[y] + " begin descending the left tube "
        + "towards the gnomish strongbox.\n");
    add_room_tell( size[z] + " " + coin[x] + " coins begin descending the left "
...
/* cmd_items */
    ...
    /* Exits */
    add_exit(BANK_ROOM + "line2", "southeast", 0);
    add_exit(BANK_ROOM + "garage", "southwest", 0); /* First floor line 2 */

/*
 *  /d/Sparkle/area/city/wep/church_sword.c
 *
 *  The default sword given to new players who pray at the church in
 *  Sparkle.
 *
...
create_church_weapon()
{
    ...
    set_short("mistform sword");
    set_long("This sword is light as a feather, yet looks as if it could"
      + " still do quite a bit of damage if anyone wanted to"
      + " <wield> it and try to <kill> something.\n");

    set_default_weapon(10, 10, W_SWORD, W_SLASH, W_ANYH, 0);
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(10, W_SWORD) / 4);

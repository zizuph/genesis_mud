/*
 *  /d/Sparkle/area/city/obj/gnome/beam.c
 *
 *  This is a standard beam for gnomish machinery.
 *  This is a wooden beam that generally connects to gears
 *  to show the mechanical energy transferred across the room
 *  or to another room.
 *
 *  Created January 2009, Aeg (Matthew Morin)
...
create_machine()
{
    add_name("beam");
    set_adj( ({ "wooden" }) );
    set_short("@@get_the_desc@@" + "beam");
    set_desc("This is a wooden beam that is mounted to allow movement.");
 ...
 * Description  :        set which direction the beam rotates
 ...
 * Description  :        set up the rotation for this beam.
 */
public void
configure_clockwise()
{

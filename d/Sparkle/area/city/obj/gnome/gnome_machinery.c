...
public object      Next_Machine; /* What is the next machine triggered? */
...
trigger_forward()
{
    ...
    {
        if (Next_Machine && Do_Trigger) /* Is there a Next_Machine? */
        {
            Next_Machine->trigger_forward();
        }
    }
...
trigger_f_forward()
{
    ...
    {
        Next_Machine->trigger_f_forward();
    }
...
trigger_backward()
{
    ...
    if (Immediate && Do_Trigger) /* Should this immediately trigger
                                  * the next machine? */
    {
        if (Next_Machine) /* Is there a Next_Machine? */
        {
            Next_Machine->trigger_backward();
        }
    }
...
trigger_f_backward()
{
    ...
    {
        Next_Machine->trigger_f_backward();
    }
    else if (!Immediate && Do_Trigger) /* Should the Next_Machine
                                        * trigger now? */
    {

 ...
 * 2021-07 - Zizuph
 * - Send notify message to the sold object of its sale price.  Will
 *   be helpful for house auctions.
 *
 */
inherit "/std/monster";
...
return_prize(object player, int aid)
{
    ...
    prize->move(TO,1);
    prize->notify_auction_sale_price(auction_data["current_bid"]);

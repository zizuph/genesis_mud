/*
 *  /d/Sparkle/area/city/rooms/streets/west_c.c
 *
...
{
    set_quadrant("west");
    set_street(STREET_WEST);

    add_exit("northwest_a", "north");
    add_exit("west_b", "east");
    add_exit("southwest_2e", "south");
    add_exit("west_d", "west");
} /* create_sparkle */
/*
 *  /d/Sparkle/area/city/rooms/streets/northeast_3a.c
 *
...
create_sparkle()
{
    ...
    set_street(STREET_NORTHEAST_3);

    add_exit("northeast_3b", "east");
    add_exit("northeast_4a", "south");
    add_exit("northeast_2f", "west");
} /* create_sparkle */
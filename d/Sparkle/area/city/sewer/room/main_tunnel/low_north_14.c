/*
 *  /d/Sparkle/area/city/sewer/room/main_tunnel/low_north_14.c
 *
 *  This is a main tunnel room of the sewers of Sparkle.
 *
 * Upstream: high_north_west_1.c
 * Downstream: low_north_13.c
 * 
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "high_north_west_1", "up", 0);  
    add_exit(SEWER_MAIN_TUNNEL + "low_north_13", "south", 0); 

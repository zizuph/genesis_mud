/*
 *  /d/Sparkle/area/city/sewer/room/main_tunnel/low_north_5.c
 *
 *  This is a main tunnel room of the sewers of Sparkle.
 *
 * Upstream: low_north_6.c
 *           high_north_northeast_1.c
 * Downstream: low_north_4.c
 * 
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "high_north_northeast_1", "up", 0);
    add_exit(SEWER_MAIN_TUNNEL + "low_north_6", "west", 0);  
    add_exit(SEWER_MAIN_TUNNEL + "low_north_4", "east", 0);  

/*
 *  /d/Sparkle/area/city/sewer/room/main_tunnel/low_northwest_3.c
 *
 ...
 * For rent (north)
 * Road (east, west)
 * The Story Teller (south)
 * "memory lane" (southwest)
 *
 *  Aeg
 */
#pragma strict_types
...
/* Defines */
#define            FALL_LOCATION (SEWER_MAIN_TUNNEL + "low_northwest_2")
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "low_northwest_4", "west", 0);
    add_exit(SEWER_MAIN_TUNNEL + "low_northwest_2", "east", 0);

/*
 *  /d/Sparkle/area/city/sewer/room/main_tunnel/low_north_9.c
 *
 *  This is a main tunnel room of the sewers of Sparkle.
 *
 * Upstream: low_north_10.c
 * Downstream: low_north_8.c
 * 
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "low_north_10", "north", 0);  
    add_exit(SEWER_MAIN_TUNNEL + "low_north_8", "east", 0);  

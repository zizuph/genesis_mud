/*
 *  /d/Sparkle/area/city/sewer/room/main_tunnel/low_north_3.c
 *
 *  This is a main tunnel room of the sewers of Sparkle.
 *
 * Upstream: low_north_4.c
 * Downstream: low_north_2.c
 * 
 * According to Styles' map:
 * What should be above me? 
 * A Road through the South Gate (inside)
 *
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "low_north_4", "north", 0);
    add_exit(SEWER_MAIN_TUNNEL + "low_north_2", "south", 0);  

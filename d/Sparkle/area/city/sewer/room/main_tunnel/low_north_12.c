/*
 *  /d/Sparkle/area/city/sewer/room/main_tunnel/low_north_12.c
 *
 *  This is a main tunnel room of the sewers of Sparkle.
 *
 * Upstream: low_north_13.c
 * Downstream: low_north_11.c
 * 
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "low_north_13", "west", 0);  
    add_exit(SEWER_MAIN_TUNNEL + "low_north_11", "east", 0); 

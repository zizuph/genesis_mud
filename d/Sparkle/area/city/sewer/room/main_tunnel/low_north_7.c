/*
 *  /d/Sparkle/area/city/sewer/room/main_tunnel/low_north_7.c
 *
 *  This is a main tunnel room of the sewers of Sparkle.
 *
 * Upstream: low_north_8.c
 * Downstream: low_north_6.c
 * 
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "low_north_8", "west", 0);  
    add_exit(SEWER_MAIN_TUNNEL + "low_north_6", "east", 0);  

...
create_sparkle()
{
    ...
    long_desc = "The subterranean environment, being poorly lit, does not "
           + "instantly paint a complete picture. Allowing your eyes to "
           + "adjust to the scene, darkness yields and details are revealed. ";
    ...
    try_item( ({ "environment", "area", "sewer", "room", "tunnel", 
             ...
             "A tunnel extends upstream and downstream with classic "
    ...
    try_item( ({ "post", "post and lintel", "architecture", 
                 "walls", "posts", "classic architecture" }),
    ...
    try_item( ({ "smell", "smells" }),
            "Right. Intelligent people examine sounds too.\n");
            
    try_item( ({ "sound", "sounds" }),
            "Right. Intelligent people examine smells too.\n");

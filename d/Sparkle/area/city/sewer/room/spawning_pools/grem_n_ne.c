/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_n_ne.c
 *
 *  This is the north-northeast room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    // Exits Section
    add_exit(SPAWNING_POOLS + "grem_n", "southwest", 0);

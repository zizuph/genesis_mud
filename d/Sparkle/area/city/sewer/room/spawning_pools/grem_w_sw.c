/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_w_sw.c
 *
 *  This is the west-southwest room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    // Exits Section
    add_exit(SPAWNING_POOLS + "grem_w", "northeast", 0);

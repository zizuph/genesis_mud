/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_n.c
 *
 *  This is the north room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    // Exits Section
    /* add_exit(SPAWNING_POOLS + "grem_n_ne", "northeast", 0);
    add_exit(SPAWNING_POOLS + "grem_n_nw", "northwest", 0); */
    add_exit(SPAWNING_POOLS + "grem_w", "southwest", 0); 
    add_exit(SPAWNING_POOLS + "grem_c", "south", 0);
    add_exit(SPAWNING_POOLS + "grem_e", "southeast", 0);

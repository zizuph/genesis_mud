/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_n_nw.c
 *
 *  This is the north-northwest room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    set_long("These sewers appear to be tainted more than normal. Someone, "
           + "or something, has crafted damns of rubbish and debris to "
    ...
    // Exits Section
    add_exit(SPAWNING_POOLS + "grem_n", "southeast", 0);

/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_w.c
 *
 *  This is the west room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    // Exits Section
    add_exit(SPAWNING_POOLS + "grem_n", "northeast", 0);
    /* add_exit(SPAWNING_POOLS + "grem_w_nw", "northwest", 0);
    add_exit(SPAWNING_POOLS + "grem_w_sw", "southwest", 0); */
    add_exit(SPAWNING_POOLS + "grem_c", "east", 0);

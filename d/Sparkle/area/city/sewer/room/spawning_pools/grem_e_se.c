/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_e_se.c
 *
 *  This is the east-southeast room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    // Exits Section
    add_exit(SPAWNING_POOLS + "grem_e", "northwest", 0);

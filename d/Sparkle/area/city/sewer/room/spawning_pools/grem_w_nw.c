/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_w_nw.c
 *
 *  This is the west-northwest room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    // Exits Section
    add_exit(SPAWNING_POOLS + "grem_w", "southeast", 0);

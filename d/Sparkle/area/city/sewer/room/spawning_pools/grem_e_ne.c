/*
 *  /w/aeg/sparkle/sewer/spawning_pools/grem_e_ne.c
 *
 *  This is the east-northeast room for the gremlin spawning pools.
 *
...
create_sewer_room()
{
    ...
    // Exits Section
    add_exit(SPAWNING_POOLS + "grem_e", "southwest", 0);

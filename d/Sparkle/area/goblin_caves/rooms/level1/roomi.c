 ...
 * Updated July 25, 2016 by Gronkas - fixing a typo
 */
#include "defs.h"
#pragma strict_types
	...
	switch(coef)
	{
		...
		case 161..240: return "one hits right in the center of target and " +
		                      ...
		                      one_of_list(({"right leg",
		                                    ...
		                                    "head"})) +
		                      " with knife handle";
		case 241..320: return "all of them hit the mannequin in different places";
		case 321..400: return "all of them hit center of the target";
		case 401..1000: return "one by one the blades shred the " +

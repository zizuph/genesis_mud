...
create_room()
{
    ...
    set_short("Southeastern corridor");
    set_long("This is a wide tunnel which appears to connect two large " +
        "caves. A decorative black stone mosaic covers the floor beneath you," +
        ...
        "black stone appears to meet up with similar decorative stones " +
        "of white and grey.\n\n");
    
    add_item(({"black stones", "decorative stones", "floor", "tunnel",
                "corridor", "down", "mosaic"}),
        "There are thousands of small, decorative stones, all black " +
        ...
        "cave where similar decorative stones of white and grey " +
        "merge with these black stones.\n");
    add_item(({"ceiling", "up"}),
    ...
    add_item(({"end", "ends"}),
        "This corridor ends into two large caves, one to the northeast " +
        "and one to the northwest.\n");
    add_item(({"northeast end", "northeastern end"}),
        "There appears to be a rather large cave at this end of the " +
        "corridor, you will have to enter it to see more.\n");
    add_item(({"northwest end", "northwestern end"}),
        "There appears to be a rather large cave at this end of the " +
        "corridor, you will have to enter it to see more.\n");

    add_exit("shaman_boss", "northeast", "@@check_shaman");
    add_exit("shaman_entrance", "northwest");

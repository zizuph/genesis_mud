/*
 *  /d/Sparkle/area/tutorial/obj/backpack.c
 *
 *  This pack is sold at the General Store in Silverdell:
...
create_backpack()
{
    ...
    set_backpack_long("This backpack helps you carry more than you"
      + " would otherwise be strong enough to hold. You can <open>"
      + " and <close> the pack. You can <put> things in the pack to"
      + " make them feel lighter. You can then <get> them from the"
      + " pack later if you want to use or sell them. ");
}

/*
 *  /d/Sparkle/area/tutorial/woods/forest_5b.c
 *
...
#define            LOCATION         "ne"     /* where in the woods?  */
...
create_forest_room()
{
    ...
    add_exit("forest_6c", "southeast");
    add_exit("forest_5c", "south");
    add_exit("forest_4c", "southwest");
    add_exit("forest_4b", "west");
    add_exit("forest_4a", "northwest");

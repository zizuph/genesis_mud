/*
 *  /d/Sparkle/area/tutorial/woods/forest_5c.c
 *
...
create_forest_room()
{
    ...
    add_exit("forest_5b", "north");
    add_exit("forest_6c", "east");
    add_exit("forest_5d", "south");
    add_exit("forest_4d", "southwest");
    add_exit("forest_4c", "west");
    add_exit("forest_4b", "northwest");

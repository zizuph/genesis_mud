/*
 *  /d/Sparkle/area/tutorial/woods/forest_3b.c
 *
...
create_forest_room()
{
    ...
    add_exit("forest_3a", "north");
    add_exit("forest_4a", "northeast");
    add_exit("forest_4b", "east");
    add_exit("forest_4c", "southeast");
    add_exit("forest_3c", "south");
    add_exit("forest_2c", "southwest");
    add_exit("forest_2b", "west");

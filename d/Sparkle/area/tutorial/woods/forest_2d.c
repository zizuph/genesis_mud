/*
 *  /d/Sparkle/area/tutorial/woods/forest_2d.c
 *
...
#define            LOCATION         "sw"     /* where in the woods?  */
...
create_forest_room()
{
    ...
    add_exit("forest_2c", "north");
    add_exit("forest_3c", "northeast");
    add_exit("forest_3d", "east");
    add_exit("forest_3f", "southeast");
    add_exit("forest_1c", "northwest");

/*
 *  /d/Sparkle/area/tutorial/woods/forest_3f.c
 *
...
#define            LOCATION         "s"          /* where in the woods?  */
...
create_forest_room()
{
    ...
    add_exit("forest_3d", "north");
    add_exit("forest_4d", "northeast");
    add_exit("forest_4f", "east");
    add_exit("forest_2d", "northwest");

/*
 *  /d/Sparkle/area/tutorial/town/goblin_start.c
 *
 *  The goblin racial startlocation in Silverdell.
...
create_silverdell()
{
    ...
    set_long("You stand beside a dark cave in the woods."
      + " This is a place where goblins may <start here> to have this"
      + " become their start location. Read the tutorial sign"
      + " for more details.\n\n");

    add_item( ({ "grove", "trees", "grove of trees", "woods" }),
        "Trees surround you here, bordering the cave on all sides."
    ...
    add_item( ({ "cave", "hill", "hillside", "dark cave" }),
        "This dark cave looks just how you would want it to. It"
      + " travels into the side of a hill and looks perfectly"
      + " inviting. Perhaps you should <start here> from now on"
      + " and call this your home?\n");
...
int start(string arg)
{
    ...
    {
        notify_fail("Only goblins may start here.\n");
        return 0;
    }

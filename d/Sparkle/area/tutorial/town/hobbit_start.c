/*
 *  /d/Sparkle/area/tutorial/town/hobbit_start.c
 *
 *  The hobbit racial startlocation in Silverdell.
...
create_silverdell()
{
    set_short("near a comfortable hobbit hole in the woods");
    set_long("You stand beside a comfortable hobbit hole in the woods."
      + " This is a place where hobbits may <start here> to have this"
      + " become their start location. Read the tutorial sign"
      + " for more details.\n\n");

    add_item( ({ "grove", "trees", "grove of trees", "woods" }),
        "Trees surround you here, bordering the hobbit hole on all sides."
    ...
    add_item( ({ "hole", "hobbit hole", "comfortable hole",
                 "comfortable hobbit hole" }),
        "This hole looks just like you would want it to. It is"
      + " not a nasty, dirty, wet hole. Nor is it a dry, sandy hole."
      + " It is a hobbit hole, and that means comfort. Perhaps you"
      + " should <start here> from now on?\n");
...
int start(string arg)
{
    ...
    {
        notify_fail("Only hobbits may start here.\n");
        return 0;
    }

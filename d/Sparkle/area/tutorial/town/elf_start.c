/*
 *  /d/Sparkle/area/tutorial/town/elf_start.c
 *
 *  The elf racial startlocation in Silverdell.
...
create_silverdell()
{
    set_short("near an enchanted oak tree in the woods");
    set_long("You stand beside an enchanted oak tree in the woods."
      + " This is a place where elves may <start here> to have this"
      + " become their start location. Read the tutorial sign"
      + " for more details.\n\n");

    add_item( ({ "grove", "trees", "grove of trees", "woods" }),
        "Trees surround you here, bordering the oak on all sides."
    ...
    add_item( ({ "tree", "oak", "oak tree", "enchanted tree",
                 "enchanted oak", "enchanted oak tree" }),
        "The air surrounding the oak tree hums with magic. You"
      + " can <start here> if you wish to make this your home.\n");
...
int start(string arg)
{
    ...
    {
        notify_fail("Only elves may start here.\n");
        return 0;
    }

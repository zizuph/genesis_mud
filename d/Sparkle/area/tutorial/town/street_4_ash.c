/*
 *  /d/Sparkle/area/tutorial/town/street_4_ash.c
 *
...
create_ash_room()
{
    ...
    add_exit("street_5_ash", "north");
    add_exit("post_office_ash", "east");
    add_exit("street_3_ash", "southwest");
    add_exit("bank_ash", "west");

/*
 *  /d/Sparkle/area/tutorial/town/gnome_start.c
 *
 *  The gnome racial startlocation in Silverdell.
...
create_silverdell()
{
    ...
    set_long("You stand beside a house-like contraption in the woods."
      + " This is a place where gnomes may <start here> to have this"
      + " become their start location. Read the tutorial sign"
      + " for more details.\n\n");

    add_item( ({ "grove", "trees", "grove of trees", "woods" }),
        "Trees surround you here, bordering the contraption on all sides."
    ...
    add_item( ({ "contraption", "gizmo", "bell", "bells",
                 "whistle", "whistles", "whatnot", "whatnots",
                 "doohicky", "doohickies", "house-like contraption",
                 "house", "home" }),
        "You stare in wonderment at the ingenuity of this contraption."
      + " Bells and whistles are everywhere, surrounded by various"
      + " assortments of whatnots and doohickies. This is simply"
      + " the most brilliant home you could ever have! Perhaps you"
      + " should <start here> immediately!\n");
...
int start(string arg)
{
    ...
    {
        notify_fail("Only gnomes may start here.\n");
        return 0;
    }

/*
 *  /d/Sparkle/area/tutorial/farm/radish_patch3.c
 *
...
#define     LOCATION         "e"      /* where in the field?  */
#define     BUNNY_NUM        0        /* how many bunnies?    */
#define     TUTORIAL_CHAPTER 46       /* chapter for the sign */
...
create_crop_room()
{
    ...
    add_exit("radish_patch2a", "southwest");
    add_exit("potato_patch3", "west", check_exit, 1, 0);

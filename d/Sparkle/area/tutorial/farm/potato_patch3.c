/*
 *  /d/Sparkle/area/tutorial/farm/potato_patch3.c
 *
...
/* Definitions */
#define            CROP_TYPE        "potato"  /* what's planted here? */
#define            LOCATION         "ne"      /* where in the field?  */
#define            BUNNY_NUM        1         /* how many bunnies?    */
...
create_crop_room()
{
    ...
    add_exit("carrot_patch3", "north", check_exit, 1, 0);
    add_exit("radish_patch3", "east");
    add_exit("potato_patch2a", "southwest");

/*
 *  /d/Sparkle/area/tutorial/farm/turnip_patch1.c
 *
...
#define            LOCATION         "w"       /* where in the field?  */
...
create_crop_room()
{
    ...
    add_exit("garlic_patch1", "north", check_exit, 1, 0);
    add_exit("turnip_patch1a", "northeast");
    add_exit("carrot_patch1", "east");

/*
 *  /d/Sparkle/area/tutorial/pre_creation/6.c
 *
 *  This room is part of a tutorial for new players in Genesis.
 *  It teaches players how to use the search command.
 *
...
create_room()
{
    ...
    add_exit("5", "south", &log_move("5"), 1, 0);

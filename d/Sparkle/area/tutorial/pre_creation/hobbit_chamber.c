/*
 *  /d/Sparkle/area/tutorial/pre_creation/hobbit_chamber.c
 *
 *  This room describes the hobbit race for the pre-creation
 *  player tutorial.
 *
...
create_room()
{
    ...
    add_exit("7", "southwest", &log_move("7"), 1, 0);
...
reset_room()
{
    ...
    if (!present("_tutorial_statue"))
    {
        ...
        statue->set_statue("hobbit");
        statue->add_adj("hobbit");
        statue->add_name("hobbit");

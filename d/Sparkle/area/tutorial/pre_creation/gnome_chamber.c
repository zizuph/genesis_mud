/*
 *  /d/Sparkle/area/tutorial/pre_creation/gnome_chamber.c
 *
 *  This room describes the gnome race for the pre-creation
 *  player tutorial.
 *
...
create_room()
{
    ...
    add_exit("7", "northeast", &log_move("7"), 1, 0);
...
reset_room()
{
    ...
    if (!present("_tutorial_statue"))
    {
        ...
        statue->set_statue("gnome");
        statue->add_adj("gnome");
        statue->add_name("gnome");

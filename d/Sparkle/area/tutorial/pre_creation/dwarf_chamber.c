/*
 *  /d/Sparkle/area/tutorial/pre_creation/dwarf_chamber.c
 *
 *  This room describes the dwarf race for the pre-creation
 *  player tutorial.
 *
...
create_room()
{
    ...
    add_exit("7", "southeast", &log_move("7"), 1, 0);
...
reset_room()
{
    ...
    if (!present("_tutorial_statue"))
    {
        ...
        statue->set_statue("dwarf");
        statue->add_adj("dwarf");
        statue->add_name("dwarf");

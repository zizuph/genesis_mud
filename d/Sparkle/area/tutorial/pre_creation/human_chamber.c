/*
 *  /d/Sparkle/area/tutorial/pre_creation/human_chamber.c
 *
 *  This room describes the human race for the pre-creation
 *  player tutorial.
 *
...
create_room()
{
    ...
    add_exit("7", "west", &log_move("7"), 1, 0);
...
reset_room()
{
    ...
    if (!present("_tutorial_statue"))
    {
        ...
        statue->set_statue("human");
        statue->add_adj("human");
        statue->add_name("human");

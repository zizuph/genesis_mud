/*
 *  /d/Sparkle/area/tutorial/pre_creation/4.c
 *
...
create_room()
{
    ...
    add_item( ({ "west wall", "western wall", "west" }),
        "The west wall is made up of mostly of stone. However, you notice"
    ...
    add_exit("5", "southeast", &log_move("5"), 1, 1);
    add_exit("3", "west", &log_move("3"), 1, 1);

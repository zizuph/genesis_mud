/*
 *  /d/Sparkle/area/tutorial/pre_creation/goblin_chamber.c
 *
 *  This room describes the goblin race for the pre-creation
 *  player tutorial.
 *
...
create_room()
{
    ...
    add_exit("7", "northwest", &log_move("7"), 1, 0);
...
reset_room()
{
    ...
    if (!present("_tutorial_statue"))
    {
        ...
        statue->set_statue("goblin");
        statue->add_adj("goblin");
        statue->add_name("goblin");

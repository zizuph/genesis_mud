...
static string *titles = ({ "Trainee", "Scout", "Officer", });
...
{
    return MIN(MAX_GUILD_LEVEL, query_shadow_who()->query_stat(SS_OCCUP) / 5);
}
...
{
    switch(query_shadow_who()->query_stat(SS_OCCUP))
    {
        case 0..4:
            return "Fresh Recruit of the Patrol Guild of Silverdell";
            break;
        case 5..14:
            return "Scout of the Patrol Guild of Silverdell";
            break;
        default:
            return "Officer of the Patrol Guild of Silverdell";
            break;
    }
}
...
show_subloc(string subloc, object me, object for_obj)
{
    ...
    return str + "a vigilant member of the " + GUILD_NAME + ".\n";
}

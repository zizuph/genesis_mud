/*
 *  /d/Sparkle/area/tutorial/arm/leather_vest.c
 *
 *  This is the lower-level chest armour sold in the Armour Shop
...
create_armour() 
{
    ...
    set_long("This armour can be worn on the chest to protect from"
    ...
    add_prop(OBJ_I_WEIGHT, (F_WEIGHT_DEFAULT_ARMOUR(7, A_BODY) / 4));

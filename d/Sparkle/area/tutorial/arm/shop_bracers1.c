/*
 *  /d/Sparkle/area/tutorial/arm/shop_bracers1.c
 *
 *  This is the lower-level wrist armour sold in the Armour Shop
...
create_armour() 
{
    ...
    set_default_armour(5, A_ARMS, ({ 0, 1, -1}), 0);
    ...
    add_prop(OBJ_I_WEIGHT, (F_WEIGHT_DEFAULT_ARMOUR(5, A_ARMS) / 4));

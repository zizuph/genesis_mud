/*
 *  /d/Sparkle/area/tutorial/arm/shop_greaves2.c
 *
 *  This is the upper-level leg armour sold in the Armour Shop
...
create_armour() 
{
    ...
    set_short("pair of studded greaves");
    set_pshort("pairs of studded greaves");
    ...
    add_prop(OBJ_I_WEIGHT, (F_WEIGHT_DEFAULT_ARMOUR(10, A_LEGS) / 4));

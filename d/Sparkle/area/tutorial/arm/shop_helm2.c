/*
 *  /d/Sparkle/area/tutorial/arm/shop_helm2.c
 *
 *  This is the upper-level helmet sold in the Armour Shop
...
create_armour() 
{
    ...
    set_short("studded-leather helm");
    ...
    set_default_armour(9, A_HEAD, ({ 0, 1, -1}), 0);
    ...
    add_prop(OBJ_I_WEIGHT, (F_WEIGHT_DEFAULT_ARMOUR(9, A_HEAD) / 4));
    add_prop(OBJ_I_VOLUME, 200);
    add_prop(OBJ_I_VALUE, F_VALUE_ARMOUR(9) + random(12));
} /* create_armour */

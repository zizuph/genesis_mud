/*
 *  /d/Sparkle/area/tutorial/arm/shop_bracers2.c
 *
 *  This is the upper-level wrist armour sold in the Armour Shop
...
create_armour() 
{
    ...
    set_short("pair of studded bracers");
    set_pshort("pairs of studded bracers");
    set_long("These armours can be worn on the wrists to protect from"
      + " enemy attacks. Use the command <wear> to put them on, and"
      + " <remove> to take them off of your body.\n");

    set_default_armour(10, A_ARMS, ({ 0, 1, -1}), 0);
    ...
    add_prop(OBJ_I_WEIGHT, (F_WEIGHT_DEFAULT_ARMOUR(10, A_ARMS) / 4));
    add_prop(OBJ_I_VOLUME, 400);
    add_prop(OBJ_I_VALUE, F_VALUE_ARMOUR(10) + random(24));
} /* create_armour */

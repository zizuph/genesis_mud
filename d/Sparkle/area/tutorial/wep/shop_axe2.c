/*
 *  /d/Sparkle/area/tutorial/wep/shop_axe2.c
 *
 *  This is the upper-level axe sold in the Weapons Shop
...
{
    set_name("battle-axe");
    add_adj( ({ "heavy", "battle" }) );
    add_name( ({ "axe", "battleaxe" }) );

    set_short("heavy battle-axe");
    set_long("This is an improved axe weapon which will do"
    ...
    set_default_weapon(22, 22, W_AXE, W_SLASH, W_BOTH, 0);
    ...
    add_prop(OBJ_I_WEIGHT, (F_WEIGHT_DEFAULT_WEAPON(22, W_AXE) / 4));

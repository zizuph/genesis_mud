/*
 *  /d/Sparkle/area/tutorial/wep/shop_knife2.c
 *
...
create_weapon()
{
    ...
    set_long("This is an improved knife weapon which will do"
    ...
    set_default_weapon(12, 12, W_KNIFE, W_SLASH|W_IMPALE, W_ANYH, 0);
    ...
    add_prop(OBJ_I_WEIGHT, (F_WEIGHT_DEFAULT_WEAPON(12, W_KNIFE) / 3));
    add_prop(OBJ_I_VALUE, F_VALUE_WEAPON(12, 12));

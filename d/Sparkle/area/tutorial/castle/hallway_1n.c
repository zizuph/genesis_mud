/*
 *  /d/Sparkle/area/tutorial/castle/hallway_1n.c
 *
...
create_castle_room()
{
    ...
    set_long("Cold, torchlit walls run into the distance to the west,"
      ...
      + " castle. To the south, the entrance to the castle is"
      + " visible.\n\n");
    ...
    add_item( ({ "south", "entrance" }),
        "South of here, an entrance leads out of the castle.\n");

    add_castle_items();
    add_torch_items();

    add_exit("hallway_2n", "west");

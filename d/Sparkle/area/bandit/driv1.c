...
create_room()
{
    ...
    set_long("You are walking along a small dirt path, which winds its way " +
        ...
        "you here, it continues north where it gurgles under an old bridge, " +

...
create_room()
{
    ...
    set_long("You are at the end of a small dirt path, which winds its way " +
        ...
        "horizon. Off somewhere to the northeast, is the famous town " +
        "of Sparkle, the legendary port which connects to even the most " +
        "remote corners of the world.\n");

    add_exit(THIS_DIR + "driv4","north");

...
create_monster()
{
    ...
    set_stats(({60, 60, 60, 40, 40, 50}), 40);
    MAKE_MONEY;
    set_alignment(-200);
...
{
    string *banname;
    banname = ({"abbo", "adion", "arcian", "babol", "blude", "brost", "caltion", 
        "camus", "cedrus", "cernicus", "clabo", "cole", "cralto", "crondo",
        "danus", "dawar", "detrian", "denlus", "dilgus", "drune", "druvas",
        "erlo", "falgas", "fantis", "fralus", "gert", "gluff", "griss", "hadan",
        "hiram", "higg", "holtan", "jerge", "jogu", "kap", "kortus", "langer", 
        "lappus", "lewol", "limm", "makran", "mardial", "maudin", "merat", 
        "mirt", "modd", "molke", "nalo", "natran", "neddi", "neprin",
        "novian", "padal", "pagra", "pedor", "purfan", "quett", "randfas", 
        "rappan", "ravul", "remul", "rital", "rogga", "sabed", "sengi",
        "stolly", "taffo", "tarman", "teliar", "urte", "walir", "wodrun"});

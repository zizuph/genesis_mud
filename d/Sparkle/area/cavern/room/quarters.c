...
create_room()
{
  ...
  add_exit("/d/Genesis/start/goblin/caverns/common", "common", 0);
  add_exit(GOBLIN_CAVERN_DIR + "training_room","southeast","@@bendeast",0);
  add_exit(GOBLIN_CAVERN_DIR + "tunnel1","west",0,0);
...
bendeast()
{
  write("The tunnel turns eastward.\n");
  return 0;
}

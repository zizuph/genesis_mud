...
create_sea_room()
{
    ...
    set_short("near the coastline of the Jade Forest");
    set_long("You are near the coastline that borders the Pen Sea, " +
        "a body of water the stretches out to your east. The dark " +
        "shadowy Jade Forest extends to your southwest, " +
        "while to your north along the coastline you can make out the " +
        "port town of Sparkle - a bustling hub for merchants, sailors " +
        "and adventurers.\n");

    add_item(({"forest", "jade forest","coastline","shadows","dark shadows"}),
        "The dark shadows of the Jade Forest loom menacingly along the " +
        "edge of the coastline. This forest has an unsavory reputation, " +
        "with tales of desperate bandits and ferocious ogres lairing here.\n");

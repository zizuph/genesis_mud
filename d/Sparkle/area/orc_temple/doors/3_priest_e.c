 ...
 *
 *  This is the east side of the door to the High Priest's chamber
...
create_dungeon_door()
{
    ...
    set_open_desc("There is an open polished cedar door leading west.\n");
    set_closed_desc("There is a closed polished cedar door leading west.\n");
    ...
    set_door_desc("A polished cedar door is set within an alcove"
      + " in the western wall of the chamber here. The door is of"
    ...
    set_other_room(ROOMS_DIR + "3_hall9");

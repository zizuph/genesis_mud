/*
 *  /d/Sparkle/area/orc_temple/doors/1_armour_w.c
 *
 *  This is the west side of the door to the armoury on the first
...
create_dungeon_door()
{
    ...
    set_open_desc("There is an open black metal door leading east.\n");
    set_closed_desc("There is a closed black metal door leading east.\n");
    ...
    set_door_desc("A black metal door is set firmly in the eastern"
    ...
    set_other_room(ROOMS_DIR + "1_armoury");

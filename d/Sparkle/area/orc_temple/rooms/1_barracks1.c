/*
 *  /d/Sparkle/area/orc_temple/1_barracks1.c
 *
...
create_dungeon_room()
{
    ...
    set_long("What a ... terrible! ... smell! This appears to be"
      ...
      + " this large chamber which extends a ways further to the"
      + " north. A crude archway leads east.\n\n");

    try_item( ({ "smell", "terrible smell" }),
        "It's worse than lutefisk!\n");
    try_item( ({ "lutefisk" }),
        "There isn't any, and this is worse!\n");
    try_item( ({ "main corridor", "corridor" }),
        "The corridor is east, through the archway.\n");
    ...
    add_exit("1_barracks2", "north");
    add_exit("1_hall3", "east");

...
create_room()
{
     set_short("The gentlemen's toilet");
     set_long("You are in the gentlemen's toilet. It is a filthy, smelly "
...
add_item(({"wall","walls"}),"They are dirty and covered in drawings "
	+"and words.\n");

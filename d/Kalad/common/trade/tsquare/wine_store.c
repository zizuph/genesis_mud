...
add_exit(TRADE(tsquare/wine_shop),"north",0,-1,-1);
...
#define PUNCH "/d/Kalad/common/trade/tsquare/obj/newbie_punch.c"
#define MEAD "/d/Kalad/common/trade/tsquare/obj/mead.c"
#define WINE "/d/Kalad/common/trade/tsquare/obj/strong_wine.c"

mixed to_check = ({ ({ "create_drink", PUNCH, 6}),
({ "create_drink", WINE, 6}),
({ "create_drink", MEAD, 6}),
                 });

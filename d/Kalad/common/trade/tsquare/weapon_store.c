...
{
set_short("Storeroom");
set_long("This is a big room with weapons in it.\n");
add_exit(TRADE(tsquare/weapon_shop),"south",0,-1,-1);
...
#define STLSCIM "/d/Kalad/common/trade/tsquare/obj/stlscim.c"
#define BRSCIM "/d/Kalad/common/trade/tsquare/obj/brscim.c"
mixed to_check = ({ ({ "create_weapon", STLSCIM, 6}),
({ "create_weapon", BRSCIM, 6}),
                 });

...
#define STORE_ROOM "/d/Kalad/common/trade/tsquare/basket_store"
object ob1;
void
create_room()
{
   ...
   hear_bell = 1;
   INSIDE;
   set_short("Ahkmed's Basket Shop");
   set_long("This is Ahkmed's basket shop. Ahkmed sells the finest baskets "
      +"in the city of Kabal. They are large baskets, "
      +"but not very high quality.\n");
   add_exit(TRADE(tsquare/t6),"west");
   add_exit(TRADE(tsquare/basket_store),"south","@@wiz_check");

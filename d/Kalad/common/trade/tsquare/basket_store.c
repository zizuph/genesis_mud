...
{
set_short("Storeroom");
set_long("This is a big room with baskets in it.\n");
add_exit(TRADE(tsquare/basket_shop),"north",0,-1,-1);
...
#define BASKET "/d/Kalad/common/trade/tsquare/obj/basket.c"
mixed to_check = ({ ({ "create_container", BASKET, 10}),
                 });

...
create_room()
{
	...
	+"| dawn red                                              |\n"
	+"| pale red                              black           |\n"
	+"| purple            white               jet black       |\n"
	+"|                   frost white         midnight black  |\n"
	+"|                   snow white          velvet black    |\n"
        +"| yellow            glowing white       ebony           |\n"
        +"| orange            shimmering white    bronze          |\n"
	+"| pale orange       milk white          tanned          |\n"
	+"| dark yellow       marble white        pale            |\n"
	+"| pale yellow                           pink            |\n"
	+"|                   brown               golden          |\n"
	+"|                   earth brown         silver          |\n"
	+"| grey              dark brown          copper          |\n"
	+"| dark grey         pale brown          chartreuse      |\n"
	+"| pale grey         dung brown          faded           |\n"
	+"|                                                       |\n"
	+" ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ \n"

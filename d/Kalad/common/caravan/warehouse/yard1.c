...
create_cvan_room()
{
    add_prop(ROOM_I_NO_TIME_DESC, 1);
    ...
    set_long("This dry and dusty field is the front yard of the "+
      ...
      "from Warehouse Lane in the south to the doors of the warehouse in the "+
      "north.\n");

    add_item(({ "warehouse" }), "A large rectangular structure that fills "+
      "your vision to the north, two large doors lead inside.\n");
    ...
    add_exit(CVAN + "warehouse/wh1", "north", "@@query_move");
    add_exit(CVAN + "warehouse/s1", "south");

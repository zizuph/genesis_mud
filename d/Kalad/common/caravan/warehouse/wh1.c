...
create_cvan_room()
{
    ...
    set_long("You probably shouldn't be in here, if anyone ever found "+
      "out, the merchants and traders would probably lynch you on sight, "+
      "but then again, what do you care? All around you are piles upon "+
    ...
    add_item(({ "symbol" }), "An image of a red sun on a white field is "+
    ...
    add_exit(CVAN + "warehouse/yard1", "south");
}

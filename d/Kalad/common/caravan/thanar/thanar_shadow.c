...
{
    return "/d/Kalad/common/caravan/thanar/train";
}
...
query_thanar_level()
{
    return shadow_who->query_base_stat(SS_RACE) / 4;
}
...
show_subloc(string subloc, object me, object for_obj)
{
	...
	return "";
    if(MASTER_OB(me->query_armour(A_NECK)) != "/d/Kalad/common/caravan/thanar/symbol")
	return "";
    if (for_obj == me)
	pos = "your";
    else

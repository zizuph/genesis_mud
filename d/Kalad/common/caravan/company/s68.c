...
create_cvan_room()
{
    ...
    set_long("You enter the council chambers of the Trading Company.\n"+
      "You find yourself inside a massive room. To your south are several finely "+
      "crafted stone benches which continue along the wall towards the west. "+
      "North from here is a large open space, apparently where council "+
    ...
    add_exit(CVAN + "company/s69", "west");
    add_exit(CVAN + "company/s61", "north");

    clone_object(CVAN + "door/tcdoor9")->move(TO);

...
create_cvan_room()
{
    ...
    set_long("You are travelling along a hallway.\n"+
      ...
      "to the north and south, while a smaller hallway heads east.\n");
    ...
    add_exit(CVAN + "company/s45", "north");
    add_exit(CVAN + "company/s63", "east");
    add_exit(CVAN + "company/s67", "south");

    clone_object(CVAN + "door/tcdoor6")->move(TO);

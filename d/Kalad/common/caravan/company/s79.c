...
create_cvan_room()
{
    ...
    set_long("You enter the deathly quiet alcove. Now that you are within "+
      ...
      "the north lies the main area of the Inner Sanctum.\n");

    add_item(({ "marble" }), "You gaze in admiration at the beautifully "+
      "crafted ceiling, walls, and floor...\n");

    add_item(({ "floor" }), "The ground is covered in beautiful marble "+
      "tiles, flawlessly covering every square inch.\n");

    add_exit(CVAN + "company/s82", "north");
}

...
create_cvan_room()
{
    ...
    set_long("You are inside the council chambers of the Trading Company.\n"+
      ...
      "finely crafted stone benches while just to the northwest is a high "+
      "platform. North from here is a large open space, apparently where "+
    ...
    add_item(({ "platform" }), "A raised dais on the far west of this "+
    ...
    add_exit(CVAN + "company/s59", "north");
    add_exit(CVAN + "company/s69", "east");

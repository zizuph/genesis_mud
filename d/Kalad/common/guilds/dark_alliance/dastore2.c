...
/* 
 * /d/Kalad/common/guilds/dark_alliance/dastore2.c
 * Purpose    : store room for dashop2.c(used store room exapmles)
...
create_room()
{
   ...
   add_exit("/d/Kalad/common/guilds/dark_alliance/dashop2", "east",0,-1,-1);
   reset_room();
}
...
#define CLOAK "/d/Kalad/common/guilds/dark_alliance/da_cloak"

 /*****************************************************************************
*  /d/Kalad/common/guilds/fishing/rod/expertrod.c
*
*  Rod File: Expert Rod
*
...
create_object()
{
   ...
   set_adj("expert");
   add_adj("fishing");
   set_short("expert fishing rod");
   set_long("Well crafted with not only a sleek design but to be sturdy "
	+ "this fishing rod should have no problems landing a fish. The reel "
	+ "takes little to no effort to use, contains some heavy duty line "
	+ "and has a treble hook at the end.\n");
...
cast_rod(string str)
{
   ...
   if(this_player()->query_skill(SS_SWIM) < 60)
   {

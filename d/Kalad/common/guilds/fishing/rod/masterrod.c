 /*****************************************************************************
*  /d/Kalad/common/guilds/fishing/rod/masterrod.c
*
*  Rod File: Master Rod
*
...
create_object()
{
   ...
   set_adj("master");
   add_adj("fishing");
   set_short("master fishing rod");
   set_long("Beautifully designed from the flexible wood of the Ashweir "
	+ "trees in the Kalad jungles this rod is unlike any other. A pin reel "
	+ "made from silver has been attached, spooled with some drider silk "
	+ "and at the end of the line a double fang anglers hook has been tied "
	+ "on.\n");
...
cast_rod(string str)
{
   ...
   if(this_player()->query_skill(SS_SWIM) < 90)
   {

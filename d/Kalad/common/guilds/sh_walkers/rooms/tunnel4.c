...
create_room()
{
   ...
   add_exit((SHADOW + "rooms/tunnel3"), "southeast", 0, 3);

   add_exit((SHADOW + "rooms/join_room"), "north", 0 , 3);
...
from_direction()
{
   ...
   if(last == find_object(SHADOW + "rooms/tunnel3"))
   {
   ...
   else if(last == find_object(SHADOW + "rooms/join_room"))
   {

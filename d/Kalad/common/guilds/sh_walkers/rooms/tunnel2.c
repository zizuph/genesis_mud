...
create_room()
{
   ...
   set_long ("\n@@from_direction@@"+
      ...
      "southwest, and down toward the northeast.  "+
      "\n\n");
   ...
   add_item(({ "dark", "darkness", "black", "blackness" }), 
      ...
      "northeast seems to be relatively clear of obstacles, though.  "+
   ...
   /*  Take off 3 fatigue points for going nw (long, treacherous). */
   add_exit((SHADOW + "rooms/tunnel1"), "southwest", 0, 3);
   add_exit((SHADOW + "rooms/tunnel3"), "northeast");
...
from_direction()
{
   ...
   else if(last == find_object(SHADOW + "rooms/tunnel3"))
   {
      return "As you make your way up the slow incline of the tunnel "+

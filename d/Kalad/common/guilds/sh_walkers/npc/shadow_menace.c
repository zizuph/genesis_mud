...
create_monster()
{
   ...
   add_adj("shady");
   add_adj("scrubby");
   set_short("shady scrubby thief");
   set_pshort("shady scrubby thieves");
   set_long("A dark cloaked-figure that stands off in the shadows. "+
   "He appraises you with dark, keen eyes. He is dirty and scruffy "+
   "looking, but he can more than take care of himself. He looks "+
   "as if all his life has been on the streets.\n");
   set_stats(({80,100,80,50,70,80}));
   add_speak("You're a pretty rich looking sap...\n");

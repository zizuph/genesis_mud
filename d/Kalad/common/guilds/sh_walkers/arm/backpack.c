/*
 * /d/Kalad/common/guilds/sh_walkers/arm/backpack.c
 * Created By :  Maniac 31.01.94
 * Modified By:  Quetzl, Milan, Rico
 */
...
create_backpack()
{
   ...
   set_long("This backpack has been woven with black hemp, "+
      "which makes it very light in weight but at the same "+
      "time very sturdy.  This backpack has become a valuable "+
      "asset for the notorious Shadow Walkers of Kabal.\n"+
      "Type <packhelp backpack> for available commands.\n");
...
packhelp(string arg)
{
   ...
   write("\nAvailable commands for the " + short() + ":\n\n"+
      "\tunkeep backpack --> will make the " + short() + " sellable\n"+
      "\tkeep backpack   --> will make the " + short() + " unsellable\n"+
      "\tpackstore       --> quickly fill the " + short() + "\n"+
      "\tpackget         --> quickly empty the " + short() + "\n"+
      "\tpackhelp        --> to get this help message\n"+
      "\nNota Bene: When filling the pack, only unworn and unwielded "+
      "objects will be\n\t   affected, excluding coins and other "+
      "special items.\n\n");

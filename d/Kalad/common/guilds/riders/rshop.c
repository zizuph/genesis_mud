...
#define STORE_ROOM "/d/Kalad/common/guilds/riders/rstore"
object ob1;
...
create_room()
{
   ...
   set_long("This is the supply show for the Dark Alliance. Along the "+
   ...
   add_exit(COMMON(guilds/riders/rstore), "north", "@@wiz_check",-1,-1);
   add_exit(COMMON(guilds/riders/rhall), "south",0,0);
   ob1 = clone_object(COMMON(guilds/riders/owner));
...
do_collar(string str)
{
    ...
    ob1 = clone_object(COMMON(guilds/riders/wcollar));

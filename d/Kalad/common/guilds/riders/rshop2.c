...
#define STORE_ROOM "/d/Kalad/common/guilds/riders/rstore2"
object ob1;

/* 
 * /d/Kalad/common/guilds/riders/rshop2.c
...
create_room()
{
   ...
   "counter.\n");
   add_exit(COMMON(guilds/riders/rstore2), "west", "@@wiz_check",-1,-1);
   add_exit(COMMON(guilds/riders/train), "north",0,0);
   ob1 = clone_object(COMMON(guilds/riders/dezzin));

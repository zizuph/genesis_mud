 ...
 *                   relogs.
 * Zignur 2017-11-07 changed the death message in do_die
 * Arman 2020-03-15  Removed an exploit where players could dismiss                  
 *                   and resummon a wolf to refresh their fatigue.
 *
 */
...
create_steed()
{
    ...
    /* Commented out due to player abuse. Is now taken care
     * of through refresh_steed - Arman */
...
*/
public void
refresh_steed(int fatigue, int hp)
{
    // AK_DEBUG("Fatigue at wolf: " +fatigue);
...
/* Zignur 2017-11-07 changed the death message */
public void
...
/* Zignur 2017-10-24 make sure the autodismount and automount stays on */

...
wolf_sign()
{
    ...
    "|  list adjectives                              |\n"+
    "|                                               |\n"+
    "|  When you send a wolf back, then fetch him    |\n"+
    "|  again, he will be fully rested and fed.      |\n"+
...
do_fetch(string str)
{
    ...
    nwolf = clone_object(FANG_DIR(obj/wolf_temp));
...
do_buy(string str)
{
    ...
    wolf = clone_object(FANG_DIR(obj/wolf_temp));

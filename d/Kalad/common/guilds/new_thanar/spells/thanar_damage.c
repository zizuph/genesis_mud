 ...
 * A damage spell used by the Thanars in Kalad
 */
...
config_harm_spell()
{
    ...
    set_spell_desc("Call upon the powers of Thanar to harm your foes.");
    set_spell_vocal(1);
    set_spell_visual(1);
...
desc_harm_damage(object caster, object target, mixed *result)
{
	...
	//MIR_DEBUG("Phurt: "+phurt+" Hitresult: "+result[3]+ ".");
...
desc_harm_cast(object caster, object * targets)
{
    ...
    caster_message = "Hearing Thanar answering your prayers, you raise " + 
            "hands and a gigantic black snake materializes out of the " +
            "shadows, sinking its deadly fangs into " + QTNAME(target) + 

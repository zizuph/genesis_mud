 ...
 * Blind spell used by Thanar in Kalad.
 * 
...
config_blind_spell()
{
    ...
    set_spell_object(SPELLS + "obj/deity_blind_obj");
} /* config_blind_spell */
...
{
    caster->catch_msg("You draw upon the power granted to you by the dark " +
              "and power of the human race as you focus on "
			  + COMPOSITE_LIVE(targets) +
              ". You feel dark shadows shoot out from your " +
              "hands.\n");

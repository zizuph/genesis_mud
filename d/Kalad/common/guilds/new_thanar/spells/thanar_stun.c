...
config_stun_spell()
{
    ...
    set_spell_desc("Call upon Thanar to stun your foe.");
    set_spell_vocal(1);
    set_spell_visual(1);
    ...
    set_spell_object(SPELLS + "obj/thanar_stun_obj");    
} /* config_stun_spell */
...
{
    caster->catch_tell("You summon a ghastly visage of Thanar and send it " +
        "towards " + COMPOSITE_LIVE(targets) + ".\n");
    caster->tell_watcher(QCTNAME(caster) + " summons a ghastly visage of " +
         "Thanar.\n", ({ }) );

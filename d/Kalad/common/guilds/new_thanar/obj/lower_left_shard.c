/*
 * /d/Kalad/common/guilds/new_thanar/obj/lower_left_shard.c
 *
 *  The lower left shard of the Thanar medallion you need
...
inherit "/d/Kalad/common/guilds/new_thanar/obj/shard_base";
 ...
 create_shard()
 {
     add_name("lower left shard");
     add_name("_lower_left_shard_");
     add_name("lower left");
     add_adj( ({ "lower", "left", "lower left"}) );
     set_short("lower left shard");
      ...
      */
     set_shard_companion("/d/Kalad/common/guilds/new_thanar/obj/lower_right_shard");
...
study_shard(string str)
{
    if(!strlen(str))
    {
        notify_fail("Study what? <study lower left shard>, perhaps?\n");
        return 0;
    }
   
    if (str != "lower left shard")
    {
        notify_fail("Study what? <study lower left shard>, perhaps?\n");
        return 0;
    }     

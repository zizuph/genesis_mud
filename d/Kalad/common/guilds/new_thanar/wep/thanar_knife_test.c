...
create_weapon() 
{
    ...
    set_adj("blackened");
    add_adj("magnificent");
    set_short("blackened magnificent knife");
    ...
    set_default_weapon(23, 23, W_KNIFE, W_SLASH | W_IMPALE, W_NONE,0);
    add_prop(OBJ_I_VALUE, F_VALUE_WEAPON(23, 23) + random(20) -10);
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(23, W_KNIFE) +
        random(50) - 25);

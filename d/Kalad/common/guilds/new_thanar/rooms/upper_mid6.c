 ...
 * /d/Kalad/common/guilds/new_thanar/upper_mid6.c
 */
...
create_std_thanar()
{
    ...
    add_exit(RDIR + "upper_mid5","west");
    add_exit(RDIR + "inner_right2","southeast");
    add_exit(RDIR + "upper_mid7","northeast");
    
    //Sets the no exit message for unlisted directions
    set_no_exit_msg(get_all_no_exits(({"w","se","ne"})),

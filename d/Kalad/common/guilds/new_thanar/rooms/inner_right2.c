 ...
 * /d/Kalad/common/guilds/new_thanar/inner_right2.c
 */
...
create_std_thanar()
{
    ...
    add_exit(RDIR + "inner_right1","west");
    add_exit(RDIR + "inner_right3","east");
    add_exit(RDIR + "upper_mid6","northwest");
    
    //Sets the no exit message for unlisted directions
    set_no_exit_msg(get_all_no_exits(({"w","e","nw"})),

 ...
 * /d/Kalad/common/guilds/new_thanar/rooms/upper5.c
 */
...
create_std_thanar()
{
    ...
    add_exit(RDIR + "upper4","west");
    add_exit(RDIR + "upper_left_path3","northwest");
    add_exit(RDIR + "upper6","east");
    
    //sets the no exit message for unlisted directions
    set_no_exit_msg(get_all_no_exits(({"w","nw","e"})),

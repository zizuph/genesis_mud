 ...
 * /d/Kalad/common/guilds/new_thanar/upper_right_path1.c
 */
...
create_std_thanar()
{
    ...
    add_exit(RDIR + "upper_right_path1","southwest");
    add_exit(RDIR + "upper_right_path3","southeast");
    add_exit(BALC + "balcony1", "up");

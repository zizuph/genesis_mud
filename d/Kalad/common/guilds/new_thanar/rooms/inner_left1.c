 ...
 * /d/Kalad/common/guilds/new_thanar/inner_left1.c
 */
...
create_std_thanar()
{
    ...
    add_exit(RDIR + "inner_left2","west");
    add_exit(RDIR + "inner_mid","east");
    add_exit(RDIR + "centrance","southeast");
    
    //Sets the no exit message for unlisted directions
    set_no_exit_msg(get_all_no_exits(({"w","e","se"})),

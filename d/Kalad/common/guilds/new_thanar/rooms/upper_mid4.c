 ...
 * /d/Kalad/common/guilds/new_thanar/upper_mid4.c
 */
...
create_std_thanar()
{
    ...
    add_exit(RDIR + "upper_mid3","northwest");
    add_exit(RDIR + "inner_left2","southwest");
    add_exit(RDIR + "upper_mid5","east");
    
    //Sets the no exit message for unlisted directions
    set_no_exit_msg(get_all_no_exits(({"nw","sw","e"})),

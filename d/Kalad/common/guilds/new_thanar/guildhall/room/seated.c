...
#define SDESC \
"\nSeveral plush cushions are resting on the floor in front of "+ \
"the stone fireplace. The fabrics are dark in color with sapphire, "+ \
"crimson, and mithril threads woven in intricate patterns. There "+ \

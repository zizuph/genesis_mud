/*********************************************************************
 * - fireplace.c                                                   - *
 * - Include this file if you want fireplace functions             - *
 * - remember to add: init_fire();                                 - *
 * - to your init                                                  - *
...
/*
 * Function name: stoke_fire()
 * Description  : Allows player to stoke the fireplace
 * Variable     : string is the fire
 */
int
stoke_fire(string str)
{
   if((str == "the fire") || (str == "fire") || (str == "logs") 
       || (str == "the logs"))
      {
      write("You take out a poker and stoke up the fire in the fireplace. "+
        "\nThe fire burns more brightly.\n"+
        "You replace the poker in its holder.\n");
      
          /* This what others in room see. */
      say(QCTNAME(TP)+" picks up the fireplace poker from the holder "+
        "and begins to stoke the fire.\n"+
...
/*
 * Function name: log_fire()
 * Description  : Add another log to the fire
 */
int
log_fire(string str)
{
     ...
     {
       write("You take out a log from the firebox and place it on the fire. "+
         "\nThe fire burns more brightly.\n");
      
          /* This what others in room see. */
       say(QCTNAME(TP)+" takes out a log from the firebox and places "+
         "it on the fire.\n"+
         "The fire burns brightly now.\n");
      return 1;
      }
...
/*
 * Function name: warm_it()
 * Description  : Let's you warm yourself by the fire
 */
int
warm_it(string str)
{
   if((str == "face"))
      ...
      write("You press your face forward to warm your cheeks "+
        ...
        "Ahh nice and warm.\n");
          ...
          /* This what others in room see. */
      say(QCTNAME(TP)+" puts "+HIS(TP)+" face closer to the fireplace.\n");
      return 1;
           }
   if((str == "hands"))
          {
   ...
   if((str == "legs"))
          {
       write("You step very close to the fireplace and rub along your "+
   ...
   if((str == "body"))
       ...
       write("You step up to the fire and feel the heat soothe your bones.\n");
          ...
          /* This what others in room see. */
      say(QCTNAME(TP)+" steps up to the fire for a long moment.\n");
      return 1;
      }
   if((str == "bottom"))
       {
       write("You step up to the fire and stick your bottom towards it.\n");
          ...
          /* This what others in room see. */
      say(QCTNAME(TP)+" steps up to the fire sticking "+HIS(TP)+" bottom "+
        "towards it.\n");
      return 1;
      } 
   else
...
/*
 * Function name: extinguish_fire()
 * Description  : Puts out the fire
 */
int
extinguish_fire(string str)
{
   if((str == "the fire") || (str == "fire"))
      {
      write("You try to extinguish the fire in the fireplace but fail.\n");
      
          /* This what others in room see. */
      say(QCTNAME(TP)+" tries to extinguish the fire in the fireplace but fails.\n");
      return 1;
      }
   else
  {
 ...
 * Description  : Inititalizes the commands for the fire
 */
public void
init_fire()
{

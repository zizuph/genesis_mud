...
create_room()
{
    ...
    "hallway also continues to the east, where you see nothing "+
    ...
    add_exit(KHIRAA_DIR(temple/rooms/t13),"east",0,-1);
    clone_object(KHIRAA_DIR(temple/doors/shrinedoor1))->move(TO);
    clone_object(KHIRAA_DIR(temple/doors/circledoor1))->move(TO);
    clone_object(KHIRAA_DIR(temple/doors/meetdoor1))->move(TO);
}

...
create_armour()
{
    ::create_armour();
    set_name("greaves");
    set_short("pair of black studded-leather greaves");
    set_pshort("pairs of black studded-leather greaves");
    set_adj("black");
    add_adj("studded-leather");

    set_long("These are a pair of finely crafted greaves from "+
    "black leather. They are covered with small silver studs, and "+
    "a white grim-looking skull is painted on the knee parts.\n");

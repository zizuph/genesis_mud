...
void
ldark_conc(object caster, object *targets, string arg)
{
...
void
do_spell_ldark(object caster, object *targets)
{
    object d_coin;
    float time;
...
void
create_spell_ldark(object caster, object *targets, string arg)
{
    ...
    set_spell_time(5);
    set_spell_mana(20);
    set_spell_effect(do_spell_ldark);
    set_spell_task(TASK_SIMPLE);
    set_spell_conc_message(ldark_conc);
    return 0;
}

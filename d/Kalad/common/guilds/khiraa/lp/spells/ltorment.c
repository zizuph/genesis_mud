...
void
ltorment_conc(object caster, object *targets, string arg)
{
...
void
do_spell_ltorment(object caster, object *targets)
{
    object head_ob;    
    object ob = targets[0];
...
int
create_spell_ltorment(object caster, object *targets, string arg)
{
    ...
    set_spell_time(3);
    set_spell_mana(15);
    set_spell_effect(do_spell_ltorment);
    set_spell_task(TASK_SIMPLE);
    set_spell_conc_message(ltorment_conc);
    return 0;
}

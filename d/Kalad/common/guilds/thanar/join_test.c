/* 
 * /d/Kalad/common/caravan/thanar/joinroom.c
...
create_room()
{
   ...
   add_cmd_item(({ "plaque", "black plaque", "marble plaque" }), "read",
     ...
     "\t|                                                              |\n"+
     "\t|                                                              |\n"+
     "\t|    Here you may join or leave the Thanarian racial guild.    |\n"+
     "\t|    Read the Dark Book of Thanar for more specific guild      |\n"+
     "\t|    information. Within this chamber you may <enter> or       |\n"+
     "\t|    <leave> the guild and <update membership>. You may also   |\n"+
     "\t|    enquire about your current memberships with <list>.       |\n"+
     "\t|                                                              |\n"+
   ...
   add_exit(OLDTHANAR(shrine), "north", "@@check_member", -1);
   add_exit(THANAR(chamber), "east", "@@check_member", -1);
   add_exit(THANAR(train), "south", "@@check_member", -1);
...
do_join(str)
{
   ...
   if(str == "guild")
   {
      ...
      log_file("thanars", extract(ctime(time()), 4, 15) + " " +

...
set_long("The street ends here, but forks both north and southeast. "
	+"This side street seems fairly uninhabited, and the guards "
	+"obviously don't frequently visit this grungy area. The "
	+"buildings and homes both are run down and somewhat shoddy "
	+"as compared to other on the town.\n");
...
*/
add_exit(ZHENT +"port/p10","north");
add_exit(ZHENT +"port/p13","southeast");

...
set_long("The street continues to the east and west, but also branches "
	+"north towards the piers. Guards mill about, content with "
	+"only occasionally pursuing a lawbreaker. The buildings and "
	+"houses that line the road are tightly packed, with the "
	+"buildings towering high over the road.\n");
...
*/
add_exit(ZHENT +"port/p10","east");
add_exit(ZHENT +"port/p8","west");
add_exit(ZHENT +"port/p32","north");

...
set_long("There is a small intersection here, a road leads north, east, "
	+"and southwest. All around you are homes of the commoners here "
	+"and large towering buildings. Guards patrol the city, passing "
	+"by at regular intervals. Shadow roam the streets, caused "
	+"by the large gray cloud that rides the winds above you.\n");
...
*/
add_exit(ZHENT +"port/p8","east");
add_exit(ZHENT +"port/p6","north");
add_exit(ZHENT +"port/p20","southwest");

...
set_long("The street turns back towards the south gate here. To your "
	+"east is the massive city wall. Homes line the streets, "
	+"surrounding the large buildings like small children. High "
	+"above you, a large gray cloud spews forth hatred and deceit. "
	+"The guards apparently get a lot of these emotions, and get "
	+"out their aggression on you.\n");
...
add_exit(ZHENT +"port/p10","west");
add_exit(ZHENT +"port/p13","southwest");

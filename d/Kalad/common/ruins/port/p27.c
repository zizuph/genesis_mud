...
set_long("The street turns leads away from the more populous areas, "
	+"and leads through a less dense area. Shadows crawl along the "
	+"buildings and houses, creating strange images. The guards "
	+"seem to avoid this area, because there aren't any here.\n");
...
*/
add_exit(ZHENT +"port/p28","east");
add_exit(ZHENT +"port/p26","west");

...
set_long("The street continues east to west here. The southern part "
	+"of Zhentil Keep is more of a housing district than the inner "
	+"city. Homes surround you, hiding in the shadows of the huge "
	+"buildings that line the street. The massive city wall guards "
	+"the southern side of the street, its towers and battlements "
	+"stretching high into the air. Guards roam the streets, "
	+"looking for anyone suspicious, just so they can inflict pain "
	+"upon them. High above you is an immense gray cloud, acting "
	+"in accordance to the will of the gods for this city of evil.\n");
...
add_exit(ZHENT +"port/p19","west");
add_exit(ZHENT +"port/p17","east");

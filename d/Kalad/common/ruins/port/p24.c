...
*/
#define HOUSE "/d/Kalad/common/zhent/port/house7.c"
object ob1;
object ob2;
object ob3;
void
...
set_long("The street continues to the east and west here. Angry guards "
	+"wade through the throng of people, trying to act as if they "
	+"have a true purpose. The buildings that tower over the street "
	+"hide the small houses that lean against or between them. The "
	+"people of Zhentil Keep are a downtrodden bunch, kept in check "
...
add_exit(ZHENT +"port/p23","west");
add_exit(ZHENT +"port/p25","east");

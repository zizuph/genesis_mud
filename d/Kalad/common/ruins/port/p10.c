...
set_long("The street turns southwards here, leaving the foul stench of "
	+"the polluted river behind. The towering buildings throw "
   +"shadows over the street, and small houses which lie along it. "
	+"A feeling of dread seems to encompass the whole city, caused "
	+"by the constant grayness of the skies due to the menacing "
	+"cloud looming overhead.\n");

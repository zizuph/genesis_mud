...
set_long("You have reached the western corner of the southern port "
	+"area. Here the street stretches southeast down towards the "
	+"southern gate, and east towards the river, and a large temple. "
	+"There are no houses here, but there are still some buildings "
	+"as well as the everpresent guards of the keep.\n");
...
*/
add_exit(ZHENT +"port/p4","east");
add_exit(ZHENT +"port/p2","southeast");

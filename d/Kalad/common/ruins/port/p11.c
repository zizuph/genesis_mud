...
*/
#define HOUSE "/d/Kalad/common/zhent/port/house5.c"
/*
object ob1;
object ob2;
object ob3;
...
set_long("You are heading towards the eastern edge of the city. Back "
	+"to the northwest is the river and the merchant vessels that "
	+"use it for their wares. Buildings tower over the street. and "
	+"small homes belonging to the common people are there also. "
	+"Guards roam the street accosting everyone in sight.\n");
...
add_exit(ZHENT +"port/p9","west");
add_exit(ZHENT +"port/p11","southeast");

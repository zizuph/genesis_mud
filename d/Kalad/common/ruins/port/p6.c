...
set_long("The street continues east and west here, but also branches "
	+"northward, towards the piers of Zhentil Keep. The river has "
	+"become a real nuisance, what with its smell and horrid "
	+"appearance. Guards are milling around here, searching the "
	+"incoming merchandise for illegal contraband, as well as "
	+"harrassing the ship captains for fun.\n"); 
...
*/
add_exit(ZHENT +"port/p7","east");
add_exit(ZHENT +"port/p5","west");
add_exit(ZHENT +"port/p29","north");

...
set_long("The street extends to the east and west here, winding through "
	+"the crowd of townsfolk. Guards patrol endlessly here, keeping "
	+"the order among a city otherwise filled with chaos. Lining "
	+"street are groups of small houses, interspersed with large "
	+"towering buildings. Far above, a huge gray cloud saps the light "
	+"from the sun and the happiness from the inhabitants of this "
	+"city.\n");
...
add_exit(ZHENT +"port/p24","west");
add_exit(ZHENT +"port/p26","east");

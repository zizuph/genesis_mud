...
set_long("Here there is an intersection, with streets leading east, "
	+"west, and northwest. From the northwest, the smell of polluted "
	+"water wafts in and assaults your nostrils. Groups of guards "
	+"wander through here, heading off in all directions. There are "
	+"a few homes scattered along the street, intermixed with the "
	+"towering buildings that dominate Zhentil Keep. Shadows cover "
	+"the street, partially from the buildings, but mostly from the "
	+"monstrous gray cloud that looms above the city.\n");
...
add_exit(ZHENT +"port/p26","northwest");

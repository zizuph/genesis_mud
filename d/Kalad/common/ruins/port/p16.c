...
#define HOUSE "/d/Kalad/common/zhent/port/house9.c"
object ob1;
object ob2;
object ob3;
void
...
set_long("The street begins to widen here, opening up for the "
	+"intersection to the east. To the east also lies the second "
	+"southern gate of Zhentil Keep. Lining the street are numerous "
	+"homes and buildings, which provide shelter for the denizens "
	+"of the city. Guards rush by, escorting criminals to the "
	+"temples to recieve punishment. Overhead, a swirling gray "
	+"cloud casts moving shadows onto the ground, destroying what "
	+"would otherwise be a normal city. To the east lies the second "
	+"southern gate of Zhentil Keep.\n");
...
add_exit(ZHENT +"port/p17","west");
add_exit(ZHENT +"port/p15","east");

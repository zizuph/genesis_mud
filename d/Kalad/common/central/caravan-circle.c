/* 
 * /d/Kalad/common/central/caravan-circle.c
 * Purpose    : Road connection between caravan and circlestreet
...
create_room()
{
   ...
   set_short("intersection of caravan street and circle road");
   set_long(
      "You stand in an intersection between Caravan Street and Circle Road. "+
      ...
      "and to the west you can see the backside of some large, adorned buildings. "+
   ...
   add_exit(CENTRAL(caravan-gladiator),"northeast");
   add_exit(CENTRAL(circle/s5),"west");
   add_exit(CENTRAL(caravan/s5),"southwest");

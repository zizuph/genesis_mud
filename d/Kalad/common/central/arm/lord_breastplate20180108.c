...
wear(object what)
{
   ...
   {
      write("With a chill going through your body, you wear the breastplate.\n");
      return 0;
   }
...
remove(object what)
{
   if (TP->query_intoxicated()<10)
      {
      write("A chill goes through your body when you "+
         "rip it off yourself.\n");
      return 0;
   }
   write("You struggle to remove the breastplate, "+
      "but you fail. You cannot concentrate enough on forcing it off your body.\n");
      TP->add_mana(-50);
   return -1;
}

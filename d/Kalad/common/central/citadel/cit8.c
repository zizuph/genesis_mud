...
create_room()
{
   ...
   set_long("You gasp when you watch the size of this room. A large "+
      ...
      "meets selections of his people anmasse. "+
      "If you walk south, west or to the northwest, you will continue further "+
      "into this huge dome.\n");
   ...
   add_exit(CENTRAL(citadel/cit9),"west",0,-1,-1);
   add_exit(CENTRAL(citadel/cit6),"south",0,-1,-1);
   add_exit(CENTRAL(citadel/cit12),"northwest",0,-1,-1);

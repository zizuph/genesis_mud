...
create_room()
{
   ...
   set_long("You gasp when you watch the size of this room. A large "+
      ...
      "meets selections of his people anmasse. To the west you see a podium "+
      "with a huge throne in the centre. If you walk south or to the "+
   ...
   add_exit(CENTRAL(citadel/cit11),"west",0,-1,-1);
   add_exit(CENTRAL(citadel/cit9),"south",0,-1,-1);
   add_exit(CENTRAL(citadel/cit8),"southeast",0,-1,-1);

...
create_room()
{
   ...
   set_long("You walk along the Promenade, a street laid with cobblestones. "+
      ...
      "notice a huge tower to the west; the Citadel. All manner of refuse "+
   ...
   add_item(({"refuse"}),
      ...
      "or two.\n");
   add_exit(CENTRAL(promenade/s1), "northeast",0);
   add_exit(CENTRAL(promenade/s3), "southwest",0);
   add_exit(COMMON(guilds/new_thanar/rooms/centrance),"north",0);
}

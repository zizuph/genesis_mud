 ...
 * Zignur Jan 2018 removed the command_driver and use cmdparse instead,
 *                 to make spells such as phammer work properly.
 *
 *  2021-08-22 Meton Added phurt -3 acrobatic dodge.
 */
...
{                       
    ...
    {       
        ...
        wound_obj->set_effect_caster(wielder);

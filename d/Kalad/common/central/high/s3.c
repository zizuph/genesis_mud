...
create_room()
{
   ...
   set_long("You walk along the High Street, a street laid with cobblestones. "+
      ...
      "notice a huge tower to the west; the Citadel. If you walk southwards "+
      "it looks like you will end up in a center, while northwards this road "+
      "leads to the Caravan area. All manner of refuse "+
   ...
   add_item(({"refuse"}),
      ...
      "or two.\n");
   add_exit(CENTRAL(high/s2), "north",0);
   add_exit(CENTRAL(high-circle-north), "south",0);
}

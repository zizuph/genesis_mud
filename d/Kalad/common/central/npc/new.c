...
create_monster()
{
   ...
   add_ask(({"job","quest","help","task"}),"The cleric goes "+
      ...
      "Ofcourse, this is frown upon by the High Lord, since it might "+
...
reward1(string who)
{
   ...
   if(obj = present(who, environment()))
      ...
      if(obj->test_bit("Kalad",1,10))
         ...
         command("wink");
         command("say but be careful! And don-t get caught!! "+
            "I expect they would kill you if they find you snooping "+
...
react_code(string who)
{
   ...
   if(obj = present(who, environment()))
      ...
      command("say If you think you know the solution, then whisper to me the _exact_ "+
...
{
   if (emote == "whisper") set_alarm(1.0,0.0,"return_whisper",actor,adverb);
}
...
void
return_whisper(object who, string what)
{
   object obj;
   int ran;
   if(obj = present(who, environment()))
      ...
      if(obj->test_bit("Kalad",1,12))
         {
         command("say Why are you whispering to me?");
         return;
      }
      if(obj->test_bit("Kalad",1,11))
         {
         command("say Ahh, you think you know the answere... "+
            "Lets see.");
       if(lower_case(what)=="as arranged i will pay you the "+
            ...
            "bocca, lord of the city council.")
         {
            ...
            obj->catch_msg("You don't feel more experienced.\n");
   obj->catch_msg(what+"....!!\n");
         }
      }
   }

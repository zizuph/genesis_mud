...
Zignur Jan 2018  Made the npc neutral
*/
...
create_monster()
{
   ...
   trig_new("'Urian' 'shouts:' %s","assist_guards");
...
do_assist()
{
   ...
   switch (random(3))
   {
      ...
      break;
      case 1:
      command("shout My Lord! I will slay them for you.");
      command("west");
      command("assist guard");
      break;
      case 2:
      ...
      break;
      default:
      command("shout I will drink their blood!");
      command("west");
      break;
   }
}

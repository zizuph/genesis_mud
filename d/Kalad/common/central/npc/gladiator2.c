...
create_monster()
{
   ...
   set_name("gladiator");
   set_long("This man is a gladiator of the arena in Kabal, "+
     "and he looks like it too with scars all over his face. "+
     "A dangerous man this, if he is irritated.\n");
   str = 30 + random(50);
   dex = 50 + random(50);
   con = 30 + random(70);
   ...
   set_random_move(20);
   set_act_time(4);
   add_act("emote sharpens his gladius.");
   add_act("emote slices some air with the gladius.");
   add_act("emote kicks a small stone away.");
   add_act("emote looks wishfully at the arena.");
   add_act("groan");
   add_act("emote scratches his back.");
   add_act(({"say Who are you?","ponder newbie gladiators...dead "+
     "meat.","grin"}));
   set_cact_time(1);
   ...
   add_speak("Ahh, you are here to fight too? Too bad they won't let us.\n");

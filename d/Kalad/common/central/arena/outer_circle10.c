/* 
 * /d/Kalad/common/central/arena/outer_circle10.c
...
void create_room()
{
   ...
   set_long ("You walk below the outer archway of the arena. "+
      ...
      "the decay this once grand arena has been a victim of." 
   );
   ...
   add_exit (CENTRAL(arena/outer_circle9),"north",0,1);
   add_exit (CENTRAL(arena/outer_circle11),"south",0,1);
   add_exit (CENTRAL(arena/inner_circle6),"west","@@archway",0,1);

/* 
 * /d/Kalad/common/central/arena/under_arena5.c
...
void create_room()
{
    ...
    add_exit (CENTRAL(arena/under_arena4),"northeast",0,-1,-1);
    ...
    add_item ("cage","The cage itself has metal bars and a hatch on "+
        ...
        "drive them crazy. These aren't animals you want to meet "+
        "in a fight, so you'd better leave the cage alone...\n");

/* 
 * /d/Kalad/common/central/arena/outer_circle14.c
...
void create_room()
{
   ...
   add_exit (CENTRAL(arena/outer_circle13),"east",0,1);
   add_exit (CENTRAL(arena/outer_circle15),"west",0,1);
   add_exit (CENTRAL(arena/inner_circle8),"north","@@archway",0,1);

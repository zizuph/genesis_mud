/* 
 * /d/Kalad/common/central/arena/outer_circle2.c
...
void create_room()
{
   ...
   add_exit (CENTRAL(arena/outer_circle1),"south",0,1);
   add_exit (CENTRAL(arena/outer_circle3),"north",0,1);
   add_exit (CENTRAL(arena/inner_circle2),"east","@@archway",0,1);

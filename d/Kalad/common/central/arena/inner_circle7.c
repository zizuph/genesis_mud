/* 
 * /d/Kalad/common/central/arena/inner_circle7.c
...
create_room()
{
    ...
    add_exit(CENTRAL(arena/inner_circle8),"southwest",0,-1,-1);
    add_exit(CENTRAL(arena/inner_circle6),"northeast",0,-1,-1);
    add_exit(CENTRAL(arena/outer_circle12),"southeast","@@archway",-1,-1);
...
{
    TP->catch_msg(
      "You walk below the arch, leaving the sounds of death and "+
      "its celebration by the crowd behind you.\n");
    return 0;
}

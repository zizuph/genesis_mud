/* 
 * /d/Kalad/common/central/arena/outer_circle6.c
...
void create_room()
{
   ...
   add_exit (CENTRAL(arena/outer_circle5),"west",0,1);
   add_exit (CENTRAL(arena/outer_circle7),"east",0,1);
   add_exit (CENTRAL(arena/inner_circle4),"south","@@archway",0,1);

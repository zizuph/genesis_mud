/* 
 * /d/Kalad/common/central/arena/inner_circle6.c
...
create_room()
{
    ...
    add_exit(CENTRAL(arena/inner_circle5),"northwest",0,-1,-1);
    add_exit(CENTRAL(arena/inner_circle7),"southwest",0,-1,-1);
    add_exit(CENTRAL(arena/outer_circle10),"east","@@archway",-1,-1);

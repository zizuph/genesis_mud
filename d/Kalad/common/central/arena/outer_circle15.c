/* 
 * /d/Kalad/common/central/arena/outer_circle15.c
...
void create_room()
{
   ...
   add_exit (CENTRAL(arena/outer_circle14),"east",0,1);
   add_exit (CENTRAL(arena/outer_circle16),"northwest",0,1);
   add_exit (CENTRAL(arena/entrance_arena),"west",0,1);

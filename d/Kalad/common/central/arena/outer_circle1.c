/* 
 * /d/Kalad/common/central/arena/outer_circle1.c
...
void create_room()
{
   ...
   add_exit (CENTRAL(arena/outer_circle2), "north",0,1);
   add_exit (CENTRAL(arena/outer_circle16), "southeast",0,1);
   add_exit (CENTRAL(arena/entrance_arena), "south",0,1);

/* 
 * /d/Kalad/common/central/arena/inner_circle1.c
...
create_room()
{
    ...
    add_exit(CENTRAL(arena/inner_circle8),"southeast",0,-1,-1);
    add_exit(CENTRAL(arena/inner_circle2),"northwest",0,-1,-1);
...
number_of_fights()
{
    ...
    "drowed by the cheering of the spectators when the weapons draw "+
    "blood.";
}

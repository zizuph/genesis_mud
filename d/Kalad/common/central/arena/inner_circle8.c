/* 
 * /d/Kalad/common/central/arena/inner_circle8.c
...
create_room()
{
    ...
    add_exit(CENTRAL(arena/inner_circle1),"northwest",0,-1,-1);
    add_exit(CENTRAL(arena/inner_circle7),"northeast",0,-1,-1);
    add_exit(CENTRAL(arena/outer_circle14),"south","@@archway",-1,-1);

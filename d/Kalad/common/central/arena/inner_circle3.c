/* 
 * /d/Kalad/common/central/arena/inner_circle3.c
...
create_room()
{
    ...
    add_exit(CENTRAL(arena/inner_circle2),"southwest",0,-1,-1);
    add_exit(CENTRAL(arena/inner_circle4),"northeast",0,-1,-1);
    add_exit(CENTRAL(arena/outer_circle4),"northwest","@@archway",-1,-1);

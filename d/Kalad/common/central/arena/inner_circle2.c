/* 
 * /d/Kalad/common/central/arena/inner_circle2.c
...
create_room()
{
    ...
    add_exit(CENTRAL(arena/inner_circle1),"southeast",0,-1,-1);
    add_exit(CENTRAL(arena/inner_circle3), "northeast",0,-1,-1);
    add_exit(CENTRAL(arena/outer_circle2),"west","@@archway@@",-1,-1);

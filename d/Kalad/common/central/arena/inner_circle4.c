/* 
 * /d/Kalad/common/central/arena/inner_circle4.c
...
create_room()
{
    ...
    add_exit(CENTRAL(arena/inner_circle3),"southwest",0,-1,-1);
    add_exit(CENTRAL(arena/inner_circle5),"southeast",0,-1,-1);
    add_exit(CENTRAL(arena/outer_circle6),"north","@@archway",-1,-1);

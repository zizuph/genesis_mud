/* 
 * /d/Kalad/common/central/arena/outer_circle4.c
...
void create_room()
{
   ...
   add_exit (CENTRAL(arena/outer_circle3),"southwest",0,1);
   add_exit (CENTRAL(arena/outer_circle5),"northeast",0,1);
   add_exit (CENTRAL(arena/inner_circle3),"southeast","@@archway",0,1);

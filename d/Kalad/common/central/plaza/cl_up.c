...
create_room()
{
   ...
   set_short("A hallway upstairs in the Lord Council building");
   set_long(
   ...
   add_exit(CENTRAL(plaza/cl_hall2),"down",0,-1,-1);
   add_exit(CENTRAL(plaza/cl_lord),"east",0,-1,-1);

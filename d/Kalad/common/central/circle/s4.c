...
create_room()
{
   ...
   set_long("You walk along the circle road, a road paved with large "+
      ...
      "while the circle street continues northwards and to the southeast.\n");
   ...
   add_exit(CENTRAL(circle/s3),"north",0,1);
   add_exit(CENTRAL(circle/s5),"southeast",0,1);
   add_exit(CENTRAL(plaza/sq_st_ne),"west",0,1);

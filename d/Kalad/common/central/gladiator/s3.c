...
create_room()
{
   ...
   set_long("You walk along the Gladiator Row, a street laid with cobblestones. "+
      ...
      "attention is a huge circular construction to the northeast. It is the "+
      "Gladiatoral arena of Kabal and by walking northeastwards you will soon "+
      "be close to it. You can walk to the northwest "+
      "or towards a new crossroad in the southeast. All manner of refuse "+
   ...
   add_item(({"arena","gladiatoral arena","construction"}),
      ...
      "to remember.\n");
   add_exit(CENTRAL(gladiator/s2), "northwest",0);
   add_exit(CENTRAL(caravan-gladiator),"southeast",0);
   add_exit(CENTRAL(gladiator/s4),"northeast",0);

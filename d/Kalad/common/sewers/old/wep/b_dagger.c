...
#define HIT (20+random(3))
#define PEN (22+random(6))
...
::create_weapon();
    ...
    set_long("This is a fincrafted black metal dagger. " +
    ...
    add_cmd_item( ({"dagger","black dagger"}),({"touch","feel"}),
        "The dagger is cold and smooth.\n");
    ...
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(HIT,W_DAGGER) + random(35));

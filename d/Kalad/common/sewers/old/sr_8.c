...
create_room()
{
   ...
   "the west.\n");
   add_exit("/d/Kalad/common/sewers/sr_16.c","northwest",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_10.c","west",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_9.c","southeast",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_17.c","notheast",0,1,3);
}

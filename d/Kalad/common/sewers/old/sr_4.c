...
create_room()
{
   ...
   add_exit("/d/Kalad/common/sewers/sr_1.c","southwest",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_14.c","northeast",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_12.c","north",0,1,3);
   add_exit("/d/Kalad/common/sewers/tr_1.c","west",0,1,3);
}

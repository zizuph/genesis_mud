...
create_room()
{
   ...
   add_exit("/d/Kalad/common/sewers/sr_13.c","west",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_19.c","northeast",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_4.c","southwest",0,1,3);
}

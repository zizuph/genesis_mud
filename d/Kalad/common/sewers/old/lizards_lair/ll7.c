...
::create_room();
   ...
   add_exit(PATH + "ll6.c","west",0,2);
   add_exit(PATH + "ll8.c","northeast",0,2);
...
dwarf_check()
{
    ...
    if(TP->query_race() == "dwarf")
        return"The tunnel slopes down to the northeast and up to the west.\n"; 
	
   return"The tunnel leads to the northeast and west.\n";
}
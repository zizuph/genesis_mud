 ...
 *	Location:	/d/Kalad/common/sewers/ll27.c
 *	Modified:	Toby, 97-08-12
 */
...
::create_room();
   ...
   clone_object("/d/Kalad/common/sewers/doors/capt2door")->move(TO);
...
check_read_skill()
{
   switch(TP->query_skill(SS_LANGUAGE))
      {
         case 0..20:
	 return "You read: c.m...d.r P.e..s ..iv.t. .u...rs.\n" +
		"                 K... ...!\n";
         break;

         case 21..100:
	 return "You read: Commander Pretz's private quarters.\n" +
		"                 KEEP OUT!\n";
	 break;

 ...
 *	Location:	/d/Kalad/common/sewers/ll26.c
 *	Modified:	
 */
...
::create_room();
   ...
   set_long("You are in a dimly lit underground tunnel. It is cut " +
	    ...
	    "tunnel leads north. There seem to be a room to the east. " +
	    "@@dwarf_check" );
   ...
   clone_object("/d/Kalad/common/sewers/doors/capt2door1.c")->move(TO);
   add_exit(PATH + "ll25.c","north",0,1);
   add_exit(PATH + "ll29.c","east",0,1);

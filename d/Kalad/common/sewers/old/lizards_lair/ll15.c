 ...
 *	Location:	/d/Kalad/common/sewers/ll15.c
 *	Modified:	
 */
...
::create_room();
   ...
   set_long("You are in a dimly lit underground hallway. It is cut " +
	    ...
	    "hallway continues to the east and to the west, south " +
	    "a tunnel opens up. " + "@@dwarf_check" );
   ...
   add_exit(PATH + "ll16.c","east",0,1);
   add_exit(PATH + "ll14.c","west",0,1);
   add_exit(PATH + "ll25.c","south",0,1);

 ...
 *     Location:       /d/Kalad/common/sewers/ll31.c
 *     Modified:       
 */
...
::create_room();
    ...
    set_long("This is the western part of a great hall. " +
	     ...
	     "reflection. To the east there seem to be a " +
	     "throne. You can move into the great hall going " +
	     "east, southeast and northeast. Or move closer to " +
	     "the exits of the great hall going north and south. " +
	     "@@dwarf_check");
    ...
    add_item("wall","The wall are completely smooth.\n");
    add_item("throne","You can not see the throne clearly enough " +
	     "from this point to get any details. You would have " +
	     "to further into the hall.\n");

    add_exit(PATH + "ll30.c","north",0,1);
    add_exit(PATH + "ll32.c","south",0,1);
    add_exit(PATH + "ll34.c","east",0,1);
    add_exit(PATH + "ll33.c","northeast",0,1);
    add_exit(PATH + "ll35.c","southeast",0,1);

 ...
 *	Location:	/d/Kalad/common/sewers/ll14.c
 *	Modified:	
 */
...
::create_room();
   ...
   set_long("You are in a dark underground hallway. It is cut " +
	    "directly out of the rock, the surface of the walls is " +
	    "made very smooth. There are torches placed in steel " +
	    "holders at the floor, they are burned out though. The " +
	    "hallway continues to the east and to the northwest a " +
	    "tunnel opens up. " + "@@dwarf_check" );
   ...
   add_item( ({"torch","torches"}),
	    "They are regular burned out torches.\n");
   ...
   add_exit(PATH + "ll15.c","east",0,1);
   add_exit(PATH + "ll10.c","northwest",0,1);

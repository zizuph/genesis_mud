 ...
 *	Location:	/d/Kalad/common/sewers/ll25.c
 *	Modified:	
 */
...
::create_room();
   ...
   set_long("You are in a dimly lit underground tunnel. It is cut " +
	    ...
	    "tunnel continues to the south, looking north you see a " +
   ...
   add_exit(PATH + "ll15.c","north",0,1);
   add_exit(PATH + "ll26.c","south",0,1);
   add_exit(PATH + "ll28.c","east",0,1);

 ...
 *	Location:	/d/Kalad/common/sewers/ll12.c
 *	Modified:	
 */
...
::create_room();
   ...
   set_long("You are in a dimly lit underground hallway. It is cut " +
	    ...
	    "hallway continues to the east and to the west, north " +
   ...
   add_exit(PATH + "ll13.c","east",0,1);
   add_exit(PATH + "ll11.c","west",0,1);
   add_exit(PATH + "ll17.c","north",0,1);

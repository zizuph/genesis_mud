 ...
 *	Location:	/d/Kalad/common/sewers/ll11.c
 *	Modified:	
 */
...
::create_room();
   ...
   set_long("You are in a dimly lit underground hallway. It is cut " +
	    ...
	    "hallway continues to the east and to the southwest a " +
	    "dark tunnel opens up. " + "@@dwarf_check" );
   ...
   add_exit(PATH + "ll12.c","east",0,1);
   add_exit(PATH + "ll10.c","southwest",0,1);

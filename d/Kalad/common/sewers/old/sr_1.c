...
{
   ::create_room();
   set_short("A somewhat bright and reeking brick room");
   ...
   "notice some red eyes watching you from the darkness. Sunlight "+
   "streams in from the grate above you.\n");
   add_item("walls","Filthy, slime-covered brick.\n");
   add_item(({"eyes","red eyes"}),"They belong to the rats that"+
   " infest this disgusting place.\n");
   add_exit("/d/Kalad/common/sewers/sr_4.c","northeast",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_3.c","north",0,1,3);
   add_exit("/d/Kalad/common/sewers/sr_2.c","northwest",0,1,3);
}

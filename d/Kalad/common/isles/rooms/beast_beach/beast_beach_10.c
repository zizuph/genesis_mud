 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_10.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_19","northwest");	
   add_exit(BEAST_BEACH + "beast_beach_20","north");
   add_exit(BEAST_BEACH + "beast_beach_9","east");
   add_exit(BEAST_BEACH + "beast_beach_7","southeast");
   add_exit(BEAST_BEACH + "beast_beach_6","south");
   add_exit(BEAST_BEACH + "beast_beach_5","southwest");
   add_exit(BEAST_BEACH + "beast_beach_11","west");

	 /*************************************************************************
   *  Sets the no exit message for unlisted directions
    *************************************************************************/
   set_no_exit_msg(get_all_no_exits(({"nw","n","e","se","s","sw","w"})),

 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_9.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_20","northwest");	
   add_exit(BEAST_BEACH + "beast_beach_8","southeast");
   add_exit(BEAST_BEACH + "beast_beach_7","south");
   add_exit(BEAST_BEACH + "beast_beach_6","southwest");
   add_exit(BEAST_BEACH + "beast_beach_10","west");

	 /*************************************************************************
   *  Sets the no exit message for unlisted directions
    *************************************************************************/
   set_no_exit_msg(get_all_no_exits(({"nw","se","s","sw","w"})),

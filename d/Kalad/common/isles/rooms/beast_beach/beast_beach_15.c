 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_15.c
*
...
{   
   ...
   + "the north end you can see what appears to be a densely packed tree "
	...
	add_exit(BEAST_BEACH + "beast_beach_16","northeast");
	add_exit(BEAST_BEACH + "beast_beach_14","east");
	add_exit(BEAST_BEACH + "beast_beach_2","southeast");
	add_exit(BEAST_BEACH + "beast_beach_1","south");

	 /*************************************************************************
   *  Sets the no exit message for unlisted directions
    *************************************************************************/
   set_no_exit_msg(get_all_no_exits(({"ne","e","se","s"})),

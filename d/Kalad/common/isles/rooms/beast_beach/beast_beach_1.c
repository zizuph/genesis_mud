 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_1.c
*
...
create_std_beach()
{
   ...
   add_exit(BEAST_BEACH + "beast_beach_15","north");
   add_exit(BEAST_BEACH + "beast_beach_14","northeast");
   add_exit(BEAST_BEACH + "beast_beach_2","east");

 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_3.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_13","north");
   add_exit(BEAST_BEACH + "beast_beach_12","northeast");
   add_exit(BEAST_BEACH + "beast_beach_4","east");
   add_exit(BEAST_BEACH + "beast_beach_2","west");
   add_exit(BEAST_BEACH + "beast_beach_14","northwest");

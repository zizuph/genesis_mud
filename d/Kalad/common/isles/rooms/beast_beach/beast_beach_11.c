 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_11.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_18","northwest");	
   add_exit(BEAST_BEACH + "beast_beach_19","north");
   add_exit(BEAST_BEACH + "beast_beach_20","northeast");
   add_exit(BEAST_BEACH + "beast_beach_10","east");
   add_exit(BEAST_BEACH + "beast_beach_6","southeast");
   add_exit(BEAST_BEACH + "beast_beach_5","south");
   add_exit(BEAST_BEACH + "beast_beach_4","southwest");
   add_exit(BEAST_BEACH + "beast_beach_12","west");

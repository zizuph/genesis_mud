 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_17.c
*
...
{   
   ...
   + "the north end you can see what appears to be a densely packed tree "
	...
	add_exit(BEAST_BEACH + "beast_beach_18","east");
	add_exit(BEAST_BEACH + "beast_beach_12","southeast");
	add_exit(BEAST_BEACH + "beast_beach_13","south");
	add_exit(BEAST_BEACH + "beast_beach_14","southwest");
	add_exit(BEAST_BEACH + "beast_beach_16","west");

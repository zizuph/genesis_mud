 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_4.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_12","north");
   add_exit(BEAST_BEACH + "beast_beach_11","northeast");
   add_exit(BEAST_BEACH + "beast_beach_5","east");
   add_exit(BEAST_BEACH + "beast_beach_3","west");
   add_exit(BEAST_BEACH + "beast_beach_13","northwest");

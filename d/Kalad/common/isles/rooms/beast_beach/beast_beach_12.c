 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_12.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_17","northwest");	
   add_exit(BEAST_BEACH + "beast_beach_18","north");
   add_exit(BEAST_BEACH + "beast_beach_19","northeast");
   add_exit(BEAST_BEACH + "beast_beach_11","east");
   add_exit(BEAST_BEACH + "beast_beach_5","southeast");
   add_exit(BEAST_BEACH + "beast_beach_4","south");
   add_exit(BEAST_BEACH + "beast_beach_3","southwest");
   add_exit(BEAST_BEACH + "beast_beach_13","west");

 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_20.c
*
...
{   
   ...
   + "the north end you can see what appears to be a densely packed tree "
	...
	add_exit(BEAST_BEACH + "beast_beach_9","southeast");
	add_exit(BEAST_BEACH + "beast_beach_10","south");
	add_exit(BEAST_BEACH + "beast_beach_11","southwest");
	add_exit(BEAST_BEACH + "beast_beach_19","west");

	 /*************************************************************************
   *  Sets the no exit message for unlisted directions
    *************************************************************************/
   set_no_exit_msg(get_all_no_exits(({"se","s","sw","w"})),

 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_5.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_11","north");
   add_exit(BEAST_BEACH + "beast_beach_10","northeast");
   add_exit(BEAST_BEACH + "beast_beach_6","east");
   add_exit(BEAST_BEACH + "beast_beach_4","west");
   add_exit(BEAST_BEACH + "beast_beach_12","northwest");

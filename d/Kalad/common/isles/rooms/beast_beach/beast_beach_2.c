 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_2.c
*
...
{   
   ...
   add_exit(BEAST_BEACH + "beast_beach_14","north");
   add_exit(BEAST_BEACH + "beast_beach_13","northeast");
   add_exit(BEAST_BEACH + "beast_beach_3","east");
   add_exit(BEAST_BEACH + "beast_beach_1","west");
   add_exit(BEAST_BEACH + "beast_beach_15","northwest");

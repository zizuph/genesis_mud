 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_19.c
*
...
{   
   ...
   + "the north end you can see what appears to be a densely packed tree "
	...
	add_exit(BEAST_BEACH + "beast_beach_20","east");
	add_exit(BEAST_BEACH + "beast_beach_10","southeast");
	add_exit(BEAST_BEACH + "beast_beach_11","south");
	add_exit(BEAST_BEACH + "beast_beach_12","southwest");
	add_exit(BEAST_BEACH + "beast_beach_18","west");

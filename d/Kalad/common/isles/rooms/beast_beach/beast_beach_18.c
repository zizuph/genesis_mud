 /*****************************************************************************
*  /d/Kalad/common/isles/rooms/beast_beach/beast_beach_18.c
*
...
{   
   ...
   + "the north end you can see what appears to be a densely packed tree "
	...
	add_exit(BEAST_BEACH + "beast_beach_19","east");
	add_exit(BEAST_BEACH + "beast_beach_11","southeast");
	add_exit(BEAST_BEACH + "beast_beach_12","south");
	add_exit(BEAST_BEACH + "beast_beach_13","southwest");
	add_exit(BEAST_BEACH + "beast_beach_17","west");
	add_exit(BEAST_BEACH + "beast_beach_1","north", "@@exit_north", 1, 1);

...
create_port_room()
{
    ...
    set_long("You are standing on a long wooden pier that sticks out "+
      "into the bay. An enormous ship is docked to your west. The "+
      ...
      "your senses. The faint cry of seagulls fills the air.\n");
    ...
    add_exit(PORT + "s85", "north");
    add_exit(PORT + "s94", "south");
}

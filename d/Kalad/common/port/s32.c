...
create_port_room()
{
    ...
    set_long("This is the eastern area of a wooden platform that rests within the bay.\n"+
      "A large building lies west from here. "+
    ...
    add_exit(PORT + "s19", "north");
    add_exit(PORT + "s45", "south");
    clone_object(PORT + "obj/wbasket")->move(TO);
}

...
reset_room()
{
    if(!ob1)
    {
	ob1 = clone_object(PORT + "npc/orphan");
	ob1 -> move_living("M",TO);
	tell_room(TO,"Someone collides into you from behind, nearly knocking you down!\n");
    }
}
...
create_port_room()
{
    ...
    set_long("You are standing on a long wooden pier that sticks out "+
      "into the bay. An enormous ship is docked to your north. The "+
    ...
    add_exit(PORT + "s92", "west");
    add_exit(PORT + "s94", "east");

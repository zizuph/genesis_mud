...
create_monster()
{
    ...
    add_cact("sigh");
    add_cact("sniff");
    add_speak("Don't tell anyone, but I think the manager hid his special "+
      "beer somewhere in this room.\n");
    set_knight_prestige(-8);
    set_alarm(1.0,0.0,"arm_me");
    set_default_answer("The worker merely wipes the sweat from his brow.\n");
    add_ask(({"contraption","machine"}),
      "The worker says: Why that's the machine that makes all the beer "+
      "for the entire brewery. The manager really likes hanging around "+
      "in this part of the brewery when he's not drinking in his office.\n");
    add_ask(({"manager"}),"The worker says: His office is to the west.\n");
    add_ask(({"beer"}),"The worker says: What we make, of course!\n");
    add_ask(({"office"}),"The worker says: Where the manager is, silly.\n");
    add_ask(({"brewery"}),"The worker says: What you are standing in, silly.\n");
}
void
arm_me()
{

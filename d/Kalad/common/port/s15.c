...
create_port_room()
{
    ...
    set_long("You are standing on a small wooden pier that sticks out "+
      "into the bay. The end of the pier and beginning of the wooden platform "+
      "lies just east from here. Further north rises a massive cliff. The "+
    ...
    add_item(({"large building","building"}),"A big wooden edifice sitting "+
      "upon the platform.\n");
    add_exit(PORT + "s14", "west");
    add_exit(PORT + "s16", "east");
}

...
create_room()
{
  ...
  ::create_pier();
    ...
    set_long("You are standing on a long wooden pier that sticks out "+
      ...
      "movement and the sound of water roughly hitting against the "+
      "supports assaults your senses. The cry of seagulls fills the air.\n");
    ...
    add_exit(PORT + "s95", "west");
    add_pier_entry(MASTER_OB(this_object()), "Kabal", "Newbie Line C");
    initialize_pier();

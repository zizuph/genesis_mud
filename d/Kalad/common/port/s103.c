/*
 * Added some tiny minotaurs for the sohms to kill
 * Changed by Zignur october 2017
 */
...
create_port_room()
{
    ...
    /* Add some yearlings for the Sohms */
    add_npc(PORT + "npc/yearling",2,&->arm_me());  
    
    add_exit(PORT + "s102", "east");
    add_exit(PORT + "s104", "west");
}

...
create_port_room()
{
    set_short("The storeroom of Orgadar the Sailmaker");
    set_long("This is the storeroom of Orgadar the Sailmaker. You should "+
      "leave as soon as possible before you are discovered and viciously beaten "+
      "by him.\n");

    add_exit(PORT + "s31", "south");
 ...
 */
mixed to_check = ({ ({ "create_object", SAIL, 10 }) });

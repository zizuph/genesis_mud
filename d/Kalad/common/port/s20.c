...
create_port_room()
{
    ...
    set_long("You are travelling on a street aside the bay. Further north "+
      "you can see a huge cliff tower above the district. The cobblestones underfoot "+
      "are moist and covered with some greenish grime. To the east and southeast "+
      "is a large wooden building. The sparkling bay lies gloriously to your "+
      "west, its beauty only marred by the squat pier lying to the northwest.\n");
    ...
    add_item(({"squat pier","pier"}),"A small wooden appendage that sticks out "+
      "into the bay.\n");
    add_exit(PORT + "s4", "north");
    add_exit(PORT + "s21", "east");
    add_exit(PORT + "s33", "south");
}

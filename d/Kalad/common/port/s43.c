...
create_port_room()
{
    ...
    set_long("This is the southwestern area of a wooden platform that rests within the bay.\n"+
      "A large building lies northeast from here. "+
    ...
    add_exit(PORT + "s30", "north");
    add_exit(PORT + "s44", "east");
}

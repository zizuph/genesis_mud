...
create_port_room()
{
    ...
    set_long("This is a narrow and rocky path leading along the base of "+
      ...
      "path continues to the east. To the south lies a small pier.\n");
    ...
    add_item(({"small pier","pier"}),"A rickety wooden pier that can be "+
      "reached by travelling south among the rocks of the path.\n");
    add_item(({"rocks","rock"}),"Sharp grey stones that have fallen from "+
      "the cliff or have been eroded by the breaking of the waves.\n");
    add_exit(PORT + "shipline/path1", "east");
    add_exit(PORT + "shipline/pier1", "south");
}

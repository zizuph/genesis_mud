...
create_object()
{
    ...
    set_adj("rotten");
    set_pname("fruits");
    set_long("The fruit is native to the highlands above Kabal and looks "+
      "to be a hybrid of an apple and a pear. It is well past ripeness and "+
      "the odor is quite potent.\n");
...
eat(string s)
{
    ...
    write("Its rotten, you'd get sick if you ate that!\n");
    return 1;
}

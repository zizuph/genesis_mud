...
create_port_room()
{
    set_short("The storeroom of Gorumn the Netweaver");
    set_long("This is the storeroom of the Netweaver's shop. It would "+
      "probably be a good idea for you to leave soon, for if Gorumn should "+
      "discover you here, all hell might break loose.\n");

    add_exit(PORT + "s22", "down");
...
#define NET "/d/Kalad/common/guilds/shadow_walkers/net"
#define NET2 PORT + "obj/net"
 ...
 */
mixed to_check = ({ ({ "create_object", NET, 10 }), ({ "create_object",
    NET2, 10 }) });

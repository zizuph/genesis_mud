...
create_port_room()
{
    set_short("The storeroom of Telbruin the Tanner");
    set_long("This is the storeroom of the Tanner's shop. It would "+
      "probably be the intelligent thing for you to do if you left right "+
      "away. Telbruin would be greatly pissed off at you if he found you "+
      "messing around in his storeroom.\n");

    add_exit(PORT + "s21", "down");
...
#define VEST PORT + "arm/tanner_vest"
#define PANTS PORT + "arm/tanner_pants"
#define CLOAK PORT + "arm/tanner_cloak"
 ...
 */
mixed to_check = ({ ({ "create_armour", VEST, 5 }),

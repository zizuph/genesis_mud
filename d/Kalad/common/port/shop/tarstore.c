...
create_port_room()
{
    set_short("The storeroom of Mardon's Tar Shop");
    set_long("This is the storeroom of the Tar Shop. It would be most "+
      "wise of you to depart the premises immediately. If Mardon found you "+
      "here he would surely kill you.\n");

    add_exit(PORT + "s54", "down");
 ...
 */
mixed to_check = ({ ({ "create_object", TAR, 10 }) });

...
create_port_room()
{
    ...
    set_long("You are travelling along a street which borders the bay. "+
      "The road bends here and heads north and east. The moist cobblestones "+
      "beneath you are covered with grime. The beautiful bay spreads out "+
      "to your west and south, its beauty marred only by the squat pier "+
      "jutting out to the west. A large building lies to your northeast.\n");
    ...
    add_exit(PORT + "s68", "west","@@move");
    add_exit(PORT + "s56", "north");
    add_exit(PORT + "s70", "east");
}

...
create_port_room()
{
    ...
    set_long("This is the southeastern area of a wooden platform that rests within the bay.\n"+
      "A large building lies to the northwest. "+
    ...
    add_exit(PORT + "s44", "west");
    add_exit(PORT + "s32", "north");
}

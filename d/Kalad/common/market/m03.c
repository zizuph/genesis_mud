...
create_room()
{
   ...
   set_long("\n"+
      ...
      "\n\n"+
      "    There is a drab colored tent to the west, "+
      "and a darker colored tent to the north. There "+
      "is a sign with some script hanging over the "+
      "doorway to the drab colored tent and a similar "+
      "sign, which you can see better and has an image "+
      "of crossed swords depicted on it, hanging over "+
      "the doorway of the tent to the north. To the "+
      "south is the entrance to Market Street which "+
      "runs south through the city. "+
      "\n\n");
   
   add_item(({ "drab tent", "drab colored tent" }),
      "\n"+
      "You don't know what the purpose of the tent "+
      "to the north is, but you can clearly make out "+
      "the script on the tent to the west."+
      "\n\n");
   add_item(({ "sign", "script" }),
      "\n"+
      "There is some script engraved in common on it. "+
      "\n\n");
   ...
   add_item(({ "people", "crowd" }), 
      ...
      "\n\n"+
      "    Through the crowd to the north you are "+
      "able to make out a drab colored tent. You "+
      "better able to make out another drab tent "+
      "to the west. Which has a sign swinging in "+
      "the wind above the doorway. "+
      "\n\n");
   ...
   add_exit(MRKT_PATH(sh_wep), "north");
   add_exit(MRKT_PATH(smithy), "west");
   add_exit(MRKT_PATH(mstreet01), "south");
   add_exit(MRKT_PATH(m02), "east");
   add_exit(MRKT_PATH(m07), "northeast");
   add_exit(MRKT_PATH(m08),"northwest");
}
...
read(string str)
{
   if((str=="sign")||(str=="script"))
      ...
      say(QCTNAME(this_player()) + " studies the "+
         "sign on the drab tent to the west.\n");
      return 1;
   }

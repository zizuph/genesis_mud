...
create_room() 
{
set_short("The store room of the perfume shop");
set_long("You are within the store room of the perfume shop, you should "+
"probably leave before Amey finds you in here and calls for the guards!\n");

add_exit(CVAN(shop/perfume_shop),"east",0,-1,-1);
...
#define PERFUME "/d/Kalad/common/caravan/obj/perfume"
#define COLOGNE "/d/Kalad/common/caravan/obj/cologne"
 ...
 */
mixed to_check = ({ ({ "create_object", PERFUME, 10 }),
({ "create_object", COLOGNE, 10 }),
                 });

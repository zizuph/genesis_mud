 ...
 *
 * Revision history:
*stolen by cyric from anthronos' who stole it from mercade
 */
...
create_room() 
{
set_short("The store room of the weaponsmith's shop");
set_long("You are in the Weaponsmith's store room. "+
        "You should leave now before someone finds you here.\n");

add_exit(MARKET(sh_wep),"south");
...
#define BC_DAGGER "/d/Kalad/common/market/wep/bc_dagger"
#define SIL_FLAIL "/d/Kalad/common/market/wep/sil_flail"
#define SM_AXE "/d/Kalad/common/market/wep/sm_axe"
 ...
 */
mixed to_check = ({
({"creat_object",BC_DAGGER,3}), ({"create_object",SIL_FLAIL,2}),
   ({"create_object",SM_AXE,4})
                 });

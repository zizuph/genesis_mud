...
create_room()
{
   ...
   set_long("\n"+
      ...
      "\n\n"+
      "    To the north is a tent of a bright and "+
      "strange mixture of colors. It can only be "+
      "the tent of the famous Kaladian fortune "+
   ...
   add_exit(MRKT_PATH(fteller01), "north");
...
reset_room()
{
    if(!ob1)
        {
         ob1 = clone_object("/d/Kalad/common/market/npc/fatmerch.c");

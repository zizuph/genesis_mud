...
create_room()
{
   ...
   set_long("\n"+
      ...
      "\n\n"+
      "    To the north is a green tent, and to the "+
      "northwest is a yellow tent. They both have "+
      "signs hanging above the doorways which you "+
      "might be able to read. "+
      "\n\n");
   
   add_item(({ "green tent" }), "\n"+
      "This tent is made of a bright, emerald green "+
      "material. Except for the fact that it is in "+
      "terrible condition, it is a pleasant looking "+
      "structure. Considering how many people there "+
      "are in the Market right now, this tent is "+
      "not getting much use. There is a shiny sign "+
      "hanging over the doorway. "+
      "\n\n");
   add_item(({ "shiny sign" }), "\n"+
      "It glitters as the suns sparkles off of it, "+
      "making you squint your eyes as you look at it. "+
      "You think you can read what is written on it. "+
      "\n\n");
   add_item(({ "yellow tent" }), "\n"+
      "This tent closely resembles the green tent, "+
      "but is in much better state of repair. It has "+
      "a wooden sign tacked to its walls. There is a "+
      "continuous stream of people going in and out "+
      "of it. "+
      "\n\n");
   add_item(({ "wooden sign" }), "\n"+
      "This sign is carved out of red fir. It has "+
      "some words burned into it. "+
      "\n\n");
   ...
   add_item(({ "people", "crowd" }), "\n"+
      "The market place is packed with people of all "+
      "descriptions and races. There are so many people "+
      "constantly bumping into you that you think you "+
      "should probably keep a firm grasp upon your "+
      "purse... Unless you don't mind losing it of "+
      "course. "+
      "\n\n");
   ...
   set_time_desc("    The crowds are tightly packed right "+
      ...
      "day, there are still a large number of people "+
      "milling about. Must have something to do with the "+
      "fact that the Market is the center of activity "+
      "around these parts. "+
      "\n\n");
   ...
   add_exit(MRKT_PATH(sh_spice), "northwest");
   add_exit(MRKT_PATH(stall01), "north");
   add_exit(MRKT_PATH(m14), "southwest");
}
...
read(string str)
{
   if((str=="shiny sign"))
      {
      write("The shiny sign reads:\n\n"+
         "     'Market Stall -> Feeding and Care'\n\n");
      say(QCTNAME(this_player()) + " studies the "+
         "shiny sign on the green tent to the north.\n");
      return 1;
   }
   if((str=="wooden sign"))
      {
      write("The burned lettering on the wooden sign read:\n\n"+
         "         'Spices of All Kinds'\n\n");
      say(QCTNAME(this_player()) + "studies the "+
         "burn marks on the wooden sign tacked on the "+
         "side of the yellow tent.\n");
      return 1;
   }
   write("Read what? The wooden sign, or the shiny sign?\n");
   return 1;
}
...
reset_room()
{
   ...
   if(!ob4)
      {
      ob4 = clone_object(MRKT_PATH(npc/mguard1));
      ob4 -> move_living("xxx", TO);
      ob4 -> team_join(ob3);
   }
   if(!ob5)
      {
      ob5 = clone_object(MRKT_PATH(npc/goblin1));

...
create_room()
{
    ...
    add_item("banner","It is red and reads: House of Aemilius.\n");
    ...
    "red banners hang around it.\n");
    add_item("road","A very nice white-stoned road that is clean "+
    "and well-kept.\n");
    add_prop(ROOM_NO_TIME_DESC,1);
    add_exit(NOBLE(road/r11),"southeast",0,0,-1);
    add_exit(NOBLE(aemilius/g1),"west",0,0,-1);
}

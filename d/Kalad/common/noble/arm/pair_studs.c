...
query_ring_short()
{
    ...
    if(gem && metal)
        return "pair of "+qmetal+" studs with "+qgem+" gems";
    else
        return "pair of "+qmetal+" studs";
}
...
query_ring_long()
{
    ...
    {
        return
        "These are a pair of "+qmetal+" studs. They are small, but "+
        "beautifully crafted. The pin at the end looks like it can "+
        "be inserted into a piercing. In the center of the stud, "+
        "a "+qgem+" gleams brightly.\n";
    }
    if(metal)
    {
        return

...
static int worn;
string metal, qmetal, gem, qgem, article;
...
query_ring_short()
{
    ...
    if(gem && metal)
        return qmetal+" stud with "+article+" "+qgem;
    else
        return qmetal+" stud";
}
...
{
    if (query_ring_gem())
        return query_ring_metal() + " studs with " + 
            LANG_PWORD(query_ring_gem()); 

    return query_ring_metal() + " studs";
}
...
query_ring_long()
{
    ...
    if(gem && metal)
        {
        return
        "This is a little "+qmetal+" stud with a beautiful "+
        qgem+" set in it. The pin sticking out of it looks "+
        "like it can be inserted into a piercing. You can "+
        "'keep' it from being sold.\n";
    }
    if(metal)
        {
        return
        "This is a little "+qmetal+" stud."+
        "The pin sticking out of it looks "+
        "like it can be inserted into a piercing. You can "+
        "'keep' it from being sold.\n";
    }
    else

...
create_room()
{
    ...
    set_long("You have entered the begining of the beautiful gardens "+
      ...
      "your west and southwest, while the "+
      "grand entrance to the estate is just off to the west.\n");
    ...
    add_exit(NOBLE(paullus/g3),"west",0,-1,-1);
    add_exit(NOBLE(paullus/g1),"southwest",0,-1,-1);
}

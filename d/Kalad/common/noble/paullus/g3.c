...
create_room()
{
    ...
    add_exit(NOBLE(paullus/g4),"west",0,-1,-1);
    add_exit(NOBLE(paullus/g2),"east",0,-1,-1);
    add_exit(NOBLE(paullus/m1),"north",0,-1,-1);
    add_exit(NOBLE(paullus/g1),"south",0,-1,-1);
    reset_room();
}
...
reset_room()
{
	...
	obj2->set_house_name("Paullus");
	obj2->set_color_name("red-gold");
	obj2->arm_me();

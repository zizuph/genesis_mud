...
create_room()
{
    ...
    set_long("You now find yourself in northwest corner of what "+
    ...
    "to your south and east.\n");

    INSIDE;

    add_exit(NOBLE(paullus/m6),"east",0,-1,-1);
    add_exit(NOBLE(paullus/m20),"south",0,-1,-1);
    add_exit(NOBLE(paullus/m2),"southeast",0,-1);

...
create_room()
{
    ...
    "various animal life. The path branches off here to your north, "+
    "west and east.\n");
    ...
    add_exit(NOBLE(park/p14),"east",0,0,-1);
    add_exit(NOBLE(park/p23),"west",0,0,-1);
    add_exit(NOBLE(park/p16),"north",0,0,-1);

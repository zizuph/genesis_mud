...
create_room()
{
    ...
    set_long("You stand inside a beautiful park. A great hedge wall "+
        ...
        "various animal life. The path splits here, leading to the "+
        "northwest where you can hear running water, and to the "+
        "west, deeper into the park.\n");
    ...
    add_exit(NOBLE(park/p5),"north",0,0,-1);
    add_exit(NOBLE(park/p7),"northwest",0,0,-1);
    add_exit(NOBLE(park/p13),"west",0,0,-1);

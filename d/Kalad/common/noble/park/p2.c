...
create_room()
{
    ...
    "various animal life. North leads to the exit of the park, "+
    ...
    add_exit(NOBLE(park/p1),"north",0,0,-1);
    add_exit(NOBLE(park/p3),"south",0,0,-1);
    add_prop(ROOM_NO_TIME_DESC,1);
    set_up_herbs(({"/d/Kalad/common/herbs/redeye"}),({"bushes","trees"}),8);
}

...
create_room()
{
    ...
    "various animal life. Paths branch out all over from here. "+
    "There is a bench here.\n");
    add_item("bench","This is a small wooden bench.\n");
    add_cmd_item("bench","sit on","You sit on the bench and rest.\n");
    ...
    add_exit(NOBLE(park/p17),"east",0,0,-1);
    add_exit(NOBLE(park/p21),"northwest",0,0,-1);
    add_exit(NOBLE(park/p20),"north",0,0,-1);
    add_exit(NOBLE(park/p15),"south",0,0,-1);
    add_exit(NOBLE(park/p23),"southwest",0,0,-1);

...
create_room()
{
    ...
    "various animal life. This area, here, is circular, and "+
    "a large tree stands in the center.\n");
    ...
    clone_object(NOBLE(obj/tree))->move(TO);
    add_exit(NOBLE(park/p17),"south",0,0,-1);

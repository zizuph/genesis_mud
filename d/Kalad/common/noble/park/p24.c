...
create_room()
{
    ...
    "various animal life. West leads to the exit of the park, "+
    "while east leads to a split in the path.\n");
    ...
    add_exit(NOBLE(park/p25),"west",0,0,-1);
    add_exit(NOBLE(park/p23),"east",0,0,-1);

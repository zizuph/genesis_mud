...
create_room()
{
    ...
    "various animal life. You are in a small, secluded area of the "+
    "park. A path leads east into a shaded alcove, while north, "+
    "you see large tree.\n");
    ...
    add_exit(NOBLE(park/p18),"east",0,0,-1);
    add_exit(NOBLE(park/p16),"west",0,0,-1);
    add_exit(NOBLE(park/p19),"north",0,0,-1);

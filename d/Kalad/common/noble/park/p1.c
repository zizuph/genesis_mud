...
create_room()
{
    ...
    "various animal life. North leads back out, while south "+
    "leads further into the great park of the Noble district.\n");
    ...
    add_exit(NOBLE(road/r16),"north",0,0,-1);
    add_exit(NOBLE(park/p2),"south",0,0,-1);
    add_prop(ROOM_NO_TIME_DESC,1);
    set_up_herbs(({"/d/Kalad/common/herbs/mandrake",
        "/d/Kalad/common/herbs/redeye"}),({"trees","bushes"}),8);
}

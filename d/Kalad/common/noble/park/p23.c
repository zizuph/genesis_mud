...
create_room()
{
    ...
    "various animal life. The path branches off here to your east "+
    "and northeast.\n");
    ...
    add_exit(NOBLE(park/p15),"east",0,0,-1);
    add_exit(NOBLE(park/p24),"west",0,0,-1);
    add_exit(NOBLE(park/p16),"northeast",0,0,-1);

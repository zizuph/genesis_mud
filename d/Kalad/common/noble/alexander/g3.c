...
create_room()
{
    ...
    set_long("You have entered the beginning of the beautiful gardens "+
    ...
    add_exit(NOBLE(alexander/g4),"south",0,-1,-1);
    add_exit(NOBLE(alexander/g2),"north",0,-1,-1);
    add_exit(NOBLE(alexander/m1),"east",0,-1,-1);
    add_exit(NOBLE(alexander/g1),"west",0,-1,-1);
...
reset_room()
{
	...
	obj2->set_house_name("Alexander");
	obj2->set_color_name("black");
	obj2->arm_me();

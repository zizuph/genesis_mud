...
/* 2017-09-18 Malus: Header contents removed, so removing directive */ 
inherit "/std/door";
create_door()
{
   set_door_id("fgdoor");
   set_pass_command(({"w","west"}));
   set_door_name(({"pair of massive steel doors", "massive steel doors",
               "steel doors", "doors", "massive doors"}));
   set_other_room("/d/Kalad/common/wild/farm/farm_gate");

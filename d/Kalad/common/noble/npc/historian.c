/*
    ...
    Changed reply to gender specific, Meton 2020
 */
...
create_kalad_monster()
{
    ...
    set_long("This woman has piercing blue eyes that contrast greatly "+
        "with her old, silver hair. A vast amount of knowledge must "+
        "reside in her head, as she appears to be very old and wise. She "+
        "regards you carefully.\n");
    ...
    if(ENV(TO))
    {
        if (present("_case6_", ENV(TO)) )
            return "Yes, it is a very intresting sphere, but lately, "+
                ...
                "you've seen it once, thats all. It is a real mystery, "+
                "and people around here don't like that. You wouldn't be "+
                "'interested' in having it, would you?\n";
...
reward_quest(object ob)
{
    ...
    {
        command("say Thank you very much, " +gender+"!");

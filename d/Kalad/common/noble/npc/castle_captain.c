 ...
 *              Zignur 20171122 bugfix he did not wield his weapon
 *              
 * Cotillion - 2019-09-18
 * - Add clone_unique to AMC
 */

inherit "/d/Kalad/std/monster";
inherit "/d/Kalad/lib/special";
inherit "/d/Kalad/lib/assist";
/* Zignur 20171122 bugfix use clone_unique for magic weapons */
inherit "/lib/unique";
...
create_kalad_monster()
{
    ...
    /* Zignur 20171122 bugfix otherwise he wont wield properly */
    refresh_living();
    ...
    equip(({
        clone_unique(NOBLE + "wep/fire_axe", 10, NOBLE +"wep/other_axe"),
        clone_unique(NOBLE + "arm/mithril_chainmail", 18, NOBLE + "arm/os_breastplate"),
        NOBLE + "arm/os_helm",

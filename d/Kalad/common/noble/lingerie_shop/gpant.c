...
create_object()
{
    ...
    set_short("pair of @@query_color@@ silky panties");
    set_long("A very silky pair of panties, probably imported and "+
    "very expensive.\n");
...
wear(string str)
{
    ...
    if(worn == 1)
        return 0;
    write("You slip on the "+short()+" on your bottom.\n");
    say(QCTNAME(TP)+" slips on the "+short()+" on "+
    HIS(TP)+" bottom.\n");
    worn = 1;

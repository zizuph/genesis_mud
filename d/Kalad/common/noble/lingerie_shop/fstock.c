...
create_object()
{
    set_name("pair of stockings");
    add_name("stockings");
    set_adj("@@query_color@@");
    add_adj("fish-net");
    add_adj("thigh-high");
    set_short("pair of thigh-high @@query_color@@ fish-net stockings");
    set_pshort("pairs of thigh-high @@query_color@@ fish-net stockings");
    set_long(
     "These are @@query_color@@ stockings made out of fine strands of "+
     "silk criss-crossinng to form a net appearance.\n");

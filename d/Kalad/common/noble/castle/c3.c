...
create_noble_room()
{
    ...
    "a red carpet. The hall bends to the southeast, while "+
    "directly south, you see another long hallway.\n");
    ...
    add_exit(NOBLE + "castle/c8", "southeast", 0, 0);
    add_exit(NOBLE + "castle/c2", "west", 0, 0);
    add_exit(NOBLE + "castle/c7", "south", 0, 0);
}

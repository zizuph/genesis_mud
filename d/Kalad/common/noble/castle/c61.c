...
create_noble_room()
{
    ...
    set_long("These are the unusually lavish 'barracks' of the "+
        ...
        "room is dotted with comfortable looking cots. The room extends "+
        "to the south and north further.\n");
    ...
    add_exit(NOBLE + "castle/c56", "north", 0, 0);
    add_exit(NOBLE + "castle/c60", "west", 0, 0);
    add_exit(NOBLE + "castle/c66", "south", 0, 0);

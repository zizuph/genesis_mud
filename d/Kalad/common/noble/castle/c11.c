...
create_noble_room()
{
    ...
    set_long("You are now in the huge dining room of the "+
      ...
      "large. The small one is right here, and it seats a few "+
      "nobles. To the west and south, however, a huge table "+
      ...
      "Servants run across the room, serving nobles their food. "+
    ...
    add_exit(NOBLE + "castle/c6", "north", 0, 0);
    add_exit(NOBLE + "castle/c15", "south", 0, 0);
    add_exit(NOBLE + "castle/c10", "west", 0, 0);
...
reset_room()
{
    noble1 = clone_npcs(noble1, NOBLE + "npc/yf_dinner_noble");
    noble2 = clone_npcs(noble2, NOBLE + "npc/yf_dinner_noble");
    noble3 = clone_npcs(noble3, NOBLE + "npc/om_ball_noble");

...
create_noble_room()
{
    ...
    "giving you a good look at their cold, grey self. To the "+
    "south, you can hear the sounds of cooking.\n");
    add_item("carpet","The carpet is soft and warm.\n");
    add_item("torches","They hang on the walls.\n");

    add_exit(NOBLE + "castle/c7", "north", 0, 0);
    add_exit(NOBLE + "castle/c16", "south", 0, 0);
}

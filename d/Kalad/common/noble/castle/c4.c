...
create_noble_room()
{
    ...
    "decorated with tapestries. To the east, you see a room.\n");
    ...
    add_exit(NOBLE + "castle/c1", "northeast", 0, 0);
    add_exit(NOBLE + "castle/c5", "east", 0, 0);
    add_exit(NOBLE + "castle/c9", "south", 0, 0);
    add_exit(NOBLE + "castle/c38", "up", 0);
}

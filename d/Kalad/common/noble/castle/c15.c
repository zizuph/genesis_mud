...
create_noble_room()
{
    ...
    set_long("You are now in the huge dining room of the "+
      ...
      "stretches northwesternly across the wall. There is a "+
      ...
      "The walls are decorated with tapestries and murals. The "+
      "sounds of cooking can be heard to the east.\n");
    ...
    add_exit(NOBLE + "castle/c11", "north", 0, 0);
    add_exit(NOBLE + "castle/c10", "northwest", 0, 0);
    add_exit(NOBLE + "castle/c16", "east", 0, 0);

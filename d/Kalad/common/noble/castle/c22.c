...
create_noble_room()
{
    ...
    set_long("You now stand on the soft, red carpet that covers "+
        ...
        "giving you a good look at their cold, grey self. A stair"+
        "case leads up here into the upper towers.\n");
    ...
    add_exit(NOBLE + "castle/c17", "north", 0, 0);
    add_exit(NOBLE + "castle/c27", "south", 0, 0);
    add_exit(NOBLE + "castle/c57", "up", 0, 0);
...
reset_room()
{
    ob = clone_npcs(ob, NOBLE + "npc/castle_squire");
}

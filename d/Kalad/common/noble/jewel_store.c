...
{
set_short("Storeroom");
set_long("This is a big room with jewels in it.\n");
add_exit(NOBLE(jewel_shop),"west",0,-1,-1);
...
#define JEWEL "/d/Kalad/common/noble/obj/diamond"
#define JEWEL2 "/d/Kalad/common/noble/obj/sapphire"
#define JEWEL3 "/d/Kalad/common/noble/obj/ruby_ring"
#define JEWEL4 "/d/Kalad/common/noble/obj/diamond_ring"

mixed to_check = ({ ({ "create_object", JEWEL, 4 }),
                    ({ "create_object", JEWEL2, 4 }),
                    ({ "create_object", JEWEL3, 4 }),
                    ({ "create_object", JEWEL4, 4 }),
                 });

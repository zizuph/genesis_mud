...
create_room()
{
    ...
    set_long("You are travelling along Wayfarer's Boulevard in "+
      ...
      "surround you. The castle rises up to your south, and you see "+
      "the entrance to it along the path to your south.\n");
    ...
    add_exit(NOBLE(wayfarer/s8),"west",0,0,-1);
    add_exit(NOBLE(wayfarer/s10),"east",0,0,-1);
    add_exit(NOBLE(gateway/s9),"north",0,0,-1);
    add_exit(NOBLE(castle/g4),"south",0,0,-1);
}

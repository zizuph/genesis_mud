...
create_room()
{
    ...
    set_long("You are travelling along Wayfarer's Boulevard in "+
      ...
      "surround you. You are now very close to the castle that "+
      "rises to your southeast. You can see the towers and guards "+
      "and flags.\n");
    ...
    add_exit(NOBLE(wayfarer/s5),"west",0,0,-1);
    add_exit(NOBLE(wayfarer/s7),"east",0,0,-1);
}

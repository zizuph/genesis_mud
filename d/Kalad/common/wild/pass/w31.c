/* 
 * /d/Kalad/common/wild/pass/w31.c
...
create_room()
{
   ...
   set_long("You've entered a large clearing surrounded by several giant "+
      "huts. In the center of the clearing is a huge stone monument. Looking "+
      "around at your surroundings you note several piles of refuse scattered "+
      "about the clearing. One large hut, of even greater size than the "+
      "rest lies just to the north.\n");
   add_item(({"large clearing","clearing"}),"A large area around sixty "+
      "feet in diameter that is devoid of plant life, but is filled with "+
      "several piles of refuse.\n");
   add_item(({"refuse"}),"It is heaped in piles all about the clearing.\n");
   add_item(({"piles"}),"Different odds and ends can be seen, with "+
      "discarded bits of metal and wood being most prominent.\n");
   add_item(({"huge stone monument","huge monument","stone monument","monument"}),
      "Unfortunately for you, an all too realistic portrayal of a large, "+
      "and grotesque looking humanoid, probably a hill giant by the stooping "+
      "ape-like posture. Plastered on the giant's face is an utterly "+
      "repulsive grin.\n");
   ...
   add_exit("/d/Kalad/common/wild/pass/swhut", "southwest");
   add_exit("/d/Kalad/common/wild/pass/nwhut", "northwest");
   add_exit("/d/Kalad/common/wild/pass/nhut", "north");
   add_exit("/d/Kalad/common/wild/pass/nehut", "northeast");
   add_exit("/d/Kalad/common/wild/pass/sehut", "southeast");
   add_exit("/d/Kalad/common/wild/pass/w30", "south");
   reset_room();
}
void
reset_room()

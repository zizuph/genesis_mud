...
create_room()
{
   ...
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The room has several exits that branches "+
      "southwest, southeast, west, east and northwest "+
      "into what looks like other rooms hidden "+
   ...
   add_exit(CPASS(citadel/level2/b6),"east","@@arch",-1);
   add_exit(CPASS(citadel/level2/b4),"west","@@arch",-1);
   add_exit(CPASS(citadel/level2/b2),"northwest","@@arch",-1);
   add_exit(CPASS(citadel/level2/b8),"southeast","@@block",-1);
   add_exit(CPASS(citadel/level2/b7),"southwest","@@block",-1);
}

...
create_room()
{
   ...
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "cracks inbetween the stoneblocks. Along the eastern wall "+
      "you see different chains attached to it. "+
      "The only exit is west towards another room hidden "+
...
reset_room()
{
   if (!objectp(prisoner))
   {
      prisoner=clone_object("/d/Kalad/common/wild/pass/citadel/npc/nomadprisoner");

...
create_room()
{
   ...
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The room has an exit to the northeast and "+
      "southeast into what looks like two more rooms hidden "+
   ...
   add_exit(CPASS(citadel/level2/b5),"northeast","@@arch",-1);
   add_exit(CPASS(citadel/level2/b9),"southeast","@@arch",-1);
}

...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the west and northeast");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards west and northeast, hiding "+
   ...
   add_exit(CPASS(citadel/x4),"west","@@down",-1);
   add_exit(CPASS(citadel/x6),"northeast","@@up",-1);
}

...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the southwest and northeast");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards southwest and northeast, hiding "+
   ...
   add_exit(CPASS(citadel/x6),"southwest","@@down",-1);
   add_exit(CPASS(citadel/x8),"northeast","@@up",-1);

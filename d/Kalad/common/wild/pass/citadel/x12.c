...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the west and southeast");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards southeast and west, hiding "+
   ...
   add_exit(CPASS(citadel/level2/b1),"west",0,-1);
}

...
create_room()
{
   ...
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The room continues into a hallway to the northeast and "+
      "into another room northwards that hides "+
   ...
   add_exit(CPASS(citadel/level3/c5),"north","@@arch",-1);
   add_exit(CPASS(citadel/x18),"northeast","@@up",-1);
}

/* gives a feel of going upwards */
void
up()
{

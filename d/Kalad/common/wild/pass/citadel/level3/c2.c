...
create_room()
{
   ...
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The room has two exits to the northeast and southeast "+
   ...
   add_exit(CPASS(citadel/level3/c1),"northeast","@@arch",-1);
   add_exit(CPASS(citadel/level3/c5),"southeast","@@arch",-1);
}

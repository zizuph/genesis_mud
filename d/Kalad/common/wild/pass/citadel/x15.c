...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the north and south");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards north and south, hiding "+
   ...
   add_exit(CPASS(citadel/x14),"south","@@down",-1);
   add_exit(CPASS(citadel/x16),"north","@@up",-1);
}

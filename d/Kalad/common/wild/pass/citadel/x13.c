...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the east and northwest");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards northwest and east, hiding "+
   ...
   add_exit(CPASS(citadel/level2/b9),"east",0,-1);
   add_exit(CPASS(citadel/x14),"northwest","@@block",-1);

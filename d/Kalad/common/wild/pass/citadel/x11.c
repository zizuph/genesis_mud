...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the southeast and northwest");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards southeast and northwest, hiding "+
   ...
   add_exit(CPASS(citadel/x10),"southeast","@@down",-1);
   add_exit(CPASS(citadel/x12),"northwest","@@up",-1);
}

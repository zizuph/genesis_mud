...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the north and southeast");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards north and southeast, hiding "+
   ...
   add_exit(CPASS(citadel/x13),"southeast","@@down",-1);
   add_exit(CPASS(citadel/x15),"north","@@up",-1);
}

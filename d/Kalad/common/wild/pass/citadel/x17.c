...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the east and southwest");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards east and southwest, hiding "+
   ...
   add_exit(CPASS(citadel/x16),"southwest","@@down",-1);
   add_exit(CPASS(citadel/level3/c1),"east",0,-1);
}

...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the east. "+
      "The northwestern way is blocked by huge stones");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "cracks inbetween the stoneblocks. The northwestern "+
      "hallway is blocked by huge stones. It seems the "+
      "walls have caved in here. The only way out is to the east, "+
   ...
   add_exit(CPASS(citadel/x4),"east",0,-1);
}

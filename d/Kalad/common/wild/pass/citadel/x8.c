...
{
   ::create_room();
   set_short("dwarven Citadel. A hallway continues to the southwest and north");
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "The hallway continues towards southwest and north, hiding "+
   ...
   add_exit(CPASS(citadel/x7),"southwest","@@down",-1);
   add_exit(CPASS(citadel/x9),"north","@@up",-1);
}

...
create_room()
{
   ...
   set_long("You are inside an ancient citadel, long abandoned "+
      ...
      "This larger room has a peculiar opening in the roof, but "+
      "else from that the only interesting is the two exits; one "+
      "going east and another southeast.\n");

   add_item(({"shaft","opening"}),"It is just a plain shaft "+
      "leading up to somewhere. You think it might have once been "+
      "used for easy transport of garbage, but you are not sure.\n");
   ...
   add_exit(CPASS(citadel/level1/a4),"east",0,-1);
   add_exit(CPASS(citadel/level1/a2),"southeast",0,-1);

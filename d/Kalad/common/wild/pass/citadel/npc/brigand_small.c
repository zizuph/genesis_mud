 ...
 * September 1996
 * 
 * A small brigand placed in the citadel
 *
*/
...
create_monster()
{
   ...
   set_short("brigand");
   set_pshort("brigands");
   set_long("He is a young, dark-haired man whose job is to "+
...
arm_me()
{
   ...
   wep -> move(TO);
   command("wield all");
   MONEY_MAKE_SC(random(4))->move(TO,1);
}
void

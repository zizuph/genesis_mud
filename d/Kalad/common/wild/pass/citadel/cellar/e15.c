...
create_room()
{
   ...
   add_exit(CPASS(citadel/cellar/e14),"west",0,3,1);
   add_exit(CPASS(citadel/cellar/death2),"north","@@walk",3,1);
   add_exit(CPASS(citadel/cellar/death4),"south","@@walk",3,1);
   add_exit(CPASS(citadel/cellar/e16),"east","@@walk",3,1);
}
...
tracking()
{
   ...
   switch (dagger->query_prop("_korat_is_kabal_dagger")) 
   {
      case 0: return "A creepy silence seems to enclose you.";
      break;
      case -1:
         return "The pull in the dagger seems to waver between a path "+
         "leading to the north and another leading south.";
      break;
      case 2:
         return "The dagger seems to pull you towards a path "+
      ...
      break;
      case 3:
         return "The dagger seems to pull you eastwards.";
      break;
      default:
         return "The dagger seems to pull you westwards.";
      break;
   }
}

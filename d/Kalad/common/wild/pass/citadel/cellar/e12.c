...
create_room()
{
   ...
   add_exit(CPASS(citadel/cellar/e11),"northwest",0,3,1);
   add_exit(CPASS(citadel/cellar/death1),"northeast","@@walk",3,1);
   add_exit(CPASS(citadel/cellar/death6),"southwest","@@walk",3,1);
   add_exit(CPASS(citadel/cellar/e14),"southeast","@@walk",3,1);
}
...
tracking()
{
   ...
   switch (dagger->query_prop("_korat_is_kabal_dagger")) 
   {
      ...
      case -1:
         ...
         "leading to the northeast and another leading southwest.";
      break;
      case 1:
      ...
      break;
      default:
         return "The dagger seems to pull you towards the southeast.";
      break;
   }
}

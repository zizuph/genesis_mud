...
/* by korat 
 * 
 * The entrance for dwarven-led teams to underhome 
*/
...
create_room()
{
    ...
    set_long("You find yourself in the narrow end of this cave, "+
      "just behind the boulders you managed to pass through. "+
      "This part of the dark and cold cave seems to be spared "+
      "from being used as refugee for the spiders, and looks quite "+
      "empty. The only interesting things to study is the walls, "+
      "since they seem to glitter in the light you carry.\n");
    add_item(({"wall","walls"}),
      ...
      "walls. @@dwarf_skill@@\n");
    add_item(({"sharp edges", "edges"}),"The edges look ... sharp?\n");
    ...
    add_exit(CPASS(citadel/cellar/e5),"up",0,3,1);
}
...
dwarf_skill()
{
    ...
    /* dwarves manages to see more than others */
    return
    "The rock is made of granite; you know that is a "+
    ...
    "usual. It triggers your dwarven imagination.";
}
...
quartz()
{
	...
	"Only a dwarf could figure it out - and who would want to be "+
	"a dwarf!?!.\n";
    ...
    "to have crystalized itself. Marvellous! The beauty of the stones "+
    "makes you think back to your childhood.\n";
}
string
crystal()
{
    ...
    "runes seems to be written inside it! Magic!! And you know "+
    "that only the most skilled of your kind would be able to "+
    "do this workmansship with such skill!\n";
}
...
touch(string what)
{
    ...
    tell_room(TO,"The wall suddenly starts to sparkle faintly!\n");

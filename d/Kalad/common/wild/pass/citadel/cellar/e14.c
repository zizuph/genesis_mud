...
create_room()
{
   ...
   add_exit(CPASS(citadel/cellar/e12),"northwest",0,3,1);
   add_exit(CPASS(citadel/cellar/death5),"southeast","@@walk",3,1);
   add_exit(CPASS(citadel/cellar/e15),"east","@@walk",3,1);
}
...
tracking()
{
   ...
   switch (dagger->query_prop("_korat_is_kabal_dagger")) 
   {
      ...
      break;
      case -1:
         return "The pull in the dagger seems to waver towards "+
         "a path leading southeast inbetween two large boulders.";
      break;
      case 5:
      ...
      case 1:
      case 6:
         return "The dagger seems to pull you northwest.";
      break;
      default:
         return "The dagger seems to pull you towards the east.";
      break;
   }
}

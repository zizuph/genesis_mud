...
create_room()
{
   ...
   set_long("Large boulders and stones litter this cavern, making "+
   ...
   add_exit(CPASS(citadel/cellar/e4),"east","@@walk",3,1);
   add_exit(CPASS(citadel/cellar/e6),"down","@@down",3,1);
     ...
     case 0 .. 35:
      ...
      default:
      {
          return "You notice some footsteps in the dust leading "+
            "towards the east and down heading west inbetween "+
            "large boulders.";
          break;
      }
   }

...
create_room()
{
   ...
   set_long("You are within a widening valley.\n"+
      ...
      "narrow passages in the northwest and south the rest of the valley "+
      "lies.\n");
   ...
   add_exit("/d/Kalad/common/wild/pass/w28", "northwest",0,2);
   add_exit("/d/Kalad/common/wild/pass/w26", "south",0,2);
}

...
{
   if(poison_used)
      return "A thick shaft of wood whose tip has been hardened in a fire, "+
   "providing a crude, and surprisingly effective weapon.\n";
   else
      return "A thick shaft of wood whose tip has been hardened in a fire, "+
   "providing a crude, and surprisingly effective weapon. A thin sheen "+
   "of liquid is visible on the spear head.\n";
}
public varargs int

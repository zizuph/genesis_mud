 ...
 * Purpose    : A magical sword gained through a quest from the Deep Dragon
 * Located    : The Deep Dragon
 * Created By : Antharanos  ??.??.??
 * Modified By:
 * 2022-02-06: Ckrik
 *    This sword was made into a spell enhancer of power 45, life, fire and air.
 */ 
...
int uses=1;
/* The sword blessed by the Sun Goddess, Solara */
/* by Antharanos */
create_weapon()
{
    ::create_weapon();
    ...
    add_adj("snow-white");
    set_pname("swords");
    set_short("pure snow-white sword");
    set_pshort("pure snow-white swords");
    set_long("@@my_long@@");
    set_hit(45);
    set_pen(45);
    ...
    set_spellpower_elements(({
        SS_ELEMENT_LIFE, SS_ELEMENT_FIRE, SS_ELEMENT_AIR
    }));
    set_hands(W_BOTH);
    set_wt(W_SWORD);

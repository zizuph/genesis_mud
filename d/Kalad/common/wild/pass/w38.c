/* 
 * /d/Kalad/common/wild/pass/w38.c
...
create_room()
{
   ...
   add_exit("/d/Kalad/common/wild/pass/w37", "south",0,2);
   add_exit("/d/Kalad/common/wild/pass/w39", "northeast",0,2);
}
public string
search_here(object me, string arg)
{
   if (arg != "here")
      return "";
   clone_object("/d/Kalad/common/wild/pass/herbs/treemushroom")->move(TP);

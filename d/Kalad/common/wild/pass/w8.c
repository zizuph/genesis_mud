...
create_room()
{
   ...
   set_long("You are travelling along the Caravan Route.\n"+
      "The way west eventually leads towards the large city of Kabal. "+
   ...
   add_exit("/d/Kalad/common/wild/pass/w7", "west",0,2);
   add_exit("/d/Kalad/common/wild/pass/w9", "east",0,2);
   reset_room();
}
void
reset_room()

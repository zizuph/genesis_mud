/* 
 * /d/Kalad/common/wild/pass/giantpass/rooms/w26.c
...
create_room()
{
   ::create_room();
   set_short("Valley");
   set_long("You are within the confines of a valley.\n"+
      "The valley walls seem farther apart here than further to the "
      + "southwest. Spreading out before you is the vista of a forest of "
      + "redwood trees, boxed in on the sides by the sheer cliff walls of "
      + "the Hespyre mountains. Through narrow passages in the north and "
      + "southwest the rest of the valley lies.\n");
   ...
   "canopy"}),
      "A ceiling of green is all you can see, with occasional bits of the "+ "sky also visible.\n");
   ...
   add_exit(RDIR + "w27", "north",0,2);
   add_exit("/d/Kalad/common/wild/pass/w25", "southwest",0,2);

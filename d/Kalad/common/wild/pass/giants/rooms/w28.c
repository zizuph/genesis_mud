/* 
 * /d/Kalad/common/wild/pass/giantpass/rooms/w28.c
...
create_room()
{
   ...
   set_long("You are within a widening valley.\n"
      + "The valley walls are much wider here than farther to the "
      + "southeast. Spreading out before you is the vista of a forest of "
      + "redwood trees, boxed in on the sides by the sheer cliff walls of "
      + "the Hespyre mountains. Through wide passages in the north and "
      + "southeast the rest of the valley lies.\n");
   ...
   add_exit(RDIR + "w29", "north","@@query_move",2);
   add_exit(RDIR + "w27", "southeast",0,2);

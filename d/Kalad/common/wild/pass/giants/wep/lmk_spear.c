...
*   /d/Kalad/common/wild/pass/giantpass/wep/lmk_spear.c
 ...
 * 
 * Cotillion - 2007-10-02
 * Fixed cloning of poison, uid problems. 
 */ 
...
{
   if(poison_used)
      return "A sturdy wooden shaft, with an extremely sharp steel head "
      + "at its tip.\n";
   else
      return "A sturdy wooden shaft, with an extremely sharp steel head "
      + "at its tip. A thin sheen of liquid is visible on the spear "
      + "head.\n";
}
...
did_hit(int aid, string hdesc, int phurt, object enemy, int dt, int phit)
{
    object poison;
    int res;
    res = ::did_hit(aid, hdesc, phurt, enemy, dt, phit);

...
*
*  /d/Kalad/common/farmland/camps/arm/goblin_gloves.c
*
*  This is a pair of low-level gloves used by the goblins in
...
create_armour()
{
    ...
    set_short("pair of " + Adj1+ " "+ Adj2 +" gloves");
    set_long("A very poorly crafted pair of " +Adj1 + " " + Adj2
      + " gloves. This piece of armour is worn on the hands, but"
      + " it seems to offer very little protection.\n");
    set_default_armour(12, A_HANDS, ({ 3, -2, -1 }), 0);
    add_prop(OBJ_I_VALUE,F_VALUE_ARMOUR(12) + random(50));
    add_prop(OBJ_I_WEIGHT,F_WEIGHT_DEFAULT_ARMOUR(12, A_HANDS) 
            + random(20));

...
*
*  /d/Kalad/common/farmland/camps/arm/goblin_bracers.c
*
*  This is a pair of low-level bracers used by the goblins 
...
create_armour()
{
    ...
    set_short("a pair of " + Adj1+ " "+ Adj2 +" bracers");
    set_long("A very poorly crafted pair of " +Adj1 + " " + Adj2
      + " bracers. This piece of armour is worn on the arms, but"
      + " they seems to offer very little protection.\n");
    set_default_armour(12, A_ARMS, ({ 3, -2, -1 }), 0);

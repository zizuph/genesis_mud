...
*
*  /d/Kalad/common/farmland/camps/arm/goblin_breastplate.c
*
*  This is a low-level breastplate used by the goblins in
...
create_armour()
{
    ...
    set_short( Adj1+ " "+ Adj2 +" breastplate");
    set_long("A very poorly crafted " +Adj1 + " " + Adj2 + " breastplate." 

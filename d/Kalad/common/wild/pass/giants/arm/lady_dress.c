...
create_armour()
{
    ...
    set_long("The dress is made of white silk and satin, and feels very "
        + "smooth to the touch. It is covered with glittering little "
        + "white scales, that seem to made of mother-of-pearl. It makes "
        + "the whole dress glow with a strange light.\n");
    set_ac(2);
    set_at(A_ROBE);

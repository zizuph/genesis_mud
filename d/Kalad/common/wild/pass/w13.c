/* 
 * /d/Kalad/common/wild/pass/w13.c
 * Purpose    : Road
...
create_room()
{
   ...
   set_long("You are travelling along the Caravan Route.\n"+
      "The way west heads through a narrow valley and eventually towards the famed city of Kabal. "+
      ...
      "continues eastward, leading out of the Hespyre mountains.\n");
   ...
   add_exit("/d/Kalad/common/wild/pass/w12", "west",0,2);
   add_exit("/d/Kalad/common/wild/pass/w45", "north",0,2);
   add_exit("/d/Kalad/common/wild/pass/w14", "east",0,2);
}

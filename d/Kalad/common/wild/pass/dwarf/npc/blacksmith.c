...
create_monster()
{
   ...
   set_long("This is the blacksmith, a craftsman in forging and "+
      "mending weapons. During these dark times, he works almost "+
      "all day and night to provide the deep dwarves with their "+
      "axes, swords and armours.\n");
   ...
   add_act("emote drops the halfmade sword into the water-basin. The room "+
      "fills with hot steam as it hits the water with a sizzling sound.");
   add_act("emote gets an axe from the basin and puts it into the furnace.");
   ...
   add_speak("I might have time to sharpen or wax your weapons too.\n");

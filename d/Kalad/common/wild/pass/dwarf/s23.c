...
create_room()
{
   ...
   set_long("From here you can see the edges of a large ruin "+
      "southwestwards, while the littered road continues "+
      "northeast, northwest and south. To the southeast another ruin "+
   ...
   add_exit(CPASS(dwarf/s26),"south");
   add_exit(CPASS(dwarf/s21),"northeast");
   add_exit(CPASS(dwarf/s24),"northwest");

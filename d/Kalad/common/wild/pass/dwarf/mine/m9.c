...
create_room()
{
   ...
   set_long("This excavation, made in the hard rock by hundreds "+
       ...
       "You can walk to the northwest, southwest and up a wooden ladder.\n");
   add_item("ladder","Its a normal wooden ladder.\n");
   add_item(({"rock","minerals","stones","ore","coal"}),
       "In the walls here you can see @@coal@@.\n");
   add_exit(CPASS(dwarf/mine/m12),"up",0,3);
   add_exit(CPASS(dwarf/mine/m6),"northwest",0,3);
   add_exit(CPASS(dwarf/mine/m10),"southwest",0,3);

...
create_room()
{
   ...
   set_long("You are standing outside a mineshaft where "+
       "hundreds of dwarves has been excavating for the purpose "+
       "of extracting mineral substances as "+
       "ore, coal and even precious stones. "+
       "You can enter it down a wooden ladder or go back south "+
       "towards some other caves.\n");
   add_item("ladder","Its a normal wooden ladder.\n");
   add_item(({"rock","minerals","stones","ore","coal"}),
       "In the walls here you can see @@coal@@.\n");
   add_exit(CPASS(dwarf/houses/h3),"south");
   add_exit(CPASS(dwarf/mine/m13),"down",0,3);

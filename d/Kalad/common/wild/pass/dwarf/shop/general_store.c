...
create_room() 
{
set_short("The store room in Underhome's General shop");
   set_long("The store room in Underhome's General shop");

add_exit(CPASS(dwarf/shop/general_shop),"south",0,-1,-1);

...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s35),"west",0,4);
   add_exit(CPASS(desert/salt/s43),"north",0,4);
   add_exit(CPASS(desert/salt/s33),"east",0,4);
   add_exit(CPASS(desert/salt/s30),"south",0,4);
}

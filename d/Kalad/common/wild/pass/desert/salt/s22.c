...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s23),"west",0,4);
   add_exit(CPASS(desert/salt/s27),"north",0,4);
   add_exit(CPASS(desert/salt/s21),"east",0,4);
   add_exit(CPASS(desert/salt/s12),"south",0,4);
}

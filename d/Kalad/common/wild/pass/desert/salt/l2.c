...
create_room()
{
   ...
   set_long("The echo of water dripping from far off reaches your ears from "+
      ...
      "are travelling along continues to the west and east, where it "+
      "ventures into inky darkness. Stalagmites and stalactites abound in "+
      "this passageway.\n");
   ...
   add_item(({"stalagmites","stalactites","stalagmite","stalactite"}),
      ...
      "your movement.\n");
   add_exit(CPASS(desert/salt/l1),"west","@@hurt",1,2);
   add_exit(CPASS(desert/salt/l3),"east","@@hurt",1,2);
}
hurt()
{

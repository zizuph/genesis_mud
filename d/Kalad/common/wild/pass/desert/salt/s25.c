...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s26),"east",0,4);
   add_exit(CPASS(desert/salt/s24),"south",0,4);
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"A snake suddenly burrows out of the salt crystals before you.\n");
   }
}

...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s10),"west",0,4);
   add_exit(CPASS(desert/salt/s12),"north",0,4);
   add_exit(CPASS(desert/salt/s8),"east",0,4);
   add_exit(CPASS(desert/salt/s1),"south",0,4);
}

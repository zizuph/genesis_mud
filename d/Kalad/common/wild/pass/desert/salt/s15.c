...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s14),"west",0,4);
   add_exit(CPASS(desert/salt/s19),"north",0,4);
   add_exit(CPASS(desert/salt/s16),"east",0,4);
   add_exit(CPASS(desert/salt/s6),"south",0,4);

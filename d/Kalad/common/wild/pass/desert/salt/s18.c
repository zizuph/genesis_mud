...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s19),"west",0,4);
   add_exit(CPASS(desert/salt/s31),"north",0,4);
   add_exit(CPASS(desert/salt/s17),"east",0,4);
   add_exit(CPASS(desert/salt/s16),"south",0,4);
}

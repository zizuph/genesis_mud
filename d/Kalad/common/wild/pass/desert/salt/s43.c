...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s42),"west",0,4);
   add_exit(CPASS(desert/salt/s45),"north",0,4);
   add_exit(CPASS(desert/salt/s44),"east",0,4);
   add_exit(CPASS(desert/salt/s34),"south",0,4);
}

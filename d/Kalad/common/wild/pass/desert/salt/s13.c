...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s12),"west",0,4);
   add_exit(CPASS(desert/salt/s21),"north",0,4);
   add_exit(CPASS(desert/salt/s14),"east",0,4);
   add_exit(CPASS(desert/salt/s8),"south",0,4);
}

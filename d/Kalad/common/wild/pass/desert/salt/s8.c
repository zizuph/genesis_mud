...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s9),"west",0,4);
   add_exit(CPASS(desert/salt/s13),"north",0,4);
   add_exit(CPASS(desert/salt/s7),"east",0,4);
   add_exit(CPASS(desert/salt/s2),"south",0,4);
}

...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s39),"west",0,4);
   add_exit(CPASS(desert/salt/s48),"north",0,4);
   add_exit(CPASS(desert/salt/s41),"east",0,4);
   add_exit(CPASS(desert/salt/s37),"south",0,4);

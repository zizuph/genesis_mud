...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s36),"west",0,4);
   add_exit(CPASS(desert/salt/s42),"north",0,4);
   add_exit(CPASS(desert/salt/s34),"east",0,4);
   add_exit(CPASS(desert/salt/s29),"south",0,4);

...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s26),"west",0,4);
   add_exit(CPASS(desert/salt/s37),"north",0,4);
   add_exit(CPASS(desert/salt/s28),"east",0,4);
   add_exit(CPASS(desert/salt/s22),"south",0,4);

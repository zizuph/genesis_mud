...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s8),"west",0,4);
   add_exit(CPASS(desert/salt/s14),"north",0,4);
   add_exit(CPASS(desert/salt/s6),"east",0,4);
   add_exit(CPASS(desert/salt/s3),"south",0,4);

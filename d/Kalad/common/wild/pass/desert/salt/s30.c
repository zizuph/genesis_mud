...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s29),"west",0,4);
   add_exit(CPASS(desert/salt/s34),"north",0,4);
   add_exit(CPASS(desert/salt/s31),"east",0,4);
   add_exit(CPASS(desert/salt/s19),"south",0,4);
}

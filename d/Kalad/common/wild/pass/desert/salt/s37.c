...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s38),"west",0,4);
   add_exit(CPASS(desert/salt/s40),"north",0,4);
   add_exit(CPASS(desert/salt/s36),"east",0,4);
   add_exit(CPASS(desert/salt/s27),"south",0,4);
}

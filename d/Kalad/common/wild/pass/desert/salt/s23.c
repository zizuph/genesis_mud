...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s24),"west",0,4);
   add_exit(CPASS(desert/salt/s26),"north",0,4);
   add_exit(CPASS(desert/salt/s22),"east",0,4);
   add_exit(CPASS(desert/salt/s11),"south",0,4);

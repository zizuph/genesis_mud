...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s41),"west",0,4);
   add_exit(CPASS(desert/salt/s46),"north",0,4);
   add_exit(CPASS(desert/salt/s43),"east",0,4);
   add_exit(CPASS(desert/salt/s35),"south",0,4);
}

...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s13),"west",0,4);
   add_exit(CPASS(desert/salt/s20),"north",0,4);
   add_exit(CPASS(desert/salt/s15),"east",0,4);
   add_exit(CPASS(desert/salt/s7),"south",0,4);
}

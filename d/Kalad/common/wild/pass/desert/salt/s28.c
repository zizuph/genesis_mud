...
create_room()
{
   ...
   add_exit(CPASS(desert/salt/s27),"west",0,4);
   add_exit(CPASS(desert/salt/s36),"north",0,4);
   add_exit(CPASS(desert/salt/s29),"east",0,4);
   add_exit(CPASS(desert/salt/s21),"south",0,4);
}

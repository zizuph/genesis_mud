...
create_room()
{
   ...
   add_exit(CPASS(desert/d3),"northwest","@@msg",3);
   add_exit(CPASS(desert/d5),"southeast",0,3);
}
msg()
{
   write("The heat seams to lessen in its oppressiveness the "+
      "further northwest you travel.\n");
   return 0;
}

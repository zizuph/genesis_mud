...
create_room()
{
   ...
   set_long("The Great Kalad Waste, a desert of immense proportions "+
      ...
      "A series of mountains, known as the Desertrise, lie far to the "+
      "northeast.\n"+
   ...
   add_item(({"mountains","mountain","desertrise"}),"A low range of "+
      "mountains that rises in the center of the Great Kalad Waste.\n");
   add_exit(CPASS(desert/d26),"northwest",0,3);
   add_exit(CPASS(desert/d28),"southeast",0,3);
   set_alarm(1.0,0.0,"msg");
}
msg()
{
   tell_room(TO,"A warm wind from the east softly caresses your cheek.\n");
   return 1;
}

...
create_room()
{
   ...
   set_long("Towering in great sloping mounds around you are the "+
      ...
      "The nearest dunes lie to the northwest and to the south. "+
      "Passages among the dunes lead off to the northeast, east and "+
      "southwest. "+
   ...
   add_item(({"passages","passage"}),"Little more than depressions "+
      "among the sand dunes.\n");
   add_exit(CPASS(desert/sand/d21),"northeast",0,3);
   add_exit(CPASS(desert/sand/d26),"east",0,3);
   add_exit(CPASS(desert/sand/d29),"southwest",0,3);
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"An odd rattling sound alerts you to the presence of a rattler snake.\n");
   }
}

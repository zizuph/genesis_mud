...
create_room()
{
   ...
   set_long("All around you, in great sloping mounds are "+
      ...
      "A massive sand dune almost entirely closes off this area, for it "+
      "lies to your west, east and south. The only passages through the "+
      "dunes lies to the northwest and northeast, as the way is split by "+
      "a small dune in the north. "+
   ...
   add_item(({"massive sand dune"}),"A towering ridge of sand that "+
      "rises many dozens of feet into the air.\n");
   add_item(({"small dune"}),"A dune that only rises up to a height of "+
      "twenty feet, a small one when compared to the many others in this "+
      "area.\n");
   add_item(({"passages","passage","way"}),"Depressions among the dunes "+
      "that allow travellers to pass among them.\n");
   add_exit(CPASS(desert/sand/d26),"northwest",0,3);
   add_exit(CPASS(desert/sand/d27),"northeast",0,3);

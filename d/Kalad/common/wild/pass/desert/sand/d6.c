...
create_room()
{
   ...
   set_long("All around you, in great sloping mounds are "+
      ...
      "A way through the great mounds of sand around you lie to the northeast "+
      "and southeast where the dunes are not so high. "+
   ...
   add_item(({"way"}),"A depression among the sand dunes that might be "+
      "passable.\n");
   add_exit(CPASS(desert/sand/d3),"northeast",0,3);
   add_exit(CPASS(desert/sand/d10),"southeast",0,3);

...
create_room()
{
   ...
   set_long("Towering in great sloping mounds around you are the "+
      ...
      "A way through the sand dunes lies to the northeast and southwest. "+
   ...
   add_item(({"way"}),"Nothing more than a slight depression between "+
      "the great mounds of the sand dunes.\n");
   add_exit(CPASS(desert/d10),"northeast","@@msg",3);
   add_exit(CPASS(desert/sand/d2),"southwest",0,3);
}
msg()
{
   write("As you step back onto the Caravan Route, sand slides off your "+
      "body in great torrents.\n");
   return 0;
}

...
create_room()
{
   ...
   set_long("The Great Kalad Waste, a desert of immense proportions "+
      ...
      "The Caravan Route travels straight across the waste, heading west "+
      "and east.\n");
   ...
   add_exit(CPASS(desert/d11),"west","@@msg",3);
   add_exit(CPASS(desert/d13),"east",0,3);
}
msg()
{
   write("Sweat pours from your brow, leaving you drenched.\n");
   return 0;
}

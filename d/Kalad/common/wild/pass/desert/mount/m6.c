...
create_room()
{
   ...
   set_long("An abundance of slate-grey rocks surrounds you on all sides, "+
      ...
      "mountains, going to the north and southwest. "+
      "A moisture-poor wind seems to constantly blow through this area. "+
   ...
   add_exit(CPASS(desert/mount/m7),"north",0,4);
   add_exit(CPASS(desert/mount/m5),"southwest",0,4);
}

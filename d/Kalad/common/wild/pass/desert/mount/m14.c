...
create_room()
{
   ...
   set_long("An apparently endless sea of slate-grey rocks surrounds "+
      ...
      "northwest. A warm wind, choked with the presence of dust and some "+
   ...
   add_exit(CPASS(desert/mount/m13),"northwest",0,4);
   add_exit(CPASS(desert/mount/m15),"southeast",0,4);
}

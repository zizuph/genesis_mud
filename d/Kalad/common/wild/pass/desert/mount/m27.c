...
create_room()
{
   ...
   set_long("An apparently endless sea of slate-grey rocks surrounds "+
      ...
      "rocky waste. A rocky path travels to the west and north, taking an "+
      "unusually sharp turn here. A searing wind blows constantly here. "+
      "The relentless rays of the Kaladian sun strike you from above, lending "+
   ...
   add_exit(CPASS(desert/mount/m28),"west",0,4);
   add_exit(CPASS(desert/mount/m26),"north",0,4);
}

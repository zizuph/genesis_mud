...
create_room()
{
   ...
   set_long("An apparently endless sea of slate-grey rocks surrounds "+
      ...
      "rocky barren. A rocky path travels to the east, and back down to the "+
      "southwest. A dust-laden wind blows through the area. The fierce "+
      "rays of the Kaladian sun strike you from above, "+
   ...
   add_exit(CPASS(desert/mount/m11),"southwest",0,4);
   add_exit(CPASS(desert/mount/m13),"east",0,4);
}

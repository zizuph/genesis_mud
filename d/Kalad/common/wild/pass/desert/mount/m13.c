...
create_room()
{
   ...
   set_long("An apparently endless sea of slate-grey rocks surrounds "+
      ...
      "rocky barren. A rocky path travels to the southeast, and back down to the "+
      "west. A warm, dust-laden wind, blows throughout this area. "+
      "The fierce rays coming from the Kaladian sun strike you from above, "+
   ...
   add_exit(CPASS(desert/mount/m12),"west",0,4);
   add_exit(CPASS(desert/mount/m14),"southeast",0,4);
}

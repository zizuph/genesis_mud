...
create_room()
{
   ...
   set_long("An abundance of slate-grey rocks surrounds you on all sides, "+
      ...
      "mountains, going to the northeast and south. "+
      "A hot dry wind whips across the land here. "+
   ...
   add_exit(CPASS(desert/mount/m5),"northeast",0,4);
   add_exit(CPASS(desert/mount/m3),"south",0,4);
}

...
create_room()
{
   ...
   set_long("An apparently endless sea of slate-grey rocks surrounds "+
      ...
      "south. A constantly blowing wind seems to compliment the life-sucking "+
      "rays of the Kaladian sun, as one sends grains of sand scraping "+
      "across your exposed flesh and the other sears you with heat from "+
      "its vantage-point on high.\n");
   ...
   add_exit(CPASS(desert/mount/m24),"north",0,4);
   add_exit(CPASS(desert/mount/m26),"south",0,4);
}

...
create_room()
{
   ...
   set_long("An apparently endless sea of slate-grey rocks surrounds "+
      ...
      "rocky barren. A rocky path journeys to the northeast and to the south "+
      "where the land seems to drop in elevation. A dry, blistering wind "+
      "blows among the mountainous surroundings. The harsh rays of the "+
      "Kaladian sun strike you from above, causing you no end in misery.\n");
   ...
   add_exit(CPASS(desert/mount/m20),"northeast",0,4);
   add_exit(CPASS(desert/mount/m22),"south",0,4);
}

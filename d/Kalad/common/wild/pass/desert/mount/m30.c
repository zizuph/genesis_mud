...
create_room()
{
   ...
   set_long("An apparently endless sea of slate-grey rocks surrounds "+
      ...
      "rocky landscape. A rocky path heads to the west and northeast, while "+
      "from above the rays of the Kaladian sun beat down upon you.\n");
   ...
   add_exit(CPASS(desert/mount/m31),"west",0,4);
   add_exit(CPASS(desert/mount/m29),"northeast",0,4);
}

...
create_room()
{
   ...
   set_long("You are within the camp of the Bedellin nomads, the "+
      ...
      "Just to the west is a small tent, while directly to the north is a "+
      "much larger and more impressive tent. "+
   ...
   add_item(({"small tent"}),"A tent that looks suited for a small Bedellin "+
      "family.\n");
   add_item(({"much larger tent","more impressive tent","larger tent","impressive tent"}),
      "Judging by its size and central location it would seem to be the "+
      "abode of the Bedellin sheik.\n");
   add_exit(CPASS(desert/camp/c33),"west",0,-1);
   add_exit(CPASS(desert/camp/c31),"east",0,2);
   add_exit(CPASS(desert/camp/c37),"south",0,2);
}

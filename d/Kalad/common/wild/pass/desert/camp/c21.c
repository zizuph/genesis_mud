...
create_room()
{
   ...
   set_long("You are within the camp of the Bedellin nomads, the "+
      ...
      "Rising to the east, in the center of the Bedellin camp, is a large "+
      "tent, one of the largest you've ever seen. "+
   ...
   add_item(({"large tent"}),"A massive canvas arrangement, judging by its "+
      "size and central location, you conclude that it must belong to "+
      "the sheik of the Bedellin.\n");
   add_exit(CPASS(desert/camp/c22),"west",0,2);
   add_exit(CPASS(desert/camp/c24),"south",0,2);
}

...
create_room()
{
   ...
   set_long("You are standing within the Bedellin nomads' camp. The "+
      ...
      "East from here lies a small tent, while to the south is a massive "+
      "tent. "+
   ...
   add_item(({"small tent"}),"A relatively small-sized tent, probably "+
      "the dwelling of a Bedellin family.\n");
   add_item(({"massive tent"}),"An extremely large tent, much larger "+
      "than any other and is located in the center of the camp.\n");
   add_exit(CPASS(desert/camp/c13),"west",0,2);
   add_exit(CPASS(desert/camp/c7),"north",0,2);
   add_exit(CPASS(desert/camp/c15),"east",0,-1);
}

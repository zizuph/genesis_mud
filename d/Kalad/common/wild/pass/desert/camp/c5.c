...
create_room()
{
   ...
   set_short("Entrance to the Bedellin camp");
   set_long("You have entered the camp of the Bedellin nomads, the "+
   ...
   add_exit(CPASS(desert/camp/c6),"west",0,2);
   add_exit(CPASS(desert/camp/c4),"northeast","@@msg",2);
   add_exit(CPASS(desert/camp/c16),"south",0,2);
...
msg()
{
   write("A bit of dust chokes you on your way out of the camp.\n");
   TP->command("cough");
   return 0;
}

...
create_room()
{
   ...
   add_exit(CPASS(desert/d8),"northwest",0,3);
   add_exit(CPASS(desert/d10),"southeast",0,3);
...
reset_room()
{
   ...
   if(!ob2)
      ...
      ob1 -> team_join(ob2);
      tell_room(TO,"Like a mirage from the desert, a man and a camel arrive before you.\n");
   }
}

...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g9),"west");
   add_exit(CPASS(desert/grass/g5),"northwest");
   add_exit(CPASS(desert/grass/g17),"southeast");
   add_exit(CPASS(desert/grass/g16),"south");
   add_exit(CPASS(desert/grass/g15),"southwest");
}

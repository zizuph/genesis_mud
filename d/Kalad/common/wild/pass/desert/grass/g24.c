...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g23),"west");
   add_exit(CPASS(desert/grass/g16),"northwest");
   add_exit(CPASS(desert/grass/g17),"north");
   add_exit(CPASS(desert/grass/g30),"south");
   add_exit(CPASS(desert/grass/g29),"southwest");
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"The hiss of a snake alerts you to its presence.\n");
   }
}

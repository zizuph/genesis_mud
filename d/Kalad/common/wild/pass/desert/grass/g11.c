...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g6),"northeast");
   add_exit(CPASS(desert/grass/g12),"east");
   add_exit(CPASS(desert/grass/g19),"southeast");
   add_exit(CPASS(desert/grass/g18),"south");

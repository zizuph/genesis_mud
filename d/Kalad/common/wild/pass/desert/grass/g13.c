...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free "+
      "of clouds.\n");
   add_exit(CPASS(desert/grass/g12),"west");
   add_exit(CPASS(desert/grass/g6),"northwest");
   add_exit(CPASS(desert/grass/g7),"north");
   add_exit(CPASS(desert/grass/g8),"northeast");
   add_exit(CPASS(desert/grass/g14),"east");
   add_exit(CPASS(desert/grass/g21),"southeast");
   add_exit(CPASS(desert/grass/g20),"south");
   add_exit(CPASS(desert/grass/g19),"southwest");
}

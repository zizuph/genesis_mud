...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g6),"west");
   add_exit(CPASS(desert/grass/g2),"northwest");
   add_exit(CPASS(desert/grass/g3),"north");
   add_exit(CPASS(desert/grass/g4),"northeast");
   add_exit(CPASS(desert/grass/g8),"east");
   add_exit(CPASS(desert/grass/g14),"southeast");
   add_exit(CPASS(desert/grass/g13),"south");
   add_exit(CPASS(desert/grass/g12),"southwest");
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"The piercing screech of a falcon overhead catches your attention.\n");
   }
}

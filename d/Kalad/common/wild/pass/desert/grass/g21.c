...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free "+
      "of clouds.\n");
   add_exit(CPASS(desert/grass/g20),"west");
   add_exit(CPASS(desert/grass/g13),"northwest");
   add_exit(CPASS(desert/grass/g14),"north");
   add_exit(CPASS(desert/grass/g15),"northeast");
   add_exit(CPASS(desert/grass/g22),"east");
   add_exit(CPASS(desert/grass/g28),"southeast");
   add_exit(CPASS(desert/grass/g27),"south");
   add_exit(CPASS(desert/grass/g26),"southwest");
}

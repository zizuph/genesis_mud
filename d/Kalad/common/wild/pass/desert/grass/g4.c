...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g3),"west");
   add_exit(CPASS(desert/grass/g5),"east");
   add_exit(CPASS(desert/grass/g9),"southeast");
   add_exit(CPASS(desert/grass/g8),"south");
   add_exit(CPASS(desert/grass/g7),"southwest");

...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g25),"west");
   add_exit(CPASS(desert/grass/g19),"northwest");
   add_exit(CPASS(desert/grass/g20),"north");
   add_exit(CPASS(desert/grass/g21),"northeast");
   add_exit(CPASS(desert/grass/g27),"east");
}

...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g15),"west");
   add_exit(CPASS(desert/grass/g9),"northwest");
   add_exit(CPASS(desert/grass/g10),"north");
   add_exit(CPASS(desert/grass/g17),"east");
   add_exit(CPASS(desert/grass/g24),"southeast");
   add_exit(CPASS(desert/grass/g23),"south");
   add_exit(CPASS(desert/grass/g22),"southwest");
}

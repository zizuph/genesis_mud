...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g7),"west");
   add_exit(CPASS(desert/grass/g3),"northwest");
   add_exit(CPASS(desert/grass/g4),"north");
   add_exit(CPASS(desert/grass/g5),"northeast");
   add_exit(CPASS(desert/grass/g9),"east");
   add_exit(CPASS(desert/grass/g15),"southeast");
   add_exit(CPASS(desert/grass/g14),"south");
   add_exit(CPASS(desert/grass/g13),"southwest");
}

...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g14),"west");
   add_exit(CPASS(desert/grass/g8),"northwest");
   add_exit(CPASS(desert/grass/g9),"north");
   add_exit(CPASS(desert/grass/g10),"northeast");
   add_exit(CPASS(desert/grass/g16),"east");
   add_exit(CPASS(desert/grass/g23),"southeast");
   add_exit(CPASS(desert/grass/g22),"south");
   add_exit(CPASS(desert/grass/g21),"southwest");
}

...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free "+
      "of clouds.\n");
   add_exit(CPASS(desert/grass/g4),"west");
   add_exit(CPASS(desert/grass/g1),"north");
   add_exit(CPASS(desert/grass/g10),"southeast");
   add_exit(CPASS(desert/grass/g9),"south");
   add_exit(CPASS(desert/grass/g8),"southwest");
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"A wild dog suddenly arrives in your vicinity.\n");
   }
}

...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free of "+
      "clouds.\n");
   add_exit(CPASS(desert/grass/g26),"west");
   add_exit(CPASS(desert/grass/g20),"northwest");
   add_exit(CPASS(desert/grass/g21),"north");
   add_exit(CPASS(desert/grass/g22),"northeast");
   add_exit(CPASS(desert/grass/g28),"east");
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"A wild dog arrives in your vicinity.\n");
   }
}

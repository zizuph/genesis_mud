...
create_room()
{
   ...
   add_item(({"sky"}),"Colored the deepest blue, it is completely free "+
      "of clouds.\n");
   add_exit(CPASS(desert/grass/g16),"west");
   add_exit(CPASS(desert/grass/g10),"northwest");
   add_exit(CPASS(desert/grass/g24),"south");
   add_exit(CPASS(desert/grass/g23),"southwest");
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"The screech of a falcon overhead attracts your attention.\n");
   }
}

...
create_room()
{
   ...
   add_item(({"kaladian sun","sun"}),
      ...
      "animal.\n");
   add_exit(CPASS(desert/rock/p5),"west",0,4);
   add_exit(CPASS(desert/rock/p6),"northwest",0,4);
   add_exit(CPASS(desert/rock/p29),"northeast",0,4);
   add_exit(CPASS(desert/rock/p34),"east",0,4);
   add_exit(CPASS(desert/rock/p33),"southeast",0,4);
   add_exit(CPASS(desert/rock/p27),"south",0,4);
}

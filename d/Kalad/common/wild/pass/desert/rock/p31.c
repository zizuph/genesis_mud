...
create_room()
{
   ...
   add_item(({"kaladian sun","sun"}),
      ...
      "animal.\n");
   add_exit(CPASS(desert/rock/p33),"west",0,4);
   add_exit(CPASS(desert/rock/p34),"northwest",0,4);
   add_exit(CPASS(desert/rock/p30),"north",0,4);
   add_exit(CPASS(desert/rock/p12),"northeast",0,4);
   add_exit(CPASS(desert/rock/p13),"east",0,4);
   add_exit(CPASS(desert/rock/p14),"south",0,4);
   add_exit(CPASS(desert/rock/p32),"southwest",0,4);
}

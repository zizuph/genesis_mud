...
create_room()
{
   ...
   add_item(({"desertrise mountains","mountains","mountain"}),
      ...
      "rock-strewn plains.\n");
   add_exit(CPASS(desert/rock/p7),"north",0,4);
   add_exit(CPASS(desert/rock/p28),"southeast",0,4);
   add_exit(CPASS(desert/rock/p5),"south",0,4);
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"A giant lizard appears.\n");
   }
}

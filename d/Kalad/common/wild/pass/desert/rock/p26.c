...
create_room()
{
   ...
   add_item(({"kaladian sun","sun"}),
      ...
      "animal.\n");
   add_exit(CPASS(desert/rock/p4),"northwest",0,4);
   add_exit(CPASS(desert/rock/p27),"northeast",0,4);
   add_exit(CPASS(desert/rock/p25),"southwest",0,4);
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"A giant horned lizard arrives before you.\n");
   }
}

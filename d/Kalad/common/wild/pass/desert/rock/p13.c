...
create_room()
{
   ...
   add_item(({"desertrise mountains","mountains","mountain"}),
      ...
      "rock-strewn plains.\n");
   add_exit(CPASS(desert/rock/p31),"west",0,4);
   add_exit(CPASS(desert/rock/p30),"northwest",0,4);
   add_exit(CPASS(desert/rock/p12),"north",0,4);
   add_exit(CPASS(desert/rock/p14),"southwest",0,4);

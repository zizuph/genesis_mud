...
create_room()
{
   ...
   add_item(({"desertrise mountains","mountains","mountain"}),
      ...
      "rock-strewn plains.\n");
   add_exit(CPASS(desert/rock/p30),"west",0,4);
   add_exit(CPASS(desert/rock/p11),"north",0,4);
   add_exit(CPASS(desert/rock/p13),"south",0,4);
   add_exit(CPASS(desert/rock/p31),"southwest",0,4);
}

...
create_room()
{
   ...
   set_long("You are within a field covered with innumerable rocks, "+
      ...
      "To the southeast lies part of the Desertrise mountains.\n");
   ...
   add_item(({"desertrise mountains","mountains","mountain"}),
      ...
      "rock-strewn plains.\n");
   add_exit(CPASS(desert/rock/p32),"west",0,4);
   add_exit(CPASS(desert/rock/p33),"northwest",0,4);
   add_exit(CPASS(desert/rock/p31),"north",0,4);
   add_exit(CPASS(desert/rock/p13),"northeast",0,4);
   add_exit(CPASS(desert/rock/p15),"south",0,4);
}

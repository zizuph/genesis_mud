...
create_room()
{
   ...
   add_item(({"kaladian sun","sun"}),
      ...
      "animal.\n");
   add_exit(CPASS(desert/rock/p10),"northeast",0,4);
   add_exit(CPASS(desert/rock/p30),"southeast",0,4);
   add_exit(CPASS(desert/rock/p34),"south",0,4);
   add_exit(CPASS(desert/rock/p28),"southwest",0,4);

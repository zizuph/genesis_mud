...
create_room()
{
   ...
   add_item(({"desertrise mountains","mountains","mountain"}),
      ...
      "rock-strewn plains.\n");
   add_exit(CPASS(desert/rock/p17),"north",0,4);
   add_exit(CPASS(desert/rock/p19),"southwest",0,4);
...
reset_room()
{
   if(!ob1)
      ...
      tell_room(TO,"A creature appears and disappears from behind several "+
         "rocks.\n");
...
message()
{
   tell_room(TO,"Suddenly, the creature is before you!\n");
   return 1;
}

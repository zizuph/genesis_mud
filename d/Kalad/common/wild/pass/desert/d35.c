...
create_room()
{
   ...
   set_long("The vastness of the Great Kalad Waste stretches in every "+
      ...
      "The Caravan Route bends here, heading to the northwest and east.\n");
   ...
   add_exit(CPASS(desert/d34),"northwest","@@msg",3);
   add_exit(CPASS(desert/d36),"east",0,3);
}
msg()
{
   write("The heat of the waste hits you like a furnace blast, seeming "+
      "to increase in intensity the further northwest you travel.\n");
   return 0;
}

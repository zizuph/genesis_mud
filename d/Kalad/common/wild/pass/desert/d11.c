...
create_room()
{
   ...
   set_long("The vastness of the Great Kalad Waste stretches in every "+
      ...
      "The Caravan Route travels straight across the waste, going west "+
      "and east.\n");
   ...
   add_exit(CPASS(desert/d10),"west",0,3);
   add_exit(CPASS(desert/d12),"east","@@msg",3);
}
msg()
{
   write("Rivulets of sweat pour down your face, causing you to blink your "+
      "eyes fiercely in order to see.\n");
   return 0;
}

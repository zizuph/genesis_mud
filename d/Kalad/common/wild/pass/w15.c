/* 
 * /d/Kalad/common/wild/pass/w15.c
 * Purpose    : Road
...
create_room()
{
   ...
   set_long("You are travelling along the Caravan Route.\n"+
      ...
      "The mountains seem lower towards the east, possibly indicating the "+
      "eastern side of the Hespyre range. "+
      "The Caravan Route, which winds its way past the sheer walls of the mountains, "+
      "continues southeast, leading out of the Hespyre mountains and "+
      "eventually to the great Kalad waste.\n");
   ...
   add_exit("/d/Kalad/common/wild/pass/w14", "west",0,2);
   add_exit("/d/Kalad/common/wild/pass/w16", "southeast",0,2);
}

/* 
 * /d/Kalad/common/wild/pass/w26.c
...
create_room()
{
   ...
   set_long("You are within the confines of a valley.\n"+
      "The valley walls seem farther apart here than further to the southwest. "+
      ...
      "narrow passages in the north and southwest the rest of the valley "+
      "lies.\n");
   ...
   add_exit("/d/Kalad/common/wild/pass/w27", "north",0,2);

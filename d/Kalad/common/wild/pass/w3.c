...
create_room()
{
   ...
   add_exit("/d/Kalad/common/wild/pass/w2", "southwest",0,2);
   add_exit("/d/Kalad/common/wild/pass/w4", "northeast",0,2);
}
void
init()
{
   ::init();
   write("A light breeze blows past you.\n");
}

...
land(object ob)
{
   ...
   tell_room("/d/Kalad/common/wild/pass/uc/d5","You hear a horrible noise from above, "+
      "suddenly you see ");
   
   if (living(ob))
      {
      tell_room("/d/Kalad/common/wild/pass/uc/d5",QTNAME(TP) + " slam into the ground.\n");
      
      ob->move("/d/Kalad/common/wild/pass/uc/d5");
      ...
      {
      tell_room("/d/Kalad/common/wild/pass/uc/d5", LANG_ASHORT(ob) + " fall down.\n");
      ob->move("/d/Kalad/common/wild/pass/uc/d5");
   }
}

...
create_room()
{
   ...
   set_long("At the bottom of the chasm.\n"+
      ...
      "that rise far above you, while others are strewn about, as if "+
      "they were a child's playthings. The surrounding rock is as it was "+
   ...
   add_exit(CPASS(uc/d1),"west","@@msg",2,1);
   add_exit(CPASS(uc/d3),"east","@@msg",2,1);
}
void
init()
{

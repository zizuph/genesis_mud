...
create_room()
{
   ...
   set_long("At the bottom of the chasm.\n"+
      ...
      "that stretch far over you, while the majority of them are strewn about, "+
      "as though a terrible wind had blown through here. The surrounding "+
      "rock is as it was higher up, composed of some unusually dark material. "+
      "Escape from this place seems nigh unto impossible, for the walls of "+
      "the chasm are perfectly vertical.\n"+
      "The bottom of the chasm continues to the west and east.\n");
   ...
   add_exit(CPASS(uc/d3),"west","@@msg",2,1);
   add_exit(CPASS(uc/d5),"east","@@msg",2,1);
}
void
init()
{

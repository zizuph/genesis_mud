...
create_room()
{
   ...
   set_long("At the edge of a chasm.\n"+
      "Countless and near limitless stone surrounds you from every angle, "+
      ...
      "you are in continues to the northeast.\n");
   add_item(({"edge"}),
   ...
   add_exit(CPASS(uc/u16),"northeast",0,2,1);
   add_exit(CPASS(uc/u30),"south","@@check",2,1);
}
check()
{

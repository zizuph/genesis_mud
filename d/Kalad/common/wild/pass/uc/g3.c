...
create_room()
{
   ...
   set_long("A cramped passage.\n"+
      ...
      "passage you are travelling within. The gloomy fact that just the "+
      ...
      "heads to the west and southeast.\n");
   ...
   add_exit(CPASS(uc/g2),"west",0,2,1);
   add_exit(CPASS(uc/g5),"southeast",0,2,1);
}
void
init()
{

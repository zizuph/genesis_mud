...
create_room()
{
   ...
   set_long("This dirt pathway you are travelling on winds its way "+
      ...
      "The path travels northwestward, deeper into the foothills, and "+
   ...
   add_exit(CPASS(goblin/g8),"northwest",0,2,1);
   add_exit(CPASS(goblin/g6),"south","@@check_aware",2,1);
...
check_aware()
{
   ...
   write("You continue on your path out of the foothills.\n");
   return 0;
}
reset_room()
{

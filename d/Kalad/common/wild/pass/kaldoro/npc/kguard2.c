/* 
 * /d/Kalad/common/wild/pass/kaldoro/npc/kguard2.c
 * Purpose    : A typical Kaldoro guard; female.
 * Located    : ../rooms/<not determined yet>
...
arm_me()
{
   ...
   obj = clone_object(KALDORO(arm/gshield.c));
   obj -> move(this_object());

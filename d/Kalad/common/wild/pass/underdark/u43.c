/*
 * /d/Kalad/common/wild/pass/underdark/u43.c
 * Purpose    : Potential land of the beasties
 * Located    : South Dark Domain
...
create_dark_dom()
{
    ...
    add_exit(DARK(u42), "northwest");
    add_exit(DARK(u44), "east");

/* 
 * /d/Kalad/common/wild/pass/npc/gazelle_m.c
 * Purpose    : A dear like creature
...
create_monster()
{
   ...
   set_long("A creature vaguely resembling a small deer. Its brownish-white "+
      ...
      "grassland. A large pair of horns sprout from its head.\n");
   set_stats(({50,75,50,30,30,50}));
   ...
   set_cact_time(6);
   add_cact("emote makes a loud blurting sound.");
   ...
   set_attack_unarmed(A_HORNS, 25, 35, W_BLUDGEON, 20, "large horns");
   set_hitloc_unarmed(H_HEAD, ({ 20, 15, 20 }), 20, "head");
   set_hitloc_unarmed(H_BODY, ({ 15, 20, 25 }), 60, "body");

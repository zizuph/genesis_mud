/* 
 * /d/Kalad/common/wild/pass/npc/salt_mar.c
 * Purpose    : A salt marauder
...
#define H_RARM 3
#define H_LEGS 4
/* The salt marauder, infamous dweller of the salt flat in the Kalad
desert. */
/* by Antharanos */
create_monster()
{
   ...
   set_long("A vaguely humanoid-shaped mass of wrinkled flesh. Its "+
      "oddly colored skin tone matches the hue and texture of the surrounding "+
      "salt flat, making it extremely well-camouflaged. Its grotesque "+
   ...
   set_attack_unarmed(A_L_HAND, 25, 25, W_BLUDGEON, 45, "wrinkled left fist");
   set_attack_unarmed(A_R_HAND, 25, 25, W_BLUDGEON, 45, "wrinkled right fist");
...
cr_did_hit(int aid, string hdesc, int phurt, object enemy, int dt, int phit)
{
    if(aid == A_MOUTH)
    {
        tell_object(enemy,"The salt marauder's suckered mouth rips into you!\n");
        {
            enemy -> add_mana(-30);

...
create_room()
{
   ...
   set_long("You are travelling along the Caravan Route.\n"+
      ...
      "surroundings are small foothills which slowly rise to the towering "+
   ...
   add_item(({"terrain","small foothills","foothills","foothill"}),"The "+
   ...
   add_exit("/d/Kalad/common/wild/pass/w1", "southwest",0,2);
   add_exit("/d/Kalad/common/wild/pass/w3", "northeast",0,2);
}
void
init()
{
   ::init();
   write("A gentle breeze blows past you.\n");
}

/* 
 * /d/Kalad/common/wild/pass/w43.c
 * Purpose    : Valley setting
 * Located    : South of Caravan Route
 * Created By : Antharanos Hm...
 * Modified By: 
 */ 
...
create_room()
{
   ...
   set_short("Valley");
   set_long("A beautiful vista spreads out before you. What was clearly "+
      "visible from the north is the wondrous "+
   ...
   add_exit("/d/Kalad/common/wild/pass/w42", "north",0,2);
   add_exit("/d/Kalad/common/wild/pass/w44", "south",0,2);

/* 
 * /d/Kalad/common/wild/pass/w29.c
...
create_room()
{
   ...
   set_long("You are within a wide open valley.\n"+
      "The valley walls are very far apart here, more so than in the rest of the valley to the south. "+
      "Here the valley makes a sharp turn westward, with the area to the north "+
      "being the sheer side of a mountain. "+
      ...
      "wide passages in the west and south the rest of the valley "+
      "lies.\n");
   ...
   add_exit("/d/Kalad/common/wild/pass/w30", "west","@@query_move",2);
   add_exit("/d/Kalad/common/wild/pass/w28", "south",0,2);

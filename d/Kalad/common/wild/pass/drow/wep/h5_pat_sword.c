...
create_weapon()
{
   ...
   add_prop(MAGIC_AM_ID_INFO,({"This sword has been enchanted\n", 5,
         ...
         "This enchanted sword requires swift actions and training by " +
         "journeymen before it can be mastered. Its drow creator " +
         "enchanted it to refuse any user that does not follow Lolths " +
         "evil ways.\nCommanding it servantyr will let you use its " +
         "magic to bring you to safety.\n", 51}));

...
{
   if(poison_used)
      return "A fine piece of drow craftsmanship. The large halberd, "+
   "fashioned from pure adamantine, is truly a work of art.\n";
   else
      return "A fine piece of drow craftsmanship. The large halberd, "+
   "fashioned from pure adamantine, is truly a work of art. Upon its "+
   "blade is a thin sheen of colorless liquid.\n";
}
public varargs int

 ...
 *
 *
 * 20210722 Meton added comment with maybe new ID message.
 */
...
create_weapon()
{
   ...
   add_prop(OBJ_S_WIZINFO,
      ...
      "If a person of alignment that is less than 500 and a sword skill "+
      "of at least 40, with dex of 100 minimum wields it, they will be "+
      "able to command the weapon to (randomly) transport them "+
      "throughout the Dark Dominion.\n");
   add_prop(MAGIC_AM_ID_INFO,({"This sword has been enchanted\n", 5,
         "The enchantment on the sword has made it more powerful than "+
         "conventional weapons.\n", 25,
         "This enchanted sword, more powerful than normal ones, can only "+
         " be wielded by individuals of less than trusting personality "+
         "and trained in the art of swordplay and great agility, those "+
         "that fail will be drained of mana.\n", 51}));
                  /*
      Thinking of changing 51 to:
      This enchanted sword requires swift actions and training by journeymen before it can be mastered. Its drow creator enchanted it to  refuse any user that does not follow Lolths evil ways.
      Commanding it servantyr will let you use its magic to bring you to safety.
      */
}
mixed
wield(object what)

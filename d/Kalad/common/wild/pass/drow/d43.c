...
create_room()
{
   ...
   set_long("A great many stalagmites and stalactites fill your field "+
      ...
      "The sheer face of a cavern wall towers to the north, its top lying in "+
      "total darkness. "+
      "The street you are journeying upon curves ever so slightly here, "+
      "meandering off to the west and southeast.\n");
   ...
   add_exit(CPASS(drow/d38),"west");
   add_exit(CPASS(drow/d47),"southeast");

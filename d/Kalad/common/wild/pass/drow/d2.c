...
create_room()
{
    ...
    set_long("An immense weight of rock hangs above you in this narrow "+
      "and cramped tunnel, giving you sensations of claustrophobia. It "+
      "looks as if the passage enlarges in the east. The "+
      "featureless walls of the passage do nothing but add to the "+
      "seemingly endless expanse of rock.\n"+
      "The passage bends here, heading to the southwest in one direction, "+
      "and east in the other.\n");
    ...
    add_exit(CPASS(drow/d1), "southwest");
    add_exit(CPASS(drow/d3),"east");
    clone_object(CPASS(drow/door/c_e_gate2))->move(TO);

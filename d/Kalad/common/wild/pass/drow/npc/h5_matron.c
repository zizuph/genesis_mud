/*
 *
 * Added clone_unique on the healing wand 
 * modified by Zignur Sept 2017
 *
*/
...
arm_me()
{
    ...
    /* We will allow 10 wands modifed by Zignur 2017-09-27 */

    arm = clone_unique("/d/Kalad/common/wild/pass/drow/obj/dhwand", 10,
                       "/d/Kalad/common/wild/pass/drow/obj/dwand");
    arm -> move(TO);
    /* Make her hold the wand too modifier by Zignur 20-17-09-28 */
    command("hold wand");

/*
 * Created by Mirandus - February 8, 2022
 * A damage spell used by Saurian Shamans in Kalad
 */
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    caster_message = "You close your eyes and draw on the power within " +
          "you granted by those who have come before you.\n";
    watcher_message = QCTNAME(caster) + " closes "+ 
          caster->query_possessive()+  " eyes drawing upon the power of those "
          +"who have come before them, the strength of their ancestors.\n";
...
desc_harm_cast(object caster, object * targets)
{
    ...
    caster_message = "You raise your hands and a phantasmic warrior with "
			+"a huge trident manifests itself before"+ QTNAME(target) + 
            " thrusting towards them.\n";
            
            
    target_message = QCTNAME(caster)+ " raises his hands and a phantasmic "+
            "warrior with a huge trident manitfests itself before you. It " +
            "thrusts its trident into you.\n";

    watcher_message = QCTNAME(caster)+ " raises his hands and a phantasmic " +
            "warrior with a huge trident manifests itself, thrusting its trident " + 
            "into " + QTNAME(target) + ".\n";

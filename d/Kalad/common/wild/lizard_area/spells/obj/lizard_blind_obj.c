/*
 * /d/Kalad/common/guilds/new_thanar/spells/obj/thanar_blind_obj.c
...
inherit "/d/Genesis/specials/new/magic/spells/objs/blind_obj";
...
hook_spell_effect_started()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("The bright energy attacks your vision.\n" +
...
hook_spell_effect_ended()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("Your eyes recover from the assault.\n");
    }

/*
 *  /d/Kalad/common/farmland/f_road13
 *
...
create_std_road()
{
    set_short("A gravel road at a crossing in the farmlands");
    set_long("A gravel road at a crossing in the farmlands"
      + " far west of Kalad. You can see the city gates to the"
      + " far east, while wast farmlands stretch out to the southwest."
      + " You notice a sparse forest with what seems to be a camp"
      + " to the northeast, however there is no way to get there from this"
      + " location. The road leads east to Kalad and to a large farm"
      + " estate to the southwest. It is possible to travel to the east,"
      + " and southwest.\n\n");       
    ...
    add_exit("f_road12", "east");
    add_exit("f_road14", "southwest");

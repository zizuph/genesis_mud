/*
 *  /d/Kalad/common/farmland/camps/rooms/redfang_camp7
 *
...
{
    set_short("southeastern part of the camp");
    set_long("In the southeastern part of a Red Fang training camp."
    ...
    add_exit("redfang_camp12", "north");
    add_exit("redfang_camp8", "east");
    add_exit("redfang_camp6", "west");

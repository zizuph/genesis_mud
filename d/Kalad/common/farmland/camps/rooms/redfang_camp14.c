/*
 *  /d/Kalad/common/farmland/camps/rooms/redfang_camp14
 *
...
create_redfang_camp_room()
{
    ...
    set_long("In the northwestern corner of a Red Fang training"
      + " camp. @@get_camp_state_desc@@ The camp stretch"
      + " out to the southwest, south and to the east.\n\n");      
    ...
    add_exit("redfang_camp9", "southwest");
    add_exit("redfang_camp10", "south");
    add_exit("redfang_camp15", "east");

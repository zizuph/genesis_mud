/*
 *  /d/Kalad/common/farmland/camps/rooms/redfang_camp17
 *
...
{
    set_short("northeastern part of the camp");
    set_long("In the northeastern part of a Red Fang traning"
      + " camp. @@get_camp_state_desc@@ You notice what"
      + " appears to be some kind of meeting place to the east."
      + " The camp stretch out to the west, south and to the"
      + " east.\n\n");        

    add_redfang_camp_items();
    /* special item for this room */
    add_item( ({ "meeting place", "place"}),
        "There is some kind of meeting place to the east.\n");
    ...
    add_exit("redfang_camp16", "west");
    add_exit("redfang_camp18", "east");   
    add_exit("redfang_camp13", "south");

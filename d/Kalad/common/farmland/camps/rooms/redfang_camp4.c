/*
 *  /d/Kalad/common/farmland/camps/rooms/redfang_camp4
 *
...
{
    set_short("southwestern part of the camp");
    set_long("In the southwestern part of a Red Fang training camp."
      + " @@get_camp_state_desc@@ The camp stretch out to the north"
      + " and the east, the path south leads out to the surrounding"
      + " sparse forest.\n\n");       
    ...
    add_exit("redfang_camp9", "north");
    add_exit("redfang_camp3", "south");
    add_exit("redfang_camp5", "east");

/*
 *  /d/Kalad/common/farmland/camps/rooms/redfang_camp6
 *
...
{
    set_short("southern part of the camp");
    set_long("In the southern part of a Red Fang training camp."
      + " @@get_camp_state_desc@@ You notice a large training pit"
      + " just north of here. The camp stretch out to the north, east"
      + " and to the west.\n\n");      
    ...
    add_exit("redfang_camp11", "north");
    add_exit("redfang_camp7", "east");
    add_exit("redfang_camp5", "west");

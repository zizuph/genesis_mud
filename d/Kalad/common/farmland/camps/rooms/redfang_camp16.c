/*
 *  /d/Kalad/common/farmland/camps/rooms/redfang_camp16
 *
...
{
    set_short("northern part of the camp");
    set_long("In the northern part of a Red Fang training camp."
      + " @@get_camp_state_desc@@ The camp stretch out to the"
      + " southwest, south and to the east.\n\n");      
    ...
    add_exit("redfang_camp15", "west");
    add_exit("redfang_camp17", "east");   
    add_exit("redfang_camp12", "south");

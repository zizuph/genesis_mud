/*
 * /d/Kalad/common/farmland/camps/rooms/redfang_camp1
 *
...
{
    set_short("at a path outside the red fang camp");
    set_long("A sparse forest surrounds the area, broken crates,"
      + " barrels and refuse piles lie scattered on the ground."
      + " A narrow path has been cleared that leads further"
      + " into the camp to the west. To the southeast the path" 
      + " leads back to the farmlands west of Kalad.\n\n");       
    ...
    add_exit("redfang_camp2", "west");
    add_exit("/d/Kalad/common/farmland/f_road4", "southeast");

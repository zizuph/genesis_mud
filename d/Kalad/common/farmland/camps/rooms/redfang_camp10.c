/*
 *  /d/Kalad/common/farmland/camps/rooms/redfang_camp10
 *
...
create_redfang_camp_room()
{
    ...
    set_long("In the western part of a Red Fang training camp."
      ...
      + " pit just east of here. The camp stretch out to the"
      + " north, east, west and to the south.\n\n");      
    ...
    add_exit("redfang_camp14", "north");
    add_exit("redfang_camp5", "south");
    add_exit("redfang_camp11", "east");
    add_exit("redfang_camp9", "west");

 ...
 *  2018-03-09 Mirandus added name "dwarf" and add intro reaction.
 *  2021-07-09 Meton fixed a type from "be my well" to "be well my"
 *  2021-08-05 Meton fixed various typos
 */
#include "../defs.h"
#include <macros.h>
#include <ss_types.h>
...
{   
    ...
    set_long("A " +Adj1 + " " + Adj2 + " half-dwarven miner. This"
      + " poor half-dwarf seems to have been beaten and robbed. His" 
    ...
    add_ask( ({ "gem", "gems", "loot"}),
      ...
      + " If you help me get my revenge, I will let you keep "
...
react_intro(object tp)
{
    ...
    command("say A pleasure to meet you.");
    command("say You look like an adventurer. Perhaps you could help me "
    +"with a task I have.\n");

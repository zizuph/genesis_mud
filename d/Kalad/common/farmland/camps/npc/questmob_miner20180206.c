...
{   
    ...
    set_short( Adj1+ " "+ Adj2 +" dwarf");
    
    set_long("A " +Adj1 + " " + Adj2 + " dwarven miner. This"
      + " poor dwarf seems to have been beated and robbed. His" 
      + " face is bruised and bleeding. You get a strong feeling" 
      + " that you should <ask miner help> if you wish to aid him.\n");
...
{   
    ...
    set_alarm(8.0, 0.0, &command("say " + killedWarriors + " warriors."));
    set_alarm(9.0, 0.0, &command("say " + killedTrainers + " trainers."));
    set_alarm(10.0, 0.0, &command("say " + killedWolves + " wolves."));

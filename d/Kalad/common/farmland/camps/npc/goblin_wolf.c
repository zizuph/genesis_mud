 ...
 *
 *
 *  20210717 Meton Masked return_object so wolves always drop items
 *  and doesnt speak to people.
 */
#pragma strict_types
#include "../defs.h"
 ...
 * Description:         We mask this function so the wolves dont assist each
 *                      other.
 *                      

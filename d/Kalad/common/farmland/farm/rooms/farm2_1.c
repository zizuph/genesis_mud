/*
 *  /d/Kalad/common/farmland/farm/rooms/farm2_1
 *
...
create_std_farm()
{
    set_short("Inside the hall of House Aemilius farm estate");
    set_long("Inside the hall of House Aemilius farm estate, even though"
    ...
    add_npc(NPC_DIR + "house_guard_a",2,&->arm_me());
       
    add_exit(FARM_DIR+ "f_road11", "north");
    add_exit("farm2_2", "west");
    add_exit("farm2_3", "east");
    add_exit("farm2_4", "south");

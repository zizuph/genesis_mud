/*
 *  /d/Kalad/common/farmland/farm/rooms/farm2_4
 *
...
create_std_farm()
{
    ...
    add_npc(NPC_DIR + "house_guard_captain_a",1,&->arm_me());     
      
    add_exit("farm2_5", "west");
    add_exit("farm2_6", "east");
    add_exit("farm2_1", "north");
    add_exit("farm2_7", "south");

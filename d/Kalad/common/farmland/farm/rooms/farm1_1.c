/*
 *  /d/Kalad/common/farmland/farm/rooms/farm1_1
 *
...
create_std_farm()
{
    set_short("Inside the hall of House Paullus farm estate");
    set_long("Inside the hall of House Paullus farm estate, even though"
    ...
    add_npc(NPC_DIR + "house_guard_p",2,&->arm_me());
     
    set_alarm(0.5,0.5, "update_guards");
  
    add_exit(FARM_DIR+ "f_road6", "north");
    add_exit("farm1_2", "west");
    add_exit("farm1_3", "east");
    add_exit("farm1_4", "south");

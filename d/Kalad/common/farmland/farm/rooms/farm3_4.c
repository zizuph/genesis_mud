/*
 *  /d/Kalad/common/farmland/farm/rooms/farm3_4
 *
...
create_std_farm()
{
    ...
    add_npc(NPC_DIR + "house_guard_captain_al",1,&->arm_me());     
      
    add_exit("farm3_5", "west");
    add_exit("farm3_6", "east");
    add_exit("farm3_1", "north");
    add_exit("farm3_7", "south");

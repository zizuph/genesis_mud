/*
 *  /d/Kalad/common/farmland/f_road6
 *
...
create_std_road()
{
    ...
    set_long("A gravel road just outside a farm estate. You can see"
      ...
      + " south into the estate or north back to the main road. It"
      + " is possible to travel north and to the south.\n");       
     ...
     add_item( ({ "entrance", "door", "doors","wooden doors"}),
      ...
      + " doors. A red-gold banner hangs over each door showing that"
      + " this estate belongs to the house of Paullus.\n");  
    add_item( ({ "banner", "banners", "red-gold banner", "red-gold banners"}),
        "A red-gold banner hangs over each door, proudly displaying the"
      + " emblem of the House of Paullus.\n"); 
    add_item( ({ "emblem", "emblems"}),
        "The emblem of the House of Paullus is very skillfully"
      + " inscribed on the red-gold banners.\n");      
   
    add_exit("f_road5", "north");
    add_exit(ROOMS_DIR +"farm1_1", "south");

/*
 *  /d/Kalad/common/farmland/f_road8
 *
...
create_std_road()
{
    set_short("A gravel road in the farmlands far west of Kalad");
    set_long("A gravel road in the farmlands far west of Kalad. You can"
      + " see the city gates to the far east, while wast"
      + " farmlands stretch out to the south. You notice a"
      + " sparse forest with what seems to be a camp to the north,"
    ...
    add_exit("f_road9", "west");
    add_exit("f_road7", "east");  

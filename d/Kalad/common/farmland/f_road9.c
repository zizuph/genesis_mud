/*
 *  /d/Kalad/common/farmland/f_road9
 *
...
create_std_road()
{
    ...
    set_long("A gravel road at a crossing in the farmlands"
      ...
      + " farmlands and to the east towards Kalad. You can also"
      + " see fields and a road leading to a large farm estate to the"
      + " south. It is possible to travel to the east, west and south.\n\n");       
    ...
    add_exit("f_road12", "west");
    add_exit("f_road8", "east");
    add_exit("f_road10", "south");  

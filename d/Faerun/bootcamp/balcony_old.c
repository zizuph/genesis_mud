...
create_room()
{
    ...
    set_long("This is a large balcony overlooking the front of the building. It extends out over the entrance and allows anyone "
	    +"here to observe "
    ...
    add_exit("/d/Faerun/bootcamp/r1", "down");
}

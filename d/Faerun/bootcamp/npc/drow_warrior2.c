/*
 * Drow Warrior NPC 2/Entrance camp Underdark city
...
create_monster()
{
	...
	set_title("of the Bregan D'aerthe");
	...
	set_act_time(10);
    set_cact_time(10);
    add_act("emote looks around, taking in the surrounding area.");
    add_act("emote draws his scimitar from it's sheath and sharpens it " + 
	     "with a whetstone.");
    add_act("emote pokes in the undergrowth with his sword.");
    add_act("emote drinks from a wineskin hanging on his hip.");
   
    set_chat_time(25);
    add_chat("Why are you here?");
    add_chat("Inform the commander!");

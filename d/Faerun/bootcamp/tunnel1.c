...
create_room()
{
    ...
    add_exit("/d/Faerun/bootcamp/hidden_trail2","out");
    add_exit("/d/Faerun/bootcamp/tunnel2","north");
    add_exit("/d/Faerun/bootcamp/tunnel3","east");
    add_exit("/d/Faerun/bootcamp/tunnel4","west");
}
...
#define ADJ2        "lavender"
#define FLOWER_ID   FLOWER_NAME + "_" + ADJ1 + PROP_BASE

string
flower_long()
{
    return "The " + ADJ1 + " " + FLOWER_NAME + IS_ARE + ADJ2 + 
        " colored with trumpet shaped flowers on long stalks. Each flower " +
        "is about the length of a finger and delicate looking with fluted " +
        "edges. The stalks are flexible and covered with many flowers.\n";
}

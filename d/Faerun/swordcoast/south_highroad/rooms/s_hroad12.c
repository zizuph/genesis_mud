...
create_shr_room()
{
    ...
    set_extraline(
        "The road runs west and southeast along the coast. To the south, tall "
    ...
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad11", "west");
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad13", "southeast");
}

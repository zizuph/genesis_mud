...
create_shr_room()
{
    ...
    set_extraline(
        "The road runs west and east along the coast. A forest lies off to the "
        + "north. To the south, tall cliffs drop off into the sea."
    );
    ...
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad08", "west");
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad10", "east");
}

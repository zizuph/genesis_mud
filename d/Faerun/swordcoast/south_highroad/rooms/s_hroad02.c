...
create_shr_room()
{
    ...
    set_extraline(
        ...
        + "parts of the Sword Mountains. The road runs roughly north and "
    ...
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad01", "north");
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad03", "southeast");
}

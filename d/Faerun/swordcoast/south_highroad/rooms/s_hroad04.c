...
create_shr_room()
{
    ...
    set_extraline(
        "The road runs east and west through the valley. On either side of the "
        + "road rises a craggy peak, towering over you."
    );
    ...
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad03", "west");
    add_exit(SOUTH_HIGHROAD_ROOM + "s_hroad05", "east");
}

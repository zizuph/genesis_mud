...
create_room()
{
    ...
    set_long("The tunnel opens up before you, wide carved colums greet " +
	     "your vision in the tunnel just ahead. All the more ominous due " +
		 "to the dull glow eminating from the lichen.\n");
    
    add_item(({"ground","floor","dirt"}),
        "The ground you stand on is a combination of hard packed dirt and rock.\n");
   
    add_item(({"tunnels"}),
        "You see one tunnel opening looming in front of you.\n");
    ...
    add_exit(CAMP_DIR + "tunnel5","northwest"); 
    add_exit(CAMP_DIR + "tunnel7","southeast");	
}
...
create_room()
{
    ...
    set_short ("Inside a large underground tunnel system.\n");

    set_long("You are standing at the beginning of a large underground " +
	    "network of tunnels, they seem to both incline and decline at random " +
		"intervals.\n");
    ...
    add_exit(CAMP_DIR + "tunnel4","southwest");
	add_exit(CAMP_DIR + "tunnel13","northeast");   
}
/* 
 * Halfling Racial Guild Master Surname Object
 *
...
add_member(mixed player)
{
    ...
    send_debug_message("halflings", capitalize(player_name)
...
query_is_member(mixed player)
{
    if(!stringp(player))
    {
       if (player->query_npc())
       {
           ...
           return (player->query_guild_name_race() == GUILD_NAME);
       }
    }
...
public void
set_halfling_surname(object player, string surname)
{
    set_player_property(player, "halfling_surname", surname);
}

public string
query_halfling_surname(mixed player)
{
    return query_player_property(player, "halfling_surname");

}

public void
remove_halfling_surname(object player)
{
    set_player_property(player, "halfling_surname", 0);
}

public void
set_halfling_location(object player, string location)
{
    set_player_property(player, "halfling_location", location);
}

public string
query_halfling_location(mixed player)
{ 
    return query_player_property(player, "halfling_location");
}

public void
remove_halfling_location(object player)
{
    set_player_property(player, "halfling_location", 0);
}

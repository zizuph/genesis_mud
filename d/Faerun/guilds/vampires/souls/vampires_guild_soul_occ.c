...
{ 
    ...
    write("| ---------------------------------                         |\n");
    write("| Unfinished Tier 5 items.                                  |\n");
    write("|                                                           |\n");   
    write("|                                                           |\n");
    write("| DONE                                                      |\n");
    write("| ----                                                      |\n");
    write("| 10.04.2023:  Updates on a specific ability.               |\n");
    write("|                                                           |\n");   
    write("| 08.03.2023:  Support for Elder Vampires added.            |\n");
    write("|                                                           |\n");       
    write("| 21.01.2023:  Syntax for unlocking tiers further described |\n");
    write("|              in the helpfiles. Vampires will now always   |\n");
    write("|              age (regardless of reputation and faction    |\n");
    write("|              standing).                                   |\n");
    write("|                                                           |\n");       
    write("| 06.12.2022:  Status of creation of new vampires is added  |\n");
	write("|              to the vnation command. Bloodrate are also   |\n");
    write("|              adjusted to acommodate to the new reality.   |\n");
    write("|                                                           |\n");
...
{ 
    ...
    {          
        ...
        write("|                                                           |\n"); 
        write("|                                                           |\n"); 
        write("| On the creation of new Vampires, the Vampire Nation       |\n");
        write("| is in agreement on the following:                         |\n");
        write("| --------------------------------------------------------- |\n");

        if (VAMPIRES_MASTER->occ_active_vamp_members_check() > 3)
        {
            write("| The creation of new Vampires are currently FORBIDDEN.     |\n");
            write("|                                                           |\n");
            write("|                                                           |\n"); 
            write("|                                                           |\n");             
        }
        ...
        {
            write("| The creation of new Vampires are currently ALLOWED.       |\n");
            write("|                                                           |\n"); 
            write("|                                                           |\n"); 
            write("|                                                           |\n"); 
        }
        ...
        {               
            if (VAMPIRES_MAPPINGS->query_vampire_reputation(this_player()->query_name()) >= TIER3_1_MIN_REQ_REP)
            {
                ...
                if (VAMPIRES_MAPPINGS->query_vampire_ability_occ_5(this_player()->query_name()) == 1)
                {
                    int check1;
                    int check2;
                    ...
                    {
                        write("|  **You sense that the Elder Sanctuary is available to         |\n"); 
                        write("|    you somewhere in the lands of Faerun.                      |\n");
                        write("|                                                               |\n");    
                    }
                }
        ...
        if (VAMPIRES_MAPPINGS->query_vampire_ability_occ_4(this_player()->query_name()) > 0)        
        {
            ...
            write("| reputation requirements and standing requirements.        |\n");
            write("|                                                           |\n");
            write("| Current known ways to earn the higher ranks:              |\n");
            write("|                                                           |\n");
            write("| - Challenge a higher ranked vampire. Example: A Vampire   |\n");
            write("|   Lord that successfully wins a challenge vs an Elder will|\n");
            write("|   be elevated to Elder-rank (if qualifications are met),  |\n");
            write("|   and the Elder who lost demoted back to Vampire Lord.    |\n");
            write("|   An important premise here is that the swapping of ranks |\n");
            write("|   can only happen with ranks adjacent to eachother.       |\n");
            write("|                                                           |\n");
            write("|   Challenges can only be initiated in certain areas.      |\n");
        ...
        if (VAMPIRES_MASTER->is_vamp_elder(this_player()->query_real_name()) == 1)
        {
            ...
            write("| Vampires in the hiearchy, your role is to guide, vett and |\n");
        ...
        if (VAMPIRES_MAPPINGS->query_vampires_gauge(this_player()->query_real_name()) >= 11001)
        {
            write("|                                                           |\n"); 
            write("|                                                           |\n"); 
            write("|            L O R D   V A M P I R E ,   R O L E            |\n");
            write("|            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~            |\n"); 
            write("|                                                           |\n"); 
            write("| Aknowledged and respected throrough the Vampire ranks,    |\n"); 
            write("| Vampire Lords often lead covens, weave conspirations and  |\n"); 
            write("| propaganda among the living, and ruthlessly end the lives |\n"); 
            write("| of those that dare to tempt fate. Vampire Lords are a     |\n"); 
            write("| force to be reckogned with, and often sought by and       |\n"); 
            write("| hunted by so-called 'holy' men, warriors, paladins and    |\n"); 
            write("| other ilk that suffer from serious degrees of dogmatic    |\n"); 
            write("| views and narratives. While respecting the rules and      |\n"); 
            write("| ideals of the Vampire Nation, they only hail to Elder     |\n"); 
            write("| Vampires and above.                                       |\n"); 
            write("|                                                           |\n");
            write("|___________________________________________________________|\n");

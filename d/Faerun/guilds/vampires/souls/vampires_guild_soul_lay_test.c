...
{ 
    if (str == "commands")
    {
        ...
        if (VAMPIRES_MAPPINGS->query_vampire_ability_occ_4(this_player()->query_name()) == 3)
        {
            write("|___________________________________________________________|\n");
            write("|                                                           |\n");
            write("|                        TIER FOUR                          |\n"); 
        ...
        // OCC abilities, TIER 5
        if (VAMPIRES_MASTER->is_vamp_elder(this_player()->query_name()) == 1)
        {
            write("|___________________________________________________________|\n");
            write("|                                                           |\n");
            write("|                        TIER FIVE                          |\n"); 
    ...
    if (str == "bloodpath")
    {
        ...
        // TIER 5 ABILITIES
        if (VAMPIRES_MASTER->is_vamp_elder(this_player()->query_name()) == 0)
        {
            write("|                                                              |\n");
            write("|______________________________________________________________|\n");
        ...
        if (VAMPIRES_MASTER->is_vamp_elder(this_player()->query_name()) == 1 
        || VAMPIRES_MASTER->is_vamp_methuselah(this_player()->query_name()) == 1
        || VAMPIRES_MASTER->is_vamp_antediluvian(this_player()->query_name()) == 1
        || VAMPIRES_MASTER->is_vamp_progenitor(this_player()->query_name()) == 1)
        {
            write("|                | |                                           |\n");
            write("|               _| |_                                          |\n");
            write("|              | Sigil|                                        |\n");
    ...
    write("|  LATEST UPDATES, 06.12.2022. Use command 'vbugsandfixes' for data.  |\n");
    write("|                                                                     |\n");
    write("|                                                                     |\n");
    write("|                                                                     |\n");

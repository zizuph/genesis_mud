/* /d/Faerun/guilds/vampires/obj/vamp_puzzle_box1.c
 * 
 * Nerull 2021
 */
...
{  
    ...
    set_short("small flat rock");
    set_pshort("small flat rocks");
       
    set_long("This is a small almost flat rock which has been "
    +"polished on all sides with the exception of its underside. It has "    
    +"probably been submerged in seawater for a very long time before "
    +"ending up here. It measures about about three inches in "
    +"diameter, about "
    +"half an inch in thickness, and has a slight oval form.\n");

    add_item(({"underside"}),
        "Hidden at the underside of the "
...
press_button(string str)
{
    ...
    {         
        ...
        +"button on the underside of the "+short()+", but nothing "
    ...
    && (dial_nr3 == correct_nr3))
    {
        ...
        +"button on the underside of the "+short()+".\n");
        ...
        {       
            ...
            VAMPIRES_MAPPINGS->set_vampires_seeker(this_player()->query_name(), 2);
            
            if (!present("box1_paralyze", this_player()))
            {
                clone_object(BOX1_PARALYZE)->move(this_player(), 1);
            }

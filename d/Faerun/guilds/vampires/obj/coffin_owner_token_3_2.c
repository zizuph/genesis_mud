/*  /d/Faerun/guilds/vampires/obj/coffin_owner_token_3_2.c
 *
...
place_coffin(string str)
{
    ...
    if (str == "coffin")
    {
        ...
        write("You place your simple steel coffin on the ground!\n");
...
create_object()
{
    set_name("_coffin_owner_token_3_2");
    add_name("coffin");
    set_adj("simple");
    add_adj("steel");
    
    set_short("simple steel coffin");
    
    set_long("This is a simple steel coffin.\nYou may "

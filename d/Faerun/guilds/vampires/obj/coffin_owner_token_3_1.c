/*  /d/Faerun/guilds/vampires/obj/coffin_owner_token_3_1.c
 *
...
place_coffin(string str)
{
    ...
    if (str == "coffin")
    {
        ...
        write("You place your plain steel coffin on the ground!\n");
...
create_object()
{
    set_name("_coffin_owner_token_3_1");
    add_name("coffin");
    set_adj("plain");
    add_adj("steel");
    
    set_short("plain steel coffin");
    
    set_long("This is a plain steel coffin.\nYou may "

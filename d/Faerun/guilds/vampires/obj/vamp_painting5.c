...
string contours()
{
    ...
    if (box == 0)
    {
        switch(randdesc5_0)
        {
            ...
            +"stools. You also notice a box stuffed with straw to serve as "
    ...
    if (box == 1)
    {
        switch(randdesc5_1)
        {
            ...
            +box_middle_dial_str+" noble looking faces, each is painted "
    ...
    if (box == 2)
    {
        switch(randdesc5_2)
        {
            ...
            +"are "+box_right_dial_str+" bloody and mutilated elven "
            +"heads, undoubtedly the inspiration for their celebration.\n";
            break;

            case 1:
            box_str = "This is a painting of a regimented but messy "
            ...
            +"size and distance apart. Several pieces of primitive wooden "
            ...
            +"of this room. A clear view of a dark cloudy sky through a narrow "
            ...
            +"orcs walking their patrols, while the rest of the city "
	...
	if (box == 3)
    {
        switch(randdesc5_3)
        {
            ...
            +"to take a drink. At the edge of the lake, a small stream "

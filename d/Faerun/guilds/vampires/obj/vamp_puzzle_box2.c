/* /d/Faerun/guilds/vampires/obj/vamp_puzzle_box2.c
 * 
 * Nerull 2021
 */
...
{  
    ...
    set_short("tiny wooden doll");
    set_pshort("tiny wooden dolls");
       
    set_long("This is a tiny featureless doll of a male "
    +"figure. It is carved out of a single piece of wood and "
    +"generally polished for a smooth overall finish except "
    +"for its backside. It measures about four inches in height.\n");

    add_item(({"backside"}),
        "Partly hidden at the backside of the "
...
press_button(string str)
{
    ...
    {         
        ...
        +"button on the backside of the "+short()+", but nothing "
    ...
    && (dial_nr3 == correct_nr3))
    {
        ...
        +"button on the backside of the "+short()+".\n");
        ...
        {       
            ...
            VAMPIRES_MAPPINGS->set_vampires_seeker(this_player()->query_name(), 3);
            
            if (!present("box2_paralyze", this_player()))
            {
                clone_object(BOX2_PARALYZE)->move(this_player(), 1);
            }
            
                        
            VAMPIRES_OBJHANDLER->set_box2_inactive();

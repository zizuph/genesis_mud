/*  /d/Faerun/guilds/vampires/obj/coffin_owner_token_1_2.c
 *
...
place_coffin(string str)
{
    ...
    if (str == "coffin")
    {
        ...
        write("You place your simple wood coffin on the ground!\n");
...
create_object()
{
    set_name("_coffin_owner_token_1_2");
    add_name("coffin");
    set_adj("simple");
    add_adj("wood");
    
    set_short("simple wood coffin");
    
    set_long("This is a simple wood coffin.\nYou may "

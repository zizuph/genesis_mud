/*  /d/Faerun/guilds/vampires/obj/coffin_owner_token_2_1.c
 *
...
place_coffin(string str)
{
    ...
    if (str == "coffin")
    {
        ...
        write("You place your plain stone coffin on the ground!\n");
...
create_object()
{
    set_name("_coffin_owner_token_2_1");
    add_name("coffin");
    set_adj("plain");
    add_adj("stone");
    
    set_short("plain stone coffin");
    
    set_long("This is a plain stone coffin.\nYou may "

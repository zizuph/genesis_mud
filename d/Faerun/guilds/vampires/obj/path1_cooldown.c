/*
 *  /d/Faerun/guilds/vampires/obj/path1_cooldown.c
 *
 *  Nerull, 2022
 *
 */
...
static int    expiration_time = 12800;
...
create_object()
{
    set_name("path1_cooldown_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy path1_cooldwn_obj");
    set_long("This is a vampire path1 cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A vampire path1 cooldown object.\n");

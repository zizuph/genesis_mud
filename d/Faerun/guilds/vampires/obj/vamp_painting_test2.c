...
string contours()
{
    ...
    if (box == 1)
    {
        switch(randdesc2_1)
        {
            ...
            +"to collect themselves into one wide river that empties itself "
    ...
    if (box == 3)
    {
        switch(randdesc2_3)
        {
            ...
            +"above a "
            +"small, shy deer which hides behind one of the oaks. Zipping "
            +"through "
    ...
    if (box == 4)
    {
        switch(randdesc2_4)
        {
            ...
            +"grey mountain, two black stone doors are bound by "

/*
 *  /d/Faerun/guilds/vampires/obj/thrall_amplifier.c
 *
 *  Nerull, 2021
 *
 */
...
create_object()
{
    ...
    add_prop(OBJ_S_WIZINFO,"A vampire thrall amplifier object.\n");
    ...
    set_alarm(60.0, 60.0, &amplify_me());
} 
...
destroy_me(object player)
{
    ...
    thrall->catch_tell("You no longer feel superaturally enhanced.\n");

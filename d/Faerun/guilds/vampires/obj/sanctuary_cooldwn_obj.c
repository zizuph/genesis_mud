/*
 *  /d/Faerun/guilds/vampires/obj/sanctuary_cooldwn_obj.c
 *
 *  Nerull, 2021
 *
 */
...
create_object()
{
    set_name("sanctuary_cooldwn_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy sanctuary_cooldwn_obj");
    set_long("This is a vampire sanctuary cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A vampire rejoin cooldown object.\n");

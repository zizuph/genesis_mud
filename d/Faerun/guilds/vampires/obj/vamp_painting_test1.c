...
string contours()
{
    ...
    if (box == 0)
    {
        ...
        {
            case 0:
            box_str = "You notice "+box_left_dial_str+" seagulls circle "
			+"around "
            ...
            case 1:
            box_str = "A wave crashes into the sandy beach, partly covering "
            ...
            case 2:
            box_str = "In the horizon, you see "
    ...
    if (box == 1)
    {
        ...
        {
            case 0:
            box_str = "You see some bright flowers and "
            ...
            case 1:
            box_str = "A goat is chewing various vegetation from the "
			+"flowerbed, "
            ...
            case 2:
            box_str = "The "+box_left_dial_str+" bees are buzzing about "
			+"near "
    ...
    if (box == 2)
    {
        ...
        {
            case 0:
            box_str = "Near the surface of the brown swamp water, "
			+box_left_dial_str
            ...
            case 1:
            box_str = "You see "+box_left_dial_str+" pair of eyes submerged "
            ...
            case 2:
            box_str = "A horrible faceless spectre is dragging the "
			+"remains of "

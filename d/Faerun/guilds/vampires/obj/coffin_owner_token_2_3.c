/*  /d/Faerun/guilds/vampires/obj/coffin_owner_token_2_3.c
 *
...
place_coffin(string str)
{
    ...
    if (str == "coffin")
    {
        ...
        write("You place your elaborate stone coffin on the ground!\n");
...
create_object()
{
    set_name("_coffin_owner_token_2_3");
    add_name("coffin");
    set_adj("elaborate");
    add_adj("stone");
    
    set_short("elaborate stone coffin");
    
    set_long("This is an elaborate stone coffin.\nYou may "

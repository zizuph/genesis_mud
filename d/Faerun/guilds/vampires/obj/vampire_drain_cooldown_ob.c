/*
 *  /d/Faerun/guilds/vampires/obj/vampire_drain_cooldown_ob.c
 *
 *  Nerull, 2021
 *
 */
...
static int    expiration_time = 10800;
...
create_object()
{
    set_name("_vampire_drain_cooldown_ob");
    add_adj( ({"moldy"}) );

    set_short("moldy vampire_drain_cooldown_ob");
    set_long("This is a vampire vampire_drain_cooldown_ob cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A vampire drain cooldown object.\n");

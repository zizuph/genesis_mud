/*  /d/Faerun/guilds/vampires/obj/coffin_owner_token_2_2.c
 *
...
create_object()
{
    set_name("_coffin_owner_token_2_2");
    add_name("coffin");
    set_adj("simple");
    add_adj("stone");
    
    set_short("simple stone coffin");
    
    set_long("This is a simple stone coffin.\nYou may "

/*
 *  /d/Faerun/guilds/vampires/obj/seekercleanse_countdown_ob.c
 *
 *  Nerull, 2021
 *
 */
...
#include "../guild.h"
                                ...
                                // about 3 months
static int    expiration_time = 7889229;
...
create_object()
{
    set_name("_seekercleanse_countdown_ob");
    add_adj( ({"moldy"}) );

    set_short("moldy seekercleanse_countdown_ob");
    set_long("This is a vampire seekercleanse_countdown_ob cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A vampire seeker cleanse object.\n");
...
{
    if (present("_seekercleanse_countdown_ob2", player))
    {
        remove_object();

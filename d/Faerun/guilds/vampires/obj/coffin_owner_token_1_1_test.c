/*  /d/Faerun/guilds/vampires/obj/coffin_owner_token_1_1.c
 *
...
string *blacklisted_locations = ({
    "/d/Avenir/common/dead/barrow/slide",
    "/d/Avenir/common/dead/barrow/sliding",
    "/w/nerull/testing_50",
    "/d/Calia/sea/sector_0_0_0/*",
});
...
place_coffin(string str)
{
    ...
    if (str == "coffin")
    {
        ...
        write("You place your plain wood coffin on the ground!\n");
        
        object coffin=clone_object(VAMPIRES_GUILD_DIR +"rooms/coffin_test");
			
        coffin->set_owner(COFFIN_MANAGER->get_name(this_player())); 
        coffin->set_material("wood");
        coffin->set_material_cost(25);
...
create_object()
{
    set_name("_coffin_owner_token_1_1");
    add_name("coffin");
    set_adj("plain");
    add_adj("wood");
    
    set_short("plain wood coffin");
    
    set_long("This is a plain wood coffin.\nYou may "

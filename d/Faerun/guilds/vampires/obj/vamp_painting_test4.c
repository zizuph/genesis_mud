...
string contours()
{
    ...
    if (box == 1)
    {
        switch(randdesc4_1)
        {
            ...
            +"one hatchling still perches on the edge of the nest. Soaring "
	...
	if (box == 3)
    {
        switch(randdesc4_3)
        {
            ...
            +"eating their dinners and chatting with one another. In the "

...
create_object()
{
    set_name("vampthrall_coold_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy vampthrall_coold");
    set_long("This is a vampire vampthrall_coold_obj.\n");

    add_prop(OBJ_S_WIZINFO,"A vampire thrall cooldown object.\n");

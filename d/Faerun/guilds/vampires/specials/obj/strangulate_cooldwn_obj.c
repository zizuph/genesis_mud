/*
 * /d/Faerun/guilds/vampires/obj/strangulate_cooldwn_obj.c
 *
 * Nerull 2021
 */
...
create_object()
{
    set_name("_strangulate_cooldwn_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy strangulate_cooldwn_obj");
    set_long("This is a vampire strangulate cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A vampire strangulate cooldown object.\n");
    ...
    set_alarm(STRANGULATE_COOLDOWN_DURATION, 0.0, &destroy_me());
} 
/*
 * Resilience - add magical damage mitigation
 * By Nerull, June 2017
 * Based on Arman's Stoneskin spell. 2021
 */
...
config_stoneskin_spell()
{
    ...
    set_spell_desc(" - Enhance your skin to magically absorb incoming damage");
    ...
    set_spell_object(VAMPIRES_SPELLOB_DIR + "resilience_obj");
}
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    bloodamount = bloodamount - RESILIENCE_COST;   
...
{
    write("Your skin is already enhanced. Casting the "
...
{
    write("You lack a proper ingredient for the Resilience.\n");
}
/*
 * Deadeye =  See invisible creatures
 * By Nerull, June 2021
 */
...
{
    set_spell_name("deadeye");
    set_spell_desc(" - See invisible creatures");
    ...
    set_spell_object(VAMPIRES_SPELLOB_DIR + "deadeye_obj");
}
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    bloodamount = bloodamount - DEADEYE_COST;   
...
{
    write("You are already maintaining the Deadeye spell.\n");
}

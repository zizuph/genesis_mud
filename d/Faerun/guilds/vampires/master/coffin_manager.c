...
int set_sigil(mixed who,int yesno)
{
    return set_info(who,"sigil",yesno);
}


public int query_sigil(mixed who)
{
    return get_info(who,"sigil");
}


int set_owner_avg(mixed who,int cost)
{
    return set_info(who,"owner_avg",cost);
}


public int query_owner_avg(mixed who)
{
    return get_info(who,"owner_avg");
}

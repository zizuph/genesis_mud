...
* 
* 
* Magical resistanceshield for 2 elements
*/
...
{
    set_spell_name("urluir");
    set_spell_desc(" - Armor of Mist: Resist Air and Fire spells");
    ...
    set_spell_object(WARLOCK_SPELLOB_DIR + "a_mist_obj");
}
...
query_spell_can_be_learned(object player)
{
    ...
    {
        if (WARLOCK_MAPPINGS->query_warspell_18(this_player()->query_name()) == 1)
        {
...
int execute = 0)
{
    ...
    {
        if (present("_eldritch_sight_object_", caster))
        {
            caster->catch_tell("The effect of Urhavol interferes "
            +"with your ability to cast this spell.\n");
    ...
    {
        add_resistance(MAGIC_I_RES_AIR, resist_value); 
        add_resistance(MAGIC_I_RES_FIRE, resist_value); 
...
{
    caster->catch_tell("A grey mist suddenly surrounds your body.\n");
}
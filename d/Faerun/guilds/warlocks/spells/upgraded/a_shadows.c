/*
 * Armor of Shadows - Resist Magical Attacks
 * By Nerull, June 2017
 */
...
{
    set_spell_name("urvaesa");
    set_spell_desc(" - Armor of Shadows: Resist Life and Death spells");
    ...
    set_spell_object(WARLOCK_SPELLOB_DIR + "a_shadows_obj");
}
...
query_spell_can_be_learned(object player)
{
    ...
    {
       if (WARLOCK_MAPPINGS->query_warspell_18(this_player()->query_name()) == 2)
        {
...
int execute = 0)
{
    ...
    {
        add_resistance(MAGIC_I_RES_DEATH, resist_value); 
...
{
    caster->catch_tell("You cast Urvaesa on yourself.\n");
}
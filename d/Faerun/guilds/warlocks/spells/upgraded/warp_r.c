...
int execute = 0)
{
    ...
    // Limitation checks
    //if (caster->query_prop(STATBUFF_ON))
    if (present("_sculptor_object_", caster))
    {
        caster->catch_tell("The effect of Urhagash interferes "
        +"with your ability to cast Uralane.\n");

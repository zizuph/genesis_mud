...
turn_target_success(object spell_object)
{
    ...
    TASK_ROUTINE,   ({  SKILL_WEIGHT, 40, TS_INT, SKILL_WEIGHT, 40, TS_WIS,
                        SKILL_WEIGHT, 20, SKILL_AVG, SS_ELEMENT_EARTH,
...
{
    set_spell_name("urnerulla");
    set_spell_desc(" - Spook: Cause goblins and dwarves to flee");
...
query_spell_can_be_learned(object player)
{
    ...
    {
        if (WARLOCK_MAPPINGS->query_warspell_17(this_player()->query_name()) == 2)
        {
...
{
    write("You are not properly prepared for the Urnerulla spell!\n");
}

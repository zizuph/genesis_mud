/*
* /d/Faerun/guilds/warlocks/obj/war_flat_charm_2.c
*
...
query_spell_active(object player)
{
    ...
    if (player->query_guild_level_lay() < DEPTH_UNLOCK)
        return 0;
...
create_heap()
{
    ...
    add_name("_war_flat_charm_2");
    add_prop(HEAP_S_UNIQUE_ID, "_war_flat_charm_2");
    
    set_adj("flat");
    add_adj("jagged");
    add_adj("bone");
    
    set_short("flat jagged bone charm");
    set_pshort("flat jagged bone charms");
    ...
    setup_spell_effect("urfenn", "_depth_charge", SPELL_STD_CHARGE);
}

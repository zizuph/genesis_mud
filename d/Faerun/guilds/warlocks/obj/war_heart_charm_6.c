/*
* /d/Faerun/guilds/warlocks/obj/war_heart_charm_6.c
*
...
{
    if (str == "fiery charm" 
        || str == "fiery heart charm"
        || str == "urfiviel"
        || str == "hardened fiery heart charm")
    {
        write("You sacrifice a hardened fiery heart charm!\n");
...
create_heap()
{
    ...
    add_name("_war_heart_charm_6");
    add_prop(HEAP_S_UNIQUE_ID, "_war_heart_charm_6");
    
    set_adj("hardened");
    add_adj("fiery");
    add_adj("heart");
    
    set_short("hardened fiery heart charm");
    set_pshort("hardened fiery heart charms");
    ...
    +"arcane symbol of power is burned into both sides of "
    +"the fiery hot muscle tissue.\n");
    ...
    setup_spell_effect("urfiviel", "_coldlight_charge", SPELL_STD_CHARGE);
}

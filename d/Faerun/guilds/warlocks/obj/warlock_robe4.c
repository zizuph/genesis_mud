/*
*  /d/Faerun/guilds/warlocks/obj/warlock_robe4.c
*
*  2018, Nerull
*
*/
...
wear(object ob)
{
    ...
    {
        return "You have no interest in wearing this robe.\n";
        return 1;
    }
    ...
    //Shadow = clone_object(WARLOCK_GUILDDIR + "obj/warlock_robe4_sh");

/*
 *  /d/Faerun/guilds/warlocks/obj/war_cooldwn_ptrx_obj.c
 *
 *  Nerull, 2018
 *
 */
...
static int    expiration_time = COOLDOWN_REJOIN_TIME;
...
create_object()
{
    set_name("war_cooldwn_ptr2_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy war_cooldwn_ptr2_obj");
    set_long("This is a warlock cooldown for rejoining x patron.\n");

    add_prop(OBJ_S_WIZINFO,"This is a warlock cooldown for rejoining x patron.\n");

/*
* /d/Faerun/guilds/warlocks/obj/war_heart_charm_1.c
*
...
{
    if (str == "black charm" 
        || str == "black heart charm"
        || str == "urhagash"
        || str == "hardened black heart charm")
    {
        write("You sacrifice a hardened black heart charm!\n");
...
create_heap()
{
    ...
    add_name("_war_heart_charm_1");
    add_prop(HEAP_S_UNIQUE_ID, "_war_heart_charm_1");
    
    set_adj("hardened");
    add_adj("black");
    add_adj("heart");
    
    set_short("hardened black heart charm");
    set_pshort("hardened black heart charms");
    ...
    +"arcane symbol of power is burned at both sides of "
    +"the blackened muscle tissue.\n");
    ...
    setup_spell_effect("urhagash", "_sculptor_charge", SPELL_STD_CHARGE);
}

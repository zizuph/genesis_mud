/*
* /d/Faerun/guilds/warlocks/obj/war_flat_charm_5.c
*
...
{
    if (str == "green charm" 
        || str == "green bone charm"
        || str == "uraene"
        || str == "flat green bone charm")
    {
        write("You sacrifice a flat green bone charm!\n");
...
create_heap()
{
    ...
    add_name("_war_flat_charm_5");
    add_prop(HEAP_S_UNIQUE_ID, "_war_flat_charm_5");
    
    set_adj("flat");
    add_adj("green");
    add_adj("bone");
    
    set_short("flat green bone charm");
    set_pshort("flat green bone charms");
    ...
    setup_spell_effect("uraene", "_ascendstep_charge", SPELL_STD_CHARGE);
}

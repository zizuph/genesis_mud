/*
* /d/Faerun/guilds/warlocks/obj/war_heart_charm_3.c
*
...
query_spell_active(object player)
{
    ...
    if (player->query_guild_level_lay() < ELDRITCH_SIGHT_UNLOCK)
        return 0;
...
{
    if (str == "gleamy charm" 
        || str == "gleamy heart charm"
        || str == "urhavol"
        || str == "hardened gleamy heart charm")
    {
        write("You sacrifice a hardened gleamy heart charm!\n");
...
create_heap()
{
    ...
    add_name("_war_heart_charm_3");
    add_prop(HEAP_S_UNIQUE_ID, "_war_heart_charm_3");
    
    set_adj("hardened");
    add_adj("gleamy");
    add_adj("heart");
    
    set_short("hardened gleamy heart charm");
    set_pshort("hardened gleamy heart charms");
    ...
    +"arcane symbol of power is branded at both sides of "
    +"the weird gleamy muscle tissue.\n");
    ...
    setup_spell_effect("urhavol", "_eldritch-sight_charge", SPELL_STD_CHARGE);
}

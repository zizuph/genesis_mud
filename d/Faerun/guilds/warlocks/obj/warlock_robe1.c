/*
*  /d/Faerun/guilds/warlocks/obj/warlock_robe1.c
*
*  2018, Nerull
*
*/
...
create_armour()
{
    ...
    add_name("patr1_guild_object");
    set_adj(({"crimson", "hooded"}));
    set_short("crimson hooded robe");
    
    set_long("This hooded robe is made of ordinary cloth but is dyed "
    +"in an empowering crimson color. You sense the presence of "
    +"a devil in this fabric.\nWarlocks may <wahelp> for more information.\n");
...
wear(object ob)
{
    ...
    && !WARLOCK_MASTER->is_patr1_warlock(this_player()->query_name()))
    {
        return "As you try to wear the crimson hooded robe, flashes "
        +"of Devils wreak havoc in your mind! You let it be.\n";
        return 1;
    }
    
    write("You wear the "+query_short()+" around your body.\n");
    say(QCTNAME(this_player())+" wears "+LANG_ASHORT(this_object())+".\n");
    //Shadow = clone_object(WARLOCK_GUILDDIR + "obj/warlock_robe1_sh");

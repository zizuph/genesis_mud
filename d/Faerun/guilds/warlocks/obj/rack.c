/*
 * /d/Faerun/guilds/warlocks/obj/rack.c
 *
 * Nerull 2018
 */
...
inherit WARLOCK_OBJ_DIR + "guild_rack";
...
create_rack()
{
    ...
    set_name("rack");
    set_adj("equipment");
    set_long("This massive equipment rack is set deeply into "
    +"the north wall. It stretches nearly the entire length of the "
    +"chamber and from the floor to the ceiling. Countless "
    +"hooks, chains and straps line its interior for effective "
    +"ordering and storage of various equipment types. You notice "
    +"a carving shaped like an inverted pentagram on the left "
    +"side of the rack.\n");

...
remove_cutscene_paralyze()
{
    ...
    environment(this_object())->move_living("M", "/d/Genesis/start/human/wild2/peninsula", 1);
    
    tell_room("/d/Genesis/start/human/wild2/peninsula", QCTNAME(environment(this_object()))

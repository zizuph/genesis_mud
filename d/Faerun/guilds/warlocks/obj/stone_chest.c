/*
 * /d/Faerun/guilds/warlocks/obj/stone_chest.c
 *
 * Nerull 2018
 */
...
create_rack()
{
    set_short("stone chest");
    set_name("chest");
    set_adj("stone");
    set_long("This is a massive open chest made of "
    +"rough stone. It may contain a wide array of items, armors and "

/*
* /d/Faerun/guilds/warlocks/obj/war_curved_charm_1.c
*
...
query_spell_active(object player)
{
    ...
    if (player->query_guild_level_lay() < MAGICSHIELD_UNLOCK)
        return 0;
...
{
    if (str == "acid-etched charm" 
        || str == "acid-etched bone charm"
        || str == "urwem"
        || str == "curved acid-etched bone charm")
    {
        write("You sacrifice a curved acid-etched bone charm!\n");
...
create_heap()
{
    ...
    add_name("_war_curved_charm_1");
    add_prop(HEAP_S_UNIQUE_ID, "_war_curved_charm_1");
    
    set_adj("curved");
    add_adj("acid-etched");
    add_adj("bone");
    
    set_short("curved acid-etched bone charm");
    set_pshort("curved acid-etched bone charms");
    set_long("This magical charm is roughly circular in appearance and "
    +"slightly curved. It measures about two inches in diameter. A vague "
    +"arcane symbol of power is etched into both sides of the charm.\n");
    ...
    setup_spell_effect("urwem", "_shroud_charge", SPELL_STD_CHARGE);
}

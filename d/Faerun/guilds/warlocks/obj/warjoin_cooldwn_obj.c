/*
 *  /d/Faerun/guilds/warlocks/obj/warjoin_cooldwn_obj.c
 *
 *  Nerull, 2018
 *
 */
...
create_object()
{
    set_name("warjoin_cooldwn_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy warjoin_cooldwn_obj");
    set_long("This is a warlock rejoin cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A warlock rejoin cooldown object.\n");

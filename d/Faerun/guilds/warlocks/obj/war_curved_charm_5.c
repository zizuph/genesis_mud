/*
* /d/Faerun/guilds/warlocks/obj/war_curved_charm_5.c
*
...
{
    if (str == "rust-red charm" 
        || str == "rust-red bone charm"
        || str == "urnerulla"
        || str == "curved rust-red bone charm")
    {
        write("You sacrifice a curved rust-red bone charm!\n");
...
create_heap()
{
    ...
    set_pname("charms");
    add_name("urnerulla");
    add_name("_war_curved_charm_5");
    add_name("_spell_ingredient");
    add_prop(HEAP_S_UNIQUE_ID, "_war_curved_charm_5");
    
    set_adj("curved");
    add_adj("rust-red");
    add_adj("bone");
    
    set_short("curved rust-red bone charm");
    set_pshort("curved rust-red bone charms");
    ...
    setup_spell_effect("urnerulla", "_spook_charge", SPELL_STD_CHARGE);
}

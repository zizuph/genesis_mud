...
remove_cutscene_paralyze()
{
    ...
    environment(this_object())->move_living("M", "/d/Ansalon/balifor/flotsam/room/street28", 1);
    
    tell_room("/d/Ansalon/balifor/flotsam/room/street28", QCTNAME(environment(this_object()))

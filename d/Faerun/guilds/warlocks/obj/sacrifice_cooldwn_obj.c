/*
 * /d/Faerun/guilds/warlocks/obj/sacrifice_cooldwn_obj.c
 *
 * Nerull 2018
 */
...
static int    expiration_time = 1000;
...
create_object()
{
    set_name("sacrifice_cooldwn");
    add_adj( ({"moldy"}) );

    set_short("moldy sacrifice_cooldwn_obj");
    set_long("This is a warlock sacrifice cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A warlock sacrifice cooldown object.\n");
...
enter_env(object player, object from)
{
    ...
    {
        set_alarm(1.0, 0.0, &destroy_me(player));
        //remove_object():
        return;
    }

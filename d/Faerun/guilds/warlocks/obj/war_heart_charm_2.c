/*
* /d/Faerun/guilds/warlocks/obj/war_heart_charm_2.c
*
...
{
    if (str == "rotten charm" 
        || str == "rotten heart charm"
        || str == "urhaese"
        || str == "hardened rotten heart charm")
    {
        write("You sacrifice a hardened rotten heart charm!\n");
...
create_heap()
{
    ...
    add_name("_war_heart_charm_2");
    add_prop(HEAP_S_UNIQUE_ID, "_war_heart_charm_2");
    
    set_adj("hardened");
    add_adj("rotten");
    add_adj("heart");
    
    set_short("hardened rotten heart charm");
    set_pshort("hardened rotten heart charms");
    ...
    setup_spell_effect("urhaese", "_aversion_charge", SPELL_STD_CHARGE);
}

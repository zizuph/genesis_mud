/*
* /d/Faerun/guilds/warlocks/obj/war_flat_charm_6.c
*
...
{
    if (str == "humming charm" 
        || str == "humming bone charm"
        || str == "urhuew"
        || str == "flat humming bone charm")
    {
        write("You sacrifice a flat humming bone charm!\n");
...
create_heap()
{
    ...
    add_name("_war_flat_charm_6");
    add_prop(HEAP_S_UNIQUE_ID, "_war_flat_charm_6");
    
    set_adj("flat");
    add_adj("humming");
    add_adj("bone");
    
    set_short("flat humming bone charm");
    set_pshort("flat humming bone charms");
    ...
    +"the charm, creating a low humming noise.\n");
    ...
    setup_spell_effect("urhuew", "_witchstep_charge", SPELL_STD_CHARGE);
}

/*
 * /d/Faerun/guilds/warlocks/obj/rit_cooldwn_obj.c
 *
 * Nerull 2018
 */
...
static int    expiration_time = COOLDOWN_EXPIRATION_TIME;
...
create_object()
{
    set_name("rit_cooldown_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy rit_cooldown_obj");
    set_long("This is a warlock ritual cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A warlock ritual cooldown object.\n");
...
destroy_me(object player)
{
    ...
    player->catch_tell("You feel strong enough to perform a new ritual.\n");

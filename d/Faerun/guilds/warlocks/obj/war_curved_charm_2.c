/*
* /d/Faerun/guilds/warlocks/obj/war_curved_charm_2.c
*
...
{
    if (str == "jagged charm" 
        || str == "jagged bone charm"
        || str == "urvaesa"
        || str == "curved jagged bone charm")
    {
        write("You sacrifice a curved jagged bone charm!\n");
...
create_heap()
{
    ...
    add_name("_war_curved_charm_2");
    add_prop(HEAP_S_UNIQUE_ID, "_war_curved_charm_2");
    
    set_adj("curved");
    add_adj("jagged");
    add_adj("bone");
    
    set_short("curved jagged bone charm");
    set_pshort("curved jagged bone charms");
    ...
    +"arcane symbol of power is etched into both sides of the jagged charm\n");
    ...
    setup_spell_effect("urvaesa", "_shadows_charge", SPELL_STD_CHARGE);
}

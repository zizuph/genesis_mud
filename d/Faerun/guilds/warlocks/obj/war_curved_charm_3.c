/*
* /d/Faerun/guilds/warlocks/obj/war_curved_charm_3.c
*
...
{
    if (str == "scorched charm" 
        || str == "scorched bone charm"
        || str == "urluir"
        || str == "curved scorched bone charm")
    {
        write("You sacrifice a curved scorched bone charm!\n");
...
create_heap()
{
    ...
    add_name("_war_curved_charm_3");
    add_prop(HEAP_S_UNIQUE_ID, "_war_curved_charm_3");
    
    set_adj("curved");
    add_adj("scorched");
    add_adj("bone");
    
    set_short("curved scorched bone charm");
    set_pshort("curved scorched bone charms");
    ...
    +"arcane symbol of power is burned into both sides of the charm.\n");
    ...
    setup_spell_effect("urluir", "_mist_charge", SPELL_STD_CHARGE);
}

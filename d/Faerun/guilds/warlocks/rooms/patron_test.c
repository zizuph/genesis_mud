...
enter_tepcircle(string str)
{
    ...
    || str == "teleportation field")
    {
        ...
        {
            case 0:
            this_player()->move_living("M", TELEPORT_DIR + "me22", 1);
            tell_room(TELEPORT_DIR + "me22", QCTNAME(this_player())
            + " arrives from east.\n", this_player());
            break;
            case 1:
            this_player()->move_living("M", TELEPORT_DIR + "me12", 1);
            tell_room(TELEPORT_DIR + "me12", QCTNAME(this_player())
            + " arrives from north.\n", this_player());
            break;
            case 2:
            this_player()->move_living("M", TELEPORT_DIR + "me03", 1);
            tell_room(TELEPORT_DIR + "me03", QCTNAME(this_player())
            + " arrives from west.\n", this_player());
            break;
            case 3:
            this_player()->move_living("M", TELEPORT_DIR + "me30", 1);
            tell_room(TELEPORT_DIR + "me30", QCTNAME(this_player())
            + " arrives from south.\n", this_player());
            break;
        }
...
create_warlock_room()
{
    ...
    "teleportation field"}),
    "Engraved into the smooth claystone ground and glowing in a "
    +"purple fashion, the teleporation circle is in the dead center "
    +"of the chamber and measures about ten feet in diameter. Anyone "
    +"that 'enter circle' will be teleported somewhere else in "
    +"Faerun.\n");

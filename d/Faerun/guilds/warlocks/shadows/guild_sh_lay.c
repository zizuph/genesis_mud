/* /d/Faerun/guilds/warlocks/shadows/guild_sh_lay.c
 *
...
add_soul()
{
    ...
    {
        if (WARLOCK_MASTER->is_lay_warlock(member[i]->query_name()))
        {
...
query_guild_title_lay()
{
    ...
    if (WARLOCK_MASTER->is_patr1_warlock(shadow_who->query_name()))
    {
        ...
        return titles_patr1[query_guild_level_lay()];
    }
    ...
    if (WARLOCK_MASTER->is_patr2_warlock(shadow_who->query_name()))
    {
        ...
        return titles_patr2[query_guild_level_lay()];
    }
    ...
    if (WARLOCK_MASTER->is_patr3_warlock(shadow_who->query_name()))
    {
        ...
        return titles_patr3[query_guild_level_lay()];
    }
...
linkdeath_hook(int i)
{
    ...
    {
        if (WARLOCK_MASTER->is_lay_warlock(member[j]->query_name()))
        {
...
remove_object()
{
    ...
    if(calling_function(-1) == "quit")
    {
        ...
        {
            if (WARLOCK_MASTER->is_lay_warlock(obs[i]->query_name()))
            {
...
public void check_demand()
{
    ...
    int patron_level = query_guild_level_lay();

/*
 *  /d/Faerun/guilds/black_flame/obj/bfjoin_cooldwn_obj.c
 *
 *  Nerull, 2022
 *
 */
...
create_object()
{
    set_name("bfjoin_cooldwn_obj");
    add_adj( ({"moldy"}) );

    set_short("moldy bfjoin_cooldwn_obj");
    set_long("This is a black flame rejoin cooldown object.\n");

    add_prop(OBJ_S_WIZINFO,"A black flame rejoin cooldown object.\n");

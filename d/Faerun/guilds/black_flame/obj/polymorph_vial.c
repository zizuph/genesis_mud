/*
* /d/Faerun/guilds/black_flame/obj/polymorph_vial.c
*
...
{
    if (str == "pearlescent vial" 
        || str == "tiny pearlescent vial"
		|| str == "tiny vial"
		|| str == "vial")
    {
        write("You consume a tiny pearlescent vial!\n");
...
create_heap()
{
	...
	set_name("_polymorph_vial");
    add_name("polyjuice");
    add_name("vial");
    set_pname("vials");
    add_name("_spell_ingredient");
    add_prop(HEAP_S_UNIQUE_ID, "_polymorph_vial");
    
    set_adj("tiny");
    add_adj("pearlescent");
    
    set_short("tiny pearlescent vial");
    set_pshort("tiny pearlescent vials");
    ...
    setup_spell_effect("polymorph", "_polymorph_charge", SPELL_STD_CHARGE);
}

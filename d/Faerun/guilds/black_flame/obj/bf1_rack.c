/*
 * /d/Faerun/guilds/black_flame/obj/bf1_rack.c
 *
 * Nerull 2022
 */
inherit "/d/Faerun/guilds/black_flame/obj/guild_rack";
...
{  
    ...
    +"of the entire southern wall, along which are various slots and "

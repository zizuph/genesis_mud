/*
 * Support Shadow for the Black Flame polymorph spell
 *
 * Originally created by Petros, modified by Arman (8/2016)
 * and refitted to be used for the Black Flame, Nerull 2022
 */
...
initialize_shadow(object spell_object, mapping spell_input)
{
    ...
    spell_object->set_spell_effect_desc("Polymorph");
    spell_object->set_short("polymorph spell object");
...
hook_spell_effect_started(object spell_object)
{
    ...
    if (objectp(target))
    {
        ...
        target->catch_tell("You change appearance!\n");
...
hook_spell_effect_warn_fading(object spell_object)
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You sense your polymorph spell "
        +"begins to fade.\n");
    }
}

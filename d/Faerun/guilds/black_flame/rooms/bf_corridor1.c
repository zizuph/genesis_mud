/* /d/Faerun/guilds/black_flame/rooms/bf_corridor1.c
 *
 * Nerull 2022
 *
 */
...
create_bf_room()
{
    ...
    +"lies around the corner, but you can proceed southwest "
    +"or west to find out.\n");
    ...
    add_exit(BF_ROOMS_DIR + "bf_boardroom", "east");
    add_exit(BF_ROOMS_DIR + "bf_rackroom1", "southwest");

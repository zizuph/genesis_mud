/* /d/Faerun/guilds/black_flame/rooms/bf_corridor3.c
 *
 * Nerull 2022
 *
 */
...
create_bf_room()
{
    ...
    +"lies around the corner, but you can proceed east "
    +"or northwest to find out.\n");
    ...
    add_exit(BF_ROOMS_DIR + "bf_entrance", "east");
    add_exit(BF_ROOMS_DIR + "bf_rackroom1", "northwest");

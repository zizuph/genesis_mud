...
#define PACK_ID   "_faerun_gem_satchel_"
...
long_func()
{
    string long_desc = "This is a " + short() + " and holds gems. It is " +
        "made of soft black leather and can be worn on the shoulder. ";

    if (query_prop(OBJ_M_NO_SELL))
        long_desc += " Currently, the " + short() + " is protected and cannot be sold. " +
        "This protection may be removed with <unkeep satchel>.";
    else
        long_desc += " You may protect this from being sold by doing " +
        "<keep satchel>. This does not protect it from being stolen. You " +

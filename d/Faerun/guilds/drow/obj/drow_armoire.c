/*
 * /d/Faerun/guilds/drow/obj
 *
 * Clyptas 2018
 *adopted from Nerull's /d/Faerun/guilds/warlocks/obj/iron_chest
 */
...
create_rack()
{
    set_short("blackwood armoire");
    set_name("armoire");
    set_adj("blackwood");
    set_long("This is a freestanding, giant armoire made of " +
        "ancient blackwood. It is intricately engraved. It may " +
        "contain a wide array of items, armours and other items of " +
        "interest.\n");
        
    add_item(({"engraving","engravings"}),
        "The engravings are delicately curving and wrapping vines " +
        "around the doors of the armoire. Spiders crawl among the " +
        "coiling stalks.\n");
        
    add_item(({"spiders"}),
        "The spiders appear very lifelike and range from medium to " +
        "small and are crawling through the vines. Their eyes are inlaid " +
        "with bright gems and precious stones.\n");

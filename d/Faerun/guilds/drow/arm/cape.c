...
#define SAM ({0,1,0})
#define SNAME "cape"
#define SSHORT "smooth black cape"
#define SPSHORT "smooth black capes"
...
create_armour()
{
    ...
    add_item(({"gold chain", "black gold chain"}),
        ...
        "lapel to the other, holding the " + short() + " on.\n");
...
read_sign()
{
    return "\nYou may do the following while wearing the " + short() + ":\n" +
        "\t(cls)pin    - Spin around\n" +
        "\t(clb)ow     - Bow before someone\n" +
        "\t(clc)urtsey - Curtsey before someone\n" +
        "\t(clp)ick    - Pick some dirt off your " + short() + "\n\n";

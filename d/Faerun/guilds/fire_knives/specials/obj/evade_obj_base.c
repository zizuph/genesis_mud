...
create_effect()
{
    set_name("fireknives_evade_base");
    add_name( ({"fireknives_evade_base_object" }) );
    set_short("hidden fireknives evade base object");    
    set_long("This is the secret and extremely hidden fireknives evade base object.\n");
...
attack_blocked(object player, object attacker, int attack_id)
{
    ...
    {
    case 0:
        msg1 = "You watch as "+attacker->query_the_name(player) 
...
block_backstab()
{
	write("As an Assassin, you should "
	+"use 'assassinate' instead of backstab!\n");
...
init()
{
    ...
    add_action(block_backstab, "backstab");
}
*/

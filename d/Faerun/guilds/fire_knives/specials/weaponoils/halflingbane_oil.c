...
create_heap()
{
    ...
    set_name("halflingbane");
    set_pname("halflingbanes");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("halflingbane oil");
    add_pname("oils");
    add_pname("halflingbane oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("halflingbane_weaponoil");
    add_name("_weaponoil_halflingbane");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_halflingbane");
    
    set_adj("tiny");
    add_adj("black");
    
    set_short("tiny black vial");
    set_pshort("tiny black vials");
    set_long("This is tiny clear vial. Within you see some "
    +"black oily opaque substance that is slightly reacting "

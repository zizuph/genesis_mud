...
create_heap()
{
    ...
    set_name("dwarfbane");
    set_pname("dwarfbanes");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("dwarfbane oil");
    add_pname("oils");
    add_pname("dwarfbane oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("dwarfbane_weaponoil");
    add_name("_weaponoil_dwarfbane");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_dwarfbane");
    
    set_adj("tiny");
    add_adj("brown");
    
    set_short("tiny brown vial");
    set_pshort("tiny brown vials");
    set_long("This is tiny clear vial. Within you see some "
    +"brown oily opaque substance that is slightly reacting "

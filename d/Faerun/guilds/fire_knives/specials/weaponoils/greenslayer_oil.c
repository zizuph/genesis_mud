...
create_heap()
{
    ...
    set_name("greenslayer");
    set_pname("greenslayers");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("greenslayer oil");
    add_pname("oils");
    add_pname("greenslayer oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("greenslayer_weaponoil");
    add_name("_weaponoil_greenslayer");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_greenslayer");
    
    set_adj("tiny");
    add_adj("violet");
    
    set_short("tiny violet vial");
    set_pshort("tiny violet vials");
    set_long("This is tiny clear vial. Within you see some "
    +"violet oily opaque substance that is slightly reacting "

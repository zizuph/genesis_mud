...
create_heap()
{
    ...
    set_name("gnomeslayer");
    set_pname("gnomeslayers");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("gnomeslayer oil");
    add_pname("oils");
    add_pname("gnomeslayer oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("gnomeslayer_weaponoil");
    add_name("_weaponoil_gnomeslayer");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_gnomeslayer");
    
    set_adj("tiny");
    add_adj("purple");
    
    set_short("tiny purple vial");
    set_pshort("tiny purple vials");
    set_long("This is tiny clear vial. Within you see some "
    +"purple oily opaque substance that is slightly reacting "

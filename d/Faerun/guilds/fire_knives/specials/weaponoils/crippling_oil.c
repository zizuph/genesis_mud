...
create_heap()
{
    ...
    add_name("weapon oil");
    add_name("vial");
    add_name("torpefy oil");
    add_pname("oils");
    add_pname("torpefy oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("torpefy_weaponoil");
    add_name("_weaponoil_torpefy");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_torpefy");
    
    set_adj("tiny");
    add_adj("ash-grey");
    
    set_short("tiny ash-grey vial");
    set_pshort("tiny ash-grey vials");
    set_long("This is tiny clear vial. Within you see some "
    +"ash-grey oily opaque substance that is slightly reacting "

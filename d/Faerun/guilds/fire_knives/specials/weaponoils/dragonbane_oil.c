...
create_heap()
{
    ...
    set_name("dragonbane");
    set_pname("dragonbanes");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("dragonbane oil");
    add_pname("oils");
    add_pname("dragonbane oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("dragonbane_weaponoil");
    add_name("_weaponoil_dragonbane");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_dragonbane");
    
    set_adj("tiny");
    add_adj("white");
    
    set_short("tiny white vial");
    set_pshort("tiny white vials");
    set_long("This is tiny clear vial. Within you see some "
    +"white oily opaque substance that is slightly reacting "

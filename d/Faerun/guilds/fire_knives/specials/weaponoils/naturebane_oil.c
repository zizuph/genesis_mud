...
create_heap()
{
    ...
    set_name("naturebane");
    set_pname("naturebanes");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("naturebane oil");
    add_pname("oils");
    add_pname("naturebane oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("naturebane_weaponoil");
    add_name("_weaponoil_naturebane");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_naturebane");
    
    set_adj("tiny");
    add_adj("pale");
    
    set_short("tiny pale vial");
    set_pshort("tiny pale vials");
    set_long("This is tiny clear vial. Within you see some "
    +"pale oily opaque substance that is slightly reacting "

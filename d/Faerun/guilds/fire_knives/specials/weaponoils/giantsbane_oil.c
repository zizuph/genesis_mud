...
create_heap()
{
    ...
    set_name("giantsbane");
    set_pname("giantsbanes");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("giantsbane oil");
    add_pname("oils");
    add_pname("giantsbane oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("giantsbane_weaponoil");
    add_name("_weaponoil_giantsbane");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_giantsbane");
    
    set_adj("tiny");
    add_adj("blue");
    
    set_short("tiny blue vial");
    set_pshort("tiny blue vials");
    set_long("This is tiny clear vial. Within you see some "
    +"blue oily opaque substance that is slightly reacting "

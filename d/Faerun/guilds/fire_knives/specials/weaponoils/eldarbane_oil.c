...
create_heap()
{
    ...
    set_name("eldarbane");
    set_pname("eldarbanes");
    add_name("oil");
    add_name("weapon oil");
    add_name("vial");
    add_name("eldarbane oil");
    add_pname("oils");
    add_pname("eldarbane oils");
    add_pname("weapon oils");
    add_pname("vials");
    add_name("eldarbane_weaponoil");
    add_name("_weaponoil_eldarbane");
    add_prop(HEAP_S_UNIQUE_ID, "_weaponoil_eldarbane");
    
    set_adj("tiny");
    add_adj("red");
    
    set_short("tiny red vial");
    set_pshort("tiny red vials");
    set_long("This is tiny clear vial. Within you see some "
    +"red oily opaque substance that is slightly reacting "

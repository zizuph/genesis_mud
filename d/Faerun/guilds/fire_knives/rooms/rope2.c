/* /d/Faerun/guilds/fire_knives/rooms/rope2.c
 *
 * Climbing the rope, step 2.
 *
 * Nerull 2019
 *
 */
...
create_fireknives_room()
{
   ...
   /* Climb up rope / Climb down rope */
    ...
    add_item(({"footsteps"}),
    "Footsteps are printed with patches of snow on the "
    +"ground, proof that someone "
    ...
    add_exit(FIREKNIVES_ROOMS_DIR + "rope3", "up");
    add_exit(FIREKNIVES_ROOMS_DIR + "rope1", "down");

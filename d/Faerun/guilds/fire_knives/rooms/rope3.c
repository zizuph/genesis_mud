/* /d/Faerun/guilds/fire_knives/rooms/rope3.c
 *
 * Climbing the rope, step 3.
 *
 * Nerull 2019
 *
 */
...
create_fireknives_room()
{
    ...
    set_long("All around you the massive walls "
    +"of mountains protect you from the "
    ...
    add_item(({"rope"}),
    "You are hanging from the rope that extends "
    +"from the top of the hole to the "
   ...
   /* Climb up rope / Climb down rope */
    ...
    add_item(({"rocks"}),
    "The walls of the mountains are formed of earth and "
    +"rock formed tightly together "
    ...
    add_exit(FIREKNIVES_ROOMS_DIR + "rope4", "up");
    add_exit(FIREKNIVES_ROOMS_DIR + "rope2", "down");

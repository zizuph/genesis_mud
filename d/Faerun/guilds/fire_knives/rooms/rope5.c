/* /d/Faerun/guilds/fire_knives/rooms/rope5.c
 *
 * Climbing the rope, step 5.
 *
 * Nerull 2019
 *
 */
...
create_fireknives_room()
{
    ...
    +"you continue climbing. The faint outline of "
    +"a circular shape can be seen "
    +"some meters above you. \n");

    add_item(({"outline","shape","circular shape"}),
    "Some meters above you, the faint outline of a "
    +"circular shape can be seen. It "
    +"looks like a hole of sorts.\n");
   ...
   /* Climb up rope / Climb down rope */
    ...
    +"is nothing comparable to the stormy "
    +"winds outside, but still enough to make "
    +"even the heavy rope dangle.\n");
   
    add_exit(FIREKNIVES_ROOMS_DIR + "rope6", "up");
    add_exit(FIREKNIVES_ROOMS_DIR + "rope4", "down");

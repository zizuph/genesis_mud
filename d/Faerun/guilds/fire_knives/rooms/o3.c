/* /d/Faerun/guilds/fire_knives/rooms/o3.c
 *
 * Northwestern point in the sanctuary
 *
 * Nerull 2019
 *
 */
...
create_fireknives_room()
{
    ...
    set_short("Northeastern point in the sanctuary");
    
    set_long("The spacious, rectangular area revolves "
    +"around a statue centered atop "
    +"a marble block in the middle of the "
    +"scope of this area. It seems unfinished and "
    ...
    +"that seemed to have sustained the passage of "
    +"time. Between each of them is a massive "
    +"wall with an iron sconce from which a thick, "
    +"wooden torch hangs high, shedding off "
    +"light to the area. From the east of here comes "
    +"an aroma of freshness and oils that "
    +"mixes with the stale air to revitalize your lungs.\n");
    ...
    +"side of his torso, while another can be seen "
    +"strapped around his left leg "
    ...
    add_item(({"concourse"}),
    "The concourse revolves around the statue in "
    +"a circular fashion, its walls cut six times "
    ...
    +"north to the main hallway, east to an "
    +"aromatic room, and south further along the "
    +"circular concourse.\n");
    ...
    add_exit(FIREKNIVES_ROOMS_DIR + "herb", "east");
    add_exit(FIREKNIVES_ROOMS_DIR + "o2", "north");
    add_exit(FIREKNIVES_ROOMS_DIR + "o4", "south");

/* /d/Faerun/guilds/fire_knives/rooms/rope4.c
 *
 * Climbing the rope, step 4.
 *
 * Nerull 2019
 *
 */
...
create_fireknives_room()
{
   ...
   /* Climb up rope / Climb down rope */
    ...
    +"the tight hole created by the encroaching walls of the mountains.\n");
    ...
    add_exit(FIREKNIVES_ROOMS_DIR + "rope5", "up");
    add_exit(FIREKNIVES_ROOMS_DIR + "rope3", "down");

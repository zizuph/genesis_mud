/* /d/Faerun/guilds/fire_knives/rooms/climb1.c
 *
 * First room climbing up to the ledge
 *
 * Nerull 2019
 *
 */
...
create_fireknives_outdoor()
{
    ...
    +"more of the jagged stones from which you are hanging.");
    ...
    +"away from you just as a new wave hits you "
    +"from the west.\n");

    add_item(({"ground","floor"}),
    "Layers of snow cover the ground beneath you "
    +"from what you can see from here "
    +"now that you've left it behind. It seems "
    +"as if it was a comfortable bed made "
    +"of cotton, inviting you to drop into it.\n");

    add_item(({"base","mountain","mountains"}),
    "The mountain is wide and high, extending "
    +"upwards as far as the eye can see "
    +"only to lose itself into a dense fog. From "
    +"your current perspective it seems "
    +"as if it would go on forever, while "
    +"downwards would be but a few steps away.\n");
    ...
    add_item(({"winds","wind"}),
    "The winds buffet mightily against you as "
    +"try and hold on to the stones jutting "
    ...
    +"the moment, and looking up you find similar ones "
    +"within reach.\n");

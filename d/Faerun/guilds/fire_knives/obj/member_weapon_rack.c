/*
 * /d/Faerun/guilds/fire_knives/obj/member_weapon_rack.c
 *
 * Nerull 2018
 */
...
create_rack()
{
    ...
    set_long("A weapons rack carved right into the granite wall in this "
    +"room with wooden pegs added for weapons to be hung. I'ts quite big "
    +"with no real ornamentation but the craftmanship used when "
    +"carving it is incredibly precise. This is where the assassins "
    +"of full status store various weapons and other useful items. Use "
    +"'listrack' to list the content.\n");

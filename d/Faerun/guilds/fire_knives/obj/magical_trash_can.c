 ...
 *
 * Borrowed by Nerull for the Fire Knives  guild. Need
 * to keep halls tidy. 2019.
 */
#pragma strict_types
...
create_container()
{
	...
	+"Brotherhood by the lich "
	+"Szass Tam as a reward for a well executed retirement of "
	+"an earlier rival. Anything put into it will be regulary "

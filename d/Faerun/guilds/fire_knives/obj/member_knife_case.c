/*
 * /d/Faerun/guilds/fire_knives/obj/member_knife_case.c
 *
 * Nerull 2018
 */
...
create_rack()
{
    ...
    set_short("huge mahogany case");
    set_long("A huge case made out of mahogany with gold ornaments. Covered "
    +"with a very fine silk cloth in the darkest black it shines back "
    +"at you. Over the case is a crystal glass shell polished to "
    +"perfection with a platinum inlaid insignia of the fireknives on the "
    +"glass. This is where the tools of the arts are placed and stored for "
    +"those honored enough to use them. Use 'listcase' to list the content.\n");

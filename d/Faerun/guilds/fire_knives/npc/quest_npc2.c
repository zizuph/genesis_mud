...
nomask void create_monster()
{
    ...
    set_race_name("human");
    set_name("_quest_npc2_");
    add_name("sand dan glokta");
    add_name("sand");
    add_name("man");
    add_name("sand glokta");
    add_name("sand dan");
    ...
    set_short("limping hunched male human");
    
    set_long("A seemingly old man leaning heavily on a cane "
    +"due to his lifeless left leg which hangs behind him "
    +"as he moves. His perhaps once youthful face wrinkled in "
    +"what seems to be an eternal grimace of pain. Although small, "
    +"frail, and hunched over, he exudes an aura of respect "
    +"among the nobles around him who are instantly invaded "
    +"by feelings of fear and awe. He from time to time "
    +"dries his weary eyes with a soft crimson handkerchief.\n");
    ...
    set_act_time(5);
    set_cact_time(5);
    add_act("emote leans on his cane.");
    add_act("emote eats a moldy sandwich.");
    add_act("emote complains about the weather.");
    
    set_cchat_time(5);
    add_cchat("I will teach you a lesson!");
    add_cchat("Eat my cane, bandit!");
...
arm_me()
{
    ...
    wep = clone_object(FIREKNIVES_GUILD_DIR + "obj/cane");
...
do_die(object killer)
{
    ...
    {
        clone_object(FIREKNIVES_GUILD_DIR + "obj/quest_item2")->move(this_object(), 1);
    }

/*
 *  faerun/underdark/upper/menzo/sorcere/obj/second_door.c
 *
 *  The door used on the second floor in Sorcere. 
...
void create_door()
{
    ...
    set_door_desc("This sturdy looking door is constructed out of " +
                  "weirwood. It's been polished and oiled into a " +
                  "smooth finish. Soft blue fairie light dances " +
                  "across the surface of the door, with a  " +
                  "continuous light.\n");
}

...
create_faerun_weapon()
{
    ...
    add_adj("blackened");
    add_adj("slim-bladed");
    set_long("This vicious-looking dagger is known as 'Heart of the Golem'. " +
              "There are no records of this weapon's creator, nevertheless, " +
              "its existence can be traced back among thieves and murderers " +
              "to before Dalereckoning. Its blackened blade was apparently " +
              "forged from the arcane metals of an iron golem, giving the " +
              "weapon an appearance as dark as its history. \n");

 
    set_short("blackened slim-bladed dagger");

/*
 *  faerun/underdark/upper/menzo/sorcere/study6.c
 *
 *   
...
#define MASTER1 P_MENZO_SORCERE + "npc/master2_web"
...
void create_sorcere_room()
{
	...
	door_e = clone_object(P_MENZO_SORCERE + "obj/third_master_door");
	door_e->configure_ground_door("east", "s6_3", 

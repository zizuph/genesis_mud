/*
 *  faerun/underdark/upper/menzo/sorcere/second15.c
 *
 *   
 *  Study on the second floor in the north tower of sorcere.
...
void create_sorcere_room()
{
	...
	door->configure_ground_door("west", "n2_15", 
		P_MENZO_SORCERE + "north2");

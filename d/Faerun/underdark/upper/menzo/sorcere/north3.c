/*
 *  faerun/underdark/upper/menzo/sorcere/north3.c
 *
 *   
 *  Stair and corridor on the third floor in the north tower of sorcere.
...
void create_sorcere_room()
{
	...
	door_w = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door_w->configure_ground_door("west", "n3_17", 
		P_MENZO_SORCERE + "third17");
	door_w->move(this_object());

	door_n = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door_n->configure_ground_door("north", "n3_16", 
		P_MENZO_SORCERE + "third16");
	door_n->move(this_object());

	door_e = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door_e->configure_ground_door("east", "n3_15", 
		P_MENZO_SORCERE + "third15");
	...
	add_item(({"stair"}),
        ...
        add_exit("third15", "east");
        add_exit("third17", "west");
        add_exit("third14", "south");
        add_exit("third16", "north");
        
        add_exit("north2", "down");

/*
 *  faerun/underdark/upper/menzo/sorcere/third20.c
 *
 *   
 *  Study on the third floor in the west tower of sorcere.
...
void create_sorcere_room()
{
	...
	door->configure_ground_door("east", "w3_20", 
		P_MENZO_SORCERE + "west3");

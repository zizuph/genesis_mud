/*
 *  faerun/underdark/upper/menzo/sorcere/second6.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 "wide corridor crossing in the north wing of the main tower " +
                 "of Sorcere. The only lightsource is the trail of glimmering " +
	...
	add_item(({"corridor"}),
        ...
        add_exit("second7", "west");
        add_exit("second5", "east");
        add_exit("second13", "north");

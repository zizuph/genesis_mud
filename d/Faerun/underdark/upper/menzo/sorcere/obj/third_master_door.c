/*
 *  faerun/underdark/upper/menzo/sorcere/obj/third_master_door.c
 *
 *  The door used on the third floor. Create an instance of it, and call
...
void create_door()
{
    ...
    set_door_desc("This sturdy looking door is constructed out of " +
                  "natural untreated silverwood. A dancing light of " +
                  "fairie fire dances across the doors natural surface. " +
                  "Silverwood is a rare and highly prized type of wood.\n" +
                  "@@trap_desc@@");
}
...
spring_trap(object who)
{
    ...
    // Create the cloud
    seteuid(getuid());
    ob = clone_object(SOR_OBJ_DIR + "mana_health_drain_cloud");
    ...
    string other_side)
{
    ...
    // Configure the door
    set_door_name(({"silver door", "door", direction + " door"}));
    set_door_id(door_id);

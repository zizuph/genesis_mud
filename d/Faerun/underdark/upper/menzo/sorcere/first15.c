/*
 *  faerun/underdark/upper/menzo/sorcere/first15.c
 *
 *   
 *  Study on the first floor in the north tower of sorcere.
...
void create_sorcere_room()
{
	...
	door->configure_ground_door("west", "n1_15", 
		P_MENZO_SORCERE + "north1");

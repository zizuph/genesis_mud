/*
 *  faerun/underdark/upper/menzo/sorcere/second14.c
 *
 *   
 *  Corridor on the second floor in the north tower of sorcere.
...
void create_sorcere_room()
{
	...
	set_long("You're walking in a narrow corridor in the north " +
	...
	add_item(({"corridor"}),
        ...
        add_exit("second13", "south");
        add_exit("north2", "north");

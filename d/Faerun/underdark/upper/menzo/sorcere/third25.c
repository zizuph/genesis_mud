/*
 *  faerun/underdark/upper/menzo/sorcere/third25.c
 *
 *   
...
#define STUDENT P_MENZO_SORCERE + "npc/student3_fire"
...
void create_sorcere_room()
{
	...
	set_long("You've entered a half-moon shaped study of a wizard " +
        ...
        door = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door->configure_ground_door("north", "s3_25", 
		P_MENZO_SORCERE + "south3");

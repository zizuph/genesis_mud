/*
 *  faerun/underdark/upper/menzo/sorcere/first3.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 ...
                 "soft hue of blue radiance guide the way inside " +
	...
	door_w = clone_object(P_MENZO_SORCERE + "obj/ground_master_door");
	door_w->configure_ground_door("west", "s1_3", 
		P_MENZO_SORCERE + "study1");
	...
	add_item(({"corridor"}),
        ...
        add_exit("study1", "west");
        add_exit("first4", "north");
        add_exit("first1", "east");

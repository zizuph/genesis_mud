/*
 *  faerun/underdark/upper/menzo/sorcere/second18.c
 *
 *   
 *  Corridor on the second floor in the west tower of sorcere.
...
void create_sorcere_room()
{
	...
	set_long("You're walking in a narrow corridor in the west " +

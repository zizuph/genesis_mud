/*
 *  faerun/underdark/upper/menzo/sorcere/second3.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 ...
                 "soft hue of purple radiance guide the way inside " +
	...
	door_w = clone_object(P_MENZO_SORCERE + "obj/second_master_door");
	door_w->configure_ground_door("west", "s3_3", 
		P_MENZO_SORCERE + "study3");
	door_w->move(this_object());
	
	door_w = clone_object(P_MENZO_SORCERE + "obj/second_master_door");
	door_w->configure_ground_door("east", "s5_3", 
		P_MENZO_SORCERE + "study5");
	door_w->move(this_object());
	...
	add_item(({"corridor"}),
        ...
        add_exit("study3", "west");
        add_exit("second4", "north");
        add_exit("study5", "east");
        add_exit("second12", "south");

/*
 *  faerun/underdark/upper/menzo/sorcere/third23.c
 *
 *   
 *  Study on the third floor in the south tower of sorcere.
 *  Created by Midnight, 8-3-2004
 */

#include "defs.h"

#define STUDENT P_MENZO_SORCERE + "npc/student3_acid"
...
void create_sorcere_room()
{
	...
	door->configure_ground_door("east", "s3_23", 

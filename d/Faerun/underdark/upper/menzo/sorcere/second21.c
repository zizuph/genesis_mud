/*
 *  faerun/underdark/upper/menzo/sorcere/second21.c
 *
 *   
...
#define STUDENT P_MENZO_SORCERE + "npc/student2_acid"
...
void create_sorcere_room()
{
	...
	set_short("A half-moon shaped study room in the west tower");
	...
	door->configure_ground_door("north", "w2_21", 
		P_MENZO_SORCERE + "west2");

/*
 *  faerun/underdark/upper/menzo/sorcere/second12.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 "wide corridor in the south wing of the main tower " +
                 "of Sorcere. The only lightsource is the trail of " +
                 "glimmering magical stones inserted in the floor, their " +
	...
	add_item(({"corridor"}),
        ...
        add_exit("second11", "west");
        add_exit("second3", "north");

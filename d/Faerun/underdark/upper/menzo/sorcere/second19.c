/*
 *  faerun/underdark/upper/menzo/sorcere/second19.c
 *
 *   
 *  Study on the second floor in the west tower of sorcere.
...
void create_sorcere_room()
{
	...
	set_long("You've entered a half-moon shaped study of a wizard " +
        ...
        door->configure_ground_door("south", "w2_19", 

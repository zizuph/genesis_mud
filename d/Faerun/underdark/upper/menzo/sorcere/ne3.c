/*
 *  faerun/underdark/upper/menzo/sorcere/ne3.c
 *
 *   
 *  Stair on the third floor in the northeast tower of sorcere.
...
void create_sorcere_room()
{
	...
	set_long("Sedimentary rock forms a winding stair up and down into " +
	...
	add_item(({"stair"}),
        "A dark stairway seems to lead up to the fourth floor " +
        "and down to the second floor " +

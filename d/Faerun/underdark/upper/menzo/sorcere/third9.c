/*
 *  faerun/underdark/upper/menzo/sorcere/third9.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 ...
                 "of crimson radiance guide the way inside the shadowy corridor. " +
	...
	add_item(({"corridor"}),
        ...
        "to glow in a soft crimson blue shimmering light. They mark the " +
        ...
        add_exit("third8", "north");
        add_exit("third10", "east");

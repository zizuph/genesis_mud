/*
 *  faerun/underdark/upper/menzo/sorcere/second8.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 ...
                 "soft hue of purple radiance guide the way inside the " +
                 "shadowy corridor. " +
	...
	door = clone_object(P_MENZO_SORCERE + "obj/second_master_door");
	door->configure_ground_door("east", "s4_8", 
		P_MENZO_SORCERE + "study4");
	...
	add_item(({"corridor"}),
        ...
        "to glow in a soft purple blue shimmering light. They mark the " +
        ...
        add_exit("second7", "north");
        add_exit("second18", "west");
        add_exit("study4", "east");
        add_exit("second9", "south");

/*
 *  faerun/underdark/upper/menzo/sorcere/second9.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 ...
                 "of purple radiance guide the way inside the shadowy corridor. " +
	...
	add_item(({"corridor"}),
        ...
        add_exit("second8", "north");
        add_exit("second10", "east");

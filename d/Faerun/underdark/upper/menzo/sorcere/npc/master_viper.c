/*
 *  faerun/underdark/upper/menzo/sorcere/npc/master_viper.c
 *
 *  A 1st level wizard master in the Sorcere
 *
...
void create_sorcere_drow()
{
    ...
    set_stats(({ 140, 200, 160, 170, 160, 150 }));
    set_alignment(-800);
    ...
    add_spell(P_FAERUN_SPELLS + "drow_viperhand");
    set_cast_chance(60);
...
void equip()
{
    ...
    clone_object(P_MENZO_SORCERE + "wep/roncone")->move(this_object());
    command("wear all");
    command("wield all");
}

/*
 *  faerun/underdark/upper/menzo/sorcere/third17.c
 *
 *   
 *  Study on the third floor in the north tower of sorcere.
...
void create_sorcere_room()
{
	...
	door->configure_ground_door("east", "n3_17", 
		P_MENZO_SORCERE + "north3");

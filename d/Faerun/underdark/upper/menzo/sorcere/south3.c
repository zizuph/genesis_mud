/*
 *  faerun/underdark/upper/menzo/sorcere/south3.c
 *
 *   
 *  Stair and corridor on the third floor in the south tower of sorcere.
...
void create_sorcere_room()
{
	...
	door_w->configure_ground_door("west", "s3_23", 
		P_MENZO_SORCERE + "third23");
	door_w->move(this_object());

	door_s = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door_s->configure_ground_door("south", "s3_25", 
		P_MENZO_SORCERE + "third25");
	door_s->move(this_object());

	door_e = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door_e->configure_ground_door("east", "s3_24", 
		P_MENZO_SORCERE + "third24");
	...
	add_item(({"stair"}),
        ...
        add_exit("third24", "east");
        add_exit("third23", "west");
        add_exit("third25", "south");
        add_exit("third22", "north");
        add_exit("south2", "down");

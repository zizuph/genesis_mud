/*
 *  faerun/underdark/upper/menzo/sorcere/study1.c
 *
 *   
 *  Study on the first floor in the main tower of sorcere.
...
#define MASTER1 P_MENZO_SORCERE + "npc/master_viper"
...
void create_sorcere_room()
{
	...
	door_e = clone_object(P_MENZO_SORCERE + "obj/ground_master_door");
	door_e->configure_ground_door("east", "s1_3", 
		P_MENZO_SORCERE + "first3");

/*
 *  faerun/underdark/upper/menzo/sorcere/second25.c
 *
 *   
 *  Study on the first floor in the south tower of sorcere.
...
void create_sorcere_room()
{
	...
	set_long("You've entered a half-moon shaped study of a wizard " +
        ...
        door = clone_object(P_MENZO_SORCERE + "obj/second_door");
	door->configure_ground_door("north", "s2_25", 

/*
 *  faerun/underdark/upper/menzo/sorcere/third8.c
 *
 *   
...
void create_sorcere_room()
{
	...
	door->configure_ground_door("east", "s8_8", 
		P_MENZO_SORCERE + "study8");
	...
	add_item(({"corridor"}),
        ...
        add_exit("third7", "north");
        add_exit("third18", "west");
        add_exit("study7", "east");
        add_exit("third9", "south");

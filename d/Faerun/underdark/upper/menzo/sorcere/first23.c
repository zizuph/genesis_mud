/*
 *  faerun/underdark/upper/menzo/sorcere/first23.c
 *
 *   
...
#define STUDENT1 P_MENZO_SORCERE + "npc/student_fire"
...
reset_room()
{
    ...
    {
        student_fire = clone_object(STUDENT1);
...
void create_sorcere_room()
{
	...
	door->configure_ground_door("east", "s1_23", 
		P_MENZO_SORCERE + "south1");

/*
 *  faerun/underdark/upper/menzo/sorcere/west3.c
 *
 *   
 *  Stair and corridor on the third floor in the west tower of sorcere.
...
void create_sorcere_room()
{
	...
	door_w->configure_ground_door("west", "w3_20", 
		P_MENZO_SORCERE + "third20");
	door_w->move(this_object());

	door_n = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door_n->configure_ground_door("north", "w3_19", 
		P_MENZO_SORCERE + "third19");
	door_n->move(this_object());

	door_s = clone_object(P_MENZO_SORCERE + "obj/third_door");
	door_s->configure_ground_door("south", "w3_21", 
		P_MENZO_SORCERE + "third21");
	...
	add_item(({"stair"}),
        ...
        add_exit("third18", "east");
        add_exit("third20", "west");
        add_exit("third21", "south");
        add_exit("third19", "north");

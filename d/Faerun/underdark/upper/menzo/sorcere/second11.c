/*
 *  faerun/underdark/upper/menzo/sorcere/second11.c
 *
 *   
...
void create_sorcere_room()
{
	...
	set_long("The shadows are static along the edges of this " +
                 "wide corridor crossing in the south wing of the " +
                 "main tower of Sorcere. " +
                 "The only lightsource is the trail of glimmering " +
                 "magical stones inserted in the floor, their soft hue " +
                 "of blue radiance guide the way guide the way inside " +
	...
	add_item(({"corridor"}),
        ...
        add_exit("second10", "west");
        add_exit("second12", "east");
        add_exit("second22", "south");

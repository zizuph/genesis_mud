/*
 *  faerun/underdark/upper/menzo/tierbreche/plateau4.c
 *
 *  
...
void create_tierbreche_room()
{
	...
	set_long("You are walking on a path marked by smooth rocks,  " +
                 "which markes the way between Sorcere and the entrance " +
	...
	add_item(({"entrance"}),
        ...
        add_exit("plateau3", "southeast");
        add_exit("plateau5", "northwest");

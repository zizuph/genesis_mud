/*
 *  faerun/underdark/upper/menzo/melee/npc/student4.c
 *
...
void equip()
{
    ...
    clone_object(P_MENZO_MELEE + "wep/sword")->move(this_object());
    clone_object(P_MENZO_MELEE + "wep/s_dagger")->move(this_object());
    command("wear all");
    command("wield all");
}

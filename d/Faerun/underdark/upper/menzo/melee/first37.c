/*
 *  faerun/underdark/upper/menzo/melee/first37.c
 *
 *   
...
{
	set_short("A dark southern corridor on the first floor");
	...
	add_item(({"corridor"}),
        ...
        add_exit("first39", "west");
        add_exit("first35", "east");
        add_exit("first38", "north");
        reset_room();
}
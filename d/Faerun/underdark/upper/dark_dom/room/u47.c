...
dark_dom(void)
{
    set_short("An carved arched passage near Menzoberranzan");
    set_long("You find yourself standing under an arched passage near "+
    ...
    add_exit("u46", "south", check_follow);
    add_exit("u48", "north", check_follow);
 }
...
dark_dom(void)
{
	...
	"something. Dark passages lead to the north and south. To the south " +
	"you notice a smaller cavern opening up in the darkness. \n");

    add_item(({"sides","side","irregular walls","walls","wall"}),
	"The walls are nothing but bare uncut stone.\n");

    add_exit("u29", "south", check_follow);
    add_exit("u34", "north", check_follow);
 }
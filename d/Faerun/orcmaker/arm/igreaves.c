...
void create_faerun_armour()
{
    ...
    set_long("This is a " + short() + ". They are made from plates of iron and hammered together. The plates overlap each other and protect the legs.\n");

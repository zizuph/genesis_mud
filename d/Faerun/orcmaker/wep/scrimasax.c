...
void create_faerun_weapon()
{
    ...
    set_long("This is a " + short() + ". It is single-edged shortsword " +
        "but resembles a long knife. The sword looks sharp and was forged " +
        "by orcs but the workmanship is decent.\n");

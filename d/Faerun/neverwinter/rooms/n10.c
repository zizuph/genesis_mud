...
create_neverw_outdoor()
{
    extraline = "The street has narrowed immensely compared to the main "
       ...
       +"To the south is a large gate, seperating a section of the "
       +"city from Protector's Enclave. The gate, and the wall "
       +"surrounding it, seem to have been constructed recently. ";
	...
	add_exit(ROOM_DIR + "n9.c", "northwest");
	add_exit(ROOM_DIR + "nd1.c", "south");
	add_exit(ROOM_DIR + "s_grim.c", "east");
}

...
create_neverw_outdoor()
{
    extraline = "You are at an intersection in the southeastern "
       ...
       +"crossing. To the east is a large, almost barracks like "
       +"building. Large amounts of laughter seem to radiate from "
       +"the building, overpowering the vast amount of sounds from the "
       +"street outside.";
    ...
    add_exit(ROOM_DIR + "n3.c", "south");
    add_exit(ROOM_DIR + "n5.c", "north");
    add_exit(ROOM_DIR + "m_ninn.c", "east");

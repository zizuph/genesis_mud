/*
 * Herbalist cottage for Faerun. This use to be the hut on the hill and part of
 * of the NOV guild, but was removed and made public since it was not taxed properly.
 * -- Finwe, January 2009
 */
#pragma no_clone
#pragma strict_types
...
create_indoor_room()
{
    ...
    set_short("inside a small cottage");
    set_extraline("It is square-shaped and comfortable looking. The wooden walls are solid looking and lined with some shelves. A single lamp and many dried plants hangs from the ceiling. The floor has been swept clean. A fireplace sits in another corner, providing warmth to the cottage.");
    ...
    add_item(({"lamp"}),
        "The lamp hangs from the ceiling, casting a warm glow around the room. The lamp is large and unusually bright.\n");
    add_item(({"shelves"}),
...
// fireplace
    ...
    add_item("fireplace",
        ...
        "room with a gentle yellow glow. The fireplace has a large brass screen in front of " +
    ...
    add_exit(HR_DIR + "herb_clearing", "west");

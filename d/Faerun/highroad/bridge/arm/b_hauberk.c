...
create_faerun_armour()
{
    ...
    set_long("Thousands of large bronze rings were used to create this chainmail, each of " +
    	"them connected with four others to build a regular mesh. This armour should " +
    	"protect you well from cuts and slashes, but it is hardly effective against piercing " +
    	"or crushing weapons.\n");

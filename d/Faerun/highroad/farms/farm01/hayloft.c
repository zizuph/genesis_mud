...
create_farm_room()
{
    ...
    set_long(short() + ". It fills the back half of the large "
	+"barn. It is dusty with all the hay bales stacked "
	+"up here. Light filters in between the cracks of "
	+"the wall. A painting is hanging at one of the "
	+"walls. A ladder leads down to the main level of the barn.\n");
    ...
    add_item(({"walls"}),
        "They are made of wood. They looks like they were once "
		+"smooth, but have become rough in places "
		+"over the years. There are cracks "
		+"between the slats which filter light into the barn. A painting is hanging onto "
		+"one of the walls.\n");
    add_item(({"ceiling"}),
    ...
    room_add_object(VAMPIRES_OBJ_DIR  + "vamp_painting7");

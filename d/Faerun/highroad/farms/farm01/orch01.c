...
//Sets the description of the fruit in the trees.
string
tree_item()
{
    if(fruit_counter == MAX_FRUIT)
    {
        return("The trees are old and gnarled. they look overgrown and "
            + "haven't been cared for in years. Still, they look vigorous. "
            + "However, the branches are bare, as if all of the trees' "
    ...
    else
    {
        return("The trees are old and gnarled. They look overgrown and "
            + "haven't been cared for in years. Still, they look vigorous "
            + "and have fruit hanging from them.\n");
    }
}

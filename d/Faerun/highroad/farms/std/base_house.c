/*
 *  This is the base room for the farmhouses of the High Road
 *  Updated by Finwe, August 2006
 */
...
set_extra_window(string str)
{
    add_item(({"windows","window"}),
        ...
        "@@window_position@@ covered by curtains.\n");
    add_item("curtains",
        "They are made from fabric and are open, letting light fill the room.\n");
...
{
    add_item(({"rug", "carpet"}),
        "It is large and " + shape + " shaped. The rug covers the floor and looks well worn.\n");
...
{
    return "The curtains are already opened.\n";
}

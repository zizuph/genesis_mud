...
create_house()
{
    ...
    add_item(({ "brass lantern", "lantern" }),
    	"A non-descript lantern rests upon a crate.\n");
    
    add_cmd_item("lantern","get","As you reach for the lantern " +
    	"someone from the other room, yells leave it be! " +
    	"embarrassed, you decide against taking it.\n");

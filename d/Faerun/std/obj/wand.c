/*
 * Kehr, Dec 2007 - minor updates and adjustments for Faerun domain
 * Finwe, April 2012 - Cleaned up code for readability
 */
...
/*******************************************************************
  ...
  set_wand_effect  - set the effect of the wand. This is simply a
                     ...
                     ** This routine phased out and replased with the following
                     routines
...
int wandStat, wandChange, wandTime;
...
public void enter_env(object dest,object old)
{
    ...
    if((dest->query_skill(SS_SPELLCRAFT)+dest->query_stat(SS_WIS))>(2*ident_limit))
        identified = 1;
    else
        identified = 0;
}
...
public string stat_object()
{
    ...
    str += "Wand type   : ";
        ...
        switch(wandtype)
        {
            case WAND_POOF: str += "WAND_POOF\n";
                break;
            case WAND_HEAL: str += "WAND_HEAL\n";
                break;
            case WAND_SPECIAL: str += "WAND_SPECIAL\n";
                break;
            case WAND_SPELL: str += "WAND_SPELL\n";
                break;
            case WAND_MANA: str += "WAND_MANA\n";
                break;
            case WAND_STAT: str += "WAND_STAT\n";
        }

    //str += "Wand effect : " + wandeffect + "\n";
    str += "Wand effect : sorry, ignored" + "\n";
    str += "Wand param  : " + wandparam + "\n";
    str += "Fail msg    : " + failmsg + "\n";
    str += "Ident. lim. : " + ident_limit + "\n";
    str += "Wand Stat   : " + wandStat + "\n";
    str += "Wand Time   : " + wandTime + "\n";
    str += "Wand Change : " + wandChange + "\n";
 ...
 */
public void set_id_short(string s)
{
    idshort = s;
 ...
 */
public void set_id_long(string s)
{
    idlong = s;
}
 ...
 */
public void set_ident_limit(int i)
{
    ident_limit = i;
 ...
 * No longer used April 2012
 */

/* public void set_wand_effect(mixed eff)
{
    wandeffect = eff;
}
*/
 ...
 */
public void set_charges(int charg)
{
    charges = charg;
}
...
wave(string s)
{
    ...
    say(QCTNAME(TP)+" waves a little in the air with some kind of "+query_name()+".\n");
    return 1;
}
...
zap(string s)
{
    ...
    if(!sizeof(wand))
    {
      ...
      /* sigh */
        if(!parse_command(s,environment(TO),"%w 'of' %w 'at' / 'on' %w",wa,wn,gunk))
	        return 0;
        else
	    {
	        wn = wn + " " + wa;
...
make_tmp_stat(object ob,int stat,int str,int dur)
{
  /* borrowed from herb_support */
    ...
    if (str > 0)
    {
        ...
        {
            case SS_STR: case 0:
                ob->catch_msg("You feel stronger.\n");
            case SS_DEX: case 1:
                ob->catch_msg("You feel more dexterous.\n");
            case SS_CON: case 2:
            ...
            default:
                ob->catch_msg("You feel more clever.\n");
        }
    }
    else if(str < 0)
    {
      ob->add_tmp_stat(stat,random(str) + str / 2,random(str) + str / 2);
        switch(stat)
        {
            ...
            case SS_DEX:
                ob->catch_msg("You feel more slower.\n");
            case SS_CON:
                ob->catch_msg("You feel less healthy.\n");
            case SS_INT:
                ob->catch_msg("You feel dumber.\n");
            case SS_WIS:
                ob->catch_msg("You feel more ignorant.\n");
            case SS_DIS:
                ob->catch_msg("You feel less secure.\n");
            default:
                ob->catch_msg("You feel less clever.\n");
        }
    }
    else
...
public int zappa(string s)
{
  ...
  /* tell the object that it has been zapped. this function was
    ...
    switch(wandtype)
    {
        case WAND_POOF: notify_fail(failmsg);
            return 0;
        case WAND_HEAL:
        ...
        case WAND_MANA:
            ...
            return 1;
        case WAND_STAT:
            ob->make_tmp_stat(ob,wandStat,wandChange,wandTime);
            return 1;
        case WAND_SPECIAL:

...
create_whaleb_outdoor()
{
    ...
    +"tinues on further inland in a northerly and westerly direction.";
    ...
    add_exit(ROOM_DIR + "5o.c", "north");
    add_exit(ROOM_DIR + "11o.c", "east");
    add_exit(ROOM_DIR + "14o.c", "south");
    add_exit(ROOM_DIR + "13o.c", "southwest");
    add_exit(ROOM_DIR + "9o.c", "west");
    add_exit(ROOM_DIR + "5o.c", "northwest");

...
create_whaleb_outdoor()
{
    ...
    + "ush scatter around the base of a steep craggy mountain to your south"
    +". Cool fresh"
    +" sea breeze tickles your senses. This windswept coastal plateau con"
    +"tinues on further inland in a easterly directions.";
    ...
    set_no_exit_msg( ({"west","southwest", "northwest", "north", "south"}),
        "The terrain appears quite rocky and hazardous in that"
        +" direction. You choose to save your ankles the trouble.\n");


    add_exit(ROOM_DIR + "19o.c", "northeast");
    add_exit(ROOM_DIR + "17o.c", "east");
    add_exit(ROOM_DIR + "15o.c", "southeast");

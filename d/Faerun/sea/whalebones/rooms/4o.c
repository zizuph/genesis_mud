...
create_whaleb_outdoor()
{
    ...
    + "ush scatter around the base of a steep craggy mountain before you."
    +" Cool fresh"
    +" sea breeze tickles your senses. This windswept coastal plateau con"
    +"tinues on further inland in a easterly, southerly and westerly dire"
    +"ction.";
    ...
    add_exit(ROOM_DIR + "22o.c", "north", 1, 0, 1);//needs to be hidden
    add_exit(ROOM_DIR + "5o.c", "east");
    add_exit(ROOM_DIR + "10o.c", "southeast");
    add_exit(ROOM_DIR + "9o.c", "south");
    add_exit(ROOM_DIR + "8o.c", "southwest");
    add_exit(ROOM_DIR + "3o.c", "west");

...
create_whaleb_outdoor()
{
    ...
    set_no_exit_msg( ({"southwest", "northwest", "southeast"}),
        "The terrain appears quite rocky and hazardous in that"
        +" direction. You choose to save your ankles the trouble.\n");


      add_exit(ROOM_DIR + "19o.c", "north");
      add_exit(ROOM_DIR + "20o.c", "northeast");
      add_exit(ROOM_DIR + "18o.c", "east");
      add_exit(ROOM_DIR + "15o.c", "south");
      add_exit(ROOM_DIR + "16o.c", "west");

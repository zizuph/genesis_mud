...
{
    extraline = "Overlooking the southern bleakly inhospitable shore,"
    ...
    add_item(({"mountain", "cliff"}), "A large craggy clifface pierces th"
        +"rough clouds to your northwest. Something feels off about it.\n");
    ...
    add_exit(ROOM_DIR + "11o.c", "northeast");
    add_exit(ROOM_DIR + "13o.c", "west");
    add_exit(ROOM_DIR + "9o.c", "northwest");

    set_no_exit_msg( ({"southeast", "south", "southwest", "east"}),

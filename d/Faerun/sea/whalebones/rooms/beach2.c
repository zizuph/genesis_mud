/*  /d/Faerun/sea/whalebones/rooms/beach2.c
*
*   By Nucifera, 2020
*
*/
...
//more immersive expirience.
    set_no_exit_msg( ({"northwest", "west"}), "There is a cl"
        +"iff in the way. You decided it is too risky to climb a horizontal"
        +" face of rock.\n");

    set_no_exit_msg( ({"northeast", "east", "southeast", "south"}), "Break"
       +"ing waves deter you from moving in that direction.\n");

//Connecting exits
    add_exit(ROOM_DIR + "beach1.c", "north");
    add_exit(ROOM_DIR + "beach3.c", "southwest");

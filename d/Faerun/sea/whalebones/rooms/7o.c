...
{
    extraline = "Overlooking the southeastern rocky shore, "
    ...
    add_exit(ROOM_DIR + "2o.c", "north");
    add_exit(ROOM_DIR + "12o.c", "southeast");
    add_exit(ROOM_DIR + "8o.c", "east");
    add_exit(ROOM_DIR + "3o.c", "northeast");

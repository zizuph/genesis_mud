...
{
    extraline = "Overlooking the northern bleakly inhospitable shore, "
    ...
    add_exit(ROOM_DIR + "20o.c", "east");
    add_exit(ROOM_DIR + "18o.c", "southeast");
    add_exit(ROOM_DIR + "17o.c", "south");
    add_exit(ROOM_DIR + "16o.c", "southwest");

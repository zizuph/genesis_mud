...
{
    extraline = "Overlooking the western bleakly inhospitable shore, "
    ...
    add_exit(ROOM_DIR + "6o.c", "northeast");
    add_exit(ROOM_DIR + "5o.c", "northwest");
    add_exit(ROOM_DIR + "10o.c", "west");
    add_exit(ROOM_DIR + "14o.c", "southwest");

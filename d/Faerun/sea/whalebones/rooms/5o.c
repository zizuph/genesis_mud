...
create_whaleb_outdoor()
{
    ...
    +"tinues on further inland in a easterly and southerly dire"
    +"ction.";
    ...
    set_no_exit_msg( ({"north", "northwest", "northeast", "east"}),
        "The terrain appears quite rocky and hazardous in that"
        +" direction. You choose to save your ankles the trouble.\n");

    add_exit(ROOM_DIR + "11o.c", "southeast");
    add_exit(ROOM_DIR + "10o.c", "south");
    add_exit(ROOM_DIR + "9o.c", "southwest");
    add_exit(ROOM_DIR + "4o.c", "west");

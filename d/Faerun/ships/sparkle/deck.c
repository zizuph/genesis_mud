...
create_deck()
{
    set_short("On a sleek vessel");
    set_long("You're standing on a sleek vessel. It looks seaworthy and " +
        "very fast. The deck is uncluttered and probably cleaned regularly " +
        "by sailors. There are two tall masts supporting sails. A set " +
        "of stairs leads down from the deck to a cabin below.\n");
    add_item(({"mast", "masts"}),
    ...
    add_exit(SPARKLE_DIR + "cabin", "down");

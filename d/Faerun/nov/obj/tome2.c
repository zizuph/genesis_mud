...
create_book()
{
        ...
        set_short("red leather-bound tome on a marble stand");
        set_long("This is a red leather-bound tome. It rests upon a marble stand.\n");
...
read_book_at_page(int page, string verb)
{
    ...
    if(page == 1)
    {
                file = read_file(NOV_DIR +"obj/tome2/page1");
    ...
    if(page == 5)
    {
                file = read_file(NOV_DIR +"obj/tome2/page5");
                this_player()->more(file,0);
        }
        
    if(page == 6)
    {
                file = read_file(NOV_DIR +"obj/tome2/page6");
                this_player()->more(file,0);
        }
        
    if(page == 7)
    {
                file = read_file(NOV_DIR +"obj/tome2/page7");
                this_player()->more(file,0);
        }

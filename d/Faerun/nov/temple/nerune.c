...
create_nov_room()
{
    ...
    set_name("In the eastern secion of the runecrafter's area");
    add_name( ({ "room", "hall", "corridor", }) );

    set_short("In the eastern section of the runecrafter's area");
    set_long("In the eastern section of the runecrafter's area.\n");
    ...
    add_exit(NOV_DIR + "temple/ncrune",   "west");

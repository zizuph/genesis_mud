...
create_nov_room()
{
    ...
    set_short("You are in the northeastern section of the great Laboratory of " +
    "The Necromancers of Vile Darkness");
    
    set_long("You are in the northeastern section of the great Laboratory of " +
    ...
    add_exit(NOV_DIR + "temple/nclab",   "southwest");

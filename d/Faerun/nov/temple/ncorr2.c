...
blockmembers()
{
    ...
    write("The iron portcullis prevents you from going further north.\n");
        return 1;
}
...
create_nov_room()
{
    ...
    set_short("You are walking down a hallway in the northern part of " +
    "the temple");
    set_long("You are walking down a hallway in the northern part of " +
    ...
    add_exit(NOV_DIR + "temple/ncorr1",   "north");
    add_exit(NOV_DIR + "temple/ncorr3",   "south");

...
create_nov_room()
{
    ...
    set_short("You are in the northern section of the great Laboratory of " +
    "The Necromancers of Vile Darkness");
    
    set_long("You are in the northern section of the great Laboratory of " +
    "The Necromancers Vile Darkness. The walls are covered with shelves " +
    ...
    add_exit(NOV_DIR + "temple/nclab",   "south");

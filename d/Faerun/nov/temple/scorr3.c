...
create_nov_room()
{
    ...
    set_short("You are walking down a hallway in the southern part of " +
    "the temple");
    set_long("You are walking down a hallway in the southern part of " +
    ...
    add_exit(NOV_DIR + "temple/nccentral",   "north");
    add_exit(NOV_DIR + "temple/scorr2",   "south");

...
#define PACK_ID         "_faerun_money_purse_"
...
create_container()
{
    ...
    add_name(PACK_ID);
    set_adj("leather");
    set_short("large leather " + BAG_NAME );
    set_long("@@long_func@@");
...
long_func()
{
    string long_desc = "This is a " + short() + ". It is made from tanned leather is very soft. The purse looks like it can hold quite a few coins.";

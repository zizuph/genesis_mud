...
//    set_pname(({"cakes", "pieces", "pieces of cake"}));
    ...
    set_long("This is a piece of a yule-time cake. It is green colored and looks delicious to eat. If you get bored, you could probably throw the piece of cake at someone.\n");

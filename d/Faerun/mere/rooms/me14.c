...
string extraline = "Countless footprints cover the ground.";
...
create_mere()
{
    ...
    add_exit(ROOM_DIR + "me11", "northeast");
    add_exit(ROOM_DIR + "me10", "northwest");
    add_exit(ROOM_DIR + "me18", "southeast");
    add_exit(ROOM_DIR + "me17", "southwest");
}

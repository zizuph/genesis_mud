/*
 *  /d/Ravenloft/droptables/fos_drops/e_fos_2hmace.c
 *
...
create_weapon()
{
    ...
    set_default_weapon(FOS_E_2HMACE_HIT, FOS_E_2HMACE_PEN,
    ...
    add_prop(OBJ_S_WIZINFO, "This is en epic weapon dropping from the "
        ...
        + "adds " + FOS_E_2HMACE_HASTE_BONUS + " to _live_i_quickness at "
        + "the wielder.\n");

    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(FOS_E_2HMACE_PEN, W_CLUB));
    add_prop(OBJ_I_VOLUME, FOS_E_2HMACE_VOLUME);
    add_prop(OBJ_I_VALUE, FOS_E_2HMACE_VALUE);

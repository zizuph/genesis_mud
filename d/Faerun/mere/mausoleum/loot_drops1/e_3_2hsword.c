/*
 *  /d/Ravenloft/droptables/fos_drops/e_fos_2hsword.c
 *
...
create_weapon()
{
    set_name("_e_fos_2hsword");
    add_name( ({"blade", "sword", "greatsword"}) );

    set_adj("rune-etched");
    add_adj("obsidian");

    set_short("rune-etched obsidian greatsword"); 
    set_pshort("rune-etched obsidian greatswords");

    set_long("This greatsword has crimson runes running down "
    ...
    set_default_weapon(FOS_E_2HSWORD_HIT, FOS_E_2HSWORD_PEN,
    ...
    add_prop(OBJ_S_WIZINFO, "This is en epic weapon dropping from the "
        ...
        + "adds " + FOS_E_2HSWORD_HASTE_BONUS + " to _live_i_quickness at "
        + "the wielder.\n");

    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(FOS_E_2HSWORD_PEN, W_SWORD));
    add_prop(OBJ_I_VOLUME, FOS_E_2HSWORD_VOLUME);
    add_prop(OBJ_I_VALUE, FOS_E_2HSWORD_VALUE);

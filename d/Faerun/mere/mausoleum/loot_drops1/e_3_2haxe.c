/*
 *  /d/Ravenloft/droptables/fos_drops/e_fos_2haxe.c
 *
...
create_weapon()
{
    ...
    set_default_weapon(FOS_E_2HAXE_HIT, FOS_E_2HAXE_PEN,
	...
	add_prop(OBJ_S_WIZINFO, "This is en epic weapon dropping from the "
		...
		+ "adds "+ FOS_E_2HAXE_HASTE_BONUS+" to _live_i_quickness at "
		+ "the wielder.\n");

    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(FOS_E_2HAXE_PEN, W_AXE));
    add_prop(OBJ_I_VOLUME, FOS_E_2HAXE_VOLUME);
    add_prop(OBJ_I_VALUE, FOS_E_2HAXE_VALUE);

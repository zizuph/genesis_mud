...
text_on_sign =
    ...
    "\t|     -----------------------------------------------------     |\n" +
    "\t|                                                               |\n" +
    "\t|     Fine Rohan-bred steeds for rent. My steeds ride two       |\n" +
    "\t|     people, are trained to stay calm during combat, and       |\n" +
    "\t|     make excellent pack animals.                              |\n" +
    "\t|                                                               |\n" +
    "\t|     Initial fee <pay fee> ........................... 50 pc   |\n" +
    "\t|     Rental fee <rent horse/pony> ....................  2 pc   |\n" +
    "\t|                                                               |\n" +
    "\t|     <stable horse/pony> .............................  free   |\n" +
    "\t|                                                               |\n" +
    "\t|     Once you pay the fee, you may rent a horse any            |\n" +
    "\t|     time after for a nominal fee.                             |\n" +
    "\t|                                                               |\n" +
...
create_room()
{
    ...
    add_exit("corral", "east", yard_security);
...
yard_security()
{
    ...
    write("You can't seem to climb over the coral fence.\n");
    return 1;
}

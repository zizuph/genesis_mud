...
long_desc()
{
    string text = "A " + desc1 + " " + TO->query_real_name() +
    " with a mane braided in the style of horses from Rohan. " +
    capitalize(HIS_HER(TO)) + " lustrous " + desc2 +
    " coat and sheeny black tail give proof " + HE_SHE(TO) +
    " is well cared for. ";
    ...
    {
        return text + additional_longdesc() + " Do 'hhelp' to see emotes and commands.\n";
    }
...
add_desc()
{
    ...
    adj1 = ({"fleet-footed", "gentle", "haughty", "muscular", "noble", "proud", "sleek", "splendid", "swift"});
    adj2 = ({"brown", "flaxen", "auburn", "chestnut", "tan"});

...
{
    object steed = query_steed();
    write("Your " + steed->query_short() + " rears up on its back legs, " +
        "nearly dumping you to the ground. It paws the air emphatically, " +
        "then drops back to the ground.\n");
    say(QCTNAME(TP) + "'s " + steed->query_short() + " rears up on its " +
        "back legs, nearly dumping " + QCTNAME(TP) + " to the ground. " +
        "It paws the air emphatically, then drops to the ground.\n");
    return 1;
}
...
{
    object steed = query_steed();
    write("Your " + steed->query_short() + " paws the ground anxiously.\n");
    say(QCTNAME(TP) + "'s " + steed->query_short() + " paws the ground anxiously.");
    return 1;
}

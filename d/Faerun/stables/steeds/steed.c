...
#include "/d/Faerun/stables/stables.h"
#include "/d/Faerun/stables/steeds/steed.h"

inherit "/d/Genesis/steed/new/steed";
//inherit "/d/Faerun/stables/steeds/steed_base.c";
...
inherit "/d/Faerun/lib/kill_logger";
...
create_steed()
{
    ...
    set_leader_object_file(LEADER_OBJECT);
...
{
    object *ob_list;
    ob_list = object_clones(find_object("/d/Faerun/stables/steed/steed"));
    dump_array(ob_list);
}
...
*/
    ...
    desc1 = ONE_OF_LIST(adj1);
    desc2 = ONE_OF_LIST(adj2);
...
init_living()
{
    ...
    add_action(do_dismount, "dismount_all");

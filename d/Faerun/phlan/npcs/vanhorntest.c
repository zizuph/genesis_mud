...
*/
    ...
    if(this_player()->test_bit(DOMAIN, PHLAN_TOUR4_QUEST_GROUP, 
            PHLAN_TOUR4_QUEST_BIT))
    {
    ...
    if(this_player()->test_bit(DOMAIN, PHLAN_TOUR3_QUEST_GROUP, 
            PHLAN_TOUR3_QUEST_BIT))
    {
    ...
    if(this_player()->test_bit(DOMAIN, PHLAN_TOUR2_QUEST_GROUP, 
            PHLAN_TOUR2_QUEST_BIT))
    {
        ...
        +" and then come back here and ask for your reward.", 1;
        this_player()->add_prop("_phlan_tour3_start", 1);         
    }
    
    if(this_player()->test_bit(DOMAIN, PHLAN_TOUR1_QUEST_GROUP, 
            PHLAN_TOUR1_QUEST_BIT))
    {
        ...
        +" post office and then come back here and ask for your reward.", 1;
        this_player()->add_prop("_phlan_tour2_start", 1);         
    }
    
    {
        command("say Phlan is a safe town. We have almost no crime and a big part of"
...
ask_reward_func()
{
    if(this_player()->query_prop("_phlan_tour1_prop"))    
    {
        ...
        this_player()->set_bit(PHLAN_TOUR1_QUEST_GROUP, PHLAN_TOUR1_QUEST_BIT);
        this_player()->add_exp_quest(PHLAN_TOUR1_QUEST_EXP);
            
        QUEST_LOG_FILE(PHLAN_TOUR1_QUEST_LNG, PHLAN_TOUR1_QUEST_EXP);        
        return 0;
    }
    ...
    if(this_player()->query_prop("_phlan_tour2_prop"))    
    {
        ...
        // add experience to be determined
        this_player()->set_bit(PHLAN_TOUR2_QUEST_GROUP, PHLAN_TOUR2_QUEST_BIT);
        this_player()->add_exp_quest(PHLAN_TOUR2_QUEST_EXP);
            
        QUEST_LOG_FILE(PHLAN_TOUR2_QUEST_LNG, PHLAN_TOUR2_QUEST_EXP);         
        return 0;
    }
    ...
    if(this_player()->query_prop("_phlan_tour3_prop"))    
    {
        ...
        // add experience to be determined
        this_player()->set_bit(PHLAN_TOUR3_QUEST_GROUP, PHLAN_TOUR3_QUEST_BIT);
        this_player()->add_exp_quest(PHLAN_TOUR3_QUEST_EXP);
            
        QUEST_LOG_FILE(PHLAN_TOUR3_QUEST_LNG, PHLAN_TOUR3_QUEST_EXP);         
        return 0;
    }
    ...
    if(this_player()->query_prop("_phlan_tour4_prop"))    
    {
        ...
        // add experience to be determined
        this_player()->set_bit(PHLAN_TOUR4_QUEST_GROUP, PHLAN_TOUR4_QUEST_BIT);
        this_player()->add_exp_quest(PHLAN_TOUR4_QUEST_EXP);
            
        QUEST_LOG_FILE(PHLAN_TOUR1_QUEST_LNG, PHLAN_TOUR4_QUEST_EXP);        
        return 0;
    }    

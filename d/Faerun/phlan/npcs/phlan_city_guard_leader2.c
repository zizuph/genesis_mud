...

{
    ...
    set_living_name("hanna");
    set_name("hanna"); 
    add_name("guard");     
    set_title("city guard leader");    
    set_race_name("human");
    set_adj( ({"iron-thewed", "calculating"}) );         
    set_gender(G_FEMALE);    

    set_short("iron-thewed calculating female human"); 
    set_long("This is one of the leaders of the city guards of Phlan. She looks like" +
...
*/        
    ...
    add_prop(CONT_I_WEIGHT, 72576);
    add_prop(CONT_I_HEIGHT, 167);    
...
*/
    ...
    set_chat_time(30);
    add_chat("Phlan has the best drilled guards on the Moonsea.");
    add_chat("Councilman Van Horn was a powerful warrior in his youth.");

    set_act_time(25);
    add_act("emote eyes you suspiciously.");
    
    set_cchat_time(10);
    add_cchat("Flee enemy of Phlan!");   

    set_cact_time(10);
    add_cact("emote parries your blow with ease.");    

...
create_phlan_outdoor()
{
    extraline = "Podol Plaza is a field of short clipped, manicured grass."
                ...
                +" the plaza, where the city wall runs east and west. To the"
...
*/
    ...
    add_exit(PODOL_DIR + "pa6", "northwest"); 
    add_exit(PODOL_DIR + "pp54", "east"); 
    add_exit(PODOL_DIR + "pp56", "west");        

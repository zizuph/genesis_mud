...
create_phlan_outdoor()
{
    extraline = "The road is of hard packed dirt. Far to the east is the"
                ...
                +" north lies the Stojanow Gate and beyond that Valjevo"
...
*/    
    ...
    add_exit(PODOL_DIR + "pps12", "east");    
    add_exit(PODOL_DIR + "pps14", "west"); 
    add_exit(PODOL_DIR + "pp8", "southeast");   
    add_exit(PODOL_DIR + "pp9", "south");     
    add_exit(PODOL_DIR + "pp10", "southwest");      

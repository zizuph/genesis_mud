...
{
    extraline = "A stark change from the limestone streets of Phlan, Podol"
                +" Street is hard packed dirt. To the east it enters the"
                +" gate through the city wall back into the town itself and"
                +" to the west it extends eventually to the bridge over the"
                +" Stojanow River. Between here and there are Kuto's Well"
                +" and Podol Plaza.";
...
*/    
    ...
    add_exit(ROOM_DIR + "gate", "east");    
    add_exit(PODOL_DIR + "pps2", "west");    

...
*/
    ...
    add_room_tell("A runner for the city guard walks towards the well with several"
        +" empty waterskins.");       


    reset_faerun_room();

    add_exit(PODOL_DIR + "pps4", "northeast");         
    add_exit(PODOL_DIR + "pps5", "north");    
    add_exit(PODOL_DIR + "pps6", "northwest"); 
    add_exit(PODOL_DIR + "pp1", "east");     
    add_exit(PODOL_DIR + "pp3", "west"); 
    add_exit(PODOL_DIR + "pp12", "southeast");     
    add_exit(PODOL_DIR + "kw", "south");
    add_exit(PODOL_DIR + "pp13", "southwest");    

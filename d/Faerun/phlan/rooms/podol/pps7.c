...
*/    
    ...
    add_exit(PODOL_DIR + "pps6", "east");    
    add_exit(PODOL_DIR + "pps8", "west");  
    add_exit(PODOL_DIR + "pp3", "southeast");   
    add_exit(PODOL_DIR + "pp4", "south");
    add_exit(PODOL_DIR + "pp5", "southwest");    

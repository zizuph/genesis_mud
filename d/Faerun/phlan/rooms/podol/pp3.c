...
*/
    ...
    add_room_tell("A light breeze kicks up a swirl of dust on the road to the north.");       


    reset_faerun_room();

    add_exit(PODOL_DIR + "pps5", "northeast");         
    add_exit(PODOL_DIR + "pps6", "north");    
    add_exit(PODOL_DIR + "pps7", "northwest"); 
    add_exit(PODOL_DIR + "pp2", "east");     
    add_exit(PODOL_DIR + "pp4", "west"); 
    add_exit(PODOL_DIR + "kw", "southeast");     
    add_exit(PODOL_DIR + "pp13", "south");
    add_exit(PODOL_DIR + "pp14", "southwest");    

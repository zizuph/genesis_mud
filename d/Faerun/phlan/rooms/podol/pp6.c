...
*/
    ...
    add_exit(PODOL_DIR + "pps8", "northeast");         
    add_exit(PODOL_DIR + "pps9", "north");    
    add_exit(PODOL_DIR + "pps10", "northwest"); 
    add_exit(PODOL_DIR + "pp5", "east");     
    add_exit(PODOL_DIR + "pp7", "west"); 

...
create_phlan_outdoor()
{
    extraline = "The road is of hard packed dirt. To the east it leads to the"
                ...
                +" disctrict. Kuto's Well is to the south and east and Podol Plaza is"
                +" to the southwest.";
...
*/    
    ...
    add_exit(PODOL_DIR + "pps7", "east");    
    add_exit(PODOL_DIR + "pps9", "west");  
    add_exit(PODOL_DIR + "pp4", "southeast");   
    add_exit(PODOL_DIR + "pp5", "south");
    add_exit(PODOL_DIR + "pp6", "southwest");    

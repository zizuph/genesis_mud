...
create_phlan_outdoor()
{
    extraline = "Podol Plaza is a field of short clipped, manicured grass."
                ...
                +" and to the west Podol Avenue crosses the market south"
                +" to north. A nondescript tan tent is northwest at the"
                +" corner of the market. The wall surrounding the plaza"
...
*/    
    ...
    add_item(({"wall", "city wall"}),
        ...
        +" is the southeastern corner of the wall as it turns west"
    ...
    add_item(({"trader's way"}),
        "The road of cobblestones crosses the market from east to west,"
...
*/
    ...
    add_room_tell("A swirl and eddy of breeze ruffles the grass at the"
        +" wall's corner.");      


    reset_faerun_room();

    add_exit(PODOL_DIR + "pp46", "north"); 
    add_exit(PODOL_DIR + "pp54", "west");        

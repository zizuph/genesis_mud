...
*/
    ...
    add_room_tell("Water swirls around the pilings of the bridge.");    

    add_room_tell("Dragonflies buzz along the riverbank.");        
             

    reset_faerun_room();
           
    add_exit(PODOL_DIR + "vhs1", "northwest"); 
    add_exit(PODOL_DIR + "pp16", "southeast");        

...
create_phlan_outdoor()
{
    extraline = "Podol Plaza is a field of short clipped, manicured grass."
                ...
                +" to the east. The market itself is to the west.";
...
*/
    ...
    add_exit(PODOL_DIR + "pp3", "northeast");         
    add_exit(PODOL_DIR + "pp4", "north");    
    add_exit(PODOL_DIR + "pp5", "northwest"); 
    add_exit(PODOL_DIR + "pp13", "east");     
    add_exit(PODOL_DIR + "pp15", "west"); 
    add_exit(PODOL_DIR + "pp21", "southeast");     
    add_exit(PODOL_DIR + "pp22", "south");
    add_exit(PODOL_DIR + "pp23", "southwest");    

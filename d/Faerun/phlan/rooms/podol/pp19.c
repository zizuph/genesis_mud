...
create_phlan_outdoor()
{
    extraline = "Podol Plaza is a field of short clipped, manicured grass."
                ...
                +" feet every year. Podol Street lies to the north. Kuto's Well"
                +" is directly to the northwest. The city wall to the east and south"
                +" surrounds the plaza, a remnant of the wilder days of the area."
                +" It is still well maintained and functional.";
...
*/
    ...
    add_exit(PODOL_DIR + "pp12", "north");     
    add_exit(PODOL_DIR + "pp20", "west");   
    add_exit(PODOL_DIR + "kw", "northwest");    

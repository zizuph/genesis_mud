...
*/    
    ...
    add_item(({"image", "scene"}),
        ...
        +" showing an adventuring party clearing a mixed group of orcs"
        +" and kobolds from Kuto's Well.\n");
    ...
    add_exit(ROOM_DIR + "ch1", "west");
    add_exit(ROOM_DIR + "cho1", "north");
}

...
/*
*   Making the basic room. Will have 4 guards.
*/

void
create_phlan_outdoor()
{
    extraline = "This broad avenue continues north and south or enters the"
                +" gate through the city wall. An entrance to the east leads"
                +" to the church. To the northwest the guardhouse maintains"
                +" watch over the gate. A large building stands to the north."
...
*/    
    ...
    add_item(({"wall", "city wall"}),
        ...
        +" guardhouse stands to the northwest.\n");
    ...
    add_item(({"marketplace"}),
        "The marketplace is colorful and busy.\n");       
    ...
    add_exit(ROOM_DIR + "road5", "north");
    add_exit(ROOM_DIR + "church1", "east");    
    add_exit(ROOM_DIR + "road7", "south");
    add_exit(ROOM_DIR + "gate", "west");    

...
*/    
    ...
    add_room_tell("A butterfly flutters past to land on a flower.");        
        


    reset_faerun_room();
        
    add_exit(ROOM_DIR + "park2", "northwest"); 
    add_exit(ROOM_DIR + "park3", "north");   
    add_exit(ROOM_DIR + "park5", "west");    

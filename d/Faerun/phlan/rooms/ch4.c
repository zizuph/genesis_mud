...
*/     
    ...
    add_item(({"image", "scene"}),
        ...
        +" showing the entire city being transported to an enormous"
        +" underground cavern by an insane Red Wizard of Thay only to"
        +" be foiled by the original heroes of Phlan.\n");
    ...
    add_exit(ROOM_DIR + "ch3", "east");
    add_exit(ROOM_DIR + "cho3", "west");
}

...
create_phlan_outdoor()
{
    extraline = "This park is a garden oasis in the center of the city."
        ...
        +" north. The garden is full of verdant flowers, plants, shrubs"
...
*/    
    ...
    add_item(({"hedge", "bushes"}),
        ...
        +" casual observation. An entrance through the hedge is to the north.\n");
    ...
    add_item(({"entrance", "arch"}),
        ...
        +" The entrance stands directly to the north.\n");         
    ...
    add_exit(ROOM_DIR + "park3", "east");
    add_exit(ROOM_DIR + "road8", "north");  
    add_exit(ROOM_DIR + "park1", "west"); 
    add_exit(ROOM_DIR + "park5", "south");   
    add_exit(ROOM_DIR + "park4", "southwest");
    add_exit(ROOM_DIR + "park6", "southeast");    

...
*/    
    ...
    add_room_tell("A gentle wind rustles the branches of a nearby tree.");    
        


    reset_faerun_room();
        
    add_exit(ROOM_DIR + "park2", "east"); 
    add_exit(ROOM_DIR + "park4", "south");   
    add_exit(ROOM_DIR + "park5", "southeast");    

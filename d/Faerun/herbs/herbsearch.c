 ...
 *
 * Modified and updated so Faerie has an herbing system. Thanks Shire!! :)
...
#ifndef FAERUN_HERB_MASTER
#define FAERUN_HERB_MASTER "/d/Faerun/herbs/herb_master.c"
#endif
...
string *terrain = ({"road","path","forest","meadow","plains","hills",
  "hill","plain","grassland","grasslands", "woods", "field"});
int no_grow = 0;
 ...
 * Example to add additional herbs to room:
 *
...
add_std_herbs(mixed type, int seed)
{
    ...
    herb_list = FAERUN_HERB_MASTER->query_herbs(type);
...
/*
 * Function name: reset_faerun_herbs()

...
#define HERBS ({ GONDOR_HERB_DIR + "alfirin", \
                 ...
                 GONDOR_HERB_DIR + "niphredil", \
                 GONDOR_HERB_DIR + "oregano", \
                 GONDOR_HERB_DIR + "peanut", \
                 GONDOR_HERB_DIR + "raspberry", \
                 GONDOR_HERB_DIR + "red_pepper", \

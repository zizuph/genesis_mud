...
string extraline = "The trail passes by trees and bushes, heading north and southwest.";

void
create_forest()
{

    set_short("The southeast border of" + FOR_NAME);
    set_extraline(forest_descr2(extraline));

    set_add_forest();
    
    add_exit(FOR_DIR + "kr12", "north");
    add_exit(FOR_DIR + "kr04", "southwest");
    reset_faerun_room();
}

...
#define MAX_NPCS        3
string extraline = "The trail winds past bushes and trees.";
...
create_forest()
{
    ...
    add_exit(FOR_DIR + "kr33", "northwest");
    add_exit(FOR_DIR + "kr34", "northeast");
    add_exit(FOR_DIR + "kr23", "southeast");
    add_exit(FOR_DIR + "kr22", "southwest");
    reset_faerun_room();
}

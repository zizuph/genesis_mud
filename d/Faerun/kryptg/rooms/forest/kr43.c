...
string extraline = "A deep ravine cuts through the forest.";
...
create_forest()
{
    ...
    add_exit(FOR_DIR + "kr46", "northwest");
    add_exit(FOR_DIR + "kr47", "northeast");
    add_exit(FOR_DIR + "kr39", "southeast");
    add_exit(FOR_DIR + "kr38", "southwest");
    reset_faerun_room();
}

...
string extraline = "Hidden by the trees is an ancient citadel to the west.";
...
create_forest()
{
    ...
    add_exit(FOR_DIR + "kr32", "northwest");
    add_exit(FOR_DIR + "kr33", "northeast");
    add_exit(FOR_DIR + "kr22", "southeast");
    add_exit(FOR_DIR + "kr21", "southwest");
    reset_faerun_room();
}

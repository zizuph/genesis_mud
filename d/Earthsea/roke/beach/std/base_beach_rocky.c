...
beach_desc()
{
    switch(random(4))
    {
        ...
        case 1:
            ...
            "across the beach. The salty air blows past you " +
        ...
        break;
        default:
            return "Gravel, rocks, and an occasional large rock " +
            ...
            "Small crustaceans move about the " +
             "rocks as they scramble for safety. " +
            "@@tide_dependent@@";
    }
}
...
tide_tell()
{
    ...
    if(tide <= 1)
    {
        return "The calm water of the low tide brings the " +
...
create_earthsea_room()
{
    ...
    add_item ("rocky beach",
      "The beach is rocky and coarse. Gravel and rocks make " +
      "up the coastline. The beach crunches under your feet " +
    ...
    set_up_herbs(select_herb_files(BEACH_HERBS), BEACH_LOCATIONS, 3);
}

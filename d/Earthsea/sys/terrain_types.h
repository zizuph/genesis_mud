/* /d/Earthsea/sys/terrain_types.h - #defines for terrain types
 *
...
#define TERRAIN_MIXEDWOOD    (TERRAIN_FOREST)
#define TERRAIN_CONIFEROUS   (TERRAIN_FOREST)
#define TERRAIN_DECIDUOUS    (TERRAIN_FOREST)
...
#define TERRAIN_UGART        (TERRAIN_UNDERGROUND | TERRAIN_INART | \
                              TERRAIN_SHADY)
#define TERRAIN_ACAVETUNNEL  (TERRAIN_UGART)

...
create_weapon()
{
  ...
  set_short("goat herder's staff");
  set_pshort("goat herder's staffs");
  
  set_long("A goat herder's staff. As tall as a person, this staff " +
	   "allows a goat herder to rest his legs. It is also quite " +

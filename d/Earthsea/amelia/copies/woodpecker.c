...
create_monster()
{
   ...
   add_prop(OBJ_I_NO_MAGIC_ATTACK,"A forcefield protects the woodpecker.\n");
   
   add_ask(({"blue dragon","dragon"}),"Woodpecker says: I've heard that the dragon was a wizard before.\n");
   ...
   add_ask("jhonlee","Woodpecker says: Jhonlee meditates beyond the Stairs to the Sky.\n");
    add_ask("healer","Woodpecker says: Jhonlee meditates beyond the Stairs to the Sky.\n");
...
tenk()
{
   TP->catch_msg("I think I have found the solution to your problems.\n\n"+
      ...
      "Carisca, which is told to be somewhere south of Re Albi.\n\n"+

...
public void init_smith();
public int calc_mend_value(object obj);
public int calc_wax_value(object obj);
public int calc_sharpen_value(object obj);
public int distort(int price);

public int check_smith_active() { return 1; } // use if smith not here?

public void
notify_smith_inactive()
{
   write("The smith is not here to help you.\n");
}
...
init_smith()
{
   add_action(do_fix, "mend");
   add_action(do_fix, "sharpen");
   add_action(do_fix, "wax");

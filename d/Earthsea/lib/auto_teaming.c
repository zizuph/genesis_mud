/*  Borrowed with permission from Aridor, 12/97 */
 ...
 * 3) In create_monster(), call set_pick_up(<arg>); where arg is one of the
 *    following:   a string              eg.  "baaz"
 *                 an array of strings   eg.  ({"baaz","bozak"});

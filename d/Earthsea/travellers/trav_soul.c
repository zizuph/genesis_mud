...
public string emotes_help();
public string male_titles_help();
public string female_titles_help();
public string carving_help();
...
tkiller(string str)
{
    ...
    return default_emote(({ str, 6, "Killer what?\n",
        ...
        "in case a horrible monster happens to lurk behind you.\n",
...
public int
sort_names(object ob1, object ob2)
{
...
_tl(string str)
{
    ...
    if (!this_player()->query_wiz_level())
    {
        ...
        members = filter(members,
           &not() @ &wildmatch("*jr") @ &->query_real_name()
        );
    }
    ...
    write("The following Travellers are currently abroad in the realms:\n");

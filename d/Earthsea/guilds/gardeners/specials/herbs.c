...
private int _specials_member_herbs_count;
...
public int
query_gardener_member_herbs_count()
{
    return _specials_member_herbs_count;
}
...
init_gardener_herbs()
{
   ...
   _specials_member_herbs_count = sz;
...
enter_inv(object ob, object old)
{
   ...
   if(member_array(name, _specials_known_herbs) == -1)
   {
      ...
      if(member_array(id, _specials_herb_varieties) == -1)
      {
         ...
         _specials_member_herbs_count += 1;

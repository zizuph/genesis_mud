...
/* --- Herb variants required for max title --- */
#define GARDENER_MAX_HERBS 200
#define GARDENER_MAX_RANK (GARDENER_NUM_TITLES - 1)
#define GARDENER_RANK_MOD (GARDENER_MAX_HERBS / GARDENER_MAX_RANK)
...
#define GARDENER_PAGES ({ \
	"very thin", "thin", "compact", "thick", "very thick", "hefty" \
})

...
create_camp()
{
    ...
    add_long("There is a large tent here. The camp extends to the east, " +
        "south, and west.\n");
    ...
    add_exit("karg_camp02", "east");
    add_exit("karg_camp06", "south");
    add_exit("karg_camp08", "west");
    reset_room();
}
...
tent(string str)
{
    if(str == "tent")
    {
        this_player()->move_living("entering the tent",
            "/d/Earthsea/gont/tenalders/south_path/camp_1/tent05");
        return 1;
    }

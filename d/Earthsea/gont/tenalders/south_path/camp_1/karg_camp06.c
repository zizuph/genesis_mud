...
create_camp()
{
    ...
    add_long("There is a large tent here. The camp extends in all " +
        "directions.\n");
    ...
    add_exit("karg_camp05", "north");
    add_exit("karg_camp03", "east");
    add_exit("karg_camp07", "south");
    add_exit("karg_camp09", "west");
    reset_room();
}
...
tent(string str)
{
    if(str == "tent")
    {
        this_player()->move_living("entering the tent",
            "/d/Earthsea/gont/tenalders/south_path/camp_1/tent06");
        return 1;
    }

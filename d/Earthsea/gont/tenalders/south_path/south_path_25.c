...
create_herb_room()
{
    ...
    set_long("Tall evergreen trees mark the beginning of an " +
        ...
        "a path to a wooden bridge and to the northeast the path " +
        "ascends toward the darker forest.\n");
    ...
    add_exit("south_path_26", "west");
    add_exit("south_path_24", "northeast");
}

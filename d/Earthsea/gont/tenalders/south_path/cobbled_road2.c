...
create_earthsea_room()
{
    ...
    set_long("The cobblestone road lies like a " +
        ...
        "road bends to the north. To the south the " +
        "great stone walls of Gont Port stand like a fortress " +
        "with its gaily coloured banners fluttering on the towers.\n");
    ...
    add_exit("cobbled_road1", "southeast");
    add_exit("cobbled_road2a", "north", 0, 2);
}

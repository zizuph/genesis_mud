...
create_earthsea_room()
{
    ...
    set_long("The cobblestone road lies like a " +
        "ribbon across green farmland on the hillside. " +
        ...
        "sheep. The road rises steeply to the east. To the southwest " +
        "you see the great dark stone walls of Gont Port. Beyond " +
        "the city ships sail in and out of the busy harbour. The " +
        "dark blue sea extends to a line of blue where it meets the " +
        "horizon far to the south.\n");
    add_item((({"sea", "blue sea", "horizon" })), "The dark blue " +
        "Gont Sea lies some distance south, and many ships frequent " +
        "the busy harbour of Gont Port.\n");
    ...
    add_exit("hilltop", "east");
    add_exit("cobbled_road2d", "southwest");
}

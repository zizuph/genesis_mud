...
create_earthsea_room()
{
    ...
    set_long("The cobblestone road lies like a " +
        ...
        "road climbs steeply northeast and descends southwest. " +
        "To the southwest you see the " +
        "great dark stone walls of Gont Port with its colourful " +
        "fluttering banners on the towers.\n");
    ...
    add_exit("cobbled_road3", "northeast");
    add_exit("cobbled_road2c", "southwest");
}

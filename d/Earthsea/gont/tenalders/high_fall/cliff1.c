...
create_earthsea_room()
{
    ...
    set_next_up("/d/Earthsea/gont/tenalders/high_fall/cliff2");
    set_next_down("/d/Earthsea/gont/tenalders/high_fall/ne7");
    ...
    add_tell("Your grasp on the rock slips, and you almost fall!\n");
    reset_room();
    set_tell_time(30);
}

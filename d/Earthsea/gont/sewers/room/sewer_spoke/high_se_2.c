/*
 *  /d/Earthsea/gont/sewers/room/sewer_spoke/high_se_2.c
 *
 *  This is a spoke room of the sewers of Gont. 
 *
 * According to the current Gont map:
 * What should be above me? 
 * uncoded buildings -- SE Gont
 * 
 *
 * What is above and nearby?
 * North: Narrow street. (city_road25)
 * South: x (x)
 * East: wall? (x)
 * West: Narrow street. (city_road24)
 *
...
/* Defines */
#define            FALL_LOCATION (SEWER_SPOKE + "high_se_1")
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_SPOKE + "high_se_1", "west", 0);

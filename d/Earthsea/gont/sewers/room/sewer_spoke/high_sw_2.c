/*
 *  /d/Earthsea/gont/sewers/room/sewer_spoke/high_sw_2.c
 *
 *  This is a spoke room of the sewers of Gont.
 *
 * According to the current Gont map:
 * What should be above me? 
 * "Within a grove of oak trees" -- Southwest Gont
 * /d/Earthsea/gont/gont_city/rooms/park_1
 *
 ...
 * East: x(x)
 * West: park(x)
 * NE: Street northeast of a large park 
 *      (../gont_city/rooms/city_street/city_road13.c)
 * SW: Wide grass lawn. (../gont_city/rooms/park_2)
 *
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_SPOKE + "high_sw_1", "northeast", 0);
    add_exit(SEWER_SPOKE + "high_sw_3", "west", 0);
    
    set_flow_speed(5.0);
	set_downstream_dir("northeast");    
}   /* create_sewer_room */

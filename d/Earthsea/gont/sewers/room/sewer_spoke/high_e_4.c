/*
 *  /d/Earthsea/gont/sewers/room/sewer_spoke/high_e_4.c
 *
 ...
 * /d/Earthsea/gont/gont_city/rooms/city_street/city_road26
 *
 * What is above and nearby?
 * North: Street just west of the city wall. (city_road27)
 * South: Narrow street. (city_road25)
 * East: Wall (x)
 * West: warehouse? (x)
 *
...
/* Defines */
#define            FALL_LOCATION (SEWER_SPOKE + "high_e_3")
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_SPOKE + "high_e_3", "west", 0);

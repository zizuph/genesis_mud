/*
 *  /d/Earthsea/gont/sewers/room/sewer_spoke/high_nw_6.c
 *
 *  This is a spoke room of the sewers of Gont. 
 *
 * According to the current Gont map:
 * What should be above me? 
 * Uncoded buildings  -- NW Gont
 * This is a possible room for expansion into the buildings.
 *
 * What is above and nearby?
 * North: building (x)
 * South: Narrow street in the living quarters. (city_road4)
 * East: building (x)
 * West: building (x)
 *
...
/* Defines */
#define            FALL_LOCATION (SEWER_SPOKE + "high_nw_5")
...
create_tunnel_room()
{
    ...
    /* Exits Section */
    add_exit(SEWER_SPOKE + "high_nw_5", "south", 0);

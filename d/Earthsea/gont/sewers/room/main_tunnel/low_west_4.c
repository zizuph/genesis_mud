/*
 *  /d/Earthsea/gont/sewers/room/main_tunnel/low_west_4.c
 *
 ...
 * NORTH: Buildings (x) 
 * SOUTH: Water (x) 
 * EAST: North of a long pier. (city_road17) 
 * WEST: Buildings (x)
 * NW: Inside a warehouse. (warehouse2)
 * SW: Northwest side of the harbour. (city_road10)
 * 
 * 
...
create_tunnel_room()
{
    ...
    set_long_extra("The main tunnel runs upstream to the east "
    ...
    /* Exits Section */
    add_exit(SEWER_MAIN_TUNNEL + "low_center", "east", 0);
	add_exit(SEWER_MAIN_TUNNEL + "low_west_3", "southwest", 0);  

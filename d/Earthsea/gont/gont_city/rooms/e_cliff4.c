...
create_room()
{
    ...
    set_long("This is the east side of the "+
        ...
        "fist. You are on a narrow path which runs south from "+
        "here. There is a magnificent view of the surrounding area "+
        "and coast. The path leads up toward a pile of boulders.\n");
    ...
    add_item((({"tower", "granite tower", "guard tower"})),
        ...
        "out over the coast.\n");
    add_exit("city_street/city_road21", "northwest");
    add_exit("e_cliff3", "south");
    add_exit("roc_nest", "up");
}

...
#define GUARD4 "/d/Earthsea/gont/gont_city/liv/guard4"
...
create_room()
{
    ...
    set_short("Southeast corner of guard tower (third floor)");
    set_long("This is the southeast corner "+

...
create_room()
{
    ...
    set_short("First floor of guard tower");
    set_long("You are standing inside "+
    ...
    add_exit("city_street/city_road1a", "north");
    add_exit("tower_ne1", "northeast");
    add_exit("tower_nw1", "northwest");
    add_exit("tower_se1", "southeast");
    add_exit("tower_sw1", "southwest");
    add_exit("tower_2", "up");
}

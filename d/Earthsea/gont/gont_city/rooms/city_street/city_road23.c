...
create_room()
{
    ...
    set_long("The quay ends and the cobbled road"+
        ...
        " stone tower built on top of it. A rocky path leads "+
        "to the south. You can see"+
        " a stairway cut out from the granite rock leading"+
        " upwards.\n");
    ...
    add_exit("../east_stairs", "up");
    add_exit("city_road22", "northeast");
    add_exit("city_road23a", "south");
}

/* Alco bottle by Milan.
   ...
   Keep added, Maniac, 8/6/96 
    ...
    borrowed from Calia by Amelia, with permission of
      Uhclem -- 3/12/98
*/
...
static  object  *gFail = ({ });
int reset_bottle(int am1, int am2, string str);
...
int
reset_bottle(int am1, int am2, string str)
{
    TO->set_soft(am1);
    TO->set_alco(am2);
    filled_short += ({ str });

...
create_earthsea_room()
{
    ...
    set_long(break_string("You stand uncertainly upon a "+
	"swaying rope bridge, which "+
	"is suspended from the cliff edge across a deep rift. "+
	"A white mist swirls all around you, making it impossible to "+
	...
	"Far below you hear the roaring sound of water swirling "+
	"in a maelstrom.\n", 70));
    ...
    add_exit(BRIDGE + "bridge2.c", "north", 0, 2, 0);
    add_exit(ROKE_MOUNT, "south", 0, 2, 0);
}

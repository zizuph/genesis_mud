/*
 *  /d/Earthsea/common/arm/wearable_item.c
 *
 *  The standard wearable_item object of Earthsea.  
 *
 *  Example usage: (see ~Earthsea/std/examples/necklace)
 *  To create a wearable item redefine create_earthsea_wearable_item.
 *  That's all there is to it. Remember to set the size of the item
 *  by calling set_earthsea_wearable_item_size. For special checks
 *  when the item is worn or removed redefine wear_earthsea_item and 
 *  remove_earthsea_item respectively. 
 *
 *  inherit "/d/Earthsea/lib/wearable_item";
 *
 *  #include <ss_types.h>
 ...
 *
 *      write("You fasten the "+short()+" around your neck.\n");
...
//** prototypes **//
public void   create_earthsea_wearable_item();
public mixed  wear_earthsea_item(object o);
public mixed  remove_earthsea_item(object o);
...
create_object()
{
     ...
     */
    config_wearable_item(A_NO_T, 0, 0, this_object());
    set_name("_std_earthsea_wearable_item");
    create_earthsea_wearable_item();
}


/*
 * Function name: wear_earthsea_item
 ...
 *                this function, instead use wear_earthsea_item.
 * Arguments    : object item - The item we want to wear.
 * Returns      : see wear_earthsea_item
 */

public mixed
wear(object item)
{
    return wear_earthsea_item(item);
}


/*
 * Function name: remove_earthsea_item
 ...
 *                this function, instead use remove_earthsea_item.
 * Arguments    : object item - The item we want to remove.
 * Returns      : see remove_earthsea_item
 */

public nomask mixed
remove(object item)
{
    return remove_earthsea_item(item);
}

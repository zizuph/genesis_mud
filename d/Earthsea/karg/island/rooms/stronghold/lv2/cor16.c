...
void create_stronghold_room()
{
 ...
 set_long("You are in the dark and broad corridor on the second level "+
   ...
   "Smaller corridor splits, running towards south.\n");
 ...
 add_exit(STRHOLD_LVL2+"cor15","southeast");
 add_exit(STRHOLD_LVL2+"cor17","northwest");
 add_exit(STRHOLD_LVL2+"cor25","south");
}

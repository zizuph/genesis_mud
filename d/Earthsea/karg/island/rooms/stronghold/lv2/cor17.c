...
void create_stronghold_room()
{
 ...
 set_long("You are in the dark and broad corridor on the second level "+
   ...
   "Corridor here seems to split as new one leads towards northeast.\n");
 ...
 add_exit(STRHOLD_LVL2+"cor16","southeast");
 add_exit(STRHOLD_LVL2+"cor18","west");
 add_exit(STRHOLD_LVL2+"cor22","northeast");
}

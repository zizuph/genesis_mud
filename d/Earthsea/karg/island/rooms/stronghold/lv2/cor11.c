...
void create_stronghold_room()
{
 ...
 set_long("You are in the dark and broad corridor on the second level "+
   ...
   "To the southwest you see some kind of guard room.\n");
 ...
 add_exit(STRHOLD_LVL2+"cor10","northwest");
 add_exit(STRHOLD_LVL2+"cor12","east");
 add_exit(STRHOLD_LVL2+"guard1","southwest");
}

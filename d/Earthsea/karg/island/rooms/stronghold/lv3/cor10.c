...
void create_stronghold_room()
{
 ...
 set_long("You are in the main circle corridor on the third level "+
   ...
   "northwest , while smaller corridor splits towards east.\n");
 ...
 add_exit(STRHOLD_LVL3+"cor9","southeast");
 add_exit(STRHOLD_LVL3+"cor22","east");
 add_exit(STRHOLD_LVL3+"cor11","northwest");
}

...
void create_stronghold_room()
{
 ...
 set_long("You are in the main circle corridor on the third level "+
   ...
   "northwest , while smaller corridor splits towards west.\n");
 ...
 add_exit(STRHOLD_LVL3+"cor1","northwest");
 add_exit(STRHOLD_LVL3+"cor17","west");
 add_exit(STRHOLD_LVL3+"cor3","southeast");
}

...
void create_stronghold_room()
{
 ...
 set_long("You are in the small corridor on the third level "+
   "of the stronghold. Corridor running from north ends here. "+
   "To southwest and southeast you see small round rooms.\n");

 add_exit(STRHOLD_LVL3+"cor18","north");
 add_exit(STRHOLD_LVL3+"down1","southwest");
 add_exit(STRHOLD_LVL3+"down2","southeast");
     ...
     switch(i)
      {
       ...
       case 3: to_clone="eguard"; break;
       case 4: to_clone="guard"; break;
      }

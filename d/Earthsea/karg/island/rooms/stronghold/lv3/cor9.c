...
void create_stronghold_room()
{
 ...
 set_long("You are in the main circle corridor on the third level "+
   ...
   "northwest , while smaller corridor splits towards north.\n");
 ...
 add_exit(STRHOLD_LVL3+"cor8","northeast");
 add_exit(STRHOLD_LVL3+"cor10","northwest");
 add_exit(STRHOLD_LVL3+"cor22","north");
}

...
void create_stronghold_room()
{
 ...
 set_long("You are in the dark corridor leading north and south. "+
   "Corridor splits to the west , where smaller corridor leads to.\n");
 ...
 add_exit(STRHOLD_LVL1+"cor2","south");
 add_exit(STRHOLD_LVL1+"cor4","north");
 add_exit(STRHOLD_LVL1+"cor37","west");

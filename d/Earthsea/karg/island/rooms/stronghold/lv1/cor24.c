...
void create_stronghold_room()
{
 ...
 set_long("You are in the small and dark corridor in the stronghold. "+
   "It is very dusty and narrow. Some really small and narrow "+
   "corridor leads west of here.\n");

 add_exit(STRHOLD_LVL1+"cor23","south");
 add_exit(STRHOLD_LVL1+"cor25","northwest");
 add_exit(STRHOLD_LVL1+"cor29","west");

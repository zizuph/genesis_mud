...
create_island_room()
{
	...
	set_long("You are approaching a dense forest. To the "+
		 ...
		 " grass and low bushes. To the south you see "+
		 "a small bay. Forest to the east is "+
                 "very dense , you wonder whether you should "+
                 "look for another entrance.\n\n");

	add_exit("shore5","north");
	add_exit("docks","south");
	add_exit(FROOMS+"/forest0","east","@@enter_forest");
	add_exit("shore3","west");
	
	add_item("bay","You can hardly see anything from this "+
		 "angle. Perhaps you should come closer.\n\n");

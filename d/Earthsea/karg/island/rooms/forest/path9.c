...
create_island_room()
{
	...
	set_long("You are on a path leading through dark forest. "+
		 ...
		 "west and follows east. To the east the forest "+
		 "seems much lighter.\n\n");
	...
	add_exit(FROOMS+"/path11","east","@@road_works");
	add_exit(FROOMS+"/path8","west");
...
road_works()
{
	write("You feel your breath ease. The forest looks "+
		"much less threatening here.\n\n");
	return 0; 
}

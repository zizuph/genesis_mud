...
create_island_room()
{
 ...
 set_long("Path continues runing through the green valley. Back to "+
   "south you can figure out high hills. You are approaching the "+
   "trully amazing structure - karg stronghold. You can see it "+
   "prety well from here, and what you see makes you hold your "+
   "breath.\n");
 ...
 add_exit(FROOMS+"/path22","northeast");
 add_exit(FROOMS+"/path20","southwest");
}

...
create_room()
{
    ...
    set_long("This small path heads into a light forest area.  " +
        ...
        "there is a house to your southeast.\n");
    ...
    add_exit(CALATHIN_DIR + "houses/house2", "southeast", 0);
    add_exit(CALATHIN_DIR + "paths/path_n02", "south", 0);
    add_exit(CALATHIN_DIR + "paths/path_n04", "east", 0);

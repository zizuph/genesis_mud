...
create_room()
{
     ...
     set_long(
        "You are standing on a small path just south of the river. " +
        "There are a few trees scattered around the place. " +
        "To the north you see a small wooden bridge and the path " +
     ...
     add_exit(CALATHIN_DIR + "paths/path_e11", "north", 0);
     add_exit(CALATHIN_DIR + "paths/path_e13", "southwest", 0);

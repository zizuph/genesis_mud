...
create_room()
{
     ...
     add_item(({"ruin", "ruins", "ruined house"}), 
        "Yes, it's a ruin. That's about all you can figure out from your " +
        "position.\n");

     add_exit(CALATHIN_DIR + "paths/path_e06", "northwest", 0);
     add_exit(CALATHIN_DIR + "paths/path_e08", "southwest", 0);
     add_exit("/d/Terel/common/town/mansion/porch", "east", 0);
}

...
#define TREE   CALATHIN_DIR + "trees/tree_s05"

public void
create_terel_room()
{
    set_short("path at the forest edge");
    set_long("Threading through the edge of the forest, this path "+
      "runs parallel to the West Road behind a row of townhouses. "+
      "The town square of Calathin can be reached to the east, "+
      "while the gate to leave the protection of the town walls "+
      "lies west. The air is frigid and heavy with the scent of "+
      "woodsmoke. There are several tree stumps here, and "+
      "countless pines stretching north as far as your eyes "+
      "can see.\n");

    add_exit(CALATHIN_DIR + "paths/path_s06", "west", 0);
    add_exit(CALATHIN_DIR + "paths/path_s04", "east", 0);	

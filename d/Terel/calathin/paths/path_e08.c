...
create_room()
{
     ...
     set_long(
        ...
        "northeast and southwest. Far south your sharp eyes discern " +
        "a road.\n");
     ...
     add_item("road", "It's too far to the south to look at closely.\n");

     add_exit(CALATHIN_DIR + "paths/path_e07", "northeast", 0);
     add_exit(CALATHIN_DIR + "paths/path_e09", "southwest", 0);

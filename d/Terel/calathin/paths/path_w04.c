...
create_room() {
    ...
    set_long(
      ...
      "east and southwest.  Southwest leads towards a temple, and east " +
      "leads back to the road.  You can barely make out the temple " +    
      "in the trees to your southwest.\n");
    ...
    add_exit(CALATHIN_DIR + "paths/path_w03", "east", 0);
    add_exit(CALATHIN_DIR + "paths/path_w05", "southwest", 0);
}

...
#define N_GATE CALATHIN_DIR + "south_gate"
...
create_room()
{
    ...
    set_long("This is the south gate of Calathin. Large wooden gates stand before "+
                   "you, leading out through the walls of the town. Guards are posted "+
                   "above to operate the gates and keep watch. The road leads north "+
                   "into the town.\n");
    ...
    add_item(({"town","calathin","Calathin"}), 
                      "To the north lies the town of Calathin. Trees can be seen "+
    ...
    add_exit(CALATHIN_DIR + "south_gate", "south", "@@check_south");
    add_exit(CALATHIN_DIR + "roads/road_e02","north",0);
    reset_room();
}

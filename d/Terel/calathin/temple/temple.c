/*
 * Fixed do_pray to use notify_fail to prevent bad interactions
 * with guilds that <pray> for their spells.
 * Updated by Shanoga, 11/09/18
 * Lilith -- Modified path for cloning the priest, it was cloning 
 *           from the old town dir.
 */
...
*/   
#define PATH "/d/Terel/calathin/temple/"   
...
{    
    ...
    set_long("This is a small temple sanctuary, it is made of dark " +
        ...
        "sanctuary is a grand statue that stands twenty feet " +
        "high. The walls are painted with colourful icons and " +
        "images depicting heroes and heroines. The dome of " +
        "the temple has been coated with a sheen of gold which " +
        "projects a golden glow upon the statue. " +
    ...
    add_exit("/d/Terel/calathin/paths/path_w06", "north", 0);
    ...
    add_cmd_item("statue", "revere", "@@rev_stat");
    
    add_item(({"dome", "gold"}), "The dome is brilliant and flawless.\n");

    add_item(({"primrose", "bushes"}), "Beautiful blooming red flowers " +
        "grow out of the golden urn.\n");

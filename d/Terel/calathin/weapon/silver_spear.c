...
create_weapon()
{
    ...
    set_default_weapon(45, 55, W_POLEARM, W_IMPALE, W_BOTH, TO);
    add_prop(OBJ_I_WEIGHT, 4500);
    add_prop(OBJ_I_VALUE, 800);
    add_prop(OBJ_I_IS_MAGIC_WEAPON, 1);
    add_prop(MAGIC_AM_MAGIC, ({"enchantment", 60}));
    add_prop(OBJ_S_WIZINFO, "A powerful spear wielded by the Captain of the "+
                   "Calathin Guard. 45 hit, 55 pen. Does extra damage to all giants.\n");

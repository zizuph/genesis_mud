...
create_room()
{
    ...
    add_exit(CALATHIN_DIR + "houses/house4_2d","north",0,1);
    add_exit(CALATHIN_DIR + "houses/house4a","downstairs",0,1);
    ...
    door = clone_object(CALATHIN_DIR + "houses/obj/house4_2a_door");
       door->move(TO);

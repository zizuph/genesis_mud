...
#define IN_GATE CALATHIN_DIR + "in_west_gate"
...
create_room()
{
    ...
    set_long("This is the west gate of Calathin. Before you stands a tall wooden "+
                   "gate through the timber walls thats surround the town. Above, "+
                   "you can see a few guards keeping watch over the entrance. The "+
                   "road leads back into the forest to the west. The town itself is "+
    ...
    add_exit(CALATHIN_DIR + "in_west_gate", "east", "@@check_east");
    add_exit(RIBOS_DIR + "roads/road_01","west",0,5);
    reset_room();

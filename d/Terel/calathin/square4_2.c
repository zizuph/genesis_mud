...
create_terel_room()
{
    ...
    set_long(
      ...
      "of roads. To your northeast is a town hall, south of which is a " +
      "playhouse. There is a soot blackened building to your east.\n");
    ...
    add_item( ({ "buildings" }),
      ...
      "To your northeast, a town hall, south of which is a playhouse.\n");
    ...
    add_exit(CALATHIN_DIR + "square4_1", "north", 0);
    add_exit(CALATHIN_DIR + "square4_3", "south", 0);
    add_exit(CALATHIN_DIR + "square3_2", "west", 0);

    room_add_object(CALATHIN_DIR + "obj/forge_door2");
    add_npc(CALATHIN_DIR +"npc/assq_citizen");
}

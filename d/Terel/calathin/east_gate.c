...
#define IN_GATE CALATHIN_DIR + "in_east_gate"
...
create_room()
{
    ...
    set_long("This is the east gate of Calathin. Before you stands a tall wooden "+
    ...
    add_exit(CALATHIN_DIR + "in_east_gate", "west", "@@check_west");
    reset_room();

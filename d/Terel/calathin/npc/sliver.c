/*
 *  Sliver the Blade, /d/Terel/calathin/npc/sliver.c 
...
#include <wa_types.h>
#include <formulas.h>
#define KILL_LOG "/d/Terel/log/sliver_kills"
void dress_me();
...
create_monster()
{
    ...
    set_long("A thin almost frail looking halfing. He has "+
             "short brown hair, and dark brown eyes. His face "+
...
/* Make this guy introduce himself */
/*
...
dress_me()
{
    ...
    clone_unique(CALATHIN_DIR + "armour/stud_armourm", 5, 
                          CALATHIN_DIR + "armour/stud_armourh")->move(TO);
...
special_attack(object enemy)
{
    ...
    if(random(ranseed) < 1)
    {
        ...
        hurt = F_PENMOD((45 + (intox/2)) * gobmod, (45 + (intox/2)) * gobmod);

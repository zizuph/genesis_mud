...
create_wearable_pack()
{
    ...
    set_pshort("leather backpacks");
    add_name("pack");
    set_adj("leather");
    set_long("This is an ordinary backpack of fine leather. Packs " +
      "of this kind can be purchased in Calathin, as you see "+
      "from the small inscription on it: TS. For Talok Smitt. "+
      "You may <fill> and <empty> the backpack as you wish.\n");

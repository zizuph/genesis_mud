...
#define  UP   CALATHIN_DIR + "trees/tree_s03b"
#define  DOWN CALATHIN_DIR + "paths/path_s03"
#define  BELOW ({ DOWN })
...
create_terel_room()
{
    ...
    set_long("You are in a pine tree above the path that follows "+
      ...
      "the wind. "+
      "The tree branches obscure much of the view, but "+
      "@@see_down@@"+
...
climb_tree()
{
	...
	write("You try to climb up the tree but you can't seem " +
	  ...
	  "are balancing on and down you go! AAAAGGGGHHHHH!\n");

...
#define N_GATE CALATHIN_DIR + "north_gate"
...
create_room()
{
    set_short("the north gate of Calathin");
    set_long("This is the north gate of Calathin. Large wooden gates stand before "+
                   "you, leading out through the walls of the town. Guards are posted "+
                   "above to operate the gates and keep watch. The road leads south "+
                   "into the town.\n");
    ...
    add_item(({"town","calathin","Calathin"}), 
                      "To the south lies the town of Calathin. Trees can be seen "+
                      "throughout the town lightly covered with snow. A number "+
                      "of buildings form the town square. To the west another "+
                      "gate leads out of the town. The view to the east is "+
                      "blocked by a large mansion to the southeast.\n");
    ...
    add_exit(CALATHIN_DIR + "north_gate", "north", "@@check_north");
    add_exit(CALATHIN_DIR + "roads/road_n07", "south",0);
    reset_room();
}
...
check_north()
{
    ...
    {
        write("You pass through the northern gates of Calathin.\n");
        return 0;
    }

 ...
 * se_path.c
 *
 * A generic room for the southeastern path off the Dabaay road.
...
create_room()
{
    ...
    set_up_herbs( ({ ONE_OF_LIST(ANY_HERBS),
                  ...
                  ({"foliage","brush","undergrowth"}) , 
                   3 );
    add_item(({"path","track","dirt path","dirt track"}),
        "A narrow strip of cleared ground.\n");

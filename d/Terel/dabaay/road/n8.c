...
create_room()
{
    ...
    set_long(
        "You are on a dirt road that runs through a dense forest of trees "+
        "and shrubs. The road bends from the west to the southeast here.\n");
    ...
    add_exit(DAB_ROAD + "n9", "west", 0);
    add_exit(DAB_ROAD + "n7", "southeast", 0);
}

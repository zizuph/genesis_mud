...
create_room()
{
    ...
    set_long(
        ...
        "and shrubs grow in abundance on both sides of the road while the "+
        "path remains clear. The road bends from the north to the "+
        "southeast here.\n");
    ...
    add_exit(DAB_ROAD + "n7", "north", 0);
    add_exit(DAB_ROAD + "n5", "southeast", 0);
}

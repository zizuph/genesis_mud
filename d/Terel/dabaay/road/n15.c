...
create_room()
{
    ...
    set_long(
        "You are traveling along a dirt road, in the northern reaches "+
        "of a dark forest. The road is bordered by a variety of trees and "+
        "shrubs. The road bends from the northwest to the east here.\n");
    ...
    add_exit(DAB_ROAD + "n16", "northwest", 0);
    add_exit(DAB_ROAD + "n14", "east", 0);
}

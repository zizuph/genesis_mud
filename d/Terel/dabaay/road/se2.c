...
/*
 * se2.c Path off of north road from Dabaay
 *
...
create_room()
{
    ...
    set_long(
        ...
        "the forest floor. The track continues from the north to the south.\n");
    ...
    add_exit(DAB_ROAD + "se1", "north", 0);
    add_exit(DAB_ROAD + "se4", "south", 0);
}

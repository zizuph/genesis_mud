...
create_room()
{
    ...
    set_long(
        ...
        "vegetation. You can see a bend in the road to the north while "+
        "to the south, the road continues on into the distance.\n");
    ...
    add_exit(DAB_ROAD + "n4", "north", 0);
    add_exit(DAB_ROAD + "n2", "south", 0);
}

...
{
    ::create_room();
    set_short("On a dirt road, deep in a dark forest");
    set_long(
        "You are on a dirt road that bends from the north to "+ 
        "the southeast. A dark and dense forest looms around and "+
        "over your path.\n");
    ...
    add_exit(DAB_ROAD + "s9", "north", 0);
    add_exit(DAB_ROAD + "s11", "southeast", 0);
}

...
/*
 * se3.c Path off of north road from Dabaay
 *
...
create_room()
{
    ...
    set_long(
        "You are on a small dirt track off of the main road. The trees "+
        "here vie with masses of brush and undergrowth for a take of "+
        "the forest floor. The track bends from the northwest to the south.\n");
    ...
    add_exit(DAB_ROAD + "se1", "northwest", 0);
    add_exit(DAB_ROAD + "se5", "south", 0);
}

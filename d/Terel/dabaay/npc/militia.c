...
reply_job()
{
   command("say I dont have anything that needs doing at the " +
           "moment. You might want to speak to Jarred down at " +
           "the Stumble inn. He may have something for you to do.");
   return"";
}

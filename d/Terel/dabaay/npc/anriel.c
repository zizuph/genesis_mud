...
#define HERBAL_SAVE "/d/Terel/dabaay/npc/herbalist_herbs"
#define MAX_HERBS 100 /* the maximum number of herbs Anriel will keep of one type */
#define NUM sizeof(MONEY_TYPES)
#define INTRODUCED_TO_ANRIEL "introed_Anriel"
#define HERB_BUY "/d/Terel/dabaay/log/herbs_bought"
#define HERB_SELL "/d/Terel/dabaay/log/herbs_sold"
...
ask_herbs()
{
    ...
    command("say You can purchase some from me, and I buy herbs, too!");
    command("say If you have an unknown herb, I can try to identify " +
            "it for you, if you give it to me.");
    return "";
}
...
{
    if (herbs) 
        command("say I have herbs for sale too, would you like to "+
                "purchase some?");
    else 

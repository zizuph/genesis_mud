...
create_room()
{
    ...
    set_long(
        "You are in the northern area of a small fishing village. "+
        "Out to the east, you can see a deep blue ocean "+
        "beyond what appears to be a bay. Closer in, "+
    ...
    add_exit(DAB_TOWN + "square1_4", "north", 0);
    add_exit(DAB_TOWN + "square2_3", "south", 0);
    add_exit(DAB_TOWN + "square1_6", "west", 0);
    add_exit(DAB_TOWN + "square1_3", "northwest", 0);
    add_exit(DAB_TOWN + "square2_2", "southwest", 0);
}

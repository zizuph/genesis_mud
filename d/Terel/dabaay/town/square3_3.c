...
create_room()
{
    ...
    set_long(
        ...
        "Nearby to the north and east, is what appears to "+
        "be a large bay.\n");
    ...
    add_exit(DAB_TOWN + "square3_6", "south", 0);
    add_exit(DAB_TOWN + "square3_2", "west", 0);
    add_exit(DAB_TOWN + "square2_6", "northwest", 0);
    add_exit(DAB_TOWN + "square3_5", "southwest", 0);
}

...
create_room()
{
    ...
    add_exit(DAB_TOWN + "square3_5", "north", 0);
    add_exit(DAB_TOWN + "square4_3", "east", 0);
    add_exit(DAB_TOWN + "square4_1", "west", 0);
    add_exit(DAB_TOWN + "square3_6", "northeast", 0);
    add_exit(DAB_TOWN + "square3_4", "northwest", 0);
}

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay3_5", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_6", "north", 0,6,1);
    add_exit(DAB_HARB + "bay3_7", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay4_5", "west", 0,6,1);
    add_exit(DAB_HARB + "bay4_7", "east", 0,6,1);
    add_exit(DAB_HARB + "bay5_5", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay5_6", "south", 0,6,1);
    add_exit(DAB_HARB + "bay5_7", "southeast", 0,6,1);

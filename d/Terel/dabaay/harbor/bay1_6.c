...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay1_5", "west", 0,6,1);
    add_exit(DAB_HARB + "bay1_7", "east", 0,6,1);
    add_exit(DAB_HARB + "bay2_5", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay2_6", "south", 0,6,1);
    add_exit(DAB_HARB + "bay2_7", "southeast", 0,6,1);

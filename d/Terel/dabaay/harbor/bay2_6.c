...
create_room()
{
    ...
    set_long(
        ...
        "You can see the piers and the town to your southwest. "+
    ...
    add_exit(DAB_HARB + "bay1_5", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay1_6", "north", 0,6,1);
    add_exit(DAB_HARB + "bay1_7", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay2_5", "west", 0,6,1);
    add_exit(DAB_HARB + "bay2_7", "east", 0,6,1);
    add_exit(DAB_HARB + "bay3_5", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_6", "south", 0,6,1);
    add_exit(DAB_HARB + "bay3_7", "southeast", 0,6,1);

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay1_4", "west", 0,6,1);
    add_exit(DAB_HARB + "bay1_6", "east", 0,6,1);
    add_exit(DAB_HARB + "bay2_4", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay2_5", "south", 0,6,1);
    add_exit(DAB_HARB + "bay2_6", "southeast", 0,6,1);

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay3_3", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_4", "north", 0,6,1);
    add_exit(DAB_HARB + "bay3_5", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay4_3", "west", 0,6,1);
    add_exit(DAB_HARB + "bay4_5", "east", 0,6,1);
    add_exit(DAB_HARB + "bay5_3", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay5_4", "south", 0,6,1);
    add_exit(DAB_HARB + "bay5_5", "southeast", 0,6,1);

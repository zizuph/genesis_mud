...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay1_7", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay1_8", "north", 0,6,1);
    add_exit(DAB_HARB + "bay2_7", "west", 0,6,1);
    add_exit(DAB_HARB + "bay3_7", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_8", "south", 0,6,1);

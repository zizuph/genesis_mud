...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay4_6", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay4_7", "north", 0,6,1);
    add_exit(DAB_HARB + "bay4_8", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay5_6", "west", 0,6,1);
    add_exit(DAB_HARB + "bay5_8", "east", 0,6,1);
    add_exit(DAB_HARB + "bay6_6", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay6_7", "south", 0,6,1);
    add_exit(DAB_HARB + "bay6_8", "southeast", 0,6,1);

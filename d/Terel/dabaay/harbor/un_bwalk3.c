...
create_room()
{
    ...
    set_long(
        "You are in shallow waters underneath a wooden "+
    ...
    add_exit(DAB_HARB + "un_bwalk2", "west", 0,4);
    add_exit(DAB_HARB + "un_bwalk4", "east", 0,4,1);
    add_exit(DAB_HARB + "bwalk_4", "up", 0,8);

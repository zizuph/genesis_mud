...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay4_1", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay4_2", "north", 0,6,1);
    add_exit(DAB_HARB + "bay4_3", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay5_3", "east", 0,6,1);
    add_exit(DAB_HARB + "bay6_3", "southeast", 0,6,1);

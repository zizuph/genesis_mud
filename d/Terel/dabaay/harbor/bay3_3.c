...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay2_2", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay2_3", "north", 0,6,1);
    add_exit(DAB_HARB + "bay2_4", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay3_2", "west", 0,6,1);
    add_exit(DAB_HARB + "bay3_4", "east", 0,6,1);
    add_exit(DAB_HARB + "bay4_2", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay4_3", "south", 0,6,1);
    add_exit(DAB_HARB + "bay4_4", "southeast", 0,6,1);

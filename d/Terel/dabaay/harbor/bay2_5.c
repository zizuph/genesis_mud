...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay1_4", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay1_5", "north", 0,6,1);
    add_exit(DAB_HARB + "bay1_6", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay2_4", "west", 0,6,1);
    add_exit(DAB_HARB + "bay2_6", "east", 0,6,1);
    add_exit(DAB_HARB + "bay3_4", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_5", "south", 0,6,1);
    add_exit(DAB_HARB + "bay3_6", "southeast", 0,6,1);

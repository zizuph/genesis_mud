...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay6_4", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay6_5", "north", 0,6,1);
    add_exit(DAB_HARB + "bay6_6", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay7_4", "west", 0,6,1);
    add_exit(DAB_HARB + "bay7_6", "east", 0,6,1);

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay5_3", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay5_4", "north", 0,6,1);
    add_exit(DAB_HARB + "bay5_5", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay6_3", "west", 0,6,1);
    add_exit(DAB_HARB + "bay6_5", "east", 0,6,1);
    add_exit(DAB_HARB + "bay7_4", "south", 0,6,1);
    add_exit(DAB_HARB + "bay7_5", "southeast", 0,6,1);

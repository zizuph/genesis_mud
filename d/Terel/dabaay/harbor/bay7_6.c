...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay6_5", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay6_6", "north", 0,6,1);
    add_exit(DAB_HARB + "bay6_7", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay7_5", "west", 0,6,1);
    add_exit(DAB_HARB + "bay7_7", "east", 0,6,1);

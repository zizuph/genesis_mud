...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay4_5", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay4_6", "north", 0,6,1);
    add_exit(DAB_HARB + "bay4_7", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay5_5", "west", 0,6,1);
    add_exit(DAB_HARB + "bay5_7", "east", 0,6,1);
    add_exit(DAB_HARB + "bay6_5", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay6_6", "south", 0,6,1);
    add_exit(DAB_HARB + "bay6_7", "southeast", 0,6,1);

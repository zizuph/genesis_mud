...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay4_4", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay4_5", "north", 0,6,1);
    add_exit(DAB_HARB + "bay4_6", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay5_4", "west", 0,6,1);
    add_exit(DAB_HARB + "bay5_6", "east", 0,6,1);
    add_exit(DAB_HARB + "bay6_4", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay6_5", "south", 0,6,1);
    add_exit(DAB_HARB + "bay6_6", "southeast", 0,6,1);

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay6_3", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay6_4", "north", 0,6,1);
    add_exit(DAB_HARB + "bay6_5", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay7_5", "east", 0,6,1);

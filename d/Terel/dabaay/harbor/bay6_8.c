...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay5_7", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay5_8", "north", 0,6,1);
    add_exit(DAB_HARB + "bay6_7", "west", 0,6,1);
    add_exit(DAB_HARB + "bay7_7", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay7_8", "south", 0,6,1);

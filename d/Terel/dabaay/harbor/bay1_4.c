...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay1_5", "east", 0,6,1);
    add_exit(DAB_HARB + "bay2_3", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay2_4", "south", 0,6,1);
    add_exit(DAB_HARB + "bay2_5", "southeast", 0,6,1);

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay5_2", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay5_3", "north", 0,6,1);
    add_exit(DAB_HARB + "bay5_4", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay6_4", "east", 0,6,1);
    add_exit(DAB_HARB + "bay7_4", "southeast", 0,6,1);

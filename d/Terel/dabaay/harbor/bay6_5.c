...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay5_4", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay5_5", "north", 0,6,1);
    add_exit(DAB_HARB + "bay5_6", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay6_4", "west", 0,6,1);
    add_exit(DAB_HARB + "bay6_6", "east", 0,6,1);
    add_exit(DAB_HARB + "bay7_4", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay7_5", "south", 0,6,1);
    add_exit(DAB_HARB + "bay7_6", "southeast", 0,6,1);

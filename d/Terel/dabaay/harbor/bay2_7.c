...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay1_6", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay1_7", "north", 0,6,1);
    add_exit(DAB_HARB + "bay1_8", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay2_6", "west", 0,6,1);
    add_exit(DAB_HARB + "bay2_8", "east", 0,6,1);
    add_exit(DAB_HARB + "bay3_6", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_7", "south", 0,6,1);
    add_exit(DAB_HARB + "bay3_8", "southeast", 0,6,1);

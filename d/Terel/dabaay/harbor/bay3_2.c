...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay2_3", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay3_3", "east", 0,6,1);
    add_exit(DAB_HARB + "bay4_1", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay4_2", "south", 0,6,1);
    add_exit(DAB_HARB + "bay4_3", "southeast", 0,6,1);

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay6_6", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay6_7", "north", 0,6,1);
    add_exit(DAB_HARB + "bay6_8", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay7_6", "west", 0,6,1);
    add_exit(DAB_HARB + "bay7_8", "east", 0,6,1);

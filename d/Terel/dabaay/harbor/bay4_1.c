...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay3_2", "northeast", 0,6,1);
    add_exit(DAB_HARB + "un_bwalk7", "west", 0,6,1);
    add_exit(DAB_HARB + "bay4_2", "east", 0,6,1);
    add_exit(DAB_HARB + "bay5_2", "southeast", 0,6,1);

...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay1_4", "northeast", 0,6,1);
    add_exit(DAB_HARB + "bay2_4", "east", 0,6,1);
    add_exit(DAB_HARB + "bay3_2", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_3", "south", 0,6,1);
    add_exit(DAB_HARB + "bay3_4", "southeast", 0,6,1);

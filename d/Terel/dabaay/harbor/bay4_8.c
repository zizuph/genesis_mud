...
create_room()
{
    ...
    add_exit(DAB_HARB + "bay3_7", "northwest", 0,6,1);
    add_exit(DAB_HARB + "bay3_8", "north", 0,6,1);
    add_exit(DAB_HARB + "bay4_7", "west", 0,6,1);
    add_exit(DAB_HARB + "bay5_7", "southwest", 0,6,1);
    add_exit(DAB_HARB + "bay5_8", "south", 0,6,1);

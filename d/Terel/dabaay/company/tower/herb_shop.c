...
#define STORE_ROOM COMPANY + "tower/hstore"
...
create_shop() 
{
    ...
    set_keeper_file(COMPANY + "npc/herbboy");
    set_shop_name("Herbs Shop");
    set_short("Herbs here");
    set_long(
    ...
    add_cmd_item(({"poster","sign"}),"read", 
        ...
        "The herbalist likely has herbs for sale to. You may "+

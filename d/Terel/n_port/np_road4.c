...
create_room()
{
    ...
    set_long("Standing in the middle of this small portside village, " +
	     ...
	     "village store lies to the north, while the " +
	     "village inn lies to the south.  Both look like a great " +
	     "place to get a feel for the culture of the area.\n");
    ...
    add_item(({"hill", "small hill"}), 
	     ...
	     "300 yards, and completely obscures your vision of " +
	     "everything beyond.\n");
   ...
   add_item(({"forest", "large forest"}), 
    ...
    add_item(({"store"}), "This is 'The Grimacing Eskimo's Igloo'.  Here, " +
	     "you can supply\nyourself with all kinds of gear.\n");
    ...
    add_exit(NPORT_DIR + "np_road3", "west",  0);
    add_exit(NPORT_DIR + "np_road5", "east",  0);
    add_exit(NPORT_DIR + "shop",     "north", 0);
    add_exit(NPORT_DIR + "inn",      "south", 0);
}

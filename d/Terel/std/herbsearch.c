 ...
 *              
 * 25-Aug-1999: Goldberry
 *   Removed redundancies in defaults for 'places'
 *   Now possible to define 'places' without having "here"
 *   and "ground" being forced as well
 */
...
query_sizeofherbs()
{
    mixed herbies = this_object()->query_herb_files();
    return sizeof(herbies);
}

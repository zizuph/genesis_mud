...
equip_me(){
   ...
   sword=clone_object("/d/Terel/dark/obj/evil_spear");
   sword->move(this_object());
   command("wield spear");
   helm=clone_object("/d/Terel/dark/obj/helmet");
   helm->move(this_object());
   command("wear helmet");
   chain=clone_object("/d/Terel/dark/obj/chainmail");
   chain->move(this_object());
   command("wear chainmail");
   shield=clone_object("/d/Terel/dark/obj/bshield");

...
#define OPP_GUILD_NAME  "The Disciples of Dark Song"

#define GUILDMASTER     "cedric"
#define GUILDMASTERJR	"cedricjr"
#define ASSISTANT       "vader"

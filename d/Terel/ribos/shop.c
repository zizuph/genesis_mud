/* 
   ...
   This is Vaders Town of Ribos version.

   For now this shop uses the trade2.c object instead of the usual trade.c
   trade2.c is quicker but you can't use VBFC, but then again, it's always
   possible to set those variables if needed from the outside. Apart from that
   there is no difference between trade.c and trade2.c
*/
...
#define STORE_ROOM "/d/Terel/ribos/store"
#define MAXLIST 30
...
create_room()
{
    ...
    set_short("The Shop of Ribos");
    set_long(break_string(
      "This is the Shop of Ribos.  Here you can buy and sell various "
    + "items, so long as the shop can make a profit."
    ...
    add_exit("/d/Terel/ribos/square", "south", 0);
    add_exit("/d/Terel/ribos/store", "north", "@@wiz_check");
   "/d/Terel/ribos/store"->short();

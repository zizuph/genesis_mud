...
create_room()
{
    ...
    set_long(BS(
        ...
        "the forest.  You can still hear the bubbling of the river " +
        "to your north, but you hear another, more unnatural sound " +
        "coming from the east.  The path leads deeper into the forest " +
        "to the east, or back to the road to the west.\n"));
    ...
    add_exit(TOWNDIR + "road_s/road_s03", "west", 0);
    add_exit(TOWNDIR + "road_s/p_guild_2", "east", 0);

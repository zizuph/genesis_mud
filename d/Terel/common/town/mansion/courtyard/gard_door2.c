...
create_door() {
  ...
  ::create_door();
    ...
    */
   set_pass_command(({"w", "west", "in", "mansion"}));

  set_door_desc(break_string("It's a wooden door with a screen, " +
	"leading into the mansion.\n",70));
  set_open_desc("A wooden door leads into the mansion.\n");
  set_closed_desc("A wooden door leads into the mansion.\n");
    ...
    */
   set_other_room(MANSION + "rooms/gameroom");

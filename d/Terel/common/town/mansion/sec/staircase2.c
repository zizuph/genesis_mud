...
create_room()
{
    ...
    set_long(break_string(
        ...
        "large crystal chandelier still hangs from the ceiling.  " +
        "Something is suspended from the chandelier by a rope.  An " +
    ...
    add_item( "chandelier",
        ...
        "A corpse has been hung by a rope noosed around its neck. " +
        "The weight of the body tips the chandelier slightly to the " +
        "north.  Whomever it was, the corpse has been dead for " +
        "many years.\n", 70) );
    ...
    add_exit(MANSION + "second/antechamber", "west", 0);
}

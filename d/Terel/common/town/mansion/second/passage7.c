...
#define NORTH_EXIT  MANSION + "second/passage6.c"
#define SOUTH_EXIT  MANSION + "second/passage8.c"

create_room()
{
    set_short("Dark Passage");
    set_long(BS(
        "The passageway is beginning to get very twisty!\n"));

    add_exit(NORTH_EXIT, "north", "@@twisty");
...
twisty()
{
    write("The passage twists and turns.\n");
    return 0;
}

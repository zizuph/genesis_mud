...
create_room()
{
   ...
   add_item(({"web", "webs", "cobwebs", "cobweb"}), BS(
    ...
    add_exit(TOWNDIR + "mansion/wing_w4", "north", 0);
    add_exit(TOWNDIR + "mansion/wing_w2", "south", 0);
    add_exit(TOWNDIR + "mansion/entrance", "west", 0);
    add_exit(MANSION + "stairs", "east", 0);
}

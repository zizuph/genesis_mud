...
{
    set_short("tunnel");
    set_long(BS("You are in a long, dark, dank tunnel dug under the mansion. "+
       ...
       "above your head. \n"));
    add_exit(MANSION + "grd/tunnel1", "north",0,0);
     add_exit(BASE + "entrance", "south", 0,0);
    add_exit(MANSION + "crt/tunn1_5","east",0,0);

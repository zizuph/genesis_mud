...
create_room()
{
   ...
   set_long(BS(
         ...
         "are draped with dust. Cobwebs are everywhere. A broken archway "
     + "leads northeast.\n"));
   ...
   add_item(({"web", "webs", "cobwebs", "cobweb"}), BS(
    ...
    add_exit(MANSION + "wing_n4", "west", 0);
    add_exit(MANSION + "wing_e5", "southeast", 0);
   add_exit(MANSION + "rooms/dining", "northeast", 0);
}

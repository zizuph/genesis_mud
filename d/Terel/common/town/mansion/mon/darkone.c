/*
    ...
    Modified: Jan 2021, by Lucius
        - Minor cleanup and moved from Cedric directory
...
create_monster()
{
    ...
    add_chat("Elf, your time is through. I am all that is dark and barbaric in "
	...
	if (killer->test_bit("Terel", QUEST_TH1_GROUP, QUEST_TH1_BIT))
		...
		seteuid(getuid(this_object()));
                write_file(QUEST_LOG, killer->query_name() +
                    " solved part 2 of the Duncan Thane quest (" +
                    ctime(time()) + ")\n");
	    }
        }

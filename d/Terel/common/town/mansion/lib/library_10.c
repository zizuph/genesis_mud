...
create_room()
{
	...
	+ "bookcases to the west and north, and deteriorating bookshelves "
	+ "that line the southern wall. The air here is musty and dry, thick "
	+ "with the smell of ancient parchment and rotting wood.\n"));
	
	add_exit(LIBRARY+"library_9","east");
	...
	+ "on the spines in most cases, but most seem to begin with the letter 'O'.\n"));

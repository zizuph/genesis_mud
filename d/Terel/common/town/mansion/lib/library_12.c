...
create_room()
{
	...
	+ "bookcases to the west and east, and a rotten set of bookshelves "
	+ "that line the northern wall of the room. The air here is musty and dry, thick "
	+ "with the smell of ancient parchment and rotting wood.\n"));
	
	add_exit(LIBRARY+"library_11","south");
	...
	+ "on the spines in most cases, but most seem to begin with the letters 'Q' and 'R'.\n"));

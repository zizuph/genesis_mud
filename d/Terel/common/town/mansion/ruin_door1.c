...
create_door() {
  ...
  set_door_desc("It is a very grand wooden door, but it is rather decayed\n"
   + "and somewhat in ruins.\n");
 set_open_desc("A grand wooden door leads into the mansion.\n");
  set_closed_desc("A grand wooden door leads into the mansion.\n");

    /* The name of the door. The first name in the array will be used in the
       standard description of the door.
    */
   set_door_name(({"wooden door", "door", "old wooden door", "old door"}));

    /* This is the room on the other side of the door.
    */
   set_other_room(TOWNDIR + "mansion/entrance");

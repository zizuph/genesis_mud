...
create_room()
{
  ...
  add_my_desc("A beautiful amber arch leads into a room to the southwest.\n");
   ...
   add_item(({"web", "webs", "cobwebs", "cobweb"}), BS(
    ...
    add_exit(TOWNDIR + "mansion/wing_w2", "north", 0);
    add_exit(TOWNDIR + "mansion/wing_s1", "southeast", 0);
   add_exit(MANSION + "rooms/salon", "southwest", 0);
}

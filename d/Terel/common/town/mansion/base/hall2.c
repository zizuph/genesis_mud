...
create_room()
{
   ...
   set_long(break_string(
    ...
    "some places.  To your west, you can see some kind of a storage " +
    "room.  The hall ends to your north, and continues to the south." +
    "\n", 70));
   ...
   add_exit(BASE + "entrance", "north", 0);
   add_exit(BASE + "storage", "west", 0);
   add_exit(BASE + "hall5", "south", 0);
}

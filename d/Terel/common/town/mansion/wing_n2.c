...
create_room()
{
    ...
    set_long(BS(
        ...
        "north wing " +
        "of the old mansion. A plain wooden door leads to the north. " +
   ...
   add_item("door", "It is fairly plain and uninteresting.\n");

    add_prop(ROOM_I_INSIDE, 1);
    add_exit(MANSION + "wing_n1", "west", 0);
    add_exit(MANSION + "grd/ent", "north", 0);
    add_exit(MANSION + "wing_n3", "east", 0);
}

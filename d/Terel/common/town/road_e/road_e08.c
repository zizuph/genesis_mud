...
create_room()
{
    ...
    set_long(BS(
        ...
        "trees here and there. The road goes along a river. There is a " +
        "path going south.\n"));
    ...
    add_exit(TOWNDIR + "road_e/road_e07", "northwest", 0);
    add_exit(TOWNDIR + "road_e/road_e09", "east", 0);
    add_exit(TOWNDIR + "paths/path_e10", "south", 0);
}

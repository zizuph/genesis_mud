...
create_room(){
   ...
   set_long("A garden of magnificent greenery. Tall hollies with\n" +
      ...
      "of vibrant colour. Ornamental stones and white rocks have been\n" +
   ...
   add_exit(PATH + "garden1", "west", 0);
   add_exit(PATH + "garden3", "southeast", 0);
   add_exit(PATH + "clearing", "east", 0);

...
set_short("Garden Lane");
set_long("This simple stone lane leads through a large garden\n" +
   "of evergreens. The lane is paved with smooth white stones\n" +
   "and hedged with trimmed yew, holly, box, laurel and bay\n" +
   "bushes. The lane leads north toward Calathin and south,\n"+
   "where it links up with the Enchanted Forest.\n");


add_exit(PATH + "lane2", "south", 0);
add_exit(PATH + "garden1", "north", 0);

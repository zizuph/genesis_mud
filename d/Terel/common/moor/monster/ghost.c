...
/*
   ...
   // Found the ghost down in the tunnels under Calathin so
   // I'm setting a restrained path and updating the clone location.
   // Lilith Feb 2022
...
create_monster()
{
	...
	set_restrain_path("/d/Terel/calathin/roads/");     
    set_monster_home("/d/Terel/calathin/roads/road_s03");
    ...
    trig_new("%s 'gives' %s", "sandal_give");
	
	add_ask(({"[the] [other] / [missing] 'sandal'"}),
	    "say My other sandal is lost, and I cannot rest without it. "+
		"Find my sandal and bring it to me, and I will reward you.", 1);
...
void
sandal_give(string s1, string s2)
{
    object sandal;

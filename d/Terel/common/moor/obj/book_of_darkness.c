// Lilith Jan 2022: I've copied this from the /d/Terel/mountains dir
//        and will try to find a use for it, perhaps involving the 
//        altar at the top of the mountain, or in the tomb dweller area.

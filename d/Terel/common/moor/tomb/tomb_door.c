...
create_door()
{
     ...
     set_closed_desc("The door of the tomb will have to be opened more "+
           "to permit passage to the north.\n");
     set_open_desc("The opening between tomb door and the stone "+
         "of the vault wall looks big enough to permit ingress "+
		 "to the north.\n");
     ...
     set_open_mess(({"gives chains slack and pushes the the heavy " +
           "stone door open just wide enough for someone to " +
           "pass it.\n",

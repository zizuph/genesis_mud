...
create_room()
{
	...
	"clay seeping from the cracks in the bricks that remain. This whole "+
    "place seems to be at risk of collapse.\n"
    );
	
    add_exit("under_ne3", "north", test_exit);
    add_exit("under_ne_b", "south", test_exit);
    reset_room();
}

...
create_terel_room()
{
    ::create_terel_room();
    set_long(query_long() +
        "You can head farther into the cave by heading north or return "+
        "to the mouth of the cave, south.\n");

    add_exit(TROLL_CAVE_DIR + "tcave10", "north", "@@guarded");
    add_exit(TROLL_CAVE_DIR + "tcave02", "south", "@@guarded");

...
create_room()
{
	...
	"covered with shale tiles. It looks like the room has been " +
    "stripped bare except for a small bed leaning against one wall.\n"
    );

    add_item(({"bed", "small bed"}), 
	"It is a small straw-stuffed mattress on a wooden frame. "+
    "The headboard is inscribed with the initials S.A.\n");
    ...
    add_exit("cottage_kitchen", "west", 0);

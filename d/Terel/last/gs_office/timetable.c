...
{
  set_name("timetable");
  set_adj(({"large", "glass-like"}));
  set_short("large glass-like timetable");
  set_long("A large brown glass-like timetable, bolted into wall. "+
           "Several bells and whistles are attached to the perimeter of the "+
           "glass-like material you fail to recognize.\n" +

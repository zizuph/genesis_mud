...
create_room()
{
    ...
    add_exit(NPORT_DIR + "pier2",    "south", 0);
    add_exit(NPORT_DIR + "pier4",    "north", 0);
}

int n_block()
{
    write("The pier where ship from Calia docks isn't open yet, but soon!\n");
    return 1;
}

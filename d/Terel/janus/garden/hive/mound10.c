...
create_room()
{
    set_short("drainage pipe");
    set_long("The tunnel is leading sharply downwards. A smell of "+
	"decaying flesh is very strong from below.\n");
    ...
    add_exit(JANUSDIR + "garden/hive/mound6","up",0,3);
    add_exit(JANUSDIR + "garden/hive/mound12","down",0,3);

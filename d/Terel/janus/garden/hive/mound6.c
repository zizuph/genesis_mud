...
{
    set_short("tunnel");
    set_long("The celing of this tunnel is getting lower and lower, "+
	"as the tunnel leads deeper into the bowels of the hive. "+
	"In the left wall there is a small hole that leads sharply downwards.\n");
    ...
    add_exit(JANUSDIR + "garden/hive/mound8","northwest",0,0);
    add_exit(JANUSDIR + "garden/hive/mound4","southeast",0,0);
    add_exit(JANUSDIR + "garden/hive/mound10","down",0,0);

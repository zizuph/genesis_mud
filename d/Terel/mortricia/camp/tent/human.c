...
create_monster()
{
    ...
    if (i == G_YOUNGSTER) {
        set_name("human");
        set_pname("humans");
        set_short("young human");
        set_pshort("young humans");
        set_long(BSN(
            "It's a young human."
        ));
        set_adj("young");
    ...
    if (i == G_GROWN) {
        set_name("human");
        set_pname("humans");
        set_short("bored human");
        set_pshort("bored humans");
        set_long(BSN(
            "It's a bored human, waiting for the show to start."
        ));
        set_adj("bored");
...
dress_me()
{
    ...
    clone_object(ARM_DIR + "sandals") -> move(TO);
    command("wear all");
    command("wield all");
}

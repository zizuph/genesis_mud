...
create_container()
{
    ...
    set_long("This "+ short() +" is where useless items are tossed. "+
	"A servant will empty it before too long.\n");
...
do_empty()
{
	...
	"A servant comes and empties the bin at the bottom of the chute.\n");

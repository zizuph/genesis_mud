...
create_seating(void)
{
    ...
    "probably sleep in it. It is made of pine with four posts "+
    "at each end. The thick goosedown mattress is covered in "+
    "red satin sheets.\n");

    set_seat_names(({"bed", "big bed", "large bed", "luxurious bed"}));
    set_seat_id("_h1_bed");
	
    add_item(({"sheets", "red sheets", "red satin sheets", "satin sheets" }),
    ...
    add_item(({"bedframe" }), "A bedframe made of pine posts.\n");

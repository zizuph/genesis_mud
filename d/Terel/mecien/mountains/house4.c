...
giant=clone_object("/d/Terel/mecien/mountains/giant");
...
add_prop(ROOM_I_INSIDE, 1);
 add_exit("/d/Terel/mecien/mountains/house2","south","@@guarded2");
 add_exit("/d/Terel/mecien/mountains/cellar1","down","@@guarded",1);

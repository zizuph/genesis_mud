...
command("jump");
axe = clone_object("/d/Terel/mecien/mountains/haxe");
axe->move(this_object());
command("wield axe");
command("shout Death!");
fur = clone_object("/d/Terel/mecien/mountains/fur");
fur->move(this_object());
command("wear coat");
coat = clone_object("/d/Terel/mecien/coat");
coat->move(this_object());
command("wear coat");
purse = clone_object("/d/Terel/common/moor/sack");
purse->move(this_object());
ob = clone_object("/d/Terel/mecien/valley/guild/obj/hw");
ob->move(this_object());
misc = clone_object("/d/Terel/mecien/mace");

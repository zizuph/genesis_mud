...
#define WEP "/d/Terel/mecien/mountains/haxe"
#define ARM "/d/Terel/mecien/mountains/chain"
...
create_monster()
{
    ...
    seq_new("do_things");
    seq_addfirst("do_things",({"@@arm_me","cackle"}));
}
...
arm_me()
{
    ...
    */
    ...
    money = MONEY_MAKE_SC(5);
    money->move(this_object());

   key = clone_object("/d/Terel/mecien/mountains/bkey");

...
add_exit("/d/Terel/mecien/mountains/house1","south",0);
add_exit("/d/Terel/mecien/mountains/house4","north",0);
add_exit("/d/Terel/mecien/mountains/house3","east",0);
add_exit("/d/Terel/mecien/mountains/kitchen","west",0);

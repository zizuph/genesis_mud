...
boar=clone_object("/d/Terel/mecien/mountains/boar");
...
add_exit("/d/Terel/mecien/mountains/house2","north","@@guarded");
add_exit("/d/Terel/mecien/mountains/closet","east","@@guarded");
add_item(({"lamp","light"}),

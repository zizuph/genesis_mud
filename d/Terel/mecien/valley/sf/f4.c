...
+"A monstrous grove of thorns grows to the west, making it impassable, but\n"
+"still passable to the northwest.\n"
);

  add_exit("/d/Terel/mecien/valley/bp", "northwest", 0);
   add_exit(PATH + "f3", "south", 0);

add_item("thorns", "They form a monstrous grove of deadly spines.\n");

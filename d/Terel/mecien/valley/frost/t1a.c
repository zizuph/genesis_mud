...
"is a bunking place for guards. A massive keg sits in the corner. A set of " +
"steps leads up." +
"\n", 70));
add_item("steps", "They are icy stone.\n");
add_item("keg", "It is empty, but smells of beer.\n");
...
add_exit(PATH + "t1b", "up", "@@check");

door = clone_object(PATH + "d1b");
door->move(TO);

...
add_name("human");
set_race_name("human");
set_short("captain of the city guard");
set_long("A powerful and noble man, he is charged with defense of the town.\n");
set_base_stat(SS_INT, 65);
set_base_stat(SS_WIS, 15);
set_base_stat(SS_DIS, 88);
set_base_stat(SS_STR, 40);
set_base_stat(SS_DEX, 112);
set_base_stat(SS_CON, 133);

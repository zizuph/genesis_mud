 ...
 * Description: This function should be redefined to perform a test for success.
...
do_spell(string str)
{
  ...
  string o1, o2;
    ...
    if (!query_components()) {
        return 7;  /* Player doesn't possess the required components */
    }
...
/*
 * Function name: query_components
 * Description:   Check if the player has the components necessary for
 *                the spell, if there are no components just return 1.
 * Arguments:     -
 * Returns:       1 if the components are found
 */
public int
query_components()
{

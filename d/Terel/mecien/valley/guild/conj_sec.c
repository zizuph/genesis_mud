...
{ 
   ...
   set_short("Conjuration Section");
   set_long("There is an ominous feeling to this part of the library, as if\n"
     +"many eyes are upon it. The shelves are clean, the books are orderly,\n"
     +"though dark and gothic.\n");
...
set_up_skills()
{
   ...
   me = "use conjuration spells"; ot = me;
   sk_add_train(SS_FORM_CONJURATION, ({me, ot}), 0, 0, MYSTIC_MAX_CONJURATION);
}

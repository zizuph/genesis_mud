...
create_room(){
  ::create_room();
   ...
   set_long("Solemn and inspiring, this courtyard is an open garden\n"
      ...
      + "though somewhat shorter here. A large building stands off to\n"
      + "northwest, its thatched roof rises high above the hedges.\n"
   );
   ...
   add_item("building", "It is a large thatched roof building to the northwest.\n");
  ...
  add_exit(PATH + "g2", "southeast", 0);
  add_exit(PATH + "ve", "northwest", 0);
}

...
object obj;
  ::create_room();
   ...
   set_long("Solemn and inspiring, this courtyard is an open garden\n"
      ...
      + "simple stone paths.\n"
   + "The paths form a small circle here and lead out from it in\n"
   + "many directions through the hedges.\n"
   );
   
   obj=clone_object(PATH + "obelisk");
  ...
  add_exit(PATH + "g1", "south", 0);
   add_exit(PATH + "g3", "southwest", 0);
   add_exit(PATH + "g4", "northwest", 0);
   add_exit(PATH + "g5", "northeast", 0);
   add_exit(PATH + "g6", "southeast", 0);
   set_alarm(1.0, -1.0, "more_herbs");
}

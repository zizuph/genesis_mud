...
create_room()
{
    ...
    add_exit(DEFAULT + "road15", "north");
    add_exit(DEFAULT + "road13", "south");
    add_exit(FOREST_DIR + "forest_c7", "southeast",0,4,1);
    add_exit(FOREST_DIR + "forest_d8", "east",0,4,1);
    add_exit(FOREST_DIR + "forest_d5", "west",0,4,1);
    add_exit(FOREST_DIR + "forest_c5", "southwest",0,4,1);

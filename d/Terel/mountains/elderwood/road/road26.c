...
create_room()
{
    ...
    add_exit(FOREST_DIR + "forest_q7", "east",0,4,1);
    add_exit(FOREST_DIR + "forest_r7", "northeast",0,4,1);
    add_exit(FOREST_DIR + "forest_p7", "southeast",0,4,1);
    add_exit(FOREST_DIR + "forest_q5", "west",0,4,1);
    add_exit(FOREST_DIR + "forest_r5", "northwest",0,4,1);
    add_exit(FOREST_DIR + "forest_p5", "southwest",0,4,1);

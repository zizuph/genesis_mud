...
create_room()
{
    ...
    add_exit(FIELD_DIR  + "field_d4", "south",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_d5", "southeast",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_f4", "north",0,4,"@@exits");
    add_exit(ROAD_DIR   + "road33", "east",0,4,"@@exits");
    add_exit(ROAD_DIR   + "road34", "northeast",0,4,"@@exits");

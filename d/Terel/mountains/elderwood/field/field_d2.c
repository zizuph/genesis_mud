...
create_room()
{
    ...
    set_long(query_long() + "Someone has build a " +
       "tent city here. Several fires " +
       "burn about the tents heating food and the inhabitants.\n");
...
enter_tent()
{
    ...
    write("You push aside the tent flap and enter the tent.\n");
       ...
       MOUNTAIN_DIR + "elderwood/field/tent_d2",1,0);
       return "";
}

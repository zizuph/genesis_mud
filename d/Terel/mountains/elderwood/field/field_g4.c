...
create_room()
{
    ...
    set_long("The mountains rise high above " +
       ...
       "blocks the nothern pass. Towards the northeast you see " +
    ...
    add_exit(FIELD_DIR  + "field_f4", "south",0,4,"@@exits");
    add_exit(ROAD_DIR   + "road34", "southeast",0,4,"@@exits");
    add_exit(ROAD_DIR   + "road35", "east",0,4,"@@exits");
    add_exit(STRONGHOLD + "main_gate", "northeast");

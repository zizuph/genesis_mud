...
create_room()
{
    ...
    add_exit(FIELD_DIR  + "field_c3", "east",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_d3", "northeast",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_b2", "south",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_b3", "southeast",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_d2", "north",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_c1", "west",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_b1", "southwest",0,4,"@@exits");
...
enter_tent()
{
    ...
    write("You push aside the tent flap and enter the tent.\n");
       ...
       MOUNTAIN_DIR + "elderwood/field/tent_c2",1,0);
       return "";
}

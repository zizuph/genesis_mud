...
create_room()
{
    ...
    set_long(query_long() + "Someone has build a tent city here. " +
    ...
    add_exit(FIELD_DIR  + "field_c4", "east",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_d4", "northeast",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_b3", "south",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_b4", "southeast",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_d3", "north",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_c2", "west",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_b2", "southwest",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_d2", "northwest",0,4,"@@exits");
...
enter_tent()
{
    ...
    write("You push aside the tent flap and enter the tent.\n");
       ...
       MOUNTAIN_DIR + "elderwood/field/tent_c3",1,0);
       return "";
}

...
create_room()
{
    ...
    add_exit(FIELD_DIR  + "field_e6", "south",0,4,"@@exits");
    add_exit(ROAD_DIR   + "road33", "southwest",0,4,"@@exits");
    add_exit(FIELD_DIR  + "field_g6", "north",0,4,"@@exits");
    add_exit(ROAD_DIR   + "road34", "west",0,4,"@@exits");
    add_exit(ROAD_DIR   + "road35", "northwest",0,4,"@@exits");

...
create_room() {
    ...
    add_exit("/d/Terel/mountains/ice8", "west",0);
    add_exit("/d/Terel/mountains/ice5", "south", 0);
    add_exit("/d/Terel/mountains/cliff", "east", 0);
   add_exit("/d/Terel/mountains/ice14", "north", 0);
}

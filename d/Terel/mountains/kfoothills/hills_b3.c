...
create_room()
{
    ...
    add_exit(HILLS_PATH + "hills_b2","west",0);
    add_exit(HILLS_PATH + "hills_b4","east",0);
    add_exit(HILLS_PATH + "hills_c3","north",0);
    add_exit(HILLS_PATH + "hills_a3","south",0);
    add_exit(HILLS_PATH + "hills_a4","southeast",0);
    add_exit(HILLS_PATH + "hills_a2","southwest",0);
    add_exit(HILLS_PATH + "hills_c2","northwest",0);

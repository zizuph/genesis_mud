...
create_room()
{
	...
	add_exit(HILLS_PATH + "hills_f3","west",0);
    add_exit(HILLS_PATH + "hills_g4","north",0);
    add_exit(HILLS_PATH + "hills_g5","northeast",0);
    add_exit(HILLS_PATH + "hills_f5","east",0);
    add_exit(HILLS_PATH + "hills_e4","south",0);
    add_exit(HILLS_PATH + "hills_e3","southwest",0);

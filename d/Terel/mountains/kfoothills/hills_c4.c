...
create_room()
{
    ...
    add_item(("boulder"), "A large chunk of solid rock " +
        "and you notice that the northeastern face has been " +
        "polished smooth by someone or something.\n");

	add_prop(ROOM_S_MAP_FILE, "kobold_camp.txt");
    add_exit(HILLS_PATH + "hills_c3","west",0);
    add_exit(HILLS_PATH + "hills_c5","east",0);
    add_exit(HILLS_PATH + "hills_d4","north",0);
    add_exit(HILLS_PATH + "hills_b4","south",0);
    add_exit(HILLS_PATH + "hills_b5","southeast",0);
    add_exit(HILLS_PATH + "hills_d5","northeast",0);
    add_exit(HILLS_PATH + "hills_d3","northwest",0);

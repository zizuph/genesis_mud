...
create_room()
{
	...
	add_exit(HILLS_PATH + "hills_g5","east",0);
    add_exit(HILLS_PATH + "hills_f5","southeast",0);
    add_exit(HILLS_PATH + "hills_f4","south",0);
    add_exit(HILLS_PATH + "hills_f3","southwest",0);

...
create_room()
{
	...
	add_exit(HILLS_PATH + "hills_a1","west",0);
    add_exit(HILLS_PATH + "hills_a3","east",0);
    add_exit(HILLS_PATH + "hills_b3","northeast",0);
    add_exit(HILLS_PATH + "hills_b1","northwest",0);
    add_exit(HILLS_PATH + "hills_b2","north",0);

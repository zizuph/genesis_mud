...
create_room()
{
	...
	add_exit(HILLS_PATH + "hills_e3","west",0);
    add_exit(HILLS_PATH + "hills_f3","northwest",0);
    add_exit(HILLS_PATH + "hills_f4","north",0);
    add_exit(HILLS_PATH + "hills_e5","east",0);
    add_exit(HILLS_PATH + "hills_d5","southeast",0);
    add_exit(HILLS_PATH + "hills_d4","south",0);
    add_exit(HILLS_PATH + "hills_d3","southwest",0);

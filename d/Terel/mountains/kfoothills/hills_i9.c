...
create_room()
{
	...
	add_exit(HILLS_PATH + "hills_i8","west",0);
    add_exit(HILLS_PATH + "hills_j8","northwest",0);
    add_exit(HILLS_PATH + "hills_j9","north",0);
    add_exit(HILLS_PATH + "hills_h8","southwest",0);

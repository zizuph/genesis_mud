...
create_room()
{
	...
	add_exit(HILLS_PATH + "hills_e4","west",0);
    add_exit(HILLS_PATH + "hills_f5","north",0);
    add_exit(HILLS_PATH + "hills_f6","northeast",0);
    add_exit(HILLS_PATH + "hills_e6","east",0);
    add_exit(HILLS_PATH + "hills_d6","southeast",0);
    add_exit(HILLS_PATH + "hills_d5","south",0);
    add_exit(HILLS_PATH + "hills_d4","southwest",0);

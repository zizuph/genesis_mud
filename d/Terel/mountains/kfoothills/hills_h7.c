...
create_room()
{
	...
	add_exit(HILLS_PATH + "hills_i8","northeast",0);
    add_exit(HILLS_PATH + "hills_h8","east",0);
    add_exit(HILLS_PATH + "hills_g8","southeast",0);
    add_exit(HILLS_PATH + "hills_g7","south",0);

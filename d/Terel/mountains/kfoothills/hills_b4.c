...
create_room()
{
    ...
    add_exit(HILLS_PATH + "hills_b3","west",0);
    add_exit(HILLS_PATH + "hills_b5","east",0);
    add_exit(HILLS_PATH + "hills_c4","north",0);
    add_exit(HILLS_PATH + "hills_a4","south",0);
    add_exit(HILLS_PATH + "hills_a3","southwest",0);
    add_exit(HILLS_PATH + "hills_c5","northeast",0);

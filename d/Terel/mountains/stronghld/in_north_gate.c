...
#define N_GATE MOUNTAIN_DIR + "stronghld/north_gate"
...
create_room()
{
    set_short("Inside the northern gate of Stonehold");
    set_long("You are standing inside the great northern wall " +
       ...
       "south is the cobblestone road leading back through Stonehold.\n");
    ...
    add_item(({"gate","gates","northern gate","northern gates"}),
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/north_gate", "north", "@@check_north");
    add_exit(MOUNTAIN_DIR + "stronghld/roada", "south",0);
    reset_room();
}

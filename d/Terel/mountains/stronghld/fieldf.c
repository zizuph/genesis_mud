...
create_room()
{
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/fieldh","north",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadc","west",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadb","southwest",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldd","south",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadd","northwest",0,1);

...
create_room()
{
    ...
    set_long("The rocky field is kept clear of snow " +
       ...
       "The southern gate is to the southwest.\n");
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/fieldd","north",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadb","northwest",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roada","west",0,1);

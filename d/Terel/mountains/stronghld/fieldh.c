...
create_room()
{
    ...
    set_long("The rocky field is kept clear of snow " +
       ...
       "Above you. A cobblestone road can be seen towards the west. The " +
       "northern gate is to the northwest.\n");
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/fieldj","north",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadd","west",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadc","southwest",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldf","south",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roade","northwest",0,1);

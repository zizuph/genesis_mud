...
create_room()
{
    ::create_room();
    set_short("Pass");
    set_long("The road continues north towards the northern " +
       "gate and south towards the southern gate. " +
       "The catwalks can be seen atop the sheer " +
       "cliff walls above the rocky fields to the west and east.\n");
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/roade","north",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadc","south",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldg","west",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldh","east",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldi","northwest",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldj","northeast",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fielde","southwest",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldf","southeast",0,1);

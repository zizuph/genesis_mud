...
create_room()
{
    ...
    set_long("The rocky field is kept clear of snow " +
       ...
       "Above you. A cobblestone road can be seen towards the east " +
       "and north. The road north of here leads to a large metal gate " +
       "which can be seen to the northwest. The southern gate is to the " +
       "southeast.\n");
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/fielde","north",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fielda","south",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadb","east",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roada","southeast",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadc","northeast",0,1);

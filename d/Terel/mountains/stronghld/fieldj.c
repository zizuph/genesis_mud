...
create_room()
{
    ...
    set_long("The rocky field is kept clear of snow " +
       ...
       "Above you. The northern gate and cobblestone road is to the west.\n");
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/roade","west",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadd","southwest",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/fieldh","south",0,1);

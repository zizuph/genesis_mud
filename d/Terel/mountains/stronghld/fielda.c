...
create_room()
{
    ...
    set_long("The rocky field is kept clear of snow " +
       ...
       "The southern gate is to the southeast.\n");
    ...
    add_exit(MOUNTAIN_DIR + "stronghld/fieldc","north",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roadb","northeast",0,1);
    add_exit(MOUNTAIN_DIR + "stronghld/roada","east",0,1);

...
create_room()
{
    ...
    set_long(query_long() +
             "The shaft levels off, then continues northeast.\n"); 

    add_tell("You hear the sounds of rushing water to the northeast.\n");

    DARK;
    
    add_exit(DEFAULT + "shaft12", "northeast");
    add_exit(DEFAULT + "shaft10", "up");

/*
 * /d/Terel/mountains/ghastly_keep/obj/g_throw_cooldown.c
 *
...
#define SUBLOC "_gkeep_brew_ice_subloc"
...
create_object()
{
    set_name("_gkeep_throw_cooldown_ice");
...
show_subloc(string subloc, object on, object for_obj)
{
    ...
    return str + "freezing cold, almost bluish.\n";
}

/* /d/Terel/mountain/ghastly_keep/ghastly_keep/rooms/gkeep22.c
 *
...
create_gkeep_room()
{
    ...
    add_exit(GKEEP + "gkeep17",       "north");
    add_exit(GKEEP + "gkeep18",       "northeast");
    add_exit(GKEEP + "gkeep26",       "southeast");
    add_exit(GKEEP + "gkeep21",       "west");

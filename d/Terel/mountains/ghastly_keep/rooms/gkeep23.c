/* /d/Terel/mountains/ghastly_keep/rooms/gkeep23.c
 *
...
create_gkeep_room()
{
    ...
    add_exit(GKEEP + "gkeep20",       "northeast");
    add_exit(GKEEP + "gkeep24",       "east");
    add_exit(GKEEP + "gkeep26",       "southwest");
    add_exit(GKEEP + "gkeep18",       "northwest");

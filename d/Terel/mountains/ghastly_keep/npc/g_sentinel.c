/* /d/Terel/mountains/ghastly_keep/npc/g_sentinel.c
 *
 * A sentinel in the ghastly keep
 *
 *  Created by Znagsnuf.
 *
...
void create_creature()
{
    ...
    set_long("This " +adj1+ " "+adj2+ " creature is surrounded with an inky "
           + "black aura. " + CAP(HIS_HER) + " teeth, eerily incandescent, "
           + "emitting a strange blue glow and is as sharp as a fine diamond "
           + "sword. " + CAP(HIS_HER) + " skin is mostly scar tissue.\n");

    add_prop(CONT_I_WEIGHT, 110000);
    add_prop(CONT_I_HEIGHT, 180);

    set_stats( ({ 220, 200, 220, 180, 180, 190 }) );

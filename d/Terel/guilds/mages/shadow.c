/* File:          /d/Terel/guilds/mages/shadow.c
 * Creator:       Shinto
 * Date:          11/29/2001
 * Modifications:
 * Purpose:
...
init_guild_member()
{
    ...
    who->add_cmdsoul("/d/Terel/guilds/mages/soul.c");
    who->update_hooks();
...
wear_arm(object what)
{
    ...
    if (what->query_prop(MAGES_BLESS) < 1)
    {
         return "The "+what->short()+" has not been blessed.\n";
    }

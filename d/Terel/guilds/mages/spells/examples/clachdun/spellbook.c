...
inherit (SPELL_DIR + "fireball");
inherit (SPELL_DIR + "icestorm");
inherit (SPELL_DIR + "sunburst");
inherit (SPELL_DIR + "darkness");
...
create_khalakhor_object()
{
    ...
    add_spell("darkness", "A mist of darkness", create_darkness,
      spell_target_caster_environment);
    ...
    add_spell("fireballs", "small fireballs", create_fireball_bolt,
    spell_target_one_present_enemy);

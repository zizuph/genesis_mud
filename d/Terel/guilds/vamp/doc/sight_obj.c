...
start()
{
    ...
    switch(Dlevel)
    {
        case 1..5:   str = "low"; break;
        case 6..8:   str = "moderate"; break;
        case 9..11:  str = "deep"; break;
        case 12..13: str = "very deep"; break;
        case 14..15: str = "extremely deep"; break;
        default:     str = "low"; break;
    }
    effect_target->catch_msg("Your eyes are adjusted to "+ str +" levels of darkness.\n");

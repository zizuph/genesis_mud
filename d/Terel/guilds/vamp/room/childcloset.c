...
void create_vamp_room()
{
    ...
    add_exit("childbedroom.c", "south");

    add_item(({"south","bedroom"}),
        "To the south is to the bedroom.\n");
...
do_dream_2(object tp)
{
    ...
    tp->catch_msg("You are viewing down upon the child's bedroom, "+
        ...
        "He leans over the girl, mouth agape and fangs glistening...  "+
        "\n\n");
...
do_dream_4(object tp)
{
    ...
    tp->catch_msg("Isabella cowers in the closet, watching in horror "+
        ...
        "The thin man picks Bear up with one hand and drives his "+
        "glistening fangs into the man's throat.  "+
...
/* Vision above is a slightly modified version of the following:

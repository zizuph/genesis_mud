...
static string *titles = ({
    "Inexperienced Stablekeep of Last",
    "Novice Stablekeep of Last",
    "Stablekeep of Last",
    "Respected Stablekeep of Last",
    "Senior Stablekeep of Last",
    "Experienced Stablekeep of Last",
    "Novice Horseman of Last",
    "Horseman of Last",
    "Respected Horseman of Last",
    "Senior Horseman of Last",
    "Experienced Horseman of Last",
    "Master Horseman of Last",
    "Novice Rider of Last",
    "Rider of Last",
    "Respected Rider of Last",
    "Senior Rider of Last",
    "Experienced Rider of Last",
    "Master Rider of Last",
    "Novice Equestrian of Last",
    "Equestrian of Last",
    "Respected Equestrian of Last",
    "Senior Equestrian of Last",
    "Experienced Equestrian of Last",
    "Master Equestrian of Last",
    "Novice Cavalier of Last",
    "Cavalier of Last",
    "Respected Cavalier of Last",
    "Senior Cavalier of Last",
    "Experienced Cavalier of Last",
    "Master Cavalier of Last",
});
...
query_rider_level()
{
    return SW->query_base_stat(8) * 7 / 9;
}
...
leave_riders()
{
    ...
    log_file("riders", capitalize(SW->query_real_name()) + 
        " left " + ctime(time()) + "\n");

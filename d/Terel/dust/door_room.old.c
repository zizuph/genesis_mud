...
do_press(string str)
{
	...
	*/
	...
	// Altered this formula to be lethal to everybody, not just
	//  the little guys.  -Bleys
	damage = TP->query_max_hp() + 500;
	// damage = TP->query_max_hp() / 2 + 500;
...
{
    /* Print something. */
    write("You raise your hand and press it to the center of the "+
	"of the Zodiac.\n");

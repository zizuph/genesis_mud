...
#include <macros.h>
/*
 * Quest bits definitions added, Udana
 */
#include "./quest_bits.h"
...
#define HIS_HER          this_player()->query_possessive()
#define HIM_HER          this_player()->query_objective()
#define HE_SHE           this_player()->query_pronoun()
...
#define QRACE(x)   this_player()->query_race_name(x)
...
#define ME(x) if (find_player("lilith")) \
              find_player("lilith")->catch_msg(x + "\n")
/*
...
#define T_UNIQUE      "/d/Terel/unique/"
...
/* Found no instance of this used in Terel. 
 * Tomas is no longer liege.
 */
...
#define WHITE           "/d/Terel/guilds/white/"
...
/*
 * Property seting this prop to 0 will make monster bouncable.
 */
...
#define PLAYER_I_COLD "_player_i_cold"
#define ROOM_I_TEREL_COLD "_room_i_terel_cold"


/*
 * Terel Boss NPC
 */
#define BOSS_NPC   "_live_i_am_Terel_boss_npc"

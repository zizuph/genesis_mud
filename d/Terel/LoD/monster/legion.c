...
create_monster()
{
    ::create_monster();
    set_name("soldier");
    add_name("legion_soldier");
    set_short("legion soldier");
    set_long("A soldier of the Legion. Trained for combat in the city of "+
        "Maskyr Keep.\n");
    set_adj("swift");
    set_gender(MALE);
    set_alignment(-(random(500) + 200));

    set_stats(random(30) + 40);
    SET_MAX_HP;

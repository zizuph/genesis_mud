 ...
 * wolf_coat.c
 *
 * A wolf coat, used in the dungeon quest.
 *
...
#define REVERT_OBJ  (LOD_DIR + "obj/wolf_skin")
#define MIN_DUR     10
#define DEF_DUR     100
#define MAX_DUR     1000
...
{
    set_name("coat");
    add_name(DQ_WOLF_COAT);
    set_adj("warm");
    set_long("It is a cosy looking coat. It's made of wolf fur.\n");
    ...
    add_prop(MAGIC_AM_ID_INFO,
	         ({"This is a magical coat.\n", 10,
	           "It will help you in entering the crystal and " +
	           "endure the dangers within it.\n", 40}));
	add_prop(OBJ_S_WIZINFO, "A special coat used in the dungeon quest.\n");

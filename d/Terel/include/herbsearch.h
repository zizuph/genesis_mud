...
/*
 * This file should be kept consistent with Gondor's.
 * see /d/Gondor/elessar/lib/herbsearch.h
 *
 * Sorgum 941008
 */
...
/*
 * see /d/Terel/std/room::query_herb_list()
 */

void set_search_places(string *places_arr)
{
    places = places_arr+({"here"});
}

void add_search_places(string *places_arr)
{
    places = places_arr+({"here"});
}

string herb_search(object player, string str)
{
    string  place,
           *herb_names = ({}),
            this_herb;

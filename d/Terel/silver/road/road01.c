 ...
 * Modifed by Udana
 *   Lilith, Feb 2022: removed invalid exit going to wizard dir
 */
...
// I don't know why this exit is here. This isn't a valid path.    
// add_exit("/w/tarn/silver/forest_ag/forest_a11", "north", 0);

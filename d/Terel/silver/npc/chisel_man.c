 ...
 *
   Modified: 25.03.2006 by Udana
       - He's moving with caravan now, he's behavior is mostly the same though.
...
/* All changes I need to do, so he behaves like he should */
...
{
  /* Change here by Udana, he also uses help from caravan guards.*/
  ::attacked_by(ob);
    if (!buddy) {

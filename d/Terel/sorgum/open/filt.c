...
int clans()    { pl("Dwarven Warriors of the Neidar Clan", "clans", OCC); R1}
...
int onearthsea(){ domain_filter("Earthsea");  R1 }
int onraumdor(){ domain_filter("Raumdor");  R1 }
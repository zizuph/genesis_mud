...
void create_room()
{
  ...
  set_long("You are in a big dirty cave under the Misty "
    ...
    + "water. The whole floor is full of beds. Most of them are empty but "
    + "some of them have covers on. If you have cover too then you can "
...
int start_here(string arg)
{
  ...
  if(!ob)
  {
    write("How do you want to make bed for yourself without bed covers?\n");
    return 1;
  }
  ...
  else write("Please try again and if you don't succed report bug.\n");
  return 1;
}

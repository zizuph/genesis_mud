...
create_room()
{
  ...
  add_prop(ROOM_I_INSIDE, 1);
    ...
    set_long("This room is dark and it smells bad. Somehow you can guess "+
             ...
             "here forever. There is big noise coming from north and "+
...
push_something(something)
{
  if(something=="door")
  {
    ...
    say(QCTNAME(TP)+" opens the door and disapear inside. Wall swung back "+
        "closing small opening.\n");
          tell_room(CAVE_DIR+"t17",QCTNAME(TP)+" enters room through "+
                                           "secret door.\n");

...
create_room()
{
    ...
    set_short("east side of ford");
    set_long("You are standing on the eastern side of the Old Ford through "+
             "the River Anduin. " + 
    ...
    add_exit(MISTY_DIR+"p15", "west",    0,    4);
    add_exit(MISTY_DIR+"p17", "east",    0,    4);

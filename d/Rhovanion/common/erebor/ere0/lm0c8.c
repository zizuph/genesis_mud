...
create_room()
{
    ...
    "The River Running flows directly to the south of you then turns " +
    "west here where you're standing, the twists south again towards " +
    "the long lake.\n");
      
    add_exit(CAVE_DIR+ "lm0c7","east");
    add_exit(CAVE_DIR+ "lm0c9","west");
    add_exit(CAVE_DIR+ "lm0c10","southwest");

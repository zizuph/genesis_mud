...
set_other_room(CAVE_DIR + "ere1");
set_lock_name("bolt");
set_lock_command("bolt");
set_unlock_command("unbolt");
set_open(1);
set_open_desc("The heavy steel gate leading south is wide ajar.\n");
set_closed_desc("The heavy steel gate leading south is firmly shut.\n");

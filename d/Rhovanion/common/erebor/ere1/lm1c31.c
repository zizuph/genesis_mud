...
create_cave()
{
    ...
    set_cave("Erebor");
    set_cave_type(8);
    set_long("You can hardly breathe as you enter the room, thick clouds of " 
	+ "smoke slams into your face making it almost impossible to see " 
	+ "anything in the room. After a few minutes you get used to the smoke " 
	+ "and can finally make out some of the contures here. The floor is "
	+ "covered with hay to prevent the spilled beer from destroying the "
	+ "rocks underneath. "
	+ "Sitting around tables and at the bar you see many different people "
    ...
    add_exit(CAVE_DIR + "lm1c30","west",0,1);
    add_exit(CAVE_DIR + "lm1c31_2","east",0,1);
}

...
create_cave()
{
  ...
  add_exit(CAVE_DIR + "lm1c21","west",0,1);
  add_exit(CAVE_DIR + "lm1c52","east",0,1);
  add_exit(CAVE_DIR + "lm1c26","north",0,1);
  add_exit(CAVE_DIR + "lm1c61","south",0,1);
  add_exit(CAVE_DIR + "lm1c62","southeast",0,1);
}

...
create_cave()
{
  ...
  add_exit(CAVE_DIR + "lm1c18","west",0,1);
  add_exit(CAVE_DIR + "lm1c21","east",0,1);  
  add_exit(CAVE_DIR + "lm1c19","northwest",0,1);
  add_exit(CAVE_DIR + "lm1c17","southwest",0,1);
  add_exit(CAVE_DIR + "lm1c20","down","@@down_move",1);
}
...
down_move()
{
  ...
  tell_room(CAVE_DIR + "lm1c20",QCTNAME(TP)+" tries to go down the "

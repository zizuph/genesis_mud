...
create_door()
{
set_door_id("East_Gate");
set_pass_command(({"w","west"}));
set_door_name(({"steel gate", "gate","reinforced gate" }));
set_other_room(CAVE_DIR + "lm1c59");
set_lock_name("bolt");
set_lock_command("bolt");
set_unlock_command("unbolt");
set_open(1);
set_open_desc("The heavy steel gate leading west is wide ajar.\n");
set_closed_desc("The heavy steel gate leading west is firmly shut.\n");

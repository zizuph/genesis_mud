...
create_cave()
{
  ...
  add_exit(ERE_DIR + "lm1c10","west",0,1);
  add_exit(ERE_DIR + "lm1c12","north",0,1);
  add_exit(ERE_DIR + "lm1c15","east",0,1);  
  add_exit(ERE_DIR + "lm1c16","northeast",0,1);
  add_exit(ERE_DIR + "lm1c14","southeast",0,1);
}

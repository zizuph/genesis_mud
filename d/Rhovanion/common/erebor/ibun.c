...
short_func()
{
  switch (cavetype)
    {
    case 1:
      return "A corridor in "+cavename+" in the "+region+ 
	" parts of "+cave+"";
    case 2:
      return "A large hall in "+cavename+" in the "+region+
	" parts of "+cave+".";
    case 3:
      return "A storage room in "+cavename+" in the "+region+
	" parts of "+cave+".";
    case 4:
      return "A cell in "+cavename+" in the "+region+" parts of "+
	cave+".";
    case 5:
      return "A room in "+cavename+" in the "+region+" parts of "+
        cave+".";
    default: "BAD";
    }
}

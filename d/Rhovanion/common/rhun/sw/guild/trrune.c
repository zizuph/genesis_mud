...
create_room()
{
	...
	add_exit(SWG+"occrune","east",0);
	add_exit(SWG+"hallsw","west",0);
	...
	add_item("rune","This large and intricately carved rune"
		...
		+"  It includes a perfect square with"
		+" diagonal lines extending from its top-right and"
		+" bottom-left corners."
		+"  You find yourself"

...
create_room()
{
	...
	add_exit(SWG+"trrune","west",0);
	add_exit(SWG+"depart","northeast",0);
	...
	add_item("rune","This large and intricately carved rune"
		...
		+"  It consists of a singe arching line that rises"
		+" and then falls again as it moves from left to"
		+" right."
		+"  You find yourself"

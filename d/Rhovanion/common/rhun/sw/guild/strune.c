...
create_room()
{
	...
	add_exit(SWG+"psrune","west",0);
	add_exit(SWG+"depart","southeast",0);
	...
	add_item("rune","This large and intricately carved rune"
		+" is formed of a large square.  It its center, a single diagonal"
		+" line runs from northwest to southeast"
		+" across its surface.  Two smaller lines lie"
		+" perpendicular to this first."
		+"  You find yourself"

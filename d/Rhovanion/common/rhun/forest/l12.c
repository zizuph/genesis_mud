...
void create_room()
{
  ...
  add_exit(RHUN_DIR+"forest/l11", "north", 0);
  add_exit(RHUN_DIR+"forest/l13", "south", 0);
  add_exit(RHUN_DIR+"forest/m12","east",0);
  add_exit(RHUN_DIR+"forest/k12","west",0);
  add_exit(RHUN_DIR+"forest/m11","northeast",0);
  add_stuff();
}

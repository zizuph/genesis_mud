...
void create_room()
{
  ...
  add_exit(RHUN_DIR+"forest/j8", "north", 0);
  add_exit(RHUN_DIR+"forest/k9","east",0);
  add_exit(RHUN_DIR+"forest/i9","west",0);
  add_exit(RHUN_DIR+"forest/k10","southeast",0);
  add_exit(RHUN_DIR+"forest/i10","southwest",0);
  add_stuff();
}

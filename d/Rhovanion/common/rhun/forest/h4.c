...
void create_room()
{
  ...
  add_exit(RHUN_DIR+"forest/g3","northwest",0);
  add_exit(RHUN_DIR+"forest/h3","north",0);
  add_exit(RHUN_DIR+"forest/i3","northeast",0);
  add_exit(RHUN_DIR+"forest/i5","southeast",0);
  add_exit(RHUN_DIR+"forest/h5","south",0);
  add_exit(RHUN_DIR+"forest/g5","southwest",0);
  add_stuff();
}

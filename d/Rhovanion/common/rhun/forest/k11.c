...
void create_room()
{
  ...
  add_exit(RHUN_DIR+"forest/k10","north",0);
  add_exit(RHUN_DIR+"forest/k12", "south", 0);
  add_exit(RHUN_DIR+"forest/l11", "east", 0);
  add_exit(RHUN_DIR+"forest/j11", "west", 0);
  add_exit(RHUN_DIR+"forest/j12", "southwest", 0);
  add_stuff();
}

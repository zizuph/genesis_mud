...
void create_room()
{
  ...
  add_exit(RHUN_DIR+"forest/m13", "northeast", 0);
  add_exit(RHUN_DIR+"forest/j15", "southwest", 0);
  add_exit(RHUN_DIR+"forest/k15", "south", 0);
  add_exit(RHUN_DIR+"forest/j14","west",0);
  add_stuff();
}

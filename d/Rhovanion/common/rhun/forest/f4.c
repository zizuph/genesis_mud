...
void create_room()
{
  ...
  add_exit(RHUN_DIR+"forest/e4","west",0);
  add_exit(RHUN_DIR+"forest/f3","north",0);
  add_exit(RHUN_DIR+"forest/g3","northeast",0);
  add_exit(RHUN_DIR+"forest/g5","southeast",0);
  add_exit(RHUN_DIR+"forest/f5","south",0);
  add_stuff();
}

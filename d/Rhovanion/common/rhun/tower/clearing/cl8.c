...
set_long(break_string("You are standing in a large clearing.  Just"
    ...
    +" may enter by heading south.  The clearing continues around to"
    +" the east or west, while an entrance back into the forest can"
    +" be seen north of here."
	+"\n",75));

AE(RHUN+"tower/clearing/cl9", "east", 0);
AE(RHUN+"tower/clearing/cl6", "west", 0);
AE(RHUN+"tower/clearing/cl7", "north", 0);
    add_exit(RHUN_DIR+"tower/inside/1a", "south", 0);

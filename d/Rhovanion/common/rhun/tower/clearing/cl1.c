...
set_long("You have entered a large clearing in the"
    ...
    +" center, to the north, stands a tall and menacingly-dark tower."
    +" You can see Easterlings moving around inside.\n");

add_exit(RHUN_DIR+"tower/clearing/cl3", "north", 0);
add_exit(RHUN_DIR+"forest/m15", "south", 0);
add_exit(RHUN_DIR+"tower/clearing/cl2", "northeast", 0);
add_exit(RHUN_DIR+"tower/clearing/cl4", "northwest", 0);

...
void create_room()
{
    set_short("East part of the hallway.");
    set_long("The hallway stretches out to the west and east, and "+
            " to the west you see light coming through the doors. Several small "+ 
    ...
    add_exit(RHUN_DIR + "newruins/hall","west");
    add_exit(RHUN_DIR + "newruins/etower","east");

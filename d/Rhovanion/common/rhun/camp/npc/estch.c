...
arming ()
{
    ...
    wep = clone_object(CAMP_DIR + "wep/obsaxe");
    wep->move(this_object());
    command("wield axe");

    shield = clone_object(CAMP_DIR + "arm/obsshield");
    shield->move(this_object());
    command("wear shield");

    helmet = clone_object(CAMP_DIR + "arm/obshelmet");
    helmet->move(this_object());
    command("wear helmet");

    mail = clone_object(CAMP_DIR + "arm/obsmail");
    mail->move(this_object());
    command("wear platemail");

    leggings = clone_object(CAMP_DIR + "arm/obsleggings");
...
void 
react_axe(string acc,string caa)
{

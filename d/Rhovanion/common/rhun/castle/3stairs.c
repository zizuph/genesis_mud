...
reset_room()
{
    ...
    if(!find_living("_castle_guard_3stairs"))
    {
        object guard;
	guard=clone_object(RHUN+"npc/castle_guard");
        guard->set_living_name("_castle_guard_3stairs");
        guard->move(TO);
    }
}
...
{
    set_short("Staircase");
    set_long("You stand on the third level of this stone castle.  "+
    ...
    AE(RHUN+"castle/3east","east");
    AE(RHUN+"castle/4","up");
    AE(RHUN+"castle/2stairs", "down");
    AE(RHUN+"castle/3west", "west");

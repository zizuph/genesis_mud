...
set_chat_time(3);
add_chat("This ship stops halfway upriver, besides stopping at both ends.");
add_chat("Have you been to Esgaroth?");
add_chat("The River Carnen flows down from the Iron Hills, where dwarves live.");
}
...
buy(string str)
{
    ...
    buy_ob=clone_object(RHUN+"ships/ticket1");
    if (!buy_ob) {

...
create_room()
{
    set_short("Hallway branching");
    set_long("This hallway of high arches and walls of black stone heads "+
        "north to south here, with a smaller branch going west.\n");

    AE(RHUN+"citadel/1i","south");
    AE(RHUN+"citadel/1o","west");
    AE(RHUN+"citadel/1m","north");
    ...
    add_item(({"hall","hallway","west"}),"The hallway of black stone, "+
        ...
        "to the south, east and north from here.  It is quite high, probably "+
        "close to six "+

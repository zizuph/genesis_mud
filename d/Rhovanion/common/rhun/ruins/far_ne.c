...
{   
    ...
    "around you to the "+
    "northwest and southwest, while a wide dirt road heads off to the "+
    "northeast"+
    ".\n");
    
    AE(RHUN+"ruins/far_n","northwest");
    AE(RHUN+"ruins/ne_side","southwest");
    AE(RHUN+"ruins/to_road","northeast");

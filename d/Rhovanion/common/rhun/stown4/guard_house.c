...
set_long(break_string("You are standing in the guardhouse at"
     +" the northwest corner of this little town.  It is made entirely"
     +" of wood, and is sparsely furnished.  The only exit from it"
     +" leads southeast to a crossroads.\n",75));

AE(RHUN+"stown4/crossroads","southeast",0);

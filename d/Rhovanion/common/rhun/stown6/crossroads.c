...
AE(RHUN+"stown6/guard_house","northwest",0);
AE(RHUN+"stown6/road_sw","southwest",0);
AE(RHUN+"stown6/road_ne","northeast",0);
AE(RHUN+"stown6/home_1","east",0);
AE(RHUN+"stown6/road_se","southeast",0);

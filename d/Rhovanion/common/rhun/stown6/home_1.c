...
set_long(break_string("You have stepped into a small home in this tiny"
	...
	+" exit is back out a small open doorway to the west."
	+"\n",75));

AE(RHUN+"stown6/crossroads","west",0);

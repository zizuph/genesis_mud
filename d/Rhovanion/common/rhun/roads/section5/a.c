...
set_long(break_string("You stand on a very-old and well-defined dirt road"
     ...
     +" empty plains of Rhun.  A small town sits just to the southwest, and"
     +" the road continues on to the northeast."
     +"\n",75));

AE(RHUN+"roads/section5/b","northeast",0);
AE(RHUN+"stown2/road_ne","southwest",0);
...
add_item("road",break_string("The road is made of dirt, but is well-marked."
	+"  It heads from northeast to southwest here."
	+"\n",75));
add_item("plains",break_string("The plains lie to the north, stretching"
	+" on seemingly forever.\n",75));
add_item("town",break_string("The little town lies just to the southwest."

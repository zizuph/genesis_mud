...
+"The Sea of Rhun lies off to the"
	...
	+"  To the north is a junction in the road."
     +"\n",75));

AE(RHUN+"roads/section6/c","north",0);
AE(RHUN+"roads/section7/b","southeast",0);

add_item("road",break_string("The road is made of dirt, but it"
	+" is quite well-marked."
	+"  It makes a fork to the north."
	+"\n",75));
add_item(({"sea","Sea","Sea of Rhun","sea of rhun"}),
	break_string("The Sea of Rhun lies just south of here."

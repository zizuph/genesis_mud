...
set_long(break_string(
	...
	+"  The Sea of Rhun, the largest known inland body of"
	+" water, stands nearby."
     +"\n",75));

AE(RHUN+"roads/section4/d","southeast",0);
AE(RHUN+"roads/section4/b","west",0);

add_item(({"sea","Sea","sea of rhun","Sea of Rhun"}),
	break_string("The Sea of Rhun extends beyond the"
	+" range of sight.  It lies to the east and south"
	+" from here.\n",75));

...
get_stuff() {
   ...
   clone_object("/d/Rhovanion/common/dungeon1/gear/wsword1.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/wsword1.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/wgauntlets.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/wbuckler.c")
   ->move(TO);
   command("wear all");
   command("wield all");
   return 1;

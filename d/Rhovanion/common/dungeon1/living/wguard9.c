...
get_stuff() {
   ...
   clone_object(ONE_OF_LIST(({
               "/d/Rhovanion/common/dungeon1/gear/waxe2.c",
               "/d/Rhovanion/common/dungeon1/gear/wwarhammer3.c",
               "/d/Rhovanion/common/dungeon1/gear/wknife2.c",
               "/d/Rhovanion/common/dungeon1/gear/loincloth.c"})))->move(TO);
   clone_object(ONE_OF_LIST(({
               "/d/Rhovanion/common/dungeon1/gear/wshirt.c",
               "/d/Rhovanion/common/dungeon1/gear/wshirt2.c",
               "/d/Rhovanion/common/dungeon1/gear/whelmet2.c"})))->move(TO);
   clone_object(ONE_OF_LIST(({
               "/d/Rhovanion/common/dungeon1/gear/wpants.c",
               "/d/Rhovanion/common/dungeon1/gear/loincloth.c",
               "/d/Rhovanion/common/dungeon1/gear/wpants3.c"})))->move(TO);
   command("wear all");
   command("wield all");
   return 1;
}

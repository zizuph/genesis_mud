...
get_stuff() {
   seteuid(getuid());
   clone_object("/d/Rhovanion/common/dungeon1/gear/gwarmour1.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/gwarmour2.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/gwarmour3.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/gwarmour4.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/gwpouch.c")
   ->move(TO);
   ob1=clone_object("/d/Rhovanion/common/dungeon1/gear/gwsword.c");
   ob1->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/hpotion2.c")
   ->move(TO);
   command("wear all");
   command("wield all");
}

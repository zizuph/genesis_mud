...
get_stuff() {
   ...
   object ob1;
   seteuid(getuid());
   clone_object("/d/Rhovanion/common/dungeon1/gear/banshirt.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/banpants.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/banboots.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/bansword.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/ring.c")
   ->move(TO);

...
create_door() {
   ...
   set_door_desc("This is a sturdy, wooden door with " +
      "a simple lever for a handle.\n");
   set_other_room("/d/Rhovanion/common/dungeon1/rooms/guard5.c");
   set_open(0);
   set_open_desc("The north door stands open.\n");
   set_closed_desc("The north door stands closed.\n");

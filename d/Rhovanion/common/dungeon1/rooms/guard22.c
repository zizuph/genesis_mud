...
create_room() {
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard9","north");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard21","west");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard23","south");
}

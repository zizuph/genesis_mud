...
create_room() {
   ...
   clone_object("/d/Rhovanion/common/dungeon1/living/constrictor.c")
   ->move(TO);
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun29","northwest");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun27","northeast");
}

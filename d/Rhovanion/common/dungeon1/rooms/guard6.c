...
create_room() {
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard25","north",
      "@@part_check");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/store1","east");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard2","south");
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard2.c")
   ->move(TO);
}
int part_check() {

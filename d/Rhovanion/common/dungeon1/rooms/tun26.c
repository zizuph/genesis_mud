...
create_room() {
   ...
   clone_object("/d/Rhovanion/common/dungeon1/gear/corpse.c")
   ->move(TO);
   for (i = 0; i < 5; i++)
   clone_object("/d/Rhovanion/common/dungeon1/living/rat.c")
   ->move(TO);
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun27","west");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun25","southeast");
}

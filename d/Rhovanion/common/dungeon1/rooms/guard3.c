...
create_room() {
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard4","west",
      "@@part_check");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard2","north");
   room_add_object("/d/Rhovanion/common/dungeon1/living/wguard2.c",
      1,"An odd figure steps out from around the corner " +
      "to oppose you.");
}
int part_check() {

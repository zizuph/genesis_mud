...
create_room() {
   ...
   clone_object("/d/Rhovanion/common/dungeon1/misc/door4a.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard3.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard4.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/wchest2.c")
   ->move(TO);
}
void
init()

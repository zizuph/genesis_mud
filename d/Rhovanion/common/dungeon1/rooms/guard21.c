...
create_room() {
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard8","north");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard22","east");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard20","south");
}

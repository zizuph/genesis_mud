...
create_room() {
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard1","west");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/alcove1","southwest");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/alcove2","southeast");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun33","east");
}
int
false_door() {

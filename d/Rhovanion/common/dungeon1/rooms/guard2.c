...
create_room() {
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard6","north");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard1","east");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard3","south");
}

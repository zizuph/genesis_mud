...
create_room() {
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard21","south");
   ...
   add_food(({"boar intestines","intestines"}),"intestines","boar",
      ...
      BS("This is a bowl of boiled boar intestines simmering in " +
         "its own juices.\n"),0);
   for (i = 0; i < 5; i++)
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard9.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard10.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/living/wbarmaid.c")
   ->move(TO);
}
init()
{

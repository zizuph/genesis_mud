...
create_room() {
   ...
   set_long("You are now in a long, dark passageway " +
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard32","west");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard30","east");
}

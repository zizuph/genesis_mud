...
create_room()
{
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun3","east");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun5","west");
...
{
   seteuid(getuid());
   TO->add_exit("/d/Rhovanion/common/dungeon1/rooms/spilair1.c","shaft",0);
...
enter_shaft()
{
   TP->move_living("into the shaft",
      "/d/Rhovanion/common/dungeon1/spilair1.c");
   return 1;
}

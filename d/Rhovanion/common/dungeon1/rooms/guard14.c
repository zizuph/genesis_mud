...
create_room() {
   ...
   set_long("This is a small room approximately fifteen " +
      ...
      "straw tatami mat lies against the west wall and hanging " +
      "from the north wall is an old scroll.  It smells oddly " +
      "rank in here.\n");
   ...
   clone_object("/d/Rhovanion/common/dungeon1/misc/door2a.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard3.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/gear/wchest.c")
   ->move(TO);
}
void
init()

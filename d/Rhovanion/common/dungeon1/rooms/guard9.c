...
create_room() {
   ...
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard11.c")
   ->move(TO);
   clone_object("/d/Rhovanion/common/dungeon1/living/wguard11.c")
   ->move(TO);
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard22","south");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard26","east",
      "@@p_check");
}
int p_check() {

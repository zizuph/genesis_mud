...
create_room() {
   ...
   set_long("The stone blocked passageway curves sharply here " +
      "heading off to the northwest and south and, you think, " +
      "is slightly slanted down to the east.  The ceiling hangs " +
   ...
   add_exit("/d/Rhovanion/common/dungeon1/rooms/tun26","northwest");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/int9","south");
}

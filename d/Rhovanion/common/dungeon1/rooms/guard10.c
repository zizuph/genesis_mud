...
create_room() {
   ...
   clone_object("/d/Rhovanion/common/dungeon1/misc/door7a.c")
   ->move(TO);
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard12","west");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard11","south");
}

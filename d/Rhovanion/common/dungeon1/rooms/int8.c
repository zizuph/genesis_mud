...
create_room() {
   ...
   set_long("This is a small room about fifteen feet east and " +
      ...
      "fall apart on top of you.  The air here is hardly breatheable " +
      "and reaks of death.  Your ears detect horrid unearthly " +
      "noises coming from the east passageway a ways down.\n");
   ...
   ->move(TO);
   add_exit("/d/Rhovanion/common/dungeon1/rooms/int9","north");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/were1","east");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/int7","south");
}

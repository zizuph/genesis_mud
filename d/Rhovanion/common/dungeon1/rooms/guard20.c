...
create_room() {
   ...
   clone_object("/d/Rhovanion/common/dungeon1/misc/door6.c")
   ->move(TO);
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard21","north");
   add_exit("/d/Rhovanion/common/dungeon1/rooms/guard19","south");
}

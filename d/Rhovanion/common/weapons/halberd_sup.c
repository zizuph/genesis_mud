...
{
  if(!query_wielded())
    return "This is very strange halberd. You have never seen such weapon.\n";
  if(!halb_is_in_both)
    return "This is very strange halberd. Maybe it should be a good weapon "+
           "but you simply can't hit properly with it.\n";
  return "This is an excellent halberd. It fits exactly into your hands and "+
         "it seems like if it is hitting on its own.\n";
}

...
#define STORE_ROOM CAMPDIR+"campstore"
#define KEEPER     CAMPDIR+"shopkeeper"
...
create_room()
{
  ...
  set_long("You're inside huge tent. But you notice that "+
           "this tent was choosen by one of barbarians to make "+
           "shop here. \n"+
           "There is one obvious exit: southeast.\n");
  ...
  add_exit(CAMPDIR+"camp2","southeast",0);
}

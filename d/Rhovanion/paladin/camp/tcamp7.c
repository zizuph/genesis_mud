...
#define STD_FEE 30
#define BANKER  CAMPDIR+"bankkeeper"
...
/*** redefine long but I suggest leave the safe in desc ***/
  ...
  set_long("You are inside huge tent. But there is diffirence between "+
           "this tent and others.\nYou notice huge safe in one "+
           "wall. One of the barbarians opened his bank here. If you "+
           "want instructions just ask him.\n");

...
create_room()
{
  ...
  set_long("You are in a part of the camp that you find "+
           ...
           "get attacked!\n"+
           "You also noticed small tent to the west.\n");
  set_short("Usualy looking part of the camp near some tents");
  add_exit(CAMPDIR+"camp24","south",0);
  add_exit(CAMPDIR+"camp12","north","@@trygo");
  add_exit(CAMPDIR+"tcamp10","west","@@trygo");
  add_exit(CAMPDIR+"camp16","east","@@trygo");

...
create_room()
{
  ...
  add_item(({"cave", "opening"}), break_string("Here in the rocky side "
    + "of the mountain is the opening to a small cavern.  A humid gust of "
...
string get_long()
{
  ...
  case "morning":
    RetS += "The sun is rising above the mountain tops.  ";
    break;
  ...
  case "afternoon":
    RetS += "The sky begins to darken as the sun sets behind the mountain "
      + "tops.  ";
    break;
  ...
  RetS += "You can see a valley below you.  The path continues northeast "
    + "and southwest.  There is a opening of a dark and forbidding cave "

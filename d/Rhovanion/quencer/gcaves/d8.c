...
reset_room(){
  ...
  door->set_lock_mess( ({"", 
          "A bunch of goblins come running in carrying some poor elf.\n"+
          "The leader goblin unlocks and opens the grating and they throw "+
                   "the prisoner in the cell.\n"+
          "The leader goblin shouts: Next time you try to escape I kill you "+
                   "with my own hands!!!\n"+
          "The leader closes the grating, locks it, grins evilly at you and "+
                   "the goblins run away.\n"+
          "You feel a great relief. Fortunately they haven't considered "+

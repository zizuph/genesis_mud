...
void create_cave()
{
  ...
  set_long("You are at the end of a tunnel that burrows under the Misty "
    ...
    + "But this one is slightly different. One greedy goblin has made a private "
    + "shop here. If he is here he will sell all kind of things he has or "
    + "buy what you offer to him. He has made a poster explaining it which you "
    + "can read. Because he doesn't want to have anything stolen he keeps "
  ...
  add_item("storeroom","You can see only a closed door.\n");
  add_item("door","They are very massive and able to keep anyone out "+
                  "of the storeroom.\n");
...
{
  keeper->command("say "+TP->query_name()+", you have not specified to sell "+

...
create_room() {set_short("Divided Sky.\n");
   ...
   clone_object("/d/Rhovanion/mute/dungeon1/wguard5.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wguard6.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wguard6.c")->move(TO);
   add_exit("/d/Rhovanion/mute/dungeon1/guard18","west");
   add_exit("/d/Rhovanion/mute/dungeon1/pit","pit");
}

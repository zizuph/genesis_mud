...
create_room() {
   ...
   ob1 = clone_object("/d/Rhovanion/mute/dungeon1/bandit1.c")->move(TO);
   ob2 = clone_object("/d/Rhovanion/mute/dungeon1/bandit1.c")->move(TO);
   ob3 = clone_object("/d/Rhovanion/mute/dungeon1/bandit2.c")->move(TO);
   add_exit("/d/Rhovanion/mute/dungeon1/tun6.c","north");
   add_exit("/d/Rhovanion/mute/dungeon1/bantun1.c","hole","@@part_check");
}
int part_check() {
   object bandit;         

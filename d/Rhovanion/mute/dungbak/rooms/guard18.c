...
create_room() {
   ...
   clone_object("/d/Rhovanion/mute/dungeon1/door4.c")->move(TO);
   add_exit("/d/Rhovanion/mute/dungeon1/guard19","north");
   add_exit("/d/Rhovanion/mute/dungeon1/guard7","east");
   add_exit("/d/Rhovanion/mute/dungeon1/guard5","south");
}

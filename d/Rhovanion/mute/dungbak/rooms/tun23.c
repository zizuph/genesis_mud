...
create_room() {
   ...
   for (i = 0; i < 3; i++)
   ob1 = clone_object("/d/Rhovanion/mute/dungeon1/rat.c")->move(TO);
   for (i = 0; i < 5; i++)
   ob2 = clone_object("/d/Rhovanion/mute/dungeon1/rat3.c")->move(TO);
   add_exit("/d/Rhovanion/mute/dungeon1/int6","south");
   add_exit("/d/Rhovanion/mute/dungeon1/tun24","east");
}

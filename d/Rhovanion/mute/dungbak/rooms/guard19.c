...
create_room() {
   ...
   clone_object("/d/Rhovanion/mute/dungeon1/door5.c")->move(TO);
   add_exit("/d/Rhovanion/mute/dungeon1/guard20","north");
   add_exit("/d/Rhovanion/mute/dungeon1/guard18","south");
}

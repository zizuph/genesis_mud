...
get_stuff() {
   ...
   object ob1;
   seteuid(getuid());
   clone_object("/d/Rhovanion/mute/dungeon1/shovel.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/banarmour2.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/bandag2.c")->move(TO);

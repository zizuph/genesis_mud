...
get_stuff() {
   ...
   clone_object("/d/Rhovanion/mute/dungeon1/wwarhammer.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wshirt.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wpants2.c")->move(TO);

...
get_stuff() {
   ...
   object ob2;
   seteuid(geteuid());
   clone_object("/d/Rhovanion/mute/dungeon1/warmour3.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wbuckler2.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wbelt.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wboots.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/whelmet.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wnecklace.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wsword4.c")->move(TO);

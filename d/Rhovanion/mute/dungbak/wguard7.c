...
get_stuff() {
   ...
   clone_object("/d/Rhovanion/mute/dungeon1/wboots.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wwarhammer2.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wknife.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wknife.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wshield1.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wshield2.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/wsword2.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/waxe.c")->move(TO);
   clone_object("/d/Rhovanion/mute/dungeon1/warmour1.c")->move(TO);

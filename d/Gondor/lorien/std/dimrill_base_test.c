...
void set_items_near_dimrill();
void set_items_far_dimrill();
...
set_items_all_dimril()
{
    ...
    add_item( ({"southern mountains", "south mountains",
            "mountains to the south"}), "To the south, the Misty Mountains " +
            "recede as far as the eye can see.\n");
...
set_items_near_dimrill();
{
    add_item( ({"caradhras", "azanulbizar", "redhorn", "barazinbar"}),
        ...
        "front.\n");
    add_item( ({"glen", "vale", "narrow valley", "dark vale"}),
...
set_items_fauna_1()
{
    add_item( ("heather"), "XXXX\n");
    add_item( ({"whin", "gorse"}), "XXXX\n");
}
...
{
    set_items_fauna_1();
    add_item( ({"mirrormere", "mere", "lake", "body of water"}),
    ...
    add_item( ("road"), "The road winds its way thru the trees, among " +
        ...
        "Moria can be seen.\n");
//  Heather and whin are added to set_items_fauna_1
}

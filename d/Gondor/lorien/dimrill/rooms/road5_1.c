...
create_dimrill_room()
{
    ...
    set_long("Along a mountain road. Up-mountain from here lies the" +
        "Dimril gate to Moria. Downward from here a vale can be seen, " +
        "and in this steep valley to the north " + VBFC("light_type")+ 
        " reflects off the surface of a body of water in the distance. " +

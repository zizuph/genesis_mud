...
create_dimrill_room()
{
    ...
    set_long("Along a mountain road. Upwards and to the northwest lies the " +
        "Dimril gate to Moria. Downward to the east lies a vale. The valley " +
        "narrows to a steep and shady glen towards it's northern end. " +
         VBFC("light_type")+ " reflects off the surface of a body there, " +
        "in the distance. There are birch and fir trees along " +
        "the road.\n"); 

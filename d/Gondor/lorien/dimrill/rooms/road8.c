...
create_dimrill_room()
{
    ...
    set_long("The entrance to Moria, glares down from atop a mountain " +
    "to the northwest. The road continues towards the north where, " + 
    "in the distance, " + VBFC("light_type") + " "+
    "reflects off of the surface of a pond or mere. " +
    "To the southeast a stream emerges and begins to tumble along. The " +
    "road follows alongside, as the small river winds its way southward " +
    "and eastward from here\n"); 

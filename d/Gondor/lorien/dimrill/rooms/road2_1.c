...
create_dimrill_room()
{
    ...
    set_long("The way turns and opens up. Steps upwards, towards " +
        "the entrance to Moria, can be seen to the west. Downward a dale " +
        "can be seen to the east where, in the distance, " + 
        VBFC("light_type")+ " reflects off the surface of a body of " +
        "water. There are birch and fir trees along the road.\n"); 

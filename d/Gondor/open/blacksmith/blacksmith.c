...
#define BLACKS_DIR "/d/Gondor/open/blacksmith"
...
/*
 * Function name:	ccreate_blacksmith
...
//    set_dunedain_house("Hallacar");
    set_race_name("human");
    set_living_name("derick");
    set_title("Blacksmith");
    set_adj(({"sweaty","strong"}));
set_long("This is Derick, the local blacksmith. His muscular body comes from years of hard work crafting weapons and armours. Sweat drips off his brow from the heat of the forge."); 
...
//    add_chat("If you want something, just say you would like to order.");
    ...
    equip(BLACKS_DIR + "smithapron");
    equip(BLACKS_DIR + "smithhammer");

//    set_equipment( ({ (, (BLACKS_DIR + "smithapron"), }) );
} /* create_blacksmith */

...
// this is a base file for Gondor
inherit "/d/Gondor/common/lib/area_room.c";

// This inherits the drink code 
...
// This always happens in all rooms.
    add_tell("The grass waves in the breeze.");
...
// These are additional meadow noises that are added when this routine is used
    add_tell("Some deer watch you from a distance.");
    add_tell("A rabbit hops through the grass.");
    add_tell("A butterfly darts from flower to flower.");
...
// These tells are only used when this routine is inherited.
    add_tell("A fish leaps out of the pond and then splashes in the water.");
    add_tell("Bugs skate across the pond's surface.");
    add_tell("'rbbt ... rbbt'");
}

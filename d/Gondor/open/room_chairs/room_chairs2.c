 ...
 *
 * configurable definite/indefinite articles courtesy of Gorboth
 *
...
remove_chair(string name)
{
    ...
    {
	Room_chairs = m_delete(Room_chairs, name);
	return 1;
    }
    return 0;
} /* remove_chair */
...
exits_description()
{
	...
	while ( s-- > 0)
	{
	    desc = sitting_on_chair(chairnames[s], tp, 0, Mentioned) + desc;
	}
    }
    return desc;
} /* exits_description */

/* Name      : /d/Gondor/harondor/room/camp/room/camp04.c
...
create_camp()
{
    ...
    set_extraline("Across the dry and barren land dried grasses grow " +
        ...
        "the area, a few bigger then most. Southwest of you is one " +
        "particularly large with tent flaps open. Northwest there are " +
    ...
    add_exit(HAR_RM_CAMP_DIR + "campE02", "northwest", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp05", "south", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp03", "west", check_allow, 2);
    
    set_tent_path(HAR_RM_CAMP_DIR + "camptent04");

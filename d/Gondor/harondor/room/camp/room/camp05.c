/* Name      : /d/Gondor/harondor/room/camp/room/camp05.c
...
create_camp()
{
    ...
    set_extraline("Across the dry and barren land dried grasses grow " +
        ...
        "the area, a few bigger then most. Just southeast of you is one " +
    ...
    add_exit(HAR_RM_CAMP_DIR + "camp06", "south", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp04", "north", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp09", "west", check_allow, 2);
    
    set_tent_path(HAR_RM_CAMP_DIR + "camptent05");

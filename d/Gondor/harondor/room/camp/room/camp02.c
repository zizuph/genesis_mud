/* Name      : /d/Gondor/harondor/room/camp/room/camp02.c
...
create_camp()
{
    ...
    set_extraline("Across the dry and barren land dried grasses grow " +
        ...
        "the area, a few bigger then most. Southeast of you is one " +
    ...
    add_exit(HAR_RM_CAMP_DIR + "campE02", "northeast", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp03", "east", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp01", "south", check_allow, 2);
    
    set_tent_path(HAR_RM_CAMP_DIR + "camptent02");

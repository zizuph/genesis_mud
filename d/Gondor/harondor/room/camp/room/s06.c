/* Name      : /d/Gondor/harondor/room/camp/room/s06.c
...
create_area_room()
{
    ...
    add_exit(HAR_RM_CAMP_DIR + "s05", "west",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s03", "northwest",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s04", "north",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s07", "east",0,2,1);

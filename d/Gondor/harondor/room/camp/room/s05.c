/* Name      : /d/Gondor/harondor/room/camp/room/s05.c
...
create_area_room()
{
    ...
    add_exit(HAR_RM_CAMP_DIR + "s02", "northwest",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s03", "north",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s04", "northeast",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s06", "east",0,2,1);

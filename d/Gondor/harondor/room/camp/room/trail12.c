/* Name      : /d/Gondor/harondor/room/camp/room/trail12.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs south and northeast.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail13", "northeast",0,1,1);
    add_exit(HAR_RM_CAMP_DIR + "trail11", "south",0,1,1);

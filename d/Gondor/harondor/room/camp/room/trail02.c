/* Name      : /d/Gondor/harondor/room/camp/room/trail02.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs east and west. A road " +
        "can be spotted a little way to the west.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail01", "west");
    add_exit(HAR_RM_CAMP_DIR + "trail03", "east");

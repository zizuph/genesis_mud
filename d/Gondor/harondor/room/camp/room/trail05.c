...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail wind between them as it runs southeast and northwest. A " +
        "road can vaguely be spotted far to the west.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail04", "northwest");
    add_exit(HAR_RM_CAMP_DIR + "trail06", "southeast");

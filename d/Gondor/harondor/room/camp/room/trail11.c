/* Name      : /d/Gondor/harondor/room/camp/room/trail11.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs southwest and north.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail07", "southwest",0,1,1);
    add_exit(HAR_RM_CAMP_DIR + "trail12", "north",0,1,1);

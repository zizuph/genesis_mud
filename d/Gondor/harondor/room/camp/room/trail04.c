/* Name      : /d/Gondor/harondor/room/camp/room/trail04.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs southeast and southwest. A " +
        "road can vaguely be spotted to the west.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail03", "southwest");
    add_exit(HAR_RM_CAMP_DIR + "trail05", "southeast");

/* Name      : /d/Gondor/harondor/room/camp/room/camp08.c
...
create_camp()
{
    ...
    set_extraline("Across the dry and barren land dried grasses grow " +
        ...
        "the area, a few bigger then most. Just south of you is one " +
    ...
    add_exit(HAR_RM_CAMP_DIR + "campE01", "northwest", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp01", "north", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp07", "east", check_allow, 2);
    
    set_tent_path(HAR_RM_CAMP_DIR + "camptent08");

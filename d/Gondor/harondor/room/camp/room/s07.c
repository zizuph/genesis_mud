/* Name      : /d/Gondor/harondor/room/camp/room/s07.c
...
create_area_room()
{
    ...
    add_exit(HAR_RM_CAMP_DIR + "s06", "west",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s04", "northwest",0,2,1);
    add_exit(HAR_RM_CAMP_DIR + "s08", "east",0,2,1);

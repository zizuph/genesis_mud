/* Name      : /d/Gondor/harondor/room/camp/room/trail13.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs southwest and east.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail14", "east",0,1,1);
    add_exit(HAR_RM_CAMP_DIR + "trail12", "southwest",0,1,1);

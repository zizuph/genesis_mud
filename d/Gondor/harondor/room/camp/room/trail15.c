/* Name      : /d/Gondor/harondor/room/camp/room/trail15.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail wind between them as it runs west and southeast. Further " +
        "southeast the mounds tend to get lower and the trail wider.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "campE02", "southeast",0,1,1);
    add_exit(HAR_RM_CAMP_DIR + "trail14", "west",0,1,1);

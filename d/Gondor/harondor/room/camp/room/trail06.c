/* Name      : /d/Gondor/harondor/room/camp/room/trail06.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs east and northwest.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail05", "northwest");
    add_exit(HAR_RM_CAMP_DIR + "trail07", "east");

/* Name      : /d/Gondor/harondor/room/camp/room/trail07.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs west and east, it also splits " +
        "up trailing off to the south and faintly to the northeast.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail06", "west");
    add_exit(HAR_RM_CAMP_DIR + "trail08", "east");
    add_exit(HAR_RM_CAMP_DIR + "trail11", "northeast",0,1,1);
    add_exit(HAR_RM_CAMP_DIR + "trail09", "south");

/* Name      : /d/Gondor/harondor/room/camp/room/s09.c
...
create_area_room()
{
    ...
    set_extraline("Across the dry and barren land dried grasses grow " +
        ...
        "mounds in different sizes. With the wind blowing it is as if " +
        "mounds grow and dissipate in a flowing motion.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "camp06", "north","@@my_block",2,1);
    add_exit(HAR_RM_CAMP_DIR + "s10", "east","@@my_east",6,1);
    add_exit(HAR_RM_CAMP_DIR + "s08", "south",0,2,1);

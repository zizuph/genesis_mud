/* Name      : /d/Gondor/harondor/room/camp/room/camp09.c
...
create_camp()
{
    ...
    add_exit(HAR_RM_CAMP_DIR + "camp05", "east", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp03", "north", check_allow, 2);
    add_exit(HAR_RM_CAMP_DIR + "camp01", "west", check_allow, 2);
    
    set_tent_path(HAR_RM_CAMP_DIR + "camptent09");

/* Name      : /d/Gondor/harondor/room/camp/room/trail05.c
...
create_area_room()
{
    ...
    set_extraline("Dried grass grow in scattered patches across the " +
        ...
        "trail winds between them as it runs east and west. Further to " +
        "the east the mounds tend to get lower and the trail wider.");
    ...
    add_exit(HAR_RM_CAMP_DIR + "trail07", "west");
    add_exit(HAR_RM_CAMP_DIR + "campE01", "east");

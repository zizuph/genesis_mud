 ...
 * 
 *  Added MAGIC_AM_MAGIC
 *     Cotillion, May 8th 2017
 */ 
...
create_weapon()
{
    ...
    add_prop(MAGIC_AM_ID_INFO, 
        ({"This club appears to somehow be very special. ",1,
         "Its effectiveness seems to be dependant on the skill of the user. ", 25,
         "It works best in the hands of a user rumoured to have skills of " + 
         "a veteran. ", 55, "\n", 1 }) );

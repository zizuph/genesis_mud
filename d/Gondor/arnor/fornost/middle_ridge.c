/*
 *      /d/Gondor/arnor/fornost/middle_ridge.c
 *
 *      Coded by Arren.
 *
 *      Modification log:
...
create_fornost()
{
    set_short("at the middle of a ridge between two hilltops");
    ...
    add_exit(FORNOST_DIR + "north_ridge", "northeast", 0, 2);
    add_exit(FORNOST_DIR + "south_ridge", "south", 0, 2);
...
set_arnor_long()
{
    ...
    desc = "In the middle of a grassy ridge between two hilltops. "+
    ...
    "plains. The ridge extends to the northeast and south. ";

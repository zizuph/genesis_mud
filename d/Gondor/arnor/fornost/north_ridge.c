/*
 *      /d/Gondor/arnor/fornost/north_ridge.c
 *
 *      Coded by Arren.
 *
 *      Modification log:
...
create_fornost()
{
    set_short("at the northern end of a ridge between two hilltops");
    ...
    add_exit(FORNOST_DIR + "hill_top", "north", 0, 2);
    add_exit(FORNOST_DIR + "middle_ridge", "southwest", 0, 2);
...
set_arnor_long()
{
    ...
    desc = "In the northern end of a grassy ridge between two hilltops. "+
    ...
    "plains. The ridge extends to the southwest, there is a hilltop to "+
    "the north. ";

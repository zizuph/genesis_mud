...
create_arnor()
{
    ...
    add_item("tracks", &can_see_path("southwest"));
    ...
    add_exit(ND_OFFROAD + "offw1_2", "north", &off_road(), 0, 1);
    add_exit(ND_OFFROAD + "offw1_4", "southwest", &off_road(), 0, 1);
    add_exit(ND_OFFROAD + "offw1_5", "west", &off_road(), 0, 1);
    set_grass_wandering_msg();
    add_grass_room_items();
    set_tracks("southwest", "orc");
    reset_room();
}

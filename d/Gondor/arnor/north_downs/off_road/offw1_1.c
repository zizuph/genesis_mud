...
create_arnor()
{
    ...
    add_item("tracks", &can_see_path("northwest"));
    ...
    add_exit(ND_ROAD + "nd_road4", "east", &off_road(), 0, 1);
    add_exit(ND_OFFROAD + "offw1_2", "northwest", &off_road(), 0, 1);
    set_grass_wandering_msg();
    add_grass_room_items();
    set_tracks("northwest", "orc");
    reset_room();
}

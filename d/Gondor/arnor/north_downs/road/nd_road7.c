...
create_arnor()
{
    ...
    road_dirs = " The road gets steeper as it climbs to the " +
        "northwest and becomes more rugged, while it descends " +
        "to the southwest.\n";
    ...
    add_exit(ND_ROAD + "nd_road8", "northwest", 0, 0);
    add_exit(ND_ROAD + "nd_road6", "southwest", 0, 0);

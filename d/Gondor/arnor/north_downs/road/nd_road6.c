...
create_arnor()
{
    ...
    road_dirs = " The road continues to climb steadily and bends " +
		"to the northeast, while it descends to the west.\n";
    ...
    add_exit(ND_ROAD + "nd_road7", "northeast", 0, 0);
    add_exit(ND_ROAD + "nd_road5", "west", 0, 0);

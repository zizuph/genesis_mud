...
object  cap,
       *olog = allocate(2 + random(2)),
       *orc  = allocate(3 + random(3));

void
create_room()
{
    set_short("The Hall of Law in the House of the Stewards in Emyn Arnen");
    set_long(BSN("This is a large hall in the House of the Stewards in "
    ...
    add_item(({"hall", "large hall", "hall of law", }), BSN(
    ...
    add_item(({"pillars", "pillar", "columns", "stone pillars"}), BSN(
    ...
    add_item(({"band", "bands", "metal bands", "metal band"}), BSN(
    ...
    add_item(({"arch", "archway", "hinges", }), BSN(

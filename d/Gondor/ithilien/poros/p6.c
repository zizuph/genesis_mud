...
create_area_room()
{
    ...
    add_exit(ITH_DIR + "poros/p7", "west", 0, 2);
    add_exit(ITH_DIR + "poros/p5", "northeast", 0, 2);
    ...
    add_item(({"path", "ground", "trail", "game trail"}), BSN(
        ...
        + "areas with scrub and briar. To the northeast the path travels "
        + "through an especialy thick growth of bushes."));

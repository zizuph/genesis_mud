...
create_camp()
{
    ...
    set_long("The road opens up wide and veers southwest and also leads " +
        "north. The sounds of an army echo in from the southwest. \n");
    add_item("forest", 
    ...
    add_exit(ITH_DIR+"forest/haradpath2", "north", 0);
    add_exit(ITH_DIR+"forest/haradcamp8n", "southwest", 0);

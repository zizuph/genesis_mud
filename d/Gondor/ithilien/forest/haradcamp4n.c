...
create_camp()
{
    ...
    set_long("Trees surround the camp. It is dirty from all the mud " +
        "kicked up. Nonetheless, the camp is far cleaner than most " +
        "military camps.\n");
    add_item("forest", 
    ...
    add_exit(ITH_DIR+"forest/haradcamp8n", "north", 0);
    add_exit(ITH_DIR+"forest/haradcamp3n", "west", 0);
    add_exit(ITH_DIR+"forest/haradcamp1b", "southwest", 0);

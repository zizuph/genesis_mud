...
create_camp()
{
    ...
    add_item(({ "rows", "tents", "tent" }), 
        ...
        "soldiers.\n");
    add_item("forest", 
        "The forest surrounds the camp, hiding it from prying eyes and " +
        "muffling its sounds.\n");
    add_item("path",
	    "The path leads west and seems to have been made by humans.\n");

    add_exit(ITH_DIR+"forest/haradcamp3a", "west", 0);

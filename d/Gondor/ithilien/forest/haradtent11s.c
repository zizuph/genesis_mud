 ...
 *
 * 18-jun-2008, Toby: Fixed a newline in exa cot 
 *                    and added various adj to exa
 *
 */
...
create_camp()
{
    ...
    add_item(({ "cot","low bed","bed","temporary bed",
                "collapsible cot","collapsible bed"}),
    ...
    add_item(({ "clothing","coloured clothing","brightly coloured clothing" }), 
    ...
    add_exit(ITH_DIR+"forest/haradcamp11s","out",0);
    reset_room();
}

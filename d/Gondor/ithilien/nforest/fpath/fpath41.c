...
create_area_room()
{
    ...
    set_extraline("You are walking under old trees in ever-green woods. "
      ...
      + "they are growing thinner here. The land falls more steeply than "
      + "further to the east. An ever-present sweet and pungent smell of "
    ...
    add_exit(ITH_DIR + "nforest/fpath/fpath4",  "north",     0, 4);
    add_exit(ITH_DIR + "nforest/fpath/fpath42", "southwest", 0, 4);

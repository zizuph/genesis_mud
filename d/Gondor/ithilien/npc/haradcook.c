...
create_monster()
{
  ...
  set_long(BS("This is probably the cook. He seems to feed himself "+
      "rather liberally, for he is a true giant. But he moves with a "+
      "speed that is almost impossible for a man of his size. Unlike "+
      "the other Haradrim, he doesn't wear a single earring. \n"));
  set_race_name("human");
...
init_attack()
{
  ...
  TP->query_skill(SS_SNEAK) > TO->query_skill(SS_AWARENESS))
  {

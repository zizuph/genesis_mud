...
create_monster()
{
  ...
  add_chat("These cursed tramps that calls themselves rangers keep ambushing us!");
  add_act("sigh");
...
long_func()
{
  return BSN("You are looking at a black-skinned soldier. He looks like an experienced fighter. " + 
    "He is a mercenary in the army of the Dark Lord, serving in the armies that are to overrun Gondor.");
}

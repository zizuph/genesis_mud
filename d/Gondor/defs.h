...
#define TOLFALAS_DIR     (GONDOR_DIR + "tolfalas/")
...
#define BNUMEN_DIR        (GONDOR_GUILDS_DIR + "bnumen/")

#define GWATHLO_DIR      (GONDOR_DIR + "gwathlo/")

#define HAR_DIR          (GONDOR_DIR + "harondor/")
#define HAR_RM_DIR       (HAR_DIR + "room/")
...
/* New ranger definitions--see also rangers.h under RANGERS_DIR */
...
#define NRANGER_SOUL     (RANGERS_DIR + "soul/rangers_soul")
#define R_MANAGER        (RANGERS_DIR + "manager/manager")
#define R_COUNCIL        (R_MANAGER)
#define R_OUTLAW         (R_MANAGER)
#define R_SPONSORS       (R_MANAGER)
#endif
...
#define BNUMEN_S_GUILD_NAME "Black Numenoreans"
...
#define NOLDOR_S_GUILD_NAME     "Noldor of Imladris"
...
#ifdef NEW_RANGERS_OPEN
#define IS_CAPTAIN(x)     (R_MANAGER->query_council((x)->query_real_name()) \
                             == 0)
#endif
...
#define IS_NOLDOR(x)    ((x)->query_guild_name_race() == NOLDOR_S_GUILD_NAME)
...
/* reserved for Black Numenoreans: 118030 .. 118039
 */
#define SS_BNUMEN_LEVEL          118039

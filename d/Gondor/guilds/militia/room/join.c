 ...
 * 22Nov2004 - Mercade, added information about part/full time to rules.
 * December 2017 - Finwe, Updated sign and banned guilds
 */
...
militia_only()
{
    ...
    {
        write ("The recruiter steps in front of you, and blocks you from " +
            "going there.\n");
        return 1;
    }
...
"  / \\                                                              \\\n" +
" /___|                                                              |\n" +
" |\\_/___-_______-______/|________--___|\\_____-______-______/\\______/\n" +
"  \\                                                               \\\n" +
"   \\                                                               \\\n";

    string foot = ""+
"   /                                                               /\n" +
"  /___ ____  ________ _________________  _______________ _________/\n" +
" |/\\  -    |/        -                 |/               -          \\\n" +
" \\\\_|                                                               |\n" +
...
"    |                 =============================                 |\n" + 
"    |                                                               |\n" + 
"    |  1. Do no harm to those who assist us against the Lidless     |\n" + 
"    |     Eye, fellow Militia, soldiers of Gondor or their citi-    |\n" + 
"    |     zens, Rangers, or Heralds of the Valar.                   |\n" + 
"    |                                                               |\n" + 
"    |  2. Do not regularly associate with those of a black heart    |\n" + 
"    |     or evil reputation.                                       |\n" + 
"    |                                                               |\n" + 
"    |  3. The following may not be members of the Militia: Orcs,    |\n" + 
"    |     Servants of the East, followers of the foul dragon        |\n" + 
"    |     Takhisis, or others who cannot be trusted.                |\n" + 
"    |                                                               |\n" + 
"    |  4. Please refrain from spitting or using profanity in the    |\n" + 
"    |     in the guildhouse, and try to treat each other cour-      |\n" + 
"    |     teously. Try not to post anything on the board which      |\n" + 
"    |     might be considered unecessarily rude to others. We are   |\n" + 
"    |     not bickering orcs. We have to be able to count on our    |\n" + 
"    |     fellow Militia to guard our backs.                        |\n" + 
"    |                                                               |\n" + 
"    |  5. In principle, the Militia is a part time organization of  |\n" + 
"    |     people who have an occupation elsewhere. It is also pos-  |\n" + 
"    |     sible to join as a full time member and find another lay- |\n" + 
"    |     man trade to complete the skills. For the Militia it-     |\n" + 
"    |     self, there are no differences between part time or full  |\n" + 
"    |     time members.                                             |\n" + 
"    |                                                               |\n"; 

    if (IS_MILITIA(this_player()))
    {
"    |  One may 'list members', 'list banished', and 'list warned',  |\n" +
"    |  as well as being able to 'resign'--with a small penalty--    |\n" +
"    |  here. To switch between part time and full time, simply      |\n" +
"    |  'enlist' as the other time. There is no cost for this.       |\n" +
"    |                                                               |\n";
    }
    else
    {
        txt += ""+
"    |  One may 'enlist' here either as 'part time' or 'full time'.  |\n" +
"    |                                                               |\n";
    }
...
/*
    string txt = ("You read over the rules of the Thornlin Militia.\n" +
        "       RULES OF THE THORNLIN MILITIA\n" +
        "\n" +
        "1. Do no harm to those who assist us against the lidless eye: fellow Militia,\n" +
        "   Gondorian soldiers or citizens, Rangers, or Heralds of the Valar.\n" +
        "\n" +
        ...
        "   servants of the East, minions of the foul dragon Takhisis, or others who\n" +
        "   cannot be trusted. Trustworthy though they may be, Knights of Solamnia do\n" +
        "   not have the necessary time to assist in our defence, and so are also\n" +
        "   forbidden from being members.\n" +
        "\n" +
        "4. Please refrain from spitting or using profanity in the guildhouse, and try\n" +
        "   to treat each other courteously.  Try not to post anything on the board\n" +
        "   which might be considered unnecessarily rude to another member, class of\n" +
        "   members, or allies. We are not bickering orcs, we have to be able to count\n" +
        "   on our fellow Militia to guard our backs.\n" +
        "\n" +
        "5. In principle, the Militia is a part time organisation of people who have an\n" +
        "   occupation elsewhere. It is also possible to join as full time member and\n" +
        "   find another layman trade to complete ones skills. For the Militia itself,\n" +
        "   there are no differences between part time or full time members.\n" +
        "\n");

    if (IS_MILITIA(this_player()))
    {
        txt += "In fine print at the bottom, you read that one may 'list members', " +
            "'list banished' and 'list warned', as well as being able to 'resign' " +
            "(at a small penalty) here. To switch between part time and full time, " +
            "simply 'enlist' as the other type (at no cost).\n";
    }
    else
    {
        txt += "In fine print at the bottom, you read that one may 'enlist' here " +
...
enlist(string str)
{
    ...
    else if (who->query_race() == "goblin" || who->query_race() == "orc" )
    {

/*
 *  /d/Gondor/guilds/rangers/obj/racks/north_arrow_box.c
 * 
 *  A rack for the Rangers of the North to hold their arrows.
 *
 *  Copied from Finwe's similar rack in the Heralds guild in Shire.
 *  Gorboth, 2014
 */
 ...
 * Description  :    set up the rack
 */
public void
create_container()
{
    set_short("sturdy leather trough");
    set_name("trough");
    set_adj( ({ "sturdy", "leather" }) );
    set_long("This trough has been attached to the wall. Its sturdy leather sides"
      + " form a deep trough used to store arrows.\n");
...
prevent_enter(object obj)
{
    ...
    {
        write("Only arrows may be placed in the " + short() + ".\n");
        return 1;
    }

 ...
 * ?   , 15 February 2004: previous update?
 * Lavellan, 29 October 2010: changed to use new saving rack system
 * Lavellan, 31 January 2011: Fixed recovery conflict
 * Gorboth, 5 September 2012: Increased capacity to match other guilds
 *
 */
...
create_container()
{
    ...
    // Don't do this here, as it is overwritten by set_save_file
    //init_database();
    //set_alarm(0.0, 0.0, &recover_objects_from_database());
}

...
create_rack()
{
    ...
    set_adj("large");
    set_adj("wooden");
    set_long("This is a large wooden crate. It is made from planks of " +
        "oak and is set in a corner of the tree. From the looks of " +
        "the crate, can hold a lot of equipment.\n");

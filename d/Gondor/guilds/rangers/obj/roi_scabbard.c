/*
 *  /d/Gondor/guilds/rangers/obj/roi_scabbard.c
 *
...
#define SCABBARD           "/d/Gondor/guilds/rangers/obj/roi_scabbard.c"
...
set_scabbard_data()
{
    ...
    set_name("scabbard");
    add_name("roiscabbard");
    set_adj(adj);
    add_adj("leather");
    add_adj("green");
    set_short(short_description);
    set_pshort(adj + " green leather scabbards");
...
string short_description()
{
    if (sizeof(all_inventory(TO)))
        return adj + " green leather scabbard with a sword sheathed " +
            "inside";

    return adj + " green leather scabbard";
}

string long_description()
{
    string long_desc = "This " + adj + " green leather scabbard " +

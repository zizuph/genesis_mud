 ...
 * Gnadnar, 19-Mar-1998
 *
 * Made a Grey version for the North company
 * Varian - May, 2020
 */
...
create_backpack()
{
    ...
    add_adj(({ "large", "grey", "mottled-grey", "grey-coloured" }));
    set_short("large mottled-grey backpack");
    ...
    set_backpack_long("The backpack is rather large and "
        ...
        + "various shades of grey so that it offers the best possible "

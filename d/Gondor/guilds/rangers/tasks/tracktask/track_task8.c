/*
 *  /d/Gondor/guilds/rangers/hq/track_task8.c
 *
...
create_gondor()
{
    ...
    add_item(({"bush", "bushes"}), "Bushes grow in thick clusters beneath "
        ...
        + "notice a small gap beneath some of the bushes to the east.\n");
    ...
    add_exit(TRACKTASK_DIR + "track_task7", "east", &allowed(), 1, 1);
    add_exit(TRACKTASK_DIR + "track_task9", "west", &allowed(), 1);

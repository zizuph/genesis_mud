/*
 *  /d/Gondor/guilds/rangers/hq/track_task27.c
 *
...
create_gondor()
{
    ...
    set_long("The trees close about you in all directions but to the "
        + "north. Due to the thick bushes growing beneath the trees, it seems "
    ...
    add_item(({"bush", "bushes"}), "Bushes grow in thick clusters beneath "
        ...
        + "the path leading to the north. On closer inspection, however, you "
    ...
    add_exit(TRACKTASK_DIR + "track_task24", "southeast", &allowed(), 1, 1);
    add_exit(TRACKTASK_DIR + "track_task28", "north", &allowed(), 1);

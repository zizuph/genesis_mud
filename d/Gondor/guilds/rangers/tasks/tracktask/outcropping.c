/*
 *  /d/Gondor/guilds/rangers/hq/outcropping.c
 *
...
create_gondor()
{
    ...
    set_long("You are standing on a large rock protruding from the "
        ...
        + "back along the outcropping to the east. Brambles seem "
    ...
    add_item(({"bramble", "brambles"}), "The brambles grow too thickly here "
        + "to pass through them.\n");
        
    add_exit(TRACKTASK_DIR + "track_task14",  "east", &allowed(), 1);

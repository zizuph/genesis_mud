/*
 *  /d/Gondor/guilds/rangers/hq/track_task9.c
 *
...
create_gondor()
{
    ...
    add_exit(TRACKTASK_DIR + "track_task8", "east", &allowed(), 1);
    add_exit(TRACKTASK_DIR + "track_task10", "northwest", &allowed(), 1);
    add_exit(TRACKTASK_DIR + "track_task11", "southwest", &allowed(), 1);
    add_exit(TRACKTASK_DIR + "track_task12", "uphill", &allowed(), 1);

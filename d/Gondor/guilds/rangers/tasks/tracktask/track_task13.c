/*
 *  /d/Gondor/guilds/rangers/hq/track_task13.c
 *
...
create_gondor()
{
    ...
    set_long("You are standing on top of a small hill rising out of the "
        ...
        + "Below you, to the east, a path descends back toward to trees. "
        + "You may also travel along the top of the hill to the west.\n");
    ...
    add_item(({"bramble", "brambles"}), "The brambles grow thickly here, almost "
        + "entirely obscuring the ground.\n");
        
    add_exit(TRACKTASK_DIR + "track_task12",  "downhill", &allowed(), 1);
    add_exit(TRACKTASK_DIR + "track_task15", "west", &allowed(), 1);

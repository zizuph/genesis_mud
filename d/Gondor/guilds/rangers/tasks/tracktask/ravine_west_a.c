/*
 *  /d/Gondor/guilds/rangers/hq/ravine_west_a.c
 *
...
create_gondor()
{
    ...
    set_long("You are standing in a shallow ravine deep inside the Druedain forest. "
        ...
        + "from west to east. It appears, however, that logs block your passage "
    ...
    add_exit(TRACKTASK_DIR  + "ravine_west",   "northeast", &allowed(), 1, 1);

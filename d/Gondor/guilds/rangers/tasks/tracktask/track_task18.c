/*
 *  /d/Gondor/guilds/rangers/hq/track_task18.c
 *
...
create_gondor()
{
    ...
    set_long("The trees close about you in all directions but to the "
        + "east. Due to the thick bushes growing beneath the trees, it seems "
    ...
    add_exit(TRACKTASK_DIR + "track_task20", "northwest", &allowed(), 1, 1);
    add_exit(TRACKTASK_DIR + "track_task17", "east", &allowed(), 1);

/* /d/Gondor/guilds/rangers/warg_cave/tr_cave6.c
...
create_cave()
{
    ...
    add_exit(CAVE_PATH + "tr_cave7", forward, &find_path(forward), 0, 1);
    add_exit(CAVE_PATH + "tr_cave5", back, &find_path(back), 0, 1);
    reset_room();
}

/* /d/Gondor/guilds/rangers/warg_cave/rcave3.c
...
create_cave()
{
    ...
    add_exit(CAVE_PATH + "rcave4", forward, &find_path(forward), 0, 1);
    add_exit(CAVE_PATH + "rcave2", back, &find_path(back), 0, 1);
    add_exit(CAVE_PATH + "tr_cave1", "west", &find_path("west"), 0, 1);
    reset_room();
}

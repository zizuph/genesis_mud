/* /d/Gondor/guilds/rangers/warg_cave/tr_cave1.c
...
create_cave()
{
    ...
    add_exit(CAVE_PATH + "tr_cave2", forward, &find_path(forward), 0, 1);
    add_exit(CAVE_PATH + "rcave3", back, &find_path(back), 0, 1);
    reset_room();
}

/* /d/Gondor/guilds/rangers/warg_cave/tr_cave4.c
...
create_cave()
{
    ...
    add_exit(CAVE_PATH + "tr_cave5", forward, &find_path(forward), 0, 1);
    add_exit(CAVE_PATH + "tr_cave3", back, &find_path(back), 0, 1);
    reset_room();
}

/* /d/Gondor/guilds/rangers/warg_cave/tr_cave7.c
...
string forward = "south";
string back = "northwest";
...
create_cave()
{
    ...
    add_exit(CAVE_PATH + "tr_cave8", forward, &find_path(forward), 0, 1);
    add_exit(CAVE_PATH + "tr_cave6", back, &find_path(back), 0, 1);
    reset_room();
}

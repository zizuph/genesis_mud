/* /d/Gondor/guilds/rangers/warg_cave/tr_cave2.c
...
string forward = "north";
string back = "southeast";
...
create_cave()
{
    ...
    add_exit(CAVE_PATH + "tr_cave3", forward, &find_path(forward), 0, 1);
    add_exit(CAVE_PATH + "tr_cave1", back, &find_path(back), 0, 1);
    reset_room();
}

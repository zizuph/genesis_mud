 ...
 * modification log: 
 * 30-Mar-2000 Stern : lowered the price for Athelas 
 * 31-Mar-2002 Alto: moved and revised to fit new rangers code
 * 28-Mar-2007 Toby: fixed typo in default_answer
 * 04-Okt-2008 Eowul: Made him actually give out the gold coins for the Athelas
 *                    and reduced the price to 1 gold. Also removed the herb
 *                    object after it has been given.
 */
...
create_ranger()
{
    ...
    set_default_answer("The Ranger of Westerness before you responds: I'm afraid I don't know what you mean.\n");
...
enter_inv(object obj, object from)
{
    ...
    {   
        ...
        set_alarm(0.5, 0.0, obj->remove_object);
    }
    else if (obj->id("herb"))
...
do_inform(string what)
{
    ...
    case "hint1":
        ...
        command("say The diary also had some obscure reference about " +
            "asking for a scroll, but from whom or where it does not say.");
        command("sigh");

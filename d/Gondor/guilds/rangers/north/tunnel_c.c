/*
 *  /d/Gondor/guilds/rangers/north/tunnel_c.c
 *
...
long_desc()
{
    ...
    return "You are in a small tunnel somewhere beneath the ruins of Fornost. "
        ...
        + "southeast. From here you may walk directly north or southeast.\n";
}
...
create_gondor()
{
    ...
    add_item(({"slope", "upward slope"}), "There is an upward incline " +
        "in the tunnel as it leads to the southeast.\n");

    add_exit(RANGERS_NOR_DIR + "tunnel_b", "north");
    add_exit(RANGERS_NOR_DIR + "tunnel_d", "southeast");

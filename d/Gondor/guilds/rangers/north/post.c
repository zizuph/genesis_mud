...
create_room()
{
    ...
    set_long("In this room is the post-office. Along the walls you see "
        + "mailboxes. In one corner there is a writing desk. Fastened "
    ...
    add_exit(RANGERS_NOR_DIR + "e_corridor", "west");

/*
 *  /d/Gondor/guilds/rangers/north/vantage1.c
 *
...
create_gondor()
{
    ...
    add_exit(RANGERS_NOR_DIR + "vantage_stair", "down", &check_ranger());
...
move_ranger(object who)
{
    ...
    who->move_living("M", RANGERS_NOR_DIR + "vantage2", 1, 0);
    tell_room(RANGERS_NOR_DIR + "vantage2", QCTNAME(who) + " arrives from "
        + "below.\n", who);
    return 1;
}

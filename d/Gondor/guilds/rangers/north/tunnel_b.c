/*
 *  /d/Gondor/guilds/rangers/north/tunnel_b.c
 *
...
long_desc()
{
    ...
    return "You are in a small tunnel somewhere beneath the ruins of Fornost. "
        ...
        + "south. From here you may walk directly north or south.\n";
}
...
create_gondor()
{
    ...
    add_exit(RANGERS_NOR_DIR + "tunnel_a","north");
    add_exit(RANGERS_NOR_DIR + "tunnel_c","south");

/*
 *  /d/Gondor/guilds/rangers/ithilien/tunnel/tunnelg08.c
 *
...
create_gondor()
{
    ...
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg09","west", &check_ranger());
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg07","east", &check_ranger());

...
create_area_room()
{
    ...
    set_extraline("You are standing in a thicket of large trees and " +
        "underbrush, wondering where to go next. To the north the forest " +
        "seems to grow thinner, while to the east the forest grows thicker.");
...
ranger_exit()
{
    ...
    {
        write("You feel disoriented as to what is the correct " +
            "direction, so you stop in fear of getting lost.\n");
        return 1;
    }

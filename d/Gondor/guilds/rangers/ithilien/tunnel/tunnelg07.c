/*
 *  /d/Gondor/guilds/rangers/ithilien/tunnel/tunnelg07.c
 *
...
create_gondor()
{
    ...
    set_long("The rock walls enclose a tunnel that leads " +
        "into darkness. The passage leads to the west and " +
        "southeast.\n");
    ...
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg08","west", &check_ranger());
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg06","southeast", &check_ranger());

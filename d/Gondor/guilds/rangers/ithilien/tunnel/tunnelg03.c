/*
 *  /d/Gondor/guilds/rangers/ithilien/tunnel/tunnelg03.c
 *
...
create_gondor()
{
    ...
    set_long("The rock walls enclose a tunnel that leads " +
        "into darkness. The passage extends west and turns to the " +
        "southeast.\n");
    ...
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg04","west", &check_ranger());
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg02","southeast", &check_ranger());

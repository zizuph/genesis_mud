/*
 *  /d/Gondor/guilds/rangers/ithilien/tunnel/tunnelg04.c
 *
...
create_gondor()
{
    ...
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg05","west", &check_ranger());
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg03","east", &check_ranger());

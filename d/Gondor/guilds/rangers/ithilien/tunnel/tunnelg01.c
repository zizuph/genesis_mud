/*
 *  /d/Gondor/guilds/rangers/ithilien/tunnel/tunnelg01.c
 *
...
create_gondor()
{
    ...
    set_long("The rock walls enclose a tunnel that leads " +
        "into darkness. The passage extends northwest and " +
        "southeast from here.\n");
    ...
    add_exit(RANGERS_ITH_TUNNEL + "tunnelg02","northwest", &check_ranger());
    add_exit(RANGERS_ITH_TUNNEL + "tunnel08","southeast", &check_ranger());

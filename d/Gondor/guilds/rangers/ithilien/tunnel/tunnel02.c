/*
 *  /d/Gondor/guilds/rangers/ithilien/tunnel/tunnel02.c
 *
...
create_gondor()
{
    ...
    set_long("Rock walls enclose a tunnel that leads " +
        ...
        "the rock under Ithilien. The passage " +
    ...
    add_exit(RANGERS_ITH_TUNNEL + "tunnel01","northeast", &check_ranger());
    add_exit(RANGERS_ITH_TUNNEL + "tunnel03","southwest", &check_ranger());

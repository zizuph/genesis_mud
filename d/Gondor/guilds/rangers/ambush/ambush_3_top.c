/*
 *  /d/Gondor/guilds/rangers/ambush/ambush_3_top.c
 *
...
create_ambush_top()
{
    set_long("You are crouched near a crossing of roads in the central "
        + "part of Ithilien. Two small platforms have been lashed "
        ...
        + "the intersection.\n");
    set_ambush_move(RANGERS_AMB_DIR + "ambush_3e");
    set_top_exit("/d/Gondor/ithilien/road/crossroads");
...
scan_here(string str)
{
    ...
    {
    case "environment":
        write("From here you can probably scan the crossroads or the "
            + "entrance.\n");
        return 1;

    case "crossroads":
    case "crossroad":
        entrance = "/d/Gondor/ithilien/road/crossroads";
    ...
    case "entrance":
        exit = "/d/Gondor/ithilien/road/er7";

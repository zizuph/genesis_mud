/*
 *  /d/Gondor/guilds/rangers/ambush/ambush_2_top.c
 *
...
create_ambush_top()
{
    set_long("You are crouched near an intersection of roads to the north "
        + "of Edoras. Two small platforms have been lashed "
        + "here so that you may rest during the long hours you may need "
        + "to remain hidden. From here you can scan the intersection, as "
        + "well as the entrance where you left the road. When you are "
        + "ready to depart, you may <return> to the road or <ambush> "
        + "the intersection.\n");
    set_ambush_move(RANGERS_AMB_DIR + "ambush_2e");
    set_top_exit(ROH_DIR + "road/crossroad");
    set_ambush_desc("intersection");
...
{
    string target, entrance, surroundings, exit;
    ...
    {
    case "environment":
        write("From here you can probably scan the intersection or the "
            + "entrance.\n");
        return 1;
    ...
    case "crossroads":
    case "intersection":
        entrance = "/d/Gondor/rohan/road/crossroad";
        ...
        actor->catch_tell("You carefully examine the intersection from your "
    ...
    default:
        NF("What do you want to scan? The intersection or the entrance?\n");
        return 0;
    }

...
create_morgul_tower_room()
{
    ...
    add_exit(MORGUL_ROOM_DIR + "post",      "north", 0, 1);
    add_exit(MORGUL_ROOM_DIR + "tower_3e",  "east",  0, 1);
    add_exit(MORGUL_ROOM_DIR + "boardroom", "south", 0, 1);
    add_exit(MORGUL_ROOM_DIR + "tower_3w",  "west",  0, 1);
    add_exit(MORGUL_ROOM_DIR + "tower_4c",  "up",    0, 4);

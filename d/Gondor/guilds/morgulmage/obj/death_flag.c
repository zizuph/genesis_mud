 ...
 *
 * Modification log:
 * Eowul, May 2009: Moved to the new guild directory
 */
...
set_up_flag(object pledge)
{
    ...
    TP->move_living("in a cloud of sulphur", MORGUL_ROOM_DIR + "death_room");
    MORGUL_MASTER->add_player_to_guild(TP, sponsor);

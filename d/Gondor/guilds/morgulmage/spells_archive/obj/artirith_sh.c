...
inherit "/d/Genesis/specials/std/spells/obj/invisibility_sh";
...
private int determine_bonus(object spell_object, int skill) 
{
...
hook_spell_effect_started(object spell_object)
{
    ...
    if (objectp(target))
    {
        ...
        location_sense_bonus = determine_bonus(spell_object, SS_LOC_SENSE);
        awareness_bonus = determine_bonus(spell_object, SS_AWARENESS);
        tracking_bonus = determine_bonus(spell_object, SS_TRACKING);

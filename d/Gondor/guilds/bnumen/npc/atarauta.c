/*
 *	/d/Gondor/guilds/bnumen/npc/atarauta.c
 *
 *	The shop keeper in the Houses of the Black Numenoreans.
 *
...
inherit "/d/Gondor/guilds/bnumen/npc/npc_bnumen";
...
create_bnumen() 
{
    ...
    set_long(BSN(
        "The Weaponmaster of the House of the Black Numenoreans is in charge "

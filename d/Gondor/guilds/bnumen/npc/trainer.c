/*
 *	The trainer for the Black Numenoreans
 *
...
inherit "/d/Gondor/guilds/bnumen/npc/npc_bnumen.c";
...
create_bnumen()
{
    ...
    set_long("The trainer for the Black Numenoreans.\n");

    set_title("Master of Arts");
    set_bnumen_house("Haladin");
...
wizinfo() 
{
    return ("This is the trainer for the Black Numenoreans, a race guild for humans.\n"+
...
sk_improve(string str)
{
    if (!IS_MEMBER(TP))
    {
	command("say I train only members of the Houses of the Black Numenoreans!");
	return 1;
    }
...
{
    if (to_lev > pl->query_bnumen_level())
	return 0;

...
// Global variables
static  string  open_lib = (BNUMEN_DIR + "rooms/lib_public");
...
create_cabin()
{
    ...
    set_long(BSN(
        "In this room of the library in the House of the Black Numenoreans "
    ...
    add_exit(BNUMEN_DIR + "ship/ncabin_hall4", "aft", "@@lib_check", 0);
    ...
    set_save_path(BNUMEN_DIR + "books/submissions");
    set_library(BNUMEN_DIR + "rooms/lib_houses");
    set_log_file("bnumen");
    set_up_office();
}

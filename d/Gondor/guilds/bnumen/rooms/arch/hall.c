/*
 *	/d/Gondor/guilds/bnumen/rooms/hall.c
 *
...
create_gondor()
{
    ...
    set_long(BSN(
        "The great Assembly Hall of Gondor. Here the Black Numenoreans from all"
    ...
    add_exit(BNUMEN_DIR + "rooms/hallw_n", "north", 0,  0);
    add_exit(PELAR_DIR + "streets/belfalas05", "east", leave_hall, 0);
    add_exit(BNUMEN_DIR + "rooms/hallw_s", "south", check_exit,  0);
    add_exit(BNUMEN_DIR + "rooms/board_room", "west", 0,  0);
    ...
    add_item(({"recess", "recesses", "statue", "statues", }), BSN(
      ...
      + "Houses of the Black Numenoreans. There are Beor the Old; the Lady "
      + "Haleth of the Haladin; Hador the Goldenhaired; Hurin Thalion, "
      + "son of Galdor; Hurin of Emyn Arnen, Steward of King Minardil; "
      + "Aranrath of Fornost, first chieftain of the Black Numenoreans of the "

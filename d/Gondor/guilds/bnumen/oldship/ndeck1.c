...
create_deck()
{
    set_short("Foredeck of the ship");
    set_long("Three tall masts support the rigging and triangular sails " +
        ...
        "fly away in a storm. Nearby stands the fore-mast, made from " +
        "a single huge cedar tree. The deck extends back to the mid deck, " +
        "and there is an aft or poop deck at the stern. From here you can " +
        "gaze forward across the bow, where there is a huge battering " +
        "ram. A ladder leads down through a hatch.\n");
    ...
    add_exit(BNUMEN_DIR + "ship/ndeck2", "aft", 0);
    add_exit(BNUMEN_DIR + "ship/ncabin_hall4", "down", 0);

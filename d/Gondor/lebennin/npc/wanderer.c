...
create_monster()
{
   ...
   set_chat_time(30);
   add_chat("In my days we feared the Corsairs of Umbar.");
   add_chat("Have you been to Pelargir?");
   add_chat("Lindir is a beautiful city, and improtant to Gondor.");
   add_chat("The bridge to Linhir is a special one, you should go and see it!");
   ...
   add_ask(({"linhir","about linhir","city in west"}), VBFC_ME("inform_linhir"));
}

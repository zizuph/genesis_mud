/*
 *      /d/Gondor/lebennin/wroad/wr13.c
 *
...
create_lebennin_room()
{
    ...
    add_exit(AREA_DIR + "wroad/wr12", "east", 0, 1);
    add_exit(AREA_DIR + "wroad/wr14", "southeast", 0, 2);
    add_exit(AREA_DIR + "wroad/wr15", "west", 0, 1);
    set_no_exit_msg(get_all_no_exits(({"se", "w", "e"})), "You decide to stay on " +
        "the road.\n");
}

...
create_lebennin_room()
{
    ...
    add_exit(AREA_DIR + "wroad/wr3", "east", 0, 1);
    add_exit(AREA_DIR + "wroad/wr5", "southwest", 0, 1);
    set_no_exit_msg(get_all_no_exits(({"sw","e"})), "You decide to stay on " +
        "the road.\n");
}

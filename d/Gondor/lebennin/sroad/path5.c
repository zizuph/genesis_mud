/*
 * /d/Gondor/lebennin/sroad/path5.c
 *
 * Copyright (C) May 26, 1998 by Ron Miller (Tyr)
 *
 * This is the northern edge of a clearing where the lens taken from 
...
create_gondor()
{
    ...
    set_long(BSN("This is the northern edge of a small clearing. "+
        "The remains of a small campfire to the south suggest "+
    ...
    add_item(({"remains","campfire","small campfire","pile","ashes",
        ...
        "south lies a pile of wet ashes and partially burnt firewood."));
    ...
    add_exit("path4", "west", 0, 1);
    add_exit("path6", "east", 0, 1);
    add_exit("path7", "southwest", 0, 1);
    add_exit("path8", "south", 0, 1);
    add_exit("path9", "southeast", 0, 1);
} /* end create gondor */

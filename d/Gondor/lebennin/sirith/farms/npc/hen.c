/*
 * /d/Gondor/lebennin/sirith/farms/npc/chicken.c
 *
 ...
 * Description	:	set up the chicken
 */
public void
create_sirith_livestock()
{
    set_name( ({"hen", "chicken", "fowl", "bird", "beast" }) );
    ...
    {
    case 0:
	set_short("speckled hen");
    	set_adj( ({ "small", "speckled" }) );
    	set_long(BSN("This hen is fairly small; her feathers are "+
	    "white with brown speckles around the head and neck."));
	break;
    case 1:
	set_short("plump white hen");
    	set_adj( ({ "white", "plump" }) );
    	set_long(BSN("This hen is rather plump; her feathers "+
	    "are solid white."));
	break;
    case 2:
	set_short("brown hen");
	set_adj( ({ "brown", "reddish-brown" }) );
	set_long(BSN("This hen has dark reddish brown feathers."));
	break;
    }

...
#define STDPOTIONFILE "/std/potion"
 ...
 */
    ...
    {
        temp_alarm = set_alarm(1.0, 0.0, "tp_remove_temp", this_player());
...
{
    tp->remove_prop(TEMP_STDPOTION_CHECKED);
...
{ 
    ...
    if ((environment(ob) == this_player()) &&
        (function_exists("create_object", ob) == STDPOTIONFILE) &&

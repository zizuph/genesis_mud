 ...
 * modes : (un)silence  : no chats and emotes
 *         game: busy   : replies to quest questions with "I'm busy".
 *               unbusy : inviting mode
 *               betting: takes bets   *TBD*
 *               playing: replies to quest questions with "I'm busy".
 *                        but allows other interactions. *TBD*  
 *         (in)vis       *TBD*
 *  also tbd is cheaterlist
 */
...
#define MY_TITLE    ("of the House of Hallacar, " + \
                    "the Incredible Gambler from Pelargir")
...
#define MAX_TEXTS 62  /* max nr of lines in TEXT */
#define TEXT ({"I won a horse once.", \
	       ...
	       "You have an hour.", \
               ...
               "I lost one of my dice. Have you seen my die?", \
               "I lost my dice. Have you seen my dice?" })
...
create_monster()
{
    ...
    set_long("He is a fun-loving ever-smiling male human.\n" +
        ...
        "He is playing with a pair of dice.\n" +
        "He is wearing a neat suit, neat shoes and a neat hat.\n" +
        "He is a dunadan of the House of Hallacar.\n" +
        "He is gallantly carrying a purse fastened on the belt, " +
        "which indicates that He is a Wealthy Member of the " +
        "Rich Men's Club.\n" +
        "A tiny tattoo of a pair of aces adorns his right hand.\n");
...
add_act_cact()
{
    ...
    add_chat("I won a gold crown from Karpath.");
    ...
    add_act("emote sings with a loud voice: I'm a winner, baaaaby!");
    add_act("emote sings with a loud voice: " + 
        "I'm a gaaaambler not a fiiiighter!");
    add_act("emote sings with a loud voice: " + 
        "Oooh, baby, I wanna play a game with you!");
    add_act("twinkle");
    ...
    add_act("emote sings with a loud voice: \n\n" + 
        ...
        "  To win her over,\n" +
        "    I'd seen the tables turn around.\n" +
        "  She's ten the hard way,\n" +
        "    I can feel it in my bones.\n" +
        "  She'll be makin' my day\n" +
        "    and not another night alone.\n" +
        "  'Til it's time for a windfall\n" +
        "    and not a single moment too soon.\n" +
        "  I've been too long overdue,\n" +
        "    now I'm gonna shoot the moon.\n" +
        "  I'd bet it all\n" +
        "    on a good run of bad luck.\n" +
        "  Seven come eleven\n" +
        ...
        "  Squeezin' out a thin dime\n" +
        "    'til there's no one hanging on my arm.\n" +
        ...
        "His last tones end in a dreamy sigh.");
}

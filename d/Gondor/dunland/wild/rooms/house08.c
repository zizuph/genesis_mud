...
create_gondor()
{
    ...
    set_long("The house is very small, but along the "
      ...
      + "broken table lies in a heap in the middle of "
    ...
    add_item(({"table", "stool", "stools", "broken table"}), BSN(
	"In the centre of the house lies a small table in ruins. " 
	+ "Next to it stands 2 wooden stools and the third stool "
	+ "has been tipped over. Around the "
	+ "table are some scattered cards. Perhaps someone "
	+ "got very angry when he or she lost money in a " 
	+ "card game."));
    ...
    add_item("ceiling", "The ceiling is made of wood. It looks "
      ...
      + "rain in Rohan.\n");
    add_item(({"card", "cards"}), BSN(
	"Several gaming cards are scattered on the " 
	+ "floor close to the broken table."));
    ...
    add_exit(DUN_WILD_ROOMS + "field09", "out");

...
create_gondor()
{
	...
	+ "some smaller knife marks in it, and there are "
	+ "some food remains lying on it."));
    ...
    add_item("ceiling", "The ceiling is made of wood. It looks "
      ...
      + "rain in Rohan.\n");
    add_item(({"food", "food remains", "remains"}), BSN(
	"It looks to be the remains of a roasted chicken."));
    ...
    add_exit(DUN_WILD_ROOMS + "field14", "out");

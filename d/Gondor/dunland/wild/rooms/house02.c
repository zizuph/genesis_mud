...
create_gondor()
{
	...
	+ "surrounded by some wooden stools. On the table "
	+ "you can detect some blood stains."));
    ...
    add_item("ceiling", "The ceiling is made of wood. It looks "
      ...
      + "rain in Rohan.\n");
    add_item(({"blood", "blood stains"}), BSN(
	"When you look closer at the blood stains on the " 
	+ "table, you also see that there is blood under "
	+ "the floor, along with two teeth. Wow, someone "
	+ "must have suffered from a good punch, loosing "
	+ "two teeth from one blow."));
    add_item(({"tooth", "teeth"}), BSN(
	"Two teeth are on floor below the table, along with "
	+ "some blood stains."));
    ...
    add_exit(DUN_WILD_ROOMS + "field02", "out");

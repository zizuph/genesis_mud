...
create_area_room()
{
    ...
    add_exit(DUN_WILD_ROOMS + "house06", "in", 0, 2);
    add_exit(DUN_WILD_ROOMS + "field12", "west", 0, 2);
    add_exit(DUN_WILD_ROOMS + "field08", "north", 0, 2);
    add_exit(DUN_WILD_ROOMS + "field14", "east", 0, 2);
    add_exit(DUN_WILD_ROOMS + "field07", "northwest", 0, 2);
    add_exit(DUN_WILD_ROOMS + "field09", "northeast", 0, 2);

create_monster()
{
  ...
  set_skill(SS_WEP_SWORD,random(25)+10);
  set_skill(SS_WEP_KNIFE,random(20)+10);
  set_skill(SS_2H_COMBAT,random(20)+10);
  set_skill(SS_UNARM_COMBAT,random(30)+10);
  set_skill(SS_DEFENCE,random(5)+5);
  set_skill(SS_PARRY,random(5)+5);
  set_whimpy(1);
  set_pick_up(50);

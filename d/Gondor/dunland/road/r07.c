...
create_room() 
{
 ...
 vegetation = "clumps of dry green grass";
 extraline = "You are on a rolling high plateau extending as far as the"
  ...
  add_exit(DUN_DIR+"road/r08","northwest",0);
  add_exit(DUN_DIR+"road/r06","southeast",0);

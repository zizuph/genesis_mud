 ...
 * Mercade, 3 June 2006: Changed NO_DROP property to VBFC for death/quit.
 */
 ...
 * Description  : When a person dies or quits, allow dropping.
 * Returns      : mixed - failure string or 0.
 */
mixed
obj_m_no_drop()
{

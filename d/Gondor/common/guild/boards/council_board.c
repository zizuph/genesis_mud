/*
 * /d/Gondor/common/guild/boards/council_board.c
 *
 * derived from:
 *
...
#define COMMON "/d/Gondor/common/guild/boards/council_master"
...
store_msg(string str)
{
    write(break_string("Sorry. In order to store a message you shall have " +
        "to go to the council board in the guildhall of the Rangers of " +
        "Gondor and do it from the room there.", 75) + "\n");
    return 1;

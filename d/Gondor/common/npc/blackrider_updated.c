...
add_stuff()
{
    ...
    wep = clone_unique("/d/Gondor/common/wep/nazgul_sword", MAX_UNIQUE_ITEMS, "/d/Gondor/common/wep/nazgul_basic_sword");
    wep -> move(this_object());

    arm1 = clone_unique("/d/Gondor/common/arm/nazgul_helm", MAX_UNIQUE_ITEMS, "/d/Gondor/common/arm/nazgul_basic_helm");
    arm1->move(this_object());

//    arm1 = clone_object(ANN_ARM + "gauntlets");
    arm2 = clone_unique("/d/Gondor/common/arm/nazgul_plate", MAX_UNIQUE_ITEMS, "/d/Gondor/common/arm/nazgul_basic_plate");
    arm2 -> move(this_object());


//    arm3 = clone_object(ANN_ARM + "pmail");
...
//    add_prop(LIVE_O_ENEMY_CLING, enemy);
    ...
    if (objectp(enemy))
    {
        ...
        if (!present("_nazgul_broadsword", inventory(this_object())))
        {

/*
 *  /d/Gondor/common/lib/herb_shop.c
 *
 ...
 *
 *  Modification Log:
 *  - 24.08.2004 Raven: added heap support in query_sell_price(object).
 *  - 01.12.2018 Cotillion: Fixed object value for non herb objects
 */
#pragma save_binary
#pragma strict_types
...
query_sell_price(object ob)
{
    ...
    return query_object_value(ob) * 100 /
        (query_money_greed_sell() + 15 -
        this_player()->query_skill(SS_TRADING) / 3 + 

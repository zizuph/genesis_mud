...
create_container()
{
    ...
    set_short("cute furry teckel");
    set_pshort("cute furry teckels");

    set_long("It is a long and narrow teckel. Its fur is smooth and " +
        "coloured black and brown with patches of silver and it even kefs " +
        "cutely. The teckel is wearing a fashionable black leather collar " +
        "with a cool snap buckle. It has everything you ever looked for in " +
        "a teckel and looks very huggable.\n");

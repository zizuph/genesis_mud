...
int
sort_dunadan_level(object arg1, object arg2)
{
    int     wl1 = SECURITY->query_wiz_rank(arg1->query_real_name()),
            wl2 = SECURITY->query_wiz_rank(arg2->query_real_name());
    int     dl1 = arg1->query_dunadan_level(),
            dl2 = arg2->query_dunadan_level();
    string  house1 = arg1->query_dunadan_house(),
            house2 = arg2->query_dunadan_house();

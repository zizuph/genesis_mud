 ...
 *     Morbeche, 16-Nov-1999:  Added skill support for Language, Awareness,
 *              and Climb to remain at level 50 after recent mudlib changes.
 *              Swim skill will remain at Adv Levels (too much tax)
 */
#pragma save_binary
#pragma strict_types

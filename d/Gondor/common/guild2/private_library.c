...
void create_morgul_room()
{
    ...
    add_exit(MORGUL_DIR + "city/rooms/mmlibrary", "up", "@@prevent_leave_with_books@@");
    ...
    set_library_save_path("/d/Gondor/common/guild2/books/private/");
    set_library_save_file("/d/Gondor/common/guild2/books/private_library");
    set_library_allow_new_books(1);
    set_library_log_file("morgul_lib_new");

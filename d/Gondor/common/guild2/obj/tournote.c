 ...
 * Elessar, May 92.
 *
 * Based on the Pelargir tour note, Adapted for the MM tours
 * Finwe, May 2020
 * Modifidation Log:
 */
...
long_desc()
{
    string  ld = "This tour note was given to you as a proof that you are working on a task assigned to you by the Hand of th Dark Lord. ";
    ...
    if (tour_done)
        ...
        ld += "You have not solve the task.\n";

...
public int inflate_anvil( int weight, int volume )
{
    ...
    {
	//15 minute base + a random 15. This is temporary until I make
	//a function to generate a random value (within this same range)
	//but based on a calcuation of stat and spellpower. Altrus, Feb 9, 2006
        _Time_left = itof( 900 + random(900) );
    }

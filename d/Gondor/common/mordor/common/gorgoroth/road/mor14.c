...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leads " +
     "southeastwards towards a small crossroad, while " +
     "northwards following Ephel Duath.  Orodruin can be seen in a far distance " +
     "eastwards from here.\n");

    add_exit(ROOM + "mor13", "north");
    add_exit(ROOM + "mor15", "southeast");

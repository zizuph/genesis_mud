...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leads " +
     "westhwards towards Cirith Ungol and northeastwards further " +
     "unto the plateau Gorgoroth towards Orodruin. At northeast there " +
     "is a crossroad.   Orodruin can be " +
     "seen in a medium distance northeastwards from here.\n");

    add_exit(ROOM + "moree5", "west");
    add_exit(ROOM + "moree7", "northeast");

...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leads " +
     "southwards following Ephel Duath, then northwards " +
     "towards a crossroad.  Orodruin can be seen in a far distance " +
     "southeastwards from here.\n");

    add_exit(ROOM + "mor7", "north");
    add_exit(ROOM + "mor9", "south");

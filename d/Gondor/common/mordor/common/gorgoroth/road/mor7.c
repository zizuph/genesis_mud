...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leads " +
     "southwards following Ephel Duath, then northeastwards " +
     "towards Carach Angren and northwestwards towards " +
     "Durthang.  Orodruin can be seen in a far distance " +
     "southeastwards from here.\n");

    add_exit(ROOM + "mor6", "northeast");
    add_exit(ROOM + "mor8", "south");
    add_exit(ROOM + "morw8", "northwest");

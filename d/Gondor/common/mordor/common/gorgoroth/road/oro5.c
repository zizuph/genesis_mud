...
// "flying in circles far above you.\n");
    ...
    set_long("You are a the northwestern side of the mighty volcano Orodruin.  The " +
     "pathway continue ascending southwards following the side of the cone.  You " +
     "sense small shakes and an immense heat radiating from " +
     "the cone.  the top of Orodruin looms far above you, making you unsure of " +
     "traveling further as it might erupt at any time.  The " +
     "Black tower; Barad-Dur, can't be seen from here as the cone blocks the " +
     "view, but still you feel its presence and a " +
     "terrible feeling of being watched...\n");

    
    add_exit(ROOM + "oro4", "northeast");
    add_exit(ROOM + "oro6", "south");

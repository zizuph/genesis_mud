...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leading " +
     "southwards following Ephel Duath and northwards towards a " +
     "crossroad.  Orodruin can be seen in a far distance " +
     "southeastwards from here.\n");

    add_exit(ROOM + "mor2", "north");
    add_exit(ROOM + "mor4", "south");

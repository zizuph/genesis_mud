...
// "flying in circles far above you.\n");
    ...
    set_long("You are a the southeastern side of the mighty volcano Orodruin. You " +
     "sense small shakes and an immense heat radiating from " +
     "the ground.  Orodruin looms far above you, making you unsure of " +
     "traveling further as it might erupt at any time. A small cobbered " +
     "pathway ascends to the north, following the side of the volcano.  The " +

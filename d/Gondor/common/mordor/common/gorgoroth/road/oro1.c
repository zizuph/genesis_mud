...
// "flying in circles far above you.\n");
    ...
    set_short("At a steep pathway on Mount Doom"); 

    set_long("You are a the eastern side of the mighty volcano Orodruin.  The " +
     "pathway continue ascending northwards following the side of the cone.  You " +
    ...
    add_exit(ROOM + "moree15", "south");
    add_exit(ROOM + "oro2", "north");

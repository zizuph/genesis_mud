...
// "flying in circles far above you.\n");
    ...
    set_long("You are a the west side of the mighty volcano Orodruin.  The " +
     "pathway continue ascending southeastwards following the side of the cone.  You " +
    ...
    add_exit(ROOM + "oro5", "north");
    add_exit(ROOM + "oro7", "southeast");

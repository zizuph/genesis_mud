...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_short("At a broad road"); 

    set_long("The broad paved road leading " +
     "southwestwards following Ephel Duath towards a crossroad,  and " +
     "northeastwards towards " +
     "Carach Angren.  Orodruin can be seen in a far distance " +
     "southeastwards from here.\n");

    add_exit(ROOM + "mor5", "northeast");
    add_exit(ROOM + "mor7", "southwest");

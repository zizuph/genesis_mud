...
// "flying in circles far above you.\n");
    ...
    set_long("You are a the northern side of the mighty volcano Orodruin.  The " +
     "pathway continue ascending southwestwards following the side of the cone.  You " +
    ...
    add_exit(ROOM + "oro3", "east");
    add_exit(ROOM + "oro5", "southwest");

...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("You are a the foot of the mighty volcano Orodruin. You " +
     "sense small shakes in the ground, and a immense heat radiating from " +
     "the ground and the side of the cone.  The road ascends somewhat to " +
     "east, crossing the southern side of the volcano. \n");

    
    add_exit(ROOM + "moree13", "east");
    add_exit(ROOM + "moree11", "southwest");

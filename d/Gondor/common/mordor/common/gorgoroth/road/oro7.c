...
// "flying in circles far above you.\n");
    ...
    set_long("You are a the southern side of the mighty volcano Orodruin.  The " +
     "pathway continue ascending northeastwards following the side of the cone.  You " +
    ...
    add_exit(ROOM + "oro6", "northwest");
    add_exit(ROOM + "oro8", "northeast");

...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leads " +
     "southwards toward the southwestern part of the plateau " +
     "and following Ephel Duath northwestwards while the last road " +
     "heads eastwards towards Orodruin.  Orodruin can be seen " +
     "in a far distance eastwards from here.\n");

    add_exit(ROOM + "mor14", "northwest");
    add_exit(ROOM + "mor16", "south");
    add_exit(ROOM + "moree1", "east");

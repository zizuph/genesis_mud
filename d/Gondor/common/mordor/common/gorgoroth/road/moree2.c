...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leads " +
     "westhwards towards Cirith Ungol and eastwards further " +
     "unto the plateau Gorgoroth towards Orodruin.  A crossroad " +
     "can be seen westwards from here.  Orodruin can be seen in a " +
     "far distance northeastwards from here.\n");

    add_exit(ROOM + "mor18", "west");
    add_exit(ROOM + "moree3", "east");

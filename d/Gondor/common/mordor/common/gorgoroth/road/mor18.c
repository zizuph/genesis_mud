...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved road leads " +
     "westhwards towards Cirith Ungol and northwards " +
     "following Ephel Duath while an even broader road leading " +
     "eastwards further into the plateau towards Orodruin.  A small " +
     "pathway leading further towards the volcanic plains of " +
     "Perth Ulmyn.  Orodruin can be seen in a far distance eastwards from here.\n");

    add_exit(ROOM + "mor17", "north");
    add_exit(ROOM + "mor19", "west");
    add_exit(ROOM + "moree2", "east");
    add_exit(ROOM + "perth1", "south");

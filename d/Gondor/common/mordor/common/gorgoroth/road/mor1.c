...
// set_short("south of the pass of Carach Angren"); 

    set_long("The broad paved road stretches southwards towards " +
     "a crossroad and northwards to the gates of Carach Angren.  The " +
     "heavy contruction of the second gate leading " +
     "out of Mordor stands firmly betveen the enclosement of Ephel Duath and " +
     "Ered Lithui.\n");

    // add_exit(ROOM + "gor11", "north");
    add_exit(ROOM + "mor2", "south");

...
// "flies eastwards towards Barad-Dur.\n");
    ...
    set_long("The broad paved crossroad leading " +
     "westhwards and southwestwards towards Cirith Ungol and eastwards further " +
     "unto the plateau Gorgoroth towards Orodruin.  Orodruin can be " +
     "seen in a medium distance northeastwards from here.\n");

    add_exit(ROOM + "moree6", "southwest");
    add_exit(ROOM + "moree8", "east");
    add_exit(ROOM + "morea5", "west");

...
// "flying in circles far above you.\n");
    ...
    set_long("You are a the northeastern side of the mighty volcano Orodruin.  The " +
     "pathway continue ascending westwards following the side of the cone.  You " +
    ...
    add_exit(ROOM + "oro2", "southeast");
    add_exit(ROOM + "oro4", "west");

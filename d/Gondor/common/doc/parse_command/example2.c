 ...
 * this one allows you to use varying prepositions and names,
 * optional articles, optional adjectives -- the works!
 */
...
create_gondor()
{
	...
	"For testing, try lots of variations on reaching inside " +
	"the niche."));

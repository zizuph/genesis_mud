...
create_herb()
{
    ...
    set_id_long("This bright yellow five-petaled flower is known as " +
        "a marsh marigold which grows in moist meadows and swamps. The " +
        "marigold is famous for its medicinal properties in curing minor " +
...
rub_herb(string str)
{
	...
	say(QCTNAME(TP)+" crushes a flower in "+HIS_HER(TP)+"" +
	  " hand and rubs the fluid from the petals carefully on" +
	  " the skin of "+HIS_HER(TP)+" "+where+".\n");

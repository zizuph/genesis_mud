 ...
 * This herb must exist in ALL rooms in which
 * Yave exists. It may also exist in additional
 * rooms elsewhere on its own.
 *
 * Varian 2015
 */
...
create_herb()
{
    ...
    set_herb_name("anna");
    set_id_long(BSN("This is the rare Anna fruit. The fruit " +

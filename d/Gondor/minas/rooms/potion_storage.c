...
#define TIRITH_POTION_SHOP	"/d/Gondor/minas/rooms/potion_shop"
#define TIRITH_POTION_SAVE	"/d/Gondor/minas/rooms/potion_store"
...
create_room()
{
   ...
   add_exit(TIRITH_POTION_SHOP, "out");

   add_prop(ROOM_I_INSIDE, 1);  /* This is an inside room */

   set_save_file(TIRITH_POTION_SAVE);

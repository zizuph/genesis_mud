...
create_street()
{
    ...
    add_exit(INNER_MINAS + "/n3crc6", "northeast", 0, 1);
    add_exit(INNER_MINAS + "/houses/fen_hollen", "southwest", 0, 1);
    ...
    set_extraline("The quiet street is lined by large white houses, "
        ...
        + "the wealthiest districts in the city. To the southwest "
        + "is a small square before a door in the Sixth Wall. The "
        + "street narrows to the northeast.");
    ...
    add_item(({"citadel wall", "citadel"}), "To the southeast, the great "
        + "wall of the Citadel "
        + "can be seen rising above the Sixth Circle. The tall White Tower "
        + "rises from within.\n");
    add_item(({"door"}), "It appears well-made "
        + "and very strong. It lies to the southwest of here.\n");
    add_item(({"square"}), "The Square of the Fen Hollen, or the Closed "
        + "Door, lies to the southwest. From here it appears to be "
    ...
    add_item(({"wall", "walls"}), "Which one? To the northwest is the sixth wall. "
        + "To the "
        + "southeast, the Citadel wall rises behind the buildings.\n");

/*
 *  /d/Gondor/minas/citadel/battlement9.c
 *
 *  Stairs to the Battlement: Stairs Eight
 *
 *  Alto, 20 April 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/citadel/battlement10", "east", 0, 1);
    add_exit(INNER_MINAS + "/citadel/battlement8", "down", 0, 1);

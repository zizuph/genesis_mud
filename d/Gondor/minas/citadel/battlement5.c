/*
 *  /d/Gondor/minas/citadel/battlement5.c
 *
 *  Stairs to the Battlement: Stairs Four
 *
 *  Alto, 20 April 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/citadel/battlement6", "east", 0, 1);
    add_exit(INNER_MINAS + "/citadel/battlement4", "down", 0, 1);

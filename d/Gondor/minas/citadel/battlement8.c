/*
 *  /d/Gondor/minas/citadel/battlement8.c
 *
 *  Stairs to the Battlement: Stairs Seven
 *
 *  Alto, 20 April 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/citadel/battlement9", "up", 0, 1);
    add_exit(INNER_MINAS + "/citadel/battlement7", "down", 0, 1);

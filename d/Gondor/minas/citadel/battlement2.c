/*
 *  /d/Gondor/minas/citadel/battlement2.c
 *
 *  Stairs to the Battlement: Stairs One
 *
 *  Alto, 20 April 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/citadel/battlement3", "up", 0, 1);
    add_exit(INNER_MINAS + "/citadel/battlement1", "down", 0, 1);

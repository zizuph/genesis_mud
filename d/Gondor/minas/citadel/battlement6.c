/*
 *  /d/Gondor/minas/citadel/battlement6.c
 *
 *  Stairs to the Battlement: Stairs Five
 *
 *  Alto, 20 April 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/citadel/battlement7", "up", 0, 1);
    add_exit(INNER_MINAS + "/citadel/battlement5", "west", 0, 1);

/*
 *  /d/Gondor/minas/citadel/battlement4.c
 *
 *  Stairs to the Battlement: Stairs Three
 *
 *  Alto, 20 April 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/citadel/battlement5", "up", 0, 1);
    add_exit(INNER_MINAS + "/citadel/battlement3", "down", 0, 1);

/*
 *  /d/Gondor/minas/citadel/battlement3.c
 *
 *  Stairs to the Battlement: Stairs Two
 *
 *  Alto, 20 April 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/citadel/battlement4", "up", 0, 1);
    add_exit(INNER_MINAS + "/citadel/battlement2", "down", 0, 1);

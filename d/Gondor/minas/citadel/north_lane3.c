/*
 *  /d/Gondor/minas/citadel/north_lane3.c
 *
...
create_gondor()
{
    ...
    set_long("This is a small lane running around the base of the "
        ...
        + "hedge. The lane leads west and southeast from here.\n");

    add_exit(INNER_MINAS + "/citadel/north_lane2", "southeast", 0, 1);
    add_exit(INNER_MINAS + "/citadel/north_lane4", "west", 0, 1);

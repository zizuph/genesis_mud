/*
 *  /d/Gondor/minas/citadel/north_lane5.c
 *
...
create_gondor()
{
    ...
    set_long("This is a small lane running around the base of the "
        ...
        + "hedge. The lane leads southwest and east from here.\n");

    add_exit(INNER_MINAS + "/citadel/north_lane4", "east", 0, 1);
    add_exit(INNER_MINAS + "/citadel/north_lane6", "southwest", 0, 1);

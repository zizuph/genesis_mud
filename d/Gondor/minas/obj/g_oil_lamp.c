/*
 * /d/Gondor/minas/obj/g_oil_lamp.c
 *
 ...
 * Carried by Minas Tirith guards.
 *
 ...
 *		don't rot
 * 10-Feb-2001, Alto: moved to /minas/obj and named g_oil_lamp.c
 *                    cannot be stolen, as std_gondor_guard.c continues
 *                    to do lamp emotes when it is not in the inventory.
 */

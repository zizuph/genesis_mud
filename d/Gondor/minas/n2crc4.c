...
create_street() 
{
    ...
    set_activity(2);
    set_wealth(1);
    add_exit(MINAS_DIR + "houses/g1ncrc4", "north",     0, 0);
    add_exit(MINAS_DIR + "n1crc4",         "southeast", 0, 1);
    add_exit(MINAS_DIR + "n3crc4",         "west",      0, 1);
    set_extraline("The street continues west, and southeast you can "
      + "see the doors of the Fifth Gate, which leads through to "
      + "the Fifth Circle.");

...
create_gondor()
{
    set_short("in the tunnel of the Third Circle of Minas Tirith");
    set_long(long_desc);
    add_exit(MINAS_DIR + "e3crc3", "north", 0, 1);
    add_exit(MINAS_DIR + "e2crc3", "south", 0, 1);
...
long_desc()
{
    ...
    {
	 return BSN(
	    "This tunnel of the Third Circle cuts beneath "
	  ...
	  + "onto the Main Street of the Third Circle of Minas "
	  + "Tirith.");
    }
    return BSN(
	"This tunnel of the Third Circle cuts beneath "

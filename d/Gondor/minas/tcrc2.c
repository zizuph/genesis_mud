...
create_gondor()
{
    set_short("in the tunnel of the Second Circle of Minas Tirith");
    set_long(long_desc);
    add_exit(MINAS_DIR + "e3crc2", "north", 0, 1);
    add_exit(MINAS_DIR + "e2crc2", "south", 0, 1);
...
long_desc()
{
    ...
    {
	 return BSN(
	    "This tunnel of the Second Circle cuts beneath "
	  ...
	  + "onto the Main Street of the Second Circle of Minas "
	  + "Tirith.");
    }
    return BSN(
	"This tunnel of the Second Circle cuts beneath "

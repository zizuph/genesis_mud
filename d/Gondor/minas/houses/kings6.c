/*
 *  /d/Gondor/minas/houses/kings6.c
 *
 *  The House of Kings: Interior Five
 *
 *  Alto, 18 April 2001
 *
 */
...
create_gondor()
{
    ...
    set_long("You are south of center of the House of Kings. This is a wide "
    ...
    add_exit(INNER_MINAS + "/houses/kings3", "north", 0, 0);

    clone_object(INNER_MINAS + "/obj/king_door_out")->move(TO);
    ...
    add_item(({"first table", "first form", "first king"}), "On the "
        + "first table is inscribed Minardil, King of Gondor.\n");
    add_item(({"second table", "second form", "second king"}), "On the "
        + "second table is inscribed Telemnar, King of Gondor.\n");
    add_item(({"third table", "third form", "third king"}), "On the "
        + "third table is inscribed Tarondor, King of Gondor.\n");
    add_item(({"fourth table", "fourth form", "fourth king"}), "On the "
        + "fourth table is inscribed Telumehtar, King of Gondor.\n");
    add_item(({"fifth table", "fifth form", "fifth king"}), "On the "
        + "fifth table is inscribed Narmacil II, King of Gondor.\n");
    add_item(({"sixth table", "sixth form", "sixth king"}), "On the "
        + "sixth table is inscribed Calimehtar, King of Gondor.\n");

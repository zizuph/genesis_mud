/*
 *  /d/Gondor/minas/houses/kings5.c
 *
 *  The House of Kings: Interior Four
 *
 *  Alto, 18 April 2001
 *
 */
...
create_gondor()
{
    ...
    set_long("You are east of center of the House of Kings. This is a wide "
    ...
    add_exit(INNER_MINAS + "/houses/kings3", "west", 0, 0);
    ...
    add_item(({"first table", "first form", "first king"}), "On the "
        + "first table is inscribed Calmacil, King of Gondor.\n");
    add_item(({"second table", "second form", "second king"}), "On the "
        + "second table is inscribed Romendacil II, King of Gondor.\n");
    add_item(({"third table", "third form", "third king"}), "On the "
        + "third table is inscribed Valacar, King of Gondor.\n");
    add_item(({"fourth table", "fourth form", "fourth king"}), "On the "
        + "fourth table is inscribed Eldacar, King of Gondor.\n");
    add_item(({"fifth table", "fifth form", "fifth king"}), "On the "
        + "fifth table is inscribed Aldamir, King of Gondor.\n");
    add_item(({"sixth table", "sixth form", "sixth king"}), "On the "
        + "sixth table is inscribed Hyarmendacil II, King of Gondor.\n");

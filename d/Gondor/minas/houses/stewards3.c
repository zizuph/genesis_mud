/*
 *  /d/Gondor/minas/houses/stewards3.c
 *
 *  The House of Stewards: Interior Two
 *
 *  Alto, 18 April 2001
 *
 */
...
create_gondor()
{
    ...
    set_long("You are near the center of the House of Stewards. This is a wide "
    ...
    add_exit(INNER_MINAS + "/houses/stewards2", "south", 0, 0);
    add_exit(INNER_MINAS + "/houses/stewards4", "west", 0, 0);
    add_exit(INNER_MINAS + "/houses/stewards5", "east", 0, 0);
    add_exit(INNER_MINAS + "/houses/stewards6", "north", 0, 0);
    ...
    add_item(({"tables", "rows"}), "There are many rows of tables "
        ...
        + "but to the west, east and north there appear to be many more. "
        + "Each table "
    ...
    add_item(({"first table", "first form", "first steward"}), "On the "
        + "first table is inscribed Mardil, Steward of Gondor.\n");
    add_item(({"second table", "second form", "second steward"}), "On the "
        + "second table is inscribed Eradan, Steward of Gondor.\n");
    add_item(({"third table", "third form", "third steward"}), "On the "
        + "third table is inscribed Herion, Steward of Gondor.\n");
    add_item(({"fourth table", "fourth form", "fourth steward"}), "On the "
        + "fourth table is inscribed Belegorn, Steward of Gondor.\n");
    add_item(({"fifth table", "fifth form", "fifth steward"}), "On the "
        + "fifth table is inscribed Hurin I, Steward of Gondor.\n");
    add_item(({"sixth table", "sixth form", "sixth steward"}), "On the "
        + "sixth table is inscribed Turin I, Steward of Gondor.\n");

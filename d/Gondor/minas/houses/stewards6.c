/*
 *  /d/Gondor/minas/houses/stewards6.c
 *
 *  The House of Stewards: Interior Five (north)
 *
 *  Alto, 18 April 2001
 *
 */
...
create_gondor()
{
    ...
    set_long("You are north of center in the House of Stewards. This is a wide "
    ...
    add_exit(INNER_MINAS + "/houses/stewards3", "south", 0, 0);

    clone_object(INNER_MINAS + "/obj/steward_door_out")->move(TO);
    ...
    add_item(({"tables", "rows"}), "There are many rows of tables "
        ...
        + "but to the south and north there appear to be many more. "
        + "Each table "
    ...
    add_item(({"first table", "first form", "first steward"}), "On the "
        + "first table is inscribed Beren, Steward of Gondor.\n");
    add_item(({"second table", "second form", "second steward"}), "On the "
        + "second table is inscribed Beregond, Steward of Gondor.\n");
    add_item(({"third table", "third form", "third steward"}), "On the "
        + "third table is inscribed Belecthor II, Steward of Gondor.\n");
    add_item(({"fourth table", "fourth form", "fourth steward"}), "On the "
        + "fourth table is inscribed Thorondir, Steward of Gondor.\n");
    add_item(({"fifth table", "fifth form", "fifth steward"}), "On the "
        + "fifth table is inscribed Turin II, Steward of Gondor.\n");
    add_item(({"sixth table", "sixth form", "sixth steward"}), "On the "
        + "sixth table is inscribed Turgon, Steward of Gondor.\n");

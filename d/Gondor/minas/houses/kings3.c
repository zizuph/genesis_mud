/*
 *  /d/Gondor/minas/houses/kings3.c
 *
 *  The House of Kings: Interior Two
 *
 *  Alto, 18 April 2001
 *
 */
...
create_gondor()
{
    ...
    set_long("You are near the center of the House of Kings. This is a wide "
    ...
    add_exit(INNER_MINAS + "/houses/kings2", "north", 0, 0);
    add_exit(INNER_MINAS + "/houses/kings4", "west", 0, 0);
    add_exit(INNER_MINAS + "/houses/kings5", "east", 0, 0);
    add_exit(INNER_MINAS + "/houses/kings6", "south", 0, 0);
    ...
    add_item(({"tables", "rows"}), "There are many rows of tables "
        ...
        + "but to the west, east and south there appear to be many more. "
        + "Each table "
    ...
    add_item(({"first table", "first form", "first king"}), "On the "
        + "first table is inscribed Anardil, King of Gondor.\n");
    add_item(({"second table", "second form", "second king"}), "On the "
        + "second table is inscribed Ostoher, King of Gondor.\n");
    add_item(({"third table", "third form", "third king"}), "On the "
        + "third table is inscribed Romendacil I, King of Gondor.\n");
    add_item(({"fourth table", "fourth form", "fourth king"}), "On the "
        + "fourth table is inscribed Turambar, King of Gondor.\n");
    add_item(({"fifth table", "fifth form", "fifth king"}), "On the "
        + "fifth table is inscribed Atanatar I, King of Gondor.\n");
    add_item(({"sixth table", "sixth form", "sixth king"}), "On the "
        + "sixth table is inscribed Siriondil, King of Gondor.\n");

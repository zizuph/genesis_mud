...
create_room()
{
  set_short("The lower corridors in the west wing of the Houses of Healing");
  set_long(BSN("The corridor turns south and east here, in the main building of "+
    "the House. In the west and north walls windows are letting fresh air "+
    "in, and there is a stairway to the east. The white-walled corridor "+
  ...
  add_exit(HOH_DIR + "nw_stair","east",0,0);
  add_exit(HOH_DIR + "w_corr","south",0,0);
}

/*
 *  /d/Gondor/minas/houses/stewards4.c
 *
 *  The House of Stewards: Interior Three (west)
 *
 *  Alto, 18 April 2001
 *
 */
...
create_gondor()
{
    ...
    set_long("You are west of center in the House of Stewards. This is a wide "
    ...
    add_exit(INNER_MINAS + "/houses/stewards3", "east", 0, 0);
    ...
    add_item(({"tables", "rows"}), "There are many rows of tables "
        ...
        + "but to the east there appear to be many more. "
        + "Each table "
    ...
    add_item(({"first table", "first form", "first steward"}), "On the "
        + "first table is inscribed Hador, Steward of Gondor.\n");
    add_item(({"second table", "second form", "second steward"}), "On the "
        + "second table is inscribed Barahir, Steward of Gondor.\n");
    add_item(({"third table", "third form", "third steward"}), "On the "
        + "third table is inscribed Dior, Steward of Gondor.\n");
    add_item(({"fourth table", "fourth form", "fourth steward"}), "On the "
        + "fourth table is inscribed Denethor I, Steward of Gondor.\n");
    add_item(({"fifth table", "fifth form", "fifth steward"}), "On the "
        + "fifth table is inscribed Boromir, Steward of Gondor.\n");
    add_item(({"sixth table", "sixth form", "sixth steward"}), "On the "
        + "sixth table is inscribed Cirion, Steward of Gondor.\n");

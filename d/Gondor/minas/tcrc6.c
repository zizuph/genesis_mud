...
create_gondor()
{
    set_short("in the tunnel of the Sixth Circle of Minas Tirith");
    set_long(long_desc);

    add_exit(INNER_MINAS + "/e3crc6", "north", 0);
    add_exit(INNER_MINAS + "/e2crc6", "south", 0);
...
long_desc()
{
    ...
    {
	 return ("This tunnel of the Sixth Circle cuts beneath "
	  ...
	  + "onto the Main Street of the Sixth Circle of Minas "
	  + "Tirith.\n");
    }
    return ("This tunnel of the Sixth Circle cuts beneath "
      + "the vast pier of rock which divides the City in two "

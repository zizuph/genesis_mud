/* 
 * /d/Gondor/minas/npc/spectre_minardil.c  
 *
 * Spectre of Minardil, Guardian of the House of Kings
 *
 * Alto, 19 May 2001
 *
 */
...
create_monster()
{
    ...
    add_name("ghost");
    add_name("minardil");
    set_title("the Twenty-Fifth King of Gondor, Guardian of the House of Kings");

    set_race_name("spectre");

    set_long("This is the spectre of Minardil, Twenty-Fifth King of Gondor, "
        + "who guards the House of Kings. His restless spirit awakens when "
    ...
    add_chat("Behold my kinsmen, those who lie here were Kings all.");
    ...
    add_chat("To walk in the sun once again .. ah, but such is no longer "
        + "for me.");
    add_chat("Ahhh! The Corsairs are upon us! But no, that is but a "
        + "faded memory.");
    ...
    clone_object(INNER_MINAS + "/obj/king_door_key.c")->move(TO);

...
create_dunadan()
{
    ...
    set_race_name("human");
    set_living_name("calmacil");
    set_title("Armourer");
    set_adj(({"sweaty","strong"}));
    set_long(BSN("This must be the owner of the armoury, Calmacil "
        + "the Armourer, the blacksmith and armourer in Minas "
        + "Tirith. His dark and sweaty skin tells " 
        + "the tale of hard work in front of the heat of the forge. "
        + "As you are looking at him, he smiles to you, and points at "
        + "the sign, then continues working by the heat.")); 

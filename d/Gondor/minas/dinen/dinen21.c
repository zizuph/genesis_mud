/*
 *  /d/Gondor/minas/houses/dinen21.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen20", "west", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen22", "east", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen19c", "northeast", 0, 5, test_obv());

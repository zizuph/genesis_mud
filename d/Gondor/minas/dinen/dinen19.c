/*
 *  /d/Gondor/minas/houses/dinen19.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen18", "west", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen20", "southwest", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen19a", "northeast", 0, 5, test_obv());

/*
 *  /d/Gondor/minas/houses/dinen15.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen14", "west", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen16", "southwest", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen15a", "northeast", 0, 5, test_obv());

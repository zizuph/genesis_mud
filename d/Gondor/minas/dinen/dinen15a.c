/*
 *  /d/Gondor/minas/houses/dinen15a.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen5", "northeast", 0, 5, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen15", "southwest", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen15b", "east", 0, 0, test_obv());

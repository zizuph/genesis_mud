/*
 *  /d/Gondor/minas/houses/dinen11.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen12", "south", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen10", "northeast", 0, 5, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen11a", "northwest", 0, 5, test_obv());

/*
 *  /d/Gondor/minas/houses/dinen14.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen8", "northeast", 0, 5, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen13", "southwest", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen15", "east", 0, 0, test_obv());

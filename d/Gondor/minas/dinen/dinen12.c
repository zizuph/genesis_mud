/*
 *  /d/Gondor/minas/houses/dinen12.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen13", "southeast", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen11", "north", 0, 5, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen12a", "southwest", 0, 0, test_obv());

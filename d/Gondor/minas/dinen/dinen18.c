/*
 *  /d/Gondor/minas/houses/dinen18.c
 *
...
create_gondor()
{
    ...
    add_exit(INNER_MINAS + "/dinen/dinen17", "southwest", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen19", "east", 0, 0, test_obv());
    add_exit(INNER_MINAS + "/dinen/dinen15b", "northeast", 0, 5, test_obv());

 ...
 * 
 * N.B. code that changes SEWER_ROOM is #ifdef'd out so that
 * updating etc this test room does not affect the sewer room
...
create_pelargir_room()
{
    ...
    add_exit((PELAR_DIR + "test/beacon04"), "west", 0);
    add_exit((PELAR_DIR + "test/beacon06"), "east", 0);

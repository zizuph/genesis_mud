...
create_pelargir_room()
{
    ...
    add_item( ({ "buildings", "building", "stone buildings",
      ...
      + " the north. It appears to be solidly build, yet showing"
      + " little imagination or elegance in its design. The sounds"
      + " of hammers and saws can be heard coming from behind the"
      + " door."));
    ...
    add_exit((PELAR_DIR + "test/beacon05"), "east");
    add_exit((PELAR_DIR + "test/beacon03"), "west");
} /* create_gondor */

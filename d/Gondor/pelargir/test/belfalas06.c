...
create_pelargir_room()
{
    ...
    add_exit((PELAR_DIR + "test/belfalas05"), "north", 0);
    add_exit((PELAR_DIR + "test/belfalas07"), "south", 0);
    add_exit((PELAR_DIR + "test/admiral07"), "east", 0);
    add_exit((PELAR_DIR + "test/admiral06"), "west", 0);

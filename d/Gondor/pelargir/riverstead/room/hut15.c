...
create_gondor()
{
    set_short("a burning hut in the northern parts of the settlement");
    set_long(&long_desc());
    ...
    add_exit(NCAMP_ROOM + "camp15.c", "out");
...
long_desc()
{
    return "You are surrounded by smoke and flame. This fire looks "
        + "too far gone to put out. It is only a matter of time "
        + "before the cabin collapses around you.\n";
}

...
create_gondor()
{
    ...
    add_exit(NCAMP_ROOM + "camp11.c", "west");
    add_exit(NCAMP_ROOM + "dock6.c", "east");
...
long_desc()
{
    return "Nothing remains of this part of the village. "
        + "Marauding orcs have burned it all to the ground."
        + sky_desc() 
        + " It does not seem entirely safe here. Best to "
        + "move back into the remains of the settlement to the "
        + "west or take your chances on the dock to the east.\n";
}

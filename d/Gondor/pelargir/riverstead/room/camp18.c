...
create_gondor()
{
    ...
    add_exit(NCAMP_ROOM + "camp14.c", "west");
    add_exit(NCAMP_ROOM + "dock3.c", "east");
...
long_desc()
{
    return "The burning remains of huts and cabins smoulder all "
        + "around you. The muck beneath your feet is a mixture of "
        + "debris and mud."
        + sky_desc() 
        + " To the west can be seen many huts yet standing, and to "
        + "the east a dock extends onto the river.\n";
}

...
create_gondor()
{
    set_short("a burning hut in the eastern parts of the settlement");
    set_long(&long_desc());
    ...
    add_exit(NCAMP_ROOM + "camp14.c", "out");
...
long_desc()
{
    return "Smoke fills the room about you. Flames rise from "
        + "the walls and you hear the roaring and crackling that "
        + "wood makes when it is in full combustion. Best not "
        + "to linger too long in here.\n";
}

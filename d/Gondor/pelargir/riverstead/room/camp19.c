...
create_gondor()
{
    ...
    add_exit(NCAMP_ROOM + "camp13.c", "west");
    add_exit(NCAMP_ROOM + "dock4.c", "east");
...
long_desc()
{
    return "Although this was once a thriving part of the "
        + "settlement, the huts in which fishermen lived can "
        + "no longer be seen. All that is left is debris "
        + "and smouldering char."
        + sky_desc() 
        + " The huts in the remainder of the settlement still "
        + "stand to the west, and a dock can be reached by "
        + "walking to the east.\n";
}

...
create_gondor()
{
    ...
    add_exit(NCAMP_ROOM + "camp15.c", "southwest");
    add_exit(NCAMP_ROOM + "dock1.c", "east");
...
long_desc()
{
    return "This area of the settlement has been utterly devastated "
        + "by fire. No huts are standing anywhere nearby."
        + sky_desc() 
        + " To the east you see a dock extending "

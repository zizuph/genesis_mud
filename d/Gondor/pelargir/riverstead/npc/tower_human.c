/*
 * This file is NCAMP_NPC + "tower_human.c"
*/
...
public void	push_victim(object victim);
...
init_attack()
{
    ...
    if ((victim = TP)->query_alignment() >  10)
        return;

    set_alarm(20.0, 0.0, &push_victim(victim));
}

void
push_victim(object victim)
{
    string name;

...
create_room()
{
    set_short("in a guard room at the south gate of Pelargir");
    set_long(BSN("This is the room where the guards on duty at "
      + "the south gate of Pelargir spend their time. There are "
      + "a few beds in a corner, and on the walls there are "
      + "fixtures to hold weapons and armour."));

    add_exit(PELAR_DIR + "streets/s_gate_in", "east", 0, 1);

...
#define STREET          ("/d/Gondor/pelargir/streets/belfalas03")
...

{
	...
	add_item( ({"south wall", "southern wall"}),
		...
		"wall has an open doorway leading into the beautifully " +
		"decorated living room which stands at the center of this " +
		"home.\n");
	add_item( ({"doorway", "open doorway"}),
		...
		"see a beautifully decorated living room\n");
	add_item( ({"north wall", "northern wall", "west wall",
			"western wall"}),
		"Two large windows gaze out from the northern and western " +
		"walls, looking out into " + CITY + ".\n");
	add_item( ({"east wall", "eastern wall"}),
		"A painted wooden wardrobe rests against the eastern " +
	...
	add_item( ({"living room", "south"}),
		"Peering through the open doorway, you spy the living " +
		"room and the door which leads back out into " + CITY + ".\n");
	add_item( ({"bedroom", "room", "here"}),
		room_desc);
	add_item( ({"city", "town", "pelargir"}),
		"The city of Pelargir stands proudly near the southern  " +
		"edge of the realm of Gondor. The great harbour, Gondor's " +
		"gateway to the rest of the world, has been founded where " +
		"the Sirith drains into the great river Anduin.\n");
	add_item( ({"bed", "luxurious bed", "wide bed", 
		"wide luxurious bed"}),
		&look_at(BED_NAME) );
	add_item( ({"window", "windows", "north window", "west window"}),
		"@@exa_window|" + "You look out through one of the windows.\n|"
		+ STREET + "@@");

	set_no_exit_msg( ({"southwest", "southeast", "northeast",
			"northwest", "west", "east", "north"}),
	...
	room_add_object(OBJ + "wardrobe2");

	add_prop(ROOM_I_INSIDE,1);

	add_exit(PEL + "h1_liv", "south", check_sitting, 0, 0);
...
{
	return
		("This is a luxurious and ornate bedroom which sits at the " +
		"northern end of the house. A large window gazes out into " +
		"the streets of " + CITY +  " where it overlooks a bridge " +
		"crossing the Sirith River. A painted wooden wardrobe stands " +
		"beside the door, providing the owner of this home an ideal " +
		"place to store their belongings. A wide luxurious bed rests " +
		"against the eastern wall, providing a comfortable place " +
		"to rest for the owner when they are weary from their " +
		"travels around the realms.\n");
}
...

{
	...
	add_item( ({"large house", "townhouse", "large townhouse",
			"house"}),
		"You are wandering through gardens sprinkled in the yard " +
		"of a large townhouse " + CITY + ". Somewhat larger than " +
		"the other houses you have seen in Bree, you surmise that " +

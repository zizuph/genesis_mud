/*
 * /d/Gondor/river/anduin/lorien2rauros/riverbottom14w.c
 *
...
create_anduin_underwater()
{
    ...
    add_exit("river14w", "up");
    add_exit("riverbottom14e", "east");
    add_exit("riverbottom12", "north");
    add_exit("riverbottom15w", "south");
    add_exit("riverbottom15e", "southeast");

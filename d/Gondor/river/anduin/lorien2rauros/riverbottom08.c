/*
 * /d/Gondor/river/anduin/lorien2rauros/riverbottom08.c
 *
...
create_anduin_underwater()
{
    ...
    set_long("Underwater.\n"+
	BSN("The dark waters seem to flow from northeast to south."));
    ...
    /* no rocks */
    add_exit("river08", "up");
    add_exit("riverbottom07", "northeast");
    add_exit("riverbottom09", "south");

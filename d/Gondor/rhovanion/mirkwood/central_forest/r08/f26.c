...
void create_mirkwood_central_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r08/f25", "west", "@@block@@",2,1);    
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r07/f25", "southwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r07/m26", "south", "@@block@@",2,1);    
    ...
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r09/f25", "northwest", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r07/m27", "southeast", 
        "upstream, into the mountains of Mirkwood");
}
void
init()
{

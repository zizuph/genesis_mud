...
void create_mirkwood_central_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r08/f26", "east", "@@block@@",2,1);    
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r09/f26", "northeast", "@@block@@",2,1);
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r09/f25", "north", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r09/f24", "northwest", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r07/m26", "southeast", 

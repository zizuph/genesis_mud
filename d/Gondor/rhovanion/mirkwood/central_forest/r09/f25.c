...
void create_mirkwood_central_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r09/f24", "west", "@@block@@",2,1);    
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r08/f24", "southwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r08/f25", "south", "@@block@@",2,1);    
    ...
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r10/f24", "northwest", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r08/f26", "southeast", 

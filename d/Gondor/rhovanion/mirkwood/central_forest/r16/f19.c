...
void create_mirkwood_central_forest_forest_room() {
    ...
    add_mirkwood_exits(([
        "northeast" : MIRKWOOD_ELFPATH_DIR + "p20",
    ...
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r15/f18", "southwest", "@@block@@",2,1);    
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r16/f18", "west", "@@block@@",2,1);
    add_exit(MIRKWOOD_ELFPATH_DIR + "p18", "northwest", "@@block@@",2,1);    
    add_exit(MIRKWOOD_ELFPATH_DIR + "p19", "north", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_ELFPATH_DIR + "p20", "northeast", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r15/f19", "south", 

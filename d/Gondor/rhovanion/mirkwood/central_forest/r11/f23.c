...
void create_mirkwood_central_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r11/f22", "west", "@@block@@",2,1);    
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r10/f22", "southwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r10/f23", "south", "@@block@@",2,1);    
    ...
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r12/f22", "northwest", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r10/f24", "southeast", 

...
void create_mirkwood_central_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r15/f19", "east", "@@block@@",2,1);    
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r16/f19", "northeast", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r16/f18", "north", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r14/f19", "southeast", 

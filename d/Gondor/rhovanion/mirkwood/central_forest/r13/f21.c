...
void create_mirkwood_central_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r13/f20", "west", "@@block@@",2,1);    
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r12/f20", "southwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_CENTRAL_FOREST_DIR + "r12/f21", "south", "@@block@@",2,1);    
    ...
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r14/f20", "northwest", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_CENTRAL_FOREST_DIR + "r12/f22", "southeast", 

...
create_monster()
{
   ...
   set_name("banor");
   add_adj(({"tall","thin"}));
   set_long("This tall, thin man seems to be rather busy running the inn. He would " +
...
arm_me()
{
   ...
   hat = clone_object(WOODSMEN_DIR + "arm/banor_hat.c");
   shirt = clone_object(WOODSMEN_DIR + "arm/banor_shirt.c");
   pants = clone_object(WOODSMEN_DIR + "arm/banor_pants.c");

...
void create_room()
{       
    set_short("Shack in the village of Weanting");
    
    set_long("This tiny shack is obviously home to a family of woodsmen " +
...
weant()
{
write("You step through the door and back out into the village.\n");
return 0;
}

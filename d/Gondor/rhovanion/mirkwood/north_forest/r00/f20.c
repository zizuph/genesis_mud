...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_mirkwood_exits(([
        "southwest" : MIRKWOOD_ELFPATH_DIR + "p19",
        "south"     : MIRKWOOD_ELFPATH_DIR + "p20",
        "southeast" : MIRKWOOD_ELFPATH_DIR + "p21",
        
        "east" : "r00/f21",
    ]));
    
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r01/f21", "northeast", "@@block@@",2,1);    
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r01/f20", "north", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r01/f19", "northwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r00/f19", "west", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r00/f21", "east", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_ELFPATH_DIR + "p20", "south", 

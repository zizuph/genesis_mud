...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_mirkwood_exits(([
        "southwest" : MIRKWOOD_ELFPATH_DIR + "p20",
        "south"     : MIRKWOOD_ELFPATH_DIR + "p21",
        "southeast" : MIRKWOOD_ELFPATH_DIR + "p22",
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r01/f21", "northwest", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r01/f22", "northeast", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r00/f20", "west", 

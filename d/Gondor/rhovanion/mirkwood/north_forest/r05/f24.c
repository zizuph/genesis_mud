...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r06/f24", "north", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r06/f25", "northeast", "@@block@@",2,1);
    ...
    set_river_name("forest river");
        add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r05/f25", "east", 
            "downstream towards Esgaroth");
        add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r06/f23", "northwest", 

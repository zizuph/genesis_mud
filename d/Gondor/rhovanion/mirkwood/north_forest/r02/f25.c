...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_mirkwood_exits(([
        "southeast" : MIRKWOOD_ELFPATH_DIR + "p26",
        "southwest" : "r01/f24",
        "south" : "r01/f25",
        "east" : "r02/f26",
        "northeast" : "r03/f26",
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r03/f25", "north", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r03/f24", "northwest", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r03/f26", "northeast", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r02/f24", "west", 

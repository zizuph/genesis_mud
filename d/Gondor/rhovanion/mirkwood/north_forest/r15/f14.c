...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r16/f14", "north", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r16/f15", "northeast", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r15/f15", "east", "@@block@@",2,1);
    ...
    set_river_name("forest river");
        add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r14/f15", "southeast", 
            "downstream towards Esgaroth");
        add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r16/f13", "northwest", 

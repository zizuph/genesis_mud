...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r14/f15", "south", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r14/f14", "southwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r15/f14", "west", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r16/f14", "northwest", 
        "upstream, through Mirkwood forest");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r14/f16", "southeast", 

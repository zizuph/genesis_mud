...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r12/f17", "south", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r12/f16", "southwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r13/f16", "west", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r14/f16", "northwest", 
        "upstream, through Mirkwood forest");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r12/f18", "southeast", 

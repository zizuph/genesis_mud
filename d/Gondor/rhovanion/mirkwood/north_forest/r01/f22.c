...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_mirkwood_exits(([
        "southeast" : MIRKWOOD_ELFPATH_DIR + "p23",
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r02/f23", "northeast", "@@block@@",2,1);    
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r02/f22", "north", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r02/f21", "northwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r01/f21", "west", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r01/f23", "east", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r00/f21", "southwest", 

...
void create_mirkwood_north_forest_edge_room() {
    ...
    add_exit("r04/f34", "west", "@@block@@",2,1);
    add_exit("r04/f35", "southwest", "@@block@@",2,1);
    add_exit("r03/f35", "south", "@@block@@",2,1);
    add_exit(MIRKWOOD_DIR + "elfpath/p36", "southeast", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r05/f34", "northwest", 
        "upstream, deeper into Mirkwood");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r04/f36", "east", 

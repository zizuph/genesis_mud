...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r05/f28", "north", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r05/f27", "northwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r04/f27", "west", "@@block@@",2,1);

    add_long("To the northwest, you can see the wide, rushing waters of a " +
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r05/f29", "northeast", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r03/f27", "southwest", 

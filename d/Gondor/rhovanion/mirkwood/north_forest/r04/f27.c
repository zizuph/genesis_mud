...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r03/f27", "south", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r03/f28", "southeast", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r03/f26", "southwest", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r04/f28", "east", "@@block@@",2,1);
    ...
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r05/f28", "northeast", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r04/f26", "west", 

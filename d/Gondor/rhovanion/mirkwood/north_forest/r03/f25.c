...
void create_mirkwood_north_forest_forest_room() {
    ...
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r03/f26", "east", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r02/f26", "southeast", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r02/f25", "south", "@@block@@",2,1);
    add_exit(MIRKWOOD_NORTH_FOREST_DIR + "r02/f24", "southwest", "@@block@@",2,1);
    ...
    add_item_light(({"river", "enchanted river"}),
        ...
        "west is the legendary Enchanted river. This river is rumoured " +
        "to be cursed with an ancient elven magic which protects the " +
        "Woodland Realm.\n", LIGHT_ALL);

    set_river_name("enchanted river");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r04/f26", "northeast", 
        "downstream towards the Woodland Realm");
    add_follow_direction(MIRKWOOD_NORTH_FOREST_DIR + "r03/f24", "west", 

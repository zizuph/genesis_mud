...
void create_mirkwood_road_room()
{
    ...
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f27", "northwest");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f28", "north");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f29", "northeast");

    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f27", "southwest");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f28", "south");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f29", "southeast");
}

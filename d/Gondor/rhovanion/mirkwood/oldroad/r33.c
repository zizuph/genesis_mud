...
void create_mirkwood_road_room()
{
    ...
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f37", "northwest");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f38", "north");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f39", "northeast");
    
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f37", "southwest");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f38", "south");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f39", "southeast");
}

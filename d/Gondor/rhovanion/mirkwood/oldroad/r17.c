...
void create_mirkwood_road_room()
{
    ...
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f21", "northwest");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f22", "north");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f23", "northeast");

    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f21", "southwest");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f22", "south");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f23", "southeast");
}

...
void create_mirkwood_road_room()
{
    ...
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f41", "northwest");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f42", "north");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f43", "northeast");
    
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f41", "southwest");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/p42", "south");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f43", "southeast");
}

...
void create_mirkwood_road_room()
{
    ...
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f32", "northwest");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f33", "north");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f34", "northeast");
    
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f32", "southwest");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f33", "south");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f34", "southeast");
}

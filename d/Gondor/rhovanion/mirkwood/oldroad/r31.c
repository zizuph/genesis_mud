...
void create_mirkwood_road_room()
{
    ...
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f35", "northwest");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f36", "north");
    add_forest_entrance(MIRKWOOD_CENTRAL_FOREST_DIR + "r00/f37", "northeast");
    
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f35", "southwest");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f36", "south");
    add_forest_entrance(MIRKWOOD_SOUTH_FOREST_DIR + "r00/f37", "southeast");
}

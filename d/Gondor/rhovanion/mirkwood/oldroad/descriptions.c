...
void add_location_long()
{
    add_long(get_random_message(({
        "You are traveling along the old forest road " + 
        VBFC("location_desc") + " of Mirkwood. ",
        
        "You are walking on the old forest road " +
        VBFC("location_desc") + " of Mirkwood. ",

        "You find yourself somewhere along the old " +
        "forest road, which runs to the east and " +
        "to the west " + VBFC("location_desc") +
        " Mirkwood forest. ",

        "You are " + VBFC("location_desc") + " of Mirkwood " +
        "forest, where the old forest road runs in " +
        "a straight line east and west. ",

        "You are somewhere " + VBFC("location_desc") + " of " +
        "Mirkwood, following the old forest road which " +
        "runs both and east and west from here. ",

        "You are on the old forest road as it passes " +
        "along " + VBFC("location_desc") + " of " +
        "Mirkwood forest. ",

        "This part of the old forest road is somewhere " +
        VBFC("location_desc") + " of Mirkwood. ",

        "Shadows have been draped all around you as you " +
        "follow the old forest road here " + VBFC("location_desc") +
        " of Mirkwood forest. ",

        "Trees crowd overhead as the old road tunnels itself " +
        "through them to both the east and west here " +
        VBFC("location_desc") + " of the legendary Mirkwood forest. ",

        "You are " + VBFC("location_desc") +
        " of Mirkwood forest, where you can see the old " +
        "road stretching out to both the east and west. "
        })), LIGHT_ALL);
}
...
void add_tree_long()
{
    add_long(get_random_message(({
        ...
        "any direction, save where the old " +
        "forest road tunnels away to the " +
        "east and west. ",
...
void add_emo_long()
{
    add_long(get_random_message(({
        ...
        "forest moving ever closer as they crowd the road. You " +
        ...
        "On the both sides of the road, right beside you " +
        ...
        "On the north side of the road, right beside you " +
        "yet hidden deep within the shadows of the " +
        "tall, black trees of Mirkwood forest; you can hear the " +
        ...
        "On the south side of the road, right beside you " +
        "yet hidden deep within the shadows of the " +
        "tall, black trees of Mirkwood forest; you can hear the " +
        "occasional snap of a twig followed by a brief glimpse of " +
        "what appears to be a pair of sinister, glowing eyes. It " +
        ...
        "On the north side of the road, you can see the bushes " +
        ...
        "advice which suggests you should never leave the road " +
...
void add_long_spiders_close()
{
     add_long(get_random_message(({
        ...
        "follow them into the woods beyond the road. ",
        ...
        "On both sides of the road, massive spider webs " +
        "have been casually draped between thick tree " +
        "trunks. Common sense tells you that wandering " +
        "off the road into Mirkwood forest would be very " +
        "dangerous here. ",

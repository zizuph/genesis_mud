...
create_room()
{
    ...
    set_short("Dungeon of the Elvenking");
    set_long("\n");
    ...
    add_exit(MIRKWOOD_DIR + "elves/guard", "east", "@@guard@@");
    add_exit(MIRKWOOD_DIR + "elves/dungeon2", "west");
...
guard()
{
write("You climb back up the winding stone stairs and into a " +
    "guardroom in the halls of the Elvenking.\n");
return 0;
}

...
create_room()
{
    ...
    add_exit(MIRKWOOD_DIR + "elves/hall", "south");
    add_exit(MIRKWOOD_DIR + "elves/kitchen", "east");
    add_exit(MIRKWOOD_DIR + "elves/bedroom", "north",  "@@bedroom@@");
    add_exit(MIRKWOOD_DIR + "elves/guard", "west");
...
bedroom()
{
write("Before you can move north along the hallway, two guards usher " +
    "you back away from their private sleeping quarters. You are given " +
    "to understand that only the Sindar of Mirkwood will be allowed " +
    "down there.\n");
return 1;
}

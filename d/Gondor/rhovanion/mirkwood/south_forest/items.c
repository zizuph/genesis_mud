...
location_desc() 
{
    ...
    {
        case LOCATION_WEST_EDGE: return "on the western edge of Mirkwood";
        case LOCATION_WEST_PART: return "in the western part of Mirkwood";
        case LOCATION_MIDDLE: return "in the middle of Mirkwood";
        case LOCATION_EAST_PART: return "in the eastern part of Mirkwood";
        case LOCATION_EAST_EDGE: return "on the eastern edge of Mirkwood";
        default:
            return "in Mirkwood";
    }
}

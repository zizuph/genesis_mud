...
location_desc() 
{
    ...
    {
        case LOCATION_WEST_EDGE: return "near the western edge";
        case LOCATION_WEST_PART: return "in the western part";
        case LOCATION_MIDDLE: return "in the middle";
        case LOCATION_EAST_PART: return "in the eastern part";
        case LOCATION_EAST_EDGE: return "near the eastern edge";
        default:
            return "somewhere";
    }
}
...
add_item_light(({"tree", "trees"}),
    "Hovering over the elf path, the trees of Mirkwood give you the" +
    " strangest feeling that they are actually watching your every" +
    " movement. The massive black trunks of the trees are all" +
    " tangled in the underbrush, as such, any attempt to leave the" +
    " elf path would be quite a chore. Occasionally, a slender" +
...
add_item_light(({"branch", "tree branch", "branches", "tree branches"}),
    ...
    " out to hover over the elf path menacingly, striving to prevent" +
...
add_item_light(({"road","path","elf path","elven path"}),
    "You are walking along a solid dirt path which cuts through the menacing " +
    "darkness of Mirkwood forest. This path was created by the elves of " +
    "Mirkwood, and it provides safe passage from Esgaroth to the banks of " +
    "the Anduin.\n", LIGHT_ALL);
add_item_light(({"anduin","vale","vale of anduin"}),
    "Somewhere beyond the western edge of the forest, runs the great " +
    "Anduin river.\n", LIGHT_ALL);
add_item_light(({"laketown","esgaroth","lake-town"}),
    "Somewhere near the eastern edge of Mirkwood forest is the town of " +
    "Esgaroth, also known as Lake-town. If you were to follow this path, " +
    "it should take you quite close to the town on Long Lake.\n", LIGHT_ALL);
add_item_light(({"lake","long lake"}),
    "Long Lake lies somewhere beyond the eastern edge of Mirkwood forest, " +
    "the town of Esgaroth sits upon its banks.\n", LIGHT_ALL);
...
add_item_light(({"underbrush", "bushes", "brush", "bush", "shrub", "shrubs"}),
    "Thick clusters of shrubs mingle in the dense underbrush along the sides of " +
    "the elf path. These bushes are so tangled that any attempt to leave the " +
    "safety of the elf path would be a difficult chore at the best of times.\n",
    LIGHT_ALL);

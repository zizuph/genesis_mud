/*
 * Elven Captain - /d/Gondor/rhovanion/dolguldur/npc/silmelen.c
 *
...
create_monster()
{
   ...
   set_name("silmelen");
   add_name("elf");
   add_adj( ({"stern", "bright-eyed"}) );
   set_title("Silverstar, Captain of the Woodland Realm");
...
ask_task()
{
    command("say I have already sent one of my scouts on an " +
      "important task.");
    command("smile grim");
    command("say Thank you for offering to help.");
    return "";
}

/*
 * Ale - /d/Gondor/rhovanion/dolguldur/obj/ale.c
 *
...
create_drink() 
{
    ...
    set_long("The cup is filled with a light, pale ale. This " +
        "looks like a refreshing drink to enjoy after a hard day.\n");
    set_soft_amount(90);
    set_alco_amount(7);

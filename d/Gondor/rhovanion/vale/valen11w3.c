...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen10w3", "south",0,2,1);
    add_exit(VALE_DIR + "valen10w2", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen11w2", "east",0,2,1);
    add_exit(VALE_DIR + "valen12w2", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen12w3", "north",0,2,1);
    add_exit(VALE_DIR + "valen12w4", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen11w4", "west",0,2,1);
    add_exit(VALE_DIR + "valen10w4", "southwest",0,2,1); 
}

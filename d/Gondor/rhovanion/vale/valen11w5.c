...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen10w5", "south",0,2,1);
    add_exit(VALE_DIR + "valen10w4", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen11w4", "east",0,2,1);
    add_exit(VALE_DIR + "valen12w4", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen12w5", "north",0,2,1);
    add_exit(VALE_DIR + "valen12w6", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen11w6", "west",0,2,1);
    add_exit(VALE_DIR + "valen10w6", "southwest",0,2,1); 
}

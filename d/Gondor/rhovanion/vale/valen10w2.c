...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen9w2", "south",0,2,1);
    add_exit(VALE_DIR + "valen9w1", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen10w1", "east",0,2,1);
    add_exit(VALE_DIR + "valen11w1", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen11w2", "north",0,2,1);
    add_exit(VALE_DIR + "valen11w3", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen10w3", "west",0,2,1);
    add_exit(VALE_DIR + "valen9w3", "southwest",0,2,1); 
}

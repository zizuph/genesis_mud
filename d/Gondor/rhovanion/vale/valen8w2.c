...
create_vale_room()
{
    ...
    set_long("A tall, yellowish grass surrounds you, swaying in the breeze and " +
    ...
    add_exit(VALE_DIR + "valen7w2", "south",0,2,1);
    add_exit(VALE_DIR + "valen7w1", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen8w1", "east",0,2,1);
    add_exit(VALE_DIR + "valen9w1", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen9w2", "north",0,2,1);
    add_exit(VALE_DIR + "valen9w3", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen8w3", "west",0,2,1);
    add_exit(VALE_DIR + "valen7w3", "southwest",0,2,1); 
}

...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen12w2", "south",0,2,1);
    add_exit(VALE_DIR + "valen12w1", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen13w1", "east",0,2,1);
    add_exit(VALE_DIR + "valen14w1", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen14w2", "north",0,2,1);
    add_exit(VALE_DIR + "valen14w3", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen13w3", "west",0,2,1);
    add_exit(VALE_DIR + "valen12w3", "southwest",0,2,1); 
}

...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen5w2", "south",0,2,1);
    add_exit(VALE_DIR + "valen5w1", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen6w1", "east",0,2,1);
    add_exit(VALE_DIR + "valen7w1", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen7w2", "north",0,2,1);
    add_exit(VALE_DIR + "valen7w3", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen6w3", "west",0,2,1);
    add_exit(VALE_DIR + "valen5w3", "southwest",0,2,1); 
}

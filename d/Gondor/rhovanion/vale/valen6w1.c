...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen5w1", "south",0,2,1);
    add_exit(VALE_DIR + "valen5w0", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen6w0", "east",0,2,1);
    add_exit(VALE_DIR + "valen7w0", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen7w1", "north",0,2,1);
    add_exit(VALE_DIR + "valen7w2", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen6w2", "west",0,2,1);
    add_exit(VALE_DIR + "valen5w2", "southwest",0,2,1); 
}

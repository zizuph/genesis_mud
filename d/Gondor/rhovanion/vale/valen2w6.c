...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen1w6", "south",0,2,1);
    add_exit(VALE_DIR + "valen1w5", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen2w5", "east",0,2,1);
    add_exit(VALE_DIR + "valen3w5", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen3w6", "north",0,2,1);
    add_exit(VALE_DIR + "valen3w7", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen2w7", "west",0,2,1);
    add_exit(VALE_DIR + "valen1w7", "southwest",0,2,1); 
}

...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen7w1", "south",0,2,1);
    add_exit(VALE_DIR + "valen7w0", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen8w0", "east",0,2,1);
    add_exit(VALE_DIR + "valen9w0", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen9w1", "north",0,2,1);
    add_exit(VALE_DIR + "valen9w2", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen8w2", "west",0,2,1);
    add_exit(VALE_DIR + "valen7w2", "southwest",0,2,1); 
}

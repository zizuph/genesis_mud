...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen13w1", "south",0,2,1);
    add_exit(VALE_DIR + "valen13w0", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen14w0", "east",0,2,1);
    add_exit(VALE_DIR + "valen15w0", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen15w1", "north",0,2,1);
    add_exit(VALE_DIR + "valen15w2", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen14w2", "west",0,2,1);
    add_exit(VALE_DIR + "valen13w2", "southwest",0,2,1); 
}

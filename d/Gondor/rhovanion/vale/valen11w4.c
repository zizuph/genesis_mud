...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen10w4", "south",0,2,1);
    add_exit(VALE_DIR + "valen10w3", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen11w3", "east",0,2,1);
    add_exit(VALE_DIR + "valen12w3", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen12w4", "north",0,2,1);
    add_exit(VALE_DIR + "valen12w5", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen11w5", "west",0,2,1);
    add_exit(VALE_DIR + "valen10w5", "southwest",0,2,1); 
}

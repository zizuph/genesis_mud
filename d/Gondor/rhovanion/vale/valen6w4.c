...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen5w4", "south",0,2,1);
    add_exit(VALE_DIR + "valen5w3", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen6w3", "east",0,2,1);
    add_exit(VALE_DIR + "valen7w3", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen7w4", "north",0,2,1);
    add_exit(VALE_DIR + "valen7w5", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen6w5", "west",0,2,1);
    add_exit(VALE_DIR + "valen5w5", "southwest",0,2,1); 
}

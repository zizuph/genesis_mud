...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen14w4", "south",0,2,1);
    add_exit(VALE_DIR + "valen14w3", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen15w3", "east",0,2,1);
    add_exit(VALE_DIR + "valen16w3", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen16w4", "north",0,2,1);
    add_exit(VALE_DIR + "valen16w5", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen15w5", "west",0,2,1);
    add_exit(VALE_DIR + "valen14w5", "southwest",0,2,1); 
}

...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen5w6", "south",0,2,1);
    add_exit(VALE_DIR + "valen5w5", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen6w5", "east",0,2,1);
    add_exit(VALE_DIR + "valen7w5", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen7w6", "north",0,2,1);
    add_exit(VALE_DIR + "valen7w7", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen6w7", "west",0,2,1);
    add_exit(VALE_DIR + "valen5w7", "southwest",0,2,1); 
}

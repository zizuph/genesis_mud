...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen1w2", "south",0,2,1);
    add_exit(VALE_DIR + "valen1w1", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen2w1", "east",0,2,1);
    add_exit(VALE_DIR + "valen3w1", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen3w2", "north",0,2,1);
    add_exit(VALE_DIR + "valen3w3", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen2w3", "west",0,2,1);
    add_exit(VALE_DIR + "valen1w3", "southwest",0,2,1); 
}

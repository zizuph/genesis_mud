...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen1w5", "south",0,2,1);
    add_exit(VALE_DIR + "valen1w4", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen2w4", "east",0,2,1);
    add_exit(VALE_DIR + "valen3w4", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen3w5", "north",0,2,1);
    add_exit(VALE_DIR + "valen3w6", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen2w6", "west",0,2,1);
    add_exit(VALE_DIR + "valen1w6", "southwest",0,2,1); 
}

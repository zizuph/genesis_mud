...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen11w6", "south",0,2,1);
    add_exit(VALE_DIR + "valen11w5", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen12w5", "east",0,2,1);
    add_exit(VALE_DIR + "valen13w5", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen13w6", "north",0,2,1);
    add_exit(VALE_DIR + "valen13w7", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen12w7", "west",0,2,1);
    add_exit(VALE_DIR + "valen11w7", "southwest",0,2,1); 
}

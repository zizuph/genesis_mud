...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen1w3", "south",0,2,1);
    add_exit(VALE_DIR + "valen1w2", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen2w2", "east",0,2,1);
    add_exit(VALE_DIR + "valen3w2", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen3w3", "north",0,2,1);
    add_exit(VALE_DIR + "valen3w4", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen2w4", "west",0,2,1);
    add_exit(VALE_DIR + "valen1w4", "southwest",0,2,1); 
}

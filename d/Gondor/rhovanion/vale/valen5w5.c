...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen4w5", "south",0,2,1);
    add_exit(VALE_DIR + "valen4w4", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen5w4", "east",0,2,1);
    add_exit(VALE_DIR + "valen6w4", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen6w5", "north",0,2,1);
    add_exit(VALE_DIR + "valen6w6", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen5w6", "west",0,2,1);
    add_exit(VALE_DIR + "valen4w6", "southwest",0,2,1); 
}

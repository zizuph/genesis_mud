...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen14w6", "south",0,2,1);
    add_exit(VALE_DIR + "valen14w5", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen15w5", "east",0,2,1);
    add_exit(VALE_DIR + "valen16w5", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen16w6", "north",0,2,1);
    add_exit(VALE_DIR + "valen16w7", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen15w7", "west",0,2,1);
    add_exit(VALE_DIR + "valen14w7", "southwest",0,2,1); 
}

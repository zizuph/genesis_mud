...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen6w4", "south",0,2,1);
    add_exit(VALE_DIR + "valen6w3", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen7w3", "east",0,2,1);
    add_exit(VALE_DIR + "valen8w3", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen8w4", "north",0,2,1);
    add_exit(VALE_DIR + "valen8w5", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen7w5", "west",0,2,1);
    add_exit(VALE_DIR + "valen6w5", "southwest",0,2,1); 
}

...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen6w6", "south",0,2,1);
    add_exit(VALE_DIR + "valen6w5", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen7w5", "east",0,2,1);
    add_exit(VALE_DIR + "valen8w5", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen8w6", "north",0,2,1);
    add_exit(VALE_DIR + "valen8w7", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen7w7", "west",0,2,1);
    add_exit(VALE_DIR + "valen6w7", "southwest",0,2,1); 
}

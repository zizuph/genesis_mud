...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen10w2", "south",0,2,1);
    add_exit(VALE_DIR + "valen10w1", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen11w1", "east",0,2,1);
    add_exit(VALE_DIR + "valen12w1", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen12w2", "north",0,2,1);
    add_exit(VALE_DIR + "valen12w3", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen11w3", "west",0,2,1);
    add_exit(VALE_DIR + "valen10w3", "southwest",0,2,1); 
}

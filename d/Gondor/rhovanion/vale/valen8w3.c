...
create_vale_room()
{
    ...
    add_exit(VALE_DIR + "valen7w3", "south",0,2,1);
    add_exit(VALE_DIR + "valen7w2", "southeast",0,2,1);
    add_exit(VALE_DIR + "valen8w2", "east",0,2,1);
    add_exit(VALE_DIR + "valen9w2", "northeast",0,2,1);
    add_exit(VALE_DIR + "valen9w3", "north",0,2,1);
    add_exit(VALE_DIR + "valen9w4", "northwest",0,2,1);
    add_exit(VALE_DIR + "valen8w4", "west",0,2,1);
    add_exit(VALE_DIR + "valen7w4", "southwest",0,2,1); 
}

/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf1.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_no_exit_msg(({"southwest","west", "northwest","north","northeast"}),
    ...
    add_exit(CAIRANDROS_DIR + "caf2", "east",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf4", "south",0,0,0);
    add_exit(CAIRANDROS_DIR + "fort1", "down",0,0,0);

/*
 * Cair Andros - /d/Gondor/anorien/cairandros/fort9.c
 *
 * Varian 2016
 */
...
{    
    ...
    add_exit(CAIRANDROS_DIR + "fort10","east",0,0,0);
    add_exit(CAIRANDROS_DIR + "fort8","west",0,0,0);

    door = clone_object(AN_OBJ_DIR + "storage_door_in_nw");
    door->move(TO);
}
/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf11.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_long("You are around the northwest corner of the stone fortress, " +
        ...
        "are south and west of here. Looking over the stone walls, you " +
    ...
    add_item(({"stair","stairs","step","steps","stone stair","stone stairs",
        ...
        "up are on the other end of this pathway, to the south and west.\n");
    ...
    set_no_exit_msg(({"northeast","east", "northwest","south","southeast"}),
    ...
    add_exit(CAIRANDROS_DIR + "caf12", "west",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf10", "south",0,0,0);

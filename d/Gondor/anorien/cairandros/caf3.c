/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf3.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_long("You are around the southwest corner of the stone fortress, " +
        ...
        "are north and west of here. Looking over the stone walls, you " +
    ...
    add_item(({"stair","stairs","step","steps","stone stair","stone stairs",
        ...
        "up are on the other end of this pathway, to the north and west.\n");
    ...
    add_exit(CAIRANDROS_DIR + "caf4", "west",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf2", "north",0,0,0);

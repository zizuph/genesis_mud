...
string *weapons = ({ AN_WEP_DIR + "sword", AN_WEP_DIR + "dagger", AN_WEP_DIR + "mace", AN_WEP_DIR + "gsword" }); 
string *helmets = ({ AN_ARM_DIR + "helm", AN_ARM_DIR + "helm2" });
string *body = ({ AN_ARM_DIR + "chain", AN_ARM_DIR + "chain2", AN_ARM_DIR + "chain3", AN_ARM_DIR + "plate", AN_ARM_DIR + "plate2", AN_ARM_DIR + "plate3"});
...
create_monster()
{
    ...
    set_stats(({140, 140, 180, 55, 75, 120}), 40);
    set_alignment(500);
    ...
    add_cchat("Foul servant of the east! I will see you dead!");

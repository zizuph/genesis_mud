/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf15.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_long("You are around the northeast corner of the stone fortress, " +
        ...
        "are south and east of here. Looking over the stone walls, you " +
    ...
    add_item(({"stair","stairs","step","steps","stone stair","stone stairs",
        ...
        "up are on the other end of this pathway, to the south and east.\n");
    ...
    set_no_exit_msg(({"northeast","east", "northwest","south","southwest"}),
    ...
    add_exit(CAIRANDROS_DIR + "caf14", "east",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf16", "south",0,0,0);

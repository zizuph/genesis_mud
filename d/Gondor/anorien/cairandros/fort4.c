/*
 * Cair Andros - /d/Gondor/anorien/cairandros/fort4.c
 *
 * Varian 2016
 */
...
{    
    ...
    add_exit(CAIRANDROS_DIR + "fort5","east",0,0,0);
    add_exit(CAIRANDROS_DIR + "fort3","west",0,0,0);

    door = clone_object(AN_OBJ_DIR + "storage_door_in_se");
    door->move(TO);
}
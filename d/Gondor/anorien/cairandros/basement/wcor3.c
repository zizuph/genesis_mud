 ...
 * /d/Gondor/anorien/cairandros/basement/wcor3.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "wcor2", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "wcor4", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "ba23", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba24", "south", 0, 0, 0);

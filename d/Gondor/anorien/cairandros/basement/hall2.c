 ...
 * /d/Gondor/anorien/cairandros/basement/hall2.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ba3", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba4", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "hall3", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "hall1", "south", 0, 0, 0);

 ...
 * /d/Gondor/anorien/cairandros/basement/ba15.c
 *
 * Home of Velgond and the pipeweed quest
 *
...
{    
    ...
    add_item( ({"east", "east wall", "eastern wall"}),
        "There are several crates stacked up against the eastern " +
        "wall, each seemingly filled with pipe-weed.\n");
    ...
    add_item( ({"weed", "pipeweed", "pipe-weed", "crate", "crates",
            "crate of pipe-weed", "crates of pipe-weed"}),
        "A sweet aroma drifts outward from several crates " +
        "of pipe-weed, all of which have been stacked up neatly " +
        "against the eastern wall here. Upon closer inspection, " +
        "you notice that the crates have been marked with the " +
        "name 'Longbottom'.\n");
...
desc()
{
    write("You are currently standing in sleeping quarters " +
        "designed for the soldiers who are serving in the fort "+
        "of Cair Andros. Dozens of simple pallets have been " +
        "organized against the north and south walls here, " +
        "serving as functional beds for the men sleeping here. " +
        "Several crates have been stacked up against the " +
        "eastern wall, while the hallway which runs through " +
        "the lower levels of the fortress is visible on " +
        "the other side of the wide opening in the west wall.\n");
}
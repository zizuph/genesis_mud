 ...
 * /d/Gondor/anorien/cairandros/basement/ba38.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"south", "south wall", "southern wall"}),
        "A long table reaches across the width of the southern " +
        "wall here.\n");
    ...
    add_exit(CABASE_DIR + "ecor5", "north", 0, 0, 0);
...
desc()
{
    write("You are in the lower levels of Cair Andros, where the " +
        "barracks seem to sprawl out in every direction. There are " +
        "plenty of simple sleeping pallets arranged along the east " +
        "and west walls in neat rows, giving the soldiers who are " +
        "on duty in the fort a reasonably comfortable place to rest. " +
        "A long wooden table stretches across the southern wall, " +
        "while the corridor is visible through the wide opening in " +
        "the north wall.\n");
}
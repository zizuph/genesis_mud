 ...
 * /d/Gondor/anorien/cairandros/basement/ba36.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"south", "south wall", "southern wall"}),
        "Several barrels are clustered together near the southern " +
        "wall.\n");
    ...
    add_item( ({"wine", "wine barrel", "wine barrels", "small barrel",
            "small barrels", "wood barrel", "wooden barrels",
            "wooden barrel", "wood barrels", "small wooden barrels",
            "small wooden barrel", "barrel", "barrels"}),
        "There are dozens of small wooden barrels stacked in a " +
        "cluster against the southern wall here. The barrels all " +
        "appear to be marked with the name 'Dorwinion' on the top. " +
        "While most of the barrels are still closed and tightly " +
        "sealed, you can smell the remains of wine in the few " +
        "open barrels.\n");
    ...
    add_exit(CABASE_DIR + "ecor4", "north", 0, 0, 0);
...
desc()
{
    write("You are in some sleeping quarters within the lower " +
        "levels of Cair Andros. Like most of the rooms down " +
        "here, these quarters have rows of bunks lined up " +
        "against the east and west walls, giving plenty of " +
        "space for the soldiers serving here to take their " +
        "rest. Dozens of small wooden barrels are clustered " +
        "in a pile against the southern wall, while a wide " +
        "opening in the northern wall leads back out into the " +
        "corridor.\n");
}
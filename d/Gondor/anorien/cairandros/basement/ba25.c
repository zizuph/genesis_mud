 ...
 * /d/Gondor/anorien/cairandros/basement/ba25.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"north", "north wall", "northern wall"}),
        "Dozens of tall clay jars have been gathered up against " +
        "the northern wall.\n");
    ...
    add_item( ({"tall clay jar", "tall clay jars", "clay jar", "jar",
            "clay jars", "jars", "oil", "oil jars"}),
        "Dozens of tall clay jars have been gathered up against the " +
        "northern wall. A quick look is enough to tell you that " +
        "the jars are all filled with supplies of oil.\n");
    ...
    add_exit(CABASE_DIR + "wcor4", "south", 0, 0, 0);
...
desc()
{
    write("You are in some sleeping quarters in the lower levels " +
        "of the fort at Cair Andros. Dozens of simple pallets have " +
        "been lined up against both the east and west walls, " +
        "providing a functional place to sleep for soldiers " +
        "who have been assigned the duty of defending the " +
        "fortress. Lined up against the northern wall are several " +
        "tall clay jars, while a wide opening in the southern " +
        "wall leads out into the corridor beyond.\n");
}
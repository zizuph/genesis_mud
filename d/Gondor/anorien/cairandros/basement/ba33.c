 ...
 * /d/Gondor/anorien/cairandros/basement/ba33.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"north", "north wall", "northern wall"}),
        "A huge heap of arrows, wrapped tightly in bundles, rest up " +
        "against the north wall here.\n");
    ...
    add_item( ({"bundle", "bundles", "bundle of arrows", "arrows",
            "arrow", "bundles of arrows", "heap", "huge heap",
            "huge heap of arrows"}),
        "There are easily several thousand arrows here, all wrapped " +
        "up in tight bundles and piled up against the wall. With " +
        "a supply of arrows like this, Cair Andros looks well " +
        "prepared to withstand any invasion coming out of Ithilien.\n");
    ...
    add_exit(CABASE_DIR + "ecor3", "south", 0, 0, 0);
...
desc()
{
    write("You are in the lower levels of Cair Andros, currently " +
        "inside on of the rooms which serve as sleeping quarters for " +
        "the soldiers serving in the fort. The east and west wall " +
        "are organized with rows of bunks for the men to sleep in " +
        "when they are off-duty. There are hundreds, perhaps " +
        "thousands, of arrows wrapped tightly in bundles against " +
        "the north wall while the corridor you came in from is " +
        "visible through a wide opening in the southern wall.\n");
}
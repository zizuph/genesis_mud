 ...
 * /d/Gondor/anorien/cairandros/basement/ba31.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"north", "north wall", "northern wall"}),
        "There are several pieces of what is probably a ballista " +
        "stacked up against the grey stone of the north wall here.\n");
    ...
    add_item( ({"ballista", "dismantled ballista", "broken ballista"}),
        "This appears to be a ballista, or at least, the dismantled " +
        "remains of one. Upon closer inspection, you can see that " +
        "the windlass appears to be broken and the ballista has " +
        "been dismantled and placed here so that someone can work " +
        "on repairs.\n");
    ...
    add_exit(CABASE_DIR + "ecor2", "south", 0, 0, 0);
...
desc()
{
    write("You are currently on the lower levels of Cair Andros in " +
        "one of the rooms designated as sleeping quarters for the " +
        "soldiers who have been assigned to serve in the fortress. " +
        "Both the eastern and western walls are lined with bunks, " +
        "simple pallets for the men to sleep in when they are " +
        "off-duty. There appears to be a dismantled ballista " +
        "piled up against the northern wall and a wide opening " +
        "in the southern wall leads back out to the corridor.\n");
}
 ...
 * /d/Gondor/anorien/cairandros/basement/wcor5.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"west", "western wall", "west wall"}),
        "The hallway ends here, and the way west is blocked " +
    ...
    add_exit(CABASE_DIR + "wcor4", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba27", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba28", "south", 0, 0, 0);
...
desc()
{
    write("You are currently in the lower levels of the fortress " +
        ...
        "you are in ends in a stone wall to the west and runs east " +

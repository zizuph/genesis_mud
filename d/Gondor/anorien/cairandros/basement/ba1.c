...
{    
    ...
    add_exit(CABASE_DIR + "hall1", "west", 0, 0, 0);
...
desc()
{
    write("You are inside the sleeping quarters designed for some " +
        "of the soldiers who have been stationed at Cair Andros. " +
        "You are currently in the lower levels of the fortress, " +
        "where the bulk of the soldiers assigned here sleep. Rows " +
        "of beds line the northern and southern walls here, while " +
        "a long wooden table has been pressed up against the eastern " +
        "wall. A wide opening in the western wall leads back out " +
        "into the hallway.\n");
}
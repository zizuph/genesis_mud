 ...
 * /d/Gondor/anorien/cairandros/basement/ecor2.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ecor3", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ecor1", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "ba31", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba32", "south", 0, 0, 0);

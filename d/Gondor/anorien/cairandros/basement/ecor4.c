 ...
 * /d/Gondor/anorien/cairandros/basement/ecor4.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ecor5", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ecor3", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "ba35", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba36", "south", 0, 0, 0);

 ...
 * /d/Gondor/anorien/cairandros/basement/wcor1.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"east", "eastern corridor", "east corridor"}),
        "The corridor opens up into an intersection to the east, " +
    ...
    add_exit(CABASE_DIR + "hall5", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "wcor2", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "ba19", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba20", "south", 0, 0, 0);
...
desc()
{
    write("You are currently in the lower levels of the fortress " +
        ...
        "runs westward from an intersection to the east, while openings " +

 ...
 * /d/Gondor/anorien/cairandros/basement/hall9.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ba15", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba16", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "hall10", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "hall8", "south", 0, 0, 0);

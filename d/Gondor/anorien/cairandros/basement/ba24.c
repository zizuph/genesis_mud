 ...
 * /d/Gondor/anorien/cairandros/basement/ba24.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"south", "south wall", "southern wall"}),
        "You can see a long wooden desk, filled with papers, pushed " +
        "up against the southern wall.\n");
    ...
    add_item( ({"wooden desk", "long desk", "long wooden desk",
            "desk", "papers", "reports"}),
        "Pushed up against the southern wall of these quarters is " +
        "a long wooden desk, filled with papers. The desk itself " +
        "is of plain construction, but is does feel extremely " +
        "solid. Scattered across the surface, there are numerous " +
        "papers which all seem to outline all of the logistical " +
        "records for the fortress here at Cair Andros.\n");
    ...
    add_exit(CABASE_DIR + "wcor3", "north", 0, 0, 0);
...
desc()
{
    write("You are in the lower levels of Cair Andros, inside " +
        "a part of the barracks that house the local soldiers. " +
        "Rows of pallets are lined up against both the east and " +
        "west walls, providing simple bunks for the men who " +
        "are stationed here. A long wooden desk, covered with " +
        "all sorts of papers, has been pushed up against the " +
        "southern wall, while a wide opening in the north " +
        "wall leads back out to the corridor.\n");
}
 ...
 * /d/Gondor/anorien/cairandros/basement/ba29.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"north", "north wall", "northern wall"}),
        "Dozens of small crates have been stacked up here, almost " +
        "covering the northern wall entirely.\n");
    ...
    add_item( ({"crate", "crates", "goods", "dry goods", "small crate",
            "small crates", "dried goods", "food", "dried food",
            "dry food", "wood crate", "wooden crate", "wood crates",
            "wooden crates", "small wooden crate",
            "small wooden crates"}),
        "These small wooden crates have been stacked up to the " +
        "ceiling here. Most of the crates are nailed shut, but " +
        "the few which are open show a small variety of dried " +
        "goods for the soldiers to eat.\n");
    ...
    add_exit(CABASE_DIR + "ecor1", "south", 0, 0, 0);
...
desc()
{
    write("You are in the lower levels of Cair Andros, where the " +
        "soldier's quarters sprawl out all over the place. Dozens " +
        "of simple pallets serve as bunks here and have been " +
        "tightly lined up against both the east and west walls. " +
        "There are dozens of wooden crates filled with dried food " +
        "stacked up to the ceiling, leaning against the northern " +
        "wall. A wide opening in the south wall leads back out to " +
        "the corridor.\n");
}
 ...
 * /d/Gondor/anorien/cairandros/basement/wcor2.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "wcor1", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "wcor3", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "ba21", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba22", "south", 0, 0, 0);

 ...
 * /d/Gondor/anorien/cairandros/basement/hall3.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ba5", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba6", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "hall4", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "hall2", "south", 0, 0, 0);

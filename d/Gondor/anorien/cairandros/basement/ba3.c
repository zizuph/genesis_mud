 ...
 * /d/Gondor/anorien/cairandros/basement/ba3.c
 *
...
{    
    ...
    add_item( ({"east", "east wall", "eastern wall"}),
        "A large desk filled with maps stands up against the " +
        "eastern wall.\n");
    ...
    add_item( ({"desk", "large desk"}),
        "This large desk appears to be a place where some officers " +
        "have gathered information on the movements of enemy armies.\n");
    add_item( ({"map", "maps"}),
        "Several maps have been neatly organized on the desk here. " +
        "Most of the maps seem to have markings on them, detailing " +
        "where the forces of Mordor have been advancing.\n");
    ...
    add_exit(CABASE_DIR + "hall2", "west", 0, 0, 0);
...
desc()
{
    write("This room is filled with dozens of bunks for the " +
        "soldiers who have been assigned to duty at Cair Andros. " +
        "Dozens of sleeping pallets line the north and south " +
        "walls, while a large desk filled with maps rests up " +
        "against the eastern wall. The western wall is empty " +
        "except for a wide opening that leads back out into " +
        "the hallway beyond.\n");
}
 ...
 * /d/Gondor/anorien/cairandros/basement/hall7.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ba11", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba12", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "hall8", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "hall6", "south", 0, 0, 0);

 ...
 * /d/Gondor/anorien/cairandros/basement/ba22.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item( ({"south", "south wall", "southern wall"}),
        "The southern wall itself is bare, but a large pile of " +
        "mops, buckets, rags and other cleaning equipment sits " +
        "here.\n");
    ...
    add_item( ({"equipment", "cleaning equipment", "mops", "mop",
            "bucket", "buckets", "rags", "rag", "broom", "brooms",
            "brush", "brushes"}),
        "There is a large cluttered mound of various cleaning " +
        "equipment piled up against the southern wall here. You " +
        "can see several buckets with brushes inside, dozens " +
        "of mops, brooms and countless cleaning rags.\n");
    ...
    add_exit(CABASE_DIR + "wcor2", "north", 0, 0, 0);
...
desc()
{
    write("You are standing in the lower barracks of Cair Andros. " +
        "Dozens of bunks have been lined up along both the east " +
        "and west walls, although the beds here are really nothing " +
        "more than rough pallets filled with straw. A cluttered " +
        "pile of buckets, mops and other cleaning equipment rests " +
        "near the southern wall. A wide opening in the north wall " +
        "shows you the corridor you came in from.\n");
}
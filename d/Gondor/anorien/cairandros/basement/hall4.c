 ...
 * /d/Gondor/anorien/cairandros/basement/hall4.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ba7", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba8", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "hall5", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "hall3", "south", 0, 0, 0);
...
desc()
{
    write("You are currently in the lower levels of the fortress " +
        ...
        "in the east and west walls lead into rooms where the " +
        "soldiers serving here sleep. Several torches line the walls " +
        "of the hallway, giving plenty of light from their " +
        "flickering flames. A corridor crosses this hallway just " +
        "north of you here.\n");
}
 ...
 * /d/Gondor/anorien/cairandros/basement/wcor4.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "wcor3", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "wcor5", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "ba25", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba26", "south", 0, 0, 0);

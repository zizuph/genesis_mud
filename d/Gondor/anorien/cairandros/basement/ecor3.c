 ...
 * /d/Gondor/anorien/cairandros/basement/ecor3.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ecor4", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ecor2", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "ba33", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "ba34", "south", 0, 0, 0);

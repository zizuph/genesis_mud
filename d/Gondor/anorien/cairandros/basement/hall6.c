 ...
 * /d/Gondor/anorien/cairandros/basement/hall6.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_exit(CABASE_DIR + "ba9", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba10", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "hall7", "north", 0, 0, 0);
    add_exit(CABASE_DIR + "hall5", "south", 0, 0, 0);

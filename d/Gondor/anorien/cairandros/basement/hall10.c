 ...
 * /d/Gondor/anorien/cairandros/basement/hall10.c
 *
 * Varian - March, 2020
 */
...
{    
    ...
    add_item (({"north", "northern wall", "north wall"}),
        "The hallway ends here, and the way north is blocked " +
    ...
    add_exit(CABASE_DIR + "ba17", "east", 0, 0, 0);
    add_exit(CABASE_DIR + "ba18", "west", 0, 0, 0);
    add_exit(CABASE_DIR + "hall9", "south", 0, 0, 0);
...
desc()
{
    write("You are currently in the lower levels of the fortress on the " +
        "island of Cair Andros in Gondor. The hallway stretches out" +
        "to the south, but ends in a wall to the north here. Openings " +

/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf2.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_long("You are near the southwest corner of the stone fortress, " +
        ...
        "the south and the west where several stone stairs descend " +
    ...
    add_item(({"stair","stairs","step","steps","stone stair","stone stairs",
        ...
        "Just west of here, you can see some stone stairs leading down " +
        "into the fortress.\n");
    ...
    add_exit(CAIRANDROS_DIR + "caf1", "west",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf3", "south",0,0,0);

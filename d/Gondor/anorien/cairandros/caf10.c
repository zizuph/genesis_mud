/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf10.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_long("You are near the northwest corner of the stone fortress, " +
        ...
        "the north and the west where several stone stairs descend " +
    ...
    add_exit(CAIRANDROS_DIR + "caf11", "north",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf9", "west",0,0,0);

/*
 * /d/Gondor/anorien/cairandros/arm/ca_shield2.c
 *
...
create_armour()
{
    set_name("shield");
    add_name("armour");
    set_short("sturdy Gondorian shield");
    set_adj("sturdy");
    add_adj("gondorian");
    set_long("This wooden shield has been rimmed " +
        "with black iron while proudly displaying " +
        "the white tree of Gondor painted on the " +
        "face.\n");

/*
 * /d/Gondor/anorien/cairandros/arm/helm2.c
 *
 * Varian - 2016
 *
...
#define ARM ({"helm", "helmet"})
#define ADJ ({"winged", "sturdy", "pointy", "shiny", "dented"})
...
set_armour_data()
{
    ...
    set_long("This is a "+adj+" "+adj2+" "+arm+" which has been issued out " +
        ...
        "condition, and it should protect your head quite well.\n");

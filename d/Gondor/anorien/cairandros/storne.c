/*
 * Cair Andros - /d/Gondor/anorien/cairandros/storne.c
 *
 * Varian 2016
 */
...
{    
    ...
    set_long("You are in a small storage room that is inside the fortress " +
        ...
        "large wooden door that stands in the middle of the northern " +
    ...
    add_item(({"east","eastern wall"}),
        "The eastern wall is rather plain, with nothing much to look " +
        "at.\n");
    add_item(({"north", "northern wall"}),
        "There is a large wooden door in the middle of the northern wall, " +
        "providing access into the rest of the fortress.\n");
    add_item(({"west", "western wall"}),
        "The western wall is rather plain, aside from the torch that hangs " +
        "on the wall, there is nothing much to look at.\n");
    add_item(({"south", "southern wall"}),
        "The southern wall is rather plain, with nothing much to look " +
        "at.\n");
    add_item(({"boxes","box"}),
    ...
    door = clone_object(AN_OBJ_DIR + "storage_door_out_ne");
    door->move(TO);
}
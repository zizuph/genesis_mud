/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf13.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_no_exit_msg(({"southeast","east", "northeast","north","southwest"}),
    ...
    add_exit(CAIRANDROS_DIR + "caf14", "north",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf16", "west",0,0,0);
    add_exit(CAIRANDROS_DIR + "fort12", "down",0,0,0);

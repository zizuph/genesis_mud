/*
 * Cair Andros - /d/Gondor/anorien/cairandros/caf14.c
 *
 * Varian 2016
 */
...
create_ca_room()
{
    ...
    set_long("You are near the northeast corner of the stone fortress, " +
        ...
        "the west and the south where several stone stairs descend " +
    ...
    set_no_exit_msg(({"northwest","east", "northeast","south","southeast"}),
    ...
    add_exit(CAIRANDROS_DIR + "caf13", "south",0,0,0);
    add_exit(CAIRANDROS_DIR + "caf15", "west",0,0,0);

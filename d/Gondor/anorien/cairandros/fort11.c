/*
 * Cair Andros - /d/Gondor/anorien/cairandros/fort11.c
 *
 * Varian 2016
 */
...
{    
    ...
    add_exit(CAIRANDROS_DIR + "fort12", "east",0,0,0);
    add_exit(CAIRANDROS_DIR + "fort10","west",0,0,0);

    door = clone_object(AN_OBJ_DIR + "storage_door_in_ne");
    door->move(TO);
}
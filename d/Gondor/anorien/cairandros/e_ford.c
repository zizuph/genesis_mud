...
create_room() 
{
    ...
    set_long("You are in the middle of the Anduin river, wading across " +
        "the ford between Cair Andros and Ithilien. The island of Cair " +
        "Andros lies immediately to the west, and is heavily forested " +
        "with a tall stone fort guarding the ford at the southern end " +
        "of the island. To the east, you can see the forested hills " +
        "of Ithilien as they bump up against the riverbank, watching " +
        "the Anduin as it flows south towards the sea.\n");
    ...
    add_item(({"ford","fords","shallows"}),
        "This ford connects Ithilien to the island of Cair Andros in the " +
        "shallows of the Anduin. A second ford connects Cair Andros to " +
        "the plains of Anorien farther to the west.\n");
    ...
    add_item(({"ithilien"}),
        "The lands of Ithilien are just east of you here, filled with " +
        "shadowy forests hiding in the hills and huddled beneath the " +
        "ominous gaze of the Mountains of Shadow that dominate the " +
        "eastern horizon.\n");
    add_item(({"anorien","plains","grass","grassy plains"}),
        "The grassy plains of Anorien roll across gentle hills on the " +
    ...
    add_item(({"west", "western horizon"}),
        "The western horizon is filled mostly with the island of Cair " +
        "Andros, although you can see the rolling plains of Anorien " +
        "beyond.\n");
    add_item(({"southwest", "southwestern horizon"}),
        "The southwestern horizon is filled mostly with the island of Cair " +
        "Andros, although you can see the rolling plains of Anorien " +
        "beyond.\n");
    add_item(({"northwest", "northwestern horizon"}),
        "The northwestern horizon is filled mostly with the island of Cair " +
        "Andros, although you can see the rolling plains of Anorien " +
        "beyond.\n");
    ...
    add_item(({"east", "eastern horizon"}),
        "The shadowy forests and hills of Ithilien lie beneath the " +
        "watchful eye of the mountains that dominate the horizon to the " +
        "east.\n");
    ...
    add_item(({"island", "cair andros"}),
        "You are near the island of Cair Andros which stands in the middle " +
    ...
    add_item(({"ford", "river", "anduin", "bank", "banks", "waters",
        ...
        "river. You are currently standing in the middle of the ford.\n");

    add_exit(CAIRANDROS_DIR + "fort5","west","@@cairandros@@");
    add_exit("/d/Gondor/ithilien/road/rr10","east","@@ithilien@@");
...
ithilien()
{
    ...
    write("You cross over the Anduin and enter the land of Ithilien.\n");
    return 0;
}
/*

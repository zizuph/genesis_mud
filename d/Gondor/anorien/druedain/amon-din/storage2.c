/*
 *  /d/Gondor/anorien/druedain/amon-din/storage2.c
 *
 *  A storage room where the watchers of Gondor keep firewood for their
 *  beacon signals.
 *
 *  Created 1996(?) by Gorboth (Cooper Sherry)
 *
 *  Revision history:
 *
 *    October 2004: Made quest redoable without a reboot. (Gorboth)
 */

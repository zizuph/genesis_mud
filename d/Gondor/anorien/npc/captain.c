...
create_monster()
{
    ...
    set_stats(({200, 260, 260, 85, 95, 150}), 40);
    set_alignment(500);

    set_restrain_path(({PLAINS_DIR}));
    set_monster_home(({PLAINS_DIR + "an16w3n"}));
    set_random_move(20);
...
{
    string *guardname;
    guardname = ({"adrahil", "anardil", "angbor", "baranor", "derufin",
        "hallas", "hirgon", "malbeth", "ohtar", "thorondir", "valdil",
        "havar", "elagon", "astior", "pelhil", "anwar", "cuthion",
        "mestil", "madil", "berdil", "lothan", "eldior", "nardil"});

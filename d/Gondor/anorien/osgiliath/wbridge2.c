...
create_area_room()
{
    ...
    "territory. Further northeast is the islet of central Osgiliath, "+
    ...
    "ruined, and the sad remains are no longer populated. Southwest is "+
    "the west shore of the Anduin, and West Osgiliath.");
    add_item(({"bridge","ruins"}), BS(
    ...
    add_exit(OSG_DIR + "wbridge1","southwest", 0, 2);
    add_exit(OSG_DIR + "wbridge3","northeast", 0, 2);
}

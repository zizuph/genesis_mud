/*
 *	/d/Gondor/anorien/osgiliath/wbridge2.c
 *
 *	Coded by Olorin
 *
 *	Modification log:
...
create_area_room()
{
    ...
    "To the west the bridge reaches the islet in the Anduin, and the "+
    ...
    "to expect. East the bridge stretches on arched pillars across to "+
    "the east shore of the Anduin, and the green lands of Ithilien.");
    add_item("bridge", BS(
    ...
    add_item(({"ruins","archway"}),BSN("Before you to the west is a "+
    ...
    add_exit(OSG_DIR + "ebridge2",  "east", 0, 2);
    add_exit(OSG_DIR + "e1archway", "west", 0, 2);
}

/*
 * Anorien - /d/Gondor/anorien/plains/an12w2n.c
 *
 * Varian 2016
 */
...
create_plains_room()
{
    ...
    set_short("Anorien");
    set_long("It is " + VBFC("day_desc") + " here on the rolling plains " +
        "of Anorien. Wide green fields of tall grass surround you in every " +
        ...
        " across the southern horizon. To the east, you see the deep valley " +
        "which follows the mighty Anduin River on its journey to the sea. " +
        "Groves of trees dot the plains here, filling the hills and " +
    ...
    add_exit(PLAINS_DIR + "an13w2n", "east",0,2,1);
    add_exit(PLAINS_DIR + "an11w2n", "west",0,2,1);
    add_exit(PLAINS_DIR + "an11w3n","southwest",0,2,1);
    add_exit(PLAINS_DIR + "an12w3n","south",0,2,1);
    add_exit(PLAINS_DIR + "an13w3n","southeast",0,2,1);
    add_exit(PLAINS_DIR + "an13w1n","northeast",0,2,1);

/*
 * Anorien - /d/Gondor/anorien/plains/an4w2n.c
 *
 * Varian 2016
 */
...
create_plains_room()
{
    ...
    set_long("You are in the middle of tall fields of green grass, where " +
        ...
        "The fields slowly grow into marshy wetlands as they near the " +
    ...
    add_exit(PLAINS_DIR + "an5w2n", "east",0,2,1);
    add_exit(PLAINS_DIR + "an3w2n", "west",0,2,1);
    add_exit(PLAINS_DIR + "an3w3n","southwest",0,2,1);
    add_exit(PLAINS_DIR + "an4w3n","south",0,2,1);
    add_exit(PLAINS_DIR + "an5w3n","southeast",0,2,1);

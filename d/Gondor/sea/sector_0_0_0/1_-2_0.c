...
create_water_room()
{
    ...
    add_swim_exit(SECTOR_PATH(1, -2, -1) + "1_-2_-1", "down", 0);
    add_row_exit(SECTOR_PATH(1, -2, -1) + "1_-2_-1", "down", 0);
    add_swim_exit(SECTOR_PATH(0, -2, 0) + "0_-2_0", "west", 0);
    add_row_exit(SECTOR_PATH(0, -2, 0) + "0_-2_0", "west", 0);

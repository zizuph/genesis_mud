...
create_water_room()
{
    ...
    add_swim_exit(SECTOR_PATH(2,1,0)+"2_1_0", "north", 0, 1);
    add_swim_exit(SECTOR_PATH(2,3,0)+"2_3_0", "south", 0, 1);
    add_swim_exit(SECTOR_PATH(3,2,0)+"3_2_0", "west", 0, 1);
    add_swim_exit(SECTOR_PATH(3,1,0)+"3_1_0", "northwest", 0, 1);
    add_swim_exit(SECTOR_PATH(3,3,0)+"3_3_0", "southwest", 0, 1);
    add_row_exit(SECTOR_PATH(2,1,0)+"2_1_0", "north", 0, 1);
    add_row_exit(SECTOR_PATH(2,3,0)+"2_3_0", "south", 0, 1);
    add_row_exit(SECTOR_PATH(3,2,0)+"3_2_0", "west", 0, 1);
    add_row_exit(SECTOR_PATH(3,1,0)+"3_1_0", "northwest", 0, 1);
    add_row_exit(SECTOR_PATH(3,3,0)+"3_3_0", "southwest", 0, 1);
}

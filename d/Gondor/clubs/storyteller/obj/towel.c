/*
 * /d/Gondor/clubs/storytellers/obj/towel.c
 * Borrowed from:
...
do_snap(string str)
{
        ...
        (random(who[0]->query_stat(SS_DEX) + who[0]->query_skill(SS_ACROBAT))))
    {
        ...
        write("You "+vb+" your wet towel at " + who[0]->query_the_name(tp)
    ...
    write("You try to "+vb+" your wet towel at " + who[0]->query_the_name(tp)
      + ", but miss!\n");

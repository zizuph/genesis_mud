/*
 * /d/Gondor/clubs/storytellers/obj/2f_door_out.c
 */
inherit "/std/door";
...
create_door()
{
    ...
    set_door_name(({"dark door","wooden door","door"}));
    set_other_room(STORYT_DIR + "rooms/ehallway");
    set_door_desc("The dark door is made of solid, polished wood.\n");
...
pass_door(string arg)
{
    ...
    if (IS_STORYTELLER(this_player()))
    {
	    ...
	    tell_room(environment(this_object()),
		QCTNAME(this_player())+" opens the " + short() + ".\n");

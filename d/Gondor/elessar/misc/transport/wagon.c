...
my_noise()
{
  tell_room(environment(this_object()),"The wagon whirls up some dust as it passes you.\n");
  tell_room(WAGON_INSIDE,"The wagon rambles on along the road to "+goal+".\n");
  return 1;
}

...
prepare_tour() {
  goal = tourgoal;
  tell_room(environment(this_object()),"The wagon-driver yells: All passengers aboard! The transport to "+goal+" leaves soon!\n");
  tell_room(wagon_inside,"The wagon-driver yells: All passenger aboard! The transport to "+goal+" leaves soon!\n");
  set_leavable(0);
...
turn_back() {
  goal = retourgoal;
  tell_room(environment(this_object()),"The wagon-driver yells: All passengers aboard! The transport is returning to "+goal+"!\n");
  tell_room(wagon_inside,"The wagon-driver yells: All passenger aboard! The transport is returning to "+goal+"!\n");
  set_leavable(0);
...
tour_move(int turn)
{
  ...
  tell_room(wagon_inside,break_string("The wagon-driver yells: Allright, we have arrived in "+tourgoal+"! The carriage will return to "+retourgoal+" in 1 hour!\n",70));
...
disassemble() 
{
  ...
  while (n < liv_arr) {
    liv_arr[n]->move(environment(this_object()));
    n++;
  }
  return 1;
}

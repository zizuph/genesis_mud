...
create_area_room()
{
    ...
    set_extraline("To the north a ridge with a strange hill is seen, with " +
        "the White Mountains towering up behind it. The field is dark " +
        "green, some bushes and small trees are scatered over the field. " +
	"The sound of running water can be heard to the north and the " +
        "east.");
                                   /* set extra longdesc */

...
create_gondor()
{
  ...
  set_long("You are inside a tunnel. The air feels very dense here. The " +
	   "tunnel continues eastward into the White Mountains.\n");
  ...
  add_exit(E_PATH + "north1.c", "northwest", "@@pass", 2, 0);
  add_exit(E_PATH + "north3.c", "east", "@@pass", 2, 0);
}

...
//inherit "/std/living/combat";  /* for the panic */
...
create_monster()
{
    ...
    set_race_name("ghost");
    set_living_name("_walking_ghost_of_erech_");
    ...
    set_random_move(11, 0);
    set_restrain_path(E_PATH);
    ...
    set_cact_time(5);
    add_cact("emotes stares deep into your eyes. Your limbs freeze.");
    add_cact("knee enemy");
    add_cact("kick enemy");
    add_cact("slap enemy");

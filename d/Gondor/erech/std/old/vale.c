...
hill_items()
{
    add_item("ridge", "A steep ridge rises from the field to a plateau " +
	"further up. At the end of the ridge you can see an unusual hill.\n");
    add_item( ({ "hill", "unusual hill" }),
	"This is an unusual hill. It is somewhat round in shape, and on " +
        "top a large black rock can be seen. The sides of the hill are " +
        "tinted green.\n");
}
...
time_sky()
{
    ...
    case "night":
    case "early morning":
      sky = "Stars fill the sky, with Elbereth's twinkling clearly.";
      break;
    case "morning":
    ...
    case "afternoon":
      ...
      break;
    case "evening":
      sky = "The sun's rays are fading from view as the sun sinks below " +
          "the horizon, and the sky is filled with the colours of sunset.";
      break;
    }
...
vale_items()
{
    add_item( ({"hill", "hills"}), "You see small hills in all directions.\n");
    add_item( ({"mountain","mountains"}), 
	"To the north you notice large mountains towering up into the sky. " +
	"They are light blue, almost white in colour, and on the tops " +
	"you see snow.\n");
...
add_item_field()
{
    add_item("field", "The field is dark green, and some trees and bushes " +
...
path_items()
{
    add_item("path", "You are on a dusty road in Gondor, but you cannot " +
        "see where it leads.\n");
}
...
blocked_river()
{
    write("The river is too strong for you to pass.\n");
    return 1;
}
...
blocked_path()
{
    write("It is too dificoult for you to pass here.\n");
    return 1;
}

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn33", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn24", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornee", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "garlic", HERB_DIR + "hemlock", }),
		  ({ "ground", "forest", }), 3);
}

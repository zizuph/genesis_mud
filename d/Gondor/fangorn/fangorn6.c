...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn11", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornk", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "holly", HERB_DIR + "hemlock", }),
		  ({ "ground", "forest", }), 3);

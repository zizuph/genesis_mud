...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn13", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn21", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn34", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorno", "north", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "attanar", HERB_DIR + "foxglove", }),
		  ({ "ground", "forest", }), 3);
}

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn2", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn3", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn13", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn14", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornd", "north", test_loc, 2, 1);
    ...
    set_extraline("Although the trees here are relatively thin, there "
        ...
        + "ancient trees behind you do not seem inviting. A small stream "
    ...
    set_up_herbs( ({ HERB_DIR + "handasse", HERB_DIR + "gonion", }),
		  ({ "ground", "forest", }), 3);
}

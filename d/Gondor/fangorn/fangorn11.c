...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn5", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn6", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn17", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornj", "north", test_loc, 2, 1);
    ...
    set_up_herbs( ({ SHIRE_HERB_DIR + "lianor_berry", 

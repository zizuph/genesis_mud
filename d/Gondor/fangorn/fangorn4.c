...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn9", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn10", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorng", "south", test_loc, 2, 1);

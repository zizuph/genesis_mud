...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn3", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn4", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornf", "north", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "coccinea", HERB_DIR + "seregon", }),
		  ({ "ground", "forest", }), 3);

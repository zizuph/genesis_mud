...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn18", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn19", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn25", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn26", "southeast", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "sumac", HERB_DIR + "tuo", }),
		  ({ "ground", "forest", }), 3);
}

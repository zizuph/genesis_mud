...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn21", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn34", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn30", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn31", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorny", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "suranie", HERB_DIR + "alfirin", }),
		  ({ "ground", "forest", }), 3);
}

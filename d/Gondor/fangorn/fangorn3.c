...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn8", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn9", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorne", "south", test_loc, 2, 1);

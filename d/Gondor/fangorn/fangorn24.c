...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn22", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn29", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn35", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn28", "southwest", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "attanar", HERB_DIR + "lissuin", }),
		  ({ "ground", "forest", }), 3);
}

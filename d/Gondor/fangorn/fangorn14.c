...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn8", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn20", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornp", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "curugwath", HERB_DIR + "seregon", }),
		  ({ "ground", "forest", }), 3);

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn19", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn20", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn26", "southwest", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "curugwath", HERB_DIR + "athelas", }),
		  ({ "ground", "forest", }), 3);
}

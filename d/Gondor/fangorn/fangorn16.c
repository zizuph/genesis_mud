...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn10", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn35", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn22", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornt", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "suranie", HERB_DIR + "hemlock", }),
		  ({ "ground", "forest", }), 3);
}

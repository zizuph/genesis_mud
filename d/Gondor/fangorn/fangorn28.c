...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn23", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn24", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn32", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn33", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorncc", "south", test_loc, 2, 1);

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn11", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn22", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornv", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "tyelka", HERB_DIR + "ungolestel", }),
		  ({ "ground", "forest", }), 3);
}

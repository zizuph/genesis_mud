...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn31", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn32", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornaa", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "attanar", HERB_DIR + "astaldo", }),
		  ({ "ground", "forest", }), 3);
}

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn21", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn30", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornw", "south", test_loc, 2, 1);

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn27", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn28", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornbb", "north", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "holly", HERB_DIR + "sumac", }),
		  ({ "ground", "forest", }), 3);
}

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn12", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn21", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn13", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornm", "north", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "foxglove", SHIRE_HERB_DIR + "pawnrose", }),
		  ({ "ground", "forest", }), 3);
}

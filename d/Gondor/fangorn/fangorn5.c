...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn10", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn11", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorni", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "curugwath", HERB_DIR + "hemlock", }),
		  ({ "ground", "forest", }), 3);
}

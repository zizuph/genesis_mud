...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn16", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn17", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn24", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornu", "north", 0, 0, 0);

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn4", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn5", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn15", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn16", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornh", "north", test_loc, 2, 1);

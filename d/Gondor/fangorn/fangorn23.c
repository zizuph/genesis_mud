...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn20", "northwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn35", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn28", "southeast", test_loc, 2, 1);

...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn7", "southwest", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn8", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornc", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "alfirin", HERB_DIR + "suranie", }),
		  ({ "ground", "forest", }), 3);
}

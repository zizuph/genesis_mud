...
create_area_room()
{
    ...
    add_exit(FANGORN_DIR + "fangorn7", "northeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangorn18", "southeast", test_loc, 2, 1);
    add_exit(FANGORN_DIR + "fangornl", "south", test_loc, 2, 1);
    ...
    set_up_herbs( ({ HERB_DIR + "seregon", HERB_DIR + "suranie", }),
		  ({ "ground", "forest", }), 3);
}

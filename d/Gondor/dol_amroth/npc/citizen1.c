...
#define NO_LIGHT      ({ "This should have been done by the gards.", \
                         ...
                         "The dark streets are unsafe, better make some light.", \
                         "This is tiresom." })
...
create_dunadan()
{
    ...
    set_restrain_path( ({ DOL_HILLS+"streets",DOL_TRADE+"streets",
			    DOL_TRADE+"piers",DOL_OTHER+"streets",
			    DOL_OTHER+"pier",DOL_COMMON+"streets",
			    DOL_COMMON+"piers",DOL_CRAFT+"streets",
			    DOL_CRAFT+"piers" }) );

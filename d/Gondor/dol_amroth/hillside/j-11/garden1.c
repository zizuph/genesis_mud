...
create_gondor()
{
    ...
    set_long("This is a beautiful garden, filled with bushes, flowers " +
	     ...
	     "of a small pound. From the gate to the north to the door in " +
	     "goes a paved path.\n");
    ...
    add_exit(DOL_HILLS + "streets/j-10", "north", 0, 1);
    add_exit(DOL_HILLS + "j-11/hall1", "southeast", 0, 1);

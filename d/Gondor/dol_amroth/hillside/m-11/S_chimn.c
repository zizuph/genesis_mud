...
{
    set_short("a tube");
    set_long("The solid walls of the chimney is completely covered in sooth, " +
...
last_mesg()
{
    write("You finally climbs yout of the stove.\n");
    this_player()->move_living("M", DOL_HILLS + "m-11/hall4", 1, 0);
    say(QCTNAME(this_player()) + " climbs yout of the stove.\n");
}

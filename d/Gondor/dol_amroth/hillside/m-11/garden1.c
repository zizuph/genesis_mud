...
create_gondor()
{
    ...
    set_long("This is a beautiful garden, filled with bushes, flowers " +
	     ...
	     "of a small pound. From the gate in west to the door in " +
	     "goes a paved path.\n");
    ...
    add_exit(DOL_HILLS + "streets/l-11", "west", 0, 1);
    add_exit(DOL_HILLS + "m-11/hall1", "east", 0, 1);

    o = clone_object(DOL_NPC + "m11-servant");
    o->move(DOL_HILLS + "m-11/hall1");
...
reset_room()
{
    ...
    o = clone_unique(DOL_NPC + "m11-servant", 1, 0, 1, 1);
    o->move(DOL_HILLS + "m-11/hall1");
}

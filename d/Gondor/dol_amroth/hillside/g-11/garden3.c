...
create_gondor()
{
    ...
    add_exit(DOL_HILLS + "g-11/garden2", "northeast", 0, 1);
    add_exit(DOL_HILLS + "g-11/garden4", "southeast", 0, 1);
    add_exit(DOL_HILLS + "g-11/tower1", "east", 0, &npc_block());

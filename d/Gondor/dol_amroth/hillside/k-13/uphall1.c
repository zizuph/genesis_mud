...
create_inside()
{
    ...
    add_exit(DOL_HILLS + "k-13/uphall2", "north", 0, 1);
    add_exit(DOL_HILLS + "k-13/uphall3", "east", 0, 1);
    add_exit(DOL_HILLS + "k-13/uphall4", "south", 0, 1);
    add_exit(DOL_HILLS + "k-13/uphall5", "west", 0, 1);
    add_exit(DOL_HILLS + "k-13/hall1", "down", 0, 1);
}

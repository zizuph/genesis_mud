 ...
 * joat.c
 *
 * A coat to be sold in Dol Amroth
 *
 * By Skippern 20(c)01
 */
inherit "/std/object";
...
create_object()
{
    ...
    set_adj("brown");
    add_adj("leather");
    set_short("brown leather coat");
    set_pshort("brown leather coats");
    set_long("This is a brown leather coat. It can be used both for " +
	     "everyday and party.\n");

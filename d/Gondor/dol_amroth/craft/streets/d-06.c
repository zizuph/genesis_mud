...
create_dol_amroth()
{
    ...
    add_exit(DOL_CRAFT + "streets/e-06", "east", 0, 1);
    add_exit(DOL_CRAFT + "streets/c-06", "west", 0, 1);
    set_grate("down", DOL_SEWER+"d-06");
    clone_object(DOL_OBJ + "doors/d-06-door")->move(this_object());
}

...
create_dol_amroth()
{
    ...
    set_lastline("This is the middle of the square.");
    ...
    add_exit(DOL_TRADE + "streets/q-10", "west", 0, 1);
    add_exit(DOL_TRADE + "streets/s-10", "east", 0, 1);
    add_exit(DOL_TRADE + "streets/r-09", "north", 0, 1);
    add_exit(DOL_TRADE + "streets/r-11", "south", 0, 1);
    set_grate("down", DOL_SEWER+"r-10");
}

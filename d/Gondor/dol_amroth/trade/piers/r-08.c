...
create_dol_amroth()
{
    ...
    set_lastline("A street goes south here towards the main square.");
    ...
    add_exit(DOL_TRADE + "streets/r-09", "south", 0, 1);
    add_exit(DOL_TRADE + "piers/s-08", "east", 0, 1);
    add_exit(DOL_TRADE + "piers/q-08", "west", 0, 1);
}
...
reset_room()
{
	...
	o->add_name("ship");
	o->add_name("vessel");
	o->set_dest(DOL_OTHER+"ships/deck-3");
	o->move(this_object());
    }
}

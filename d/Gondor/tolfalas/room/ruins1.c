...
create_gondor()
{
    ...
    add_exit(TOLFALAS_DIR + "room/ruins6", "south", 0, 2);
    add_exit(TOLFALAS_DIR + "room/ruins2", "east", 0, 2);
    add_exit(TOLFALAS_DIR + "room/ruins5", "southeast", 0, 2);
    add_exit(TOLFALAS_DIR + "room/ruins0", "north", 0, 2);

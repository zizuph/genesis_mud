...
create_gondor()
{
    ...
    add_exit(TOLFALAS_DIR + "room/ruins10", "south", 0, 2);
    add_exit(TOLFALAS_DIR + "room/ruins4", "north", 0, 2);
    add_exit(TOLFALAS_DIR + "room/ruins8", "west", 0, 2);
    add_exit(TOLFALAS_DIR + "room/ruins5", "northwest", 0, 2);

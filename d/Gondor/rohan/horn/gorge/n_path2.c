...
void create_helmsdeep_room()
{
    ...
    "north. Further along to the east are the gates of the keep. ");

    set_track_dir1("southeast");
    set_track_dir2("west");
    ...
    add_exit(ROH_DIR+"horn/gorge/n_path1","southeast",0);
    add_exit(ROH_DIR+"horn/gorge/n_path3","west",0);
}

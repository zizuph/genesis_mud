...
void create_helmsdeep_room()
{
    ...
    "either side of the gorge. The Deeping-wall is a short distance up "+
    "the slope. ");
    ...
    add_item("cliffs","They rise high and steep, impossible to climb.\n");

    add_exit(ROH_DIR+"horn/gorge/ofield2","north",0);
    add_exit(ROH_DIR+"horn/gorge/out_wall2","southwest",0,3);

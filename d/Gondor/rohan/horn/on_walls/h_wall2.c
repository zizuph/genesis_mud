...
void create_helmsdeep_room()
{
	...
	"the gorge goes deeper into the mountains. "+
    	"The wall runs from northwest to southeast. ");
    ...
    add_exit(ROH_DIR+"horn/on_walls/h_wall1","northwest",0);
    add_exit(ROH_DIR+"horn/on_walls/h_wall3","southeast",0);
}

...
create_dunlending()
{
    set_short("Near the foothills of the White Mountains");
    set_long("You are in a meadow, grass up to your knees. All around "
        + "you bees buzz as they fly from wildflower to wildflower. "
        + "@@extra_line@@" + "To the south, a forest of ancient pine "
        + "trees rises along with the landscape as the foothills to the "
        + "White Mountains begin. Giant granite boulders show from "
        + "beneath the pine needles in the forest.\n");

/*
 *  /d/Gondor/rohan/isengard/tunnel4.c
 *
 *  Opus, April 1997
 *
...
create_isengard()
{
	...
	"light for this area of the tunnel. To the north the inner gates "+
	"can be seen, while traveling southward will lead to "+
	"the outer gates."));
	...
	"this entire area, it is hard to believe how the floor could have "+
	...
	"Almost out of sight, the outer gates are barely visible to the "+
	"south."));
    ...
    add_exit(ISEN_DIR + "tunnel5", "north", 0);
    add_exit(ISEN_DIR + "tunnel3", "south", 0);  

...
long_extratext()
{
    ...
    + "the northwestern part of the ring wall on the third level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "nwt8.c",      "northeast");
    add_exit(WALL_TUNNEL_THREE + "nwt10.c",      "southwest");

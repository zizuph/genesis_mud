...
long_extratext()
{
    ...
    + "the southeastern part of the ring wall on the third level. A "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "set4.c",         "southwest");
    add_exit(WALL_TUNNEL_THREE + "set6.c",         "northeast");
    add_exit(WALL_FLOOR_FOUR + "se_para2.c",       "up");

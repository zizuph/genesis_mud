...
long_extratext()
{
    ...
    + "the northeastern part of the ring wall on the third level. "
    + "A narrow stone walkway leads to the northwest.\n";
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "net7.c",       "southeast");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_THREE + "net9", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_THREE + "net9", 1, 0);
    return 1;
}

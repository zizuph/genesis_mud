...
long_extratext()
{
    ...
    + "the northeastern part of the ring wall on the third level. A "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "net4.c",       "southeast");
    add_exit(WALL_TUNNEL_THREE + "net6.c",       "northwest");
    add_exit(WALL_FLOOR_FOUR + "ne_para2.c",       "up");

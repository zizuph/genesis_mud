...
long_extratext()
{
    ...
    + "A narrow stone walkway leads to the southeast.\n";
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "net3.c",       "northwest");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_THREE + "net1", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_THREE + "net1", 1, 0);
    return 1;
}

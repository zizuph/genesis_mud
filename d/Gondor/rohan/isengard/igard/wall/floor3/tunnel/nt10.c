...
long_extratext()
{
    ...
    + "the northern part of the ring wall on the third level. "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "nt11.c",      "west");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_THREE + "nt9", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_THREE + "nt9", 1, 0);
    return 1;
}

...
long_extratext()
{
    ...
    + "the southwestern part of the ring wall on the third level. A "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "swt5.c",       "northwest");
    add_exit(WALL_TUNNEL_THREE + "swt7.c",       "southeast");
    add_exit(WALL_FLOOR_FOUR + "sw_para2.c",       "up");

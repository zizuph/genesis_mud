...
long_extratext()
{
    ...
    + "the southern part of the ring wall on the third level. A wide "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "swt10.c",     "northwest");
    add_exit(WALL_TUNNEL_THREE + "st6.c",       "east");
    add_exit(WALL_TUNNEL_TWO + "st5.c",          "down");

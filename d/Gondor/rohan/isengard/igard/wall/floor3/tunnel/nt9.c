...
long_extratext()
{
    ...
    + "A narrow stone walkway leads to the west.\n";
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "nt8.c",       "east");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_THREE + "nt10", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_THREE + "nt10", 1, 0);
    return 1;
}

...
long_extratext()
{
    ...
    + "the southwestern part of the ring wall on the third level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "swt8.c",      "northwest");
    add_exit(WALL_TUNNEL_THREE + "swt10.c",      "southeast");

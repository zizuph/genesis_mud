...
long_extratext()
{
    ...
    + "the eastern part of the ring wall on the third level. A "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "et5.c",       "south");
    add_exit(WALL_TUNNEL_THREE + "et7.c",       "north");
    add_exit(WALL_FLOOR_FOUR + "e_para2.c",      "up");

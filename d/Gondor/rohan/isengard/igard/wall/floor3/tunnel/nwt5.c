...
long_extratext()
{
    ...
    + "the northwestern part of the ring wall on the third level. A "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_THREE + "nwt4.c",       "northeast");
    add_exit(WALL_TUNNEL_THREE + "nwt6.c",       "southwest");
    add_exit(WALL_FLOOR_FOUR + "nw_para2.c",       "up");

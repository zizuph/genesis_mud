/*
 *  WALL_FLOOR_ONE + "1_archroom_2a.c"
 *
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "st8.c",                 "west");
    add_exit(WALL_FLOOR_ONE  + "1_archroom_1a.c",       "north");
    add_exit(WALL_FLOOR_ONE  + "1_archroom_3a.c",       "south");

...
long_extratext()
{
    return "There are several cross-shaped slots in the west wall.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "st1.c",                "east");
    add_exit(WALL_FLOOR_ONE  + "1_archroom_1.c",       "north");
    add_exit(WALL_FLOOR_ONE  + "1_archroom_3.c",       "south");
...
scan_slot()
{
    ...
    adjoining = IGARD_WALL + "gate_tun4.c";

/*
 *  WALL_FLOOR_ONE + "1_archroom_1c.c"
 *
...
long_extratext()
{
    return "There are several cross-shaped slots in the east wall and "
...
leave_room()
{
    ...
    tell_room(WALL_TUNNEL_ONE + "nt7.c", QCTNAME(TP) + " slips silently "
        + "into the room from behind the tapestry.\n");

    TP->move_living("M", WALL_TUNNEL_ONE + "nt7.c", 1, 0);

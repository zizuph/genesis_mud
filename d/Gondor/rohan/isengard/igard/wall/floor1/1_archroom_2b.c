/*
 *  WALL_FLOOR_ONE + "1_archroom_2b.c"
 *
...
long_extratext()
{
    return "There are several cross-shaped slots in the south wall and "
...
create_gondor()
{
    ...
    add_item(({"south wall"}), "The south wall is made from rough-hewn "
...
leave_room()
{
    ...
    tell_room(WALL_TUNNEL_ONE + "et7.c", QCTNAME(TP) + " slips silently "
        + "into the room from behind the tapestry.\n");

    TP->move_living("M", WALL_TUNNEL_ONE + "et7.c", 1, 0);

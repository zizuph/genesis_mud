...
long_extratext()
{
    ...
    + "the northeastern part of the ring wall on the ground level. A "
    + "subtle breeze flows in from the southwest.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "net4.c",       "southeast");
    add_exit(WALL_TUNNEL_ONE + "net6.c",       "northwest");
    add_exit(WALL_TUNNEL_ONE + "net_gate1.c",  "southwest");

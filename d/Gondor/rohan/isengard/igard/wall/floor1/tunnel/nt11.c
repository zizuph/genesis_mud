...
long_extratext()
{
    ...
    + "the northern part of the ring wall on the ground level. A wide "
    + "stairwell on one side of the tunnel leads upward.\n";
}
...
create_gondor()
{
    ...
    add_item(({"stairwell", "stairs", "steps", "step", "stair"}), "The "
        + "wide stairwell leads up to the second level of the ring "
        + "wall.\n");
    ...
    add_exit(WALL_TUNNEL_ONE + "nt10.c",      "east");
    add_exit(WALL_TUNNEL_ONE + "nwt1.c",      "southwest");
    add_exit(WALL_TUNNEL_TWO + "nt11.c",          "up");

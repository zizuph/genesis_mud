...
long_extratext()
{
    ...
    + "the southern part of the ring wall on the ground level. A wide "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "set1.c",   "northeast");
    add_exit(WALL_TUNNEL_ONE + "st3.c",         "west");
    add_exit(WALL_TUNNEL_TWO + "st4.c",           "up");

...
long_extratext()
{
    ...
    + "the southern part of the ring wall on the ground level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "swt10.c",     "northwest");
    add_exit(WALL_TUNNEL_ONE + "st6.c",       "east");

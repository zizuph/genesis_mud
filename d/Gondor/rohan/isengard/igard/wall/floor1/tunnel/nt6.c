...
long_extratext()
{
    ...
    + "the northern part of the ring wall on the ground level. A "
    + "subtle breeze flows in from the south.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "nt5.c",       "east");
    add_exit(WALL_TUNNEL_ONE + "nt7.c",       "west");
    add_exit(WALL_TUNNEL_ONE + "nt_gate1.c",  "south");

...
long_extratext()
{
    ...
    + "the southeastern part of the ring wall on the ground level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "set1.c",       "southwest");
    add_exit(WALL_TUNNEL_ONE + "set3.c",       "northeast");

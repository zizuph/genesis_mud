...
long_extratext()
{
    ...
    + "subtle breeze flows in from the northwest.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "set4.c",       "southwest");
    add_exit(WALL_TUNNEL_ONE + "set6.c",       "northeast");
    add_exit(WALL_TUNNEL_ONE + "set_gate1.c",  "northwest");

...
long_extratext()
{
    ...
    + "the northeastern part of the ring wall on the ground level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "net6.c",       "southeast");
    add_exit(WALL_TUNNEL_ONE + "net8.c",       "northwest");

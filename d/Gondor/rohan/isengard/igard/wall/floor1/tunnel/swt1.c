...
long_extratext()
{
    ...
    + "part of the ring wall on the ground level. The tunnel ends abruptly "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "swt2.c",      "southeast");
    add_exit(WALL_TUNNEL_TWO + "swt1.c",          "up");

...
long_extratext()
{
    ...
    + "the eastern part of the ring wall on the ground level. A "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "et5.c",       "south");
    add_exit(WALL_TUNNEL_ONE + "et7.c",       "north");
    add_exit(WALL_TUNNEL_ONE + "et_gate1.c",  "west");

...
long_extratext()
{
    ...
    + "the eastern part of the ring wall on the ground level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "set9.c",      "southwest");
    add_exit(WALL_TUNNEL_ONE + "et2.c",       "north");

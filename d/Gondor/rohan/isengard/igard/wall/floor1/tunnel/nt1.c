...
long_extratext()
{
    ...
    + "the northern part of the ring wall on the ground level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "net9.c",      "southeast");
    add_exit(WALL_TUNNEL_ONE + "nt2.c",       "west");

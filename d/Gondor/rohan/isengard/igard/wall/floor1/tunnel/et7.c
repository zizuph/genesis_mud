...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "et6.c",       "south");
    add_exit(WALL_TUNNEL_ONE + "et8.c",       "north");
...
leave_room()
{
    ...
    tell_room(WALL_FLOOR_ONE + "1_archroom_2b.c", QCTNAME(TP) + " slips silently "
        + "into the room from behind the tapestry.\n");

    TP->move_living("M", WALL_FLOOR_ONE + "1_archroom_2b.c", 1, 0);

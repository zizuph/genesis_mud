...
long_extratext()
{
    ...
    + "the eastern part of the ring wall on the ground level. A wide "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "et10.c",       "south");
    add_exit(WALL_TUNNEL_ONE + "net1.c",       "northwest");
    add_exit(WALL_TUNNEL_TWO + "et11.c",          "up");

...
long_extratext()
{
    ...
    + "the southwestern part of the ring wall on the ground level. A "
    + "subtle breeze flows in from the northeast.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_ONE + "swt5.c",       "northwest");
    add_exit(WALL_TUNNEL_ONE + "swt7.c",       "southeast");
    add_exit(WALL_TUNNEL_ONE + "swt_gate1.c",  "northeast");

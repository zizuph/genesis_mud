...
create_gondor()
{
    set_short("A dead end in the southern part of the ring wall");
    ...
    add_exit(WALL_TUNNEL_TWO + "st2.c",        "east");
    add_exit(WALL_TUNNEL_TWO + "st11.c",       "west");

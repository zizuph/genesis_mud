...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "st5.c",       "west");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_TWO + "st7", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_TWO + "st7", 1, 0);
    return 1;
}

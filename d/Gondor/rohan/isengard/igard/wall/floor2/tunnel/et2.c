...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "et1.c",       "south");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_TWO + "et3", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_TWO + "et3", 1, 0);
    return 1;
}

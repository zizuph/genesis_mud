...
long_extratext()
{
    ...
    + "the eastern part of the ring wall on the second level. "
    + "A narrow stone walkway leads to the south.\n";
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "et11.c",       "north");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_TWO + "et9", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_TWO + "et9", 1, 0);
    return 1;
}

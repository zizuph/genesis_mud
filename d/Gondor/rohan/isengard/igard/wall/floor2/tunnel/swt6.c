...
long_extratext()
{
    ...
    + "the southwestern part of the ring wall on the second level.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "swt5.c",       "northwest");
    add_exit(WALL_TUNNEL_TWO + "swt7.c",       "southeast");

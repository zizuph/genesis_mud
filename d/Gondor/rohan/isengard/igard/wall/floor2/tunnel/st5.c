...
long_extratext()
{
    ...
    + "the southern part of the ring wall on the second level. A wide "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "swt10.c",     "northwest");
    add_exit(WALL_TUNNEL_TWO + "st6.c",       "east");
    add_exit(WALL_TUNNEL_THREE + "st5.c",          "up");

...
long_extratext()
{
    ...
    + "the northern part of the ring wall on the second level. "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "nt8.c",       "east");
...
move_player()
{
    ...
    tell_room(WALL_TUNNEL_TWO + "nt10", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_TUNNEL_TWO + "nt10", 1, 0);
    return 1;
}

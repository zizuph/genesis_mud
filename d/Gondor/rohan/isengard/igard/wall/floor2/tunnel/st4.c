...
long_extratext()
{
    ...
    + "the southern part of the ring wall on the second level. A "
    + "wide stairwell on one side of the tunnel leads downward.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "st3.c",        "west");
    add_exit(WALL_TUNNEL_TWO + "set1.c",       "northeast");
    add_exit(WALL_TUNNEL_ONE + "st4.c",          "down");

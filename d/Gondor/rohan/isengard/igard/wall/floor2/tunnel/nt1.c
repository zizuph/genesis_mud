...
long_extratext()
{
    ...
    + "the northern part of the ring wall on the second level. A wide "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "net9.c",      "southeast");
    add_exit(WALL_TUNNEL_TWO + "nt2.c",       "west");
    add_exit(WALL_TUNNEL_THREE + "nt1.c",          "up");

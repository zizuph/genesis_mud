...
long_extratext()
{
    ...
    + "the eastern part of the ring wall on the second level. A wide "
...
create_gondor()
{
    ...
    add_exit(WALL_TUNNEL_TWO + "set9.c",      "southwest");
    add_exit(WALL_TUNNEL_TWO + "et2.c",       "north");
    add_exit(WALL_TUNNEL_THREE + "et1.c",          "up");

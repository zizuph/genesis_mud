...
long_extratext()
{
    ...
    + "The parapet extends to the northwest and southeast, and a stairwell "
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "sw_para1.c",       "northwest");
    add_exit(WALL_FLOOR_FOUR + "sw_para3.c",       "southeast");
    add_exit(WALL_TUNNEL_THREE + "swt6.c",         "down");

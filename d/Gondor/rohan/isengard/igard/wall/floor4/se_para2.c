...
long_extratext()
{
    ...
    + "The parapet extends to the southwest and northeast, and a stairwell "
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "se_para1.c",       "southwest");
    add_exit(WALL_FLOOR_FOUR + "se_para3.c",       "northeast");
    add_exit(WALL_TUNNEL_THREE + "set5.c",         "down");

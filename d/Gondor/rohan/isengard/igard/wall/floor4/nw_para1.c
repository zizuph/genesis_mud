...
long_extratext()
{
    ...
    + "extends to the northeast, and a stairwell leads up to a higher "
    + "parapet.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "nw_para1t.c",      "up");
    add_exit(WALL_FLOOR_FOUR + "nw_para2.c",       "northeast");

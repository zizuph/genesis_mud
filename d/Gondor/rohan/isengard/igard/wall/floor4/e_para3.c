...
long_extratext()
{
    ...
    + "Misty Mountains. The parapet extends to the south, and a "
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "e_para3t.c",      "up");
    add_exit(WALL_FLOOR_FOUR + "e_para2.c",       "south");

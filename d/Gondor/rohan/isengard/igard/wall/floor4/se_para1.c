...
long_extratext()
{
    ...
    + "The parapet extends to the northeast, and a stairwell "
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "se_para1t.c",      "up");
    add_exit(WALL_FLOOR_FOUR + "se_para2.c",       "northeast");

...
long_extratext()
{
    ...
    + "the Misty Mountains rise high into the northwestern sky. The parapet "
    + "extends to the northeast and southwest, and a stairwell leads down into "
    + "the ring wall.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "nw_para1.c",       "southwest");
    add_exit(WALL_FLOOR_FOUR + "nw_para3.c",       "northeast");
    add_exit(WALL_TUNNEL_THREE + "nwt5.c",         "down");

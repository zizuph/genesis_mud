...
long_extratext()
{
    return "This section of the ring wall looks to the north, where the "
    + "Misty Mountains encircle and loom above the Wizard's Vale. A stairwell "
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "n_para1.c",      "down");

...
long_extratext()
{
    ...
    + "Mountains. The parapet extends to the southeast, and a stairwell "
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "ne_para1t.c",      "up");
    add_exit(WALL_FLOOR_FOUR + "ne_para2.c",       "southeast");

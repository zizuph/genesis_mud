...
move_player()
{
    tell_room(WALL_FLOOR_FOUR + "test_room1", QCNAME(TP) + " arrives from the "
        + "other end of the narrow stone walkway.\n");

    TP->move_living("M", WALL_FLOOR_FOUR + "test_room1", 1, 0);
    return 1;
}

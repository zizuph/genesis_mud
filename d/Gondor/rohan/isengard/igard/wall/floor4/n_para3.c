...
long_extratext()
{
    ...
    + "The parapet extends to the west, and a stairwell leads up to a "
    + "higher parapet.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "n_para3t.c",      "up");
    add_exit(WALL_FLOOR_FOUR + "n_para2.c",       "west");

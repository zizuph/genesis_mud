...
long_extratext()
{
    ...
    + "Misty Mountains. The parapet extends to the north and south, "
    + "and a stairwell leads down into the ring wall.\n";
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "e_para3.c",       "north");
    add_exit(WALL_FLOOR_FOUR + "e_para1.c",       "south");
    add_exit(WALL_TUNNEL_THREE + "et6.c",        "down");

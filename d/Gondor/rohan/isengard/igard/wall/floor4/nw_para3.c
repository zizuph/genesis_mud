...
long_extratext()
{
    ...
    + "extends to the southwest, and a stairwell leads up to a higher "
    + "parapet.\n";
}
...
create_gondor()
{
    ...
    add_exit(WALL_FLOOR_FOUR + "nw_para3t.c",      "up");
    add_exit(WALL_FLOOR_FOUR + "nw_para2.c",       "southwest");

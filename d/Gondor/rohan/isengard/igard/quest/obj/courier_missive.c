/*
 * Missive from the courier orc in the Igard quest.
 *
 * IGARD_QUEST_OBJ + "courier_missive.c"
 *
...
create_object()
{
    ...
    add_name("note");
    set_adj("small");
    add_name("_igard_courier_missive_");
    ...
    set_long("The small missive reads: \n\n\n"
        ...
        + "\tthe crescent moon waxes. Soon we shall dance upon the bones\n"

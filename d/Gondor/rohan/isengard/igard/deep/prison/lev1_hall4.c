/*
 *  IGARD_DEEP_PRISON + "lev1_hall4.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev1_hall3",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev1_hall5",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev1_cell4n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev1_cell4s",         "south");

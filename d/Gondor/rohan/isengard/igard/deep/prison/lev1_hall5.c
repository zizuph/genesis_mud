/*
 *  IGARD_DEEP_PRISON + "lev1_hall5.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev1_hall4",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev1_hall6",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev1_cell5n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev1_cell5s",         "south");

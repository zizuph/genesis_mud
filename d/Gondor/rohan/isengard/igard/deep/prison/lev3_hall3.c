/*
 *  IGARD_DEEP_PRISON + "lev3_hall3.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev3_hall2",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev3_hall4",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev3_cell3n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev3_cell3s",         "south");

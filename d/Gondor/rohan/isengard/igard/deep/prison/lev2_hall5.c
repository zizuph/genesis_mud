/*
 *  IGARD_DEEP_PRISON + "lev2_hall5.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev2_hall4",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev2_hall6",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev2_cell5n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev2_cell5s",         "south");

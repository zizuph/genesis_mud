/*
 *  IGARD_DEEP_PRISON + "lev2_hall4.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev2_hall3",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev2_hall5",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev2_cell4n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev2_cell4s",         "south");

/*
 *  IGARD_DEEP_PRISON + "lev3_hall4.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev3_hall3",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev3_hall5",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev3_cell4n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev3_cell4s",         "south");

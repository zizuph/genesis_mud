/*
 *  IGARD_DEEP_PRISON + "lev3_hall2.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev3_hall1",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev3_hall3",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev3_cell2n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev3_cell2s",         "south");

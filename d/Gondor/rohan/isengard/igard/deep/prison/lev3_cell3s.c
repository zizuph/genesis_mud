/*
 *  IGARD_DEEP_PRISON + "lev3_cell3s.c"
 *
...
static object *Quest     = allocate(1);
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev3_hall3",          "north");
...
reset_room()
{
    clone_npcs(Quest,    IGARD_NPC + "i_quest_prisoner.c",  -1.0);
    add_elf_prisoners();
    add_dwarf_prisoners();
}
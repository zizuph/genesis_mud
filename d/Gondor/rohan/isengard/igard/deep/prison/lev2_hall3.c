/*
 *  IGARD_DEEP_PRISON + "lev2_hall3.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev2_hall2",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev2_hall4",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev2_cell3n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev2_cell3s",         "south");

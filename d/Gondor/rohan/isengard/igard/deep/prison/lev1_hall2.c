/*
 *  IGARD_DEEP_PRISON + "lev1_hall2.c"
 *
...
create_gondor()
{
    ...
    add_exit(IGARD_DEEP_PRISON + "lev1_hall1",          "west");
    add_exit(IGARD_DEEP_PRISON + "lev1_hall3",          "east");

    add_exit(IGARD_DEEP_PRISON + "lev1_cell2n",         "north");
    add_exit(IGARD_DEEP_PRISON + "lev1_cell2s",         "south");

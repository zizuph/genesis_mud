 /*
  * IGARD_NPC + "igard_warg_pup.c"
  * which is modified directly from:
  *
  ...
  * - Made it a puppy, Alto, November 2001
  *
  */
...
{
    add_adj(({"small", "wolf", }));
    set_short("small wolf puppy");
    set_pshort("small wolf puppies");

    set_long(BSN("This is a small puppy, not very large, and probably "
      + "not very dangerous. He looks carefully at you with his large "
      + "brown eyes."));
...
create_creature()
{
    ...
    set_stats(({20+random(14), 15+random(10), 15+random(5), 10, 5, 15}));
    set_alignment(0);

    set_skill(SS_DEFENCE,      17);
    set_skill(SS_UNARM_COMBAT, 33);
...
special_attack(object victim)
{
    ...
    switch(hr[0])
    {
        ...
        case 5..9:
            ...
            break;
        case 10..19:
            vmsg = " and tears with "+his+" milk teeth at your "+hr[1]+".";
            wmsg = " and tears with his milk teeth at "+vhis+" "+hr[1]+".";
            break;
        case 20..34:
            vmsg = " and sinks his milk teeth into your "+hr[1]+".";
            wmsg = " and sinks his milk teeth into "+vhis+" "+hr[1]+".";
            break;
        case 35..49:
            vmsg = " and sinks his milk teeth deep into your "+hr[1]+".";
            wmsg = " and sinks his milk teeth deep into "+vhis+" "+hr[1]+".";
            break;
        case 50..59:
            vmsg = " and tears with milk teeth at your throat.";
            wmsg = " and tears with milk teeth at "+vhis+" throat.";
            break;
        case 60..79:
            vmsg = ", knocks you to the ground and tears with milk teeth "
                      + " at your throat.";
            wmsg = ", knocks "+vhim+" to the ground and tears with milk teeth "
                      + " at "+vhis+" throat.";
            break;
        case 80..99:
            vmsg = ", knocks you to the ground and and sinks "+his+" milk teeth "
                      + " deep into your throat.";
            wmsg = ", throws "+vhim+" to the ground and and sinks "+his
                      +" milk teeth deep into "+vhis+" throat.";
            break;
        default:
            vmsg = ", knocks you to the ground and and bites through your throat.";
            wmsg = ", knocks "+vhim+" to the ground and and bites through "+vhis+" throat.";
            break;
    }
    if (!strlen(wmsg))
        wmsg = vmsg;
    victim->catch_msg("The "+short()+" jumps at you with wide open "
        + " milk teeth" +vmsg+"\n");
    tell_watcher("The " +short()+" jumps at "+QTNAME(victim)+" with wide open "
        + " milk teeth" +wmsg+"\n", TO, victim);

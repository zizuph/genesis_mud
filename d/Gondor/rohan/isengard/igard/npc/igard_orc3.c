/*
 * This file is IGARD_NPC + "igard_orc3"
 *
...
long_text()
{
    ...
    case 0:
       ...
       + "to the ground. This is one of the bigger orcs you have "
       + "seen, certainly big enough to cause trouble if crossed.\n";
	      break;
    case 1:
       long_looks = CAP(LANG_ADDART(implode(query_adjs()," ")))
...
create_igard_monster()
{
    ...
    set_skill(SS_WEP_POLEARM,65 + rnd / 3);

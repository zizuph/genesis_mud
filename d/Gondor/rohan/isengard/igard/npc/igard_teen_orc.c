/*
 * This file is IGARD_NPC + "igard_teen_orc.c"
 *
...
create_igard_monster()
{
    ...
    set_skill(SS_WEP_SWORD,  35 + rnd / 3);
    set_skill(SS_WEP_CLUB,   35 + rnd / 3);
    set_skill(SS_WEP_KNIFE,  35 + rnd / 3);
    set_skill(SS_PARRY,      35 + rnd / 2);
    set_skill(SS_DEFENCE,    35 + rnd / 2);

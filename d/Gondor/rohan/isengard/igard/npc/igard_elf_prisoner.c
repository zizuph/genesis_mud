/*
 * This file is IGARD_NPC + "igard_elf_prisoner.c"
 *
...
long_text()
{
    ...
    case 0:
       ...
       + " elf who glares about with glimmering eyes. This is one of "
       + "the High Elves, not accustomed to such rude treatment.\n";
	      break;
    case 1:
       long_looks = CAP(LANG_ADDART(implode(query_adjs()," ")))
       + " elf who spends a great deal of time walking in the "
       + "corridors of memory. Although much of the history of the "
       + "elves is filled with sadness, there are few memories worse "
       + "than life in this squalid prison.\n";
	      break;
    case 2:
       long_looks = "This " + (implode(query_adjs()," "))
       + " elf looks beaten and broken. The light of Valinor no "
       + "longer radiates from the timeless and ageless face, only "
...
add_2_friends(int i)
{
    ...
    while (++n < i)
    {
        friend = clone_object(IGARD_NPC + "igard_elf_prisoner");

...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN_PATHS  + "sw_path2c.c",          "north");
    add_exit(IGARD_PLAIN_PATHS  + "sw_path2e.c",          "east");
    add_exit(IGARD_PLAIN_PATHS  + "sw_path2k.c",          "west");
...
long_desc()
{
    return "This is a small gravel path on the southwestern plain of "

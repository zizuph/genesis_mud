...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN_PATHS  + "sw_path2g.c",          "east");
    add_exit(IGARD_PLAIN_PATHS  + "sw_path2i.c",          "west");
    add_exit(IGARD_PLAIN_PATHS  + "sw_dome2.c",           "north");

/*
 *  IGARD_PLAIN_PATHS + "se_path2g.c"
 *
 *  A path on the plain of Isengard.
 *
 *  Last modified by Alto, 27 October 2001
 *
 */
...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN_PATHS  + "se_path2f.c",          "northeast");
    add_exit(IGARD_PLAIN_PATHS  + "se_path2h.c",          "northwest");
...
long_desc()
{
    return "This is a small gravel path on the southeastern plain of "

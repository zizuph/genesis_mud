...
create_gondor()
{
    ...
    add_item(({"gravel", "pebble", "pebbles", "pink pebbles"}), 
        "The pebbles on the "
        + "gravel path are a strange pink colour.\n");

    add_exit(IGARD_PLAIN_PATHS  + "se_path1g.c", "west", check_dome, 2, 0);

 ...
 *
 *  Southwestern road on the plain of Isengard.
 *
...
create_gondor()
{
    set_short("A street on the southwestern plain of Isengard");
    set_long(&long_desc());
    ...
    add_exit(IGARD_PLAIN  + "southwest_road4.c",      "southwest");
    add_exit(IGARD_PLAIN  + "southwest_road6.c",      "northeast");
    add_exit(IGARD_PLAIN_PATHS  + "sw_path2a.c",          "south");
...
long_desc()
{
    return "You are standing on a street built with great skill on the "
      + "southwestern plain of Isengard." + sky_desc() 

...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN  + "northeast_road6",  "northeast");
    add_exit(ORTHANC      + "entrance_stair",   "south");
    add_exit(IGARD_PLAIN  + "isle2",            "west");
...
long_desc()
{
    return "You stand at the very foot of the mighty tower Orthanc, which "
      ...
      + sky_desc() + " A street leads to the northeast, and a small path leads "
      + "around the isle to the west and south.\n";
}

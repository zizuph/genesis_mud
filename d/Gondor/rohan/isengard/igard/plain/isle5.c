...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN  + "southwest_road6",       "southwest");
    add_exit(IGARD_PLAIN  + "isle4",                 "north");
    add_exit(IGARD_PLAIN  + "isle6",                 "east");
...
long_desc()
{
    return "You stand at the very foot of the mighty tower Orthanc, which "
      ...
      + sky_desc() + " A street leads to the southwest, and a small path leads "
      + "around the isle to the north and west.\n";
}

/*
 *  IGARD_PLAIN + "northeast_road2.c"
 *
 *  Northeastern road on the plain of Isengard.
 *
...
create_gondor()
{
    set_short("A street on the northeastern plain of Isengard");
    set_long(&long_desc());
    ...
    add_exit(IGARD_PLAIN  + "northeast_road1.c",      "northeast");
    add_exit(IGARD_PLAIN  + "northeast_road3.c",      "southwest");
    add_exit(IGARD_PLAIN_PATHS  + "ne_path1a.c",          "south");
...
long_desc()
{
    return "You are standing on a street built with great skill on the "
      + "northeastern plain of Isengard." + sky_desc() 

...
create_gondor()
{
    set_short("A street at the foot of Orthanc");
    set_long(&long_desc());
    ...
    add_exit(IGARD_PLAIN  + "southeast_road5.c",      "southeast");
    add_exit(IGARD_PLAIN  + "isle7.c",                "northwest");

 ...
 *
 *  Southeastern road on the plain of Isengard.
 *
...
create_gondor()
{
    set_short("A street on the southeastern plain of Isengard");
    set_long(&long_desc());
    ...
    add_exit(IGARD_PLAIN  + "southeast_road2.c",      "southeast");
    add_exit(IGARD_PLAIN  + "southeast_road4.c",      "northwest");
    add_exit(IGARD_PLAIN_PATHS  + "se_path2a.c",      "northeast");
...
long_desc()
{
    return "You are standing on a street built with great skill on the "
      + "southeastern plain of Isengard." + sky_desc() 

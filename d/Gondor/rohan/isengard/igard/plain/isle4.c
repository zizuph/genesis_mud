...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN  + "west_road10",      "west");
    add_exit(IGARD_PLAIN  + "isle3",            "north");
    add_exit(IGARD_PLAIN  + "isle5",            "south");
...
long_desc()
{
    return "You stand at the very foot of the mighty tower Orthanc, which "
      ...
      + sky_desc() + " A street leads to the west, and a small path leads "
      + "around the isle to the north and south.\n";
}

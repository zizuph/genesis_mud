...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN  + "southeast_road6",      "southeast");
    add_exit(IGARD_PLAIN  + "isle6",                 "west");
    add_exit(ORTHANC      + "entrance_stair",        "north");
...
long_desc()
{
    return "You stand at the very foot of the mighty tower Orthanc, which "
      ...
      + sky_desc() + " A street leads to the southeast, and a small path leads "
      + "around the isle to the west and north.\n";
}

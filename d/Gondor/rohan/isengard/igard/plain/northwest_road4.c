...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN  + "northwest_road3.c",       "northwest");
    add_exit(IGARD_PLAIN  + "northwest_road5.c",       "southeast");
    add_exit(IGARD_PLAIN_PATHS  + "nw_path2a.c",       "west");

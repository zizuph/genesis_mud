...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN  + "northwest_road6",  "northwest");
    add_exit(IGARD_PLAIN  + "isle2",            "east");
    add_exit(IGARD_PLAIN  + "isle4",            "south");
...
long_desc()
{
    return "You stand at the very foot of the mighty tower Orthanc, which "
      ...
      + sky_desc() + " A street leads to the northwest, and a small path leads "
      + "around the isle to the east and south.\n";
}

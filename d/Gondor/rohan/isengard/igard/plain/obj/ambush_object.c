/*
 * This file is IGARD_PLAIN_OBJ + "ambush_object.c"
 *
 * Yes, I know it is strange to use the standard monster,
 * but it does what I need. Until a better solution presents
 * itself, this will suffice.
 *
...
create_monster()
{
    set_short("_trap_object_");
    set_name("_trap_object_");

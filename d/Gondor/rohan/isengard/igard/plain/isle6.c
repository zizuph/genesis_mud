...
create_gondor()
{
    ...
    add_exit(IGARD_PLAIN  + "south_road10",          "south");
    add_exit(IGARD_PLAIN  + "isle5",                 "west");
    add_exit(IGARD_PLAIN  + "isle7",                 "east");
...
long_desc()
{
    return "You stand at the very foot of the mighty tower Orthanc, which "
      ...
      + sky_desc() + " A street leads to the south, and a small path leads "

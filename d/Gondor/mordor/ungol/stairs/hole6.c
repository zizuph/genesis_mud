/*
 * /d/Gondor/mordor/ungol/stairs/hole6.c
 *
...
create_hole()
{
    ...
    set_long(BSN("This is a crevice between two great piers of rock. " +
        ...
        "continues further into the rocks to the southwest. "));
    ...
    add_exit(STAIRS_DIR + "ravine3", "south",     0, 1);
    add_exit(STAIRS_DIR + "hole7",   "southwest", 0, 1);
}

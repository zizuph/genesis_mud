/*
 * /d/Gondor/mordor/ungol/stairs/hole4.c
 *
...
create_hole()
{
    ...
    set_long(BSN("This is a crevice between two great piers of rock. " +
        ...
        "To the north a narrow ravine is visible through a crack, " +
        "while the crevice runs from northwest to southeast. "));
    ...
    add_exit(STAIRS_DIR + "ravine2", "north",     0, 1);
    add_exit(STAIRS_DIR + "hole5",   "southeast", 0, 1);
    add_exit(STAIRS_DIR + "hole3",   "northwest", 0, 1);
}

/*
 * /d/Gondor/mordor/ungol/stairs/hole3.c
 *
...
create_hole()
{
    ...
    set_long(BSN("This is a crevice between two great piers of rock. " +
        ...
        "To the north a narrow ravine is visible, while the crevice " +
        "continues further into the rocks to the southeast. "));
    ...
    add_exit(STAIRS_DIR + "ravine1", "northwest", 0, 1);
    add_exit(STAIRS_DIR + "hole4",   "southeast", 0, 1);
}

/*
 * /d/Gondor/mordor/ungol/tower/stairs3.c
 *
 * This is the third level of the tower of Cirith Ungol. It isn't very
...
create_room()
{
    ...
    set_name("Ungol tower, third floor");
    add_name( ({ "room", "passage" }) );

    set_short("The tower at Cirith ungol at the third floor in the staircase");
    set_long(BSN("You are at the third floor in the tower at Cirtih Ungol. " +
    ...
    add_exit(CIRITH_DIR + "winding2", "northeast", "@@walk_northeast", 2);
    add_exit(CIRITH_DIR + "winding3", "northwest", "@@walk_northwest", 2);

...
#define MOVING_FLOOR_NUMBER 29067
#define MOVING_FLOOR_HINTS  ({ })

#define BALANCE_RWB_GROUP   4
#define BALANCE_RWB_BIT     4
#define BALANCE_RWB_EXP     0
#define BALANCE_RWB_NAME    "CIRITH UNGOL RWB BALANCE"
#define BALANCE_RWB_NUMBER  10253
#define BALANCE_RWB_HINTS   ({ })
...
#define BALANCE_MONO_NUMBER 39861

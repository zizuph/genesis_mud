/*
 * /d/Gondor/mordor/ungol/tower/east12.c
 *
...
create_room()
{
    ...
    set_long(BSN("You are at the first floor in the tower at Cirtih Ungol. " +
        ...
        "angle of the tower. To the west and east are exits leading to and " +
        "from this hallway."));

    add_exit(CIRITH_DIR + "east15",   "east");
    add_exit(CIRITH_DIR + "centre12", "west");
}

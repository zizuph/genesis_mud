/*
 * /d/Gondor/mordor/ungol/tower/winding2.c
 *
...
#define HIGHER_ROOM CIRITH_DIR + "stairs3"
#define LOWER_ROOM  CIRITH_DIR + "stairs2"
...
create_room()
{
    ...
    set_short("Tower at Cirith ungol on the stairs between the second and " +
        "and third floor");
    set_long(BSN("You are in the staircase between the second floor and the " +
        "the third floor of the tower at Cirith Ungol. It is dimly lit by " +
        "torches that flare in on the floors. The stairs continue up to the " +
        "southwest and if you go southeast you go down."));
...
walk_southeast()
{
    write(BSN("Walking southeast, you descend the stairs to the second " +
        "floor."));
...
walk_southwest()
{
    write(BSN("Walking southwest, you climb the stairs to the third floor."));

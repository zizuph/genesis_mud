/*
 * /d/Gondor/mordor/ungol/tower/east05.c
 *
...
create_room()
{
    make_torch();    /* to prevent addition of add_item torch */
    ...
    set_long(BSN("You are at ground level in the tower at Cirith Ungol. " +
        "This room is probably hewn out of the rocks of the mountain. You " +
        ...
        "for questioning or punishment. The hall continues to the west and " +
        "to the south you see something that looks like a guards quarters."));
    ...
    add_item( ({ "cell", "cells", "prison", "prisons" }),
        ...
        "west this hall continues with more cells."));
    add_item( ({ "hole", "holes", "spy-hole", "spy-holes", "spy hole",
        ...
        "your head for the hole, you block the little light in this dark " +
        "passage."));

    make_door(CIRITH_DIR + "east03", "north", 2);

    add_exit(CIRITH_DIR + "east01", "west");
    add_exit(CIRITH_DIR + "east05", "south");

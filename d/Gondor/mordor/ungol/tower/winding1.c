/*
 * /d/Gondor/mordor/ungol/tower/winding1.c
 *
...
#define HIGHER_ROOM CIRITH_DIR + "stairs2"
#define LOWER_ROOM  CIRITH_DIR + "stairs1"
...
create_room()
{
    ...
    set_short("Tower at Cirith ungol on the stairs between the first and " +
        "second floor");
    set_long(BSN("You are in the staircase between the first and the " +
        "second floor of the tower at Cirith Ungol. It is dimly lit by " +
...
walk_southeast()
{
    write(BSN("Walking southeast, you descend the stairs to the first " +
        "floor."));
...
walk_southwest()
{
    write(BSN("Walking southwest, you climb the stairs to the second floor."));

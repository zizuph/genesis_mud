/*
 * /d/Gondor/mordor/ungol/tower/winding3.c
 *
...
#define HIGHER_ROOM CIRITH_DIR + "stairs4"
#define LOWER_ROOM  CIRITH_DIR + "stairs3"
...
create_room()
{
    ...
    set_short("Tower at Cirith ungol on the stairs between the third and " +
        "fourth floor");
    set_long(BSN("You are in the staircase between the third floor and the " +
        "the fourth floor of the tower at Cirith Ungol. It is dimly lit by " +
...
walk_southeast()
{
    write(BSN("Walking southeast, you descend the stairs to the third " +
        "floor."));
...
walk_southwest()
{
    write(BSN("Walking southwest, you climb the stairs to the fourth floor."));

/*
 * /d/Gondor/mordor/ungol/tower/east07.c
 *
...
create_room()
{
    ...
    set_long(BSN("You are at ground level in the tower at Cirith Ungol. " +
        ...
        "guard the prisons north of here. Some torches shed a little " +
        "light. The quarters extend to the north and west. There are a few " +
        "bunks here and you can see a table and some chairs. Against the " +
        "walls you see some closets."));
    ...
    add_item( ({ "hall", "hallway", "passage", "prison", "prisons",
        ...
        BSN("The prison is north of here. You cannot see them from here."));
    ...
    add_exit(TOWER_DIR + "east06", "north");
    add_exit(TOWER_DIR + "east03", "west");

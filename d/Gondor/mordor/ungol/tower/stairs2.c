/*
 * /d/Gondor/mordor/ungol/tower/stairs2.c
 *
 * This is the second level of the tower of Cirith Ungol. It isn't very
...
create_room()
{
    make_torch();    /* to forget about the add_item torch */
    make_the_room(); /* including several add_items :-)    */

    set_name("Ungol tower, first floor");
    add_name( ({ "room", "passage" }) );

    set_short("The tower at Cirith ungol at the second floor in the " +
        "staircase");
    set_long(BSN("You are at the second floor in the tower at Cirtih Ungol. " +
        ...
        "In the dimly lit hall, you see two dark openings to the north and " +
    ...
    add_exit(CIRITH_DIR + "winding1", "northeast", "@@walk_northeast", 2);
    add_exit(CIRITH_DIR + "winding2", "northwest", "@@walk_northwest", 2);

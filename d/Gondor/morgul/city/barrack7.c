...
create_morgul_room()
{
  ...
  add_item(({"floor","rags","furniture"}), BSN(
    ...
    "long ago, and no broken beyond repair. "));
  ...
  add_exit(MORGUL_DIR + "city/barrstr4","east","@@check_exit",1);
  add_exit(MORGUL_DIR + "city/rooms/b7up","up","@@stairs",1);
...
reset_room()
{
    set_alarm(20.0 + rnd() * 20.0, 0.0, &clone_npcs(orcs, MORGUL_DIR + "npc/ithil_orc", 60.0));

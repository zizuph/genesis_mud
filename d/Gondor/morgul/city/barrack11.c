...
create_morgul_room()
{
    ...
    "to the first floor of the house. A door is leading out onto " +
    "the street to the west. All the windows are all closed with shutters.");
  ...
  clone_object(MORGUL_DIR+"city/doors/b11doorin")->move(TO);

  add_exit(MORGUL_DIR + "city/darkstr5","west","@@check_exit",1);
  add_exit(MORGUL_DIR + "city/rooms/b11up","up","@@stairs",1);

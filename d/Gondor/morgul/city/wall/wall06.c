...
create_morgul_room()
{
    set_extraline("You are north of the great Mordor Gate. " +
  ...
  set_side("east");
    ...
    add_tower();
    add_view_east();
  add_exit(MORGUL_DIR + "city/wall/wall05","north","@@check_exit",1);
  add_exit(MORGUL_DIR + "city/wall/wall07","south","@@check_exit",1);
}

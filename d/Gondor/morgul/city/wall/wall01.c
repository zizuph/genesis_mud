...
create_morgul_room()
{
    set_extraline("This is the eastern part of the great Morgul Gate. " +
        "To the north, you can see the dark vale of the Morgulduin and " +
        "the steep cliffs of the mountains rising behind it. Looking down " +
        "into the city to the south you see the great tower of Minas Morgul " +
        "dominating the view. There is a flight of stairs here leading down " +
    ...
    add_view_north();
    add_stairs_down();
    add_exit(MORGUL_DIR + "city/wall/wall02","east","@@check_exit",1);
    add_exit(MORGUL_DIR + "city/wall/wall20","west","@@check_exit",1);

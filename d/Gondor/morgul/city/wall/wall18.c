...
create_morgul_room()
{
    ...
    "the northwestern corner of the city wall. The wall continues " +
    ...
    add_exit(MORGUL_DIR + "city/wall/wall19","north","@@check_exit",1);
    add_exit(MORGUL_DIR + "city/wall/wall17","south","@@check_exit",1);
}

 ...
 *                               Tricky, dec 1991
 *  moved delivery office to Thornlin so it's in a neutral area
 *                               Finwe, Nov 2005
 */
#pragma strict_types
...
discriminate()
{
    ...
    {
        /* 97 is the lowest possible without making the
           buying price lower than the selling price in
           the best possible circumstances. */
        case -1: bargain = (bargain *  97) / 100; break;
        case  0: break;

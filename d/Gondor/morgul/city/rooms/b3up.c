...
create_morgul_room()
{
  ...
  add_item(({"street","window","windows"}), 
    "@@exa_window|"+
    "Through the window you can look out onto the northern end of Dark Street and " +
    "another building like this one just across the street. |"+
    MORGUL_DIR+"city/darkstr5@@");

    set_road(5);
    set_side("east");

    add_exit(MORGUL_DIR + "city/barrack3", "down",

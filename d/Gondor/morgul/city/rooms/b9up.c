...
create_morgul_room()
{
	...
	"to the ground floor, while a doorway is leading into a back room.");
	...
	"Barracks Street which runs from north to south at the foot of " +
	"the city wall just outside the building.", 
	MORGUL_DIR + "city/barrstr2"));
    set_road(5);
    set_side("east");
    add_prop(ROOM_I_LIGHT,1);

    add_exit(MORGUL_DIR + "city/rooms/b9upback", "west", block_npc, 1);
    add_exit(MORGUL_DIR + "city/barrack9",       "down",

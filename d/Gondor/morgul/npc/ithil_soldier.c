...
create_ithil_monster()
{
    ...
    set_base_stat(SS_INT, 50 + rnd);
    set_base_stat(SS_WIS, 50 + rnd);
    ...
    add_cact("@@emote_enemy|glare"); 
    add_cact("@@emote_enemy|knee"); 
    add_cact("@@say_enemy|We will feast on your rotting corpse, stinking |"); 
    add_cact("@@say_enemy|How did a cursed | manage to sneak into the town?");

/*
 * A npc member of the Houses of the Dunedain
 *
 * Olorin, 14-nov-1994
 */
#pragma save_binary
...
int     set_dunedain_house(string str);

/* Global variables */
string  Dunedain_House;
...
{
    return "of the House of " + query_dunedain_house();
}
 ...
 *                and by call to equip_me with a dunadan soul.
...
arm_me(int mt_equip = 1)
{
    ...
    wep->move(TO);
    command("wield all");
    arm = clone_object(MORGUL_DIR + "obj/mmarmour");
    arm->set_armtype(0);

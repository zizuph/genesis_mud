...
{
    set_living_name("bolzog");
    set_name("bolzog");
    add_name(({"shopkeeper","owner","shopowner",}));
    set_race_name("orc");
    set_adj(({"filthy","dark-skinned"}));
    set_long(BSN(
    "This is Bolzog the shopkeeper, who runs the General Store in Minas Morgul. "+
    ...
    add_chat("Me Bolzog, you what?");
    add_chat("You got anything nice to sell?");

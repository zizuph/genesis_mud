...
create_area_room()
{
    ...
    add_item(({"stream","river","morgulduin", "water", }), BSN(
        "The black fuming water of the stream radiates a foul smell almost "
    ...
    add_exit(MORGUL_DIR +"road/mrd3","west", stop_escape);

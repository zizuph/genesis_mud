...
describe() 
{
    ...
    string  time = clock->query_time_of_day(),
            ...
            long_desc = "You are in a dark valley, crossing the dark slopes of Ephel Duath " +
            "towards the Black land. ";
...
add_barrack_street(string extra = 0)
{
    ...
    add_item(({"gutter","water","garbage","rivulet","puddle"}), 
    ...
    add_item("cobblestones",
        "They are rounded stones set into the ground. They are dark and " +
        "smooth from constant traffic. Some of the stones look like skulls, " +
        "most likely those of conquered enemies.\n");
}

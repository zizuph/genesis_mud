...
create_armour() 
{
  ...
  set_pshort("black robes");
  set_long(BSN(
    "This is a black robe with a wide hood, dark like the night, " +
    "made from heavy cloth. It is the standard issue for the officers " +
    "in armies of the Lord of Morgul. On the hood is the " +
    "grey picture of the Moon disfigured with a ghastly face " +
    "of death."));
  set_default_armour(8,A_ROBE,0,0);
  add_prop(OBJ_I_VALUE,F_VALUE_ARMOUR(8)+random(400)+100);

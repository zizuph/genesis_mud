/*
  A path south of the Silverlode near the Anduin.
*/
...
create_gondor()
{
    ...
    add_exit(AND_PATH + "ap48", "north", 0, 3, 0);
    add_exit(AND_PATH + "ap46", "south", 0, 3, 0);
}
...
long_desc()
{
    return "On a well-trodden path across a field near the river "
        ...
        + "to the northwest, a forest of tall trees stands on "

...
create_gondor()
{
    ...
    add_exit(AND_PATH + "ap13", "northwest", 0, 15, 0);
    add_exit(AND_PATH + "ap11", "southeast", 0, 15, 0);
}
...
long_desc()
{
    return "On a well-trodden path across Nindalf near the river Anduin."
        ...
        + "the river to the west. It is hard to tell where the path "
        + "path begings and the swamp ends.\n"; 
}

...
create_room()
{
    ...
    set_long("You are at the southernmost end of a " +
        "short, elevated walkway in the northern parts " +
        "of the ruins of "+CASTLE_NAME+". The stone " +
        "walkway heads " +
        "north from here, and a staircase descends " +
        "through an opening in the ground by your " +
        "feet. To the south, you see nothing but " +
    ...
    add_exit(RUIN + "nwalk3", "north");
    add_exit(RUIN + "nwalk1", "down");
}

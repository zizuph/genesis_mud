...
create_room()
{
    ...
    set_long("You are in a wide hallway, through the heart " +
        ...
        "dominates these ruins. The hall itself runs east and west, " +
        "but a small corridor with an arched entrance leads " +
        "away northwards in the north wall.\n\n");
    ...
    add_exit(RUIN + "hall-nwalk", "north");
    add_exit(RUIN + "main_hall_3", "east");
    add_exit(RUIN + "main_hall_1", "west");
}

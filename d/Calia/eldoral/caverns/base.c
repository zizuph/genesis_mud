 ...
 *
 * Revision history:
 * 20/2/99  Limit on "nasty" cloning added by Uhclem 
 * 14/2/99  Typos fixed  Maniac
 * 02/9/10  More typos  Lavellan
 */
#pragma strict_types
...
reset_nasties(int count)
{
  ...
  /* Only add a 'nasty' 50% of the time. */
      ...
      /*  Inventory test added by Uhclem.  When the game moved  */
      /*  to the larger machine and uptimes went from hours to  */
      /*  days, rooms began to fill up with "nasties."          */
      /*  This test limits them; they move, so rooms can still  */
      /*  get crowded on occasion.                              */

    if (!random(count) && sizeof(filter(all_inventory(TO), living)) < 5)
    {
    ...
    switch(mode)
    {
        ...
        case 1:
            ...
            add_item(({"ceiling", "roof"}),
                ...
                "enough to alleviate the nagging concern of its " +
                "stability.\n");
        ...
        case 2:
            ...
            main += "You've entered a respectable sized cavern " +
                ...
                "formation judging from the rough unevenness in the " +
                "surfaces of the room. It's a refreshing change from " +
        ...
        case 4:
            ...
            main += "You have entered a huge chamber, initially you " +
                ...
                "angles much too sharp to have formed by the " +
                "results of wind and water. It appears to have been " +
                "here for ages, but this room was definitely " +
      ...
      /* Case 1 - a narrow tunnel. */
        case 1:
            ...
            add_item(({"ground", "floor"}),
                ...
                "waterworn stone that is now covered in a loose " +
      ...
      /* Case 3 - a wide tunnel. */
        case 3:
            ...
            main += "You are in a wide tunnel through the stone " +
                ...
                "it feels much like walking down a manmade " +
 ...
 *                its inventory. Used here to watch for player
 *                corpses.
...
reincarnate_corpse(object ob)
{
    ...
    if (!strlen(name) || !find_player(name))
        return;

...
join(string str)
{
    ...
    RECRUITER_CODE->rem_acc(rn); 

    // following line no longer appropriate after trainees added 
    // RECRUITER_CODE->rem_app(rn); 

...
create_room()
{
    set_short("Walking in a boiling river");
    set_long("The boiling river continues to flow here to the "+
        ...
        "burn you.  The cavern continues north and south.\n");
#include "river.h"

    add_exit(CAVE+"room50","north","@@water_walk");
    add_exit(CAVE+"room48","south","@@water_walk");

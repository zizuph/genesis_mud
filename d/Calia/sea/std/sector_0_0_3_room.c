...
/*
    Inherited room used in northeast sector of the third level of the
    calian sea area (sector_0_0_3). 

    Detailed by Khail, 23/2/96
    Modified by Maniac, 25/5/96
...
make_the_room(string extra_long, int x, int y, int z)
{
    ...
    switch (x)
    {
        case 5 :  
            ...
            add_item(({"seabed", "bottom", "sea bed" }),

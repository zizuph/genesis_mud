/*
    Inherited room used in northeast sea bed sector of the calian sea area
    (sector_0_0_4). 
...
| sb sb  u               | 0 
| sb sb  u               |  
| sb sb  u               |      c - currents barrier
| sb sb  u               |      u - rising sea bed
| sb sb  u               |      sb - sea bed
| sb sb  u               |      sf - ship wreck just visible 
| sb sb  u               |     
| sb sb  u               | 7    
|------------------------|
...
make_the_room(string extra_long, int x, int y, int z)
{
    ...
    switch (x)
    {
        ...
        case 7 :
            ...
            add_item(({ "bottom", "sea bed", "seabed", "ground" }), 

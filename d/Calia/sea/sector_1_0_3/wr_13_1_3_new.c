...
create_water_room()
{
    ...
    add_item(({"eye","eyes","rocks","ruby coloured rocks",
        "giant ruby coloured rocks"}),"These giant ruby coloured "+
            ...
            switch (ran_riddle)
            {
                case 0:               // Dolphin Eye
                    write("I swim through the oceans with "+
                        "speed and grace,\nso fast I am, "+
                        "other fish find it hard to keep "+
                ...
                case 3:                // Demon Toad Legs
                    ...
                    break;
                default:               // Shark Eye
                    write("For guidance do I use this thing "+
                        "that you seek,\nI am certainly not "+
                        "what you would call weak.\nLarge and "+
                        "grey and swimming in the sea,\neveryone "+
...
feed_gate(string str)
{
    ...
    NF("Feed what to the gates? <feed <item> to the gates>\n");

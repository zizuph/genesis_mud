 ...
 /*    A swimming mermaid for the water area

    coder(s):    Jaacar

 * Modifications
 *   October 1, 2009 - Fixed runtime with special attack, Petros
 */

...
create_creature()
{
	set_name("flipper");
    add_name("dolphin");
	set_short("large grey dolphin");
	set_adj("large");
	add_adj("grey");
    set_race_name("dolphin");
    set_long("This dolphin is light grey in colour, except for "+
        "a patch of white down its underside. It is about eight feet in "+
        "length. It appears to be a peaceful creature, but looks "+
        "like it could hold its own in a battle.\n");

    add_leftover(SEA_LEFTOVERS+"dolphin_meat","dolphin meat",(random(4)+1), 0, 0, 1);
    add_leftover(SEA_LEFTOVERS+"dolphin_flipper","dolphin flipper",(random(1)+1), 0, 0, 1);
add_leftover(SEA_LEFTOVERS+"dolphin_eye","dolphin eyeball",(random(1)+1), 0, 0, 1);
add_leftover(SEA_LEFTOVERS+"dolphin_beak","dolphin beak", 1, 0, 0, 1);
add_leftover(SEA_LEFTOVERS+"dolphin_fin","dolphin fin", 1, 0, 0, 1);
...
special_attack(object enemy)
{
    ...
    switch(hitresult[0])
    {
        ...
        case 0..4:
        {
            how1 = my_name + " brushes you with its tail "+
                "lightly!\n";
            how2 = my_name + " brushes " + his_name + " with its "+
                "tail lightly!\n";
            break;
        }
        case 5..9:
        {
            how1 = my_name + " bashes you with its tail "+
                "hard!\n";
            how2 = my_name + " bashes " + his_name + " with its "+
                "tail hard!\n";
            break;
        }
        case 10..14:
        ...
        case 15..19:
        {
            how1 = my_name + " head-butts you hard, "+
                "stunning you momentarily!\n";
            how2 = my_name + " head-butts " + his_name +
                " hard!\n";
            enemy->add_attack_delay(5);
            break;
        }
        case 20..29:
        {
            how1 = my_name + " head-butts you very hard, "+
                "stunning you momentarily!\n";
            how2 = my_name + " head-butts " + his_name + " very "+
                "hard!\n";
        ...
        case 30..39:
        {
            how1 = my_name + " torpedoes you with great force!\n";
            how2 = my_name + " torpedoes " + his_name + " with great "+
                "force!\n";
            break;
        }
        default:
        {
            how1 = my_name + " torpedoes you with brute force, knocking "+
                "everything from your hands!\n";
            how2 = my_name + " torpedoes " + his_name + " with brute "+
                "force!\n";
            enemy->command("$drop weapons");
        }
    }

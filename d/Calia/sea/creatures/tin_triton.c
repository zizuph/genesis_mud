 ...
 /*    A Triton for the Thalassian City bridge guard house
...
create_triton()
{
    ...
    set_base_stat(SS_INT, (65+random(30)));
    set_base_stat(SS_WIS, (65+random(30)));
    set_base_stat(SS_DIS, (65+random(30)));
    set_base_stat(SS_STR, (65+random(30)));
    set_base_stat(SS_DEX, (65+random(30)));
    set_base_stat(SS_CON, (65+random(30)));

 ...
 /*    A Triton for the Thalassian City outer guard house

    coder(s):    Digit

    history:    21.7.95    header added          Digit
                07.7.03    randomized stats      Jaacar
                           added more actions
...
equip_me()
{
    ...
    this = THIS;
    seteuid(getuid(this));
    clone_object("/d/Calia/sea/weapons/br_trident")->move(this);
    command("wield trident");
    clone_object("/d/Calia/sea/armours/thalmail")->move(this);
    command("wear all");
    MONEY_MAKE_GC((random(4)))->move(this_object());
    if (random(10))
    {
...
create_triton()
{
    ...
    set_base_stat(SS_INT, (50+random(30)));
    set_base_stat(SS_WIS, (50+random(30)));
    set_base_stat(SS_DIS, (50+random(30)));
    set_base_stat(SS_STR, (50+random(30)));
    set_base_stat(SS_DEX, (50+random(30)));
    set_base_stat(SS_CON, (50+random(30)));

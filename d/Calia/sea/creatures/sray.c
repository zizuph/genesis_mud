...
create_creature()
{
    ...
    add_name("stingray");
    add_name("ray");
    set_short("large grey stingray");
    set_adj("large");
    add_adj("grey");
    set_race_name("stingray");
    set_long("This creature is very graceful while moving, "+
        "almost appearing as if it is flying through the "+
        "water. It is light grey in colour with yellow eyes "+
        "and bright blue spots on its body. Its wingspan is "+
        "almost six feet and has a very long barbed tail. It "+
        "doesn't seem to notice you are even here. Perhaps it is "+
        "best that it stays that way as those barbs on its tail "+
        "appear to be very sharp and could be painful.\n");

    add_leftover(SEA_LEFTOVERS+"sray_eye","stingray eyeball", 2, 0, 0, 1);
    add_leftover(SEA_LEFTOVERS+"sray_meat","stingray meat", (random(2)+1), 0, 0, 1);
	...
	set_attack_unarmed(A_TAIL,15,25,W_IMPALE,80,"tail");
    set_attack_unarmed(A_FIN,25,65,W_SLASH, 20,"fin");
    ...
    add_act("emote searches the sea bottom for mollusks.");
...
special_attack(object enemy)
{
    ...
    switch(hitresult[0])
    {
        case -1:
        {
            how1 = my_name+" attempts to hit you with its tail but misses.\n";
            how2 = my_name+" attempts to hit "+his_name+" with its tail "+
                "but misses.\n";
            break;
        }
        case 0..4:
        {
            how1 = my_name + " attempts to hit your legs with its fins, "+
        ...
        case 5..9:
        {
            how1 = my_name + " hits your legs with its fins, "+
        ...
        case 15..19:
        {
            how1 = my_name + " hits you with its tail, cutting "+
        ...
        default:
        {
            how1 = my_name + " slashes you viciously with its "+
                "tail, driving one of its tail barbs into your "+
                "leg.  Your leg suddenly feels numb.  You realize "+
                "the barbs are poisonous!\n";
            how2 = my_name + " slashes " + his_name + "'s "+
                "legs, driving one of the barbs into it!\n";
            ...
            if(poison)
            {
                ...
                poison->set_damage(({POISON_FATIGUE,40,POISON_HP,175}));
                poison->start_poison();
            }

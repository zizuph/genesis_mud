 ...
 /*    A Triton for the Thalassian City Royal Palace guard house
...
equip_me()
{
    ...
    command("wear all");
    MONEY_MAKE_GC((random(10)))->move(this);
    gem=RANDOM_GEM_BY_RARITY(GEM_EXTREMELY_RARE);
    gem->move(this);
}
...
create_triton()
{
    ...
    set_base_stat(SS_INT, (120+random(30)));
    set_base_stat(SS_WIS, (120+random(30)));
    set_base_stat(SS_DIS, (120+random(30)));
    set_base_stat(SS_STR, (130+random(30)));
    set_base_stat(SS_DEX, (130+random(30)));
    set_base_stat(SS_CON, (130+random(30)));
    ...
    set_act_time(5);
    add_act("emote bubbles: Don't even think about causing trouble here.");
    add_act("emote twirls his trident around skillfully.");
    add_act("emote bubbles: We must protect the King!");
    add_act("emote bubbles: We are the toughest guards in the entire city.");

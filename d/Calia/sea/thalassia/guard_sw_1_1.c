...
create_water_room()
{
    ...
    add_item(({"upstairs","second floor"}),"You cannot make "+
        "any details out about the second floor.\n");
    ...
    add_swim_exit(THAL+"guard_sw_1_3","north",0,1);
    add_swim_exit(THAL+"guard_sw_1_2","west",0,1);
    add_swim_exit(THAL+"obelisk","east",0,1);
    this = THIS;

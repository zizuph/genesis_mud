...
exa_below()
{
    ...
    if (sizeof(below_live_objects))
        results = "At the obelisk below you see "+
        COMPOSITE_ALL_LIVE(below_live_objects)+".";
    else results = "You do not see anyone at the obelisk below.";

    return "Far below you see the obelisk on the road leading "+
        "into Thalassia.\n" + 
        results + "\n";
}

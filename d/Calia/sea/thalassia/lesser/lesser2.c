...
create_water_room()
{
    ...
    set_long("You are swimming around in the Lesser Zone of "+
        ...
        "the west, south and southeast. To the east you see the "+
    ...
    add_item("grove","The grove seems absolutely beautiful, "+
        ...
        "see. Perhaps you could head to the east and take a "+
        "better look?\n");
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the west, south and southeast.\n");

    add_swim_exit(THALL+"lesser7","west",0,1);
    add_swim_exit(GROVE+"grove1","east",0,1);
    add_swim_exit(THALL+"lesser1","south",0,1);
    add_swim_exit(THALL+"lesser3","southeast",0,1);
}

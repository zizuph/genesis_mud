...
create_water_room()
{
    ...
    set_long("You are swimming around in the Lesser Zone of "+
        ...
        "the northwest, north, northeast and east. Surrounding "+
    ...
    add_swim_exit(THALL+"lesser2","north",0,1);
    add_swim_exit(THALL+"lesser7","northwest",0,1);
    add_swim_exit(GROVE+"grove1","northeast",0,1);
    add_swim_exit(THALL+"lesser3","east",0,1);
}

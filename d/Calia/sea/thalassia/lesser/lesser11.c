...
create_water_room()
{
    ...
    set_long("You are swimming around in the Lesser Zone of "+
        ...
        "the northwest, west and south. To the north you see the "+
    ...
    add_item("grove","The grove seems absolutely beautiful, "+
        ...
        "see. Perhaps you could head to the north and take a "+
        "better look?\n");
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northwest, west and south.\n");

    add_swim_exit(GROVE+"grove5","north",0,1);
    add_swim_exit(THALL+"lesser12","northwest",0,1);
    add_swim_exit(THALL+"lesser10","west",0,1);
    add_swim_exit(THALL+"lesser9","south",0,1);
}

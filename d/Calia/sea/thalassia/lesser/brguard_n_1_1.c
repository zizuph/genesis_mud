...
create_water_room()
{
    ...
    add_item("road","The road travels north into the Major "+
        "Zone of the city and south into the Lesser Zone.\n");
    ...
    add_swim_exit(THALM+"major29","north",0,1);
    add_swim_exit(THALL+"lesser20","south",0,1);
    add_swim_exit(THALL+"brguard_n_2_1","up",0,1);
}

...
create_water_room()
{
    ...
    add_item("road","The road travels west into the Lesser "+
        "Zone of the city and east into the Major Zone.\n");
    add_item(({"major zone","Major Zone"}),"East from "+
    ...
    add_swim_exit(THALL+"lesser28","west",0,1);
    add_swim_exit(THALM+"major40","east",0,1);
    add_swim_exit(THALL+"brguard_e_2_1","up",0,1);
}

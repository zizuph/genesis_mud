...
create_water_room()
{
    ...
    set_long("You are swimming around in the Lesser Zone of "+
        ...
        "the northeast, east and southwest. Surrounding "+
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northeast, east and southwest.\n");

    add_swim_exit(THALL+"lesser18","northeast",0,1);
    add_swim_exit(THALL+"lesser19","east",0,1);
    add_swim_exit(THALL+"lesser16","southwest",0,1);
}

...
create_water_room()
{
    ...
    set_long("You are swimming around in the Lesser Zone of "+
        ...
        "the north, northeast and southwest. Surrounding "+
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the north, northeast and southwest.\n");

    add_swim_exit(THALL+"lesser30","north",0,1);
    add_swim_exit(THALL+"lesser29","northeast",0,1);
    add_swim_exit(THALL+"lesser32","southwest",0,1);
}

...
create_water_room()
{
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northwest, south and southeast.\n");

    add_swim_exit(THALL+"lesser24","northwest",0,1);
    add_swim_exit(THALL+"lesser27","south",0,1);
    add_swim_exit(THALL+"lesser26","southeast",0,1);
}

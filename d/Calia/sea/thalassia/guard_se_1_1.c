...
create_water_room()
{
    ...
    set_long("This is the eastern half of a guardhouse in "+
        ...
        "down into a basement of some sort. On the walls "+
    ...
    add_item("stairs","The stairs to the north lead down into "+
        "the darkness below.\n");
    add_item("basement","You cannot make any details out "+
        "about the basement.\n");
    ...
    add_swim_exit(THAL+"guard_se_1_3","north",0,1);
    add_swim_exit(THAL+"guard_se_1_2","west",0,1);
    this = THIS;

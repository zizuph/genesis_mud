...
create_water_room()
{
    ...
    set_long("You are swimming around in the citadel of "+
        ...
        "the northwest and east. Far north from here you see "+
        "the hot water spring house, while to the northeast you see "+
        "the massive Royal Palace. Far to the northeast, above "+
        "the hot water spring house, you see the beautiful golden "+
        "dome of the Temple of Diabrecho. To the southeast you see "+
    ...
    add_item(({"garden","well kept garden"}),"The garden surrounds "+
        "the Royal Palace northeast of you. It appears to be well taken "+
    ...
    add_item(({"palace","Palace","royal palace","Royal Palace",
        ...
        "Northeast of you is the Royal Palace of Thalassia, finely "+
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northwest and east.\n");

    add_item(({"house","spring house","hot water spring house"}),
        "Far to the north you see the hot water spring house, which houses "+
    ...
    add_swim_exit(THALC+"citadel2","east", 0, 1);
    add_swim_exit(THALC+"citadel4","northwest", 0, 1);
}

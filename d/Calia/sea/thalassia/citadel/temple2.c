...
create_water_room()
{
    ...
    set_long("You are swimming in the magnificent Temple of Diabrecho. "+
        ...
        "There are many pillars rising up to hold the ceiling in place "+
        "above you. There is a pathway leading west and east from "+
        "here. To the southeast you notice a doorway.\n");

    add_item("doorway","You see a doorway leading outside to the "+
        "southeast of here. It is bordered in fine white marble "+
        "on all sides.\n");
    ...
    add_swim_exit(THALC+"temple3","west",0,1);
    add_swim_exit(THALC+"temple1","east",0,1);
}

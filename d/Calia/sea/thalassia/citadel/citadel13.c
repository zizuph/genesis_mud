...
create_water_room()
{
    ...
    set_long("You are swimming around in the citadel of "+
        ...
        "the northwest and south. To the southwest from here you see "+
        "the cold water spring house, while far to the west you "+
        "see the Temple of Diabrecho. To the west and far "+
        "above you sits the beautiful golden dome on the top of the "+
        "Temple of Diabrecho. To the southeast you see the bridge "+
        "leading out of the citadel into the lesser zone. In the "+
        "centre of the bridge looms the guard tower. North and east you "+
    ...
    add_item(({"statue","statues"}),"The golden statues are sculptures of "+
       ...
       add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northwest and south.\n");

    add_item(({"house","spring house","cold water spring house"}),
        "To the southeast you see the cold water spring house, which houses "+
        "the magical cold water spring that was granted to the citizens of "+
        "this city by Lord Diabrecho himself.\n");

    add_swim_exit(THALC+"citadel11","northwest",0,1);
    add_swim_exit(THALC+"citadel14","south",0,1);
}

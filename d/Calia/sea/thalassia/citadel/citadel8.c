...
create_water_room()
{
    ...
    set_long("You are swimming around in the citadel of "+
        ...
        "pathway leading southeast towards the immense fountain "+
        "in the very centre of the city. Directly south from "+
        "here you see the hot water spring house, while to "+
        "the east you see the Temple of Diabrecho. To the east and "+
    ...
    add_item(({"fountain","immense fountain"}),"To the southeast you "+
    ...
    add_item(({"house","spring house","hot water spring house"}),
        "To the south you see the hot water spring house, which houses "+
    ...
    add_swim_exit(THALC+"citadel6","southwest",0,1);
    add_swim_exit(THALC+"citadel10","northeast",0,1);
    add_swim_exit(THALC+"fountain","southeast",0,1);
}

...
create_water_room()
{
    ...
    set_long("This lavishly decorated room serves as a guard "+
        ...
        "see some type of chamber while south and east lead to "+
        "a hallway of some type.\n");
    ...
    add_item("hallway","The hallways lead off to the "+
        "south and east, further into the Royal Palace.\n");
    ...
    add_item(({"urn","urns"}),"These large urns are made of "+
        ...
        "in a symetrical pattern throughout the room.\n");
    ...
    add_swim_exit(THALC+"palace_1_10","north",0,1);
    add_swim_exit(THALC+"palace_1_2","west",0,1);
    add_swim_exit(THALC+"palace_1_12","east",0,1);
    add_swim_exit(THALC+"palace_1_14","south",0,1);

...
create_water_room()
{
    ...
    set_long("You are inside of the Royal Palace of "+
        ...
        "in the light. There is a stairway here leading up "+
    ...
    add_swim_exit(THALC+"palace_1_12","north",0,1);
    add_swim_exit(THALC+"palace_1_14","west",0,1);
    add_swim_exit(THALC+"palace_2_13","up",0,1);
}

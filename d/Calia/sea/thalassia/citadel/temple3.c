...
create_water_room()
{
    ...
    set_long("You are swimming in the magnificent Temple of Diabrecho. "+
        ...
        "above you. There is a pathway leading north and east from "+
        "here.\n");

    add_item("pathway","The pathway leads off to the north and east.\n");
    ...
    add_swim_exit(THALC+"temple4","north",0,1);
    add_swim_exit(THALC+"temple2","east",0,1);
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
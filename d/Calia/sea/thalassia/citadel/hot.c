...
/* 	Hot Water Spring House in Thalassia
...
create_water_room()
{
    set_short("Inside the hot water spring house");
    set_long("You have entered the hot water spring house "+
        "of Thalassia. In the centre of the room you see "+
        "a golden well of sorts. Above the well there is a "+
        "basin with a large pipe on top of it running straight "+
        "up to the ceiling of the room. At the bottom of the "+
        "well is the magical hot water spring granted to the "+
        "citizens of Thalassia by Lord Diabrecho himself. This "+
        "spring supplies hot water for the entire city. To the "+
        "east you see a fountain and far to "+
        "the west you see the bridge tower.\n");

    add_item("fountain","To the east you see a large fountain.  "+
    ...
    add_item(({"spring","hot water spring","magical spring"}),
        "The spring is far down inside of the golden well.  So "+
        "far in fact that you cannot see it, but you can definitely "+
        "feel its effects when you put your hand above the well and "+
        "feel the hot water rising from it.\n");
    ...
    add_item("basin","This basin sits atop the well to collect the "+
        "hot water that comes from the spring. At the very top of "+
    ...
    add_swim_exit(THALC+"fountain","east",0,1);
    add_swim_exit(THALC+"citadel6","west",0,1);
}

...
create_water_room()
{
    ...
    add_item("road","The road travels west into the Lesser "+
        "Zone of the city and east into the Citadel.\n");
    ...
    add_swim_exit(GROVE+"grove5","west",0,1);
    add_swim_exit(THALC+"citadel6","east",0,1);
    add_swim_exit(THALC+"brguard_w_2_1","up",0,1);
}

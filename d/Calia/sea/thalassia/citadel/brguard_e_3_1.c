...
#define ROOM_WEST "/d/Calia/sea/thalassia/citadel/citadel14"
#define ROOM_EAST "/d/Calia/sea/thalassia/grove/grove13"
...
create_water_room()
{
    ...
    add_item(({"east road","east","east window"}),
        "@@exa_east@@");
    add_swim_exit(THALC+"brguard_e_2_1","down",0,1);
    this = THIS;

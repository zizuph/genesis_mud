...
create_water_room()
{
    ...
    set_long("You are just inside of the Royal Palace of "+
        ...
        "palace to the north and back out to the Citadel to "+
        "the south. The ceiling itself glows brightly, "+
    ...
    add_swim_exit(THALC+"palace_1_2","north",0,1);
    add_swim_exit(THALC+"citadel2","south",0,1);
}

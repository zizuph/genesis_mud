...
create_water_room()
{
    ...
    set_long("You have entered the magnificent Temple of Diabrecho. "+
        ...
        "To the northeast, in front of the statue of Lord Diabrecho, "+
        "you see a large altar. There are many pillars rising up to "+
        "hold the ceiling in place above you. There is a pathway "+
        "leading west and east from here and a doorway leading south "+
        "back out to the fountain.\n");

    add_item(({"fountain","air fountain","Air Fountain"}),"The large "+
        "Air Fountain sits in the centre of the city south of here.\n");

    add_item("doorway","The doorway is bordered in fine white marble "+
        "on all sides. Through the doorway you see the Air Fountain "+
        "that lies in the centre of the city.\n");
    ...
    add_swim_exit(THALC+"temple2","west",0,1);
    add_swim_exit(THALC+"temple12","east",0,1);
    add_swim_exit(THALC+"fountain","south",0,1);
}

...
#define ROOM_SOUTH "/d/Calia/sea/thalassia/citadel/citadel10"
#define ROOM_NORTH "/d/Calia/sea/thalassia/grove/grove9"
...
create_water_room()
{
    ...
    add_item(({"south road","south","south window"}),
        "@@exa_south@@");
    add_swim_exit(THALC+"brguard_n_2_1","down",0,1);
    this = THIS;

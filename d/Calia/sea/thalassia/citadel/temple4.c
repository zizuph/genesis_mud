...
create_water_room()
{
    ...
    set_long("You are swimming in the magnificent Temple of Diabrecho.  "+
        ...
        "above you. There is a pathway leading north and south from "+
        "here.\n");
    ...
    add_item("symbol","You cannot quite make out the symbol from this "+
        "angle. You'll have to swim either north or south to look at "+
        "it.\n");
    ...
    add_swim_exit(THALC+"temple5","north",0,1);
    add_swim_exit(THALC+"temple3","south",0,1);
}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
...
create_water_room()
{
    ...
    set_long("You are swimming around in the citadel of "+
        ...
        "the north and southwest. To the northwest from here you see "+
        "the cold water spring house. Far to the northwest, above "+
        "the cold water spring house, you see the beautiful golden "+
        "dome of the Temple of Diabrecho. To the northeast you see "+
        "the bridge leading out of the citadel into the lesser zone.  "+
        "In the centre of the bridge looms the guard tower. South and "+
        "east you see the orichalcum wall that surrounds the entire "+
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the north and southwest.\n");

    add_item(({"house","spring house","cold water spring house"}),
        "To the northeast you see the cold water spring house, which houses "+
        "the magical cold water spring that was granted to the citizens of "+
        "this city by Lord Diabrecho himself.\n");

    add_swim_exit(THALC+"citadel14","north",0,1);
    add_swim_exit(THALC+"citadel3","southwest",0,1);
}

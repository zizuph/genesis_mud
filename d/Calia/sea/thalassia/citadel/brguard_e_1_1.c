...
create_water_room()
{
    ...
    set_long("You are on a bridge of sorts between two "+
        ...
        "wall. The road you are travelling on runs west "+
        "and east from here. Towering high above you is "+
    ...
    add_item("road","The road travels west into the Citadel "+
        "of the city and east into the Lesser Zone.\n");
    add_item(({"citadel","Citadel"}),"East from "+
        "here is the Citadel of the city. This section "+
        "of the city looks to be the smallest of the three sections "+
        "of the city.\n");
    add_item(({"lesser zone","Lesser Zone"}),"West from "+
    ...
    add_swim_exit(THALC+"citadel14","west",0,1);
    add_swim_exit(GROVE+"grove13","east",0,1);
    add_swim_exit(THALC+"brguard_e_2_1","up",0,1);
}

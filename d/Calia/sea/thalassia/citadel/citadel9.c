...
create_water_room()
{
    ...
    set_long("You are swimming around in the citadel of "+
        ...
        "the east and southwest. Far south from here you see "+
        "the hot water spring house, while to the southeast you "+
        "see the Temple of Diabrecho. To the southeast and far "+
        "above you sits the beautiful golden dome on the top of the "+
        "Temple of Diabrecho. To the northeast you see the bridge "+
        "leading out of the citadel into the lesser zone. In the "+
        "centre of the bridge looms the guard tower. Northwest you "+
    ...
    add_item(({"statue","statues"}),"The golden statues are sculptures of "+
       ...
       add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the east and southwest.\n");

    add_item(({"house","spring house","hot water spring house"}),
        "Far to the south you see the hot water spring house, which houses "+
    ...
    add_swim_exit(THALC+"citadel7","southwest",0,1);
    add_swim_exit(THALC+"citadel10","east",0,1);
}

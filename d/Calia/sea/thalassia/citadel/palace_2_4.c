...
create_water_room()
{
    ...
    set_long("You are inside of the Royal Palace of "+
        ...
        "palace to the east and the south. North from here "+
        "is the Royal Bedroom. The ceiling itself "+
    ...
    add_item("hallway","The hallway continues off to the "+
        "east and south, further into the Royal Palace.\n");

    IN;

    add_swim_exit(THALC+"palace_2_7","east",0,1);
    add_swim_exit(THALC+"palace_2_3","south",0,1);

...
create_water_room()
{
    ...
    set_long("You are swimming in the magnificent Temple of Diabrecho. "+
        ...
        "here. To the northeast you notice a doorway.\n");

    add_item("doorway","You see a doorway leading outside to the "+
        "northeast of here. It is bordered in fine white marble "+
        "on all sides.\n");
    ...
    add_swim_exit(THALC+"temple5","west",0,1);
    add_swim_exit(THALC+"temple7","east",0,1);
}

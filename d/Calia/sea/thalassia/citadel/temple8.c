...
create_water_room()
{
    ...
    set_long("You are swimming in the magnificent Temple of Diabrecho. "+
        ...
        "domed roof. To the southeast you see a large altar, directly "+
        ...
        "from here. To the northwest you notice a doorway.\n");

    add_item("doorway","You see a doorway leading outside to the "+
        "northwest of here. It is bordered in fine white marble "+
        "on all sides.\n");
    ...
    add_swim_exit(THALC+"temple7","west",0,1);
    add_swim_exit(THALC+"temple9","east",0,1);
}

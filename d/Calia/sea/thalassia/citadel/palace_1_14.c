...
create_water_room()
{
    ...
    set_long("You are inside of the Royal Palace of "+
        ...
        "palace to the north and east to some stairs leading "+
    ...
    add_item("stairs", "In the room to the east you see a "+
    ...
    add_swim_exit(THALC+"palace_1_9","north",0,1);
    add_swim_exit(THALC+"palace_1_13","east",0,1);
}

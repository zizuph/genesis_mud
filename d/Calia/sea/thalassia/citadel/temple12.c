...
create_water_room()
{
    ...
    set_long("You are swimming in the magnificent Temple of Diabrecho. "+
        ...
        "domed roof. To the northeast you see a large altar, directly "+
        ...
        "in place above you. There is a pathway leading west and east "+
        "from here. To the southwest you notice a doorway.\n");

    add_item("doorway","You see a doorway leading outside to the "+
        "southwest of here. It is bordered in fine white marble "+
        "on all sides.\n");
    ...
    add_item("pathway","The pathway leads off to the west and east "+
        "for a distance then seems to curve around to the north.\n");
    ...
    add_item("symbol","The symbol is too difficult to make out from "+
        "here. You will have to swim further west to get a good look "+
        "at it.\n");
    ...
    add_swim_exit(THALC+"temple1","west",0,1);
    add_swim_exit(THALC+"temple11","east",0,1);
}

...
create_water_room()
{
    ...
    set_long("You are inside of the Royal Palace of "+
        ...
        "palace to the north and the south. The ceiling itself "+
    ...
    add_item("hallway","The hallway continues off to the "+
        "north and south, further into the Royal Palace.\n");

    IN;

    add_swim_exit(THALC+"palace_1_11","north",0,1);
    add_swim_exit(THALC+"palace_1_9","west",0,1);
    add_swim_exit(THALC+"palace_1_13","south",0,1);
}

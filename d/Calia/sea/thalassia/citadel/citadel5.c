...
create_water_room()
{
    ...
    set_long("You are swimming around in the citadel of "+
        ...
        "pathway leading northeast towards the immense fountain "+
        "in the very centre of the city. Directly north from "+
        "here you see the hot water spring house, while to "+
        "the east you see the massive Royal Palace. Far to the "+
        "northeast, above the hot water spring house, you see the "+
    ...
    add_item(({"garden","well kept garden"}),"The garden surrounds "+
        "the Royal Palace east of you. It appears to be well taken "+
    ...
    add_item(({"palace","Palace","royal palace","Royal Palace",
        ...
        "East of you is the Royal Palace of Thalassia, finely "+
    ...
    add_item(({"fountain","immense fountain"}),"To the northeast you "+
    ...
    add_item(({"house","spring house","hot water spring house"}),
        "To the north you see the hot water spring house, which houses "+
    ...
    add_swim_exit(THALC+"citadel6","northwest",0,1);
    add_swim_exit(THALC+"fountain","northeast",0,1);
    add_swim_exit(THALC+"citadel2","southeast",0,1);
}

...
create_water_room()
{
    ...
    set_long("You are swimming in the magnificent Temple of Diabrecho. "+
        ...
        "domed roof. To the south you see a large altar, directly "+
        ...
        "in place above you. There is a pathway leading west and south "+
        "from here.\n");

    add_item(({"altar","large altar"}),"The large altar appears to "+
        "be made of the fiery metal orichalcum and decorated with "+
        "marble and silver. It is directly south from here.\n");

    add_item("pathway","The pathway leads off to the west and south.\n");
    ...
    add_swim_exit(THALC+"temple8","west",0,1);
    add_swim_exit(THALC+"temple10","south",0,1);
}

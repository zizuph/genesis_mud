...
create_water_room()
{
    ...
    set_long("You are inside of the Royal Palace of "+
        ...
        "palace to the north and east. The ceiling itself "+
    ...
    add_swim_exit(THALC+"palace_2_4","north",0,1);
    add_swim_exit(THALC+"palace_2_2","east",0,1);
    add_swim_exit(THALC+"palace_1_7","down",0,1);
}

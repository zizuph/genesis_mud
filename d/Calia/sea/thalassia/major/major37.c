...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "the northwest, south and southeast. Surrounding "+
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northwest, south "+
        "and southeast.\n");

    add_swim_exit(THALM+"major36","northwest",0,1);
    add_swim_exit(THALM+"major38","south",0,1);
    add_swim_exit(THALM+"major39","southeast",0,1);
}

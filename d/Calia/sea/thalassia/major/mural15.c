...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a ruined city underwater with dark slimy creatures inside. They "+
        "appear to be destroying rather than rebuilding the city, and there "+
        "are signs that they are living there in the crumbling, dark "+
        "ruins. There appears to be another mural to the northwest of "+
        "here.\n");
    ...
    add_swim_exit(THALM+"major36","northeast",0,1);
    add_swim_exit(THALM+"mural14","northwest",0,1);

...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a beautiful woman floating above the land, surrounded by "+
        "clouds and winged creatures. The woman is holding a crystal "+
        "wand in her hand, and her eyes sparkle an emerald green. "+
        "Written below this mural in a language you seem to understand "+
        "are the words `Lady Aeria, Elemental of Air and Ruler of "+
        "the Heavens.' There seems to be other murals to the northwest "+
        "and southeast of here.\n");

    add_item(({"garden","gardens"}),"The gardens have many varieties of "+
        "plants that you do not recognize. They are very colourful "+
        "and plentiful.\n");

    add_swim_exit(THALM+"major10","southwest",0,1);
    add_swim_exit(THALM+"mural4","northwest",0,1);
    add_swim_exit(THALM+"mural2","southeast",0,1);

...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "the west, east, south and southeast. A few statues "+
    ...
    add_swim_exit(THALM+"major8","west",0,1);
    add_swim_exit(THALM+"major4","east",0,1);
    add_swim_exit(THALM+"major1","south",0,1);
    add_swim_exit(THALM+"major3","southeast",0,1);
}

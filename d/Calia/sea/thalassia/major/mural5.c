...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a large creature sitting on a throne made of ice with "+
        "peasants bowing before him. In his hand is a large sceptre, "+
        "and his eyes glow a bright blue. Written below this mural "+
        "in a language you seem to understand are the words `Lord "+
        "Diabrecho, Elemental of Water and Ruler of the Seas'. There "+
        "seems to be another mural to the southeast of here.\n");

    add_item(({"garden","gardens"}),"The gardens have many varieties of "+
        "plants that you do not recognize. They are very colourful "+
        "and plentiful.\n");

    add_swim_exit(THALM+"major12","southwest",0,1);
    add_swim_exit(THALM+"mural4","southeast",0,1);

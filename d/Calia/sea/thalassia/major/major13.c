...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "the northwest, north and southeast. Surrounding "+
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northwest, north "+
        "and southeast.\n");

    add_swim_exit(THALM+"major14","northwest",0,1);
    add_swim_exit(THALM+"major15","north",0,1);
    add_swim_exit(THALM+"major12","southeast",0,1);
}

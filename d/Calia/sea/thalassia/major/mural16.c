...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "the Thalassian citizens worshipping their dieties in a "+
        "large golden temple. There appears to be a large statue "+
        "inside the temple that they are praying before. You estimate "+
        "there are about two hundred people in the temple praying. There "+
        "appears to be another mural to the southwest of here.\n");

    add_item(({"garden","gardens"}),"The gardens have many varieties of "+
        "plants that you do not recognize. They are very colourful "+
        "and plentiful.\n");

    add_swim_exit(THALM+"major45","southeast",0,1);
    add_swim_exit(THALM+"mural17","southwest",0,1);

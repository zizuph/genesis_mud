...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "the northwest, west, southwest and southeast. Surrounding "+
    ...
    add_swim_exit(THALM+"major30","northwest",0,1);
    add_swim_exit(THALM+"major31","west",0,1);
    add_swim_exit(THALM+"mural11","southwest",0,1);
    add_swim_exit(THALM+"major33","southeast",0,1);
}

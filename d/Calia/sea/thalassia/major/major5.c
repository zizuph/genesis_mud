...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "the northwest, north, northeast and west. Surrounding "+
    ...
    add_swim_exit(THALM+"major6","north",0,1);
    add_swim_exit(THALM+"major4","northwest",0,1);
    add_swim_exit(THALM+"major7","northeast",0,1);
    add_swim_exit(THALM+"major3","west",0,1);
}

...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "two mountain peaks, each containing a city, rising into the "+
        "air, leaving flat plateaus below. Rocks and boulders fall onto "+
        "hordes of armed barbarians below. They appear as though they "+
        "were ready for a large assault on the two cities but now stand "+
        "there puzzled, confused and even scared. There appears to be "+
        "another mural to the northeast.\n");
    ...
    add_swim_exit(THALM+"major21","northwest",0,1);
    add_swim_exit(THALM+"mural7","northeast",0,1);

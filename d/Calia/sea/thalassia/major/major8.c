...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "the northwest, northeast, east and southeast. Surrounding "+
    ...
    add_item(({"wall","bronze wall","southwest","south",
        "southwest wall","south wall"}),"This shiny metal surrounds the "+
    ...
    add_item(({"road","roads"}),"The roads are constructed of "+
        ...
        "road leads off to the northwest, northeast, east "+
        "and southeast.\n");

    add_swim_exit(THALM+"major9","northwest",0,1);
    add_swim_exit(THALM+"mural1","northeast",0,1);
    add_swim_exit(THALM+"major2","east",0,1);
    add_swim_exit(THALM+"major1","southeast",0,1);
}

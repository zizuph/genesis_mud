...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a city in total ruins. Not one building is standing, not one "+
        "object untouched. You also notice several dark creatures inside "+
        "the ruins, as if they were beginning to inhabit such a place "+
        "and make it their new home. There appears to be another mural "+
    ...
    add_swim_exit(THALM+"major25","northwest",0,1);
    add_swim_exit(THALM+"mural9","southwest",0,1);
}

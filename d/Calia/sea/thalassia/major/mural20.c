...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a magnificent palace surrounded by a large garden and a "+
        "golden wall. There appears to be another mural to the "+
        "northeast of here.\n");
    ...
    add_swim_exit(THALM+"major7","southeast",0,1);
    add_swim_exit(THALM+"mural19","northeast",0,1);

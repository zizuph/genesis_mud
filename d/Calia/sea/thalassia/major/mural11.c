...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "two half-moon shaped islands sinking into the sea. The "+
        "inhabitants of both cities look panicked, trying to find "+
        "places to hide to avert their undeniable fates. There appears "+
        "to be another mural to the southeast of here.\n");

    add_item(({"garden","gardens"}),"The gardens have many varieties of "+
        "plants that you do not recognize. They are very colourful "+
        "and plentiful.\n");

    add_swim_exit(THALM+"major32","northeast",0,1);
    add_swim_exit(THALM+"mural12","southeast",0,1);

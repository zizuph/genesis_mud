...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a horde of large blackened creatures led by a well armoured "+
        "creature attacking the city on the south half-moon shaped "+
        "island. Written below this picture in a language you can "+
        "understand are the words `General Steerax'. There appear to "+
    ...
    add_swim_exit(THALM+"major24","northwest",0,1);
    add_swim_exit(THALM+"mural10","northeast",0,1);
    add_swim_exit(THALM+"mural8","southwest",0,1);

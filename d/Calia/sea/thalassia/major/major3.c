...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "and into the entrance area of the city. Above the bridge "+
    ...
    add_swim_exit(THALM+"major4","north",0,1);
    add_swim_exit(THALM+"major2","northwest",0,1);
    add_swim_exit(THALM+"major6","northeast",0,1);
    add_swim_exit(THALM+"major1","west",0,1);
    add_swim_exit(THALM+"major5","east",0,1);
    add_swim_exit(THALM+"brguard_s_1_1","south",0,1);
}

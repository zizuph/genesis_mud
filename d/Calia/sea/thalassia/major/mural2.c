...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a large flaming creature standing atop a flaming sphere, "+
        "and people kneeling before him. The creature has its hand above "+
        "it's head, and it's eyes are glowing bright yellow. Written "+
        "below this mural in a language you seem to understand are the "+
        "words `Lord Pyros, Elemental of Fire and Ruler of the Flames'. "+
        "There seems to be other murals to the northwest and "+
        "southeast of here.\n");
    ...
    add_swim_exit(THALM+"mural3","northwest",0,1);
    add_swim_exit(THALM+"major9","southwest",0,1);
    add_swim_exit(THALM+"mural1","southeast",0,1);
}

...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "merfolk planting trees, plants and flowers in a magnificent "+
        "garden. There appears to be other murals to the northeast "+
    ...
    add_swim_exit(THALM+"major47","southeast",0,1);
    add_swim_exit(THALM+"mural17","northeast",0,1);
    add_swim_exit(THALM+"mural19","southwest",0,1);

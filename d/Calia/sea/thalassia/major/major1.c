...
create_water_room()
{
    ...
    add_swim_exit(THALM+"major8","northwest",0,1);
    add_swim_exit(THALM+"major2","north",0,1);
    add_swim_exit(THALM+"major4","northeast",0,1);
    add_swim_exit(THALM+"major3","east",0,1);
}

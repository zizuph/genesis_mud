...
create_water_room()
{
    ...
    set_long("You are swimming around in the Major Zone of "+
        ...
        "the north, northwest, west, southwest and south. Surrounding "+
    ...
    add_item("sign","The sign reads 'Thalassian Zoo'.\n");
    ...
    add_item(({"wall","bronze wall","northeast","northeast wall"}),
    ...
    add_swim_exit(THALM+"major39","north",0,1);
    add_swim_exit(THALM+"major38","northwest",0,1);
    add_swim_exit(THALM+"major40","west",0,1);
    add_swim_exit(THALM+"zoo1","east",0,1);
    add_swim_exit(THALM+"major42","southwest",0,1);
    add_swim_exit(THALM+"major43","south",0,1);
}
...
do_read(string str)
{
    ...
    write("The sign reads: 'Thalassian Zoo'\n");
    return 1;
}

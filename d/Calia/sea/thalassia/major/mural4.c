...
create_water_room()
{
    ...
    add_item(({"mural","colourful mural"}),"The mural is a depiction "+
        ...
        "a very tall woman standing atop a mountain with peasants "+
        "bowing before the mountain in worship to her. Her eyes "+
        "shine like diamonds. Written below this mural in a language "+
        "you seem to understand are the words `Lady Gu, Elemental of "+
        "Earth and Ruler of Rock'. There seems to be other murals to "+
        "the northwest and southeast of here.\n");

    add_item(({"garden","gardens"}),"The gardens have many varieties of "+
        "plants that you do not recognize. They are very colourful "+
        "and plentiful.\n");

    add_swim_exit(THALM+"major11","southwest",0,1);
    add_swim_exit(THALM+"mural5","northwest",0,1);
    add_swim_exit(THALM+"mural3","southeast",0,1);

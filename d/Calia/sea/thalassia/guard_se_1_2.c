...
create_water_room()
{
    ...
    set_long("This is the western half of a guardhouse in "+
    ...
    add_swim_exit(THAL+"guard_se_1_4","north",0,1);
    add_swim_exit(THAL+"obelisk","west",0,1);
    add_swim_exit(THAL+"guard_se_1_1","east",0,1);
    this = THIS;

...
create_water_room()
{
    ...
    set_long("You have entered into the sacred Grove of "+
        ...
        "southwest along a small pathway.\n");
    ...
    add_item(({"grove","sacred grove","Grove of Diabrecho",
        ...
        "It continues off to the northeast and southwest along "+
        "a small pathway.\n");
    ...
    add_item(({"plant","plants"}),"There are several types of "+
        ...
        "flowers.\n");
    add_item(({"flowers","flower"}),"You recognize two of "+
        "the flowers growing here, the iris and the hydrangea.\n");
    ...
    add_swim_exit(GROVE+"grove13","northeast",0,1);
    add_swim_exit(GROVE+"grove15","southwest",0,1);
}

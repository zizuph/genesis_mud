...
create_water_room()
{
    ...
    add_item("fountain","This fountain is as all others you have seen "+
        ...
        "very refreshing. At the top of the fountain you notice a "+
        "statue.\n");
    ...
    add_item("statue","The statue is sitting on the top of the basin "+
        "of the fountain. It is of a magnetic, oval-faced female "+
        "human. Below the statue is a small inscription reading "+
        "\"Hameelas\".\n");
    ...
    add_swim_exit(GROVE+"grove4","northwest",0,1);
    add_swim_exit(GROVE+"grove2","southeast",0,1);
}

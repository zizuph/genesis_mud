...
create_water_room()
{
    ...
    set_long("You have entered into the sacred Grove of "+
        ...
        "himself. The grove continues to the southwest and "+
        "the southeast along a small pathway. The road "+
        "continues south to another bridge. The Lesser Zone "+
        "lies around you in all other directions.\n");
    add_item(({"bridge","tower","guard tower"}),"The bridge leads off to "+
        "the south into the Citadel of the city. On the top "+
    ...
    add_item(({"grove","sacred grove","Grove of Diabrecho",
        ...
        "It continues off to the southwest and southeast along a "+
        "small pathway.\n");
    add_item(({"path","pathway","small path","small pathway"}),
        ...
        "through the Grove. It leads off to the southwest and "+
    ...
    add_item(({"flowers","flower"}),"You recognize two flowers "+
        "here, the hydrangea and the iris.\n");
    ...
    add_swim_exit(THALL+"lesser20","north",0,1);
    add_swim_exit(THALL+"lesser19","west",0,1);
    add_swim_exit(THALL+"lesser22","east",0,1);
    add_swim_exit(THALC+"brguard_n_1_1","south",0,1);
    add_swim_exit(THALL+"lesser18","northwest",0,1);
    add_swim_exit(THALL+"lesser21","northeast",0,1);
    add_swim_exit(GROVE+"grove8","southwest",0,1);
    add_swim_exit(GROVE+"grove10","southeast",0,1);
}

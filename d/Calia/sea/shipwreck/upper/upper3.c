...
create_water_room()
{
    ...
    set_long("You are floating underwater at the northern parts of the "+
        ...
        "wooden railwork southwest or head directly south to the center "+
        "of the main deck of the shipwreck.\n");
...
/* Room tells borrowed from the sea rooms, created by Maniac & Khail. */
    ...
    add_swim_exit(WRECKU + "upper2","southwest");
    add_swim_exit(WRECKU + "upper4","south");

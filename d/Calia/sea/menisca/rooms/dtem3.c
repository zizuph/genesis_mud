...
create_water_room()
{
    ...
    set_long("From the amount of rotten wood and rusted railings " +
             ...
             "south. There is a narrow hallway that leads to the " +
             "southwest and a passage that exits to the west.\n");

    add_swim_exit(MENISCA + "dtem2","east",0,1);
    add_swim_exit(MENISCA + "dtem4","north",0,1);
    add_swim_exit(MENISCA + "dtem1","northeast",0,1);
}

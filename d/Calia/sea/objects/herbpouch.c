 ...
 * Jaacar, 23-July-97: Modified description for Calian village store
 * Maniac, 12/6/99: Revised to deal with "keep" problem
 * Maniac, 4/7/02:  Fixed typo in long desc.
 * Jaacar  18/8/03: Added support for other items (leftovers)
 * Mercade, 21/05/2004; removed decay routines.
 */
...
{
    if (sizeof(all_inventory(TO)))
        return "leather pouch containing components";

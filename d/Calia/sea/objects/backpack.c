...
/*   A large backpack for the equipment shop in Thalassia

    coder(s):   Maniac

    history:  
            10/7/03    adapted for Thalassian Shop            Jaacar  
...
create_wearable_pack()
{
    ...
    set_adj("large");
    set_long("A large backpack made out of an oily skin to "+
        "protect it's contents from water damage. "+
        "There is also some sort of 'sleeve' inside of it "+
        "so that you can place and remove items inside of it "+
        "while underwater and not have to worry about getting the "+
        "rest of the contents wet, or filling the pack with water. "+

...
create_room()
{
    ...
    set_long("You walk along the sea front of a small fishing village. " +
        ...
        "the coastline gets rather craggy and rocky, seeming to " +
    ...
    add_item(({"rocks", "coastline" }), 
          "South of here are large grey craggy rocks that would seem to " +
          "block the progress of those wishing to travel further. They " +
          "stretch along the coastline, which turns southwest into " +
          "the distance.\n"); 

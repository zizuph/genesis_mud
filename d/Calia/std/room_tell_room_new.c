...
public int          tell_alrm;
public int          repeat_tell = 0;

public string *     tell_strings = ({ });
public string *     tell_strings_left;
...
do_room_tell()
{
    ...
    if (function_exists(this_tell_string, this_object()))
    {
        tell_room(this_object(),
            call_other(this_object(), this_tell_string));
    }
    else
    {
        tell_room(this_object(), this_tell_string);
    }

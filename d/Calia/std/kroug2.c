...
set_kroug_type(int type)
{
    ...
    switch (kroug_type) {
        case KROUG_REGULAR : 
                          ...
                          set_skill(SS_WEP_CLUB, 38);
                          set_skill(SS_WEP_KNIFE, 38);
                          set_skill(SS_WEP_SWORD, 38);
                          set_skill(SS_WEP_AXE, 38);
                          set_skill(SS_WEP_POLEARM, 38);
                          set_skill(SS_DEFENSE, 38);
                          set_skill(SS_PARRY, 38);
                          set_skill(SS_2H_COMBAT, 38);
                          set_alignment(-150);
                          set_skill(SS_AWARENESS, 40); 
                          add_prop(LIVE_I_SEE_DARK, 2); 
                          kpr = 300;
                          break;
        case KROUG_TOUGH : set_base_stat(SS_STR, 72);
                          strength = 75;
                          set_base_stat(SS_DEX, 72);
                          set_base_stat(SS_CON, 72);
                          ...
                          kpr = 620;
                          break;
        case KROUG_ELITE : set_base_stat(SS_STR, 95);
                          strength = 95;
                          set_base_stat(SS_DEX, 95);
                          set_base_stat(SS_CON, 95);
                          set_base_stat(SS_INT, 25);
                          set_base_stat(SS_WIS, 25);
                          ...
                          kpr = 1005;
                          break;
        case KROUG_ULTRA : set_base_stat(SS_STR, 120);
                          strength = 120;
        ...
        default:          set_base_stat(SS_STR, 30);
                          ...
                          set_base_stat(SS_DIS, 100);
                          set_skill(SS_WEP_CLUB, 22);
                          set_skill(SS_WEP_KNIFE, 22);
                          set_skill(SS_WEP_SWORD, 22);
                          set_skill(SS_WEP_AXE, 22);
                          set_skill(SS_WEP_POLEARM, 22);
                          set_skill(SS_DEFENSE, 22);
                          set_skill(SS_PARRY, 22);
                          set_skill(SS_2H_COMBAT, 22);

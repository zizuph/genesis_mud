...
react_to_weapon(object wep, object donor) 
{
    ...
    { 
        tell_here(QCTNAME(this) + " lays " + LANG_THESHORT(wep) + 
            ...
            " kneels, and then " + LANG_THESHORT(wep) + " disappears.\n"); 
        wep->remove_object(); 
...
create_calian()
{
    ...
    add_ask(({"help","task","quest","job", "weapon", "weapon of light"}),
              "say Greetings and welcome. I am glad that you have come in " +
              "answer of my prayers. Bring me a weapon of light to help " +
              "defend this Palace. The commander of the Krougs raiding " +
              "the foothills holds a weapon of darkness. Guildmaster " +
              "Krom told me this weapon can be transformed into a weapon " +
              "of light. Perhaps ask him how this is done?\n",1);
}

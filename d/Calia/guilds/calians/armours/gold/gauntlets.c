/* 	gauntlets for the gold knight in the crystalline palace
...
detach(string str)
{
    ...
    clone_object(ARMOUR("gold_lgauntlet"))->move(tp);
    clone_object(ARMOUR("gold_rgauntlet"))->move(tp);
    remove_object();
    write("Ok.\n");
    return 1;
}
...
create_armour()
{
    ...
    set_long("This is a pair of golden gauntlets.\n");
    set_ac(20);

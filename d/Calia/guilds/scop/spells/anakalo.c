...
#define SPIRIT_TEMPLE_GARDEN "/d/Calia/guilds/elementalists/temple/greathall"
...
config_spell(object caster, object *targets, string argument)
{
    ...
    set_spell_ingredients(({"_leftover_heart"}));   // Also _anakalo_component 
...
resolve_anakalo(object caster)
{
    ...
    else
    {
        ...
        if (spell_mode == ANAKALO_MODE_TEMPLE)
        {
            ...
            {
                caster->catch_tell("You are already in the Temple greathall!\n");
            }
            else
            {
                caster->catch_tell("Picturing the familiar image of the" +
                                   " Temple greathall in your mind's eye, you " +

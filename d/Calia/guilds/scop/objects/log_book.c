...
create_log_book()
{
    ...
    set_long("A leather book with a brown cover.  "+
        "The title of the book is: \"Spirit Circle Council Log\".\n");
    set_file("/d/Calia/guilds/scop/logs/council");
    set_max_size(BOOK_MAX_SIZE);
    add_prop(OBJ_I_WEIGHT, 1000);
    add_prop(OBJ_I_VOLUME, 1000);
    add_prop(OBJ_M_NO_GET,
	"The council log book is fixed here by the magic of Psuchae.\n");
}

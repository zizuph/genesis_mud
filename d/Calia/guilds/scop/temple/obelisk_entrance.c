 ...
 * obelisk_entrance.c
 *
 * The entrance to the black obelisk in the garden of
...
create_room() 
{
    ...
    set_long("You are standing inside of the black obelisk. It is a "+
        "small chamber with a set of stairs leading down into the "+
        "darkness below. You feel you could also head back 'out' to "+
        "the garden (as long as you are in your shadowy form and "+
        "can walk through the wall again).\n");
    
    add_exit(SPIRIT_TEMPLE+"garden","out","@@check_spiritform",1);
    add_exit(SPIRIT_TEMPLE+"obelisk_lower1","down","@@check_stairs",1);
}

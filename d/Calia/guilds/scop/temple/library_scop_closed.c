 ...
 *   Added code to support closure of Spirit Circle guild - Jaacar Dec 2017
 */
...
{
    set_short("Library");
    set_long("You are in the remains of the private library of the Spirit "+
        "Circle of Psuchae. Lining the northern wall are shelves. Just "+
        "above the shelves you see a small slate plaque. "+
        "You can head back to the sleeping chamber to the southeast.\n");
    ...
    add_exit(SPIRIT_TEMPLE+"startroom","southeast",library_exit_block,1);
}
...
library_write_access()
{
    ...
    /* No-one else has permission to write books since the guild
       is closed */
    write("This library is no longer functional so you cannot write "+
        "books.\n");
    return 0;
}

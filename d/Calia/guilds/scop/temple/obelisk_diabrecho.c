...
create_room() 
{
    ...
    add_exit(SPIRIT_TEMPLE+"obelisk_ante","southwest","@@check_spiritform",1,1);
...
statue_desc()
{
    ...
    {
        statue_desc = "It is a small statue of Lord Diabrecho. It seems ";
    ...
    statue_desc = "You find no statue.";
    return statue_desc;
}
...
passage_desc()
{
    ...
    if (present("_skiamati_object_",TP))
    {
        pass_desc = "The passage leads off to the southwest, into the ";
        pass_desc += "darkness.";
        return pass_desc;
    }
...
can_see()
{
    ...
    if (present("_skiamati_object_",TP))
    {
        ...
        desc += "passage leading to the southwest into the darkness. ";
...
do_insert(string str)
{
    ...
    if (str != "triangle" && str != "blue triangle")
    {
        write("The "+str+" does not fit in the notch.\n");
        return 1;
    }

    triangle = present("_diabrecho_triangle_",TP);
    if (!triangle)
    {
    ...
    write("You place the blue triangle into the notch. The triangle "+

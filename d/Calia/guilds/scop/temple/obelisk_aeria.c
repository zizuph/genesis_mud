...
create_room() 
{
    ...
    add_exit(SPIRIT_TEMPLE+"obelisk_ante","southeast","@@check_spiritform",1,1);
...
passage_desc()
{
    ...
    if (present("_skiamati_object_",TP))
    {
        pass_desc = "The passage leads off to the southeast, into the ";
        pass_desc += "darkness.";
        return pass_desc;
    }
...
do_insert(string str)
{
    ...
    if (str != "triangle" && str != "crystal triangle")
    {

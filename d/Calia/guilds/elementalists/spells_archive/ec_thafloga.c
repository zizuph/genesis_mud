/*
 * Fire Tendrils At-Will Spell for the Elemental Cleric Guild of Calia
 *
...
query_spell_can_be_learned(object player)
{
    ...
    if (player->query_stat(SS_LAYMAN) < SPELL_MINIMUM_GSTAT_CLERIC_THAFLOGA)
    {
        return 0;
    }


    // Only child clerics get this spell - it is replaced by a branch 
    // specific one at Master and higher
...
{
    write("You feel ready to use the prayer of thafloga again.\n");
}
...
{
    write("You do not feel ready to use the prayer of thafloga again.\n");
}

public void
hook_already_active(object ability)
{
    write("You are currently using the prayer of thafloga!\n");
}
...
desc_harm_damage(object caster, object target, mixed *result)
{
    ...
    {        
        ...
        case 3..5:
            target_message = "You turn your body to try and dodge the many "+
            	"fiery "
        ...
        case 10..15:
            target_message = "Flying past you at tremendous speeds, "+
            	"the fiery tendrils "
                + "seem to miss you, but at the last moment they "+
                "come hurtling "
                + "back and wrap your " + hitloc_desc + ", burning "+
                "you deeply.\n";

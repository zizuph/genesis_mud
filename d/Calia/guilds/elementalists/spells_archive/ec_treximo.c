/*
 * Blink Spell for the Elemental Cleric Guild of Calia
 *
...
config_blink_spell()
{
    set_spell_name("treximo");
    set_spell_desc("Blink behind a team member");
    ...
    set_spell_object(ELEMENTALIST_SPELL_OBJS + "treximo_obj");
...
query_spell_can_be_learned(object player)
{
    ...
    if (player->query_stat(SS_LAYMAN) < SPELL_MINIMUM_GSTAT_CLERIC_TREXIMO)
    {
        return 0;
    }
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    string caster_message, watcher_message;
        ...
        caster_message = "You concentrate and pray to Lord Diabrecho.\n";
...
{
    return "treximo component (eye, sapphire shard)";
}

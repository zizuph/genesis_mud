...
attack_blocked(object player)
{
    ...
    if (enemy)
    {
        ...
        player->catch_msg("You attempt to attack " + QTNAME(enemy)
                         + ", but find that your arms feel like they have "+
                         "quicksand "+
                         "running through them and you cannot.\n");
...
hook_stun_ended(object player)
{
    ...
    player->catch_msg("You feel you have fully recovered from " +
        "the quicksand flowing through your arms.\n");
...
hook_stun_begin(object attacker, object target)
{
    ...
    target->catch_msg("Your arms suddenly feel heavy and like they have "+
        "quicksand running through them, greatly restricting your ability "+
        "to attack.\n");

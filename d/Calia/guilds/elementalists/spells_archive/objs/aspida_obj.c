/*
 * Earth Shield for the Aspida Spell for the Elementalists of Calia
 *
...
create_spell_object()
{
    set_name("_aspida_object_");
    set_short("aspida stoneskin object");    
    set_long("This is the aspida stoneskin object. It absorbs "
        + "incoming damage.\n");

    add_prop(OBJ_M_NO_DROP, 1);
    add_prop(OBJ_S_WIZINFO, "This is a spell object " +
                            "created by the aspida stoneskin "+
                            "spell.\n");
    set_spell_effect_desc("aspida stoneskin");    
}
...
{
    return ELEMENTALIST_SPELL_OBJS + "aspida_dam_mod";
}

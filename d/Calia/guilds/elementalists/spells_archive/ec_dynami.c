...
config_statboost_spell()
{
    ...
    add_stat_boost(SS_STR, 3);
    add_stat_boost(SS_CON, 10);
    add_stat_boost(SS_INT, 7);
    add_stat_boost(SS_DIS, 8);
    ...
    else
    {
        ...
        switch(primary_element)
        {
            case "fire": // 50 CAID
                ...
                {
                    max_boosts[SS_STR] = 3;
                    max_boosts[SS_CON] = 18;
                    max_boosts[SS_INT] = 11;
                    max_boosts[SS_DIS] = 14;
                }
                break;
            ...
            case "air": // 65 CAID
                ...
                {
                    max_boosts[SS_STR] = 3;
                    max_boosts[SS_CON] = 22;
                    max_boosts[SS_INT] = 11;
                    max_boosts[SS_WIS] = 10;
            ...
            case "earth": // 75 CAID
                ...
                {
                    max_boosts[SS_STR] = 5;
                    max_boosts[SS_CON] = 40;
                    max_boosts[SS_INT] = 10;
                    max_boosts[SS_DIS] = 18;
                }
                break;

/*
 * Syndyasmos Spirit + Spirit combination spell the 
...
config_stun_spell()
{
    set_spell_name("epnevmatos");
    set_spell_desc("Syndyasmos Spirit + Spirit Combination");
    ...
    set_spell_object(ELEMENTALIST_SPELL_OBJS + "syndyasmos_stun_obj_spirit");

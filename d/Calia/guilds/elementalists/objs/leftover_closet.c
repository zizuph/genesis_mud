...
/* 
 *  Leftover Closet for the Elemental Clerics
 *
...
inherit "/d/Calia/guilds/elementalists/objs/describable_rack";
...
// Defines
#define     LEFTOVER_DATA   (ELEMENTALIST_TEXTS + "leftover_data")
...
create_rack()
{
    ...
    add_item( ({ "circles", "three circles", "large circles", "circle",
              ...
              "The symbols are a reminder of Psuchae.\n" );

...
load_cabinet(object obj) 
{
    ...
    load_cabinet_item((ELEMENTALIST_OBJS+"robe"),             NUM_ROBES,   obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"mantle"),           NUM_MANTLES, obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"alb"),              NUM_ALBS,    obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"incense"),          NUM_INCENSE, obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"anointing_oil"),    NUM_OILS,    obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"ceremonial_drum"),  NUM_DRUMS,   obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"ceremonial_bell"),  NUM_BELLS,   obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"ceremonial_candle"),NUM_CANDLES, obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"chimes"),           NUM_CHIMES,  obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"chalice"),          NUM_CHAL,    obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"bread"),            NUM_BREAD,   obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"water"),            NUM_WATER,   obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"certome"),          NUM_TOMES,   obj);
    load_cabinet_item((ELEMENTALIST_OBJS+"wedtome"),          NUM_TOMES,   obj);

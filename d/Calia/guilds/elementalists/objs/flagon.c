/*
    This is a flagon containing water that Earth Clerics can get
    from the trefo prayer (summon food/water)
...
{
    set_name("flagon");
    add_name("_ec_flagon_");
    set_short("flagon");
    set_long("It is a crystal flagon filled with a glowing "+
        "liquid of some sort. You can drink from it.\n");

/*
 * Mandala for the Elemental Earth Clerics
 *
...
hook_describe_long()
{
    ...
    return "This " + short() + " is the holy symbol of Gu. "+
        ...
        "straight lines running from left to right.\n";
}
...
do_pattern()
{
	...
	symbol = "                                                                              \n"+
			...
			"                                                                              \n"+
			"   ..,...........................................................,...         \n"+
			"  ii1iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii;ii.       \n"+
			"  :iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii1:.       \n"+
			 "                                                                              \n";

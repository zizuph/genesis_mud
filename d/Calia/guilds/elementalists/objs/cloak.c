 ...
 * cloak.c
 *
 * A colour changing cloak for the Elemental Guilds of Calia
 *
...
#define SECTION(x) GUILD_MANAGER->query_primary_element(x)
#define WEARING_ELEMENTAL_CLOAK "_wearing_elemental_cloak"



mapping colours = (["fire":({"glowing white","blazing blue","golden",
                   ...
                   "air":({"clear crystalline","shimmering translucent",
                   ...
                   "earth":({"sparkling diamond-coloured","sculptured marble-coloured",
                   ...
                   "water":({"sparkling blue","sleek cerulean","glittering icy blue",
                   ...
                   "life":({"ethereal bright silver","vaporous platinum","obscure pastel grey",
                   "dimly pale silver","slate grey","pulsating stormcloud grey",
                   "pewter-coloured","gloomy shadow-infused","dark byzantium",
                   "dark lavender","dark orchid","mesmerizing byzantium",
                   "palatinate purple","obscure damson","celestial purple taupe"})]);
...
wear(object what)
{
    TP->add_prop(WEARING_ELEMENTAL_CLOAK,1);
    hood = 0;
...
remove(object what)
{
    TP->remove_prop(WEARING_ELEMENTAL_CLOAK);
    hood = 0;
...
do_bow()
{
    if (!TP->query_prop(WEARING_ELEMENTAL_CLOAK))
    {

/*
   This is the staff of fire, a magical quarterstaff that's found in Calia.
   It is mediocre for someone with no skill in fire magic, but for someone
...
adj()
{
    ...
    if (!objectp(ob) || ob->query_skill(SS_ELEMENT_FIRE) < 30)
    {
        return "painted";
    }
    else
    if (ob->query_skill(SS_ELEMENT_FIRE) < 60)
    {
        return "sculpted";
    }
    else
...
extra_long()
{
    ...
    {
        return " The staff exudes heat, but you feel no discomfort" +
            " holding it in your hands.";
    }
    else
    {
        return " The staff radiates fiery energy, but you are" +
            " unaffected by it.";
    }
}
...
create_weapon()
{
    ...
    set_adj("@@adj@@");
    set_adj("red");
    set_short("@@adj@@ red quarterstaff");
    ...
    set_long("This solid quarterstaff must have been cut from a" +
        ...
        " has been painted with shades of red and dark orange. Thick"+
        " and thin lines snake their way around the weapon in"+
        " intricate patterns. It reminds you of a flame."+
        "@@extra_long@@\n");
    ...
    add_prop(MAGIC_AM_ID_INFO, ({"This staff has been enchanted with" +
        ...
        " additional benefits to those who know fire magic.\n", 25, 
        "This staff performs better for masters of fire magic, in" +
        " addition to sometimes stunning opponents.\n", 40}));
    
    add_prop(OBJ_S_WIZINFO, "This staff gets higher hit/pen for a" +
        " wielder who has skill in fire magic, and has a 1 in 8 chance" +
...
wield(object weapon)
{
    ...
    skill = wielder->query_skill(SS_ELEMENT_FIRE);

...
create_board()
{
    seteuid(getuid(THIS));
    set_name("board");
    set_short("board of the Elemental Clerics Council");
    set_board_name("/d/Calia/private/cleric_council/council_msgs");
    set_num_notes(30);
    set_silent(0);
    set_show_lvl(0);
...
{
    object tp = TP;
    return GUILD_MANAGER->query_is_elder_cleric(tp, 1);

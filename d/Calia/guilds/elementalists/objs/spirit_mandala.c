/*
 * Mandala for the Elemental Spirit Clerics
 *
...
hook_describe_long()
{
    ...
    return "This " + short() + " is the holy symbol of Psuchae. "+
        "It is a small, black, round symbol with a pattern of gold "+
        "in the middle. The <pattern> consists of a circle "+
        "with a square inside of it. Inside of the square are three "+
        "same-sized, perfect circles intertwined, surrounded by one "+
        "large circle.\n";
}

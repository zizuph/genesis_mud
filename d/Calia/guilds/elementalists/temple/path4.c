...
create_room()
{
    ...
    set_long("You are standing on a dirt path nestled in the foothills "+
        ...
        "off to the northwest and ends abruptly at an entrance leading "+
        "down into the ground itself.\n");
    
    try_item(({"entrance","down", "ground"}), "An entrance has been "+
        "carved into the ground itself, leading downwards.\n");
        
    try_item( ({ "dirt path", "path" }),
        "The dirt path allows you to travel northwest. The path itself consists "
    ...
    add_exit(ELEMENTALIST_TEMPLE + "path5", "northwest");
    add_exit(ELEMENTALIST_TEMPLE + "oldestiroom", "down");

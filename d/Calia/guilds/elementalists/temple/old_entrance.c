...
create_room()
{
    ...
    add_exit(ELEMENTALIST_TEMPLE+"newarchway","north",0,1);
    add_exit(ELEMENTALIST_TEMPLE+"oldw_chamber","west",0,1);
    add_exit(ELEMENTALIST_TEMPLE+"olde_chamber","east",0,1);
    add_exit(ELEMENTALIST_TEMPLE+"olds_chamber","south",0,1);
}

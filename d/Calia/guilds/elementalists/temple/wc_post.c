...
create_temple_room()
{
    ...
    set_long("Here you find the post office of the Elemental Temple of "
        + "Calia. Members of the Worshippers Council can correspond "
        ...
        + "   mail council      Mail the Elemental Worshippers Council.\n"
        + "   mail clerics      Mail the Elemental Clerics Council.\n"
        + "   mail guildmaster  Mail the Elemental Worshippers Guildmaster.\n"
    ...
    add_exit(ELEMENTALIST_TEMPLE + "worshipper_councilroom", "east");
}
...
add_mail_aliases(object reader)
{
    ...
    string * councilmembers = GUILD_MANAGER->query_ew_council();
    ...
    {
        reader->set_alias("clerics", eccouncilmembers);
    }
}

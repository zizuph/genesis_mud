/*
 * Startroom for the Followers of Diabrecho in the Elemental Temple of Calia
 * 
...
describe_long()
{
    ...
    return "This is the sleeping quarters for all who are guided by Lord "
        + "Diabrecho. You notice rows of beds along the northern and "
        ...
        + "above. You sense the feeling that Lord Diabrecho is watching "
        + "over you, allowing you a peaceful rest. To the west, "
...
create_temple_room()
{
    set_short("Bunkroom for the Servants of Diabrecho");
    ...
    add_exit(ELEMENTALIST_TEMPLE + "diabrecho", "west");
}

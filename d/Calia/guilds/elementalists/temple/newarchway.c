...
create_room()
{
    ...
    set_long("You enter a small vale nestled in the foothills "+
        ...
        "continues southwest. Looking carefully you notice a beautiful "+
        "archway hidden amongst the bushes, flowers and plants. It "+
    ...
    add_prop(ROOM_S_MAP_FILE, "elementalist_path.txt");
    ...
    add_exit(ELEMENTALIST_TEMPLE+"newpath","north",0,1);
    add_exit(ELEMENTALIST_TEMPLE+"path1", "southwest",0,1);
    add_exit(ELEMENTALIST_TEMPLE+"old_entrance","archway",0,1);
}

/*
 * Startroom for the Followers of Aeria in the Elemental Temple of Calia
 * 
...
/*
 * Description updates by TT, February 2016
 * Coding updates and spelling corrections by Leia, February 2016
 */
...
describe_long()
{
    ...
    return "This is the sleeping quarters for all who are guided by Lady "
        + "Aeria. You notice rows of beds along the southeastern and "
        + "northwestern walls. Each bed is separated by its own small "
        ...
        + "above. You sense the feeling that Lady Aeria is watching "
        + "over you, allowing you a peaceful rest. To the east, "
...
create_temple_room()
{
    set_short("Bunkroom for the Servants of Aeria");
    set_long("@@describe_long@@");
    
    try_item( ({ "beds", "bed", "rows of beds", "rows", "row of beds",
                 "row", "southeastern wall", "northwestern wall",
                 "wood", "petrified wood" }),
    ...
    add_exit(ELEMENTALIST_TEMPLE + "aeria", "east");
}

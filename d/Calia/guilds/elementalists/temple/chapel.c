 ...
 * 2016-09-13 - Cotillion
 * - Fixed std->add_prop where str was from a player
 * 2020-11-24 - Mirandus
 * - Allowed Elders to accept worshippers at the request
 *   of the council.
 */
...
do_allow(string str)
{
    ...
    find_player(str)->add_prop(I_PRAYED_WORSHIPPERS, 1);
...
inform_player_joining_instructions(object player)
{
    ...
    player->catch_tell(
        ...
        + "gardens. When complete, return here to pray to the Elementals to become a "
        + "Seeker in the Temple. Afterwards, mail the council in the Temple post "
        + "office to begin your new journey.\n\n");

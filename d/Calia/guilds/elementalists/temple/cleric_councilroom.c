/*
 * Council Chambers for the Elemental Clerics of Calia
 *
 * Created by Petros, April 2014
 *
 * Modifications: 
 *    - Allowed Elders to be use the tasking functions at the
 *      request of the council - Mirandus, Nov 24, 2020
 *    - Modified to properly execute dicharge/expel - Mirandus
 */
#pragma strict_types
#pragma save_binary
...
#define WORSHIPPER_BOARDROOM (ELEMENTALIST_TEMPLE + "ew_boardroom")
...
load_board()
{
    clone_object(ELEMENTALIST_OBJS + "ec_council_board")->move(THIS);
}
...
create_temple_room()
{
    set_short("Elemental Council Chambers");
    set_long("You are standing in the council chambers of the "+
        "Elemental Circle of Calia. This chamber is lit "+
        "by glowing rocks set into the walls. There is a large "+
        "platinum banner showing all of the management commands, "+
        "a large golden banner showing all of the special title "+
        "commands and a smaller silver banner hanging showing all "+
        "of the Seeker related commands on the "+
        "western wall, and a scroll hanging below them. Beside the "+
        "scroll you notice a tasklist. In one "+
    ...
    add_item("golden banner", "@@describe_golden_banner@@");
    add_item("silver banner", "@@describe_silver_banner@@");
    add_item("platinum banner", "@@describe_platinum_banner@@");
    add_item("tasklist", "@@describe_tasklist@@");
    add_item("banner","Did you mean the platinum, golden or the silver banner?\n");

    add_prop(ROOM_I_INSIDE, 1);
    add_prop(ROOM_I_LIGHT, 1);

    add_exit(ELEMENTALIST_TEMPLE + "stairwell3", "north");
    add_exit(ELEMENTALIST_TEMPLE + "ec_post", "west");
...
public string
describe_silver_banner()
{
	return "On the silver banner you see:\n"+
	    "Seeker Related Commands:\n"+
        ...
        "                          re-answer.\n"+
        "  reset5 <player>       - Reset <player>'s task 5 status so they can\n"+
        "                          re-answer.\n"+
        "  reset6 <player>       - Reset <player>'s task 6 status so they can\n"+
        "                          re-answer.\n"+
...
public string
describe_platinum_banner()
{
    return "On the platinum banner you see:\n"+
        "Council Management Commands:\n" +
        "  council               - check council members.\n" +
        "  addmem <player>       - add <player> to the Cleric Council.\n" + 
        "  remmem <player>       - remove <player> from the Cleric council.\n"+
        "  focus                 - check the current Elementalist Focus.\n"+
        "  setfocus <player>     - set <player> as Elementalist Focus.\n"+
        "  remfocus <player>     - remove <player> as Elementalist Focus.\n"+
        "  seekers               - check the current Seekers.\n"+
        "  worshippers           - check the current Worshippers.\n"+        
        "  children              - check the current Child Clerics.\n"+
        "  masters               - check the current Master Clerics.\n"+
        "  fullmasters           - check the current Full Master Clerics.\n"+
        "  elders                - check the current Elder Clerics.\n"+
        "  racials               - check the current Racial Clerics.\n"+
        "\n"+
        ...
        "  expel <player>        - expel <player> from the Cleric guild.\n" +
        "                          NOTE: This will result in their death.\n"+
        "  discharge <player>    - discharge <player> from the Cleric guild.\n"+
        "                          NOTE: This will NOT result in their death.\n"+
        ...
        "  allow <player>        - This will allow <player> to join the Elemental\n"+
        "                          Worshippers. Once this is done, they need only\n"+
        "                          'worship <diety>' to enter their service.\n"+
        "                          NOTE: This command can also be done in the Chapel\n"+
        "                          itself.\n"+
        "\n" +
...
describe_tasklist()
{
    return "On the tasklist you see:\n\n"+
        ...
        "\n"+
        "Task Five (Spirit and Soul):\n"+
        "The Seeker should be instructed to go see Sehis (in the Greathall).\n"+
        "They will be asked the following questions (answers in brackets).\n"+
        "The Seeker should be instructed to go see Sehis (in the Greathall).\n"+
        "They will be asked the following questions.\n"+
        "The Elements work together constantly in Creation. Creation is not a\n"+
        "singular event, it happens in every second and in every moment of our\n"+
        "lives. An Elder has spoken to you about a part of Creation relating\n"+
        "to Spirit as the catalyst and binder. What do we call this part?\n"+
        "(Quickening or the Quickening)\n"+
        "An Elder also would have mentioned another role; that of Soul. The\n"+
        "continued existence of the eternal component that is truly you.\n"+
        "All phases of our existence. What do we call this journey of our\n"+
        "Soul? (Cycle of Soul or Cycle of the Soul}\n"+
        "\n"+
        "Task Six (Servitude):\n"+
        "The Seeker should be instructed to go see Tiashe (in the Refectory).\n"+
        "They will be asked the following questions.\n"+
        "Given that we are both Elemental Servants and Kyrullians, explain\n"+
        "to me who the Clerics of this Temple are.\n"+
        "What behaviour would you expect from such a Cleric?\n"+
        "How do the Clerics handle conflicts internally and externally?\n"+
        "How do the Clerics approach outsiders?\n"+
        "How do the Clerics stand in regards to the moral strifes of good\n"+
        "and evil?\n"+
...
public string
describe_golden_banner()
{
    return "On the golden banner you see:\n"+
        "Special Title Commands:\n"+
        "  archa                 - check the current Archon of Apotheosis.\n"+
        "  archd                 - check the current Archon of Deliverance.\n"+
        "  archr                 - check the current Archon of Revelation.\n"+
        "  conservator           - check the current Conservator of Armaments.\n"+
        "  cultivator            - check the current Cultivator of Life.\n"+
        "  emissary              - check the current Emissary.\n"+
        "  illuminati            - check the current Illuminati.\n"+
        "  liberator             - check the current Liberator of Souls.\n"+
        "  luminary              - check the current Luminary of the Elementalists.\n"+
        "  addcon <player>       - set <player> as Conservator of Armaments.\n"+
        "  addcul <player>       - set <player> as Cultivator of Life.\n"+
        "  addemi <player>       - set <player> as Emissary.\n"+
        "  addill <player>       - set <player> as Illuminati.\n"+
        "  addlib <player>       - set <player> as Liberator of Souls.\n"+
        "  addlum <player>       - set <player> as Luminary of the Elementalists.\n"+
        "  setarcha <player>     - add <player> to be the Archon of Apotheosis.\n"+
        "  setarchd <player>     - add <player> to be the Archon of Deliverance.\n"+
        "  setarchr <player>     - add <player> to be the Archon of Revelation.\n"+                
        "  remcon <player>       - remove <player> as Conservator of Armaments.\n"+
        "  remcul <player>       - remove <player> as Cultivator of Life.\n"+
        "  rememi <player>       - remove <player> as Emissary.\n"+
        "  remill <player>       - remove <player> as Illuminati.\n"+
        "  remlib <player>       - remove <player> as Liberator of Souls.\n"+
        "  remlum <player>       - remove <player> as Luminary of the Elementalists.\n"+
        "  remarcha <player>     - remove <player> from Archon of Apotheosis.\n"+
        "  remarchd <player>     - remove <player> from Archon of Deliverance.\n"+
        "  remarchr <player>     - remove <player> from Archon of Revelation.\n"+
        "\n";
}
...
public int
can_use_elder_commands()
{
    setuid();
    seteuid(getuid());
    if (GUILD_MANAGER->query_is_elder_cleric(this_player(), 1))
    {
        return 1;
    }
    return 0;
...
see_council(string str)
{
    ...
    string * council = GUILD_MANAGER->query_ec_council();
    if (sizeof(council) == 0)
    {
        message = "The Elemental Council does not currently have any members.\n";
    }
    else if (sizeof(council) == 1) 
    {
        message = "The Elemental Council currently has the following member: " 
            + capitalize(council[0]) + ".\n";
    }
    else
    {
        message = "The Elemental Council currently has the following members: ";
...
add_council_member(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("Who would you like to add to the Elemental Council?\n");
        return 0;
    }
    ...
    setuid();
    seteuid(getuid());
    if (GUILD_MANAGER->query_is_ec_council(str, 1))
    {
        write(capitalize(str) + " is already a member of the Elemental Council!\n");
        return 1;
    }

    if (!SECURITY->exist_player(str))
    {
        write(capitalize(str) + " doesn't appear to have ever walked the Donut.\n");
        return 1;
    }

    if (!GUILD_MANAGER->query_is_cleric(str))
    {
        write(capitalize(str) + " isn't a member of the Elemental Clerics and "
              + "cannot become a Council member here.\n");
        return 1;
    }

    GUILD_MANAGER->set_ec_council(str, 1);
    string log_message = capitalize(str)
        + " has been added to the Elemental Council "
...
remove_council_member(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("Who would you like to remove from the Elemental Council?\n");
        return 0;
    }
    ...
    setuid();
    seteuid(getuid());
    if (!GUILD_MANAGER->query_is_ec_council(str, 0))
    {
        if (GUILD_MANAGER->query_is_ec_council(str, 1))
        {
            write(capitalize(str) + " is technically on the Elemental "
                  + "Council, but not someone can be removed because they aren't part "
                  + "of the Elemental Clerics guild.\n");
        }
        else
        {
            write(capitalize(str) + " is not a member of the Elemental Council!\n");
        }
        return 1;
    }

    GUILD_MANAGER->set_ec_council(str, 0);
    string log_message = capitalize(str)
        + " has been removed from the Elemental Council "
        + "by " + capitalize(this_player()->query_real_name())
        + ".\n";
    send_debug_message("cleric", log_message);
    COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
...
record_stop_train(string str)
{
    ...
    {
        write(capitalize(str) + " is a member of the Elemental Council. "
...
record_resource_banned(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("Who would you like to prevent from using Temple resources?\n");
        return 0;
    }
    ...
    {
        write(capitalize(str) + " is a member of the Elemental Council. "
              + "You will not be able to ban them from using Temple resources.\n");
        return 1;
    }

    if (GUILD_MANAGER->query_is_punish_resource_banned(str))
    {
        write(capitalize(str) + " is already banned from using Temple resources!\n");
        return 1;
    }
...
record_temple_banned(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("Who would you like to prevent from entering the Temple?\n");
        return 0;
    }
...
record_player_expelled(string str)
{
    ...
    if (objectp(player))
    {
        ...
        player->catch_tell(sprintf("\n%=-75s\n\n", "You have been expelled from the Elemental Circle "
                                   + "guild by the Elemental Council."));
        player->catch_tell(sprintf("%'='|75s\n\n", ""));
        if (GUILD_MANAGER->query_is_cleric(str))
        {
          GUILD_MANAGER->leave_occ_guild(str);
        }
        else if (GUILD_MANAGER->query_is_worshipper(str))
        {
          GUILD_MANAGER->leave_guild_expel(str);
        }
        else GUILD_MANAGER->leave_seekers_guild(str);
    }
    string log_message = capitalize(str)
    ...
    if (objectp(board)) 
    { 
        board->create_note("Member Expelled", 
                 "Sehis", capitalize(str) + 
                 " has been expelled from the Elemental Circle and is no "+
                 "longer welcome in this Temple!\n\nSehis\n"); 
    }
    object board2 = present("board", WORSHIPPER_BOARDROOM->get_this_object());    
    if (objectp(board2)) 
    { 
        board2->create_note("Member Expelled", 
                 "Sehis", capitalize(str) + 
                 " has been expelled from the Elemental Circle and is no "+
                 "longer welcome in this Temple!\n\nSehis\n"); 
    }
...
public int
record_player_discharged(string str)
{
    if (!can_use_council_commands())
    {
        return 0;
    ...
    if (!strlen(str))
    {
        notify_fail("Who would you like to dispel from the guild?\n");
        return 0;
    }
    ...
    {
        write(capitalize(str) + " is a member of the Elemental Council. "
              + "You will not be able to dispel them from the guild.\n");
        return 1;
    }

    if (GUILD_MANAGER->query_is_guild_discharged(str))
    {
        write(capitalize(str) + " has already been discharged from the guild.\n");
        return 1;
    }
    
    GUILD_MANAGER->set_guild_discharged(str, 1);
    object player = find_player(str);
    if (objectp(player))
    {
        // They are currently in the game.
        player->catch_tell(sprintf("\n\n%'='|75s\n", "DISCHARGED"));
        player->catch_tell(sprintf("\n%=-75s\n\n", "You have been discharged from the Elemental Circle "
                                   + "guild by the Elemental Council."));
        player->catch_tell(sprintf("%'='|75s\n\n", ""));
        if (GUILD_MANAGER->query_is_cleric(str))
        {
          GUILD_MANAGER->leave_occ_guild_discharge(str);
        }
        else if (GUILD_MANAGER->query_is_worshipper(str))
        {
    ...
    string log_message = capitalize(str)
        + " has been discharged from the guild "
        + "by " + capitalize(this_player()->query_real_name())
        + ".\n";
    send_debug_message("cleric", log_message);
    COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
    ...
    if (objectp(board)) 
    { 
        board->create_note("Member Discharged", 
                 "Sehis", capitalize(str) + 
                 " has been discharged from the Elemental Circle.\n\nSehis\n"); 
    }
    object board2 = present("board", WORSHIPPER_BOARDROOM->get_this_object());
    if (objectp(board2)) 
    { 
        board2->create_note("Member Discharged", 
                 "Sehis", capitalize(str) + 
                 " has been discharged from the Elemental Circle.\n\nSehis\n"); 
    }
    write("Ok.\n");
...
record_remove_punishments(string str)
{
    ...
    {
        GUILD_MANAGER->set_guild_betrayed(str, 0);
        write("You remove the guild betrayal on " + capitalize(str) + ".\n");
        bPunishmentRemoved = 1;
        string log_message = capitalize(str)
            + "'s guild betrayal has been removed "
            + "by " + capitalize(this_player()->query_real_name())
            + ".\n";
        send_debug_message("cleric", log_message);
        COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
    ...
    if (objectp(player))
    {
        player->catch_tell("The Elemental Council has removed all of your "
                           + "guild punishments.\n");
    }
    write("Ok.\n");    
    return 1;
...
read_item(string str)
{
    ...
    case "scroll":
        ...
        break;
    case "banner":
    	write("Did you mean the platinum, golden or the silver banner?\n");
    	break;
    case "platinum banner":
        write(describe_platinum_banner());
        break;
    case "golden banner":
        write(describe_golden_banner());
        break;
    case "silver banner":
    	write(describe_silver_banner());
    	break;
    default:
        notify_fail("Read what?\n");
        return 0;
...
enter_inv(object ob, object from)
{
    ...
    if (!GUILD_MANAGER->query_is_ec_council(ob, 1) &&
       !GUILD_MANAGER->query_is_elder_cleric(ob, 1))
    {
        ob->move(from);
        ob->catch_msg("You're not coming into the Elemental Council " +
...
do_anote(string str)
{
    ...
    if (!can_use_council_commands() && !can_use_elder_commands())
    {
        return 0;
    }
...
do_task(string str)
{
    ...
    if (sscanf(str, "%s %i", player, task) == 2)
    {
    	...
    	{
    		case 1:
    		    if (GUILD_MANAGER->query_can_do_ec_task_six(player))
			    {
			    	write(capitalize(player) + " has already been assigned task 6!\n");
			        return 1;
			    }
			    
			    if (GUILD_MANAGER->query_can_do_ec_task_five(player))
			    {
			    	write(capitalize(player) + " has already been assigned task 5!\n");
			        return 1;
			    }
			...
			case 5:
			    ...
			    if (!GUILD_MANAGER->query_is_worshipper(player))
			    {
    			    ...
    			    // One question in task four so it would need to be set to 3 (1 + 1 correct answer)
    			    if ((GUILD_MANAGER->query_can_do_wor_task_four(player)) != 2)
    			    {
    			        write(capitalize(player) + " has not completed task 4 yet!\n");
    			        return 1;
    			    }
    			}
			    
			    GUILD_MANAGER->set_can_do_ec_task_five(player, 1);
			    log_message = capitalize(player)
			        + " has been given permission to do task 5 for the Elemental Clerics "
			        + "by " + capitalize(this_player()->query_real_name())
			        + ".\n";
			    send_debug_message("ew_council", log_message);
			    COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
			...
			case 6:
				...
				if (!GUILD_MANAGER->query_is_worshipper(player))
			    {
    			    ...
    			    // One question in task four so it would need to be set to 2 (1 + 1 correct answer)
    			    if ((GUILD_MANAGER->query_can_do_wor_task_four(player)) != 2)
    			    {
    			        write(capitalize(player) + " has not completed task 4 yet!\n");
    			        return 1;
			    ...
			    // Two question in task five so it would need to be set to 3 (1 + 2 correct answers)
			    if ((GUILD_MANAGER->query_can_do_ec_task_five(player)) != 3)
			    {
			        write(capitalize(player) + " has not completed task 5 yet!\n");
			        return 1;
			    }
			    
			    GUILD_MANAGER->set_can_do_ec_task_six(player, 1);
			    log_message = capitalize(player)
			        + " has been given permission to do task 6 for the Elemental Clerics "
			        + "by " + capitalize(this_player()->query_real_name())
			        + ".\n";
			    send_debug_message("ew_council", log_message);
			    COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
...
do_resetone(string str)
{
    ...
    if (GUILD_MANAGER->query_can_do_ec_task_five(str))
    {
    	write(capitalize(str) + " has already been assigned task 5!\n");
        return 1;
    }
    
    if (GUILD_MANAGER->query_can_do_ec_task_six(str))
    {
    	write(capitalize(str) + " has already been assigned task 6!\n");
        return 1;
    }
...
do_resetfive(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("Who would you like to reset and allow to do task 5 again?\n");
        return 0;
    }
    ...
    if (!(GUILD_MANAGER->query_is_seeker(str)))
    {
        if (!GUILD_MANAGER->query_is_worshipper(str))
        {
            write(capitalize(str) + " is not a member of the Elemental Seekers or "+
                "Worshippers!\n");
            return 1;
        }
    }
    ...
    if (!GUILD_MANAGER->query_is_worshipper(str))
    {
        ...
        // One question in task four so it would need to be 
        // set to 2 (1 + 1 correct answer)
        if ((GUILD_MANAGER->query_can_do_wor_task_four(str)) != 2)
        {
            write(capitalize(str) + " has not completed task 4 yet!\n");
            return 1;
        }
    }			   
    ...
    GUILD_MANAGER->set_can_do_ec_task_five(str, 1);
    string log_message = capitalize(str)
        + " has been given permission to re-answer task 5 for the Elemental Clerics "
        + "by " + capitalize(this_player()->query_real_name())
        + ".\n";
    send_debug_message("ew_council", log_message);
    COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
...
do_resetsix(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("Who would you like to reset and allow to do task 6 again?\n");
        return 0;
    }
    ...
    // 2 questions in task 5 so it would need to be set to 3 (1 + 2 correct answers)
    if ((GUILD_MANAGER->query_can_do_ec_task_five(str)) != 3)
    {
        write(capitalize(str) + " has not completed task 5 yet!\n");
        return 1;
    }
           
    GUILD_MANAGER->set_can_do_ec_task_six(str, 1);
    GUILD_MANAGER->set_task_six_answer_one(str, 0);
    GUILD_MANAGER->set_task_six_answer_two(str, 0);
    GUILD_MANAGER->set_task_six_answer_three(str, 0);
    GUILD_MANAGER->set_task_six_answer_four(str, 0);
    GUILD_MANAGER->set_task_six_answer_five(str, 0);
    GUILD_MANAGER->set_task_six_answer_six(str, 0);
    string log_message = capitalize(str)
        + " has been given permission to re-answer task 6 for the Elemental Clerics "
        + "by " + capitalize(this_player()->query_real_name())
        + ".\n";
    send_debug_message("ew_council", log_message);
    COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
...
query_archa()
{
    string message = GUILD_MANAGER->query_ec_archon_apotheosis();
    write("The current Archon of Apotheosis is: "+capitalize(message)+"\n");
    return 1;
}

public int
set_archa(string str)
{
    if (!can_use_council_commands())
    {
        return 0;
    ...
    if (!str)
    {
        notify_fail("Set who as the Archon of Apotheosis?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_archon_apotheosis(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_archa()
{
    ...
    string message = GUILD_MANAGER->remove_ec_archon_apotheosis(TP->query_real_name());
    write(message);
    return 1;
}
...
query_archd()
{
    string message = GUILD_MANAGER->query_ec_archon_deliverance();
    write("The current Archon of Deliverance is: "+capitalize(message)+"\n");
    return 1;
}

public int
set_archd(string str)
{
    if (!can_use_council_commands())
    {
        return 0;
    ...
    if (!str)
    {
        notify_fail("Set who as the Archon of Deliverance?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_archon_deliverance(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_archd()
{
    ...
    string message = GUILD_MANAGER->remove_ec_archon_deliverance(TP->query_real_name());
    write(message);
    return 1;
}
...
query_archr()
{
    string message = GUILD_MANAGER->query_ec_archon_revelation();
    write("The current Archon of Revelation is: "+capitalize(message)+"\n");
    return 1;
}

public int
set_archr(string str)
{
    if (!can_use_council_commands())
    {
        return 0;
    ...
    if (!str)
    {
        notify_fail("Set who as the Archon of Revelation?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_archon_revelation(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_archr()
{
    ...
    string message = GUILD_MANAGER->remove_ec_archon_revelation(TP->query_real_name());
    write(message);
    return 1;
}
...
query_conservator()
{
    string message = GUILD_MANAGER->query_ec_conservator();
    write("The current Conservator of Armaments is: "+capitalize(message)+"\n");
    return 1;
}

public int
set_conservator(string str)
{
    if (!can_use_council_commands())
    {
        return 0;
    ...
    if (!str)
    {
        notify_fail("Set who as the Conservator of Armaments?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_conservator(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_conservator()
{
    ...
    string message = GUILD_MANAGER->remove_ec_conservator(TP->query_real_name());
    write(message);
    return 1;
}
...
query_cultivator()
{
    string message = GUILD_MANAGER->query_ec_cultivator();
    write("The current Cultivator of Life is: "+capitalize(message)+"\n");
    return 1;
}
...
set_cultivator(string str)
{
    ...
    if (!str)
    {
        notify_fail("Set who as the Cultivator of Life?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_cultivator(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_cultivator()
{
    ...
    string message = GUILD_MANAGER->remove_ec_cultivator(TP->query_real_name());
    write(message);
    return 1;
}
...
query_emissary()
{
    string message = GUILD_MANAGER->query_ec_emissary();
    write("The current Emissary is: "+capitalize(message)+"\n");
    return 1;
}
...
set_emissary(string str)
{
    ...
    if (!str)
    {
        notify_fail("Set who as the Emissary?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_emissary(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_emissary()
{
    ...
    string message = GUILD_MANAGER->remove_ec_emissary(TP->query_real_name());
    write(message);
    return 1;
}
...
query_illuminati()
{
    string message = GUILD_MANAGER->query_ec_illuminati();
    write("The current Illuminati is: "+capitalize(message)+"\n");
    return 1;
}
...
set_illuminati(string str)
{
    ...
    if (!str)
    {
        notify_fail("Set who as the Illuminati?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_illuminati(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_illuminati()
{
    ...
    string message = GUILD_MANAGER->remove_ec_illuminati(TP->query_real_name());
    write(message);
    return 1;
}
...
query_liberator()
{
    string message = GUILD_MANAGER->query_ec_liberator();
    write("The current Liberator of Souls is: "+capitalize(message)+"\n");
    return 1;
}
...
set_liberator(string str)
{
    ...
    if (!str)
    {
        notify_fail("Set who as the Liberator of Souls?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_liberator(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_liberator()
{
    ...
    string message = GUILD_MANAGER->remove_ec_liberator(TP->query_real_name());
    write(message);
    return 1;
}
...
query_luminary()
{
    string message = GUILD_MANAGER->query_ec_luminary();
    write("The current Luminary of the Elementalists is: "+capitalize(message)+"\n");
    return 1;
}
...
set_luminary(string str)
{
    ...
    if (!str)
    {
        notify_fail("Set who as the Luminary of the Elementalists?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_luminary(str, TP->query_real_name());
	write(message);
    return 1;
}
...
rem_luminary()
{
    ...
    string message = GUILD_MANAGER->remove_ec_luminary(TP->query_real_name());
    write(message);
    return 1;
}
...
query_children()
{
    ...
    string * children = GUILD_MANAGER->query_all_children();
    if (sizeof(children) == 0)
    {
        message = "There are currently no Child Clerics.\n";
    }
    else if (sizeof(children) == 1) 
    {
        message = "There is currently one Child Cleric: " 
            + capitalize(children[0]) + ".\n";
    }
    else
    {
        message = "There are currently the following Child Clerics: ";
        message += (COMPOSITE_WORDS(map(children, capitalize)) + ".\n"); 
    }
...
query_masters()
{
    ...
    string * masters = GUILD_MANAGER->query_all_masters();
    if (sizeof(masters) == 0)
    {
        message = "There are currently no Master Clerics.\n";
    }
    else if (sizeof(masters) == 1) 
    {
        message = "There is currently one Master Cleric: " 
            + capitalize(masters[0]) + ".\n";
    }
    else
    {
        message = "There are currently the following Master Clerics: ";
        message += (COMPOSITE_WORDS(map(masters, capitalize)) + ".\n"); 
    }
...
query_fullmasters()
{
    ...
    string * fullmasters = GUILD_MANAGER->query_all_fullmasters();
    if (sizeof(fullmasters) == 0)
    {
        message = "There are currently no Full Master Clerics.\n";
    }
    else if (sizeof(fullmasters) == 1) 
    {
        message = "There is currently one Full Master Cleric: " 
            + capitalize(fullmasters[0]) + ".\n";
    }
    else
    {
        message = "There are currently the following Full Master Clerics: ";
        message += (COMPOSITE_WORDS(map(fullmasters, capitalize)) + ".\n"); 
    }
...
query_elders()
{
    ...
    string * elders = GUILD_MANAGER->query_all_elders();
    if (sizeof(elders) == 0)
    {
        message = "There are currently no Elder Clerics.\n";
    }
    else if (sizeof(elders) == 1) 
    {
        message = "There is currently one Elder Cleric: " 
            + capitalize(elders[0]) + ".\n";
    }
    else
    {
        message = "There are currently the following Elder Clerics: ";
        message += (COMPOSITE_WORDS(map(elders, capitalize)) + ".\n"); 
    }
...
query_racials()
{
    ...
    string * racials = GUILD_MANAGER->query_all_racials();
    if (sizeof(racials) == 0)
    {
        message = "There are currently no Racial Clerics.\n";
    }
    else if (sizeof(racials) == 1) 
    {
        message = "There is currently one Racial Cleric: " 
            + capitalize(racials[0]) + ".\n";
    }
    else
    {
        message = "There are currently the following Racial Clerics: ";
        message += (COMPOSITE_WORDS(map(racials, capitalize)) + ".\n"); 
    }
...
set_focus(string str)
{
    ...
    if (!str)
    {
        notify_fail("Set who as the Elementalist Focus?\n");
        return 0;
    }
	...
	string message = GUILD_MANAGER->set_ec_focus(str,TP->query_real_name());
	write(message);
    return 1;
}
...
rem_focus()
{
    ...
    string message = GUILD_MANAGER->remove_ec_focus(TP->query_real_name());
    write(message);
    return 1;
}
...
do_allowswitch(string str)
{
    ...
    string log_message = capitalize(str)
            ...
            + "by " + capitalize(this_player()->query_real_name())
            + ".\n";
    send_debug_message("ec_council", log_message);
    COUNCIL_LOG_BOOK->update_log_book(my_time() + log_message);
...
init()
{
    ...
    add_action(query_archa, "archa");
    add_action(query_archd, "archd");
    add_action(query_archr, "archr");
    add_action(set_archa, "setarcha");
    add_action(set_archd, "setarchd");
    add_action(set_archr, "setarchr");
    add_action(rem_archa, "remarcha");
    add_action(rem_archd, "remarchd");
    add_action(rem_archr, "remarchr");
    add_action(query_conservator, "conservator");
    add_action(query_cultivator, "cultivator");
    add_action(query_emissary, "emissary");
    add_action(query_illuminati, "illuminati");
    add_action(query_liberator, "liberator");
    add_action(query_luminary, "luminary");
    add_action(set_conservator, "addcon");
    add_action(set_cultivator, "addcul");
    add_action(set_emissary, "addemi");
    add_action(set_illuminati, "addill");
    add_action(set_liberator, "addlib");
    add_action(set_luminary, "addlum");
    add_action(rem_conservator, "remcon");
    add_action(rem_cultivator, "remcul");
    add_action(rem_emissary, "rememi");
    add_action(rem_illuminati, "remill");
    add_action(rem_liberator, "remlib");
    add_action(rem_luminary, "remlum");
    ...
    add_action(record_player_discharged, "discharge");
    ...
    add_action(do_resetfive, "reset5");
    add_action(do_resetsix, "reset6");
    ...
    add_action(query_children, "children");
    add_action(query_masters, "masters");
    add_action(query_fullmasters, "fullmasters");
    add_action(query_elders, "elders");
    add_action(query_racials, "racials");

/*
 * Startroom for the Followers of Psuchae in the Elemental Temple of Calia
 * 
...
describe_long()
{
    ...
    return "This is the sleeping quarters for all who are guided by "
        + "Psuchae. You notice rows of beds along the eastern and "
        + "western walls. Each bed is separated by its own small "
        ...
        + "above. You sense the feeling that Psuchae is watching "
        + "over you, allowing you a peaceful rest. To the south, "
...
create_temple_room()
{
    set_short("Bunkroom for the Servants of Psuchae");
    set_long("@@describe_long@@");
    
    try_item( ({ "beds", "bed", "rows of beds", "rows", "row of beds",
                 "row", "eastern wall", "western wall",
                 "wood", "petrified wood" }),
    ...
    add_exit(ELEMENTALIST_TEMPLE + "psuchae", "south");
}

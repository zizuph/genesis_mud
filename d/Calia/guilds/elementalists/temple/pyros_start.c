/*
 * Startroom for the Followers of Pyros in the Elemental Temple of Calia
 * 
 * Created by Petros, April 2010
 * TT comment - removed reference to the dome, since the dome does not cover this part of the temple.
 * added a ceiling desc
 * Moved room to fit actual place on pentagram - Jaacar, June 2016
 */
 
 /* 
  * Spelling and grammatical updates by Leia
  * February 2016
  */
...
describe_long()
{
    ...
    return "This is the sleeping quarters for all who are guided by "
        + "Lord Pyros. You notice rows of beds along the northern and "
        ...
        + "above. You sense the feeling that Lord Pyros is watching "
        + "over you, allowing you a peaceful rest. To the northwest, "
...
create_temple_room()
{
    set_short("Bunkroom for the Servants of Pyros");
    ...
    add_exit(ELEMENTALIST_TEMPLE + "pyros", "northwest");
}

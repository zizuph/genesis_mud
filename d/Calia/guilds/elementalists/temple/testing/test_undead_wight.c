...
{
    set_name("wight");
    set_short("basic undead wight");
    set_adj("basic");
    add_adj("undead");
    set_race_name("wight");
    set_long("This is an undead wight for EC beta testers. It has myth-base stats, " +
    ...
    set_default_answer("The test wight cannot communicate with you.\n");
}  

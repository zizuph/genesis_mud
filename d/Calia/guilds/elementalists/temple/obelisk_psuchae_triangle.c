...
create_room() 
{
    ...
    add_exit(ELEMENTALIST_TEMPLE+"obelisk_ante","south","@@check_spiritform",1,1);
...
statue_desc()
{
    ...
    statue_desc = "It is a small statue of Psuchae. It seems ";
...
can_see()
{
    ...
    desc += "passage leading to the south into the darkness. ";
...
do_insert(string str)
{
    ...
    write("You place the black triangle into the notch. The triangle "+

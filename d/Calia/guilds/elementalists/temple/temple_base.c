...
public int
cannot_see_worshipper_floor_punished()
{
    if (this_player()->query_guild_name_lay() == "Elemental Worshippers of Calia"
        || this_player()->query_guild_name_occ() == "Spirit Circle of Psuchae"
        || this_player()->query_guild_name_lay() == "Elemental Seekers of Calia"
        || this_player()->query_guild_name_occ() == "Elemental Clerics of Calia")
    {
        if (!GUILD_MANAGER->query_is_punish_resource_banned(this_player()))
            // Allow non-resource banned seekers, worshippers and scop to enter 
            // the worshipper floor
            return 0;
    }
...
public int
cannot_enter_worshipper_floor_punished()
{
    if (!cannot_see_worshipper_floor_punished())
    {
        notify_wizard_of_restricted_access();
        return 0;
    }
...
cannot_see_cleric_floor()
{
    ...
    {
        if (!GUILD_MANAGER->query_is_punish_resource_banned(this_player()))
            // Allow non-resource banned scop/clerics to enter this floor
            return 0;
    }
...
public int
cannot_see_restrict_seekers_punished()
{
    if (this_player()->query_guild_name_lay() == "Elemental Worshippers of Calia"
        || this_player()->query_guild_name_occ() == "Spirit Circle of Psuchae"
        || this_player()->query_guild_name_occ() == "Elemental Clerics of Calia")
    {
        if (!GUILD_MANAGER->query_is_punish_resource_banned(this_player()))
            // Allow non-resource banned worshippers and scop/clerics to enter 
            // the floor, no seekers
            return 0;
...
public int
cannot_enter_restrict_seekers_punished()
{
    if (!cannot_see_restrict_seekers_punished())
    {
        notify_wizard_of_restricted_access();
        return 0;
    }

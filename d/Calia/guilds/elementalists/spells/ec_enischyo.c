/*
 * Magic weapon enhancer spell for the Elemental Clerics of Calia
 *
...
config_shadow_spell()
{
    set_spell_name("enischyo");
    set_spell_desc("Empowering prayer");
    ...
    // Spell effect object
    set_shadow_filename(ELEMENTALIST_SPELL_OBJS + "enischyo_sh");
}
...
check_valid_action(object caster, mixed * targets, string arg, int execute = 0)
{
    ...
    {
        caster->catch_tell("You can only cast this prayer on hammers or clubs.\n");
        return 0;
    }
...
query_spell_can_be_learned(object player)
{
    ...
    if (player->query_stat(SS_LAYMAN) < SPELL_MINIMUM_GSTAT_CLERIC_ENISCHYO)
    {
        return 0;
    }
    return 1;
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    caster_message = "You pray through the ancient chant of enischyo "
        + "to Psuchae.\n";
    ...
    if (caster != targets[0])
    {
    	target_message = "With a lifting motion of their arms, "+
    	    QCTNAME(caster)+" calls out to Psuchae to grant you "+
    	    "empowerment of your prayers.\n";
    	watcher_message += "With a lifting motion of their arms, "+
    	    QCTNAME(caster)+" calls out to Psuchae.\n";
...
{
    write("You renew your efforts to empower your prayers!\n");
}

/*
 * Damage Mentals (Mana Damage) Spell for the Elemental Cleric Guild of Calia
 *
 ...
 * Description: Config function for harm_mana spells. Redefine this in your
 *              own harm_mana spells to override the defaults.
...
{
    set_spell_name("ilithios");
    set_spell_desc("Damage mentals");
...
query_spell_can_be_learned(object player)
{
    ...
    if (player->query_stat(SS_LAYMAN) < SPELL_MINIMUM_GSTAT_CLERIC_ILITHIOS)
    {
        return 0;
    }
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    string caster_message, watcher_message;
        ...
        caster_message = "You close your eyes briefly in prayer to Psuchae "+
 ...
 * Description: When it is not possible to harm_mana, for whatever reason,
 *              this message is given.
 * Arguments:   caster - person casting the spell
 *              target - the person being harm_manaed
 */
public void

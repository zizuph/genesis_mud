...
config_disarm_spell()
{
    set_spell_name("eousiaaeras");
    set_spell_desc("Syndyasmos Air + Spirit Combination");
...
/*
 * Function name : resolve_disarm_resisted
...
hook_describe_disarm(object caster, mixed * targets, int result)
{
    ...
    target_message = QCTNAME(caster) + " extends " + 
		...
		partner_ob->query_pronoun()+" does so, a wave of shadowy energy "+
		"shoots "+

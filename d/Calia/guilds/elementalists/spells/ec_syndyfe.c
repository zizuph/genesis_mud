/*
 * Syndyasmos Fire + Earth combination spell the 
...
{
    set_spell_name("fotiagi");
    set_spell_desc("Syndyasmos Fire + Earth Combination");
    ...
    {        
        ...
        case 41..65:
            target_message = "A large streak of fire strikes your " + 
                ...
                "you, causing "
                + "scorching pain.\n";
            watcher_message = "A large streak of fire strikes " + QTNAME(target) + " on the "
...
desc_harm_cast(object caster, object * targets)
{
    ...
    else
    {
        ...
        caster_message = "A fireball forms in your hand. A ball of earth "+
        	"forms in "+
            QTPNAME(partner_ob)+" hand. You and "+partner_name+" push "+
            "your hands out "+
            "towards each other causing the fireball and ball of earth "+
            ...
            ", leaving trails of "+
            "dust in "+go_plural2+" wake.\n";
        partner_message = "A ball of earth forms in your hand. "+
        	"A fireball forms in "+

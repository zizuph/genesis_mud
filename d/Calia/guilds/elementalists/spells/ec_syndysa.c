/*
 * Syndyasmos Spirit + Air combination spell the 
...
config_stun_spell()
{
    set_spell_name("epnevmaaera");
    set_spell_desc("Syndyasmos Spirit + Air Combination");
    ...
    set_spell_object(ELEMENTALIST_SPELL_OBJS + "syndyasmos_stun_obj_air");

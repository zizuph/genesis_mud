...
config_disarm_spell()
{
    set_spell_name("epyrkagia");
    set_spell_desc("Syndyasmos Air + Fire Combination");
...
{
    string caster_message, target_message, watcher_message, partner_message;
    string partner_name, caster_name;
    object partner_ob;
    ...
    target_message = QCTNAME(caster) + " extends " + 
		...
		partner_ob->query_pronoun()+" does so, a wave of fiery energy shoots "+

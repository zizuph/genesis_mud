/*
 * Stoneskin Spell for the Elemental Cleric Guild of Calia
 *
...
#define MAX_CAID          (BASE_ASPIDA_AID + ELEFRINISI_AID + \
...
{
    set_spell_name("aspida");
    set_spell_desc("Stoneskin");
    ...
    // Spell effect object
    set_spell_object(ELEMENTALIST_SPELL_OBJS + "aspida_obj");
...
query_spell_combat_aid_modifier()
{
    ...
    // DEBUG("Aspida available_combat_aid: " +ftoi(available_combat_aid));
    // DEBUG("Aspida max potential combat aid: " +ftoi(total_combat_aid));
...
query_spell_can_be_learned(object player)
{
    ...
    if (player->query_stat(SS_LAYMAN) < SPELL_MINIMUM_GSTAT_CLERIC_ASPIDA)
    {
        return 0;
    }
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    caster_message = "You close your eyes and concentrate on "+
        "the powers granted to you by Lady Gu.\n";
...
{
    write("You are already protected by the aspida prayer!\n");
}

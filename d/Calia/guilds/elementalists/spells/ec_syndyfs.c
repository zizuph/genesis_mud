/*
 * Syndyasmos Fire + Spirit combination spell the 
...
{
    set_spell_name("pyrosousia");
    set_spell_desc("Syndyasmos Fire + Spirit Combination");
    ...
    {        
        ...
        case 11..25:
            ...
            watcher_message = QCTNAME(target) + " turns " 
                ...
                + ", but " + target->query_pronoun() + " is unable to keep "+
                "it "
...
desc_harm_cast(object caster, object * targets)
{
    ...
    else
    {
        ...
        caster_message = "A fireball forms in your hand. A ball of "+
        	"shadows forms in "+
            QTPNAME(partner_ob)+" hand. You and "+partner_name+
            " push your hands out "+
            "towards each other causing the fireball and ball of "+
            "shadows to fly at one another, "+
            "colliding in a violent explosion. Streaks of fire "+
            "from the explosion fly "+
            "off in the direction of " + COMPOSITE_LIVE(targets) + 
            ", leaving trails of "+
            "shadowy essence in "+go_plural2+" wake.\n";
        partner_message = "A swirl of air forms in your hand. "+
        	"A ball of shadows forms in "+
            QTPNAME(caster)+" hand. You and "+caster_name+
            " push your hands out "+
            "towards each other causing the fireball and ball of "+
            "shadows to fly at one another, "+
            "colliding in a violent explosion. Streaks of fire from "+
            "the explosion fly "+
            "off in the direction of " + COMPOSITE_LIVE(targets) + 
            ", leaving trails of "+
            "shadowy essence in "+go_plural2+" wake.\n";
        target_message = "A large fireball forms in "+QTPNAME(caster)+ 
        	" hand. A ball "+
            "of shadows forms in "+QTPNAME(partner_ob)+" hand. "+
            QCTNAME(caster)+" and "+
            QTNAME(partner_ob)+" push their hands out towards each "+
            "other causing the "+
            "fireball and ball of shadows to fly at one another, "+
            "colliding in a violent explosion. "+
            "Streaks of fire from the explosion fly right towards "+
            "you, leaving trails of "+
            "shadowy essence in its wake!\n";

        watcher_message = "A fireball forms in "+QTPNAME(caster)+ 
        	" hand. A ball of shadows "+
            "forms in "+QTPNAME(partner_ob)+" hand. "+QCTNAME(caster)+
            " and "+QTNAME(partner_ob)+
            " push their hands out towards each other causing the "+
            "fireball and ball of shadows to fly at "+
            "one another, colliding in a violent explosion. Streaks "+
            "of fire from the explosion "+
            "fly right towards " + COMPOSITE_LIVE(targets) + 
            ", leaving trails of shadowy essence in "+
            go_plural2+" wake.\n";

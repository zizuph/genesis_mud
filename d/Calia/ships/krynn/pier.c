/* Pier in Calia, for the Krynn ship.
   ...
   Coded by Maniac. 5/7/95, revised 18/3/97, Maniac
*/

#pragma save_binary

inherit "/std/room";
inherit "/d/Calia/ships/lib/pier";
...
create_room()
{
	...
	set_long("The wooden pier extends out from the docks "+
	    "and is clearly a place where ships land. This " +
            "pier is special, it extends and then forks out into two " +
            "branches, which are landing bays that go on either side of " +
            "the incoming ship. The landing bays have peculiar serrated " +
            "stonework. The whole thing has the appearance of a giant " +
            "nutcracker.\n");
...
*/
	...
	add_exit("/d/Calia/mountain/road/road23", "east");

    set_ship_line("Calia/Krynn", SHIPS+"ship.c",
        "Shipline between Palanthas in Krynn and Gelan in Calia");

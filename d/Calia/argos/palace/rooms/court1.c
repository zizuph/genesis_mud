...
void create_room() {
   ...
   add_item(({"bark","branches"}),
      "The black bark of the branches of the trees are laden with "+
      "red cherries.\n");
   add_item("leaves",
   ...
   add_item("statue",
      ...
      "extravagant jewelled robes. He has several rings on his hands "+
      "which clutch a long scepter. He has an elaborate crown with "+
      "three jewels on his head, and a condescending look about "+
   ...
   add_item(({"sides","palace","walls"}),
      ...
      "the courtyard to the south and west. Divided into enormous "+

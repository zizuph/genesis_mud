...
create_room()
{
    ...
    set_exit_desc(3, "east, southeast and north");
    
    make_me_forest(extra_long, loc_type, cliffs);
    
    add_exit(SFDIR + "forest01x08.c", "north", 0, FOREST_FATIGUE,
        EXITNOTOBVIOUS);
    add_exit(SFDIR + "forest02x07.c", "east", 0, FOREST_FATIGUE,
        EXITNOTOBVIOUS);
    add_exit(SFDIR + "forest02x06.c", "southeast", 0, FOREST_FATIGUE,
        EXITNOTOBVIOUS);
}

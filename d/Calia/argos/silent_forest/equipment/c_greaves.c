/*   c_greaves.c
 *
 *  The crystal greaves, a pretty good pair 
...
create_armour()
{
    set_name("greaves");
    set_adj("crystal");
    set_short("pair of crystal greaves"); 
    set_pshort("pairs of crystal greaves"); 
    set_long("This pair of greaves, made of pure crystal is heavily "+

...
void create_room() {
   ...
   set_long(
       "You are standing in a niche of an olive grove, the trees set "+
       "in neat rows all around you laden with fruit. A fence borders "+
       "the grove to the north and west, over which you see a dirt "+
   ...
   /* exits */
   add_exit(ROOM_DIR+"ogrove6","south",0);
   reset_room();
}

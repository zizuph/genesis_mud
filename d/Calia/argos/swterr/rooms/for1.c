...
create_room()
{
   ...
   set_long(break_string(
       ...
       "forest.  Black mahogany trees loom over you, as if they are " +
       ...
       "south into the forest, while you see a dirt road to the " +
       "northeast.\n",70));
    ...
    /* exits */
    add_exit(ROOM_DIR+"r19","northeast",0);
    add_exit(ROOM_DIR+"for4","south",0);
}

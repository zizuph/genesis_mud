...
**   11/18/95   Zima       Recoded lamps to act as Gondorian lamps
**
...
**   Players can buy sheep shears here, needed to shear sheep in
**      pastures (nwterr/rooms/pastX.c) to solve Grandma Quest
*/
/* inherits/includes */
inherit "/std/room";
...
void create_room() {
   ...
   set_long(
       ...
       "brass lamps, next to which a sign hangs on the wall. "+
...
int buy(string Parms) {
   ...
   if (member_array("lamp",Parm) > -1) {
      ObjName="oil lamp";
      FileName="oil_lamp";
      keeper->command("say You'll need a flask of olive oil to fuel that.");
      ObjCost=-150;
   }

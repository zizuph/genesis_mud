...
create_room() {
   ...
   set_long(
      ...
      "on the inner wall to the west, while a smaller passageway leads "+
      "to the east. The inner corridor circles to the northwest and "+
      "the southwest.\n");
   ...
   add_item("window","It is a small arched window on the western "+
   ...
   add_exit(ROOM_DIR+"corr24", "northwest", 0);
   add_exit(ROOM_DIR+"corr22", "southwest", 0);
   add_exit(ROOM_DIR+"corr28", "east", 0);
}

...
create_room() {
   ...
   set_long(break_string(
    ...
    add_item("desk", break_string(
      "A long desk fashioned of thick boards of polished mahogany from " +
    ...
    add_item("chair", break_string(
       ...
       "mahogany and detailed with hemlock leaves. It is upholstered " +
    ...
    add_cmd_item(({"scrolls","scroll"}), "read",
       break_string(
    ...
    add_item("sofa", break_string(
       ...
       "who must sit there.\n",70));
    add_cmd_item(({"sofa","on sofa"}), "sit", break_string(
    ...
    add_item("tapestry", break_string(
       ...
       "There is a sash draped from the top corners " +

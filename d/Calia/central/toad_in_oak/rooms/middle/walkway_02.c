/*
 * /d/Calia/central/toad_in_oak/rooms/middle/walkway_02.c
 *
...
{
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_03",    "east"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_01",    "west"); 
}

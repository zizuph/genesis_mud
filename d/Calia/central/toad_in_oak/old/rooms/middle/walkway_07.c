/*
 * /d/Calia/central/toad_in_oak/rooms/middle/walkway_07.c
 *
...
create_tio_middle_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_06", "northeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "workshop", "southeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_08", "south"); 

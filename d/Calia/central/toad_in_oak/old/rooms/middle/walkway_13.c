/*
 * /d/Calia/central/toad_in_oak/rooms/middle/walkway_13.c
 *
...
create_tio_middle_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_01", "northeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_12", "south"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_17", "down"); 

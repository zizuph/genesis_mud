/*
 * /d/Calia/central/toad_in_oak/rooms/middle/walkway_08.c
 *
...
create_tio_middle_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_07", "north"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_09", "west"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_10", "down"); 

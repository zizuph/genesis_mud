/*
 * /d/Calia/central/toad_in_oak/rooms/middle/walkway_09.c
 *
...
create_tio_middle_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_08", "east"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_10", "northwest"); 

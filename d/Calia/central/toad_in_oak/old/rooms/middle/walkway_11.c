/*
 * /d/Calia/central/toad_in_oak/rooms/middle/walkway_11.c
 *
...
create_tio_middle_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_12", "north"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_10", "southeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "animal_trainer", "west"); 

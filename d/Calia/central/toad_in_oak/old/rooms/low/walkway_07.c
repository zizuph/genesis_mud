/*
 * /d/Calia/central/toad_in_oak/rooms/low/walkway_07.c
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_06", "north"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "tailor", "east"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_08", "south"); 

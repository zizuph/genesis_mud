/*
 * /d/Calia/central/toad_in_oak/rooms/low/walkway_10.c
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_09", "northeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_11", "northwest"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_08", "up");
    add_exit( TOAD_IN_OAK_ROOMS_GROUND + "path_06", "down"); 

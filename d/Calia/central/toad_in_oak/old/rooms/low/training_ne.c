/*
 * /d/Calia/central/toad_in_oak/rooms/low/training_ne.c
 *
 * This is the northeast corner of the villages training area. 
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_18", "southeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_se", "south"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_sw", "southwest"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_nw", "west"); 

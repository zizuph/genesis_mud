/*
 * /d/Calia/central/toad_in_oak/rooms/low/training_se.c
 *
 * This is the southeast corner of the villages training area. 
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_ne", "north"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_sw", "west"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_nw", "northwest"); 

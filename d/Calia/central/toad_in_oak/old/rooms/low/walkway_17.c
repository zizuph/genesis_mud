/*
 * /d/Calia/central/toad_in_oak/rooms/low/walkway_17.c
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_18", "northeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_16", "south"); 
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_13", "up"); 
    add_exit( TOAD_IN_OAK_ROOMS_GROUND + "path_02", "down"); 

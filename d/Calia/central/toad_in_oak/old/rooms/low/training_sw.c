/*
 * /d/Calia/central/toad_in_oak/rooms/low/training_sw.c
 *
 * This is the southwest corner of the villages training area. 
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_nw", "north"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_ne", "northeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_se", "east"); 

/*
 * /d/Calia/central/toad_in_oak/rooms/low/walkway_05.c
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_06", "southwest"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_04", "northwest");
    add_exit( TOAD_IN_OAK_ROOMS_MIDDLE + "walkway_04", "up"); 
    add_exit( TOAD_IN_OAK_ROOMS_GROUND + "flowers_east", "down"); 

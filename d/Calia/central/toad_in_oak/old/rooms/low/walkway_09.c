/*
 * /d/Calia/central/toad_in_oak/rooms/low/walkway_09.c
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_08", "northeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_10", "southwest"); 

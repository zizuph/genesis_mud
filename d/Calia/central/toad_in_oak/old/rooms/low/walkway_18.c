/*
 * /d/Calia/central/toad_in_oak/rooms/low/walkway_18.c
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_01", "northeast"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_17", "southwest"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "training_ne", "northwest"); 

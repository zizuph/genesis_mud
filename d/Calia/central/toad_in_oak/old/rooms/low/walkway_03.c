/*
 * /d/Calia/central/toad_in_oak/rooms/low/walkway_03.c
 *
...
create_tio_low_room()
{
    ...
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "restaurant", "northeast");  
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_04", "east"); 
    add_exit( TOAD_IN_OAK_ROOMS_LOW + "walkway_02", "northwest"); 

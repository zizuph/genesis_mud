...
{
    set_name("rapier");
    set_adj("ornamented", "average", "steel", "sword");
    set_short("ornamented steel rapier");
    set_pshort("ornamented steel rapiers"); 
    set_long("This is a long, slender sword designed for " +
        "thrusting and slashing. It's a work of art, created " +
...
// PROPERTIES
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_WEAPON(20,20));
    add_prop(OBJ_I_VOLUME, query_prop(OBJ_I_WEIGHT));
    add_prop(OBJ_I_VALUE, F_VALUE_WEAPON(20, 20)*2);

...
//        DOME_ROOMS + trail03
    ...
    /*  Calia Domain
        ...
        PURPOSE
        This is the east end of a small trail leading up to
...
create_room()
{
    ...
    set_short("Eastern end of Bloodstone trail");
   ...
   /* TELLS */
     ...
     add_tell("You hear wind rustling through the leaves.\n");
     add_tell("A chill mountain breeze blows against you.\n");
     add_tell("You hear the faint sound of falling rocks.\n");

    /* EXITS */

    add_exit("trail02", "west", 0, 20);
    add_exit("plateau01", "east", 0, 05);

...
create_room()
{
    ...
    set_long("You are standing on a well-trodden pathway" +
        ...
        " your north. To your south lies a small hut.\n");
    ...
    add_item(({"frothing river","river"}),"It's moving quite fast, and is" +
        ...
        " forest continues.\n");
    add_item(({"hut","small hut"}),"This small building, made out of oak" + 
        " branches, has a fur draped in front of the entrance preventing" + 
        " you from seeing inside.\n");
    add_item("fur","It's probably from some kind of wolf or bear.\n");
    ...
    add_exit(VILLAGE+"village_path11","west",0,1);
    add_exit(VILLAGE+"village_path13","east",0,1);
    add_exit(VILLAGE+"village_home6","in",0,1);
}

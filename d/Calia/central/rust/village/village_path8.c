...
create_room()
{
    ...
    set_long("You are standing on a well-trodden pathway" +
        ...
        " A hut you can enter lies west." +
        " You can hear also clearly hear the sound of a rushing river," +
        " from the north.\n");
    ...
    add_exit(VILLAGE+"village_home4","in",0,1);
    add_exit(VILLAGE+"village_path7","south",0,1);
    add_exit(VILLAGE+"village_path9","north",0,1);
}

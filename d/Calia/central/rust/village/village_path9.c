...
create_room()
{
    ...
    set_long("You are standing on a well-trodden pathway" +
        ...
        " The path bends here, leading east and south, and you are" +
        " standing close to the bank of a frothing river, to your north." +
        " A hollow tree, that you could enter, lies southwest.\n");
    ...
    add_item(({"frothing river","river"}),"It's moving quite fast, and is" +
        ...
        " forest continues.\n");
    add_item(({"tree","hollow tree"}),"It's a large and old tree, and unlike" +
        " most dwellings in this village, the opening is not covered up.\n");
    add_item("opening", "It appears to lead into a dimly lit shop.\n");
    ...
    add_exit(VILLAGE+"village_path8","south",0,1);
    add_exit(VILLAGE+"village_store","in",0,1);
    add_exit(VILLAGE+"village_path10","east",0,1);
}

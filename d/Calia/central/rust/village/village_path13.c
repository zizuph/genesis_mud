...
create_room()
{
    ...
    set_long("You are standing on a well-trodden pathway" +
        ...
        " your north. You can enter a hut to the east." +
        " The path bends here, leading south and west.\n");
    ...
    add_item("village", "It's too small by far to be called a" +
        " town.\n");
    ...
    add_item(({"frothing river","river"}),"It's moving quite fast, and is" +
        ...
        " fish to manage the swim over to the other bank, where the" +
        " great forest continues.\n");
    add_item(({"hollow trees"}),"You have to move" +
        " further into the village to get a look.\n");
    add_item("hut","It's a moderately sized hut, with a fur to" +
        " cover the opening.\n");
    add_item("opening","It's covered up, so you can't see inside." +
        "\n");
    ...
    add_exit(VILLAGE+"village_path12","west",0,1);
    add_exit(VILLAGE+"village_path14","south",0,1);
    add_exit(VILLAGE+"village_alchemist","in",0,1);
}

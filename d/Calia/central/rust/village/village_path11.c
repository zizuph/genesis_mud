...
create_room()
{
    ...
    set_long("You are standing on a well-trodden pathway" +
        ...
        " your north. A great hollow tree leans precariously out over" +
    ...
    add_item(({"frothing river","river"}),"It's moving quite fast, and is" +
        ...
        " forest continues.\n");
    add_item(({"great tree","great hollow tree","hollow tree","tree"}), "" +
        "This big tree is leaning rather precariously out over the river." +
        " The opening is covered with a large fur.\n");
    ...
    add_exit(VILLAGE+"village_path10","west",0,1);
    add_exit(VILLAGE+"village_path12","east",0,1);
    add_exit(VILLAGE+"village_home5","in",0,1);
}

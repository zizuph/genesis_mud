...
{
    set_name("icicle");
    add_name(ICICLE_NAME);
    set_long("A little icicle on your clothing, it seems to be " +
             "gradually turning into water. It looks rather unusual, " +
             "perhaps magical.\n");
    ...
    set_alarm(1800.0, 0.0, "become_water");
}
...
become_water()
{
    ...
    if (interactive(tp)) 
        tp->catch_msg("The " + short() + " turns into water " +
                      "and is absorbed into your clothing.\n");

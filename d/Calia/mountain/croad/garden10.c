// ROOM:  palace garden 10

    /* Calia Domain

    HISTORY

    [96-02-26] Created by Uhclem from [C:\CALIA\MOUNTAIN\CROAD\GARDEN10.DOC].
...
create_room()
    ...
    set_long("Here a decorative wall has been built " +
        ...
        "between the wall to your east and the palace to your west, " +
        ...
        "to the northwest where it leads through a rose trellis.\n");

    /*  EXITS  */

    add_exit(CROAD + "garden9", "northwest", 0);
    add_exit(CROAD + "garden11", "south", 0);

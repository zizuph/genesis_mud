// ROOM:  palace garden 6

    /* Calia Domain

    HISTORY

    [96-02-25] Created by Uhclem from [C:\CALIA\MOUNTAIN\CROAD\GARDEN6.DOC].
...
create_room()
    ...
    set_long("This is the west end of the formal gardens, bounded " +
    ...
    add_exit(CROAD + "garden5", "west", 0);
    add_exit(CROAD + "garden7", "east", 0);

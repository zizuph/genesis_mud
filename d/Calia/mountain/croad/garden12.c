// ROOM:  palace garden 12

    /* Calia Domain

    HISTORY

    [96-02-23] Created by Uhclem from [C:\CALIA\MOUNTAIN\CROAD\GARDEN12.DOC].
...
create_room()
    ...
    add_exit(CROAD + "garden13", "southwest", 0);
    add_exit(CROAD + "garden11", "northeast", 0);

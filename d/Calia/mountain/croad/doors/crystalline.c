...
create_door()
{
    ...
    set_other_room(ROOM("light_entrance"));
    set_pass_command( ({ "enter", "north", "s" }) );
    set_fail_pass("The doors are closed.\n");
    set_pick(49);
    set_open(0);
    set_open_desc("There are crystalline double doors leading north "+
       "into the palace.\n");
    ...
    set_closed_desc("There are crystalline double doors leading north which " +
	"are closed.\n");
    ...
    set_locked(0);
    set_lock_name("lock");
    set_lock_desc("The lock is large and is made of crystal.\n");

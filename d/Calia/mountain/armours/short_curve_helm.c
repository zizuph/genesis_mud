...
/* 	
    Helm with short curved horns, for the regular krougs 
...
set_up_desc(string c)
{
    ...
    set_short("helm with two short curved " + my_colour + " horns");
    set_pshort("helms with two short curved " + my_colour + " horns");

    set_long("A steel helm with two short, curved " + my_colour + " " +
         "horns sticking out " +   
...
create_armour()
{
    ...
    set_name("helmet");
    add_name("helm");
    set_adj(({"horned", "short-horned", "curve-horned"}));

...
create_room()
{
    ...
    add_exit(FOOTHILL+"fh77", "north");
    add_exit(FOOTHILL+"fh78", "northeast");
    add_exit(FOOTHILL+"fh88", "east");
    add_exit(FOOTHILL+"fh101", "southeast");
    add_exit(FOOTHILL+"fh100", "south");
    add_exit(FOOTHILL+"fh99", "southwest");
    add_exit(FOOTHILL+"fh86", "west");

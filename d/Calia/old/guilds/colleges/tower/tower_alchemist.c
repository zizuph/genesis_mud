...
inherit "/d/Calia/guilds/colleges/tower/objects/ashop_list";
...
#define STORE_ROOM "/d/Calia/guilds/colleges/tower/tower_alchemist_store"
...
{
    sk_add_train(SS_ALCHEMY, "mix and identify potions", "alchemy",
        100, 60, SS_INT, 40);
}
...
create_room()
{
    ...
    clerk = clone_object(TOWER_NPCS + "alchemist_clerk");
...
enter_inv(object ob, object from)
{
    ...
    if (strlen(ob->is_college_member()))
    {
        ...
        if (ob->query_skill(SS_COLLEGE_BITS) & ALCHEMY_CHOSEN_BIT)
        {
            maxtrain = 60;
        }
        else
...
{
    notify_fail("You fail to adopt what Nagor teaches you.\n");
    return 0;
}
...
{
    write("You cannot improve further with Nagor's aid. Perhaps you" +

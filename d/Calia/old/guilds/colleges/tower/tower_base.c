...
static string corridor_desc = "You stand in a corridor in the Marble" +
    " Tower.";
static string stair_desc = "You have arrived at a staircase in the" +
    " Marble Tower. This beautifully crafted stairway is wide and" +
    " circular, drilling through the entire Tower. You can see the" +
    " glass dome of the observatory at the top.";

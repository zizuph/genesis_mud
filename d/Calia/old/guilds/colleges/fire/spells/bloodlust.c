/*
  This is the Bloodlust spell for the College of Fire Magic.
...
{
    if (present("_bloodlust_ob_", caster))
    {
        caster->catch_tell("You are already under the effects of that" +
            " spell!\n");
        return ({ });
    }
    else
...
{
    set_spell_name("bloodlust");
    set_spell_desc("Give in to the flame within");
    ...
    set_spell_object(FIRE_SPELLS + "bloodlust_ob");
    return 0;
}

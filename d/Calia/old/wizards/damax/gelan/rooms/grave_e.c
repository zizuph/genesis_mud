...
/* 	this is a room of the town Gelan
    ...
    purpose:    The E side of the graveyard in Gelan
    exits:      south, west and north  
...
create_room()
{
    ...
    set_short("The east side of the graveyard");
    set_long(BS("This is the eastern side of the graveyard.  The "+
                "path meanders south and north from here.  You see a "+
                "huge willow to the west.  There are many white "+
                "tombstones here. "+
                "\n"));  
    ...
    add_exit(ROOM("grave_ne"), "north", 0);
    add_exit(ROOM("grave_se"), "south", 0);
    add_exit(ROOM("grave_tree"), "west", 0);
    ...
    BS("The tombstones here are pure white marble, and a small wreath "+
       ...
       "It reads: TROK - IN DEATH, STILL BELOVED\n"));

    add_item(({"tree", "willow", "willow tree", "knoll", "small knoll"}),
    BS("On top of the small grassy knoll to the west stands a huge "+

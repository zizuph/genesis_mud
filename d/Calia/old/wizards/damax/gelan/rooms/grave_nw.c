...
/* 	this is a room of the town Gelan
    ...
    purpose:    The NW corner of the graveyard in Gelan
...
create_room()
{
    ...
    set_short("The northwest corner of the graveyard");
    set_long(BS("This is the northwestern corner of the graveyard.  The "+
                "path turns north here and also goes west.  You see a "+
                "huge willow to the northwest.  There are few "+
    ...
    BS("The tombstones here are pure white marble, and a small wreath "+
       ...
       "It reads: CHILMACK - A DWARF OF QUALITY\n"));

...
create_armour()
{
    ...
    set_af(TO);
    add_adj(({ "@@query_color@@", "dragonscale"}));
    ...
    add_prop(MAGIC_AM_ID_INFO,
		 ...
		 "natural threats.\n",50,
		 "This armour protects against fires and lightning.\n", 70}));
    add_prop(MAGIC_AM_MAGIC,({100, "enchantment"}));
    /*add_prop(OBJ_M_NO_BUY, 1); do the rules require this or not?*/

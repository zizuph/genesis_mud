...
create_creature()
{
    set_name(({"horse","winged horse","a winged horse"}));
    set_race_name("winged horse");

    set_adj(({"white", "majestic"}));
    set_long(BS(
        "This mythological winged horse is from the distant realm " +
        "of Argos.  You wonder how he got here.\n"));

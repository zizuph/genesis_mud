/* MCLUB - Bell Tower Door, Inside
**
** History:
** Date      Coder      Action
** -------- ----------- -------------------------------
** 5/2/95   Zima        Created - found in btower1.c
**
*/
inherit "/std/door";
#include "defs.h"
...
void create_door() {
    ::create_door();
    set_other_room(ROOM_DIR+"shvests");

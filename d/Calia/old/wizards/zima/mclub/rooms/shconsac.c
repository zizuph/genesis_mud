...
create_room() {
   ...
   set_long(
      ...
      "of the conclave, euphimistically called the sacristry. A small "+
      "lamp sits on a shelf near the door to the west, providing "+
      "sufficient light to the room, while a ring of keys hangs from "+
      "a peg on the wall.\n");
   ...
   add_item("shelf",
     "It is a small shelf on the wall used for a lampstand.\n");
   add_item("lamp",

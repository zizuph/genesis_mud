/* ARGOS - SWTERR - Eastern Bridge from Marble Road (NWTERR)) to Dirt Road
**
** History:
** Date      Coder      Action
** --------- ---------- --------------------------------
...
void create_room() {
   ...
   set_long(
      ...
      "the flow of the river along their respecitve banks.\n");
   ...
   /* exits */
   add_exit(NWTERR_DIR+"rooms/r26","north",0);
   add_exit(ROOM_DIR+"r26","south",0);
}

...
** 11/18/96 Zima             Road Extension; satyr entrance moved to 14a
*/
/* inherits/includes */
inherit "/std/room";
...
void create_room() {
   ...
   set_long(
     ...
     "forested with maples, oaks and evergreens. To the east is an elegant "+
     "marble bridge spanning a wide river which flows from the foothills "+
     "to the north into the valley to the southeast. A banner "+
     "flutters in the wind atop a tall pole set in a mable block at "+
   ...
   add_item("emblem",
      ...
      "jewels.\n");
   add_item("foothills",
      "Heavily forested with trees, the foothills roll along the western "
      +
      "horizon, bordering the mountains behind them.\n");
   add_item("bridge",
   ...
   add_exit(ROOM_DIR+"mbridge","east",0);
}
int doup() {

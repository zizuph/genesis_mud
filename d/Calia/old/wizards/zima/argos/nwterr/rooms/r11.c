...
void create_room() {
   ...
   set_long(
       ...
       "of rain. The road winds up to the summit of the mountains " +
       "to the west, and down the mountain to the east.\n");
 
    add_item("road",
       "Made of long slabs of white marble, this road seems fairly " +
       "new. It winds along the side of the mountain toward the summit " +
       "to the west, and down towards the foothills to the east.\n");
    ...
    add_item("mountains",
       "Rising towards a summit to the west, and down towards the " +
       "foothills to the east, the mountains are dotted with " +
       "trees and boulders.\n");
    add_item("boulders",
    ...
    /* exits */
    add_exit(ROOM_DIR+"r10a","up","@@doup");
    add_exit(ROOM_DIR+"r12","down","@@dodown");
}
int doup() {
   write("You climb west along the road, higher into the mountains.\n");
   return 0;
}
int dodown() {

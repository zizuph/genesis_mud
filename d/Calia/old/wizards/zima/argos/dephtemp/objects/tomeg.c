 ...
 *   hints.
 *
 *   LOCATION FOUND: On poteum in east anteroom of the sanctuary
 *                   rooms/eanterm
 *
 *   HISTORY:
 *   CODER         DATE             ACTION
...
#define HOME_ROOM ROOM_DIR+"anterme.c"
#define OBJ_NUM 0
#include "../retrnobj.h"
...
create_scroll()
{
    set_name(({"ancient tome","tome","gamma tome"}));
    set_short("ancient tome");
    set_long("An ancient tome entitled: The Vision of Delphia - Gamma\n");
 
    add_prop(OBJ_M_NO_SELL,1);
    add_prop(OBJ_I_WEIGHT, 20);
    add_prop(OBJ_I_VOLUME, 150);
 
    set_file(OBJ_DIR+"tomeg.txt");
}

...
create_room()
{
   ...
   set_long(
       ...
       "center of town lies a little further to the east, while Lambdos "+
       "leads out of the city to the west.\n");
    ...
    add_item(({"columns","capitols"}),
             ...
             "with elaborate capitals sculpted in the "+
             "shape of oak leaves.\n");
    ...
    /* exits */
    add_exit(ROOM_DIR+"lroad4","west",0);
    add_exit(ROOM_DIR+"lroad6","east",0);
}

...
#define  KRETAN_LIST ({"tcomder/tcomder2","soldier/soldier4", \
                                          "soldier/soldier4"})
#include "sentry.h"
...
void create_room() {
   ...
   set_long(
      "You are in another of the round tents, rows of x-framed cots "+
      "set out along the back. Stools are scattered "+
      "about the remainder, some around a small table which sits next "+
      "to the center pole. A typical home for soldiers on the move.\n");

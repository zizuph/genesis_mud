/* Inside warrior's tent, with DComder
**
** History:
** Date        Coder       Action
**----------   ----------- ----------------------------------
...
#define KRETAN_LIST ({"dcomder/dcomder5","warrior/warrior5", \
                                          "warrior/warrior5"})
#include "sentry.h"
...
void create_room() {
   ...
   set_long(
      ...
      "center holding up its pointed top. A ring of simple beds is set "+
      "up around the perimeter of the tent, while some rickety old chairs "+
      "are scattered around a couple of tables. The flap of the tent is "+
      "open on the north side leading out.\n");

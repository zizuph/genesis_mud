...
#define KRETAN_LIST ({"warrior/warrior4","warrior/warrior4","warrior/warrior4"})
#include "sentry.h"
...
void create_room() {
   ...
   set_long(
      ...
      "A flap is open to the east leading outside, while there is an "+
      "entrance to an adjacent tent to the north.\n");
   ...
   /* exits */
   add_exit("b5tent4","north","@@check_blocked");
   add_exit("nroad1", "east", 0);
   reset_room();
}

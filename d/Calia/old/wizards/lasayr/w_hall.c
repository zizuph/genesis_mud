...
create_room()
{
  ...
  "of the rock, the hall leads from doors to the east to an expanse of " +
  "space to the west. Being narrow as it is, the ceiling is surprisingly " +
  ...
  "distantly begins to waver in sync.\n");
    ...
    add_exit("/d/Genesis/wiz/post", "west", 0);

  door = clone_object("/d/Calia/lasayr/e_door1");

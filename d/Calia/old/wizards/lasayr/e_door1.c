...
create_door()
{
  ...
  set_other_room("/d/Calia/lasayr/workroom");
  set_open(0);
  set_locked(0);
  ...
  set_open_command(({"push","open"}));
  set_open_mess(({"pushes on the east doors, they swing silently aside.\n","The " +
  ...
  set_close_mess(({"pulls on the east doors, they swing silently shut.\n","The " +

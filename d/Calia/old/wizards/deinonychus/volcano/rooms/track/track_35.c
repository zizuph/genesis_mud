...
void create_room()
{
    ...
    set_long(DESC("track_long") + DESC("south-east") + "\n" +
        BS("Going west you'll come to the top of the volcano. " + 
...
#include "south.itm"
    ...
    add_exit(ROOM("track_36"), "west", 0);
    add_exit(ROOM("track_34"), "north", 0);
}

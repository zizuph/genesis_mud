 ...
 * Conjured by the Anthisto (Fire Resistance) spell of the Firewalkers.
 *
 * Coded by Jaacar - April 28th, 1998
 *
 */
...
start()
{
    set_spell_effect_desc("anthisto");

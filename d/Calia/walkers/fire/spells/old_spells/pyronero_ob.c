...
{
    set_name("decanter");
    add_name("_walker_decanter_");
    set_short("decanter");
    set_long("It is a fiery coloured crystal decanter filled with a glowing "+
...
remove_object()
{
    tell_object(environment(this_object()),"The decanter suddenly "+
        "explodes into flames and melts into nothing.\n");
    ::remove_object();
}

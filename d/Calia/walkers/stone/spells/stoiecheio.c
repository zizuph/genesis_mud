 ...
 /*
   * Stoiecheio (Elemental Form) Spell for the Stonewalkers
   * by Jaacar
   * November 7th, 1998
   */
...
stoiecheio(object caster, object *targets, int *resist, int result)
{
    ...
    write("Concentrating all of your efforts on the task, you "+
        ...
        "begins to harden, turning into solid stone.\n");
    tell_room(environment(caster),QCTNAME(caster)+" suddenly becomes a "+
        "living statue made of stone.\n",({caster}));
    seteuid(getuid());

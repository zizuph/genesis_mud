...
/* Earth Elemental Object

   Conjured by the Stoiecheio spell of the Stonewalkers.
...
object s_shadow;
int    st_timer;
string *adjectives1 = ({"enormous","colossal","gigantic","massive","immense","great"});
string *adjectives2 = ({"rock-hard"});
...
dispel_spell_effect(object dispeller)
{
    ...
    tell_room(environment(dispeller),"The "+new_short+" earth elemental "+
        "explodes into thousands of small particles of dirt. You are forced "+
        "to cover your eyes.\n",({dispeller}));
...
start()
{
    ...
    tell_room(environment(ob),"Out of it steps a "+new_short+" earth elemental.\n",({ob}));

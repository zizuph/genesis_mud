...
int Block_prop = 0;
string Adj1 = "massive", Adj2 = "rock-hard";
...
long(mixed for_obj)
{
    ...
    return (SW == for_obj ? "You are a massive rock-hard being in "+
        "the vague shape "+
        "of a humanoid." : capitalize(SW->query_pronoun())+
        " is a massive rock-hard being in the vague shape of a humanoid.") +
        "\n";
} 

...
/* Air Elemental Object

   Conjured by the Stoiecheio spell of the Windwalkers.
...
object s_shadow;
int    st_timer;
string *adjectives1 = ({"lucid","howling","delicate","faint","vague","whispering","dark","gusty"});
string *adjectives2 = ({"gloomy","vivid","spirited","watchful","wispy","breezy"});
...
dispel_spell_effect(object dispeller)
{
    ...
    tell_room(environment(dispeller),"The "+new_short+" air elemental spins "+
        "wildly sending debris everywhere.  You are forced to avert "+
        "your eyes.\n",({dispeller}));
...
start()
{
    ...
    tell_room(environment(ob),"Out of it steps a "+new_short+" air elemental.\n",({ob}));

...
/*
  ...
  History:
           3/6/2000    enemy info list = enemy list        Maniac
          12/2/2000    optimisations                       Maniac
...
#define ENEMY_INFO_DIR "/d/Calia/glykron/palace/texts/enemy_info/"
...
create()
{
    ...
    while (objectp(po = previous_object(i--))) { 
        log_file("old_palace_code", "council code: " + 
                 file_name(po) + " (" + 
                 po->query_real_name() + ").\n"); 
    } 
}

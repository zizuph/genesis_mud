/* 	this is a room of the town Gelan
    ...
    history:    2/7/98      Fixed typos                     Maniac 
                14.9.95     Maple street, square room       Maniac
...
create_room()
{
    ...
    set_long("You are walking down Maple street, which leads off "
           + "the east side of the town square. "
           ...
           + "To your west the square of Gelan opens out.\n");
    ...
    add_exit(GELAN_ROOMS + "square_eastend","west",0);

    add_item(({"house", "houses"}), "You see many residences on each side "

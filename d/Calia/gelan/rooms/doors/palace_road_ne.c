/* 	this is a door of the town Gelan
    ...
    exits:      door between palace road west and stable east
...
create_door() {
  ...
  set_other_room(GELAN_ROOMS + "stables_e");            /* room on the other side */
  set_pass_command(({"east","in","enter"}));    /* command(s) to pass the door */
  ...
  set_locked(0);                                /* 1 for locked, 1 for locked, std 1 */

  /* descs */

  set_open_desc("There is a open door leading east.\n"); /* desc for the open door */

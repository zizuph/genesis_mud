...
#define MY_PRICES ({ 7, 22, 43, 72, 155, 272 })
...
price_long() 
{
   return (
    ...
    + "   Sesame bread ............   " + MY_PRICES[4] + " cc.\n"
    + "   Fat bastard cake ........   " + MY_PRICES[5] + " cc.\n" 
 ...
 */
   ...
   {
      if(can_afford(MY_PRICES[4], "sesame bread"))
      {
         tell_room(this_object(),
   ...
   {
      if(can_afford(MY_PRICES[5], "fat bastard cake"))
      {
         tell_room(this_object(),

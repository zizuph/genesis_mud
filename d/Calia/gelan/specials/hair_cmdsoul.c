...
/* 
    ...
    History: 
    	    12/12/06    removed interactive chec               Lucius
            14/08/01    typos fixed                            Maniac 
            30/07/01    compatibility with double emotes       Maniac 
            20/09/96    more emote suggestions added           Maniac 
            18/03/96    more emote suggestions added           Maniac 
            23/01/96    hwash check for OBJ_I_CONTAIN_WATER    Maniac 
            04/12/95    more emotes added                      Maniac 
            11/07/95    Created                                Maniac 

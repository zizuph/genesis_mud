/* 	this file contains the pathes to all objects in Gelan, please modify
    ...
    history:    21.3.95     added alchemist rooms           Maniac
                12.1.95     added grocery store items       Maniac
                28.12.94    changed post office path	    Deinonychus
    	        23.12.94    added number quest objects      Maniac
                10.11.94    added rabbit quest objects      Maniac
...
mapping rooms_path =        ([
    "alchemist":                MANIAC_ROOMS        + "alchemist.c",
    "alchemist_lab":            MANIAC_ROOMS        + "alchemist_lab.c",
    ...
    "grocery":                  MANIAC_ROOMS        + "grocery.c",
...
mapping objects_path =     ([
    "apple":                    MANIAC_OBJECTS      + "apple.c",
    "banana":                   MANIAC_OBJECTS      + "banana.c",
    "beetroot":                 MANIAC_OBJECTS      + "beetroot.c", 
    "bottle":                   DINO_OBJECTS        + "bottle.c",
    "broccoli":                 MANIAC_OBJECTS      + "broccoli.c",
    "bright_poster":            MANIAC_OBJECTS      + "bright_poster.c",
    "celery":                   MANIAC_OBJECTS      + "celery.c",
    ...
    "melon":                    MANIAC_OBJECTS      + "melon.c",
    "orange":                   MANIAC_OBJECTS      + "orange.c",
    "poster":			DINO_OBJECTS	    + "poster.c",
    "tour_ticket":		DINO_OBJECTS	    + "ticket.c",
    "rabbit_droppings":         MANIAC_OBJECTS      + "rabbit_droppings.c",
    "rubbish_bin":              MANIAC_OBJECTS      + "rubbish_bin.c",
    "sesame_bread":             MANIAC_OBJECTS      + "sesame_bread.c",
    "shortcake":                MANIAC_OBJECTS      + "shortcake.c",
    "trapped_in_net":           MANIAC_OBJECTS      + "trapped_in_net.c",
    "trapped_in_bucket":        MANIAC_OBJECTS      + "trapped_in_bucket.c",
    "trash_net":                MANIAC_OBJECTS      + "trash_net.c",
    "trash_fish":               MANIAC_OBJECTS      + "trash_fish.c",
    "trash_bucket":             MANIAC_OBJECTS      + "trash_bucket.c",
    "trash_carrot":             MANIAC_OBJECTS      + "trash_carrot.c",
                            ]);
...
mapping weapons_path =     ([
    ...
    "trash_club":               MANIAC_WEAPONS      + "trash_club.c",
                            ]);
...
mapping specials_path =     ([
    ...
    "eval_plus":                MANIAC_SPECIALS     + "eval_plus.c",
...
mapping monsters_path =     ([
   ...
   "patati":                    MANIAC_MONSTERS     + "patati.c",
   "rabbit":                    MANIAC_MONSTERS     + "rabbit.c", 
   "ska":                       MANIAC_MONSTERS     + "ska.c",
   "stdDoc":                    MERLIN_MONSTERS     + "stdDoc.c",
                            ]);

mapping texts_path =     ([
   "special_activities":        MANIAC_TEXTS        + "special_activities",

/* 	this is a weapon of the town Gelan 
    ...
    history:         
                 ...
                 10. 1.92    townweapons -> weapon           Merlin 
                 8.11.92    created                         Merlin 
 
    purpose:    this is the standard sword for the experienced fighters of Gelan 
...
{ 
    ...
    set_adj(({"standard","experienced", "steel"})); 
 
    set_short("steel sword"); 
    set_pshort("steel swords"); 
 
    set_long("It's a standard steel sword of one of the fighter guards " 
          + "in Gelan. There is the golden sign of Gelan on its hilt. The " 
          + "hilt has a faint blue shimmer, so it must be a sword of a " 
          + "fighter.\n"); 

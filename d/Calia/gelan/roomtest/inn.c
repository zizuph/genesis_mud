...
create_room()
{
  ...
  set_long(
    ...
    + "the tables and order a good drink.\n"
  );

  add_item("floor", "The floor is made of the fines oaken wood.\n");
  ...
  add_item("menu","An ordinary menu, what did you expected? It is "
    + "here for everyone to read it.\n");

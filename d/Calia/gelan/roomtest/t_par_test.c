...
#include "/d/Calia/gelan/rooms/defs.h"
...
#define GUILDS_PICTURE BASE+"guilds_picture_list_test"
...
#define ACADEMY_PICTURE BASE+"academy_picture"
...
academy_desc()
{
   this_player()->more(read_file(ACADEMY_PICTURE));
  return "";
}

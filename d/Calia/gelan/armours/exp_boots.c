/* 	this is an armour of the town Gelan 
    ...
    history:
		02.12.94    type removed		    Deinonychus
                    8.94    armour stats changed            Maniac 
                 9. 1.93    slight modifications            Merlin 
                 8.11.92    created                         Merlin 
 
    purpose:    these are the standard boots for an experienced fighter of Gelan 
...
{ 
    ...
    set_adj(({"experienced","leather","standard"})); 
 
    set_short("leather boots"); 
    set_pshort("leather boots"); 
 
    set_long(BS("These are fine leather boots. They have the golden sign " 
              + "of Gelan on it.\n")); 

/* 	this is an armour of the town Gelan 
    ...
    purpose:    this is the standard helmet for an experienced fighter fo Gelan 
...
{ 
    ...
    set_long(BS("It's a red steel helmet. You notice the sign of " 
              + "Gelan on it's front side.\n")); 
 
    add_prop(OBJ_I_WEIGHT, 2500); 
    add_prop(OBJ_I_VOLUME, 321); 

/* 	this is an armour of the town Gelan 
    ...
    purpose:    this is the standard platemail for an apprentice figher fo Gelan 
...
{ 
    ...
    set_long(BS("It's a light blue steel platemail of an apprentice " 

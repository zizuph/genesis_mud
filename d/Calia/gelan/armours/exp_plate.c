/* 	this is an armour of the town Gelan 
    ...
    purpose:    this is the standard platemail for an experienced figher fo 
                Gelan 
...
#define ACMIN   30                              /* min value armour class */ 
...
{ 
    ...
    set_adj(({"experienced","steel","standard"})); 
    ...
    set_long(BS("It's a blue steel platemail of a " 
              ...
              + "You notice the golden sign of Gelan on it's front side.\n")); 

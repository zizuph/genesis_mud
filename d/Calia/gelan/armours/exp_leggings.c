/* 	this is an armour of the town Gelan 
    ...
    purpose:    these are the standard legginngs for an experienced fighter of 
                Gelan 
...
#define ACMIN   35                              /* min value armour class */ 
#define ACDIFF  10                              /* diff between max an min */ 
...
{ 
    ...
    set_long(BS("These are solid chain leggigs, as they are use by the " 
              + "fighter guards of Gelan. There's a small golden sign " 
              + "of Gelan on them.\n")); 

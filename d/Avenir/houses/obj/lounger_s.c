...
create_seating(void)
{
    ...
    add_adj(({"lounge","rope", "mesh", "wood", "wooden","south", "pool"}));
    ...
    "comfortable. This lounger is located south of the other one.\n");

    set_seat_names(({"lounge", "lounger", "south lounger", "pool chair"}));
    set_seat_id("_south_lounger");

/*
 * Filename: /d/Avenir/common/ships/bazaar/sea3.c
...
create_room()
{
    set_short("between islands and outpost tunnel");
    set_long("The great sea's islands are near you to the north.  Further " +
             "away to your south is a wall of the great cavern.\n");

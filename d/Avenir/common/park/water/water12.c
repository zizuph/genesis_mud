...
create_room()
{
    ...
    set_long("The rocky tunnel around you is dark and "
      ...
      +"here it is painful to swim through. A dark hole "
      +"leads upwards, and the tunnel extends into "
      +"pitch blackness to the north.\n");
    ...
    add_exit(PK + "water/water11", "up");
    add_exit(PK + "water/water13", "north");
}

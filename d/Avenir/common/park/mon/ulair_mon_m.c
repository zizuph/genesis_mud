...
/* ulair_mon_m.c
The Underground Lair Monster, Male, for Park island
...
create_creature() {
    ...
    if (!IS_CLONE)
        return;
        set_name(({"Cadrixiis","ulair_mon_m"}));
        ...
        +" it might be male, though you can't be sure. Whatever it"

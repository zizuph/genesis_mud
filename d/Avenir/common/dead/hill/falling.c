...
create_room()
{
    ...
    add_exit(CRYPT+"crypt"+(75+random(10)),"down", 0, 10, 0);	
    add_exit(CRYPT+"crypt"+(75+random(10)),"up", 0, 10, 1);
    add_exit(CRYPT+"crypt"+(75+random(10)),"out", 0, 10, 1);
    // Detour into the cairn
...
move_along(object tp)
{
    ...
    tp->move_living("M", CRYPT+"crypt"+(75+random(10)));
    // rooms 75-84

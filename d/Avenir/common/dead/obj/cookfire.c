...
// cookfire            /d/Avenir/common/dead/obj/cookfire.c       
// creator(s ):       Lilith Aug 2021
// purpose:           Cookfire for BOGL camp
// last update:      
// note:            
// bug(s):
// to-do:
...
#define BTU         (2)  /* How bright the fire burns.   */
...
{
    set_name("cookfire");
    add_name(({"fire", "avenir_cookfire"}));

    set_long("This is a small cookfire, built with collected "+
...
flame_tells()
{
    ...
    {
        case 0:
            str = "The fire pops and sizzles as fat from the roasting fish "+
...
{
    ::light_me_after_delay();
    tell_room(environment(this_object()), "The cookfire sputters back to life.\n");
    set_alarm(itof(random(200) + 20), 0.0, flame_tells);
    return 1;
}

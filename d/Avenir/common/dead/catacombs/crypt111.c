...
create_crypt_room()
{
    add_exit(CRYPT+"crypt112","down", 0, 10, 1);
	add_exit(CRYPT+"crypt44","up", 0, 20, 1);
    add_exit(CRYPT+"crypt44","climb", 0, 20, 1);
	set_short("wall of the pit of despair");
    set_long("You are clinging to the wall near the opening "
	    +"of a deep pit somewhere in the catacombs of Sybarus. "
		+"The stench is so bad that the smell of your own "
		+"vomit might be a welcome relief. "
    ...
    add_cmd_item(({"wall", "walls"}), ({"touch", "feel"}), 
	    "Disgusting! The wall feels slick with slime or perhaps blood.\n");	

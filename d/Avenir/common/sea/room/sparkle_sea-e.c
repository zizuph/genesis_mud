...
inherit ROOM_BASE;
#define AVENIR_LINK "/d/Avenir/common/sea/room/sea-0-7-x"
...
//  add_row_exit(ROOM + "xx", "east", "@@no_go", 1);
    add_row_exit(AVENIR_LINK, "east", 0, 1);    
...
no_go()
{
    write("Strong currents frustrate any progress you make trying to sail east.\n");
    return 1;
}

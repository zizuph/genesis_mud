/* Lilith FEb 2022: Avenir sea_base copied from 
...
#define DEBUG(x)  find_player("lilith")->catch_msg("[Av-sea] " + x + "\n")
...
query_file_with_map ()
{
  return AVENIR_SEA + "avenir_sea_map";
}
...
create_map_room ()
{
  ...
  // OOPS. 
 set_area_handler(AVENIR_SEA + "sea-placer");
///  set_area_handler(AVENIR_SEA + "avenir_sea_placer");
}

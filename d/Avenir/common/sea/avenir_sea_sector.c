/* Avenir sea secotr based on the 
 * Khalakhor Base sector file
 * Tapakah, 10/2021
 */
...
long_descr ()
{
  return "Somewhere in the waters near Terel...\n";
}
...
edge_descr ()
{
  ...
  string descr = sprintf(" The waters to the %s seem to be churning wildly, "+
                         "as if encountering a barrier that isn't visible to "+
                         "your eyes.",
                         edge_data[1]);
  if (edge_data[0])

...
do_ring(string str)
{
    ...
    if (!host)
    {
        ...
        host_speak("Ta'haveth. If you've got money, I've got "+
           "food fer ya.");
    }
    else
    {
        host_speak("Ta'haveth. If you've got money, I've got "+
           "food fer ya. What did you want to order?");
    }
    ...
    switch(str1)
    {
     ...
     // Donuts  -- host's choice 		
        ...
        price = num * 144;
         break;
        default:
        notify_fail("He doesn't appear to understand what you want to buy.\n");
        return 0;
    }
    ...
    for (i = 0; i < inum; i++)
    {
        ...
        else if (!test) 
        {
            if (num == 0)
            {
                ...
                {
                    ob->catch_msg("You buy " + drink->short() + " from the cook.\n");

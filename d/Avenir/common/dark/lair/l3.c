...
create_room ()
{
    ...
    set_long ("The walls of the tunnel send forth gouts of "+
        "crackling flame, so it is difficult to make anything "+
        "out through the smoke. The pressure in the air is "+
        "intensely, sufficatingly hot, warm as the lava flowing "+
        "with deceptive gentleness through the tunnel.\n");

...
create_room ()
{
    ...
    set_long ("You are in a winding round tunnel, deep in the "+
        "bowels of Avenir. The heat here is intense, and all "+
        "around you the walls crackle and burn with orange flames. "+
        "A stream of lava flows steadily by, impinging on your "+
        "freedom of movement. The stifling air seems heavy with "+
        "an ancient sense of waiting.\n");

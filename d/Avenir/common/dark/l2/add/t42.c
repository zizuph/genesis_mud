// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t42.c
...
create_tunnel_room()
{
    ...
    set_long("A resonant whistling is omnipresent throughout this "+
        "tunnel. A random assortment of odd, tubular passages pierce "+
        "the walls, causing a wide range of whistles as the wind "+
        "blows through them.\n");

    add_exit("t41", "northwest", 0);
    add_exit("t43", "southeast", 0);
	add_exit("t54", "south", 0);

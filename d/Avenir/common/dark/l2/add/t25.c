// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t25.c
...
create_tunnel_room()
{
    ...
    set_long("The filth and debris in this tunnel is pretty impressive, "+
        ...
        "despite the unpleasantness of being here. There is a crack "+
        "in the south wall that leads southwest into another tunnel.\n");

    add_exit("t24", "northeast", 0);
    add_exit("t26", "west", 0);
    add_exit("t68", "southwest", 0, 0, 1);  // non-obvious
    ...
    add_item(({"crack", "south wall"}), "The crack in the south wall "+
        "appears to be the result of a recent excavation. It looks "+
		"unfinished or abandoned, as though whoever broke through "+
        "to this tunnel immediately regretted it.\n");

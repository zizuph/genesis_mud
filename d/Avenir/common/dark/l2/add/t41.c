// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t41.c
...
create_tunnel_room()
{
    ...
    set_long("A resonant whistling is omnipresent throughout this "+
        "tunnel. It appears to be an effect caused by the odd tubular "+
        "passages which lace the walls,  causing various frequency "+
        "whistles as the nearly steady wind "+
        "blows through here.\n");

    add_exit("t40", "west", 0);
    add_exit("t42", "southeast", 0);

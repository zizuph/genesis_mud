// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t43.c
...
create_tunnel_room()
{
    ...
    set_long("A resonant whistling is omnipresent throughout this "+
        "tunnel. It appears to be the effect produced by the wind "+
        "blowing through the series of odd, tubular passages "+
        "piercing the tunnel walls at seemingly random intervals. "+
        "The tunnel continues in a northwest-southeast direction. "+
        "It looks like there was a cave-in to the east."+		
        "\n");

    add_exit("t42", "northwest", 0);
    add_exit("t44", "east", 0);
    add_exit("t55", "southeast", 0);

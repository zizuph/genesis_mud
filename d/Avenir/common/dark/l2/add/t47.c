// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t47.c
...
create_tunnel_room()
{
    ...
    set_long("This is a wide ledge hanging above a raging subterranian "+
        ...
        "been suspended over the river to the west.\n");

    add_exit("t46", "east", 0);
    add_exit("t48", "west","@@bridge@@");
    ...
    add_item("bridge","A rickity, none too steady rope bridge with wooden "+
        ...
        "security.\n");
    add_item("river","A raging river flows no more then ten feet below "+
        "you.\n");

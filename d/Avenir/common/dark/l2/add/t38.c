// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t38.c
...
create_tunnel_room()
{
    ...
    set_long("A resonant whistling is omnipresent throughout this "+
        "tunnel. It appears to be an affect caused by the walls "+
        "which are laced with odd tubular passages, causing "+
        "various frequency whistles as the nearly steady wind "+
        "blows through here.\n");

    add_exit("t37", "southwest", 0);
    add_exit("t39", "northeast", 0);
    ...
    add_item(({"tubes","passages"}),"Small tubelike passages "+
        ...
        "arm. Each size causes various frequencies of whistling sounds "+

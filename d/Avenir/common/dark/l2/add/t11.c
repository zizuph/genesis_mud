// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t11.c
...
create_tunnel_room()
{
    ...
    set_long("This is a large natural tunnel that seems perpetually "+
        "dark and gloomy. Shadows fill the nooks and crevices of the walls and "+
        "ceiling.\n");

    add_exit("t10", "southwest", 0);
    add_exit("t12", "northeast", 0);

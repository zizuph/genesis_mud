// -*-C++-*-
// file name:        /d/Avenir/common/dark/l2/t23.c
...
create_tunnel_room()
{
    ...
    set_long("The filth and debris in this tunnel is pretty impressive, "+
        ...
        "a path through all the trash, evidence of the tunnels use "+
        "despite the displeasure of being here.\n");

    add_exit("t22", "northwest", 0);
    add_exit("t24", "southwest", 0);
add_exit("t20", "east", 0);

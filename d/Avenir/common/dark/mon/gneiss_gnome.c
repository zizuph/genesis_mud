...
//             from broken weapons. 
// update(s):  Lilith Dec 2021: Fixed typo in special attack  
...
equip_me()
{
	...
	string sparkly = one_of_list(({ "/d/Genesis/gems/obj/garnet",
                     ...
                     "/d/Genesis/gems/obj/ruby",
                     "/d/Genesis/gems/obj/opal_fire",
    ...
    switch (random(4))
    {
        case 0: equip(trinket);	break; 
		case 1: equip(sparkly); break;
        case 2: add_weapon(DARK +"obj/d_pickaxe"); break;
		case 3: equip(DARK +"mon/bat"); break;
    }

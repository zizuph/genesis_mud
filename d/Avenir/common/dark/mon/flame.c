...
//              Zizuph Aug 2022, notify_fail fix and syntax improvements.
...
my_long() {
  return
    "Mysterious, cold, blue-white flame burning steadily without\n" +
    "any visible source. Living a life of its own, it cannot be\n" +
    "neither taken nor extinguished. It can be only guided by\n" +
    "a gentle hand.\n";
}

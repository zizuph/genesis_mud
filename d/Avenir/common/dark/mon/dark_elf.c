 ...
 * Lilith Dec 2021: Added set_restrain_path to keep them on L1.
 * Lilith Feb 2022: Removed magic resistance now that combat system calcs it.
 *                   
 */
...
create_monster(void)
{
    ...
    // Keep them from wandering out of their territory
    set_restrain_path("/d/Avenir/common/dark/l1/");
    set_monster_home("/d/Avenir/common/dark/l1/center");
    set_act_time(10);

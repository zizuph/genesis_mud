...
create_room(void)
{
    ...
    set_long("A darkened tunnel, its walls covered with fungi, the " +
	     ...
	     "The tunnels lead northwest-east. A small cavern is south " +
	     "of here. There is a foul stench in the air.\n");
    ...
    add_exit(L1 + "se3", "northwest");
    add_exit(L1 + "se4a", "east");
    add_exit(L1 + "cavern1", "south"); 
		add_npc(MON + "dark_elf", 4);
}

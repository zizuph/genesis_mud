// File name:    /d/Avenir/common/dark/l5/s3.c
// creator(s):   Farlong
...
create_room()
{
	...
	+" the east and northwest.  There are two small chambers to"
	+" the northeast and south.\n");

    add_exit(L5 + "s2","northwest",0);
    add_exit(L5 + "s4","east",0);
    add_exit(L5 + "s13","northeast",0);
    add_exit(L5 + "s14","south",0);

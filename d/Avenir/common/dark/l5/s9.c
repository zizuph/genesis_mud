// File name:    /d/Avenir/common/dark/l5/s9.c
// creator(s):   Farlong
...
create_room()
{
	...
	+" the south.  To the northwest and northeast are two"
        +" small chambers.\n");

    add_exit(L5 + "s8","south",0);
    add_exit(L5 + "s10","northwest",0);
    add_exit(L5 + "s20","northeast",0);

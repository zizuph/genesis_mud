// File name:    /d/Avenir/common/dark//l5/n3.c
// creator(s):   Farlong
...
create_room()
{
	...
	+" the west and southeast.  A smaller tunnel joins it here from the"
	+" north.\n");

    add_exit(L5 + "n4","west",0);
    add_exit(L5 + "n2","southeast",0);
    add_exit(L5 + "e11","north",0);

// File name:    /d/Avenir/common/dark/l5/s2.c
// creator(s):   Farlong
...
create_room()
{
	...
	+" the northwest and southeast.  There are two small chambers to"
	+" the northeast and southwest.\n");

    add_exit(L5 + "s1","northwest",0);
    add_exit(L5 + "s3","southeast",0);
    add_exit(L5 + "s11","northeast",0);
    add_exit(L5 + "s12","southwest",0);

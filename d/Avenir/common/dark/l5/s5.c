// File name:    /d/Avenir/common/dark/l5/s5.c
// creator(s):   Farlong
...
create_room()
{
	...
	+" the west and northeast.  To the north and southeast are"
	+" two small chambers.\n");

    add_exit(L5 + "s4","west",0);
    add_exit(L5 + "s6","northeast",0);
    add_exit(L5 + "s16","southeast",0);
    add_exit(L5 + "s17","north",0);

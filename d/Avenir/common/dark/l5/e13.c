// File name:    /d/Avenir/common/dark/l5/e13.c
// creator(s):   Farlong
...
create_room()
{
	...
	+" heading off to the"
	+" south and southwest.  To the north it enters a small"
	+" chamber.\n");

    add_exit(L5 + "e12","southwest",0,DUST);
    add_exit(L5 + "e14","south",0,DUST);
    add_exit(L5 + "e15","north",0);

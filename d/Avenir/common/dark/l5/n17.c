// File name:    /d/Avenir/common/dark/l5/n17.c
// creator(s):   Farlong
...
create_room()
{
	...
	+" the west.  To the northeast and southeast are two small"
	+" chambers.\n");

    add_exit(L5 + "n16","west",0);
    add_exit(L5 + "n18","northeast",0);
    add_exit(L5 + "n19","southeast",0);

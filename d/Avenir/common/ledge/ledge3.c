...
// Ledge path 3 (/d/Avenir/common/ledge/ledge3.c)
// creator(s): Ilyian
// last update:  
// purpose:
//
...
create_room()
{
     AE(LEDGE+"ledge2", "northwest", 0, 6);
     AE(LEDGE+"ledge4", "south", 0, 0);
 

   SHORT("On the steep path");
   make_the_room("  The path turns from the south to the "
      +"northwest here. Upwards, you see you are near to the "
      +"top of the cliff wall. The face of the cliff is very "
      +"rough and uneven here.\n");

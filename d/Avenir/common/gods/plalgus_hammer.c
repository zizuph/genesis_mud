...
// 
//   Lilith May 2022: added another function do_judge(enemy) to go straight 
//        to declaring a person a murderer/infidel, no second chance. 
//                 
...
/* This clones the wrath object to the player 
 * It is called when a player enters Sybarus as 
 * an infidel/murder, as well as when they kill
...
/* This logs the murder of the sybarite citizen */
public void
...
/* This goes straight to judgement */
public void
do_judge(object enemy)
{
    mark_enemy(enemy);
    log_malefactor(enemy);
}

/* This gives players a chance to avoid judgement */
public void

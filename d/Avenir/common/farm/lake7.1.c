...
create_room()
{
    ...
    make_the_room();
    add_exit("lake6.1","northwest", 0 , 1, 1);
    add_exit("lake6.3","northeast", 0 , 1, 1);
    add_exit("lake6.2","north", 0 , 1, 1);
    add_exit("lake7.2","east", 0, 1, 1);
    add_exit("lake8.1","southeast", 0, 1, 1);

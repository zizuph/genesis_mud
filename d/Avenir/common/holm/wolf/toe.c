...
// note:		found in /d/Avenir/park/e_path5.c
//			by searching the wall
...
my_long()
{
    ...
    {
        str = "A long and bleached white bone belonging to "
            + "the paw of what was once a massive wolf.\n";
        return str;
    }
    else
    {
...
//Code below copied from /d/Avenir/common/outpost/obj/lsource.c
void
...
self_destruct()
{
    ...
    tell_room( current_room, "The toe bone glitters briefly "

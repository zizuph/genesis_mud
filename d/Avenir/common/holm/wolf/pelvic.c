...
my_long()
{
    ...
    {
        str = "Large and smooth, your trained eye identifies this bone "
	    + "as being half of the remains of what was once the "
	    + "strong and sturdy pelvis of a wolf.\n";
...
self_destruct()
{
    ...
    tell_room( current_room, "The pelvic bone glitters briefly "

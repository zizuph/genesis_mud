...
// note:		found in /d/Avenir/common/holm/jungle/hf5.c
//			by searching the log
...
create_object()
{
    ...
    seteuid(getuid());	//dont have a clue what this is for.
}
...
my_long()
{
    ...
    {
	str = "Thick and curved, this bone once formed "
	    + "half of the lung cage for a powerful "
	    + "and vigorously healthy wolf. Standing it on end, "
	    + "it stands a breathtaking 7 hands tall.\n";
...
self_destruct()
{
    ...
    tell_room( current_room, "The rib bone glitters briefly "

// -*-C++-*-
// file name:	vertebra.c
// creator(s): 	sirra march 98
// last update:	
// purpose:		wolf skeleton quest item.

// note:		found in /d/Avenir/common/dark/obj/bones.c
...
my_long()
{
    ...
    {
        str = "Bleached white and curvacious, this bone fits neatly "
            + "into the palm of your hand. Your trained eye identifies "
            + "it as being the remains of what was once a large "
            + "and flexible wolf.\n";
...
self_destruct()
{
    ...
    tell_room( current_room, "The vertebra bone glitters briefly "

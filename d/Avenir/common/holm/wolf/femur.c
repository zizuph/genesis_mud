...
// note:	found when searching fence 
//		in /d/Avenir/common/bazaar/green/green11.c
// bug(s):	
// to-do:
...
my_long()
{
    ...
    {
        str = "Bleached white, long and graceful, "
	    + "this bone once formed "
	    + "the thigh of a swift and powerful wolf.\n";
...
self_destruct()
{
    ...
    tell_room( current_room, "The femur bone glitters briefly "

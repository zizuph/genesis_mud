 ...
 *      Lilith, Mar 2022: added fishing prop    
 *
 */
#include "port.h"
...
create_room(void)
{
     ...
     add_item(({"wall","crack"}),
     "The wall seems to have been smoothed by the water. A small crack " +
...
do_search(object searcher, string str)
{
  ...
  //Starting to track search attempts.
   ...
   ob = clone_unique(DEAD + "obj/watch", 15, ({ PORT +"obj/oilskin_cloak", 

// Underwater room   (/d/Avenir/common/port/uw2.c)
...
create_room()
{
    ...
    set_long("You are swimming in dark, murky water. Powerful " +
      "currents are pulling you in various directions.  The dim light from " +
      "the surface is weaker here. Below you is only darkness. To your north " +
      "the cliff appears like a shadow within shadow, so dark that you cannot " +
    ...
    add_exit(PORT + "uw1", "up");
    add_exit(PORT + "uw3", "down");
    add_exit(PORT + "uw4", "north");
    add_exit(PORT + "uw2a", "east");
}

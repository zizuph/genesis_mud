// Green5 (/d/Avenir/common/bazaar/green/green5.c)
// creator(s):   Tepisch Sept 1994
// last update: Lilith, 7:06 PM 4/21/97 (updated herbsearch)
...
create_room()
{
   AE(GREEN + "green2", "north", 0);
   AE(GREEN + "green9", "south", 0);

   SHORT("North garden");
   make_the_room(" Here there grows a profusion of sweet-smelling plants.\n");

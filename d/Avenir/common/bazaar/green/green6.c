...
// Green6 (/d/Avenir/common/bazaar/green/green6.c)
// creator(s):   Tepisch Sept 1994
// last update: Lilithg, 7:08 PM 4/21/97 (updated herbsearch)
...
create_room()
{
   AE(GREEN + "green3", "north", 0);
   AE(GREEN + "green10", "south", 0);

   SHORT("North garden");
   make_the_room(" You notice an interesting mixture of plants "+
     "growing here.\n");

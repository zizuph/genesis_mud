...
#define STORE_ROOM HINROOM_DIR + "herbshop_store" /* Where the items are stored */
...
create_room()
{
   ...
   set_long(break_string(
    ...
    + "the store has written down all items on a pricelist, together with "
    + "their price. If you like something, feel free to buy it. "
   ...
   add_item(({"item","items", "potions", "herbs"}), break_string(
   ...
   add_exit(HINROOM_DIR + "hall2", "east", 0);

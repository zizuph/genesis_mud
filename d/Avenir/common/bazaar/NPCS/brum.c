...
quest_ask()
{
    ...
    switch(qnum)
    {
        case 1: 
        {
            ...
            command("say Norlayo is most qualified.");
            command("say Dibron does not have the necessary tools");
        }
            break;
        case 2: 
        {
            command("say Norlayo is the most qualified.");
            command("say Dibron has never worked with statuary.");
            command("say Norlayo's first statement is false.");
        }
            break;
        case 3:
        {
            ...
            command("say Norlayo is the most qualified.");
            command("say Dibron is experienced in this type of work.");
        }
            break;
        case 4: 
        {
            command("say Norlayo is the most qualified.");
            command("say Maxild does not have all the necessary tools.");

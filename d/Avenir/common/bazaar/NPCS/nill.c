...
quest_ask()
{
    ...
    switch(qnum)
    {
        case 1: 
        {
            ...
            command("say Both Herk and Pab are guilty.");
        ...
        case 2: 
        {
            ...
            command("say Trimto owns a chisel.");
            command("say Trimto was seen in the Center Pale late "+
                "that night.");       
        }
            break;
        case 3: 
        {
            command("say I already told them I did not do it, "+
                "I am innocent!");
            command("say Trimto did it.");
        ...
        case 4:
        {
            ...
            command("say Pabby was out late that night.");
            command("say I wouldn't do this, I'm innocent.");
        }
            break;

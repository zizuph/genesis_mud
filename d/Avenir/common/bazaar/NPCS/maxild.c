...
create_monster()
{
    ...
    set_act_time(10);
      add_act("sigh .");
      add_act("smile grim");
      add_act("emote breathes quickly.");
      add_act("emote sighs nervously.");
...
quest_ask()
{
    ...
    switch(qnum)
    {
        case 4:
        {
            ...
            command("say Brum is the most qualified.");
            command("say Norlayo is experienced in this type of work.");
        }
            break;
        case 3: 
        {
            command("say Brum is the most qualified.");
            command("say Norlayo has never worked with statuary.");
            command("say Brum's first statement is false.");
        }
            break;
        case 2: 
        {
            command("say I am experienced with this type of work.");
            command("say Brum is most qualified.");
            command("say Norlayo does not have the necessary tools.");
        }
            break;
        case 1: 
        {
            command("say Brum is the most qualified.");
            command("say Dibron does not have all the necessary tools.");

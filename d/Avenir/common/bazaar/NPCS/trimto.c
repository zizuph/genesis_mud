...
quest_ask()
{
    ...
    switch(qnum)
    {
        case 1:
        {
            ...
            command("say Innocent am I, of this crime, truly.");
            command("say Nill was out late that night.");
        }
            break;
        case 2: 
        {
            command("say Both Pab and Nill did the deed.");
        ...
        case 3: 
        {
            command("say Herk was seen in the Center Pale late "+
                "that night.");       
            command("say Herk owns a chisel.");

...
create_monster()
{
    ...
    set_adj("shackled");
    add_adj("cowed");
    default_config_npc(random(20) + 50);    
    set_gender(G_FEMALE);
    set_name("pabby");
    add_name("prisoner");
    set_long(my_long);
...
quest_ask()
{
    ...
    switch(qnum)
    {
        case 1: 
        {
            ...
            command("say Nill owns just such a chisel as would "+
                "be needed to do such a blasphemous thing.");
        ...
        case 2: 
        {
            ...
            command("say I was in the Soke when the crime "+ 
                "occurred.");
            command("say Nill did it.");
        }
            break;
        case 3:
        {
            command("say Herk was out late that night.");
            command("say I am innocent of this crime.");
        ...
        case 4: 
        {
            ...
            command("say Both Herk and Trimto are guilty.");
        }
            break;
        default: 
        {

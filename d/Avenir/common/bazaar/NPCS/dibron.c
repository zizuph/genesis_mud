...
quest_ask()
{
    ...
    switch(qnum)
    {
        case 1:
        {
            ...
            command("say Maxild is the most qualified.");
            command("say Brum is experienced in this type of work.");
        }
            break;
        case 2: 
        {
            command("say Maxild is the most qualified.");
            command("say Norlayo does not have all the necessary tools.");
        ...
        case 3: 
        {
            ...
            command("say Maxild is most qualified.");
            command("say Brum does not have the necessary tools");
        }
            break;
        case 4: 
        {
            command("say Maxild is the most qualified.");
            command("say Brum has never worked with statuary.");
            command("say Maxild's first statement is false.");
        }
            break;
        default: 
        {

// file name:	     jhawker.c
// creator(s):	     Grace
// revision history: Denis, May'97: Regular updates.
...
create_monster()
{
    ...
    set_name("ornglut");
    set_title("Yarne, hawker extra-ordinaire");
    add_name(({"hawker","peddler"}));
    set_race_name("gnome");
    set_gender(0);

    add_adj(({"young", "smiling"}));
    set_long("This young gnome seems to like yelling at the "+
    ...
    set_act_time(10);
    add_act("shout We've got novelty junk here!");
    add_act("shout Step inside this here tent and get yourself "+
        "some novelty junk!");
    add_act("shout We got your backscratchers!");
    add_act("point tent");
    add_act("shout Bunny slippers! Thumbscrews!");
    add_act("shout Get them here! Get them Now! While they last!");

    add_ask(({"junk", "thumbscrews", "slippers", "backscratcher"}),

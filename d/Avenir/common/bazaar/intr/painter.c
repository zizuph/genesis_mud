...
/* Numbers to keep allow name-to-random pigments given */
#define G_IDENT 48329172
#define G_RANGE 4
#define R_IDENT 58302943
#define R_RANGE 4
#define P_IDENT 66219732
#define P_RANGE 4
...
create_dunadan()
{
    ...
    add_ask(({"additive", "additives", "paint additives", "pigments"}),
        "say I am always short on paint pigments. It's a pity, since " +
...
default_ans()
{
    ...
    {
    case 0:
        command("emote appears to be distracted by something.");
        break;
    case 1:

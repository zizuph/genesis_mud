// Standard room for Bazaar Center (std_center.c)
// creator(s):   Tepisch Aug 1994
// last update:  
// purpose:     Inheritable room with function providing a view of
//              the Hill.
// note:
// bug(s):
// to-do:        
...
make_the_room(string extra_long)
{
    ...
    set_name("Bazaar");
/*
    SHORT("Center of Sybarus bazaar");
*/
    LONG("You stand in a crowded market area.  People of many races " +
       ...
       "scampering out of the reach of sadistic guardsmen." +
    ...
    AI(({"guardsmen","protectors"}),
        "The guardsmen are tall, well-muscled elves. Called the "+
        "Protectors of Sybarus, their purpose is ostensibly to " +
        "protect the peace. However, it looks like the residents "+
        "of Sybarus need protection from them.\n");

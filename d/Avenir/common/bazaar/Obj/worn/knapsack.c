...
create_wearable_pack(void)
{
    ...
    set_pshort("sturdy leather knapsacks");
    ...
    add_prop(CONT_I_MAX_WEIGHT, 150000);  /* 80.0 kg */
    add_prop(CONT_I_MAX_VOLUME, 150000);  /* 80.0 L  */
    add_prop(CONT_I_REDUCE_WEIGHT, 125); // reduces weight by 25%

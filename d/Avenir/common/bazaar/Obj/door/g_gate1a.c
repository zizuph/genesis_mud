...
create_door()
{
   ...
   set_door_desc("This is a high gate of thick iron bars. Through "
     +"the bars you can see the beginning of a lovely garden that "
     +"stretches to the south, surrounded by high stone walls. There "
     +"is a heavy wooden latch on the gate, and a discreet sign tacked " 
     +"to the bars.\n");
   set_other_room(BAZAAR + "green/green1");
   set_open(0);
   set_locked(0);
   set_open_desc("An open iron gate is to the south.\n");
   set_closed_desc("A closed iron gate is to the south.\n");

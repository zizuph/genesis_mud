...
create_door()
{
    ...
    set_door_desc("This gate is really a portcullis. The grating "+
        ...
        "To the people of Sybarus, it is known as the Second Gate.\n");
    ...
    set_other_room(BAZ_ADMIN + "a16");
    set_open(1);
    set_open_desc("The open portcullis of the Second Gate lies west.\n");

// -*-C++-*-
// file name: 	  /d/Avenir/common/bazaar/Obj/forge/shield.c
// creator(s):	  Lilith 
// last update:	  Lilith 
// purpose:       
// note:          
...
long_desc()
{
    ...
    if (plating && plating != 0)
        str = "The edges of the shield have a "+ plating +
    ...
    return  "This "+ short() +", unsurpassed in beauty and function"+
            ...
            "is of average size, kite-shaped, and is made "+
            "with "+ query_style_long() +" It is "+
            "padded with "+ colour +" "+ lining +" designed to supply "+
            "optimum protection from the jots and jars of impact for "+ 
...
{
    if (plating && plating != 0)
        return plating +"-plated "+ astyle +" shield";
    else    
        return colour +" "+ decor +" "+ astyle +" shield";
...
forge_it()
{
    ...
    add_name(({"shield", style, "armour", astyle}));

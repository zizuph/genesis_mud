// -*-C++-*-
// file name: 	  /d/Avenir/common/bazaar/Obj/forge/boots.c
// creator(s):	  Lilith 
// last update:	  Lilith 
// purpose:       
// note:          
...
long_desc()
{
    ...
    if (plating && plating != 0)
        str = "The boots have been embellished "+ 
    ...
    return  "This "+ short() +", unsurpassed in beauty and function"+
            ...
            "boots are lined with "+ colour +" "+ lining +" and "+
            "moulded to fit the feet of "+ LANG_ADDART(query_owner()) +
            " perfectly. "+ str;
}
...
{
    if (plating && plating != 0)
        return plating +"-plated pair of "+ astyle +" boots";
    else    
        return "pair of "+ colour +" "+ decor +" "+ astyle +" boots";
...
{
    if (plating && plating != 0)
        return plating +"-plated pairs of "+ astyle +" boots";
    else    
        return "pairs of "+ colour +" "+ decor +" "+ astyle +" boots";
}

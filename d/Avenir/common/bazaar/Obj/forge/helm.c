// -*-C++-*-
// file name: 	  /d/Avenir/common/bazaar/Obj/forge/helm.c
// creator(s):	  Lilith 
// last update:	  Lilith 
// purpose:       
// note:          
...
long_desc()
{
    ...
    if (plating && plating != 0)
        str = "The edges of the helm have a "+ plating +
    ...
    return  "This "+ short() +", unsurpassed in beauty and function"+
            ...
            "was made with "+ query_style_long() +" It is "+
            "padded with "+ colour +" "+ lining +" that is "+
            "moulded to provide maximum comfort and protection for "+ 
...
{
    if (plating && plating != 0)
        return plating +"-plated "+ astyle +" helm";
    else    
        return colour +" "+ decor +" "+ astyle +" helm";
...
forge_it()
{
    ...
    add_name(({"helmet", style, "armour", "helm", astyle}));

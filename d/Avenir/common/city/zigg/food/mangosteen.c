// -*-C++-*-
// file name:   zigg/food/mangosteen
// creator(s):  Lilith, Feb 2022
// last update:
// purpose:     fruit fir mangosteen tree
// note:
// bug(s):
// to-do:
...
{
    write("A thrillingly intoxicating flavor that is a delicious "+
     "mix of lychee, peach, strawberry, and pineapple floods your "+
	 "mouth as you bite into the luscious flesh of the "+ 
...
{
    write("It has a subtle caramel-like fragrance.\n");
}

public void
create_food(void)
{
    set_name(({"mangosteen", "fruit",}));
    set_pname(({"mangosteens", "fruits",}));
    set_short("purple mangosteen");
    set_pshort("purple mangosteens");
    set_adj(({"purple","luscious","round","white-fleshed",
	"ripe", "sweet", "smooth", "succulent", "intoxicating"}));
    set_long("This mangosteen fruit is round, with a thick, "+
    "purple skin and a pillowy circle of juicy white segments "+
    "inside. Known as the Queen of Fruits, this rare, "+
    "tangerine-sized delicacy will not disappoint.\n");
    ...
    add_prop(HEAP_S_UNIQUE_ID, "zigg:food:mangosteen");
}
...
do_savour(string str)
{
	...
	write("You nibble the "+ singular_short() + how[1] +
	  ", your teeth sinking into a juicy white segment of "+
      "mangosteen flesh.\n");
	...
	write("You take a tiny bite of the "+ singular_short() +
	  ", biting it"+ how[1] +" just until the sweet and tangy "+
	  "floral juice wells up to meet your lips. \n");
	...
	write("You bite"+ how[1] +" into the "+ singular_short() +
	  ", using your lips and tongue to capture the intoxicatingly "+
	  "delicious juice as it runs from the fruit.\n");
	...
	if (strlen(str))
	{
		...
		", running your tongue over the pillowy white flesh "+
        "inside.\n");
	...
	{
	    write("You"+ how[1] +" lick the drops of intoxicating "+
        "juice clinging to the white flesh of your "+ 
	    singular_short() +".\n");
	...
	write("You"+ how[1] +" chew a segment of your "+ singular_short() +
	  ", savouring the intoxicating flavor.\n");

/* bronze crozier        /d/Avenir/common/city/obj/wield/crozier_nm.c
 ...
 *              Effects: Increases cb_attackuse from 100 to 120.  This will
...
void create_object()
{
    ...
    set_long("This is a flexible kesoit pole with a trefoil knot on one " +
       ...
       "  The head of the crozier is cast in bronze. When " +
    ...
    add_item(({ "head", "cap", }),
        "The cap of the crozier is cast in bronze.\n");
    ...
    add_prop(OBJ_S_WIZINFO, "This crozier increases attackuse " +
        "from 100 to 120, which will be foot-based attacks.  " +
...
hold()
{
        ...
        holder->query_stat(SS_DEX) >= 130)
    {
        ...
        shadow->add_crozier_shadow(holder, this_object(), 
            10 + (holder->query_skill(SS_ACROBAT) / 20));
    }

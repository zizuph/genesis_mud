// file name:  first_gate2.c
// creator(s): Lilith Feb 2002
// last update:
// purpose:    First Gate, on the city side.
// note:       connects to BAZ_ADMIN a18.c
//             cloned to CITY /public/courtyard.c
// bug(s):
// to-do:
...
create_door()
{
    ...
    set_pass_command(({"north", "n", "enter gate", "pass gate"}));
    ...
    set_other_room("/d/Avenir/common/bazaar/admin/a18");
    set_open(0);
    set_locked(1);

...
create_door()
{
    ...
    set_pass_command(({"ne", "northeast", "pass"}));
    set_fail_pass("The door is closed.\n");
    set_door_name(({"door", "door one", "first door"}));
    set_door_desc("This door leads northeast into the public bath.\n");
    set_other_room(BATH +"sw_arc.c");
    set_open(0);
    set_locked(1);

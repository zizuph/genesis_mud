...
create_door()
{
    ...
    set_pass_command(({"sw", "southwest", "pass"}));
    set_fail_pass("The door is closed.\n");
    set_door_name(({"door", "door seven", "seventh door"}));
    set_door_desc("This door leads southwest into the public baths.\n");
    set_other_room(BATH +"ne_arc.c");
    set_open(0);
    set_locked(1);

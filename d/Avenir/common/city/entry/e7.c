// file name:        /d/Avenir/common/city/entry/e7.c
...
{
    set_short("blue slate path, about a two-thirds of the way to the Bath");
    set_long("Sedan chairs flow along the path, making the occasional "+
        ...
        "and beyond it, to the southwest, can be seen the terraced pyramid "+

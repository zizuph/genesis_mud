...
// last update: Lilith May 2022: added do_die with the wrath_obj like the
...
entry_route()
{
    ...
    seq_addfirst("crying",
       ({ "smile polite", "whisper defender How is the knee?",
          "emote asserts: If you want to know the time, just ask.", "w", 
          "emote stares up at the Source.", "stretch",
          "emote smiles engagingly.", "@@tell_time@@","w", 
          "emote asserts: There is no greater joy than pleasing the Gods.", 
          "emote leans against the dark stone wall.", "e", "e", 
          "bow respect all", "blue", "greet overseer",
          "whisper overseer love your hair", "emote appears to be "+
          "observing you with studied nonchalance.", "w", "@@tell_time@@", 
          2, "@@entry_route@@"}) ); 
    return 0;
}

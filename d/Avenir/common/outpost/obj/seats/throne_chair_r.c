...
create_seating(void)
{
    string str = one_of_list(({"white", "pink", "grey"}));
	
    set_name("throne");
	add_name("chair");
    set_adj(str);
    add_adj(({"rosewood", "throne-like"}));
    set_short("rosewood throne-like chair");
    set_long("It is a high-backed chair made of carved rosewood and "+
    ...
    set_seat_id(random(100)+"_f_throne_chair");

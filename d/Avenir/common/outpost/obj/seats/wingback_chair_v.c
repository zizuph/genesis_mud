...
create_seating(void)
{
    string str = one_of_list(({"blue", "dark blue", "royal blue", "teal blue",
	             "green", "forest green", "emerald green", "sage green",
                 "red", "crimson", "maroon", "carmine", "scarlet" }));
	
    set_name("chair");
    set_adj(str);
    add_adj(({"wingback", "velvet"}));
    set_short("velvet wingback chair");
    set_long("This is a big wingback chair upholstered in "+ str +" velvet. "+
    ...
    add_prop(OBJ_I_WEIGHT, 60000); // ~65 pounds

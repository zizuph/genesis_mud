...
create_vampires_room()
{
	...
	set_short("crevice");
	set_long("The dark stone of this place radiates the faintest warmth, "+
        "heated as it is by the magma flowing through the abyss "+ 
        "south of you. Crystals sprout around a somewhat jagged opening "+
        "that leads northwest.\n");
    ...
    add_item(({"crystal", "crystals", "opening"}),
        "Small crystals can be seen along the edges of an opening that "+
        "was broken between this crevice and a larger void beyond.\n"); 		
    add_exit("cv2_tunnel2", "northwest");

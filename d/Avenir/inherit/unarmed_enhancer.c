...
inherit "/std/unarmed_enhancer";           /* The normal weapon file   */
...
private nomask mixed get_enemy_weapon_desc(object enemy)
{
    ...
    weapons = FILTER_CAN_SEE(weapons, query_worn());
                ...
                int phit, int dam)
{
    ...
    */
   object     wield = query_worn(); /* object wearing us       */

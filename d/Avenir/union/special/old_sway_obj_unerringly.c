 ...
 *                   instead increase in special to_hit
 *
...
enter_env(object to, object from)
{
	...
	me->catch_tell("You close your eyes and focus all your "+
	    "energies on entering the Unerring Sway.\n");
    }
 ...
 *  set LIVE_I_SEE_DARK to 1 (unerring sway does not give this)
 *  set quickness to 25% of the sway skill 
 *  increase dex by dex * (sway / 10) % (unerring sway does not give this)
 *  increase in specials to_hit
 ...
 *  set LIVE_I_SEE_DARK to 2 (unerring sway does not give this)
 *  set quickness to 45% of the sway skill 
 *  increase dex by dex * (sway / 5) % (unerring sway does not give this)
 ...
 *  increase dex by dex * (sway / 2) % (unerring sway does not give this)
 ...
 *  set quickness to 95% of the sway skill (unerring sway does not give this)
 *  set LIVE_I_SEE_DARK to 3 (unerring sway does not give this)
...
end_sway(void)
{
    ...
    ALTER_PROP(me, SWAY_PHASE_PROP, 0);

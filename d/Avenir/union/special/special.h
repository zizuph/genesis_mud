...
/* average caid over the length of sway is 75% this maximum */
#define SWAY_EVADE_CAID 44
...
#define MIN_FLING_RECOVER	12
#define MAX_FLING_RECOVER	15
#define MIN_SLASH_RECOVER	9
#define MAX_SLASH_RECOVER	10
/*
 * FLING: Min  3 +  12 = 15
 *        Max 10 +  15 = 25
 *
...
#define SWAY_OBJ_DEF     (SPECIAL + "sway_obj_defensively")

#define SWAY_EVADE_OBJ   (SPECIAL + "sway_evade_obj")
#define STUCK_DAGGER_SH  (SPECIAL + "stuck_dagger_sh")

 ...
 * Arman,  Dec 2020: Created new variations of sway to provide
 *                   more versatility. No dex or vision bonus,
 *                   instead increase in special caid at the cost
 *                   of special to_hit
 *
...
enter_env(object to, object from)
{
	...
	me->catch_tell("You close your eyes and focus all your "+
	    "energies on entering the Aggressive Sway.\n");
    }
...
/*
 * Phase one of the unerring sway:
 *  set LIVE_I_SEE_DARK to 1 (aggressive sway does not give this)
 *  set quickness to 25% of the sway skill 
 *  increase dex by dex * (sway / 10) % (aggressive sway does not give this)
 *  increase specials caid at the cost of to_hit
 ...
 *  set LIVE_I_SEE_DARK to 2 (aggressive sway does not give this)
 *  set quickness to 45% of the sway skill 
 *  increase dex by dex * (sway / 5) % (aggressive sway does not give this)
 ...
 *  increase dex by dex * (sway / 2) % (aggressive sway does not give this)
 ...
 *  set LIVE_I_SEE_DARK to 3 (aggressive sway does not give this)
 ...
 *  set LIVE_I_SEE_DARK to 4 (aggressive sway does not give this)
 *  set LIVE_I_SEE_INVIS to 1 (aggressive sway does not give this)
 * Other stats and skills remain the same.

 ...
 *
 * 2021-05-04 - Lilith:
 * - Returned the SS_GRACE drop amount on misses to previous
 *   as Warriors were going negative.
 * 
 * 2021-08-01 - Zizuph
 ...
 *   extra damage per special due to their slower slash.
 */
#pragma no_clone
#pragma no_shadow
#pragma strict_types

...
create_forge_room()
{
    set_short("The south forge of the Smiths Guild");
    set_long("This is the south forge of the Smiths guild. It " +
    ...
    add_exit(SMITHSDIR_ROOMS+"forge_entr","north","@@check_forging@@");
...
leave_inv(object obj, object to)
{
    ...
    if (tools = present("smiths_forging_tools", obj))
    {
        ...
        tools->move("/d/Shire/smiths/rooms/forge_s");
        TP->add_fatigue(-100);

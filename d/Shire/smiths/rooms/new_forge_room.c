...
create_room() 
{
    ...
    add_prop(ROOM_M_NO_STEAL, thieves);
    ...
    if (!objectp("guild_assistant")) 
        room_add_object(SMITHSDIR_NPC+"berim", 1, QCTNAME(TO)+" arives.\n");
...
// adds drinking
    ...
    add_item("large barrel",
        "The large barrel is full of rainwater. It us used to " +
    ...
    add_exit(SMITHSDIR_ROOMS+"discus","west","@@check_forging@@");
...
"      |     - Chainmail              - Knife                         |\n"+
"      |     - Gauntlets              - Longsword                     |\n"+
"      |     - Greaves                - Quarterstaff                  |\n"+
"      |     - Platemail Greaves      - Shortsword                    |\n"+
"      |     - Scalemail Greaves      - Spiked Club                   |\n"+
"      |     - Helm                   - Stiletto                      |\n"+
"      |     - Great Helm             - Warhammer                     |\n"+
"      |     - Plate Helm                                             |\n"+
"      |     - Platemail                                              |\n"+
"      |     - Ribbed Platemail                                       |\n"+
"      |     - Ringmail                                               |\n"+

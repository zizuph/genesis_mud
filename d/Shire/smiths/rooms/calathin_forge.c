 ...
 * Modified slightly for Calathin - Finwe, Oct 2005
 */
...
create_forge_room()
{
    ...
    set_long("This is a hot forge. It is large with a heavy forge set in the middle of the room. Glowing coals fill the forge and radiate heat. A set of bellows sit next to the forge with a set of tools next to them. Those skilled in the art of blacksmithing may forge here. Some barrels of water sit against one wall with a sign posted above them.\n");
...
//    add_exit("/d/Khalakhor/se_speir/port/room/blacksmith_forge", "west", "@@check_forging@@");

...
create_room() {
	...
	("/d/Shire/smiths/npc/bores", 1, QCTNAME(TO)+" arives.\n");
    if (!objectp("brown book")) room_add_object
	("/d/Shire/smiths/obj/book", 1);
...
leave(string str) {
	...
	write("Are you sure you want to leave the Smiths guild?\n\nOnce you leave, you will not be permitted to ever join the Smiths again.\n\nIf you are sure this is what you want, type <leave guild> again.\n");
    ...
    TP->set_bit(FOURTH_GROUP,SMITHS_BIT);

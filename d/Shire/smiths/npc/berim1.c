...
//weapons
    ...
    add_ask(({"quarterstaff","staffs", "stafves", "quarterstafves"}),
        QCTNAME(TO)+" tells you: Oh, quarterstafves are a popular weapon. They require special training to be used 
...
// armours    
    ...
    add_ask(({"bracers","scalemail bracers", "platemail bracers"}),
        ...
        "this you will need an iron bar.\n");
    ...
    add_ask(({"helm", "great helm", "platemail helm"}),QCTNAME(TO)+

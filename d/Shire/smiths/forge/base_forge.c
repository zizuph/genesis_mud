...
/** Inherited from values from other files. 
    If strs are not suplied, we insert default values
 **/
// forge npc
void set_forge_npc(string str)      
{ 
    forge_npc = str; 
    if (!forge_npc)
        forge_npc = (NEW_SMITHSDIR + "base_forge_npc";
}
...
"      |                                                              |\n"+
"      |   You may plate your newly forged items with gold or silver. |\n"+
"      |                                                              |\n"+
"      |   Skilled smiths may forge the following items. Listed also  |\n"+
"      |   are the supplies needed.                                   |\n"+
"      |                                                              |\n"+
"      |     Armours                  Weapons                         |\n"+
"      |   =========================================================  |\n"+
"      |   - Shirt of chainmail     - Halberds                        |\n"+
"      |       iron bar, leather        iron bar, leather, wood       |\n"+
"      |   - Shirt of ringmail      - Battle axes                     |\n"+
"      |       iron bar, leather        iron bar, leather             |\n"+
"      |   - Helms                  - Longswords                      |\n"+
"      |       iron bar, leather        iron bar, leather             |\n"+
"      |   - Platemails             - Stilettoes                      |\n"+
"      |       iron bar, leather        iron bar                      |\n"+
"      |   - Greaves                - Shortswords                     |\n"+
"      |       iron bar, leather        iron bar, leather             |\n"+
"      |   - Bracers                - Claymores                       |\n"+
"      |       iron bar                 iron bar, leather             |\n"+
"      |   - Boots                  - Knives                          |\n"+
"      |       iron bar, leather        iron bar, leather             |\n"+
"      |                            - Warhammer                       |\n"+
"      |                                iron bar, leather, wood       |\n"+
"      |                                                              |\n"+
"      |    o                                                   o     |\n"+
"      |  o O o                                               o O o   |\n"+
"      +--------------------------------------------------------------+\n\n";

...
create_container()
{
    ...
    set_name("box");
    set_adj("steel");
    set_long("This is a large steel box. It is ornately " +
        "decorated with geometric shapes and used to store " +
        "equipment for the guild.\n");

    add_prop(OBJ_M_NO_GET, "The steel box is too valuable to take.\n");

...
#define SMITHS_TRANSFER_LOG   ("/d/Shire/guild/smiths/log/transfer")
#define SMITHS_TRANSFER_OBJ   ("/d/Shire/guild/smiths/lib/transfer")
...
#define SMITH_STEEL_OBJECT_LOG  (SMITHSDIR_LOG + "smith_steel_object_log")
...
#define SMITH_MEMBERSHIP_LOG ("/d/Shire/guild/smiths/log/membership.log")
...
remove_smith_guild_member(object member)
{
    ...
    member->set_guild_pref(SS_LAYMAN, 0);

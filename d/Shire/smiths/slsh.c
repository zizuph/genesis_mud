 ...
 *
 *   Modified to reflect changes made within the guild. This includes new titles,
 *   new skills, new admission/acceptance criteria, and the removal of the council.
 *   Glaurung 1-2-98
...
// other guild title functionallity
    ...
    else if (shadow_who->query_guild_name_occ() == "Union of the Warriors of Shadow")

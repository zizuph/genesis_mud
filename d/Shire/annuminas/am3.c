...
create_room() {
  ...
  set_long("You have travelled further down the broken stone road. "
 	  +"The same mist still obscures the view, hiding the ruins "
          +"that lie to the north. The carpet of grass that surrounds "
	  +"the road is lush and green and covers the small piles of rubble "
	  +"that lie aging in the air.\n"); 
  ...
  add_exit(ANNUM_DIR + "am4", "north", 0);
  add_exit(ANNUM_DIR + "am2", "southeast", 0);
}

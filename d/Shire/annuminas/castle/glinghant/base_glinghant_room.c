/*
 * Base file for the Glinghant area
 */
...
public void create_room()
{
    ...
    add_item(({"pillars", "pillar", "tall pillars"}),
        "The pillars are massive, and stand symmetrically in two rows " +
        "along the east, west, north and south walls of the hall. The " +
        "pillars to the east appear to be most intact, while the " +
        "others are crumbling in various stages of decay.\n");
    ...
    add_item(({"ceiling"}),"The ceiling extends overhead into the " +
        "overarcing darkness above. Since it blocks any light from " +
        "sun or stars, you assume that it must be mostly intact.\n");
   ...
   add_item(({"mica"}),"a shiny silicate mineral with a layered " +
		"structure, found as minute scales in granite and other rocks, " +
		"or as crystals.\n");
   
   add_cmd_item("mica", "get", "the minute pieces are far too small " +
		"and are mixed directly into the tiles. Its impossible for " +
		"you to collect any.");      
...
test_vines()
{
  // room gling_5_6.c
    ...
    {
       return "The vines form and wind long the base of a " +
...
test_statue()
{
	if (CASTLE_GLINGHANT_VINEROOM->query_vinecreeper())
	{
        return "From this distance, and poor lighting, you can just " +
...
test_flowers()
{
	if (CASTLE_GLINGHANT_VINEROOM->query_vinecreeper())
	{
       ...
       {
          return "Tiny red and white flowers grow along " +
                 ...
                 "flowers at all. The stems " +
                 "appear to be more veinlike, and the petals " +
                 "are far to leathery It looks more like animal " +
                 "than plantlike. Upon closer inspection, the red " +
                 "flowers seem to pulse in concert with one another.\n";
       } 
       else
           return "Tiny red flowers can just be seen beginning from " +
				"the origin of the vine, turning white towards the ends " +
				"of the vines.";
	}
}
...
my_long()
{
	...
	{
		return (
			"Once a place of great beauty, now " +
			"overgrown and fallen into ruin. The marble tiled floor " +
			"is still somewhat intact, as are four rows of tall pillars " +
			"running south to north, and another two rows running, " +
			"east to west converging at the center of the hall. Between " +
			"the pillars is a shallow rectangle mirror pool. Portions " +
			"of a large statue in decay rests at the pool cross center. " +
			"Small brackish pools of water can be seen at the center " +
			"and pooled along the edges. Plants of different types " +
			"seem to thrive in the brackish water that covers most of " +
			"the marble tiled floor. The walls and various surfaces " +
			"are stained by years of mold and mildew. Flowery thorned " +
			"vines seem cover everything from the floor to the cracked " +
			"dome above. Several large holes from fallen pieces of the " +
			"domed ceiling have damaged the mosaic surface of the pool. " +
			"The stone walls have been stripped bare of decoration, " +
			"and what was once a graceful room full of light, beauty " +
			"and music is dark and still as a tomb. The hall extends " +
			"in all directions. Its very humid here.\n");
    } else 
    return (
        "Once a place of great beauty, now overgrown and " +
        "fallen into ruin. The marble tiled floor is still somewhat " +
        "intact, as are four rows of tall pillars running south to " +
        "north, and another two rows running, east to west converging " +
        "at the center of the hall. Between the pillars " +
        "is a shallow rectangle mirror pool. Portions of a large statue " +
        "in decay rests at the pool cross center. Small brackish " +
        "pools of water can be seen at the center and pooled along the " +
        "edges. Plants of different types seem to thrive in the " +
        "brackish water that covers most of the marble tiled floor. " +
        "The walls and various surfaces are stained by years of mold " +
        "and mildew. Several large holes from fallen pieces of the " +
        "domed ceiling have damaged the mosaic surface of the pool. " +
        "The stone walls have been stripped bare of decoration, " +
        "and what was once a graceful room full of light, beauty and " +
        "music is dark and still as a tomb. The hall extends in " +
        "all directions.\n");
}

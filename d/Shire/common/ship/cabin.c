...
create_cabin()
{
  set_short("A spacious and luxurious cabin inside the elegant ship");
  set_long("The cabin, surrounding you with more space than would "+
    "seem to fit within the ship, has a pervasive scent, reminiscent "+
    "of a subtle blend of freshly cut cedar, pine, and lebethron. "+
    "The wood forming the bulk of the cabin glows as only well polished "+
    "wood can, reflecting and magnifying any hint of light that "+
    "seeps in through the upper door and portholes until all shadows "+
    "are banished from the room. Low hung benches and beds adorn "+
    "the walls, interspersed with the windows and bare wall. "+
    "A solitary, slender stairway winds its way up towards the "+
    "deck of the ship.\n");

  add_exit(SHIP_DIR + "deck", "up",0,3);
  add_prop(ROOM_I_LIGHT, 10);

  add_item(({"door","upper door","doorway","upper doorway"}),
    "The door looks like it is crafted of the same blend of woods "+
    "that composes the rest of the cabin.\n");

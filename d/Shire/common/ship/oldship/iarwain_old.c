...
create_monster()
{
   ...
   add_chat("Mithlond is the last refuge for elves in Middle-Earth.");
   add_chat("Cirdan the shipwright lives in Mithlond.");
...
buy(string str)
{
    ...
    buy_ob=clone_object("/d/Shire/common/obj/ticket2");
    if (!buy_ob) {
    ...
    {
	if (present("the Mithlond-Gont line", TP))
	{
	    command("sigh");

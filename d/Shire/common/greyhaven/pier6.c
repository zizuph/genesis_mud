...
create_shire_room()
{
    ...
    add_item(({"sign"}),"The sign reads: Ship to Gelan has been discontinued.\n");

    add_exit("/d/Shire/common/greyhaven/path6","east",0,1);
...
do_read(string str)
{
    ...
    write("The sign reads: Ship to Gelan has been discontinued.\n");
    return 1;
}

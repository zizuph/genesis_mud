...
/* Ship replaced with PM - GH newbie circle line - Tapakah 05/2009 */
...
create_shire_room()
{
  //  ::create_pier();
    ...
    add_item(({"sign"}),"The sign reads: Ship to Port MacDunn is no longer available.\n");

    add_exit("/d/Shire/common/greyhaven/path7","east",0,1);
    add_prop(ROOM_I_NO_CLEANUP,1);
    add_pier_entry(MASTER_OB(TO), "Grey Havens",
...
do_read(string str)
{
    ...
    write("The sign reads: Ship to Port MacDunn is no longer available.\n");
    return 1;
}
*/

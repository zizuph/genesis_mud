...
create_room() {
   set_short("The post office of the Hin Warrior guild");
   set_long("@@my_long");
   ...
   add_exit(HINROOM_DIR + "hall1", "south");
...
my_long() {
   string long;
   long = "You have entered a cave of some sort, with many little holes \n"
   + "in the wall. A special division of the Hin Warrior Guild is\n" 
   + "day and night busy here, to keep the mail from all over Genesis\n"
   + "flowing in. Several runners take outgoing mail to places all\n"

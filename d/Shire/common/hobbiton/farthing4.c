...
create_room()
{
    ...
    + "and smoked. The land looks ready for harvest. The "
    + "ground seems rich.\n", 70));

    add_item("ground", break_string(
      "The ground seems to be full of useful greens, and perhaps "
   ...
   add_exit(STAND_DIR + "farthing2","east");
add_exit(STAND_DIR + "farthing5","west");
add_exit(STAND_DIR + "farthing6","south");
}

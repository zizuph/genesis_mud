/* File: /d/Shire/common/hollin/dwarfroad.11.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "Now you are standing in the entrance of a valley in front of the Misty "
        + "Mountains. Silvertine (Celebdil to elves) looms high above you in white "
        + "mists, probably one of the highest mountain top you have ever seen.\n"
    ...
    add_item(({"valley",""}),
        "This is a valley which leads upwards to the Misty Mountains.\n"
    );
    add_item(({"silvertine",""}),
        "The top is increadibly large and looms high above you.\n"
    );
    add_exit(TEMP_DIR + "dwarfroad.12", "east", 0);
    add_exit(TEMP_DIR + "dwarfroad.10", "west", 0);
}

/* File: /d/Shire/common/hollin/dwarfroad.2.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "The road continues east and west. North of you, there is a dense "
    ...
    add_exit(TEMP_DIR + "dwarfroad.3", "east", 0);
    add_exit(TEMP_DIR + "dwarfroad.1", "west", 0);
}

/* File: /d/Shire/common/hollin/dwarfroad.12.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "The valley still goes east and west, and the Road follows the River in "
        + "this direction.\n"
    ...
    add_item(({"valley"}),
        "The valley goes up to the east towards the Misty Mountains.\n"
    );
    add_exit(TEMP_DIR + "dwarfroad.13", "east", 0);
    add_exit(TEMP_DIR + "dwarfroad.11", "west", 0);
}

/* File: /d/Shire/common/hollin/dwarfroad.6.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "The dwarven road continues northeast and southwest. North of you "
        + "the Hollin forest extends and the river follows your path.\n"
    ...
    add_exit(TEMP_DIR + "dwarfroad.7", "northeast", 0);
    add_exit(TEMP_DIR + "dwarfroad.5", "southwest", 0);
}

/* File: /d/Shire/common/hollin/dwarfroad.5.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "Westwards, the road continues up somewhat on a high part of the "
        + "river-bank on which you are following. Here, the river turns "
        + "from the north-east to the west, and the road follows along it.\n"
    ...
    add_exit(TEMP_DIR + "dwarfroad.6", "northeast", 0);
    add_exit(TEMP_DIR + "dwarfroad.4", "west", 0);
}

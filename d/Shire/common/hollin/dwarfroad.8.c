/* File: /d/Shire/common/hollin/dwarfroad.8.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "You can see the Knoll somewhat northwest of you now, while the Road "
        + "continues along the River northeast and southwest.\n"
    ...
    add_item(({"knoll"}),
        "The knoll lies northwest of you.\n"
    );
    add_exit(TEMP_DIR + "dwarfroad.9", "northeast", 0);
    add_exit(TEMP_DIR + "dwarfroad.7", "southwest", 0);
}

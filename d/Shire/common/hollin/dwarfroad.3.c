/* File: /d/Shire/common/hollin/dwarfroad.3.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "The road still continues east and west, and the Hollin forest "
        + "lies in the north.\n"
    ...
    add_exit(TEMP_DIR + "dwarfroad.4", "east", 0);
    add_exit(TEMP_DIR + "dwarfroad.2", "west", 0);
}

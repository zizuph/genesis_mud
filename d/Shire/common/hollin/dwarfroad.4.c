/* File: /d/Shire/common/hollin/dwarfroad.4.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "The broad dwarf-road goes east and west, and looking north you "
        + "have the Hollin forest. You can see the river from here, since "
        + "you are standing on a high top of the river-bank, and you notice "
        + "that the river goes quite low. You wonder what have stopped the "
        + "water from flowing this once great river.\n"
    ...
    add_item(({"river-bank",""}),
        "The bank goes a little bit higher here than elsewhere.\n"
    );
    add_exit(TEMP_DIR + "dwarfroad.5", "east", 0);
    add_exit(TEMP_DIR + "dwarfroad.3", "west", 0);
}

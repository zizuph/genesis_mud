/* File: /d/Shire/common/hollin/dwarfroad.7.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "The river continues northeast and southwest, as does the Dwarf-Road. "
        + "Looking north, you can see a knoll in the Forest.\n"
    ...
    add_item(({"knoll"}),
        "The knoll is just a small hill with some tall trees around.\n"
    );
    add_exit(TEMP_DIR + "dwarfroad.8", "northeast", 0);
    add_exit(TEMP_DIR + "dwarfroad.6", "southwest", 0);
}

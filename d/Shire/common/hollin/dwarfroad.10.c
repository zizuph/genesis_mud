/* File: /d/Shire/common/hollin/dwarfroad.10.c */ 
...
create_dwarfroad()
{
    ...
    set_long(
        ...
        + "Here, the River turns from the east to the southwest, and the Road "
        + "still follows the river bank.\n"
    ...
    add_exit(TEMP_DIR + "dwarfroad.11", "east", 0);
    add_exit(TEMP_DIR + "dwarfroad.9", "southwest", 0);
}

...
* Borrowed for use in the Shire as a Squirrel. Dunstable ;)
   * Oct 1994
*shamelessy borrowed by Shanna to change into a rabbit    2/95
  */
...
set_long("A fat white rabbit with red eyes and huge "+
"buck teeth.\n");
set_adj(({"fat","white"}));
...
set_alignment(75-random(25));
  ...
  seq_new("do_first");
seq_addfirst("do_first",({"@@arm_me","blink","emote wiggles its nose."}));
}

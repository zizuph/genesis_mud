...
#define NAME1 "butterfly"
#define NAME2 "butter fly"
#define NAME3 "fly"
#define PNAME "butterflies"
#define LONG "This butterfly flutters around with the wind.\n"
#define ADJ1 "colorful"
#define ADJ2 "delicate"
#define ALIGN 85
#define WEIGH 500
#define MOUT "flutters"
#define AMIN "flutters in."   /* Don't forget the period. :) */
#define FIGHT1 30   /* Unarmed */
#define FIGHT2 60  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote alights on a blade of grass."
#define ACTTIME 7
#define ACT1 "emote flutters past your ear."
#define ACT2 "emote alights on a blade of grass."
#define ACT3 "emote flaps around gently."

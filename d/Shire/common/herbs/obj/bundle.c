...
#define MASTER_BUNDLE "/d/Shire/common/herbs/obj/master_bundle.c"
#define LOG write
...
// restore empty wrap
    ...
    stun_eff = clone_object("/d/Shire/common/herbs/stun_eff");
    stun_eff->move(this_player());

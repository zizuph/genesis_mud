...
#define MAP_FILE "/d/Shire/common/herbs/obj/bundle_map"

// Upped time from 7 to 14 days. Palmer Sept 15 2005
/* MAX_TIME is oldest time for bundles in seconds before it is deleted.
 * Currently set to 14 days.
 * 86400 = 1 day, or 86400 seconds
 */
#define MAX_TIME 1209600

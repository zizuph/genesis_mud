...
create_shawrom()
{
    ...
    set_extraline(
	 "You find that your legs have taken you to the northeast "
	+"part of a ridge in the trollshaws. Down to the east you see "
	+"a path going through some bushes while to the south and west "
	+"the ridge continues. Northeast and northwest there are some "
	+"narrow paths that would take you down from this ridge. ");

...
#define OTHER_WEPS ({WEP + "trollclub", WEP + "greataxe", WEP + "trollhalb", WEP + "trollsword", WEP + "poison_dagger"})
...
// which weapon is cloned
int wep_num = random(4);
...
void s_save_object ()
{
  ...
  save_object (MASTER_OB (this_object ()));
}
 
void s_restore_object ()
{
  setuid (); seteuid (getuid (this_object ()));
  restore_object (MASTER_OB (this_object ()));
}
...
// determines which magical weapon to clone

    switch (wep_num)
        {
            case 0:
write(wep_num+"\n");
                wep = clone_unique("/d/Shire/common/trollsh/weapon/gem_sword", 
                3, OTHER_WEPS );
            break;
            case 1:
write(wep_num+"\n");
                wep = clone_unique("/d/Shire/common/trollsh/weapon/gem_axe", 
                3, OTHER_WEPS);
            break;
            case 2:
write(wep_num+"\n");
                wep = clone_unique("/d/Shire/common/trollsh/weapon/gem_flail", 
                3, OTHER_WEPS);
            break;
            case 3:
write(wep_num+"\n");
                wep = clone_unique("/d/Shire/common/trollsh/weapon/gem_halberd", 
                3, OTHER_WEPS);
            break;

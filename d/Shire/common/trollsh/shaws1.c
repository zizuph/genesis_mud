...
create_shawrom()
{
    ...
    set_extraline("This ridge looks north and east where the ridge continues. It is overgrown with bushes. To the southwest is a narrow slope leading down to the Great East Road.\n");
         
    add_item("slope",
        "The slope winds its way down southwest toward the Great East Road.\n"); 

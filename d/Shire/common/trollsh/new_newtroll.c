 ...
 */ 
    ...
    type  = (({"young", "large", "warrior",}));
 
/* 
 * randomly chooses adjectives and type of crab to create
 */
    ...
    add_adj(color[y]);
    add_adj(type[z]);
    set_short(color[y] + " " + type[z] + " troll");
    set_race_name("troll");
    ...
    switch (type[z]) // set's stats based on size
    {
        case "young": // young
        {
            set_stats(({120+random(50),
                120+random(50), 
                125+random(50), 
                120+random(50),  
                120+random(50), 
                75}));
            set_exp_factor(50+random(7));
            break;
        }
        ...
        case "large": // large
        {
            set_stats(({130+random(30),
                ...
                130+random(30), 
                100+random(30)}));
            set_exp_factor(50+random(5));
                set_exp_combat(600+random(200));
            break;
        }
        case "warrior": // warrior
        {
            set_stats(({200+random(20),
                200+random(20), 
                200+random(20), 
                75+random(20),  
                75+random(20), 
...
// Armours
    ...
    arm = ({"wgaunt1", "wgaunt"})[random(2)];
    clone_object(ARM_DIR + arm)->move(TO);

// Weapons
    wep = ({"nastyclub", "tr_scimitar","trollclub","trollaxe","trollmstar"}) [random(5)];

...
create_tunnel_room()
{
    ...
    add_my_desc("Angling northwest and southeast, the narrow " +
        "tunnel coonects two other tunnel networks.\n");

    add_exit(TUN_DIR + "tb21", "northwest");
    add_exit(TUN_DIR + "ta27", "southeast");

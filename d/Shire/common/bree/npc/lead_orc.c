...
create_monster()
{
   ...
   set_race_name("orc"); 
   set_long("This orc is one of the clan leaders in the camp. " +_
        "He's vicious and tolerates little from other orcs.\n");

   add_prop(CONT_I_WEIGHT,87000);   /* 87  Kg */
   add_prop(CONT_I_HEIGHT,153);     /* 153 cm */
   set_stats(({ 52, 41, 50, 23, 20, 50}));

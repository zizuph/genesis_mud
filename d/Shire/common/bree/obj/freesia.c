...
{
    player->catch_msg("You breathe deeply and inhale nothing but freessia. " +
        "Its fragrance is sweet and intoxicating--Ahh!\n");

    tell_room(environment(environment(TO)), "The sweet and intoxicating " +
        "fragrance of freesia envelopes you for a moment.\n");
}

...
enter_env(object to, object from)
{
  ...
  if (!living(to)) 
  {
    ...
    set_alarm(1.0, 90.0, "stench_message", to);
    alarm_id = set_alarm(450.0,0.0,&remove_stench());
}
...
{
  player->catch_msg("You catch a whiff of your clean-smelling "
    + "sandalwood perfume.\n");

    tell_room(environment(environment(TO)), "A cool breeze brings the delightful odor of sandalwood to your nose.\n");
}

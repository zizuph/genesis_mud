...
create_room()
{
  set_short("The branch of the money-deposit service in Bree");
  set_long("You are in a side-room of the Bank of Bree. This is the\n"+
    "branch of the Gnomes of Genesis money-deposit in Bree-hill,\n"+
    ...
    add_exit(BREE_DIR + "bank","west",0,1);

...
void create_room()
{
   ::create_room();
    ...
    set_short("A private room of the Prancing Pony");
    set_long("This is a private room in the Prancing Pony. Travellers " +
...
get_order(string item_name)
{
    ...
    case "coffees":
    case "1":
        order = clone_object(SUPL_DIR + "coffee");
        price = 40;
        break;
    case "green tea":
    case "green teas":
    case "2":
        order = clone_object(SUPL_DIR + "g_tea");
        price = 20;
        break;
    case "black tea":
    case "black teas":
    case "3":
        order = clone_object(SUPL_DIR + "b_tea");
        price = 20;
        break;
    case "ale":
    case "mulled ale":
    ...
    case "vegetable pies":
    case "5":
        order = clone_object(SUPL_DIR + "pie_veg");
        price = 150;
        break;
    ...
    case "meat pies":
    case "6":
        order = clone_object(SUPL_DIR + "pie_meat");
        price = 150;
        break;
    ...
    case "7":
        order = clone_object(SUPL_DIR + "potatoes");
        price = 77;
        break;
    case "boar":
    case "wild boar":
    ...
    case "8":
        order = clone_object(SUPL_DIR + "boar");
        price = 160;
        break;
    case "mushrooms":
    case "steamed mushrooms":
    case "9":
        order = clone_object(SUPL_DIR + "mushrooms");
        price = 132;
        break;
    case "hens":
    case "hen":
    ...
    case "game hens":
    case "10":
        order = clone_object(SUPL_DIR + "hen");
        price = 175;
        break;

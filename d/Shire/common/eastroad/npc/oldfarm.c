...
{
   set_name("bibble");
   set_living_name("_bibble_");
   set_pname("bibbles");
   add_name(({"_old_milk_farmer_","farmer"}));
   set_race_name("hobbit");
   add_adj(({"old","rickety"}));
   set_long("Your heart goes out to this old rickety hobbit. "+
   "He is very very old, and walks with a severe limp. You wonder how "+
   "he ever gets around in his condition.\n");

/*
 * Modified from /doc/examples/obj/crystal.c for the Shire by Finwe, July 2002.
 * This crystal has no special abilities.
 * 
...
crystal_long()
{
    return "The small clear crystal" + 
        ((num_heap() == 1) ? " is " : "s are ") + "tear shaped. The " +
        "cut facets catch the light, scattering a rainbow of light everywhere.\n";
}

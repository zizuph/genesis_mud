...
//inherit "/d/Shire/guild/clubs/common_clubs";
...
fbeat(string str)
{
    ...
    if(!str) 
    {
	write("You shake your cane at everyone.\n");
	all(" shakes his cane at you.");
	return 1;
    }
    ...
    if(!sizeof(oblist))
    {
	write("Beat whom with your cane?\n");
	return 1;
    }

    actor("You beat",oblist, " soundly about the head and shoulders.");
    target(" beats you soundly about your head and shoulders " +
        "with his cane.",oblist);
    all2act(" beats",oblist," soundly about the head and shoulders.");
    return 1;
}
...
fhelp()
{
    ...
    write("Old Fogeys have the following commands at their service:\n"+
      "==========================================================\n"+
   "   (fac)he:          Mention how painful your aches are.\n"+
   "   (fbe)at:          Get a young 'un's attention.\n"+
   "   (fgo)ut:          Let everyone know your gout is acting up again.\n"+
   "   (fhe)lp:          This menu.\n"+
   "   (fji)g:           Dance a jig like only you know how.\n"+
   "   (fle)an:          Momentarily lean on your cane.\n"+  
   "   (fli)mp:          Let your leg drag a bit. 'flimp stop' will make you\n"+
   "                     walk again normally.\n"+
   "   (fpa)in:          Let a moment of pain show on your face.\n"+
   "   (fpo)int:         Point at something with your cane.\n"+
   "   (fre)mind:        Remind people of things they might have forgotten.\n"+
   "   (frh)eumatism:    Let your fingers tremble as sign of your decay.\n"+
   "   (fsm)ile:         Let your toothless grin show!\n"+
   "   (fst)ammer:       Speak in an unhasty way so as to annoy the young 'uns!\n"+
   "   (fwa)rn:          Warn your fellows about the danger of wiles.\n\n"+ 
...
flean()
{
    write("You lean against your cane in order to rest your " +
        "weary bones.\n");
    all(" leans on his cane, resting his weary bones. The cane " +
        "bends slightly under his weight.");
    return 1;
}
...
flimp(string str)
{
    if (TP->query_fogey_limp_shadow() && str != "stop")
    {
...
start_limp(object player)
{
    ...
    if(player->query_prop(SKIP_PROP))
    {
        write("This may conflict with your Treehouse Club movement. Please " +
            "turn that off first.\n");
        return;
    }
...
frheumatism()
{
    write("You wring your hands, muttering about your rheumatism.\n");
    all(" wrings his hands, complaining about rheumatism.");
    return 1;
}

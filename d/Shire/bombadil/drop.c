...
//   seteuid(getuid());
   ...
   set_long("This large room is designated for advanced Smiths. " +
       ...
       "with others. A large crate for storing equipment sit against " +
...
// safe rooms
   ...
   clone_object("/d/Shire/smiths/obj/sm_adv_box")->move(this_object(), 1);
...
pick_up(object ob)
{
    ...
    cleaner->command("say Allow me to lend you a hand and put this in the box for you.");

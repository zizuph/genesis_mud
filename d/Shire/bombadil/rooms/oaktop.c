/*
 * Top of the Oak Tree at Tom Bombadill's house.
...
{
    set_areadesc("tree top of a");
    set_area("mighty oak next to");
    set_areaname("the merry cottage");
    set_land("in the clearing");
    set_areatype(0);
   
//    set_short("Treetop");
    set_extraline("The branches " +
        "stretch out in all directions shading the house and the " +
        "clearing. Bird nests are scattered throughout the branches, " +
        "some old and some new.");

    add_item("tree",
        "This is an ancient, oak tree. It is the only tree growing " +
        "in the clearing and has long, thick branches. Green leaves " +
        "cover the branches and bird nests are scattered throughout " +
        "the tree.\n");
    add_item(({"nests", "bird nests",}),
        "The nests are both new and old looking. Some of the newer " +
        "ones even have some birds in them, but those are mostly " +
        "out of reach. The nests are small, and made of twigs and " +
        "feathers.\n");

 ...
 * By Finwe, July 2000
 *
 * 2005/10/12 Last update
 * 2011/08/02 Lavellan - Removed useless reset_room here as it was preventing
 *                       tents from reloading (they use reset_shire_room and
 *                       not add_stuff!)
 */
...
#include "local.h"
#include "/d/Shire/bree_camp/camp.h"
...
create_shire_room()
{
    ...
    add_item(({"bones","bone","pile"}), 
        ...
        "white and pocked with teeth marks.\n");

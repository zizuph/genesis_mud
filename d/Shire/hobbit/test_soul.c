...
hcheer(string str)
{
    ...
    alarm_id = set_alarm(3.0,0.0,"do_toast");
    return 1;
}
...

{
	...
	write("Your building desperation and frustration boil over, and "+
	  "you launch yourself into combat renewed with a unexpected ferocity.\n");

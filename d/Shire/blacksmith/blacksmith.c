...
create_monster()
{
    ...
    set_adj("muscular");
    set_adj("large");
    set_long("This is Derick, a master blacksmith. He is muscular from years of forging and repairing weapons and armours. His dark hair is peppered with gray, and his face is smudged with dirt. He looks like he has been travelling and had to stop here for a time, probably to raise money for fare. Use <help blacksmith> for more information on how he can help you.\n");

...
create_armour() {
	...
	+ "They are light and fits your legs nicely. They will "
...
do_kick(string str)
{
    ...
    if(str)
	attacker = present(lower_case(str), ETP);
    else
...
spell_attack(object me, object vict)
{
    ...
    watchers = filter(watchers, "sees_fights", TO);
    watchers -= ({ me, vict });
	...
	case 10..19:
	    ...
	    break;
	case 20..39:
	    good = "[You] cakcle[s] grinningly as [you] kick[s] the guts out "
		 + " of [him]!";
	    break;
	case 40..59:

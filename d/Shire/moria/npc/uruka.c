...
string short() { return "very evil Uruk-Hai"; }

string query_nonmet_name() { return "Uruk guard"; }
...
arm_me()
{
    ...
    clone_object(MORIA_OBJ+"bowstring")->move(this_object());
    clone_object(MORIA_OBJ+"bowstring")->move(this_object());
    clone_object(MORIA_WEP+"quiver_black")->move(this_object());
    clone_object(MORIA_WEP+"longbow")->move(this_object());
    clone_object(MORIA_WEP+"arrow_lblack")->move(this_object());
    clone_object(MORIA_WEP+"arrow_lblack")->move(this_object());
    clone_object(MORIA_WEP+"arrow_lblack")->move(this_object());
...
*/
	...
	who->catch_msg(
	    "The Uruk-Hai swears some ugly curses and runs past you.\n");
	go_home();
    }
}

/* 
 *   This is the standard room for Moria as found after 
 *   after lots of digging... (Toby)
 *   
 *   Added terrain.h support at a request by Ibun to support
 *   new cool enchanted stuff.
 *   -- Toby, 10'th of Sept 2007
 *
 */

...
CONSTRUCT_ROOM
{
    set_short("East end of a brightly lit hall");
    set_long(
	"You are in the eastern end of a brightly lit hall. The hall is "+
	"domed and big chandeliers illuminates the whole room. There is a "+
	"wide passage leading east out of here.\n");
    add_item("ceiling",

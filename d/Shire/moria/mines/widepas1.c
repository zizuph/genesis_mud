...
CONSTRUCT_ROOM
{
    set_short("North end of a wide passage");
    set_long(
	"You are standing by the north end of a wide sloping passage. "+
	"In the east, there is a little hole leading into a bigger room. "+
	"The walls are amazingly straight and dry.\n");
    add_item("passage", "It is approximately seven meters wide.");
    ...
    add_item("hole", "The hole leads east into a cave.");

...
CreateMines()
{
    ...
    set_long(
        ...
        ". " +
        "You notice that the tunnel winds northwards. " +
        "You are also able to follow the exit leaving up through a hole. " );
    add_exit(THIS_DIR + "mining.3","north");
    add_exit(THIS_DIR + "mining.1","up");
    add_item(({"wall","walls"}),

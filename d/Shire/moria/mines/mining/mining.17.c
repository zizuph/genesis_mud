...
CreateMines()
{
    ...
    set_long(
        ...
        ". " +
        "There is one exit which levels out in the west. " +
        "Also, there is an exit continuing in the east. " );
    add_exit(THIS_DIR + "mining.18","west");
    add_exit(THIS_DIR + "mining.16","east");
    add_item(({"wall","walls"}),

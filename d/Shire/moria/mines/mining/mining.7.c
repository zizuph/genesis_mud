...
CreateMines()
{
    ...
    set_long(
        ...
        "There is one exit which levels out in the east. " +
        "Also, there is an exit winding south-west. " );
    add_exit(THIS_DIR + "mining.8","east");
    add_exit(THIS_DIR + "mining.6","southwest");
    add_item(({"wall","walls"}),

...
CONSTRUCT_ROOM
{
    ...
    set_long("You are climbing in a steep stair-case with a hot and " +
	     "damp, red-glowing steam surrounding. You can feel the " +
	     "intensity of the steam growing as you descend into the " +
	     "darkness.\n");
    ...
    add_exit(THIS_DIR + "lair", "down", "@@check_slip|10@@", 3);
    add_exit(THIS_DIR + "stair1", "up", "@@check_slip|50@@", 12);
}

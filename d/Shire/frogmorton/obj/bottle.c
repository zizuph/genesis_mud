...
static  object  *gFail = ({ });
string long_descr = "This is a big glass bottle. It is used to hold " +
        "drinks during travels. It can be filled with drinks, and later, " +
        "you can drink from it. On the bottom of the bottle it reads, " +
        "'Made in Frogmorton'.";
int
query_alco()
{

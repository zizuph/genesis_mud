 ...
 *
 * 2001/10/09 Last update
 * 2011/08/05 Lavellan - Removed bad duplicate hobbit spawn to void
 *                     - Changed to use previously unused individual files for 
                         food/drink (from unused inn_new etc)
 */
...
#define SUPL_DIR FROG_DIR + "supplies/"
...
/*      order = clone_object("/std/drink");
    ...
    case "meat": case "meat pie": case "9":
      ...
      order = clone_object(SUPL_DIR + "mpie");
      price = 235;
      break;

...

{
    ...
    set_long("You are walking along a wide, well-travelled dirt road which " +
        ...
        "Longbottom Leaf. The road also continues east towards Sarn " +
        "Ford, and out of the Shire. Almost everywhere you look, there " +
    ...
    add_item(({"longbottom", "village"}),
        ...
        "take the northwest fork in the road here, you should enter the " +
        "village proper.\n");
    ...
    add_item(({"sarn ford", "sarn", "ford", "Sarn Ford", "stone", "stones"}),
        ...
        "Gondor. You can find it following the road east from here.\n");
    add_item(({"river","brandywine", "baranduin"}),
        "Somewhere to the east, is the legendary Brandywine river, " +
    ...
    add_exit(SARNFORD_DIR + "wroad6.c", "east");
    add_exit(SARNFORD_DIR + "wroad8.c", "west");
    add_exit(LB_DIR + "rooms/road01.c", "northwest", "@@valley@@",);

    add_std_herbs("field", 12);
}

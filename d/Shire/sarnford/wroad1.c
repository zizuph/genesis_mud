...

{
    ...
    set_long("You are walking along a wide, well-travelled dirt road between " +
        ...
        "To the east, the mighty Brandywine river cuts its way " +
        "through the tall grass of the fields. The road you are on appears " +
  	    "to run directly into a wide stone path which cuts across " +
  	    "the rushing waters of the river, this is the crossing " +
        "known as Sarn Ford.\n");
    ...
    add_item(({"river", "brandywine", "baranduin"}),
        ...
        "otherwise known as the Baranduin River, as it twists and cuts " +
        "its way through the grass fields. The wide, stone path of Sarn " +
        "Ford cuts across the river just to the west.\n");
    ...
    add_exit(SARNFORD_DIR + "wroad2.c", "west");

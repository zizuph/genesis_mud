...
create_camp_room()
{
	...
	add_exit(CAMP_DIR + "track07", "south");
	add_exit(CAMP_DIR + "track12", "east");
	add_exit(CAMP_DIR + "track10", "west");
	add_exit(CAMP_DIR + "track14", "northeast");
	add_exit(CAMP_DIR + "track08", "southeast");
	add_exit(CAMP_DIR + "track06", "southwest");

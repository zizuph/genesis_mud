...
create_camp_room()
{
	set_extraline("This is a grassy field, standing between " +
        "large green patches of tall grass. The grass is " +
        "trampled  down by what is probably countless feet. " +
        "Dense bushes block your view in places.");
	...
	add_exit(CAMP_DIR + "track20", "south");
    add_exit(CAMP_DIR + "track17", "west");

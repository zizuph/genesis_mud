/*
** This is a variation on the GoG bank,
** Called the Dwarves of Genesis Bank.
** Created by Leia
** February 15, 2006
*/
...
create_object() 
{
    ...
    set_long("It is a small fort-like hut. It has an opening protected " +
        ...
        "a burly golden-eyed dwarf.\n");

    add_item( ({ "sign", "large sign" }),
        "A large sign with large letters at the top and a lot " +
        "of fine print at the bottom.\n");
    add_item( ({ "dwarf", "burly dwarf", "golden-eyed dwarf",
        "burly golden-eyed dwarf" }),
        "A burly, greedy-looking dwarf with a long beard.\n");
    ...
    add_prop(OBJ_M_NO_GET, "It is not just a strongroom, it is a very heavy " +
        "strongroom as well. There's no way you can lift it.\n");
...
{
    dest->add_my_desc("There is a dwarf money deposit here.\n",
        this_object());
}
...
read(string str)
{
        ...
        (str == "large sign"))
    {
        write("The sign reads:\n\n" +
            "Dwarves of Genesis Bank Money Deposit\n" +
            "- Absolutely Safe (No Identity Theft)\n" +
            "- Friendly Service\n" +
            "- Available Everywhere (Or Everywhere That's Anywhere)\n" +
            "- Low Fees\n" +
            "- Dwarves Get Special Rates! \n\n" +
            "After that there is a lot of fine print regulating the terms " +
            "of deposit and giving instructions on using the Dwarves of " +
	    "Genesis Bank deposit.\n");
...
april_fools()
{
    ...
    write("As you approach the deposit, the dwarven clerk exclaims:\n");
    say("As " + QTNAME(this_player()) +
       " approaches the deposit, the dwarven clerk exclaims:\n");
    tell_room(environment(this_player()),
       "    Great Reorx! I's terrible! We have been robbed! All those beautiful coins are gone!\n\n" +
       "The clerk cries out in agony and continues:\n" +
       "    It happened last night! They were hooded and masked! And they carried swords!\n" +
       "    And heavy hammers too! They fled that way!\n\n" +
...
deposit(string str)
{
    ...
    say(QCTNAME(this_player()) +
        " deposits some coins in the care of the Dwarves of Genesis Bank.\n");
...
account(string str)
{
    ...
    if (!mappingp(acc) || !m_sizeof(acc))
    {
        notify_fail("The dwarf says: Sorry, but you do not seem to have " +
            "an account with us.\n");
        return 0;
    }
    ...
    say(QCTNAME(this_player()) + " inquires about " +
        ...
        " account at the Dwarves of Genesis Bank.\n");
    return 1;
}
...
withdraw(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("The dwarf says: You have to state amount and coin " +
            "type to withdraw.\n");
        return 0;
    }
    ...
    if (!mappingp(acc))
    {
        write("The dwarf says: Sorry, but you do not seem to have an " +
            "account with us.\n");
        return 1;
    }
    ...
    write("The dwarf does some calculations on an abacus and writes " +
    ...
    if ((!acc[DEPOSIT_PC]) &&
        ...
        (!acc[DEPOSIT_CC]))
    {
        write("The dwarf says: The money deposited in your accout does " +
            "not even cover our fee. I am forced to close your account " +
            "and register you as having a low reliability. We dwarves do " +
            "not like to deal with people who cannot work for a living!\n");
    ...
    for (index = 0; index < sizeof(coin_arr); index++)
    {
        ...
        {
            write("The dwarf says: You don't have that many " + coin_type +
    ...
    else
    {
        ...
        write("The dwarf says: Since you no longer have any coins in our " +
            "trust, I shall close your account.\n");
    }

    write("The dwarf says: Thank you for putting your money in our trust.\n");
    say(QCTNAME(this_player()) + 
        " withdraws some coins from the Dwarves of Genesis Bank.\n");
    return 1;
}
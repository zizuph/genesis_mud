...
create_room() {
    ...
    set_long("You have entered the back room of the Dwarven Mining Company Supply Shop. This is where the shopkeeper keeps all his items that are for sale. You'd best leave all of this alone or else the dwarf might ring your neck!\n");
    set_max_values(70, 7);
    reset_store();

...
set_up_skills() {
  ...
  sk_add_train(SS_MENDING_ARMOURS,train_text(SS_MENDING_ARMOURS),
    "mending armours",50,60,SS_CRAFT,100);
  sk_add_train(SS_MENDING_WEAPONS,train_text(SS_MENDING_WEAPONS),
    "mending weapons",50,60,SS_CRAFT,100);

  sk_add_train(SS_APPR_OBJ,train_text(SS_APPR_OBJ),0,0,70);

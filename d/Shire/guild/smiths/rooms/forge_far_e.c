...
create_forge_room()
{
    set_short("The further east forge of the Smiths Guild");
    set_long("This is the further east forge of the Smiths guild. It " +
    ...
    add_exit(SMITHSDIR_ROOMS + "forge_e","west","@@check_forging@@");

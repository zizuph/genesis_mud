/*
 * Khalakhor Blacksmith
 * By Boron, based on Finwe's forge: Finwe, March 2001
 * Modified slightly for Khalakhor - Damaris@Genesis 02/2005
 *
 * 2011/07/19 Lavellan - Converted to modern smiths location. Why was this not
 *                       done along with the others? Fixed a few other things.
 */
...
create_forge_room()
{
    ...
    set_long("   This is a special forge that has been set "+
      ...
      "to use it. The heavy forge in the center of the room "+
...
"      |    o                                                    o    |\n"+
"      |                                                              |\n"+
"      |                The Special Forge of Port MacDunn             |\n"+
"      |                     --========oo=========--                  |\n"+
"      |                                                              |\n"+
...
"      |                                                              |\n"+
"      |                                                              |\n"+
"      |   Visitors may assist smiths by pumping the bellows.         |\n"+

/*
 * Barrel used to hold broken items
 * Finwe, November 2001
 */
...
create_container()
{
    set_short("large iron barrel");
    set_name("barrel");
    set_adj("barrel");
    set_long("This is a iron barrel. It is hammered from a sheet " +
        "of iron and wrapped around an iron frame. The edges are " +
        "rounded to prevent injuries. The barrel is used to hold " +
        "broken items that are ready to be melted down.\n");

    add_prop(OBJ_M_NO_GET, "The barrel is too heavy to move.\n");

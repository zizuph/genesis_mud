...
create_scroll()
{
    ...
    set_long("This is a large leatherbound full of parchments. " +
...
read_book_at_page(int which, string verb)
{
    ...
    "    :  gems shined with the light of the Two Trees and eventually    |\n"+
    ...
    "    :  dwarves and elves. The dwarves fashioned a crown to hold a    |\n"+
    "    :  Silmarili and ather than give the crown to Thingol, the       |\n"+
    "    :  Ultimately, Thingol was slain and the dwarves sacked the      |\n"+ 
    "___/ \_______________________________________________________________|\n"+
    "\n\n");
    break;
	case 3:
    ...
    "   \ /                                                      Page 3   |\n"+
    "    :                                                                |\n"+
    "    :  beautiful city. Since then we have never trusted trusted the  |\n"+
    "    :  dwarves knowing their selfishness brought the fall of that    |\n"+
    "    :  great city.                                                   |\n"+
    "    :                                                                |\n"+
    "    :  Our talents are many and are excellent craftspeople. We excel |\n"+
    "    :  in the art of carving stone and making gems, working metal,   |\n"+
    "    :  learning, inventing languages and scripts, and other          |\n"+
    "    :  beautiful arts. Our ability to carve beautiful gems and shape |\n"+
    "    :  metal into works of art. We once set aside our animosity for  |\n"+
    "    :  a time with the dwarves during the Second Age.                |\n"+
    "    :                                                                |\n"+
    "    :  During the Second Age Celebrimbor came out of Lindon and      |\n"+
    ...
    "    :  you can follow these guildelines, you may declare your race   |\n"+
    "    :  as a Noldor. If there is room within the walls, you will be   |\n"+
    "    :  permitted to join, otherwise you will have to try again at    |\n"+
    "    :  another time.                                                 |\n"+
    "    :                                                                |\n"+
    "    :                                                                |\n"+
    "    :                                                                |\n"+
    ...
    "    :  voluntarily, simply return here and you may abandon the       |\n"+
    "    :  Noldor. You may rejoin at a later date if there is room in    |\n"+
    "    :  the guild. Repeated leaving and joining may anger the elves,  |\n"+
    "    :  and result in a permanent banishment from the guild.          |\n"+
    "    :                                                                |\n"+

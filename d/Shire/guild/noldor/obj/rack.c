...
inherit "/d/Gondor/guilds/rangers/obj/racks/tree_guild_crate";
...
create_rack()
{
    ...
    set_name("rack");
    set_adj("wooden");
    set_long("This is a massive equipment rack. It is carved of wood by " +
        "the Noldor for their guild. It has been stained a deep honey " +
        "color and looks large enough to hold many weapons, armours, " +
        "and other supplies need for their travels.\n");

 ...
 * Finwe, May 2001
 *
 * Changed descript for use in the orc race guild
 * Altrus, May 2005
 */
...
create_container()
{
    ...
    set_adj("large");
    set_adj("wooden");
    set_long("This is a large wooden crate. It doesn't appear to be in the best condition, but would probably still hold a great many items.\n");

    add_prop(OBJ_M_NO_GET, "Why would you want that piece of junk?\n");

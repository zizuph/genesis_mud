/*
*   The Heren Istimor own post-office.
*/
...
create_room()
{
   ...
   add_exit(HEREN_ISTIMOR_DIR + "board","down");
   add_exit(HEREN_ISTIMOR_DIR + "start","up");
...
query_mail(silent)
{
   ...
   write("\n"+
      "********************************************************\n"+
      "There is"+new+" mail for you in the Post of the Heren Istimor.\n"+
      "********************************************************\n\n");
   return 1;
}

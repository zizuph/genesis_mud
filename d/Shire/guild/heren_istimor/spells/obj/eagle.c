 ...
 * Back to the Shire, used as messenger for the Heren Istimor
 * Dunstable, 1-6-96
 */
...
#define TEMP_ROOM   ("/d/Shire/guild/heren_istimor/tempeagle")
#define MESSAGE     (RANGER_DIR + "obj/message")
#define START_ROOM  ("/d/Shire/guild/heren_istimor/start")

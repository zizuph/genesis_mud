/*
 *  The light object of the Heren Istimor
...
#define SUBLOC "_heren_istimor_light_aura_subloc"
...
create_object()
{
    ...
    add_prop(OBJ_S_WIZINFO, "This is the radiant aura of the Heren " +
      "Istimor guild, summoned to provide light.");
}

...
create_object() 
{
    ...
    set_long("This is a beautiful " + color + " flower. It smells wonderful "+
      "and looks like no other flower in this neighbourhood. It looks like "+
      "it has been put here by divine providence.\n");
    set_name("flower");

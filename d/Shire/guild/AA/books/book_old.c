...
"smiths, was jealous of the Dark Lords knowledge and skills, and after "+
...
"the Dark Lord began and ever since that time our lord has continued in his "+
"attempts to restore the order in the world.\n\n");
            break;
        case 3:
            write("\n"+
"The Dark Lord wished to appeal to the worthy among the race of Men, "+
...
"The Dark Lord despaired in the realization that these unbelievers were "+
...
"them. The king, sensing the honesty in the Dark Lord, agreed- banishing "+
...
"men of Numenor before they had uttered a word. The Dark Lord returned to "+
...
"Mordor. The alliance besieged the Dark Lord at Barad-dur and after several "+
...
"when the Dark Lord returned to Dol Guldur and sent northa new captain for "+
...
"renowned for being unfailingly loyal to the Dark Lord and the Dark Lord only "+
"(which led to him being called, 'The club of the Dark Lord' in some circles). "+
"Unlike the Nazgul, he had not needed a ring of power to show him the "+
"truth and righteousness inherent in the Dark Lords great scheme- he had "+
"known it all along. Morgrond had no difficulty in regathering the Army "+
"of Angmar for most still believed in the Dark Lords cause and could not help "+
...
"ordered by the Dark Lord launched an assault against the Dunedain. "+
...
"vengeance on Eorl's troops and smashed Eorl to his death.\n");
        ...
        case 9:
            write("\n"+
"In the year 2941, the Dark Lord was forced to abandon the home he had made "+
...
"********************************\n"+
"\n"+
"For some taxation on your progress in the realms (a little less "+
"for layman soldiers) we give you the chance "+
...
"send a bunch of strong warriors with clubs to beat your stupidity out of "+
...
"'skills' here means just any skills and not only ones related to the "+

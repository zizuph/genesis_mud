...
#define BARTENDER     AA_DIR + "npc/bartender"
#define BOTTLE        AA_DIR + "obj/bottle"
#define GLASS         AA_DIR + "obj/bottle"
...
create_room()
{
  ...
  add_exit(AA_DIR+"rooms/c2", "west", "@@block_exit@@");
...
enter_inv(object ob, object from)
{
  ...
  {
    alarm = set_alarm(15.0, 0.0, &get_glasses());
  }
}

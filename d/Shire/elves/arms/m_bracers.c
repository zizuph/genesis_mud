...
create_armour()
{
    ...
    set_short("pair of polished mithril bracers");
    set_pshort("pairs of polished mithril bracers");
    set_pname("bracerses");
    set_long("This " + short() + " was forged by elves in Middle-earth. They are polished to a bright luster and shine in the light. They protect the arms and are etched with intricate designs.\n");

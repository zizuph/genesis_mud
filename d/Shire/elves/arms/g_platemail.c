 ...
 * They are a rare item made from Mithril
 * - Finwe, January 2018
 */
...
create_armour()
{
    set_name("platemail");
    set_adj(({"jet", "black"}));
    set_short("jet black platemail");
    set_long("This " + short() + " was made by the elves in ages long past. It protects the chest and is crafted from a jet black metal. Spiral lines and ornate designs decorate the " + short() + ", and were like made for royalty. The armour was crafted so well that there aren't any scratches or dents on them.\n");

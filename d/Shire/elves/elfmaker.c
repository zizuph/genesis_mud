/* 
 * Maker for the travelling elf group, based on Rivendell elf npc base,
 * by Finwe, (March 1998) which in turn was based on the Hobbitmaker.
 * Altrus, November 2005
 */

#include "/d/Shire/sys/defs.h"
#include "/d/Shire/rivendell/local.h"
//#include "/d/Shire/elves/patrol.h"
#include <formulas.h>

inherit SHIRE_MONSTER;
inherit "/d/Shire/rivendell/npc/names";
inherit "/d/Shire/lib/assist_friend";
//inherit "/d/Shire/elves/patrol";

 ...
 *              
 * Modified Gondor's file to suit the Shire's needs
...
#ifndef SHIRE_HERB_MASTER
#define SHIRE_HERB_MASTER "/d/Shire/common/herbs/herb_master.c"
#endif
...
add_std_herbs(mixed type, int seed)
{
    ...
    case "pond":
    case "river":
        places = ({"streams","marsh","river","pond"});
        break;

    }
    herb_list = SHIRE_HERB_MASTER->query_herbs(type);
...
/*
 * Function name: reset_shire_herbs()

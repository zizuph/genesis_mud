...
create_object()
{
    ...
    add_name("_shire_wreath_pin");
    set_adj(({"small", "wreath"}));
    set_short("small wreath pin");
    set_long("This is a nice stick pin in the shape of a wreath. The " +
        "festive pin is round and green. Groups of red dots are scattered " +
        "on it, and look like red beries. Something is etched on the back " +
        "of the pin.\n");

...
create_object()
{
    ...
    set_long("This is an ancient coronet that has been battered from " +
		"years of misuse. It is a wide band metal, coverd with gold " +
		"and decorated with gems. On the fron, the center rises to a " +
		"point, where a large gem was once set, but now only a hole is. " +
		"The " + short() + " once decorated the brow of an ancient " +
		"ruler, but now it's dented terribly.\n");

/*
 * From /d/Genesis/doc/examples/obj/mirror.c
 *
 ...
 * Revision history:
 * 
 * Modified for Bree's shack. It is invisible in the room, and can't be taken.
 * -- Finwe, June 2002
 * 
 */
 ...
 */
    description = "The mirror is a tall, oval shaped piece of " +
        "polished glass. It is on top of a piece of polished oval " +
        "shaped steel and set inside a wooden frame. This very " +
        "expensive piece of furniture stands in a corner of the room.\n\n"+

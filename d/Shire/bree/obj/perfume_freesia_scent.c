/*
 *  2007-05-09, Toby: Fixed a typo fressia - freesia
 *
 */
...
{
  player->catch_msg("You breathe deeply and inhale nothing "
    + "but freesia--Ahh!\n");

    tell_room(environment(environment(TO)), "The smell of freesia envelopes you for a moment.\n");
}

...
create_room()
{
    ...
    extraline = "This room is sparse but some paintings " +
        "hang on the walls. A few hooks are near the door for " +
        "coats, hats and the like. A bench sits in one corner.";
    ...
    add_exit(ROAD_DIR + "broad10",   "out");
    add_exit(HOUSES_DIR + "hobbit02b", "north");

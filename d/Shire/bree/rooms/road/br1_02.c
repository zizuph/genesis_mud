...
void create_er_room()
{
    ...
    extraline = "The grassy field is dotted with wildflowers. The grass " +
        "is short and green. Boulders lay strewn across the field, and " +
        "tall trees grow scattered everywhere. A thin path runs through " +
        "the field.";

    add_item(({"path"}),
        "This thin line meanders west through the brush and trees.\n");
    ...
    add_exit(ROAD_DIR + "br1_01", "east");
    add_exit(ROAD_DIR + "br1_03", "south");
    add_exit("/d/Shire/eastroad/girdley/secret04", "northwest");

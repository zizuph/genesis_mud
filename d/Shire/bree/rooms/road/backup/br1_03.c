...
void create_er_room()
{
    ...
    extraline = "A thin path runs through the grassy field. Bushes and " +
        "shrubs grow scattered everywhere. Wild flowers grow on the " +
        "field alone and around large boulders buried in the ground.";      
    ...
    add_exit(ROAD_DIR + "br1_02", "north");
    add_exit(ROAD_DIR + "br1_04", "southeast");

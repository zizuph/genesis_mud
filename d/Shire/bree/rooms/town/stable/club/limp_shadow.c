// Palmer, January 2003
// Taken from Old Fogey's limp shadow.
...
query_m_in()
{
    ...
    return "arrives walking bow-legged";
}
...
query_m_out()
{
    ...
    return "leaves walking bow-legged";
}

public int
query_equestrian_hobble_shadow()
{
    return 1;
}
...
void
remove_equestrian_hobble_shadow()
{

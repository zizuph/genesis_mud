...
create_shire_room()
{
    ...
    set_short("Stables in Bree");
    add_prop(ROOM_I_INSIDE, 0);

    set_long("The stables of Bree. The stables are large, " +
        "housing many fine steeds. Many stalls " +
        "fill one end of the building, some with horses and " +
        "others empty. Straw covers the floor. Bales of hay " +
        "are stacked up against one wall. There is a door " +
        "that leads out to the corral.\n");
    ...
    add_exit("east_yard.c", "south", 0, 0, 0);
}

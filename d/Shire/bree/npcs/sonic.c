/*
 * Rumor has it Sonic was a wizard who was caught cheating in the Shire 
 * back in 1994. As punishment, Dunstable removed the wizard, and created 
 * this pitiful npc as a reminder to all who cheat in the domain.
 * -- Finwe
 */
...
create_monster()
{
    ...
    set_chat_time(4);	    
     add_chat("Oh, I did it all right. And now I'm paying the price.");
    ...
    add_chat("Have you been to see Sanford?");
    add_chat("Nobody likes me, everybody hates me, I think I'll go eat worms.");
...
ask_help()
{
   command("say Sorry, you can't help me, but try Sanford up on the Hill.");

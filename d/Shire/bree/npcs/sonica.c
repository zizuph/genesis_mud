...
create_monster()
{
    ...
    set_chat_time(4);	    
     add_chat("Okay, I did it, all right? And now I'm paying the price.");
...
arm_me()
{
    ...
    clone_object("/d/Shire/moria/obj/bowstring")->move(TO);
    clone_object("/d/Shire/moria/wep/arrow_lblack")->move(TO);
    clone_object("/d/Shire/moria/wep/arrow_lblack")->move(TO);
    clone_object("/d/Shire/moria/wep/longbow")->move(TO);
...
{
    object wep  = this_object()->query_wielded();  
    ::attacked_by(obj);

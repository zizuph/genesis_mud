/*
* The shopkeeper of the holiday shop in Bree.
...
create_monster() {
   if (!IS_CLONE) return;
   set_name("merigrin");
   add_name(({"hopper","shopkeeper"}));
   set_living_name("merigrin");
   set_title("Hopper, Shopkeeper of the Bree Holiday Shop");
...
my_long() {
   ...
   return("This is Merigrin Hopper, shopkeeper for the Bree " +
        "Holiday Shop. She's a cheerful, festive person who enjoys " +
        "helping others pick the perfect gift for the holidays.\n");
}

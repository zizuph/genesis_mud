...
create_shire_room()
{
    ...
    add_item(({"wall","west wall","east wall","walls","solid wall"}),
      "The east wall is made of dirt as are all the other walls, but "+
      "it also has a sign affixed to it.\n");

    add_item(({"decoration", "sign"}),
      "Read the sign, if you are able.  Otherwise, get someone to "+
      "read it for you.\n");
    add_cmd_item( ({ "sign" }), ({ "read" }),
      "The sign reads: Trickster guild.\nIf you want, you may:"+
      ...
      "in the guild.\n"+
      "Currently the guild tax is low.\n");


    add_cmd_item("notice","read","The Tricksters do not favor those\n"+
      "who follow crusades.  They do not allow those who become\n"+
      "more holy than sweet or more evil than nasty\n"+
      "to remain in their ranks.\n"+
      "For the privileges gained in this guild are\n"+
      "skills such as awareness, club, trading, parry and\n"+
      "appraise value.\nLater, a few more things "+
      "will arrive. Also, we don't like elves. \n" +
      "They are too serious for us.\n");
...
lower_skill(object tp)
{
    ...
    // Emotes were kept after quitting. What the heyck is remove_cmdlist? Palmer 09/21/2003
    tp->remove_cmdsoul(TRICKSTER_GUILD_SOUL);

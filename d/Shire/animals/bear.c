...
#define NAME3 "bear"
#define PNAME "bears"
#define LONG "This bear looks quite dangerous.\n"
#define ADJ1 "tall"
#define ADJ2 "brown"
#define ALIGN 65
#define WEIGH 10500
...
#define FIGHT1 70   /* Unarmed */
#define FIGHT2 50  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote stands up on two feet."
#define ACTTIME 7
#define ACT1 "growls ferociously"
#define ACT2 "emote claws the ground, looking for food."
#define ACT3 "emote swings at you dangerously."
...
create_creature()
{
  ...
  add_act(ACT2);
  add_act(ACT3);
  add_leftover(ANIM_DIR + "bearskin", "skin", 1, 0, 1, 1);
  add_leftover(ANIM_DIR + "bearskin", "skin", 1, 0, 1, 1);

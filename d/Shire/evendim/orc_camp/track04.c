...
create_camp_room()
{
	...
	add_exit(CAMP_DIR + "track07", "north");
	add_exit(CAMP_DIR + "track05", "east");
	add_exit(CAMP_DIR + "track06", "northwest");
	add_exit(CAMP_DIR + "track08", "northeast");
	add_exit(CAMP_DIR + "track03", "southwest");

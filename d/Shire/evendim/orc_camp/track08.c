...
create_camp_room()
{
	...
	add_exit(CAMP_DIR + "track12", "north");
	add_exit(CAMP_DIR + "track05", "south");
	add_exit(CAMP_DIR + "track09", "east");
	add_exit(CAMP_DIR + "track07", "west");
	add_exit(CAMP_DIR + "track13", "northeast");
	add_exit(CAMP_DIR + "track11", "northwest");
	add_exit(CAMP_DIR + "track04", "southwest");

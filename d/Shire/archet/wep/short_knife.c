...
void create_weapon()
{
	...
	set_long("This small knife looks like it might be used anything. It is quite a versatile looking implement. Its blade is sharp, but short. Don't cut yourself!\n");

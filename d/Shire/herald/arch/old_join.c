...
create_shire_room()
{
    ...
    add_cmd_item("inscription","read","The inscription reads:\n\n"+
      ...
      "\t\t * Your alignment must be better than sympathetic, a heart that\n"+
      "\t\t   desires to follow the will of the Lords of West and the\n" +
      "\t\t   Valar.\n"+
      "\t\t * No killing those who defend the Free Peoples, including\n" +
      "\t\t   hobbits.\n\n"+
      "\tIf you still wish to become a Herald of the Valar, then these\n"+
      "\tcommands will be of some importance to you:\n\n"+
      "\t\t<serve the lords of the west> -> Joining.\n"+
      "\t\tTo join the guild you need a Herald to vouch for you.\n"+

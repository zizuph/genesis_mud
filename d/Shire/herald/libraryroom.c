...
"yourself.\n");
   ...
   set_save_path(HERALD_DIR+"libsave");
   set_lib_name("The Library of the Heralds of the Valar");
   lib_exit(HERALD_DIR + "board","southwest",0,1);

   set_write_dir(HERALD_DIR+"books");
   set_librarian_room(HERALD_DIR+"bookroom");

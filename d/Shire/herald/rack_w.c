 ...
 * Finwe May 2020, Increased rack volume.
 */
...
create_container()
{
    ...
    set_name("rack");
    add_name("weapon rack");
    set_adj("wooden");
    set_long("This is a large rack formed by branches of the tree. It " +
        "holds weapons for the Heralds.\n");
...
prevent_enter(object obj)
{
    ...
    if (!function_exists("create_weapon",obj))
    {

/*
 * Rack to hold weapons
 * -- Finwe, January 2006
 *
 * Palmer 12-Aug-2006 
 * Added 'weapon rack' as name
 */
...
create_container()
{
    set_short("wooden case");
    set_name("case");
    add_name("herb case");
    set_adj("wooden");
    set_long("This is a wooden herb case. It is rectangular shaped and designed to hold herbs donated to the Heralds of the Valar.\n");
...
prevent_enter(object obj)
{
    ...
    {
        write("Only herbs are allowed in the " + short() + ".\n");
        return 1;
    }

...
config_heal_spell()
{
	set_spell_name("healme");
	set_spell_desc("Heal yourself");
...
query_spell_can_be_learned(object player)
{
	...
	// If the guildrank is 1, this spell unlocks
	/*if (player->query_herald_level() <= 1)
	{
		return 0;
	}*/
	
	// TESTING PARAMETERS. WE WILL REMOVE THIS LATER.
	if (player->query_name() != "Nerulljr")
	{
		return 0;
	}

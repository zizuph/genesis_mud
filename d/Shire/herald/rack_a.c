/*
 * Rack to hold armours
 * -- Finwe, January 2006
 * Palmer 12-Aug-2006 
 * Added 'armour rack' as name
 */
...
create_container()
{
    ...
    set_adj("wooden");
    set_long("This is a " + short() + ". It is formed by branches of the tree and holds the armours for the Heralds.\n");
 ...
 * Description  : Checks that it is an armour.
...
prevent_enter(object obj)
{
    ...
    if (!function_exists("create_armour",obj))
    {

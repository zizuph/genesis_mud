  ...
  *
  * Stolen for waymeet. Copied because I need a pelt for a quest.
  * Raymundo, winter, 2020
  *
  */
...
{
    add_adj(({"grey", "mangy", }));
    set_short("mangy grey wolf");
    set_pshort("mangy grey wolves");
    ...
    set_restrain_path(WAYM_FIELD_DIR);
    set_random_move(2);
    add_leftover(WAYM_ARM_DIR + "wolf_pelt", "pelt", 1, 0, 1, 100);
}

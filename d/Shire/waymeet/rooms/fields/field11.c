/*
    /d/Shire/waymeet/rooms/fields/field11.c
...
void create_field()
{
    ...
    add_exit(WAYM_FIELD_DIR + "field19","south");
    add_exit(WAYM_FIELD_DIR + "field03","north");
    add_exit(WAYM_FIELD_DIR + "field12","east");
    add_exit(WAYM_FIELD_DIR + "field10","west");
}

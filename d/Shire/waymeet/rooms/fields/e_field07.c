...
void create_field()
{
	...
	add_exit(WAYM_FIELD_DIR + "e_field03", "south");
	add_exit(WAYM_FIELD_DIR + "e_field11","north");
	add_exit(WAYM_FIELD_DIR + "e_field08", "east");
	add_exit(WAYM_FIELD_DIR + "e_field06", "west");

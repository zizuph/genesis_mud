/*
    /d/Shire/waymeet/rooms/fields/field10.c
...
void create_field()
{
    ...
    add_exit(WAYM_FIELD_DIR + "field18","south");
    add_exit(WAYM_FIELD_DIR + "field02","north");
    add_exit(WAYM_FIELD_DIR + "field11","east");
    add_exit(WAYM_FIELD_DIR + "field09","west");
}

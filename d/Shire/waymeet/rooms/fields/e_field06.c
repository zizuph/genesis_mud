...
void create_field()
{
	...
	add_exit(WAYM_FIELD_DIR + "e_field02", "south");
	add_exit(WAYM_FIELD_DIR + "e_field10","north");
	add_exit(WAYM_FIELD_DIR + "e_field07", "east");
	add_exit(WAYM_FIELD_DIR + "e_field05", "west");

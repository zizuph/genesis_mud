...
void create_field()
{
   ...
   add_exit(WAYM_FIELD_DIR + "s_field12","south");
   add_exit(WAYM_FIELD_DIR + "s_field07","east");
  // add_exit(WAYM_FIELD_DIR + "s_field08", "west");
   add_exit(WAYM_FIELD_DIR + "s_field04", "north");

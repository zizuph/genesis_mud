...
void test_locket_quest(object player)
{
    ...
    {
        command("smile hope");
        command("say Did you find the jewel?");
        command("sigh sadly");
        command("say This isn't the right jewel. It is easily confused " +
        "with the ancient jewel from Gondolin.");
        return;
    }
    ...
    {
        command("blink");
        command("say This is the wrong item. I don't need this, but thank you.");

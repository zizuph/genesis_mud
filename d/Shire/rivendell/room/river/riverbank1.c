...
create_forest_room()
{
    set_extraline("The path ends here at a ford on the river " +
        "Bruinen. The forest surrounds you and is peaceful " +
        "here. The river flows along past you. It looks calm " +
        "but you see evidence that it overflows its banks as " +
...
//        if(!TP->query_prop("_no_cross_") || TP->query_alignment() <= -150) 
    ...
    {                                                             
        write("\n");
        write("The river boils and churns before you, as if to " +

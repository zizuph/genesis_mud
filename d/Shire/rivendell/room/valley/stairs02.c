...
create_valley_room()
{
    ...
    set_extraline("You stand at the base of the plateau in the " +
        "valley of Imladris, or Rivendell in the common tongue. " +
        "Within this valley lives Elrond and many of the Noldor " +
        "elves.");
    ...
    add_exit(VALLEY_DIR + "stairs01", "up", 0, 1);
    add_exit(VALLEY_DIR + "path01", "northeast", 0, 1);
 
}

string short_desc()
{
    return "Some stairs on the side a forest plateau";
}

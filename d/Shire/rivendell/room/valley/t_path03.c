...
create_valley_room()
{
    set_extraline("You stand beneath a canopy of fruit and " +
        "deciduous trees. Their branches mingle together " +
        "creating a quiet glade of solitude. The only " +
        "disturbance is the sound of the river, babbling " +
        "alongside you.");
    ...
    add_exit(VALLEY_DIR + "t_path02",  "north");
    add_exit(VALLEY_DIR + "t_path04",  "southeast");
    reset_room();
}

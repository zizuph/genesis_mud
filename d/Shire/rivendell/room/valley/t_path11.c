...
create_valley_room()
{
    set_extraline("The path looks used here. It appears the " +
        "elves love the sound of the river. A large garden " +
        "grows on this side of the house. Its fruit trees and " +
        "vegetables look delicious. The river runs swiftly " +
        "west out of the mountains. The ground dips east " +
        "towards the river.");
    ...
    add_exit(VALLEY_DIR + "v_path11",  "north");
    add_exit(VALLEY_DIR + "t_path10",  "south");
    reset_room();
}

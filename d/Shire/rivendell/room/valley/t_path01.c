...
create_valley_room()
{
    set_extraline("You stand on a path south of the bridge. " +
        "This path wanders alongside the river Bruinen which " +
        "flows north and west out of the mountains. The ground " +
        "slopes to the river.");
    ...
    add_exit(VALLEY_DIR + "v_path01",  "north");
    add_exit(VALLEY_DIR + "t_path02",  "southeast");
    reset_room();
}

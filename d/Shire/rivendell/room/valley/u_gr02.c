...
create_house_room()
{
    ...
    set_long("This is a guestroom in Elrond's house. " +
        "The room is decorated simply with some paintings on " +
        "the walls. A bed, a dresser, and a night stand are " +
        "in the room. large windows fill the room with gentle " +
         "@@daylight_desc@@.\n");
  
    add_item(({"painting", "paintings"}),
        "Both paintings are of long forgotten elven cities.\n");
    ...
    add_item("baseboard", 
        ...
        "outward like a wave on the sea.\n");
    add_item("headboard", 
    ...
    add_item("night stand",
        ...
        "of maple.\n");
    add_item("dresser",
        "The dresser is tall and carved of maple. It has six " +
    ...
    add_item(({"east window", "eastern window"}),
         "@@east_up@@ A winding path leads past the house and " +
    ...
    add_exit(VALLEY_DIR + "u_cor02", "south");
}

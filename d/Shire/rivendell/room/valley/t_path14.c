...
create_valley_room()
{
    set_extraline("The path levels out here as it " +
        "comes out of the forest. The area is clear of any " +
        "trees and has a beautiful view of the surrounding " +
        "landscape. You clearly see the river as it flows " +
        "southwest out of the mountains. Northeast of you is " +
        "some sort of a clearing.");
    ...
    add_exit(VALLEY_DIR + "stone_seat",  "northeast");
    add_exit(VALLEY_DIR + "t_path13",  "southwest");

...
create_valley_room()
{
    set_extraline("You stand the south side of the house " +
        "between the garden and the river Bruinen. The river " +
        "rushes west on its way out of the mountains. The path " +
        "is wide and runs the length of the house. A garden " +
        "grows here, surrounded by a split-rail. The ground " +
    ...
    add_exit(VALLEY_DIR + "t_path07",  "west");
    add_exit(VALLEY_DIR + "t_path09",  "northeast");
    reset_room();
}

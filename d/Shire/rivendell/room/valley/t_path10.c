...
create_valley_room()
{
    ...
    set_extraline("This gentle path follows the river's " +
        "shoreline. A garden full of fruit trees and food grows " +
        "between the path and the house here. A split-rail " +
        "fence protects the garden. The ground slopes towards " +
        "the river.");
    ...
    add_exit(VALLEY_DIR + "t_path11",  "north");
    add_exit(VALLEY_DIR + "t_path09",  "south");
    reset_room();
}

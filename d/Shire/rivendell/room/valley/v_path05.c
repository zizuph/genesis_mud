...
create_valley_room()
{
    ...
    set_extraline("You are on a path behind the house and the " +
        "start of another that heads north. Behind you, sounds " +
        "of rich music filter from the house.");
    ...
    add_exit(VALLEY_DIR + "n_path01", "north");
    add_exit(VALLEY_DIR + "v_path06", "east");
    add_exit(VALLEY_DIR + "v_path04", "west");

...
create_valley_room()
{
    ...
    set_extraline("You are behind the house. The path " +
        "wanders alongside the gardens of the valley. West " +
        "leads to the forge while east takes you towards the " +
        "back of the house.");
    ...
    add_exit(VALLEY_DIR + "v_path08", "east");
    add_exit(VALLEY_DIR + "v_path06", "west");

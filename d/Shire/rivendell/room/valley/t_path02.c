...
create_valley_room()
{
    set_extraline("The path wanders through a small grove of " +
        "trees here. They shade the house and provide an " +
        "inviting cool atmosphere. This quiet place is relaxing " +
        "and soothing.");
    ...
    add_exit(VALLEY_DIR + "t_path03",  "south");
    add_exit(VALLEY_DIR + "t_path01",  "northwest");
    reset_room();
}

...

{
    ...
    set_long("This is a guestroom in Elrond's house. It not " +
        "lavish but rather comfortable and tidy, nonetheless. " +
        "The room is decorated simply with some paintings on " +
        "the walls. Large windows are set into the walls, " +
        "filling the room with @@daylight_desc@@. A nice bed, " +
        "a night stand, and a dresser are the only " +
        "furniture in the room.\n");
 
 
    add_item(({"painting", "paintings"}),
        "One painting is a view of the Valley from up in the " +
        "mountains and the other painting is a forest scene.\n");
   ...
   add_item(({"north window", "northern window"}),
        "@@north_up@@ The roof of the forge is visible from here\n");
   add_item(({"west window", "western window"}),
        "@@west_up@@ The stable is visible in the distance. \n");
    ...
    add_exit(VALLEY_DIR + "u_cor01", "south");
}

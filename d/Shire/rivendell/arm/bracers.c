...
create_armour()
{
    set_name(({"pair of light elven bracers", "light elven bracers", 
        "bracers"}));
    set_pshort("pair of light elven bracers");
    set_adj(({"light","elven"}));
    set_short("pair of light elven bracers");
    set_long("This pair of "+short()+" was made by the elves " +
        "in Middle-earth. They are designed to protect the arms " +
    ...
    add_prop(OBJ_M_NO_BUY, 1);
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_ARMOUR(15, A_ARMS));

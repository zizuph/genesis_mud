...
create_area_room()
{
    ...
    add_item(({"riverbank", "bank"}),
        ...
        "plants grow along its edges providing colour and " +
    ...
    add_item(({"river", "withywindle", "withywindle river"}),
        "The Withywindle is a river that flows from the Barrow " +
        "Downs into the Old Forest. It is clear and cool looking, " +
        "flowing past tall trees that grow over the river.\n");
    ...
    add_item(({"lilies", "lily"}),
        ...
        "flowers are star shapped and brightly coloured in shades " +
        "of red, white, yellow, and pink. The flowers are slightly " +
        "fragrant, filling the air with a sweet scent.\n");
    ...
    add_item(({"valleys", "valley", "vale", "vales"}),
        ...
        "covered with grass and swirling fogs and mists.\n");
    add_item(({"barrows", "barrow", "hill", "hills", "downs", 
            "barrow downs", "barrow-downs"}),
        "They are grass covered burial mounds. They rise in the " +
        "distance to the northeast and hidden by forgs and mists. " +
        "It is rumoured they are haunted by something evil.\n");
    add_item(({"bone white stone", "bone white stones", "white stones", 
            "bone white stone", "cairn", "cairns", "monuments", "marker"}),
        "They are too far away to look at.\n");
    add_item(({"fogs", "fog", "mists", "mist", "swirling fog", 
            "swirling fogs", "swirling mists", "swirling mist"}),
        "Fogs and mists rise up from the hills to the northeast. " +

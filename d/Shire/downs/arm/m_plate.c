...
create_armour()
{
    set_name( ({"armour", "platemail"}) );
    set_short("steel fullplate armour");
    set_adj("steel");
    set_adj("fullplate");
    set_long("A fullplate armour made of ancient steel. It is made of strips " +
        "of steel and cover the chest. The armour is ancient looking and " +
        "looks strong.\n");
    set_ac( 23 );
    set_at( A_TORSO );
    set_am( ({ -1, -2, 3}) );

 ...
 * -- Finwe, May 2001
 * 
 * Changed to Longbottom pack, Finwe December 2019
 * Removed pack looting abilities, Finwe December 2019
...
#define BACKPACK_SUBLOC  "_longbottom_backpack"
...
create_container()
{
    ...
    set_short("large travel-stained backpack");
...
long_description()
{
    string long_desc = "This is a large travel-stained backpack from the South Farthing area of the Shire. It is made of strong linen and is stained from constant usage. Do <help backpsk>  to learn what you can do with the backpack:\n\n";
...
do_keep(string str)
{
    if (!parse_command(str, TP, " [the] [travel-stained] [large] 'backpack' / " +
        "'backpack' / 'pack' "))
    {
...
string read_tag()
{
    return "\n\n" +
        ...
        "    |   Backpack Commands                                    |\n" +
        "    |   -----------------                                    |\n" +
        "    |   <open/close pack>   - Open or close the backpack     |\n" +
        "    |                                                        |\n" +
        "    |   <wear/remove pack>  - Wear or remove the backpack    |\n" +
        "    |                                                        |\n" +
        "    |   <keep/unkeep pack>  - Protect or unprotect backpack  |\n" +
        "    |   from being sold                                      |\n" +
        "    |                                                        |\n" +
        "    |   <fillpack>          - Put unused items, except gems, |\n" +
        "    |   money, worn and wielded items, herbs, and empty      |\n" +
        "    |   containers into the backpack                         |\n" +
        "    |                                                        |\n" +
        "    |   <emptypack>         - Remove everything except for   |\n" +
        "    |   gems and money from the backpack                     |\n" +
        "    |                                                        |\n" +
        "    |   <get all from pack> - Get everything from the back-  |\n" +
        "    |   pack that you are able to hold                       |\n" +
        "    +--------------------------------------------------------+\n\n";
}

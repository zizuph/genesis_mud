...
create_blue_road()
{
   ...
   areadesc = "path";
    ...
    extraline = "The river runs swiftly from the northeast as it " +
        "travels southwest towards the sea. A bridge has been built over " +
        "the river, allowing travellers to cross easily.";
   ...
   add_exit(ROAD_DIR + "rd07","northwest");
   add_exit(ROAD_DIR + "rd05","southeast");

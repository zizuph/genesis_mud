...
create_mine_room()
{
    ...
    add_my_desc("The stairs lead up into the mountain and blackness. " +
        "Rumours hold that there are two hundred steps. They look long " +
        "and tiring, but are probably the only way out of here. Corpses " +
        "litter the ground here. There is one other exit, and that is " +
        "through the gate on the west wall.\n");

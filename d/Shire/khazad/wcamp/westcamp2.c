...
create_moria_room()
{
  ...
  set_long("You stand at the edge of a vast cavern. Stalactites "+
     ...
     "the northeast you see a massive tower of stone. A few well "+
     "worn paths lead further into the cavern. Paths to the "+
     "north and southeast run along the edge of the cavern "+
     "while another heads off to the east towards the heart of "+
     "the cavern.\n");
/*
...
*/
  add_exit("/d/Shire/khazad/wcamp/westcamp5","north",0,1);
  add_exit("/d/Shire/khazad/wcamp/westcamp3","east",0,1);
  add_exit("/d/Shire/khazad/wcamp/westcamp1","southeast",0,1);
}

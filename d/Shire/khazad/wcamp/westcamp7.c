...
create_moria_room()
{
  ...
  set_long("You stand at the edge of a vast cavern. Numerous "+
     ...
     "the west. A well worn path will take you north deeper into "+
...
*/
  add_exit("/d/Shire/khazad/wcamp/westcamp9","north",0,1);
  add_exit("/d/Shire/khazad/wcamp/westcamp4","south",0,1);
}

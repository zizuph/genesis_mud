...
create_moria_room() 
{
  ...
  add_exit("/d/Shire/khazad/west/wd6","up",0,5);
  add_exit("/d/Shire/khazad/wcamp/westcamp1","down",0,5);
}
...
enter_inv(object ob, object from)
{
  ...
  if (!living(ob))
    return;
  if (file_name(from) == "/d/Shire/khazad/west/wd6")
  {
    ob->catch_msg("You laboriously make your way down the "+
      "treacherous stairs.\n");
  }
 
  else if (file_name(from) == "/d/Shire/khazad/west/westcamp1")

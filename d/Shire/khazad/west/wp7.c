...
create_moria_room()
{
  ...
  set_long("You stand in a bend in the Western passage. Empty torch "+
     "holders jut out of the cold, stone walls here. To the west "+
     "the corridor leads towards the ancient western entrance of "+
     "Khazad-dum. To the northeast the corridor winds its way deeper "+
     "into the uninviting darkness.\n");

  add_item(({ "bend", "corridor", "passageway", "passage" }),
     "The corridor bends to the north and west here.\n");
  ...
  add_exit("/d/Shire/khazad/west/wp6","west",0,1);
  add_exit("/d/Shire/khazad/west/wp8","northeast",0,1);
}

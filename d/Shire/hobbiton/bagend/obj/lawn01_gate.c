...
create_door()
{
    ...
    set_door_desc("This is a small garden gate. It is made of vertical wood slats. The top of the gate is semi-circular shaped and opens to the front of the hill.\n");

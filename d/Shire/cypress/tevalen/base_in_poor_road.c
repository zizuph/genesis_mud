/*
 * Base file for poor section road Tevalen
 * Tijgen 08 OCT 2001
 */
...
string road_desc1()
{
    return "The road is wide and goes through the poorer"+
		" section of town.";
...
string road_desc2()
{
    return "The road leading through this part of the"+
		" town seems to be almost obliterated by the sands blown"+
		" in from the wastelands.";
}
string road_desc3()
{
...
string road_desc4()
{
    return "This road has seen better days, refuse from just"+
		" about everywhere is spread across the street making"+
		" it a large puddle of mud and assorted other components.";
} 

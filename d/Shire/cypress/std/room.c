...
inherit "/d/Shire/cypress/std/room/search";
inherit "/d/Shire/cypress/std/room/cmd_parse";
inherit "/d/Shire/cypress/std/room/exitmsg";
...
/*
 * Function name : Create_cypress_room
...
create_room()
{
    ...
    // short desceptions.
    set_short("Cypress base room file");
    set_long("This is the Cypress's Base Room which should be inherited "+
      "by every outdoor room in Cypress.\n");
...
/*
 * Function name : Reset_cypress_room
 * Description   : If you want to reset a room in the Cypress use this function.
 */
void
reset_cypress_room() {}

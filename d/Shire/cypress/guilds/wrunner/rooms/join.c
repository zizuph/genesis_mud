/*
 * This is the joining room for the Wild Elves. It is based on 
 * numerous join rooms in the Shire such as the Rockfriends, 
 * the hobbits, and others.
 *
 *  -- Finwe, July 2001
 */
...
#define RD3_DIR     THAL_DIR + "rooms/roads/ring3/"
...
void create_room()
{
    ...
    add_exit("/d/Sparkle/area/faerie/rooms/greenoaks/front", "north");

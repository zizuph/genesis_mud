...
inherit "/d/Shire/cypress/guilds/wrunner/new_emotes";

#include "/d/Shire/cypress/sys/defs.h"
#include "/d/Shire/cypress/guilds/wrunner/wrunner_defs.h"
#include "ground.c"
//#include "new_emotes.c"
#include <macros.h>
#include <formulas.h>
#include <language.h>
 ...
 * No longer needed. converted over to new help file system
 * Finwe, Jan 2017
 */
int help(string str)
{

/* Leech, a magical scimitar wielded by /d/Shire/greenfields/npc/gorgun
 ...
 *    6 July, 1997 -Igneous
 *
 *    Set to right handed - Jaypeg 17 Apr 1999
 *
 *    changed WRITEN to wielder->catch_msg()
 *    -- Finwe May 2004  
 *
 *    Updated with removing the BSN and fixing all indentations for easier 
 *    reading after a suspected bug was reported. Nothing of the sorts was
 *    found however. 
 *    Also updated the MAGIC_AM_ID_INFO for a better readout when using an
 *    identify spell on the Leech.
 *    -- Toby, 9th of Sept 2007
 */
...
create_weapon()
{
    ...
    set_default_weapon(HIT,PEN,W_SWORD,W_SLASH|W_IMPALE,W_RIGHT,TO);
    set_pm(({-3,3,0}));
    set_likely_dull(4);
    set_likely_corr(1);
    set_likely_break(0);
    ...
    add_prop(MAGIC_AM_ID_INFO,({
       "The "+short()+" appears to be strongly magical. ",1,
       "The jewel in the hilt of the "+short()+" seems to draw "+
       "in magical energy. ",45,
       "The "+short()+" was forged ages ago by the greatest of "+
       "the orcish smiths with the aid of the maia Sauron. They "+
       "created Leech with one purpose in mind: to kill mages. ",67,
       "Accordingly, Leech will not even tolerate the touch of a "+
       "mage, and will force such would-be-users to drop it. ",74,
       "Not until the Leech will main the would be mage who would be "+
       "foolish enough to attempt wielding it. ",83,
       "Leech stores the energy it drains, and releases the energy in "+
       "a violent burst when it can no longer contain the energy. ",89,
       "Leech possesses a will of its own, and is capable of forcing "+
...
jewel_desc()
{
    ...
    return "The dark red jewel appears to be quite valuable, but "+
           ...
           "visible in its setting. The jewel pulsates and shifts within "+
...
do_pry(string str)
{
    ...
    {
       notify_fail("The blade has been broken and the jewel seems stuck!\n");
       return 0;
    }
    if (!passed_test)
    {
...
wield(object wep)
{
    ...
    wielder->catch_msg("You wrap your hand around the hilt of the "+short()+".\n");
    ...
    {
       set_default_weapon(HIT+5,PEN+15,W_SWORD,W_SLASH|W_IMPALE,W_RIGHT,TO);
       TP->update_weapon(TO);
...
leech_msg()
{
    ...
    {
       DEBUG("Leech_msg() was called with no one wielding "+
             "the scimitar.");
       return;
    }
    ...
    {
       case 0:
          wielder->catch_msg("A comforting voice whispers to you: 'Soon we will "+
          "slay another foul mage!'\n");
          break;
       case 1:
          wielder->catch_msg("A hissing voice pleads: 'Feed me! I hunger!'\n");
          break;
       case 2:
          wielder->catch_msg("A rumbling voice echoes in your head: 'Kill "+
          "the mages, kill them all before they kill you!'\n");
          break;
       case 3:
          wielder->catch_msg("The "+short()+" announces: 'Do not fear, my master. I "+
          "will make you strong and then we shall destroy your "+
          "enemies completely.'\n");  
          break;
       case 4:
          wielder->catch_msg("A comforting voice whispers: 'All will fall before you "+
          "as long as I am with you!'\n");
          break;
       case 5:
          wielder->catch_msg("An outraged voice shouts: 'How I despise those pompous "+
          "Valar and their foul, spineless followers.'\n");
          break;
       case 6:
          wielder->catch_msg("A pleasant voice soothes: 'You are the greatest "+
...
leech_attack()
{
    ...
    if (!sizeof(karr)) 
    {
       wielder->catch_msg("A sad voice murmurs: 'There is nothing here worth "+
    ...
    {
       wielder->catch_msg("A sinister voice says to you: 'Kill that elf, I must "+
       "be fed!'\n");
    }
    if (victim->query_race()=="dwarf")
    {
       wielder->catch_msg("A domineering voice commands: 'Kill that dwarf, I despise "+
       "dwarves!'\n");
    }
    if (victim->query_race()=="human")
    {
       wielder->catch_msg("A quiet voice whispers insidiously into your ear: '"+
...
leech_urges()
{
    ...
    if (!objectp(wielder))
    {
       DEBUG("Urge was called with no one wielding the scimitar.");
       return;
    }
    ...
    if (no_more_tests > TEST_LIMIT)
    {
       ...
       set_default_weapon(HIT+10,PEN+10,W_SWORD,W_SLASH|W_IMPALE,W_RIGHT,TO);
...
burn_me(object enemy, int dam) 
{
    ...
    if (dam < 1)
    {
       ...
       wielder->tell_watcher("A pulse of blood-red energy narrowly "+
         "misses "+QTNAME(enemy)+".\n",enemy);
...
drain_me(object enemy, int dam) 
{
    ...
    {  
       enemy->catch_msg("The jewel on the "+short()+" pulsates, but nothing "+   
         "seems to happen.\n");
       wielder->catch_msg("The jewel on the "+short()+" pulsates, but "+   
    ...
    wielder->catch_msg("The jewel on the "+short()+" pulsates brighter as "+
      "your blow connects.\n");
    enemy->catch_msg("The jewel on the "+short()+" pulsates brighter, and "+
      "you feel drained.\n");
    accum += drained;
...
did_hit(int aid,string hdesc,int phurt,object enemy,int dt,int phit,int dam)
{
    ...
    switch(phurt)
    {
       ...
       case 81..90:
          ...
          break;
       default:
          wielder->catch_msg("Broken bones fly and blood sprays everywhere as "+
            "your "+short()+" shatters the "+hdesc+" of the "+
            enemy->query_race_name()+".\n");
          ...
          wielder->tell_watcher("You duck to avoid shards of bone as the "+short()+
            " wielded by "+QTNAME(wielder)+" shatters "+

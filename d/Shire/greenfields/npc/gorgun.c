/*
 * Removed specialized adjectives from Gorgun. Did this so it's more difficult 
 * for players to set triggers for his description when attacking.
 * -- Finwe, September 19, 2004
 */
...
//    set_adj(({"filthy","long-armed"}));
    ...
    set_name("gorgun");
    set_race_name("orc");
    set_long("This orc has an air of command about "+

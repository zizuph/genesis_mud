...
void create_monster()
{
  ...
  set_base_stat(SS_DIS,100+random(16));
...
{
::attacked_by(ob);
  command("shout Get in here you fools, I am under attack!");
  (GREEN_DIR + "camp/tent12bak")->react_alarm();
  (GREEN_DIR + "camp/tent13bak")->react_alarm();
  (GREEN_DIR + "camp/tent15bak")->react_alarm();
}

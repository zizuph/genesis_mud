...
create_room()
{
   ...
   add_exit(GREEN_DIR + "camp/camp02","out",0,1);
...
add_stuff()
{
   ...
   if (!present("leader"))
   {
     ...
     orcleader->set_power(49 + random(16));
   ...
   if (!present("guard1"))
   {
     ...
     orc1->set_long("This orc scout is glaring at you angrily.\n");
     orc1->add_name("guard1");
     orc1->set_power(45 + random(11));
     orc1->set_type(SCOUT);
     orc1->move(TO);

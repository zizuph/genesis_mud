...
create_room()
{
   ...
   add_exit(GREEN_DIR + "camp/camp07","out",0,1);
...
add_stuff()
{
   ...
   if (!present("leader"))
   {
     ...
     orcleader->set_long("This is an monstrously strong orc guard.\n");
     orcleader->add_name("leader");
     orcleader->set_power(60 + random(36));

...
void create_area_room()
{
	...
	add_exit(ROOM_DIR + "maggotforest02", "east");
	add_exit(ROOM_DIR + "maggotforest04", "west");
	add_exit(ROOM_DIR + "maggotforest07", "south");
	add_exit(FIELD_DIR + "maggotfield05", "north");
}

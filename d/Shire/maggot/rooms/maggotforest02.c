...
void create_area_room()
{
	...
	set_up_herbs( ({GONDOR_HERB_DIR + "astaldo", SHIRE_HERB_DIR + "bilberry"}), ({"ground"}), 3); 
	
	add_exit(ROOM_DIR + "maggotforest01", "east");
	add_exit(ROOM_DIR + "maggotforest03", "west");
	add_exit(ROOM_DIR + "maggotforest06", "south");
}

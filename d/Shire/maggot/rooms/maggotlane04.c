...
create_area_room()
{
	...
	"a couple buildings to the west of here. West of here, you " +
	"can just make out a turnip field.";
	...
	"there is a large turnip to the west\n");
	add_item(({"field", "turnip field"}), "From here it appears to be " +
	"a very large turnip field.\n");
	...
	add_exit(ROOM_DIR + "maggotlane03", "east");
	add_exit(ROOM_DIR + "maggotlane05", "west");

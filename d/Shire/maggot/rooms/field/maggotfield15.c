...
void create_area_room()
{
	...
	add_exit(FIELD_DIR + "maggotfield14", "east");
	add_exit(FIELD_DIR + "maggotfield16", "west");
	add_exit(FIELD_DIR + "maggotfield21", "north", 0, 3, 1);
	add_exit(FIELD_DIR + "maggotfield09", "south", 0, 3, 1);

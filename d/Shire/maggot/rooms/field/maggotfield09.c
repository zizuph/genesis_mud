...
void create_area_room()
{
	...
	add_exit(FIELD_DIR + "maggotfield08", "east");
	add_exit(FIELD_DIR + "maggotfield10", "west");
	add_exit(FIELD_DIR + "maggotfield15", "north", 0, 3, 1);
	add_exit(FIELD_DIR + "maggotfield03", "south", 0, 3, 1);

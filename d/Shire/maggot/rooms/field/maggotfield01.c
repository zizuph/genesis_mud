...
void create_area_room()
{
	...
	"in a row of planted turnips in the southeast corner of " +
	"the field. A grove of trees are growing near the edge of " +
	"the field southwest of here.";
	...
	add_exit(FIELD_DIR + "maggotfield02", "west");
	add_exit(FIELD_DIR + "maggotfield07", "north", 0, 3, 1);

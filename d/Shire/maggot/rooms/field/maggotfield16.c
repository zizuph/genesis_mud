...
void create_area_room()
{
	...
	add_exit(FIELD_DIR + "maggotfield15", "east");
	add_exit(FIELD_DIR + "maggotfield17", "west");
	add_exit(FIELD_DIR + "maggotfield22", "north", 0, 3, 1);
	add_exit(FIELD_DIR + "maggotfield10", "south", 0, 3, 1);

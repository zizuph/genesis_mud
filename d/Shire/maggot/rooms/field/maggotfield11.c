...
void create_area_room()
{
	...
	add_exit(FIELD_DIR + "maggotfield10", "east");
	add_exit(FIELD_DIR + "maggotfield12", "west");
	add_exit(FIELD_DIR + "maggotfield17", "north", 0, 3, 1);
	add_exit(FIELD_DIR + "maggotfield05", "south", 0, 3, 1);

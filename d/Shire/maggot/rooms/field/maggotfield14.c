...
void create_area_room()
{
	...
	add_exit(FIELD_DIR + "maggotfield13", "east");
	add_exit(FIELD_DIR + "maggotfield15", "west");
	add_exit(FIELD_DIR + "maggotfield20", "north", 0, 3, 1);
	add_exit(FIELD_DIR + "maggotfield08", "south", 0, 3, 1);

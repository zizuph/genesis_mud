...
void create_area_room()
{
	...
	add_exit(FIELD_DIR + "maggotfield09", "east");
	add_exit(FIELD_DIR + "maggotfield11", "west");
	add_exit(FIELD_DIR + "maggotfield16", "north", 0, 3, 1);
	add_exit(FIELD_DIR + "maggotfield04", "south", 0, 3, 1);

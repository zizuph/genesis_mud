...
create_tunnel_room()
{
    ...
    add_my_desc("Torches give a minimum of light here. There " +
        "is a large hole in the east wall. The tunnel runs " +
        "north and west here.\n");
    ...
    add_exit(ORCR_ROOM + "start", "east");
    add_exit(ORCR_ROOM + "gld07", "north");
    add_exit(ORCR_ROOM + "gld04", "west");

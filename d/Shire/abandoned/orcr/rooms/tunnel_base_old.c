...
create_area_room()
{
    ...
    set_short("A dark tunnel inside the Misty Mountains");
//    add_long("You are in a tunnel deep in the Misty Mountains. 
//    add_prop(ROOM_I_LIGHT, );  // Lamps add extra light.
...
string tunnel_desc3()
{
    return "Standing in a tunnel in the mountains. Gashes in " +
    "the walls, ceiling and floor show show that the tunnel was " +

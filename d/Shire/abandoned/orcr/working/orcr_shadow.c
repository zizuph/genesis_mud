...
/*
    if (style == "thief")
    {
        player->catch_tell("We brave fighters don't want thieves in our " +
            "ranks.\n");
        return 1;
    }
*/
...
{
//    return titles[query_guild_level_race()];
}
...
query_guild_skill_name(int type)
{
    ...
    {
        return "racial guild special skill";
    }

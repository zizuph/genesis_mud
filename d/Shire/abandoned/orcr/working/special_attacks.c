...
/*
 * Function name: can_attack_with_race_special
 ...
 */
mixed
can_attack_with_race_special(object target, string attack)
{
    mixed why;
...
punch2(object target)
{
    ...
    if (stringp(why = can_attack_with_race_special(target, "punch")))
    {

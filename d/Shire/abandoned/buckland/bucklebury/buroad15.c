...
#define EXIT1 BB_DIR + "buroad14","east",0,1
#define EXIT2 BB_DIR + "buroad5","west",0,1
#define EXIT3 BB_DIR + "burrow5_1","southeast",0,1
...
create_room()
{
    ...
    "small burrows.  You can enter the one to the southeast.  The path "+

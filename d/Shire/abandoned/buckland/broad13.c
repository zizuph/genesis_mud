...
#define EXIT1 BUCK_DIR + "broad12","northwest",0,1
#define EXIT2 BUCK_DIR + "broad14","southeast",0,1
...
create_room()
{
   ...
   extraline = "The fields that surround you are lush and green "+
    ...
    "You feel very alone here, with only some small animals in the fields "+
    "for company.";

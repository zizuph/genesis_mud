...
create_object()
{
   ...
   set_short("gold-trimmed blood-red badge");
   set_pshort("gold-trimmed blood-red badges");
   ...
   "of the Red Fang. I has been trimmed with gold, for this is the "+
   "special badge of honor, given to those who have done a great "+
   "service in the name of the Red Fang.\n"+
...
show_subloc(string subloc, object on, object for_obj)
{
    ...
    if (for_obj != on)
      return capitalize(HE(on))+" is wearing a "+short()+" on "+HIS(on)+
    " chest.\n";
    else
      return "You are wearing a "+short()+" on your chest.\n";
}

/*  -*- LPC -*-  */
/* Filaname: /d/Shire/moria/skills/fumble.c
 * It's a skill that enables you to do different 
 * kind of confusing acts against an enemy.
 * You can make him loose his weapon, make him slip
 * and thus loose one combat round on that, make him hit
 * himself. Read the functions, they are selfexplainable.
 * Created by Rogon for use in Moria, 
 * updated by Odin for use in the Healers guild, which the
 * original file was intended to be used also.
 */
...
{
	if(!living(who))
	NF("You cannot make that fumble!\n");
		return 0;
	if(!present(who))
	NF("Who do you want to fumble?\n");
		return 0;

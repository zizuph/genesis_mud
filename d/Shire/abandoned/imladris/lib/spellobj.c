...
inherit STD_SPELL_FILE;
inherit EXTRA_FILE;
inherit SPELL_MESSAGE_FILE;
inherit PARSE_FILE;
inherit TELLEM_FILE;
...
start_spell_msg(string arg)
{
    ...
    write("You start singing an arcane hymn of Illuvatar.\n" +
	  "You sing: Hyarmen Eru Illuvatar tananda " + query_prop(SPELL_S_NAME)+"!\n"+
	  "You gain great wisdom in twisting the essence of " + element + ", forming "+
	  LANG_ADDART(form)+ " spell.\n");

    mess = " starts singing: Hyarmen Eru Illuvatar tananda " + query_prop(SPELL_S_NAME);

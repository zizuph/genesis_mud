...
#define ARMBAND  "_orc_race_guild_armband_"
...
query_cmdlist()
{
	...
	return ([
      "help"       :   "do_help",
      "hlist"      :   "list_active_orcs",
      "hobbitlist" :   "list_active_orcs",
    ]);
...
calc_full(object player)
{
    string full;
    int tummy, max;
	// Gets the max eat for the player
    max = TP->eat_max(); 

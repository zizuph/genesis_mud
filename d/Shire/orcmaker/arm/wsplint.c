...
#define SNAME "mail"
#define SADJ "splint"
#define SSHORT "bronze splint mail"
#define SPSHORT "bronze splint mails"
...
create_armour()
{
  ...
  set_short(SSHORT);
  set_pshort(SPSHORT);
  set_long("The "+short()+" covers the torso of the wearer with a "+
    "padded cloth vest that has thick strips of bronze sewn to it. "+
    "These vertical strips of bronze provide some protection.\n");

...
create_weapon()
{
   ...
   set_long("This is a broad axe, wielded by larger orcs. You can see "+
        "how the axe head curves wickedly near the top. It seems "+
        "capable of doing serious damage in the right hands.\n");

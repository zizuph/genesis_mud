...
create_weapon()
{
   ...
   set_pshort("curved axes");
   set_long("This is a curved axe, wielded by bigger orcs, you can see "+
        "how the axehead makes a gentle curve in the middle. Looks like it would "+

...
create_er_room()
{
    ...
    add_exit(ER_DIR + "erb11",  "west", 0, 1);
    add_exit(ER_DIR + "erb13",  "southeast", 0, 1);
    /*  add_exit(ER_DIR + "erb13n", "east", 0, 2, 1);
	add_exit(ER_DIR + "erb12n", "north", 0, 2, 1);
	add_exit(ER_DIR + "erb12s", "south", 0, 2, 1); */

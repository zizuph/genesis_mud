...
create_er_room()
{
    ...
    add_exit(ER_DIR + "erb34",  "northwest", 0, 1);
    add_exit(ER_DIR + "erb36",  "east", 0, 1);
/*  add_exit(ER_DIR + "erb34s", "west", 0, 2, 1);
    add_exit(ER_DIR + "erb35n", "north", 0, 2, 1);
    add_exit(ER_DIR + "erb35s", "south", 0, 2, 1);
*/
    add_lonelands();

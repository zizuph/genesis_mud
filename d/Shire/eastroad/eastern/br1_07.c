...
void create_er_room()
{
    ...
    set_extraline("The hillocks seem to float in the water. They look " +
        "unsafe with water lapping at their edges. Dead trees stick out " +
        "of the water, and insects buzz around.");
    ...
    add_exit(ER_DIR + "br1_08", "northeast");
    add_exit(ER_DIR + "br1_06", "west");

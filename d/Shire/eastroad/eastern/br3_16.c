...
void create_er_room()
{
    ...
    set_extraline("Sparse vegetation grows among the grasses that " +
        "covers the rocky ground. Groves of trees grow scattered across " +
        "the area along with bushes and shrubs.");

    add_item(({"path"}),
        "The path is little more than a thin line that winds through " +
        "the land.\n");

    add_exit(ER_DIR + "br3_17", "east");
    add_exit(ER_DIR + "br3_15", "west");

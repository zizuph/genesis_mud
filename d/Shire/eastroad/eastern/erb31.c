...
create_er_room()
{
    ...
    add_exit(ER_DIR + "erb30",  "west", 0, 1);
    add_exit(ER_DIR + "erb32",  "southeast", 0, 1);
/*  add_exit(ER_DIR + "erb32n", "east", 0, 2, 1);
    add_exit(ER_DIR + "erb31n", "north", 0, 2, 1);
    add_exit(ER_DIR + "erb31s", "south", 0, 2, 1);
*/
    add_lonelands();

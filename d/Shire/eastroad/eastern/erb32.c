...
create_er_room()
{
    ...
    add_exit(ER_DIR + "erb31",  "northwest", 0, 1);
    add_exit(ER_DIR + "erb33",  "east", 0, 1);
/*  add_exit(ER_DIR + "erb31s", "west", 0, 2, 1);
    add_exit(ER_DIR + "erb32n", "north", 0, 2, 1);
    add_exit(ER_DIR + "erb32s", "south", 0, 2, 1);
*/
    add_lonelands();

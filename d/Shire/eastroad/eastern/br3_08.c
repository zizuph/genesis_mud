...
void create_er_room()
{
    ...
    set_extraline("The dry land is covered with grasses and wild flowers. " +
        "It is flat except for bushes and trees that grow in scattered " +
        "groups. The path veers northwest and east.");

    add_item(({"path"}),
        "The path is little more than a thin line that winds through " +
        "the land.\n");

    add_exit(ER_DIR + "br3_09", "east");
    add_exit(ER_DIR + "br3_07", "northwest");

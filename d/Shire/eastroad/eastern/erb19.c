...
create_er_room()
{
    ...
    set_extraline("You stand at the southwest edge of Weathertop as "+
    "it towers above you, sparse vegetation failing to soften "+
    "its ominous demeanor. You fail to make out any details of "+
    "what might be on the top from here, except a few aspens that "+
    "grow in clumps around the base of the ancient watchpost. "+
    "The road continues to the southwest and east from here.");

    add_item("weathertop",
      "Looming over you to the northeast is Amon Sul, "+
    ...
    add_exit(ER_DIR + "erb18",  "southwest", 0, 1);
    add_exit(ER_DIR + "erb20",  "east", 0, 1);
/*  add_exit(ER_DIR + "erb18n", "west", 0, 2, 1);

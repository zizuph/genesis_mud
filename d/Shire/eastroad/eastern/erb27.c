...
create_er_room()
{
    set_area("somewhere in the Lone-lands");
    ...
    add_exit(ER_DIR + "erb26",  "west", 0, 1);
    add_exit(ER_DIR + "erb28",  "northeast", 0, 1);
/*  add_exit(ER_DIR + "erb28s", "east", 0, 2, 1);
    add_exit(ER_DIR + "erb26n", "north", 0, 2, 1);
    add_exit(ER_DIR + "erb26s", "south", 0, 2, 1);
*/
    add_lonelands();

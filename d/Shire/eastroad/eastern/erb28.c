...
create_er_room()
{
    ...
    add_exit(ER_DIR + "erb27",  "southwest", 0, 1);
    add_exit(ER_DIR + "erb29",  "east", 0, 1);
/*  add_exit(ER_DIR + "erb27n", "west", 0, 2, 1);
    add_exit(ER_DIR + "erb28n", "north", 0, 2, 1);
    add_exit(ER_DIR + "erb28s", "south", 0, 2, 1);
*/
    add_lonelands();

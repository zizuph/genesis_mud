...
create_er_room()
{
    ...
    add_exit(ER_DIR + "erb33",  "west", 0, 1);
    add_exit(ER_DIR + "erb35",  "southeast", 0, 1);
/*  add_exit(ER_DIR + "erb35n", "east", 0, 2, 1);
    add_exit(ER_DIR + "erb34n", "north", 0, 2, 1);
    add_exit(ER_DIR + "erb34s", "south", 0, 2, 1);
*/
    add_lonelands();

...
create_er_room()
{
    ...
    set_extraline("You stand right under the southernmost point "+
    "of Weathertop, here the road runs closest. "+
    ...
    add_item("weathertop",
      "Looming right over you to the north is Amon Sul, "+
    ...
    add_exit(ER_DIR + "erb19",  "west", 0, 1);
    add_exit(ER_DIR + "erb21",  "east", 0, 1);
/*  add_exit(ER_DIR + "erb20n", "north", 0, 2, 1);
    add_exit(ER_DIR + "erb20s", "south", 0, 2, 1);
*/
}

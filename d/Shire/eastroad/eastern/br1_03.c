...
void create_er_room()
{
    ...
    set_extraline("The path is barely visible in the forest. It winds " +
        "through the forest and out of view. The forest is large, and " +
        "doted with wild flowers that grow under the trees and on the path.");
    ...
    add_exit(ER_DIR + "br1_04", "east");
    add_exit(ER_DIR + "br1_02", "west");

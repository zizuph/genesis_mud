...
#define EXIT1 ERE_DIR + "err19","east",0,1
#define EXIT2 ERE_DIR + "err6","west",0,1
...
create_er_room()
{
    ...
    extraline = "The dense underbrush of prickly thorns surrounds "+
    "the few trees here, making it very difficult to move "+
    "around. Fortunately, they seem to be somewhat thiner to the "+
    "east and west.";

...
#define EXIT1 ERE_DIR + "ser10","west",0,1
#define EXIT2 ERE_DIR + "ser12","east",0,1
...
create_er_room()
{
    ...
    extraline ="The river is flowing swiftly beside you, making "+
    "loud noises which is probably why you didn't notice the "+
    "other noises coming from the area.";

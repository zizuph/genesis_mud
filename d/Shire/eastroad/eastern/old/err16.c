...
#define EXIT1 ERE_DIR + "err11","northwest",0,1
#define EXIT2 ERE_DIR + "err17","south",0,1
...
create_er_room()
{
    ...
    extraline = "Light filters through the trees to the northwest "+
    "and the outline of a little used path can be "+
    "seen to the south.";
    treetype = "oak";

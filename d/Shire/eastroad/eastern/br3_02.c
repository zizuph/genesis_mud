...
//    set_add_weather_hills();
    ...
    set_extraline("Sparse vegetation grows among the grasses that covers " +
        "the rocky ground. Hills loom to the west, and groves of trees " +
        "grow scattered across the area.");

    add_item(({"path"}),
        "The path is little more than a thin line that winds through " +
        "the land.\n");

    add_exit(ER_DIR + "br3_03", "east");
    add_exit(ER_DIR + "br3_01", "west");

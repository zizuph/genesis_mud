...
//    set_add_weather_hills();
    ...
    set_extraline("The land is rocky but covered with wild grasses. Sparse " +
        "vegetation grows among the grasses. Small groves of aspens grow " +
        "scattered around the land. To the west are some hills.");

    add_item(({"path"}),
        "The path is little more than a thin line that winds through " +
        "the land.\n");

    add_exit(ER_DIR + "br3_02", "east");
    add_exit(ER_DIR + "br1_14", "southwest");

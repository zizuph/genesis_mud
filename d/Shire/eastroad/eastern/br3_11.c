...
void create_er_room()
{
    ...
    set_extraline("Trees grow on the rocky land along with shrubs and " +
        "bushes. The rocky land is covered by sparse grasses and wildflowers.");

    add_item(({"path"}),
        "The path is little more than a thin line that winds through " +
        "the land.\n");

    add_exit(ER_DIR + "br3_12", "east");

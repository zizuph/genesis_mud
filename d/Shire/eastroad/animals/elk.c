...
#define NAME3 "elk"
#define PNAME "elks"
#define LONG "This elegant elk is wary of predators.\n"
#define ADJ1 "elegant"
#define ADJ2 "slender"
#define ALIGN 75
#define WEIGH 8500
#define MOUT "prances"
#define AMIN "prances in."   /* Don't forget the period. :) */
#define FIGHT1 50   /* Unarmed */
#define FIGHT2 50  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote stumbles a bit as it walks."
#define ACTTIME 7
#define ACT1 "emote prances to and fro."
#define ACT2 "emote stops to listen to something."
#define ACT3 "emote looks around carefully."

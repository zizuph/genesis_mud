...
#define NAME1 "moose"
#define NAME2 "moose"
#define NAME3 "bull moose"
#define PNAME "moose"
#define LONG "This stout moose looks very powerful.\n"
#define ADJ1 "stout"
#define ADJ2 "powerful"
#define ALIGN 55
#define WEIGH 15500
#define MOUT "stomps"
#define AMIN "stomps in."   /* Don't forget the period. :) */
#define FIGHT1 80   /* Unarmed */
#define FIGHT2 60  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote stares around cautiously."
#define ACTTIME 7
#define ACT1 "emote stomps around loudly."
#define ACT2 "emote bellows with a deafening roar."
#define ACT3 "emote nibbles at the grass."

...
#define NAME1 "turtle"
#define NAME2 "box turtle"
#define NAME3 "turtle"
#define PNAME "turtles"
#define LONG "The turtle has a huge shell and small head.\n"
#define ADJ1 "green"
#define ADJ2 "box"
#define ALIGN 55
#define WEIGH 4500
#define MOUT "slinks "
#define AMIN "slinks in."   /* Don't forget the period. :) */
#define FIGHT1 50   /* Unarmed */
#define FIGHT2 80  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote pulls its head out of the shell."
#define ACTTIME 7
#define ACT1 "emote snaps its jaws aimlessly."
#define ACT2 "emote pulls its arms, legs and head into the shell."
#define ACT3 "emote crawls around slowly."

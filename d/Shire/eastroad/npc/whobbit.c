...
// 2011/08/02 Lavellan - Added sizes, not all very tall very skinny hobbits...
...
int not_intro, intro_alarm, reintro_alarm, alarm_id;
...
create_monster()
{
   ...
   add_chat("I love my sweets and beer!");
   add_chat("Have you been to Michel Delving?");
   add_chat("My mother makes the loveliest cakes and cookies.");
   add_chat("My gaffer is soon to be a hundred years old.");
   add_chat("The only good to come out of the South Farthing is tobacco.");
   add_chat("It's my birthday tomorrow, I shall have to find presents.");
   add_chat("I can't stand those Tooks, they are too strange for words.");

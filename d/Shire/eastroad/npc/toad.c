...
#define NAME3 "toad"
#define PNAME "toads"
#define LONG "This toad seems covered in warts.\n"
#define ADJ1 "brown"
#define ADJ2 "warty"
#define ALIGN 25
#define WEIGH 500
#define MOUT "hops"
#define AMIN "hops in."   /* Don't forget the period. :) */
#define FIGHT1 30   /* Unarmed */
#define FIGHT2 30  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote leaps high into the air."
#define ACTTIME 7
#define ACT1 "emote goes: croak...croak."
#define ACT2 "emote hops away from you."
#define ACT3 "emote blinks slowly."

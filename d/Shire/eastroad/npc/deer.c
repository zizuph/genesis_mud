...
#define NAME3 "buck"
#define PNAME "deer"
#define LONG "This deer dances about nimbly.\n"
#define ADJ1 "shy"
#define ADJ2 "brown"
#define ALIGN 75
#define WEIGH 6500
#define MOUT "dances"
#define AMIN "dances in."   /* Don't forget the period. :) */
#define FIGHT1 30   /* Unarmed */
#define FIGHT2 50  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote dances to and fro."
#define ACTTIME 7
#define ACT1 "bounce hap"
#define ACT2 "emote examines the ground for marks."
#define ACT3 "emote nibbles on the grass."

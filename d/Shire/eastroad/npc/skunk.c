...
#define NAME1 "skunk"
#define NAME2 "stinker"
#define NAME3 "skunk"
#define PNAME "skunks"
#define LONG "This skunk is a real stinker!\n"
#define ADJ1 "black"
#define ADJ2 "striped"
#define ALIGN 65
#define WEIGH 4500
#define MOUT "waddles"
#define AMIN "waddles in."   /* Don't forget the period. :) */
#define FIGHT1 50   /* Unarmed */
#define FIGHT2 30  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote wiggles its tail."
#define ACTTIME 7
#define ACT1 "emote raises its tail threateningly."
#define ACT2 "emote waddles about aimlessly."
#define ACT3 "emote sniffs itself carefully."

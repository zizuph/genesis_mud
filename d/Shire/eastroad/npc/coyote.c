...
#define NAME2 "coyote"
#define NAME3 "coyote"
#define PNAME "coyotes"
#define LONG "This coyote eyes you up as a possible meal.\n"
#define ADJ1 "sneaky"
#define ADJ2 "black"
#define ALIGN -65
#define WEIGH 8500
#define MOUT "sneaks"
#define AMIN "sneaks in."   /* Don't forget the period. :) */
#define FIGHT1 60   /* Unarmed */
#define FIGHT2 40  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote looks carefully for leftover food."
#define ACTTIME 7
#define ACT1 "grumble unhap"
#define ACT2 "emote stalks around after you."
#define ACT3 "emote pants tiredly."

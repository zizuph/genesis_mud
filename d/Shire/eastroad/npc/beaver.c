...
#define NAME2 "beaver"
#define NAME3 "beaver"
#define PNAME "beavers"
#define LONG "This beaver looks quite ferocious.\n"
#define ADJ1 "ferocious"
#define ADJ2 "angry"
#define ALIGN 35
#define WEIGH 5500
#define MOUT "struts"
#define AMIN "struts in."   /* Don't forget the period. :) */
#define FIGHT1 50   /* Unarmed */
#define FIGHT2 50  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote glares at you in a very hostile manner."
#define ACTTIME 7
#define ACT1 "emote stretches out slowly."
#define ACT2 "emote sniffs the air."
#define ACT3 "glare"

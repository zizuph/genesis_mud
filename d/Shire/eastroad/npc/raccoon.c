...
#define NAME1 "raccoon"
#define NAME2 "coon"
#define NAME3 "raccoon"
#define PNAME "raccoons"
#define LONG "This raccoon looks like he is wearing a mask.\n"
#define ADJ1 "fuzzy"
#define ADJ2 "grey"
#define ALIGN 65
#define WEIGH 2500
#define MOUT "scuttles"
#define AMIN "scuttles in."   /* Don't forget the period. :) */
#define FIGHT1 40   /* Unarmed */
#define FIGHT2 30  /* Defence */
#define RM 8   /* Random move */
#define EMOTE "emote wiggles its whiskers."
#define ACTTIME 7
#define ACT1 "emote plays with something with its paws."
#define ACT2 "emote scuttles about."
#define ACT3 "emote looks for something to eat."

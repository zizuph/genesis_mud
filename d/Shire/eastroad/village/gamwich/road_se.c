...
create_room()
{
    ...
    extraline="A wide dirt path heads from northwest to southeast "+
        "here, lined with large stones.  Following the road to the "+
        "northwest, one can enter the town square of the hamlet of "+
        "Gamwich.";
    ...
    add_exit(GAMWICH_DIR+"road_start","northwest");
    add_exit(GAMWICH_DIR+"road_turn","southeast");

...
#define EXIT1 GREEN_DIR + "burrow/1","north",0,1
...
create_room()
{
   ...
   add_item(({"seven chairs","battered rocking chairs","cherry rocking chair","chair"}),
   "The seven battered rocking chairs are handmade, you suppose, judging by the "+

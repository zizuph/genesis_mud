 ...
 *
 * 1998/06/26 Last update.
 * 2001/01/25 Last update, but was unused (whitbaker_new.c)
 * 2011/08/01 Lavellan - Now in use. Fixed pricelist and counter a little.
 */
...
create_shire_room()
{
    ...
    add_exit("/d/Shire/eastroad/village/whit/whitlane1","south", 0,0,1);
...
counter_desc()
{
    ...
    "things.  They all look dirty and uninteresting though.\n";
    }

 ...
 *
 * Borrowed by Dunstable for use in Greenholm, April 1995
 */
...
#define IS_STUPID
#define STORE_ROOM (ER_BASE_DIR + "village/greenholm/shop_store")
...
create_room()
{
   set_short("The Greenholm Trader");
   set_long("The Greenholm Trader is a veritable wealth of stored supplies, "+
   "though not all of them are weapons of war or shields, "+
   "still there are many interesting things lying about.  "+
   "A pricelist is affixed to the wall above the counter.  "+
   "The store's owner is probably asleep behind the counter "+
   "so just leave the money with him and take what you wish.  Feel free to "+
    "browse as long as you like.  West will take you back "+
    "out to the village.\n");
   ...
   "feet lazily perched.\n");
    add_exit(ER_BASE_DIR + "village/greenholm/viln2","west",0);

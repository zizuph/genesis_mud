...
#define EXIT1 ER_BASE_DIR + "village/greenholm/1","north",0,1
#define EXIT3 ER_BASE_DIR + "village/greenholm/1d","south",0,1
#define EXIT2 ER_BASE_DIR + "village/greenholm/1f","east",0,1

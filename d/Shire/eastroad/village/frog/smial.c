...
string short_func()
{
   switch(roomtype)
   {
      ...
      +"There is a comfortable looking bed, as well as cupboards "
      +"and dressers, used for storage. ";
      case 6:
      return "This smaller room is used as a guest bedroom. There "
      +"is a small bed in here, as well as a dresser. ";
      case 7:
...
void make_the_room()
{
   ...
   switch(roomtype)
   {
      ...
      add_item("door","This round wooden door is small, as "
         +"befits the door to a hobbit hole.  There is a litle "
      ...
      case 8:
      add_item("walls",
         "The walls of this hallway are pannelled in oak. "

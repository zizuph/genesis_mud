...
create_er_room()
{
   ...
   "the road.  To the east is a crossroad, with roads leading "+
   ...
   "on another crossroad.";
   
   add_item(({"crossroad","crossroads"}),"These crossroads "+
...
//    room_add_object("/d/Shire/charity/hob_box");

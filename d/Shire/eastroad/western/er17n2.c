...
create_er_room()
{
   ...
   "   The fields of the Shire stretch out around you in all directions. To "+
   ...
   add_exit(EAST_R_DIR + "er17n3","north",0,2);
   add_exit(EAST_R_DIR + "er17n","south",0,2);
   add_exit(EAST_R_DIR + "er16n","west",0,2);
   add_exit(EAST_R_DIR + "er18n","east",0,2);

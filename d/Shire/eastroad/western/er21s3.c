...
create_er_room()
{
    ...
    "damp from when the river recently flooded. Plants grow scattered " +
    "across the field. The river flows south alongside the lane.";
    ...
    add_exit(EAST_R_DIR + "er21s2","north",0,2);
    add_exit(EAST_R_DIR + "er21s4","south",0,2);
}

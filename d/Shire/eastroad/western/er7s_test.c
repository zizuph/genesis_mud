...
create_er_room()
{
    ...
    "Michel Delving lies east of here; north and west will find Greenholm.";
...
add_exit("/d/Shire/finwe/hell", "hell");
/*
...
reset_shire_room()
{
   ...
   herbalist->add_prop(ROOM_I_NO_ATTACK, 1); 
   herbalist->add_prop(ROOM_I_NO_MAGIC_ATTACK, 1); 

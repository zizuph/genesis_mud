...
create_er_room()
{
   ...
   "people in these parts call it, yet the surroundings are still wide open and the true "+
   ...
   "horizon to your west. North you can return to the Eastroad, "+
   "and east takes you into another field.";
   
   add_item(({"walls","wall","mithlond","horizon"}),
   "Directly to your northwest you see the White Walls of Mithlond towering high "+
   ...
   add_exit(EAST_R_DIR + "er1","north");
   add_exit(EAST_R_DIR + "er2s","east");

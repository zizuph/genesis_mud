/* Adapted from Hobbits, for use of Elves.
 * Boy, These daggers must get around :)
 * Avenger, May 6 1995
...
create_weapon()
{
 ...
 set_long("This is a long, thin dagger, that has been made " +
  "for use by a elf.  The grip is long enough, for a elf's " +
  "hand, but the dagger could probably be used by anyone.\n");
 add_item("blade","The blade of the dagger is thin and long.\n");

...
create_er_room()
{
    ...
    extraline = "Tall grasses wave in the breeze and are dotted with " +
        "bushes and trees growing in the field. A barely visible path runs " +
        "east and west through the grass.";
    ...
    add_exit(GIRD_DIR + "secret04", "east");
    add_exit(GIRD_DIR + "secret02", "west");

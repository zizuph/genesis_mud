/* I've changed this from a Huge goblin to a massive 
 * Since I have made the guard rooms clone the huge goblins
 * this one wasn't nessacery.
 * Igneous
 */
#include "../local.h"
...
void return_introduce()
{
    ...
    in_room = FILTER_LIVE(all_inventory(ENV(TO)));
    met_me=1;

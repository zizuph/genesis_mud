...
create_shire_room()
{
    set_short("@@my_short");
    set_long("@@my_long");
    add_item(({"wall","walls"}),"The walls appear "+
		"to be of a limestone rock. Every surface "+
		"glistens with moisture. Deep shadows surround"+
...
string my_long()
{
    ...
    switch(i)
    {
    case 0: str = "You are in a narrow cave with out exits"; break;
    case 1: str = "You are at the end of the cavern"; break;
    case 2: str = "You are in a tunnel"; break;
    default: str = "You are at a branch of the tunnels";
    }
    return str+" "+
    "under the Misty Mountains. Every twist and turn of the"+
		" cavern complex appears to be almost identical."+
		" The floor slopes forever downward towards the "+
		"heart of the mountain.\n";
}
int climb_up()
{
    write ("You ascend the stairs upwards towards fresh air.\n\n");
    say(QCTNAME(TP) + " ascends the stairs upwards.\n\n");
...
int climb_down()
{
    write ("You descend the stairs into the abysmial depths.\n\n");
    say(QCTNAME(TP) + " descends the stairs into the depths.\n\n");
...
int push_something(string str)
{
	...
	if(CAN_SEE_IN_ROOM(TP))
	{
		...
		TP->catch_msg("You push the wall with all your strength. It " +
		  "starts move but suddenly stops. Maybe you should eat more " +
		  "spinach.\n");

...
create_shire_room()
{
    ...
    add_exit(ROOMS_DIR+"c93", "northeast", "@@block_exit:" + file_name(this_object()) + 
      "|"+ROOMS_DIR+"c93@@");
	 add_exit(ROOMS_DIR+"c98", "south", "@@block_exit:" + file_name(this_object()) + 
      "|"+ROOMS_DIR+"c98@@");
	  add_exit(ROOMS_DIR+"c95", "southwest", "@@block_exit:" + file_name(this_object()) + 
      "|"+ROOMS_DIR+"c95@@");

...
create_shire_room()
{
    ...
    set_long("You are on an animal trail leading through the brush to the "  +
      "northwest towards the foothills of the Misty mountains. The southeastern " +
      "direction leads past the heavy bushes down into the valley to the high pass.\n");
    ...
    add_room_tell("You hear a 'chirping' sound coming from the bushes nearby.");

    /* The other room,           direction, VBFC, fatigue */
    add_exit(MISTY_DIR + "er_link", "southeast", 0, 0, 1);
    add_exit(MISTY_DIR + "hunter_trail02", "northwest", 0, 0, 1);

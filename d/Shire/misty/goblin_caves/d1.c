/* goblin caves 
 *
 * This is where players find the key for the free prisoner quest.
 *
 *    Quest re-opened 2008-05-05 by Toby
 */
...
get_key(string arg)
{
      ...
      (arg == "small key from pot") || (arg == "small rusty key from pot"))
    {
        ...
        key_is_in_pot = 0;
        key = clone_object(MISTY_OBJ_DIR + "rusty_key");
        key->set_key("_rusty_gcaves_quest_key_"); //re-opened quest thus set to this /Toby
        key->move(TP);
        return 1;
    }
    return 0;

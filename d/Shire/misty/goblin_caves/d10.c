 ...
 * -Igneous-
 ...
 Palmer March 16, 2006
 Removed block if Goblin NPC is present.
 TODO:
 We should let people in and out a few times, then make them search.
 */
...
create_shire_room()
{
    ...
    // add_exit(CAVE_DIR+"t25", "out", check_combat);
    add_exit(CAVE_DIR+"t25", "out");

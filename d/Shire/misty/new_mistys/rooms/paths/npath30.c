...
create_mt_room()
{
    ...
    add_exit(PATH_DIR + "npath31", "northwest",0,5);
    add_exit(PATH_DIR + "npath29", "east",0,5);
    reset_shire_room();
}
...
add_stuff()
{
    ...
    if (!warrior2)
    {
	    ...
	    warrior2->set_power(190+random(51));
    	warrior2->set_type(SCOUT);
    ...
    if (!warrior3)
    {
    	...
    	warrior3->set_power(200+random(51));
	    warrior3->set_type(WARRIOR);

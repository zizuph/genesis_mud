...
create_shire_room()
{
	...
	add_exit("/d/Shire/misty/orc_area/oa5", "east", 0, 5);
	add_exit("/d/Shire/misty/orc_area/oa7", "north", 0, 5);
	add_exit("/d/Shire/misty/orc_area/oa1", "south", 0, 5);
	add_exit("/d/Shire/misty/orc_area/oa3", "west", 0, 5);

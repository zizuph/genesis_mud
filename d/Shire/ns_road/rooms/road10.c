...
create_road_room()
{
    ...
    set_extraline("The " + areadesc + " travels north into the Southfathing. It also heads southeast past Longbottom.");

    set_add_southfarthing();
    set_add_farms();
    add_longbottom_descr();

    add_exit(NS_RM_DIR + "road10a", "north");
    add_exit(NS_RM_DIR + "road09", "southeast");

...
create_room()
{
  ...
  set_long("east-west direction. To the east it leads further into the "+
  ...
  add_exit(BARB_ROOM +"br2","east");
 // add_exit(BARB+"bo1","west");
 // add_exit(BARB+"bc1","north");
  //add_exit(BARB+"bc2","south","@@stop");
}

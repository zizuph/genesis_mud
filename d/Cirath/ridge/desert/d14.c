 /* At the base of a cliff, in the desert west of Tyr. 
  * Derryn can be found here.
...
reset_room()
{
    bring_room_team(RIDGE_NPC+"derryn.c",1);
}
...
create_desert()
{
  ...
  add_exit(RIDGE_DESERT+"d15.c","east",0,8,0);
  add_exit(RIDGE_DESERT+"d11.c","northeast",0,12,0);
  add_exit(RIDGE_DESERT+"d10.c","north",0,8,0);
/*  add_exit(RIDGE_DESERT+"d19.c","southeast",0,12,0);
*/
  reset_room();
}

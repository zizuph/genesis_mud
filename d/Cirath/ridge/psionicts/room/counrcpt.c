...
create_room()
{
    ...
    add_exit(PSION_ROOM+"stairwy3.c", "north", 0, 1);
    add_exit(PSION_ROOM+"counmain.c", "east", "@@spot_block@@", 1);
...
do_list(string str)
{
    ...
    lowoverdud1 = "Not filled. The arena is silent.";
    if(the_crew[1]) lowoverdud1 = CAP(the_crew[1]);

    lowoverdud2 = "Not filled. The battles shall rage!";
    if(the_crew[2]) lowoverdud2 = CAP(the_crew[2]);

    lowoverdud3 = "Not filled. Everyone is a suspect.";
    if(the_crew[3]) lowoverdud3 = CAP(the_crew[3]);

    lowoverdud4 = "Not filled. Who will guide the lost sheep?";
    if(the_crew[4]) lowoverdud4 = CAP(the_crew[4]);

    lowoverdud5 = "Not filled. Everything is more difficult.";
    if(the_crew[5]) lowoverdud5 = CAP(the_crew[5]);

    write ("\n  The Overseers Currently Consist of\n"+
           "  ===========================================================\n"+
           "  High Overseer: "+highoverdude+"\n\n"+
           "  Lesser Overseers\n"+
           "            Arena: "+lowoverdud1+"\n"+
           "              War: "+lowoverdud2+"\n"+
           "         Internal: "+lowoverdud3+"\n"+
           "      Recruitment: "+lowoverdud4+"\n"+
           "        Assistant: "+lowoverdud5+"\n"+
           "  -----------------------------------------------------------\n\n");
    return 1;
}

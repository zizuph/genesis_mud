...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v11.c
...
create_valley()
{
  ...
  add_exit(RIDGE_VALLEY+"v08.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v12.c","east",0,8,0);
  add_exit(RIDGE_VALLEY+"v15.c","south",0,8,0);
  add_exit(RIDGE_VALLEY+"v14.c","southwest",0,8,0);
  reset_room();
}

...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v05.c
...
create_valley()
{
  ...
  add_exit(RIDGE_VALLEY+"v03.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v06.c","east",0,8,0);
  add_exit(RIDGE_VALLEY+"v09.c","south",0,8,0);
  add_exit(RIDGE_VALLEY+"v08.c","southwest",0,8,0);
  reset_room();
}

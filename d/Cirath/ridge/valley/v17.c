...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v17.c
...
create_valley()
{
 set_short("Sand Valley");
  set_long("You are standing on the western ridge of the valley. To the southwest, "
  	...
  	+"the other side. Taking a closer look you can see something moving over there.\n");
  ...
  add_exit(RIDGE_VALLEY+"v14.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v18.c","east",0,8,0);
  reset_room();

...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v13.c
...
create_valley()
{
  ...
  add_exit(RIDGE_VALLEY+"v09.c","north",0,8,0);
  add_exit(RIDGE_VALLEY+"v10.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v16.c","southwest",0,8,0);
  add_exit(RIDGE_VALLEY+"v12.c","west",0,8,0);
  reset_room();
}

...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v07.c
...
create_valley()
{
  ...
  add_exit(RIDGE_VALLEY+"v04.c","north",0,8,0);
  add_exit(RIDGE_VALLEY+"v10.c","southwest",0,8,0);
  add_exit(RIDGE_VALLEY+"v06.c","west",0,8,0);
  reset_room();
}

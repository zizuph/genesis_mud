...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v01a.c
...
create_room()
{
  ...
  set_long("After a few hours of travelling you finnaly reach the base "+
      "of a red stone cliff. The landscape is harsh and desolate. There "+
      "is not a trace of vegetation to be found anywhere in sight. "+
      "Stretching away from the cliff is an endless sea of bare rock and "+
      "earth. Gusts of wind raise clouds of red dirt which sweep their "+
      "way across the barren landscape. The cliff stretches gradually becomes "+

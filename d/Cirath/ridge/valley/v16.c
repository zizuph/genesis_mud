...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v16.c
...
create_valley()
{
  ...
  set_long("You are standing on the eastern ridge of the valley. Looking down "
  ...
  add_exit(RIDGE_VALLEY+"v12.c","north",0,8,0);
  add_exit(RIDGE_VALLEY+"v13.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v19.c","southwest",0,8,0);
  add_exit(RIDGE_VALLEY+"v15.c","west",0,8,0);
  reset_room();
}

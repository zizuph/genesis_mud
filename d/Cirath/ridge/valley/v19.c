...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v19.c
...
create_valley()
{
 set_short("Sand Valley");
  set_long("You are standing on the eastern ridge of the valley. To the southwest, "
  ...
  add_exit(RIDGE_VALLEY+"v15.c","north",0,8,0);
  add_exit(RIDGE_VALLEY+"v16.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v18.c","west",0,8,0);
  reset_room();
}

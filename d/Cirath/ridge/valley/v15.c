...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v15.c
...
create_valley()
{
  ...
  add_exit(RIDGE_VALLEY+"v11.c","north",0,8,0);
  add_exit(RIDGE_VALLEY+"v12.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v16.c","east",0,8,0);
  add_exit(RIDGE_VALLEY+"v19.c","south",0,8,0);
  add_exit(RIDGE_VALLEY+"v18.c","southwest",0,8,0);
  add_exit(RIDGE_VALLEY+"v14.c","west",0,8,0);
  reset_room();
}

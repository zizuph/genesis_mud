...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v10.c
...
create_valley()
{
 set_short("Sand Valley");
  set_long("You are standing on the eastern ridge of the valley. To the northeast "
  ...
  add_exit(RIDGE_VALLEY+"v06.c","north",0,8,0);
  add_exit(RIDGE_VALLEY+"v07.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v13.c","southwest",0,8,0);
  add_exit(RIDGE_VALLEY+"v09.c","west",0,8,0);
  reset_room();
}

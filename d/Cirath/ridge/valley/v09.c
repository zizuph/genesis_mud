...
* Date: 19 August 2001
*
* File: /d/Cirath/ridge/valley/v09.c
...
create_valley()
{
  ...
  add_exit(RIDGE_VALLEY+"v05.c","north",0,8,0);
  add_exit(RIDGE_VALLEY+"v06.c","northeast",0,8,0);
  add_exit(RIDGE_VALLEY+"v10.c","east",0,8,0);
  add_exit(RIDGE_VALLEY+"v13.c","south",0,8,0);
  add_exit(RIDGE_VALLEY+"v12.c","southwest",0,8,0);
  add_exit(RIDGE_VALLEY+"v08.c","west",0,8,0);
  reset_room();
}

...
create_room()
 {
  ...
  set_long("You have come to a corner in the wall of the gith fortress.  "
  	+"A narrow stone staircase leads upward to the walkway on the top "
  	+"of the wall where you assume guards monitor both the outside "
  	+"and inside of the fortress.  The same tents and shelters you "
  	+"have seen scattered all over the fortress grounds are still "
  	+"present here, some even managed to squeeze under the staircase "
  	+"and get a precious small amount of shade.\n");
  ...
  add_exit(CAMP + "c2","northeast");
  add_exit(CAMP + "c11","southeast");
  add_exit(CAMP + "c10","south");
  add_exit(CAMP + "c8","east");
  add_exit(CAMP + "c30","up");
  add_exit(CAMP + "t7","enter",0,0,1);

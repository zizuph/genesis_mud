...
create_room()
 {
  ...
  add_exit(CAMP + "c5","northeast");
  add_exit(CAMP + "c6","north");
  add_exit(CAMP + "c15","southeast");
  add_exit(CAMP + "c7","northwest");
  add_exit(CAMP + "c17","southwest");
  add_exit(CAMP + "c16","south");
  add_exit(CAMP + "c14","east");
  add_exit(CAMP + "c12","west");
  add_exit(CAMP + "t12","enter",0,0,1);

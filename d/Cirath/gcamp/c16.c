...
create_room()
 {
  ...
  set_long("Rising high above you, the black stone of the mountain "
  	...
  	+"the west.  There is also a narrow corridor leading off "
  	+"into the mountain to your southeast.\n");
  ...
  add_exit(CAMP + "c13","north");
  add_exit(CAMP + "c12","northwest");
  add_exit(CAMP + "c14","northeast");
   add_exit(CAMP + "c22","southwest","@@block");
  add_exit(CAMP + "c15","east");
  add_exit(CAMP + "c17","west");

...
add_prop(ROOM_I_HIDE,-1);
  add_exit(CAMP + "c2","northwest");
  add_exit(CAMP + "c3","north");
  add_exit(CAMP + "c4","northeast");
  add_exit(CAMP + "c12","south");
  add_exit(CAMP + "c13","southeast");
  add_exit(CAMP + "c8","west");
  add_exit(CAMP + "c14","southwest");
  add_exit(CAMP + "c6","east");
  add_exit(CAMP + "t6","enter",0,0,1);

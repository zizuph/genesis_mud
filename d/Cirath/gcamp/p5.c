...
create_room()
 {
  ...
  add_exit(CAMP + "p4","southwest");
  add_exit(CAMP + "campent","northeast","@@message");
}

message()
{
	say("A strong wind blows through the area as you step off "
		+"the narrow path and back on the main route, "
		+"totally removing all traces of any possible "
		+"path off the road.\n");
	write("A strong wind blows through the area as you step off "
		+"the narrow path and back on the main route, "
		+"totally removing all traces of any possible "
		+"path off the road.\n");
   return 0;

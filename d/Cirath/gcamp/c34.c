...
create_room()
 {
  ...
  set_long("You have reached the southeastern corner of the walkway"
  	...
  	+"camp.  North of you, where the walkway should be is a "
  	+"large hole in the wall.  It looks to be about a 15 foot "
  	+"drop to the ground, so be careful.\n");
  ...
  add_item("wall","It is a large sanstone wall circling the gith "
  	...
  	+"standing on.  North there is also a large hole which "
  	+"seems to provide some means of escape from the fortress.\n");
  add_item("ladder","It is cut into the surface of the tower itself "
  	+"with hardly enough room for your foot to fix in the hole.\n");
  add_item("hole","The hole looks to have been made ages ago during "
  	+"some fight.\n");
  ...
  add_exit(CAMP + "c37","up");
  add_exit(CAMP + "c33","north");

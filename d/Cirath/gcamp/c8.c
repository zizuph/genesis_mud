...
create_room()
 {
  ...
  add_exit(CAMP + "c2","north");
  add_exit(CAMP + "c3","northeast");
  add_exit(CAMP + "c11","south");
  add_exit(CAMP + "c12","southeast");
  add_exit(CAMP + "c9","west");
  add_exit(CAMP + "c10","southwest");
  add_exit(CAMP + "c7","east");

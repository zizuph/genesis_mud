...
did_hit(int aid, string hdesc, int phurt, object enemy, int dt, int phit, int dam)
{
	...
	if (poison)
	{
     ...
     poison->set_damage(({POISON_FATIGUE, 250, POISON_STAT, SS_CON}));
	    poison->start_poison();
	    return 0;
	}
	else
...
wield(object what)
{
  object me = ENV(TO);
   ...
   write("Your body explodes in pain as you wield the dagger!\n");
...
unwield(object what)
{
   write("You release the cold weapon from your hand.\n");
    return 0;
}

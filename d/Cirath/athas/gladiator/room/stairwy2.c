...
create_room()
{
    ...
    add_exit(GLAD_ROOM+"stairwy1.c", "down", 0, 1);
    add_exit(GLAD_ROOM+"stairwy3.c", "up", 0, 1);
    /*
	add_exit(GLAD_ROOM+"training.c", "east", "@@check_leave@@", 1);
	add_exit(GLAD_ROOM+"gldboard.c", "south", "@@check_leave2@@", 1);
    */
    add_exit(GLAD_ROOM+"training.c", "east", 0, 1);
    add_exit(GLAD_ROOM+"gldboard.c", "south", 0, 1);
}
int
check_leave()
{

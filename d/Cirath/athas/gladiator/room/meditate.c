...
#include "defs.h"
#define CHARGE_LOG (GLAD_LOG+"chargeob.log")
#define CHARGE_ALLOW (GLAD_HELP + "chargeok.gh")
...
void create_room()
{
    ...
    add_exit(GLAD_ROOM + "gldboard.c", "west", 0, 1);
}
...
setcharge(string str)
{
    ...
    if ((glad->query_gladiator_level()) < CHARGE_OB_LEVEL)
    {
    ...
    MANAGER->set_charge_desc(glad, str);
//    WRITE_LOG(CHARGE_LOG, glad, ": "+str);

    glad->catch_msg("Custom charge string set!\n"+

...
*
*   20210712 Meton - Added non-standard reply to ask "brutus"
 */
...
create_monster()
{
    ...
    add_ask("freedom", MAIN_ASK("freedom"));
    add_ask("brutus", "say He is in the main hall.", 1);
}
...
{
    string speach;
    speach = (read_file(GLAD_HELP + subject +".nh") + "\n> ");

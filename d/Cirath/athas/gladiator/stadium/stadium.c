...
#define SHADOW STADIUM_DIR+"stadiumshadow"
#define STONE1 STADIUM_DIR+"stone1.c"
#define STONE2 STADIUM_DIR+"stone2.c"
...
create_room()   
{
    ...
    LOAD_ERR(STADIUM_DIR + "ringside");

    add_exit(STADIUM_DIR+"ringside.c", "seats", 0, 1);
...
leave(string whatleft)
{
    ...
    write("In the arena? You must be joking.\n");
    return 1;
}

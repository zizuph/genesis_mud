...
create_container()
{
    ...
    set_name("corpse");
    set_short("dessicated corpse");
    set_adj("dessicated");
    set_long("This corpse seems to have been here for "
        +"ages.  Thoroughly dried and preserved by the heat and "
        +"lack of moisture, you see the grimmace of pain that "
        +"sense formed this hapless human's death mask.\n");

...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "d13","northeast");
    add_exit(DESERT + "r3","north");
    add_exit(DESERT + "r2","northwest");
    add_exit(DESERT + "r4","east");
    add_exit(DESERT + "d9","west");
    add_exit(DESERT + "d7","southwest");
    add_exit(DESERT + "d6","south");
    add_exit(DESERT + "d5","southeast");

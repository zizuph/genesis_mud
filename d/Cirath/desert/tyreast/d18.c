...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "d19","northeast");
    add_exit(DESERT + "d20","northwest");
    add_exit(DESERT + "d17","west");
    add_exit(DESERT + "d13","southwest");
    add_exit(DESERT + "d12","south");
    add_exit(DESERT + "d11","southeast");

...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "r5","northeast");
    add_exit(DESERT + "d10","northwest");
    add_exit(DESERT + "r4","north");
    add_exit(DESERT + "d4","east");
    add_exit(DESERT + "d6","west");
    add_exit(DESERT + "d3","southeast");
    add_exit(DESERT + "d2","south");
    add_exit(DESERT + "d1","southwest");

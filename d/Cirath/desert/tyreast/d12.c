...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "d17","northwest");
    add_exit(DESERT + "d18","north");
    add_exit(DESERT + "d13","west");
    add_exit(DESERT + "d11","east");
    add_exit(DESERT + "r4","southwest");
    add_exit(DESERT + "r5","south");

...
create_room()
 {
  ...
  set_long(my_long()+".\n");
   add_exit(DESERT + "r3","northeast");
   add_exit(DESERT + "r2","north");
  add_exit(DESERT + "r1","northwest");
    add_exit(DESERT + "d10","east");
    add_exit(DESERT + "d8","west");
   add_exit(DESERT + "d7","south");
   add_exit(DESERT + "d6","southeast");

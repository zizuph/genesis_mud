...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "r4","northeast");
    add_exit(DESERT + "d9","northwest");
    add_exit(DESERT + "d10","north");
    add_exit(DESERT + "d5","east");
    add_exit(DESERT + "d7","west");
    add_exit(DESERT + "d2","southeast");
    add_exit(DESERT + "d1","south");

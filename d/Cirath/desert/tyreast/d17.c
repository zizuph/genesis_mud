...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "d20","north");
    add_exit(DESERT + "d21","northwest");
    add_exit(DESERT + "d16","west");
    add_exit(DESERT + "d18","east");
    add_exit(DESERT + "r3","southwest");
    add_exit(DESERT + "d13","south");

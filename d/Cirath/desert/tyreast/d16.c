...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "d21","north");
    add_exit(DESERT + "d20","northeast");
    add_exit(DESERT + "d15","west");
    add_exit(DESERT + "d17","east");
    add_exit(DESERT + "r2","southwest");
    add_exit(DESERT + "r3","south");
    add_exit(DESERT + "d13","southeast");

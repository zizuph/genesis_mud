...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "r5","north");
    add_exit(DESERT + "r4","northwest");
    add_exit(DESERT + "r6","east");
    add_exit(DESERT + "d5","west");
    add_exit(DESERT + "d3","south");
    add_exit(DESERT + "d2","southwest");

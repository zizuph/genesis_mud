...
create_room()
 {
  ...
  set_long(my_long()+".\n");
    add_exit(DESERT + "d16","northwest");
    add_exit(DESERT + "d17","north");
    add_exit(DESERT + "d18","northeast");
    add_exit(DESERT + "d14","west");
    add_exit(DESERT + "d12","east");
    add_exit(DESERT + "d10","southwest");
    add_exit(DESERT + "r4","south");
    add_exit(DESERT + "r5","southeast");

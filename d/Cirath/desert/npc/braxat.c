...
#define RNDADJ ({"huge","massive","large","hulking","big"})
#define RNDADJ2 ({"deformed","ugly","brutish","reptilian","scaly"})
...
create_monster()
{
   ...
   set_race_name("braxat");
    ...
    set_stats(({170,110,160,90,90,120}));
...
arm_me()
{
    clone_object(DES_WEP+"b_club")->move(TO);
    command("wield all");
}

...
void create_room()
{
    ...
    set_long ("You are in a crevice. "+
	      ...
	      "savour the feeling of their cool rugged surfaces "+
              "against your hot skin. The path goes upwards to "+
              "the northeast and downwards south, where it seems a bit "+
              "cooler.\n");
    ...
    TRAIL;
    OUTSIDE
    add_exit(WILD_PASS+"pass13.c","northeast",0,2);
    add_exit(WILD_PASS+"pass11.c","south",0,2);
}

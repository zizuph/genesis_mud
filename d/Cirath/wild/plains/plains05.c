...
void create_room()
{
    ...
    set_long("You are at the west end of the road between Tyr and "+
              "the Ringing Mountains. Looking west you can make out "+
              "a trail heading into the mountains, and eastwards you "+
              "can glimpse the Golden Tower and the Ziggurat in the city "+
              "of Tyr. You think you vaguely can make out the walls of "+
              "the Arena as well. "+
              "The road continues to the east across the sandy plains, "+
              "and far across the shrubland to the south you can "+
              "see what appears to be a few farms.\n");
    ...
    OUTSIDE
    add_exit(WILD_PASS+"pass01.c","west",0,1);
    add_exit(WILD_PLAINS+"plains04.c","east",0,1);
}

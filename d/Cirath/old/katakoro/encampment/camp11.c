...
* Date: 
*
* File: /d/Cirath/katakoro/encampment/camp11.c
...
create_room()
{
  	set_short("Barbarian camp");
   	set_long("This is deep into the encampment. Wandering "+
		"about this area are soldiers as well women and children "+
		"going through the various routines of thier lives. Some are "+
		"milling about cooking fires, others making repairs on the "+
		"felt rugs used for the yurts, and some are seeing to thier "+
  	...
  	add_exit(KAT_CAMP + "camp12","south", 0, 1);
  	add_exit(KAT_CAMP + "camp17","east", 0, 1);
  	add_exit(KAT_CAMP + "camp5","west", 0, 1);
  	reset_room();
}

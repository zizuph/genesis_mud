...
* Date: 
*
* File: /d/Cirath/chukel/nomads/p04.c
...
create_room()
{
  ...
  set_long("You are travelling a small path close to the base of a large mountain. "+
           "A small stream flows to sour south and continues in northwest-southeast "+
           "direction.\n");  
  ...
  add_exit(NOMAD+"p05","east", 0, 1);
  add_exit(NOMAD+"p03","northwest", 0, 1);
  reset_room();
}

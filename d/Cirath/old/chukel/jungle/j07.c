...
void create_room()
{
  ...
  add_exit(JUNGLE+"j04","northwest","@@work");
  add_exit(JUNGLE+"j07","north","@@work");
  add_exit(JUNGLE+"j09","northeast","@@work");
  add_exit(JUNGLE+"j07","west","@@work");
  add_exit(JUNGLE+"j07","east","@@work");
  add_exit(JUNGLE+"j07","southwest","@@work");
  add_exit(JUNGLE+"j07","south","@@work");

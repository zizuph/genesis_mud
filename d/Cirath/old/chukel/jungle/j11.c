...
void create_room()
{
  ...
  add_exit(JUNGLE+"j11","northwest","@@work");
  add_exit(JUNGLE+"j11","north","@@work");
  add_exit(JUNGLE+"j11","northeast","@@work");
  add_exit(JUNGLE+"j11","west","@@work");
  add_exit(JUNGLE+"j12","east","@@work");
  add_exit(S_TRADE+"r08","southwest","@@work");
  add_exit(JUNGLE+"j11","south","@@work");
  add_exit(JUNGLE+"j11","southeast","@@work");
...
tracks()
{
  ...
  if(trck>ntrck && aware>45 && locsns>45)
    TP->catch_msg(break_string(
          ...
          "exits to your east and southwest.\n",60));
  else
    TP->catch_msg(

...
* Date: 
*
* File: /d/Cirath/chukel/ciubori/houses/home3.c
...
create_room()
{
  	...
  	set_long("This is one of the homes in Ciubori. The room looks quite shabby and you "+
           	"wonder who would want to live here. The furniture is sparse. Just a bed in the "+
  	...
  	add_item("table","Its a wooden table and it doesn't look very clean either.\n");
  	add_item("chair","The chair doesn't look very confortable.\n");
  	add_item("carpet","The carpets are stained by grease and other unmentionable stuff.\n");
  	...
  	add_exit(CIU_STR + "dstreet4", "south", 0, 1);
	reset_room();
}
...
ruglift(string str)
{
  	if (str=="rug" && rug==0)
  	{
   	write("You discover a hole in the floor that are covered with some wood.\n");
    	...
    	add_item("lid","It's covering the hole. You think you can manage to lift it off.\n");
    	set_long("This is one of the homes in Ciubori. The room looks quite scabby and you "+
  	...
  	{
    		write("The rug is already lifted off, and where it have laid you can see a hole covered "+
      		"with a wooden lid.\n");
    		return 1;
  	}
  	...
  	if (str=="lid" && rug==1)
  	{
    		write("You lift the lid off and discover a ladder leading down.\n");
   		 remove_item("hole");
    		remove_item("lid");
    		add_item("hole","The hole lies open, why don't you enter it?\n");
    		add_item("lid","It's lies beside the hole.\n");
    		set_long("This is one of the homes in Ciubori. The room looks quite scabby and you "+
           	"wonder who wants to live here. The furniture is sparse. Just a bed in the "+
           	"corner and a wooden table with a chair. The carpets are filthy and a dirty "+
           	"rug is covering the floor. In the window stands a pot which contains something "+
  	...
  	else if (str=="lid" && rug==2)
  	{
    		write("The wood is already lifted off. At its previous location, a ladder leads down into a hole.\n");
    		return 1;
  	}
...
holeenter(string str)
{
  	if (str=="hole" && rug==2)
  	{
    		...
    		TP->move_living("through the hole",CIU_HOU + "sneakladder");
    		return 1;
  	}
  	NF("What?!");
  	return 0;

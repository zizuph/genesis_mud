...
* Date: 
*
* File: /d/Cirath/chukel/s_trade/r15.c
...
create_room()
{
  ...
  set_long("This little village is not in the best shape. Propably "+
  ...
  add_exit(S_TRADE+"r16","west",0,1);
  add_exit(S_TRADE+"r14","east",0,1);
  //add_exit(S_VILLAGE+"tavern","north",0,1);
  //add_exit(S_VILLAGE+"house1","south",0,1);
  reset_room();
}

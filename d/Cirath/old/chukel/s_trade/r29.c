...
* Date: 
*
* File: /d/Cirath/chukel/s_trade/r29.c
...
create_room()
{
  ...
  set_long("You are travelling on the southern trade-route, between "+
  ...
  add_exit(S_TRADE+"r28","east",0,1);
  add_exit(S_TRADE+"r30","west",0,1);
  reset_room();
}

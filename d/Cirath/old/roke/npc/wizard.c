...
create_monster()
{
    set_name("wizard");
    set_adj("evil");
    set_long("This is the evil wizard Refnas who was turned into a dragon " +
             "by the good wizard in the castle.\n");
...
reward(object tp)
{
    ...
    TP->add_exp(BLUEDRAGONXP);

    whisper("Thank you! I've been a prisoner here since");
    whisper("Krfsm threw me out of the castle.");
    whisper("Now I am free to haunt the locals again!");
    whisper("You will be handsomly rewarded!");

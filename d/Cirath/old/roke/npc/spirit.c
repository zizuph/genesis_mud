...
#define BORTPROP "_roke_osdufksdkjfhsdj"
#define SPIRIT_PROP "_roke_got_tissue"

void rminv(object ob);
...
create_creature()
{
    ...
    add_prop(OBJ_M_NO_MAGIC_ATTACK,
             "You can't attack the transparent spirit.\n");
    set_act_time(4);
}
...
help(string s)
{
    ...
    say("The spirit whispers something to " + QCTNAME(TP) + ".\n");
...
mkinv(object ob)
{
    ...
    set_alarm(300.0, 0.0, &rminv(ob));
}

void
rminv(object ob)
{
    ob->catch_msg("You are visible again.\n");

...
void create_room()
{
	...
	add_item( ({"wares", "good", "goods"}), "As expected, the goods for sale are made of "+
    ...
    add_exit(TYR_TCAMP+"camp_6.c", "north", 0, 1);
    add_exit(TYR_TCAMP+"camp_1.c", "east", 0, 1);
    add_exit(TYR_TCAMP+"camp_18.c", "west", 0, 1);
}

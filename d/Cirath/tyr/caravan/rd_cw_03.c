...
void create_room()
{
    ...
    add_exit(TYR_CARAVAN+"armrmrch.c", "north", 0, 1);
    add_exit(TYR_CARAVAN+"rd_cw_04.c", "east", 0, 1);
    add_exit(TYR_CARAVAN+"weapmrch.c", "south", 0, 1);
    add_exit(TYR_CARAVAN+"rd_cw_02.c", "west", 0, 1);
}

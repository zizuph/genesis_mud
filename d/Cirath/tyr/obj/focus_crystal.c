...
*
*   2021-08-08 Meton Changed the way merging crystals gave message,
                hoping it wont go into lplog, and so other players
                than the one dropping crystal can see it.
*/
inherit "/std/object";
inherit "/lib/keep";
...
dedup_shards(object *shards)
{
    ...
    if (sizeof(shards))
    {
        ...
        set_alarm(0.2, 0.0, &tell_room(environment(), "The crystals "+
            "vibrate sharply, and merge into one.\n"));
    }
}

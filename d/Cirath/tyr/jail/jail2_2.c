...
* Date: 11 August 2001
*
* File: /d/Cirath/tyr/jail/jail2_2.c
...
create_room()
{
	...
	set_long("The corridor looks like a X shape, a corridor leading in "
		+"all the corners of the room. There is a cell to the "
		+"southwest of here. The corridor is lit by torches "
		+"that are fastened to the walls.\n");

	add_item("cell", "There is a cell to the southwest. You think you "
		+"heard something in the cell, but when you take a closer look "
	...
	add_exit(TYR_JAIL + "jail2_9.c", "northwest", 0,1);
	add_exit(TYR_JAIL + "jail2_7.c", "northeast", 0,1);
	add_exit(TYR_JAIL + "jail2_3.c", "southeast", 0,1);
	add_exit(TYR_JAIL + "cell2_9.c", "southwest", 0,1);
	reset_room();
}

...
reset_room()
{
   bring_room_team(TYR_NPC+"drabakk.c",1,7,TYR_NPC+"rich_eat.c",1);
}
...
create_room()
{
    ...
    set_long("Little more than a glorified tavern, the Senators' Hall is "+
    ...
    add_exit(TYR_NOBLE+"rd_ds_01.c","north",0,1);
    reset_room();
}

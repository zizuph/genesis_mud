...
block_exit()
{
    write("The road is blocked by a huge carriage! You may not "+
      "go this way, at this time.\n");
    return 1;
}
...
create_room()
{
 ...
 set_long("Once in a moment of excess the nobles of Tyr decided that "
    ...
    /* add_exit(TYR_NOBLE+"rd_pr_01.c", "north", "@@roof_message", 5); */
   
    add_exit(TYR_NOBLE+"rd_pr_01.c", "north", block_exit);
    add_exit(TYR_NOBLE+"rd_hr_04.c", "east", "@@roof_message", 5);
    add_exit(TYR_NOBLE+"rd_pr_03.c", "south", "@@roof_message", 1);
    add_exit(TYR_NOBLE+"rd_hr_03.c", "west", "@@roof_message", 1);
}

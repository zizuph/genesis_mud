...
create_room()
{
  ...
  add_exit(TYR_MARKET+"shdwsqre.c","north",0,1,0);
  add_exit(TYR_MARKET+"hhh.c","east",0,1,0);
  add_exit(TYR_MARKET+"elfmkt.c","west",0,1,0);
  add_exit(TYR_MARKET+"shdwsqrw.c","northwest",0,1,0);
  add_exit(TYR_MARKET+"souvenir.c","south","@@block_exit@@",1,0);

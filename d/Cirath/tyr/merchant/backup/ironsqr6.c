...
create_room()
{
    ...
    add_exit(TYR_MERCHANT+"ironsqr4.c", "north", "@@block_exit@@", 1);
    add_exit(TYR_MERCHANT+"ironsqr7.c", "east", 0, 1);
/*
    add_exit(TYR_MERCHANT+"housiant.c", "south", "@@house_block", 1);
*/
    add_exit(TYR_MERCHANT+"tyroffc.c", "south", "@@house_block", 1);

...
//Integers
static object right,gloves;

/*
*   Function name: remove_right_flames_shadow
*   Description  : removes this shadow
*   Arguments    : 
*   Returns      : 
*/
void
remove_right_flames_shadow()
{
    gloves->removal_message(right);
    remove_shadow();
}

/*
*   Function name: query_right_flames_shadow
*   Description  : checks this shadow
*   Arguments    : 
*   Returns      : 
*/
int
query_right_flames_shadow() { return 1; }

/*
*   Function name: set_right_flames_ob
*   Description  : sets the ob.
*   Arguments    : 
*   Returns      : 
*/
void
set_right_flames_ob(object ob)
{
    right = ob; 
}

/*
*   Function name: query_right_flames_ob
...
object
query_right_flames_ob() { return right; }

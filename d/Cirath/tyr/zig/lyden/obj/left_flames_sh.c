...
//Integers
static object left,gloves;

/*
*   Function name: remove_left_flames_shadow
*   Description  : removes this shadow
*   Arguments    : 
*   Returns      : 
*/
void
remove_left_flames_shadow()
{
    gloves->removal_message(left);
    remove_shadow();
}

/*
*   Function name: query_left_flames_shadow
*   Description  : checks this shadow
*   Arguments    : 
*   Returns      : 
*/
int
query_left_flames_shadow() { return 1; }

/*
*   Function name: set_left_flames_ob
*   Description  : sets the ob.
*   Arguments    : 
*   Returns      : 
*/
void
set_left_flames_ob(object ob)
{
    left = ob; 
}

/*
*   Function name: query_left_flames_ob
...
object
query_left_flames_ob() { return left; }

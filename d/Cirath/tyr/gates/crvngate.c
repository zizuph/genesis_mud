/* crvngate: Tyr's western gate: Serpine, 12-04-96 
   Updated June 2001, Casimir. Added connection to /ridge/desert 
   updated 2020, Meton, added Cirath_magic*/
...
create_room()
{
    ...
    add_exit(TYR_CARAVAN+"rd_cw_01.c","east","@@sun_flash@@",1);
    add_exit("/d/Cirath/ridge/desert/d09.c","west","@@sun_flash@@",1);

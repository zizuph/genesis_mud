 ...
 * 
 * Fylo, Feb 2000
 * Added shields Damaris 9/2002
 * updated shields to remove the full body overage  Damaris 02/2007
 * Updated shields to add back coverage of body and legs Mirandus 01/2018
 */
#pragma strict_types
...
query_shield_slots()
{
    if (query_at() & A_SHIELD)
     {
        return (::query_shield_slots() + ({ A_BODY, A_HEAD}) );
     }

...
create_room()
 {
  set_short("Waiting Room");
   set_long("You have entered what appears to be the "
     +"northeastern room designed for "
	+"visitors to wait for an opportunity to speak with Lord "
	+"Minthor. Plush couches and comfortable looking chairs are "
  ...
  ADD_ZIG_ITEM
  INSIDE
   add_exit(TZ_MINTHOR + "mh15","east", 0);
   add_exit(TZ_MINTHOR + "mh11","southwest", 0);
}

...
create_room()
{
    ...
    add_exit(TYR_SLAVE+"rd_sw_06.c", "north", "@@block_exit@@", 1); 
    add_exit(TYR_GATES+"gate_tn.c", "east", "@@block_exit@@", 1);
    add_exit(TYR_SLAVE+"rd_sw_04.c", "south", 0, 1);
    add_exit(TYR_SLAVE+"rd_tr_04.c", "west", 0, 1);
}

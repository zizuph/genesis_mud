...
create_monster()
{
   ...
   add_act("' I get bored standing here all day.");
   add_act("' I get paid well for this job.");
   add_act("' Don't try anything funny, or I'll squash you.");
   add_cact("' You are a pitiful fool.");
   add_cact("' Why do you even try?");
   add_cact("' I like to destroy puny fools like you.");
}
...
arm_me()
{
   ...
   club = clone_object(TYR_WEP+"club_hge.c");
   club->move(TO);

...
create_monster ()
{
	...
	add_act("' What are you doing here, leave now!");
	add_act("' Hmm I wonder where i put that cell key.");
	add_act("shout Slave come here now! I want my desk polished.");
	add_act("' I hate sitting in here. If i only could beat up some "
		+"prisoners or slaves.\n");
	add_act("' You stink like a corpse. Go and lie down on the pile "
		+"outside the window.\n");
	...
	add_cact("' Hmm looks like i have to put you in a cell.");

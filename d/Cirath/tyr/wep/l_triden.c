...
*
*   2010/09/17 Lavellan, commented out unnecessary query_keepable
*   redefine as it was preventing the file being compiled.
*
        ...
        object enemy, int dt, int phit, int dam)
{
    ...
    switch(phurt)
    {
      ...
      case 0..4:
        ...
        break;
      case 5..8:
        me->catch_msg("You smashed the Lotulis so hard into "+HIS_HER(enemy)+" "+hdesc

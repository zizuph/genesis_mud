...
{
  seteuid(getuid(TO));
  clone_object(OBJ+"cg_armour")->move(TO);
  clone_object(OBJ+"cg_boots")->move(TO);
  clone_object(OBJ+"cg_bracers")->move(TO);
  clone_object(OBJ+"cg_gloves")->move(TO);
  clone_object(OBJ+"cg_greaves")->move(TO);
  clone_object(OBJ+"cg_helm")->move(TO);
  clone_object(OBJ+"cg_robe")->move(TO);
  clone_object(OBJ+"cg_shield")->move(TO);

  clone_object(OBJ+"cg_weapon")->move(TO);

...
void create_room()
{
  ...
  add_exit(JUNGLE+"j01","northwest","@@work");
  add_exit(JUNGLE+"j01","north","@@work");
  add_exit(JUNGLE+"j01","northeast","@@work");
  add_exit(JUNGLE+"j01","west","@@work");
  add_exit(JUNGLE+"j03","east","@@work");
  add_exit(JUNGLE+"r1","southwest","@@work");
  add_exit(JUNGLE+"j01","south","@@work");
  add_exit(JUNGLE+"j01","southeast","@@work");

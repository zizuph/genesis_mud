...
void create_room()
{
  ...
  add_exit(JUNGLE+"j09","northwest","@@work");
  add_exit(JUNGLE+"j09","north","@@work");
  add_exit(JUNGLE+"j09","northeast","@@work");
  add_exit(JUNGLE+"j09","west","@@work");
  add_exit(JUNGLE+"j09","east","@@work");
  add_exit(JUNGLE+"j07","southwest","@@work");
  add_exit(JUNGLE+"j09","south","@@work");
  add_exit(JUNGLE+"j09","southeast","@@work");
...
tracks()
{
  ...
  if(trck>ntrck && aware>45 && locsns>45)
    TP->catch_msg(break_string(
          "After looking carefully on the ground, you think there's an "+
          "exit southwest.\n",60));
  else
    TP->catch_msg(

...
void create_room()
{
  ...
  add_exit(JUNGLE+"j12","north","@@work");
  add_exit(JUNGLE+"j12","northeast","@@work");
  add_exit(JUNGLE+"j11","west","@@work");
  add_exit(JUNGLE+"j12","east","@@work");
  add_exit(JUNGLE+"j12","southwest","@@work");
  add_exit(JUNGLE+"j12","south","@@work");
  add_exit(JUNGLE+"j13","southeast","@@work");
...
tracks()
{
  ...
  if(trck>ntrck && aware>45 && locsns>45)
    TP->catch_msg(break_string(
          ...
          "exits to your west and southeast.\n",60));
  else
    TP->catch_msg(

...
void create_room()
{
  ...
  add_exit(JUNGLE+"j08","north","@@work");
  add_exit(JUNGLE+"j08","northeast","@@work");
  add_exit(JUNGLE+"j05","west","@@work");
  add_exit(JUNGLE+"j08","east","@@work");
  add_exit(JUNGLE+"j08","southwest","@@work");
  add_exit(JUNGLE+"j08","south","@@work");

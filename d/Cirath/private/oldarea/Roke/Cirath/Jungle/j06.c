...
void create_room()
{
  ...
  add_exit(JUNGLE+"j06","northwest","@@work");
  add_exit(JUNGLE+"j05","north","@@work");
  add_exit(JUNGLE+"j06","northeast","@@work");
  add_exit(JUNGLE+"j06","west","@@work");
  add_exit(JUNGLE+"j06","east","@@work");
  add_exit(JUNGLE+"j04","southwest","@@work");
  add_exit(JUNGLE+"j06","south","@@work");
  add_exit(JUNGLE+"j06","southeast","@@work");

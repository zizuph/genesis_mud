...
void create_room()
{
  ...
  add_exit(JUNGLE+"j02","northwest","@@work");
  add_exit(JUNGLE+"j02","north","@@work");
  add_exit(JUNGLE+"j02","northeast","@@work");
  add_exit(JUNGLE+"j02","west","@@work");
  add_exit(JUNGLE+"j02","east","@@work");
  add_exit(JUNGLE+"j02","southwest","@@work");
  add_exit(JUNGLE+"j03","south","@@work");
  add_exit(JUNGLE+"j02","southeast","@@work");

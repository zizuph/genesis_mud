...
void create_room()
{
  ...
  add_exit(JUNGLE+"j03","northwest","@@work");
  add_exit(JUNGLE+"j04","north","@@work");
  add_exit(JUNGLE+"j06","northeast","@@work");
  add_exit(JUNGLE+"j04","west","@@work");
  add_exit(JUNGLE+"j04","east","@@work");
  add_exit(JUNGLE+"j04","southwest","@@work");
  add_exit(JUNGLE+"j04","south","@@work");
  add_exit(JUNGLE+"j07","southeast","@@work");
...
tracks()
{
  ...
  if(trck>ntrck && aware>45 && locsns>45)
    TP->catch_msg(break_string(
          ...
          "exits to your northwest, northeast and southeast.\n",60));
  else
    TP->catch_msg(

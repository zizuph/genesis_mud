...
void create_room()
{
  ...
  add_exit(JUNGLE+"j13","northwest","@@work");
  add_exit(JUNGLE+"j14","north","@@work");
  add_exit(JUNGLE+"j14","northeast","@@work");
  add_exit(JUNGLE+"j14","west","@@work");
  add_exit(JUNGLE+"road/r4","east","@@work");
  add_exit(JUNGLE+"j14","southwest","@@work");
  add_exit(JUNGLE+"j14","south","@@work");
...
tracks()
{
  ...
  if(trck>ntrck && aware>45 && locsns>45)
    TP->catch_msg(break_string(
          ...
          "exits to your northwest and east.\n",60));
  else
    TP->catch_msg(

...
void create_room()
{
  ...
  add_exit(JUNGLE+"j05","northwest","@@work");
  add_exit(JUNGLE+"j05","north","@@work");
  add_exit(JUNGLE+"j05","northeast","@@work");
  add_exit(JUNGLE+"j05","west","@@work");
  add_exit(JUNGLE+"j08","east","@@work");
  add_exit(JUNGLE+"j05","southwest","@@work");
  add_exit(JUNGLE+"j06","south","@@work");
  add_exit(JUNGLE+"j05","southeast","@@work");

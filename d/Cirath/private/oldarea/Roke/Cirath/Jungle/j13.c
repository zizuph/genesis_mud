...
void create_room()
{
  ...
  add_exit(JUNGLE+"j12","northwest","@@work");
  add_exit(JUNGLE+"j13","north","@@work");
  add_exit(JUNGLE+"j13","northeast","@@work");
  add_exit(JUNGLE+"j13","west","@@work");
  add_exit(JUNGLE+"j13","east","@@work");
  add_exit(JUNGLE+"j13","southwest","@@work");
  add_exit(JUNGLE+"j13","south","@@work");
  add_exit(JUNGLE+"j14","southeast","@@work");
...
tracks()
{
  ...
  if(trck>ntrck && aware>45 && locsns>45)
    TP->catch_msg(break_string(
          ...
          "exits to your northwest and southeast.\n",60));
  else
    TP->catch_msg(

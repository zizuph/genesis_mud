...
void create_room()
{
  ...
  add_exit(JUNGLE+"j03","northeast","@@work");
  add_exit(JUNGLE+"j01","west","@@work");
  add_exit(JUNGLE+"j03","east","@@work");
  add_exit(JUNGLE+"j03","southwest","@@work");
  add_exit(JUNGLE+"j03","south","@@work");
  add_exit(JUNGLE+"j04","southeast","@@work");
...
tracks()
{
  ...
  if(trck>ntrck && aware>45 && locsns>45)
    TP->catch_msg(break_string(
          ...
          "exits to your north, west and southeast.\n",60));
  else
    TP->catch_msg(

...
reset_room()
{
    if (!tika)
    {
        tika = clone_object(MONSTER+"unci");
...
create_room()
{
    ...
    set_long(BS(
        "You are standing inside a dark pub. This is the place, "+
    ...
    add_item(({"barrel","barrels"}),"They are or have been filled with beer. They"+
             "look very heavy, in fact, you doubt that you should be"+
             "to move them.\n");
    add_item("chairs",
        "They look nice.\n"); 
    ...
    add_exit(CIUBORI+"topaz/street3","west",0); 

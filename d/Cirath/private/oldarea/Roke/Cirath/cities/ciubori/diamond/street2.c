...
void create_room()
{
  ...
  set_long(break_string(
           ...
           "can't enter it from here. East you see a crossroad.\n"
           ,60));  
  ...
  add_exit(CIUBORI+"diamond/street3","east");
  add_exit(CIUBORI+"diamond/street1","west");
  add_exit(CIUBORI+"homes/home2","north");
}

...
void create_room()
{
  ...
  set_long(break_string(
           "You are standing on Ruby Street in the southern part of "+
           "Ciubori. North lies a large, impressive building, which you "+
           "can't enter from here. West, you see a crossroad.\n"
           ,60));  
  ...
  add_exit(CIUBORI+"ruby/street5","east");
  add_exit(CIUBORI+"ruby/street3","west");
}

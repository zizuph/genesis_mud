...
arm_me()
{
   ...
   clone_object("/d/Cirath/athas/o_weapons/club_hge.c")->move(TO);
   clone_object("/d/Cirath/athas/o_armours/body_hid.c")->move(TO);
   clone_object("/d/Cirath/athas/o_armours/head_hid.c")->move(TO);
   clone_object("/d/Cirath/athas/o_armours/legs_hid.c")->move(TO);
   command("wield all");
   command("wear all");
}

...
void create_room()
{
    ...
    set_long ("You are standing on a path leading up a mountain. "+
              ...
              "that they get far to little of the oxygen they need to "+
              "operate properly. This , combined with the blazing sun "+
              "over your head, makes you doubt you will last long, "+
              "but seeing vultures in the horizon you decide that "+
    ...
    TRAIL;
    OUTSIDE
    add_exit(PASS_DIR+"a_pass19.c","southwest",0,2);
    add_exit(PASS_DIR+"a_pass17.c","east",0,2);
}

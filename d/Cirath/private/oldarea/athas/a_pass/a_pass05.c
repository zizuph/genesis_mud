...
{
    BRIEF;
    set_long ("You are are travelling along a path between two huge "+
              "mountains. The path is straight and it looks a bit easier "+
              "to travel northwards here. Some rocks seem to have been "+
              "thrown of the path, making it possible to travel at a higher "+
    ...
    TRAIL;
    OUTSIDE
    add_exit(PASS_DIR+"a_pass06.c","north",0,1);
    add_exit(PASS_DIR+"a_pass04.c","south",0,1);
}

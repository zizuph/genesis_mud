...
create_room()
{
    ...
    add_exit(TZ_NOBLE+"rd_hr_03.c", "northeast", 0, 1);
    add_exit(TZ_NOBLE+"house1.c", "east", 0, 1);
    add_exit(TZ_NOBLE+"bank.c", "north", 0, 1);
    add_exit(TZ_NOBLE+"rd_hr_01.c", "southwest", 0, 1);
}

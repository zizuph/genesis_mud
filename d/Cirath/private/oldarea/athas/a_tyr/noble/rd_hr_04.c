...
create_room()
{
    ...
    add_exit(TZ_NOBLE+"house3.c", "north", 0, 1);
    add_exit(TZ_NOBLE+"house5.c", "northeast", 0, 1);
    add_exit(TZ_NOBLE+"rd_ds_01.c", "east", "@@gate_message", 1);
    add_exit(TZ_NOBLE+"rd_hr_05.c", "southeast", 0, 1);
    add_exit(TZ_NOBLE+"rd_pr_02.c", "west", "@@roof_message", 1);
}

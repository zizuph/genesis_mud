...
reset_room()
{
    bring_room_mob("half-giant", ATH_PERSON+"hgiant.c", 1, 1);
}
...
create_room()
{
    ...
    add_exit(TZ_MERCHANT+"ironsqr1.c", "south", "@@check_guard", 1);
    add_exit(TZ_NOBLE+"rd_hr_05.c", "northwest", "@@check_guard", 1);

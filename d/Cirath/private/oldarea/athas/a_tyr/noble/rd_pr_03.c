...
reset_room()
{
    ...
    leader->set_restrain_path(TZ_NOBLE);
    leader->set_monster_home(TZ_NOBLE+"rd_pr_03");
}
...
create_room()
{
    ...
    add_exit(TZ_NOBLE+"rd_pr_02.c", "north", "@@roof_message", 1);
    add_exit(TZ_NOBLE+"house8.c", "south", "@@block_exit@@", 1);

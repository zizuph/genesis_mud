...
create_room()
{
    ...
    add_exit(TZ_NOBLE+"rd_hr_06.c", "north", 0, 1);
    add_exit(TZ_MERCHANT+"ironsqr2.c", "east", 0, 1);
    add_exit(TZ_MERCHANT+"ironsqr4.c", "south", "@@block_exit@@", 1);
    add_exit(TZ_CARAVAN+"rd_cw_07.c", "west", 0, 1);
}

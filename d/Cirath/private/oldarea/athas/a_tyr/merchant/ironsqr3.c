...
create_room()
{
    ...
    add_exit(TZ_SLAVE+"rd_pe_01.c", "north", 0, 1);
    add_exit(TZ_SLAVE+"rd_tr_01.c", "east", 0, 1);
    add_exit(TZ_MERCHANT+"ironsqr5.c", "south", 0, 1);
    add_exit(TZ_MERCHANT+"housstel.c", "southwest", "@@house_block", 1);
    add_exit(TZ_MERCHANT+"ironsqr2.c", "west", 0, 1);
}

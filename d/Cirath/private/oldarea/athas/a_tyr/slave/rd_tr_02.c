...
create_room()
{
    ...
    add_exit(TZ_SLAVE+"rd_ds_04.c", "north", 0, 1); 
    add_exit(TZ_SLAVE+"rd_tr_03.c", "east", 0, 1);
    add_exit(TZ_SLAVE+"zgbuild1.c", "southeast", 0, 1);
    add_exit(TZ_SLAVE+"rd_tr_01.c", "west", 0, 1);
}

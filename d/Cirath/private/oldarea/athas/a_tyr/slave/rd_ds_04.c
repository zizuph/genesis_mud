...
reset_room()
{
    ...
    leader->set_restrain_path(TZ_SLAVE);
    leader->set_monster_home(TZ_SLAVE+"rd_ds_04");
}
...
create_room()
{
    ...
    add_exit(TZ_SLAVE+"rd_ds_03.c", "northwest", 0, 1);
    add_exit(TZ_SLAVE+"rd_tr_02.c", "south", 0, 1);

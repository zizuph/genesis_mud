...
void create_room()
{
    ...
    add_exit(TZ_CARAVAN+"spplmrch.c", "north", 0, 1);
    add_exit(TZ_CARAVAN+"rd_cw_03.c", "east", 0, 1);
    add_exit(TZ_CARAVAN+"dragoman.c", "south", 0, 1);
    add_exit(TZ_CARAVAN+"rd_cw_01.c", "west", 0, 1);
}

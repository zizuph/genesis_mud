...
reset_room()
{
    ...
    leader->set_restrain_path(({TZ_CARAVAN, TZ_MERCHANT}));
    leader->set_monster_home(TZ_CARAVAN+"rd_cw_04");
}
...
void create_room()
{
    ...
    add_exit(TZ_CARAVAN+"rd_cw_05.c", "east", 0, 1);
    add_exit(TZ_CARAVAN+"bonesmth.c", "south", 0, 1);
    add_exit(TZ_CARAVAN+"rd_cw_03.c", "west", 0, 1);

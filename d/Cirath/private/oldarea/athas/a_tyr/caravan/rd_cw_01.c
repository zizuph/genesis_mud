...
void create_room()
{
    ...
    add_exit(TZ_NOBLE+"rd_hr_01.c", "north", 0, 1);
    add_exit(TZ_CARAVAN+"rd_cw_02.c", "east", 0, 1);
    add_exit(TZ_WARREN+"rd_vr_04.c", "south", 0, 1);
    add_exit(TZ_GATES+"crvngate.c", "west", "@@gatepass", 1);
}

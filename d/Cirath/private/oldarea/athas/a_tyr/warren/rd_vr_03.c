...
void create_room()
{
    ...
    add_exit(TZ_WARREN+"rd_vr_04.c", "northwest", 0, 1);
    add_exit(TZ_WARREN+"hut5.c", "north", 0, 1);
    add_exit(TZ_WARREN+"rd_cw_06.c", "northeast", 0, 1);
    add_exit(TZ_WARREN+"hut4.c", "east", 0, 1);
    add_exit(TZ_WARREN+"rd_vr_02.c", "southeast", 0, 1);
}

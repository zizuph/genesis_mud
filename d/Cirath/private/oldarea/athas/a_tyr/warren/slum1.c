...
void reset_room()
{
    bring_room_mob ("akabarl", TYR_NPCS+"slumlord.c", 1, 1);
    bring_room_mob ("dweller", ATH_PERSON+"poor_mob.c", 1);
}
...
void create_room()
{
    ...
    add_exit(TZ_WARREN+"rd_vr_01.c", "southwest", 0, 1);
    add_exit(TZ_WARREN+"slum4.c", "north", 0, 1);
    add_exit(TZ_WARREN+"slum3.c", "east", 0, 1);
    add_exit(TZ_WARREN+"slum2.c", "south", 0, 1);

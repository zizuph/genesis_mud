...
create_monster()
{
   ...
   add_act("I have a really big needle.");
...
buy_pierce1(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce1");
   if (!buy_ob) {
...
buy_pierce2(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce2");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }
...
buy_pierce3(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce3");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }
...
buy_pierce4(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce4");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }
...
buy_pierce5(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce5");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }
...
buy_pierce6(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce6");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }
...
buy_pierce7(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce7");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }
...
buy_pierce8(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce8");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }
...
buy_pierce9(string str)
{
   ...
   buy_ob=clone_object("/d/Cirath/athas/a_tyr/pierce/obj/pierce9");
   if (!buy_ob) {
      notify_fail("I'm too tired to pierce you.\n");
      return 0;
   }

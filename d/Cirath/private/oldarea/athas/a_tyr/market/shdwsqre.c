...
create_room()
{
    ...
    add_exit(TZ_MARKET+"bardqrtr.c", "north", 0, 1);
    add_exit(TZ_MARKET+"rd_mr_03.c", "east", 0, 1);
    add_exit(TZ_MARKET+"shdwsqrs.c", "south", 0, 1);
    add_exit(TZ_MARKET+"elfmkt.c", "southwest", 0, 1);
    add_exit(TZ_MARKET+"shdwsqrw.c", "west", 0, 1);
    add_exit(TZ_MARKET+"shdwsqrn.c", "northwest", 0, 1);

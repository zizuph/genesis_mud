...
create_room()
{
    ...
    add_exit(TZ_MARKET+"bardqrtr.c", "east", 0, 1);
    add_exit(TZ_MARKET+"shdwsqre.c", "southeast", 0, 1);
    add_exit(TZ_MARKET+"shdwsqrw.c", "south", 0, 1);
    add_exit(TZ_MARKET+"rd_mr_05.c", "west", 0, 1);

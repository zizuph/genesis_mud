 /* /d/Cirath/athas/a_tyr/market/shdwsqrw.c
...
create_room()
{
  ...
  add_exit(TZ_MARKET+"shdwsqrn.c","north",0,1,0);
  add_exit(TZ_MARKET+"bdpnt.c","west","@@block_exit@@",1,0);
  add_exit(TZ_MARKET+"elfmkt.c","south",0,1,0);
  add_exit(TZ_MARKET+"shdwsqrs.c","southeast",0,1,0);
  add_exit(TZ_MARKET+"shdwsqre.c","east",0,1,0);
  add_exit(TZ_MARKET+"bardqrtr.c","northeast",0,1,0);

/*
 *  /d/Emerald/lib/gem_shop.c
 *
 *  This is the master Gem Shop to be inherited by Jewelers
 *  in Emerald.
 *
 *  Copied from /d/Gondor/common/lib/gem_shop by Olorin.
 *
...
inherit "/d/Emerald/telberin/lib/shop";
inherit "/lib/trade";
...
int
shop_hook_allow_sell(object ob)  /*If not a gem, don't take it*/
{
    if (!ob->query_gem())
    {
 ...
 * Description:   List an object other than a gem

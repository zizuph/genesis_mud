...
create_castle_room()
{
    set_em_long("This corridor runs straight through the residence. To "+
    ...
    add_exit("castle1_02", "south");
    add_exit("castle1_04", "north");
    add_exit("castle1_07", "east");
    add_exit("castle1_08", "west");
}

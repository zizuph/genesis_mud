...
create_castle_room()
{
    ...
    set_em_long("This is the male section of the Servant Quarters of "+
        "the castle. This room is long and full of small pallets. "+
   ...
   add_item(({"pillow", "pillow"}),
    ...
    add_item("walls",
        ...
        "cut and set.  The other wall makes the border for the next "+
        "room. It really thin and differs in quality to the other wall. "+
        "The wall was unevenly set across the room and you can hear the "+
        "light laugh of female servants coming across the other side.\n");
    ...
    add_door_exit(CASTLE_OBJ_DIR + "cdoor2_03", "castle2_13", "south");
}                                     

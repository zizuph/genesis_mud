...
create_west_avenue()
{
    ...
    set_em_long("This is the West Avenue of Telberin, which passes between "+
        "two of the city's famous gardens. The street is filled with soft "+
        "fragrances from the gardens. Traveling east takes you to the gates "+
        "of the Royal Palace and to the west you will find the west gate.\n");

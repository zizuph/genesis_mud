...
create_emerald_room()
{
    ...
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall5", "north");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall4", "northwest");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall7", "west");

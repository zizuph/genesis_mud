...
create_emerald_room()
{
    ...
    add_exit("/d/Emerald/telberin/arts/minstrel_guild", "north");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall7", "east");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall4", "northeast");
...
reset_room()
{
    if(!objectp(statue))
    {
        ...
        statue->set_muse_type("polyhymnia");

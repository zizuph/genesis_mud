...
create_emerald_room()
{
    ...
    add_exit("/d/Emerald/telberin/arts/minstrel_guild", "west");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall2", "north");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall5", "east");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall7", "south");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall1", "northwest");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall3", "northeast");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall8", "southeast");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall6", "southwest");

...
create_emerald_room()
{
    ...
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall2", "west");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall4", "southwest");
    add_exit("/d/Emerald/telberin/arts/minstrel_guild_hall5", "south");
...
reset_room()
{
    if(!objectp(statue))
    {
        ...
        statue->set_muse_type("terpsichore");

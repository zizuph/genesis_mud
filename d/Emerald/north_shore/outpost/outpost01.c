/*
 *  /d/Emerald/north_shore/outpost/outpost01.c
 *
...
{
    set_short("within the south entrance of the outpost complex");
    set_em_long("Standing within the southern entrance to this central"
      + " complex within the outpost, it is evident that this building"
      + " has not yet been breached by the raids which have ravaged"
      + " the rest of the fortress. This corridor runs to the north,"
    ...
    add_exit("outpost02" , "north");
    add_exit("gate02" , "south");
} /* create_outpost_inside_room */

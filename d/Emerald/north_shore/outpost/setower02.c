/*
 *  /d/Emerald/north_shore/outpost/setower02.c
 *
...
{
    set_short("within the southeastern guard tower of the outpost");
    ...
    add_item( ({ "guard tower", "tower", "southeastern tower",
                 "southeastern guard tower", "southeast tower",
                 "southeast guard tower" }), long);

/*
 *  /d/Emerald/north_shore/outpost/nwtower02.c
 *
...
{
    set_short("within the northwestern guard tower of the outpost");
    set_em_long("Though badly damaged, this guard tower still"
      ...
      + " shore. The courtyard is visible below and to the south."
      + " All around and above to the north are the dark colors"
      + " of the forest and eventual heights of the Blackwall"
      + " Mountains.\n");

    add_item( ({ "guard tower", "tower", "northwestern tower",
                 "northwestern guard tower", "northwest tower",
                 "northwest guard tower" }), long);

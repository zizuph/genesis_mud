/*
 * /d/Emerald/blackwall/delrimmon/lakeside/e_stairway.c
 *
...
create_del_rimmon()
{
    ...
    Extraline = "A stairway leads up to a landing in the rock wall"
              ...
              + " of rock. Just to the west, a pathway runs through"
    ...
    add_item( ({ "slot", "slots", "arrow slot", "arrow slots",
        ...
        "These are almost certainly arrow slots. Their narrow length"
    ...
    add_item( ({ "rock", "rock wall", "wall of rock", "rock walls",
                 ...
                 "sheer rock walls" }),
        "A great rock wall rises up to the east, towering over"
    ...
    add_item( ({ "pass", "mountain pass" }),
        "The pathway to the west is the only way in or out of the"
      + " area to the north.\n");
    add_item( ({ "path", "pathway", "west", "corridor",
                 "narrow corridor" }),
    ...
    add_exit(DELRIMMON_DIR + "lakeside/pathway2", "west");
    add_exit(DELRIMMON_DIR + "lakeside/east_overlook", "up", 0, 1, 1);

...
catch_tell(string msg)
{
    ...
    else if (strlen(msg) && (msg != "> "))
    {
        shadow_who->catch_tell("Some far off, distant place in your"
          + " mind is suddenly awakened: " + msg);
    }
...
catch_msg(mixed msg, object from_player)
{
    ...
    else if (pointerp(msg) || (msg != "> "))
    {
        trance_msg = "Some far off, distant place in your mind is suddenly awakened: ";
        if (pointerp(msg))
        {

/*
 *  /d/Emerald/blackwall/delrimmon/obj/wep/wr_sword.c
 *
 ...
 *
 *  Resurrected by Gorboth - Fall 2001. Original Coder: Mylos (?)
 */
inherit "/std/weapon";
inherit "/lib/keep";
...
create_weapon()
{
   ...
   set_long(break_string("This sword is old even for swords, the gleam "+
         "on its blade just showing traces of ancient runes.\n", 76));
   set_adj("spirit");
   ...
   add_prop(MAGIC_AM_MAGIC, ({ 30, "enchantment" }));
    add_prop(MAGIC_AM_ID_INFO, ({
        "You sense an aura of enchantment about this sword.\n", 1,
        "Clearly, there is a power within the sword which makes this"
      + " weapon valuable and powerful.\n", 25,
        "This sword was once carried by the worst evil of all, a wraith."
      + " Its spirit is still slightly imbued in the blade which you can"
      + " feel emanating into the hilt and into you.\n", 50 }) );
   add_prop(OBJ_S_WIZINFO,
        "This sword was originally wielded by wraiths in the old castle"
      + " of Telberin back when Mylos ruled Emerald. These days, an orc"
      + " captain wields it in the caves of Del Rimmon.\n");
}
...
summon_mist(mixed args)
{
   ...
   this_player()->catch_msg(CAP(colour) + " mist swirls around "
      + QTNAME(target) + ", and you nearly lose sight of "

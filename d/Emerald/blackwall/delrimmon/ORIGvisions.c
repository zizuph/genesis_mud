...
trigger_vision(object tp, string vision, string catalyst, object paralyze)
{
    ...
    switch(Tell_Stage)
    {
        case 0:
            ...
            break;
        case 2:
            tp->catch_msg("As your mind relaxes, your eyelids close.\n");
            break;
        case 3:
            tp->catch_msg("\n");
            break;
        case 4:
            tp->catch_msg("The feeling in your own body departs from"
        ...
        case 8:
            ...
            break;
        case 9:
            tp->catch_msg("Images and sounds begin to slowly unfold"
                        + " in your mind.\n");
            break;
        case 11:
            tp->catch_msg("\n");
...
vision_test(object tp, string catalyst, object paralyze)
{
    ...
    {
        case 1:
            tp->catch_tell("You drift slowly forward through"

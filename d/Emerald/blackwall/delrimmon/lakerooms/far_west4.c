...
create_nen_hithoel()
{
    ...
    add_exit("far_west3a", "north");
    set_distance("north", 1);
    add_exit("west3", "northeast");
    set_distance("northeast", 1);
    add_exit("west4", "east");
    set_distance("east", 1);
    add_exit("west5", "southeast");
    set_distance("southeast", 1);
    add_exit("far_west4a", "south");
    set_distance("south", 1);
    add_exit(DELRIMMON_DIR + "lakeside/w_shore2", "southwest");
    set_distance("southwest", 1);
    add_exit(DELRIMMON_DIR + "lakeside/w_shore3", "west");
    set_distance("west", 1);
    add_exit(DELRIMMON_DIR + "lakeside/w_shore4", "northwest");

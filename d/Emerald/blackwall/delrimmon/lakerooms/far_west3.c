...
create_nen_hithoel()
{
    ...
    add_exit(DELRIMMON_DIR + "lakeside/nw_shore2", "north");
    set_distance("north", 1);
    add_exit("far_west2", "northeast");
    set_distance("northeast", 1);
    add_exit("west3", "east");
    set_distance("east", 1);
    add_exit("west4", "southeast");
    set_distance("southeast", 1);
    add_exit("west4", "south");
    set_distance("south", 1);
    add_exit("far_west3a", "southwest");
    set_distance("southwest", 1);
    add_exit(DELRIMMON_DIR + "lakeside/w_shore5", "west");
    set_distance("west", 1);
    add_exit(DELRIMMON_DIR + "lakeside/nw_shore1", "northwest");

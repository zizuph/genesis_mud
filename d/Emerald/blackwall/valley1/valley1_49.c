...
create_valley_room()
{
    ...
    set_em_long("Within a sylvan forest. The forest is alive with life, "+
		...
		"are somehow aware of your presence...\n");
    
    add_item(({"animals", "small animals", "snakes", "squirrels",
		 "chipmunks", "birds"}),
    ...
    add_exit(BLACKWALL_VALLEY1_DIR + "valley1_48", "northwest", 0, 5);
    add_exit(BLACKWALL_VALLEY1_DIR + "valley1_50", "south", 0, 4);
}

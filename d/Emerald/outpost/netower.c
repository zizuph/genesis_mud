...
{
    set_short("In the northeastern tower.");
    set_em_long("You are inside the northeastern tower of the outpost. " +
    ...
    add_item( ({"tops", "pointed tops", "wooden wall", "wall"}),
        ...
        "You notice a set of gates built into the northern wall off to your west.\n");
    ...
    add_item( ({"hole"}),
        ...
        "Upon the west side of the hole, the top of a wooden ladder is secured " +
        "with steel brackets.\n");
    ...
    add_item( ({"ladder", "wooden ladder", "rungs", "steps" }),
        "A small, wooden ladder is secured to the west side of the hole. Each side of " +
    ...
    add_item( ({"gate" , "gates", "back gates", "northern gates", 
                "northern gate", "back gate"}),
        "Thick wooden gates stand in the middle of the northern wall. Reinforced with " +
        "steel, they look as though it would take a massive amount of force to open " +
        "them once they are closed.\n");

    
    add_exit("yard_03","down");
}

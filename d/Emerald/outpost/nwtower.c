...
create_outpost_inside_room()
{
    ...
    set_em_long("You are inside the northwestern tower of the outpost. " +
    ...
    add_item( ({"tops", "pointed tops", "wooden wall", "wall"}),
        ...
        "You notice a set of gates built into the northern wall off to your east.\n");

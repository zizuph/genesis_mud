...
{
    set_short("Outside the southwestern tower.");
    set_em_long("You are standing below a tower in the southwest corner " +
       ...
       "A rough wooden wall runs along the ground to your south and west, " +
       "forming the perimeter of the grounds. A ladder leads up to a hole " +
       "in the platform and a dirt path leads northeast towards the heart " +
       "of the camp.\n");

    add_item( ({"tower", "southwestern tower", "wooden tower" }),
        "You are directly below the floor of the tower. From this angle, " +
        "it is hard to see much other than the large logs which support " +
        "the building, one in each corner of the structure.\n");
    ...
    add_item( ({"platform", "wooden platform" }),
        ...
        "middle of the platform with a ladder securely fastened to the " +
        "east side of the hole.\n");
    ...
    add_exit("yard_10.c","northeast");
    add_exit("swtower.c","up");
} 

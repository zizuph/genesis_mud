...
create_outpost_outside_room()
{
    ...
    set_em_long("You are standing below a tower in the northwest corner " +
       ...
       "A rough wooden wall runs along the ground to your north and " +
       "west, forming the perimeter of the grounds. A ladder leads up " +
       "to a hole in the platform and a dirt path leads southeast " +
       "towards the heart of the camp.\n");

    add_item( ({"tower", "northwestern tower", "wooden tower" }),
        "You are directly below the floor of the tower. From this " +
        "angle, it is hard to see much other than the large logs " +
        "which support the building, one in each corner of the " +
        "structure.\n");
    ...
    add_item( ({"platform", "wooden platform" }),
        ...
        "fit tightly together. There is a square hole cut into the middle " +
        "of the platform with a ladder securely fastened to the east side " +
        "of the hole.\n");
    ...
    add_item( ({"wall", "wooden wall", "perimeter", "rough wooden wall" }),
        ...
        "a point making any attempted journey over the walls a very " +
        "costly one indeed.\n");
    ...
    add_item( ({"hole" }),
        ...
        "above. A ladder is fastened to the east side of the hole and " +
        "secured deep into the earth.\n");

    add_item( ({"ladder", "wooden ladder", "rungs", "steps" }),
        "A small, wooden ladder is secured to the east side of the hole. " +
    ...
    add_exit("yard_04.c","southeast");
    add_exit("nwtower.c","up");
} 

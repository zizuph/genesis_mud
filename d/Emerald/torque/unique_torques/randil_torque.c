/*
 *  /d/Emerald/torque/unique_torque/randil_torque.c
 *
 *  This is the torque bound to Randil, who lies buried in the
...
{
    set_name("torque");
    set_adj(({ "bright", "gold-layered", "crystal" }));
    set_short("bright gold-layered crystal torque");
} /* create_placed_torque */

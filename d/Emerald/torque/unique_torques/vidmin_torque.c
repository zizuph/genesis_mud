/*
 *  /d/Emerald/torque/unique_torque/vidmin_torque.c
 *
 *  This is the torque bound to Vidmin, who lies buried in the
...
{
    set_name("torque");
    set_adj(({ "intricate", "carefully-woven", "crystal" }));
    set_short("intricate carefully-woven crystal torque");
} /* create_placed_torque */

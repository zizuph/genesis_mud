/*
 *  /d/Emerald/torque/unique_torque/islin_torque.c
 *
 *  This is the torque bound to Islin, who lies buried in the
...
{
    set_name("torque");
    set_adj(({ "vibrant", "many-stoned", "crystal" }));
    set_short("vibrant many-stoned crystal torque");
} /* create_placed_torque */

/*
 *  /d/Emerald/torque/unique_torque/formandil_torque.c
 *
 *  This is the torque bound to Formandil, who lies buried in the
...
{
    set_name("torque");
    set_adj(({ "polished", "silver-set", "crystal" }));
    set_short("polished silver-set crystal torque");
} /* create_placed_torque */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_1x6.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_1x6");

    add_exit("trophy_1x7", "east");
    add_exit("trophy_2x7", "southeast");
    add_exit("trophy_2x6", "south");
    add_exit("trophy_2x5", "southwest");
    add_exit("trophy_1x5", "west");
} /* create_cave_room */

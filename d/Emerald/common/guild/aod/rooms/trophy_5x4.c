/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_5x4.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_5x4");

    add_exit("trophy_4x4", "north");
    add_exit("trophy_4x5", "northeast");
    add_exit("trophy_5x5", "east");
    add_exit("trophy_6x5", "southeast");
    add_exit("trophy_6x4", "south");
    add_exit("trophy_6x3", "southwest");
    add_exit("trophy_5x3", "west");
    add_exit("trophy_4x3", "northwest");
} /* create_cave_room */

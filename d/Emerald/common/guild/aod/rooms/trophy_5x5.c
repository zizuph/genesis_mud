/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_5x5.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_5x5");

    add_exit("trophy_4x5", "north");
    add_exit("trophy_4x6", "northeast");
    add_exit("trophy_5x6", "east");
    add_exit("trophy_6x6", "southeast");
    add_exit("trophy_6x5", "south");
    add_exit("trophy_6x4", "southwest");
    add_exit("trophy_5x4", "west");
    add_exit("trophy_4x4", "northwest");
} /* create_cave_room */

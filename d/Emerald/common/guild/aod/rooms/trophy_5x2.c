/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_5x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_5x2");

    add_exit("trophy_4x2", "north");
    add_exit("trophy_4x3", "northeast");
    add_exit("trophy_5x3", "east");
    add_exit("trophy_6x3", "southeast");
    add_exit("trophy_6x2", "south");
    add_exit("trophy_6x1", "southwest");
    add_exit("trophy_5x1", "west");
    add_exit("trophy_4x1", "northwest");
} /* create_cave_room */

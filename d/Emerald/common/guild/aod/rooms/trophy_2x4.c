/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x4.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x4");

    add_exit("trophy_1x4", "north");
    add_exit("trophy_1x5", "northeast");
    add_exit("trophy_2x5", "east");
    add_exit("trophy_3x5", "southeast");
    add_exit("trophy_3x4", "south");
    add_exit("trophy_3x3", "southwest");
    add_exit("trophy_2x3", "west");
    add_exit("trophy_1x3", "northwest");
} /* create_cave_room */

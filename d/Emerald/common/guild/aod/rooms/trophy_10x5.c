/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_10x5.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_10x5");

    add_exit("trophy_9x5", "north");
    add_exit("trophy_9x6", "northeast");
    add_exit("trophy_10x6", "east");
    add_exit("trophy_10x4", "west");
    add_exit("trophy_9x4", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_10x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_10x3");

    add_exit("trophy_9x3", "north");
    add_exit("trophy_9x4", "northeast");
    add_exit("trophy_10x4", "east");
    add_exit("trophy_10x2", "west");
    add_exit("trophy_9x2", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x1.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x1");

    add_exit("trophy_1x1", "north");
    add_exit("trophy_1x2", "northeast");
    add_exit("trophy_2x2", "east");
    add_exit("trophy_3x2", "southeast");
    add_exit("trophy_3x1", "south");
} /* create_cave_room */

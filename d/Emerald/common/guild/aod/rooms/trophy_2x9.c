/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x9.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x9");

    add_exit("trophy_1x9", "north");
    add_exit("trophy_1x10", "northeast");
    add_exit("trophy_2x10", "east");
    add_exit("trophy_3x10", "southeast");
    add_exit("trophy_3x9", "south");
    add_exit("trophy_3x8", "southwest");
    add_exit("trophy_2x8", "west");
    add_exit("trophy_1x8", "northwest");
} /* create_cave_room */

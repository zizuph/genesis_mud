/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_3x1.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_3x1");

    add_exit("trophy_2x1", "north");
    add_exit("trophy_2x2", "northeast");
    add_exit("trophy_3x2", "east");
    add_exit("trophy_4x2", "southeast");
    add_exit("trophy_4x1", "south");
} /* create_cave_room */

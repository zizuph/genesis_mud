/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x10.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x10");

    add_exit("trophy_1x10", "north");
    add_exit("trophy_3x10", "south");
    add_exit("trophy_3x9", "southwest");
    add_exit("trophy_2x9", "west");
    add_exit("trophy_1x9", "northwest");
} /* create_cave_room */

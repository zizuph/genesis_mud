/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_8x8.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_8x8");

    add_exit("trophy_7x8", "north");
    add_exit("trophy_7x9", "northeast");
    add_exit("trophy_8x9", "east");
    add_exit("trophy_9x9", "southeast");
    add_exit("trophy_9x8", "south");
    add_exit("trophy_9x7", "southwest");
    add_exit("trophy_8x7", "west");
    add_exit("trophy_7x7", "northwest");
} /* create_cave_room */

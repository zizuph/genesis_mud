/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x5.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x5");

    add_exit("trophy_1x5", "north");
    add_exit("trophy_1x6", "northeast");
    add_exit("trophy_2x6", "east");
    add_exit("trophy_3x6", "southeast");
    add_exit("trophy_3x5", "south");
    add_exit("trophy_3x4", "southwest");
    add_exit("trophy_2x4", "west");
    add_exit("trophy_1x4", "northwest");
} /* create_cave_room */

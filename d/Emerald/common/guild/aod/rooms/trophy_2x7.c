/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x7.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x7");

    add_exit("trophy_1x7", "north");
    add_exit("trophy_1x8", "northeast");
    add_exit("trophy_2x8", "east");
    add_exit("trophy_3x8", "southeast");
    add_exit("trophy_3x7", "south");
    add_exit("trophy_3x6", "southwest");
    add_exit("trophy_2x6", "west");
    add_exit("trophy_1x6", "northwest");
} /* create_cave_room */

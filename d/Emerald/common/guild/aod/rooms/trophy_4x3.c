/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_4x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_4x3");

    add_exit("trophy_3x3", "north");
    add_exit("trophy_3x4", "northeast");
    add_exit("trophy_4x4", "east");
    add_exit("trophy_5x4", "southeast");
    add_exit("trophy_5x3", "south");
    add_exit("trophy_5x2", "southwest");
    add_exit("trophy_4x2", "west");
    add_exit("trophy_3x2", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x3");

    add_exit("trophy_6x3", "north");
    add_exit("trophy_6x4", "northeast");
    add_exit("trophy_7x4", "east");
    add_exit("trophy_8x4", "southeast");
    add_exit("trophy_8x3", "south");
    add_exit("trophy_8x2", "southwest");
    add_exit("trophy_7x2", "west");
    add_exit("trophy_6x2", "northwest");
} /* create_cave_room */

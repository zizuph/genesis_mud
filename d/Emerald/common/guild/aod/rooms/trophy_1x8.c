/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_1x8.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_1x8");

    add_exit("trophy_1x9", "east");
    add_exit("trophy_2x9", "southeast");
    add_exit("trophy_2x8", "south");
    add_exit("trophy_2x7", "southwest");
    add_exit("trophy_1x7", "west");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_9x1.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_9x1");

    add_exit("trophy_8x1", "north");
    add_exit("trophy_8x2", "northeast");
    add_exit("trophy_9x2", "east");
    add_exit("trophy_10x2", "southeast");
    add_exit("trophy_10x1", "south");
} /* create_cave_room */

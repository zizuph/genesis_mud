/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_1x5.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_1x5");

    add_exit("trophy_1x6", "east");
    add_exit("trophy_2x6", "southeast");
    add_exit("trophy_2x5", "south");
    add_exit("trophy_2x4", "southwest");
    add_exit("trophy_1x4", "west");
} /* create_cave_room */

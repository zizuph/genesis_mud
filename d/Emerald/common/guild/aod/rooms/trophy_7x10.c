/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x10.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x10");

    add_exit("trophy_6x10", "north");
    add_exit("trophy_8x10", "south");
    add_exit("trophy_8x9", "southwest");
    add_exit("trophy_7x9", "west");
    add_exit("trophy_6x9", "northwest");
} /* create_cave_room */

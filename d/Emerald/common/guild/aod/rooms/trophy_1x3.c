/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_1x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_1x3");

    add_exit("trophy_1x4", "east");
    add_exit("trophy_2x4", "southeast");
    add_exit("trophy_2x3", "south");
    add_exit("trophy_2x2", "southwest");
    add_exit("trophy_1x2", "west");
} /* create_cave_room */

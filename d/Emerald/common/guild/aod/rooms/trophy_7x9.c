/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x9.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x9");

    add_exit("trophy_6x9", "north");
    add_exit("trophy_6x10", "northeast");
    add_exit("trophy_7x10", "east");
    add_exit("trophy_8x10", "southeast");
    add_exit("trophy_8x9", "south");
    add_exit("trophy_8x8", "southwest");
    add_exit("trophy_7x8", "west");
    add_exit("trophy_6x8", "northwest");
} /* create_cave_room */

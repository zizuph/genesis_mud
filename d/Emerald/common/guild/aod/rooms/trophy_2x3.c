/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x3");

    add_exit("trophy_1x3", "north");
    add_exit("trophy_1x4", "northeast");
    add_exit("trophy_2x4", "east");
    add_exit("trophy_3x4", "southeast");
    add_exit("trophy_3x3", "south");
    add_exit("trophy_3x2", "southwest");
    add_exit("trophy_2x2", "west");
    add_exit("trophy_1x2", "northwest");
} /* create_cave_room */

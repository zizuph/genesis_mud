/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_6x8.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_6x8");

    add_exit("trophy_5x8", "north");
    add_exit("trophy_5x9", "northeast");
    add_exit("trophy_6x9", "east");
    add_exit("trophy_7x9", "southeast");
    add_exit("trophy_7x8", "south");
    add_exit("trophy_7x7", "southwest");
    add_exit("trophy_6x7", "west");
    add_exit("trophy_5x7", "northwest");
} /* create_cave_room */

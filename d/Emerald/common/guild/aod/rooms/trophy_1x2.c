/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_1x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_1x2");

    add_exit("trophy_1x3", "east");
    add_exit("trophy_2x3", "southeast");
    add_exit("trophy_2x2", "south");
    add_exit("trophy_2x1", "southwest");
    add_exit("trophy_1x1", "west");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_5x10.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_5x10");

    add_exit("trophy_4x10", "north");
    add_exit("trophy_6x10", "south");
    add_exit("trophy_6x9", "southwest");
    add_exit("trophy_5x9", "west");
    add_exit("trophy_4x9", "northwest");
} /* create_cave_room */

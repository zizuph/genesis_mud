/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_2x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_2x2");

    add_exit("trophy_1x2", "north");
    add_exit("trophy_1x3", "northeast");
    add_exit("trophy_2x3", "east");
    add_exit("trophy_3x3", "southeast");
    add_exit("trophy_3x2", "south");
    add_exit("trophy_3x1", "southwest");
    add_exit("trophy_2x1", "west");
    add_exit("trophy_1x1", "northwest");
} /* create_cave_room */

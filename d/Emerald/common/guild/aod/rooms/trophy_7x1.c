/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x1.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x1");

    add_exit("trophy_6x1", "north");
    add_exit("trophy_6x2", "northeast");
    add_exit("trophy_7x2", "east");
    add_exit("trophy_8x2", "southeast");
    add_exit("trophy_8x1", "south");
} /* create_cave_room */

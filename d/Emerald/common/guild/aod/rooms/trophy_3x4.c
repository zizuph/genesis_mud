/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_3x4.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_3x4");

    add_exit("trophy_2x4", "north");
    add_exit("trophy_2x5", "northeast");
    add_exit("trophy_3x5", "east");
    add_exit("trophy_4x5", "southeast");
    add_exit("trophy_4x4", "south");
    add_exit("trophy_4x3", "southwest");
    add_exit("trophy_3x3", "west");
    add_exit("trophy_2x3", "northwest");
} /* create_cave_room */

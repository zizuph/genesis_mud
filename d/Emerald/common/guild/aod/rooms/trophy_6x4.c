/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_6x4.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_6x4");

    add_exit("trophy_5x4", "north");
    add_exit("trophy_5x5", "northeast");
    add_exit("trophy_6x5", "east");
    add_exit("trophy_7x5", "southeast");
    add_exit("trophy_7x4", "south");
    add_exit("trophy_7x3", "southwest");
    add_exit("trophy_6x3", "west");
    add_exit("trophy_5x3", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_9x4.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_9x4");

    add_exit("trophy_8x4", "north");
    add_exit("trophy_8x5", "northeast");
    add_exit("trophy_9x5", "east");
    add_exit("trophy_10x5", "southeast");
    add_exit("trophy_10x4", "south");
    add_exit("trophy_10x3", "southwest");
    add_exit("trophy_9x3", "west");
    add_exit("trophy_8x3", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_3x9.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_3x9");

    add_exit("trophy_2x9", "north");
    add_exit("trophy_2x10", "northeast");
    add_exit("trophy_3x10", "east");
    add_exit("trophy_4x10", "southeast");
    add_exit("trophy_4x9", "south");
    add_exit("trophy_4x8", "southwest");
    add_exit("trophy_3x8", "west");
    add_exit("trophy_2x8", "northwest");
} /* create_cave_room */

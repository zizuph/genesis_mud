/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_8x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_8x2");

    add_exit("trophy_7x2", "north");
    add_exit("trophy_7x3", "northeast");
    add_exit("trophy_8x3", "east");
    add_exit("trophy_9x3", "southeast");
    add_exit("trophy_9x2", "south");
    add_exit("trophy_9x1", "southwest");
    add_exit("trophy_8x1", "west");
    add_exit("trophy_7x1", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_4x10.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_4x10");

    add_exit("trophy_3x10", "north");
    add_exit("trophy_5x10", "south");
    add_exit("trophy_5x9", "southwest");
    add_exit("trophy_4x9", "west");
    add_exit("trophy_3x9", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_4x1.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_4x1");

    add_exit("trophy_3x1", "north");
    add_exit("trophy_3x2", "northeast");
    add_exit("trophy_4x2", "east");
    add_exit("trophy_5x2", "southeast");
    add_exit("trophy_5x1", "south");
} /* create_cave_room */

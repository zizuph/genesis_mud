/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_5x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_5x3");

    add_exit("trophy_4x3", "north");
    add_exit("trophy_4x4", "northeast");
    add_exit("trophy_5x4", "east");
    add_exit("trophy_6x4", "southeast");
    add_exit("trophy_6x3", "south");
    add_exit("trophy_6x2", "southwest");
    add_exit("trophy_5x2", "west");
    add_exit("trophy_4x2", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x8.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x8");

    add_exit("trophy_6x8", "north");
    add_exit("trophy_6x9", "northeast");
    add_exit("trophy_7x9", "east");
    add_exit("trophy_8x9", "southeast");
    add_exit("trophy_8x8", "south");
    add_exit("trophy_8x7", "southwest");
    add_exit("trophy_7x7", "west");
    add_exit("trophy_6x7", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x5.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x5");

    add_exit("trophy_6x5", "north");
    add_exit("trophy_6x6", "northeast");
    add_exit("trophy_7x6", "east");
    add_exit("trophy_8x6", "southeast");
    add_exit("trophy_8x5", "south");
    add_exit("trophy_8x4", "southwest");
    add_exit("trophy_7x4", "west");
    add_exit("trophy_6x4", "northwest");
} /* create_cave_room */

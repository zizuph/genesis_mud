/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_6x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_6x3");

    add_exit("trophy_5x3", "north");
    add_exit("trophy_5x4", "northeast");
    add_exit("trophy_6x4", "east");
    add_exit("trophy_7x4", "southeast");
    add_exit("trophy_7x3", "south");
    add_exit("trophy_7x2", "southwest");
    add_exit("trophy_6x2", "west");
    add_exit("trophy_5x2", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_5x9.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_5x9");

    add_exit("trophy_4x9", "north");
    add_exit("trophy_4x10", "northeast");
    add_exit("trophy_5x10", "east");
    add_exit("trophy_6x10", "southeast");
    add_exit("trophy_6x9", "south");
    add_exit("trophy_6x8", "southwest");
    add_exit("trophy_5x8", "west");
    add_exit("trophy_4x8", "northwest");
} /* create_cave_room */

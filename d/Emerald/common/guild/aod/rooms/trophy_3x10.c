/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_3x10.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_3x10");

    add_exit("trophy_2x10", "north");
    add_exit("trophy_4x10", "south");
    add_exit("trophy_4x9", "southwest");
    add_exit("trophy_3x9", "west");
    add_exit("trophy_2x9", "northwest");
} /* create_cave_room */

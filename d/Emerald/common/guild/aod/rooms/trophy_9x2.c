/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_9x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_9x2");

    add_exit("trophy_8x2", "north");
    add_exit("trophy_8x3", "northeast");
    add_exit("trophy_9x3", "east");
    add_exit("trophy_10x3", "southeast");
    add_exit("trophy_10x2", "south");
    add_exit("trophy_10x1", "southwest");
    add_exit("trophy_9x1", "west");
    add_exit("trophy_8x1", "northwest");
} /* create_cave_room */

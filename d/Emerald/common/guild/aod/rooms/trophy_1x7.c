/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_1x7.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_1x7");

    add_exit("trophy_1x8", "east");
    add_exit("trophy_2x8", "southeast");
    add_exit("trophy_2x7", "south");
    add_exit("trophy_2x6", "southwest");
    add_exit("trophy_1x6", "west");
} /* create_cave_room */

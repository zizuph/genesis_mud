/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x2");

    add_exit("trophy_6x2", "north");
    add_exit("trophy_6x3", "northeast");
    add_exit("trophy_7x3", "east");
    add_exit("trophy_8x3", "southeast");
    add_exit("trophy_8x2", "south");
    add_exit("trophy_8x1", "southwest");
    add_exit("trophy_7x1", "west");
    add_exit("trophy_6x1", "northwest");
} /* create_cave_room */

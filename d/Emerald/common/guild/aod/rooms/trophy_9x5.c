/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_9x5.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_9x5");

    add_exit("trophy_8x5", "north");
    add_exit("trophy_8x6", "northeast");
    add_exit("trophy_9x6", "east");
    add_exit("trophy_10x6", "southeast");
    add_exit("trophy_10x5", "south");
    add_exit("trophy_10x4", "southwest");
    add_exit("trophy_9x4", "west");
    add_exit("trophy_8x4", "northwest");
} /* create_cave_room */

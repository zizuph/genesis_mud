/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_3x6.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_3x6");

    add_exit("trophy_2x6", "north");
    add_exit("trophy_2x7", "northeast");
    add_exit("trophy_3x7", "east");
    add_exit("trophy_4x7", "southeast");
    add_exit("trophy_4x6", "south");
    add_exit("trophy_4x5", "southwest");
    add_exit("trophy_3x5", "west");
    add_exit("trophy_2x5", "northwest");
} /* create_cave_room */

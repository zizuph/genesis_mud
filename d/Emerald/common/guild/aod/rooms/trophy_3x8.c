/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_3x8.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_3x8");

    add_exit("trophy_2x8", "north");
    add_exit("trophy_2x9", "northeast");
    add_exit("trophy_3x9", "east");
    add_exit("trophy_4x9", "southeast");
    add_exit("trophy_4x8", "south");
    add_exit("trophy_4x7", "southwest");
    add_exit("trophy_3x7", "west");
    add_exit("trophy_2x7", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_1x4.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_1x4");

    add_exit("trophy_1x5", "east");
    add_exit("trophy_2x5", "southeast");
    add_exit("trophy_2x4", "south");
    add_exit("trophy_2x3", "southwest");
    add_exit("trophy_1x3", "west");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_4x7.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_4x7");

    add_exit("trophy_3x7", "north");
    add_exit("trophy_3x8", "northeast");
    add_exit("trophy_4x8", "east");
    add_exit("trophy_5x8", "southeast");
    add_exit("trophy_5x7", "south");
    add_exit("trophy_5x6", "southwest");
    add_exit("trophy_4x6", "west");
    add_exit("trophy_3x6", "northwest");
} /* create_cave_room */

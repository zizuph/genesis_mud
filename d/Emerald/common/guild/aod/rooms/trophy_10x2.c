/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_10x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_10x2");

    add_exit("trophy_9x2", "north");
    add_exit("trophy_9x3", "northeast");
    add_exit("trophy_10x3", "east");
    add_exit("trophy_10x1", "west");
    add_exit("trophy_9x1", "northwest");
} /* create_cave_room */

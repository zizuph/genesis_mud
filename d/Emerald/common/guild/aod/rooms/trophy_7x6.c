/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x6.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x6");

    add_exit("trophy_6x6", "north");
    add_exit("trophy_6x7", "northeast");
    add_exit("trophy_7x7", "east");
    add_exit("trophy_8x7", "southeast");
    add_exit("trophy_8x6", "south");
    add_exit("trophy_8x5", "southwest");
    add_exit("trophy_7x5", "west");
    add_exit("trophy_6x5", "northwest");
} /* create_cave_room */

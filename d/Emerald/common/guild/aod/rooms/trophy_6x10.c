/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_6x10.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_6x10");

    add_exit("trophy_5x10", "north");
    add_exit("trophy_7x10", "south");
    add_exit("trophy_7x9", "southwest");
    add_exit("trophy_6x9", "west");
    add_exit("trophy_5x9", "northwest");
} /* create_cave_room */

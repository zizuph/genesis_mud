/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_6x7.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_6x7");

    add_exit("trophy_5x7", "north");
    add_exit("trophy_5x8", "northeast");
    add_exit("trophy_6x8", "east");
    add_exit("trophy_7x8", "southeast");
    add_exit("trophy_7x7", "south");
    add_exit("trophy_7x6", "southwest");
    add_exit("trophy_6x6", "west");
    add_exit("trophy_5x6", "northwest");
} /* create_cave_room */

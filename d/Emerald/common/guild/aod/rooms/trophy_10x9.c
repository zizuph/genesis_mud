/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_10x9.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_10x9");

    add_exit("trophy_9x9", "north");
    add_exit("trophy_9x10", "northeast");
    add_exit("trophy_10x10", "east");
    add_exit("trophy_10x8", "west");
    add_exit("trophy_9x8", "northwest");
} /* create_cave_room */

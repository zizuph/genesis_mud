/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_4x2.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_4x2");

    add_exit("trophy_3x2", "north");
    add_exit("trophy_3x3", "northeast");
    add_exit("trophy_4x3", "east");
    add_exit("trophy_5x3", "southeast");
    add_exit("trophy_5x2", "south");
    add_exit("trophy_5x1", "southwest");
    add_exit("trophy_4x1", "west");
    add_exit("trophy_3x1", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_10x7.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_10x7");

    add_exit("trophy_9x7", "north");
    add_exit("trophy_9x8", "northeast");
    add_exit("trophy_10x8", "east");
    add_exit("magma", "south");
    add_exit("trophy_10x6", "west");
    add_exit("trophy_9x6", "northwest");
} /* create_cave_room */

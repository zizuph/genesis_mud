/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_9x7.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_9x7");

    add_exit("trophy_8x7", "north");
    add_exit("trophy_8x8", "northeast");
    add_exit("trophy_9x8", "east");
    add_exit("trophy_10x8", "southeast");
    add_exit("trophy_10x7", "south");
    add_exit("trophy_10x6", "southwest");
    add_exit("trophy_9x6", "west");
    add_exit("trophy_8x6", "northwest");
} /* create_cave_room */

/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_8x3.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_8x3");

    add_exit("trophy_7x3", "north");
    add_exit("trophy_7x4", "northeast");
    add_exit("trophy_8x4", "east");
    add_exit("trophy_9x4", "southeast");
    add_exit("trophy_9x3", "south");
    add_exit("trophy_9x2", "southwest");
    add_exit("trophy_8x2", "west");
    add_exit("trophy_7x2", "northwest");
} /* create_cave_room */

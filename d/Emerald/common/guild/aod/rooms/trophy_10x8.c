/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_10x8.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_10x8");

    add_exit("trophy_9x8", "north");
    add_exit("trophy_9x9", "northeast");
    add_exit("trophy_10x9", "east");
    add_exit("trophy_10x7", "west");
    add_exit("trophy_9x7", "northwest");
} /* create_cave_room */

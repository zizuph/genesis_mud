/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_9x6.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_9x6");

    add_exit("trophy_8x6", "north");
    add_exit("trophy_8x7", "northeast");
    add_exit("trophy_9x7", "east");
    add_exit("trophy_10x7", "southeast");
    add_exit("trophy_10x6", "south");
    add_exit("trophy_10x5", "southwest");
    add_exit("trophy_9x5", "west");
    add_exit("trophy_8x5", "northwest");
} /* create_cave_room */

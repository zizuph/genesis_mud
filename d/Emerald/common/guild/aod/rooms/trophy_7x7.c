/*
 *  /d/Emerald/common/guild/aod/rooms/trophy_7x7.c
 *
...
create_cave_room()
{
    ...
    add_spike("trophy_7x7");

    add_exit("trophy_6x7", "north");
    add_exit("trophy_6x8", "northeast");
    add_exit("trophy_7x8", "east");
    add_exit("trophy_8x8", "southeast");
    add_exit("trophy_8x7", "south");
    add_exit("trophy_8x6", "southwest");
    add_exit("trophy_7x6", "west");
    add_exit("trophy_6x6", "northwest");
} /* create_cave_room */

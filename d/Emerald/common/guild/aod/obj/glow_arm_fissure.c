/*
 *  /d/Emerald/common/guild/aod/obj/glow_arm_fissure.c
 * 
 *  This fissure is where glowing armours are stored in the Army of
 *  Darkness guild.
 *
...
create_container()
{
    ...
    set_adj( ({ "deep" }) );
    set_long("A deep fissure has opened in the ground just beside the"
      + " switchbacks here. A bit of strange purple energy seems to"
      + " hover over it.\n");

...
#define GUILD_NAME          "Vampire Coven"
...
#define EMBRACE_ROOM    (VAMP_SHADOW_DIR + "embrace_room")
...
#define VAMP_I_VS_POWER    "_vamp_i_vs_power"
...
// Max / Base Power Offset (Generation 1 vamps)
#define MAX_POWER_OFFSET   35
#define MIN_POWER_OFFSET    0
#define POWER_MULTIPLIER    3
// Generate the new Power Offset for sired vamps.
#define CALC_POWER_OFFSET  max(MIN_POWER_OFFSET, \
	MAX_POWER_OFFSET - (POWER_MULTIPLIER * query_vamp_generation()))

#define UNSEEN_SUBLOC  "_vunseen_subloc"
#define VAURA_SUBLOC   "_vaura_subloc"
#define EM_DARKNESS_SUBLOC "_em_darkness_subloc"
#endif

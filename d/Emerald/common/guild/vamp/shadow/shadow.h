...
string      query_sire();
string      show_unseen_subloc(object carrier, object for_obj);
string     show_darkness_subloc(object carrier, object for_obj);

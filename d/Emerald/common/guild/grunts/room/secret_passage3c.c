...
create_room()
{
    ...
    set_long(
        "   The passage leads on. It is nice to have the torches on the walls " +
        "of the cave, as otherwise it would probably be quite dark. The " +
        "passage seems very straight, and was obviously not formed by " +
       "nature. The passage carries on further to the southwest.\n\n");

    add_prop(ROOM_I_INSIDE, 1);
    add_exit(THIS_DIR + "secret_passage4c", "northeast", 0, 1);
    add_exit(THIS_DIR + "secret_passage2c", "southwest", 0, 1);

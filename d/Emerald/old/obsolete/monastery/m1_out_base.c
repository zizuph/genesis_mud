...
add_garden()
{
    set_short("In the garden");
    set_em_long("This large garden at the center of the courtyard is now " +
        "neglected and filled with weeds.  The area is clearly not " +
        "abandoned, though, as many of the plants appear to be freshly " +
        "trampled or uprooted.\n");
}

void
add_walkway()
{
    set_short("On the ground-level walkway");
    set_em_long("This wide, stone walkway skirts the edge of the garden, " +
        "which encompasses most of the large courtyard, and is bordered " +
        "by the monastery walls on the opposite side.  It appears that " +
        "the walkway encircles the garden completely.\n");
}

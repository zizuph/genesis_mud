...
{
    set_short("Southern section of the outpost.");
    set_em_long("You are standing on a dirt path in the middle of the " +
       "southern sections of the outpost. The center of the camp can be " +
       "reached by following the path towards the north where a large " +
    ...
    add_item( ({"tower", "towers", "watchtowers", "watchtower"}),
        "A tall watchtower rises up in just north of you in the middle " +
    ...
    add_exit("yard_08.c","north");
    add_exit("yard_14.c","south");
    add_exit("yard_12.c","east");
    add_exit("yard_10.c","west");

...
create_outpost_outside_room()
{
    ...
    set_em_long("You are standing on a dirt path in the southern section " +
       ...
       "to the northeast, the west and the southwest.\n");
    ...
    add_exit("yard_11.c","west");
    add_exit("yard_08.c","northwest");
    add_exit("yard_09.c","northeast");
    add_exit("yard_14.c","southwest");
    add_exit("yard_15.c","southeast");

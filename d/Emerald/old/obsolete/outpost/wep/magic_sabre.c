...
create_weapon()
{
    ...
    set_long("This thin sabre looks to made of steel, " +
        "however upon closer inspection the blade has a green tint to " +
        "it. The shine of the blade seems to go to the core of the sword. Almost as " +
        "if no matter how much damage this sword takes, it will never lose " +
        "its freshly polished luster. You notice fine runes engraved along the " +
        "flat of the blade. The hilt is made of mithril, wrapped in white " +
        "leather, and bound with gold wire.\n");
    set_hit(40);
    set_pen(35);
    set_wt(W_SWORD);
    ...
    add_prop(OBJ_S_WIZINFO, "This sword is an any handed 40/35 " +
        ...
        "damamge. You must have a sowrd skill of 55 or higher to use it.\n");
...
wield(object what)
{
    ...
    { 
        write("The sabre seems awkward and heavy in your grasp. You don't feel " +
            "as though you have the skill to use this blade.\n");
        return -1;
    }
  
    write("As you wrap your hands around the soft leather hilt, you " +
        "feel contentment. You like wielding this blade.\n");

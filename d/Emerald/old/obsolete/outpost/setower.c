...
{
    set_short("In the southeastern tower.");
    set_em_long("You are inside the southeastern tower of the outpost. " +
    ...
    add_item( ({"tops", "pointed tops", "wooden wall", "wall"}),
        ...
        "You notice a set of gates built into the southern wall off to your west.\n");

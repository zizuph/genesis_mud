...
create_guard() 
{
    ...
    set_act_time(5);
    add_act("emote stares into your eyes, gauging your abilities.");
...
arm_me()
{
    ...
    add_equipment(OUTPOST_ARM_DIR + "cgreaves");
    add_equipment(OUTPOST_ARM_DIR + "cbracers");
    add_equipment(OUTPOST_ARM_DIR + "lhelm");
}

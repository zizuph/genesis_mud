...
{
    set_short("Outside the northeastern tower.");
    set_em_long("You are standing below a tower in the northeast corner " +
       "of the outpost. The wooden platform which forms the base of the " +
       "tower stands above your head supported by large logs and " +
       "stones. A rough wooden wall runs along the ground to your north " +
       "and east, forming the perimeter of the grounds. A ladder leads " +
       "up to a hole in the platform and a dirt path leads southwest " +
       "towards the heart of the camp.\n");

    add_item( ({"tower", "northeastern tower", "wooden tower" }),
    ...
    add_item( ({"platform", "wooden platform" }),
        ...
        "of the platform with a ladder securely fastened to the west side " +
        "of the hole.\n");
    ...
    add_exit("yard_06.c","southwest");
    add_exit("netower.c","up");
} 

...
{
    set_short("Inside the gates of the elven Outpost");
    set_em_long("You are now standing inside the gates of the elven outpost. " +
        ...
        "north looms a large octagonal building sitting in the center of " +
        "the outpost.\n");

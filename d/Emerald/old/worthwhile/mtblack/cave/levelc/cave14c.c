...
create_room()
{
    ...
    set_long("   "+
        ...
        "It would appear that none of the exits are too appealing,  " +
        "except for the one you first entered here from.\n\n");
    ...
    add_exit(THIS_DIR+"cave11c", "south", 0, 1);
    add_exit(THIS_DIR+"cave17c", "northwest", 0, 1);
    add_exit(THIS_DIR+"cave18c", "northeast", 0, 1);
}

...
create_room()
{
    ...
    set_long("   "+
        "This tunnel leads further on into the darkness. " +
        "It seems a long time since you last saw daylight, and maybe " +
        "the thought of fresh air and sunshine will make you consider " +
        "getting out of this nasty place.\n\n");
    ...
    add_exit(THIS_DIR+"cave18c", "west", 0, 1);
    add_exit(THIS_DIR+"cave20c", "east", 0, 1);

...
create_room()
{
    ...
    set_long("   " +
        "The way up looks very inviting compared to the way north. " +
        "You can certainly sense the odour of Ogres nearby. " +
        "Ogres are not the most welcoming hosts, so perhaps you " +
        "should seriously consider how much safer it would be to go back " +
        "up and out of these caves.\n\n");
    ...
    add_exit(THIS_DIR+"cave4c", "north", 0, 1);
    add_exit(CAVE_DIR+"levelb/cave17b", "up", 0, 1);
}

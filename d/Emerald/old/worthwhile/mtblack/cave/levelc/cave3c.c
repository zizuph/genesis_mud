...
create_room()
{
    ...
    set_long("   "+
        "This cave seems to be a bit wider for some reason. " +
        "You wonder exactly how deep underground you are at the moment. " +
        "Well, it doesn't matter as long as you can remember the way " +
        "back, surely. The smell of Ogres is quite strong in here. " +
        "You might come across one just around the corner.\n\n");
    ...
    add_exit(THIS_DIR+"cave6c", "northwest", 0, 1);
    add_exit(THIS_DIR+"cave4c", "east", 0, 1);
}

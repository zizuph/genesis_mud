...
create_room()
{
    ...
    set_long("   " +
        "This cave branches off into another two directions here. " +
        "The safest one to take would be the one heading south. Which " +
        "takes you back the way you came in, of course. " +
        "Maybe these dark places do not suit you. Mind you, " +
        "they certainly seem to suit the resident Ogre population.\n\n");
    ...
    add_exit(THIS_DIR+"cave7c", "northeast", 0, 1);
    add_exit(THIS_DIR+"cave3c", "west", 0, 1);
    add_exit(THIS_DIR+"cave1c", "south", 0, 1);

...
create_room()
{
    ...
    set_long("   " +
        ...
        "There is some lichen growing in various places. " +
       "You wonder what might be lurking in the shadows.\n\n");
    ...
    add_exit(THIS_DIR+"entrance", "west", 0, 1);
    add_exit(THIS_DIR+"cave8a", "north", 0, 1);
}

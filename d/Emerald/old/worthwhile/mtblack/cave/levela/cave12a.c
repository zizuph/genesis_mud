...
create_room()
{
    ...
    set_long("   " +
        "Coming into this part of the cave would appear to have been " +
        "a waste of time. There is nothing here except the cold damp walls. " +
    ...
    add_exit(THIS_DIR+"cave11a", "west", 0, 1);
}

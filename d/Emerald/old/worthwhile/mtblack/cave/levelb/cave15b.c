...
create_room()
{
    ...
    set_short("This is a very dark place. " +
        "You have entered a large cavern");
    set_long("   " +
        "You have entered a large cavern. Because of the darkness, " +
        "however, you cannot see all of it. In fact there is very " +
        "little of it that you can see. You must be quite a long way " +
    ...
    add_exit(THIS_DIR+"cave17b.c", "north", 0, 1);
    add_exit(THIS_DIR+"cave14b", "south", 0, 1);
}

...
create_room()
{
    ...
    set_short("This cave has puddles on the floor with ice covering them");    
    set_long("   " +
        "There are large puddles in this room, but these ones have " +
        "a large covering of ice over them. Even the walls have ice " +
        "starting to form on them, and icicles hang from the ceiling. " +
        "The cave seems to get colder towards the northeast corner" +
        " of the cave.\n\n");
    ...
    add_exit(THIS_DIR+"cave6b", "west", 0, 1);
    add_exit(THIS_DIR+"cave10b", "northeast", 0, 1);
}

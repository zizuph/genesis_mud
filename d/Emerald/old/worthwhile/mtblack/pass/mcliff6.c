/* mcliff6.c the southern cliff of Mt. Black*/
...
#define UP_ROOM MBLACK_DIR + "pass/mcliff7"
#define DOWN_ROOM MBLACK_DIR + "pass/mcliff5"
...
{
	set_short("Niche");
	add_my_desc("You squeeze into a small niche barely wide enough "+
		"for you and cling to to the walls while you rest.\n\n");

/* mcliff5.c the southern cliff of Mt. Black*/
...
#define UP_ROOM MBLACK_DIR + "pass/mcliff6"
#define DOWN_ROOM MBLACK_DIR + "pass/mb21"
...
{
	set_short("Cleft");
	add_my_desc("You find a cleft to rest on before you continue "+
		"your climb.\n\n");

...
#define UP_ROOM MBLACK_DIR + "/pass/mcliff5.c"
...
create_path()
{
	...
	add_item(({"cliffs", "black cliffs"}), "As you look toward the "+
	...
	add_exit(MBLACK_DIR + "pass/mb23", "northwest",0,0);	

...
create_castle_room()
{
    ...
    set_short("The Foyer");
    set_em_long("The foyer is a wide, high-ceiling, receiving room. This "+
    ...
    add_item(({"mystical animals", "animals"}),
        "There are five mystical animals represented in the stained-glass "+
        "windows. On the left wall, there is an unicorn and a "+

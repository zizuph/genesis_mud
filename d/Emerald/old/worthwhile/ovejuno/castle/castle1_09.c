...
create_castle_room()
{
    ...
    set_em_long("This is the library of this residence. Rows upon "+
    ...
    add_rugs("They are plaid in color, with green, red, yellow and orange " +
        "all weave together to give a lively look to this room.");

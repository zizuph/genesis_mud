...
wield(object to)
{
    if((this_player()->query_race() == "elf") || ( this_player()->query_race() ==
						   "half-elf"))
    {
	this_object()->set_hit(39);
	this_object()->set_pen(35);
	this_player()->catch_msg("As you wrap your hand around the hilt of "+
    ...
    {
	this_object()->set_hit(35);
	this_object()->set_pen(29);
	return ::wield();
    }
    return 1;
}

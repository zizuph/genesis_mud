...
/*  pouch1.c is cloned by various thiefs in thief_lair/npc/ */
...
create_container()
{
    ...
    set_adj("money");
    add_adj("leather");
    set_long("It's a handy leather money pouch.\n");
    ...
    if (IS_CLONE)
    {
    cop=MONEY_MAKE_CC(random(50)+50);
    cop->move(this_object());
 
    sil=MONEY_MAKE_SC(random(15)+5);

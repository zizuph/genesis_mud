...
create_armour()
{
    ...
    set_long(break_string("It is a heraldic shield. It was not designed for "  
        ...
        + "symbol best described as a five toothed comb with the a tooth "
        + "at either end missing, superimposed above it. "
        + "You feel the urge to return it "
...
query_recover()
{
    return "/d/Emerald/tulix/heraldry/hqshield1" + ":" +
        query_arm_recover();
}

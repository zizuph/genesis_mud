...
string query_rank()
{
    switch(TP->query_rider_level())
    {
        ...
        break;
        case 5:
        return "a silver collar, with gold studs";
        break;
        case 6:
        return "a golden collar, with platinum studs";
        break;
        case 7:
        return "an exsquisite platinum collar, studded with saphires";
        break;
        case 8:

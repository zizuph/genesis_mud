...
create_monster()
{
   ...
   "horse, or mabye because it's fangs are half a foot long, but something "+
   ...
   set_stuffed(5000); /* Fill up on creation */
}
public void
init_living()
{
...
do_mount(string str)
{
    ...
    "with fierce blood-shot eyes. "+QCTNAME(TP)+" is riding it.\n");
    return 1;
}

...
create_castle_room()
{
    ...
    set_long("This is the female section of the Servant Quarters of the "+
        "castle. This room is long and full of small beds. "+
    ...
    add_item("quarters",
        "The quarters are definetely female. They are neat and cheerful, "+
        "with coquetish decorations. Although there is not much space in this "+
        "room, it looks cozy and warm. A tall and wide closet cover all "+
        "wall at the bottom of the room. Some of the chambermaids are"+
        "are sitting on the beds chatting happily.\n"); 

...
create_castle_room()
{
    ...
    set_long("This corridor goes straight through the residence. To "+
    ...
    add_exit("castle1_01.c", "south");
    add_exit("castle1_03.c", "north");
    add_exit("castle1_05.c", "east");
    add_exit("castle1_06.c", "west");

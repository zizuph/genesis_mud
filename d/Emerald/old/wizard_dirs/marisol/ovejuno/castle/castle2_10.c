...
create_castle_room()
{
    ...
    set_long("This is the private room of the Head Chambermaid of the "+
        "castle. Here the decoration of the room are not only definetely "+
        "human but feminine. Nice sheep hides serve as rugs. A charming "+
        "bureau is set besides a small bed. A closet stands on one of the "+
        "walls. A small window faces west. Torches and candle-holders "+
        "are arranged craftily to provide light to the small "+
        "room.\n");
    ...
    add_item(({"small bed", "bed"}),
        ...
        "person on it. A soft mattress stands on top of wooden bed. White "+
        "clean sheets cover it and one big pillow rests at the top of "+
        "the mattress.\n");

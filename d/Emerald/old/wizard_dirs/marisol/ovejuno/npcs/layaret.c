...
create_elf()
{
    ::create_elf();
    set_name("layaret");
    set_living_name("layaret");
    set_title("Captain of the Guards of the Telbarion's palace");
    set_adj("stern");
    set_adj("strong");
    set_race_name("elf");
    set_gender(G_MALE);
    set_appearance_offset(-30);
    set_long("A stern, strong-looking elf. His face is serious and "+
        "there is a feel of menace around his body. This is someone "+
        "you would not want to cross.\n");

    set_stats(({95, 95, 105, 65, 65, 98}));
    ...
    set_act_time(50);
    add_act("emote frown worrily as he scans the room.");

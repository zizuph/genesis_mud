...
#include "/d/Emerald/marisol/ovejuno/village_OV/pastures/ptells.h"
#include "/d/Emerald/sys/terrain_types.h"
#include "/d/Emerald/sys/properties.h"
#define PASTURES_HERBS ({ \
...
#define PASTURES_LOCATIONS ({"here", "ground"})
...
create_emerald_room()
{
    ...
    set_up_herbs((this_object()->select_herb_files(PASTURES_HERBS)),
    PASTURES_LOCATIONS, 3);

    set_tell_time(100);
    for(i = 0; i < 4; i++)
    {
       add_tell(PTELLS[random(sizeof(PTELLS))]);
    }

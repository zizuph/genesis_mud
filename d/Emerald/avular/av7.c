/*
 * AV7.c
 * Exits underneath the snake bridge to av6
 * - Alaron FEB 2000
 */
...
create_avular_room()
{
    ...
    set_em_long("The narrow, black street descends down a steep slope to the "+
        "north. At the bottom of the slope, an enormous stone-carved bridge arches "+
        "up over the road. The huge bridge is  an arching, twisting "+
        ...
        "obscures the road to the north of the bridge and south of here. Through the "+
        "blackness to the south, you can barely make out the dark form of another "+
        "bridge.\n");
    ...
    add_item( ({"bridge", "snake", "serpent", "sculpture", "serpent bridge",
        "snake bridge" }),
        "The bridge to the north is frightening, disturbing, and a marvel of "+
    ...
    add_item( ({"south bridge", "bridge to south", "other bridge", "southern bridge"}),
        "You can barely distinguish the shape of the bridge to the south through the "+
        "thick blackness surrounding you. The darkness is so thick here you would "+
        "probably need to be standing right on the bridge to see it.\n");

    add_exit(AVMAIN+"av6", "north", "@@go_under@@");
    add_exit(AVMAIN+"av8", "south");
}

...
config_shelf(string where)
{
    ...
    shelf = clone_object(MIST_TOWER_DIR + "obj/shelf");
...
create_tower_room()
{
    ...
    set_em_long("Dark and cramped walls form a square alcove here, which"
              + " seems to provide some sort of storage space within"
              + " the tower. Cobwebs and dust run heavily along the"
    ...
    add_item( ({ "wall", "walls" }),
        "The walls here are angular and squared, much unlike many other"
      + " parts of the tower. They are covered in many places with"
      + " cobwebs and dust.\n");
    add_item( ({ "cobwebs", "web", "cobweb", "webs" }),
        "These cobwebs are thickly netted over large portions of the"
      + " wall. They lilt and stir slightly with the occasional breeze.\n");
    add_item( ({ "dust" }),

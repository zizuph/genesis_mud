 ...
 * Olorin, 30-may-1995
 * Modified to a leather dufflebag for the Cove shop.
 * Vladimir, 8 August 1995
 */
...
#define BACKPACK_SUBLOC  "_traveller_backpack"
...
create_backpack()
{
    ...
    set_pshort("dufflebags");

    set_backpack_long("It is made of dark brown leather and has two straps that "+
            "allow you to wear it on your back. You feel that it could "+
            "hold a large amount of items.\n");
}
...
{
  environment()->update_light(light(), 0, 0);
  return 0;
}
...
wear(string str)
{
    ...
    {
       NF("You already wear another dufflebag!\n");
       return 0;
    }

...
create_forest()
{
    ...
    set_long("   The normally thick layer of mist seems to thin out here. The fog still "+
	     ...
	     "grayness of the rest of the forest. The south and southeast edges of "+
             "the clearing are bordered by a tremendous cliff face. The face is completely "+
	     "flat, and unnaturally smooth. The thick fog fades as it drifts toward the "+
	     "cliff face, allowing a faint trickle of sunlight to filter through, casting "+
	     "warm, welcome light on the hard granite of the cliff.\n\n");

    add_item( ({"cliff", "cliff face", "face", "granite"}),
	     "The face of the cliff is extremely impressive. The faint glow of daylight "+
	     "which trickles in from a gap in the fog above illuminates just enough of "+
	     "the rock to show that it is very flat, and seems unnaturally smooth. You "+
    ...
    add_fexit(CORAMAR+"f63", "northwest", 0);

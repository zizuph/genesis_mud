...
create_forest()
{
	...
	"shades of green appears impenetrable to the naked eye. Jutting out from the "+
	"huge wall of bushes, vines and other interesting plant life are two huge "+
	"walls of more vegetation, each coming to a point a bit above your head. The "+
	"two walls form a rustling path leading east as the wind gently blows through "+
	"the area.\n\n");
    ...
    add_exit(CORAMAR+"f36", "east", 0);
    add_exit(CORAMAR+"f34", "west", 1);
}
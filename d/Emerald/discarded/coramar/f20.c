...
create_forest()
{
    ...
    set_long("   The forest is so overgrown here that no light can get "+
             ...
             "the dark tunnel of trees very difficult. To the northeast, you "+
	     "can see the ominous, blue-gray illumination of the forest peek "+
	     "through the tangled mass of trees and bushes.\n\n");
    ...
    add_fexit(CORAMAR+"f21", "northeast", 0);
    add_fexit(CORAMAR+"f19", "southwest", 0);
}

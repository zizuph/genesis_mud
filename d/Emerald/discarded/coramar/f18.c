...
create_forest()
{
    ...
    set_long("   The forest is so overgrown here that no light can get "+
             ...
             "the dark tunnel of trees very difficult. There seems to "+
             "be a small opening between two young trees to the "+
             "southeast.\n\n");
    ...
    add_fexit(CORAMAR+"f19", "northeast", 0);
    add_fexit(CORAMAR+"f17", "southwest", 0);
    add_fexit(CORAMAR+"f68", "southeast", 1); /* HIDDEN EXIT */
}

...
create_room()
{
    ...
    set_long("   You are standing in the central area of the Elven "+
      ...
      "the base and capital. To the south, you notice a gathering "+
      "of people and guards clustered into one area. There are "+
      "so many of them clusted into one group you can't quite "+
      "make out what they're doing from here. "+
      "The fine smell of perfumes, incense and freshly baked "+
      "food drifts through the courtrooms, generating a managerie of "+
      "overpowering scents.\n\n");
    ...
    add_exit(CASTLE_DIR + "th1","north",0);
    add_exit(CASTLE_DIR + "th5","south",0);
    add_exit(CASTLE_DIR + "th3","west", 0);

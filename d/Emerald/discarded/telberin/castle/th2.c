...
create_room()
{
    ...
    set_long("   You are standing in the front area of the Elven "+
	     ...
	     "of people and guards clustered into one area. You can't quite "+
	     "make out the source of their concern from here.\n\n");
    ...
    add_exit(CASTLE_DIR + "th3","south",0);
    add_exit(CASTLE_DIR + "th1","east",0);

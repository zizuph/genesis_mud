...
create_emerald_monster()
{
   ...
   alignlook = ({"proud", 0, "proud", 50, "good natured", 200,
	...
	"ordinary", 0, "selfish", -100,
	"mean-spirited", -200, "rude", -50, "callous", -75, "mean",
	-150, "grating", -50, "shadowy", -200 });
   ...
   set_race_name("elf");
   add_name("trader");
   set_long("This elf is a trader of the Elven city of Telberin. "+
	"As the city is full of elves of different walks and lives, "+
	"one can never generalize the behaviors of these citizens."+
	" @@align_extra");
   add_prop(LIVE_I_NEVERKNOWN, 1);
   set_short(featurelook[x] + " " + alignlook[y] + " " + query_race_name() + " trader");
   ...
   MONEY_MAKE_SC(5 + random(11))->move(TO, 1);
}

...
/* gnome.c is cloned by /telberin/tree_office.c */
...
#include "/d/Emerald/lib/add_money.c"
 
#define FAMILY_TREE TELBERIN_DIR + "obj/fam_tree"
...
create_monster()
{
    ...
    set_long("This gnome is very smart-looking. He is a master in " +
             "genealogy and he has many books, filled with information on " +
             "people, their ancestors and descendants. Ask him the right " +
             "question and he will tell you everything he knows. At a fair " +
             "price naturally.\n");
 
    set_stats(({ 40, 50, 50, 75, 75, 40 }));
 
    add_prop(OBJ_M_NO_ATTACK  , "@@obj_m_no_attack");
    add_prop(OBJ_M_NO_TELEPORT, 1);
    add_prop(OBJ_S_WIZINFO, "This gnome knows everything about genealogy. " +
             "He is specialized in the pedigree of the members of the " +
             "Vampyre Guild. For his presence on this donut and his skills, " +
             "he owes gratitude to Mercade.");
}
...
cannot_pay(int price)
{
    ...
    {
	write("You pay " + query_nonmet_name() + " his fee, " + price +
              " silver coins.");
	return 0;
    }
...
catch_question(string question)
{
     ...
     */
    seteuid(getuid());
    write_file(TELBERIN_DIR + "log/gnome.log",

...
create_emerald_monster()
{
   ...
   alignlook = ({"proud", 0, "proud", 50, "good natured", 200,
	...
	"ordinary", 0, "selfish", -100, "mean-spirited", -200, "rude",
	 -50, "callous", -75, "grating", -50 });
   ...
   set_race_name("elf");
   set_long("This elf is a traveller in the Elven city of Telberin. "+
	"As the land is full of elves of different walks of life, "+
	"one can never generalize the behaviors of these wandering folk."+
	" @@align_extra");
   add_prop(LIVE_I_NEVERKNOWN, 1);
   set_short(featurelook[x] + " " + alignlook[y] + " " + query_race_name() + " traveller");
   set_stats(({ 35+random(20), 50+random(15), 35+random(20),
   ...
   set_gender(random(2));
   MONEY_MAKE_CC(29 + random(10))->move(TO, 1);
   MONEY_MAKE_SC(5 + random(2))->move(TO, 1);

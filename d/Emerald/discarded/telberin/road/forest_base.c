...
void create_room()
{
    ...
    add_item( "lake",
        ...
        "occaisonally in the distance, kingfishers skim the " +
    ...
    add_item( "trees",
        ...
        "creating a wall of foilage and cover the foothills but " +
...
forest_desc()
{
    switch(random(5))
    {
        ...
        "and south into Emerald. To your west is a great lake. " +
        "Tall trees grow along its edge. Their foilage shades " +
        ...
        break;
        case 2:
        return "   The road stretches north and south as it runs " +
        "under tall trees here. The trees block your view of " +
        ...
        "around on the edge. Occaisonally, you see a fish jump " +
        "from the water.\n\n";
        break;
        case 4:
        return "   The road meanders here as it follows the " +
        "shoreline. It is well worn from constant use. Trees grow " +
        "along the western edge of the road. Between the trees " +
        "you see the lake, stretching out in the distance. Heavy " +
        "bushes grow along the otherside of the road, making it " +
        ...
        "along the shoreline. The shade the road and bend in " +

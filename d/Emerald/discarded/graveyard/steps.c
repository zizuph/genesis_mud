...
void create_room()
{
    ...
    set_long("   You stand amidst a pool of slowly swirling mist and "+
	     ...
	     "assault your senses. Off to the east, you can make out the "+
	     "dark gray shadows of broken and leaning gravestones. Far "+
	     "to the north you manage to make out the foggy outline of "+
    ...
    add_item( ({"gravestones", "graves", "leaning gravestones",
		"broken gravestones", "graveyard", "east"}),
	     "Looking through the ominous fog to the east, you can "+
	     "see the shadow-darkened outlines of broken and leaning "+
	     "gravestones worn down by years of neglect. You get a "+
	     "strange feeling of loneliness and despair as you gaze "+
	     "at the graveyard.\n");
    ...
    add_exit(GRAVEYARD_DIR + "graveyard1", "east", 0);
}

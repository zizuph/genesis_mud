...
create_room()
{
    ...
    add_item( "crumbs",
        "You notice some crumbs in the corner of the room, " +
        "Where the shopkeeper missed. They appear to be broken " +
        "bits of ice cream cones.\n");
    add_item( ({"wall", "walls"}),
        "The walls are made of stone. They are expertly crafted " +
        "and constructed.\n");
    add_item( ({"up", "ceiling"}),
        "The ceiling rises to a peak. It is strong and sturdy " +
        "looking\n");
    add_item("plaque", 

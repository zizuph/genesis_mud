...
create_room()
{
    ...
    set_long("   You're on a busy boulevard in the city of Telseron. " +
        ...
        "effect. On your west is a stone building. It is " +
        "an ordinary looking building with birds flying to " +
        "and from it. You are on Hibiscus street.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd12", "north");
    add_exit(TOWNSHIP_DIR + "rd18", "south");
}

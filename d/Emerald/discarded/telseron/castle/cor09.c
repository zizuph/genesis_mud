...
create_corridor()
{
    add_my_desc("A large crystal chandelier hangs from the " +
        ...
        "North leads to a corridor, east takes you into the King's " +
        "audience room, and west goes further into the castle.\n\n");
    ...
    add_exit( TCASTLE_DIR + "cor06", "north");
    add_exit( TCASTLE_DIR + "lb01",  "south");
    add_exit( TCASTLE_DIR + "ac01",  "east");
    add_exit( TCASTLE_DIR + "cor08", "west");
}

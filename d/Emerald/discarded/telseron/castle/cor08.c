...
create_corridor()
{
    add_my_desc("Large windows in the north and western wall fill " +
        "the room with light. The light reflects off the walls " +
        "filling the room with a brilliant aura. East leads towards " +
    ...
    add_exit( TCASTLE_DIR + "cor12", "south");
    add_exit( TCASTLE_DIR + "cor09", "east");
}

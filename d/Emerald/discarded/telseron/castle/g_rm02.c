...
create_room()
{
    ...
    reset_room();
    set_short("East guard room");
    set_long("   You stand in the eastern guard to the King's " +
	"chambers. The guards stand at attention as you enter. " +
	"They defend the King with their lives, if needed, and " +
	"are proud of station. They look strong. Light enters in " +
	"from windows on the eastern wall. The walls are smooth " +
	"and pure white. They are decorated with floral designs. " +
	"The floors are covered with rich carpets which dampen " +
	"most of the noise. They look comfortable and are luxurious. " +
	"You see some scrapes on the walls from what may be " +
	"recent skirmishes in here. Servants of the King pass " +
	"by, ignoring you.\n\n");
    ...
    add_exit( TCASTLE_DIR + "cor20", "north");
    add_exit( TCASTLE_DIR + "k_lib", "west");
}

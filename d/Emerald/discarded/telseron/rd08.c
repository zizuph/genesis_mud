...
create_room()
{
    ...
    set_long("   You're on a boulevard in the city of Telseron. " +
        ...
        "boulevard is very busy as elves move past you going about " +
        "their business. The trees that grow here create a forest " +
        "canopy, shading you from the sun's rays. North of you is " +
        "the crossroads of Begonia, Fuschia, and Stephanotis " +
        "streets. You are on Stephanotis street.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd01", "north");
    add_exit(TOWNSHIP_DIR + "rd13", "south");
    add_exit(TOWNSHIP_DIR + "rd09", "east");
} 

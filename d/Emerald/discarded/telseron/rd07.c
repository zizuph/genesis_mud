...
create_room()
{
    ...
    set_long("   You're on a busy boulevard in the city of Telseron. " +
        ...
        "by a column of trees on either side of it. Running west " +
        "is Fuschia street, south is Hibiscus street, and running " +
        "southwest into the city is Gardenia street.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd06", "west");
    add_exit(TOWNSHIP_DIR + "rd12", "south");
    add_exit(TOWNSHIP_DIR + "rd11", "southwest");
} 

...
create_room()
{
    ...
    set_long("   A busy boulevard in the city of Telseron. The " +
        "boulevard is crowded with elves going about their " +
        "business. However, the boulevard is still clean despite " +
        "all the traffic it gets. The street is wide and goes " +
        "underneath a canopy of trees which grows on either side " +
        "of the street. A floral fragrance drifts from the stone " +
        "building north of here. South of you is a crossroad. " +
        "Stephanotis, Tulip, and Gardenia meet there. You're on " +
        "Stephanotis street.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd19", "north");
    add_exit(TOWNSHIP_DIR + "rd26", "south");

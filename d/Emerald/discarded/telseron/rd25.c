...
create_room()
{
    ...
    set_long("   You're on a boulevard in the city of Telseron. " +
        ...
        "canopy, shading you from the sun's rays. South of you is " +
        "the crossroads of Begonia, Tulip, and Hibiscus " +
    ...
    add_exit(TOWNSHIP_DIR + "rd20", "north");
    add_exit(TOWNSHIP_DIR + "rd32", "south");

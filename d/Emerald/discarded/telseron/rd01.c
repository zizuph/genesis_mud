...
create_room()
{
    ...
    set_long("   You're on a boulevard in the city of Telseron. " +
        ...
        "their business. Running east from here is Fuschia street, " +
        "south is Stephanotis street, and running southeast through " +
        "the city is Begonia street.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd08", "south");
    add_exit(TOWNSHIP_DIR + "rd02", "east");
    add_exit(TOWNSHIP_DIR + "rd09", "southeast");

   gate = clone_object( TOWNSHIP_DIR + "doors/gate_out");

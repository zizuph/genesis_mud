...
create_room()
{
    ...
    set_long("   You're on a boulevard in the city of Telseron. " +
        ...
        "the crossroads of Fuschia, Hibiscus, and Gardenia " +
        "streets. You are on Hibiscus street.\n\n");
    ...
    add_item("elves",
        "These are the residents of Telseron. Like" +
        "They love forests, songs, and many good things.\n");
    add_item(({"plantings", "flowers"}),
        "The plantings are full of flowers which fill the " +
        "air with fragrance.\n");
 
    add_exit(TOWNSHIP_DIR + "rd07", "north");
    add_exit(TOWNSHIP_DIR + "rd14", "south");
    add_exit(TOWNSHIP_DIR + "rd11", "west");
} 

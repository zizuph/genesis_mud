...
create_room()
{
    ...
    set_long("   A busy boulevard in the city of Telseron. " +
        ...
        "side of the street. A floral perfume drifts from the " +
        "southwest. Camellia street meets here from the east. " +
        "You are on Stephanotis street.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd13", "north");
    add_exit(TOWNSHIP_DIR + "rd19", "south");
    add_exit(TOWNSHIP_DIR + "rd16", "east");

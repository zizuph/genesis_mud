...
create_room()
{
    ...
    set_long("   You're on a boulevard in the city of Telseron. " +
        ...
        "their business. A busy boulevard meets here and runs west " +
        "through the city. The road that meets you here is " +
        "Camellia street.\n\n");
    ...
    add_item("trees",
        ...
        "surronds each tree. Under the trees are small plantings " +
    ...
    add_exit(TOWNSHIP_DIR + "rd14", "north");
    add_exit(TOWNSHIP_DIR + "rd20", "south");
    add_exit(TOWNSHIP_DIR + "rd17", "west");

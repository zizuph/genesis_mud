/* towncastle/doors/cdoor1_a.c is cloned by towncastle/corridor_wend.c */
inherit "/std/door";
...
create_door()
{
    set_door_id("celldoor_1");
    set_pass_command(({ "w", "west" }));
    set_door_name(({ "cell door", "door", "west cell door", "west door" }));
    set_door_desc( "The door looks old, but quite solid. You can "+
		  "hear some sounds from the other side of it.\n" );
 
    set_other_room(TCASTLE_DIR + "cell_1");
    set_open(0);
    set_locked(1);

/* towncastle/npc/babyalligator.c is cloned by towncastle/hatchery.c */
...
create_creature()
{
    ...
    add_adj("cute");
    add_adj("baby");
    set_long("You've never seen so cute alligators before.\n");
 
    set_stats( ({ 30, 25, 20, 2, 2, 61 }) );
    ...
    set_attack_unarmed(A_BITE, 30, 30, W_IMPALE, 55, "jaws");
    set_attack_unarmed(A_TAIL, 25, 20, W_SLASH,  45, "tail");
 
    set_hitloc_unarmed(H_HEAD, ({ 15, 25, 20, 20 }), 20, "head");
    set_hitloc_unarmed(H_BODY, ({ 10, 15, 30, 20 }), 60, "body");

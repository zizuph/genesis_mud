...
create_room()
{
    ...
    set_long("   You're on a busy boulevard in the city of Telseron. " +
        ...
        "effect. North of you is a stone building. It looks " +
        "sturdy and able to protect whatever is inside it. " +
    ...
    add_exit(TOWNSHIP_DIR + "rd31", "east");
    add_exit(TOWNSHIP_DIR + "rd29", "west");

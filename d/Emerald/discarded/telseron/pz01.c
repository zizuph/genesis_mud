...
create_room()
{
    ...
    add_exit(TOWNSHIP_DIR + "rd03", "north");
    add_exit(TOWNSHIP_DIR + "pk01", "south");
    add_exit(TOWNSHIP_DIR + "board", "east");
    add_exit(TOWNSHIP_DIR + "rd09", "west");
}                    

...
create_room()
{
    ...
    set_long("   You're on a boulevard in the city of Telseron. " +
        ...
        "their business. A floral perfume floats from the stone " +
        "building west of you. A sign hangs over the door. East " +
        "of you is another stone building. Loud singing comes " +
        "from it. You are on Stephanotis street.\n\n");
 
    add_item( ({"buildings", "stone buildings", "building",
                "stone building"}),
        "Two stone buildings stand on either side of you. To " +
        "the west is the Flower Shop of Telseron. From the " +
        "eastern building you hear drunken singing and merriment.\n");
    add_item("trees",
    ...
    add_exit(TOWNSHIP_DIR + "rd15", "north");
    add_exit(TOWNSHIP_DIR + "rd21", "south");
    add_exit(TOWNSHIP_DIR + "flower_shop", "west");
...
read_sign()
{
    return "On the sign you see painted in bright letters:\n " +
        "'Telseron Florist'.\n";
}

...
create_room()
{
    ...
    set_long("   A busy boulevard in the city of Telseron. " +
      ...
      "side of the street. You're on Fuschia street.\n\n");
   ...
   add_prop(IS_CARRIAGE_STOP, 1);
    ...
    add_exit(TOWNSHIP_DIR + "rd03", "east");
    add_exit(TOWNSHIP_DIR + "rd01", "west");
    reset_room();
} 
...
reset_room()
{
    ...
    {
       reset_euid();
        carriage = clone_object(CARRIAGE_PATH + "emerald_carriage");
        carriage->move(TO);

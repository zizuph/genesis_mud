...
create_emerald_monster()
{
   ...
   alignlook = ({"proud", 0, "proud", 50, "proud", -50, "good natured", 200,
	...
	"ordinary", 0, "nasty", -100, "malevolent", -200, "selfish", -100,
	"mean-spirited", -200, "rude", -50, "naughty", -75, "mean",
	-150, "sneering", -200, "frowning", -50, "troublemaking", -200,
	 "bratty", -200, "slinking", -200 });

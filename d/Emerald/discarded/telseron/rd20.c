...
create_room()
{
    ...
    set_long("   A busy boulevard in the city of Telseron. " +
        ...
        "side of the street. Looking west you see a stone " +
        "building. From it you hear an occasional scream and a " +
        "muffled cry of pain. You are on Hibiscus street.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd18", "north");
    add_exit(TOWNSHIP_DIR + "rd25", "south");

...
create_room()
{
    ...
    set_long("   The Plaza is the general meeting area for " +
        "many elves. Quiet and inviting, it is an open area " +
        "in the city and serves as a meeting place. Often " +
        "times, you can find friends and families gathering here.\n");
    ...
    add_tell("A dove takes wand flys away.\n");

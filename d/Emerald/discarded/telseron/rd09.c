...
create_room()
{
    ...
    set_long("   You're on a boulevard in the city of Telseron. " +
      ...
      "you going about their business. Looking south, you see " +
      "the south side of a stone building. To the east, you see " +
      "a plaza. Southeast of here, you sense a serene " +
      "feeling.\n\n");
    ...
    add_exit(TOWNSHIP_DIR + "rd01", "northwest");
    add_exit(TOWNSHIP_DIR + "pk01", "southeast");
    add_exit(TOWNSHIP_DIR + "rd08", "west");
    add_exit(TOWNSHIP_DIR + "pz01", "east");

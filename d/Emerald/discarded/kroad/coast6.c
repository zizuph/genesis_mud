...
create_room()
{
  ...
  set_long("   A thick mist hangs over the area, distorting the trees "+
	   ...
	   "mist to the west and heads toward a tall, building-"+
	   "shaped shadow looming beyond the mist. Further south you notice "+
  ...
  add_item( ({"shadow", "building-shaped shadow", "building",
	      "tall building", "tall shadow"}),
	   "The shadows lurking off in the distance to the south "+
	   "seem to resemble a building.\n");
  ...
  add_exit("coast5", "west");
  add_exit("coast7", "south");

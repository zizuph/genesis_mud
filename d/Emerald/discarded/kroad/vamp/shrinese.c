...
void create_room()
{
    ...
    set_short( "Southeastern point of the shrine of darkness" );
    set_long( "   The aura of ancient darkness here swirls like "+ 
      "molasses, leaving you nauseated and dizzy. "+ 
      "You stand weak-kneed at the southeastern "+ 
    ...
    add_exit( VAMP_KR_DIR + "shrinee.c", "nne", 0 );
    add_exit( VAMP_KR_DIR + "shrines.c", "wsw", 0 );

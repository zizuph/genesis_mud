/*	This room was created by Jaypeg : 01/05/97
*/
...
void create_cave_room()
{
    ...
    add_exit( VAMP_KR_DIR + "cav2.c", "north", 0 );
    add_exit( VAMP_KR_DIR + "cavs1.c", "south", 0 );
    add_exit( VAMP_KR_DIR  + "cave1.c", "east", 0 );
    add_exit( VAMP_KR_DIR + "cavw1.c", "west", 0 );

...
void create_room()
{
    ...
    set_short( "Northwestern point of the shrine of darkness" );
    set_long( "   The aura of ancient darkness here swirls like "+ 
      "molasses, leaving you nauseated and dizzy. "+ 
      "You stand weak-kneed at the northwestern "+ 
    ...
    add_exit( VAMP_KR_DIR + "shrinen.c", "ene", 0 );
    add_exit( VAMP_KR_DIR + "shrinew.c", "ssw", 0 );

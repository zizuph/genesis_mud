...
void create_room()
{
    ...
    set_short( "Southwestern point of the shrine of darkness" );
    set_long( "   The aura of ancient darkness here swirls like "+ 
      "molasses, leaving you nauseated and dizzy. "+ 
      "You stand weak-kneed at the southwestern "+ 
    ...
    add_exit( VAMP_KR_DIR + "shrinew.c", "nnw", 0 );
    add_exit( VAMP_KR_DIR + "shrines.c", "ese", 0 );

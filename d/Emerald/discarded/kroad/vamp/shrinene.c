...
void create_room()
{
    ...
    set_short( "Northeastern point of the shrine of darkness" );
    set_long( "   The aura of ancient darkness here swirls like "+ 
      "molasses, leaving you nauseated and dizzy. "+ 
      "You stand weak-kneed at the northeastern "+ 
    ...
    add_exit( VAMP_KR_DIR + "shrinee.c", "sse", 0 );
    add_exit( VAMP_KR_DIR + "shrinen.c", "wnw", 0 );

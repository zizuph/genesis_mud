...
create_room()
{
  ...
  set_long("   The dark, gray area is cold and damp. The fog looms heavily "+
	   ...
	   "the huge, ominous, dark shadow of a building hidden behind "+
  ...
  add_item( ({"shadow", "building", "huge shadow", "huge building"}),
	   ...
	   "the shadows are the outlines of a building of some kind, but you "+
  ...
  add_exit("coast6", "east");
  add_exit("coast4", "northwest");
}

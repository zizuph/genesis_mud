...
create_emerald_monster()
{
   ...
   add_name("child");
   set_random_move(5);
   set_long("This cute little elf child runs around the streets of Leah "+
	"making noise, bumping into people, and being generally childlike."+
	"\n");
   ...
   set_gender(random(2));
   set_act_time(7);
   add_act("emote giggles, and prances around you.");
   add_act("emote grins cutely and bounces off the wall of a nearby building");
   set_chat_time(10);
   add_chat("Oh hello there! Will you play with me?");
   set_m_in("wanders in");
   set_m_out("wanders");
   set_restrain_path( ({ "/d/Emerald/leah" }) );
   set_whimpy(60);
...
align_extra()
{
	...
	switch (TO->query_alignment())
	  ...
	  case 0..99:
		...
		"Telseron. " + capitalize(HE_SHE(TO)) + " doesn't seem "+

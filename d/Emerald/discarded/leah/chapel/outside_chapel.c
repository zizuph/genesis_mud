...
create_room()
{
   ...
   set_long("   You stand in a beautiful garden outside "+
      ...
      "you are standing on leads south back the chapel garden. This garden " +
      ...
      "A large white gazebo is here, with greenery growing all around it's base "+
   ...
   add_exit(CHAPEL_DIR + "gazebo", "enter", "@@check_thrown_out");
   add_exit(CHAPEL_DIR + "outside", "bridge", "@@bridge_msg@@");
}

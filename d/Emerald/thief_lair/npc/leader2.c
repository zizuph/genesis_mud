...
// Global variables                    
public int command_mode = 0; //True when he is engaged in battle.
 ...
 * 
 * Further modified from the one in the bandits so that he may not
 * actually be attacked when he has 3 or more other bandits in his
 * presence.
 */
...
{
    ::attacked_by(ob); // This will put him into command_mode since
                       // he will call request_orders in himself.
    
    write("Tevalanar's command_mode is: " + command_mode);

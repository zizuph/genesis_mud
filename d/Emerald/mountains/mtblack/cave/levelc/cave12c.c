...
create_room()
{
    ...
    set_long("   "+
        "This cave is a dead end. It is looks like the home of an Ogre, " +
        "and indeed, thats just what it is. Looks like a rather unsafe " +
        "place to take a nap, as you would probably not wake up again.\n\n");
    ...
    add_exit(THIS_DIR+"cave15c", "northeast", 0, 1);

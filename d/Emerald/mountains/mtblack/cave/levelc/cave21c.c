...
create_room()
{
    ...
    set_long("   "+
        "This cave is a dead end. It looks as if this is a regular haunt " +
        "for Ogres, and you'd better make sure you don't run into any, " +
        "because they are not the nicest people to meet.\n\n");
    ...
    add_exit(THIS_DIR+"cave15c", "southeast", 0, 1);

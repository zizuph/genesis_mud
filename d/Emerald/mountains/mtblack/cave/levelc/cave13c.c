...
create_emerald_room()
{
    ...
    set_long("   "+
        "The cave continues on its way. It is gradually winding its " +
        "way around, and it is very difficult to see the path back. These " +
        "must be some of the darkest and most dangerous caves around.\n\n");
    ...
    add_exit(THIS_DIR+"cave10c", "southeast", 0, 1);
    add_exit(THIS_DIR+"cave16c", "north", 0, 1);

...
#define WARFARE_ENABLED
#define WAR_PATH    "/d/Krynn/devel/warfare/"
 ...
 */
#define DEFAULT_TAX_BASE      810
#define DEFAULT_RECRUIT_BASE  12
...
#define LOG(x)          write_file(W_LOG, ctime(time()) + ": " + (x) + "\n")

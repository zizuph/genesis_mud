...
config_propchange_spell()
{
    ...
    set_spell_desc("Mirror portal - a command of activation for " +
        "magical teleportation mirrors");
...
check_valid_action(object caster, mixed * targets, string arg, int execute = 0)
{
    ...
    {
        caster->catch_tell("There are no magical mirrors here you can " +
            "use as a portal.\n");
        return 0;
    }
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    caster_message = "You gesture slightly and utter a magical " +
        "word of command: 'Doton Obsule!'\n";
    watcher_message = QCTNAME(caster) + " gestures slightly and utters " +
        "a magical word of command.\n";
...
{
    caster->catch_msg("The mirror portal activates at your command!\n");
    all_mirrors->activate_magic_mirror();
}
...
{
    caster->catch_msg("Dispel your existing maintained spell before " +
        "casting mirror portal!\n");
}
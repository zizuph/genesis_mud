/* WoHS chainmail for npcs in the WoHS Test, Arman Dec 2017 */
...
create_armour()
{
    ...
    set_am( ({ -2, 3, -1 }) );
    set_at(A_BODY);
    add_adj( ({ "imperial", "shining" }) );
    set_short("shining imperial chainmail");
    set_pshort("shining imperial chainmails");
    set_long("This fine set of armour appears to be have once belonged "+
        "to an imperial soldier of the Ergothian army. It is constructed "+

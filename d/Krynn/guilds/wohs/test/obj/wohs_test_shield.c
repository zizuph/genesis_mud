/* WoHS shield for npcs in the WoHS Test, Arman Dec 2017 */
...
create_armour()
{
    ...
    set_am( ({ -2, 3, -1 }) );
    set_at(A_SHIELD);
    add_adj( ({ "imperial", "tower" }) );
    set_short("imperial tower shield");
    set_pshort("imperial tower shields");
    set_long("A steel tower shield, emblazoned with the "+
        "crest of the imperial Ergothian royal family.\n");
    add_prop(OBJ_I_VOLUME, 14000); 
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_ARMOUR(35, A_SHIELD));

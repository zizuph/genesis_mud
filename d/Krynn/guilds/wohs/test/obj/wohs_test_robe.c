/* WoHS robe for npcs in the WoHS Test, Arman Dec 2017 */
...
create_armour()
{
    ...
    set_am( ({ -2, 3, -1 }) );
    set_at(A_ROBE);
    add_adj( ({ "istarian", "white" }) );
    set_short("white Istarian robe");
    set_pshort("white Istarian robes");
    set_long("A white robe worn by Istarian clergy and clerics "+

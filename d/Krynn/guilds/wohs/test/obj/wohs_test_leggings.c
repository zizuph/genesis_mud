/* WoHS leggings for npcs in the WoHS Test, Arman Dec 2017 */
...
create_armour()
{
    ...
    set_am( ({ -2, 3, -1 }) );
    set_at(A_LEGS);
    add_adj( ({ "imperial", "chain" }) );
    set_short("pair of imperial chain leggings");
    set_pshort("pairs of imperial chain leggings");
    set_long("This fine pair of chain leggings appears to be have once " +
        "belonged to an imperial soldier of the Ergothian army. It is " +
        "constructed of high-quality steel and offers good protection.\n");
    add_prop(OBJ_I_VOLUME, 4000); 
    add_prop(OBJ_I_WEIGHT, F_WEIGHT_DEFAULT_ARMOUR(40, A_LEGS));

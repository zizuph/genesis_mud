/* WoHS cape for npcs in the WoHS Test, Arman Dec 2017 */
...
create_armour()
{
    ...
    set_am( ({ -2, 3, -1 }) );
    set_at(A_ROBE);
    add_adj( ({ "military", "white" }) );
    set_short("white military cape");
    set_pshort("white military capes");
    set_long("A short military cape worn by soldiers of the imperial "+
        "Ergothian army.\n");

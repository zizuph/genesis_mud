/* WoHS platemail for npcs in the WoHS Test, Arman Dec 2017 */
...
create_armour()
{
    ...
    set_short("engraved imperial platemail");
    set_pshort("engraved imperial platemails");
    set_long("This fine set of armour appears to be have once belonged "+
        "to an imperial cavalier of the Ergothian army. It is constructed "+
        "of high-quality steel and offers good protection.\n");

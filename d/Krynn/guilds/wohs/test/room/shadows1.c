...
string *bronze_str = ({"You notice the three moons look like they are " +
    "waxing", "You notice Nuitari is at low sanction, while Solinari " +
    "and Lunitari are waxing", "You notice Lunitari is waning, while " +
    "Solinari and Nuitari are at low sanction"});

string *silver_str = ({"You notice Nuitari is at low sanction, while " +
    "Solinari and Lunitari are waxing", "You notice Nuitari is at high " +
    "sanction, while Solinari and Lunitari are waxing", "You notice " +
    "Solinari is at low sanction, while Nuitari and Lunitari are waxing"});

string *copper_str = ({"You notice Nuitari is waxing, while Solinari " +
    "and Lunitari are at high sanction", "You notice Solinari is " +
    "waxing, while Nuitari and Lunitari are at high sanction",    
    "You notice Nuitari is at high sanction, while Solinari and " +
    "Lunitari are waxing"});
...
enter_bronze_mirror()
{
   ...
   if(mirror_setting == 0)
   {
      ...
      say(QCTNAME(TP)+ " walks into the mirror and vanishes! " +
          C(HIS(TP))+ " image appears in the reflection of the mirror " +
          "briefly, before returning to normal.\n");
      TP->move_living("M", "/d/Krynn/guilds/wohs/test/room/shadows2", 1, 0);
      return "";
   }
   else
   {
      ...
      TP->move_living("M", "/d/Krynn/guilds/wohs/test/room/shadow_hall", 1,
          0);
      return "";
   }   
}

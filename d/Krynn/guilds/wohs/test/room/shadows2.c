...
string *bronze_str = ({"You notice Nuitari is at low sanction, while " +
    "Solinari and Lunitari are waxing", "You notice Nuitari is waning, " +
    "while Solinari and Lunitari are waxing", "You notice Lunitari is " +
    "waning, while Solinari and Nuitari are at low sanction"});

string *silver_str = ({"You notice Nuitari is at high sanction, while " +
    "Solinari and Lunitari are waxing", "You notice they all look like " +
    "they are waxing", "You notice Solinari is at low sanction, while " +
    "Nuitari and Lunitari are waxing"});

string *copper_str = ({"You notice Nuitari is waxing, while Solinari " +
    "and Lunitari are at high sanction", "You notice Solinari is " +
    "waxing, while Nuitari and Lunitari are at high sanction", "You " +
    "notice Nuitari is waning, while Solinari and Lunitari are waxing"});
...
create_tower_room()
{
   ...
   set_long("You stand in triangular room of ever-shifting shadows, " +
       "swirling through the room like a dark fog. There are no " +
       "obvious exits here, however three tall mirrors hang on each " +
       "wall.\n");

   add_item(({"triangular room","room"}), "You are really stretching " +
       "the definition of 'room' by describing this space " +
       "as such. It is more a space with boundaries of shadows.\n");
   ...
   add_item(({"tall mirrors","mirrors","wall","walls","shadowy walls",
       "three tall mirrors","three mirrors"}), "Three tall mirrors hang " +
       "on each of the three walls here - a bronze mirror, a silver " +
       "mirror, and a copper mirror.\n");
...
enter_bronze_mirror()
{
   ...
   if(mirror_setting == 1)
   {
      ...
      TP->move_living("M", "/d/Krynn/guilds/wohs/test/room/shadows3", 1, 0);
      return "";
   }
   else
   {

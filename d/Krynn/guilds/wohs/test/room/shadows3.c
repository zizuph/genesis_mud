...
string *bronze_str = ({"You notice Nuitari is at waning, while " +
...
string *silver_str = ({"You notice Nuitari is at high sanction, while " +
    ...
    "they are waxing", "You notice Solinari is waxing, Nuitari at low " +
    "sanction, and Lunitari at high sanction"});
...
string *copper_str = ({"You notice Nuitari is waxing, while Solinari " +
    ...
    "Nuitari is waning, while Solinari and Lunitari are waxing"});
...
enter_bronze_mirror()
{
   ...
   if(mirror_setting == 0)
   {
      ...
      TP->move_living("M", "/d/Krynn/guilds/wohs/test/room/shadows4", 1, 0);
      return "";
   }
   else
   {

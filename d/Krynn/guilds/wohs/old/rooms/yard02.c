...
create_wayreth_room()
{
   ...
   set_long("You are standing in the courtyard of the Tower of High Sorcery. "+
            "The Tower of High Sorcery stands high above you, dwarfing you "+
            "in comparison. A pair of open gates lead east out of the "+
            "courtyard. Small towers stand at the northeast and southeast "+
            "corner of the complex, and considering the triangular shape of "+
            "the surrounding walls, you assume a third tower stands to the "+
            "west. The courtyard continues to the north and south, and "+
            "circumvents the Tower to the southwest and northwest.\n");
   AI(({"Tower","tower","Tower of High Sorcery","Tower of Wayreth",
        "tower of wayreth","tower of high sorcery"}),"The Tower of High " +
        "Sorcery looms above you, with slick walls of obsidian. It seems " +
        "to strut straight into the sky in majestic glory. You are awed " +
        "by the magic that emanates from the cold surface of the Tower.\n");
   AI(({"slick walls","walls of obsidian","slick walls of obsidian",
   ...
   AI("complex","The complex consists of the main Tower, and a triangle " +
        "of outer walls, with a tower in each of the corners.\n");
   AI(({"small towers","towers","corner towers"}),"These smaller towers " +
   ...
   add_exit("yard01", "north", 0);
   add_exit(WFOREST + "clearing", "east", 0);
   add_exit("yard03", "south", 0);
   add_exit("yard04", "southwest", "@@around_tower");
   add_exit("stairwell01", "west", "@@enter_tower");
   add_exit("yard04", "northwest", "@@around_tower");
}

/*
 * The guild object for Wizards of High Sorcery
 */
...
#include "/d/Krynn/guilds/sohm/objs/spellbook_spells.h"
...
create_object()
{
    ...
    set_long("This leather-bound tome is the closely-guarded repository "+
          "of spells for a Wizard of High Sorcery. You can list " +
          "spells collected by reading it. Information about being a " +
          "Wizard of High Sorcery can also be found within, which can " +
          "be accessed through the <help wohs> command.\n");
...
do_spellbook(string str)
{
    ...
    write("You open your spellbook and examine the spells you have " +
        "recorded within.\n");

#define GGUILD              "/d/Krynn/guilds/gnomes/"
#define GUILDMASTERS        ({ "Carnak" })
#define GNOME_NAME	        "Gnomish Inventors"
#define GNOME_TAX           2

#define LOG                 (GGUILD         + "log/")
#define MEMBERS             (LOG            + "members/")
#define MEMBER_DIR(who)     (MEMBERS        + who)

#define ROOMS               (GGUILD         + "rooms/")

#define LIB                 (GGUILD         + "lib/")
#define MANAGER             (LIB            + "manager")
#define GNOME_SOUL          (LIB            + "kgnome_soul")
#define GNOME_SHADOW        (LIB            + "race_shadow")

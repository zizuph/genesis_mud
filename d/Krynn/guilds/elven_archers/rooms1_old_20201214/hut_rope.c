...
create_krynn_room()
{
    ...
    set_long("You are walking high up in the trees. The branches have been bent and shaped to fit " +
             ...
             "Towards the east you can see the road leading to New Ports.\n");
    ...
    add_item("area", "You see the qualinesti elves camping in the forest to your left, " +
             "and the road to New Ports on your right.\n");
    add_item("road", "The road is on your right, and leads towards New Ports.\n");
    ...
    add_item(({"camp", "below"}), "The qualinesti camp is down below to your left.\n");
    add_item(({"hut", "camouflaged hut"}), "It is directly to your left.\n");

    OUTSIDE;
    add_exit(ROOMS + "hut_postoffice", "west", 0);
    reset_room();
}

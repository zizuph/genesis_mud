...
{
    object door;
    add_my_desc("There is a rounded tower to the southwest. " +
        "The street continues north and east.\n");
    ...
    door = clone_object(VOBJ + "swdoora");
    door->move(TO);
    door->set_key(KEEPKEY);

    AE(VROOM + "ws5", "north", 0);
    AE(VROOM + "ss2", "east", 0);

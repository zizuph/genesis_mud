...
*
* Information: This item can not be lifted from the ground by people
*              under 1 in alignment (neutral+) and cannot be wielded
*              by players with alignment under 910 (good+++).
*
* 110908 Lunatari: Fixed the enter_env function so that this item
*                  is allowed to enter things like backpacks.
*                  IS_OBJECT_LIVING then check, not if not.
*                  Included <files.h> for this.
*/
#include <files.h>

...
query_ability_map()
{
    return ([
	     ...
	     "kattack"  : SPECIALS + "kattack",
	     "katt"     : SPECIALS + "kattack",
	     "charge"   : SPECIALS + "charge",
	     "observe"  : SPECIALS + "observe",
	     "consider" : SPECIALS + "consider",
	     "kheroism" : SPECIALS + "kheroism",
	     "ksummon"  : SPECIALS + "ksummon", "ksum"  : SPECIALS + "ksummon",
	     "kdismiss" : SPECIALS + "kdismiss", "kdis" : SPECIALS + "kdismiss",
	     "maneuver" : SPECIALS + "maneuver",
	     "rescue"   : SPECIALS + "rescue",
     ]);
}
...
query_cmdlist()
{
    ...
    return ([
	     ...
	     "consider":"do_ability",
	     "kheroism" : "do_ability",
	     "ksummon" : "do_ability", "ksum" : "do_ability",
	     "kdismiss" : "do_ability", "kdis" : "do_ability",
	     "maneuver" : "do_ability",
	     "rescue": "do_ability",
...
secondary(string str)
{
    ...
    if (!str)
    {
        NF("Select your secondary weapon skill choice using 'polearm' or 'club'\n");
        return 0;
    }
    
    if (str == "polearm")
    {
        SKILLS_MANAGER->set_secondary_weapon_choice(TP, SS_WEP_POLEARM);
    }
    else if (str == "club")
    {
        SKILLS_MANAGER->set_secondary_weapon_choice(TP, SS_WEP_CLUB);
    }
    else
    {
        NF("Select your secondary weapon skill choice using 'polearm' or 'club'\n");
...
koptions(string str)
{
    string cry, pri, mer, kat, cha, aid, weapon;
    object medal = P("pal_med", TP);
...
*/
    ...
    setuid();
    seteuid(getuid());
    switch (SKILLS_MANAGER->query_secondary_weapon_choice(TP))
    {
    case SS_WEP_POLEARM:
        weapon = "polearm";
        break;
    ...
    write("           Mercy: "+mer+" \n");
#endif
    write("    Primary Hand: "+pri+" \n");
    write("Secondary Weapon: " + weapon + " \n");
    return 1;
}

...
#define SMITH_NAME    "The Smiths Guild"
#define SHIELD_NAME   "Shieldbearers of Iron Delving"
#define BLADE_NAME    "Blademasters of Khalakhor"
#define MILITIA_NAME  "Thornlin Militia"
#define OOTS_NAME     "Holy Order of the Stars"

/*
#define ARCHER_NAME    "Ansalon Elvish Archers"
*/
#define ARCHER_NAME "TEMPORARILY DISABLED"
#define GARDENER_NAME    "Gardeners of Gont"

/* Enable this when the global mercy command works
#define NEW_MERCY  1 */

#define CAV_CLOSED 0
#define MEDALPATH      (KOBJ    + "medal")
#define O_SHADOW       (SHADOWS + "occ_shadow")
#define KNIGHT_SOUL    (SOULS   + "solamnian_soul")
...
#define SPONSOREDPATH  KLOG + "sponsorlist"
#define JOINPATH       KLOG + "joined"
#define GUIDANCEPATH   KLOG + "guidance"
#define BANISHPATH     KLOG + "banished"
#define PRESTIGEPATH   KLOG + "prestige"
#define LEAVEPATH      KLOG + "left"
#define ADMIN_FILE     KLOG + "admin"
#define ARMSOLD        KLOG + "armsold"
#define KNIGHT_ALL_LOG KLOG + "allactions"
#define PRESTIGE_FILE  KLOG + "pre"
#define KILL_LOG       KLOG + "kills"
#define CREST          KLOG +"crests"
...
#define CHARITY_FILE         KLOG + "box"
#define CHARITY_FILELOW      KLOG + "boxlow"
#define CHARITY_FILEMED      KLOG + "boxmed"
#define CHARITY_FILEHIGH     KLOG + "boxhigh"
...
#define CHARITY_LOG          KLOG + "char"
#define RESCUE_OBJECT        "_k_rescue_object"
#define CHAR_PRES(val)       (val / 10)
#define RESCUE_TIME          "_k_rescue_time"
#define RESCUE_INTERVAL      2
#define RESCUE_PROTECT_TIME  10
...
#define ADMIN          (PARENT + "admin/admin.c")
#define MOUNT_FILE KLOG + "mounts"
/* Some identification macros for handy use */
#define IS_KNIGHT(x)      (objectp(present("pal_med", x)))
...
#define SS_LEVEL10      (RATE * 27 / 4)
/* was: 30; We need to keep this at the same level as LEVEL9, or the conclave
 * members need a lot more prestige than the Lords of the same order. Now, any
 * lord is also eligible for conclave position.
 */
#define SS_LEVEL11      (RATE * 27 / 4)
/* 33 */
#define SS_LEVEL12      (RATE * 27 / 4)
/* 36 */
#define SS_LEVEL13      (RATE * 27 / 4)
/* 40 */
...
/* 14 June 2001 - Increasing these to reflect changes in AG skills,
   elimination of halving for specials based on skills.  See tax doc
   for details. -- Auberon  */
/* The tax specified here is without the ARMOURY_TAX. That gets added
   by their tunic */
#define TAX ({ 0, 30, 14, 30, 30, 30, 0 })
/* ARMOURY TAX is no longer relevant after saving racks were introduced */
#define ARMOURY_TAX 0
...
#define SQUIRE_TITLES ({ "Untitled Squire", \
        ...
        "Inexperienced Squire of Solamnia", \
        "Squire of Solamnia", \
...
#define SS_BLOCK   26
#endif
#define KNIGHT_SKILL_DESC  ({"rescue", "kattack"})
...
#define SS_DONATE       108114  /* Krynn is domain#8 */
...
#define TUNIC_OBJECT(ob)       (present("pal_med", ob))
...
#define SKILLS_MANAGER (KLIB + "knight_skill_manager")
#define MOUNT_MANAGER (KLIB + "knight_warhorse_manager")
#define KNIGHT_UTILITY (KLIB + "knight_utility")
#define LAYMAN_MANAGER (KLIB + "knight_layman_manager")
#define CHARGE_ABILITY (SPECIALS + "charge")
#define KATTACK_ABILITY (SPECIALS + "kattack")

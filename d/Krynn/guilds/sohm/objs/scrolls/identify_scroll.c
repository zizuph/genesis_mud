...
create_object()
{
    set_name("scroll");
    add_adj(({"moist", "grey"}));
    set_long("Scroll for new spell. 'odenarcanis', or identify magic...\n");

...
create_object()
{
    set_name("scroll");
    add_adj(({"greasy", "grey"}));
    set_long("Scroll for new spell. 'riyitchikohk', or read magic...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell fool's curse " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "fool's curse cantrip in to your spellbook!\n");

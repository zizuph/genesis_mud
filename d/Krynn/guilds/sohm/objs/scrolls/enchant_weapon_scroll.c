...
{
    set_name("scroll");
    add_adj(({"intense", "azure"}));
    set_long("Scroll for new spell. 'levexlaraek', or enchant weapon...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell enchant weapon " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "enchant weapon spell in to your spellbook!\n");

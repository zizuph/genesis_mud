...
create_object()
{
    set_name("scroll");
    add_adj(({"greasy", "grey"}));
    set_long("Scroll for new spell. 'kampiunarcanis', or read magic...\n");

...
create_object()
{
    set_name("scroll");
    add_adj(({"fiery", "red"}));
    set_long("Scroll for new spell. 'trothdraconis', or protect from dragon fear...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell protect from fear " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "protect from fear spell in to your spellbook!\n");

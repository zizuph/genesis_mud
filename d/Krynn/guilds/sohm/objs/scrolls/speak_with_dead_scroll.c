...
{
    set_name("scroll");
    add_adj(({"deathly", "white"}));
    set_long("Scroll for new spell. 'ukrisrivek', or speak with dead...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell speak with dead " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "speak with dead cantrip in to your spellbook!\n");

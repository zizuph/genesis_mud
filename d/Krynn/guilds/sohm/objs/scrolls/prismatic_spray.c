...
{
    set_name("scroll");
    add_adj("multicoloured");
    set_long("Scroll for new spell. 'bakmadaingis', or prismatic spray...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell prismatic spray " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "prismatic spray spell in to your spellbook!\n");

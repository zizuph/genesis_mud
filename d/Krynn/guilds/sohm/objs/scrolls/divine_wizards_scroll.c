...
create_object()
{
    set_name("scroll");
    add_adj(({"basic", "snowy"}));
    set_long("Scroll for new spell. 'ehtahhewa', or divine magus...\n");

...
create_object()
{
    set_name("scroll");
    add_adj(({"basic", "red"}));
    set_long("Scroll for new spell. 'ricindenthanus', or psychic blast...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell psychic blast " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "psychic blast spell in to your spellbook!\n");

...
create_object()
{
    set_name("scroll");
    add_adj(({"light", "grey"}));
    set_long("Scroll for new spell. 'ickrakarcanis', or detect magic...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell detect magic " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "detect magic cantrip in to your spellbook!\n");

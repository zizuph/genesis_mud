...
create_object()
{
    set_name("scroll");
    add_adj(({"basic", "green"}));
    set_long("Scroll for new spell. 'trothixen', or protect from fire...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell protect from fire " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "protect from fire spell in to your spellbook!\n");

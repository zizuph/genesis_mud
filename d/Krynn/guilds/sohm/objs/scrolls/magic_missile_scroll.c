...
create_object()
{
    set_name("scroll");
    add_adj(({"basic", "blue"}));
    set_long("Scroll for new spell. 'arcanisvaes', or magic missile...\n");
...
study_cmd(string str)
{
    ...
    {
        notify_fail("This scroll seems to have the spell magic missile " +
            "scribed on it. This spell you already know.\n");
        return 0;
    }
     
    write("You begin to carefully study the scroll. You scribe the " +
        "magic missile spell in to your spellbook!\n");

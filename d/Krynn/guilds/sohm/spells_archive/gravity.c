...
config_haste_spell()
{
    ...
    set_spell_fail("Your attempt to cast gravity fails, fizzling harmlessly.\n");
...
check_valid_action(object caster, mixed * targets, string arg, int execute = 0)
{
    ...
    {
        caster->catch_tell("You have more spells memorised than you are " +
            "capable of mentally handling. You need to balance your " +
    ...
    if (caster == targets[0])
    {
        caster->catch_tell("You cannot burden yourself with gravitational " +
            "forces.\n");
        return 0;
    } 
    ...
    {   
        ...
        {
           caster->catch_tell("A domination enchantment interferes with " +
    ...
    {
        caster->catch_tell("Your target is already burdened with " +
    ...
    {
        caster->catch_tell("A curse of uncertainty upon your target " +
            "interferes with your spell, causing it to fail.\n");
        return 0;
    }
...
{
    write("You are missing an ingredient to cast the gravity spell.\n");
}

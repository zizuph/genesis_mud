/*
 * Custom Damage Modification Messages for Magic Shield
 *
...
{    
    ::create_effect();
    set_name("_magic_shield_dam_mod_obj");
    add_name( ({"magic shield dam mod obj" }) );
    set_short("hidden magic shield damage modifer object");    
    set_long("A SoHM magic shield damage modifier object. One should not be able to see "+

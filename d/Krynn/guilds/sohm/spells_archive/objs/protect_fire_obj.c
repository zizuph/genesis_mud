...
create_spell_object()
{
    set_name("_protect_fire_object_");
    set_short("ward against fire object");    
    set_long("This is the standard resistance spell's object. It protects "
        + "one against certain elements.\n");

    add_prop(OBJ_S_WIZINFO, "This is a spell object " +
                            "created to protect against fire.\n");
    set_spell_effect_desc("fire protection");    
}
...
hook_spell_effect_started()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You are now warded from fire.\n");
...
hook_spell_effect_ended()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You feel your ward against fire disappear.\n");
...
hook_spell_effect_warn_fading()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You feel the ward against fire begin to "
            + "fade.\n");
    }
}

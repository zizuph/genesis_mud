...
#define SOHM_MAGIC_SHIELD_EFFECT "_sohm_magic_shield_effect"
...
create_spell_object()
{
    set_name("_magic_shield_object_");
    set_short("magic shield spell object");    
...
{    
    return "/d/Krynn/guilds/sohm/spells/objs/shield_dam_mod_obj_base";
}
...
hook_spell_effect_started()
{
    ...
    target->add_prop(SOHM_MAGIC_SHIELD_EFFECT, 1);
...
hook_spell_effect_ended()
{
    ...
    target->remove_prop(SOHM_MAGIC_SHIELD_EFFECT);

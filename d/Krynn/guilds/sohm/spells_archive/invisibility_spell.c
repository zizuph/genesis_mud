...
config_invisibility_spell()
{
    ...
    set_spell_desc("Shadow walk - cloak yourself in shadows, becoming invisible.");
...
query_spell_can_be_learned(object player)
{
    ...
    setuid();
    seteuid(getuid());
    return SOHM_MANAGER->query_memorised_spell(player,"zhinpersvek_memorised");
}
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    string caster_message, watcher_message;
        ...
        caster_message = "You crouch down furtively and begin making grasping " +
           "motions with your hands while reciting magical words of deception " +
           "and confusion - 'Zhin Persvek!'\n";
        watcher_message = QCTNAME(caster) + " crouches down furtively and makes "
           +"grasping motions with " +caster->query_possessive()+ " hands " +
           "while reciting mystical words of magic.\n";

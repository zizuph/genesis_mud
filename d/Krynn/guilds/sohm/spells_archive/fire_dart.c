...
#include "/d/Krynn/guilds/sohm/spells/fire_dart_desc.h"
...
config_at_will_spell()
{
    ...
    set_spell_name("apianak");
    set_spell_desc("Fire dart - a conjured dart of fire");
...
query_spell_can_be_learned(object player)
{
    ...
    setuid();
    seteuid(getuid());
    return SOHM_MANAGER->query_memorised_spell(player,"apianak_memorised");
}
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    string caster_message, watcher_message;
        ...
        caster_message = "You close your eyes and begin reciting from "
            + "memory powerful words of magic, 'Api Anak!'\n";
...
{
    write("You feel ready to conjure a fire dart again.\n");
}
...
{
    write("You do not feel ready to conjure a fire dart again.\n");
}

public void
hook_already_active(object ability)
{
    write("You are currently conjuring a fire dart!\n");
}
...
desc_harm_cast(object caster, object *targets)
{
    ...
    fire_dart_desc_cast(caster, target);
...
{
        fire_dart_desc_damage(caster, target, result);
}
...
{
    int * needed_skills = ({ });
    int * check_skills = ({ SS_ELEMENT_FIRE, SS_FORM_CONJURATION });

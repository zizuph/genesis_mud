...
do_act(object pl)
{
    ...
    switch (random(3))
    {
        case 0:
            ...
            break;
        case 1:
            msg("You glide gracefully through the clouds, your leathery wings fully " +
...
{
    msg("No longer in dragon form, you begin to plummet down to earth! You shriek, " +
        "and frantically flap your arms as you try and remember whether you know the " +
        "featherfall spell!", ob, "No longer in dragon form, " +

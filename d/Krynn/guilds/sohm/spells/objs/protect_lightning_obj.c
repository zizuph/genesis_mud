...
create_spell_object()
{
    set_name("_protect_lightning_object_");
    set_short("ward against lightning object");    
    set_long("This is the standard resistance spell's object. It protects "
        + "one against certain elements.\n");

    add_prop(OBJ_S_WIZINFO, "This is a spell object " +
                            "created to protect against lightning.\n");
    set_spell_effect_desc("lightning protection");    
}
...
hook_spell_effect_started()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You are now warded from lightning.\n");
...
hook_spell_effect_ended()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You feel your ward against lightning disappear.\n");
...
hook_spell_effect_warn_fading()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You feel the ward against lightning begin to "
            + "fade.\n");
    }
}

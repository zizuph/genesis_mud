...
create_spell_object()
{
    set_name("_protect_cold_object_");
    set_short("ward against cold object");    
    set_long("This is the standard resistance spell's object. It protects "
        + "one against certain elements.\n");

    add_prop(OBJ_S_WIZINFO, "This is a spell object " +
                            "created to protect against cold.\n");
    set_spell_effect_desc("cold protection");    
}
...
hook_spell_effect_started()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You are now warded from cold.\n");
...
hook_spell_effect_ended()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You feel your ward against cold disappear.\n");
...
hook_spell_effect_warn_fading()
{
    ...
    if (objectp(target))
    {
        target->catch_tell("You feel the ward against cold begin to "
            + "fade.\n");
    }
}

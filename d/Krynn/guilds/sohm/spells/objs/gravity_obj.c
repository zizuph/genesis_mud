...
inherit SPELL_OBJ_DIR + "haste_obj";

#define SOHM_GRAVITY_EFFECT "_sohm_gravity_effect"
#define SOHM_GRAVITY_ACTIVE "_sohm_gravity_active"
...
hook_spell_effect_started()
{
    ...
    caster->add_prop(SOHM_GRAVITY_ACTIVE, 1); 
}
...
hook_spell_effect_ended()
{
    ...
    caster->remove_prop(SOHM_GRAVITY_ACTIVE);

...
create_krynn_monster()
{
    ...
    set_long("It's a dirty, smelly and very ugly gully dwarf."
	     + " It doesn't look particularly bright either..\n");
    add_name("gully");
    set_adj("dirty");
    add_adj("gully");
    ...
    add_act("emote tries to stand on its head but fails miserably.");
    add_act("emote lies down and moans a bit, you think it is pretending " +
	    "to be dead.");
    add_act("emote looks at you fearfully.");
    add_act("emote eats part of a dead rat.. at least if it wasn't dead, " +
	    "it is now.");
    add_act("emote has a strange grin on its face.");
    add_act("emote tries to stand on its head and succeeds!!");

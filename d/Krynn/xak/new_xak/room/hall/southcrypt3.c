...
{    
    ...
    set_long("You are standing in the middle of a long, narrow corridor " +
	     "that extends to the east and west. An arched doorway " +
	     ...
	     "moisture. A screeching sound can be heard from east.\n");

    LIGHT;

    add_exit(HALL + "southcrypt4", "east");
    add_exit(HALL + "southcrypt2", "west");

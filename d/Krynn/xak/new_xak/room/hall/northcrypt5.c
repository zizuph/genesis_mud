...
{    
    ...
    set_long("Here the long, narrow corridor ends abruptly. The floor " +
	     "here has collapsed, making it impossible to continue " +
	     "any further to the east. The corridor is lit by torches " +
	     "that flickers and smokes in the stifling air. The light " + 
	     "reflects off the walls wet with condensed moisture. " +
	     "An arched doorway reveals a large coffin to the north. Other " +
	     "coffins line the walls here and the stench of death assails " +
	     "your nostrils.\n");

    LIGHT;

    add_exit(HALL + "northcrypt4", "west");

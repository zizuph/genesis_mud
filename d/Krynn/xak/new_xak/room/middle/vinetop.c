...
reset_xak_room()
{
    MOVE(gDrac1, GET_NPC_MIDDLE)
    MOVE(gDrac2, GET_NPC_MIDDLE)
}
...
create_xak_room()
{
    ...
    set_long("You are standing at the southern end of the street. " +
	     ...
	     "of the cavern soars about two hundered feet above the cliff, " +
    ...
    add_exit(MIDDLE + "sidestreet2", "north");
...
do_climb(string str)
{
    ...
    if (!parse_command(str, ({}), "'vine' / 'vines' / 'down'"))
        return 0;
	...
	TP->move_living("M", LOWER + "vinebottom", 1);

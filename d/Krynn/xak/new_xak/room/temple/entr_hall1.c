...
{    
    ...
    add_exit(TEMPLE + "entr_hall2", "east");
    
    gDoor = clone_object(OBJ + "d_entr_hall1");
    gDoor->move(TO);
...
my_long()
{
    return "You are standing in an arching entrance hall of the temple of " +
	   ...
	   "leads to the east. The floor is made of finest marble and the " +
	   "wealth the city once had is apparent.\n";
}

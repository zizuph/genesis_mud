...
create_room()
{
    ...
    set_long("You are in an old dirty alley of Xak Tsaroth deep "+
	...
	"The alleyway dead-ends here against a blank wall "+
	"to the east.\n");
    
    add_exit(DDIR + "gally3", "west", 0);
	...
	"travel.\n");
    add_item( ({ "wall", "blank wall", "east wall" }),
	"The wall is mostly blank, but appears to have some "+
	"grubby finger marks near a crack.\n");

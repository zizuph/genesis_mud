...
create_room()
{
	...
	"underground in a huge cavern. The street goes north and "+
	"south to different main avenues. The building to the "+
	"east has strange sounds coming from it.\n");
    
    add_exit(DDIR + "gway7", "north", 0);
    add_exit(DDIR + "gway5", "south", 0);
	...
	"west look rather damaged and have no entrance from "+
	"here. The buildings to the east look sturdy "+

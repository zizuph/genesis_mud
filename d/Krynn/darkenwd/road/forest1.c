...
create_darkenwd_room()
{
    ...
    set_long_desc("This forest is quite dense, with a solid undergrowth " +
                  ...
                  "Haven road in the southwest direction.");
    ...
    add_exit(TDIR + "forest2", "northwest",0,4,1);
    add_exit(TDIR + "road2", "southwest",0,4,1);

    set_tell_time(120);
    add_tell("A rustling sound can be heard...where?\n");
    add_tell("A tree shivers in the small breeze.\n");

...
create_darkenwd_room()
{
    ...
    add_exit(TDIR + "forest8", "northwest",0,4,1);
    add_exit(TDIR + "forest6", "southeast",0,4,1);
    add_exit(TDIR + "road3", "northeast",0,4,1);

    set_tell_time(400);
    add_tell("A soft breath of wind scurries by.\n");

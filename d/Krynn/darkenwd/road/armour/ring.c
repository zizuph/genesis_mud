/* The ring found in a pocket gopher's hole. by Teth, April 9, 1996 */
...
create_armour()
{
    ...
    AI(({"jewels","red jewels","green jewels"}),"These jewels are "+
            "beautiful, worth a small fortune. Unfortunately, some of "+
            "them are now chipped or abraded, reducing their value.\n");
    AI(({"band","silver band"}),"The silver band of the ring is tarnished "+
            "due to the nonexistent care it has received. This looks "+
            "irreversible.\n");
    add_prop(OBJ_I_VOLUME, 15);
    add_prop(OBJ_I_WEIGHT, 55);
    add_prop(OBJ_I_VALUE, 60 + random(80));
}

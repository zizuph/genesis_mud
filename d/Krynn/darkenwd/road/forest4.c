...
create_darkenwd_room()
{
    ...
    add_exit(TDIR + "forest5", "northwest",0,4,1);
    add_exit(TDIR + "forest3", "southeast",0,4,1);
    add_exit(TDIR + "road5", "southwest",0,4,1);

    set_tell_time(300);
    add_tell("This area is strange by its silence.\n");

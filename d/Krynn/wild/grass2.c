...
create_wild_room()
{
    ...
    set_long(
        ...
        "The field extends to the south, east, and west. " +
        "Further west, stands a forest of tall trees. " +
        "The road enters the forest, leading towards the village " +
        "of Solace. Less than a mile to the south, thick " +
        "woodlands stretch to the east and west. " +
    ...
    add_exit(TDIR + "east3", "north");
    add_exit(TDIR + "grass5", "south");
    add_exit(TDIR + "grass3", "east");
    add_exit(TDIR + "grass1","west");
    ...
    add_item(({"thick woodlands","woodlands"}),BS(
        ...
        "to the east and west, south of here.",70));
    ...
    add_item(({"grassland","grassy field","ground","field"}),BS(
        ...
        "stretches to the south, east, and west.",70));
    ...
    add_item(({"footprint","footprints","print","prints",
        "track","tracks"}),BS(
        "There are a lot of footprints here, heading north " +

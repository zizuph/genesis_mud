 ...
 *    idea by Rastlin ---> add evil emotes
 *            Rastlin ---> add extra descrip to player
 *    Jan.30, 1996
 */
...
show_subloc(string subloc, object me, object for_obj)
{
   ...
   if (for_obj == me)
    ...
    C(b_dcolor) + " Dragon, marking " + OBJECTIVE(me) + " as " +
...
battlecry()
{
    write("You utter a formidable battlecry in the name of Paladine, " +
        "calling your brother and sister Knights to arms!\n");
   say(QCTNAME(TP) + " calls you to arms by uttering a formidable " +
      "battlecry in the name of Paladine! Adrenaline flows through " +   
      "your veins!\n");
   return 1;
}

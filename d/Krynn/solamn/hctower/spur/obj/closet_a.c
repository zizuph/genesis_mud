...
create_door()
{
   ...
   set_pass_command(({"enter", "forward", "in"}));
   ...
   set_other_room(ROOM + "closet.c");
   set_open(0);
   set_locked(0);
  set_open_desc("Here is a set of open closet doors.\n");
  set_closed_desc("Here is a set of closed closet doors.\n");

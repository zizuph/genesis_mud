...
create_door()
{
   ...
   set_other_room(ROOM + "tunnel1");
   set_open(0);
   set_locked(0);   
   set_open_desc("There are open heavy wooden doors leading east.\n");
   set_closed_desc("There are closed heavy wooden doors leading east.\n");

// pass4l1.c
// grace sept 1994
// need a door opening south onto the stairs 
...
create_spur_room()
{
   AE(ROOM + "pass3l1", "north", 0);
   AE(ROOM + "arch5", "east", 0);
   
   ACI("air", "smell",
      "It is cool and damp. Surprisingly, there is no musty smell.\n");
   clone_object(SOBJ + "l1d1a")->move(TO);
   
   make_the_room("The air is chilly and smells of fresh water.  @@npass_desc@@");

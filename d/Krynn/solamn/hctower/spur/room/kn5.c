...
create_spur_room()
{
   ...
   SHORT("High Justice Room");
   LONG("This is the private "+
     "abode of "+ ROSE + ", the High Justice of the Solamnian Knights.  "+
     "It is a stark room, both too large and too comfortable to be a "+
     "monk's cell, yet still rather cold and austere.\n   There is a modest "+
     "altar against the west wall, and a mosaic dragon rises above it, "+
   ...
   clone_object(SOBJ + "rose_b")->move(TO);

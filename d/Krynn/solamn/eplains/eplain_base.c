/*
 * East Solamnian Plains base room using Mapserver created by Milan
 */
#pragma save_binary
#pragma strict_types
...
#define CREATE "create_eplains_room"
#define RESET  "reset_eplains_room"

string gExtra_night_long, gSpecial_short;
string *herbs = 0;
static string *plain_rooms = ({ "p","s","t","u","v","w","x","y","z",
				"V","D","K","W","T","S","Q","R","U","F","C","E","X",
				"a","b","c","r","m","1","3","P","L" });
...
{
    string *paths = ({ "1","3","P","V","D","K","L","T","S","U" });
...
create_map_room()
{
	...
	break;
    case ".":
	set_area_name(WAR_AREA_THROTYL);
	break;
    }

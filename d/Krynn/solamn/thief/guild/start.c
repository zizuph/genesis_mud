...
create_thief_room()
{
   ...
   set_long("You are in the sleeping quarters of the thieves. Mats line " +
	    "the walls here and bunks are set into the walls. Some people " +
	    "are asleep here, regaining energy for another hard day out in " +
	    "the world.\n");
   ...
   add_cmd_item("here", "start", "@@do_start");
    add_item(({"mats", "bunks"}), "A couple of bunks and mats are empty, but several "+

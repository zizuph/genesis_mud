...
#define PLACES          ({/*"Emerald",*/"Kalad","Kalaman","Tharbad","Pelargir","Avenir","Gont"/*,"Terel"*/})
...
#define PIER_ON_TEREL   "/d/Terel/port/wpier_n"
...
#include "/d/Avenir/include/hidden_ship.h"
/* the above include defines: AVENIR_PORT_PATH and AVENIR_PORT_NAME
 */
#define PIER_ON_GONT    "/d/Earthsea/gont/gont_city/rooms/city_street/city_road15"

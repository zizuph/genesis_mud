...
create_splains_room()
{
    ...
    set_long(BS("There is a river blocking your path east and south. The river " +
		"flows lazily through the plains coming from your southwest " +
		"and then turning north. You are " +
    ...
    add_exit(ROOM + "river11","southwest",0,3);
    add_exit(ROOM + "plain22","west",0,3);
    add_exit(ROOM + "river9","north",0,3);
}

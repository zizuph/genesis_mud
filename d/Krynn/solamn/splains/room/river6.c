...
create_splains_room()
{
    ...
    set_long(BS("There is a river blocking your path northeast and north. The river " +
    ...
    add_item(({"river"}),
	     ...
	     "plains. The river is north of you and flows from west to east.\n");
    ...
    add_exit(ROOM + "river5","west",0,3);
    add_exit(ROOM + "river7","east",0,3);
    add_exit(ROOM + "road7","south",0,3);
}

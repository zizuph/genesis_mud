...
create_splains_room()
{
    ...
    set_long(BS("There is a river blocking your path northeast. The river " +
		"flows lazily through the plains coming from the north of " +
		"you and going east. You are " +
    ...
    add_item(({"river"}),
	     ...
	     "plains. The river is northeast of you and flows from north to east.\n");
    ...
    add_exit(ROOM + "plain14","west",0,3);
    add_exit(ROOM + "road6","south",0,3);
    add_exit(ROOM + "river6","east",0,3);
    add_exit(ROOM + "plain8","northwest",0,3);
}

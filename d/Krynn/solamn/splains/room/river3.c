...
create_splains_room()
{
    ...
    set_long(BS("There is a river blocking your path east. The river " +
		...
		"you and going southeast. You are " +
    ...
    add_item(({"river"}),
	     ...
	     "plains. The river is east of you and flows from north to southeast.\n");
    ...
    add_exit(ROOM + "plain20","west",0,3);
    add_exit(ROOM + "plain21","south",0,3);
    add_exit(ROOM + "river4","southeast",0,3);
    add_exit(ROOM + "river2","north",0,3);

...
create_splains_room()
{
    ...
    set_long(BS("There is a river blocking your path south. The river " +
		...
		"and then turning southeast. You are " +
    ...
    add_exit(ROOM + "river13","west",0,3);
    add_exit(ROOM + "river11","southeast",0,3);
    add_exit(ROOM + "plain22","east",0,3);
    add_exit(ROOM + "plain32","north",0,3);

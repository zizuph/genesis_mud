...
create_splains_room()
{
    ...
    set_long(BS("There is a river blocking your path east. The river " +
		"flows lazily through the plains coming from the south of " +
		"you and then turning northeast. You are " +
    ...
    add_item(({"river"}),
	     ...
	     "plains. The river is south and east of you and flows from " +
    ...
    add_exit(ROOM + "plain33","west",0,3);
    add_exit(ROOM + "river10","south",0,3);
    add_exit(ROOM + "road7","northeast",0,3);
    add_exit(ROOM + "road6","north",0,3);
}

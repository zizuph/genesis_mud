...
{
    set_short("In a duct");
    set_long("You are in a duct, going north and up. " +
	     "It is completely dark in either direction. Here it is " +
	     "very damp and water is dripping from the ceiling. You " +
	     "conclude there must be water somewhere above your head.\n");
    add_prop(ROOM_I_TYPE, ROOM_IN_WATER);
    DARK;
    add_exit(WATER_OUTLET,"north");
    add_exit(ROOM + "secret1","up");
}
...
rush_water_through()
{
    int i;
    object *whos;
    tell_room(TO, "Suddenly, you hear a load rushing noise coming from " +

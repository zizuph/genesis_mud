...
create_splains_room()
{
    ...
    add_exit(ROOM + "plain35","west",0,3);
    add_exit(ROOM + "river14","southwest",0,3);
    add_exit(ROOM + "river12","east",0,3);
    add_exit(ROOM + "plain31","north",0,3);

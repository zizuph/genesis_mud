...
create_splains_room()
{
    ...
    add_item(({"river"}),
	     ...
	     "plains. The river is east of you and flows from northwest to south.\n");
    ...
    add_exit(ROOM + "plain8","south",0,3);
    add_exit(ROOM + "plain21","west",0,3);
    add_exit(ROOM + "river3","northwest",0,3);

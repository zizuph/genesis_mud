...
#define ADJ1 ({"blackened","black","crimson",\
                      "cracked"})
...
create_armour()
{
    ...
    set_long("A "+adj1+" "+adj2+ " chainmail. Poorly made but still offering a "
    +"decent amount of protection. It bears the mark of the "
    +"Dewar dwarves near Palanthas. They "

...
#define RESULTS_TO  "/d/Krynn/solamn/vin/knight/log/voting_results"
...
create_object()
{
    ...
    set_long("This is a voting box. You can vote here on the current issue " +
	     ...
	     "issue to vote on is:\n@@current_issue@@" +
	     "If there is no voting going on currently, a conclave member can " +
	     "start a 'new vote' which will give an editor to describe the " +
	     "issue or start a 'new vote for <person>' to vote for a Grand Master. " +

...
create_vin_room()
{
    ...
    set_long("This room was obviously designed to hold the large "+
        ...
        "is covered with a large map of Ansalon, probably where "+
...
{
    clone_object(KOBJ + "swordmaster_shadow")->shadow_me(tar);
...
{
    clone_object(KOBJ + "general_shadow")->shadow_me(tar);
...
{
    clone_object(KOBJ + "warden_shadow")->shadow_me(tar);
...
{
    clone_object(KOBJ + "south_lt_shadow")->shadow_me(tar);
...
{
    clone_object(KOBJ + "east_lt_shadow")->shadow_me(tar);

...
({ ({ "create_torch", "/d/Krynn/solamn/vin/obj/oil_lamp",4}), \
({ "create_object", "/d/Krynn/solamn/vin/obj/oilflask",6}), \
({ "create_pack", "/d/Krynn/solamn/vin/obj/sack",4}), \
({ "create_pack", "/d/Krynn/solamn/vin/obj/backpack",6}), \
({ "create_leather", "/d/Shire/smiths/obj/sm_leath",10}) })

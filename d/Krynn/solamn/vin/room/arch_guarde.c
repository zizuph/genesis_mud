...
create_vin_room()
{
    set_short("Guardroom east of the archway");
    set_long("This is a guardroom, where Solamnian guards are typically on " +
      "duty in the event of an attack. To your west is an archway which you can "+
    ...
    AI("archway", "The archway leads north towards the inner portcullis. "+
      "It lies to your west, and is simple in design\n");

...
// Auberon is the guildmaster while seeking a replacement,
// nobody is the domain liege at the moment
#define GUILDMASTERS ({"Navarre"})
...
#define STEED          (VOBJ + "steed")
#define RIDER_OBJECT   (VOBJ + "rider_object")
#define O_SHADOW       (KOBJ + "occ_shadow")
#define CAVALRY_SHADOW (KOBJ + "cavalry_lay_shadow")
#define STEED_SHADOW   (VOBJ + "rider_shadow")
#define LEADER_SHADOW  (VOBJ + "leader_shadow")
...
#define GARDKEY  2322222
#define GARDKEY2 2333333
...
/* 14 June 2001 - Increasing these to reflect changes in AG skills,
   ...
   for details. -- Auberon  */
#define TAX ({ 0, 30, 18, 23, 23, 23, 0 })
#define ARMOURY_TAX 1
#define CAVALRY_TAX 6

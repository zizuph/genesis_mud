...
create_road_room()
{
    ...
    add_exit("", "west", "@@enter_map:" + ROAD_OBJECT + "|P@@", 3, 0);
    add_exit("", "east", "@@enter_map:" + ROAD_OBJECT + "|P@@", 3, 0);
    add_exit("", "south", "@@enter_map:" + ROAD_OBJECT + "|P@@", 3, 0);
    add_exit("", "north", "@@enter_map:" + ROAD_OBJECT + "|P@@", 6, 1);

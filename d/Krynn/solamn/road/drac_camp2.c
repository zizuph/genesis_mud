...
create_road_room()
{
    ...
    add_exit("", "west", "@@enter_map:" + ROAD_OBJECT + "|E@@",6,1);
    add_exit("", "east", "@@enter_map:" + ROAD_OBJECT + "|E@@",6,1);
    add_exit("", "south","@@enter_map:" + ROAD_OBJECT + "|E@@",6,1);
    add_exit("", "north","@@enter_map:" + ROAD_OBJECT + "|E@@",6,1); 

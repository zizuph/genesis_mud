...
ksedanger(string str)
{
    ...
    write("You narrows your eyes, looking intently into the distance for " +
	  "signs of danger.\n");
...
ksefirm(string str)
{
	...
	"would be able to move " + TP->query_objective() + " if he didn't want " +
	"to leave.");
    return 1;
}
...
ksqadmire(string str)
{
    ...
    actor("You declare your admiration of", oblist, ", voicing your " +
	  ...
	  " day.");
    target(" declares his admiration of you, voicing " + TP->query_possessive() +
...
/******************** kwed *********************************************
*         Refrain of the Wedding Song                                 */
/* Commented out by Teth on 10/5/96 because it is not a Solamnic      */
/* wedding song, but rather it is the song of Goldmoon and Riverwind. */
/*
 * int kwed(string str) { if (strlen(str)) { notify_fail("Kwed what? Try it
 * without a string.\n"); return 0; } write("You sing the Wedding Song of
 ...
 * all those things made larger by\n" + "       the vows between woman and
 * man.\n");
 * 
 * all(" sings a Solamnian wedding song:\n" + "       You and I, through burning

...
kbow(string str)
{
   ...
   if (TP->query_knight_level() <= 2)
      {
      write("But you are not a full Knight?\n");
      return 1;
   }
   ...
   if (TP->query_knight_level() == 2 || TP->query_Knight_level() == 1)
      return 0;
...
kcrstand(string str)
{
   ...
   target(" states his decision to stand by your side, no matter "+
      "what occurs.", oblist);
...
/********************* flex *************************************************/
/* Commented out by Morrigan 10/6/96                                        */
/*
int
flex(string str)
{
...
/*********************** kgrin ***************************************/
/* Commented out by Teth on 10/5/96 because it is Kitiara's grin.    */
/*
int
kgrin(string str)
{
...
kmagic(string str)
{
   ...
   if (!strlen(str))
      {
      write("You scowl at the thought of magic, and how it's "+
         "corrupted Krynn.\n");
      all(" scowls with undisguised loathing at the thought of "+
         "corrupting magic.");
      return 1;
   }
   ...
   actor("You scowl at", oblist, " as you think of how magic has "+
      "corrupted "+str+".");
   target(" scowls with undisguised loathing at you, at the thought "+
      "of corrupting magic.", oblist);
   all2act(" scowls with undisguised loathing at", oblist, " at the "+
      "thought of corrupting magic.");
   return 1;
}
...
knod(string str)
{
   ...
   if (!strlen(str))
      ...
      all(" gives a stern and confident nod, notifying every"+
         "one that it's time to press foward.");
      return 1;
   }
...
/********************** kmourn **********************************/
/* Commented out by Teth on 10/5/96 because it is a quote from  */
/* the Forestmaster.                                            */
/*
int
kmourn(string str)

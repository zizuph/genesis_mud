...
query_stat(int which_stat)
{
    ...
    if ((query_knight_level() == 5) && ((calling_function() == "join") ||
         (calling_function() == "team_join")) && TP != shadow_who)
...
{
   case 5:
      return prefix_title() + gend + " Knight of the Rose";
      break;
   case 4:
      return prefix_title() + gend + " Knight of the Sword";
      break;
   case 3:
      return prefix_title() + gend + " Knight of the Crown";
      break;
}
}

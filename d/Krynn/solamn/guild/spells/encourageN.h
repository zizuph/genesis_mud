...
encourage_message(object caster, object *targets)
{
    ...
    set_spell_duration(145 + 2 * query_spell_result()[0] + random(caster->query_stat(SS_INT) + 50));
}
...
public mixed
do_encourage(object caster, object *targets)
{
    fail_message = "";
    if (spell_failed)
      return 0;

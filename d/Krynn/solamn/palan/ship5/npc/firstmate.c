...
create_monster()
{
    ...
    add_ask(({"greyhavens", "mithlond", "elves"}),"say The elves currently distrust most outsiders, " +
	    "so none is allowed into the city. But at least the rest of the Shire likes visitors.",1);
...
introduce_me()
{
    ...
    FILTER_LIVE(all_inventory(E(TO)))->add_introduced("klaus");
    intro = 0;
}

...
create_palan_room()
{
    ...
    set_long(BS("This is the meeting room. There is a large wooden table "
          +  "here, filling almost the entire room. Several chairs are "
          +  "lying on the floor, just like the people stormed out "
          +  "recently. Several tapestries hang from the walls.", SL));
    ...
    add_item(({"tapestries","tapestry"}),BS("These tapestries cover almost "
            +"the entire walls. They show scenes from the plaza of "
            +"Palanthas, but also some portraits of the Lords of "
            +"Palanthas can be found, serving as the ancestral hall.",SL));
}

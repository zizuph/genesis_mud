/* 
 * The base outdoor room for the inner city of Palanthas.
 * Mortis 07.2005
 */
#pragma strict_types
...
create_krynn_room()
{
    ...
    ITEM(({"white tower", "tower"}), "The Tower of Lord Amothus Palanthas rises "
	+ "a hundred feet if not more above the palace.  Polished white marble "
	+ "finishes the walls and crenellations of the tower.  The view from the "
...
string get_time_item()
{
	...
	{
    case TOD_DAWN:
	ilamp += "Tall, grey lamp posts are arranged neatly throughout the plaza. "
	+ "They are unlit now, but at night the area is well-lit thanks to them.\n";
	break;
	...
	+ "starlight to evenly illuminate the streets at night.\n";
	break;
    default:
	break;
    }

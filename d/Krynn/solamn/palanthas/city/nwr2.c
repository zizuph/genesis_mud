...
get_time_desc()
{
	...
	+ "northwest the road continues on between the merchant and shipping "
	+ "districts.\n";
...
{
    SHORT("On Horizon road northwest of the palatial plaza");
    LONG("@@get_time_desc@@");

    EXIT(ROOM + "ic9", "northeast", 0, 0);
	EXIT(ROOM + "nwr1", "southeast", 0, 0);
	EXIT(MERCH + "nwr3", "northwest", 0, 0);
	EXIT(ROOM + "ic8", "southwest", 0, 0);

...
{
    string desc = "";
	string road = "  To the southeast is Scholar's Walk.  A grove of well "
	+ "cultivated trees grows to your southwest the other side of which must "
    + "be the palatial palace for its tall, white tower is visible even from "
	+ "here.  West the street curves to Trade road and the bay.\n";
...
void create_palan_room()
{
	...
	+ "oaks, birches, poplars, and cedar grows to the southwest, their rich, "
	+ "green leaves rustle softly in the breeze off the bay.  It is "
	+ "forbidden by law to enter this palatial wood unbidden.\n");

	EXIT(ROOM + "tr1", "west", 0, 0);
	EXIT(ROOM + "ner2", "southeast", 0, 0);

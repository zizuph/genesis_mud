 ...
 *
 * Gave door more appropriate key name. Key also updated.
 * Mortis 9.2014
 */
...
{
    set_door_id("jdoor");
    set_pass_command(({"n","north","enter","go through","in"}));
    set_door_name(({"iron bars","bars"}));
    set_door_desc("Very strong iron bars.\n");
    set_closed_desc("There are closed iron bars leading north.\n");
    set_open_desc("There are open iron bars leading north.\n");

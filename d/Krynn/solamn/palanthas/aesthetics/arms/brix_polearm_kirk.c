 ...
 * Mortis 06.2006
 *
 * Mana restoration was nominal. Increased slightly. Increased hit by 1.
 * This weapon is still only moderately appealing to very few character
 * types.
 *
 * Mortis 09.2014
 */
...
create_weapon()
{
    ...
    + "by draining health from wielder (can be lethal). Can be broken to "
    + "release imprisoned mage.\n");
...
remove_broken(int silent = 0)
{
    ...
    + "not cross the barrier without my vengeance!\n", mywielder);
...
did_hit(int aid,string hdesc,int phurt,object enemy,int dt,int phit,int dam)
{
    ...
    // Changed 100 to 50. Not much mana was ever being restored.
    dmana = dam * dpower / 50;
    ...
    switch (dmana)
    {
        ...
        case 36..60:
            ...
            break;
        default:
            enemy->catch_msg("Your heart shudders in shock as a force "
            + "from within the " + wshort + " sates itself deeply on your "
            + "lost energy.\n");

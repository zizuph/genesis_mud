    ...
    int dam)
{
    ...
    /* Calculate damage. Random from 22 to 21. Divide was 9.
     * now maximum range is 90-110 */
    impale_dmg = bonus_dmg * 9 / 10 + random(21);
...
//            where = " ";
    ...
    // Original punch or unarmed attack should hit, also.
    return 0;
}

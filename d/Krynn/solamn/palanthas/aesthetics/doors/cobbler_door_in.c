/*
 * Inside door to cobbler's home and shop
...
create_door()
{
	...
	+ "handle and keyhole.\n");
    set_door_id("cobbler_frontdoor");
    set_pass_command(({"north", "out"}));
    set_door_name(({"door"}));
    set_other_room(MONKS + "a11.c");
    set_open(0);
    ...
    set_key("cobbler_frontdoor");
    set_pick(26);
    set_lock_name("cobbler_frontdoor");
}

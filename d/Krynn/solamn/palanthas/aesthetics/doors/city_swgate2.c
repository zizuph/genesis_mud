/*
 * The Southwest City Gate of Palanthas
...
create_door()
{
    set_door_desc("The SOUTHWEST Gate.\n");
    set_door_id("city_southwest_gate");
    set_pass_command(({"ne","northeast"}));
    set_door_name(({"gate", "southwest gate", "southwest gates"}));
    set_other_room(MONKS + "swr7.c");
    set_open(1);
    ...
    set_pick(80);
    set_lock_name("city_southwest_gate");
}

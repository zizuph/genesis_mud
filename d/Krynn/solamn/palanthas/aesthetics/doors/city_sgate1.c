/*
 * The South City Gate of Palanthas
...
create_door()
{
    set_door_desc("The SOUTH Gate.\n");
    set_door_id("city_south_gate");
    set_pass_command(({"s","south"}));
    set_door_name(({"gate", "south gate", "south gates"}));
    set_other_room(MONKS + "sr6.c");
    set_open(1);

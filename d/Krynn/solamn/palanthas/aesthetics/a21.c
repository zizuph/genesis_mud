...
{
    string desc = "";
	string road = "  Jems court deadends here among a circle of houses and "
	+ "curves east between row upon row of tightly packed houses in this "
...
create_palan_room()
{
	...
	EXIT(MONKS + "a20", "east", 0, 0);

	clone_object(MONKS + "doors/a21_door_out")->move(TO);
}

...
{
    string desc = "";
	string road = "  Old Circle curves east into the Aesthetics quarter "
	+ "and northwest along the curve of the city wall towards the southwest "
	+ "city gates.  Through a few buildings to the northeast can be seen "
...
create_palan_room()
{
	...
	EXIT(MONKS + "w19", "northwest", 0, 0);
	EXIT(MONKS + "w17", "east", 0, 0);

...
{
    string desc = "";
	string road = "  Jems court curves in an oval north and south from "
	...
	+ "must not come here.  The city wall towers above the homes to the "
	+ "south.\n";
...
create_palan_room()
{
	...
	EXIT(MONKS + "a15", "north", 0, 0);
	EXIT(MONKS + "a17", "south", 0, 0);

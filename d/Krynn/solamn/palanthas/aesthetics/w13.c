...
{
    string desc = "";
	string road = "  Old Circle curves to the northeast and southwest along "
	+ "the inside of the city wall, and the city wall towers above you to the "
	+ "southeast.\n";
...
create_palan_room()
{
	...
	EXIT(MONKS + "w12", "northeast", 0, 0);
	EXIT(MONKS + "w14", "west", 0, 0);

...
{
    string desc = "";
	string road = "  Jems court curves in an oval west and south from "
...
create_palan_room()
{
	...
	ITEM(({"court", "jems court", "jems", "housing district", "houses"}),
		"A large housing district unfolds before you to the west and "
	+ "south.  The houses are densely arranged around Jems court, a long "
	...
	EXIT(MONKS + "a07", "north", 0, 0);
	EXIT(MONKS + "a16", "south", 0, 0);
	EXIT(MONKS + "a14", "west", 0, 0);

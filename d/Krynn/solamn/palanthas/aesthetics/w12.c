...
{
    string desc = "";
	string road = "  Old Circle runs northeast towards the main city gates "
	+ "on Knight's High road and southwest along the curve of the city wall "
	+ "further into the Aesthetics quarter.  Muest street curves off to the "
	+ "northwest, and the city wall towers above you to the southeast.\n";
...
create_palan_room()
{
	...
	EXIT(MONKS + "w11", "northeast", 0, 0);
	EXIT(MONKS + "w13", "southwest", 0, 0);
	EXIT(MONKS + "a23", "northwest", 0, 0);

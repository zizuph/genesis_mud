...
get_time_desc()
{
	...
	+ "this housing district with the front door of one on the south side "
	+ "of the street.  The street is dusty.  The street cleaners must not "
	+ "come here.\n";
...
create_palan_room()
{
	...
	ITEM("house", "Which house?  The one to the south?  Or the houses in "
	+ "general?\n");
	ITEM(({"s house", "south house"}), "The house to the south is packed "
	+ "between others like it.  With a base of brick the rest of the house "
	+ "is wood, its white paint flaking and faded all the way up to its "
	+ "second floor.\n");
	...
	+ "smoke from the alleys to the south where cheap alcohol lingers in "
	...
	+ "its inhabitants are crowded out by the dirt and debris of the unswept "
	+ "streets, and the smell of cooking fires is tainted by an odd leaf "
	+ "smoke from the alleys to the south.");
	...
	+ "potent leaf smoke from the alleys to the south from where the reek of "
	+ "alcohol wafts.");
	add_smell("goblin", "The salty breezes from the bay barely penetrate the "
	+ "dusty air of this neighborhood.  The smells of the daily lives of "
	+ "its human inhabitants are crowded out by the dirt and debris of the "
	+ "unswept streets, and the smell of cooking fires is tainted by a "
	+ "strong leaf smoke from the alleys to the south from where the reek "
	...
	+ "strong leaf smoke from the alleys to the south.");
	add_smell("hobbit", "The salty breezes from the bay barely penetrate the "
	+ "dusty air of this neighborhood.  The smells of the daily lives of "
	+ "its inhabitants are crowded out by the dirt and debris of the unswept "
	+ "streets, and the smell of cooking fires is tainted by a curiously "
	+ "enticing leaf smoke from the alleys to the south.");
	add_smell("gnome", "The salty breezes from the bay barely penetrate the "
	+ "dusty air of this neighborhood.  The smells of the daily lives of "
	+ "its inhabitants are crowded out by the dirt and debris of the unswept "
	+ "streets, and the smell of cooking fires is tainted by a curiously "
	+ "dangerous leaf smoke from the alleys to the south.  The air quality "
	...
	+ "leaf smoke from the alleys to the south.  What is that smoke, and "
	...
	+ "its human inhabitants are crowded out by the filth and debris of the "
	+ "unswept streets, and the smell of cooking fires is tainted by a "
	+ "dangerous leaf smoke from the alleys to the south from where the reek "
	...
	clone_object(MONKS + "doors/a14_door_out")->move(TO);

	EXIT(MONKS + "a15", "east", 0, 0);
	EXIT(MONKS + "a13", "west", 0, 0);
}

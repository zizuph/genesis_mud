...
{
    string desc = "";
	string road = "  Old Circle runs west to the southern city gates "
	+ "on Aesthetics row and east along the curve of the city wall "
	+ "into the Aesthetics quarter.  A fair number of buildings, shops, "
	+ "and homes stretch out to the north and northeast.  The city wall "
...
create_palan_room()
{
    SHORT("On Old Circle east of the southern gates");
    LONG("@@get_time_desc@@");
	...
	EXIT(MONKS + "w14", "east", 0, 0);
	EXIT(MONKS + "sr5", "west", 0, 0);

...
get_time_desc()
{
	...
	+ "into along Jems court to the north.  Many buildings and homes "
	+ "stretch out to the north and northwest on Jems court, a densely "
	+ "packed housing district.  The city wall towers above you to the "
	+ "south.\n";
...
create_palan_room()
{
    SHORT("On Old Circle west of the southern gates");
    LONG("@@get_time_desc@@");
	...
	EXIT(MONKS + "a17", "north", 0, 0);
	EXIT(MONKS + "sr5", "east", 0, 0);
	EXIT(MONKS + "w17", "west", 0, 0);

/*
 * The Northwest City Gate of Palanthas
...
create_door()
{
    set_door_desc("The NORTHWEST Gate.\n");
    set_door_id("city_northwest_gate");
    set_pass_command(({"nw","northwest"}));
    set_door_name(({"gate", "northwest gate", "northwest gates"}));
    set_other_room(MERCH + "nwr8.c");
    set_open(1);
    ...
    set_pick(80);
    set_lock_name("city_northwest_gate");
}

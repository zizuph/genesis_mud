/*
 * The West City Gate of Palanthas
...
create_door()
{
    set_door_desc("The WEST Gate.\n");
    set_door_id("city_west_gate");
    set_pass_command(({"w","west"}));
    set_door_name(({"gate", "west gate", "west gates"}));
    set_other_room(MERCH + "wr6.c");
    set_open(1);

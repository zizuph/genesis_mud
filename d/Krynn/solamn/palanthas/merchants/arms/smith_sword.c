/* Mortis 01.2006
 *
 * This is the weapon base for the swords forged at the
...
mapping wep_to_realname = (["cutlass":"cutlass", "rapier":"rapier",
	"sabre":"sabre", "scimitar":"scimitar", "sword":"sword"]);

mapping wep_to_pluralname = (["cutlass":"cutlasses", "rapier":"rapiers",
	"sabre":"sabres", "scimitar":"scimitars", "sword":"swords"]);

mapping wep_to_long = (["cutlass":"Extending from a protective steel basket "
	+ "hilt, the blade of this cutlass is wide with a slight curve for "
	+ "durability and ease in slashing and", 
	"rapier":"Smaller and faster than a longsword, this vicious rapier is "
	+ "curved for swift slashes, has a thin, silk bound handle for "
	+ "maneuverability, and",
	...
	+ "its hilt to its tip and ",  
	"sword":"With a sharp edged blade, crossguard hilt, tight, leather "
	+ "bound handle, and counter balanced pommel, this classic styled sword"]);

mapping sty_to_long = (["basket-hilted":"hilted with an elaborate basket of "
	+ "thin, wavy steel mesh",

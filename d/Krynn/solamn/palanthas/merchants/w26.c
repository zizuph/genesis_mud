...
{
    string desc = "";
	string road = "  Old Circle curves northeast and south along the curve of "
	+ "the city wall.  The city wall towers high above to the northwest.\n";
...
create_palan_room()
{
	...
	add_alley("se", "southeast", MERCH + "alchemist");

	EXIT(MERCH + "w27", "northeast", 0, 0);
	EXIT(MERCH + "w25", "south", 0, 0);

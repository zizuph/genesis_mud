/* Mortis 9.2014
 *
 * Add logging system that records who killed what in the city, and show it in
 * the desk here.
 */
...
create_palan_room()
{
    SHORT("The Constable's office in the Tower of Arms");
    LONG("A marble walled office with an archway leading east. It contains "
    + "only a desk and some chairs.\n");

    ITEM(({"chair", "chairs"}), "A straight, high-backed darkwood chair with "
    + "a thin, maroon cushion is behind the desk. Three simple wooden chairs "
    + "are lined up against the wall for guests.\n");
    ITEM(({"desk", "desks"}), "A great, walnut desk occupies the center of "
    + "this room. It is the only ornate item in the Constable's chambers. "
    + "Its surface is richly stained and bears nicks and scratches long "
    + "stained over and dark again. A wide, leather-bound journal lies "
    + "unbuckled atop it.\n");
    ITEM(({"journal", "book", "leather journal", "leather-bound journal"}),
        "The journal is wide and thick with vellum "
    + "papers. It is covered in leathers as dark and marred as the desk and "
    + "bound with a buckled leather strap, currently open. You may, if you "
    + "dare, <read> it.\n");
    ...
    CMD(({"book", "journal", "leather-bound", "leather journal"}), "read",
        "@@read_journal");

    EXIT(TOA + "toa67", "east", 0, 0);
...
read_journal()
{
    write("The current entry reads: 'I've had talks with the Lord and his "
    + "\"Bureaumancer\" minions. It seems they intend to contract out the "
    + "constabulary as a part of their cost saving initiative. War is "
    + "hard on budgets, and they know war is coming to Palanthas. From what "
    + "I gather, they intend to offer the contract to friendly Guilds of "
    + "the realms. The potential guilds vying for the contract would then "
    + "participate in a tournament with the victor becoming the constabulary "
    + "force in Palanthas with all the responsibilities and benefits that "
    + "implies. They would take control of the Tower of Arms, the gates, the "
    + "ports, the jails, and be responsible for the safety of the citizens "
    + "inside the city walls and surroundings. We'll see what comes of this. "
    + "I may have a new boss soon or be retired.'\n");

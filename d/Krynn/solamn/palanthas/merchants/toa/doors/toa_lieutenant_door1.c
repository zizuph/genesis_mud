/*
 * First floor outside door to the Lieutenant's rooms in the Tower of Arms in
 * Palanthas.
...
#define OSIDE                (TOA + "toa_lieutenant_01")

/*
 * First floor inside door to the Lieutenant's rooms in the Tower of Arms in
 * Palanthas.
...
create_door()
{
    set_door_desc("This bolted, iron door leads west out through the marble "

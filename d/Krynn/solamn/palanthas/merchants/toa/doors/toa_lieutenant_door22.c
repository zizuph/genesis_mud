/*
 * Second floor inside door to the Lieutenant's rooms in the Tower of Arms in
 * Palanthas.
 * Fair lock. Key exists.
 * 
 * Mortis 09.2014
 */
...
create_door()
{
    ...
    set_door_id("toa_lieutenant_door_low");
    set_pass_command(({"east","out", "door"}));
    set_door_name(({"door"}));
    set_other_room(TOA + "toa23.c");
    set_open(0);
    ...
    set_pick(20);
    set_lock_name("toa_lieutenant_door");
}

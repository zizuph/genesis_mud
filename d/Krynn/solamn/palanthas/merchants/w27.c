...
{
    string desc = "";
	string road = "  Old Circle curves northeast to the city gates on "
	+ "Horizon road and southwest along the curve of the city wall.  Above "
	+ "the shops to the east rises a short, white marble tower.  The city "
	+ "wall towers high above to the northwest.\n";
...
create_palan_room()
{
    SHORT("On Old Circle southwest of the city gates on Horizon road");
    LONG("@@get_time_desc@@");
	...
	+ "to the east, higher than all of the buildings in this section "
	...
	EXIT(MERCH + "nwr7", "northeast", 0, 0);
	EXIT(MERCH + "w26", "southwest", 0, 0);

...
create_palan_room()
{
	...
	+ "walkway to the Tower of Arms.\n");
	ITEM("walkway", "Clean and polished marble blocks form a walkway from "
	+ "landing to the Tower of Arms in the field to your east.\n");
	...
	+ "atop this hill.\n");
	ITEM(({"slope", "grassy slope"}), "Thick, green grasses cover the slope "
	+ "to the west below this landing.\n");

	CMD(({"northwest", "nw"}), "view", "@@view_northwest");
	CMD(({"southwest", "sw"}), "view", "@@view_southwest");

	EXIT(MERCH + "m03", "northwest", 0, 0);
	EXIT(MERCH + "tower_of_arms", "east", "@@place_closed", 0);

...
get_time_desc()
{
	...
	+ "towards Merchants' Way and south along the curve of the city wall "
	+ "past more houses.  A large residence is to the east, and to the "
	+ "west the city wall towers high above.\n";
...
create_palan_room()
{
    SHORT("On Old Circle in the west of the merchant quarter");
    LONG("@@get_time_desc@@");
	...
	EXIT(MERCH + "w23", "north", 0, 0);
	EXIT(MERCH + "w21", "south", 0, 0);

...
{
    string desc = "";
	string road = "  Old Circle curves south to the city gates on Merchants' "
	+ "Way and north along the curve of the city wall through an area thick "
	+ "with shops.  The city wall towers high above to the west.\n";
...
create_palan_room()
{
    SHORT("On Old Circle north of Merchants' Way");
    LONG("@@get_time_desc@@");
	...
	EXIT(MERCH + "w25", "north", 0, 0);
	EXIT(MERCH + "wr5", "south", 0, 0);

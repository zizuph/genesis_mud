...
create_krynn_monster()
{
    ...
    add_prop(OBJ_I_RES_ELECTRICITY, 15); // No flesh to fry.
    add_prop(OBJ_I_RES_DEATH, 40); // They're already undead. */
...
adjects()
{
    adjstr1 = one_of_list(({"hollow-eyed", "skull-cracked", "half-skulled",
        "dusty"}));

...
get_time_desc()
{
	...
	+ "visible to the southeast from this distance.  Along the road to the "
	+ "south is a thick wood, and a side street leads west through some "
	+ "buildings.  The road leads northwest to its intersection with "
	+ "Palanthas Circle and southeast to the inner city.\n";
...
create_palan_room()
{
    SHORT("On Horizon road north of a thick wood");
    LONG("@@get_time_desc@@");

	ITEM(({"wood", "woods", "north wood", "north woods", "thick wood",
		   "thick woods"}), "A thick wood of trees stands to your south.  "
	...
	EXIT(MERCH + "nwr3", "southeast", 0, 0);
	EXIT(MERCH + "m01", "west", 0, 0);
	EXIT(MERCH + "nwr5", "northwest", 0, 0);

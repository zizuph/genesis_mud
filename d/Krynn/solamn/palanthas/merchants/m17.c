...
{
    string desc = "";
	string road = "  Emptoris Row curves northwest into the arms district "
	+ "and to the southeast runs into Vingaard road.  A side street leads "
	+ "southwest to Old Circle and the city wall.  The city wall towers "
...
create_palan_room()
{
    SHORT("On Emptoris Row northwest of Vingaard road");
    LONG("@@get_time_desc@@");
	...
	EXIT(MONKS + "swr6", "southeast", 0, 0);
	EXIT(MERCH + "w20", "southwest", 0, 0);
	EXIT(MERCH + "m15", "northwest", 0, 0);

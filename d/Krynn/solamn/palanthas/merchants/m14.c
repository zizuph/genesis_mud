...
{
    string desc = "";
	string road = "  Scholis court curves west towards the arms district, "
	+ "and southeast towards Vingaard road.  To the north is a grove of "
	+ "great oaks out of the center of which looms a tower of dark, grey "
	+ "stone.\n";
    ...
    case TOD_DAY:
	desc += "The worn marble of Scholis court and its buildings lights up "
...
create_palan_room()
{
    SHORT("On Scholis court between the Arms district and a grove of "
	+ "large oaks");
    LONG("@@get_time_desc@@");

	ITEM(({"oak", "oaks", "tree", "trees", "grove", "shoikan grove"}),
	  "North is a grove of oaks, much larger than most you've seen, "
	...
	EXIT(MERCH + "m13", "west", 0, 0);
	EXIT(MONKS + "swr3", "southeast", 0, 0);

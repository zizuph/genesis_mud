 ...
 * This guard shouldn't take bribes.  The shipping quarter
 * is often the first part of the city visitors see so the
 * Constables pay close attention to it to give a good
 * impression.
 */
...
get_time_desc()
{
	...
	+ "southeast ";  // ...continued in TIMEOFDAY description.
	...
	+ "mountains.  A cool, misty breeze brings with it through the doorway "
	+ "the smells of wood, tar, and coffee.\n";
	break;
	...
	+ "daily business.  A cool, salty breeze blows in through the doorway "
	+ "off the bay.\n";
	break;
	...
	+ "street.  A misty, salty breeze blows blows in through the doorway "
	+ "off the bay.\n";
    break;
	...
	+ "at this hour.  A cool, salty breeze blows in through the doorway "
	+ "off the bay.\n";
    break;
...
create_palan_room()
{
	...
	EXIT(MERCH + "m01", "southeast", 0, 0);
	EXIT(MERCH + "merchant_tower1_2", "up", 0, 0);
	EXIT(MERCH + "merchant_tower1_0", "down", 0, 0);

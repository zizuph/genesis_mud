...
create_palan_room()
{
    ...
    set_long("You have reached the middle of the Marble Stairs. "
         ...
         +   "entrance hall of the palace, but it is quite far down.\n");

    add_exit(PALACE + "palace1","down",0,0);
    add_exit(PALACE + "palace5","up","@@is_protected",0);
}

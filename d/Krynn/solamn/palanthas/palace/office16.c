...
{
    set_short("Office");
    set_long("This is a small office. A window lets in light from the "
          +  "north. There is a wooden desk and a chair here, but you "
          +  "can't see anybody around.\n");

    add_item("desk","There are a lot of papers laying on the desk. You "
          +  "can make out some empty form sheets.\n");

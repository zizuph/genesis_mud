...
{
    set_short("Archive");
    set_long("This is the Archive. There are books and scrolls flying "
          +  "around everywhere. You wonder how anyone can keep track of "
          +  "things here.\n");

    add_item(({"book","books","scroll","scrolls"}),
	     "There are books and scrolls of all types and kinds. You decide there is " +
		"nothing of interest for you here and refrain from taking a closer look.\n");

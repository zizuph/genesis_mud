...
create_palan_room()
{
	...
	+ "covered in sawdust, and large sliding doors open out onto the street "
	+ "to the north.\n");
	...
	ITEM(({"door", "doors"}), "Wide doors slide back along the north wall "
	+ "and open out onto the street to the north.\n");
	...
	EXIT(SHIP + "s07", "north", 0, 0);
	EXIT(SHIP + "ware_trusq2", "east", 0, 0);
	EXIT(SHIP + "ware_trusq3", "south", 0, 0);
	EXIT(SHIP + "ware_trusq4", "west", 0, 0);

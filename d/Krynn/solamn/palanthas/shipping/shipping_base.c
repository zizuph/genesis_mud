/* 
 * The base outdoor room for the nobles quarter of Palanthas.
 * Mortis 07.2005
 */
#pragma strict_types
...
create_krynn_room()
{
	...
	+ "ground their way in between the cracks.\n");

    ITEM(({"dust", "dirt"}), "Fascinating. The dust and dirt that has "
    + "worked its way in between the cracks and joints of the marble "
    + "blocks of the street is dusty and dirty.\n");
	...
	+ "work, but are more or less level. Centuries of wear from cart and "
	+ "wagon in this quarter have begun to wear track marks into the "
	+ "stone. The marble is so translucent that the brownish clay "
	+ "bricks beneath give it a beige hue.\n");

	ITEM(({"lamps", "street lamps", "lamp", "street lamp", "glow",
		"yellow glow", "lamp posts", "lamp post"}), "@@get_time_item@@");

    ITEM(({"building", "buildings"}), "Very old marble buildings, shops, and "
	+ "primarily warehouses rise two to sometimes as high as four stories "
	+ "here in the Shipping quarter. The oldest buildings share a common "
	+ "architecture, a distinguishing feature of which is a band of chiseled "
	+ "reliefs near the top of some and at the borders between stories in "
	+ "others. A good many of those, especially near the inner city to the "
	+ "south, bear gargoyles at their top corners just below the roofs. The "
	+ "newer buildings, such as the new business warehouses, are not so "
	+ "antiquated in their styling and more frequently use small marble "
	+ "blocks combined with tan bricks and even wood by some of the piers.\n");
	...
	+ "Others bear popular traders and ship captains and their deeds which "
	+ "seem to be popular.\n");
	...
	+ "are all generally short, squating, and winged with long recurving "
	+ "claws, angular and thin faces, and aggressively slanted eyes.\n");
	...
	+ "rises high above the palace in the palatial plaza to the south at "
	+ "city center. The polished white marble finishing its walls and "
	+ "crenellations can still be made out from here.\n");
	...
	ITEM(({"dark tower", "grey tower", "tower of high sorcery"}),
	  "Far southwest in the merchants quarter rises a tower of "
	+ "great and dark grey blocks of stone. At its top are visible "
	+ "from this distance several pinnacles from which no banners fly.\n");

	ITEM(({"bay", "bay of branchala", "branchala bay"}), "The dark, blue "
	+ "waters of the Bay of Branchala stretch north from the harbor of "
	+ "Palanthas. Mountain peaks ring the bay looking down on high at the "
	+ "gentle, almost waveless waters below. Cool, salty breezes blow "
	+ "south off the bay into Palanthas.\n");
	
	ITEM(({"water", "waters", "wave", "waves"}), "The waters of the Bay of "
	+ "Branchala are dark blue and calm. They are well shielded from harsh "
	+ "winds.\n");

	ITEM(({"warehouse", "warehouses", "warehouse district"}), "The warehouse "
	+ "districts of the shipping quarter are filled with marble warehouse "
	+ "buildings of wood with marble finishing. Very few are completely "
	+ "marble except the very old.\n");
...
string get_time_item()
{
	...
	+ "streets throughout the shipping quarter. They are unlit now, but at "
	+ "night the area is fairly lit thanks to them.\n";
	break;
    ...
    case TOD_TWILIGHT:
	ilamp = "Tall, grey lamp posts are arranged somewhat far apart along the "
	+ "streets throughout the shipping quarter. City lampiers are out with "
	+ "their long candlestaves lighting the lamps before darkness falls.\n";
	break;

	case TOD_NIGHT:
	ilamp = "Oil lamps atop tall, grey lamp posts glow yellow combining with "
	+ "starlight to illuminate the streets of the shipping quarter at night. "
	+ "They are far enough apart to become pools of light in a sea of starlit "
	+ "streets by the bay.\n";
	break;
    default:
	break;
...
get_day_crowd()
{
    ...
    {
	case TOD_DAWN:
    dcrowd += "The crowds of merchants, sailors, dock workers, and "
	+ "travellers have not yet filled the streets though the early "
	+ "fishermen, deliverers, and messengers are already going about "
	+ "their business.";
	break;

	case TOD_DAY:
	dcrowd += "Crowds of people throng the streets in the midday sun eating, "
	+ "drinking, working on the docks, or setting sail.";
	break;

	case TOD_TWILIGHT:
    dcrowd += "The crowds of people working about the quarter have thinned "
	+ "since afternoon leaving it easier to make your way about. The "
	+ "strolling, relaxed evening crowd now mixes with the hustling workers "
	+ "some heading to the finer service establishments on the eastern "
	+ "dock.";
	break;

	case TOD_NIGHT:
	dcrowd += "Though most people have retired for the night, constables, "
	+ "sailors, and revelers heading for the next tavern still make "
...
get_morn_streetwashers()
{
	...
	+ "present they are vigorously sweeping and scrubbing the streets, "
	+ "sidewalks, and piers, polishing and refilling the lamp posts, and "
	+ "picking up litter from the night's revelries.";
	break;
...
get_night_revel()
{
	...
	+ "shipping quarter. Nobles, merchants, officials, and common citizens "
	+ "alike are all passing through on their way to various inns, taverns, "
	+ "and fine service establishments on the eastern dock.";
	break;

 ...
 *
 * Mortis 09.2014 - Added adjectives to long description to indicate
 * strength of variable pen.
 */
...
int honed = 0, hones = 3, myhit, myhitbonus, mypen = 42 + random(4);
string longpen;
...
my_longpen()
{
    switch (mypen)
    {
        case 43:
            ...
            break;
        case 44:
            longpen = "thrum strongly";
            break;
        case 45:
            longpen = "thrum intensely";
            break;
        default:
            longpen = "hum slightly";
            break;
    }
}
...
my_long()
{
  if (honed == 0)
  {
    ...
    + "blackened and wrapped tightly in soft, black leather which "
    + "seems to " + longpen + " in your grip.\n";
  }

...
{
    string desc = "";
	string road = "  Old Circle runs north along the city wall as well as "
	+ "southeast to the Scholar's Gate.  The great wall towers above you "
	+ "to the east.  Between the buildings to the northwest, you can see "
	+ "slivers of the dark blue bay.\n";
...
create_palan_room()
{
	...
	EXIT(SHIP + "w01", "north", 0, 0);
	EXIT(NOBLE + "ner7", "southeast", 0, 0);

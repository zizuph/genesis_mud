...
get_time_desc()
{
	...
	+ "are all you can make out southwards.  Bulwark Round curves southeast "
	+ "to its intersection with Palanthas Circle and west.  "
...
create_palan_room()
{
	...
	EXIT(SHIP + "tr3", "southeast", 0, 0);
	EXIT(SHIP + "s14", "west", 0, 0);

 ...
 * Mortis 03.2006
 *
 * Grade two merchant house Trusq security guard.
 *
 */
...
create_krynn_monster()
{
	...
	+ C(HE(TO)) + " is wearing a silver crescent necklace with a silver "
	+ "chevron.\n");
	set_race_name("human");
	...
	set_stats((({110, 105, 120, 55, 60, 95})), 4);
...
my_gender()
{
	gender = one_of_list(({G_MALE, G_MALE, G_MALE, G_FEMALE}));
	return gender;
}

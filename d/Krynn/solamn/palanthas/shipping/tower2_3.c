...
create_palan_room()
{
	...
	+ "the piers.  Southast along Palanthas Circle are tons of warehouses "
	+ "and a pair of great estates.  To the south, the shops, woods, and "
	+ "Tower of Arms can be seen.  You can also <view southeast> to see "
	+ "what's just outside the tower.\n");

	CMD(({"southeast", "se"}), "view", "@@view_southeast");

	trapdoor = clone_object(SHIP + "doors/tower2_3_trapdoor");
	trapdoor->move(TO);
...
view_southeast()
{
	/* This function returns an equivalent of 'look' from s14

...
get_time_desc()
{
	...
	+ "Horizon road and ends here by a few merchant buildings overlooking "
	+ "the bay.  The city wall towers high above to the west.\n";
...
create_palan_room()
{
    SHORT("On Old Circle near the piers");
    LONG("@@get_time_desc@@");
	...
	+ "which comprises its core.  The wall is in excellent shape.\n");

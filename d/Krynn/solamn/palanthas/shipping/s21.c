...
create_palan_room()
{
    ...
    EXIT(SHIP + "p01", "northeast", "@@pier_closed", 0);    
    EXIT(SHIP + "s20", "southeast", 0, 0);
...
pier_closed()
{
    ...
    return 0;
/*
    write("The piers to your northeast have been damaged by a recent " +
        "storm. Apart from not being safe to travel along, no ships are berthing " +
        "there. You see no reason to travel in that direction.\n");
    return 1;
*/
}
...
create_palan_room()
{
	...
	EXIT(SHIP + "s19", "southeast", 0, 0);
	EXIT(SHIP + "s21", "northwest", 0, 0);
...
pier_closed()
{
	write("Some rubble blocks the pier to your northeast. " +
              "From here it seems some Wizard is working on cleaning it up.\n");
	return 1;
}
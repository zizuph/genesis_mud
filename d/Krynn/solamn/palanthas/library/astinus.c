...
/* modified description by Arman 11 June 2016 */
...
create_krynn_monster()
{
    ...
    set_long("Astinus the Ageless One, head of the Library of Palanthas "
	    + "and chronicler of all history in Krynn. The historian's face "
            ...
            + "Astinus sits endlessly writing everything that happens on " 
            + "the face of Krynn. Rarely, very rarely, he stops to speak to "
            + "someone - he does very little interacting with history, "
            + "preferring to record it.\n");
    set_race_name("human");
    set_stats(({100, 100, 100, 400, 400, 400}));
    ALWAYSKNOWN;
    ...
    add_prop(OBJ_M_NO_ATTACK,"As you consider attacking the historian " +
        "a sense of great vertigo strikes you, making you dizzy and weak. " +
        "For some reason you get the feeling that this man will out live " +
        "you to chronicle the end of time.\n");

    set_skill(SS_AWARENESS,100);

    set_act_time(16);
    add_act("emote pauses briefly in his scribing to ink his quill.");
    add_act("emote stares piercingly into the crystal sphere on his desk.");
    add_act("emote notes down events as they happen with crisp, bold strokes " +
            "of his quill.");
...
default_ans()
{
    command("emote does not pause his calm efficient scribing, effectively " +
          "ignoring you.");
    return "";
}
...
give_out_book(object who)
{
    ...
    if (pointerp(prp))
      ...
      bok = prp;
    command("say Ahh yes, I have been informed of your coming. I have "

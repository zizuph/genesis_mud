...
create_krynn_monster()
{
    ...
    add_name("brother");
    add_name("aesthetic");
    set_long("A brother of the Aesthetic Order.  He wears a simple "
	     + "gray robe and leather slippers. He is on public duty and "
	     + "ready to serve you.\n");
    set_race_name("human");
...
default_ans()
{
    command("say Shhhh! Do not disturb the quiet here.");
    return "";
}

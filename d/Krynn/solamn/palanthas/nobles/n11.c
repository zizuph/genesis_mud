/* Mortis 11.2005
 * Alleys into the heart?  Roof of adv guild?
 */
...
{
    string desc = "";
	string road = "  Through the buildings to the northwest you spy the "
	+ "hedges of the nobles park, and towards the east off Nobil Row are "
	+ "several large estates.  Palanthas Circle curves north towards "
	+ "Nobles' Way and south where it intersects with Knight's High "
	+ "road.\n";
...
{
    SHORT("On Palanthas Circle southeast of the nobles park in the "
	+ "heart of the nobles district");
    LONG("@@get_time_desc@@");

	ITEM(({"estates", "estate", "noble estate", "noble estates"}),
	  "Through the buildings to the east can be seen some of the "
	...
	+ "and rising over ten feet to the northwest.  It is too dense to peer"
	+ "through.\n");
	...
	EXIT(NOBLE + "n10", "north", 0, 0);
	EXIT(NOBLE + "n12", "south", 0, 0);

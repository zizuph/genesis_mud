...
get_time_desc()
{
	...
	+ "park of Palanthas stretching to the south surrounding small oases "
	+ "of artfully arranged, exotic flowers, bushes, and short trees.  "
	+ "A hedge of tall bushes forms a wall around the park except south "
	+ "where the park fountain spouts arcs of water.  In front of the center "
	+ "of the north hedge is a curved flower patch of artfully arranged "
	+ "flowers.  ";
	...
	+ "Moonlight catches silver streams from the fountain to the south as "
...
void create_palan_room()
{
	...
	ITEM("fountain", "The fountain to your south is a small scale replica of "
	...
	+ "flowers sits in front of the north hedge of bushes.  To its south "
	...
	ITEM(({"bench", "grassy bench", "circle", "thick grass", "grass circle",
		   "circle of grass"}), "South of the flower patch by the north "
	...
	set_tell_time(140);
	add_tell("There is a rustling from the hedge to the north.  A "
	+ "red-breasted robin flaps vigorously as it flies out from the top.\n");
	...
	+ "trees.\n");
	add_tell("A humming bird hovers before a bright red summer lily to the "
	+ "southwest.\n");
	add_tell("A white rabbit pops its head out of the hedges to the "
	+ "southeast, and then is gone in a flash.\n");

...
#define SUBLOC			"_pal_facial_cucumber_subloc"

void
create_object()
{
    set_name("_pal_facial_cucumber");
    set_long("Subloc from cucumber paste facial from the Laethorian "
...
show_subloc(string subloc, object carrier, object for_obj)
{
	...
	string facial = "face is unbelievably smooth, fresh, and positively "
	+ "glowing!\nYou feel young and vibrant and more awake than you've "
	+ "been in ages!";
	...
	if (for_obj != carrier)
	{
		facial = " face appears unbelievably smooth, fresh, and positively "
		+ "glowing!\n" + C(pro) + " seems young, vibrant, and especially "
		+ "alert.";
	}

...
{
    string desc = "";
	string road = "  Nobil Row runs north towards several large, noble "
	+ "estates, and a side street that heads east towards the old, city "
	+ "wall.  A private road leads to the door of a great, four-story "
	+ "manor house estate to the west.\n";

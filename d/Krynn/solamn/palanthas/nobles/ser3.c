...
get_time_desc()
{
	...
	+ "Circle street intersects the road to the northwest, and to the "
...
create_palan_room()
{
    SHORT("On Knight's High road southeast of Inner Circle street");
    LONG("@@get_time_desc@@");

	EXIT(ROOM + "ser2", "northwest", 0, 0);
	EXIT(NOBLE + "ser4", "southeast", 0, 0);

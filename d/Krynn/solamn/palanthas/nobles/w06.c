...
{
    string desc = "";
	string road = "  Old Circle runs north along the city wall and south "
	+ "to the east gates.  Through the marble buildings to your west, you "
	+ "can make out some of the shops and cafes of the Plaisir district.  "
...
create_palan_room()
{
    SHORT("On Old Circle north of the eastern gates");
    LONG("@@get_time_desc@@");

	ITEM(({"cafes", "shops", "plaisir district"}), "The Plaisir district "
	...
	+ "through the buildings to the west.\n");
	...
	EXIT(NOBLE + "w05", "north", 0, 0);
	EXIT(NOBLE + "er5", "south", 0, 0);

...
void create_palan_room()
{
	...
	add_tell("An nearby bird trills sweetly, but you did not see from "
	+ "where it sang.\n");
	...
	add_smell("svampire", "Cool air blowing south off the bay mingles here "
	...
	+ "the immortals!  Please mail Mortis with your race.");

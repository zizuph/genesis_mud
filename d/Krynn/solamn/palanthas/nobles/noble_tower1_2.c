 ...
 * Add group of guards.  Assist below?
 */
...
get_time_desc()
{
	...
	+ "is bolted to the south wall and leads up to a trapdoor in the "
...
create_palan_room()
{
	...
	+ "ladder is bolted against the south wall and leads up to a trapdoor "
	+ "in the ceiling.\n");

	EXIT(NOBLE + "noble_tower1", "down", 0, 0);

	trapdoor = clone_object(NOBLE + "doors/tower2_trapdoor");
	trapdoor->move(TO);

/* Mortis 11.2005
 * Possible alley to southeast.  If so, add tell_rooms
 * to it when people go sw/ne.  Alley would be to alley
 * behind jewelers.
 */
...
void create_palan_room()
{
	...
	EXIT(NOBLE + "ner3", "southwest", "@@tell_watchers", 0);
	EXIT(NOBLE + "ner5", "northeast", 0, 0);

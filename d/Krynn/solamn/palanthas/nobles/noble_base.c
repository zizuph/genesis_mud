...
create_krynn_room()
{
    ...
    ITEM(({"building", "buildings"}), "Very old marble buildings, great and "
	+ "elaborate estates, and well-architected plazas and shops abound in "
	+ "the noble quarter of Palanthas some rising three to four stories.  "
	+ "The oldest buildings share a common architecture, a distinguishing "
	...
	+ "shops and noble estates, are not so antiquated in their styling "
	+ "and more frequently use smaller marble blocks.\n");

	ITEM(({"band", "bands", "relief", "reliefs"}), "Most of the old "
	...
	+ "Others bear popular lords and governors and their deeds which "
	+ "seem to be popular.\n");
	...
	+ "rises high above the palace in the palatial plaza to your west at city "
	+ "center.  The polished white marble finishing its walls and "
...
string get_time_item()
{
	...
	+ "throughout the noble quarter.  They are unlit now, but at night the "
	+ "area is well-lit thanks to them.\n";
	break;
    ...
    case TOD_TWILIGHT:
	ilamp = "Tall, grey lamp posts are arranged neatly along the streets "
	+ "throughout the noble quarter.  City lampiers are out with their long "
	+ "candlestaves lighting the lamps before darkness falls.\n";
	break;

	case TOD_NIGHT:
	ilamp = "Oil lamps atop tall, grey lamp posts glow yellow combining with "
	+ "starlight to evenly illuminate the streets of the noble quarter at "
	+ "night.\n";
	break;
    default:
	break;
...
get_day_crowd()
{
    ...
    {
	case TOD_DAWN:
    dcrowd += "The crowds have not yet picked up in the quarter though the "
	+ "early shoppers, deliverers, and messengers, all of which are mostly "
	+ "servants, are already going about their business.";
	break;

	case TOD_DAY:
	dcrowd += "Crowds of people move about the nobles quarter in the midday "
	+ "sun eating, drinking, and relaxing in the various districts.";
	break;

	case TOD_TWILIGHT:
    dcrowd += "The crowds of people moving about the nobles quarter have "
	+ "thinned since afternoon leaving it easier to make your way through the "
	+ "streets.  The strolling, relaxed evening crowd now mixes with the "
	+ "bustling afternoon shoppers.";
	break;

	case TOD_NIGHT:
	dcrowd += "Though most people have retired for the night, constables, "
	+ "nobles, servants, and revelers heading for the next tavern or "
	+ "Plaisir district still make their way about.";
	break;
	default:
	break;
	}
...
get_night_revel()
{
	...
	case TOD_NIGHT:
	drevel += "Having drinks and socializing is not uncommon in the "
	+ "nobles quarter, and nobles, merchants, and officials alike are all "
	+ "passing about on their way to various inns and taverns, mostly in "
	+ "the Plaisir district.";
	break;

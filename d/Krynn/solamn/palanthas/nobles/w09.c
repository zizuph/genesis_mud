...
{
    string desc = "";
	string road = "  Old Circle runs north along the curve of the city wall "
	+ "and southwest to the main city gates on Knight's High road.  The "
...
create_palan_room()
{
	...
	EXIT(NOBLE + "w08", "north", 0, 0);
	EXIT(NOBLE + "w10", "southwest", 0, 0);

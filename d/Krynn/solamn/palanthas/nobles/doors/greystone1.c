...
create_door()
{
    set_door_desc("The door leading northeast out onto Havecius Court is "
	+ "of thick, dark-stained mahogany.  Its dark, wrought iron handle "
	+ "bears ornate twists down its human hand sized length.\n");
    set_door_id("greystone_entrance");
    set_pass_command(({"ne","northeast", "out"}));
    set_door_name(({"door", "entrance", "exit"}));
    set_other_room(NOBLE + "grey_ent.c");
    set_open(1);
    ...
    set_close_mess(({"pushes the mahogany door closed.\n", "The " +

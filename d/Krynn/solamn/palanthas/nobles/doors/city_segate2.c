/*
 * The Southeast City Gate of Palanthas
 ...
 * doors.  Cannot be bribed for 15 plats to open the gates.  He does
...
create_door()
{
    set_door_desc("The SOUTHEAST Gate.\n");
    set_door_id("city_southeast_gate");
    set_pass_command(({"nw","northwest"}));
    set_door_name(({"gate", "southeast gate", "southeast gates",
	"city gate", "main city gate"}));
    set_other_room(NOBLE + "ser7.c");
    set_open(1);
    ...
    set_pick(80);
    set_lock_name("city_southeast_gate");
}

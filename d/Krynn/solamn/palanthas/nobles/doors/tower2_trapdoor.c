/*
 * Trap door in ceiling of second floor of guard tower
 * in Nobles quarter of Palanthas
 * 
 * Mortis 02.2006
 */
...
create_door()
{
	...
	+ "dark stained, thick oak planks set into the ceiling against the "
	+ "south wall.  It has a polished brass twist latch keeping it "
	+ "closed.\n");
    set_door_id("noble_gtower1");
    set_pass_command(({"u","up"}));
    set_door_name(({"trapdoor", "door", "latch"}));
    set_other_room(NOBLE + "noble_tower1_3.c");
    set_open(1);

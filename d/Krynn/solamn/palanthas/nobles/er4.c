...
get_time_desc()
{
	...
	+ "eastern gates while to the south begins Nobil Row where several "
	+ "of the great noble estates can be seen.\n";
...
{
    SHORT("On Nobles' Way in the heart of the nobles district");
    LONG("@@get_time_desc@@");

	ITEM(({"estates", "estate", "noble estate", "noble estates"}),
	  "To the south down Nobil Row can be seen some of the larger, great "
	...
	+ "through the buildings to the north.\n");

	EXIT(NOBLE + "er3", "west", 0, 0);
	EXIT(NOBLE + "er5", "east", 0, 0);
	EXIT(NOBLE + "n16", "south", 0, 0);

/* Mortis 11.2005
 * Alleys into surroundings?  Need smells or not?
 */
...
{
    string desc = "";
	string road = "  The buildings are packed in tightly here.  Towards "
	+ "the east off Nobil Row are several large estates.  Palanthas Circle "
	+ "curves north towards Nobles' Way and southwest where it intersects "
	+ "with Knight's High road.\n";
...
create_palan_room()
{
    SHORT("On Palanthas Circle northeast of Knight's High road");
    LONG("@@get_time_desc@@");
...
/*	add_smell("vampire", "Misty air blowing south off the bay mingles here "
	...
	EXIT(NOBLE + "n11", "north", 0, 0);
	EXIT(NOBLE + "ser5", "southwest", 0, 0);

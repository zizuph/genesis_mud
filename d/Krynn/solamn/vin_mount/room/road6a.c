...
create_vin_mount_room()
{
    ...
    set_long("The winding road continues in a general north-south "
        +    "direction winding itself up the mountainside.\n");

    OUTSIDE;

    add_exit(ROOM + "road5","north",0,4);
    add_exit(ROOM + "road6","south",0,1);

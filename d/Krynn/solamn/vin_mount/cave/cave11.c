...
create_vin_mount_room() 
{
	...
	+ "out to the southwest.  From the ceiling nearly seven meters above "
	+ "hang long stalactites, and portions of the floor are covered with straw "
	+ "and dead leaves.\n");
	...
	EXIT(CAVE + "cave09", "southwest", 0, 0);

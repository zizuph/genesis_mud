...
create_pax_room()
{
    ...
    set_long("You are standing in a light forest. The trees aren't " +
        ...
        "round slopes somewhat upwards. Large rocks lie around " +
        "and here and there, the naked rock of the mountains " +
        "breaks through the layer of soil covering them. North of " +
        "you the forest gets thinner and finally fades away into " +
        "the open. A small, almost invisible path, leads south " +
        "and southeast.\n");
    ...
    set_up_herbs( ({ KRHERB + "soapweed", KRHERB + "chicory", KRHERB + "wild_plum", KRHERB +"solinaith" }), 
    ...
    add_exit(VALLEY + "valley_road4", "north", 0, 1);
    add_exit(VALLEY + "forest4", "south", 0, 1);
    add_exit(VALLEY + "forest5", "southeast", 0, 1);
}

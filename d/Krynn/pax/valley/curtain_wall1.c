...
create_pax_room()
{
   set_short("At the inner curtain wall");
   set_long("You are standing in front of the gates in a wall " +
            "running across the valley in front of Pax Tharkas. The " +
            "wall functions as an extra line of defence, if the " +
            "fortress should be attacked. The gate here hasn't " +
            "been maintained, and is dangling useless from its hinges. " +
            "Looking south, upwards, you see the mighty fortress " +
            "looming in the pass above you, controlling it and " +
            "the road going through it. The road leads south, " +
            "upwards, towards the fortress, and north towards the " +
            "outer curtain wall.\n");
   ...
   add_item(({"gate", "gates"}), "Once these must have been powerful " +
            "gates closing the opening in the curtain wall. Years " +
            "without maintenance has left the gates hanging useless " +
            "from their hinges.\n");
   ...
   add_exit(VALLEY + "curtain_wall2", "north", 0);
   add_exit(VALLEY + "main_gate", "south", 0);
}

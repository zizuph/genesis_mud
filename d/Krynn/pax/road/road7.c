...
create_pax_room()
{
   ...
   add_item("water", "East, beyond the plains, you see water. " +
            "It is probably the sea, Newsea, you can catch a glimpse " +
            "of in the distance.\n");
   ...
   add_exit(QUE + "road2", "northeast", 0);
   add_exit(ROAD + "road6", "southwest", 0);
}
...
long_descr()
{
   ...
   ret_str = "You are standing on a road traversing the open " +
             ...
             "Kharolis mountains stretches across the horizon, " +
             "like a wall, from east to west. Northwest and west " +
             "you can see the green canopy of a huge forest. Looking " +
             "east, you catch a glimpse of water beyond the plains. " +
             "The road leads southwest across the plains towards the " +
             "mountains, and northeast across the open plains. ";

...
my_desc()
{
    ...
    desc = "You are standing in the middle of a large hall, obviously " +
	"constructed with care in some distant age. A wide center " +
	"aisle stretches east and westward into the darkness. This is the " +

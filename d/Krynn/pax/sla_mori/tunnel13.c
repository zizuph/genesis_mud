...
create_pax_room()
{
    ...
    set_long("You are standing in a narrow winding tunnel. The tunnel turns " +
	"here to continue north and east. Loose chunks " +
    ...
    add_exit(PSLA + "tunnel12", "north");
    add_exit(PSLA + "tunnel14", "east");

...
create_pax_room()
{
	...
	"a turn here and continues north and west. The north is a narrow " +
	"crossroad. Loose chunks of rock and a thick layer of dust covers " +
	"the floor.\n");
    ...
    add_exit(PSLA + "tunnel09", "north");
    add_exit(PSLA + "tunnel14", "west");

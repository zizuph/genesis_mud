...
create_pax_room()
{
   ...
   set_long("You are standing on a wide landing between two " +
            ...
            "The dark walls and stairs look cold and uninviting " +
            "rock. A vague draft is coming from above. On the wall a " +
            "small iron oil lamp shines with a faint light.\n");
   ...
   add_exit(WALL_LEVEL + "wall3", "east", 0);
   add_exit(WALL_LEVEL + "stair_to_wtow2", "up", 0, 1);
   add_exit(WALL_LEVEL + "ne_barrack", "down", 0);
} 

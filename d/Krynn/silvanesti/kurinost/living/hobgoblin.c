...
arm_me()
{
    ...
    clone_object(RSWEAPON + "hobgmace")->move(TO, 1);
    command("wield all");

    clone_object(RSARMOUR + "hobgshield")->move(TO, 1);
...
public void react_to_intro(string who)
{
    ...
    {
        // Player is gone!
        command("shout What! Where you go?!");
    ...
    else
    {
        ...
        {
            command("say to " + who + " What?! You ELF! Me eat you!");
            command("shout Wuagh! Kill food! Eat!");
            command("kill " + who);
            command("kill " + who);
        ...
        if (race == "orc" || race == "goblin" || race == "ogre")
        {
            command("say to " + who + " You da big one! You kill elf too!");

            return;
        }

        command("say to " + who + " Who yoo? Not Elf, not eat yoo.");
    }
}
...
special_attack(object enemy)
{
    ...
    if (!random(8))
    {
        hitresult = enemy->hit_me(120 + random(50), W_BLUDGEON, TO, -1);
        ...
        switch (random(2))
        {
            case 0:
                watcher_desc = "Dark red eyes glaring with " +
                    ...
                    " with a wild swing of his green-hilted iron " +
                    "mace. ";
                hit_desc = "Dark red eyes glaring with bloodlust, " +
                    QTNAME(TO) + " rushes madly forward, trying " +
                    "to hit you with a wild swing of his green-" +
                    "hilted iron mace. ";
                break;
            ...
            case 1:
                watcher_desc = "With a scream of rage, " +
                    ...
                    "swing of his green-hilted iron mace. ";

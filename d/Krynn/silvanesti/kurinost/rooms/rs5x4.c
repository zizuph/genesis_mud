...
{
    set_height_above_ocean("fourtyfive");

    // Always put cactus here.
    add_vegetation(2);
    ...
    add_exit(RSROOMS + "rs6x4", "east", descend_path, 2);
    add_exit(RSROOMS + "rs4x4", "west", ascend_path, MOUNT_FATIGUE);

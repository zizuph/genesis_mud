...
create_icewall_room()
{
    ...
    add_exit("conquer42","north","@@north",1,1);
    add_exit("conquer43","northeast","@@northeast",1,1);
    add_exit("conquer44","west","@@west",1,1);
    add_exit("conquer41","northwest","@@northwest",1,1);
...
{ return ("" +
   ...
   "Except to the south and east, where huge ice cliffs block the way " +

...
create_icewall_room()
{
    ...
    add_exit("conquer15","north","@@north",1,1);
    add_exit("conquer22","southwest","@@southwest",1,1);
    add_exit("conquer23","south","@@south",1,1);
    add_exit("conquer17","west","@@west",1,1);
    add_exit("snow_plain6","northwest","@@northwest",1,1);
    add_exit("snow_plain8","east","@@east",1,1);
    ...
    add_item(({"sled marks","marks"}),"The sharp, frozen " +
      ...
      "in the frozen land. The sled marks lead east and northwest here.\n");

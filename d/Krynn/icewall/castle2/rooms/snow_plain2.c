...
create_icewall_room()
{
   ...
   set_area_name(WAR_AREA_ICEWALL);
    ...
    add_exit("conquer10","northwest","@@northwest",1,1);
    add_exit("conquer11","north","@@north",1,1);
    add_exit("conquer12","northeast","@@northeast",1,1);
    add_exit("conquer18","southwest","@@southwest",1,1);
    add_exit("conquer19","south","@@south",1,1);
    add_exit("conquer20","southeast","@@southeast",1,1);
    add_exit("snow_plain1","west","@@west",1,1);
    add_exit("snow_plain3","east","@@east",1,1);
...
{ return ("" +
   ...
   "your west, quite some distance away, a hill raises from the " +
   "everpresent whiteness. Upon it, squinting, you can make out " +
   "an ice-covered, gloomy castle. There are some sled marks " +
   "visible here.\n");

...
create_icewall_room()
{
    ...
    add_exit("snow_plain5","west","@@west",1,1);
    add_exit("snow_plain7","east","@@east",1,1);  
    add_exit("conquer21","southwest","@@southwest",1,1);
    add_exit("conquer22","south","@@south",1,1);
    add_exit("conquer23","southeast","@@southeast",1,1);
    add_exit("conquer15","northeast","@@northeast",1,1);
    add_exit("snow_plain6","north","@@north",1,1);
    add_exit("conquer14","northwest","@@northwest",1,1);

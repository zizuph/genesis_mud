...
create_icewall_room()
{
    ...
    add_exit("conquer25","west","@@west",1,1);
    add_exit("conquer27","east","@@east",1,1);  
    add_exit("conquer31","south","@@south",1,1);
    add_exit("conquer32","southeast","@@southeast",1,1);
    add_exit("conquer30","southwest","@@southwest",1,1);
    add_exit("conquer21","northeast","@@northeast",1,1);
    add_exit("snow_plain4","north","@@north",1,1);
    add_exit("conquer20","northwest","@@northwest",1,1);

...
create_icewall_room()
{
    ...
    add_exit("conquer1","west","@@west",1,1);
    add_exit("conquer3","east","@@east",1,1);  
    add_exit("conquer6","southwest","@@southwest",1,1);
    add_exit("conquer7","south","@@south",1,1);
    add_exit("conquer8","southeast","@@southeast",1,1);

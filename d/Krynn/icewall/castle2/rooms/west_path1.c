...
create_icewall_room()
{
    set_short("Deep in an arctic canyon");
    set_long("@@long_descr");


    add_exit("cliff_new","north");
    add_exit("west_path2","south");
...
{ return ("" +
  "You are deep within the arctic canyon. High above you, standing " +
  "on the cliff to the east, looms the dark Icewall Castle. " +
  "High, snow-capped mountains rise to the north and west. " +
...
do_avalanche()
{
    write("\nAs you shout, the cliffs above you shake and rumble! " +
          "Frozen, you catch your breath as mounds of snow cascade " +
          "down upon you head!\nBefore you even manage to panic, the " +
          "snow reaches up to over your waist! Fearing the worst, you " +
          "glance up, but the rumble stops, and " +
          "the cliffs quiet down. The avalanche spared you this time.\n\n");
    say("As " + QTNAME(TP) + " shouts, the cliffs above you " +
          "shake and rumble! Frozen, you catch your breath as " +
          "mounds of snow cascade down on your head!\nBefore you " +
          "even manage to panic, the snow reaches up to over your " +
          "waist! Fearing the worst, you glance up, but the rumble " +
          "stops, and the cliffs quiet down. The avalanche " +
          "bids it time.\n\n");
    return 0;
}

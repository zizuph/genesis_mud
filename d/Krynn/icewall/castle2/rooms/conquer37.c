...
create_icewall_room()
{
    ...
    add_exit("conquer36","west","@@west",1,1);
    add_exit("conquer32","northwest","@@northwest",1,1);
    add_exit("conquer33","north","@@north",1,1);
    add_exit("conquer34","northeast","@@northeast",1,1);
    add_exit("conquer38","east","@@east",1,1);
    add_exit("conquer42","southeast","@@southeast",1,1);
    add_exit("conquer41","south","@@south",1,1);
    add_exit("conquer40","southwest","@@southwest",1,1);

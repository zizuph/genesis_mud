...
create_icewall_room()
{
    ...
    add_exit("conquer34","west","@@west",1,1);
    add_exit("conquer38","southwest","@@southwest",1,1);
    add_exit("conquer39","south","@@south",1,1);
    add_exit("conquer29","northwest","@@northwest",1,1);

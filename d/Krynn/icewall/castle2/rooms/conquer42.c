...
create_icewall_room()
{
    ...
    add_exit("conquer41","west","@@west",1,1);
    add_exit("conquer37","northwest","@@northwest",1,1);
    add_exit("conquer38","north","@@north",1,1);
    add_exit("conquer39","northeast","@@northeast",1,1);
    add_exit("conquer43","east","@@east",1,1);
    add_exit("conquer44","southwest","@@southwest",1,1);
    add_exit("conquer45","south","@@south",1,1);

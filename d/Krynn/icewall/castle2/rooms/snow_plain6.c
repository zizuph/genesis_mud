...
create_icewall_room()
{
    ...
    add_exit("conquer14","west","@@west",1,1);
    add_exit("conquer15","east","@@east",1,1);
    add_exit("conquer9","northeast","@@northeast",1,1);
    add_exit("conquer8","north","@@north",1,1);
    add_exit("conquer7","northwest","@@northwest",1,1);
    add_exit("conquer17","south","@@south",1,1);
    add_exit("snow_plain5","southwest",0,1,1);
    add_exit("snow_plain7","southeast",0,1,1);
    ...
    add_item(({"sled marks","marks"}),"The sharp, frozen " +
      ...
      "in the frozen land. The sled marks here lead southeast and southwest, " +
      "which worries you a bit. Does the sudden turn mean that the " +
      "sled owners lost their " +
      "way? Are you to stumble shortly upon their frozen remains?\n");

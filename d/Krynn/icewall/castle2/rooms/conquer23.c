...
create_icewall_room()
{
    ...
    add_exit("conquer22","west","@@west",1,1);
    add_exit("conquer28","southwest","@@southwest",1,1);
    add_exit("conquer29","south","@@south",1,1);
    add_exit("conquer17","northwest","@@northwest",1,1);
    add_exit("snow_plain7","north","@@north",1,1);

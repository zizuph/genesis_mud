...
create_icewall_room()
{
    ...
    add_exit("conquer24","west","@@west",1,1);
    add_exit("conquer26","east","@@east",1,1);  
    add_exit("conquer30","south","@@south",1,1);
    add_exit("conquer31","southeast","@@southeast",1,1);
    add_exit("snow_plain4","northeast","@@northeast",1,1);
    add_exit("conquer20","north","@@north",1,1);
    add_exit("conquer19","northwest","@@northwest",1,1);

...
create_icewall_room()
{
    ...
    add_exit("conquer37","west","@@west",1,1);
    add_exit("conquer33","northwest","@@northwest",1,1);
    add_exit("conquer34","north","@@north",1,1);
    add_exit("conquer35","northeast","@@northeast",1,1);
    add_exit("conquer39","east","@@east",1,1);
    add_exit("conquer43","southeast","@@southeast",1,1);
    add_exit("conquer42","south","@@south",1,1);
    add_exit("conquer41","southwest","@@southwest",1,1);

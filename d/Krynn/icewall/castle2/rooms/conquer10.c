...
create_icewall_room()
{
    ...
    add_exit("conquer4","northeast","@@northeast",1,1);
    add_exit("conquer11","east","@@east",1,1);
    add_exit("snow_plain1","south","@@south",1,1);
    add_exit("snow_plain2","southeast","@@southeast",1,1);
   ...
   add_item(({"cliff","icy cliff","cliffs","icy cliffs"}),"Tall and " +
     ...
     "ice plains.\n");
   add_item(({"shape","hilltop","snowy hilltop","dark shape"}),"" +
     "It reminds you of an ice-bound castle perched high over the " +
     "endless fields of snow. You are too far to notice any details, " +
     "though.\n");
...
{ return ("" +
   ...
   "Except to the north and west, where huge ice cliffs block the way " +
   "and your line of sight. Far to the southwest, a dark shape rises " +
   "from a snowy hilltop.\n");

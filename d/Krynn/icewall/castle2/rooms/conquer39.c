...
create_icewall_room()
{
    ...
    add_exit("conquer35","north","@@north",1,1);
    add_exit("conquer38","west","@@west",1,1);
    add_exit("conquer42","southwest","@@southwest",1,1);
    add_exit("conquer43","south","@@south",1,1);
    add_exit("conquer34","northwest","@@northwest",1,1);

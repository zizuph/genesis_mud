...
create_icewall_room()
{
    ...
    add_exit("snow_plain3","west","@@west",1,1);
    add_exit("snow_plain5","east","@@east",1,1);  
    add_exit("conquer20","southwest","@@southwest",1,1);
    add_exit("snow_plain4","south","@@south",1,1);
    add_exit("conquer21","southeast","@@southeast",1,1);
    add_exit("conquer14","northeast","@@northeast",1,1);
    add_exit("conquer13","north","@@north",1,1);
    add_exit("conquer12","northwest","@@northwest",1,1);

...
create_icewall_room()
{
    ...
    add_exit("conquer2","west","@@west",1,1);
    add_exit("conquer7","southwest","@@southwest",1,1);
    add_exit("conquer7","south","@@south",1,1);
    add_exit("conquer9","southeast","@@southeast",1,1);
...
{ return ("" +
   ...
   "Except to the east and north, where huge ice cliffs block the way " +

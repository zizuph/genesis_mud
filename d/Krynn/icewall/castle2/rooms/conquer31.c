...
create_icewall_room()
{
    ...
    add_exit("conquer30","west","@@west",1,1);
    add_exit("conquer25","northwest","@@northwest",1,1);
    add_exit("conquer26","north","@@north",1,1);
    add_exit("conquer27","northeast","@@northeast",1,1);
    add_exit("conquer32","east","@@east",1,1);
    add_exit("conquer36","southeast","@@southeast",1,1);
...
{ return ("" +
   ...
   "Except to the south, where huge ice cliffs block the way " +

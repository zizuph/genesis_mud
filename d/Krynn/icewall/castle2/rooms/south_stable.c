...
create_icewall_room()
{
    set_short("South stable staircase");
    set_long("@@long_descr");

    add_exit("stable","north","@@north");
    add_exit("battlement1","up","@@up");
    ...
    add_item(({"passageway","passageways"}),"Wide passageway " +
     "leads north towards what was long ago the castle's stable. " +
...
{ return ("" +
     ...
     "there. A wide passageway leads north, into the stable.\n");    

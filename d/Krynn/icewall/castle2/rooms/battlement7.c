...
create_icewall_room()
{
    ...
    add_exit("battlement8","south");
    add_exit("battlement6","north");
    add_exit("north_guard","down","@@down");
...
{ return ("" +
     "This is the east battlement. Some distance to the south " +
     "the enclosed blanks connect with the main building " +
     "while further north, the corridor turns west. " +
...
do_gaze(string str)
{
   ...
   write("Looking far out, you can make a flat and wide field " +
           ...
           "bit to the south, a steep path leads up the cliff to " +

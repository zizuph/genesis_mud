...
create_icewall_room()
{
    ...
    add_exit("conquer31","northwest","@@northwest",1,1);
    add_exit("conquer32","north","@@north",1,1);
    add_exit("conquer33","northeast","@@northeast",1,1);
    add_exit("conquer37","east","@@east",1,1);
    add_exit("conquer41","southeast","@@southeast",1,1);
    add_exit("conquer40","south","@@south",1,1);
...
{ return ("" +
   ...
   "Except to the west, where huge ice cliffs block the way " +

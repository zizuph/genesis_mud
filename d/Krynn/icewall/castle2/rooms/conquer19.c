...
create_icewall_room()
{
    ...
    add_exit("conquer18","west","@@west",1,1);
    add_exit("conquer20","east","@@east",1,1);  
    add_exit("conquer24","south","@@south",1,1);
    add_exit("conquer25","southeast","@@southeast",1,1);
    add_exit("snow_plain1","northwest","@@northwest",1,1);
    add_exit("snow_plain3","northeast","@@northeast",1,1);
    add_exit("snow_plain2","north","@@north",1,1);

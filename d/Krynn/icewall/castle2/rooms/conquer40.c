...
create_icewall_room()
{
    ...
    add_exit("conquer36","north","@@north",1,1);
    add_exit("conquer37","northeast","@@northeast",1,1);
    add_exit("conquer41","east","@@east",1,1);
    add_exit("conquer44","southeast","@@southeast",1,1);

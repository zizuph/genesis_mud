...
create_icewall_room()
{
    ...
    add_exit("conquer24","northwest","@@northwest",1,1);
    add_exit("conquer25","north","@@north",1,1);
    add_exit("conquer26","northeast","@@northeast",1,1);
    add_exit("conquer31","east","@@east",1,1);

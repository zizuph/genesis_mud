...
create_icewall_room()
{
    ...
    add_exit("conquer11","west","@@west",1,1);
    add_exit("conquer13","east","@@east",1,1);  
    add_exit("snow_plain2","southwest","@@southwest",1,1);
    add_exit("snow_plain3","south","@@south",1,1);
    add_exit("conquer16","southeast","@@southeast",1,1);
    add_exit("conquer6","northeast","@@northeast",1,1);
    add_exit("conquer5","north","@@north",1,1);
    add_exit("conquer4","northwest","@@northwest",1,1);

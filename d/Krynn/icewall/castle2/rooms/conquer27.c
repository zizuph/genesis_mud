...
create_icewall_room()
{
    ...
    add_exit("conquer26","west","@@west",1,1);
    add_exit("conquer28","east","@@east",1,1);  
    add_exit("conquer32","south","@@south",1,1);
    add_exit("conquer33","southeast","@@southeast",1,1);
    add_exit("conquer31","southwest","@@southwest",1,1);
    add_exit("conquer22","northeast","@@northeast",1,1);
    add_exit("conquer21","north","@@north",1,1);
   add_exit("snow_plain4","northwest","@@northwest",1,1);

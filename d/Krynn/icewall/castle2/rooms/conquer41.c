...
create_icewall_room()
{
    ...
    add_exit("conquer40","west","@@west",1,1);
    add_exit("conquer36","northwest","@@northwest",1,1);
    add_exit("conquer37","north","@@north",1,1);
    add_exit("conquer38","northeast","@@northeast",1,1);
    add_exit("conquer42","east","@@east",1,1);
    add_exit("conquer45","southeast","@@southeast",1,1);
    add_exit("conquer44","south","@@south",1,1);

...
create_icewall_room()
{
    ...
    add_exit("conquer39","north","@@north",1,1);
    add_exit("conquer42","west","@@west",1,1);
    add_exit("conquer45","southwest","@@southwest",1,1);
    add_exit("conquer38","northwest","@@northwest",1,1);
...
{ return ("" +
   ...
   "To the east and south, huge blocks of ice rise from coast, blocking " +

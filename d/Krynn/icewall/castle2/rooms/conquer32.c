...
create_icewall_room()
{
    ...
    add_exit("conquer31","west","@@west",1,1);
    add_exit("conquer26","northwest","@@northwest",1,1);
    add_exit("conquer27","north","@@north",1,1);
    add_exit("conquer28","northeast","@@northeast",1,1);
    add_exit("conquer33","east","@@east",1,1);
    add_exit("conquer37","southeast","@@southeast",1,1);
    add_exit("conquer36","south","@@south",1,1);

...
create_icewall_room()
{
    ...
    add_exit("conquer4","west","@@west",1,1);
    add_exit("conquer6","east","@@east",1,1);  
    add_exit("conquer11","southwest","@@southwest",1,1);
    add_exit("conquer12","south","@@south",1,1);
    add_exit("conquer13","southeast","@@southeast",1,1);
    add_exit("conquer1","northeast","@@northeast",1,1);
...
{ return ("" +
   ...
   "Except to the north, where huge ice cliffs block the way " +

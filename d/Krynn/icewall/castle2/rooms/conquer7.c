...
create_icewall_room()
{
    ...
    add_exit("conquer6","west","@@west",1,1);
    add_exit("conquer8","east","@@east",1,1);  
    add_exit("conquer13","southwest","@@southwest",1,1);
    add_exit("conquer14","south","@@south",1,1);
    add_exit("snow_plain6","southeast","@@southeast",1,1);
    add_exit("conquer3","northeast","@@northeast",1,1);
    add_exit("conquer2","north","@@north",1,1);
    add_exit("conquer1","northwest","@@northwest",1,1);

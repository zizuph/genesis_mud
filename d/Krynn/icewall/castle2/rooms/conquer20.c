...
create_icewall_room()
{
    ...
    add_exit("conquer19","west","@@west",1,1);
    add_exit("snow_plain4","east","@@east",1,1);  
    add_exit("conquer24","southwest","@@southwest",1,1);
    add_exit("conquer25","south","@@south",1,1);
    add_exit("conquer26","southeast","@@southeast",1,1);
    add_exit("snow_plain2","northwest","@@northwest",1,1);
    add_exit("conquer16","northeast","@@northeast",1,1);
    add_exit("snow_plain3","north","@@north",1,1);

...
create_icewall_room()
{
    ...
    add_exit("snow_plain2","northeast","@@northeast",1,1);
    add_exit("conquer19","east","@@east",1,1);
    add_exit("snow_plain1","north","@@north",1,1);
    add_exit("conquer24","southeast","@@southeast",1,1);
...
{ return ("" +
   ...
   "and your line of sight. Far to the northwest, a dark shape rises " +

...
create_icewall_room()
{
    ...
    add_exit("conquer32","west","@@west",1,1);
    add_exit("conquer27","northwest","@@northwest",1,1);
    add_exit("conquer28","north","@@north",1,1);
    add_exit("conquer29","northeast","@@northeast",1,1);
    add_exit("conquer34","east","@@east",1,1);
    add_exit("conquer38","southeast","@@southeast",1,1);
    add_exit("conquer37","south","@@south",1,1);
    add_exit("conquer36","southwest","@@southwest",1,1);

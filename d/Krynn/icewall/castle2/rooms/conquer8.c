...
create_icewall_room()
{
    ...
    add_exit("conquer7","west","@@west",1,1);
    add_exit("conquer9","east","@@east",1,1);  
    add_exit("conquer14","southwest","@@southwest",1,1);
    add_exit("snow_plain6","south","@@south",1,1);
    add_exit("conquer15","southeast","@@southeast",1,1);
    add_exit("conquer3","north","@@north",1,1);
    add_exit("conquer2","northwest","@@northwest",1,1);

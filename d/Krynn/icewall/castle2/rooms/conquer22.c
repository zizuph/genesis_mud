...
create_icewall_room()
{
    ...
    add_exit("conquer21","west","@@west",1,1);
    add_exit("conquer23","east","@@east",1,1);  
    add_exit("conquer27","southwest","@@southwest",1,1);
    add_exit("conquer28","south","@@south",1,1);
    add_exit("conquer29","southeast","@@southeast",1,1);
    add_exit("snow_plain5","northwest","@@northwest",1,1);
    add_exit("snow_plain7","northeast","@@northeast",1,1);
    add_exit("conquer17","north","@@north",1,1);

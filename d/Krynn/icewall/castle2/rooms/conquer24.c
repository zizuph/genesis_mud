...
create_icewall_room()
{
    ...
    add_exit("conquer18","northwest","@@northwest",1,1);
    add_exit("conquer20","northeast","@@northeast",1,1);
    add_exit("conquer25","east","@@east",1,1);
    add_exit("conquer19","north","@@north",1,1);
    add_exit("conquer30","southeast","@@southeast",1,1);

...
create_icewall_room()
{
    ...
    add_exit("conquer13","west","@@west",1,1);
    add_exit("snow_plain6","east","@@east",1,1);  
    add_exit("conquer16","southwest","@@southwest",1,1);
    add_exit("snow_plain5","south","@@south",1,1);
    add_exit("conquer17","southeast","@@southeast",1,1);
    add_exit("conquer8","northeast","@@northeast",1,1);
    add_exit("conquer7","north","@@north",1,1);
    add_exit("conquer6","northwest","@@northwest",1,1);

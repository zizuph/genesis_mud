...
create_icewall_room()
{
    ...
    add_exit("conquer33","west","@@west",1,1);
    add_exit("conquer28","northwest","@@northwest",1,1);
    add_exit("conquer29","north","@@north",1,1);
    add_exit("conquer35","east","@@east",1,1);
    add_exit("conquer39","southeast","@@southeast",1,1);
    add_exit("conquer38","south","@@south",1,1);
    add_exit("conquer37","southwest","@@southwest",1,1);

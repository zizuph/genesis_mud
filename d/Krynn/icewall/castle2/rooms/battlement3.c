...
create_icewall_room()
{
    ...
    add_exit("battlement2","south");
    add_exit("battlement4","north");
    add_exit("north_stable","down","@@down");

    add_item(({"stairway","stairs"}),"A circular stone staircase " +
     "situated in the middle of the battlements floor leads down, " +
...
{ return ("" +
     "This is the west battlement. Some distance to the south " +
     "the enclosed blanks connect with the main building " +
     "while further north, the corridor turns east. " +
     "In the thick walls on both sides of the battlement, " +
     ...
     "located in the middle of the battlement's floor leads down, " +
    ...
    if(str == "through outward slit" || str == "out through outward slit")
      {
         write("Looking far out, you can make a range of snow " +
           ...
           "straight down, into a deep arctic canyon. " +
           "Any attack from this side suicidal, if not " +
           "impossible.\n");

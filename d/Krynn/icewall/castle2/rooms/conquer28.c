...
create_icewall_room()
{
    ...
    add_exit("conquer27","west","@@west",1,1);
    add_exit("conquer29","east","@@east",1,1);  
    add_exit("conquer33","south","@@south",1,1);
    add_exit("conquer34","southeast","@@southeast",1,1);
    add_exit("conquer32","southwest","@@southwest",1,1);
    add_exit("conquer23","northeast","@@northeast",1,1);
    add_exit("conquer22","north","@@north",1,1);
    add_exit("conquer21","northwest","@@northwest",1,1);

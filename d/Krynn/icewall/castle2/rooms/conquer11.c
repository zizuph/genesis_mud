...
create_icewall_room()
{
    ...
    add_exit("conquer10","west","@@west",1,1);
    add_exit("conquer12","east","@@east",1,1);  
    add_exit("snow_plain1","southwest","@@southwest",1,1);
    add_exit("snow_plain2","south","@@south",1,1);
    add_exit("snow_plain3","southeast","@@southeast",1,1);
    add_exit("conquer5","northeast","@@northeast",1,1);
    add_exit("conquer4","north","@@north",1,1);

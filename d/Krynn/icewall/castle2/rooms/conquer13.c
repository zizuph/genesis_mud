...
create_icewall_room()
{
    ...
    add_exit("conquer12","west","@@west",1,1);
    add_exit("conquer14","east","@@east",1,1);  
    add_exit("snow_plain3","southwest","@@southwest",1,1);
    add_exit("conquer16","south","@@south",1,1);
    add_exit("snow_plain5","southeast","@@southeast",1,1);
    add_exit("conquer7","northeast","@@northeast",1,1);
    add_exit("conquer6","north","@@north",1,1);
    add_exit("conquer5","northwest","@@northwest",1,1);

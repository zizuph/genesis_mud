...
create_icewall_room()
{
    ...
    add_exit("conquer5","west","@@west",1,1);
    add_exit("conquer7","east","@@east",1,1);  
    add_exit("conquer12","southwest","@@southwest",1,1);
    add_exit("conquer13","south","@@south",1,1);
    add_exit("conquer14","southeast","@@southeast",1,1);
    add_exit("conquer2","northeast","@@northeast",1,1);
    add_exit("conquer1","north","@@north",1,1);

...
create_icewall_room()
{
    ...
    add_exit("conquer8","west","@@west",1,1);
    add_exit("snow_plain6","southwest","@@southwest",1,1);
    add_exit("conquer15","south","@@south",1,1);
    add_exit("conquer3","northwest","@@northwest",1,1);
...
{ return ("" +
   ...
   "To the east and north, huge blocks of ice rise from coast, blocking " +

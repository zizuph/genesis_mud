...
create_icewall_room()
{
    ...
    add_exit("snow_plain6","west","@@west",1,1);
    add_exit("conquer17","southwest","@@southwest",1,1);
    add_exit("snow_plain7","south","@@south",1,1);
    add_exit("conquer8","northwest","@@northwest",1,1);
    add_exit("conquer9","north","@@north",1,1);

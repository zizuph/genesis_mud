...
create_minotaur()
{
    ...
    add_act("emote rolls a barrel towards a rack.");
    add_act("emote lifts a barrel into " +
      "the air and sets it on a rack.");
    add_act("emote moves a heavy crate under the north wall, " +
      "obviously to make room for new supplies.");
    add_act("emote grunts and sweats.");

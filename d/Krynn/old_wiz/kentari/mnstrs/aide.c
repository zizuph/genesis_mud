...
create_krynn_monster()
{
    ...
    set_default_answer("The aide says: I'm sorry Master, but that " +
	"is beyond my knowledge and duties.\n");
   
    add_ask(" [about] 'element' / 'fire' / 'air' / 'earth' / " +
	"'water' / 'death' / 'life' / 'elements'",
            "The aide says: The ability to harness the various " +
	...
	"raw magical material of the universe.\n");
    add_ask(" [about] 'form' / 'forms' / 'abjuration' / 'conjuration' / " +
	"'enchantment' / 'transmutation' / 'illusion'", 
	"The aide says: The forms of magic constitute the type of spell " +
	...
	"magic that Wizard concentrates on.\n");
    add_ask(" [about] 'herbalism' / 'herbs'", 
	"The aide replies: Identifying herbs and knowing how to use " +
	"is an important skill for any caster of magic, for unless " +
	"you wish to spend your days waiting for your mental energies "+
	"to heal, a knowledge of the local fauna is essential.\n");
    add_ask(" [about] 'spells' / 'spellcraft'",
	"The aide explains: The most basic of a Wizard's skill, being " +
	...
	"The aide tells you: I thank you for your offer, but I am but " +
	"a lowly servant here and have no needs.\n");
    ...
    add_act("say Would you care to train in the arcane arts Master?");

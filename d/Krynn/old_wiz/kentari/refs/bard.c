...
create_krynn_monster()
{
   ...
   set_default_answer("Celeste softly whispers: I'm sorry, I can't answer "
      +"that request.\n");
   add_ask(({"huma","Huma","song of huma","Song of Huma"}),"@@huma_song", 1);
   add_ask(({"canticle","Canticle","dragon","Dragon","canticle of the dragon",
            "Canticle of the Dragon","dragons","Dragons"}),
      "@@canticle_song", 1);
   add_ask(({"death chant","chant","Chant","Death Chant",
            "Death Chant of the Solamnic Knights",
            "death chant of the Solamnic Knights",
            "death chant of the solamnic knights"}),
      "@@death_chant", 1);
   add_ask(({"song","songs","sing"}),"Celeste whispers: People have made "+
      "many requests of me for songs...which one would you like "+
      "to hear?\n");
   add_ask(({"request","requests"}),"Celeste softly states: I have had "+
      "requests for parts of the Song of Huma, I know the first "+
      "portion of the Canticle of the Dragon, and, also, I know "+
      "the Death Chant of the Solamnic Knights.\n");
...
attacked_by(object ob)
{
   ...
   seteuid(getuid());
   if (cloned == 0)
      clone_object("/d/Krynn/solamn/vkeep/mnstrs/stephen")->move(environment());
   cloned = 1;
}
...
equip_me()
{
   clone_object(VOBJ + "lyre")->move(TO);
}

public int
second_life(object killer)
   {
   K_KILL_LOG("kills", "Celeste Softsulle", killer);
   return 0;
}

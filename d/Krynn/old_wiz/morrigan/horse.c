...
#define RIDER_OBJECT "/d/Krynn/morrigan/open/rider_object"
#define RIDER_SUBLOC "_live_i_mounted"
#define RIDER_SHADOW "/d/Krynn/morrigan/open/horse_shadow"
...
void do_mount(object who)
{
    ...
    TO->unset_no_show();
    TO->set_rider(who);
    clone_object(RIDER_SHADOW)->shadow_me(query_rider());
...
void do_dismount()
{
    ...
    query_rider()->remove_shadow(RIDER_SHADOW);

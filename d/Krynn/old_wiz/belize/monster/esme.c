...
gagged_long()
{
    return "You recognize the guildmaster of the Solamnian " +
...
create_krynn_monster()
{
    ...
    set_race_name("human");
    set_title("Uth Wistan, the Grand Master of the Knights of Solamnia");
    set_long("@@normal_long@@");
    set_extra_long("He is wearing the medal of the Solamnian Knighthood, "+
		   "and he is the Grand Master of the Solamnian Knights.\n");
    set_adj("noble");
    add_adj("intense");
    set_gender(G_MALE);
    add_prop(NPC_I_NO_LOOKS,1);
    set_alarm(5.0,0.0,
               "add_cmdsoul","/d/Krynn/solamn/guild/obj/solamnian_soul");
    ...
    add_act("emote stares at you with intensity, seemingly reading " +
            "your soul.");
    add_act("emote clutches the medallion he wears around his neck " +
            "and utters a prayer.");
    ...
    set_default_answer("Gunthar declares: I am afraid I cannot help you, " +
                       "you will have to seek another.\n");
    add_ask(" [about] 'conclave'", "Gunthar responds: Currently, the " +
            "Conclave of the Knights of the Solamnia are: "+CROWN+ " of the " +
            "Order of the Crown, "+SWORD+ " of the Order of the Sword, and " +
            ROSE+ " of the Order of the Rose.\n");
    add_ask(" [about] 'crown'", "Gunthar voices: The Order of the Crown " +
            "is currently headed by "+CROWN+". This Order represents " +
            "the virtues of loyalty and obedience. Habbakuk is the " +
            "patron god.\n");
    add_ask(" [about] 'sword'", "Gunthar sounds: The Order of the Sword " +
            "is currently headed by "+SWORD+". Kiri-Jolith is the patron " +
            "god of this Order that represents courage and heroism.\n");
    add_ask(" [about] 'rose'", "Gunthar declares: The Order of the Rose " +
            "is led by the High Justice, "+ROSE+". Paladine is the patron " +
            "god of this Order that values honour and justice.\n");
    add_ask(" [about] 'vingaard'", "Gunthar proudly states: Vingaard Keep " +
            "has never fallen to the forces of evil. And by the gods, it " +
            "never will!\n");
    add_ask(" [about] 'task' / 'quest'", "Gunthar sternly says: Read the " +
            "sign for instructions.\n");
    add_ask(" [about] 'honor' / 'honour'", "Gunthar rubs his fingers " +
            "along his grand moustache and states: Honour is near " +
            "impossible to define. We've made an attempt at it with the " +
            "Oath and the Measure.\n");
    add_ask(" [about] 'oath'", "Gunthar says: My Honour is My Life.\n");
    add_ask(" [about] 'measure'", "Gunthars thinks and says: It is " +
            "thirty-seven volumes of laws and rules. This is where " +
            "the Knights have attempted to define Honour.\n");
    add_ask(" [about] 'order' / 'orders'", "Gunthar smiles " +
            "knowingly and says: The three Orders of the Knights " +
            "of Solamnia are Crown, Sword, and Rose.\n");
    add_ask(" [about] 'knight' / 'knights'", "Gunthar states: " +
            "The Knights of Solamnia are a body of warriors, bound " +
            ...
            "called on to defend the world.\n");
    add_ask(" [about] 'huma'", "Gunthar looks off into the " +
            "distance, and with a far-away voice whispers: Some " +
            "now say that Huma Dragonbane never existed. But I " +
            "still believe in the story...\n");
    add_ask(" [about] 'rumour' / 'rumours' / 'rumor' / 'rumors'", "Gunthar " +
            "sighs and says: I won't bother you with that.\n");
    add_ask(" [about] 'vinas' / 'solamnus'", "Gunthar declares: " +
            "A great man. He led an uprising against a cruel king, " +
            "after seeing the pain the king inflicted, even though " +
            "he was previously in the service of that king.\n");
    add_ask(" [about] 'paladine' / 'habbakuk' / 'kiri-jolith'", "Gunthar " +
            "simply states: One of the three patron gods of the Knights " +
            "of Solamnia. Another is better able to answer your questions " +
            "on this matter, or perhaps you could visit our library.\n");
    add_ask(" [about] 'solamnia'", "Gunthar conveys: Solamnia occupies the " +

...
#define LANG_OBJ               GOBJ + "language_obj.c"
...
wcough(string str)
{
    ...
    write("You go into a convulsive cough. After it is over, you wipe " +
        ...
        "cloth.\n");
    all(" goes into a convulsive cough. When it's over he wipes some blood " +
       "from the corner of his mouth with a small piece of cloth.");
...
wsay(string str)
{
    ...
    for(ix = 0; ix < size; ix++)
    {
        text = LANG_OBJ->translate(str, oblist[ix], 

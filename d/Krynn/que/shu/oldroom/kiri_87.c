...
create_attack_room()
{
    set_short("South arena steps");
    set_long(BS("You stand on the south side of a massive arena."
    ...
    add_exit(ROOM + "kiri_77","north");
    add_exit(ROOM + "kiri_96","southwest");
    add_exit(ROOM + "kiri_97","south");
    add_exit(ROOM + "kiri_98","southeast");

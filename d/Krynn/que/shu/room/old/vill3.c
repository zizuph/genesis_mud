...
create_attack_room()
{
    ...
    set_change_long(1,"You are standing on a path in the village of Que Kiri. " +
		    ...
		    "northwest, there are remains of something that could " +
		    "have been a building. West of you is a large " +
		    "blackened open area. To the east you can see the entrance " +
    ...
    set_change_long(2,"You are standing on a path in the village of Que Kiri. " +
		    ...
		    "blackened from a fire. To your northwest, " +
		    "there are remains of something " +
		    "that could have been a building. West of you is a large " +
		    "blackened open area. To the east you can see the entrance " +
		    "into the village, now the entire wall has been torn down " +
		    "and the entrance is about 10 times as wide as normal.\n");
    set_change_msg(2,REBUILD);
    set_change_short(3,"On a path in Que Kiri");
    set_change_long(3,"You are standing on a path in the village of Que " +
		    "Kiri. Around you, work on the village is in progress. " +
		    "A half-finished building is to your northwest and a few " +
		    "tents are visible further north, but there are still a " +
		    "lot of empty spots. Another tent is south of you. West " +
		    "of you is a large open area, and to your east you can " +
		    "reach a wall, where the path leads out of the village " +
		    "onto the Plains of Abanasinia.\n");
    set_change_msg(3,FINISH);
    
    OUTSIDE;

    add_exit(ROOM + "arena","west");
    add_exit(ROOM + "tent3","north");
    add_exit(WEST_EXIT,"east");
    add_exit(ROOM + "tent7","south");
}

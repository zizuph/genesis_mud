 ...
 *
 * By Rastlin
 * Add_items, descrips, and herbs by Teth
 */
...
string *herbs = HERB_MASTER->query_herbs( ({"garden", "urban",}) );
...
create_solace_room()
{
    ...
    add_item(({"glass jar", "forest-green jar", "forest-green glass jar"}),
            ...
            "a good candidate for perhaps having herbs.\n");
    ...
    add_search(({"glass jar", "forest-green jar",
        "forest-green glass jar", "earthen jar", "brown jar",
        "earthen brown jar"}),5,"Perhaps if you searched the jar " +
        "for herbs, you'd find some?\n");
    ...
    set_up_herbs(({ONE_OF(herbs), ONE_OF(herbs), ONE_OF(herbs),
        ONE_OF(herbs) }), ({"glass jar","forest-green jar",
        "forest-green glass jar","earthen jar","brown jar",
        "earthen brown jar",}), 2);
}

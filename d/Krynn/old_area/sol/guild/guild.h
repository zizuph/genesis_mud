...
#define LEAVE(ob)		ADMIN->leave(ob)
              ...
              /*  2H  POL PAR DEF SW KN CL */
#define SKILLS ({ 20, 1, 23, 24,  0, 3, 4, SS_RESCUE, SS_BASH, \
	SS_KICK })

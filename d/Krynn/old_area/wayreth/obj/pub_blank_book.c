 ...
 * the use in the libraries in the tower of High Sorcery.
 */
...
my_long()
{
    return "A brown book bound in soft leather. The pages of this book " +
           ...
           "  'bedit'                - Write the book using a more " +
           "advanced editor.\n" + 
...
bstore(string str)
{
    ...
    write("You put the books onto the shelves.\n");

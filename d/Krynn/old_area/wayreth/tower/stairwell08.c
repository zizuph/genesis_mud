...
create_tower_room()
{
   set_short("Stairwell on the eighth level of the tower");
   ...
   add_exit(WTOWER + "conclave", "west", "@@pass_check");
   add_exit(WTOWER + "stairwell09", "up", 0);
   add_exit(WTOWER + "stairwell07", "down", 0);
}

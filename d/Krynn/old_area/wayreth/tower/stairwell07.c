...
create_tower_room()
{
   set_short("Stairwell on the seventh level of the tower");
   ...
   add_exit(WTOWER + "study", "west", "@@pass_check");
   add_exit(WTOWER + "stairwell08", "up", 0);
   add_exit(WTOWER + "stairwell06", "down", 0);
}

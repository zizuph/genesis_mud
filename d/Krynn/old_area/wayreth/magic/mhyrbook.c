	...
	remove_spell("takadek");
        ...
        if (level >= 2)
            add_book_spell("unvalleddac", do_unvalleddac, "Detect Magic",
			     "UnvalLeddac");
	if (level >=3)
	    add_book_spell("nocturnus",do_nocturnus,"Darkness","Nocturnus");
        ...
        if(level >=6)
		add_book_spell("visiblis",do_visiblis,"Darkvision","Visiblis");

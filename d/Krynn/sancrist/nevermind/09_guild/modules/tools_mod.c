...
other_clean(string how, string what)
{
	...
	if(flag(8,1) == -1)
	{
	    [32m            write("You start to " + how + " the " + obj_name [0m
		  + " but ");
		if(how == "goil")
				...
				&& str != "ReusablePartsModule")
				  ...
				  {     
				      ...
				      [33m        say("collection of parts");[0m
					    ...
					    [32m        tell_room(E(TP), C(name));[0m
						[32m    tell_room(E(TP), " inspecting each piece in turn.\n");[0m
						    rpm->reduce_wear_out();   
						    return 1;
						}
									...
									return 1;
									  ...
									  [33m    say(QCTNAME(TP) + " meticulously polishes " + POSSESSIVE(TP) + " ");[0m
										  ...
										  [33m        say("collection of parts");[0m
											...
											[32m        tell_room(E(TP), C(name));[0m
											    [32m    tell_room(E(TP), " with a soft cleaning rag.\n");[0m
												rpm->reduce_wear_out();
												return 1;
											    }

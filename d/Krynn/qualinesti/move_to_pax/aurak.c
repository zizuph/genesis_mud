...
#define CELL_ROOM                 "/d/Krynn/qualinesti/move_to_pax/cell"
...
create_aurak()
{
    ...
    add_ask(({ "help", "quest", "task" }), VBFC_ME("ask_help"), 1);
    add_ask(({ "elves", "camp", "location" }), VBFC_ME("ask_camp"), 1);
...
calculate_experience(object who)
{
    ...
    xp_base -= (who->query_prop(QUALTHAS_KILLED)   ? 0 : 3000);

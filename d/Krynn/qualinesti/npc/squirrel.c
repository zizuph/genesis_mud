...
string  *adj_list = ({"red-furred", "furry", "red", "brown", "brown-furred"});
string  adj;
...
create_creature() 
{
    ...
    set_short("small " + adj + " squirrel");
    set_race_name("squirrel");
    set_name("squirrel");
    add_name("animal");
    set_adj(({"small", adj }));
    set_long("You see a small " + adj + " squirrel. This chittery little " +
        "forest creature prances around looking for food, and keeps " +
        "an eye on you all times as it forages, ready to spring " +
        "at any moment They are really quite " +
    ...
    add_prop(CONT_I_VOLUME, 700 + random(200));
    add_prop(CONT_I_WEIGHT, 1000 + random(200));

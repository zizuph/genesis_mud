...
#define CAMP_ROOM CDIR + "ambush2.c"
...
create_room()
{
    ...
    set_long("You are standing on a solid oaken branch high above the " +
	     "ground. Far to the southwest over the treetops you see the " +
...
ground_desc()
{
	...
	return "The Qualinesti forest stretches out in all directions. " +
	    ...
	    "The small encampment is to the west.\n" +
...
camp_desc()
{
    return "The clearing to the west has been used for setting a camp " +
        "by a group of elves.\n";
}

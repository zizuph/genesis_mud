...
create_camp()
{
    add_my_desc("The center of the camp is to the southwest.\n");
    
    OUTSIDE;
    
    add_exit(CDIR + "camp4.c", "west", 0, 1);
    add_exit(CDIR + "camp6.c", "south", 0, 1);
    add_exit(CDIR + "camp10.c", "southwest", 0, 1);
    add_exit(CDIR + "camp15.c", "north", 0, 1);
    add_exit(CDIR + "camp16.c", "northeast", 0, 1);
    reset_qualinesti_room();

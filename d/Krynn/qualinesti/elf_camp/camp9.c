...
create_camp()
{
    add_my_desc("The center of the camp is to the northeast.\n");
    
    OUTSIDE;
    
    add_exit(CDIR + "camp2.c", "north", 0, 1);
    add_exit(CDIR + "camp8.c", "east", 0, 1);
    add_exit(CDIR + "camp10.c", "northeast", 0, 1);
    add_exit(CDIR + "camp22.c", "southwest", 0, 1);
    add_exit(CDIR + "camp23.c", "west", 0, 1);
    reset_qualinesti_room();

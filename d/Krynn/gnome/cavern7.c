...
create_room()
{
    ...
    set_long(BS("You are in the middle of a vast natural cavern.  " +
      	...
      	"more work rooms.  Just to the south you see some unusually " +
      	"complex looking catapults.  To the north the cavern branches.", 70));
    ...
    add_exit(TDIR + "cavern6", "south", 0);
    add_exit(TDIR + "cavern8", "north", 0);
    add_exit(TDIR + "corridor1", "west", 0);
    reset_room();
}

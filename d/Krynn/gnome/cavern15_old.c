...
create_room()
{
    ...
    set_long(BS("In the near future, this will be the explosives " +
	"research facility for Gnomish Industries.  Testing for the " +
	"structural integrity of the bedrock have already taken place, " +
	"and the gnomes are confident their work here will in no way " + 
	"endanger the rest of the caves or the surface of Krynn in " +
	"this area...", 70));

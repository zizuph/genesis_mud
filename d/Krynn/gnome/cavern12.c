...
create_room()
{
    set_short("Near first floor landing");

    set_long(BS("You are in a tunnel leading from the first floor " +
    ...
    INSIDE;
    LIGHT;
    add_exit(TDIR + "cavern13", "west", 0);
    add_exit(TDIR + "cavern11", "east", 0);
}

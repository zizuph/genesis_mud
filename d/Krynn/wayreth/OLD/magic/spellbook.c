 ...
 * Description:	The spellbook for the Wizards of High Sorcery
 *              The file is reconstructed to fit into the new WoHS
 *
 * Coded by:	Author unknown
 *
 * Revision history:
 * -------------------
 * When       -   Who   -  What
 * 06 Oct 99  - Boron   - Removed stuff to get it to load.
 */
...
/*
mixed gPages = ({"Burn Blood", "Remove Curse", "Shield", "Dispel Illusion",
	         "Dispel Conjuration", "Dispel Magic", "Stoneskin",
	         "Spell Immunity", "Resist Magic", "Anti Magic Shell",
	         "Halo", "Burning Hands", "Rope Trick", "Deep Pocket",
	         "Teleport", "Strength", "Teleport Other", "Warp",
	         "Enchanted Weapon", "Teleport Party", "Warp Other",
	         "Disintergrate", "Warp Party", "Charm Animal", "Suggest",
	         "Friends", "Charm Person", "Hold Person", "Scare", "Demand",
	         "Hold Monster", "Charm Monster", "Comet", "Monster Summon 1",
	         "Acid rain", "Shooting Stars", "Limited Wish", "PWS",
	         "Monster Summon 2", "Monster Summon 3", "Wish", "PWK",
	         "Gate", "Detect Illusion", "Detect Secret Doors",
	         "Detect Magic", "Detect Immunities",
	         "Detect Magic Resistance", "Identify", "Locate",
	         "Wizard Eye", "Scry", "Magic Missile", "Acid arrow",
	         "MKS", "Lightning Bolt", "Fire ball", "Cone of Cold",
	         "Fire Shield", "Chain Lightning", "Ice Storm",
	         "Meteor Swarm", "Ventriloquism", "Phantom Armour",
	         "Phantasm", "Invisibility", "Improved Phantasm",
	         "Shadow Door", "Phantasmal Force", "Shadow Monster",
	         "Visual Illusion", "Alter Reality", "Permanent Illusion",
	         "SBF", "Chill touch", "Minor Malison", "Wraith Form",
	         "Animate Skeleton", "Vampiric Touch", "Animate Zombie",
	         "Death Spell", "Energy drain"});
*/
...
{
    set_name("book");
    add_name(({"spellbook", "spell book", "wizard book", SPELL_BOOK}));
    set_long("This is a red leather bound book with golden bindings. The leather "
            + "cracks at the back of the book, due to wear and intensive usage. "
            + "Judging from the looks of the book, it must have been used in "
            + "generation.\n");
    set_short("red leather bound book");
    set_adj(({"red", "leather", "leather bound"}));
    add_prop(OBJ_M_NO_DROP, "You should not drop this book, it is worth more then your life!\n");
    add_prop(OBJ_M_NO_GIVE, "You should not give this book away, it is worth more then your life!\n");
...
check_combat()
{
    ...
    //caster->remove_prop(LIVE_I_CONCENTRATE);
    return 0;
}
...
/*
 * Not loading removed by Boron Oct. 6 1999
 *
...
// Removed kentik and takadek oct 6 1999 by Boron
...
//	remove_spell("takadek");
        ...
        if (level >= 1)
            add_book_spell("spenkilus", do_spenkilus, "Scrubbing Hands",
                       "Spenkilus");
...
/*
 * Removed Oct 6 by Boron (Reconstruction of the spellbook)
        if (level >= 10)

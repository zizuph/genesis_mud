...
create_tower_room()
{
   set_short("Stairwell on the fourth level of the tower");
   ...
   add_exit(WTOWER + "guestroom", "west", 0);
   add_exit(WTOWER + "stairwell05", "up", 0);
   add_exit(WTOWER + "stairwell03", "down", 0);
}

...
create_tower_room()
{
   set_short("Stairwell on the sixth level of the tower");
   ...
   add_exit(WTOWER + "training", "west", "@@pass_check");
   add_exit(WTOWER + "stairwell07", "up", 0);
   add_exit(WTOWER + "stairwell05", "down", 0);
}

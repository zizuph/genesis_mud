...
do_read(string str)
{
	...
	if ((str=="menu")||(str=="list"))
	  ...
	  "   Bottle of spring water        10 copper\n" +
	  "   Cup of Milk                   1 silver\n" +
	  "   Dab of Honey                  1 gold, 1 silver, 6 copper\n\n" +
	  "   Imported Silvanesti Wine      4 silver\n" +
	  "   Glass of Brandy               8 silver, 4 copper\n\n" +
	  "   Slice of Thorbardin Cheese    1 silver, 6 copper\n" +
	  "   Kendermore Potato Surprise    5 silver\n" +
	  "   Stew of the Ice Folk          1 gold, 8 silver\n\n");
...
order(string str)
{
    ...
    case "bottles of water":
    case "bottle of spring water":
    case "bottles of spring water":
      name = "spring_water";
      price = num * 10;
      break;
    case "milk":

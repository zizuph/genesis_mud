...
create_object()
{
    ...
    set_long("This is a logbook which details the usage of the storage "
    + "racks of the Tower of High Sorcery. You may read it to get a recent "
    + "history of rack usage. Once finished, you can 'return' it to the "
    + "attendant.\n");

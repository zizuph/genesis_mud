...
create_tower_room()
{
   ...
   set_long("This sparsely furnished room is a place where you can stop " +
       ...
       "is a store, and to the south is a components shop, " +
   ...
   add_exit(WTOWER + "inn", "north", 0);
   add_exit(WTOWER + "stairwell05", "east", 0);
   add_exit(WTOWER + "components", "south", "@@check_entry_ban");
   add_exit(WTOWER + "shop", "west", 0);
}

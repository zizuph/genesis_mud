...
create_weapon()
{
	...
	set_adj(({ "polished", "vallenwood"}));
	set_short("polished vallenwood staff");
	set_pshort("polished vallenwood staffs");
	set_long("This stout polearm is made of vallenwood, a " +
		...
		"of this staff makes it easy to see why vallenwood is " +

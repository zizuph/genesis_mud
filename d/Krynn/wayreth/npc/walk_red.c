...
create_krynn_monster()
{
    ...
    set_default_answer("Dranin whispers: I am sorry, but I don't know what you are talkin about. \n");
    ...
    set_patrol_path(({"d","d","d","w","examine board","e","d","w","examine board","w","say Our library contains a lot of books with " +
                        "useful informations!","e","e","d","w","w","e","e","u","u","u","u","u"}));
...
arm_me()
{
    clone_object("/d/Krynn/wayreth/guild/red/robe")->move(TO);
    command("wear all");
}

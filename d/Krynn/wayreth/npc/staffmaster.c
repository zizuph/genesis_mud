...
create_krynn_monster()
{
	...
	"'objects' / 'appraising'",
            "say You must know the strength of those you " +
	    ...
	    "values of things to sell in the stores.", 1);
    ...
    add_ask(" [about] 'awareness'", "say How will you even " +
	    "think of casting spells to reveal someone, if you lack the " +
	    "awareness to know they are near? Let me help you sharpen " +
	    "your senses.", 1);
    add_ask(" [about] 'quest' / 'task'","say Well, I have my " +
            "Vallenwood staff and my wits, so at the moment there's " +
	    "not much you can do for me, but thanks for offering.", 1);

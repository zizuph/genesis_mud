...
#define PRE_OBJ_MAGIC_RES       ""

#define OBJ_I_RES_MAGIC         "_magic_i_res_magic"
#define OBJ_I_RES_ACID          "_magic_i_res_acid"
#define OBJ_I_RES_COLD          "_magic_i_res_cold"
#define OBJ_I_RES_ELECTRICITY   "_magic_i_res_electricity"
#define	OBJ_I_RES_LIGHT		"_magic_i_res_electricity"
#define OBJ_I_RES_POISON        "_magic_i_res_poison"
#define OBJ_I_RES_IDENTIFY	"_magic_i_res_identify"

#define OBJ_I_RES_AIR         	"_magic_i_res_air"
#define OBJ_I_RES_WATER       	"_magic_i_res_water"
#define OBJ_I_RES_EARTH       	"_magic_i_res_earth"
#define OBJ_I_RES_FIRE        	"_magic_i_res_fire"
#define OBJ_I_RES_LIFE        	"_magic_i_res_life"
#define OBJ_I_RES_DEATH       	"_magic_i_res_death"
...
#define WIZARD_AM_MAN_SEL_ARR	"_wizard_man_sel_arr"
#define WIZARD_S_MAN_SEL_CHAPT	"_wizard_man_sel_chapt"
#define WIZARD_AM_SMAN_SEL_ARR	"_wizard_sman_sel_arr"
#define WIZARD_S_SMAN_SEL_DIR	"_wizard_sman_sel_dir"
#define WIZARD_I_BUSY_LEVEL	"_wizard_busy_level"
...
/* 
 * List of properties that are to be saved in the player object.
 * This list is used at both restore and save since the name of 
 * the property itself isn't stored, just the value.
 * 
 * NB! If you add something, add it at the end of the array, do
 *     NOT insert anything, or all previously stored arrays will
 *     be restored in an uncorrect sequence.
 */

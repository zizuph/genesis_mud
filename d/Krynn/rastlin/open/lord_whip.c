...
create_weapon()
{
   ...
   set_long("@@my_long");
   add_item(({"handle"}),
      "The handle looks like a spiral of "+
      "twinned cords made of this black skin, laid upon itself "+
      "in several layers. In the butt end you see the tip of a "+
      "shining white ebony tooth that must be the core of the "+
      "handle. When you touch the sharp tooth it penetrates your "+
      "skin and draws a drop of blood that disappears as suddenly "+
      "as it came out. The tooth seems to glow even whiter.\n");
   add_item(({"tip","thorn","thorns"}),
      "Along the tip of this whip you see several small and sharp "+
      "thorns that seems to be a part of the black leather. You "+
      "wouldn't like to be torn up by these.\n");
   set_hit(48);
   set_pen(40);
   set_wt(W_CLUB);
   ...
   add_prop(OBJ_S_WIZINFO,"This whip is made of the tail-skin of a small "+
      "black dragon, thereby inheriting magical powers. This whip will hit any "+
      "opponent very easily, but the damage is lower. If the "+
      "whip hits a head, it will add an attack-delay to the victim for "+
      MIN_TIME+"+random("+EXTRA_TIME+") seconds. It will also draw "+
      "((100-ss_spellcraft())+100)/3 of mana (which means a "+
      "max of 65 and a min of 33 mana-points) from "+
      "the wielder since the whip will struggle for control. If the "+
      "mana reach 0, it draws "+HP_PUNISHMENT+" hp and unwields itself. "+
      "The player are given a short time to avoid this; they "+
      "can unwield it before the hp are taken away. "+
      "For the special to work, the player _must_ be "+
      "in brave mode ('whimpy brave'). Several "+
      "items are requied to have this whip "+
      "wielded: DIS > 10, SS_CLUB > 10 and Spellcraft > 10.\n"+
      "If one fails in wielding, "+HP_PUNISHMENT+
      " hitpoints are taken.\n");
   
   add_prop(MAGIC_AM_ID_INFO,({"When you study this whip of "+
            "black scaled leather, "+
            "you recognize a strong force of will flowing inside it, "+
            "emanating from a large "+
            "tooth inside the thick handle. This force seems "+
            "to control the movement of "+
            "the whip as a dragon would control its tail "+
            "to hit as much as possible, and "+
            "and make damage. "+
            "With your understanding of such objects you know "+
            "that this whip is not a "+
            "weapon wielded without a battle between forces of minds "+
            "that if won at all, "+
            "will tire the wielder for each battle the whip fights "+
            "for you, and if lost "+
            "might lead to death. A dangerous weapon indeed.\n", 55}));
...
{
   if(TO->query_wielded())
      return("When you grip the handle of the black scaled leather of this "+
      "whip you feel a force in contact with your mind, ready to win any "+
      "battle for you. It feels like burning inside your hand making you "+
      "want to drop it down and be free of those black shadows the whip makes "+
      "almost by itself as it dances in the air. A nauseating sound fills the "+
      "air when you handle the whip; You think it must be the small thorns "+
      "that sticks out all over the tip of it that sings in the air.\n");
   else
      return("When you touch the black scaled leather of this whip you feel "+
      "a force touch your mind in warning, making you hesitate to try to "+
      "wield it. Coiled up with its lethal, thorny tip touching the rough "+
      "and thick handle it seems like a snake in full tension, ready to bite "+
      "anyone daring to touch it. A mighty weapon in the hands of a brave warrior.\n");
}
...
wield(object what)
{
   write("You grip the handle of the whip, determined "+
      "to wield it. A strong "+
      "force penetrates your mind and screams terrifyingly! "+
      "Everything is black...\n");
   say(QCTNAME(TP)+ " grips the handle of a blackened whip. Suddenly the eyes of "+
      QCTNAME(TP) + " seems to grow black!\n");
   
   if (TP->query_base_stat(SS_DIS) > 10)
      if (TP->query_skill(SS_WEP_CLUB) > 10)

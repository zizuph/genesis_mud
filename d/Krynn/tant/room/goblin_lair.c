...
reset_tant_room()
{
    ...
    if (!gob4)
    {
        gob4 = clone_object(TNPC + "goblin");
        gob4->move(TO);
    }
    if (!gob5)
    {
        gob5 = clone_object(TNPC + "goblin");
        gob5->move(TO);
    }
    if (!gob6)
    {
        gob6 = clone_object(TNPC + "goblin");
        gob6->move(TO);
    }
}
...
create_tant_room()
{
    ...
    set_long("You have entered a lair. This cave is obviously " +
        ...
        "There is an exit out of this stench-filled craggy cave, " +
        "or you can explore further by going northwest or northeast.\n");
    ...
    AE(TROOM + "goblin_lair2", "northwest", 0, 0);
    AE(TROOM + "goblin_lair3", "northeast", 0, 0);
    AE(TROOM + "road6", "out", 0, 1);
    reset_tant_room();
}

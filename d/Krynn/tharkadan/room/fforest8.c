...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest5","west",0);
    add_exit(ROOM + "fforest9","north",0);
    add_exit(ROOM + "fforest11","east",0);
    add_exit(ROOM + "fforest7","south",0);
    add_exit(ROOM + "fforest10","southeast",0);
    add_exit(ROOM + "fforest4","southwest",0);
    add_exit(ROOM + "fforest6","northwest",0);

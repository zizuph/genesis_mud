...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest1","southwest",0);
    add_exit(ROOM + "fforest2","south",0);
    add_exit(ROOM + "fforest5","east",0);
    add_exit(ROOM + "fforest6","northeast",0);
    add_exit(ROOM + "fforest4","southeast",0);

...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "vale3","southeast",0);
    add_exit(ROOM + "vale5","north",0);
    add_exit(ROOM + "vale2","east",0);
    add_exit(ROOM + "vale10","southwest",0);     
    add_exit(ROOM + "vale11","west",0);
    ...
    add_item(({"towering peak","peak","ancient volcano","volcano","foot"}),
        ...
        "once an ancient volcano, standing alone amongst a sea of " +
        "aspen and fir trees.\n");

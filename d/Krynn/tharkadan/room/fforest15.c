...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest13","north",0);
    add_exit(ROOM + "fforest16","east",0);
    add_exit(ROOM + "fforest18","southeast",0);
    add_exit(ROOM + "fforest17","south",0);
    add_exit(ROOM + "fforest14","west",0);

...
create_tharkadan_room()
{
    ...
    add_exit(TROLL_CAVES + "troll_caves5","east","@@troll_block");
    add_exit(TROLL_CAVES + "troll_caves3","northeast","@@troll_block");
    add_exit(TROLL_CAVES + "troll_caves1","west",0);
...
long_descr()
{
    return "You stand within a narrow cave network that runs through " +
        ...
        "continues into darkness to your east, northeast and west.\n";
}

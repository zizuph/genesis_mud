...
create_tharkadan_room()
{
    ...
    add_exit(TROLL_CAVES + "troll_caves9","southwest","@@troll_block");
    add_exit(TROLL_CAVES + "troll_caves10","southeast","@@troll_block");
    add_exit(TROLL_CAVES + "troll_caves1","north",0);
...
long_descr()
{
    return "You stand within a narrow cave network that runs through " +
        ...
        "continues into darkness to your southeast, southwest " +
        "and north.\n";
}

...
create_tharkadan_room()
{
    ...
    add_exit(TROLL_CAVES + "troll_caves12","east","@@troll_block");
    add_exit(TROLL_CAVES + "troll_caves11","south","@@troll_block");
    add_exit(TROLL_CAVES + "troll_caves8","northwest",0);
...
long_descr()
{
    return "You stand within a narrow cave network that runs through " +
        ...
        "continues into darkness to your northwest, east and south.\n";
}
...
troll_block()
{
     ...
     {
        write("The " +troll->short()+ " blocks you from travelling in " +
            "that direction.\n");
        return 1;
     }

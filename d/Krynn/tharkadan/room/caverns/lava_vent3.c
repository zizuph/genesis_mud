...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "lava_vent4","southwest",0);
    add_exit(CAVERNS + "lava_vent2","east",0);
...
long_descr()
{
    return "You stand within an ancient lava vent that leads down into " +
         "the depths of a dormant volcano. To your east the vent leads " +
         "upwards while it continues steeply down to your southwest.\n";
}

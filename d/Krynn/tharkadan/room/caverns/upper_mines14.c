...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "upper_mines16","east","@@passage_blocked_east");
    add_exit(CAVERNS + "upper_mines15","south","@@passage_blocked_south");
    add_exit(CAVERNS + "upper_mines1","northwest",0);
...
long_descr()
{
    return "You stand within an excavated tunnel deep within the depths " +
        ...
        "doubt this was the work of the master subterranean miners, the " +
        "dwarves. The tunnel branches here to your south, east and " +
        "northwest.\n";
}

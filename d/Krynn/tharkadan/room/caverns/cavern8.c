...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "cavern_floor1","down","@@walk_down");
    add_exit(CAVERNS + "cavern7","southwest",0);
...
long_descr()
{
    return "You stand on a narrow ledge running along the walls of a " +
        ...
        "southwest and drops sharply down to your northeast towards " +
        "the floor of the cavern, that you can see reflecting strangely " +
        "back at you.\n";
}
...
walk_down()
{
   write("You make your way down to the floor of the cavern beneath " +
       "you...\n");
   return 0;
}
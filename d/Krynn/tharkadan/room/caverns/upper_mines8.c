...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "upper_mines10","northwest",
        "@@passage_blocked_northwest");
    add_exit(CAVERNS + "upper_mines9","north","@@passage_blocked_north");
    add_exit(CAVERNS + "upper_mines4","south",0);
...
long_descr()
{
    return "You stand within an excavated tunnel deep within the depths " +
        ...
        "dwarves. The tunnel branches here to your north, northwest " +
        "and south.\n";
}

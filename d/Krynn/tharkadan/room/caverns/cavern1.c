...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "ledge7","out",0);
    add_exit(CAVERNS + "cavern2","southwest",0);
...
long_descr()
{
    return "You stand on the edge of a cavern that was once part of " +
        ...
        "ridge of basalt runs down to your southwest along the edge of " +
        "the cavern into darkness. A cold breeze blows past you from " +
        "what was once a lava vent to your east, allowing you to exit " +
        "the cavern here.\n";
}

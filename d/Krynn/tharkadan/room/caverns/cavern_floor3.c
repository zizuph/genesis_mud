...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "cavern_floor4","northeast","@@check_slip");
    add_exit(CAVERNS + "cavern_floor1","north","@@check_slip");
    add_exit(CAVERNS + "cavern_floor2","northwest","@@check_slip");
    add_exit(CAVERNS + "cavern_floor5","southwest","@@check_slip");
    add_exit(CAVERNS + "cavern_floor6","south","@@check_slip");
    add_exit(CAVERNS + "cavern_floor7","southeast","@@check_slip");

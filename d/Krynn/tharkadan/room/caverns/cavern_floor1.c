...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "cavern8","up","@@walk_up");
    add_exit(CAVERNS + "cavern_floor2","southwest","@@check_slip");
    add_exit(CAVERNS + "cavern_floor3","south","@@check_slip");
    add_exit(CAVERNS + "cavern_floor4","southeast","@@check_slip");
    ...
    add_item(({"narrow ledge","ledge"}), "A narrow ledge starts here " +
        "and runs steeply up along the wall of the cavern.\n");
    add_item(({"wall"}), "You stand near the wall of the cavern where " +
        "a narrow ledge leads up.\n");
...
long_descr()
{
    return "You stand on the floor of the cavern, a thick sheet of " +
        ...
        "ancient volcano you stand within. A narrow ledge run steeply " +
        "upwards along the wall of the cavern here.\n";
}

int
walk_up()
{
   write("You make your way up along the narrow ridge...\n");
   return 0;
}

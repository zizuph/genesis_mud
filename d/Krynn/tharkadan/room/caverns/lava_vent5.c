...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "lava_vent6","north",0);
    add_exit(CAVERNS + "lava_vent4","southeast",0);
...
long_descr()
{
    return "You stand within an ancient lava vent that leads down into " +
        "the depths of a dormant volcano. To your southeast the vent " +
        "leads upwards while it continues steeply down to your north.\n";
}

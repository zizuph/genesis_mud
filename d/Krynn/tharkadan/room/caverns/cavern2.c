...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "cavern1","northeast",0);
    add_exit(CAVERNS + "cavern3","west",0);
...
long_descr()
{
    return "You stand on the edge of a cavern that was once part of " +
        ...
        "ridge of basalt runs down to your west along the edge of the " +
        "cavern into darkness, while rises to your northeast.\n";
}

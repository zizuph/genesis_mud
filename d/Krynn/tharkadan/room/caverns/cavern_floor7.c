...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "cavern_floor4","north","@@check_slip");
    add_exit(CAVERNS + "cavern_floor3","northwest","@@check_slip");
    add_exit(CAVERNS + "cavern_floor6","southwest","@@check_slip");
    add_exit(CAVERNS + "lava_vent1","southeast","@@enter_vent");
...
enter_vent()
{
   write("You step off the icy cavern floor and into an ancient lava vent...\n");
   return 0;
}
...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "upper_mines4","west","@@passage_blocked_west");
    add_exit(CAVERNS + "upper_mines12","east","@@passage_blocked_east");
    add_exit(CAVERNS + "upper_mines2","south",0);
...
long_descr()
{
    return "You stand within an excavated tunnel deep within the depths " +
        ...
        "dwarves. The tunnel branches here to your east, west and " +
        "south.\n";
}

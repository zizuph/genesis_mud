...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "cavern2","east",0);
    add_exit(CAVERNS + "cavern4","northwest",0);
...
long_descr()
{
    return "You stand on the edge of a cavern that was once part of " +
        ...
        "ridge of basalt runs down to your northwest along the edge " +
        "of the cavern into darkness, while rises to your east.\n";
}

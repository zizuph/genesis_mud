...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "cavern8","northeast",0);
    add_exit(CAVERNS + "cavern6","south",0);
...
long_descr()
{
    return "You stand on a narrow ledge running along the walls of a " +
        ...
        "south and northeast. Far below you can just make out the floor " +
        "of the cavern, reflecting strangely back at you.\n";
}

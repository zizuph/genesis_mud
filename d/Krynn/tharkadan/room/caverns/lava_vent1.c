...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "lava_vent2","southwest",0);
    add_exit(CAVERNS + "cavern_floor7","northwest",0);
    ...
    add_item(({"cold cavern","cavern","large cavern"}),
        "The vent opens up to your northwest into a large cavern.\n");
...
long_descr()
{
    return "You stand within an ancient lava vent that leads down into " +
        "the depths of a dormant volcano. To your northwest the vent " +
        "opens up into a large cavern, while it continues steeply down " +
        "to your southwest.\n";
}

...
create_tharkadan_room()
{
    ...
    add_exit(CAVERNS + "upper_mines18","east","@@passage_blocked_east");
    add_exit(CAVERNS + "upper_mines14","west", 0);
    add_exit(CAVERNS + "upper_mines17","southeast",
        "@@passage_blocked_southeast");
    add_exit(CAVERNS + "upper_mines19","north","@@passage_blocked_north");
...
long_descr()
{
    return "You stand at an intersection of excavated tunnels deep " +
        ...
        "your north, east, west and southeast.\n";
}

...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest13","northwest",0);
    add_exit(ROOM + "fforest19","southeast",0);
    add_exit(ROOM + "fforest18","south",0);
    add_exit(ROOM + "fforest17","southwest",0);
    add_exit(ROOM + "fforest15","west",0);

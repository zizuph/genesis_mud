...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "ledge13","southeast",0);
    add_exit(ROOM + "ledge15","south",0);
    ...
    add_item(({"towering peak","peak","ancient volcano","volcano",
         ...
         "and fir trees.\n");
    add_item(({"summit","top"}), "The summit of the mountain is just to " +
         "your south.\n");
...
mountain_desc()
{
    ...
    case SPRING:
    case SUMMER:
	str = "You can continue to the summit of the mountain by " +
           "heading south or you can make your way down by heading " +
           "southeast. ";
	break;
    case AUTUMN:
    case WINTER:
	str = "The snow is thick at this height, making it difficult " +
           "to travel, although you can continue up to the top of " +
           "the mountain to your south or down the peak to your " +
           "southeast. ";
	break;
    }
    return str;
...
long_descr()
{
    return "You stand near the summit of a towering peak " +
        "that sits in the centre of a forested valley. " +mountain_desc()+ 
        "\n";
}

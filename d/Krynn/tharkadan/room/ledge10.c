...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "ledge11","up",0);
    add_exit(ROOM + "ledge9","southeast",0);
...
mountain_desc()
{
    ...
    case SPRING:
    case SUMMER:
	str = "The ledge runs steeply upwards here and downwards " +
           "to your southeast. ";
	break;
    case AUTUMN:
    case WINTER:
	str = "The snow-covered ledge runs steeply upwards here and " +
            "downwards to your southeast. ";
	break;
    }
    return str;
}

...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "path13","northwest",0);
    add_exit(ROOM + "xx","southeast","@@no_go");
...
short_descr()
{
    return short_mountain_desc() + ", before the Hills of Blood";
}

string
long_descr()
{
    return long_mountain_desc() + "The trail slopes downwards to the " +
        "southeast as the path through the mountains open before you to " +
        "the lowlands know as the Hills of Blood. Beyond the hills you " +
        "can make out the desolated lands known as the Plains of " +
        "Dergoth.\n";
}
...
no_go()
{
   write("The Hills of Blood are covered with a noxious fog at the " +
       "moment. You will need to wait for it to pass before you can " +
       "go southeast.\n");
   return 1;
}
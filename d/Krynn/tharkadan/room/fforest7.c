...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest5","northwest",0);
    add_exit(ROOM + "fforest4","west",0);
    add_exit(ROOM + "fforest8","north",0);
    add_exit(ROOM + "fforest10","east",0);
    add_exit(ROOM + "fforest11","northeast",0);

...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "ledge12","southwest",0);
    add_exit(ROOM + "ledge14","northwest",0);
...
mountain_desc()
{
	...
	str = "You can continue towards the top of the mountain by " +
            "heading northwest or you can make your way down by heading " +
            "southwest. ";
	break;
    case AUTUMN:
    case WINTER:
	str = "The snow is thick at this height, making it difficult " +
            ...
            "the mountain to your northwest or down the peak to your " +
            "southwest. ";
	break;
    }
    return str;

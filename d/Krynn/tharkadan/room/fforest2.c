...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest1","west",0);
    add_exit(ROOM + "fforest3","north",0);
    add_exit(ROOM + "fforest4","east",0);
    add_exit(ROOM + "fforest5","northeast",0);
    add_exit(ROOM + "path10","southwest",0);

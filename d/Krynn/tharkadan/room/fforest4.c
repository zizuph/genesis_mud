...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest2","west",0);
    add_exit(ROOM + "fforest3","northwest",0);
    add_exit(ROOM + "fforest5","north",0);
    add_exit(ROOM + "fforest7","east",0);
    add_exit(ROOM + "fforest8","northeast",0);

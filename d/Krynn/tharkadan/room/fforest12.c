...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest10","west",0);
    add_exit(ROOM + "fforest11","northwest",0);
    add_exit(ROOM + "fforest13","southeast","@@ogre_block");
...
ogre_block()
{
   if(objectp(ogre))
   {
	...
	return 0;
      ...
      write("The " +ogre->short()+ " stops you from going southeast.\n");
      return 1;
    }

...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "ledge4","west",0);
    add_exit(ROOM + "ledge6","southeast",0);
...
mountain_desc()
{
    ...
    case SPRING:
    case SUMMER:
	str = "The ledge runs steeply upwards to your southeast and " +
            "downwards to your west. ";
	break;
    case AUTUMN:
    case WINTER:
	str = "The snow-covered ledge runs steeply upwards to your " +
            "southeast and downwards to your west. ";
	break;
    }
    return str;
}

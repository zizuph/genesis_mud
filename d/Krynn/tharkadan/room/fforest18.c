...
string *herbs = HERB_MASTER->query_herbs(({"mountains","eversnow", "conifforest", }));
object ogre;
...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest15","northwest",0);
    add_exit(ROOM + "fforest16","north",0);
    add_exit(ROOM + "fforest17","west",0);
    add_exit(ROOM + "fforest19","east",0);

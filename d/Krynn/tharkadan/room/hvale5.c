...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "hvale2","northwest",0);
    add_exit("/d/Krynn/guilds/OotS/room/joinroom","west",0);
    add_exit(ROOM + "hvale4","southwest",0);
    add_exit(ROOM + "hvale6","south",0);

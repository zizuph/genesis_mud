...
create_tharkadan_room()
{
    ...
    add_exit(ROOM + "fforest2","southwest",0);
    add_exit(ROOM + "fforest3","west",0);
    add_exit(ROOM + "fforest4","south",0);
    add_exit(ROOM + "fforest6","north",0);
    add_exit(ROOM + "fforest8","east",0);
    add_exit(ROOM + "fforest9","northeast",0);
    add_exit(ROOM + "fforest7","southeast",0);

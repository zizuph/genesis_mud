...
{ 
    ...
    set_name(({"elk"}));
    set_adj(face()); 
    set_short(face() + " brown elk");
    set_long("This elk lives in the alpine forests of the Tharkadan "+
             "mountain ranges.\n");
    ...
    add_leftover("/d/Ansalon/goodlund/nethosak/forest/obj/deer_hide.c", 
        "skin", 1, 0, 0, 1);

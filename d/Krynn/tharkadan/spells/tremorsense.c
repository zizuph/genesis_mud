...
{
    set_spell_name("tremorsense");
    set_spell_desc("tremor sense");
    ...
    set_spell_object("/d/Krynn/tharkadan/spells/tremorsense_obj");
...
concentrate_msg(object caster, mixed * targets, string arg)
{
    ...
    caster_message = "You cross your arms and press your bracers of " +
        "the umber hulk together.\n";
    watcher_message = QCTNAME(caster) + " crosses " + 
        caster->query_possessive() + " arms and presses " +
        caster->query_possessive() + " bracers of the umber hulk " +
        "together.\n";
...
{
    write("You are already maintaining the tremor sense ability.\n");
}

public void
hook_already_active(object player)
{
    write("You have already activated the bracers of the " +
        "umber hulk. Patience!\n");
}

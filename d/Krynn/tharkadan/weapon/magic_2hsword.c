...
create_weapon()
{
    ...
    add_adj("two-handed");
    add_adj("metal");
    set_short("blue two-handed sword");
    set_long("This is a massive two-handed sword made of the rare " +
        "ore referred to by ancient alchemists as 'star metal' - a blue " +
        "ore of extraordinary strength and hardness. The style of this " +
        "weapon's craftsmanship would indicate it is an old blade, " +
        "likely from the days of the Dwarfgate Wars.\n");
    ...
    set_default_weapon(47, 54, W_SWORD, W_SLASH, W_BOTH);

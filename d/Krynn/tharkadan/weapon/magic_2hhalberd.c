...
create_weapon()
{
    ...
    add_adj("metal");
    add_adj("huge");
    set_short("huge blue halberd");
    set_long("This is a huge two-handed halberd made of the rare ore " +
        "referred to by ancient alchemists as 'star metal' - a blue " +
        "ore of extraordinary strength and hardness. The style of " +
        "this weapon's craftsmanship would indicate it is an old " +
    ...
    set_likely_corr(1);
    set_likely_break(1);
    set_default_weapon(45, 55, W_POLEARM, W_SLASH | W_IMPALE, W_BOTH);

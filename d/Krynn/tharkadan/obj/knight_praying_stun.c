...
Also includes the code for knights to switch from their
current OotS god to Kiri-Jolith

Arman - 2018

Loosened restrictions on only Sword knights being able to
be followers of Kiri-Jolith.
Arman - 2019
*/
...
check_krynn_time(object victim)
{
    ...
    if(GET_TIMEOFDAY == "dawn")
    {
      write("As the glow of the sun begins to outline the Tharkadan " +
         ...
         "brightly above you... as if in anticipation. Stars of " +
         "other familiar constellations sparkle as if in approval.\n"); 
      dawn_message = 1;
        ...
        dawn_message)
    {
      write("As the sun rises over the Tharkadan mountain range its " +
         ...
         "you notice your medallion of faith resting atop of " +
         "it has changed to copper!\nYou reverently lift the copper " +
         "medallion of faith from the altar, affirming your devotion to " +
         "the gods of Good as a disciple of the god of " +

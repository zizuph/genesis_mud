...
(["human":(["abanasinian human":({ ({"of Abanasinia", "of Ankatavaka",
  ...
  "elf":(["dark elf":({ ({
      ...
      "the Dark Elf", "the Outcast of Qualinesti",
      "the Outcast of Silvanesti"
    }),
	...
	"of Tantallon",
      ...
      "Maddalena", "Merie", "Nsa'la", "Nyssa",
      "Oceanus", "Orsola", "Peleswyff", "Phoebe",
      "Quilliam", "Quith", "Rhynne", "Rose", "Saluayn",  
      "Saress", "Shadowstar", "Shadowflame", "Silverleaf",
      "Silvyre", "Tallis", "Taras", "Tsalasa", "Usse",
      "Vallena", "Wildwood", "Wyllows", "Zyllis",
    }),
    "kagonesti elf":({ ({"of Kagonesti", "of Southern Ergoth",
      ...
      "Reswyll", "Soroine", "Starsblood", "Shadowflame",
	...
	"of Silvanost", "of Sithelnost",
      ...
      "Rainsigh", "Redhair", "Sithnal", "Skytear",
  ...
  "dwarf":(["kayolin mountain dwarf":({ ({"of Kayolin",
	...
	"of the Neidar",
      ...
      "Joysmile", "Killogre", /*"Khalûn", sorry, NO special characters!!*/ "Leadfoot",

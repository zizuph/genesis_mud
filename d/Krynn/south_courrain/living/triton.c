...
string *gAdj1 = ({"blue-skinned", "warlike", "silver-haired",
          "attractive","finned","green-haired", "suspicious"});
...
create_krynn_monster()
{
    ...
    set_short(a1 + " triton");
    set_gender(random(2));
    set_long("This aquatic creature is a triton. Rumoured " +
    ...
    equip(({ WEP, (random(2) ? PEARL : CORAL ) }));

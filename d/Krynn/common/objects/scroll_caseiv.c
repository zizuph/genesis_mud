...
create_container()
{
    ...
    set_adj(({"scroll","ivory"}));

    set_short("ivory scroll case");
    set_pshort("ivory scroll cases");

    set_long("This is an ivory scroll case, an object that is " +
      "very precious and valuable. It is tubular in design.\n");

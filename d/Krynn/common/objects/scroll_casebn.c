...
create_container()
{
    ...
    set_short("bone scroll case");
    set_pshort("bone scroll cases");

    set_long("This is a bone scroll case, a hollowed out bone " +
      "that offers some protection to scrolls.\n");

    set_keep(1);

    add_prop(OBJ_I_VALUE, 300 + (random(300)));

...
react_to_token(object who)
{
    ...
    /*
     * 2018-11-19:
     * The age requirement was removed ages ago on verminaard, but was never
     * removed on Khisanth, removing it now as people are confused as to why
     * the dragon does not allow them access. - Carnak
     *
    ...
    {
        command("growl");
        command("say His Lordship would never have trusted someone like you "
        + "with this medallion.");

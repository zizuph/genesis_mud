...
create_door()
{
   ...
   set_open_desc("There is an open steel grid on the front of the " +
                 "wagon here.\n");
   set_closed_desc("There is a closed steel grid on the front of the wagon.\n");

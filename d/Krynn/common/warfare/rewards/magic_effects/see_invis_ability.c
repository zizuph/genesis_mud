...
config_darkvision_spell()
{
    ...
    set_spell_object("/d/Krynn/common/warfare/rewards/magic_effects/see_invis_ability_obj");
...
check_valid_action(object caster, mixed * targets, string arg, int execute = 0)
{
    ...
    if (helm->query_crystal_id_two() != "_see_invisible_crystal")
    {
        return 0;
    }

/*
 * Dark vision spell for warfare armour helms
...
{
    set_spell_name("catseye");
    set_spell_desc("dark vision");
    ...
    set_spell_object("/d/Krynn/common/warfare/rewards/magic_effects/see_dark_ability_obj");
...
check_valid_action(object caster, mixed * targets, string arg, int execute = 0)
{
    ...
    if (helm->query_crystal_id_two() != "_see_dark_crystal")
    {
        return 0;
    }

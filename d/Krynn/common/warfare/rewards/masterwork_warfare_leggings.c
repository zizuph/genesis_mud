/* 
 * Warfare masterwork leggings standard file for the various factions.
...
varargs void
set_armour_level(int level = 0, int location = A_LEGS, string faction = "free")
{
    if ( !level )
        gLevel = 0;
    else
...
setup_warfare_armour(int level, int location, string faction)
{
    ...
    if(!query_commodity_name())
        set_commodity_name("mw pgreaves");
...
query_crystal_slot_desc()
{
    ...
    {
        if(gLevel == 0) //plate
            return "Embedded near one of the knees of the greaves, circled by " +
            "runes inlayed by silver, is a dark empty cavity shaped like " +
            "a teardrop.";
        else if(gLevel == 1) // chain
            return "Attached near one of the knees of the leggings, circled by " +
...
warfare_armour_long()
{
    ...
    if(faction == "pot")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a pair of plate greaves of dark steel. " +
                      query_crystal_slot_desc()+ "\n";
                  ...
                  break;
               case 1:
                  long = "This is a pair of leggings of dark steel chains. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("pair of dark " + short);
                  set_pshort("pairs of dark " + short);
                  add_adj("dark");
                  break;
               case 2:
                  long = "This is a pair of dark leather leggings. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("pair of dark " + short);
                  set_pshort("pairs of dark " + short);
                  add_adj("dark");
        ...
        faction == "black" || faction == "green")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a pair of steel greaves, stained " +
                  ...
                  break;
               case 1:
                  long = "This is a pair of chain leggings, stained " +
                      faction+ " to distinguish the wearer as a supporter " +
                      "of the " +capitalize(faction)+ " Dragonarmy. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("pair of " + faction + " " + short);
                  ...
                  break;
               case 2:
                  long = "This is a pair of leather leggings, stained " +
                      faction+ " to distinguish the wearer as a supporter " +
                      "of the " +capitalize(faction)+ " Dragonarmy. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("pair of " + faction + " " + short);
    ...
    else if(faction == "knights")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a pair of steel plate greaves, designed " +
                      "in Solamnic fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("pair of solamnic plate greaves");
                  set_pshort("pairs of solamnic plate greaves");
                  add_adj("solamnic");
                  break;
               case 1:
                  long = "This is a pair of chain leggings, designed " +
                      "in Solamnic fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("pair of solamnic chain leggings");
                  set_pshort("pairs of solamnic chain leggings");
                  add_adj("solamnic");
                  break;
               case 2:
                  long = "This is a pair of leather leggings, designed " +
                      "in Solamnic fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("pair of solamnic leather leggings");
                  set_pshort("pairs of solamnic leather leggings");
                  add_adj("solamnic");
                  break;
               default:
                  long = "This is a pair of steel plate greaves, designed " +
        ...
        string short = query_short();
            ...
            {  
               case 0:
                  ...
                  set_short("pair of dwarven plate greaves");
                  set_pshort("pairs of dwarven plate greaves");
                  add_adj("dwarven");
                  break;
               case 1:
                  long = "This is a pair of chain leggings, designed " +
                      "in dwarven fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("pair of dwarven chain leggings");
                  set_pshort("pairs of dwarven chain leggings");
                  add_adj("dwarven");
                  break;
               case 2:
                  long = "This is a pair of leather leggings, designed " +
                      "in dwarven fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("pair of dwarven leather leggings");
                  set_pshort("pairs of dwarven leather leggings");
                  add_adj("dwarven");
                  break;
               default:
                  long = "This is a pair of steel plate greaves, designed " +
        ...
        string short = query_short();
            ...
            {  
               case 0:
                  ...
                  set_short("pair of elven plate greaves");
                  set_pshort("pairs of elven plate greaves");
                  add_adj("elven");
                  break;
               case 1:
                  long = "This is a pair of chain leggings, designed " +
                      "in elven fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("pair of elven chain leggings");
                  set_pshort("pairs of elven chain leggings");
                  add_adj("elven");
                  break;
               case 2:
                  long = "This is a pair of leather leggings, designed " +
                      "in elven fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("pair of elven leather leggings");
                  set_pshort("pairs of elven leather leggings");
                  add_adj("elven");
                  break;
               default:
                  long = "This is a pair of steel plate greaves, designed " +

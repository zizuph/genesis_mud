/* 
 * Warfare masterwork helm standard file for the various factions.
...
// Queries the id of the crystal cavities
public string
...
public string
query_crystal_id_two()
{
    return crystal_id_two;
}
...
varargs void
set_armour_level(int level = 0, int location = A_HEAD, string faction = "free")
{
    if ( !level )
        gLevel = 0;
    else
...
{
    if(gLevel == 0)
        gAc = PLATE_AC + crystal_one_ac + crystal_two_ac;
    else if(gLevel == 1)
        gAc = CHAIN_AC + crystal_one_ac + crystal_two_ac;
    else
        gAc = LEATHER_AC + crystal_one_ac + crystal_two_ac;

    gAm = ({-2, 3, -1});

    if(!query_commodity_name())
        set_commodity_name("mw helm");
...
warfare_armour_short()
{
    ...
    { 
        ...
        case 2:
            ...
            set_crystal_shape_two("triangular");
        break;
        default:
            short = "steel helm";
            add_name("helm");
...
query_crystal_slot_desc()
{
    ...
    {
        if(gLevel == 0) //plate
            return "Along the crest of the helm, linked by runes " +
            "inlayed with silver, you notice two dark empty " +
            "cavities shaped like teardrops.";
        else if(gLevel == 1) // chain
            return "Upon the shoulders of the mantle, linked by " +
            "chain runes inlayed with silver, you notice two empty " +
            "clasps - one shaped to hold something teardrop-shaped " +
            "and one shaped to hold something oval-shaped.";
        else // leather
            return "Upon the leather shoulders of the mantle, " +
            "linked by embroidered runes of silver, you notice " +
            "two empty clasps - one shaped to hold something " +
            "oval-shaped and one shaped to hold something " +
            "triangular-shaped.";
    }
    ...
    if(!crystal_one || !crystal_two)
    {
        ...
        if(gLevel == 0)
            return "Along the crest of the helm you notice it is " +
                "inset with " + link_desc + " linked by silver-inlay " +
                "runes to an empty cavity.";
        else if(gLevel == 1)
            return "Upon the shoulders of the mantle you notice it is " +
                "inset with " + link_desc + " linked by silver-inlay " +
                "runes to an empty clasp.";
        else
            return "Upon the leather shoulders of the mantle you " +
                "notice it is inset with " + link_desc + " linked " +
                "by embroidered runes to an empty clasp.";
...
warfare_armour_long()
{
    ...
    if(faction == "pot")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a winged helm of dark steel, forged " +
                      "in to the shape of a dragon in flight. " +
                      query_crystal_slot_desc() + "\n";
                  set_short("winged dark-" + short);
                  add_adj("dark");
                  add_adj("dark-steel");
                  add_adj("winged");
                  break;
               case 1:
                  long = "This is a chainmail hood of dark steel rings. " +
                      query_crystal_slot_desc() + "\n";
                  set_short("dark " + short);
                  add_adj("dark");
                  break;
               case 2:
                  long = "This is a leather coif studded with iron, " +
                      "stained so dark it is almost black. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("dark " + short);
                  add_adj("dark");
                  break;
        ...
        faction == "black" || faction == "green")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a winged helm of steel, forged " +
                      "in to the shape of a dragon in flight. " +
                  ...
                  set_short(faction + " winged helm");
                  add_adj(faction);
                  add_adj("winged");
                  break;
               case 1:
                  long = "This is a chainmail hood of small steel rings. " +
                      query_crystal_slot_desc() + " It has been stained " +
                      faction+ " to distinguish the wearer as a supporter " +
                      "of the " +capitalize(faction)+ " Dragonarmy.\n";
                  ...
                  break;
               case 2:
                  long = "This is a studded leather coif, stained " +faction+ 
                      " to distinguish the wearer as a supporter " +
                      "of the " +capitalize(faction)+ " Dragonarmy. "+
                      query_crystal_slot_desc()+ "\n";
                  set_short(faction + " " + short);
                  add_adj(faction);
    ...
    else if(faction == "knights")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a great helm of the finest steel, " +
                      "designed in solamnic fashion. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("solamnic great helm");
                  add_adj("solamnic");
                  add_adj("great");
                  break;
               case 1:
                  long = "This is a chainmail hood of small steel " +
                      "rings, designed in solamnic fashion. " +
                      query_crystal_slot_desc() + "\n";
                  set_short("solamnic " + short);
                  add_adj("solamnic");
                  break;
               case 2:
                  long = "This is a studded leather coif designed in solamnic " +
                      "fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("solamnic " + short);
                  add_adj("solamnic");
                  break;
               default:
    ...
    else if(faction == "neidar")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a great helm of the finest steel, " +
                      "designed in dwarven fashion and mounted with " +
                      "twin horns - either of a large ox or minotaur. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("horned great helm");
                  add_adj("dwarven");
                  add_adj("great");
                  break;
               case 1:
                  long = "This is a chainmail hood of small steel " +
                      "rings, designed in dwarven fashion. " +
                      query_crystal_slot_desc() + "\n";
                  set_short("dwarven " + short);
                  add_adj("dwarven");
                  break;
               case 2:
                  long = "This is a studded leather coif designed in dwarven " +
                      "fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("dwarven " + short);
                  add_adj("dwarven");
                  break;
    ...
    else if(faction == "qualinesti")
    {
        string short = query_short();
            ...
            {  
               case 0:
                  long = "This is a helm of the finest steel, " +
                      "designed in elven fashion with a sleek " +
                      "golden crest sweeping back from the nose plate " +
                      "to the rear of the helmet. " +
                      query_crystal_slot_desc()+ "\n";
                  set_short("crested elven helm");
                  add_adj("crested");
                  add_adj("elven");
                  break;
               case 1:
                  long = "This is a chainmail hood of small steel " +
                      "rings, designed in elven fashion. " +
                      query_crystal_slot_desc() + "\n";
                  set_short("elven " + short);
                  add_adj("elven");
                  break;
               case 2:
                  long = "This is a studded leather cowl designed in elven " +
                      "fashion. " +query_crystal_slot_desc()+ "\n";
                  set_short("elven leather cowl");
                  add_adj("elven");
                  add_adj("leather");
                  add_name("cowl");
                  break;
    ...
    else if(faction == "free")
    {
            ...
            {  
               ...
               case 1:
                  long = "This is a chainmail hood of small steel " +
                      "rings. " + query_crystal_slot_desc() + "\n";
                  break;
               case 2:
                  long = "This is a studded leather coif designed by a " +
                      "master smith. " +query_crystal_slot_desc()+ "\n";
                  break;
               default:
                  long = "This is a helm of the finest steel. " +
                      query_crystal_slot_desc()+ "\n";
...
update_warfare_armour()
{
    ...
    add_magic_obj_spell("'triangular-shaped' 'yellow' 'topaz'", 
        ({ "press" }), SCRY_PROT_ABILITY);

    add_magic_obj_spell("'triangular-shaped' 'green' 'peridot'", 
        ({ "press" }), SEE_INVIS_ABILITY);

    add_magic_obj_spell("'triangular-shaped' 'blue' 'agate'", 
        ({ "press" }), BREATHE_WATER_ABILITY);

    add_magic_obj_spell("'triangular-shaped' 'orange' 'garnet'", 
        ({ "press" }), QUICK_REFLEX_ABILITY);

    add_magic_obj_spell("'triangular-shaped' 'yellow' 'amber'", 
        ({ "press" }), SEE_DARK_ABILITY);
    ...
    if(crystal_id_two == "_scry_protection_crystal")
    {
        set_magic_obj_effect(({"_mw_scry_prot_sh_"}));
    }
    else if(crystal_id_two == "_see_invisible_crystal")
    {
        set_magic_obj_effect(({"_mw_see_invis_object_"}));
    }
    else if(crystal_id_two == "_watermere_crystal")
    {
        set_magic_obj_effect(({"_mw_water_breathe_sh_"}));
    }
    else if(crystal_id_two == "_reflex_crystal")
    {
        set_magic_obj_effect(({"_mw_haste_object_"}));
    }
    else if(crystal_id_two == "_see_dark_crystal")
    {
        set_magic_obj_effect(({"_mw_see_dark_object_"}));
    }
...
insert_gem(string str)
{
    ...
    if (!query_free_gem_slot(gem_shape))
    {
        ...
        if(query_free_gem_slot("tear"))
            spare_slot1 = "tear";
        if(query_free_gem_slot("triangular"))
            spare_slot1 = "triangular";
    ...
    string ward_type, material_type;

    if(query_free_gem_slot("tear"))
        ward_type = "wards of protection are activated";
    else if(query_free_gem_slot("triangular"))
        ward_type = "magical augmentations hum in readiness " +
            "to be activated";
    else
        ward_type = "enhancement magics are activated";

    if(gLevel > 0)
        material_type = "embroidered into";
    else
        material_type = "on the crest of";

    set_crystal_slot(gem_slot, gem_id, gem_shape, benefit_type, benefit_bonus);

    player->catch_tell("You insert " +oblist[0]->short()+ " into "+
        "the " +gem_shape+ "-shaped " +cavity_desc+ " " +material_type+
...
verify_magic_obj_spell_cast(string arg, object spell)
{
    ...
    {
        notify_fail("You have to be wearing the " +query_short()+ " to activate " +
            "its magical ability.\n");
        return 0;
    }

    if(SEE_INVIS_ABILITY->has_spell_object(E(TO)))
    {
        write("The " +query_short()+ " is already activated!\n");
        return 0;
    }

    if(SEE_INVIS_ABILITY->query_ability_preparing(E(TO)))
    {
        write("The " +query_short()+ " is currently activating!\n");
        return 0;
    }

    if(QUICK_REFLEX_ABILITY->has_spell_object(E(TO)))
    {
        write("The " +query_short()+ " is already activated!\n");
        return 0;
    }

    if(QUICK_REFLEX_ABILITY->query_ability_preparing(E(TO)))
    {
        write("The " +query_short()+ " is currently activating!\n");
        return 0;
    }

    if(SEE_DARK_ABILITY->has_spell_object(E(TO)))
    {
        write("The " +query_short()+ " is already activated!\n");
        return 0;
    }

    if(SEE_DARK_ABILITY->query_ability_preparing(E(TO)))
    {
        write("The " +query_short()+ " is currently activating!\n");
        return 0;
    }
...
cmd_parse_spell_action(string arg)
{
    ...
    if(crystal_shape_two != "triangular")
    {
        // WARFARE_DEBUG("Parse no triangular");
        notify_fail("What?\n");
        return 0;     
    }

    // Crystal two is the only gem slot that is triangular.
    if(!crystal_two)
    {
        // WARFARE_DEBUG("Parse no crystal_two");
        notify_fail("Press what? There is no crystal in your " +
            "triangular-shaped clasp to press!\n");
        return 0;     
    }

    string crys_desc = MASTERWORK_GEM_PROPS[crystal_id_two][3];
  
    if(!this_object()->query_worn())
    {
        notify_fail("You have to be wearing the " +query_short()+ 
            " to activate its magical ability.\n");
        return 0;
    }

    if(!query_crystal_slot_two())
    {
        // WARFARE_DEBUG("Parse query_crystal_slot_two");
        notify_fail("Press what? There is no crystal in your " +
            "triangular-shaped clasp to press!\n");
        return 0;
    }
    ...
    if(arg != crys_desc)
    {
        notify_fail("Press " +LANG_ADDART(arg)+ "? You need to be " +
            "more specific about what gemstone in your " +
            query_short()+ " you want to press, such as your " +
            crys_desc+ ".\n");
        return 0;
    }

...
create_gems()
{
    config_gems("bloodstone", "bloodstones", "teardrop-shaped", 1432, 
        GEM_EXTREMELY_RARE, 30, 44);

    add_name("_death_resistance_crystal");
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the death resistances of the wearer increases by 3. " +

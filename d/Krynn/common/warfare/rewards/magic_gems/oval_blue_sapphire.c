...
create_gems()
{
    config_gems("sapphire", "sapphires", "oval-shaped blue", 2345, 
        GEM_EXTREMELY_RARE, 2, 4);

    add_name("_crystal_of_defence");
    set_random_placement(0);
    add_adj("oval");
    add_adj("shaped");
    add_adj("oval-shaped");
    add_adj("blue");
    set_short("oval-shaped blue sapphire");
    set_long("@@default_gem_long@@  Sapphire is a gem "+
        ...
        "neither too pale nor too dark, and is second "+
        "only to diamond in hardness. This sapphire seems " +
        "to pulse with arcane energy.\n");

    add_prop(MAGIC_AM_ID_INFO, ({ "This oval-shaped blue sapphire " +
        "is an enchanted Crystal of Defence, and when inserted in to " +
        "armour specifically designed by a master smith it will enhance " +
        "the defensive skill of the wearer.\n", 25 }));
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the wearer's defense skill increases by 5. The armour " +
        "can be found at " +

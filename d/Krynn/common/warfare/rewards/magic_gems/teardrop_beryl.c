...
create_gems()
{
    ...
    config_gems("beryl", "beryls", "teardrop-shaped colourless", 800, 
        GEM_EXTREMELY_RARE, 3, 5);
    add_name("_cold_resistance_crystal");
    ...
    set_long("@@default_gem_long@@ Beryl is a lustrous, "+
        ...
        "and aquamarine. This beryl is pure and colourless, " + 
        "shaped like an icy teardrop.\n");

    add_prop(OBJ_I_LIGHT, LIGHT_PASSIVE);
    add_prop(MAGIC_AM_ID_INFO, ({ "This teardrop-shaped beryl " +
        "is enchanted with a Cold Ward, and when inserted in to " +
        "armour specifically designed by a master smith it will " +
        "provide additional protection to the wearer from cold " +
        "magic. This magical gemstone has the added effect when " +
        "activated close proximity to the mythical Ice Reaver " +
        "weapon to stop it from melting outside of the frigid " +
        "conditions of the Icewall Glacier.\n", 25 }));
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the cold resistances of the wearer increases by 3. " +

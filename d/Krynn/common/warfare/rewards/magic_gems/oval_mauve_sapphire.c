 ...
 *  armours to improve the open lock skill.
 *
...
create_gems()
{
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the wearer's open lock skill increases by 5. The " +

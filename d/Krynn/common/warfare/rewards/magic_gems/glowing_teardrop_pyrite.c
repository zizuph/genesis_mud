...
create_gems()
{
    config_gems("pyrite", "pyrites", "glowing teardrop-shaped", 512, 
    ...
    add_prop(MAGIC_AM_ID_INFO, ({ "This teardrop-shaped pyrite " +
        "is enchanted with a Greater Earth Ward, and when inserted in to " +
        "armour specifically designed by a master smith it will " +
        "provide substantial protection to the wearer from earth " +
        "magic.\n", 25 }));
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the earth resistances of the wearer increases by 6. " +

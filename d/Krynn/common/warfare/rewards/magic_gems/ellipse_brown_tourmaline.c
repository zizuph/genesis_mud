...
create_gems()
{
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the wielders SS_ELEMENT_EARTH is increased by 5. " +

...
create_gems()
{
    config_gems("opal", "opals", "teardrop-shaped", 864, 
        GEM_EXTREMELY_RARE, 3, 5);

    add_name("_life_resistance_crystal");
    ...
    add_prop(MAGIC_AM_ID_INFO, ({ "This teardrop-shaped opal " +
        "is enchanted with a Life Ward, and when inserted in to " +
        "armour specifically designed by a master smith it will " +
        "provide protection to the wearer from life " +
        "magic.\n", 25 }));
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the life resistances of the wearer increases by 3. " +

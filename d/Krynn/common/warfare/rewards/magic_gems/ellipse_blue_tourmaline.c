...
create_gems()
{
    config_gems("tourmaline", "tourmalines", "ellipse-shaped blue", 1048,
        GEM_EXTREMELY_RARE, 1, 2);
    add_name("_crystal_of_water");
    set_random_placement(0);
    add_adj("ellipse");
    add_adj("shaped");
    add_adj("blue");
    set_long("@@default_gem_long@@ This tourmaline is of the " +
        "indicolite variety, a vivid blue the colour of a morning " +
        "ocean. It has been carved into an ellipse shape.\n");

    add_prop(MAGIC_AM_ID_INFO, ({ "This ellipse-shaped tourmaline " +
        "is an enchanted Crystal of Water, and when inserted " +
        "in to a weapon specifically designed by a master smith " +
        "it will enhance the wielder's elemental water spell " +
        "skill.\n", 25 }));
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the wielders SS_ELEMENT_WATER is increased by 5. " +

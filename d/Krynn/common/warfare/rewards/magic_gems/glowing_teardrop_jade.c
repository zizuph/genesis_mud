...
create_gems()
{
    config_gems("jade", "jades", "glowing teardrop-shaped green", 1576, 
        GEM_EXTREMELY_RARE, 40, 62);

    add_name("_greater_poison_resistance_crystal");
    ...
    set_long("@@default_gem_long@@ Jade is normally "+
        ...
        "carved into the shape of a teardrop, and glows with a " +
        "sickly light.\n");

    add_prop(OBJ_I_LIGHT, LIGHT_PASSIVE);
    add_prop(MAGIC_AM_ID_INFO, ({ "This teardrop-shaped green jade " +
        "is enchanted with a Greater Poison Ward, and when inserted in to " +
        "armour specifically designed by a master smith it will " +
        "provide substantial protection to the wearer from poison " +
        "magic.\n", 25 }));
    ...
    add_prop(OBJ_S_WIZINFO, "This gem can be inserted in to masterwork " +
        ...
        "inserted, the poison resistances of the wearer increases by 6. " +

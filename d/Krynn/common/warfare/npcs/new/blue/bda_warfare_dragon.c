...
/* 
 * A blue dragon of the warfare system.
 */
...
create_dragon_npc()
{
    ...
    set_age(type);
    set_colour("blue");
    add_name("warfare_blue_dragon");
    set_long("Before you crouches a creature of myth and legend! " +
	     capitalize(LANG_ADDART(type))+ " blue dragon, something " +
             "that the storytellers scare children with in the late " +
             "hours of the evening... " +
	     "a creature that you now note is very real as it stands " + 
	     "threateningly over you. Its scales are a lustrous blue, " +
	     "and its eyes are a deep azure colour that spark " +
	     "malevolently like lightning.\n");
    ...
    add_act("emote hisses at you... the sound of crackling electricity echoes from " +

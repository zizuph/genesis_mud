...
/* 
 * A green dragon of the warfare system.
 */
...
create_dragon_npc()
{
    ...
    set_age(type);
    set_colour("green");
    add_name("warfare_green_dragon");
    set_long("Before you crouches a creature of myth and legend! " +
	     capitalize(LANG_ADDART(type))+ " green dragon, something " +
             "that the storytellers scare children with in the late " +
             "hours of the evening... " +
	     "a creature that you now note is very real as it stands " + 
	     "threateningly over you. Its emerald scales are small and " +
             "tightly bound, and its eyes are a deep red that radiate " +
             "cruelty and cunning malevolently like lightning.\n");
    ...
    add_act("emote hisses at you... the smell of chlorine emanating from " +

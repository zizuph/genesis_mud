...
/* 
 * A white dragon of the warfare system.
 */
...
create_dragon_npc()
{
    ...
    set_age(type);
    set_colour("white");
    add_name("warfare_white_dragon");
    set_long("Before you crouches a creature of myth and legend! " +
	     capitalize(LANG_ADDART(type))+ " white dragon, something " +
             "that the storytellers scare children with in the late " +
             "hours of the evening... " +
	     "a creature that you now note is very real as it stands " + 
	     "threateningly over you. Covered in scales white as snow, " +
	     "it has powerful legs and thick claws to punch through " +
             "layers of ice and find purchase on slippery slopes and " +
             "glaciers. Its eyes are a cold blue, shining with an " +
             "evil animal cunning.\n");

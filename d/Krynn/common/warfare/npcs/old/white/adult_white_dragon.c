...
create_dragon_npc()
{
    ...
    set_age("adult");
    set_colour("white");
    add_name("adult_white");
    set_long("Before you crouches a creature of myth and legend! " +
	     "An adult white dragon, something that the storytellers " +
	     "scare children with in the late hours of the evening... "+
	     "a creature that you now note is very real as it stands " +
	     "threateningly over you. Its scales are a shiny white " +
	     "colour.\n");
    ...
    add_act("emote flexes its enormous batlike wings and launches " +
	    "itself into the air!");

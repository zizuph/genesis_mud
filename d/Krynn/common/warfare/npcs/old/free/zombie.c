...
create_krynn_monster()
{
    ...
    set_long("Shambling before you is the decaying form of a zombie, " +
       "a ghoulish creature raised from the dead! Driven by an unholy " +
       "hunger for living flesh, it would be worth being careful around " +
       "this creature!\n");

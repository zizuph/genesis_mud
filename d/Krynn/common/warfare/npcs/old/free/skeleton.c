...
create_krynn_monster()
{
    ...
    "service by a dark curse dating back to the Cataclysm. This creature " +
    "of the night now stalks Nightlund, looking for living creatures to " +
    "turn its hatred upon. It has the stance of a fighter, and " +
    "a malicious light is shining in its empty eye sockets.\n");

    set_stats(({80+random(40),70+random(30),80+random(40),
        30, 30, 120+random(30)}));

...
create_object()
{
    set_name("scroll");
    add_adj(({"basic", "green"}));
    set_long("Scroll for new spell. 'thirkualtiui', or bird form...\n");

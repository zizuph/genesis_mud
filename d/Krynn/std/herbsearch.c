 ...
 * Returns:       /
 *
 * Disabled by Aridor, 04/25/97 because reset_room would
 * be doubly inherited by a room and it might take the
 * incorrect version. Instead, the set_searched code has
 * been added to reset_room in /d/Krynn/std/room.c
 * where it should have the same effect.
public void
reset_room()
{

 ...
 *   2016.03.10 Removed You scum! assist message in help_friend
 *   2018.09.18 Removed nomask from wear and wield functions. Arman
 */
#pragma save_binary
#pragma strict_types
 ...
 *
 * Redefine these if you want your npc to do something else.
 */

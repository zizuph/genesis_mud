 ...
 * by Aridor 12/13/95
 *
 * This is a merchant who carries a shop around with him.
 * He sells and buys things just like in any normal shop,
 * with the exception that he cannot carry too much, and
 * uses his own money to pay the customer.
 * This way, in case this guy is killed, the killer won't
 * be able to sometimes get more loot than at other times.
 *
 * Note the use of add_own_stuff(ob), as all objects which
 * the merchant possess (ie. which he shouldn't give away)
 * must be called with this function. Obviously, this is
 * especially relevant in a possible 'equip' function.
 *
 *
 * For an example how to use him, look at
 * /d/Krynn/solamn/thief/guild/obj/recruiter.c
 */

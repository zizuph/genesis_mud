...
create_tantallon_room()
{
  ...
  add_item("table", "A dead dwarf is strapped to the table.\n");
  add_item(({"elf", "dead dwarf"}), "The dwarf seems to have been tortured to death on the table.\n");

  add_exit(TDIR + "torture_room", "northeast", 0);

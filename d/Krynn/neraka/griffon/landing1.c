...
/* Navarre June 11th 2006: Changed room so it says Tantallon instead of icewall */
...
create_tantallon_room()
{
    ...
    add_exit("/d/Krynn/solamn/vin_mount/room/road7", "down");
    ...
    add_prop(OBJ_S_WIZINFO, "Here one can try to earn the griffon's trust " +
         "so it will take him/her to Tantallon.\n"
...
get_feather(string str)
{
    ...
    if(!((str=="feather")||(str=="griffon feather")))
      return 0;
    (feather=clone_object(DRAGON_DIR + "feather.c"))->move(TO);
...
quest_solved()
{
    ...
    write("You have proven yourself worthy. From now on, you may " +
      ...
      "will gladly come and carry you on my back to Tantallon.\n");
    /*set quest bit here*/

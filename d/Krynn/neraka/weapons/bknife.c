 ...
 * 2016-01-29 - Cotillion
 * - Fixed unwield message, removed extreme random hit/pen
 */
...
create_weapon()
{
    ...
    set_long("@@my_long");
    set_default_weapon(34, 39, W_KNIFE, W_IMPALE, W_LEFT);
    set_wf(TO);
...
unwield(object what)
{
  ...
  {
      query_wielded()->catch_tell("You easily let the dagger slip out of your hands.\n");
      return 0;
  }

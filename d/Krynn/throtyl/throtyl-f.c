...
create_throtyl_room()
{
    ...
    set_special_short("within the Stormshire Forest");
    set_short("Within the Stormshire Forest");
    set_long("Dense foliage surrounds you making travel difficult, and the " +
            "ancient trees looms over you as if in judgement. Few brave " +
            "souls pass through this forest, with rumours of it being infested " +
            "with hobgoblins and other unnatural horrors.\n");

    add_item(({"stormshire forest", "forest", "ancient forest", "trees", "ancient trees"}),

/*
 * The room base for the village Solace (outside rooms) and on the ground!
 * This file should not be used in the trees or on the bridge walks.
 */
#include "/d/Krynn/common/defs.h"
#include "/d/Krynn/common/clock/clock.h"
#include "../new_village/local.h";
#include <composite.h>

/* The Zeboim room. ~solace/puzzle/locations/zeboim */
...
#define ROOM_TOGO ({ "zeboim", "morgoin", "solinari", "chemosh", "hiddukel", \
                     "lunitari", "nuitari", "takhisis", "paladine" })

/* The Lunitari room. ~solace/puzzle/locations/lunitari */
...
#define ROOM_TOGO ({ "lunitari", "morgoin", "solinari", "chemosh", "hiddukel", \
                     "nuitari", "zeboim", "takhisis", "paladine" })
...
void case2()
{
    ...
    apol = find_object(LOCATIONS + "sargonnas");

    if(!objectp(apol))
    {
        (LOCATIONS + "sargonnas")->teleledningsanka();
        apol = find_object(LOCATIONS + "sargonnas");
    }

...
int pass_door(string arg)
{
    ...
    trapdoor2 = present("hiddukel_trapdoor", find_object(LOCATIONS +
        "hiddukel"));
    ...
    if(door->query_open())
    {
        if(objectp(find_object(LOCATIONS + "entrance")->query_occupied()))
        {
            ...
            tell_room(find_object(LOCATIONS + "hiddukel"), "The trapdoor in "+
        ...
        else
        {
            ...
            find_object(LOCATIONS + "hiddukel")->reset_puzzle_room();
        }
    }
    else
    {

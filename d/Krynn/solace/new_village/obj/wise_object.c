 ...
 *
 * Cherek 160116:  Updated help files to clarify the intended use of the
 *                 free emote ability.
 */
...
help(string str)
{
    if (str == "pin")
    {
	  write("The pin of the Wise People of Genesis can be worn and\n" +
		    "removed, and gives you access to the following emotes:\n\n" +
		...
		"In addition, you can also use 'wemote' to create your own\n" +
        "free emotes. Note: These emotes are logged and should be\n" +
        "used for the purpose of enhancing role-play. Using these\n" +
        "emotes to create fake game output in order to confuse\n" +
        "players or emotes with offensive language are two examples\n" +

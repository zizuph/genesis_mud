...
- Modified Sept 2005 Louie - Removing "pass" option, as I have
-     had multiple complaints about problems.
*/
...
reward(string str)
{
	...
	if (give_reward(type))
	    ...
	    say(QCTNAME(TP) + " tried to get a reward but was not worthy of one.");
	return 1;
    }
...
spell_hint()
{
    ...
    {
        command("ponder"); 
        command("say Oh I do know a bit of magic, however I think " +
          "you should take formal training before seeking out spells.");
        command("say If you are interested in magic, I suggest " +
          "learning the basics at the School of High Magic just " +
          "northwest of Solace, on the banks of Crystalmir Lake.");
        command("say Do that, and then come back to me.");
        return "";
    }
    if((this_player()->query_lesser_spells_max() < 1))
    {
        command("ponder"); 
        command("say The spell I could help you with is a bit too " +
            "advanced.");
        command("say Come back to me when you have progressed " +
             "in your training where you can cast lesser spells.");
        command("hmm");
        command("say Until then, perhaps seek out some spells of a " +
             "minor nature?");
        command("say The herbalist in Darken Woods west of Solace may be " +
             "able to teach you something...");
        command("say ... or perhaps the barmaid of the Inn of the Last Home " +
             "can give you some advice? Rumour has it her father was an " +
             "illusionist of limited ability.");
        command("shrug"); 
        return "";
    }
    ...
    {
        command("say Yes, I could give you a spell scroll you may find " +
           "useful...");
        command("say A divination spell that allows you to observe " +
           "the actions of others wherever they may be in the realms.");
        command("say However...");
        command("say I believe I left that scroll as a bookmark in a " +
           "tome on the history of Huma...");
        command("say A tome I had borrowed from the great Historian " +
           "Astinus of Palanthas.");
        command("blush");
        command("say If you are happy to go to his library in Palanthas " +
           "and collect it from him, I'll send word ahead for his scribes " +
           "to expect you.");
	this_player()->add_prop("_player_m_pal_lib_audition",
		     ({"say Oh! Quest Master Tarshir sent you to collect " +
                       "something from Astinus?", "frown",
		       "say You may enter his private chambers.",
                       "gesture south", "say Make sure you get what you " +
                       "came for before leaving!", "say He is very " +
                       "busy chronicling the history of Krynn.", "say He " +
                       "won't let you back in to his private chambers again " +
                       "until the turning of the realms!", "huma"}));

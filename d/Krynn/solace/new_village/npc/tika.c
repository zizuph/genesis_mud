...
create_krynn_monster()
{
    ...
    add_ask(({"father","illusionist","alleran","alleran waylan","dad"}),
            VBFC_ME("spell_hint"));
...
spell_hint()
{
    command("say My father, Alleran Waylan, went missing when I was just ten.");
    command("sigh sadly");
    command("say He was a travelling illusionist - known as Wonderful Waylan!");
    command("say He used to show me the most wonderful tricks.");
    command("say On my tenth birthday he gave me a wonderful portrait of himself.");
    command("say That's all I have left to remind me of him.");
    command("say While Otik has been a wonderful step-father, I'll never forget " +
            "him - I have his portrait hanging in my house still.");
    return "";
}
public void

...
create_krynn_monster()
{
	...
	set_long("This poor creature has been refused rest even in death.\n"
	 + "You reckon the creature isn't long dead as shreds of flesh\n"
	 + "still drip from its bones. That combined with the awful smell\n"
	 + "makes you feel like throwing up. "
	 + "The zombie now bears a hatred for all living things......\n");
	set_adj("warrior");

...
graves()
{
    string filename, *names, str, grave_str;
    int j;
    ...
    grave_str = "You look at the graves and read the names on them:\n";
    grave_str += break_string(str + ".\n", 70);
    grave_str += "There is text written on each grave which you can read.\n";
/*
 ...
 THE ABOVE CODE IS BROKEN, WILL BE CLEANED OUT / LUNATARI */
     return grave_str;
      }
...
graveyard()
{
    ...
    return "This is part of the Solace graveyard.\n";
}

...
create_toron_room() 
{
    ...
    set_start_desc("You stand inside a rather large tent made " +
                   "from animal hides. ");
    set_long_desc("You can leave the tent and return to the " +
                  "camp by the opening in the south wall. ");
    ...
    add_exit(ROOM + "village_e","out",0,3);

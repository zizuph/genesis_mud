...
create_toron_room()
{
    ...
    set_start_desc("You are walking on a narrow dirt road within a " +
                   "small village. ");
    set_long_desc("You are standing at a bend in the road. Going " +
                  "north will take you deeper inside the camp while " +
                  "the road westwards leads towards an intersection. ");
    ...
    add_exit(ROOM + "village_g","west",0,3);
    add_exit(ROOM + "village_i","north",0,3);

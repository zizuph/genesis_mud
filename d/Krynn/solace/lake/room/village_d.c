...
create_toron_room()
{
    ...
    set_start_desc("You are walking on a narrow dirt road within " +
                   "a small village. ");
    set_long_desc("The road leads east deeper inside the village " +
                  "and west towards an intersection. ");
    ...
    add_exit(ROOM + "village_01","west",0,3);
    add_exit(ROOM + "village_e","east",0,3);

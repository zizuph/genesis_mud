...
create_toron_room()
{
    ...
    set_start_desc("You are walking on a narrow dirt road within " +
                   "a small village. ");
    set_long_desc("The road leads west deeper inside the village " +
                  "and east towards an intersection. ");
    ...
    add_exit(ROOM + "village_b","west",0,3);
    add_exit(ROOM + "village_01","east",0,3);

/*
 * Who          : Hestos minotaurs, a random random male/female minotaur.
 * Located      : The Toron minotaur village near Crystalmir Lake outside
 *                Solace.
 *                /d/Krynn/solace/lake/npc
 * Description  : Hestos minotaurs for the Toron village. Wields axe or
 *                 sword.
...
string *adjlist2 = ({ "battle-hardened", "veteran",  "battle-scarred",
                      "experienced" });

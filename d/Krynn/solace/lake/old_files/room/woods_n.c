...
create_solace_room() 
{
    ...
    set_long("You have entered some dark, rather nasty woods to the " +
	     "north of an encampment . It seems that these guards like the " +
    ...
    add_exit(ROOM + "camp_ent","southwest",0);
    add_exit(ROOM + "campfire","south","@@check_mino");
    reset_room();
}

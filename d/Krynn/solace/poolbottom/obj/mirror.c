...
#define MIRROR_DESTINATION "/d/Krynn/wayreth/tower/guestroom.c"
    ...
    if ((str=="mirror")||(str=="into mirror")) 
    {
     ...
     if(mirror_activated)
     {
         write("Staring into the mirror, you no longer see a reflection of yourself! " +
            "You see a room somewhere else... a quaint guest room filled with memorabilia " +
            "from the realms of Krynn, permanently lit by a magical crystal globe floating " +
            "near the ceiling. The vision looks so real, you feel you could enter the " +
            "mirror to go to that location.\n");

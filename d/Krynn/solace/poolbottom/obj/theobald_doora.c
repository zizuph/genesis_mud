...
create_door()
{
   ...
   set_other_room("/d/Krynn/solace/poolbottom/room/masters_room");
   set_door_desc("This elaborate double door in the entrance to the " +
       "private residence of Master Theobald, the head of the school " +
       "of High Magic.\n");

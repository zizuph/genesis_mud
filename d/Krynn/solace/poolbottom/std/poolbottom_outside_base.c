...
long_far_desc()
{
	...
	case MIDNIGHT:
	case NIGHT:
	    str = "You stand on a snow-covered path leading in a northerly direction to a large " +
...
add_item_snow()
{
    ...
    {
    case WINTER:
	str = "It is winter, and the lands surrounding Solace are draped with a " +
          "thick layer of white snow. Angry black storm clouds " +
          "cast a pall over the land, blunting the purity of the fields of white " +
          "around you.\n";
	break;
    case SUMMER:
    case SPRING:
...
add_item_path()
{
    ...
    {
    case WINTER:
	str = "You stand on a cobbled path currently covered with fresh snow, leading to a large " +
              "stone building. It seems the path was either recently travelled or cleared, " +
              "as the snow here is not as deep as the snow that drapes the lands around you.\n";
	break;
    case SUMMER:
    case SPRING:
    case AUTUMN:
...
add_item_snow_path()
{
    ...
    case SPRING:
    case AUTUMN:
	str = "You find no snow-covered path. The cobbled path looks snow free.\n";
	break;
    }
    return str;
}
...
add_item_wings()
{
	...
	case MIDNIGHT:
	case NIGHT:
	    str = "It is difficult to make out the details of the large building through the " +
               "darkness of night.\n";
	    break;
	case EARLY_MORNING:
	case MORNING:
	...
	case AFTERNOON:
	case EVENING:
	    str = "Adjoining the main structure of the large stone building - precisely to its " +
              "east and west - are two subordinate buildings.\n";
	    break;
    }
    return str;
}
...
create_krynn_room()
{
	...
	"snow-covered school","field of white","field","fields",
	"white","snow-covered land"}),
      "@@add_item_snow");

    add_item(({"path","cobbled path"}),
      "@@add_item_path");
    add_item(({"snow-covered path"}),
      "@@add_item_snow_path");
    ...
    add_item(({"wings","east wing","west wing","subordinate buildings"}),
        "@@add_item_wings");

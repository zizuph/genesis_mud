...
create_camp()
{
    ...
    add_exit(DROOM + "campj", "northwest");
    add_exit(DROOM + "campk", "north");
    add_exit(DROOM + "campl", "northeast");
    add_exit(DROOM + "campp", "east");
    add_exit(DROOM + "camp8", "southeast");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tento",0,0);
   return 1;
}

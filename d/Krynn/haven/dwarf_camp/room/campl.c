...
create_camp()
{
    ...
    add_exit(DROOM + "campe", "northwest");
    add_exit(DROOM + "campf", "north");
    add_exit(DROOM + "campg", "northeast");
    add_exit(DROOM + "campm", "east");
    add_exit(DROOM + "campq", "southeast");
    add_exit(DROOM + "campp", "south");
    add_exit(DROOM + "campo", "southwest");
    add_exit(DROOM + "campk", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentl",0,0);
   return 1;
}

...
create_camp()
{
    ...
    add_exit(DROOM + "campd", "northwest");
    add_exit(DROOM + "campe", "north");
    add_exit(DROOM + "campf", "northeast");
    add_exit(DROOM + "campl", "east");
    add_exit(DROOM + "campp", "southeast");
    add_exit(DROOM + "campo", "south");
    add_exit(DROOM + "campj", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentk",0,0);
   return 1;
}

...
create_camp()
{
    ...
    add_exit(DROOM + "camp7", "northwest");
    add_exit(DROOM + "campb", "north");
    add_exit(DROOM + "campi", "east");
    add_exit(DROOM + "campn", "south");
    add_exit(DROOM + "campm", "southwest");
    add_exit(DROOM + "campg", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tenth",0,0);
   return 1;
}

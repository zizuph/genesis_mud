...
create_camp()
{
    ...
    add_exit(DROOM + "campa", "north");
    add_exit(DROOM + "camp5", "northeast");
    add_exit(DROOM + "campe", "east");
    add_exit(DROOM + "campk", "southeast");
    add_exit(DROOM + "campj", "south");
    add_exit(DROOM + "campc", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentd",0,0);
   return 1;
}

...
create_camp()
{
    ...
    add_exit(DROOM + "campl", "northwest");
    add_exit(DROOM + "campm", "north");
    add_exit(DROOM + "campn", "northeast");
    add_exit(DROOM + "camp8", "southwest");
    add_exit(DROOM + "campp", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentq",0,0);
   return 1;
}

...
create_camp()
{
    ...
    add_exit(DROOM + "campf", "northwest");
    add_exit(DROOM + "campg", "north");
    add_exit(DROOM + "camph", "northeast");
    add_exit(DROOM + "campn", "east");
    add_exit(DROOM + "campq", "south");
    add_exit(DROOM + "campp", "southwest");
    add_exit(DROOM + "campl", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentm",0,0);
   return 1;
}

...
create_camp()
{
    ...
    add_exit(DROOM + "camp2", "northeast");
    add_exit(DROOM + "camp5", "east");
    add_exit(DROOM + "campe", "southeast");
    add_exit(DROOM + "campd", "south");
    add_exit(DROOM + "campc", "southwest");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tenta",0,0);
   return 1;
}

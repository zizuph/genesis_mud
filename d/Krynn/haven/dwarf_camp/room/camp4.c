...
create_camp()
{
    ...
    add_exit(DROOM + "camp1", "northwest");
    add_exit(DROOM + "campb", "southeast");
    add_exit(DROOM + "camp7", "south");
    add_exit(DROOM + "camp6", "southwest");
    add_exit(DROOM + "camp3", "west");
...
my_desc()
{
	...
	return "You're on the eastern side of the dwarven encampment. To the "+
               "northwest is the entrance to the camp. You also notice a large canvas tent.\n";
    ...
    return "You're in the eastern part of the dwarven encampment. The dwarves "+
           ...
           "Haven. The entrance is to the northwest. You also notice a large canvas tent.\n";
}
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tent4",0,0);
   return 1;
}

...
create_camp()
{
    ...
    add_exit(DROOM + "camp5", "northwest");
    add_exit(DROOM + "camp6", "north");
    add_exit(DROOM + "camp7", "northeast");
    add_exit(DROOM + "campg", "east");
    add_exit(DROOM + "campm", "southeast");
    add_exit(DROOM + "campl", "south");
    add_exit(DROOM + "campk", "southwest");
    add_exit(DROOM + "campe", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentf",0,0);
   return 1;
}

...
create_camp()
{
    ...
    add_exit(DROOM + "camp4", "northwest");
    add_exit(DROOM + "campi", "southeast");
    add_exit(DROOM + "camph", "south");
    add_exit(DROOM + "campg", "southwest");
    add_exit(DROOM + "camp7", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentb",0,0);
   return 1;
}

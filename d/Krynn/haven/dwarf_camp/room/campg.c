...
create_camp()
{
    ...
    add_exit(DROOM + "camp6", "northwest");
    add_exit(DROOM + "camp7", "north");
    add_exit(DROOM + "campb", "northeast");
    add_exit(DROOM + "camph", "east");
    add_exit(DROOM + "campn", "southeast");
    add_exit(DROOM + "campm", "south");
    add_exit(DROOM + "campl", "southwest");
    add_exit(DROOM + "campf", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentg",0,0);
   return 1;
}

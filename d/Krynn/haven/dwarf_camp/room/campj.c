...
create_camp()
{
    ...
    add_exit(DROOM + "campc", "northwest");
    add_exit(DROOM + "campd", "north");
    add_exit(DROOM + "campe", "northeast");
    add_exit(DROOM + "campk", "east");
    add_exit(DROOM + "campo", "southeast");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentj",0,0);
   return 1;
}

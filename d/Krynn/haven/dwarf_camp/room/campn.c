...
create_camp()
{
    ...
    add_exit(DROOM + "campg", "northwest");
    add_exit(DROOM + "camph", "north");
    add_exit(DROOM + "campi", "northeast");
    add_exit(DROOM + "campq", "southwest");
    add_exit(DROOM + "campm", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tentn",0,0);
   return 1;
}

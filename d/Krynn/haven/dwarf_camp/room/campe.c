...
create_camp()
{
    ...
    add_exit(DROOM + "campa", "northwest");
    add_exit(DROOM + "camp5", "north");
    add_exit(DROOM + "camp6", "northeast");
    add_exit(DROOM + "campf", "east");
    add_exit(DROOM + "campl", "southeast");
    add_exit(DROOM + "campk", "south");
    add_exit(DROOM + "campj", "southwest");
    add_exit(DROOM + "campd", "west");
...
enter_tent(string str)
{
   ...
   TP->move_living("M",DROOM + "tente",0,0);
   return 1;
}

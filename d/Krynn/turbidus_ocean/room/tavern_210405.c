...
create_sea_room()
{
    ...
    set_short("Reefcutter's tavern");
    set_long("@@long_descr");
    add_prop(ROOM_I_NO_CLEANUP, 1);

    add_item("smoke","A haze of smoke hangs heavily in Reefcutter's " +
      "tavern \n");
    ...
    add_item(({"reefcutter's tavern","tavern"}),"You stand " +
      "within Reefcutter's Tavern, a rowdy tavern in the lawless " +
      "pirate cove of Reefcutter's Jetty.\n");
    add_item("patrons","Consisting mainly of pirates, corsairs, " +
      "and brigands, it is no wonder that this place is nothing " +
      "short of lively.\n");
    add_item("door","To the west the tavern door leads out " +
      "onto the jetty.\n");
    ...
    add_prop("_minstrel_performance_location", ({ "Reefcutter's Jetty", 1 }) );
...
long_descr()
{
    return "You stand in the rowdy tavern known as 'Reefcutter's " +
    "Tavern'. From the looks of things, this tavern is " +

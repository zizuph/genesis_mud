...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7s", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "8t", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "9s", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "8r", "west", "@@becalmed", 1);

    add_exit(ROOM + "8suw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "8suw1");

...
string *herbs = HERB_MASTER->query_herbs( ({ "farshore", }) );
...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "5w", "south", 0, 1);
    add_row_exit(ROOM + "6x", "east", 0, 1);
    add_row_exit(ROOM + "7w", "north", 0, 1);
    add_row_exit(ROOM + "6v", "west", 0, 1);

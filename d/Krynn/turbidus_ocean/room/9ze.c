...
create_sea_room()
{
    ...
    add_item(({"rugged coastline","coastline","barren coastline",
       ...
       "To your south stretches a rugged and barren coastline, the northern tip " +
    ...
    add_row_exit(ROOM + "10ze", "north", 0, 1);
    add_row_exit(ROOM + "9zf", "east", 0, 1);
    add_row_exit(ROOM + "9zd", "west", 0, 1);
    add_row_exit(ROOM + "8zf", "southeast", 0, 1);

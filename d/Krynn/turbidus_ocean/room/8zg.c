...
create_sea_room()
{
    ...
    add_item(({"rugged coastline","coastline","barren coastline",
       ...
       "To your southwest stretches a rugged and barren coastline, the northern tip " +
    ...
    add_row_exit(ROOM + "7zh", "southeast", 0, 1);
    add_row_exit(ROOM + "8zh", "east", 0, 1);
    add_row_exit(ROOM + "9zg", "north", 0, 1);
    add_row_exit(ROOM + "8zf", "west", 0, 1);

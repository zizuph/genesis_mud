...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "13s", "south", 0, 1);
    add_row_exit(ROOM + "high_sea_transit", "east", 0, 1);
    add_row_exit(ROOM + "high_sea_transit", "north", 0, 1);
    add_row_exit("/d/Genesis/start/human/town/jetty1", "west", 0, 1);
...
short_descr()
{
    return "the vast Toroid high seas";
}

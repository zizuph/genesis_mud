...
create_sea_room()
{
    ...
    add_item(({"rugged coastline","coastline","barren coastline",
       ...
       "To your east stretches a rugged and barren coastline, the beginning " +
    ...
    add_row_exit(ROOM + "9zb", "north", 0, 1);
    add_row_exit(ROOM + "9zc", "northeast", 0, 1);
    add_row_exit(ROOM + "8za", "west", 0, 1);
    add_row_exit(ROOM + "7zb", "south", 0, 1);
...
long_descr()
{
    return turbidus_sea_desc() + "To your east you can make out a rugged " +

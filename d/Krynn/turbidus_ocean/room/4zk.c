...
create_sea_room()
{
    ...
    add_item(({"rugged coastline","coastline","barren coastline",
       ...
       "To your west stretches a rugged and barren coastline, the beginning " +
       "of the vast Northern Wastes that borders the fertile lands of Solamnia. " +
       "Dry rolling hills make up the coastline before " +
    ...
    add_row_exit(ROOM + "5zj", "northwest", 0, 1);
    add_row_exit(COURRAIN + "5e", "east", 0, 1);
    add_row_exit(COURRAIN + "4e", "southeast", 0, 1);
    add_row_exit(ROOM + "5zk", "north", 0, 1);
...
short_descr()
{
    return "near a rugged coastline opening to the Turbidus Ocean";
}
 
string
long_descr()
{
    return turbidus_sea_desc() + "To your west you can make out a rugged " +

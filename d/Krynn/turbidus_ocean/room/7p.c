...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "6p", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "7q", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "8p", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "7o", "west", "@@becalmed", 1);

    add_exit(ROOM + "7puw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "7puw1");

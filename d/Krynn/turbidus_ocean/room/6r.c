...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7r", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "6s", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "6q", "west", "@@becalmed", 1);

    add_exit(ROOM + "6ruw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "6ruw1");

...
create_sea_room()
{
    ...
    add_item(({"rugged coastline","coastline","barren coastline",
       ...
       "To your southeast stretches a rugged and barren coastline, the beginning " +
    ...
    add_item(({"turbidus ocean","ocean","sea"}),
        "To your northwest stretches the Turbidus Ocean - a massive body of water " +
        "that extends from the Courrain Ocean in the east, across northern " +
        "Ansalon to the Sirrion Sea in the west.\n");
    add_item(({"bay", "entry"}),
        "To your southwest is the entry to a bay full of dangerous shoals and sandbars, " +
        "beyond which you notice a sheltered beach suitable for mooring a ship and " +
        "making landfall.\n");
    add_item(({"sheltered beach","beach","sheltered sandy beach","sandy beach"}),
        "To your southwest at the end of the bay you can make out a sheltered sandy beach " +
        "that would be suitable to moor a ship and make landfall.\n");
    add_item(({"dangerous shoals","shoals","sandbars"}),
        "The bay to your southwest is riddled with dangerous shoals and sandbars " +
        "that would require skilled navigation to bypass and get to a sheltered " +
        "sandy beach on the edge of the bay.\n"); 

    add_row_exit(ROOM + "7zb", "north", 0, 1);
    add_row_exit(ROOM + "6za", "west", 0, 1);
    add_row_exit(ROOM + "5za", "southwest", 0, 1);
...
long_descr()
{
    return turbidus_sea_desc() + "To your southeast you can make out a rugged " +
        "coastline of dry, rolling hills. To your southwest is " +
        "a bay full of dangerous shoals and sandbars that form a natural " +
        "barrier to a sheltered sandy beach suitable for mooring a ship. "+

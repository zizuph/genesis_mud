...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7r", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "8s", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "9r", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "8q", "west", "@@becalmed", 1);

    add_exit(ROOM + "8ruw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "8ruw1");

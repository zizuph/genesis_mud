...
create_sea_room()
{
    ...
    add_item(({"turbidus ocean","ocean","sea"}),
        "You swim near the surface of the Turbidus Ocean - a massive body of water " +
    ...
    add_item(({"sea stack", "stack", "column", "column of rock",
        ...
        "from the sea floor here like a black spear of the gods.\n");
    ...
    add_exit(ROOM + "7q", "up", "@@swim_up", 1, 1);
    add_exit(ROOM + "7quw2", "down", "@@swim_down", 1, 1);

    set_sink_path(ROOM + "7quw2");
...
short_descr()
{
    return "near the surface of the Turbidus Ocean, beside a great sea stack";
}
 
string
long_descr()
{
    return "You are near the surface of Turbidus Ocean within dark and " +
        ...
        "rising like a grim volcanic spear to the surface.\n";
}

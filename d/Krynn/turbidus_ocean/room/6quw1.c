...
create_sea_room()
{
    ...
    add_item(({"reef","great reef","coral","maze"}),
        "To your south is a great reef, a wall of coral that blocks any passage " +
        "in that direction.\n");
    ...
    add_exit(ROOM + "6q", "up", "@@swim_up", 1, 1);
    add_exit(ROOM + "6quw2", "down", "@@swim_down", 1, 1);

    set_sink_path(ROOM + "6quw2");
...
short_descr()
{
    return "near the surface of the Turbidus Ocean";
}
...
long_descr()
{
    return "You are near the surface of Turbidus Ocean within dark and " +
        ...
        "To your south is a great reef, a wall of corals that make " +

...
create_sea_room()
{
    ...
    add_item(({"reef","great reef","coral","maze"}),
        "To your east is a great reef, a maze of coral that would take a " +
    ...
    add_row_exit(ROOM + "6n", "north", 0, 1);
    add_row_exit(ROOM + "6o", "northeast", 0, 1);
    add_row_exit(REEF + "reef_entry_west", "east", 0, 1);
    add_row_exit(ROOM + "4n", "south", 0, 1);
    add_row_exit(ROOM + "4o", "southeast", 0, 1);
    add_row_exit(ROOM + "5m", "west", 0, 1);
...
long_descr()
{
    return turbidus_sea_desc() + "To your east is the edge of a great reef, a " +

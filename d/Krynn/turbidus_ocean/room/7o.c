...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "6o", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "7p", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "8o", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "7n", "west", "@@becalmed", 1);

    add_exit(ROOM + "7ouw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "7ouw1");

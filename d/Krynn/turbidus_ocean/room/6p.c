...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7p", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "6q", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "6o", "west", "@@becalmed", 1);

    add_exit(ROOM + "6puw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "6puw1");

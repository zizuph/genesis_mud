...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "6s", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "7t", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "8s", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "7r", "west", "@@becalmed", 1);

    add_exit(ROOM + "7suw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "7suw1");

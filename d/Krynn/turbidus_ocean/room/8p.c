...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7p", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "8q", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "9p", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "8o", "west", "@@becalmed", 1);

    add_exit(ROOM + "8puw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "8puw1");

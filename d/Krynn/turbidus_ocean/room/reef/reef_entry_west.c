...
create_sea_room()
{
    ...
    add_item(({"reef","great reef","coral","maze"}),
        "Your are at the western edge of a great reef, a maze of coral that " +
        "would take a skilled sailor to navigate. You have no doubt the reef " +
        "holds the wrecks of many unfortunate or foolish captains who were not " +
        "up to the task.\n");

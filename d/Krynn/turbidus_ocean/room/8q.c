...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7q", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "8r", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "9q", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "8p", "west", "@@becalmed", 1);

    add_exit(ROOM + "8quw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "8quw1");

...
create_sea_room()
{
    ...
    add_item(({"rugged coastline","coastline","barren coastline",
       ...
       "To your southeast stretches a rugged and barren coastline, the southwestern " +
    ...
    add_row_exit(ROOM + "6y", "east", 0, 1);
    add_row_exit(ROOM + "6w", "west", 0, 1);
    add_row_exit(ROOM + "7x", "north", 0, 1);
    add_row_exit(ROOM + "5x", "south", 0, 1);

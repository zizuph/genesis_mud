...
create_sea_room()
{
    ...
    add_item(({"shape","long shape","shape in the water",
        "long shape in the water"}),"Looking through the "+
        "ever-shifting surface of the water, you see the long "+
        "shape of a ship's mast protruding from the depths at "+
        "an angle. There must be a wreck further down out of sight.\n");
...
long_descr()
{
    return turbidus_sea_desc() + "There is a long shape in the water. "+
        "To your south you can make out a rugged " +

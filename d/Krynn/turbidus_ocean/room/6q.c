...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7q", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "6r", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "6p", "west", "@@becalmed", 1);

    add_exit(ROOM + "6quw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "6quw1");

...
#define SAILOR_EQUIP  ({ ROPE, LANTERN, OIL })
...
do_list(string args)
{
    ...
    {
        ::do_list(args);
        write(" --- Standard sailor equipment available by 'list equipment'\n");
        return 1;
    }
    write("This is the standard sailor equipment in stock at this shop:\n\n" +
    "+-------------------------------------------------------------------+\n"+

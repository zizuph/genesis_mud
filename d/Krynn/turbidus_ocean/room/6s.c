...
create_sea_room()
{
    ...
    add_item(({"reef","great reef","coral","maze"}),
        "To your southwest is a great reef, a maze of coral that would take a " +
    ...
    add_row_exit(ROOM + "7s", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "5t", "southeast", "@@becalmed", 1);
    add_row_exit(ROOM + "6t", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "6r", "west", "@@becalmed", 1);

    add_exit(ROOM + "6suw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "6suw1");
...
long_descr()
{
    return turbidus_sea_desc() + "The waters here churn malevolently, as if " +
        ...
        "To your southwest is the edge of a great reef, a " +

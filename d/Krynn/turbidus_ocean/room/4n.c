...
create_sea_room()
{
    ...
    add_item(({"rugged coastline","coastline","barren coastline","tanith",
       ...
       "To your south stretches a rugged and barren coastline, the Solamnian " +
    ...
    add_row_exit(ROOM + "4o", "east", 0, 1);
    add_row_exit(ROOM + "3o", "southeast", 0, 1);
    add_row_exit(ROOM + "5n", "north", 0, 1);
    add_row_exit(ROOM + "4m", "west", 0, 1);

...
create_sea_room()
{
    ...
    add_row_exit(ROOM + "7o", "south", "@@becalmed", 1);
    add_row_exit(ROOM + "8p", "east", "@@becalmed", 1);
    add_row_exit(ROOM + "9o", "north", "@@becalmed", 1);
    add_row_exit(ROOM + "8n", "west", "@@becalmed", 1);

    add_exit(ROOM + "8ouw1", "down", "@@swim_down", 1, 1);
    set_sink_path(ROOM + "8ouw1");

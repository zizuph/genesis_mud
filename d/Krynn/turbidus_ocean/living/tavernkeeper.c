 ...
 *    (manifest as a shadow on sailors and thence ships)
 *
 * Between death and respawning, Nax Zeb is thought to be
 *   drawing ships into the deeps in service to Zeboim.
 *
 * When Zeboim curses him back to life, he comes back to the
 *   tavern bearing weapons and other items from the wrecked
...
create_krynn_monster()
{
    ...
    add_prop(NPC_M_NO_ACCEPT_GIVE," doesn't take from the hands of strangers, "+
                "he bids you <put> what you would have him take and "+
                "<donate> it.\n");
...
notify_death(object killer)
{
    ...
    string str = "O Zeboim release me now! Take these others to "+
                 "the cold depths of your bosom in my place!";
...
donate_it(string str)
{
    ...
    if ( cannot_see_speaker() ) return 1;

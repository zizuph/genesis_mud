/* 
 * Trinkets worn by the sahuagin in the Turbidus Ocean.
 *
...
add_name("trinket");
    ...
    set_short(my_short);
    set_long("This " + name1 + " is a barbaric trinket commonly worn by " +
        "the monstrous creatures of the deepest oceans, the sahuagin.\n");
...
make_the_trinket()
{
    adj1 = one_of_list(({"tribal", "simple", "runed", "coral", 
        "bone", "ornate", "pearl-studded" }));

    name1 = one_of_list(({"talisman", "charm", "amulet", "pendant",
"ornament", "brassard", "armlet", "necklace"}));

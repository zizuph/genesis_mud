...
static object   shadow_ship_outer;  /* ship (outer) associated with the shadowed obj */
static object   shadow_ship_locn;  /* sea room location associated with ship outer */
static object   shadow_ship_lastlocn;  /* prior sea room location associated with ship outer */

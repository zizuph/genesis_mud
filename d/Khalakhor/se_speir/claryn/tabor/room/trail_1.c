...
check_view()
{
    ...
    return "From a gentle saddle between grassy hills, you see the sleepy " +
...
create_khalakhor_room()
{
    ...
    set_long("   @@check_view@@You are on a lightly trampled " +
        ...
        "village below. Rocky outcrops on the hill obscure the " +
        "way up to the crest of the hill.\n");

    add_exit(PLAINS + "plains_39_26", "north");
    add_exit(ROOM + "trail_2", "south");
    add_exit(ROOM + "trail_0", "up", 0, 0, 1);

...
leave_inv(object ob, object to)
{
    ...
    {
        ob->catch_tell("You stand from the edge of the fountain.\n");
...
#define SIT_STR ({ "down", "edge", "along the edge" })
...
do_sit(string str)
{
    ...
    else
    {
        ...
        write("You sit down along the edge of the fountain.\n");
        say(QCTNAME(this_player())+ " sits down on the edge of the fountain.\n");
    }
...
do_stand(string arg)
{
    ...
    {
        write("You stand up from the edge of the fountain.\n");
        say(QCTNAME(this_player()) + " stands up from the edge of the fountain.\n");
...
seat_desc()
{
    ...
    str = "The ring of the concavity offer adequate seating.\n";
    ...
    if ((j == 1) && (obs[0] == this_player()))
        return str + "You are sitting on the edge of the fountain.\n";
    ...
    return str + capitalize(COMPOSITE_WORDS(who)) + (j == 1 ? 
        " is" : " are") +" sitting along the edge of the fountain.\n";
}
...
show_subloc(string subloc, object on, object for_ob)
{
    ...
    if (tmp[0] < 3)
    {
        str += " sitting along the edge of the fountain";

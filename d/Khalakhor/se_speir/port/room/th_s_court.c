 ...
 * th_s_court.c
 *
 * This is the south courtyard for the town hall in Port
 * Macdunn.
 *
 * Khail - May 16/97
 */
...
create_khalakhor_room()
{
    ...
    set_long("   You are standing in the southern part of " +
        ...
        "courtyard to the south and west, the wall " +

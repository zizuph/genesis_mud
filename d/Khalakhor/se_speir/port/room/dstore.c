...
{
	set_short("Storeroom");
	set_long("This is the store room for dresses and gowns.\n");
	add_exit("dshop", "out");
...
#define CLOAK   ("/d/Khalakhor/se_speir/port/arm/cloak1")
#define DRESS1  ("/d/Khalakhor/se_speir/port/arm/dress1")
#define GOWN1   ("/d/Khalakhor/se_speir/port/arm/gown1")
#define DRESS2  ("/d/Khalakhor/se_speir/port/arm/dress2")
#define GOWN2   ("/d/Khalakhor/se_speir/port/arm/gown2")
#define BOW     ("/d/Khalakhor/se_speir/port/arm/bow")
...
mixed to_check = ({ ({"create_armour", CLOAK,   8}),
                    ({"create_armour", DRESS1,  4}),
                    ({"create_armour", GOWN1,   4}),
                    ({"create_armour", DRESS2,  4}),
                    ({"create_armour", GOWN2,   4}),
                    ({"create_armour", BOW,     8}), 
                 });

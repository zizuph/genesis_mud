/*
 * This is the first room on first road in Port Macdunn.
 *
 * Khail - May 16/97
 */
#pragma strict_types
...
create_road()
{
    ...
    set_long("   You are on a road leading east along " +
        ...
        "Cala Fasgadh. To the west rises the earthen embankment " +
        "which surrounds the village, preventing further " +
        "progress in that direction.\n");

    add_exit(ROOM + "road_4_9", "east");
}

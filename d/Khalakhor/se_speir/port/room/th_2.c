...
block_south()
{
    write("That area is the private living quarters of " +
        "the Lord of Port Macdunn, and off limits to " +
        "all but personal guests.\n");
    return 1;
}
...
create_khalakhor_room()
{
    ...
    set_long("   You've entered the brightly lit foyer of " +
        ...
        "orange tinge. South of here are the living " +
        "quarters of the lord of the town, which are " +
        "off-limits except to personal guests. East " +
        "of here seems to be some sort of common room, " +
    ...
    add_exit(ROOM + "th_5", "south", VBFC_ME("block_south"));

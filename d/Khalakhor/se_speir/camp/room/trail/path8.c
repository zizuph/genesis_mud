...
create_room()
{
    ...
    set_long("The trail now leads further into the mountain, forcing "
      ...
      +"peace. To the south, there is a slope for which must be climbed "
      +"down to travel southwards.\n");
    ...
    add_item(({"slope","south","southwards"}),
	  	  "To the south, the trail goes down a natural slope. If "
	  	 +"you choose to descend from the mountains of Khalakhor, "
	  	 +"you are quite aware that the air will get "
	  	 +"thicker and climbing will become more easy.\n");
  add_exit(CAMP_DIR+"path7","down",0,1);
  add_exit(CAMP_DIR+"path9","northeast",0,1);
}

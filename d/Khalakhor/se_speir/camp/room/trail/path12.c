...
create_room()
{
    ...
    set_long("The trail now leads further into the mountains to the "
        ...
        +"top of this mountain. Around you are clouds, below you can see "
        +"Port Macdunn in the distance, and an overlook of the valley.\n");
    ...
    add_exit(CAMP_DIR+"path13","northwest",0,1);
    add_exit(CAMP_DIR+"path11","southeast",0,1);
...
listen_sounds(string str)
{
   ...
   +"to listen to the sounds around the area.\n");
    ...
    +"sound of sparring becomes more definite, blending "

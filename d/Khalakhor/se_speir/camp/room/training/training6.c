...
void
 create_room()
 {
  ...
  add_exit(CAMP_DIR3+"training5","west",0,1);
  add_exit(CAMP_DIR3+"training7","east",0,1);
  add_exit(CAMP_DIR3+"training13","south",0,1);
...
enter_tent(string str)
{
   ...
   TP->move_living("M",CAMP_DIR4+"trainingtent6",0,0);
   return 1;
}
void
init()

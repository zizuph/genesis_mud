...
void
 create_room()
 {
  ...
  add_exit(CAMP_DIR3+"training7","north",0,1);
  add_exit(CAMP_DIR3+"training13","west",0,1);
  add_exit(CAMP_DIR3+"training21","south",0,1);
...
enter_tent(string str)
{
   ...
   TP->move_living("M",CAMP_DIR4+"trainingtent14",0,0);
   return 1;
}
void
init()

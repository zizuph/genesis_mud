...
void
 create_room()
 {
  ...
  add_exit(CAMP_DIR3+"training10","north",0,1);
  add_exit(CAMP_DIR3+"training16","west",0,1);
  add_exit(CAMP_DIR3+"training18","east",0,1);
...
enter_tent(string str)
{
   ...
   TP->move_living("M",CAMP_DIR4+"trainingtent17",0,0);
   return 1;
}
void
init()

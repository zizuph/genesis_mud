...
void
 create_room()
 {
  ...
  add_exit(CAMP_DIR3+"training4","north",0,1);
  add_exit(CAMP_DIR3+"training10","west",0,1);
  add_exit(CAMP_DIR3+"training12","east",0,1);
  add_exit(CAMP_DIR3+"training18","south",0,1);
...
enter_tent(string str)
{
   ...
   TP->move_living("M",CAMP_DIR4+"trainingtent11",0,0);
   return 1;
}
void
init()

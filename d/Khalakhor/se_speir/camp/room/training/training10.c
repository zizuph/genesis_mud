...
void
 create_room()
 {
  ...
  add_exit(CAMP_DIR3+"training3","north",0,1);
  add_exit(CAMP_DIR3+"training9","west",0,1);
  add_exit(CAMP_DIR3+"training11","east",0,1);
  add_exit(CAMP_DIR3+"training17","south",0,1);
...
enter_tent(string str)
{
   ...
   TP->move_living("M",CAMP_DIR4+"trainingtent10",0,0);
   return 1;
}
void
init()

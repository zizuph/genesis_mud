...
void
 create_room()
 {
  ...
  add_exit(CAMP_DIR3+"training2","north",0,1);
  add_exit(CAMP_DIR3+"training8","west",0,1);
  add_exit(CAMP_DIR3+"training10","east",0,1);
  add_exit(CAMP_DIR3+"training16","south",0,1);
...
enter_tent(string str)
{
   ...
   TP->move_living("M",CAMP_DIR4+"trainingtent9",0,0);
   return 1;
}
void
init()

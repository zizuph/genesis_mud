...
void
 create_room()
 {
  ...
  add_exit(CAMP_DIR3+"training2","west",0,1);
  add_exit(CAMP_DIR3+"training0","northeast",0,1);
  add_exit(CAMP_DIR3+"training4","east",0,1);
  add_exit(CAMP_DIR3+"training10","south",0,1);
...
enter_tent(string str)
{
   ...
   TP->move_living("M",CAMP_DIR4+"trainingtent3",0,0);
   return 1;
}
void
init()

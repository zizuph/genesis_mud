...
void
 ...
 {
  ::create_room();
  set_short("the entrance of a barbarian celtic camp");
  ...
  add_exit(CAMP_DIR2+"camp2","north",0,0);
  add_exit(CAMP_DIR2+"tent1","in",0,0);
  add_exit(CAMP_DIR+"entrance","south",0,0);

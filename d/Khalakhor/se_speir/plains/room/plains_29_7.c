...
create_khalakhor_room()
{
    ...
    add_exit(PLAINS + "plains_30_7", "east");
    add_exit(PLAINS + "plains_30_8", "southeast");
    add_exit(PLAINS + "plains_29_8", "south");
    add_exit(PLAINS + "plains_28_8", "southwest");
    add_exit(PLAINS + "plains_28_7", "west");
}

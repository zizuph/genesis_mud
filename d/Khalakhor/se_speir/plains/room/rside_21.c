/* File         : /d/Khalakhor/se_speir/plains/room/rside_21.c
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "rside_20","west",0,1,0);
   add_exit(PLAINS + "rside_22","north",0,1,0);
   add_exit(PLAINS + "rside_23","northeast",0,1,0);
   add_exit(PLAINS + "rside_19","southwest",0,1,0);
   ...
   set_long("   You are on a wide patch of bare land between a "
          ...
          + "edge of a high cliff wall a few steps to your west.\n");

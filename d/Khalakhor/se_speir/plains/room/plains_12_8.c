...
{
    extra = "To the southeast rises the earthen embankment " +
    ...
    add_exit(PLAINS + "plains_13_7", "northeast");
    add_exit(PLAINS + "plains_13_8", "east");
    add_exit(PLAINS + "plains_12_9", "south");
    add_exit(PLAINS + "plains_11_9", "southwest");
    add_exit(PLAINS + "plains_11_8", "west");
}
int
do_lay(string str)
{

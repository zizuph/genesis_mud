/* File         : /d/Khalakhor/se_speir/plains/room/rside_26.c
...
create_khalakhor_room()
{
   ...
   add_item(({"river","water","stream","rapid river"}),
            ...
            + "cross would lead to a certain death.\n");
   ...
   add_exit(PLAINS + "rside_25","south",0,1,0);

   add_cmd_item("cliff","climb",climb_cliff);
   add_cmd_item("river","swim",swim_river);

   set_short("By a rapid river");
   set_long("   You are at the end of a narrow strip of bare land between a "
          + "furious river east of you, and just beneath the "
          + "edge of a high cliff wall to your west. It is "
          + "impossible to continue north as the cliff wall "
          + "blocks your path.\n");

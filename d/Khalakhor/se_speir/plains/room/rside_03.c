/* File         : /d/Khalakhor/se_speir/plains/room/rside_03.c
...
climb_ridge()
{
   ...
   TP->move_living("climbing up the side of the cliff, "
                 + "eventually reaching the top" ,PLAINS + "tfor_e_16.c",1,0);
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "rside_04","north",0,4,0);
   add_exit(PLAINS + "rside_02","south",0,4,0);

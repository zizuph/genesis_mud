...
create_khalakhor_room()
{
    ...
    proxim = (["harbour": ({4, "southwest"})]);

    create_plain();

    add_exit(PLAINS + "plains_13_7", "north");
    add_exit(PLAINS + "plains_14_7", "northeast");
    add_exit(PLAINS + "plains_14_8", "east");
    add_exit(PLAINS + "plains_12_8", "west");
}
int
do_lay(string str)
{

/* File         : /d/Khalakhor/se_speir/plains/room/rside_20.c
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "rside_22","northeast",0,1,0);
   add_exit(PLAINS + "rside_21","east",0,1,0);
   add_exit(PLAINS + "rside_19","south",0,1,0);
   ...
   set_long("   You are on a wide patch of bare land between a "
          + "furious river a few steps east of you, and just "
          + "beneath the edge of a high cliff wall to your "
          + "west. It is impossible to continue north as the "
          + "cliff wall blocks your path.\n");

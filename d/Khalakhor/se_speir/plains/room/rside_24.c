/* File         : /d/Khalakhor/se_speir/plains/room/rside_24.c
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "rside_25","north",0,1,0);
   add_exit(PLAINS + "rside_23","south",0,1,0);
   add_exit(PLAINS + "rside_22","southwest",0,1,0);
   ...
   set_long("   You are on a wide patch of bare land between a "
          ...
          + "edge of a high cliff wall to your west. This is "
          + "where the flat ground narrows into a strip as "
          + "it winds north.\n");

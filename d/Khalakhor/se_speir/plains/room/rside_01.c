/* File         : /d/Khalakhor/se_speir/plains/room/rside_01.c
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "rside_02","north",0,4,0);

   add_cmd_item("ridge","climb",climb_ridge);
   add_cmd_item("river","swim",swim_river);

   set_short("By a river in a light forest");
   set_long("   You are standing on a narrow strip of mostly dry ground "
          + "between a river to the east of you, flowing gently southwards, "
          + "and a high ridge blocking your way west. The strip narrows down "
          + "to nothing southwards as the ridge rises straight out of the "
          + "river, but it looks possible to continue to the north. A few "
          + "trees grow here, among the mass of bushes and heavy undergrowth.\n");

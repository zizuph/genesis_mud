/* File         : /d/Khalakhor/se_speir/plains/room/rside_19.c
...
create_khalakhor_room()
{
   ...
   add_item(({"river","water","stream","rapid river"}),
            ...
            + "cross it would lead to a certain death.\n");
   ...
   add_exit(PLAINS + "rside_20","north",0,1,0);
   add_exit(PLAINS + "rside_21","northeast",0,1,0);
   add_exit(PLAINS + "rside_top","south",0,1,0);

   add_cmd_item("cliff","climb",climb_cliff);
   add_cmd_item("river","swim",swim_river);

   set_short("By a rapid river");
   set_long("   You are on a narrow strip of bare land between a "
          + "furious river east of you, and just beneath the "
          + "edge of a high cliff wall to your west.\n");

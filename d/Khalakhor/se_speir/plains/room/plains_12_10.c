...
create_khalakhor_room()
{
    ...
    add_exit(PLAINS + "plains_12_9", "north");
    add_exit(PLAINS + "plains_12_11", "south");
    add_exit(PLAINS + "plains_11_11", "southwest");
    add_exit(PLAINS + "plains_11_10", "west");
    add_exit(PLAINS + "plains_11_9", "northwest");
}
int
do_lay(string str)
{

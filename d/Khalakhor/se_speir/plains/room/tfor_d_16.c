/* File         : /d/Khalakhor/se_speir/plains/room/tfor_d_16.c
...
climb_ridge()
{
   ...
   TP->move_living("climbing carefully down the ridge, "
                 ...
                 + "vegetation" ,PLAINS + "rside_04.c",1,0);
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "tfor_d_15","west",0,1,1);
   add_exit(PLAINS + "tfor_c_16","north",0,1,1);
   add_exit(PLAINS + "tfor_e_16","south",0,1,1);
   add_exit(PLAINS + "tfor_e_15","southwest",0,1,1);
   ...
   set_long(query_long() + " Northwest of you the forest looks too deep and "
                         ...
                         + "Moving in that direction seems hopeless. The "
                         + "ground abruptly drops to the east of you, creating "
                         + "the steep ridge that you stand on. You can hear "
                         + "the sound of a flowing river from the east.\n");
}

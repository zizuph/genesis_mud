/* File         : /d/Khalakhor/se_speir/plains/room/tfor_e_16.c
...
climb_ridge()
{
   ...
   TP->move_living("climbing carefully down the ridge, "
                 ...
                 + "vegetation" ,PLAINS + "rside_03.c",1,0);
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "tfor_e_15","west",0,1,1);
   add_exit(PLAINS + "tfor_d_15","northwest",0,1,1);
   add_exit(PLAINS + "tfor_d_16","north",0,1,1);
   add_exit(PLAINS + "tfor_f_16","south",0,1,1);
   add_exit(PLAINS + "tfor_f_15","southwest",0,1,1);

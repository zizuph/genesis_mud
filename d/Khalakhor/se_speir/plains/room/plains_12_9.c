...
{
    extra = "To the east rises the earthen embankment " +
    ...
    add_exit(PLAINS + "plains_12_8", "north");
    add_exit(PLAINS + "plains_12_10", "south");
    add_exit(PLAINS + "plains_11_10", "southwest");
    add_exit(PLAINS + "plains_11_9", "west");
    add_exit(PLAINS + "plains_11_8", "northwest");
}
int
do_lay(string str)
{

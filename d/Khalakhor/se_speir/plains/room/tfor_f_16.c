/* File         : /d/Khalakhor/se_speir/plains/room/tfor_f_16.c
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "tfor_f_15","west",0,1,1);
   add_exit(PLAINS + "tfor_e_15","northwest",0,1,1);
   add_exit(PLAINS + "tfor_e_16","north",0,1,1);
   add_exit(PLAINS + "tfor_g_16","south",0,1,1);
   add_exit(PLAINS + "tfor_g_15","southwest",0,1,1);

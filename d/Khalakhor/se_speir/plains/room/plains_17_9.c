...
create_khalakhor_room()
{
    ...
    add_exit(PLAINS + "plains_17_8", "north");
    add_exit(PLAINS + "plains_18_8", "northeast");
    add_exit(PLAINS + "plains_18_9", "east");
    add_exit(PLAINS + "plains_18_10", "southeast");
    add_exit(PLAINS + "plains_17_10", "south");
    add_exit(PLAINS + "plains_16_9", "west");
    add_exit(PLAINS + "plains_16_8", "northwest");
}
int
do_lay(string str)
{

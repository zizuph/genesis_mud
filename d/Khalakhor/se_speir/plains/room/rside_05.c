/* File         : /d/Khalakhor/se_speir/plains/room/rside_05.c
...
climb_ridge()
{
   ...
   TP->move_living("climbing up the side of the cliff, "
                 + "eventually reaching the top" ,PLAINS + "tfor_c_16.c",1,0);
...
create_khalakhor_room()
{
   ...
   add_exit(PLAINS + "rside_06","north",0,4,0);
   add_exit(PLAINS + "rside_04","south",0,4,0);

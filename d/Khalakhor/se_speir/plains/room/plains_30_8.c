...
create_khalakhor_room()
{
    ...
    add_exit(PLAINS + "plains_30_9", "south");
    add_exit(PLAINS + "plains_29_9", "southwest");
    add_exit(PLAINS + "plains_29_8", "west");
    add_exit(PLAINS + "plains_29_7", "northwest");
    add_exit(PLAINS + "plains_30_7", "north");
}
public int *
query_global_coords()
{

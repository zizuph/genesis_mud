/* File         : /d/Khalakhor/se_speir/rannoch/room/c_11.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "c_10.c","west",0,3,1);
   add_exit(ROOM + "b_12.c","northeast",0,3,1);
   add_exit(ROOM + "c_12.c","east",0,3,1);
   add_exit(ROAD + "d_12.c","southeast",0,3,1);
   add_exit(ROAD + "d_11.c","south",0,3,1);
   add_exit(ROAD + "d_10.c","southwest",0,3,1);

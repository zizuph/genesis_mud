/* File         : /d/Khalakhor/se_speir/rannoch/room/a_08.c
...
create_khalakhor_room()
{
   ...
   add_item(({"ravine"}),
            ...
            + "ravine runs, from the east and as far west as "
   ...
   add_exit(ROOM + "a_07.c","west",0,3,1);
   add_exit(ROOM + "b_09.c","southeast",0,3,1);
   add_exit(ROOM + "b_08.c","south",0,3,1);
   add_exit(ROOM + "b_07.c","southwest",0,3,1);
   ...
   set_long("This is an ancient forest, and no path can be seen. " 
          ...
          + "impossible to go north or east, as the forest drops into "
          + "a ravine.\n");

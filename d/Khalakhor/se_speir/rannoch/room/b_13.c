/* File         : /d/Khalakhor/se_speir/rannoch/room/b_13.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "b_12.c","west",0,3,1);
   add_exit(ROOM + "a_13.c","north",0,3,1);
   add_exit(ROOM + "a_14.c","northeast",0,3,1);
   add_exit(ROAD + "b_14.c","east",0,3,1);
   add_exit(ROOM + "c_14.c","southeast",0,3,1);
   add_exit(ROAD + "c_13.c","south",0,3,1);
   add_exit(ROOM + "c_12.c","southwest",0,3,1);
   ...
   set_long("This is an ancient forest, and no path can be seen. " 
          ...
          + "impossible to go northwest, as the forest drops "
          + "into a ravine.\n");
}

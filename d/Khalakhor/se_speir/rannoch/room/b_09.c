/* File         : /d/Khalakhor/se_speir/rannoch/room/b_09.c
...
create_khalakhor_room()
{
   ...
   add_item(({"ravine"}),
            ...
            + "vegetation grows down there, you can not "
            + "go that way.\n");
   ...
   add_exit(ROOM + "b_08.c","west",0,3,1);
   add_exit(ROOM + "a_08.c","northwest",0,3,1);
   add_exit(ROOM + "c_10.c","southeast",0,3,1);
   add_exit(ROOM + "c_09.c","south",0,3,1);
   add_exit(ROAD + "c_08.c","southwest",0,3,1);
   ...
   set_long("This is an ancient forest, and no path can be seen. " 
          ...
          + "impossible to go east or north, as the forest drops "
          + "into a ravine.\n");
}

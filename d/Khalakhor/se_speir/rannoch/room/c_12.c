/* File         : /d/Khalakhor/se_speir/rannoch/room/c_12.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "c_11.c","west",0,3,1);
   add_exit(ROOM + "b_12.c","north",0,3,1);
   add_exit(ROOM + "b_13.c","northeast",0,3,1);
   add_exit(ROAD + "c_13.c","east",0,3,1);
   add_exit(ROOM + "d_13.c","southeast",0,3,1);
   add_exit(ROAD + "d_12.c","south",0,3,1);
   add_exit(ROAD + "d_11.c","southwest",0,3,1);

/* File         : /d/Khalakhor/se_speir/rannoch/room/a_06.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "a_05.c","west",0,3,1);
   add_exit(ROOM + "a_07.c","east",0,3,1);
   add_exit(ROOM + "b_07.c","southeast",0,3,1);
   add_exit(ROOM + "b_06.c","south",0,3,1);
   add_exit(ROOM + "b_05.c","southwest",0,3,1);

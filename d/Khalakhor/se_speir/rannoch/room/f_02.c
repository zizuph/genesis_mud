/* File         : /d/Khalakhor/se_speir/rannoch/room/f_02.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "f_01.c","west",0,3,1);
   add_exit(ROOM + "e_01.c","northwest",0,3,1);
   add_exit(ROOM + "e_02.c","north",0,3,1);
   add_exit(ROOM + "e_03.c","northeast",0,3,1);
   add_exit(ROOM + "f_03.c","east",0,3,1);
   add_exit(ROOM + "g_03.c","southeast",0,4,1);
   add_exit(ROOM + "g_02.c","south",0,4,1);
   add_exit(ROOM + "g_01.c","southwest",0,4,1);

/* File         : /d/Khalakhor/se_speir/rannoch/room/s_07.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "s_06.c","west",0,3,1);
   add_exit(ROOM + "r_06.c","northwest",0,3,1);
   add_exit(ROOM + "r_07.c","north",0,3,1);
   add_exit(ROOM + "t_08.c","southeast",0,3,1);
   add_exit(ROOM + "t_07.c","south",0,3,1);
   add_exit(ROOM + "t_06.c","southwest",0,3,1);

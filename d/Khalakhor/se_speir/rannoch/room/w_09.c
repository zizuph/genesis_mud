/* File         : /d/Khalakhor/se_speir/rannoch/room/w_09.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "w_08.c","west",0,3,1);
   add_exit(ROOM + "v_08.c","northwest",0,3,1);
   add_exit(ROOM + "w_10.c","east",0,3,1);
   add_exit(ROOM + "x_10.c","southeast",0,3,1);
   add_exit(ROOM + "x_09.c","south",0,3,1);
   add_exit(ROOM + "x_08.c","southwest",0,3,1);
    ...
    set_long("This is an ancient forest, and no path can be seen. " 
           ...
           + "way north is blocked by high cliffs.\n");

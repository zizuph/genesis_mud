/* File         : /d/Khalakhor/se_speir/rannoch/room/x_12.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "x_11.c","west",0,3,1);
   add_exit(ROOM + "w_11.c","northwest",0,3,1);
   add_exit(ROOM + "y_13.c","southeast",0,3,1);
   add_exit(ROOM + "y_12.c","south",0,3,1);
   add_exit(ROOM + "y_11.c","southwest",0,3,1);
    ...
    set_long("This is an ancient forest, and no path can be seen. " 
           ...
           + "way north and east is blocked by high cliffs.\n");

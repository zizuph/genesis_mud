/* File         : /d/Khalakhor/se_speir/rannoch/room/ad_08.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "ac_08.c","north",0,3,1);
   add_exit(ROOM + "ac_09.c","northeast",0,3,1);
   add_exit(ROOM + "ad_09.c","east",0,3,1);
   add_exit(ROOM + "ae_09.c","southeast",0,3,1);
   add_exit(ROOM + "ae_08.c","south",0,3,1);

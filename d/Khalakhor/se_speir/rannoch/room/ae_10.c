/* File         : /d/Khalakhor/se_speir/rannoch/room/ae_10.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "ae_09.c","west",0,3,1);
   add_exit(ROOM + "ad_09.c","northwest",0,3,1);
   add_exit(ROOM + "ad_10.c","north",0,3,1);
   add_exit(ROOM + "ad_11.c","northeast",0,3,1);

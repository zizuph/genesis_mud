/* File         : /d/Khalakhor/se_speir/rannoch/room/a_13.c
...
create_khalakhor_room()
{
   ...
   add_item(({"ravine"}),
            ...
            + "ravine runs, from the east and a bit further "
            + "east. Heavy vegetation grows down there, you "
            + "can not go that way.\n");
   ...
   add_exit(ROOM + "a_14.c","east",0,3,1);
   add_exit(ROAD + "b_14.c","southeast",0,3,1);
   add_exit(ROOM + "b_13.c","south",0,3,1);
   add_exit(ROOM + "b_12.c","southwest",0,3,1);
   ...
   set_long("This is an ancient forest, and no path can be seen. " 
          ...
          + "impossible to go north or west, as the forest drops into "
          + "a ravine.\n");

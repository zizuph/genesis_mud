/* File         : /d/Khalakhor/se_speir/rannoch/room/u_08.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "u_07.c","west",0,3,1);
   add_exit(ROOM + "t_07.c","northwest",0,3,1);
   add_exit(ROOM + "t_08.c","north",0,3,1);
   add_exit(ROOM + "v_08.c","south",0,3,1);
   add_exit(ROOM + "v_07.c","southwest",0,3,1);

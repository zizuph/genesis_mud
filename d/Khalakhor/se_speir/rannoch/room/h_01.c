/* File         : /d/Khalakhor/se_speir/rannoch/room/h_01.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "h_00.c","west",0,3,1);
   add_exit(ROOM + "g_00.c","northwest",0,3,1);
   add_exit(ROOM + "g_01.c","north",0,3,1);
   add_exit(ROOM + "g_02.c","northeast",0,3,1);
   add_exit(ROOM + "h_02.c","east",0,3,1);
   add_exit(ROOM + "i_02.c","southeast",0,4,1);
   add_exit(ROOM + "i_01.c","south",0,4,1);

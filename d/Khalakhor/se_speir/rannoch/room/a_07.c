/* File         : /d/Khalakhor/se_speir/rannoch/room/a_07.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "a_06.c","west",0,3,1);
   add_exit(ROOM + "a_08.c","east",0,3,1);
   add_exit(ROOM + "b_08.c","southeast",0,3,1);
   add_exit(ROOM + "b_07.c","south",0,3,1);
   add_exit(ROOM + "b_06.c","southwest",0,3,1);

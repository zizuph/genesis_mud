/* File         : /d/Khalakhor/se_speir/rannoch/room/z_13.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "z_12.c","west",0,3,1);
   add_exit(ROOM + "y_12.c","northwest",0,3,1);
   add_exit(ROOM + "y_13.c","north",0,3,1);
   add_exit(ROOM + "aa_13.c","south",0,3,1);
   add_exit(ROOM + "aa_12.c","southwest",0,3,1);

/* File         : /d/Khalakhor/se_speir/rannoch/room/d_07.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "d_06.c","west",0,3,1);
   add_exit(ROAD + "c_06.c","northwest",0,3,1);
   add_exit(ROAD + "c_07.c","north",0,3,1);
   add_exit(ROAD + "c_08.c","northeast",0,3,1);
   add_exit(ROOM + "d_08.c","east",0,3,1);
   add_exit(ROOM + "e_08.c","southeast",0,3,1);
   add_exit(ROOM + "e_07.c","south",0,4,1);
   add_exit(ROOM + "e_06.c","southwest",0,4,1);

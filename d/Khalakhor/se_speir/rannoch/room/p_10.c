/* File         : /d/Khalakhor/se_speir/rannoch/room/p_10.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "p_09.c","west",0,3,1);
   add_exit(ROOM + "o_09.c","northwest",0,3,1);
   add_exit(ROOM + "o_10.c","north",0,3,1);
   add_exit(ROOM + "o_11.c","northeast",0,3,1);
    ...
    set_long("This is an ancient forest, and no path can be seen. " 
           ...
           + "around the rocks and shrubs of the forest floor. The way "
           + "south and east is blocked by high cliffs, rising even "
           + "higher further east. Looking northeast, you are able to "
           + "catch a glimpse of water.\n");
}

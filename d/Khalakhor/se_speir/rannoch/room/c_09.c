/* File         : /d/Khalakhor/se_speir/rannoch/room/c_09.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROAD + "c_08.c","west",0,3,1);
   add_exit(ROOM + "b_08.c","northwest",0,3,1);
   add_exit(ROOM + "b_09.c","north",0,3,1);
   add_exit(ROOM + "c_10.c","east",0,3,1);
   add_exit(ROAD + "d_10.c","southeast",0,3,1);
   add_exit(ROAD + "d_09.c","south",0,3,1);
   add_exit(ROOM + "d_08.c","southwest",0,4,1);

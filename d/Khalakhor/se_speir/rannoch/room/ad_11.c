/* File         : /d/Khalakhor/se_speir/rannoch/room/ad_11.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "ad_10.c","west",0,3,1);
   add_exit(ROOM + "ac_10.c","northwest",0,3,1);
   add_exit(ROOM + "ac_12.c","northeast",0,3,1);
   add_exit(ROOM + "ac_11.c","north",0,3,1);
   add_exit(ROOM + "ae_10.c","southwest",0,3,1);

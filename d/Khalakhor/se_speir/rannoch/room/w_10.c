/* File         : /d/Khalakhor/se_speir/rannoch/room/w_10.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "w_09.c","west",0,3,1);
   add_exit(ROOM + "w_11.c","east",0,3,1);
   add_exit(ROOM + "x_11.c","southeast",0,3,1);
   add_exit(ROOM + "x_10.c","south",0,3,1);
   add_exit(ROOM + "x_09.c","southwest",0,3,1);

/* File         : /d/Khalakhor/se_speir/rannoch/room/p_09.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "p_08.c","west",0,3,1);
   add_exit(ROOM + "o_08.c","northwest",0,3,1);
   add_exit(ROOM + "o_09.c","north",0,3,1);
   add_exit(ROOM + "o_10.c","northeast",0,3,1);
   add_exit(ROOM + "p_10.c","east",0,3,1);
   add_exit(ROOM + "q_08.c","southwest",0,3,1);
    ...
    set_long("This is an ancient forest, and no path can be seen. " 
           ...
           + "way south is blocked by high cliffs.\n");
}

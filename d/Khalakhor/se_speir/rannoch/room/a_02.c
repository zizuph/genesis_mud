/* File         : /d/Khalakhor/se_speir/rannoch/room/a_02.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "a_01.c","west",0,3,1);
   add_exit(ROOM + "a_03.c","east",0,3,1);
   add_exit(ROAD + "b_03.c","southeast",0,3,1);
   add_exit(ROAD + "b_02.c","south",0,3,1);
   add_exit(ROAD + "b_01.c","southwest",0,3,1);

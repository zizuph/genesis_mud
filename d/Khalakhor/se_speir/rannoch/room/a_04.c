/* File         : /d/Khalakhor/se_speir/rannoch/room/a_04.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "a_03.c","west",0,3,1);
   add_exit(ROOM + "a_05.c","east",0,3,1);
   add_exit(ROOM + "b_05.c","southeast",0,3,1);
   add_exit(ROAD + "b_04.c","south",0,3,1);
   add_exit(ROAD + "b_03.c","southwest",0,3,1);

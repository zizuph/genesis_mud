/* File         : /d/Khalakhor/se_speir/rannoch/room/c_04.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "c_03.c","west",0,3,1);
   add_exit(ROAD + "b_03.c","northwest",0,3,1);
   add_exit(ROAD + "b_04.c","north",0,3,1);
   add_exit(ROOM + "b_05.c","northeast",0,3,1);
   add_exit(ROAD + "c_05.c","east",0,3,1);
   add_exit(ROOM + "d_05.c","southeast",0,4,1);
   add_exit(ROOM + "d_04.c","south",0,4,1);
   add_exit(ROOM + "d_03.c","southwest",0,4,1);

/* File         : /d/Khalakhor/se_speir/rannoch/room/c_10.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROOM + "c_09.c","west",0,3,1);
   add_exit(ROOM + "b_09.c","northwest",0,3,1);
   add_exit(ROOM + "c_11.c","east",0,3,1);
   add_exit(ROAD + "d_11.c","southeast",0,3,1);
   add_exit(ROAD + "d_10.c","south",0,3,1);
   add_exit(ROAD + "d_09.c","southwest",0,3,1);
   ...
   set_long("This is an ancient forest, and no path can be seen. " 
          ...
          + "impossible to go north, as the forest drops "
          + "into a ravine.\n");
}

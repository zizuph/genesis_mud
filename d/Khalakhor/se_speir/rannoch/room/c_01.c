/* File         : /d/Khalakhor/se_speir/rannoch/room/c_01.c
...
create_khalakhor_room()
{
   ...
   add_exit(ROAD + "c_00.c","west",0,3,1);
   add_exit(ROOM + "b_00.c","northwest",0,3,1);
   add_exit(ROAD + "b_01.c","north",0,3,1);
   add_exit(ROAD + "b_02.c","northeast",0,3,1);
   add_exit(ROOM + "c_02.c","east",0,3,1);
   add_exit(ROOM + "d_02.c","southeast",0,4,1);
   add_exit(ROOM + "d_01.c","south",0,4,1);
   add_exit(ROOM + "d_00.c","southwest",0,4,1);

...
create_khalakhor_human()
{
    ...
    add_ask(({"fish","fisherman","fishes","catch"}),
              "say Oh, that's what I do. I catch fish. Sometimes.",1);
    add_ask(({"wife","wifey","woman","boss"}),
              "say She's waiting for me at home. I hope she's not mad, "
            + "she'll kick me arse!",1);
    add_ask(({"pier","dock","jetty"}),
              "say This thing? I likes ta stands here and, er, catch fish.",1);
    ...
    add_ask(({"pole","fishing pole","net","fishing net","tool","tools"}),
              "say I don't need crap like that!",1);
    add_ask("village",
            "say I live there, so?",1);
    ...
    add_ask(({"bolok","boar","old boar"}),
              "say You don't want to upset that ol bastard, you hear?",1);
    add_ask(({"bandit","bandits","outlaws"}),
              "say Pfeh, let them come, I don't mind a good fight! But "
            + "I wish they'd just go away.",1);
    ...
    add_ask(({"crap","garbage"}),
            "say Your mother knows you better than I do, ask her instead.",1);
    add_ask("blackfish",
    ...
    add_ask("ear",
              "say I hid it! Might come in handy some day.\n"
            + "The rugged dark-haired human peers suspiciously around.",1);
    ...
    add_chat("Oi, don't just stand there, help me!");
    add_chat("I won't leave until I catch me some fishlings.");
    add_chat("Hey you, bugger off. You scares off the fish.");
    ...
    add_chat("Did I tell you about the time when...forget it.");
    add_chat("Did I tell you about the time when...oh wait.");
    ...
    add_chat("The lads say I talk too much garbage!");
    add_chat("You should get yourself a mirror...");
...
{
    command("say Hah! You wants to know me name eh, " + capitalize(str) + "? "
          + "Not bloody likely!");

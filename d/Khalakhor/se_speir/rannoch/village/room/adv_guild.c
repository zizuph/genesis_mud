/* File         : /d/Khalakhor/se_speir/rannoch/village/room/adv_guild.c
...
{
    set_short("The adventurer's guild of Abhainn Ruith");
    set_long("This is the adventurer's guild of Abhainn Ruith. " +

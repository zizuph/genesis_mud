/* File         : /d/Khalakhor/se_speir/rannoch/village/room/road_9_6.c
...
create_road()
{
    add_item(({"river","water"}),
             ...
             + "there is a bridge southwest of you.\n");

    add_exit(ROOM + "road_9_5.c","north",0,1,0);
    add_exit(ROOM + "road_10_6.c","east",0,1,0);
    add_exit(ROOM + "road_9_7.c","south",0,1,0);

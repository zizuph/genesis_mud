/* File         : /d/Khalakhor/se_speir/rannoch/village/room/road_10_4.c
...
create_road()
{
    ...
    add_exit(ROOM + "road_11_3.c","northeast",0,1,0);
    add_exit(ROOM + "road_11_4.c","east",0,1,0);
    add_exit(ROOM + "road_10_5.c","south",0,1,0);
    add_exit(ROOM + "road_9_5.c","southwest",0,1,0);

/* File         : /d/Khalakhor/se_speir/rannoch/village/room/road_9_5.c
...
create_road()
{
    ...
    add_exit(ROOM + "road_10_4.c","northeast",0,1,0);
    add_exit(ROOM + "road_10_5.c","east",0,1,0);
    add_exit(ROOM + "road_9_6.c","south",0,1,0);

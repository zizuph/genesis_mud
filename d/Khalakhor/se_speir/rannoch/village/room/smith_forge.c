...
create_khalakhor_room()
{
    ...
    set_long("You are in the smithy of the bladesmith of the " +
      "village. The air is quite hot, and the stone room " +
    ...
    add_exit(ROOM + "road_15_5.c", "out");
    set_alarm(0.5, 0.0, reset_room);

    config_default_trade();
    set_store_room(ROOM + "smith_store");
}

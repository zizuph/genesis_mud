/* File         : /d/Khalakhor/se_speir/rannoch/village/room/road_3_11.c
...
create_road()
{
    ...
    add_exit(ROOM + "road_3_10.c","north",0,1,0);
    add_exit(ROOM + "road_3_12.c","south",0,1,0);

    set_short("Pier");
    set_long("Pier continues S.\n"
           + "Walkway N.\n");
}

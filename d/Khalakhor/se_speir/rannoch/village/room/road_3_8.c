/* File         : /d/Khalakhor/se_speir/rannoch/village/room/road_3_8.c
...
create_road()
{
    add_item(({"tavern","pub"}),
             ...
             + "to the immediate west, and further south on the "
             + "building's east side is another entrance.\n");

    add_exit(ROOM + "inn_01.c","in",0,1,0);
    add_exit(ROOM + "road_3_7.c","north",0,1,0);
    add_exit(ROOM + "road_4_8.c","east",0,1,0);
    add_exit(ROOM + "road_3_9.c","south",0,1,0);

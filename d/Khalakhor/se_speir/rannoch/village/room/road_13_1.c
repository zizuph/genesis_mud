/* File         : /d/Khalakhor/se_speir/rannoch/village/room/road_13_1.c
...
create_road()
{
    ...
    add_exit(ROOM + "road_14_1.c","east",0,1,0);
    add_exit(ROOM + "road_13_2.c","south",0,1,0);
    add_exit(ROOM + "road_12_2.c","southwest",0,1,0);

    set_short("Wall, river");
    set_long("Wall starts, goes E.\n"
           + "River.\n");
}

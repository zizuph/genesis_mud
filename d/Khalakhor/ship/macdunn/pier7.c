/* File:          /d/Khalakhor/ship/macdunn/pier7.c
 * Creator:       Teth
...
create_pier()
{
    ...
    add_exit(MACDUNN_DIR + "pier6", "west",0,0);
    add_exit(MACDUNN_DIR + "pier5", "north",0,0);
    add_exit(MACDUNN_DIR + "pier8", "east",0,0);
    add_exit(MACDUNN_DIR + "pier9", "south",0,0);

/* File:          /d/Khalakhor/ship/macdunn/tide2.c
 * Creator:       Teth
 * Date:          April 25, 1997
 * Modifications: November 28, 1997, Teth, added drowning
...
create_khalakhor_room()
{
    ...
    set_long("   Cala Fasgadh surrounds you with its salty oceanic water. " +
      "The harbour extends outward to the south and east, while to " +
      "the north it reaches a rocky shore. The pier of Port Macdunn " +
      "stands to the west, its moorings deep in the water.\n");
    add_item("pier","The pier to the west stands on moorings. Swimming " +
      "west would take you under the pier.\n");
    ...
    add_item(({"harbour","oceanic harbour","cala","cala fasgadh"}),
      "The harbour extends to the south, where it meets Lear " +
    ...
    add_cmd_item(({"northwest","northeast","east","southeast",
...
go_west()
{
    ...
    set_dircmd("west");
    TP->move_living("swims west",MACDUNN_DIR + "under_pier", 0, 0);
    return "";
}
...
go_north()
{
    ...
    set_dircmd("north");
    TP->move_living("swims north",MACDUNN_DIR + "shore2", 0, 0);
    return "";

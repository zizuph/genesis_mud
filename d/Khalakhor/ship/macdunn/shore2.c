/* File:          /d/Khalakhor/ship/macdunn/shore2.c
 * Creator:       Teth
 * Date:          November 28, 1997
 * Modifications: December 5, 1997, Teth, added stones
...
create_khalakhor_room()
{
    ...
    set_long("   Cala Fasgadh surrounds you with its salty oceanic water. " +
      "The harbour extends outward to the south, while nearby to " +
      "the north and east is a rocky shore. The pier of Port Macdunn " +
      "stands to the west, its moorings deep in the water. One mooring " +
      "has handholds.\n");
    add_item("pier","The pier to the west stands on moorings.\n");
    ...
    add_cmd_item(({"west","southwest","northwest"}),"swim","The pier " +
      "prevents you from swimming in that direction.\n");
    add_cmd_item(({"north","northeast","east","southeast"}),"swim",
      "The rocky shore prevents you from swimming in that direction.\n");
...
go_south()
{
    ...
    set_dircmd("south");
    TP->move_living("swims south",MACDUNN_DIR + "tide2", 0, 0);
    return "";
}

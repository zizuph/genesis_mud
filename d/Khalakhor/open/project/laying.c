...
"special mats that blend so well with the grass that one "+ \
"can barely make out their presence.\n"

mixed sdef = ({
({
({"mat","on mat", "long mat", "soft mat"}),
"You sink down onto a long soft mat before the fire.\n",
" sinks onto a long soft mat before the fire.\n",
"You arise from a long soft mat.\n",
" arises from a long soft mat.\n",
"You are laying comfortably on a long soft mat before the fire.\n",
"You arise from a long soft mat and leave the area.\n",
" laying comfortably on a long soft mat before the fire",
" laying comfortably on a long soft mat before the fire.\n",
}),

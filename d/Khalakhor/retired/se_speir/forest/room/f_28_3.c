/* File:          /d/Khalakhor/se_speir/forest/room/f_28_3.c
 * Creator:       Teth
 * Date:          March 30, 1998
 * Modifications:
...
create_forest_room()
{
    ...
    add_exit(FROOM + "f_27_3", "west", 0, 2, 1);
    add_exit(FROOM + "f_27_4", "northwest", 0, 2, 1);
    add_exit(FROOM + "rb_28_4", "north", "@@enter_riverbank", 2, 1);
    add_exit(FROOM + "r_29_4", "northeast", "@@block_river", 2, 1);
    add_exit(FROOM + "rb_29_3", "east", "@@enter_riverbank", 2, 1);
    add_exit(FROOM + "rb_29_2", "southeast", "@@enter_riverbank", 2, 1);
    add_exit(FROOM + "rb_28_2", "south", "@@enter_riverbank", 2, 1);
    add_exit(FROOM + "f_28_2", "southwest", 0, 2, 1);
}

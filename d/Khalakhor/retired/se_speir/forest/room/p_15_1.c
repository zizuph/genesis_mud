/* File:          /d/Khalakhor/se_speir/forest/room/p_15_1.c
 * Creator:       Teth
 * Date:          April 17, 1998
 * Modifications:
...
create_forest_room()
{
    ...
    add_exit(FROOM + "p_14_1", "west" ,"@@continue_path", 0);
    add_exit(FROOM + "f_16_2" ,"northeast", "@@enter_forest", 3, 1);
    add_exit(FROOM + "p_16_1", "east", "@@continue_path", 0);
    add_exit(FROOM + "b_16_0", "southeast", "@@enter_bush", 0, 1);
    add_exit(FROOM + "b_15_0", "south", "@@enter_bush", 0, 1);
    add_exit(PROOM + "plains_13_1", "southwest", 0, 1);
}

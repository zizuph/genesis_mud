 ...
 *
 *	Olorin and Zephram, 1997
 *      modified by Teth for use in Krynn, November 1996
 *      - removed veto_herbs functionality
 *      - modified by Teth for Khalakhor, December 17, 1997
 *      - modifications include use of terrain types
 */
...
#include "/d/Khalakhor/common/herbs/herb_list.h"

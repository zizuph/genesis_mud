/* File:          /d/Khalakhor/common/obj/leftover/skin.c
 * Creator:       Gresolle, originally as /d/Roke/common/carisca/obj/skin.c
 * Date:          ????
 * Modifications: Teth, Jan 13, 1998 - changed it to a Genesis-wide object
 *                                   - removed call_outs
 *                                   - updated the code in general
 *                Igneous, Jan 14 98 - introduced hunting-skill variable
 *                                     for value of the item
 *                Teth, Jan 16 98    - added recovery
 * Purpose:       This skin is used as a leftover, which is useful to some.
 ...
 *                it being eaten. Also note because of the variable values,
 *                it cannot be made into a heap.
 */

...
create_khalakhor_room()
{
   ...
   add_exit("isl0403", "north", 0, 0, 1);
   add_exit("isl0203", "south");
   add_exit("isl0302", "west", 0, 0, 1); 
   add_exit("isl0402", "northwest", 0, 0, 1);
   add_exit("isl0404", "northeast");
   add_exit("isl0202", "southwest", 0, 0, 1);

...
mixed sdef = ({
({
({"blanket","on blanket", "honeysuckle", "upon honeysuckle", "upon blanket", "pink honeysuckle"}),
"You sink down onto a soft blanket of pink honeysuckle.\n",
" sinks onto a soft blanket of pink honeysuckle.\n",
"You arise from a soft blanket of pink honeysuckle.\n",
" arises from a soft blanket of pink honeysuckle.\n",
"You are laying comfortably on a soft blanket of pink honeysuckle.\n",
"You arise from a soft blanket of honeysuckle and leave the area.\n",
" laying comfortably on a soft blanket of pink honeysuckle",
" laying comfortably on a soft blanket of pink honeysuckle.\n",
}),

({
({"grass", "down", "on grass", "lush grass", "on lush grass", "upon grass", "upon lush grass"}),

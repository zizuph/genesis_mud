...
create_khalakhor_room()
{
    ...
    path = ({"northwest","south"});
    extra = "A soft breeze carries the sweet scent of pine. ";
    create_forest();
 
   add_exit("isl0407", "north", 0, 0, 1);
   add_exit("isl0207", "south");
   add_exit("isl0308", "east", 0, 0, 1);
   add_exit("isl0406", "northwest");
   add_exit("isl0408", "northeast", 0, 0, 1);
   add_exit("isl0208", "southeast", 0, 0, 1);

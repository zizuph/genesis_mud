...
create_khalakhor_room()
{
    ...
    add_exit("isl0606", "north", 0, 0, 1);
  add_exit("isl0406", "south", 0, 0, 1);
  add_exit("isl0505", "west", 0, 0, 1);
  add_exit("isl0507", "east", 0, 0, 1);
  add_exit("isl0605", "northwest", 0, 0, 1);
  add_exit("isl0607", "northeast", 0, 0, 1);
  add_exit("isl0407", "southeast", 0, 0, 1);

...
create_room()
{
    ...
    add_extra("Someone has built a barricade here to prevent you from going northeast.\n" +
              "A small path leads west into the green surroundings.\n");
    ...
    add_exit(CAMP_ROOM + "path-sw-1", "west", 0, 0, 1);
    add_exit(CAMP_ROOM + "camp-4-2", "northeast", "@@block", 0, 0);
}
...
*/
    set_long("Dust covered cobwebs drape the walls and hang like " +
             "shimmering curtains. In this musty, solemn room, more than " +
             "any other, you feel the presence of the monks who once lived " +
             "and worked here. There is a crumbling stone tablet here.\n");
...
*/
    add_item("tablet", "This is a stone tablet on which someone " +
             "has etched something that seems like words. It is hardly " +
             "readable anymore.\n");
    add_cmd_item("tablet", "read",
                 " ------------------------------------------------\n" +
                 "|             T..... of ..n..c.                 |\n" +
                 "| A coun.i.l.r ...t t...t ..llow ....c.llo.. .nd|\n" +
                 "| gu.l. me.eber. .i.h ..c. a.d ...pe.t.  An.    |\n" +
                 "| .ust en....e .u.r... ..li.ie., a.d ....e ..   |\n" +
                 "| p.o..e.u... .ha. .av. ..e. .utli.e. in .h.    |\n" +
                 "| .a.. li..... .n. i. th. C...c.. .an........   |\n" +
                 "|                                               |\n" +
                 "|                                               |\n" +
                 "|                                               |\n" +

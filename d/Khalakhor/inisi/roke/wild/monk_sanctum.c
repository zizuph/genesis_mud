...
create_room()
{
    ...
    set_long("You are in what once was the holy sanctum of the monastery. " +
             "There is a large altar in the center of the room. It is said " +
             "that the first abbot was buried under the altar. You " +
             "can feel his soul in this room and when you " +
...
close(string text)
{
    ...
    write("You close your eyes and you can see the master when he " +
          "is fighting a seven headed hydra with his bare hands.\n");
...
kneel()
{
    write("You kneel down before the altar and you can feel how the " +
          "soul of the abbot is making you stronger.\n");

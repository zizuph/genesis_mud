...
create_room()
{
    set_short("entrance of the abandoned monastery");
...
*/
    set_long("You are in the entrance of the ancient, abandoned monastery. " +
             "It is rather dark and musty here, just like in the rest of " +
             "the house, and the only source of light is from gaps in the " +
             "ceilings and walls. Before you is a small desk buried in dust " +
             "and cobwebs. The building extends back into the mountain, " +
             "where you can see exits north, east and west, and a sturdy " +
             "stone staircase up. "+
             "The floor is very worn here.\n");
    ...
    */
    ...
    add_item(({"staircase", "stair"}), "It's leading up.\n");
    add_item("floor", "There must have been a lot of people here once.\n");

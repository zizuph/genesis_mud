...
/*
  ...
  Updates:
  --------
  Added a check for ROOM_I_INSIDE. Shovel can only be used in outdoor 
  rooms since ROOM_I_NO_DIG is not a standard prop.
  -- Finwe, February 2005 
...
check_dig_fail(object where)
{
    ...
    notify_fail("You can't dig a hole indoors!\n");

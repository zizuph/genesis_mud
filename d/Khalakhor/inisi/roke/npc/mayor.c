 ...
 * Added hints about the new Golbar camp, Treacher Aug 2021
 */
...
create_monster()
{
    ...
    add_ask(({"camp", "warrior", "warriors", "rumour", "rumours", "sailor"}),
            "say I'm starting to think there is more to that rumour the drunken " +
            "sailor was spreading. The warrior camp up north looks abandoned, we " +
            "need to find their new camp.\n", 1);
...
assign()
{
    ...
    case 2:
        ...
        "Golbar have encamped close by. I want you to find " +
        "and spy on their camp. The last info I received is " +
        "that they used to have a small camp up north, but now it looks " +
        "abandoned. So you must look elsewhere. Perhaps there is something " +
        "to the rumour the sailor at the pier is spreading, find him " +
        "and ask about the rumour.");

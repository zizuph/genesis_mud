 ...
 * Returns:       The object, or 0 on error
 */
object
 ...
 *                [0]  order - The object the player ordered, or 0 on error.
...
order(string str)
{
    ...
    if (player_name == this_player()->query_real_name())
        all = ({this_player()});
    else

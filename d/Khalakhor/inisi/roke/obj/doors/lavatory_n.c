...
create_door() {
  ...
  set_other_room(NYREESEDIR + "cadu_pier_toilet_n");        /* room on the other side */
...
open_mess_here()
{
    ...
    if((NYREESEDIR + "cadu_pier_toilet_n")->query_occupied())
    {
...
exa_lock()
{
    ...
    if(lock_status)
        ...
        return str + "The sign says 'FREE', with green letters.\n";
}

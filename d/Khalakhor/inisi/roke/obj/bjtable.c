...
{
return    
"All bets here are made with the casino's markers which you can buy and " +
"sell here. Do 'help markers' for more info.\n" +
"This is a summary of the things you can do:\n" +
"bet <amount> : Bet. You can select a slot to bet on by 'bet x on <slot>'.\n" +
"               (You are allowed to bet several times for example:\n" + 
"                bet 1 blue ; bet 2 green)\n" + 
"backbet      : Works like bet, but puts the bet behind another player's\n" +
"               trusting that player's skill. You must specify a slot.\n" +

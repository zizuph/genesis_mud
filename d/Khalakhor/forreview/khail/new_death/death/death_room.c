...
public void start_message(object who);
...
do_read_soul(object who)
{
    ...
    switch (align)
    {
        case -1200..-1000:
            ...
            break;
        case -999..-500:
            str = "oH WHAT A DISPICABLE BUG WE HAVE HERE. STEALING " +
...
enter_inv(object ob, object from)
{
  ...
  /* Ok, 'ob' appears to be a dead player, let's start */
...
test_for_player(object who)
{
  ...
  /* bring them back. */
    if (environment(who) != this_object() && who->query_ghost())
    {

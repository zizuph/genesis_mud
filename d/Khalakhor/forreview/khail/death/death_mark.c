...
"flight, to a by now rather well known place.\n\n");
      ...
      /* Ensure that my_host is an interactive player */
      /* before taking the 'quick' death, as it provides */
      /* no protection later against it. This was the */
      /* cause of 'ghost' players wandering around */
      /* out in the open. */
      /* If they aren't interactive, send them through  */
      /* the normal sequence, which does guard against */
      /* non-interactives: Khail, Nov 19/96 */
        if (interactive(my_host))
        {

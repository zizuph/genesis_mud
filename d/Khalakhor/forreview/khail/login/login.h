...
/*
 * This define will tell the relevant modules to return the actual
 * race names for both query_race() and query_race_name(). This is
 * to allow time for guilds to convert the race-testing routines
 * in their shadows. Once complete, this section can be removed
 * or simply #undef'd.
 */
#define NEW_NAME_IMPLEMENTING

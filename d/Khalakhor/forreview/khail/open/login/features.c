...
create_room()
{
    ...
    set_long("You're in dark and strange hall, it's walls and ceiling " +
...
get_help(string str)
{
  ...
  /* Use the board more to read the idiot-proof help text */
    TP->more(read_file(HELP + "features_help"));
    return 1;
}

 ...
 */
#define PATH "/d/Calia/khail/open/login/"
...
#define RACEMAP ([                                          \
		...
		"im_human"  : "/d/Immortal/race/human_imm",   \
		"im_elf"    : "/d/Immortal/race/elf_imm",     \
		"im_dwarf"  : "/d/Immortal/race/dwarf_imm",   \
		"im_hobbit" : "/d/Immortal/race/hobbit_imm",  \
		"im_gnome"  : "/d/Immortal/race/gnome_imm",   \
		"im_goblin" : "/d/Immortal/race/goblin_imm",   \
		])
/*
 * RACEATTR
 *

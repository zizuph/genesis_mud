...
ghost_ready()
{
  ...
  /* If the player has a ghost body due to death, a death badge should */
  /* be present. Move it into the new body, if this is the case. */
...
reincarnate_me()
{
  ...
  /* If the 'dead' player body has a death badge on it, the ghost body */
  /* should carry it too. */
 ...
 * Description  : Always returns 'ghost' to identify this player object
 *                as being a ghost.
 * Returns      : "ghost"
 */
public string

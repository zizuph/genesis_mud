...
void create_door()  {
     ...
     set_door_name(({"hallway door","door","green door","green room door"}));
     ...
     set_open_mess(({"opens the door to the hallway.\n",
        "The door to the green guest room opens.\n"}));
     ...
     set_close_mess(({"closes the door to the hallway.\n",
        "The door to the green guest room closes.\n"}));
     ...
     set_lock_mess(({"locks the door to the hallway.\n", 
        "You hear a click as the door to the green guest room is locked.\n"}));
     ...
     set_unlock_mess(({"unlocks the door to the hallway.\n",
        "You hear a click as the door to the green guest room is unlocked.\n"}));

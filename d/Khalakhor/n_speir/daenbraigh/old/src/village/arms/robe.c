...
{   
  ...
  set_long("This robe looks thick and protecting from cold. It is woven from "+
	   "rough wool and reinforced with some kind of unknown metallic "    +
	   "threads.\n");

/* File         : /d/Khalakhor/n_speir/daenbraigh/camp/rooms/camp_path_c.c
...
create_khalakhor_room()
{
  ...
  set_short("Southern section of western camp path\n");
  set_long("* Long description *\n");

  add_exit("camp_path_1", "north", 0,0,0);
  add_exit("camp_tent_4", "east", 0,0,0);
  add_exit("camp_path_b", "southeast", 0,0,0);
  add_exit("camp_watch_4", "south", 0,0,0);

...
create_khalakhor_room()
{
  ...
  add_item(({"tent", "command tent", "command tents",
  ...
  add_exit("camp_watch_1", "north", 0,0,0);
  add_exit("camp_path_3", "northeast", 0,0,0);
  add_exit("camp_tent_1", "east", 0,0,0);
  add_exit("camp_path_1", "south", 0,0,0);

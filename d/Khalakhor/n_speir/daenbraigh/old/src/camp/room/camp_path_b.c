/* File         : /d/Khalakhor/n_speir/daenbraigh/camp/rooms/camp_path_b.c
...
create_khalakhor_room()
{
  ...
  set_short("Western section of southern camp path\n");
  set_long("* Long description *\n");

  add_exit("camp_path_a", "east", 0,0,0);
  add_exit("camp_watch_4", "west", 0,0,0);
  add_exit("camp_path_c", "northwest", 0,0,0);

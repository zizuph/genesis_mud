/* File         : /d/Khalakhor/n_speir/daenbraigh/camp/rooms/camp_path_A.c
...
create_khalakhor_room()
{
  ...
  set_short("Middle section of southern camp path\n");
  set_long("* Long description *\n");

  add_exit("camp_path_9", "east", 0,0,0);
  add_exit("camp_quartermaster", "south", 0,0,0);
  add_exit("camp_path_b", "west", 0,0,0);

/* File         : /d/Khalakhor/n_speir/daenbraigh/camp/rooms/camp_path_6.c
...
create_khalakhor_room()
{
  ...
  set_short("Northern section of eastern camp path\n");
  set_long("* Long description *\n");

  add_exit("camp_watch_2", "north", 0,0,0);
  add_exit("camp_path_7", "south", 0,0,0);
  add_exit("camp_path_5", "northwest", 0,0,0);

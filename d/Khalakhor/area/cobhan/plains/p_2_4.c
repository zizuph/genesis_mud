/* File:          /d/Khalakhor/cobhan/plains/p_2_4.c
 * Creator:       Teth
 * Date:          Dec 26 2001
 * Modifications:
...
create_plains_room()
{
    ...
    add_exit(PLAINS + "p_3_5", "northeast", 0, 2, 1);
    add_exit(PLAINS + "p_3_4", "east", 0, 2, 1);
    add_exit(PLAINS + "p_3_3", "southeast", 0, 2, 1);
    add_exit(PLAINS + "p_2_3", "south", 0, 2, 1);

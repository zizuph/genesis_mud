/* File:          /d/Khalakhor/cobhan/plains/p_2_7.c
 * Creator:       Teth
 * Date:          Dec 26 2001
 * Modifications:
...
create_plains_room()
{
    set_up_plains();
    set_long("@@my_long");
    add_my_desc("Plains. Waterfall and stream. \n");
    ...
    add_exit(PLAINS + "p_3_8", "northeast", 0, 2, 1);
    add_exit(PLAINS + "p_3_7", "east", 0, 2, 1);
    add_exit(PLAINS + "p_3_6", "southeast", "@@cross_stream", 4, 1);

/* File:          /d/Khalakhor/cobhan/plains/p_3_9.c
 * Creator:       Teth
 * Date:          Dec 26 2001
 * Modifications:
...
create_plains_room()
{
    ...
    add_exit(PLAINS + "p_3_10", "north", 0, 2, 1);
    add_exit(PLAINS + "p_4_10", "northeast", 0, 2, 1);
    add_exit(PLAINS + "p_4_9", "east", 0, 2, 1);
    add_exit(PLAINS + "p_4_8", "southeast", 0, 2, 1);
    add_exit(PLAINS + "p_3_8", "south", 0, 2, 1);

/* File:          /d/Khalakhor/cobhan/forest/f_4_3.c
 * Creator:       Teth
 * Date:          Dec 25 2001
 * Modifications:
...
create_forest_room()
{
    ...
    add_exit(FOREST + "f_3_3", "west", 0, 3, 1);
    add_exit(FOREST + "f_3_4", "northwest", 0, 3, 1);
    add_exit(FOREST + "f_4_4", "north", 0, 3, 1);
    ...
    add_exit(FOREST + "f_3_2", "southwest", 0, 3, 1);
}

/* File:          /d/Khalakhor/cobhan/forest/f_4_5.c
 * Creator:       Teth
 * Date:          Dec 25 2001
 * Modifications:
...
create_forest_room()
{
    ...
    add_exit(FOREST + "f_3_5", "west", 0, 3, 1);
    add_exit(FOREST + "f_3_6", "northwest", 0, 3, 1);
    add_exit(FOREST + "f_4_6", "north", 0, 3, 1);
    ...
    add_exit(FOREST + "f_4_4", "south", 0, 3, 1);
    add_exit(FOREST + "f_3_4", "southwest", 0, 3, 1);
}

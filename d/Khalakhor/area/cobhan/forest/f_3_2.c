/* File:          /d/Khalakhor/cobhan/forest/f_3_2.c
 * Creator:       Teth
 * Date:          Dec 25 2001
 * Modifications:
...
create_forest_room()
{
    ...
    add_exit(FOREST + "f_2_2", "west", 0, 3, 1);
    add_exit(FOREST + "f_2_3", "northwest", 0, 3, 1);
    add_exit(FOREST + "f_3_3", "north", 0, 3, 1);
    add_exit(FOREST + "f_4_3", "northeast", 0, 3, 1);
    ...
    add_exit(FOREST + "f_2_1", "southwest", 0, 3, 1);
}

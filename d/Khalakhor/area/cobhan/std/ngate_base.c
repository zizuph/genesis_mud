/* File:          /d/Khalakhor/cobhan/std/ngate_base.c
 * Creator:       Teth
...
enter_plains()
{
    write("You walk out onto the plains.\n");
    return 0;
}
...
enter_road()
{
    write("You step onto a road heading north.\n");
    return 0;
}

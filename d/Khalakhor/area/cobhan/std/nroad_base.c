/* File:          /d/Khalakhor/cobhan/std/nroad_base.c
 * Creator:       Teth
 * Date:          February 12, 1998
 * Modifications: Dec 24, 2001 - moved to the Cobhan area
 * Purpose:       This is the base room for the non-special north
...
enter_cave()
{
    write("You step into the fetid cave.\n");
    return 0;
}
...
block_road()
{
    write("The road is blocked by rockfall.\n");
    return 1;
}

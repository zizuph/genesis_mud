...
enter_plains()
{
    write("You step out onto the sunny rocky plains.\n");
    return 0;
}

public int
enter_plains_thru_stream()
{
    write("You wade through the rubble-strewn stream and step out onto " +
      "the sunny rocky plains.\n");
    return 0;
}
...
block_mountain()
{
    write("The sheer face of the mountain prevents movement in that " +
    "direction.\n");
    return 1;
}

/**********************************************************************
 * - rena.c                                                         - *
 * - Rena is a npc that teaches a bit of history.                   - *
...
create_khalakhor_human()
{
	...
	"She has silky cream coloured skin.\n"+
	"She has mysterious sultry eyes.\n"+
	"Her hair is hip length, soft red with tight "+
	"curls.\n"+
...
hook_return_intro(string str)
{
	if (!remembered[str])
	{
		...
		command("bow " + str);
		remembered[str] = "nice";
		present(str, environment(TO))->add_introduced("rena");
	}

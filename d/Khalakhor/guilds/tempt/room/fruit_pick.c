 ...
 * -     Arguments: int num - The number of different fruit types  - *
 * -                to add.                                        - *
 * -                string *arg - A specific list of fruit types   - *
 * -                to add.                                        - *
...
set_up_fruits(int num, string *arg)
{
	...
	(num > 1 ? "various " : "") + "sumptuous fruits of "+
	COMPOSITE_WORDS(fruit) +". They look pleasingly ripe and "+
	"temptingly pickable.\n");
}

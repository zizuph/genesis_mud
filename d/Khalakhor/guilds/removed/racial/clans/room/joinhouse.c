/* File         : /d/Khalakhor/racial/clans/room/joinroom.c
 * Creator      : Tomas@Genesis
 * Copyright:   : Bryan Dees
 * Date         : March 2001         
 * Purpose      : Default joinhouse for the Clans of Khalakhor.
 * Related Files: 
 * Comments     : Taken from the eil-galaith joinhouse code
 * Modifications:
 */
#pragma strict_types
...
inherit GUILD_ROOM;
inherit SCROLL;
#define CLANHOME  "MacVay"
#define ACCEPT_LOG  (GLOG_macvay + "accept")
#define QUIT_LOG    (GLOG_macvay + "leave")
#define FAIL_LOG    (GLOG_macvay + "failedaccept")
#define PETITION_LOG  (GLOG_macvay + "petition")
...
study(string str)
{
    ...
    if (!strlen(str))
    {
        notify_fail("Study which scroll? <petition>, <accept> or <leave>.\n");
        return 0;
    }

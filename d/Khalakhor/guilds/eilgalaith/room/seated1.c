...
#define SDESC \
"Several crude looking cushions are resting on the floor. "+ \
"The fabrics are dark in color with gold threads woven in, "+ \
"simple patterns. There are also a few wooden chairs "+ \
"scattered around as well.\n"

mixed sdef = ({
({
({"cushion","on cushion", "in cushion"}),
"You slip down onto a cushion and sit comfortably.\n",
" slips down onto a cushion and sits comfortably.\n",
"You arise from your cushion.\n",
" arises from a cushion.\n",
"You are sitting comfortably on a cushion.\n",
"You stand up from your cushion and leave the room.\n",
" sitting comfortably on a cushion",
" sitting comfortably on a cushion.\n",
}),

({
({"chair","in chair", "on chair"}),
"You sit down on one of the wooden chairs.\n",
" sits on one of the wooden chairs.\n",
"You arise from your wooden chair.\n",
" arises from one of the wooden chairs.\n",
"You are sitting comfortably on one of the wooden chairs.\n",
"You arise from your wooden chair and leave the room.\n",
" sitting comfortably on one of the wooden chairs",
" sitting comfortably on one of the wooden chairs.\n",
})
...
leave_inv(object ob, object to)
{
	...
	if (ob && !present(ob) && seated[ob])
	{
		...
		if (seated[ob][0] == 2 && (to = seated[ob][1]))
		{
			...
			to->catch_tell("You are dumped brusquely "+
			"onto the floor.\n");
			tell_room(this_object(), QCTNAME(to) + " is "+
			"dumped brusquely onto the floor.\n", to);
		}
		if (seated[ob][0] == 3)
		{
...
do_stand(string arg)
{
	...
	else
	{
		...
		{
			ob->unset_no_show_composite();
			ob->catch_tell("You are dumped brusquely "+
			"onto the floor.\n");
		...
		while (++i < j)
		{
			...
			if (seated[obs[i]][0] == 2)
			{
				...
				else
				{
					...
					ob->query_the_name(this_player())) + " on "+

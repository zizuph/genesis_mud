...
create_khalakhor_room()
{
	...
	"The light that illuminates this hall seems to be glowing "+
	"softly from the walls and ceiling and even from the marble "+
	"floor. It is most mysterious but casts a warm inviting glow "+
	"all around you.\n");
	add_item(({"wall", "walls"}),
	"The walls are made from a mysterious white marble with a "+
	"spiral of black intertwining in seamless patterns.\n");
	add_item(({"ceiling"}),
	"The ceiling is made from a mysterious white marble with a "+
	"spiral of black intertwining in seamless patterns.\n");
	add_item(({"floor", "flooring"}),
	"The floor is made from a mysterious white marble with a "+
	"spiral of black intertwining in seamless patterns.\n");
	add_item(({"marble"}),
	"The marble is beautifully mysterious, as it appears to "+
	"almost be glowing.\n");
	add_item(({"pattern", "patterns"}),
	"The patterns in the marble are seamless as the black "+

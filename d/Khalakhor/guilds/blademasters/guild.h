...
// path to racial server for title merging
#define CLAN_SERVER         "/d/Khalakhor/guilds/clans/server"

/* Conf. vet (75) to remain. (changed temp while recode in progress) */
#define REMAIN_SWORD_SKILL   65
/* Sup. vet (80) sword to join. (changed temp while recode in progress) */
...
#define GMASTER				 (SPECIAL + "guildmaster")

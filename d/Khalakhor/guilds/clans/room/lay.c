...
#define SDESC \
"Animal furs and sleeping mats are scattered before the fireplace.\n"

mixed sdef = ({
({
({"fur", "furs", "on fur", "on furs", "animal fur", "animal furs", "on animal fur", "on animal furs"}),
"You sink down onto the large animal fur before the fire.\n",
" sinks onto the large animal fur before the fire.\n",
"You arise from the large animal fur.\n",
" arises from the large animal fur.\n",
"You are laying comfortably on the large animal fur before the fire.\n",
"You arise from the large animal fur and leave the room.\n",
" laying comfortably on a large animal fur before the fire",
" laying comfortably on a large animal fur before the fire.\n",
}),

({
({"mat","on mat", "sleeping mat", "on sleeping mat",}),
"You sink down onto a sleeping mat.\n",
" sinks onto a sleeping mat.\n",
"You arise from a sleeping mat.\n",
" arises from a sleeping mat.\n",
"You are laying comfortably on a sleeping mat.\n",
"You arise from a sleeping mat and leave the room.\n",
" laying comfortably on a sleeping mat",
" laying comfortably on a sleeping mat.\n",
})

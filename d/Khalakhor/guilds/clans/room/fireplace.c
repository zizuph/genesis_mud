...
stoke_fire(string str)
{
	...
	{
		write("You take the poker and stoke the fire within the "+
		"fireplace.\n"+
		"The fire burns more brightly.\n"+
		"You replace the poker in its holder.\n");
		
		/* This what others in room see. */
		say(QCTNAME(TP)+" picks up a poker from the holder "+
...
log_fire(string str)
{
	...
	{
		write("You get a log and place it on the fire."+
		"\nThe fire burns more brightly.\n");
		/* This what others in room see. */
		say(QCTNAME(TP)+" gets a log and places it on the fire.\n"+
		"The fire burns brightly now.\n");
		return 1;
	}
	else
...
warm_it(string str)
{
	if((str == "face"))
	{
		...
		"Ahh nice and warm.\n");
		/* This what others in room see. */
		say(QCTNAME(TP)+" puts "+HIS(TP)+" face closer to "+
		"the fireplace.\n");
		return 1;
	}
	if((str == "hands"))
	{
		...
		"The warmth from the fire feels good.\n");
	...
	if((str == "legs"))
	{
		write("You place your legs near the fire while rubbing "+
		"along your legs to warm them up.\n"+
		"The heat of the fire feels warm.\n");
		
		/* This what others in room see. */
		say(QCTNAME(TP)+" places "+ HIS(TP) +" legs close to the "+
		"fire while rubbing "+HIS(TP)+" legs, which appears to "+
		"warm them.\n");
		return 1;
	}
	if((str == "ears"))
	...
	if((str == "body"))
	{
		write("You turn your body toward the fire felling the "+
		"heat soothe your bones.\n");
		
		/* This what others in room see. */
		say(QCTNAME(TP)+" turns "+ HIS(TP) +" body towards the "+
		"fire for a long moment.\n");
		return 1;
	}
	if((str == "bottom"))
	{

/**********************************************************************
 * - mstore.c                                                       - *
 * - This is the store that hold the doublets and pants.            - *
...
{
	set_short("Storeroom");
	set_long("This is the store room for doublets and pants.\n");
	add_exit("mshop", "out");
...
#define PANTS   ("/d/Khalakhor/sw_speir/samorgan/arm/kilt")
/*********************************************************************
...
mixed to_check = ({ ({"create_armour", TUNIC,  8}),
                    ({"create_armour", BELT,   8}),
                    ({"create_armour", BOOTS,  8}),
                    ({"create_armour", PANTS,  8}),
                 });

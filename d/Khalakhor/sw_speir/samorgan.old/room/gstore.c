...
create_khalakhor_room() 
{
	...
	set_long("   This is the store room for general items.\n");
	
	add_exit("ashop", "north");
 ...
 *********************************************************************/
#define SMOBJ1        (SMOBJ + "herbpouch")
#define SMOBJ2        (SMOBJ + "lamp")
#define SMOBJ3        (SMOBJ + "foil")
#define SMOBJ4        (SMOBJ + "pack")
#define SMOBJ5        (SMOBJ + "basket1")
/*********************************************************************
...
mixed to_check = ({ ({"create_armour", SMOBJ1,  5}),
                    ({"create_armour", SMOBJ2,  5}),
                    ({"create_armour", SMOBJ3,  5}),
                    ({"create_armour", SMOBJ4,  5}),                    
                    ({"create_armour", SMOBJ5,  5}),
                 });

 ...
 *********************************************************************/
#define ARM1        (ARM + "shield")
#define ARM2        (ARM + "mail")
#define ARM3        (ARM + "helm")
#define ARM4        (ARM + "boots2")
#define ARM5        (ARM + "gloves2")
/*********************************************************************
...
mixed to_check = ({ ({"create_armour", ARM1,  5}),
                    ({"create_armour", ARM2,  5}),
                    ({"create_armour", ARM3,  5}),
                    ({"create_armour", ARM4,  5}),                    
                    ({"create_armour", ARM5,  5}),
                 });

...
//    " warm stew is from tavern module.\n", 1000, 60);
        add_tavern_drink(FOOD + "bmilk");
        add_tavern_drink(FOOD + "smilk");
        add_tavern_drink(FOOD + "ale");
        add_tavern_drink(FOOD + "dale");
        
        add_tavern_food(FOOD + "corncake");
        add_tavern_food(FOOD + "eggs");
        add_tavern_food(FOOD + "beef");
        add_tavern_food(FOOD + "bmuffin");
        add_tavern_food(FOOD + "oyster");
        add_tavern_food(FOOD + "clams");
 ...
 //                    });
       ...
       set_tavern_waiter("/d/Khalakhor/sw_speir/samorgan/npc/sakeller");
       clone_object("/d/Khalakhor/sw_speir/samorgan/npc/sakeller")->move(this_object());

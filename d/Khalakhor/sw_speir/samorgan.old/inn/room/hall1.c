...
create_khalakhor_room()
{
	...
	set_long("\n   This long hallway spreads north with a "+
	"decorative landing to the south. On each side of the hallway "+
	"are two doors with posted numerals 1 and 2. Soft but adequate "+
	"light stems from decorative brass lanterns hanging from the "+
	"walls along with a few paintings.\n");
	...
	add_exit("landing", "south");
	add_door_exit(IOBJ + "door2", "room2", "east");
	add_door_exit(IOBJ + "door1", "room1", "west");

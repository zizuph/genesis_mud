...
create_khalakhor_room()
{
	...
	set_long("\n   This is near the end of a long hallway that "+
	"spreads south. On each side of the hallway are two doors "+
	"with posted numerals 5 and 6. Soft but adequate light stems "+
	...
	add_exit("hall4", "north");
	add_exit("hall2", "south");
	add_door_exit(IOBJ + "door6", "room6", "east");
	add_door_exit(IOBJ + "door5", "room5", "west");	

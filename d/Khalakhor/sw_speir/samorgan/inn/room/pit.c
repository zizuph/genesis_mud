...
stoke_fire(string str)
{
	if((str == "the fire") || (str == "fire") || (str == "logs") || (str == "the logs"))
	{
		...
		say(QCTNAME(TP)+" picks up the roasting pit poker from "+
		"the holder and begins to stoke the fire.\n"+
		"The fire burns brightly now.\n");
		say(QCTNAME(TP)+" returns the roasting pit poker to "+
		"its holder.\n");
		return 1;
	}
	else
...
log_fire(string str)
{
	...
	{
		write("You take out a log from the firebox and place "+
		"it on the fire.\nThe fire burns more brightly.\n");
		
		/* This what others in room see. */
		say(QCTNAME(TP)+" takes out a log from the firebox "+
...
warm_it(string str)
{
	if((str == "face"))
	{
		...
		"from the heat of the roasting pit.\n"+
		"Ahh nice and warm.\n");
	...
	if((str == "legs"))
	{
		write("You step very close to the roasting pit and rub "+
		"along your legs to warm them up.\n"+
		"The heat of the fire feels warm on your skin.\n");
		
		/* This what others in room see. */
		say(QCTNAME(TP)+" steps up to the roasting pit and "+
		"starts to rub "+HIS(TP)+" legs, which appears to warm "+
		"them.\n");
		return 1;
	}
	if((str == "ears"))
	{
		...
		/* This what others in room see. */
		say(QCTNAME(TP)+" learns forward to the roasting pit and "+
	...
	if((str == "body"))
	{
		write("You step up to the fire and feel the heat "+
		"soothe your bones.\n");
		
		/* This what others in room see. */
		say(QCTNAME(TP)+" steps up to the fire for a "+
		"long moment.\n");
		return 1;
	}
	if((str == "bottom"))
	{
		write("You step up to the fire and stick your "+
		"bottom towards it.\n");

...
config_items()
{
  add_item(({"samorgan", "village", "section", "still village",
             "fishing village", "quaint village", "calm village",
             "quiet village", "peaceful village", "serene village"}),
           query_long);
  ...
  add_item(({"entrances", "entrance"}),
           ...
           "to visitors.\n");
  add_item(({"pots", "pot", "clay pot", "clay pots",
             "reddish clay pot", "reddish clay pots"}),
           "Reddish clay pots are placed outside of the buildings with "+
           "blossoming plants growing in them.\n");
  add_item(({"plants", "blossoming plants", "flowering plants",
             "flourishing plants", "budding plants", "emerging plants"}),
...
{
  mixed *arr = map(({desc1, desc2, desc3}), one_of_list);
  ...
  string x_long = pointerp(extra_long)
    ? one_of_list(extra_long)
    :"The fishing village of SaMorgan continues on in all directions.";
  set_long(implode(({

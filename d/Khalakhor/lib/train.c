/**********************************************************************
 * - train.c                                                        - *
 * - This is a training module with a few extras added in to make   - *
 * - training easier.                                               - *
 * - This is based on code created by Shiva@Genesis                 - *
...
"           ````````````````````````````````````````````````````\n"+
"           ` <learn>                                          `\n"+
"           `     List the various skills you have not learned.`\n"+
"           ` <learn 'skill'>                                  `\n"+
"           `     Learn a desired skill which you do not know. `\n"+
"           ` <improve>                                        `\n"+
"           `     List the various skills you may improve.     `\n"+
"           ` <improve 'skill'>                                `\n"+
"           `     Improve the desired skill.                   `\n"+
"           ` <improve 'skill' 'levels'>                       `\n"+
"           `     Improve the desired skill as many levels as  `\n"+
"           `     indicated.                                   `\n"+
"           ` <improve 'skill' max>                            `\n"+
"           `     Improve a skill as high as you can.          `\n"+
"           ` <meditate>                                       `\n"+
"           `     Estimate stats or set your preferences.      `\n"+
"           ````````````````````````````````````````````````````\n";
...
sk_hook_skillisting()
{
  write("Here are the following skills you may advance in and what level:\n\n");
  write("======================================"+
      "======================================\n"+
      "Skill:                   Cost:    "+
      " Next level:              Max level:\n"+
...
sk_list(int steps)
{
  ...
  map(guild_sk, write @ &sk_fix_cost(, steps));

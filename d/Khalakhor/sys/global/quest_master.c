 ...
 *  -- Finwe, August 1998
 *
 *  Taken from the Shire and placed here in Khalakhor.
 *  I created this so I can use it where ever I want ;-)
 *  Igneous March 25th 1999
 *
 */
#pragma strict_types
#pragma no_clone
...
#define INFO_MAP_SAVE "/d/Khalakhor/sys/global/quest_info"
...
add_quest(string short, int group, int bit, int exp, string long)
{
    ...
    {
	player->catch_msg("Invaid short quest name "+short+" was used.");
	return 1;
    }
